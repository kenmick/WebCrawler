...
if(((h.MJ(h.MC(a[4])["history_today"])||h.MJ(h.MC(a[4])["history_yesterday"]))||h.MJ(h.MC(a[4])["history_recent"]))){m+=[b[59],h.ME(b[60],h.MB,h.MN,null),b[61],h.F.entities(h.MC(a[24])),b[62],h.F.entities(h.MC(a[11])),b[63],h.F.entities(h.MC(a[3])),b[64]].join("")
}m+=b[24];
...
if(i.MD(a[15])){y+=b[29];
if(i.MJ(i.track_experiment_stage("gs_sb_child_age_at_checkout_date",1))){}y+=b[30];
if((i.MJ(i.MC(a[12]))&&i.MJ(i.track_experiment("bHVSfPfECIAEcMfBDZOVHJWe")))){if((i.MJ(i.MB(a[10])==1))){y+=[(f.unshift({date:i.MC(a[11])}),(c=i.ME(b[31],i.MB,i.MN,null)),f.shift(),c),b[2]].join("")
}else{y+=[(f.unshift({date:i.MC(a[11])}),(c=i.ME(b[32],i.MB,i.MN,null)),f.shift(),c),b[2]].join("")
...
this.model.on("change",this.modelChange.bind(this));
if(this.options.gscaacd){this.model.use("dates")
...
this.modelInit()
;_r_()},modelInit:function(){_i_("378:248");var k={rooms_count:h.rooms?h.rooms.length:1,adults_count:h.adults||2,children_ages:h.childrenAges||[]};
this.model.group.init(k)
;_r_()},modelChange:function(k){_i_("378:249");if(!k||(!this.options.gscaacd&&k.group!="group")){return _r_();
}this.render()
...
if(k.val()){j.stage("bHVSfPfECIAEcMfBDZOVHJWe",1);
