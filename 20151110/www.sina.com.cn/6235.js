...
window._AdSameObj_CY2698.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20151111/fc.swf",
	target: "_blank",
	clsbtn: 0,
	clickUrl: "http://sambaclk.adsame.com/c?z=samba&la=0&si=13&ci=4225&c=5727&or=5447&l=6228&bg=6142&b=6235&u=http://ju.mmstat.com/?url=https://1111.tmall.com/?spm=a1z15.20.4415.17303&ad_id=1001319391a8290bb1ff&am_id=&cm_id=&pm_id=&campaign_id=543711",
...
window._AdSameObj_CY2698.b1 = new _as_divfl({
	...
	btnHeight: 31,
	btns: [{
	url: _as_bro.isChrome() ? "":"http://rm.sina.com.cn/bj_chuanyang/tb20151111/close.jpg",
...
window._AdSameObj_CY2698.f2 = new _as_fl({
	width: 85,
	height: 130,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20151111/fb.swf",
	target: "_blank",
...
window._AdSameObj_CY2698.run = function() {
	...
	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://samba.adsame.com/s?z=samba&c=5727&l=6228\' />";
	if (_as_bro.isIe6()) {
	...
	if(_as_bro.isChrome()){
		...
		closediv.innerHTML = '<img style="width:77px;height:31px;" src="http://rm.sina.com.cn/bj_chuanyang/tb20151111/close.jpg">';
		if(!adsame_ss){
			document.getElementById("adsame_closebtn").style.display = "none";
		}
	}
