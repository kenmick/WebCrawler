/* 2015-11-03 12:06:45 - 9.4.0.149.3 */
/*
...
else if(q1ca.indexOf('screenad_clicks')===0){q1bI=JSON.parse(decodeURIComponent(q1bC));}
...
function q1tS(){var meta=document.createElement('meta'),heads=document.getElementsByTagName('head'),head=heads&&heads[0];if(head){meta.name="referrer";meta.content="origin";head.appendChild(meta);}
}
function q1oA(){var q11,q1pK,q1oC=document.getElementsByTagName('video');for(q11=0;q11<q1oC.length;q11++){if(q1or.indexOf(q1oC[q11])!==-1||q1oC[q11].className.match(/(weborama|adrime)_video/)===null){break;}
...
q1oA();q1tS();if(screenad.hasVisibility!==undefined){q1nJ(screenad.VISIBILITY_CHANGE,screenad.hasVisibility);}
}
}
...
if((q1dy.muted===undefined&&q1dy.autoplay!==false)||(q1dy.muted!==undefined&&q1dy.muted===true)){q1m9.setAttribute('muted','true');q1aB=true;if(screenad.browser.browser.gecko===true||screenad.browser.browser.engineVersion===9||screenad.browser.browser.msedge){q1m9.muted=true;}
}
