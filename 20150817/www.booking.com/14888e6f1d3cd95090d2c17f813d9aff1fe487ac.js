...
var l=b("#suggestion_initial");
if(!t.size()){t=b('<input type="hidden" id="suggestion_clicked" name="suggestion_clicked" value="0">');
$suggested_term=b('<input type="hidden" id="suggested_term" name="suggested_term" value="">');
t.appendTo("form#frm")
}b("#destination").keydown(function(){ var _r_, _f_; try { _f_ = function() {b("ul.ui-autocomplete").off("click.search_rewrite",".partition_item");
t.val(0);
$suggested_term.val("")
}; _r_ = _f_.apply( this, [].slice.apply( arguments ) ); } catch( _e_ ) { onBookingError( _e_.message, _e_.sourceURL, 0, 0, _e_, _f_ ); onBookingError.skip = true; throw _e_; } return _r_; });
...
}if(k===1){var j=booking.jstmpl.translations("search_box_result_your_search",null,{user_searched_term:v.__suggestions__.searched_term});
...
}else{if(k===2){var Y=booking.jstmpl.translations("search_box_opt_in_alternative_search",null,{search_term2:v.__suggestions__.initial_term});
var j=booking.jstmpl.translations("search_box_result_your_search",null,{user_searched_term:v.__suggestions__.searched_term})
}}b('<li id="ac-suggestion" class="ui-menu-item search-spellcheck" role="menuitem" data-suggestion="'+i+'"><span class="spellcheck-notlink">'+j+'</span><br /><a class="partition_item ui-corner-all did-you-mean-item spellcheck-islink">'+Y+"</a></li>").data("item.autocomplete",z).appendTo("ul.ui-autocomplete");
b("#ac-suggestion.search-spellcheck a").on("click",function(){ var _r_, _f_; try { _f_ = function() {b("#destination").val(v.__suggestions__.initial_term);
n._search(v.__suggestions__.initial_term,{v:0});
b("ul.ui-autocomplete").on("click.search_rewrite",".partition_item",function(){ var _r_, _f_; try { _f_ = function() {t.val(1);
$suggested_term.val(v.__suggestions__.updated_suggestion)
}; _r_ = _f_.apply( this, [].slice.apply( arguments ) ); } catch( _e_ ) { onBookingError( _e_.message, _e_.sourceURL, 0, 0, _e_, _f_ ); onBookingError.skip = true; throw _e_; } return _r_; })
}; _r_ = _f_.apply( this, [].slice.apply( arguments ) ); } catch( _e_ ) { onBookingError( _e_.message, _e_.sourceURL, 0, 0, _e_, _f_ ); onBookingError.skip = true; throw _e_; } return _r_; })
...
f.keydown(function(j){ var _r_, _f_; try { _f_ = function(j) {if(j.keyCode!=13){h.cur_ui_item={};
g.find("input[name='place_id']").remove();
g.find("input[name='place_id_lat']").remove();
g.find("input[name='place_id_lon']").remove()
}var i=$("#suggestion_clicked");
$("ul.ui-autocomplete").off("click.search_rewrite",".partition_item");
if(i.size()){i.val(0)
}}; _r_ = _f_.apply( this, [].slice.apply( arguments ) ); } catch( _e_ ) { onBookingError( _e_.message, _e_.sourceURL, 0, 0, _e_, _f_ ); onBookingError.skip = true; throw _e_; } return _r_; });
