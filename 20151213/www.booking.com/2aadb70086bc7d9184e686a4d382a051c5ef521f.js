...
booking[sNSExperiments]["BOefGOaYdBdHIYFMINFET"]=(function(c){var b="BOefGOaYdBdHIYFMINFET";
...
c.eventEmitter.bind("CALENDAR:opened",function(f,g){var e,d;
e=g.instance.$calendarElement.find(".c2-calendar-footer-tagline");
d='<div class="c2-calendar-footer-tagline">'+booking.jstmpl("pss_calendar_persuasive_copy").render({b_is_tdot_traffic:!!booking.env.b_is_tdot_traffic,b_is_desktop_site:!booking.env.b_is_tdot_traffic})+"</div>";
if(!e.length){g.instance.$footer.addClass("c2-calendar-footer--tagline");
g.instance.$footer.after(d)
}})
},initElse:a}
})(booking);