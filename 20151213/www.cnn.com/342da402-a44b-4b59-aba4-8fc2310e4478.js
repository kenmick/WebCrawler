...
// Generated on: 12/13/2015 6:52:04 AM (UTC 12/13/2015 12:52:04 PM)
...
if (ct_dispatcher.configName == 'Release_12102015')
{
	configFoundPHC = true;
			(function(){
...
if (ct_dispatcher.configName == 'Release_01112015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 12\/13\/2015 6:52:04 AM (UTC 12\/13\/2015 12:52:04 PM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
...
if (ct_dispatcher.configName == 'Release_30112015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 12\/13\/2015 6:52:04 AM (UTC 12\/13\/2015 12:52:04 PM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
...
if (ct_dispatcher.configName == 'RC_13122015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 12\/13\/2015 6:52:04 AM (UTC 12\/13\/2015 12:52:04 PM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
