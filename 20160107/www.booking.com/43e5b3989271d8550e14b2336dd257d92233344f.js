...
if(g.MD(a[43])){q+=b[94];
if((g.MJ(g.MC(a[42])>1))){q+=b[95]
}q+=b[96];
if((g.MK(g.ATLAS_ENV("tdot"))&&((g.MJ(g.ATLAS_ENV("action")+""==="hotel"))||(g.MJ(g.ATLAS_ENV("action")+""==="searchresults"))))){q+=b[97]
}q+=[b[98],g.MC(a[43]),b[99]].join("")
}q+=b[6]
}}q+=[b[100],g.MC(a[24]),b[101],g.MC(a[9]),g.MC(a[29]),g.MC(a[23]),b[102],g.MC(a[37]),b[13],g.MC(a[39]),b[75]].join("");
if(g.MK(g.ATLAS_ENV("isPartner413084"))){q+=b[30]
}q+=b[18];
if(((g.MJ(g.ATLAS_STAGE("ebcOQPBRNQWOGKPRHe"))&&g.MJ(g.ATLAS_TRACK("ebcOQPBRNQWOGKPRHe")))||(g.MJ(g.ATLAS_STAGE("ebcBUYSaBcHDQXYHET"))&&g.MJ(g.ATLAS_TRACK("ebcBUYSaBcHDQXYHET"))))){q+=b[103]
}q+=[b[104],g.MC(a[44]),b[105]].join("");
if(g.MD(a[47])){q+=b[106];
if(g.MD(a[45])){q+=[b[107],g.HELPER_ENV("b_icons_url"),b[108],g.MC(a[45]),g.MC(a[46]),b[109]].join("")
}q+=b[110]
}else{q+=[b[111],g.MC(a[45]),g.MC(a[46]),b[112]].join("")
}q+=b[3];
if(g.MD(a[48])){q+=b[113]
}q+=b[114];
if(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe")))){q+=b[52];
if((g.MJ(g.ATLAS_ENV("action")+""==="searchresults"))){q+=b[115];
q=m(q);
q+=b[136]
}q+=b[137];
if(g.MJ(g.MC(a[64]))){q+=b[138];
if(g.MD(a[63])){q+=[b[139],g.MC(a[63]),b[140]].join("");
if(g.MJ(g.ATLAS_TRACK("eGBfQHKbdCMAWe"))){q+=[b[141],g.format_number_decimal(g.MC(a[64])),b[140]].join("")
}else{q+=[b[141],g.MC(a[64]),b[140]].join("")
}q+=b[142]
}q+=b[143];
g.MN(a[65],g.MC(a[66]));
q+=b[143];
if(g.MJ(g.MC(a[66]))){q+=[b[144],g.MB(a[67]),b[145]].join("")
}q+=b[146]
}q+=b[147];
if((g.MJ(g.MC(a[68]))&&(g.MJ(g.ATLAS_ENV("action")+""==="hotel")))){q+=b[148];
if(!((g.MJ(g.ATLAS_STAGE("ebcBUYSaBHaZFBKWXbbQMdOeZZSeae"))&&g.MJ(g.ATLAS_TRACK("ebcBUYSaBHaZFBKWXbbQMdOeZZSeae"))))){q+=[b[149],g.MC(a[68]),b[150]].join("")
}q+=b[3]
}q+=b[151];
if(((((g.MJ(g.ATLAS_TRACK("ebcBUYSaBYWEIFIeTJWe")==2))||(g.MJ(g.ATLAS_TRACK("ebcOQPBRNPIHAEAUeAC")==2)))||(g.MJ(g.ATLAS_TRACK("ebcBUYSaBYbdbVDZHFEQC")==2)))||(g.MJ(g.ATLAS_TRACK("ebcOQPBRNHFcFfOSWEPGO")==2)))){q+=b[152]
}q+=b[52];
if((g.MJ(g.MC(a[22]))&&((g.MJ(g.ATLAS_STAGE("ebcBUYSaBYWEIFIeTJWe"))&&(g.MJ(g.ATLAS_TRACK("ebcBUYSaBYWEIFIeTJWe")==2)))||(g.MJ(g.ATLAS_STAGE("ebcOQPBRNPIHAEAUeAC"))&&(g.MJ(g.ATLAS_TRACK("ebcOQPBRNPIHAEAUeAC")==2)))))){q+=[b[153],g.MB(a[69]),b[154]].join("")
}q+=b[52];
if((g.MJ(g.MC(a[71]))&&((g.MJ(g.ATLAS_STAGE("ebcBUYSaBYbdbVDZHFEQC"))&&(g.MJ(g.ATLAS_TRACK("ebcBUYSaBYbdbVDZHFEQC")==2)))||(g.MJ(g.ATLAS_STAGE("ebcOQPBRNHFcFfOSWEPGO"))&&(g.MJ(g.ATLAS_TRACK("ebcOQPBRNHFcFfOSWEPGO")==2)))))){q+=[b[155],g.MB(a[70]),b[154]].join("")
}q+=b[6];
if(((((g.MJ(g.ATLAS_TRACK("ebcBUYSaBYWEIFIeTJWe")==2))||(g.MJ(g.ATLAS_TRACK("ebcOQPBRNPIHAEAUeAC")==2)))||(g.MJ(g.ATLAS_TRACK("ebcBUYSaBYbdbVDZHFEQC")==2)))||(g.MJ(g.ATLAS_TRACK("ebcOQPBRNHFcFfOSWEPGO")==2)))){q+=b[156]
}q+=b[5]
}q+=b[157];
if(!(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe"))))){q+=b[6];
if((g.MJ(g.MC(a[50]))&&g.MJ(g.ATLAS_TRACK("eGYSaBaUJBZNSTHT")))){q+=b[3];
g.MN(a[49],g.MC(a[50]));
q+=b[6]
}q+=b[158];
q=l(q);
...
if(!(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe"))))){q+=b[160];
if((g.MJ(g.MC(a[68]))&&(g.MJ(g.ATLAS_ENV("action")+""==="hotel")))){q+=[b[161],g.MC(a[68]),b[162]].join("")
}q+=b[163];
if(!(g.MJ(g.ATLAS_TRACK("ebcfESAcCFGZJdQFePBYKe")))){q+=b[164]
}q+=b[165]
}q+=b[166];
if(g.MJ(g.MC(a[18])["b_room_group"])){q+=b[18];
g.MN(a[72],g.MC(a[18])["b_u_total_price"]);
q+=b[18];
g.MN(a[73],g.MC(a[18])["b_total_adults_and_children"]);
q+=b[3]
}else{q+=b[18];
var w=(g.MC(a[18])||[]);
j.unshift(null);
...
g.MN(a[76],(g.MI(g.MC(a[77]))-g.MI(1)));
q+=b[166];
if(g.MD(a[79])){q+=b[18];
g.MN(a[78],b[167]);
q+=b[3]
...
}else{if((g.MJ(g.MB(a[80])+""==="false"))){q+=b[18];
g.MN(a[78],b[171]);
q+=b[3]
}}}}q+=b[3];
g.MN(a[81],g.MG(((g.MC(a[18])||[])[0]||{})["rackrate"]));
q+=b[3];
if(((g.MJ(g.MB(a[81]))&&(g.MJ(g.MB(a[81])+""!==""+g.MB(a[72]))))&&g.MJ(g.ATLAS_TRACK("eGYSaBZEGJGEO")))){q+=b[18];
g.MN(a[78],[g.MB(a[78]),b[172]].join(""));
q+=b[3]
}q+=b[3];
if(g.MD(a[17])){q+=b[18];
g.MN(a[78],[g.MB(a[78]),b[173]].join(""));
q+=b[3]
}q+=b[52];
if((g.MJ(g.MC(a[64]))&&g.MK(((g.ATLAS_TRACK("eGBUYSaBNHTXT")||g.ATLAS_TRACK("ebcfESAcCSBCHC"))||g.ATLAS_TRACK("eGOQPBRNZRUXe"))))){q+=b[174];
if(g.MD(a[63])){q+=[b[175],g.MC(a[63]),b[141]].join("");
if(g.MJ(g.ATLAS_TRACK("eGBfQHKbdCMAWe"))){q+=[b[176],g.format_number_decimal(g.MC(a[64])),b[141]].join("")
}else{q+=[b[176],g.MC(a[64]),b[141]].join("")
}q+=b[177]
}q+=b[132];
g.MN(a[65],g.MC(a[66]));
q+=b[178];
if(g.MJ(g.MC(a[66]))){q+=[b[179],g.MB(a[67]),b[180]].join("")
}q+=b[181]
}q+=b[52];
if((g.MJ(g.ATLAS_STAGE("ebcBUYSaBYdXfTYMNJFC"))&&g.MJ(g.ATLAS_TRACK("ebcBUYSaBYdXfTYMNJFC")))){q+=b[182];
q=l(q);
q+=b[136]
}q+=[b[183],g.MB(a[78]),b[184]].join("");
g.MN(a[82],g.ATLAS_ENV("checkinDay"));
q+=b[80];
g.MN(a[83],g.ATLAS_ENV("checkoutDay"));
q+=b[143];
g.MN(a[84],g.ATLAS_ENV("checkinMonthShort"));
q+=b[143];
g.MN(a[85],g.ATLAS_ENV("checkoutMonthShort"));
q+=b[80];
g.MN(a[86],g.ATLAS_ENV("checkoutMonthShort"));
q+=b[185];
if(g.MD(a[79])){q+=b[186];
if((g.MJ(g.ATLAS_TRACK("ebcOQPBRNZRUAJJSVHDFNIVSHT"))||g.MJ(g.ATLAS_TRACK("ebcBUYSaBNHTIPfbJEfZBWIbYO")))){q+=b[132];
g.MN(a[87],[b[132],g.HELPER_ENV("ajax_hotel_details_soldout"),b[132]].join(""));
q+=b[132];
g.MN(a[88],[b[132],g.HELPER_ENV("ajax_hotel_details_soldout"),b[132]].join(""));
q+=b[187];
if(((((((((((g.MJ(g.MB(a[82])+""===""))||(g.MJ(g.MB(a[83])+""==="")))||(g.MJ(g.MB(a[84])+""==="")))||(g.MJ(g.MB(a[85])+""==="")))||(g.MJ(g.MB(a[86])+""==="")))||g.MK(g.MB(a[82])))||g.MK(g.MB(a[83])))||g.MK(g.MB(a[84])))||g.MK(g.MB(a[85])))||g.MK(g.MB(a[86])))){q+=[b[140],g.HELPER_ENV("ajax_hotel_details_soldout"),b[132]].join("")
}else{q+=b[140];
if((g.MJ(g.MB(a[84])+""===""+g.MB(a[86])))){q+=[b[141],g.MB(a[89]),b[140]].join("")
}else{q+=[b[141],g.MB(a[90]),b[140]].join("")
}q+=b[132]
}q+=b[188]
}else{q+=[b[132],g.HELPER_ENV("ajax_hotel_details_soldout"),b[80]].join("")
}q+=b[189]
}else{if(((g.MJ((g.MC(a[18])).length)&&g.MJ(g.MC(a[18])[0]["checkin"]))&&g.MJ(g.MC(a[18])[0]["checkout"]))){q+=b[190];
if(g.MJ(g.ATLAS_TRACK("eGOQRWSEeTOZPbaPWAUC"))){q+=[b[191],g.MG(((g.MC(a[18])||[])[0]||{})["price"]),b[192]].join("")
}else{q+=b[140];
if(g.MJ(g.ATLAS_TRACK("eGBUYSaBGcPDeBEJYcMEfTRe"))){q+=b[193];
if((g.MJ(g.ATLAS_ENV("currency")+""==="EUR"))){q+=b[194];
g.MN(a[91],b[195]);
q+=b[176]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="GBP"))){q+=b[194];
g.MN(a[91],b[196]);
q+=b[176]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="JPY"))){q+=b[194];
g.MN(a[91],b[197]);
q+=b[176]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="CNY"))){q+=b[194];
g.MN(a[91],b[198]);
q+=b[176]
}else{q+=b[199];
g.MN(a[91],b[200]);
q+=b[176]
}}}}q+=[b[201],g.MC(a[91]),b[202],g.MC(a[92]),b[203]].join("");
if((g.MJ(g.ATLAS_ENV("currency")+""==="EUR"))){q+=b[204]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="GBP"))){q+=b[205]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="JPY"))){q+=b[206]
}else{if((g.MJ(g.ATLAS_ENV("currency")+""==="CNY"))){q+=b[207]
}else{q+=b[208]
}}}}q+=b[209]
}else{q+=[b[176],g.HELPER_FROM_FRICE(g.MC(a[18])[0]["price"]),b[140]].join("")
}q+=b[140]
}q+=b[210]
}else{if(g.MD(a[18])){q+=b[211];
g.MN(a[81],g.MG(((g.MC(a[18])||[])[0]||{})["rackrate"]));
q+=b[132];
if(((g.MJ(g.MB(a[81]))&&(g.MJ(g.MB(a[81])+""!==""+g.MB(a[72]))))&&g.MJ(g.ATLAS_TRACK("eGYSaBZEGJGEO")))){q+=b[140];
g.MN(a[93],g.MG(((g.MC(a[18])||[])[0]||{})["price_discount"]));
q+=b[140];
g.MN(a[94],g.MB(a[93]));
q+=b[140];
var p="";
p+=b[141];
if(g.MJ(g.MB(a[81]))){p+=b[212];
if((g.MJ(g.ATLAS_GET_VARIANT("eGYSaBZEGJGEO")==2))){p+=b[213]
}p+=[b[214],g.MB(a[96]),b[215],g.MB(a[81]),b[216]].join("")
}p+=b[140];
g.MN(a[95],p);
q+=b[132]
}else{q+=b[140];
...
g.MN(a[97],g.MC(a[98]));
q+=b[132];
if((g.MJ(g.ATLAS_STAGE("eGBUYSaBdbLMaCffHPSaTfRe"))&&g.MJ(g.ATLAS_TRACK("eGBUYSaBdbLMaCffHPSaTfRe")))){q+=b[140];
g.MN(a[99],undefined);
q+=b[132]
}else{q+=b[140];
g.MN(a[99],b[66]);
...
q+=b[187];
var p="";
p+=[b[219],g.MB(a[73]),b[75],g.MB(a[99]),b[220],"eGBUYSaBdbLMaCffHPSaTfRe",b[221],g.MB(a[95]),b[222],g.MB(a[72]),b[223]].join("");
if(((((g.MJ(g.MC(a[97])>0))&&(g.MJ(g.MC(a[97])==1)))&&g.MJ(g.ATLAS_STAGE("ebcYSaBGceZdAVIXe")))&&g.MJ(g.ATLAS_TRACK("ebcYSaBGceZdAVIXe")))){p+=[b[224],g.VP(b[225],"b_checkin_checkout_interval"),b[226]].join("")
}else{if((g.MJ(g.MC(a[97])>1))){p+=[b[224],g.VP(b[225],"b_checkin_checkout_interval"),b[227]].join("")
}}p+=b[132];
g.MN(a[102],p);
q+=b[211];
if((g.MJ(g.HELPER_IW_B_BLOCKS(g.MC(a[18]),0,"num_rooms_available_translated"))&&((g.MJ(g.ATLAS_ENV("action")+""==="hotel"))||g.MJ(g.ATLAS_TRACK("eGOLaBQPBRNSaBGKe"))))){q+=[b[228],g.MC(a[102]),b[229],g.HELPER_IW_B_BLOCKS(g.MC(a[18]),0,"num_rooms_available_translated"),b[230]].join("")
}else{q+=[b[140],g.MC(a[102]),b[132]].join("")
}q+=b[143]
}else{if((g.MJ(g.MB(a[80])+""==="false"))){q+=[b[231],g.strings("map_occupancy_disclaimer_1"),b[232]].join("")
}}}}q+=b[233];
var p="";
p+=b[80];
if(g.MD(a[108])){p+=b[132];
if(g.MD(a[79])){p+=b[140];
if(g.MK(g.MC(a[105]))){p+=[b[141],g.MB(a[104]),b[140]].join("")
}else{p+=[b[141],g.MB(a[106]),b[140]].join("")
}p+=b[132]
}else{p+=b[140];
if((((g.MJ(g.ATLAS_STAGE("ebcOQPBRYcYFMbcMZFNTeae"))&&g.MJ(g.ATLAS_TRACK("ebcOQPBRYcYFMbcMZFNTeae")))||(g.MJ(g.ATLAS_STAGE("ebcBUYSaBdBbCANCdZBSeLT"))&&g.MJ(g.ATLAS_TRACK("ebcBUYSaBdBbCANCdZBSeLT"))))||(g.MJ(g.ATLAS_STAGE("VOGBUYSaBdBbCANCdZBSeLT"))&&g.MJ(g.ATLAS_TRACK("VOGBUYSaBdBbCANCdZBSeLT"))))){p+=[b[141],g.MB(a[107]),b[140]].join("")
}else{p+=[b[141],g.MB(a[107]),b[140]].join("")
}p+=b[132]
}p+=b[80]
}else{p+=b[132];
if(g.MK(g.MC(a[105]))){p+=[b[140],g.MB(a[104]),b[132]].join("")
}else{p+=[b[140],g.MB(a[106]),b[132]].join("")
}p+=b[80]
}p+=b[18];
g.MN(a[103],p);
q+=b[18];
...
if(g.MK((g.MB(a[79])&&(g.ATLAS_GET_VARIANT("eGYSaBAeCQJJYDBeWe")||g.ATLAS_GET_VARIANT("eGYSaBAeCQJJYDBePART"))))){q+=[b[234],g.MC(a[26]),b[235],g.MC(a[9]),g.MC(a[30]),g.MC(a[23]),g.MC(a[31]),b[236],g.MC(a[36]),b[237]].join("");
if(g.MJ(g.ATLAS_TRACK("ebcBUYSaBNHFVXKNUADDbddSdceUPTDPFHe"))){q+=b[238]
}q+=b[82];
if(g.MK(g.ATLAS_ENV("isPartner413084"))){q+=b[30]
}q+=b[239];
if(g.MJ(g.MB(a[79]))){q+=[b[141],g.MC(a[103]),b[140]].join("")
}else{if(((g.MJ(g.MC(a[108]))&&g.MK(g.MB(a[79])))&&((g.MJ(g.ATLAS_STAGE("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe"))&&g.MJ(g.ATLAS_TRACK("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe")))||(g.MJ(g.ATLAS_STAGE("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET"))&&g.MJ(g.ATLAS_TRACK("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET")))))){q+=b[240];
if((g.MJ(/213|220|228|230|232/.test(g.MC(a[110]))))){q+=[b[176],g.MB(a[109]),b[75],g.MC(a[35]),b[141]].join("")
}else{if((g.MJ(/201|219|230|229/.test(g.MC(a[110]))))){q+=[b[176],g.MB(a[111]),b[75],g.MC(a[35]),b[141]].join("")
}else{q+=[b[176],g.MB(a[112]),b[75],g.MC(a[35]),b[141]].join("")
}}q+=b[140]
}else{if(((g.MJ(g.MC(a[108]))&&g.MK(g.MB(a[79])))&&(g.MJ(g.ATLAS_STAGE("VOGBUYSaBdBbCANCdZBSeLT"))&&g.MJ(g.ATLAS_TRACK("VOGBUYSaBdBbCANCdZBSeLT"))))){q+=[b[141],g.MC(a[103]),b[75],g.MC(a[35]),b[140]].join("")
}else{q+=[b[141],g.MC(a[103]),b[140]].join("")
}}}q+=b[241]
}q+=b[18]
}q+=b[242];
if(!(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe"))))){q+=b[243]
}q+=b[157];
if(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe")))){q+=b[2];
if(!(((g.MJ(g.ATLAS_ENV("action")+""==="searchresults"))||g.MJ(g.ATLAS_TRACK("ebcBUYSaBYdXfTYMNJFC"))))){q+=b[244];
q=m(q);
q+=b[245]
}q+=b[157]
}q+=b[19];
if(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe")))){q+=b[246];
if(((g.MJ(g.ATLAS_STAGE("ebcOLaCbJFYSaBbJZSYT",1))&&g.MJ(g.ATLAS_TRACK("ebcOLaCbJFYSaBbJZSYT")))||(g.MJ(g.ATLAS_STAGE("ebcBUVKQPbBbLOAPdZUO",1))&&g.MJ(g.ATLAS_TRACK("ebcBUVKQPbBbLOAPdZUO"))))){q+=[b[247],g.MC(a[9]),g.MC(a[30]),g.MC(a[23]),g.MC(a[31]),b[248],g.MC(a[36]),b[13]].join("");
if(g.MK(g.ATLAS_ENV("isPartner413084"))){q+=b[30]
}q+=b[249];
if(g.MJ(g.MB(a[79]))){q+=[b[18],g.MC(a[103]),b[52]].join("")
}else{if(((g.MJ(g.MC(a[108]))&&g.MK(g.MB(a[79])))&&((g.MJ(g.ATLAS_STAGE("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe"))&&g.MJ(g.ATLAS_TRACK("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe")))||(g.MJ(g.ATLAS_STAGE("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET"))&&g.MJ(g.ATLAS_TRACK("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET")))))){q+=b[79];
if((g.MJ(/213|220|228|230|232/.test(g.MC(a[110]))))){q+=[b[80],g.MB(a[109]),b[75],g.MC(a[35]),b[18]].join("")
}else{if((g.MJ(/201|219|230|229/.test(g.MC(a[110]))))){q+=[b[80],g.MB(a[111]),b[75],g.MC(a[35]),b[18]].join("")
}else{q+=[b[80],g.MB(a[112]),b[75],g.MC(a[35]),b[18]].join("")
}}q+=b[3]
}else{q+=[b[18],g.MC(a[103]),b[3]].join("")
}}q+=b[250]
}q+=b[246]
}q+=[b[251],g.MC(a[27]),b[252],g.MB(a[13]),b[253]].join("");
if(!(((g.MJ(g.ATLAS_TRACK("eGBUYSaBNHTXT"))||g.MJ(g.ATLAS_TRACK("ebcfESAcCSBCHC")))||g.MJ(g.ATLAS_TRACK("eGOQPBRNZRUXe"))))){q+=b[254]
}q+=b[17];
return q
