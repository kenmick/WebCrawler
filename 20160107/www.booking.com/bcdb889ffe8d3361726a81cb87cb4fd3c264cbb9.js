...
var j=m;
j=j<10?"0"+j:""+j;
var l={weekday:r.name,short_weekday:r["short"],day_of_month:p.getUTCDate(),zero_padded_day_of_month:q,zero_padded_month:j,month_name:o.name,short_month_name:o.short_name,full_year:p.getUTCFullYear(),time:p.getUTCHours()+":"+n};
