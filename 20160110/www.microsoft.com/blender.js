...
*/
   ...
   */
    ...
    /**
      ...
      @param {style} layout and css override (optional)
    */
    var viewCartHtml = function (auth, parentElementId, environment, clientType, culture, market, cv, flight, productDetails,iframeOptions, identity, campaignDetails, mediaOptions, purchaseServiceVersion, style) {
        var postBody = {
            "Auth": auth,
            "Culture": culture,
            "Market": market,
