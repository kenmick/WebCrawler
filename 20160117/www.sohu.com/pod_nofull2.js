                        ...
                        if(!!full[0]){
                            ...
                            full.append("<div id='fullflash'></div>")
                             // full.show();//sohu_flash new
                                 var sohuFlash2 = new sohuFlash("http://images.sohu.com/bill/s2016/yanlu/taobao/0117/7604000116.swf","_LIUMEITI2",760,400,"7");
...
//æ§å¶å¨å±
    window["SHOW_"+"FULLSCREEN"] = function(){
        ...
        img.src = "http://imp.optaim.com/201601/643ad69a15656e750d16a429661f8c30.php?a=99";//é²çæ¹è¿
        setTimeout(function() {
            isClose = true;
