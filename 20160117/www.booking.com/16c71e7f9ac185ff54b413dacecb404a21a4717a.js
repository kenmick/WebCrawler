...
if (e.setRequestHeader("X-Booking-Pageview-Id", booking.env.pageview_id), e.setRequestHeader("X-Booking-AID", booking.env.aid), e.setRequestHeader("X-Booking-Session-Id", booking.env.b_sid), booking.env.b_site_type_id && e.setRequestHeader("X-Booking-SiteType-Id", booking.env.b_site_type_id), booking.env.b_partner_channel_id && e.setRequestHeader("X-Partner-Channel-Id", booking.env.b_partner_channel_id), booking.env.b_label && e.setRequestHeader("X-Booking-Label", booking.env.b_label), booking.env.b_csrf_token && e.setRequestHeader("X-Booking-CSRF", booking.env.b_csrf_token), booking.env.b_lang_for_url && e.setRequestHeader("X-Booking-Language-Code", booking.env.b_lang_for_url), booking.env.b_extra_ajax_headers) for (var n in booking.env.b_extra_ajax_headers) e.setRequestHeader(n, booking.env.b_extra_ajax_headers[n]);
...
var h = $(c).position() || {}, _ = h.left, g = h.top;
r && (_ += r), s && (g += s), o || (o = u.offsetWidth);
var f = document.getElementById("bodyconstraint").offsetWidth;
return _ + o > f && (_ = f - o - 40), u.style.left = _ + "px", u.style.top = g + "px", u.style.visibility = "visible", !1;
}
window.open(i);
}
...
if (B.env.b_add_stages_to_request_info) var f = t.require("request_info");
...
var i, c, u, d, h, f, p, m, b, v, k, y, w, $ = [], C = 9, M = "ready" === e;
...
u[T] && $.push([ u[T].priority || C, T, i, !g(T) ]);
}
c = M ? a :s, d = t[c];
for (h in d) v = d[h], $.push([ v.priority || C, h, c, !1 ]);
if ($.length > 0) for ($.sort(), y = 0, w = $.length; w > y; y += 1) f = $[y], p = f[1], m = f[2], v = t[m][p], n.extend(v, {
strings:t.strings
}), b = f[3] ? v.initElse :v.init, v.ns = "booking." + m, v.name = p, _(b) && setTimeout(function(e, t, n) {
return function() {
...
return this.selector && ("undefined" != typeof t && "display" === e ? g("ELEMENT_DISPLAY:" + this.selector, {
elem:this,
value:t
}) :"[object Object]" === o.apply(e) && "display" in e && g("ELEMENT_DISPLAY:" + this.selector, {
elem:this,
value:e.display
})), n;
...
return this.selector && g("ELEMENT_DISPLAY:" + this.selector, {
elem:this,
...
s = ";custom=";
for (var _ = 0, g = M.length; g > _; _++) s += M[_].join("|"), g > _ + 1 && (s += ",");
}
if (S.length) {
u = ";stage=";
for (var _ = 0, g = S.length; g > _; _++) u += S[_].join("|"), g > _ + 1 && (u += ",");
}
if (B.env.b_add_stages_to_request_info) f.populate($), f.populate(S.map(function(e) {
return e.join("|");
})); else {
a = n("#req_info").html() || "";
...
var g = d + ":stage" + a;
u && "undefined" == typeof l.amTracking[g] && (i = !0, S.push([ d, a ]), l.amTracking[g] = 1), a = void 0, h.length = 0;
}
...
function s() {
return t.loadComponents(this), this;
}
t.loadComponents = function(e) {
var t, n, o, r, s, l, c;
e = e || i("html");
var s = e.find("[data-component]");
for (e.is("[data-component]") && (s = e.length > 1 ? s.add(e) :s.add(e.filter("[data-component]"))), t = 0, o = s.length; o > t; t++) for (l = s.eq(t), c = l.attr("data-component").split(/\s+/g), n = 0, r = c.length; r > n; n++) a(c[n], l);
}, t.registerJQuery = function() {
i.fn.component = r, i.fn.loadComponents = s;
};
}), function(e, t) {
"use strict";
...
this.init = function(s, g) {
var m;
n = s, i = n.find(".display-settings--panel-head"), o = n.find(".ds-loader"), a = n.find(".ds-trigger--language"), r = n.find(".ds-trigger--currency"), l = n.outerHeight() - i.outerHeight(), t.extend(d, d.defaults, g || {}, _()), f();
var b = function() {
...
arrowSize:5,
content:function(e) {
e(a(this.handle().attr(this.dataAttr)));
}
},
timeout:null
});
...
flyContentTooltip:o,
init:function(e) {
e && (o = o.extend(e)), e = e || {}, o.delegate(e.delegateTo ? e.delegateTo :n);
}
};
}();
}), t.require([ "require" ], function(e) {
e("core/fly-content-tooltip/fly-content-tooltip").init(), e("core/fly-content-tooltip/fly-content-tooltip").init({
defaults:{
...
var _ = h + d + 1524, g = Math.floor((_ - 122.1) / 365.25), f = Math.floor(365.25 * g), p = Math.floor((_ - f) / 30.6001);
a = _ - f - Math.floor(30.6001 * p), r = p - 1, p > 13 && (g += 1, r = p - 13), s = g - 4716;
...
function h(t, n) {
var i, o, r, s, h, _ = a.get(0), g = a.val();
if (t.year && t.month % 1 === 0) o = new Date(t.year, t.month, 1).getDay(), h = u(t, n), g = t.date; else {
if (t) return;
h = 31;
}
...
for (var f = 1; h >= f; f++) r.appendChild(l({
text:c(f, (o - 1 + f) % 7),
selected:g == f,
value:f
}));
...
r.bind("change.dateSelector", g), a.bind("change.dateSelector", f), r.trigger("change.dateSelector"), n.bind("dateSelected", v);
}
...
"use strict";
var i = e("../lists-tools/lists-tools"), o = e("../lists-api/lists-api"), a = e("../lists-api/lists-api").API, r = e("../lists-store/lists-store"), s = e("../listview-dropdown/listview-dropdown"), l = e("../listview-travel-party/listview-travel-party"), c = e("../listview-calendar/listview-calendar"), u = e("../listview-header/listview-header"), d = e("../listview-touch/listview-touch"), h = e("../listview-tabs/listview-tabs"), _ = e("../listview-note/listview-note"), g = e("../listview-share/listview-share"), f = e("../listview-header/listview-create-list"), p = e("../listview-map/listview-map"), m = e("../listview-template/listview-template"), b = e("../listview-hotel/listview-hotel"), v = e("../listview-availability/listview-availability");
function k(e) {
var t = this;
...
t.resizeLightbox();
}, 1e3)), c.call(this), s.call(this), d.isEnabled() || l.call(this), u.call(this), B.track.getVariant("PcVBcdEQJHebCHe") && g.call(this), B.track.getVariant("PcVBcdEQJPTJECJPLcPC") && f.call(this), this._bindGA(), !d.isEnabled() && B.track.getVariant("PcVBcdEQJHPTQYO") && this._bindNoteEvents(), B.track.getVariant("PcVBcdEQJZNKe") && p.isSupported() && this.map.bindEvents(), B.track.getVariant("PcVBcdEQJZXNbBMPCDXQDZET")) {
...
$(".js-listview-header-wrapper").on("click", ".js-listview-create-list", function(n) {
...
thousand:i,
decimal:o
}, n.settings.number), r = d(a.precision), h = 0 > e ? "-" :"", p = parseInt(g(Math.abs(e || 0), r), 10) + "", m = p.length > 3 ? p.length % 3 :0;
return h + (m ? p.substr(0, m) + a.thousand :"") + p.substr(m).replace(/(\d{3})(?=\d)/g, "$1" + a.thousand) + (r ? a.decimal + g(Math.abs(e), r).split(".")[1] :"");
...
decimal:a,
format:r
}, n.settings.currency), m = h(g.format), b = e > 0 ? m.pos :0 > e ? m.neg :m.zero;
return b.replace("%s", g.symbol).replace("%v", f(Math.abs(e), d(g.precision), g.thousand, g.decimal));
};
n.formatColumn = function(e, t, i, o, a, g) {
if (!e) return [];
var p = c(l(t) ? t :{
symbol:t,
precision:i,
...
e = _(e);
var i = e > 0 ? m.pos :0 > e ? m.neg :m.zero, o = i.replace("%s", p.symbol).replace("%v", f(Math.abs(e), d(p.precision), p.thousand, p.decimal));
...
var _ = l + s.outerHeight(!0), g = this.cols + 1 - d;
for (u = 0; g > u; u++) this.colYs[c + u] = _;
},
resize:function() {
var e = this.cols;
...
function a() {
var e = "BOebRRDOQHIKZNVEO";
if (B.track.stage(e, 1), $(window).width() > 1620 && B.track.stage(e, 2), B.env.b_action) switch (B.env.b_action) {
case "hotel":
B.track.stage(e, 3);
break;
...
if ((!e.canShowNotice() || e.isNoticesDisabled()) && (a(), !B.track.getVariant("BOebRRDOQHIKZNVEO"))) return !1;
i++;
var t, r, s, l, c, u, d = {
inEffect:{
opacity:"show"
...
t = e.extend({}, d, t);
booking.track.getVariant("PYBRRCbbAPQHafJdHZcKWe");
growl_font_stack = booking.track.getVariant("PNHafDcaRDPNZJQAZFO");
var _ = growl_font_stack ? "growl_font_stack" :"", g = navigator && navigator.platform && -1 == navigator.platform.indexOf("Mac") && -1 == navigator.platform.indexOf("iPad") && -1 == navigator.platform.indexOf("iPhone"), f = (navigator && navigator.platform && (navigator.platform.indexOf("Mac") >= 0 || navigator.platform.indexOf("iPad") >= 0 || navigator.platform.indexOf("iPhone") >= 0), " ");
B.track.getVariant("BOebRRDOQPQeHOcTTDbQNZAUBO") && (f = " notice-item--persistent-close-btn ");
var p = booking.track.getVariant("BOebRRDOLdJOUTUKUDfAMO");
g && !p && (t.platform = "win"), e(".notice-wrap").length ? r = e(".notice-wrap") :(r = e("<div></div>").addClass("notice-wrap").addClass(t.platform).addClass(t.wrapperClass).appendTo("body"), r[0].id = "growl_squash"), t.zindex === !1 || isNaN(t.zindex) || r.css("z-index", t.zindex), "win" === t.platform && (h = "__placement1"), g && p && (h = "pss-growls-design-consistency-windows");
var m, b;
if ("hotel" === B.env.b_action && "win" !== t.platform && r.addClass("growls_no_scroll"), B.env.rtl && m && b && (h = "__placement_" + b), h && r.addClass(h), s = e("<div></div>").addClass("notice-item-wrapper").addClass(_), u = "" == t.destination ? "<p>" + t.text + "</p>" :'<p><a href="' + t.destination + '">' + t.text + "</a></p>", "all" == t.close ? (l = e("<div></div>").hide().addClass("notice-item " + f + t.type + " " + t.addClassName).appendTo(r).html(u).animate(t.inEffect, t.inEffectDuration).wrap(s).bind(n, function(n) {
...
return booking.google.trackEvent(booking.google.clickTracker, "growl_removed", n && n.target && $(n.target).closest(".notice-item-close-x").length ? "x" :"message"), e.noticeRemove(l, t.addClassName, !1, !0), !!t.destination;
}), c = e("<div></div>").addClass("notice-item-close-x").prependTo(l)) :(l = e("<div></div>").hide().addClass("notice-item " + f + t.type).appendTo(r).html(u).animate(t.inEffect, t.inEffectDuration).wrap(s), c = e("<div></div>").addClass("notice-item-close-x").prependTo(l).bind(n, function() {
return e.noticeRemove(l, !1, !1, !0), "language" == t.type && ("undefined" == typeof b_cookie && (b_cookie = {}), b_cookie.langPrompt = "dontshow", "undefined" != typeof JSON && $.cookie("b", JSON.stringify(b_cookie), {
expires:30,
path:"/",
domain:booking.env.b_domain_end
})), !1;
})), t.injectHTML && l.prepend(t.injectHTML), "language" == t.type && ($(".notice-item p").css("cursor", "pointer"), $(".notice-item p").bind(n, function() {
return $("#langselectformlist").val(booking.env.browser_lang), $("#languageselect")[0].submit(), e.noticeRemove(l), !1;
})), navigator.userAgent.match(/MSIE 6/i) && r.css({
top:document.documentElement.scrollTop
}), t.stay || setTimeout(function() {
e.noticeRemove(l, "", 1);
}, t.stayTime), booking.eventEmitter.triggerHandler("growl:show", t), B.track.stage("BOebRRDOQPQeHOcTTDbQNZAUBO", 1), p && g) {
switch (B.track.stage("BOebRRDVdJOUTUKUDfAMO", 1), booking.env.b_action) {
case "searchresults":
pss_growl_design_consistency_stage = 2;
break;

case "hotel":
pss_growl_design_consistency_stage = 3;
break;

case "booking":
pss_growl_design_consistency_stage = 4;
break;

default:
pss_growl_design_consistency_stage = 5;
}
B.track.stage("BOebRRDVdJOUTUKUDfAMO", pss_growl_design_consistency_stage);
}
return o(t), l;
},
...
if (o && e.setCookieOnClose(), o && (B.track.custom_goal("BOebRRDOQHIKZNVEO", 1), B.track.stage("BOebRRDOQPQeHOcTTDbQNZAUBO", 2), B.track.stage("BOebRRDOLcNTBZGHO", 1), B.env.b_action)) switch (B.env.b_action) {
case "hotel":
...
var a = booking.track.getVariant("BOebRRDOLdJOUTUKUDfAMO");
o && (B.track.custom_goal("HBbOXYZKefOCYDeHdHC", 1), a && B.track.stage("BOebRRDVdJOUTUKUDfAMO", 6)), a && !o && B.track.stage("BOebRRDVdJOUTUKUDfAMO", 7), B.env.b_is_tdot_traffic && o && B.track.custom_goal("PNRYTYeYCNOSZRRDORe", 1), o && B.env.b_growls_close_fast || B.track.getVariant("PNRYTYeYCNOSZRRDORe") ? t.parent().remove() :t.animate({
opacity:"0"
}, 600, function() {
t.parent().animate({
height:"0px"
...
var i = "x" == n ? "Left" :"Top", o = i.toLowerCase(), g = "scroll" + i, f = s[g], p = t.max(s, n);
if (r) u[g] = r[o] + (d ? 0 :f - l.offset()[o]), a.margin && (u[g] -= parseInt(c.css("margin" + i)) || 0, u[g] -= parseInt(c.css("border" + i + "Width")) || 0), u[g] += h[o] || 0, a.over[o] && (u[g] += c["x" == n ? "width" :"height"]() * a.over[o]); else {
var m = c[o];
u[g] = m.slice && "%" == m.slice(-1) ? parseFloat(m) / 100 * p :m;
}
a.limit && /^\d+$/.test(u[g]) && (u[g] = u[g] <= 0 ? 0 :Math.min(u[g], p)), !e && a.queue && (f != u[g] && _(a.onAfterFirst), delete u[g]);
}), _(a.onAfter);
function _(e) {
...
var u = r.offset().left - $(".hybrid-header").offset().left, d = $(".hybrid-header").width(), h = d - (c + s + u), _ = u + s - c, g = d / 2, f = d / 2, p = l.position().left;
if (g -= 249, f += 124, parseInt($pLeft) >= 0 && parseInt($pLeft) < 306 && parseInt(p) < parseInt(g)) if (o.css({
left:"0",
right:"auto"
...
} else if (parseInt($pRight) >= 0 && parseInt($pRight) < 430 && parseInt(p) > parseInt(f)) {
...
} else parseInt(p) > parseInt(g) && parseInt(p) < parseInt(f) && (o.hasClass("aff_currency_popover") ? o.css({
width:"802px"
...
var n, i, o, a, r, s, l, c, u, d, h, _, g, f, p = 0;
...
var m = function(e) {
a.scrollTop() + p > g - i.data("stick-to-offset") && v(), a.scrollTop() + p <= g - i.data("stick-to-offset") && k();
}, b = function(e) {
...
if (f) return void i.css({
top:i.data("stick-to-offset")
});
return S(i), i.addClass("sticked").css({
top:i.data("stick-to-offset"),
"z-index":t[sNSStartup].bookingSticker.stickToZIndex
}).before(o), t[sNSStartup].bookingSticker.stickToZIndex--, f = !0, y(), C(), void B.events.emit(B.hotel.Events.RT.STICKY_STUCK, i);
}, k = function() {
if (!f) return;
return i.removeClass("sticked").css({
top:h,
"z-index":_
}), o.remove(), t[sNSStartup].bookingSticker.stickToZIndex++, f = !1, w(), C(), void B.events.emit(B.hotel.Events.RT.STICKY_RELEASE, i);
}, y = function() {
...
g = o.is(":visible") ? parseInt(o.offset().top, 10) :parseInt(i.offset().top, 10), b(), C(), m();
}, T = function(r, s) {
...
-1 === l.indexOf(this) && l.push(this), a = e(window), elemOriginalCSSDisplay = i.css("display"), emOriginalCSSTop = i.css("top"), _ = i.css("z-index"), M(), g = parseInt(i.offset().top, 10), i.data("elem-original-offset-top", g), i.data("stick-to-offset", 0), o = i.clone(!1).css({
visibility:"hidden"
...
var d, h, _, g;
"session" === t ? d = "bs" :(d = "b", g = 30), h = this._readCookie(d), "delete" === a ? delete h[r] :h[r] = s, _ = i.isEmptyObject(h) ? null :JSON.stringify(h), i.cookie(d, _, {
expires:g,
path:"/",
...
var g = "";
if (s ? ((_ - this.till.date == 0 && n || _ - this.from.date == 0 && !n) && (g += " selected"), !n && booking.avCalendar.isDateInRange({
year:o,
month:i,
day:d
}) && (g += booking.avCalendar.isCheckInAvailable({
year:o,
month:i,
day:d
}) ? " has_av" :" no_av"), n && this.from.day && booking.avCalendar.isDateInRange(this.from) && (g += booking.avCalendar.isCheckOutAvailable(this.from, {
year:o,
month:i,
day:d
}) ? " has_av" :" no_av")) :(_ - this.today == 0 && (g += " today"), _ - this.till.date == 0 && (g += n ? " selected" :" endsel"), _ - this.from.date == 0 && (g += n ? " endsel" :" selected"), _ < this.till.date && _ > this.from.date && (g += " inbetween")), booking.env.b_fd_hotel_dates) for (var f = 0; f < booking.env.b_fd_hotel_dates.length; f++) if (booking.env.b_fd_hotel_dates[f]) {
$.lst = booking.env.b_fd_hotel_dates[f].split("-");
var p = new Date(Number($.lst[0]), Number($.lst[1]) - 1, Number($.lst[2]));
_ - p == 0 && (g += " flashdeals");
}
h.innerHTML = '<a href="#" class="' + g + '">' + d + "</a>";
...
for (var h = 1; u >= h; h++) {
var _ = d(a, o, h), g = e.b_simple_weekdays_for_js[_] + " " + h;
("ja" == e.b_lang || "zh" == e.b_lang || "ko" == e.b_lang || "hu" == e.b_lang) && (g = "ja" != e.b_lang && "zh" != e.b_lang && "ko" != e.b_lang || !B.track.getVariant("YdVSfHJSedZFNfPOUNEQYLFQCSET") ? h + " " + e.b_simple_weekdays_for_js[_] :h + B.env.sbox_day + " " + e.b_simple_weekdays_for_js[_]), o == booking.env.b_this_month && a > booking.env.b_this_year4 && (h > booking.env.b_this_day - 2 && !n || h > booking.env.b_this_day - 1 && n) && booking.env.b_site_experiment_rolling_calendar_year || (n ? a == l && o == s && c >= h && booking.env.b_site_experiment_clip_checkout_day_dropdown || $(t).append('<option value="' + h + '"' + (r == h ? ' selected="selected"' :"") + ">" + g + "</option>") :$(t).append('<option value="' + h + '"' + (r == h ? ' selected="selected"' :"") + ">" + g + "</option>"));
}
},
...
b_freebie:t[63]
}), e = g(e), i.shift(), e += [ t[59], a.MB(n[36]), t[60] ].join("")), e += t[61], a.MJ(a.MG((a.MC(n[34]) || {}).b_genius_perks_widget_bike)) && (e += t[55], a.MD(n[32]) && (e += t[56]), e += t[57], i.unshift({
b_freebie:t[64]
}), e = f(e), i.shift(), e += [ t[59], a.MB(n[37]), t[60] ].join("")), e += t[61], a.MJ(a.MG((a.MC(n[34]) || {}).b_genius_perks_widget_drink)) && (e += t[55], a.MD(n[32]) && (e += t[56]), e += t[57], i.unshift({
b_freebie:t[65]
...
b_freebie:t[65]
}), e = g(e), i.shift(), e += [ t[59], a.MB(n[38]), t[60] ].join("")), e += t[61], a.MJ(a.MC(n[34])) && (a.MJ(a.MC(n[34]).b_genius_perks_widget_parking) || a.MJ(a.MC(n[34]).b_genius_perks_widget_wifi)) && (e += t[66], a.MJ(a.track_experiment("ge_high_demand_freebies_wifi_parking")) && (e += t[67], a.MJ(a.MG((a.MC(n[34]) || {}).b_genius_perks_widget_parking)) && (e += t[68], a.MD(n[32]) && (e += t[56]), e += t[69], i.unshift({
b_freebie:t[70]
}), e = s(e), i.shift(), e += [ t[71], a.ME(t[72], a.MB, a.MN, null), t[73] ].join("")), e += t[67], a.MJ(a.MG((a.MC(n[34]) || {}).b_genius_perks_widget_wifi)) && (e += t[68], a.MD(n[32]) && (e += t[56]), e += t[69], i.unshift({
b_freebie:t[74]
}), e = l(e), i.shift(), e += [ t[71], a.ME(t[75], a.MB, a.MN, null), t[73] ].join("")), e += t[66]), e += t[61]), e;
...
b_size:t[130],
b_tooltip:t[131]
}), o = m(o), i.shift(), o += [ t[132], a.MB(n[52]), t[133] ].join(""), a.MN("num_stays_needed", a.MI(5) - a.MI(a.MC(n[53]).renewal_info.genius_stays_count_renewal_exp)), o += [ t[134], a.VP(t[135], "num_stays_needed"), t[136], a.MG(((a.MC(n[53]) || {}).renewal_info || {}).genius_stays_count_renewal_exp), t[137], a.MB(n[54]), t[138], (i.unshift({
renewal_date:a.MG(((a.MC(n[53]) || {}).renewal_info || {}).genius_stays_date_renewal_exp)
...
}, B.define("ga-tracker", function(e, t, n) {
n.exports = booking.google;
}), function(e, t, n, i, o) {
...
if (g(), t.css("visibility", "visible"), r.bAnimation) {
var n = r.bAnimation;
...
i ? r && (o("show"), $("body").bind("click.resize_partners", function(t) {
if (t && t.target && $(t.target).hasClass("no-trigger-resize")) return;
e.resizeTo(.95 * screen.width, .95 * screen.height), a();
})) :(o("show"), $("body").bind("click.resize_partners", function(t) {
if (t && t.target && $(t.target).hasClass("no-trigger-resize")) return;
...
function a() {
$("body").unbind("click.resize_partners"), e.moveTo(0, 0), $(e).trigger("resize"), o("hide");
}
return {
init:i,
priority:1
...
r = parseInt(d / 2.5);
for (var h = 0; d > h; h++) {
var _ = "!@#$%^&*(){}[];:'\"\\|,.<>/?+=-_Â±Â¤", g = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
isNaN(n.charAt(h)) || (s += 1), isNaN(n.charAt(h)) && (l = 1), _.indexOf(n.charAt(h)) > -1 && (c += 2), g.indexOf(n.charAt(h)) > -1 && (u += 1);
}
...
var t, n = booking.env, i = $(this), o = /^([\w-\.\+]+@([\w-]+\.)+[\w-]{2,14})?$/, a = $("input[name=url]", i).val(), r = $("input[name=hostname]", i).val(), s = $("input[name=aid]", i).val(), l = $("input[name=companyname]", i).val(), c = $("input[name=subscribe_source]", i).val(), u = $("input[name=subscribe_notification]", i).val(), d = $("input[name=dest_id]", i).val(), h = $("input[name=dest_type]", i).val(), _ = $("input[name=to]", i).val(), g = $("input[name=get_the_app]", i).is(":checked");
if ("" === _ || !o.test(_)) return $(this).find(".nl_inputfield_track").addClass("error"), $(".newsletter_subscribe_error_invalid", i).show(), !1;
_ = encodeURIComponent(_), t = "to=" + _ + "&url=" + a + "&hostname=" + r + "&aid=" + s + "&companyname=" + l + "&subscribe_source=" + c, "" !== u && (t = t + "&subscribe_notification=" + u), "" != d && (t = t + "&dest_id=" + d), "" != h && (t = t + "&dest_type=" + h), g === !0 && (t += "&get_the_app=1"), $(".newsletter_sub_preloader", i).show(), $.ajax({
type:"POST",
...
if (e.ttContent = $(".tt_content", e.tt).length ? $(".tt_content", e.tt).get(0) :e.tt, e.setWindowSize(), e.setScrollPosition(), booking.env.b_is_tdot_traffic && $(document).on("touchstart.ttfix", ".js-tooltip-wrap", function() {
e.showHideTooltip(null, 0, 0);
}), $("body").delegate(t, "mouseover mouseout mousemove", function(t) {
...
var g = $(e).attr("data-toponly"), f = "flexible" === g ? "flexible" :!!g;
return this.toolTips[t] = [ n, o, a, u, _, f ], null != e.getAttribute("title") && (null == e.getAttribute("data-title") && e.setAttribute("data-title", e.title), e.title = "", e.removeAttribute("title")), booking.env.b_is_ie && e.removeAttribute("alt"), this.toolTips[t];
}
return null;
}
},
...
for (var i, o, a = n.length, r = parseInt(a / 2.5), s = "!@#$%^&*(){}[];:'\"\\|,.<>/?+=-_", l = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", c = 0, u = !1, d = 0, h = 0, _ = t.attr("data-wrapper") ? t.parents(t.attr("data-wrapper")) :t.parents(".user_access_form"), g = $(".user_access_password_strength", _).find(".pass_strength_step").width(), f = $(".user_access_password_strength", _).find(".pass_strength_progress"), p = 0; a > p; p++) isNaN(n.charAt(p)) ? u = !0 :c += 1, s.indexOf(n.charAt(p)) > -1 && (d += 2), l.indexOf(n.charAt(p)) > -1 && (h += 1);
d > 4 && (d = 4), c > 2 && (c = 2), h > 2 && (h = 2), u && (r += c), r += d, r += h, r > 10 ? r = 10 :0 === r && (r = 1), 8 > a ? (f.addClass("pass_strength_invalid"), r > 3 && (r = 3), o = 0) :(f.removeClass("pass_strength_invalid"), o = parseInt(r / 2) + 1), o = o > 5 ? 5 :o, i = g * r, f.animate({
width:i + "px"
...
var u = l, d = r, h = c, _ = g, r = s || [];
n.unshift({
lang:null
});
for (var g, l = 1, c = r.length; c >= l; l++) n[0].lang = g = r[l - 1], n.unshift({
lang:g
}), i = a(i), n.shift();
n.shift(), l = u, r = d, c = h, g = _, i += e[10];
}
...
n.shift(), l = u, r = d, c = h, g = _, i += e[12];
}
...
var u = l, d = a, h = c, _ = g, a = s || [];
n.unshift({
lang:null
});
for (var g, l = 1, c = a.length; c >= l; l++) n[0].lang = g = a[l - 1], n.unshift({
lang:g
}), i = r(i), n.shift();
n.shift(), l = u, a = d, c = h, g = _, i += e[12];
}
return n.shift(), i += e[13];
}
...
var e = !1, t = !1;
B.et.track("bLYSRffECIAaKLPLTQWGJXWdIGWe") && ($("#frm").delegate(".b-children-ages-configurator__element", "click", function() {
t && (t.hide(), t.destroy());
}), $(".b-selectbox__element[name=group_children]").change(function() {
parseInt($(this).val()) > 0 && !e && setTimeout(function() {
t = $.fly.dropdown.extend({
defaults:{
position:"bottom left",
content:function() {
return B.jstmpl("searchbox_children_ages_tooltip").render({});
},
extraClass:"searchbox_children_ages_tooltip"
}
}).create(".b-children-ages-configurator__element"), t.show(), e = !0;
}, 0);
})), $(".b-selectbox__element[name=group_children]").change(function() {
B.et.stage("bLYSRffECIAaKLPLTQWGJXWdIGWe", 1);
}), $("#frm").delegate(".b-children-ages-configurator__element", "change", function() {
console.log("track stage 2"), B.et.stage("bLYSRffECIAaKLPLTQWGJXWdIGWe", 2);
});
}), function() {
...
}("YdVSfPTDPUPcC"), function(e) {
B[sNSExperiments][e] = {
init:function() {
$(".default_cur_lang_settings").find(".decline_settings, .accept_settings, .close_settings").click(function() {
$(".default_cur_lang_settings").hide(), $("#bodyconstraint").addClass("slideUp"), $("body").addClass("body-slide-up");
}), 2 == B.track.getVariant(e) && $(".default_cur_lang_settings_content_wrapper [data-trigger]").click(function() {
return $($(this).data("trigger")).click(), !1;
});
}
};
}("YdVJWcDOHQFVAFAOIEeUeKe"), B.run("YdAcCcdNANKBYbaTaTaET").onReady(function() {
...
if (0 === o) {
var a = e.track(n);
a && (i.e_brick_themes = a);
}
}), t.on("afterajax", function(t, i) {
var o = e.track("PVdIYROdVaC");
0 === o && i && i.__show_theme_flag__ && e.stage(n, 1);
});
}), B.when({
events:[ "ready" ]
}).require([ "et", "search/destination/service-booking" ], function(e, t) {
...
var n = "PVZVAAZSBMBHKdRfLFaeXC";
t.on("beforeajax", function(t, i) {
var o = e.track("PVdIYROdVaC");
if (1 === o) {
var a = e.track(n);
a && (i.e_msm = 1, i.e_brick_themes = a, i.e_theme_msm = 1);
}
}), t.on("afterajax", function(t, i) {
var o = e.track("PVdIYROdVaC");
1 === o && i && i.__show_theme_flag__ && e.stage(n, 1);
});
...
if (i && 5e3 > n - i) return;
i = n, $.getJSON("/hotel_history_counter", function(t) {
...
hover:"100ms .js-lists-header-button",
...
var g = c.replace(/\%s/, _(o)), f = c.replace(/\%s/, _(a));
s || (s = n.parent = document.createElement("div")), s.innerHTML = g + f, r = n.sansSerif = s.firstChild, i = n.serif = r.nextSibling, d.glyphs && (r.innerHTML += d.glyphs, i.innerHTML += d.glyphs);
function p(e, t, n) {
