...
},inputKeyDown:function(){B.track.stage("PVdIESZHO",2);
a.prototype.inputKeyDown.apply(this,arguments)
...
e.bind("keydown",function(){B.track.stage("PVdIESZHO",2)
});
...
}e.autocomplete({source:a,extraParams:booking.env.search_autocomplete_params,minLength:c,delay:booking.env.search_autocomplete_delay||b}).bind("autocompleteselect",function(p,o){if(o.item){B.track.custom_goal("PVdIESZHO",1);
d=true;
