...
/*
 ...
 Date: 2015-05-13 15:21:40
*/
(function(f){f(function(){var e=f("#ritNotification"),h=f("#ritNotificationBadge"),k=f("#ritNotificationButton"),n=e.find(".ritNotificArea"),t=e.find(".ritNotificInfo"),u=e.find(".ritNotificError"),B=e.find(".ntfImgDependency"),v=e.find(".ntfHelpCnt"),O=e.find(".ntfClose"),P=e.parents(),C=void 0,r=void 0,D=void 0,w=!1,p=!1,E=!1,F=!1,G=!1,x=0,H=0,s=!1,q={};moment.lang("ja",{relativeTime:{future:"%s\u5f8c",past:"%s\u524d",s:"\u6570\u79d2",m:"1\u5206",mm:"%d\u5206",h:"1\u6642\u9593",hh:"%d\u6642\u9593",
d:"1\u65e5",dd:"%d\u65e5",M:"1\u30f6\u6708",MM:"%d\u30f6\u6708",y:"1\u5e74",yy:"%d\u5e74"},weekdays:"\u65e5\u66dc\u65e5 \u6708\u66dc\u65e5 \u706b\u66dc\u65e5 \u6c34\u66dc\u65e5 \u6728\u66dc\u65e5 \u91d1\u66dc\u65e5 \u571f\u66dc\u65e5".split(" ")});var Q=function(a){a=moment(a,"YYYY-MM-DD HH:mm:ss");return 36>moment().diff(a,"hours")?a.fromNow():7>moment().diff(a,"days")?a.format("dddd"):a.format("M\u6708D\u65e5")},A=function(){f.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/get",charset:"utf-8",
callback:"_entf",callbackParameter:"callback",data:{last_id:x,loc_id:r},cache:!1,timeout:5E3,success:function(a,c){var b;F||"undefined"===typeof a.template||(b=a.template.css,"https:"===document.location.protocol&&(b=b.replace(/^http:/,"https:")),document.createStyleSheet?document.createStyleSheet(b):f("head").append('<link rel="stylesheet" type="text/css" href="'+b+'">'),F=!0);if(200===a.status.code||201===a.status.code){s||(s=!0);var d=a.notifications;b={};b.Submit_kind=p?"polling":"init";p||(p=
!0);a.open_last_id>H&&(H=a.open_last_id,y(0));0<a.last_id&&(x=a.last_id);var g=a.badge;b.NoticeNum_badgeCount=g;var l=e.find(".ntfArticle").size()+d.length;if(0===e.find(".ntfProcess").size()&&/^[0-9]{2}$/.test(a.p)){var m=parseInt(new Date/1E3);B.append('<img src="//static.event.notifier.rakuten.co.jp/ntf.gif?p='+a.p+"&t="+m+'" class="ntfProcess" width="0" height="0">')}if(0===l){b=f.tmpl(a.template.empty);I(b);return}m={height:"auto","overflow-y":"visible"};4<l&&(m={height:"448px","overflow-y":"scroll"});
n.css(m);0<d.length&&R(d,a.template);0<g&&(k.hasClass("opened")?J():(d=parseInt(h.text()),l=!1,!0===D&&"undefined"!==typeof a.badge_flash_flg&&(l=a.badge_flash_flg),y(d+g,l)));if("init"===b.Submit_kind||0<parseInt(b.NoticeNum_badgeCount)){g=[];for(d=0;d<a.notifications.length;d++)l={},m="non_rat_key","undefined"!==typeof a.notifications[d].rat_key&&(m=a.notifications[d].rat_key.charAt(0).toUpperCase()+a.notifications[d].rat_key.slice(1)),l.Notification_type=m,l.Notification_id=a.notifications[d].id,
g.push(l),q[a.notifications[d].id]=m;z("get",b,g)}}else 400===a.status.code?(p||(p=!0),s=!1,b=f.tmpl(a.template.login,{login_url:a.login_url}),I(b)):K();"undefined"!==typeof a.rd_open_flg&&!0===a.rd_open_flg&&!1===G&&(G=!0,k.trigger("click"))},error:function(a,c,b){K()}});S()},y=function(a,c){h.text(a);if(0<a){if(!0===c){h.css("filter","inherit");for(var b=0;3>b;b++)h.fadeTo(250,0).fadeTo(250,1)}h.css("display","block")}else h.css("display","none")},S=function(){e.find("abbr.ntfTime").each(function(){var a=
f(this),c=a.attr("original-date");""!==c&&a.text(Q(c))})},R=function(a,c){t.css("display","none");u.css("display","none");50<a.length&&(a=a.slice(a.length-50));for(var b=0;b<a.length;b++){var d=T(a[b],c);"undefined"!==typeof d&&null!==d&&(a[b].highlight?d.prependTo(n).biggerlink({follow:!1}).find("a").bind("click",function(){U(f(this));return!1}):d.prependTo(n).biggerlink({follow:!1}).find("a").bind("click",function(){var a=f(this),b=a.attr("href");if("undefined"===typeof b)return!1;L(a);location.href=
b;return!1}))}n.css("display","block");v.css("display","block")},L=function(a){var c=a.attr("notification-id");a={};var b="non_rat_key";if("undefined"!==typeof c){"undefined"!==typeof q[c]&&(b=q[c]);var d={};d.Notification_type=b;d.Notification_id=c;c=[];c.push(d);z("click",a,c)}},U=function(a){var c=a.attr("notification-id"),b=a.attr("href");"undefined"!==typeof c&&"undefined"!==typeof b&&f.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/click",charset:"utf-8",callback:"_entf",callbackParameter:"callback",
data:{id:c,locId:r},cache:!1,timeout:5E3,success:function(c,e){L(a);location.href=b},error:function(a,c,e){location.href=b}})},J=function(){f.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/open",charset:"utf-8",callback:"_entf",callbackParameter:"callback",data:{last_id:x,locId:r},cache:!1,timeout:5E3,success:function(a,c){201===a.status.code&&A()},error:function(a,c,b){}})},I=function(a){u.css("display","none");n.css("display","none");t.html(a).css("display","block");v.css("display",
"block")},K=function(){p||(n.css("display","none"),t.css("display","none"),v.css("display","none"),u.css("display","block"))},z=function(a,c,b){try{s&&(c.Action=a,c.Notifications=b,RAT.callCostomRequest("Notification",c,403,1))}catch(d){}},T=function(a,c){var b;b=a.template_type.toString();b=100<=a.type?c.template_notification[b]:c.notification[b];return"undefined"===typeof b?null:f.tmpl(b,a)},M=function(a){var c="https:"===document.location.protocol?"https:":"http:";a="1.4626."+a;var b=encodeURIComponent("Event Notification"),
d=encodeURIComponent("Event Notification"),e=encodeURIComponent(document.referrer),f=(new Date).getTime()*Math.random();B.append('<img src="'+(c+"//anz.rd.rakuten.co.jp/p/?i="+a+"&n="+b+"&l="+d+"&r="+e+"&c="+f+"&d=pc")+'">')},N=function(){var a=k.offset(),c={top:0,left:0},b={top:0,left:0};P.each(function(){if("relative"==f(this).css("position")){var a=f("body");c=a.offset();b=a.position();return!1}});var d=a.top+k.height()-c.top+b.top+10,a=a.left+k.width()/2-e.width()/2-c.left+b.left;e.css({top:d+
"px",left:a+"px"})};f(window).bind("resize",N);(function(a){var c=e.attr("pollingduration");C="undefined"!==typeof c?parseInt(c):3E4;c=e.attr("locid");r="undefined"!==typeof c?c:"1";D="true"===e.attr("badgeflash")?!0:!1;e.hover(function(){w=!0},function(){w=!1});f("body").bind("click",function(){w||(k.removeClass("opened"),e.css("display","none"))});a()})(function(){h.text("0");O.bind("click",function(){k.removeClass("opened");e.css("display","none")});k.bind("click",function(){var a=f(this);if(a.hasClass("opened"))e.css("display",
"none"),a.removeClass("opened");else{N();var c={};c.ButtonClick_existBadge=parseInt(h.text());var b=[],d;for(d in q){var g={};g.Notification_type=q[d];g.Notification_id=d;b.push(g)}z("open",c,b);e.css("display","block");a.addClass("opened");E||(E=!0,0<e.find(".ntfArticle").size()?M("580257"):M("580256"));0<parseInt(h.text())&&(y(0),J())}return!1});k.find("a").attr("href","#");A();setInterval(function(){A()},C)})})})(jQuery);
