...
d.exports=a.extend({init:function(){this.optionsSpec={delay:{name:"delay",type:Number,defaultValue:300},modelId:{name:"sb-id",type:Number,required:true},gpOnly:{name:"gp-only",type:Boolean,defaultValue:undefined},minLength:{name:"minlength",type:Number,defaultValue:2},ssf:{name:"ssf",type:Number,defaultValue:0}};
...
}if(!l.__upa__&&l.city.length===0&&(!l.bbtoollocations||l.bbtoollocations.length===0)&&(!k||!l.theme||l.theme.length===0)){m(new Error("service-booking-no-results"),l)
...
n.position=o;
n._ef=n._ef||[];
n._ef.push({name:"dest_id",value:n.dest_id});
n._ef.push({name:"dest_type",value:n.dest_type});
...
n.position=o;
n._ef=n._ef||[];
n._ef.push({name:"dest_id",value:n.place_id});
n._ef.push({name:"dest_type",value:n.dest_type});
n._ef.push({name:"place_id",value:n.place_id});
n._ef.push({name:"place_id_lat",value:n.place_id_lat});
n._ef.push({name:"place_id_lon",value:n.place_id_lon});
n._ef.push({name:"bbtoollocation",value:"1"});
return n
}).concat(l.results)
}if(l.theme){l.theme=l.theme.map(function(n,o){n._ef=n._ef||[];
n._ef.push({name:"dest_id",value:n.dest_id});
n._ef.push({name:"dest_type",value:n.dest_type});
return n
});
