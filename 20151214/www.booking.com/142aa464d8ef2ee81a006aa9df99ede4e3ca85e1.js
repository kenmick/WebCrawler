...
if(n.type!=="valid"||m.type!=="valid"){return false
}return(k.calendar2.today()>n.dateObject_&&k.calendar2.today()>m.dateObject_)
...
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(f,g){var d=f.track("MWCMcKNBaCFJVKe");
if(d===0){var e="PAWSUKaVeDdEAZLbMKXe";
var c=f.track(e);
if(c){g.on("beforeajax",function(h,j){j.e_arabic=c
})
}g.on("afterajax",function(h,j){if(j&&j.__deb__&&(j.__deb__.s&32)==32){f.stage(e,1)
}})
}});
