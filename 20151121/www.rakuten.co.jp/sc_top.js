...
(function(_W, _D, _N, _L) {
    ...
    SC.setParameter = function() {
        try {
            var s_getKw, _s_UADesign, sc_gender_result, genderAgeGetChar, sc_betaInfo;
    ...
    SC.addJavaScript = function() {
        ...
        _W.sc_searchBox = function(partsname, option) {
            ...
            s.eVar13 = 'Rakuten Top: SearchBox' + option + "[" + _ua + "]";
    ...
    SC.addJquery = function() {
        try {
            ...
            //SP - weblip balloon banner close button click
    ...
    }; SC.reqSiteCatalyst(); SC.addEvent(_W, 'load', SC.addJavaScript); SC.addEvent(_W, 'load', SC.addJquery);
