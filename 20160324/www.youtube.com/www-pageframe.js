...
a=on(c,W,"gapi."+wj,l);l.push.apply(l,W);en("ml0",W,Q);b.sync||Pm.___gapisync?zn(a):An(a)}else ga[y](Sm)}else d(W)&&e&&e()}
...
function po(a){li(128,!0);li(129,a);Kf("PREF",mi(),63072E3,"/");Co=a}
...
gp=new hp;function kp(a,b,c,d,e){this.c=a;this.j=c;this.D=d;this.C=e||1;this.l=45E3;this.A=new Ik(this);this.f=new Zo;$o(this.f,250)}
g=kp.prototype;g.Za=null;g.wa=!1;g.kb=null;g.wc=null;g.yb=null;g.jb=null;g.Na=null;g.Sa=null;g.ab=null;g.W=null;g.Bb=0;g.xa=null;g.Wb=null;g.$a=null;g.ub=-1;g.zd=!0;g.Wa=!1;g.hc=0;g.Pb=null;var lp={},mp={};g=kp.prototype;g.setTimeout=function(a){this.l=a};
function np(a,b,c){a.jb=1;a.Na=qg(b.clone());a.ab=c;a.B=!0;op(a,null)}
function pp(a,b,c,d,e){a.jb=1;a.Na=qg(b.clone());a.ab=null;a.B=c;e&&(a.zd=!1);op(a,d)}
function op(a,b){a.yb=z();qp(a);a.Sa=a.Na.clone();og(a.Sa,"t",a.C);a.Bb=0;a.W=a.c.cc(a.c.Ab()?b:null);0<a.hc&&(a.Pb=new bp(v(a.Fd,a,a.W),a.hc));a.A.Ka(a.W,"readystatechange",a.hf);var c=a.Za?Eb(a.Za):{};a.ab?(a.Wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.W.send(a.Sa,a.Wb,a.ab,c)):(a.Wb="GET",a.zd&&!od&&(c.Connection="close"),a.W.send(a.Sa,a.Wb,null,c));a.c.va(1)}
g.hf=function(a){a=a.target;var b=this.Pb;b&&3==rp(a)?b.Zd():this.Fd(a)};
g.Fd=function(a){try{if(a==this.W)a:{var b=rp(this.W),c=this.W.l,d=this.W.getStatus();if(P&&!zd(10)||od&&!yd("420+")){if(4>b)break a}else if(3>b||3==b&&!kd&&!sp(this.W))break a;this.Wa||4!=b||7==c||(8==c||0>=d?this.c.va(3):this.c.va(2));tp(this);var e=this.W.getStatus();this.ub=e;var f=sp(this.W);(this.wa=200==e)?(4==b&&up(this),this.B?(vp(this,b,f),kd&&this.wa&&3==b&&(this.A.Ka(this.f,"tick",this.ff),this.f.Qa())):wp(this,f),this.wa&&!this.Wa&&(4==b?this.c.Nb(this):(this.wa=!1,qp(this)))):(this.$a=
...
g.ff=function(){var a=rp(this.W),b=sp(this.W);this.Bb<b.length&&(tp(this),vp(this,a,b),this.wa&&4!=a&&qp(this))};
...
g.Ye=function(a){Bp(v(this.Xe,this,a),0)};
g.Xe=function(a){this.Wa||(tp(this),wp(this,a),qp(this))};
g.qd=function(a){Bp(v(this.We,this,a),0)};
g.We=function(a){this.Wa||(up(this),this.wa=a,this.c.Nb(this),this.c.va(4))};
g.cancel=function(){this.Wa=!0;up(this)};
function qp(a){a.wc=z()+a.l;Cp(a,a.l)}
function Cp(a,b){if(null!=a.kb)throw Error("WatchDog timer not null");a.kb=Bp(v(a.Ze,a),b)}
function tp(a){a.kb&&(m.clearTimeout(a.kb),a.kb=null)}
g.Ze=function(){this.kb=null;var a=z();0<=a-this.wc?(2!=this.jb&&this.c.va(3),up(this),this.$a=2,xp(),yp(this)):Cp(this,this.wc-a)};
function yp(a){a.c.Wc()||a.Wa||a.c.Nb(a)}
function up(a){tp(a);vc(a.Pb);a.Pb=null;a.f.stop();a.A.removeAll();if(a.W){var b=a.W;a.W=null;Dp(b);b.dispose()}a.xa&&(a.xa=null)}
function wp(a,b){try{a.c.kd(a,b),a.c.va(4)}catch(c){}}
...
;function Hp(a){this.c=a;this.f=new Yo(null,!0)}
g=Hp.prototype;g.fc=null;g.ka=null;g.Qb=!1;g.Cd=null;g.Eb=null;g.jc=null;g.gc=null;g.oa=null;g.Ja=-1;g.tb=null;g.ob=null;g.connect=function(a){this.gc=a;a=Ip(this.c,null,this.gc);xp();this.Cd=z();var b=this.c.D;null!=b?(this.tb=b[0],(this.ob=b[1])?(this.oa=1,Jp(this)):(this.oa=2,Kp(this))):(og(a,"MODE","init"),this.ka=new kp(this,0,void 0,void 0,void 0),this.ka.Za=this.fc,pp(this.ka,a,!1,null,!0),this.oa=0)};
function Jp(a){var b=Ip(a.c,a.ob,"/mail/images/cleardot.gif");qg(b);Ep(b.toString(),5E3,v(a.Sd,a),3,2E3);a.va(1)}
g.Sd=function(a){if(a)this.oa=2,Kp(this);else{xp();var b=this.c;b.ua=b.Oa.Ja;Lp(b,9)}a&&this.va(2)};
function Kp(a){var b=a.c.R;if(null!=b)xp(),b?(xp(),Mp(a.c,a,!1)):(xp(),Mp(a.c,a,!0));else if(a.ka=new kp(a,0,void 0,void 0,void 0),a.ka.Za=a.fc,b=a.c,b=Ip(b,b.Ab()?a.tb:null,a.gc),xp(),!P||zd(10))og(b,"TYPE","xmlhttp"),pp(a.ka,b,!1,a.tb,!1);else{og(b,"TYPE","html");var c=a.ka;a=!!a.tb;c.jb=3;c.Na=qg(b.clone());Ap(c,a)}}
g.cc=function(a){return this.c.cc(a)};
g.Wc=function(){return!1};
g.kd=function(a,b){this.Ja=a.ub;if(0==this.oa)if(b){try{var c=this.f.parse(b)}catch(d){c=this.c;c.ua=this.Ja;Lp(c,2);return}this.tb=c[0];this.ob=c[1]}else c=this.c,c.ua=this.Ja,Lp(c,2);else if(2==this.oa)if(this.Qb)xp(),this.jc=z();else if("11111"==b){if(xp(),this.Qb=!0,this.Eb=z(),c=this.Eb-this.Cd,!P||zd(10)||500>c)this.Ja=200,this.ka.cancel(),xp(),Mp(this.c,this,!0)}else xp(),this.Eb=this.jc=z(),this.Qb=!1};
g.Nb=function(){this.Ja=this.ka.ub;if(this.ka.wa)0==this.oa?this.ob?(this.oa=1,Jp(this)):(this.oa=2,Kp(this)):2==this.oa&&(a=!1,(a=!P||zd(10)?this.Qb:200>this.jc-this.Eb?!1:!0)?(xp(),Mp(this.c,this,!0)):(xp(),Mp(this.c,this,!1)));else{0==this.oa?xp():2==this.oa&&xp();var a=this.c;a.ua=this.Ja;Lp(a,2)}};
...
this.ga&&(this.c.responseType=this.ga);zb(this.c)&&(this.c.withCredentials=this.la);try{Tp(this),0<this.C&&(this.O=Up(this.c),To(Qp(this,"Will abort after "+this.C+"ms if incomplete, xhr2 "+this.O)),this.O?(this.c.timeout=this.C,this.c.ontimeout=v(this.Sc,this)):this.L=ap(this.Sc,this.C,this)),To(Qp(this,"Sending request")),this.D=!0,this.c.send(a),this.D=!1}catch(f){To(Qp(this,"Send error: "+f.message)),Rp(this,f)}};
function Up(a){return P&&yd(9)&&ha(a.timeout)&&p(a.ontimeout)}
function Sp(a){return"content-type"==a.toLowerCase()}
g.Sc=function(){"undefined"!=typeof aa&&this.c&&(this.B="Timed out after "+this.C+"ms, aborting",this.l=8,Qp(this,this.B),Lk(this,"timeout"),Dp(this,8))};
...
;function Yp(a,b,c){this.C=a||null;this.c=1;this.f=[];this.A=[];this.l=new Yo(null,!0);this.D=b||null;this.R=null!=c?c:null}
function Zp(a,b){this.c=a;this.map=b;this.context=null}
g=Yp.prototype;g.rb=null;g.da=null;g.U=null;g.ec=null;g.Fb=null;g.Dc=null;g.Hb=null;g.vb=0;g.re=0;g.ca=null;g.Pa=null;g.Ea=null;g.Ya=null;g.Oa=null;g.Vb=null;g.eb=-1;g.Zc=-1;g.ua=-1;g.sb=0;g.bb=0;g.Xa=8;var $p=new Kk;function aq(a){jk.call(this,"statevent",a)}
...
function iq(a,b){if(0==a.c)throw Error("Invalid operation: sending map when state is closed");a.f.push(new Zp(a.re++,b));2!=a.c&&3!=a.c||jq(a)}
g.Wc=function(){return 0==this.c};
function jq(a){a.da||a.Pa||(a.Pa=Bp(v(a.od,a),0),a.sb=0)}
g.od=function(a){this.Pa=null;kq(this,a)};
...
function fq(a,b){if(a.ca){var c=a.ca.Pc(a);c&&sb(c,function(a,c){ng(b,c,a)})}}
...
return c.join("&")}
function nq(a){a.U||a.Ea||(a.B=1,a.Ea=Bp(v(a.nd,a),0),a.bb=0)}
function oq(a){if(a.U||a.Ea||3<=a.bb)return!1;a.B++;a.Ea=Bp(v(a.nd,a),pq(a,a.bb));a.bb++;return!0}
g.nd=function(){this.Ea=null;this.U=new kp(this,0,this.j,"rpc",this.B);this.U.Za=null;this.U.hc=0;var a=this.Dc.clone();ng(a,"RID","rpc");ng(a,"SID",this.j);ng(a,"CI",this.Vb?"0":"1");ng(a,"AID",this.eb);fq(this,a);if(!P||zd(10))ng(a,"TYPE","xmlhttp"),pp(this.U,a,!0,this.Hb,!1);else{ng(a,"TYPE","html");var b=this.U,c=!!this.Hb;b.jb=3;b.Na=qg(a.clone());Ap(b,c)}};
function Mp(a,b,c){a.Vb=c;a.ua=b.Ja;a.Td(1,0);a.Fb=Ip(a,null,a.ec);jq(a)}
g.kd=function(a,b){if(0!=this.c&&(this.U==a||this.da==a))if(this.ua=a.ub,this.da==a&&3==this.c)if(7<this.Xa){var c;try{c=this.l.parse(b)}catch(f){c=null}if(ea(c)&&3==c.length)if(0==c[0])a:{if(!this.Ea){if(this.U)if(this.U.yb+3E3<this.da.yb)hq(this),this.U.cancel(),this.U=null;else break a;oq(this);xp()}}else this.Zc=c[1],0<this.Zc-this.eb&&37500>c[2]&&this.Vb&&0==this.bb&&!this.Ya&&(this.Ya=Bp(v(this.se,this),6E3));else Lp(this,11)}else"y2f%"!=b&&Lp(this,11);else if(this.U==a&&hq(this),!/^[\s\xa0]*$/.test(b)){c=
this.l.parse(b);ea(c);for(var d=0;d<c.length;d++){var e=c[d];this.eb=e[0];e=e[1];2==this.c?"c"==e[0]?(this.j=e[1],this.Hb=e[2],e=e[3],null!=e?this.Xa=e:this.Xa=6,this.c=3,this.ca&&this.ca.Ic(this),this.Dc=Ip(this,this.Ab()?this.Hb:null,this.ec),nq(this)):"stop"==e[0]&&Lp(this,7):3==this.c&&("stop"==e[0]?Lp(this,7):"noop"!=e[0]&&this.ca&&this.ca.Hc(this,e),this.bb=0)}}};
g.se=function(){null!=this.Ya&&(this.Ya=null,this.U.cancel(),this.U=null,oq(this),xp())};
function hq(a){null!=a.Ya&&(m.clearTimeout(a.Ya),a.Ya=null)}
g.Nb=function(a){var b;if(this.U==a)hq(this),this.U=null,b=2;else if(this.da==a)this.da=null,b=1;else return;this.ua=a.ub;if(0!=this.c)if(a.wa)1==b?(z(),Lk($p,new bq($p,a.ab?a.ab.length:0)),jq(this),this.A.length=0):nq(this);else{var c=a.$a,d;if(!(d=3==c||7==c||0==c&&0<this.ua)){if(d=1==b)this.da||this.Pa||1==this.c||2<=this.sb?d=!1:(this.Pa=Bp(v(this.od,this,a),pq(this,this.sb)),this.sb++,d=!0);d=!(d||2==b&&oq(this))}if(d)switch(c){case 1:Lp(this,5);break;case 4:Lp(this,10);break;case 3:Lp(this,
...
function Lp(a,b){if(2==b||9==b){var c=null;a.ca&&(c=null);var d=v(a.rf,a);c||(c=new $f("//www.google.com/images/cleardot.gif"),qg(c));Fp(c.toString(),1E4,d)}else xp();qq(a,b)}
g.rf=function(a){a?xp():(xp(),qq(this,8))};
function qq(a,b){a.c=0;a.ca&&a.ca.Gc(a,b);gq(a);eq(a)}
...
function rq(){}
g=rq.prototype;g.Ic=function(){};
g.Hc=function(){};
g.Gc=function(){};
g.ac=function(){};
g.Pc=function(){return{}};function sq(a,b){Zo.call(this);this.B=0;if(ia(a))b&&(a=v(a,b));else if(a&&ia(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.D=a;xk(this,"tick",v(this.C,this));this.stop();$o(this,5E3+2E4*Math.random())}
A(sq,Zo);sq.prototype.C=function(){if(500<this.c){var a=this.c;24E4>2*a&&(a*=2);$o(this,a)}this.D()};
sq.prototype.Qa=function(){sq.H.Qa.call(this);this.B=z()+this.c};
sq.prototype.stop=function(){this.B=0;sq.H.stop.call(this)};function tq(a,b){this.sa=a;this.A=b;this.j=new H;this.f=new sq(this.Bf,this);this.c=null;this.K=!1;this.B=null;this.R="";this.D=this.l=0;this.C=[]}
A(tq,rq);g=tq.prototype;g.subscribe=function(a,b,c){return this.j.subscribe(a,b,c)};
...
function uq(a,b){a.D=b||0;a.f.stop();a.c&&(3==a.c.c&&kq(a.c),dq(a.c));a.D=0}
...
g.Ic=function(){var a=this.f;a.stop();$o(a,5E3+2E4*Math.random());this.B=null;this.l=0;if(this.C.length){a=this.C;this.C=[];for(var b=0,c=a.length;b<c;++b)iq(this.c,a[b])}this.F("handlerOpened")};
...
g.Hc=function(a,b){if("S"==b[0])this.R=b[1];else if("gracefulReconnect"==b[0]){var c=this.f;c.stop();$o(c,500);this.f.Qa();dq(this.c)}else this.F("handlerMessage",new Wo(b[0],b[1]))};
