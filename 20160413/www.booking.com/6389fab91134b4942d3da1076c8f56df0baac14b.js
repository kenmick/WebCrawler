...
c.prototype.fixHotelUrl=function(h){_i_("158bb:648");if(B.atlas.getVariant("ebcBUcQIFcPXe")||B.atlas.getVariant("ebcOQQGAdQJKe")||B.atlas.getVariant("ebcfEFQaQFFaO")||B.atlas.getVariant("ebcfESAcCJUCTDCHT")){return _r_();
...
}function z(r){_i_("158bb:474");if((y.MJ(y.ATLAS_ENV("highlightedHotel"))&&y.MJ(y.ATLAS_STAGE("ebcOLUTBQMQAbDPNOSdYKe")))){}r+=b[4];
