...
G.unshift({b_genius_iconfont:d[17],b_type:d[127]});
L();
G.shift();
H+=d[5]
}H+=d[1]
...
G.unshift({b_classname:d[21],b_color:d[20],b_size:d[3],b_tooltip:d[4]});
K();
G.shift();
...
G.unshift({b_tooltip:d[4],b_ge_discount:d[39],b_ge_freebies:d[39],b_classname:d[128]});
o();
G.shift();
