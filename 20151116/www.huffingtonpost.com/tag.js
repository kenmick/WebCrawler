...
define("js/fo/util/modifier", [ "require", "exports", "omnitag/gostructs", "util/str", "merger", "util/context", "lib/jquery" ], function(e, t, n, a, i, r, o) {
    ...
    function c(e, t, n, i, o) {
        var s, c = function() {
            ...
            clearTimeout(s), t.data.indexOf("error") > -1 ? o() : i(t.data.substring(n.length)), 
    ...
    function i(e, n, i, a, o, d) {
        ...
        switch (n.Kind) {
          ...
          case t.ResourceImageKind.EXTERNAL:
            var l = r.Untaint(n.Data.External.Url);
            l = l.replace(/\[height\]/i, "" + a), l = l.replace(/\[width\]/i, "" + i), u = r.Untaint(e.DynamicPrefix) + "/native/preview/image?url=" + r.EncodeURIComponent(l);
            break;

          default:
            throw new Error("Unknown ResourceImageKind: " + n.Kind.toString());
        }
        return "undefined" == typeof d && (d = !1), d ? (u += "&ztop=0.3", u += "&zleft=0.3", 
        u += "&zwidth=0.3", u += "&zheight=0.3", u += "&width=" + i, u += "&height=" + a, 
...
define("js/fo/native/iframe/element/material/landing_iframe", [ "require", "exports", "util/str", "util/redir", "omnitag/gostructs", "elements", "notifications", "lib/jquery", "util/informer" ], function(t, e, r, o, n, i, s, a, l) {
    ...
    var d = a.jQuery, h = .75, f = function(t) {
        ...
        return __extends(e, t), e.prototype.GetComponentName = function() {
            ...
            var e = this;
            if (!this.secondaryUrlsLoopStarted || "once" == this.secondaryUrlsLoopBoundMode && 2 == this.secondaryUrlsLoopBoundValue) return void (this.secondaryUrlsLoopStarted = !1);
            var o = t.shift();
            t.push(o), this.elIframe.attr("src", r.Untaint(o)), this.secondaryUrlsLoopBoundValue++, 
            this.secondaryUrlsLoopDone || (this.secondaryUrlsLoopDone = !0);
            var n = (this.secondaryUrlsLoopBoundValue - 1) / t.length > 1 ? Math.floor(4 * Math.random()) + 1 : 1;
...
define("js/fo/native/integration/card/integration", [ "require", "exports", "util/str", "util/resource", "util/informer", "omnitag/gostructs", "common/base", "lib/jquery", "card_variables", "native_card_css" ], function(e, t, n, i, r, o, a, s, l, c) {
    var d, g, h, m, f, C, p, u, v = s.jQuery, w = "ayl_native_card_", _ = function(e) {
        function t() {
            e.apply(this, arguments), this.Uid = n.Untaint(this.Config.Attempt);
        }
        return __extends(t, e), t.prototype.insertTemplate = function() {
            var e = document.createElement("div");
            d = e.id = w + n.EscapeHTML(this.Config.Attempt);
            var t = document.createElement("div");
            t.className = w + "container";
            var r = document.createElement("div");
            r.className = w + "legal", r.innerHTML = n.EscapeHTML(this.Config.Legal);
            var a = document.createElement("div");
            a.className = w + "logo", a.style.backgroundImage = "url(" + i.GetUrlDynamicImage(this.Config, this.Config.Content.Preview.Thumbnail.Image, 360, 360) + ")";
            var s = document.createElement("div");
            s.className = w + "txt";
            var l = document.createElement("div");
            l.className = w + "title", l.innerHTML = n.EscapeHTML(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.TITLE));
            var c = document.createElement("div");
            if (c.className = w + "desc", c.innerHTML = n.EscapeHTML(n.ChunkText(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.DESCRIPTION), 150)), 
            s.appendChild(l), s.appendChild(c), this.Config.Content.Preview.Branding) {
                var g = document.createElement("div");
                if (g.className = w + "image", g.style.backgroundImage = "url(" + i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[0]) + ")", 
                this.Config.Content.Preview.Branding.Images.length > 1) {
                    var h = document.createElement("div");
                    h.className = w + "image_carousel";
                    var m = document.createElement("ul");
                    m.className = w + "carousel";
                    for (var f = this.Config.Content.Preview.Branding.Images, C = 0; C < f.length; C++) {
                        var p = document.createElement("li");
                        p.className = w + "carousel_li";
                        var u = document.createElement("img");
                        u.className = w + "carousel_image", u.src = i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[C]), 
                        p.appendChild(u), m.appendChild(p);
                    }
                    h.appendChild(m);
                    var v = document.createElement("div");
                    v.className = w + "left_arrow";
                    var _ = document.createElement("div");
                    _.className = w + "right_arrow", this.isDesktop() && (h.appendChild(v), h.appendChild(_));
                }
            }
            var E = document.createElement("div");
            E.className = w + "call";
            var I = document.createElement("div");
            I.className = w + "call_action", I.innerHTML = n.EscapeHTML(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.CALLTOACTION)), 
            E.appendChild(I);
            var T = document.createElement("div");
            T.className = w + "sponsor";
            var y = document.createElement("div");
            return y.className = w + "sponsor_txt", y.innerHTML += n.EscapeHTML(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.SPONSOR)), 
            this.Config.Content.Preview.Sponsor ? (T.appendChild(y), T.innerHTML += this.getCredit()) : (T.innerHTML += this.getCredit(), 
            y.setAttribute("style", "padding-left:3px"), T.appendChild(y)), t.appendChild(r), 
            t.appendChild(a), t.appendChild(s), this.Config.Content.Preview.Branding && (this.Config.Content.Preview.Branding.Images.length > 1 ? t.appendChild(h) : t.appendChild(g)), 
            t.appendChild(E), t.appendChild(T), e.appendChild(t), e;
            ...
            var e = v('<style type="text/css"></style>'), t = e[0], i = {
                Uid: this.Config.Attempt,
            ...
            }, r = c.Template(l.New(i));
            if (t.styleSheet) t.styleSheet.cssText = r; else {
                var o = document.createTextNode(r);
                t.appendChild(o);
            }
            return v(t).prependTo(v("head")), t;
            ...
            function t(e) {
                if (a) {
                    ...
                    o > 0 ? u < r.length - 1 && (u++, i.sliderAction()) : u > 0 && (u--, i.sliderAction()), 
            ...
            m = v("." + w + "carousel_li"), f = v("." + w + "image_carousel").width(), C = m.outerWidth(), 
            p = (f - C) / 2, this.sliderMove(p), g = v("#" + d), n = 0;
            for (var o = 0; o < r.length; o++) m[o].addEventListener("touchstart", e, !1), m[o].addEventListener("touchmove", t, !1);
            var a = null, s = null;
        }, t.prototype.sliderMove = function(e) {
            h = v("." + w + "carousel"), h.css({
            ...
            this.UITrigger(o.NativeUITriggerKind.CLICK);
        }, t.prototype.showArrows = function(e) {
            var t = v(this.mainContentElement), n = this.Config.Content.Preview.Branding.Images;
            m = v("." + w + "carousel_li"), C = m.outerHeight(), t.find("." + w + "left_arrow").css("height", C), 
            t.find("." + w + "right_arrow").css("height", C), e ? (0 != u ? t.find("." + w + "left_arrow").addClass("show_arrow") : t.find("." + w + "left_arrow").removeClass("show_arrow"), 
            u < n.length - 1 ? t.find("." + w + "right_arrow").addClass("show_arrow") : t.find("." + w + "right_arrow").removeClass("show_arrow")) : (t.find("." + w + "left_arrow").removeClass("show_arrow"), 
            t.find("." + w + "right_arrow").removeClass("show_arrow"));
            ...
            var n = v(this.mainContentElement);
            n.find("." + w + "logo").click(function() {
                e.clicAction();
            }), n.find("." + w + "call_action").click(function() {
                e.clicAction();
            }), n.find("." + w + "image").click(function() {
                e.clicAction();
            }), n.find("." + w + "carousel_li").click(function() {
                e.clicAction();
            }), n.find("." + w + "title").click(function() {
                e.clicAction();
            }), n.find("." + w + "desc").click(function() {
                e.clicAction();
            }), n.find("." + w + "image_carousel").mouseover(function() {
                e.showArrows(!0);
            }), n.find("." + w + "image_carousel").mouseout(function() {
                e.showArrows(!1);
            }), v(window).on("resize", function() {
                e.sliderAction();
            }), n.find("." + w + "left_arrow").click(function() {
                0 != u && (u--, e.sliderAction(), n.find("." + w + "right_arrow").addClass("show_arrow")), 
                0 == u && n.find("." + w + "left_arrow").removeClass("show_arrow");
            }), n.find("." + w + "right_arrow").click(function() {
                u < t.length - 1 && (u++, e.sliderAction(), n.find("." + w + "left_arrow").addClass("show_arrow")), 
                u == t.length - 1 && n.find("." + w + "right_arrow").removeClass("show_arrow");
            });
        }, t.prototype.Execute = function() {
            ...
            if (document.body.innerHTML.indexOf(e) >= 0) r.Snitch(r.NOTICE, "Integration already inserted"); else {
                var t = this.insertStyle(), i = this.insertTemplate(), a = this.Config.IntegrationConfig.Card.Insertion, s = v(n.Untaint(this.Config.IntegrationConfig.Card.Selector.Css));
                switch (a) {
                  case o.IntegrationInsertionKind.BEFORE:
                    s.before(i);
                    break;

                  case o.IntegrationInsertionKind.PREPEND:
                    s.prepend(i);
                    break;

                  case o.IntegrationInsertionKind.APPEND:
                    s.append(i);
                    break;

                  case o.IntegrationInsertionKind.AFTER:
                    s.after(i);
                    break;

                  case o.IntegrationInsertionKind.REPLACE:
                    s.replaceWith(i);
                    break;

                  default:
                    throw new Error("Unknown IntegrationInsertionKind " + a);
                }
                v(i).before(v(e)), this.mainContentElement = i, this.injectedNodes = [ i, t ], this.Config.Content.Preview.Branding && this.Config.Content.Preview.Branding.Images.length > 1 && this.initSlider(), 
                this.actionHandler();
            }
            this.AfterExecute();
        }, t;
