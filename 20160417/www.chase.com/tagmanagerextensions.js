...
var C=C||"";
var F="rf15-qa";
if(CHASE.TagManager.clientVars.env=="prod"){F="rf15"
}var H="https://"+F+".chase.com/meta?_o={xpo.OrgID}";
H=H+"&_t={xpo.AppID}";
...
var I="rf15-qa";
if(CHASE.TagManager.clientVars.env=="prod"){I="rf15"
}K="https://"+I+".chase.com/wsb/15629/poe/59242226?_u=[ECI]&Debug=false&Test=false&ContentType=application/json&TransactionID=eee-444";
