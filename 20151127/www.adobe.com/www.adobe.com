...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <script type="text/javascript" src="dtagent624_bxjpr23_1057.js" data-dtconfig="rid=RID_2418|rpid=-1380406066|domain=adobe.com|tp=500,50,3|cors=1|bandwidth=300_m|reportUrl=https://www.adobe.com/dynaTraceMonitor"></script><link rel="icon" href="https://wwwimages2.adobe.com/include/img/favicon.ico" type="image/x-icon">
...
<main class="lobby">
	...
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-bf2015-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="0 0" data-background-mobile-position="50% 50%" data-seed-background>
...
<p>Our best deal on Creative Cloud starts now. Itâs everything you need to create whatever you want, wherever you are. The latest versions of your favorite desktop tools. Great new mobile apps. Adobe Stock and all your assets at your fingertips. Save through November 27.</p>
...
<ul>
    ...
    <figcaption class="align-end grid-offset-2 inverse">
        <section><h2>
