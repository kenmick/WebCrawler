...
}}}},_renderItem:function(n,x,A,t){var p=this;
var y=false;
var q="";
var k=", ";
var h=0;
x.position=A;
x.array_length=t;
if(x.labels!=null&&typeof(x.labels)!="undefined"){h=x.labels.length
}if(x.cjk){y=true
}if(typeof(x.labels)!="undefined"&&(booking.env.b_lang==="zh"||booking.env.b_lang==="xt"||booking.env.b_lang==="ja"||booking.env.b_lang==="ko")){y=true
}if(typeof(x.labels)!="undefined"&&(x.lc==="zh"||x.lc==="xt"||x.lc==="ja"||x.lc==="ko")){y=true;
x.labels.forEach(function(C,D){if(D===h-1){k=""
}if(C.hl){q=q+"<strong>"+C.text+k+"</strong>"
}else{q=q+C.text+k
}})
}else{q=x.label_highlighted||x.label
}var l=q,r="",d="",s="",w="",e="",g=x.photo||"";
if(x.header){r='<span class="autocomplete_header autocomplete_h_'+x.dest_type+'" >'+booking.env.autocomplete_categories[x.header]+"</span>";
d=(x.first)?"":' style="border-top: 1px solid #CCC;"';
s+=(x.first)?"":"first-in-group"
}if(x.nr_hotels_label&&x.nr_hotels_label.length){var z="text-align: left; display: inline;";
if(booking.env.rtl==1){z+=" direction: rtl; unicode-bidi: embed;"
}e='<span class="label" style="position: static;"><span class="property-counter" style="'+z+'">';
if(booking.env.rtl!=1&&x.rtl==1){e+='<span style="visibility:hidden;margin-left:-4px;">i</span>'
}var j=x.nr_hotels_label;
if(x.dest_type=="hotel"){e+="("+j+")"
}else{if(x.nr_hotels==0&&x.nr_hotels_25>0){e+='<span class="ac_prop_nearby">('+booking.env.autocomplete_counter_label+")</span>"
}else{e=""
}}e+="</span></span>"
}var o="";
if(x.dest_type=="theme"&&x.additional_label){o='<span class="label" style="position: static;color:#888;">&nbsp;<span style="direction: rtl; text-align: left; display: inline;">'+x.additional_label+"</span></span>"
}var v='<i class="autocomplete_icons autocomplete_'+x.dest_type+'"></i>';
if(y){var f='<span class="ac-hl-cjk-wrapper">'
}else{var f="<span>"
}l=f+l+e+o+"</span>"+v;
w='class="partition_item partition_item_'+x.dest_type;
if(x.dest_type==="theme"){w+=" ac_item_theme"
}w+='"';
popular_ufi_exp_hash="PVdIZKZPHcaUSfCSRBRT";
result=b('<li class="'+s+'"'+d+"></li>").data("item.autocomplete",x).append(b("<a "+w+">"+l+"</a>"));
...
function u(C,D){return D.indexOf(C)>-1
}var m=booking.jstmpl.translations("search_top_50_badge");
var i=["-2601889","-1456928","-372490","-126693","-782831","-1746443","-390625","20088325","-2140479","-553173","-755070","-121726","-3414440","-1995499","-1829149","-246227","20079110","-2167973","-73635","-2960561","-1353149","-850553","-117543","-2996338","-1955538","-1603135","-1785434","-132007","-2403010","20014181","-534433","-1502554","-2595386","-1771148","-3096949","-2745636","20023488","20015732","-1586844","-510625","-671824","-814876","-2602512","-782066","-2524279","-666610","-402849","-979186","-1454990","-2637882"];
if(u(x.dest_id,i)){B.track.stage(popular_ufi_exp_hash,2);
result=b('<li class="'+s+'"'+d+"></li>").data("item.autocomplete",x).append(b("<a "+w+">"+l+"<strong class='ac_popular_ufi' style='display:inline-block;background-color:#55AF32;color:white;padding: 1px 5px;border-radius:3px;margin-left:5px;font-size:0.9em;'>"+m+"</strong></a>"))
