    ...
    <h2 class="module__title">&nbsp;</h2>
     ...
     <div class="module__content"> <div class="container"> <div class="editors-picks"> <ul class="media-list media-list--fixed-height layout--featured">         
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/future/story/20151026-is-beer-better-or-worse-for-you-than-wine"
                                  rev="editors-picks|headline" >
                                                            Beer vs wine â which is better?                                                    </a>
                    </h3>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/35/xz/p035xz4c.jpg" data-alt="Youâre either hardwired to be an explorer or youâre not. Which one are you?"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Youâre either hardwired to be an explorer or youâre not. Which one are you?" /></div></div>                </div>
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20151022-youre-either-an-explorer-or-youre-not-which-one-are-you"
                                  rev="editors-picks|headline" >
                                            ...
                                            <p class="media__summary">
                                                            Youâre either hardwired to be an explorer or youâre not. Which one are you?                                                    </p>
     ...
     <div class="module__content"> <div class="container"> <div class="more-bbc"> <ul class="media-list media-list--fixed-height layout--featured">         
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/36/24/p03624ns.jpg" data-alt="This man found his true calling in the stacks of Tokyoâs book town"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="This man found his true calling in the stacks of Tokyoâs book town" /></div></div>                </div>
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20151023-an-unlikely-spot-for-180-bookstores"
                                  rev="more-bbc|headline" >
                                            ...
                                            <p class="media__summary">
                                                            This man found his true calling in the stacks of Tokyoâs book town                                                    </p>
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/35/yb/p035ybtp.jpg" data-alt="Done a great job? Hereâs how to promote yourself without alienating people"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Done a great job? Hereâs how to promote yourself without alienating people" /></div></div>                </div>
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20151023-how-to-show-off-without-making-colleagues-angry"
                                  rev="more-bbc|headline" >
                                            ...
                                            <p class="media__summary">
                                                            Done a great job? Hereâs how to promote yourself without alienating people                                                    </p>
