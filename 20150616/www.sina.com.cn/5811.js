...
window._AdSameObj_CY2698.fc = function(cmd, args) {
	...
	case "replay":
		if(_as_bro.isChrome()){
			document.getElementById("adsame_closebtn").style.display = "block";
		}
		window._AdSameObj_CY2698.b1.show();


		window._AdSameObj_CY2698.b2.hide();
	...
	case "closeBig":
		...
		if(_as_bro.isChrome()){
			document.getElementById("adsame_closebtn").style.display = "none";
		}
	...
	case "close":
			...
			window._AdSameObj_CY2698.b2.destroy();
...
window._AdSameObj_CY2698.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20150616sy/fc.swf",
	target: "_blank",
	clsbtn: 0,
	clickUrl: "http://sambaclk.adsame.com/c?z=samba&la=0&si=13&ci=3896&c=5329&or=5116&l=5819&bg=5733&b=5811&u=http://ju.mmstat.com/?url=http://www.tmall.com/wh/tmall/act/14249/tmgjnianzhongcu?campaign_id=nianzhongcu&spm=a1z15.20.3383.12805&ad_id=10013144355a03be4f80&am_id=&cm_id=&pm_id=",
...
window._AdSameObj_CY2698.b1 = new _as_divfl({
	...
	autoClsSeconds: 8,
	autoclsfc: "window._AdSameObj_CY2698.fc(\"closeBig\")",
	btnWidth: 77,
	btnHeight: 31,
	btns: [{
	url: _as_bro.isChrome() ? "":"http://rm.sina.com.cn/bj_chuanyang/tb20150616sy/close.jpg",
	fc: "window._AdSameObj_CY2698.fc(\"closeBig\")"
	}],
	iniShow: cyis1
});
window._AdSameObj_CY2698.b1.onAfterHide = function() {


		window._AdSameObj_CY2698.b2.show();
...
window._AdSameObj_CY2698.f2 = new _as_fl({
	width: 25,
	height: 220,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20150616sy/fb.swf",
	target: "_blank",
	repfc: "window._AdSameObj_CY2698.fc(\"replay\")",
	clsfc: "window._AdSameObj_CY2698.fc(\"close\")",
	clickUrl: "http://sambaclk.adsame.com/c?z=samba&la=0&si=13&ci=3896&c=5329&or=5116&l=5819&bg=5733&b=5811&u=http://ju.mmstat.com/?url=http://www.tmall.com/wh/tmall/act/14249/tmgjnianzhongcu?campaign_id=nianzhongcu&spm=a1z15.20.3383.12805&ad_id=10013144355a03be4f80&am_id=&cm_id=&pm_id=",
	selfName: "window._AdSameObj_CY2698.f2",
	fscmdfc: window._AdSameObj_CY2698.fc,
	paras:{
		this_obj:window._AdSameObj_CY2698.fc
	}
});
window._AdSameObj_CY2698.b2 = new _as_divfl({
	width: 25,
	height: 220,
	...
	firstScreen: 0,
	alwaysShow: 0,
	flash: window._AdSameObj_CY2698.f2,
	selfName: "window._AdSameObj_CY2698.b2",
	iniShow: (cyis2 || 0)
});
...
window._AdSameObj_CY2698.run = function() {
	...
	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://samba.adsame.com/s?z=samba&c=5329&l=5819\' />";
	if (_as_bro.isIe6()) {
	...
	if(_as_bro.isChrome()){
		...
		closediv.style.width="77px"; 
		closediv.id = "adsame_closebtn";
		closediv.style.position = "fixed";
		closediv.style.left = "50%";
		closediv.style.top = "345px";
		closediv.style.marginLeft = "423px";
		closediv.style.zIndex = "10001";
		document.body.appendChild(closediv);
		closediv.innerHTML = '<img style="width:77px;height:31px;" src="http://rm.sina.com.cn/bj_chuanyang/tb20150616sy/close.jpg">';
		if(!adsame_ss){
			document.getElementById("adsame_closebtn").style.display = "none";
		}
	}
	window._AdSameObj_CY2698.b2.create(window._AdSameObj_CY2698.f2.getcode()+ifmcode);
	window._AdSameObj_CY2698.b2.show();
	if(!adsame_ss){
		try {
			window.sinaadsROC.done(window.sinaadsROC. stream);
	...
	document.getElementById(window._AdSameObj_CY2698.b2.id).style.zIndex = "10000";


};
window._AdSameObj_CY2698.run();

function clickSCFlash_lmt(){
	try
	{
