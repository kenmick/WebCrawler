(function(){var SiteCodes;SiteCodes=function(){function d(){}d.generate=function(a,b){var c,e,f,g,h,i,j;if(b==null)b=void 0;c=b;c=b!=null&&b.length>0?c.replace(/http:\/\//,""):a;c=c.split(".");h=[];f=c.length;if(f>1){e=i=0;for(j=c.length;i<j;e=++i){g=c[e];g==="www"||e===c.length-1||h.push(c.slice(e,+f+1||9E9).join("."))}}return h};return d}();var PartnerTags;
...
h)}})};d.fire_partner_support=function(a,b,c,e,f){var g,h;c=c.data.protocol==="http:"?"http://js":"https://sjs";c+=".bizographics.com/support/partner.html?";c+="pid="+a.pid;c+="&u="+a.u;g=a.pid;h=f.now().getTime();return b.write_iframe({src:c,style:{display:"none"},onload:function(){return e.track(g,h)}})};d.partner_ids={simplifi:"567",yieldmanager:"217"};return d}();
var BaseLogger,ConsoleLogger,ErrorLog,LocalLogger,PixelLogger,__slice=[].slice,__hasProp={}.hasOwnProperty,__extends=function(d,a){function b(){this.constructor=d}for(var c in a)if(__hasProp.call(a,c))d[c]=a[c];b.prototype=a.prototype;d.prototype=new b;d.__super__=a.prototype;return d};
...
e.length>0))return"";g=0;g=~g;f=h=0;for(i=e.length;h<i;f=++h){f=e.charCodeAt(f);g=a[(g^f)&255]^g>>>8}g=~g;if(g<0)g=4294967295+g+1;return g};d.to_crc32_string=function(e){return b(d.to_crc32(e).toString(16).toUpperCase())};d.generate_checksum=function(e){var f,g,h;f=[];for(g in e){h=e[g];f.push(""+g+"="+h)}return d.to_crc32_string(f.sort().join("&"))};return d}();var Clock;
...
this.overwrite_url_param_if_needed();this.add_secure_param_if_page_is_secure();return this.params};return d}();var ArrayUtil;
...
[],function(b){return function(c,e){var f,g,h;if(b.is_array(e)){g=0;for(h=e.length;g<h;g++){f=e[g];c.push(f)}}else c.push(e);return c}}(this))};return d}();var InsightTags;
