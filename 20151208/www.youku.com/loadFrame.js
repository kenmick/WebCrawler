...
(function(window,undefined){
	...
	var vr = '20151203'; //çæ¬å·
	var preDomain = 'https://';
	var localScriptSrc = preDomain+'account.youku.com/static-resources/js/login.js?'+vr,
			localLogoutSrc = preDomain+'account.youku.com/static-resources/js/logout.js?'+vr,
			mobileCss = preDomain +'account.youku.com/static-resources/css/frame_mobile.css?'+vr,
			pcCss = preDomain + 'account.youku.com/static-resources/css/frame_common.css?'+vr,
			pcMiniCss = preDomain + 'account.youku.com/static-resources/css/frame_mini.css?'+vr;
