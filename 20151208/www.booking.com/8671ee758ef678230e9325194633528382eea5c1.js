...
o+=[b[61],f.MC(a[53]),b[102],f.MC(a[54]),b[29]].join("")
}else{if((f.MJ(f.MC(a[55]))&&(f.MJ(f.MC(a[52]))||f.MJ(f.MC(a[50]))))){o+=b[61];
f.MN("b_map_hotel_location",(f.MC(a[50])||f.MC(a[52])));
o+=[b[103],f.MC(a[55]),f.MC(a[56]),b[102],f.MC(a[54]),b[29]].join("")
...
if((f.MJ(f.ATLAS_STAGE("ebcBUYSaBEEFXbaCdTUC"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBEEFXbaCdTUC")))){o+=[b[104],"ebcBUYSaBEEFXbaCdTUC",b[105],f.MC(a[57]),b[106],f.MC(a[58]),b[107],f.MB(a[59]),b[108]].join("")
}o+=b[109];
if((f.MJ(f.MC(a[61]))&&((f.MJ(f.ATLAS_STAGE("ebcOQPBRNQTDCPZC"))&&(f.MJ(f.ATLAS_TRACK("ebcOQPBRNQTDCPZC")==2)))||(f.MJ(f.ATLAS_STAGE("ebcBUYSaBcSPWYNWe"))&&(f.MJ(f.ATLAS_TRACK("ebcBUYSaBcSPWYNWe")==2)))))){o+=b[110];
if((f.MJ(f.ATLAS_ENV("action")+""==="hotel"))){o+=[b[94],"ebcBUYSaBcSPWYNWe",b[95]].join("")
}else{if((f.MJ(f.ATLAS_ENV("action")+""==="searchresults"))){o+=[b[94],"ebcOQPBRNQTDCPZC",b[95]].join("")
}}o+=[b[111],f.MB(a[60]),b[112]].join("")
}o+=b[113];
return o
...
}n+=[b[75],f.MC(a[36]),b[76]].join("");
if(f.MD(a[39])){n+=b[77];
if(f.MD(a[37])){n+=[b[78],f.HELPER_ENV("b_icons_url"),b[79],f.MC(a[37]),f.MC(a[38]),b[80]].join("")
}n+=b[81]
}else{n+=[b[82],f.MC(a[37]),f.MC(a[38]),b[83]].join("")
}n+=b[29];
if(f.MD(a[43])){n+=b[61];
if(f.MJ(f.ATLAS_TRACK("eGBUOQPBRYCDUfcXIFNKNMC"))){}n+=b[61];
if(f.MJ(f.ATLAS_TRACK("eGfESAcCRBTPOaXGZLOLHT"))){}n+=b[84];
if((f.MJ(f.ATLAS_GET_VARIANT("eGBUOQPBRYCDUfcXIFNKNMC"))||f.MJ(f.ATLAS_GET_VARIANT("eGfESAcCRBTPOaXGZLOLHT")))){n+=[b[85],(f.MC(a[40])?f.MB(a[41]):f.MB(a[42])),b[86]].join("")
}else{n+=b[87]
}n+=b[29]
}n+=b[88];
f.MN(a[44],f.MG((f.MC(a[45])||{})["smart"]));
n+=b[89];
if(!((f.MJ(f.MC(a[44]))&&(f.MJ(f.ATLAS_STAGE("ebcOQPBRNRWSdPJNVBUKcKe"))&&f.MJ(f.ATLAS_TRACK("ebcOQPBRNRWSdPJNVBUKcKe")))))){n+=b[84];
...
if(f.MD(a[44])){n+=[b[90],f.strings("maps-iw-deals-badge"),b[62]].join("")
}n+=b[61]
}else{n+=b[62];
if(f.MD(a[44])){n+=b[90];
f.MN("b_smart_deal_show",(f.MJ(f.ATLAS_ENV("action")+""==="searchresults")));
n+=b[90];
if(f.MD(a[46])){n+=[b[91],f.strings("value-deal-label"),b[90]].join("")
}n+=b[62]
}n+=b[61]
}n+=b[29]
}n+=b[92];
...
f.MN(a[47],f.MC(a[48]));
n+=b[93];
if((f.MJ(f.ATLAS_ENV("action")+""==="hotel"))){n+=[b[94],"ebcBUYSaBIdOccPSTRe",b[95]].join("")
}else{if((f.MJ(f.ATLAS_ENV("action")+""==="searchresults"))){n+=[b[94],"ebcOQPBRYVcTQQDBeKe",b[95]].join("")
}else{if(f.MJ(f.ATLAS_ENV("isLP"))){n+=[b[94],"ebcfESAcCRDfUFFdZYO",b[95]].join("")
}}}n+=[b[96],f.MB(a[49]),b[97],f.MC(a[48]),b[98]].join("")
}n+=b[99];
if(((f.MJ(f.ATLAS_TRACK("eGBUYSaBNHTXT"))||f.MJ(f.ATLAS_TRACK("ebcfESAcCSBCHC")))||f.MJ(f.ATLAS_TRACK("eGOQPBRNZRUXe")))){n+=b[89];
if((f.MJ(f.ATLAS_ENV("action")+""==="searchresults"))){n+=b[100];
n=h(n);
n+=b[114]
}n+=b[88];
if(f.MJ(f.MC(a[62]))){n+=b[115];
if(f.MD(a[63])){n+=b[116];
if(((f.MJ(f.ATLAS_STAGE("ebcBUYSaBcMEbSHAJDFYSCC"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBcMEbSHAJDFYSCC")))||(f.MJ(f.ATLAS_STAGE("ebcOQPBRNLEHSTRbAOdPBMO"))&&f.MJ(f.ATLAS_TRACK("ebcOQPBRNLEHSTRbAOdPBMO"))))){n+=b[91];
if(f.MJ(f.ATLAS_TRACK("eGBfQHKbdCMAWe"))){n+=[b[117],f.format_number_decimal(f.MC(a[62])),b[91]].join("")
}else{n+=[b[117],f.MC(a[62]),b[91]].join("")
}n+=[b[91],f.MC(a[63]),b[90]].join("")
}else{n+=[b[91],f.MC(a[63]),b[91]].join("");
if(f.MJ(f.ATLAS_TRACK("eGBfQHKbdCMAWe"))){n+=[b[117],f.format_number_decimal(f.MC(a[62])),b[91]].join("")
}else{n+=[b[117],f.MC(a[62]),b[91]].join("")
}n+=b[90]
}n+=b[118]
...
f.MN(a[64],f.MC(a[65]));
n+=b[119];
if((f.MJ(f.MC(a[65]))&&(f.MJ(f.ATLAS_STAGE("ebcYSaBcOcTYHWMHET"))&&f.MJ(f.ATLAS_TRACK("ebcYSaBcOcTYHWMHET"))))){n+=[b[120],f.MB(a[66]),b[121]].join("");
if((f.MJ(f.MC(a[9]))&&(f.MJ(f.ATLAS_STAGE("ebcBUYSaBYWEIFIeTJWe"))&&(f.MJ(f.ATLAS_TRACK("ebcBUYSaBYWEIFIeTJWe")==2))))){n+=[b[122],f.MB(a[27]),b[121]].join("")
}n+=b[62]
}else{n+=b[90];
if(f.MD(a[68])){n+=[b[123],f.MC(a[67]),b[121]].join("")
}n+=b[62]
}n+=b[114]
}n+=b[124];
if((f.MJ(f.MC(a[69]))&&(f.MJ(f.ATLAS_ENV("action")+""==="hotel")))){n+=b[125];
if(!((f.MJ(f.ATLAS_STAGE("ebcBUYSaBHaZFBKWXbbQMdOeZZSeae"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBHaZFBKWXbbQMdOeZZSeae"))))){n+=[b[126],f.MC(a[69]),b[127]].join("")
}n+=b[29]
}n+=b[128]
}n+=b[129];
...
if(!(((f.MJ(f.ATLAS_TRACK("eGBUYSaBNHTXT"))||f.MJ(f.ATLAS_TRACK("ebcfESAcCSBCHC")))||f.MJ(f.ATLAS_TRACK("eGOQPBRNZRUXe"))))){n+=b[132];
if((f.MJ(f.MC(a[69]))&&(f.MJ(f.ATLAS_ENV("action")+""==="hotel")))){n+=[b[133],f.MC(a[69]),b[134]].join("")
}n+=b[135];
if(!(f.MJ(f.ATLAS_TRACK("ebcfESAcCFGZJdQFePBYKe")))){n+=b[136]
}n+=b[137]
}n+=b[138];
...
f.MN(a[75],[f.MB(a[75]),b[144]].join(""));
n+=b[29]
}n+=b[29];
if(f.MD(a[2])){n+=b[61];
...
if((f.MJ(f.MC(a[62]))&&f.MK(((f.ATLAS_TRACK("eGBUYSaBNHTXT")||f.ATLAS_TRACK("ebcfESAcCSBCHC"))||f.ATLAS_TRACK("eGOQPBRNZRUXe"))))){n+=b[146];
if(f.MD(a[63])){n+=b[147];
if(((f.MJ(f.ATLAS_STAGE("ebcBUYSaBcMEbSHAJDFYSCC"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBcMEbSHAJDFYSCC")))||(f.MJ(f.ATLAS_STAGE("ebcOQPBRNLEHSTRbAOdPBMO"))&&f.MJ(f.ATLAS_TRACK("ebcOQPBRNLEHSTRbAOdPBMO"))))){n+=b[117];
if(f.MJ(f.ATLAS_TRACK("eGBfQHKbdCMAWe"))){n+=[b[148],f.format_number_decimal(f.MC(a[62])),b[117]].join("")
}else{n+=[b[148],f.MC(a[62]),b[117]].join("")
}n+=[b[117],f.MC(a[63]),b[91]].join("")
}else{n+=[b[117],f.MC(a[63]),b[117]].join("");
if(f.MJ(f.ATLAS_TRACK("eGBfQHKbdCMAWe"))){n+=[b[148],f.format_number_decimal(f.MC(a[62])),b[117]].join("")
}else{n+=[b[148],f.MC(a[62]),b[117]].join("")
}n+=b[91]
}n+=b[149]
...
f.MN(a[64],f.MC(a[65]));
n+=b[150];
if((f.MJ(f.MC(a[65]))&&(f.MJ(f.ATLAS_STAGE("ebcYSaBcOcTYHWMHET"))&&f.MJ(f.ATLAS_TRACK("ebcYSaBcOcTYHWMHET"))))){n+=[b[123],f.MB(a[66]),b[121]].join("")
}else{n+=b[91];
if(f.MD(a[68])){n+=[b[151],f.MC(a[67]),b[152]].join("")
}n+=b[90]
}n+=b[153]
}n+=b[89];
if((f.MJ(f.ATLAS_STAGE("ebcBUYSaBYdXfTYMNJFC"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBYdXfTYMNJFC")))){n+=b[154];
n=g(n);
n+=b[114]
}n+=[b[155],f.MB(a[75]),b[156]].join("");
...
n+=b[158];
if(f.MD(a[34])){n+=b[159];
if((f.MJ(f.ATLAS_TRACK("ebcOQPBRNZRUAJJSVHDFNIVSHT"))||f.MJ(f.ATLAS_TRACK("ebcBUYSaBNHTIPfbJEfZBWIbYO")))){n+=b[90];
f.MN(a[82],[b[90],f.HELPER_ENV("ajax_hotel_details_soldout"),b[90]].join(""));
n+=b[90];
f.MN(a[83],[b[90],f.HELPER_ENV("ajax_hotel_details_soldout"),b[90]].join(""));
n+=b[160];
if(((((((((((f.MJ(f.MB(a[77])+""===""))||(f.MJ(f.MB(a[78])+""==="")))||(f.MJ(f.MB(a[79])+""==="")))||(f.MJ(f.MB(a[80])+""==="")))||(f.MJ(f.MB(a[81])+""==="")))||f.MK(f.MB(a[77])))||f.MK(f.MB(a[78])))||f.MK(f.MB(a[79])))||f.MK(f.MB(a[80])))||f.MK(f.MB(a[81])))){n+=[b[91],f.HELPER_ENV("ajax_hotel_details_soldout"),b[90]].join("")
}else{n+=b[91];
if((f.MJ(f.MB(a[79])+""===""+f.MB(a[81])))){n+=[b[117],f.MB(a[84]),b[91]].join("")
}else{n+=[b[117],f.MB(a[85]),b[91]].join("")
}n+=b[90]
}n+=b[161]
}else{n+=[b[90],f.HELPER_ENV("ajax_hotel_details_soldout"),b[62]].join("")
}n+=b[162]
}else{if(((f.MJ((f.MC(a[3])).length)&&f.MJ(f.MC(a[3])[0]["checkin"]))&&f.MJ(f.MC(a[3])[0]["checkout"]))){n+=b[163];
if((f.MJ(f.ATLAS_TRACK("eGBUHaZFTSDNYQLEHJeKe"))||f.MJ(f.ATLAS_TRACK("eGOQRWSEeTOZPbaPWAUC")))){n+=[b[164],f.MG(((f.MC(a[3])||[])[0]||{})["price"]),b[165]].join("")
}else{n+=b[91];
if(f.MJ(f.ATLAS_TRACK("eGBUYSaBGcPDeBEJYcMEfTRe"))){n+=b[166];
if((f.MJ(f.ATLAS_ENV("currency")+""==="EUR"))){n+=b[167];
f.MN(a[86],b[168]);
n+=b[148]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="GBP"))){n+=b[167];
f.MN(a[86],b[169]);
n+=b[148]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="JPY"))){n+=b[167];
f.MN(a[86],b[170]);
n+=b[148]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="CNY"))){n+=b[167];
f.MN(a[86],b[171]);
n+=b[148]
}else{n+=b[172];
f.MN(a[86],b[173]);
n+=b[148]
}}}}n+=[b[174],f.MC(a[86]),b[175],f.MC(a[87]),b[176]].join("");
if((f.MJ(f.ATLAS_ENV("currency")+""==="EUR"))){n+=b[177]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="GBP"))){n+=b[178]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="JPY"))){n+=b[179]
}else{if((f.MJ(f.ATLAS_ENV("currency")+""==="CNY"))){n+=b[180]
}else{n+=b[181]
}}}}n+=b[182]
}else{n+=[b[148],f.HELPER_FROM_FRICE(f.MC(a[3])[0]["price"]),b[91]].join("")
}n+=b[91]
}n+=b[183]
}else{if(f.MD(a[3])){n+=b[184];
f.MN(a[30],f.MG(((f.MC(a[3])||[])[0]||{})["rackrate"]));
n+=b[90];
if(((f.MJ(f.MB(a[30]))&&(f.MJ(f.MB(a[30])+""!==""+f.MB(a[33]))))&&f.MJ(f.ATLAS_TRACK("eGYSaBZEGJGEO")))){n+=b[91];
f.MN(a[31],f.MG(((f.MC(a[3])||[])[0]||{})["price_discount"]));
n+=b[91];
f.MN(a[88],f.MB(a[31]));
n+=b[91];
var m="";
m+=b[117];
if(f.MJ(f.MB(a[30]))){m+=b[185];
if((f.MJ(f.ATLAS_GET_VARIANT("eGYSaBZEGJGEO")==2))){m+=b[186]
}m+=[b[187],f.MB(a[90]),b[188],f.MB(a[30]),b[189]].join("")
}m+=b[91];
f.MN(a[89],m);
n+=b[90]
}else{n+=b[91];
...
f.MN(a[91],f.MC(a[92]));
n+=b[90];
if((f.MJ(f.ATLAS_STAGE("eGBUYSaBdbLMaCffHPSaTfRe"))&&f.MJ(f.ATLAS_TRACK("eGBUYSaBdbLMaCffHPSaTfRe")))){n+=b[91];
f.MN(a[93],undefined);
n+=b[90]
}else{n+=b[91];
f.MN(a[93],b[33]);
...
n+=b[192];
var m="";
m+=[b[193],f.MB(a[70]),b[43],f.MB(a[93]),b[194],"eGBUYSaBdbLMaCffHPSaTfRe",b[195],f.MB(a[89]),b[196],f.MB(a[33]),b[197]].join("");
if(((((f.MJ(f.MC(a[91])>0))&&(f.MJ(f.MC(a[91])==1)))&&f.MJ(f.ATLAS_STAGE("ebcYSaBGceZdAVIXe")))&&f.MJ(f.ATLAS_TRACK("ebcYSaBGceZdAVIXe")))){m+=b[198];
if(f.MJ(f.ATLAS_TRACK("ebcYSaBGcBKJKINHC"))){m+=b[199]
}m+=[b[200],f.VP(b[201],"b_checkin_checkout_interval"),b[202]].join("")
}else{if((f.MJ(f.MC(a[91])>1))){m+=b[198];
if(f.MJ(f.ATLAS_TRACK("ebcYSaBGcBKJKINHC"))){m+=b[199]
}m+=[b[200],f.VP(b[201],"b_checkin_checkout_interval"),b[203]].join("")
}}m+=b[90];
f.MN(a[96],m);
n+=b[184];
if((f.MJ(f.HELPER_IW_B_BLOCKS(f.MC(a[3]),0,"num_rooms_available_translated"))&&((f.MJ(f.ATLAS_TRACK("eGBUYSaBZLOAXe"))||f.MJ(f.ATLAS_TRACK("eGOQPBRNSaBGKe")))||f.MJ(f.ATLAS_TRACK("eGOLaBQPBRNSaBGKe"))))){n+=[b[204],f.MC(a[96]),b[205],f.HELPER_IW_B_BLOCKS(f.MC(a[3]),0,"num_rooms_available_translated"),b[206]].join("")
}else{n+=[b[91],f.MC(a[96]),b[90]].join("")
}n+=b[119]
}else{if((f.MJ(f.MB(a[76])+""==="false"))){n+=[b[207],f.strings("map_occupancy_disclaimer_1"),b[208]].join("")
}}}}n+=b[209];
var m="";
m+=b[62];
if(f.MD(a[103])){m+=b[90];
if(f.MD(a[34])){m+=b[91];
if(f.MK(f.MC(a[99]))){m+=[b[117],f.MB(a[98]),b[91]].join("")
}else{m+=[b[117],f.MB(a[100]),b[91]].join("")
}m+=b[90]
}else{m+=b[91];
if((f.MJ(f.ATLAS_STAGE("eGBUYSaBEESMbSYT"))&&f.MJ(f.ATLAS_TRACK("eGBUYSaBEESMbSYT")))){m+=[b[117],f.MB(a[101]),b[91]].join("")
}else{m+=b[117];
if(((f.MJ(f.ATLAS_STAGE("ebcOQPBRYcYFMbcMZFNTeae"))&&f.MJ(f.ATLAS_TRACK("ebcOQPBRYcYFMbcMZFNTeae")))||(f.MJ(f.ATLAS_STAGE("ebcBUYSaBdBbCANCdZBSeLT"))&&f.MJ(f.ATLAS_TRACK("ebcBUYSaBdBbCANCdZBSeLT"))))){m+=[b[148],f.MB(a[102]),b[117]].join("")
}else{m+=[b[148],f.MB(a[102]),b[117]].join("")
}m+=b[91]
}m+=b[90]
}m+=b[62]
}else{m+=b[90];
...
if(f.MK((f.MB(a[34])&&(f.ATLAS_GET_VARIANT("eGYSaBAeCQJJYDBeWe")||f.ATLAS_GET_VARIANT("eGYSaBAeCQJJYDBePART"))))){n+=[b[210],f.MC(a[13]),b[211],f.MC(a[35]),f.MC(a[17]),f.MC(a[10]),f.MC(a[18]),b[212],f.MC(a[23]),b[213]].join("");
if(f.MJ(f.ATLAS_TRACK("ebcBUYSaBNHFVXKNUADDbddSdceUPTDPFHe"))){n+=b[214]
}n+=b[215];
if(f.MK(f.ATLAS_ENV("isPartner413084"))){n+=b[74]
}n+=b[216];
if(f.MJ(f.MB(a[34]))){n+=[b[117],f.MC(a[97]),b[91]].join("")
}else{if(((f.MJ(f.MC(a[103]))&&f.MK(f.MB(a[34])))&&((f.MJ(f.ATLAS_STAGE("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe"))&&f.MJ(f.ATLAS_TRACK("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe")))||(f.MJ(f.ATLAS_STAGE("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET"))&&f.MJ(f.ATLAS_TRACK("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET")))))){n+=b[217];
if((f.MJ(/213|220|228|230|232/.test(f.MC(a[105]))))){n+=[b[148],f.MB(a[104]),b[43],f.MC(a[22]),b[117]].join("")
}else{if((f.MJ(/201|219|230|229/.test(f.MC(a[105]))))){n+=[b[148],f.MB(a[106]),b[43],f.MC(a[22]),b[117]].join("")
}else{n+=[b[148],f.MB(a[107]),b[43],f.MC(a[22]),b[117]].join("")
}}n+=b[91]
}else{n+=[b[117],f.MC(a[97]),b[91]].join("")
}}n+=b[218]
}n+=b[61]
}n+=b[219];
if(!(((f.MJ(f.ATLAS_TRACK("eGBUYSaBNHTXT"))||f.MJ(f.ATLAS_TRACK("ebcfESAcCSBCHC")))||f.MJ(f.ATLAS_TRACK("eGOQPBRNZRUXe"))))){n+=b[220]
}n+=b[129];
if(((f.MJ(f.ATLAS_TRACK("eGBUYSaBNHTXT"))||f.MJ(f.ATLAS_TRACK("ebcfESAcCSBCHC")))||f.MJ(f.ATLAS_TRACK("eGOQPBRNZRUXe")))){n+=b[46];
if(!(((f.MJ(f.ATLAS_ENV("action")+""==="searchresults"))||f.MJ(f.ATLAS_TRACK("ebcBUYSaBYdXfTYMNJFC"))))){n+=b[221];
n=h(n);
n+=b[54]
}n+=b[129]
}n+=b[3];
if(((f.MJ(f.ATLAS_TRACK("eGBUYSaBNHTXT"))||f.MJ(f.ATLAS_TRACK("ebcfESAcCSBCHC")))||f.MJ(f.ATLAS_TRACK("eGOQPBRNZRUXe")))){n+=b[222];
if(((f.MJ(f.ATLAS_STAGE("ebcOLaCbJFYSaBbJZSYT",1))&&f.MJ(f.ATLAS_TRACK("ebcOLaCbJFYSaBbJZSYT")))||(f.MJ(f.ATLAS_STAGE("ebcBUVKQPbBbLOAPdZUO",1))&&f.MJ(f.ATLAS_TRACK("ebcBUVKQPbBbLOAPdZUO"))))){n+=[b[223],f.MC(a[35]),f.MC(a[17]),f.MC(a[10]),f.MC(a[18]),b[224],f.MC(a[23]),b[73]].join("");
if(f.MK(f.ATLAS_ENV("isPartner413084"))){n+=b[74]
}n+=b[225];
if(f.MJ(f.MB(a[34]))){n+=[b[61],f.MC(a[97]),b[89]].join("")
}else{if(((f.MJ(f.MC(a[103]))&&f.MK(f.MB(a[34])))&&((f.MJ(f.ATLAS_STAGE("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe"))&&f.MJ(f.ATLAS_TRACK("ebcOLaCbJFYSaBdBaHIKKDfXYZBdRHe")))||(f.MJ(f.ATLAS_STAGE("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET"))&&f.MJ(f.ATLAS_TRACK("ebcBUVKQPbBbLOMSVEKXRPLRBdSMHET")))))){n+=b[226];
...
}n+=[b[228],f.MC(a[14]),b[229],f.MB(a[108]),b[230]].join("");
...
booking.jstmpl("atlas_overlay_marker",(function(){var b=["\n",'\n    \u003cdiv class="atlas-marker-wrapper-soldout"\u003e\n','\n\u003cdiv class="atlas-marker-wrapper"\u003e\n\u003cdiv class="\n    atlas-marker\n    atlas-marker-',"\n    ","\n    atlas-marker-behavior-active\n    ",'\n"\u003e\n',"\n        ","\n\u003c/div\u003e\n\n",'\n        \u003cdiv class="atlas-marker-hotel-measle"\u003e\u003c/div\u003e\n',"\n        \u003c/div\u003e\n",""],a=["b_type","b_behaviors","b_review_score"],e,d,c;
return function(f){var h="",i=this.fn;
h+=b[0];
var g=i.MC(a[0]);
if((i.MJ(g+""==="hotel_sr_soldout"))){h+=b[1]
}h+=[b[2],i.MC(a[0]),b[3]].join("");
if(i.MJ(i.MG((i.MC(a[1])||{})["active"]))){h+=b[4]
}h+=b[5];
if((i.MJ(!/^(hotel_soldout|hotel_sr_soldout|hotel_comp_set_soldout)$/.test(i.MC(a[0]))))){h+=b[3];
if(i.MD(a[2])){h+=[b[6],i.format_number_decimal(i.MC(a[2])),b[3]].join("")
}h+=b[0]
}h+=b[7];
var g=i.MC(a[0]);
if((i.MJ(g+""==="hotel"))){h+=b[8]
}h+=b[7];
var g=i.MC(a[0]);
if((i.MJ(g+""==="hotel_sr_soldout"))){h+=b[9]
}h+=b[10];
return h
}
})());
