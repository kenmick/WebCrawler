...
n.unsubscribe=function(a,b,c){if(a=this.o[a]){var d=this.f;if(a=ua(a,function(a){return d[a+1]==b&&d[a+2]==c}))return this.W(a)}return!1};
n.W=function(a){var b=this.f[a];if(b){var c=this.o[b];if(0!=this.j)this.h.push(a),this.f[a+1]=aa;else{if(c){var d=ra(c,a);0<=d&&Array.prototype.splice.call(c,d,1)}delete this.f[a];delete this.f[a+1];delete this.f[a+2]}}return!!b};
n.N=function(a,b){var c=this.o[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.m)for(e=0;e<c.length;e++){var g=c[e];qb(this.f[g+1],this.f[g+2],d)}else{this.j++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.f[g+1].apply(this.f[g+2],d)}finally{if(this.j--,0<this.h.length&&0==this.j)for(;c=this.h.pop();)this.W(c)}}return 0!=e}return!1};
function qb(a,b,c){gb(function(){a.apply(b,c)})}
n.clear=function(a){if(a){var b=this.o[a];b&&(y(b,this.W,this),delete this.o[a])}else this.f.length=0,this.o={}};
n.G=function(){C.ka.G.call(this);this.clear();this.h.length=0};var rb=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};r("yt.config_",rb,void 0);r("yt.tokens_",window.yt&&window.yt.tokens_||{},void 0);var sb=window.yt&&window.yt.msgs_||t("window.ytcfg.msgs")||{};r("yt.msgs_",sb,void 0);function tb(a){var b=arguments;if(1<b.length){var c=b[0];rb[c]=b[1]}else for(c in b=b[0],b)rb[c]=b[c]}
...
function oc(a){var b;if(!(b=nc[a])){b=0;for(var c=oa(String(mc)).split("."),d=oa(String(a)).split("."),e=Math.max(c.length,d.length),f=0;0==b&&f<e;f++){var g=c[f]||"",h=d[f]||"",k=RegExp("(\\d*)(\\D*)","g"),l=RegExp("(\\d*)(\\D*)","g");do{var m=k.exec(g)||["","",""],K=l.exec(h)||["","",""];if(0==m[0].length&&0==K[0].length)break;b=pa(0==m[1].length?0:parseInt(m[1],10),0==K[1].length?0:parseInt(K[1],10))||pa(0==m[2].length,0==K[2].length)||pa(m[2],K[2])}while(0==b)}b=nc[a]=0<=b}return b}
...
"/csi_204?"+b.substring(1):null;window.navigator&&window.navigator.sendBeacon?(ve(a),d&&ve(d)):(M(a),d&&M(d));r("yt.timing.pingSent_",!0,void 0)}
...
x(Qe,B);var Se=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];n=Qe.prototype;n.la=function(a,b){this.isDisposed()||(Te(this,a),b||Ue(this),Ve(this,b),this.D&&We(this))};
...
n.ab=function(){return this.D};
n.A=function(a,b){if(!this.isDisposed()){var c=Xe(this,b);if(c){if(!va(this.Qa,a)&&!this.j[a]){var d=ef(this,a);this.R&&this.R(a,d)}this.T.subscribe(a,c);"onReady"==a&&this.D&&E(ma(c,this.api),0)}}};
n.qb=function(a,b){if(!this.isDisposed()){var c=Xe(this,b);c&&this.T.unsubscribe(a,c)}};
...
Ga(a.Z,String(e))};
return c}
n.Ua=function(a){a=a?Cc:Bc;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.C||b==this.J||(b.focus(),b!=document.activeElement));)b=a(b)};
n.ra=function(a){Gb("a11y-announce",a)};
n.gb=function(a){$e(this,a)};
n.ib=function(a){Gb("WATCH_LATER_VIDEO_ADDED",a)};
n.jb=function(a){Gb("WATCH_LATER_VIDEO_REMOVED",a)};
n.eb=function(){this.fa||(Id?(this.da=yc(document),pe(this.K,window,"scroll",this.pb),pe(this.K,this.l,"touchmove",this.nb)):(pe(this.K,this.l,"mousewheel",this.Aa),pe(this.K,this.l,"wheel",this.Aa)),this.fa=!0)};
n.fb=function(){qe(this.K);this.fa=!1};
n.Aa=function(a){a=a||window.event;a.returnValue=!1;a.preventDefault&&a.preventDefault()};
n.pb=function(){window.scrollTo(this.da.x,this.da.y)};
n.nb=function(a){a.preventDefault()};
n.ub=function(){cf(this);this.B="unsupported";var a='Adobe Flash Player or an HTML5 supported browser is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="/html5">Learn more about upgrading to an HTML5 browser</a>',b=navigator.userAgent.match(/Version\/(\d).*Safari/);b&&5<=parseInt(b[1],10)&&(a='Adobe Flash Player or QuickTime is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/"> Get the latest Flash Player</a> <br> <a href="http://www.apple.com/quicktime/download/">Get the latest version of QuickTime</a>');
...
n.$a=function(){return this.B||bf(this)};
n.Za=function(){return this.ea};
...
window.chrome;if(m&&(m=m.loadTimes,ea(m))){var m=m(),K=1E3*Math.min(m.requestTime||Infinity,m.startLoadTime||Infinity),K=Infinity===K?0:l.navigationStart-K;l=Math.max(0,Math.round(1E3*m.firstPaintTime+K)||0);break a}l=0}0<l&&l>g&&(d.fpt=l);l=c||Oe().span;m=k.redirectEnd-k.redirectStart;0<m&&(l.rtime_=m);m=k.domainLookupEnd-k.domainLookupStart;0<m&&(l.dns_=m);m=k.connectEnd-k.connectStart;0<m&&(l.tcp_=m);m=k.connectEnd-k.secureConnectionStart;k.secureConnectionStart>=k.navigationStart&&0<m&&(l.stcp_=
m);m=k.responseStart-k.requestStart;0<m&&(l.req_=m);m=k.responseEnd-k.responseStart;0<m&&(l.rcv_=m);S.getEntriesByType&&Le(d)}m=Je();k=m.pbr;l=m.vc;m=m.pbs;k&&l&&m&&k<l&&l<m&&1==Oe().info.yt_vis&&"youtube"==f&&(Oe().info.yt_lt="hot_bg",f=d.vc,k=d.pbs,delete d.aft,c.aft=Math.round(k-f));(f=D("PREVIOUS_ACTION"))&&(e.pa=f);e.p=D("CLIENT_PROTOCOL")||"unknown";e.t=D("CLIENT_TRANSPORT")||"unknown";window.navigator&&window.navigator.sendBeacon&&(e.ba=1);for(var za in e)"_"!=za.charAt(0)&&(b[za]=e[za]);d.ps=
...
x(gg,xf);ba(gg);n=gg.prototype;n.register=function(){V(this,"mouseover",this.ha);V(this,"mouseout",this.U);V(this,"focus",this.Xa);V(this,"blur",this.Ta);V(this,"click",this.U);V(this,"touchstart",this.rb);V(this,"touchend",this.Ea);V(this,"touchcancel",this.Ea)};
n.dispose=function(){for(var a in this.h)this.U(this.h[a]);this.h={}};
n.ha=function(a){if(!(this.f&&1E3>w()-this.f)){var b=parseInt(A(a,"tooltip-hide-timer"),10);b&&(Ya(a,"tooltip-hide-timer"),window.clearTimeout(b));var b=v(function(){hg(this,a);Ya(a,"tooltip-show-timer")},this),c=parseInt(A(a,"tooltip-show-delay"),10)||0,b=E(b,c);
Wa(a,"tooltip-show-timer",b.toString());a.title&&(zf(a,ig(a)),a.title="");b=ga(a).toString();this.h[b]=a}};
n.U=function(a){var b=parseInt(A(a,"tooltip-show-timer"),10);b&&(window.clearTimeout(b),Ya(a,"tooltip-show-timer"));b=v(function(){if(a){var b=H(jg(this,a));b&&(kg(b),b&&b.parentNode&&b.parentNode.removeChild(b),Ya(a,"content-id"));(b=H(jg(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Ya(a,"tooltip-hide-timer")},this);
b=E(b,50);Wa(a,"tooltip-hide-timer",b.toString());if(b=A(a,"tooltip-text"))a.title=b;b=ga(a).toString();delete this.h[b]};
n.Xa=function(a){this.f=0;this.ha(a)};
n.Ta=function(a){this.f=0;this.U(a)};
n.rb=function(a,b,c){c.changedTouches&&(this.f=0,a=wf(b,U(this),c.changedTouches[0].target),this.ha(a))};
n.Ea=function(a,b,c){c.changedTouches&&(this.f=w(),a=wf(b,U(this),c.changedTouches[0].target),this.U(a))};
...
Gc(b),l=jg(a,b,"arialabel"),f=document.createElement("div");Wb(f,U(a,"arialabel"));f.id=l;"rtl"==document.body.getAttribute("dir")?Dc(f,c+" "+k):Dc(f,k+" "+c);b.setAttribute("aria-labelledby",l);k=Oc()||document.body;k.appendChild(f);k.appendChild(d);lg(b,c);(c=parseInt(A(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",Wb(g,U(a,"normal-wrap")));g=Vb(b,U(a,"reverse"));ng(a,b,d,e,h,g)||ng(a,b,d,e,h,!g);var m=U(a,"tip-visible");E(function(){Wb(d,m)},0)}}}}
function ng(a,b,c,d,e,f){$b(c,U(a,"tip-reverse"),f);var g=0;f&&(g=1);a=Bd(b);f=new F((a.width-10)/2,f?a.height:0);var h=uc(b),k=new F(0,0),l;l=h?uc(h):document;var m;(m=!G||9<=Number(qc))||(m=sc(l),m=zc(m.f));b!=(m?l.documentElement:l.body)&&(l=zd(b),h=sc(h),h=yc(h.f),k.x=l.left+h.x,k.y=l.top+h.y);f=new F(k.x+f.x,k.y+f.y);f=f.clone();k=(g&8&&"rtl"==yd(c,"direction")?g^4:g)&-9;g=Bd(c);h=g.clone();l=f.clone();h=h.clone();0!=k&&(k&4?l.x-=h.width+0:k&2&&(l.x-=h.width/2),k&1&&(l.y-=h.height+0));f=new wd(0,
0,0,0);f.left=l.x;f.top=l.y;f.width=h.width;f.height=h.height;h=new F(f.left,f.top);h instanceof F?(k=h.x,h=h.y):(k=h,h=void 0);c.style.left=Ad(k,!1);c.style.top=Ad(h,!1);h=new ac(f.width,f.height);if(!(g==h||g&&h&&g.width==h.width&&g.height==h.height))if(g=h,f=uc(c),f=sc(f),k=zc(f.f),!G||oc("10")||k&&oc("8"))f=c.style,dc?f.MozBoxSizing="border-box":ec?f.WebkitBoxSizing="border-box":f.boxSizing="border-box",f.width=Math.max(g.width,0)+"px",f.height=Math.max(g.height,0)+"px";else if(f=c.style,k){G?
(k=Ed(c,"paddingLeft"),h=Ed(c,"paddingRight"),l=Ed(c,"paddingTop"),m=Ed(c,"paddingBottom"),k=new L(l,h,m,k)):(k=xd(c,"paddingLeft"),h=xd(c,"paddingRight"),l=xd(c,"paddingTop"),m=xd(c,"paddingBottom"),k=new L(parseFloat(l),parseFloat(h),parseFloat(m),parseFloat(k)));if(!G||9<=Number(qc))h=xd(c,"borderLeftWidth"),l=xd(c,"borderRightWidth"),m=xd(c,"borderTopWidth"),K=xd(c,"borderBottomWidth"),h=new L(parseFloat(m),parseFloat(l),parseFloat(K),parseFloat(h));else{h=Gd(c,"borderLeft");l=Gd(c,"borderRight");
m=Gd(c,"borderTop");var K=Gd(c,"borderBottom"),h=new L(m,l,K,h)}f.pixelWidth=g.width-h.left-k.left-k.right-h.right;f.pixelHeight=g.height-h.top-k.top-k.bottom-h.bottom}else f.pixelWidth=g.width,f.pixelHeight=g.height;g=window.document;g=zc(g)?g.documentElement:g.body;f=new ac(g.clientWidth,g.clientHeight);1==c.nodeType?(c=zd(c),h=new F(c.left,c.top)):(c=c.changedTouches?c.changedTouches[0]:c,h=new F(c.clientX,c.clientY));c=Bd(d);l=Math.floor(c.width/2);g=!!(f.height<h.y+a.height);a=!!(h.y<a.height);
...
n.Wa=function(a){var b=!!A(a,"ypc-item-type"),c=!!A(a,"ypc-item-id");!A(a,"ypc-enabled")&&b&&c&&(Wb(a,"ypc-enabled"),Wa(a,pg.Ra,"true"))};
n.Va=function(a){A(a,"ypc-enabled")&&(Xb(a,"ypc-enabled"),Ya(a,"ypc-enabled"))};
function sg(a,b){var c=wc(U(a));return sa(c,function(a){return b==A(a,"channel-external-id")},a)}
n.Sa=function(a,b,c){var d=Ca(arguments,2);y(a,function(a){b.apply(this,wa(a,d))},this)};
n.L=function(a,b,c){var d=sg(this,a),d=wa([d],Ca(arguments,1));this.Sa.apply(this,d)};
