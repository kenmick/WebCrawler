...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="publishid" content="1192641.0.98.0"/>
<title>æ°åç½_è®©æ°é»ç¦»ä½ æ´è¿</title>
...
/* css reset
--------------------------------------------------*/
* { margin: 0; padding: 0; font-size: 14px; font-weight: normal; font-family: "å®ä½", Arial, Helvetica, sans-serif; font-style: normal; text-align: left; color: #676767; }
html { height: 100%; }
body { height: 100%; text-align: center; background: url(http://www.xinhuanet.com/politics/images/20160219_xjplXHS_banner_v8.jpg) 50% 0 no-repeat; }
...
--------------------------------------------------*/
/*.lazy{display: none;}*/
.lazy, .lazyIframe, .wloadIframeAD { background: #f1f1f1 url(http://www.xinhuanet.com/res/xhwimg/public/2015/Loading.gif) no-repeat 50% 50%; }
...
.icon1 { width: 18px; height: 9px; background-position: -123px -65px; }/*è§é¢*/
.icon2 { width: 29px; height: 14px; background-position: 0px -120px; }/*é«æ¸*/
.icon3 { width: 14px; height: 12px; background-position: -93px -65px; }/*å¾è§£*/
.icon4 { width: 29px; height: 14px; background-position: 0px -65px; }/*è°æ¥*/
.icon5 { width: 14px; height: 12px; background-position: -41px -65px; }/*é®å·*/
.icon6 { width: 14px; height: 12px; background-position: -67px -65px; }/*åè±*/
.icon7 { width: 18px; height: 16px; background-position: -177px -65px; }/*å¯¹è¯*/
.icon8 { width: 14px; height: 12px; background-position: -153px -93px; }/*PK*/
.icon9 { width: 29px; height: 14px; background-position: 0px -93px; }/*å¾é*/
.icon10 { width: 29px; height: 14px; background-position: -175px -219px; }/*é³é¢*/
/* select */
