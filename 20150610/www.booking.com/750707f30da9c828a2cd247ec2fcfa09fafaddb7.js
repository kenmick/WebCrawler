...
function j(r){if(o){console.log("Event: "+r)
...
B.atlas.define("analytics",["jQuery"],function(d){var a,c="fBTeecfbHXSceIKe";
...
if(!B.atlas||!B.atlas.getVariant(c)){return
...
return(m)?m[2]:false
}function i(r,q,l){var p,m=h.call(this,r),o=this,n=e.call(o,r);
j(o);
if(!l&&n&&typeof q==="function"){q.call(o,n);
return n
}o.trigger("iw-get-before",o);
p=b.ajax({url:m,error:function(t,s){if(s!=="abort"){o.trigger("iw-get-fail",o)
}},success:function(s){if(!s){return
}if(typeof q==="function"&&s.b_hotels){q.call(o,s.b_hotels[r])
}a.push([o,r,s.b_hotels[r],p]);
o.trigger("iw-get-success",s,o)
}});
c.push([o,p]);
return p
