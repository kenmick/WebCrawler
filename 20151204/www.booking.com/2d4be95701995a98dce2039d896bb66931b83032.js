...
h.unshift({b_tooltip:d[117],b_size:d[118],b_color:d[119],b_classname:d[120]});
U=l(U);
h.shift();
...
h.unshift({b_tooltip:d[117],b_classname:d[149],b_ge_discount:d[36],b_ge_freebies:d[36]});
U=H(U);
h.shift();
