...
s(null,q)
}function o(q,s){_p=_o;_o="368:252";var r=this.atlas.getPlaceDetails;
if(B.et.track("PVdIHMDeJISUWe")){r=this.atlas.getGeocodeDetails
}r.call(this.atlas,{placeId:q.place_id},function(t){_p=_o;_o="368:253";if(!t||typeof t.get!=="function"){s(new Error("service-atlas-invalid-place"),null)
