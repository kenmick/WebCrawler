// sha: daf5521f214e
// date: Wed Mar 02 2016 18:47:41 GMT+0000 (UTC)
...
return __p;
},templates['map-key-lead-win'] = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='';
 var leaders = Helpers.getMapLeaders(races, party_id); 
__p+='\n<div class="eln-map-key eln-map-key-lead-win" data-party-id="'+
((__t=( party_id ))==null?'':__t)+
'">\n  ';
...
__p+='\n<div class="eln-map-key" data-race-id="'+
...
return __p;
},templates['mobile-dashboard'] = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="eln-results-dashboard-row" data-template="mobile-dashboard" data-load-id="'+
((__t=( _.last(_.pluck(racesByParty, 'load_id').sort()) ))==null?'':__t)+
'">\n';
 _.each(racesByParty, function(party) { 
__p+='\n<h2 class="eln-party-title">'+
((__t=( Helpers.partyTitle(party.party_id) ))==null?'':__t)+
' Results</h2>\n<h2 class="eln-party-plural">'+
...
__p+='\n    <th class="eln-header eln-candidate eln-'+
...
__p+='\n    <tr class="eln-row ';
 i == 0 ? 'eln-first-row' : '' 
__p+='">\n\n      <td class="eln-cell eln-state">\n        <a href="http://www.nytimes.com/elections/results/'+
((__t=( race.state_slug ))==null?'':__t)+
'">\n          <span class="eln-abbrev">'+
((__t=( race.state_abbrev ))==null?'':__t)+
'</span>\n          <span class="eln-name">'+
((__t=( Helpers.getStateFromPostal(race.state_id).name ))==null?'':__t)+
'</span>\n        </a>\n      </td>\n\n      ';
 if ( !race.report ) { 
__p+='\n\n        <td class="eln-cell eln-polls-close" colspan="'+
((__t=( party.candidates.length + 1 ))==null?'':__t)+
'">'+
((__t=( race.poll_display ))==null?'':__t)+
'</td>\n\n      ';
 } else { 
__p+='\n\n        ';
 _.each(party.candidates, function(candidate) { 
...
'">\n            <span class="eln-sprite eln-icon-checkmark-small"></span>\n            '+
((__t=( Math.round(race_candidate.percent_display) ))==null?'':__t)+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav class="eln-navigation eln-desktop">\n\n    <a class="eln-title-button" href="//elections.nytimes.com" title="Election 2016">\n      <span class="eln-sprite eln-icon-ballot"></span>\n      <span class="eln-election-title">Election 2016</span>\n    </a>\n\n    <div class="eln-nav-items clearfix">\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/results">Results</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/03/02/us/super-tuesday-results-delegates.html">Delegate Calculator</a>\n      <span class="eln-nav-item">Live Estimates:</span>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/03/01/upshot/super-tuesday-live-republican-delegate-estimates.html">Republicans</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/03/01/upshot/super-tuesday-live-democrat-delegate-estimates.html">Democrats</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/us/elections/primary-calendar-and-results.html">Primary Calendar</a>\n    </div>\n\n</nav>\n\n<nav class="eln-navigation eln-mobile">\n\n    <div class="eln-nav-items clearfix">\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/results">Results</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/03/01/upshot/super-tuesday-live-republican-delegate-estimates.html">Live Estimates</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/live/super-tuesday-2016-elections/">Live Updates</a>\n    </div>\n\n</nav>';
}
return __p;
...
return __p;
},templates['race-best-sentence'] = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<p class="eln-race-sentence '+
((__t=( race.race_best_sentence_is_fresh ? 'eln-race-sentence-fresh' : '' ))==null?'':__t)+
'">'+
((__t=( race.race_best_sentence ))==null?'':__t)+
'.</p>';
}
return __p;
},templates['races-table'] = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='';
 var racesByState = Helpers.racesTable(races, { max_races: 5, adminSort: true }); 
__p+='\n<div class="eln-races-table">\n  <table class="eln-races-table-table">\n    <thead>\n      <tr>\n        <th class="eln-header eln-state">State</th>\n        <th class="eln-header eln-candidate">Republicans</th>\n        <th class="eln-header eln-candidate">Democrats</th>\n      </tr>\n    </thead>\n    <tbody>\n    ';
 var partyAdded = { republican: false, democrat: false }; 
__p+='\n    ';
 _.each(racesByState, function(stateRaces) { 
__p+='\n      <tr class="eln-row">\n        <td class="eln-cell eln-state">\n          <a class="eln-link" href="http://www.nytimes.com/elections/2016/primaries/'+
((__t=( stateRaces[0].state_slug ))==null?'':__t)+
'" target="_parent">\n            '+
((__t=( Helpers.getStateFromPostal(stateRaces[0].state_id).nyt_abbrev ))==null?'':__t)+
'\n          </a>\n        </td>\n        ';
 _.each(stateRaces, function(race, i) { 
__p+='\n        ';
 if ( !race.report && i == 0 ) { 
__p+='\n        <td class="eln-cell eln-polls-closing" colspan="2">'+
((__t=( race.poll_display ))==null?'':__t)+
'</td>\n        ';
 } 
__p+='\n        ';
 if ( !race.report ) return; 
__p+='\n        ';

          var leader = Helpers.getLeader(race);
          if ( !leader && race.result == 'winner' && race.candidates.length && race.candidates[0].winner ) leader = race.candidates[0];
          if ( !leader && race.votes ) leader = { last_name: 'Tied' };
          if ( !leader ) leader = {};
        
__p+='\n        ';
 if ( stateRaces.length == 1 && race.party_id != 'republican' ) { 
__p+='\n        <td class="eln-cell eln-candidate eln-no-election">â</td>\n        ';
 } 
__p+='\n        <td class="eln-cell \n                  eln-candidate \n                  eln-party-'+
((__t=( leader.party_id ))==null?'':__t)+
' \n                  eln-'+
((__t=( Helpers.slugifyName(leader) ))==null?'':__t)+
'\n                  '+
((__t=( race.votes === 0 ? 'eln-no-results-yet' : '' ))==null?'':__t)+
'\n                  '+
((__t=( !partyAdded[race.party_id] ? 'eln-show-percent' : '' ))==null?'':__t)+
'\n                  '+
((__t=( leader.winner ? 'eln-winner' : '' ))==null?'':__t)+
'\n                  clearfix">\n          <a class="eln-link" href="http://www.nytimes.com/elections/results/'+
((__t=( race.state_slug ))==null?'':__t)+
'" target="_parent">\n            ';
 if ( leader.last_name ) { 
__p+='\n            <span class="eln-sprite eln-icon-checkmark-small"></span>\n            <span class="eln-name">'+
((__t=( leader.last_name ))==null?'':__t)+
'</span>\n            ';
 if (leader.percent) { 
__p+='\n            <span class="eln-percent">\n              '+
((__t=( Math.round(leader.percent) ))==null?'':__t)+
'<span class="eln-percent-sign">%</span>\n            </span>\n            ';
 } 
__p+='\n            ';
 } else if (race.votes === 0) { 
__p+='\n               <span class="eln-no-results-yet-text">No results yet</span>\n            ';
 } 
__p+='\n          </a>\n        </td>\n        ';
 if ( stateRaces.length == 1 && race.party_id != 'democrat' ) { 
__p+='\n        <td class="eln-cell eln-candidate eln-no-election">â</td>\n        ';
 } 
__p+='\n        ';
 partyAdded[race.party_id] = true; 
__p+='\n        ';
 }); 
__p+='\n      </tr>\n    ';
 }); 
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="eln-results-dashboard-row" data-load-id="'+
((__t=( _.last(_.pluck(racesByParty, 'load_id').sort()) ))==null?'':__t)+
'">\n';
 _.each(racesByParty, function(party) { 
__p+='\n<div class="eln-results-dashboard eln-party-'+
((__t=( party.party_id ))==null?'':__t)+
'">\n  <table class="eln-results-dashboard-table">\n    <thead>\n      <tr>\n        <th class="eln-header eln-party-title">'+
((__t=( Helpers.partyPlural(party.party_id) ))==null?'':__t)+
'</th>\n      ';
 _.each(party.races, function(race, i) { 
__p+='\n        <th class="eln-header eln-state">\n          <a class="eln-state-name" href="http://www.nytimes.com/elections/results/'+
((__t=( race.state_slug ))==null?'':__t)+
'">'+
((__t=( race.state_abbrev ))==null?'':__t)+
...
__p+='\n        <th class="eln-header eln-delegates">\n          Delegates\n          <span class="eln-election-date">(March 1)</span>\n        </th>\n      </tr>\n    </thead>\n    <tbody>\n      ';
...
((__t=( Math.round(race_candidate.percent) ))==null?'':__t)+
'</span><span class="eln-percent-sign">%</span>\n            </span>\n          </td>\n        ';
 } else { 
__p+='\n          <td class="eln-cell eln-percent">â</td>\n        ';
 } 
__p+='\n        ';
...
((__t=( Helpers.votesFormat(candidate.total_delegates) ))==null?'':__t)+
'\n          <span class="eln-date-delegates">\n            '+
((__t=( candidate.date_delegates ? ' (+' + Helpers.votesFormat(candidate.date_delegates) + ')' : '' ))==null?'':__t)+
'\n          </span>\n        </td>\n      </tr>\n      ';
 }) 
...
((__t=( Helpers.getReportingForDashboard(race) ))==null?'':__t)+
''+
((__t=( i === 0 && race.report ? '%' : '' ))==null?'':__t)+
'</td>\n        ';
 }); 
__p+='\n        <td class="eln-cell eln-delegates eln-total-delegates">'+
((__t=( Helpers.delegates_to_win(party.party_id) ))==null?'':__t)+
' to win</td>\n      </tr>\n    </tbody>\n  </table>\n  <p class="eln-note eln-total-delegates">'+
((__t=( Helpers.delegates_to_win(party.party_id) ))==null?'':__t)+
' needed to win</p>\n  <p class="eln-note eln-link"><a href="http://www.nytimes.com/elections/results">Full Results Â»</a></p>\n  <p class="eln-note eln-timestamp">'+
((__t=( Helpers.timeFormat(party.races[0].updated) ))==null?'':__t)+
'</p>\n  <div class="eln-key">\n    <div class="eln-item">\n      <span class="eln-leader"></span>\n      Lead\n    </div>\n    <div class="eln-item">\n      <span class="eln-winner">\n        <span class="eln-sprite eln-icon-checkmark-small"></span>\n      </span>\n      Win\n    </div>\n  </div>\n</div>\n';
 }); 
__p+='\n</div>';
}
...
'">'+
((__t=( candidate.delegates || 'â' ))==null?'':__t)+
'</td>\n        ';
 } 
__p+='\n      </tr>\n      ';
 }) 
...
__p+='\n  ';
 if ( race.result == 'runoff' ) { 
__p+='\n  <div class="eln-runoff-key">\n    <span class="eln-sprite eln-icon-checkmark-small"></span>\n    Runoff\n  </div>\n  ';
 } 
__p+='\n</div>';
}
return __p;
...
function initializeHelpers(_, d3, moment) {
  ...
  var Helpers = {
    ...
    delegates_to_win: function(party_id) {
      if ( !party_id || !delegates[party_id] ) return;
      return this.votesFormat(delegates[party_id]);
    },
    ...
    secondFormat: function(timestamp) {
      // http://momentjs.com/docs/#/displaying/format/
      return moment(timestamp).tz("America/New_York").format("h:mm:ss A") + ' ET';
    },
    ...
    simpleRaceTitle: function(race) {
      return this.partyTitle(race.party_id) + ' ' + ( race.election_type == 'caucus' ? 'Caucuses' : race.election_type == 'primary' ? 'Primary' : 'Race' );
    },
    ...
    raceTypeTitle: function(type) {
      if ( type == 'house' ) return 'U.S. House';
      else if ( type == 'senate' ) return 'U.S. Senate';
      else return '';
    },

    seatTitle: function(race) {
      return 'District ' + race.seat;
    },
    ...
    getLeader: function(race) {
      if ( race.votes == 0 || race.uncontested || !race.candidates.length ) return null;
      if ( race.candidates.length == 1 ) return race.candidates[0];
    ...
    getMapLeaders: function(raceObject, party_id) {
      var help = this;
      var noResults = {
      ...
      var noElection = {
        candidate_id: 'no-election',
        last_name: 'No election',
        name_display: 'No election',
        votes: 0
      };

      if ( party_id ) {

        var races = _.where(raceObject, { party_id: party_id });
        var leaders = [];
        var keyLeaders = _.chain(races)
            .map(function(race) {
              var leader = help.getLeader(race);
              if ( leader == null ) {
                if ( race.result && race.candidates.length && race.candidates[0].winner ) {
                  leader = race.candidates[0];
                } else if ( race.votes == 0 ) {
                  leader = noResults;
                } else if ( race.candidates[0].votes == race.candidates[1].votes ) {
                  leader = tied;
                }
              }
              return leader;
            })
            .sortBy(function(d) { return d && d.candidate_id == 'tied'; })
            .sortBy(function(d) { return d && d.candidate_id == 'no-results'; })
            .filter(function(d) { 
              if ( !d ) return;
              var added = _.indexOf(leaders, d.last_name) > -1;
              if ( added ) return false;
              leaders.push(d.last_name);
              return true;
            })
            .value();

        keyLeaders.push(noElection);
        return keyLeaders;
        ...
        return _.chain(geographies)
          ...
          .sortBy(function(d) { return d && (d.candidate_id == 'no-results' || d.candidate_id == 'tied'); })
          .uniq()
          .value();
        }
    },
    ...
    getPollTime: function(poll_display) {
      if ( poll_display.indexOf('midnight') > -1 ) return 'Midnight ET';
      return poll_display.split(' ').slice(-3).join(' ').replace('.','');
    },

    getReportingForDashboard: function(race) {
      if ( !race.report ) {
        var report_abbrev = race.poll_display ? this.getPollTime(race.poll_display) : '';
        return report_abbrev;
      }
      return race.reporting_display.replace('% reporting','');
    },
      ...
      return racesByParty = _.chain(races)
          ...
          .map(function(partyRaces) {
            ...
            var races = _.chain(partyRaces)
              .sortBy(function(d) { return options.adminSort && d.state_sort || 100 })
              .sortBy(function(d) { return options.pollsSort && d.poll_display ? +help.getPollTime(d.poll_display).split(' ')[0] : false; })
            ...
            var keys = [];
            var allCandidates = _.chain(races)
                .pluck('candidates')
                .flatten()
                .map(function(d) {
                  if ( _.indexOf(keys, d.candidate_id) > -1 ) return;
                  keys.push(d.candidate_id);
                  return d;
                })
                .filter(_.isObject)
                .value();

            var candidates = _.chain(allCandidates)
                .where({ rollup: false })
                ...
                .map(function(d) {
                  ...
                  // get total delegates
                  var totalDelegates = d.us_delegates || 0;

                  var candidateMeta = _.pick(d, ['candidate_id', 'first_name', 'last_name', 'name_display', 'party_id', 'party_display']);
                  return _.extend({ date_delegates: electionDateDelegates, total_delegates: totalDelegates }, candidateMeta);
                })
                .sortBy(function(d) { return -d.total_delegates })
                .value();

            var total_date_delegates = _.reduce(_.pluck(candidates, 'date_delegates'), function(memo, num) { return memo + num}, 0);

            races = options.max_races && options.max_races < races.length ? races.slice(0, options.max_races) : races;
            return {
              load_id: _.last(_.pluck(races, 'load_id').sort()),
              party_id: races[0].party_id,
              total_date_delegates: total_date_delegates,
              races: _.sortBy(races, function(d) { return !d.report }),
              candidates: candidates
            };
          })
          .sortBy(function(d) { return d.party_id != 'republican' })
          .value();
    },

    racesTable: function(races, options) {
      var output = _.chain(races)
          .sortBy('state_slug')
          .sortBy(function(d) { return !d.report })
          .sortBy(function(d) { return options.adminSort ? +(d.state_sort) : false; })
          .groupBy('state_slug')
          .value();
      output = _.toArray(output);
      if (options && options.max_races) output = output.slice(0, options.max_races);
      output = _.sortBy(output, function(d) { return !d[0].report });
      return output;
    }
  }
...
define('results-table',[
  ...
  Results.render = function(error, update) {
    ...
    // dashboards
    $('.eln-results-dashboard-row').each(function() {
      var $container = $(this).parent(),
          options = eln_dashboard_options || {},
          racesByParty = Helpers.dashboardRaces(races, options),
          last_update = $(this).data('load-id'),
          this_update = _.last(_.pluck(races, 'load_id').sort()),
          template = $(this).data('template') || 'results-dashboard';

      if ( last_update && last_update > this_update ) return;

      $(this).data('load-id', this_update);
      $container.html( Templates[template]({ Helpers: Helpers, racesByParty: racesByParty }) );
  ...
  function updateDate(races) {
    var latest_update = _.pluck(races, 'updated').sort()[0];
    if ( latest_update ) {
      $('.eln-date').text( Helpers.dateFormat(latest_update) );
      $('.eln-timestamp').text( Helpers.timeFormat(latest_update) );
    }
  }
...
define('nytg-vote-map/lib/vmap-transform',[
  ...
  function createTransform(opts) {
    ...
    */
    ...
    transform.allowNavigation = function(ok) {
    ...
    */
    ...
    transform.panBy = function(dx, dy) {
      ...
      if (!limitPan || !transform.isFullExtent()) {
        navigateToBounds(utils.shiftBounds(getCurrentBounds(), dx2, dy2), {});
      }
    };
    ...
    function navigate(zoomOpts) {
      ...
      navigateToBounds(zoomBounds, zoomOpts);
    }

    // @bounds Bounding box in projected units, same aspect ratio as viewport
    function navigateToBounds(target, opts) {
      // var post = calcLimitedViewportBounds(target, width, height);
      var post = limitBounds(target);
      var duration = opts.duration;
      var ms = ready() && duration > 0 && !vpointer.isTouchEnabled() ? duration : 0;
      if (!allowNav && !opts.size_update) {
        // if nav is disabled, only allow projection change when resizing map
        return;
      }
      updateK();
      if (ms > 0) {
    ...
    transform.getMinZoom = function() {
      return opts.minZoom < 1 ? opts.minZoom : 1;
    };
...
function(_, d3, utils) {
  ...
  function MapCanvas(container, proj, w, h) {
    ...
    var convertColor = (function() {
      ...
      return function(col) {
        ...
        if (_.isString(col)) {
          ...
          hatchId = utils.getHatchId(col.colors, (col.width || 2) * _pixelRatio);
          if (hatchId in hatches === false) {
            hatches[hatchId] = makeCanvasHatchFill(col);
          }
          css = hatches[hatchId];
        } else {
    ...
    function makeCanvasHatchFill(style) {
      var c1 = style.colors[0];
      var c2 = style.colors[1];
      var lineSize = (style.width || 2) * _pixelRatio;
      var tileSize = Math.round(lineSize * 3);
      var stripeSize = style.stripe_width ? style.stripe_width * _pixelRatio : lineSize;
...
define('nytg-vote-map/lib/vmap-navigation',['d3/3', './vmap-wheel'], function(d3, MouseWheel) {
  ...
  api.init = function(proj, pointer, opts) {
    ...
    if (isZoomable()) {
      ...
      proj.on("change", updateDraggable);
    ...
    function updateDraggable() {
      _draggable = proj.allowNavigation() && proj.getZoom() > proj.getMinZoom();
    }
...
define('nytg-vote-map/lib/vmap',[
  ...
  function VoteMap(el, opts) {
    ...
    vpage.window().on('focus', function() {
      // work around Chrome bug -- larger canvases may disappear after a tab
      // is re-focused
      // update after timeout, to avoid double-refresh if browser has been resized
      // while another tab is open (at least on Chrome, 'resize' fires after
      // 'focus' on refocused tabs);
      refocused = true;
    ...
    proj.on('change', function() {
      ...
      // hard-refresh layers if map page has been refocused
    ...
    this.isTouchEnabled = vpointer.isTouchEnabled;
    ...
    this.allowNavigation = proj.allowNavigation;
...
define('map2016/map-utils',[], function() {
  var api = {};

  // TOOD: handle house districts
  api.getGeoType = function(d) {
    var p = d.properties || {};
    var f = api.getGeoField(d);
    var id = p[f] || '';
    var type;
    if (f == 'ST') {
      type = 'states';
    ...
    } else if (/^[A-Z]{2,2}[0-9]+$/.test(id)) {
      if (id.length == 4) {
        type = 'house-districts';
      } else if (id.length == 5) {
        type = 'state-house-districts';
      }
    }
    if (!type) {
      console.error(d);
  ...
  api.getPresidentialPrimaryGeoType = function(st) {
    var type = 'counties';
    if (st == 'VT' || st == 'MA' || st == 'NH' || st == 'ME') {
      type = 'townships';
    } else if (st == 'AK') {
      type = 'state-house-districts';
    } else if (st == 'KS' || st == 'MN') {
  ...
  api.getGeoField = function(d) {
    var p = d.properties || {};
    if ('GEOID' in p) return 'GEOID';
    else if ('ST' in p) return 'ST';
    console.error(d);
    throw ("Unknown feature");
  };

  api.mapShouldZoom = function(req) {
    return req.map_extent == 'national' || 'AK,FL,MA,NY,NJ,VA,NC,CA,TX'.indexOf(req.state_id) >= 0;
  };

  api.getStateName =  (function (){
    var stateNames = {
      AK: 'Alaska',
      HI: 'Hawaii',
      AL: 'Alabama',
...
define('map2016/asset-loader',['d3/3', '../nytg-vote-map/lib/topojson-utils', 'underscore/nyt', '../nytg-vote-map/lib/vmap-utils', './map-utils', './map-simple-states'], function(d3, topojson, _, utils, maputils, topos) {
  var api = {};
  ...
  var usaUrl = 'http://graphics8.nytimes.com/newsgraphics/map-layers/election2016/counties-mixed-albers-19p.json?c=2';
  var usaUrl2 = 'http://graphics8.nytimes.com/newsgraphics/map-layers/election2016/counties-mixed-albers-10p.json?c=2';

  api.loadGeography = function(req, cb) {
    var geo = req.geography_type,
        st = req.map_extent == 'single-state' ? req.state_id : null,
        geoType = st ? maputils.getPresidentialPrimaryGeoType(st) : null,
        url, proc, stashed, record;

    if (st) {
      if (geoType && geoType != 'states' && geoType != 'counties') {
        st += '_' + geoType // kludge
      }
      url = stateBaseUrl + st + '.json?c=1';
      proc = procStateCounties;
    } else {
      url = req.map_width < 600 ? usaUrl2 : usaUrl;
      proc = procCounties;
    }
    ...
    if (req.map_extent == 'national' && !req.state_id) {
      cb(null, topos()); // use prebaked data
    } else if (record.geo) {
      cb(null, record.geo);
    } else {
  ...
  // national map data, with counties
  function procCounties(topo, req) {

    if (req.state_ids) {
      // filterCounties(topo.objects.counties, req.state_ids);
    }

    var counties = topojson.feature(topo, topo.objects.counties);
    var innerlines = topojson.mesh(topo, topo.objects.counties, function(a, b) {
        return a.properties.ST == b.properties.ST ? a.properties.ST : false;
      });
    var countylines = innerlines.features.reduce(function(memo, feat) {
      memo[feat.id] = feat;
      return memo;
    }, {});
    ...
    var geom = {
      ...
      states: topojson.feature(topo, topo.objects.states),
      statelines: topojson.meshes(topo, topo.objects.states, function(a, b) {return a != b;}),
      innerlines_by_state: countylines
    };

    if (topo.objects.cities) {
      geom.cities = topojson.feature(topo, topo.objects.cities);
  ...
  function filterCounties(object, states) {
    var index = _.countBy(states, function(st) {return st;});
    object.geometries = object.geometries.filter(function(feat) {
      return feat.properties.ST in index;
    });
  }

  // single-state county map data
...
define('map2016/map-colors',['underscore/nyt', 'd3/3', '../nytg-vote-map/lib/vmap-utils', '../nytg-vote-map/lib/vmap-color'], function(_, d3, utils, vcolor) {
  ...
  var otherCandidateLightColor = '#ddd';
  var repColor = '#bc3939';
  var demColor = '#273e7f';
  ...
  var breaks5 = {
    democrat: [15, 30, 45, 60],
    republican: [15, 25, 35, 45]
  }
  ...
  api.getRampByPartyId = function(id) {
    return breaks5[id] || [];
  };
  ...
  function initLightColors() {
    Object.keys(candidateColors).forEach(function(candId) {
      var col = candidateColors[candId];
      var lightCol = lightCandidateColors[candId];
      if (!lightCol) {
        lightCandidateColors[candId] = d3.hcl(col).brighter().toString();
      }
    });
  }
  ...
  api.getCandVotePctColor = function(cand, d) {
    var breaks = breaks5[cand.party_id];
  ...
  api.getLightCandColor = function(cand) {
    var id = cand ? cand.candidate_id : null;
    return lightCandidateColors[id] || otherCandidateLightColor
  };

  // @cand  Object from candidates[] array of a race object
  api.getCandColor = function(cand) {
    var id = cand && cand.candidate_id;
    return candidateColors[id] || otherCandidateColor;
  };
  ...
  api.getWinLeadFill = function(d, cand, winner) {
    var a, b;
    if (winner || !cand) {
      return api.getLeaderColor(d, cand);
    }
    a = api.getLightCandColor(cand);
    b = d3.hcl(a).brighter(0.4).toString();
    return {
      colors: [a, b],
      stripe_width: 1.1
    };
...
define('map2016/race-data-import',['underscore/nyt'], function(_) {
  ...
  function importVoteData(group, race) {
    ...
    var raceData = _.defaults({counties: null, townships: null, candidates: null}, race);

    raceData.results = getRaceResults(race.candidates, raceData.votes);
    raceData.winner = race.candidates.reduce(function(memo, cand) {
      return cand.winner ? cand.candidate_id : memo;
    }, null);
    ...
    if (race.counties) {
      ...
      race.counties.forEach(function(o) {
        var geoId = o.fips || o.geoid || o.fips_town;
...
define('map2016/map-popup',['underscore/nyt', 'd3/3', 'templates', 'lib/helpers', './race-data-import', './map-utils'], function(_, d3, Templates, Helpers, DataImport, maputils) {
  var api = {};
  ...
  var formatRoundedPct = d3.format(".0f");
  ...
  api.getFilteredTableHtml = function(data, req) {
    ...
    var race = formatResults(combined, req.race_data, {rounded: true});
  ...
  function getResultsTable(feat, req, overrideOptions) {
    ...
    var geoType = maputils.getGeoType(feat);
    var title = getTitle(feat, geoType, opts);
    var noResults = !voteData.results.length;
    var noCountyResults = false;
    var noPollingPlaces = noResults && (geoType == 'townships' || geoType == 'state-districts'); // kludge for AK
    var noElectionScheduled = noResults && geoType == 'states'; // kludge;
    ...
    */
    ...
    } else if (noPollingPlaces) {
      subtitle = 'No polling places'
    } else if (!voteData) {
      subtitle = 'No election'; // TODO:
    } else if (opts.show_pct_reporting && voteData.reporting_display) {
      if (voteData.report === false && voteData.poll_display) {
        subtitle = voteData.poll_display;
      } else if ( voteData.precincts_reporting == 0 ) {
        if ( voteData.votes > 0 ) {
          subtitle = 'Initial results'; // '<1% reporting';
        } else {
          subtitle = 'No precincts reporting';
        }
      } else {
        var precincts_label = voteData.precincts_total == 1 ? 'precinct' : 'precincts';
        subtitle = Helpers.votesFormat(voteData.precincts_reporting) + ' of ' + Helpers.votesFormat(voteData.precincts_total) + ' ' + precincts_label + ' reporting';
      }
  ...
  function convertCandidateResults(voteData, candidates, opts) {
    var total = voteData.votes;
    var results = voteData.results;
    var pct = opts && opts.rounded ? formatRoundedPct : formatPct;
    var convertedCands = results.map(function(rec) {
      var o = _.defaults({
          votes: rec.votes,
          percent: rec.percent,
          percent_display: pct(rec.percent),
          winner: rec.candidate_id === voteData.winner
  ...
  function formatResults(voteData, raceData, opts) {
    var candidates = convertCandidateResults(voteData, raceData.candidates, opts);
  ...
  */
  ...
  function getTitle(feat, geo, opts) {
    var name = '';
    if (geo == 'states') {
      name = maputils.getStateName(getStateId(feat));
...
define('map2016/map-layers',[
  './map-colors',
  './map-popup',
  './map-filters',
  '../nytg-vote-map/lib/vmap-utils',
  './map-utils',
  '../etagx',
  'underscore/nyt'], function(Colors, Popup, Filters, utils, maputils, etagx, _) {
  ...
  function create(vmap, mapOpts) {
    ...
    api.getStatesWithData = function() {
      return reqPrev.state_ids || [];
    };

    // @opts display opts
    api.getMapRequirements = function(races, opts) {
      var prevState = optsPrev.state_id;
      opts = _.extend(optsPrev, opts);

      var req = {
        filter: opts.filter || null,
        map_type: opts.map_type || 'leader'
      };

      var raceData = findRaceData(races, opts);
      var multiState = raceData.states.length > 1;
      req.race_data = raceData;
      req.map_width = vmap.width();
      req.map_extent = multiState ? 'national' : 'single-state';
      ...
      if (multiState) {
        req.map_extent = 'national';
        req.state_ids = raceData.states;
        req.state_id = opts.state_id;

      } else {
        req.map_extent = 'single-state';
        req.state_id = raceData.states[0];
      }
      req.prev_state_id = prevState;

      req.reporting_threshold = opts.reporting_threshold ||
    ...
    api.compileLayers = function(req, geom) {
      ...
      var dataLyr;
      var stateDataLyr, innerLinesLyr;

      var majorLineWidth = function() {
        var w = 1;
        var mapWidth = vmap.getZoom() * vmap.width();
        if (mapWidth > 500) {
          w = 1;
        }
        return w;
      ...
      if (req.map_extent == 'national' && req.geography_type == 'counties') {
        geom = filterGeography(geom, req.state_id);
        stateDataLyr = getStateLeaderLyr(req, geom);
        stateDataLyr.hoverStyle = {
          stroke: 'black',
          strokeWidth: 2
        };
        stateDataLyr.onHover = vmap.popup({classname: 'eln-popup'}).onHover(renderPopup);
        stateDataLyr.onSelect = function(d) {
          var rec = req.getResult(d);
          if (true || !rec.no_data) {
            vmap.dispatchEvent('select', {
              state_id: d.properties.ST,
              feature: d
            });
          }
        };
      ...
      // add state layer (when present)
      if (stateDataLyr) {
        layers.push(stateDataLyr);
      }
      ...
      // add state inner lines, when present
      if (geom.statelines) {
        layers.push(getInnerlinesLyr(req, geom.statelines, 'white', getMajorLineWidth));
      }

      // add inner county inner lines
      if (isChoropleth && geom.innerlines) {
        layers.push(getInnerlinesLyr(req, geom.innerlines, LIGHT_STROKE));
      }

      // add state outline layer to single-state maps
      ...
      if (req.map_extent == 'national') {
        // add national map labels
        if (showStateLabels(req)) {
          addStateLabels(layers, req, geom);

        } else if (req.state_id && geom.cities) {
          addCityLabels(layers, req, filterCities(geom, req.state_id), 2.2);
        }

      } else {
        // add city labels
        if (showCityLabels(req)) {
          addCityLabels(layers, req, geom);
        }
      }
    ...
    function filterCities(geom, st) {
      var cities = geom.cities.features.filter(function(f) {
        return f.properties.ST == st;
      })
      return {
    ...
    function addStateLabels(layers, req, geom) {
      var index = api.getStatesWithData().reduce(function(memo, st) {
        var label = maputils.getStateLabel(st, vmap.width());
        if (label) {
          memo[st] = {label: label};
        }
        return memo;
      }, {});
      var features = geom.states.features.filter(function(feat) {
        return feat.properties.ST in index;
      });
      ...
      function attr(name) {
        return function(d) {
          var rule = rules[d.properties.ST]
          return rule && (name in rule) ? rule[name] : rules.others[name];
        };
      }
      ...
      var lyr = {
        ...
        style: {
          ...
          classname: function(d) {
            var cl = 'g-map-label g-state-label';
            return cl;
          },
          dx: attr('dx'),
          dy: attr('dy'),
        ...
        text: function(d) {return index[d.properties.ST].label || '';}
      };
    ...
    function addCityLabels(layers, req, geom, minZoom) {
      ...
      layers.push(texts);
      if (minZoom) {
        dots.minZoom = dots2.minZoom = texts.minZoom = texts2.minZoom = minZoom;
      }
    }

    function getMajorLineWidth() {
      var mapWidth = vmap.getZoom() * vmap.width();
      return mapWidth > 1400 &&  1.8 || mapWidth > 800 && 0.9 || 0.6;
    }
    ...
    function showStateLabels(req) {
      if (vmap.width() < 350) return false;
      if (req.map_extent == 'national' && !req.state_id && vmap.width() > 350) {
        return true;
      }
      return false;
    }

    function showCityLabels(req) {
      // issue: height() not yet set on first display
      var maxDim = Math.max(vmap.width(), vmap.height());
      if (req.map_extent == 'national') return false; // TODO: labels on usa map
      return mapOpts.show_city_labels == 'always' || /*!req.filter &&*/ maxDim > 270;
    }
    ...
    // TODO: improve
    function findRaceData(races, opts) {
      var partyId = opts.party_id || null;
      var parties = _.pluck(races, 'party_id');
      var raceData;
      if (partyId) {
        raceData = _.find(races, function(race) {return race.party_id == partyId;});
        if (!raceData) {
          throw new Error("Missing data for party: " + partyId);
        }
      } else {
        raceData = races[0];
        if (races.length > 1 && parties.length > 1) {
          console.error("Warning: map is missing a 'party_id' display param");
        } else if (races.length > 1) {
          console.error("Warning: map received data for multiple race types");
        }
      }
      return raceData;
    }
    ...
    function filterGeography(geom, st) {
      var innerlines = null;
      var counties = [];
      var state;
      if (st) {
        var countyFeatures = geom.counties.features.filter(function(d) {
          return d.properties.ST == st;
        });

        innerlines = geom.innerlines_by_state[st] || [];
        // var innerlines = _.defaults({features: innerFeatures}, geom.innerlines2);

        var counties = _.defaults({features: countyFeatures}, geom.counties);
      }

      /*
      var stateFeatures = geom.states.features = geom.states.features.filter(function(d) {
        return d.properties.ST != st;
      });
      var states = _.defaults({features: stateFeatures}, geom.states);
      */
    ...
    function calcBubbleSize(count, maxCount, reportingPct, featureCount) {
      var avgFeatureSide = (vmap.width() + vmap.height()) * 0.35;
      var maxSize = Math.min(avgFeatureSide / Math.sqrt(featureCount), avgFeatureSide * 0.16); // don't let bubbles get too big
    ...
    function getLeaderColor(req) {
      ...
      return function(feat) {
        var d = req.getResult(feat);
        var id = req.candidate || d.winner || d.leader;
        var cand = id ? candidates[id] : null;
        return Colors.getLeaderColor(d, cand);
      };
    }

    function getStateLeaderColor(req, selectedSt) {
      var candidates = req.race_data.candidates;
      return function(feat) {
        if (feat.properties.ST == selectedSt) return 'white';
        var d = req.getResult(feat);
        var id = req.candidate || d.winner || d.leader;
        var cand = id ? candidates[id] : null;
        return Colors.getWinLeadFill(d, cand, d.winner);
      };
    }
    ...
    function initAccessors(req) {
      ...
      req.getResult = function(d) {
        var fname = maputils.getGeoField(d);
    ...
    */
    ...
    function getStateLeaderLyr(req, geom) {
      var color = getStateLeaderColor(req, req.state_id);
      return {
        features: geom.states,
        style: {
          fill: color
        }
      };
    ...
    function getInnerlinesLyr(req, features, color, strokeWidth) {
      return {
        features: features,
        style: {
          stroke: color || '#e5e5e5',
    ...
    function getDotType(d) {
      ...
      if (city == 1 || city == 2) {
        ...
        // console.log('city:', city, 'scale:', scale, 'type:', type)
      }
      return type;
    }
...
define('map2016/map',[
    ...
    './map-utils',
    '../nytg-vote-map/lib/vmap-utils'
    ], function(_, VoteMap, AssetLoader, MapCompiler, DataImporter, maputils, utils) {
  ...
  function handleTownships(raceData) {
    // kludge to import townships: treat them like counties
    /*
    var race0 = raceData[0];
    if (raceData.length == 1 && race0.townships && race0.townships.length > 1) {
      race0.townships.forEach(function(rec) {
        rec.fips = rec.fips_town;
      });
      race0.counties = race0.townships;
      race0.use_townships = true;
    }
    */
    raceData.forEach(function(race) {
      if (!race.state_id || race.race_type != 'president') return;
      var geotype = maputils.getPresidentialPrimaryGeoType(race.state_id);
      var dataField = 'counties';
      var dataArr;
      if (geotype == 'counties' || geotype == 'states') return;
      if (geotype == 'state-house-districts') {
        dataField = 'state_house_districts';
      } else if (geotype == 'house-districts') {
        dataField = 'congressional_districts';
      } else if (geotype == 'townships') {
        dataField = 'townships';
      }
      dataArr = race[dataField];
      if (!dataArr || dataArr.length > 0 == false) {
        console.error(race);
        console.error("Missing data field:", dataField);
      } else {
        race.counties = dataArr; // treat alternate geography as counties
      }
  ...
  function create(selector, mapOpts) {
    ...
    api.display = function(opts) {
      ...
      AssetLoader.loadGeography(req, function(err, geo) {
        ...
        if (geo.states && req.state_id && req.prev_state_id != req.state_id) {
          var feat = _.find(geo.states.features, function(feat) {return feat.properties.ST == req.state_id;});
          var zoomOpts = {};
          if (!opts.animate) {
            zoomOpts.duration = 0;
          }

          _vmap.zoomToFeature(feat, zoomOpts);
        }
    ...
    function initNavigation(req) {
      var useNav = maputils.mapShouldZoom(req);
      var el = d3.select(selector);
      var nav, inBtn, outBtn, backBtn;
      _vmap.allowNavigation(useNav);
      if (useNav) {
        nav = el.append('div').classed('eln-map-zoom-buttons', true);
        inBtn = nav.append('div').classed('eln-map-nav-btn eln-map-nav-zoom-in', true).append('div');
        outBtn = nav.append('div').classed('eln-map-nav-btn eln-map-nav-zoom-out', true).append('div');
        backBtn = nav.append('div').classed('eln-map-nav-btn eln-map-nav-reset', true).append('div');
        ...
        _vmap.on('navigate', function() {
          var zoom = _vmap.getZoom();
          var showNav = zoom >= 1.2;
          updateNavButtons();
          nav.classed('active', showNav);
        });

        _vmap.on('zoom-out', function() {
          api.display({state_id: null});
        });

        _vmap.on('select', function(e) {
          if (_compiler.getStatesWithData().indexOf(e.state_id) == -1) return;
          api.display({state_id: e.state_id, animate: true});
        });

      }

      function updateNavButtons() {
        var iconSize = mapOpts.iconSize === 'large' || isMobile() ? '' : '-sm';
        inBtn.attr('class', 'eln-sprite eln-icon-zoom-in' + iconSize);
        outBtn.attr('class',  'eln-sprite eln-icon-zoom-out' + iconSize);
        backBtn.attr('class', 'eln-sprite eln-icon-reset' + iconSize);
      }
    ...
    function isMobile() {
      return utils.viewportWidth() <= 700 && _vmap.isTouchEnabled();
    }

    function initMap(mapOpts) {
      var vmap = VoteMap.create(selector, mapOpts);
...
define('map2016/map-menu',['jquery/nyt','etagx'], function($, etagx) {
  ...
  $('.eln-map-menu .eln-item').on('click', function() {
    ...
    if ( $(this).data('party-id') ) {
      var map = $('.eln-national-map').data('map'),
          map_party = $(this).data('party-id');
      map.display({party_id: map_party});
    }
    ...
    $('.eln-map-key-candidate').each(function() {
      ...
      if ( race ) {
        ...
        var html = Templates['map-key-votepct']({
          ...
          colors: colors,
          breaks: map_colors.getRampByPartyId(race.party_id)
        });
        $(this).html(html);
      }
    });
...
_.extend(IC.Broker.prototype,IC.Events,{
    ...
    loadPack: function(msg,first_load){
        ...
        if(encoding === "pointer"){
            $.ajax(msg.pointer_url, {timeout: 10000}
...
require([
  ...
  'etagx',
    ...
    if (eln_config.ic_config.on === true) {
      ...
      if ( eln_config.batch_update ) {

        console.info('Batch IC updates.');

        var races_consumer = IC.makeCollectionConsumer(eln_config.ic_config.stream_name + ':' + eln_config.election_date);
            races_consumer.on('update-complete', updateRaces);
            races_consumer.register(broker);

      } else {

        console.info('Single IC updates.');

        // set up IC consumers per race
        _.each(eln_races, function(race) {
          var single_race_consumer = IC.makeSingletonConsumer(eln_config.ic_config.stream_name + ':' + race.race_id);
              single_race_consumer.on('update-complete', update);
              single_race_consumer.register(broker);
        });
    ...
    function initializeMaps() {
      ...
      $('.eln-results-map').each(function() {
        ...
        if ( $(this).hasClass('eln-national-map') ) {
          var $el = $(this),
              map_type = $el.data('map-type') || 'leader',
              map_party = $el.data('party-id');

          var map = Map.create($el[0], {});
          map.display({
            map_type: map_type, // also: 'leader', 'leader-bubbles'
            races: eln_races,
            party_id: map_party,
            timestamp: ts
          });
    ...
    function updateRaces() {
      var races = _.where(races_consumer.collection.items, { race_type: 'president' });
      if ( !races || !races.length ) return console.info("Results update error. Disable updates.");;
      console.info("Results update.", races[0].load_id, races);
      Results.render(null, { races: races });

      // update national map
      $('.eln-national-map').each(function() {
        var ts = +new Date();
        var map = $(this).data('map');
        map.display({races: races, timestamp: ts});
      });
    }
