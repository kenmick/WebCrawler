...
var qd=function(){if(hd&&m.opera){var a;var b=m.opera.version;try{a=b()}catch(c){a=b}return a}a="";(b=od())&&(a=b?b[1]:"");return Q&&(b=pd(),b>parseFloat(a))?String(b):a}(),rd={};
...
function be(a,b){if(!a||!b)return!1;if(a.contains&&1==b.nodeType)return a==b||a.contains(b);if("undefined"!=typeof a.compareDocumentPosition)return a==b||Boolean(a.compareDocumentPosition(b)&16);for(;b&&a!=b;)b=b.parentNode;return b==a}
...
function Eo(a){var b=a.f.J;if(null!=b)W(),b?(W(),Go(a.f,a,!1)):(W(),Go(a.f,a,!0));else if(a.ia=new fo(a,0,void 0,void 0,void 0),a.ia.Wa=a.Yb,b=a.f,b=Co(b,b.vb()?a.ob:null,a.Zb),W(),!Q||td(10))ig(b,"TYPE","xmlhttp"),ko(a.ia,b,!1,a.ob,!1);else{ig(b,"TYPE","html");var c=a.ia;a=Boolean(a.ob);c.gb=3;c.La=kg(b.clone());uo(c,a)}}
...
new Gr(this.j,a));break;case chrome.cast.ReceiverType.CAST:Qr(this,new Cr(this.j,a));break;default:this.P("Unknown receiver type: "+a.receiverType);return}break;case chrome.cast.ReceiverAction.STOP:this.f&&this.f.j.label==a.label?this.f.stop():this.P("Stopping receiver w/o session: "+a.friendlyName)}else this.P("onReceiverAction_ called without receiver.")};
