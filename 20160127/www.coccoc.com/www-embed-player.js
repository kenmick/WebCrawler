...
;function F(a){D.call(this);this.l=1;this.h=[];this.j=0;this.f=[];this.ga={};this.o=Boolean(a)}
...
x(mh,D);var oh=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=mh.prototype;g.getId=function(){return this.ha};
g.cc=function(a,b){this.isDisposed()||(ph(this,a),b||qh(this),rh(this,b),this.J&&sh(this))};
...
new gl(this.h,a));break;case chrome.cast.ReceiverType.CAST:ql(this,new cl(this.h,a));break;default:this.M("Unknown receiver type: "+a.receiverType);return}break;case chrome.cast.ReceiverAction.STOP:this.f&&this.f.h.label==a.label?this.f.stop():this.M("Stopping receiver w/o session: "+a.friendlyName)}else this.M("onReceiverAction_ called without receiver.")};
...
Lm.prototype.then=function(a,b,c){return Qm(this,ha(a)?a:null,ha(b)?b:null,c)};
Lm.prototype.then=Lm.prototype.then;Lm.prototype.$goog_Thenable=!0;Lm.prototype.cancel=function(a){0==this.f&&ac(function(){var b=new Rm(a);Sm(this,b)},this)};
function Sm(a,b){if(0==a.f)if(a.j){var c=a.j;if(c.h){for(var d=0,e=null,f=null,h=c.h;h&&(h.j||(d++,h.f==a&&(e=h),!(e&&1<d)));h=h.next)e||(f=h);e&&(0==c.f&&1==d?Sm(c,b):(f?(d=f,d.next==c.l&&(c.l=d),d.next=d.next.next):Tm(c),Um(c,e,3,b)))}a.j=null}else Mm(a,3,b)}
function Vm(a,b){a.h||2!=a.f&&3!=a.f||Wm(a);a.l?a.l.next=b:a.h=b;a.l=b}
function Qm(a,b,c,d){var e=Pm(null,null,null);e.f=new Lm(function(a,h){e.l=b?function(c){try{var e=b.call(d,c);a(e)}catch(n){h(n)}}:a;
...
function Mm(a,b,c){if(0==a.f){a==c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;var d;a:{var e=c,f=a.J,h=a.Y;if(e instanceof Lm)Vm(e,Pm(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ia(e))try{var l=e.then;if(ha(l)){Xm(e,l,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.B=c,a.f=b,a.j=null,Wm(a),3!=b||c instanceof Rm||Ym(a,c))}}
function Xm(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}
function h(a){k||(k=!0,c.call(e,a))}
var k=!1;try{b.call(a,h,f)}catch(l){f(l)}}
function Wm(a){a.A||(a.A=!0,ac(a.F,a))}
function Tm(a){var b=null;a.h&&(b=a.h,a.h=b.next,b.next=null);a.h||(a.l=null);return b}
Lm.prototype.F=function(){for(var a=null;a=Tm(this);)Um(this,a,this.f,this.B);this.A=!1};
function Um(a,b,c,d){if(3==c&&b.h&&!b.j)for(;a&&a.o;a=a.j)a.o=!1;if(b.f)b.f.j=null,Zm(b,c,d);else try{b.j?b.l.call(b.context):Zm(b,c,d)}catch(e){$m.call(null,e)}Xb(Om,b)}
function Zm(a,b,c){2==b?a.l.call(a.context,c):a.h&&a.h.call(a.context,c)}
function Ym(a,b){a.o=!0;ac(function(){a.o&&$m.call(null,b)})}
var $m=Tb;function Rm(a){qa.call(this,a)}
x(Rm,qa);Rm.prototype.name="cancel";function an(a,b){Hm.call(this);this.f=a||1;this.h=b||m;this.l=v(this.Ce,this);this.o=w()}
x(an,Hm);g=an.prototype;g.enabled=!1;g.ea=null;function bn(a,b){a.f=b;a.ea&&a.enabled?(a.stop(),a.start()):a.ea&&a.stop()}
...
;function dn(a,b,c){D.call(this);this.l=null!=c?v(a,c):a;this.j=b;this.h=v(this.ee,this);this.f=[]}
x(dn,D);g=dn.prototype;g.yb=!1;g.Qa=null;g.sd=function(a){this.f=arguments;this.Qa?this.yb=!0:en(this)};
g.stop=function(){this.Qa&&(m.clearTimeout(this.Qa),this.Qa=null,this.yb=!1,this.f=[])};
g.G=function(){dn.I.G.call(this);this.stop()};
g.ee=function(){this.Qa=null;this.yb&&(this.yb=!1,en(this))};
function en(a){a.Qa=cn(a.h,a.j);a.l.apply(null,a.f)}
;function fn(a){D.call(this);this.h=a;this.f={}}
x(fn,D);var gn=[];g=fn.prototype;g.rb=function(a,b,c,d){ea(b)||(b&&(gn[0]=b.toString()),b=gn);for(var e=0;e<b.length;e++){var f=wm(a,b[e],c||this.handleEvent,d||!1,this.h||this);if(!f)break;this.f[f.key]=f}return this};
...
ln=new mn;function on(a,b,c,d,e){this.f=a;this.j=c;this.F=d;this.B=e||1;this.o=45E3;this.l=new fn(this);this.h=new an;bn(this.h,250)}
g=on.prototype;g.Ia=null;g.na=!1;g.Wa=null;g.bc=null;g.gb=null;g.Va=null;g.Aa=null;g.Da=null;g.Ka=null;g.O=null;g.jb=0;g.oa=null;g.Cb=null;g.Ja=null;g.cb=-1;g.Nc=!0;g.Fa=!1;g.Sb=0;g.wb=null;var pn={},qn={};g=on.prototype;g.setTimeout=function(a){this.o=a};
function rn(a,b,c){a.Va=1;a.Aa=Dg(b.clone());a.Ka=c;a.A=!0;sn(a,null)}
function tn(a,b,c,d,e){a.Va=1;a.Aa=Dg(b.clone());a.Ka=null;a.A=c;e&&(a.Nc=!1);sn(a,d)}
function sn(a,b){a.gb=w();un(a);a.Da=a.Aa.clone();Bg(a.Da,"t",a.B);a.jb=0;a.O=a.f.Lb(a.f.ib()?b:null);0<a.Sb&&(a.wb=new dn(v(a.Sc,a,a.O),a.Sb));a.l.rb(a.O,"readystatechange",a.oe);var c=a.Ia?tb(a.Ia):{};a.Ka?(a.Cb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.O.send(a.Da,a.Cb,a.Ka,c)):(a.Cb="GET",a.Nc&&!ld&&(c.Connection="close"),a.O.send(a.Da,a.Cb,null,c));a.f.ma(1)}
...
function zn(a,b,c){for(var d=!0;!a.Fa&&a.jb<c.length;){var e=Cn(a,c);if(e==qn){4==b&&(a.Ja=4,X(),d=!1);break}else if(e==pn){a.Ja=4;X();d=!1;break}else An(a,e)}4==b&&0==c.length&&(a.Ja=1,X(),d=!1);a.na=a.na&&d;d||(yn(a),Bn(a))}
g.ne=function(){var a=vn(this.O),b=wn(this.O);this.jb<b.length&&(xn(this),zn(this,a,b),this.na&&4!=a&&un(this))};
function Cn(a,b){var c=a.jb,d=b.indexOf("\n",c);if(-1==d)return qn;c=Number(b.substring(c,d));if(isNaN(c))return pn;d+=1;if(d+c>b.length)return qn;var e=b.substr(d,c);a.jb=d+c;return e}
...
;function Kn(a){this.f=a;this.h=new Km(null,!0)}
g=Kn.prototype;g.Qb=null;g.da=null;g.xb=!1;g.Qc=null;g.nb=null;g.Vb=null;g.Rb=null;g.fa=null;g.ya=-1;g.bb=null;g.Xa=null;g.connect=function(a){this.Rb=a;a=Ln(this.f,null,this.Rb);X();this.Qc=w();var b=this.f.F;null!=b?(this.bb=b[0],(this.Xa=b[1])?(this.fa=1,Mn(this)):(this.fa=2,Nn(this))):(Bg(a,"MODE","init"),this.da=new on(this,0,void 0,void 0,void 0),this.da.Ia=this.Qb,tn(this.da,a,!1,null,!0),this.fa=0)};
function Mn(a){var b=Ln(a.f,a.Xa,"/mail/images/cleardot.gif");Dg(b);Hn(b.toString(),5E3,v(a.nd,a),3,2E3);a.ma(1)}
g.nd=function(a){if(a)this.fa=2,Nn(this);else{X();var b=this.f;b.ka=b.Ba.ya;On(b,9)}a&&this.ma(2)};
function Nn(a){var b=a.f.J;if(null!=b)X(),b?(X(),Pn(a.f,a,!1)):(X(),Pn(a.f,a,!0));else if(a.da=new on(a,0,void 0,void 0,void 0),a.da.Ia=a.Qb,b=a.f,b=Ln(b,b.ib()?a.bb:null,a.Rb),X(),!L||td(10))Bg(b,"TYPE","xmlhttp"),tn(a.da,b,!1,a.bb,!1);else{Bg(b,"TYPE","html");var c=a.da;a=Boolean(a.bb);c.Va=3;c.Aa=Dg(b.clone());Dn(c,a)}}
g.Lb=function(a){return this.f.Lb(a)};
g.tc=function(){return!1};
g.Bc=function(a,b){this.ya=a.cb;if(0==this.fa)if(b){try{var c=this.h.parse(b)}catch(d){c=this.f;c.ka=this.ya;On(c,2);return}this.bb=c[0];this.Xa=c[1]}else c=this.f,c.ka=this.ya,On(c,2);else if(2==this.fa)if(this.xb)X(),this.Vb=w();else if("11111"==b){if(X(),this.xb=!0,this.nb=w(),c=this.nb-this.Qc,!L||td(10)||500>c)this.ya=200,this.da.cancel(),X(),Pn(this.f,this,!0)}else X(),this.nb=this.Vb=w(),this.xb=!1};
g.sb=function(){this.ya=this.da.cb;if(this.da.na)0==this.fa?this.Xa?(this.fa=1,Mn(this)):(this.fa=2,Nn(this)):2==this.fa&&(a=!1,(a=!L||td(10)?this.xb:200>this.Vb-this.nb?!1:!0)?(X(),Pn(this.f,this,!0)):(X(),Pn(this.f,this,!1)));else{0==this.fa?X():2==this.fa&&X();var a=this.f;a.ka=this.ya;On(a,2)}};
g.ib=function(){return this.f.ib()};
g.isActive=function(){return this.f.isActive()};
g.ma=function(a){this.f.ma(a)};function Qn(a){Hm.call(this);this.headers=new Vc;this.R=a||null;this.h=!1;this.P=this.f=null;this.sa=this.J="";this.o=0;this.A="";this.l=this.ha=this.F=this.Z=!1;this.B=0;this.K=null;this.ta="";this.N=this.ua=!1}
x(Qn,Hm);var Rn=/^https?$/i,Sn=["POST","PUT"];g=Qn.prototype;
g.send=function(a,b,c,d){if(this.f)throw Error("[goog.net.XhrIo] Object is active with another request="+this.J+"; newUri="+a);b=b?b.toUpperCase():"GET";this.J=a;this.A="";this.o=0;this.sa=b;this.Z=!1;this.h=!0;this.f=this.R?nn(this.R):nn(ln);this.P=this.R?jn(this.R):jn(ln);this.f.onreadystatechange=v(this.Ac,this);try{em(Tn(this,"Opening Xhr")),this.ha=!0,this.f.open(b,String(a),!0),this.ha=!1}catch(f){em(Tn(this,"Error opening Xhr: "+f.message));Un(this,f);return}a=c||"";var e=this.headers.clone();
...
this.ta&&(this.f.responseType=this.ta);nb(this.f)&&(this.f.withCredentials=this.ua);try{Wn(this),0<this.B&&(this.N=Xn(this.f),em(Tn(this,"Will abort after "+this.B+"ms if incomplete, xhr2 "+this.N)),this.N?(this.f.timeout=this.B,this.f.ontimeout=v(this.sc,this)):this.K=cn(this.sc,this.B,this)),em(Tn(this,"Sending request")),this.F=!0,this.f.send(a),this.F=!1}catch(f){em(Tn(this,"Send error: "+f.message)),Un(this,f)}};
function Xn(a){return L&&sd(9)&&ga(a.timeout)&&p(a.ontimeout)}
function Vn(a){return"content-type"==a.toLowerCase()}
g.sc=function(){"undefined"!=typeof aa&&this.f&&(this.A="Timed out after "+this.B+"ms, aborting",this.o=8,Tn(this,this.A),Im(this,"timeout"),Gn(this,8))};
function Un(a,b){a.h=!1;a.f&&(a.l=!0,a.f.abort(),a.l=!1);a.A=b;a.o=5;Yn(a);Zn(a)}
function Yn(a){a.Z||(a.Z=!0,Im(a,"complete"),Im(a,"error"))}
function Gn(a,b){a.f&&a.h&&(Tn(a,"Aborting"),a.h=!1,a.l=!0,a.f.abort(),a.l=!1,a.o=b||7,Im(a,"complete"),Im(a,"abort"),Zn(a))}
...
function $n(a){if(a.h&&"undefined"!=typeof aa)if(a.P[1]&&4==vn(a)&&2==a.getStatus())Tn(a,"Local request error detected and ignored");else if(a.F&&4==vn(a))cn(a.Ac,0,a);else if(Im(a,"readystatechange"),4==vn(a)){Tn(a,"Request complete");a.h=!1;try{var b=a.getStatus(),c;a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=String(a.J).match(Ed)[1]||null;if(!f&&m.self&&m.self.location)var h=m.self.location.protocol,
f=h.substr(0,h.length-1);e=!Rn.test(f?f.toLowerCase():"")}d=e}if(d)Im(a,"complete"),Im(a,"success");else{a.o=6;var k;try{k=2<vn(a)?a.f.statusText:""}catch(l){k=""}a.A=k+" ["+a.getStatus()+"]";Yn(a)}}finally{Zn(a)}}}
function Zn(a,b){if(a.f){Wn(a);var c=a.f,d=a.P[0]?t:null;a.f=null;a.P=null;b||Im(a,"ready");try{c.onreadystatechange=d}catch(e){}}}
...
;function ao(a,b,c){this.B=a||null;this.f=1;this.h=[];this.l=[];this.o=new Km(null,!0);this.F=b||null;this.J=null!=c?c:null}
function bo(a,b){this.f=a;this.map=b;this.context=null}
g=ao.prototype;g.$a=null;g.W=null;g.L=null;g.Pb=null;g.ob=null;g.ic=null;g.pb=null;g.fb=0;g.Hd=0;g.T=null;g.Ca=null;g.xa=null;g.Ha=null;g.Ba=null;g.Bb=null;g.Ra=-1;g.uc=-1;g.ka=-1;g.ab=0;g.Pa=0;g.Ga=8;var co=new Hm;function eo(a){gm.call(this,"statevent",a)}
x(eo,gm);function fo(a,b){gm.call(this,"timingevent",a);this.size=b}
x(fo,gm);function go(a){gm.call(this,"serverreachability",a)}
x(go,gm);g=ao.prototype;g.connect=function(a,b,c,d,e){X();this.Pb=b;this.$a=c||{};d&&p(e)&&(this.$a.OSID=d,this.$a.OAID=e);this.Ba=new Kn(this);this.Ba.Qb=null;this.Ba.h=this.o;this.Ba.connect(a)};
function ho(a){io(a);if(3==a.f){var b=a.fb++,c=a.ob.clone();O(c,"SID",a.j);O(c,"RID",b);O(c,"TYPE","terminate");jo(a,c);b=new on(a,0,a.j,b,void 0);b.Va=2;b.Aa=Dg(c.clone());(new Image).src=b.Aa;b.gb=w();un(b)}ko(a)}
...
function oo(a,b){if(1==a.f){if(!b){a.fb=Math.floor(1E5*Math.random());var c=a.fb++,d=new on(a,0,"",c,void 0);d.Ia=null;var e=po(a),f=a.ob.clone();O(f,"RID",c);a.B&&O(f,"CVER",a.B);jo(a,f);rn(d,f,e);a.W=d;a.f=2}}else 3==a.f&&(b?qo(a,b):0!=a.h.length&&(a.W||qo(a)))}
function qo(a,b){var c,d;b?6<a.Ga?(a.h=a.l.concat(a.h),a.l.length=0,c=a.fb-1,d=po(a)):(c=b.F,d=b.Ka):(c=a.fb++,d=po(a));var e=a.ob.clone();O(e,"SID",a.j);O(e,"RID",c);O(e,"AID",a.Ra);jo(a,e);c=new on(a,0,a.j,c,a.ab+1);c.Ia=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.W=c;rn(c,e,d)}
...
g.Ec=function(){this.xa=null;this.L=new on(this,0,this.j,"rpc",this.A);this.L.Ia=null;this.L.Sb=0;var a=this.ic.clone();O(a,"RID","rpc");O(a,"SID",this.j);O(a,"CI",this.Bb?"0":"1");O(a,"AID",this.Ra);jo(this,a);if(!L||td(10))O(a,"TYPE","xmlhttp"),tn(this.L,a,!0,this.pb,!1);else{O(a,"TYPE","html");var b=this.L,c=Boolean(this.pb);b.Va=3;b.Aa=Dg(a.clone());Dn(b,c)}};
...
function On(a,b){if(2==b||9==b){var c=null;a.T&&(c=null);var d=v(a.Be,a);c||(c=new kg("//www.google.com/images/cleardot.gif"),Dg(c));In(c.toString(),1E4,d)}else X();uo(a,b)}
...
function Ln(a,b,c){var d=Eg(c);if(""!=d.h)b&&mg(d,b+"."+d.h),ng(d,d.B);else var e=window.location,d=Fg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.$a&&eb(a.$a,function(a,b){O(d,b,a)});
...
g.ma=function(){Im(co,new go(co))};
function X(){Im(co,new eo(co))}
...
g.isActive=function(){return!0};function wo(a,b){an.call(this);this.A=0;if(ha(a))b&&(a=v(a,b));else if(a&&ha(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.F=a;wm(this,"tick",v(this.B,this));this.stop();bn(this,5E3+2E4*Math.random())}
x(wo,an);wo.prototype.B=function(){if(500<this.f){var a=this.f;24E4>2*a&&(a*=2);bn(this,a)}this.F()};
...
g.mc=function(){var a=this.h;a.stop();bn(a,5E3+2E4*Math.random());this.A=null;this.o=0;if(this.B.length){a=this.B;this.B=[];for(var b=0,c=a.length;b<c;++b)mo(this.f,a[b])}this.D("handlerOpened")};
g.kc=function(a,b){var c=2==b&&401==this.f.ka;if(4!=b&&!c){if(6==b||410==this.f.ka)c=this.h,c.stop(),bn(c,500);this.h.start()}this.D("handlerError",b)};
...
g.lc=function(a,b){if("S"==b[0])this.J=b[1];else if("gracefulReconnect"==b[0]){var c=this.h;c.stop();bn(c,500);this.h.start();ho(this.f)}else this.D("handlerMessage",new dm(b[0],b[1]))};
...
this.Md,this);Ao(this.f,b.token);this.subscribe("remoteQueueChange",function(){var a=this.C.videoId;tk()&&T("yt-remote-session-video-id",a)},this)}
x(Y,V);g=Y.prototype;
...
a,xk())}else this.H("Connecting without params"),this.f.connect({},a,xk());Jo(this)};
g.dispose=function(){this.isDisposed()||(this.D("beforeDispose"),Ko(this,3));Y.I.dispose.call(this)};
g.G=function(){Lo(this);Mo(this);No(this);J(this.F);this.F=NaN;J(this.J);this.J=NaN;this.j=null;Te(this.Z);this.Z.length=0;this.f.dispose();Y.I.G.call(this);this.h=this.C=this.f=null};
g.H=function(a){Gj("conn",a)};
g.Bd=function(){this.o(2)};
function Io(a,b){return new xo(Uj(a.Ma,"/bc",void 0,!1),b)}
...
Gk(zo(this.f),this.ha)};
g.Jd=function(){this.H("Channel closed");isNaN(this.A)?Hk(!0):Hk();this.dispose()};
g.Kd=function(a){Hk();isNaN(this.B())?(this.H("Channel error: "+a+" without reconnection"),this.dispose()):(this.R=!0,this.H("Channel error: "+a+" with reconnection in "+this.B()+" ms"),Ko(this,2))};
function Ro(a,b){b&&(Lo(a),No(a));b==Qo(a)?b&&(Ko(a,1),Po(a,"getSubtitlesTrack")):b?(a.N()&&a.C.reset(),Ko(a,1),Po(a,"getNowPlaying"),So(a)):a.o(1)}
function To(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.C.videoId&&(qb(b.params)?a.C.j=null:a.C.j=b.params,a.D("remotePlayerChange"))}
...
Ro(this,!1);break;case "remoteConnected":var b=new ok(wd(a.params.device));Qa(this.h,function(a){return a.equals(b)})||Ua(this.h,b);
...
function Yo(a,b){switch(b.action){case "loungeStatus":var c=wd(b.params.devices);a.h=z(c,function(a){return new ok(a)});
...
Y.prototype.getProxyState=Y.prototype.ta;Y.prototype.o=function(a){this.H("Disconnecting with "+a);Lo(this);this.D("beforeDisconnect",a);1==a&&Hk();yo(this.f,a);this.dispose()};
...
Y.prototype.sendMessage=Y.prototype.ua;function $o(a){V.call(this);this.o=0;this.la=ap();this.Za=NaN;this.vb="";this.A=a;this.H("Initializing local screens: "+Rj(this.la));this.j=bp();this.H("Initializing account screens: "+Rj(this.j));this.Kb=null;this.f=[];this.h=[];cp(this,Zl()||[]);this.H("Initializing DIAL devices: "+Yj(this.h));a=Pj(Dk());dp(this,a);this.H("Initializing online screens: "+Rj(this.f));this.o=w()+3E5;ep(this)}
x($o,V);var fp=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=$o.prototype;g.H=function(a){Gj("RM",a)};
g.M=function(a){Gj("RM",a)};
function bp(){var a=ap(),b=Pj(Dk());return Na(b,function(b){return!gk(a,b)})}
function ap(){var a=Pj(zk());return Na(a,function(a){return!a.f})}
function ep(a){xc("yt-remote-cast-device-list-update",function(){var a=Zl();cp(this,a||[])},a);
...
g.Lc=function(){var a=Zl()||[];0==a.length||cp(this,a);a=gp(this);0==a.length||(Oa(a,function(a){return!gk(this.j,a)},this)&&Bk()?hp(this):ip(this,a))};
function kp(a,b){var c=gp(a);return Na(b,function(a){return a.f?(a=fk(this.h,a.f),!!a&&"RUNNING"==a.status):!!gk(c,a)},a)}
function cp(a,b){var c=!1;y(b,function(a){var b=hk(this.la,a.id);b&&b.name!=a.name&&(this.H("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
c&&(a.H("Renaming due to DIAL."),lp(a));Ek(ck(b));var d=!bb(a.h,b,ek);d&&a.H("Updating DIAL devices: "+Yj(a.h)+" to "+Yj(b));a.h=b;dp(a,a.f);d&&a.D("onlineReceiverChange")}
g.Ee=function(a){var b=fk(this.h,a.id);b&&(this.H("Updating DIAL device: "+b.id+"("+b.name+") from status: "+b.status+" to status: "+a.status+" and from activityId: "+b.f+" to activityId: "+a.f),b.f=a.f,b.status=a.status,Ek(ck(this.h)));dp(this,this.f)};
function dp(a,b,c){var d=kp(a,b),e=!bb(a.f,d,Mj);if(e||c)0==b.length||Ck(z(d,Nj));e&&(a.H("Updating online screens: "+Rj(a.f)+" -> "+Rj(d)),a.f=d,a.D("onlineReceiverChange"))}
...
var e=this.Kb?mp(this,this.Kb):null;e&&!gk(c,e)&&c.push(e);dp(this,c,!0)}};
Xd(Uj(a.A,"/pairing/get_screen_availability"),e)}
function hp(a){var b=gp(a),c=z(b,function(a){return a.id});
0!=c.length&&(a.H("Updating lounge tokens for: "+M(c)),Xd(Uj(a.A,"/pairing/get_lounge_token_batch"),{S:{screen_ids:c.join(",")},method:"POST",context:a,ca:function(a,c){np(this,c.screens||[]);this.la=Na(this.la,function(a){return!!a.token});
lp(this);ip(this,b)}}))}
function np(a,b){y(Xa(a.la,a.j),function(a){var d=Qa(b,function(b){return a.id==b.screenId});
d&&(a.token=d.loungeToken)})}
function lp(a){var b=ap();bb(a.la,b,Mj)||(a.H("Saving local screens: "+Rj(b)+" to "+Rj(a.la)),yk(z(a.la,Nj)),dp(a,a.f,!0),cp(a,Zl()||[]),a.D("managedScreenChange",gp(a)))}
function op(a,b,c){var d=Ra(b,function(a){return Lj(c,a)}),e=0>d;
...
return d};
g.Hc=function(a,b,c){var d=!1;b>=fp.length&&(this.H("Pairing DIAL device "+a+" with "+c+" timed out."),d=!0);var e=fk(this.h,a);if(!e)this.H("Pairing DIAL device "+a+" with "+c+" failed: no device for "+a),d=!0;else if("ERROR"==e.status||"STOPPED"==e.status)this.H("Pairing DIAL device "+a+" with "+c+" failed: launch error on "+a),d=!0;d?(pp(this),this.D("screenPair",null)):Xd(Uj(this.A,"/pairing/get_screen"),{method:"POST",S:{pairing_code:c},context:this,ca:function(a,b){if(c==this.vb){pp(this);var d=
new Jj(b.screen);d.name=e.name;d.f=e.id;this.H("Pairing "+c+" succeeded.");var l=op(this,this.la,d);this.H("Paired with "+(l?"a new":"an old")+" local screen:"+Qj(d));lp(this);this.D("screenPair",d)}},
onError:function(){c==this.vb&&(this.H("Polling pairing code: "+c),J(this.Za),this.Za=I(v(this.Hc,this,a,b+1,c),fp[b]))}})};
function qp(a,b,c){var d=Z,e="";pp(d);if(fk(d.h,a)){if(!e){var f=e=Zj();Sl();var h=am(a),k=Pl();if(k&&h){var l=new cast.Receiver(h.id,h.name),l=new cast.LaunchRequest("YouTube",l);l.parameters="pairingCode="+f;l.description=new cast.LaunchDescription;l.description.text=document.title;b&&(l.parameters+="&v="+b,c&&(l.parameters+="&t="+Math.round(c)),l.description.url="http://i.ytimg.com/vi/"+b+"/default.jpg");"UNKNOWN"!=h.status&&(h.status="UNKNOWN",Xl(h),K("yt-remote-cast-device-status-update",h));
Nl("Sending a cast launch request with params: "+l.parameters);k.launch(l,pa(bm,a))}else Nl("No cast API or no cast device. Dropping cast launch.")}d.vb=e;d.Za=I(v(d.Hc,d,a,0,e),fp[0])}else d.H("No DIAL device with id: "+a)}
function pp(a){J(a.Za);a.Za=NaN;a.vb=""}
function mp(a,b){var c=hk(gp(a),b);a.H("Found screen: "+Qj(c)+" with key: "+b);return c}
function rp(a){var b=Z,c=hk(b.f,a);b.H("Found online screen: "+Qj(c)+" with key: "+a);return c}
function sp(a){var b=Z,c=fk(b.h,a);if(!c){var d=hk(b.la,a);d&&(c=fk(b.h,d.f))}b.H("Found DIAL: "+(c?c.toString():"null")+" with key: "+a);return c}
function gp(a){return Xa(a.j,Na(a.la,function(a){return!gk(this.j,a)},a))}
;function tp(a){ik.call(this,"ScreenServiceProxy");this.V=a;this.f=[];this.f.push(this.V.$_s("screenChange",v(this.Me,this)));this.f.push(this.V.$_s("onlineScreenChange",v(this.Td,this)))}
x(tp,ik);g=tp.prototype;g.$=function(a){return this.V.$_gs(a)};
...
Dp.push(xc("yt-remote-cast2-session-change",Fp));Dp.push(xc("yt-remote-connection-change",function(a){a?Kl(Bp(),"YouTube TV"):Gp()||(Kl(null,null),Gl())}));
...
Z&&(E(Z),Z=null);vp=null;Wl()}
function Mp(){if(Np()&&El()){var a=[];if(U("yt-remote-cast-available")||r("yt.mdx.remote.cloudview.castButtonShown_")||Op())a.push({key:"cast-selector-receiver",name:Pp()}),q("yt.mdx.remote.cloudview.castButtonShown_",!0,void 0);return a}return r("yt.mdx.remote.cloudview.initializing_")?[]:Qp()}
function Qp(){var a=[],a=Rp()?Ap().V.$_gos():Pj(Dk()),b=Sp();b&&Op()&&(gk(a,b)||a.push(b));Rp()||(b=dk(Fk()),b=Na(b,function(b){return!hk(a,b.id)}),a=Xa(a,b));
return bk(a)}
function Tp(){if(Np()&&El()){var a=Fl();return a?{key:"cast-selector-receiver",name:a}:null}return Up()}
function Up(){var a=Qp(),b=Vp(),c=Sp();c||(c=Gp());return Qa(a,function(a){return c&&Kj(c,a.key)||b&&(a=sp(a.key))&&a.id==b?!0:!1})}
function Pp(){if(Np()&&El())return Fl();var a=Sp();return a?a.name:null}
function Sp(){var a=Bp();if(!a)return null;if(!Z){var b=Ap().$();return hk(b,a)}return mp(Z,a)}
function Fp(a){Cp("remote.onCastSessionChange_: "+Qj(a));if(a){var b=Sp();b&&b.id==a.id?Kl(b.id,"YouTube TV"):(b&&Wp(),Xp(a,1))}else Wp()}
function Yp(a,b){Cp("Connecting to: "+M(a));if("cast-selector-receiver"==a.key)Ep(b||null),Jl(b||null);else{Wp();Ep(b||null);var c=null;Z?c=rp(a.key):(c=Ap().$(),c=hk(c,a.key));if(c)Xp(c,1);else{if(Z&&(c=sp(a.key))){Zp(c);return}I(function(){$p(null)},0)}}}
function Wp(){Z&&pp(Z);a:{var a=Op();if(a&&(a=a.getOtherConnectedRemoteId())){Cp("Do not stop DIAL due to "+a);aq("");break a}(a=Vp())?(Cp("Stopping DIAL: "+a),cm(a),aq("")):(a=Sp())&&a.f&&(Cp("Stopping DIAL: "+a.f),cm(a.f))}Il()?Al().stopSession():xl("stopSession called before API ready.");(a=Op())?a.disconnect(1):(Ac("yt-remote-before-disconnect",1),Ac("yt-remote-connection-change",!1));$p(null)}
function Cp(a){Gj("remote",a)}
...
function bq(a){q("yt.mdx.remote.currentScreenId_",a,void 0);if(Z){var b=Z;b.o=w()+3E5;if((b.Kb=a)&&(a=mp(b,a))&&!gk(b.f,a)){var c=Ya(b.f);c.push(a);dp(b,c,!0)}}}
...
function Gp(){var a=tk();if(!a)return null;if(Rp()){var b=Ap().$();return hk(b,a)}return Z?mp(Z,a):null}
...
function Jp(){var a=Gp();a?(Cp("Resume connection to: "+Qj(a)),Xp(a,0)):(Hk(),Gl(),Cp("Skipping connecting because no session screen found."))}
function wp(a){Cp("Paired with: "+Qj(a));a?Xp(a,1):$p(null)}
function xp(){var a=Bp();a&&!Sp()&&(Cp("Dropping current screen with id: "+a),Wp());Gp()||Hk()}
var vp=null,yp=null,Lp=null,Z=null;function zp(a){var b=Hp();if(qb(b)){var b=sk(),c=U("yt-remote-session-name")||"",d=U("yt-remote-session-app")||"",b={device:"REMOTE_CONTROL",id:b,name:c,app:d};a&&(b["mdx-version"]=3);q("yt.mdx.remote.channelParams_",b,void 0)}}
function Hp(){return r("yt.mdx.remote.channelParams_")||{}}
function Ip(a){a?(T("yt-remote-session-app",a.app),T("yt-remote-session-name",a.name)):(aj("yt-remote-session-app"),aj("yt-remote-session-name"));q("yt.mdx.remote.channelParams_",a,void 0)}
...
function hq(a){"cast-selector-receiver"==a?Hl():iq(a)}
function iq(a){var b=Mp();if(a=ak(b,a)){var c=dq,d=c.getVideoData().video_id,e=c.getVideoData().list,f=c.getCurrentTime();Yp(a,{videoIds:[d],listId:e,videoId:d,index:0,currentTime:f});"html5"!=c.getPlayerType()?c.loadNewVideoConfig(c.getCurrentVideoConfig(),"html5"):c.updateRemoteReceivers&&c.updateRemoteReceivers(b,a)}}
...
function nq(a){li()?(R(Zh,new Th(a.externalChannelId,a.Gd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Ld({event:"subscribe",source:a.source}))&&Og(a)):oq(a)}
function oq(a){ki(function(b){b.subscription_ajax&&nq(a)},null)}
function pq(a){a=lq(a);R(di,new Vh(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Ld({event:"unsubscribe",source:a.source}))&&Og(a)}
...
function vq(a,b){switch(a){case "loadVideoById":return b=fj(b),hj(b),[b];case "cueVideoById":return b=fj(b),hj(b),[b];case "loadVideoByPlayerVars":return hj(b),[b];case "cueVideoByPlayerVars":return hj(b),[b];case "loadPlaylist":return b=gj(b),hj(b),[b];case "cuePlaylist":return b=gj(b),hj(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
xq.prototype.G=function(){xq.I.G.call(this);delete this.f};function yq(){var a=this.h=new Ji,b=v(this.pe,this);a.h=b;a.j=null;this.l=[];this.B=!1;this.o=(a=G("POST_MESSAGE_ORIGIN",void 0))&&Jg(a)?a:null;this.A={}}
...
Dq.prototype.G=function(){Te(this.l);this.f=null;Dq.I.G.call(this)};var Eq=!1;function Fq(a){if(a=a.match(/[\d]+/g))a.length=3,a.join(".")}
...
(function(){if(xf)return Gq(/Firefox\/([0-9.]+)/);if(L||jd||id)return qd;if(Bf)return Gq(/Chrome\/([0-9.]+)/);if(Cf&&!(hd()||B("iPad")||B("iPod")))return Gq(/Version\/([0-9.]+)/);if(yf||zf){var a;if(a=/Version\/(\S+).*Mobile\/(\S+)/.exec(xb))return a[1]+"."+a[2]}else if(Af)return(a=Gq(/Android\s+([0-9.]+)/))?a:Gq(/Version\/([0-9.]+)/);return""})();function Hq(){var a={format:"RAW",method:"GET",withCredentials:!0};return new Lm(function(b,c){a.ca=function(a){Sd(a)?b(a):c(a)};
a.onError=c;Xd("//googleads.g.doubleclick.net/pagead/id",a)})}
;var Iq=null;function Jq(){if(!Iq){var a=Hq().then(Kq),b=Lq,b=Pm(b,b,void 0);b.j=!0;Vm(a,b);Iq=a}return Iq}
function Kq(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw Error("Response improperly formatted");return JSON.parse(a.substr(4)).id}
function Lq(){I(function(){Iq=null},3E5)}
;function Mq(a){Nq=a;q("yt.www.ads.data.encryptedBiscottiId",Nq,void 0)}
var Nq="";function Oq(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&Og(c)}}
...
x(Tq,P);var Uq=new Q("ypc-core-load",Pq),Vq=new Q("ypc-guide-sync-success",Qq),Wq=new Q("ypc-purchase-success",Rq),Xq=new Q("ypc-subscription-cancel",Tq),Yq=new Q("ypc-subscription-cancel-success",Sq),Zq=new Q("ypc-init-subscription",Tq);var $q=!1,ar=[],br=[];function cr(a){a.f?$q?R(ci,a):R(Uq,new Pq(function(){R(Zq,new Tq(a.f))})):dr(a.h,a.l,a.j,a.source)}
function er(a){a.f?$q?R(hi,a):R(Uq,new Pq(function(){R(Xq,new Tq(a.f))})):fr(a.h,a.subscriptionId,a.l,a.j,a.source)}
function gr(a){hr(Ya(a.f))}
function ir(a){jr(Ya(a.f))}
function kr(a){lr(a.f,a.isEnabled,null)}
function mr(a,b,c,d){lr(a,b,c,d)}
function nr(a){var b=a.h,c=a.f.subscriptionId;b&&c&&R(bi,new Uh(b,c,a.f.channelInfo))}
function or(a){var b=a.f;eb(a.h,function(a,d){R(bi,new Uh(d,a,b[d]))})}
function pr(a){R(gi,new Rh(a.h.itemId));a.f&&a.f.length&&(qr(a.f,gi),qr(a.f,ii))}
function dr(a,b,c,d){var e=new Rh(a);R($h,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&rr(b,c);Xd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",ac:f,S:c,ca:function(b,c){var d=c.response;R(bi,new Uh(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&K("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Oq(d.actions)},
Xb:function(){R(ai,e)}})}
function fr(a,b,c,d,e){var f=new Rh(a);R(ei,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&rr(c,d);Xd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",ac:h,S:d,ca:function(a,b){var c=b.response;R(gi,f);c.actions&&Oq(c.actions)},
Xb:function(){R(fi,f)}})}
function lr(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);Xd("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",S:e,onError:function(){d&&d()}})}}
function hr(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-subscribe-loading");qr(b,$h);var c={};c.a=b.join(",");var d=function(){R("subscription-batch-subscribe-loaded");qr(b,ai)};
...
function jr(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-unsubscribe-loading");qr(b,ei);var c={};c.c=b.join(",");var d=function(){R("subscription-batch-unsubscribe-loaded");qr(b,fi)};
Xd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",S:c,ca:function(){d();qr(b,gi);a.length&&jr(a)},
onError:function(){d()}})}}
function qr(a,b){y(a,function(a){R(b,new Rh(a))})}
function rr(a,b){var c=Od(a),d;for(d in c)b[d]=c[d]}
;var sr,tr=null,ur=null,vr=null,wr=!1;
function xr(){var a=G("PLAYER_CONFIG",void 0),b=G("REVERSE_MOBIUS_PERCENT",void 0);if(eg&&100*Math.random()<b)try{var c=r("yt.www.ads.biscotti");(c?c.getId():Jq()).then(Mq)}catch(e){pc(e)}if(G("REQUEST_POST_MESSAGE_ORIGIN")){if(!sr){sr=new Ji;sr.f=xr;return}sr.origin&&"*"!=sr.origin&&(a.args.post_message_origin=sr.origin)}var d=document.referrer,b=G("POST_MESSAGE_ORIGIN"),c=!1;u(d)&&u(b)&&-1<d.indexOf(b)&&Jg(b)&&Jg(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);G("LIGHTWEIGHT_AUTOPLAY")&&
(a.args.autoplay="1");a.args.autoplay&&hj(a.args);tr=Eh("player",a);d=G("POST_MESSAGE_ID","player");G("ENABLE_JS_API")?vr=new Bq(tr):G("ENABLE_POST_API")&&u(d)&&u(b)&&(ur=new Dq(window.parent,d,b),vr=new xq(tr,ur.h));(wr=c&&!G("ENABLE_CAST_API"))?a.args.disableCast="1":(a=tr,up(),dq=a,dq.addEventListener("onReady",fq),dq.addEventListener("onRemoteReceiverSelected",hq),eq.push(xc("yt-remote-receiver-availability-change",gq)),eq.push(xc("yt-remote-auto-connect",iq)));G("BG_P")&&(G("BG_I")||G("BG_IU"))&&
Mc();he();jq=tr;jq.addEventListener("SUBSCRIBE",mq);jq.addEventListener("UNSUBSCRIBE",pq);kq.push(Wg(bi,qq),Wg(gi,rq))}
...
q("writeEmbed",xr,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a=a+"mac_204?action_fcts=1")&&Og(a);return!0},void 0);
var yr=nc(function(){bh("ol");$q=!0;br.push(Wg(Zh,cr),Wg(di,er));$q||(br.push(Wg(ci,cr),Wg(hi,er),Wg(Wh,gr),Wg(Xh,ir),Wg(Yh,kr)),ar.push(xc("subscription-prefs",mr)),br.push(Wg(Wq,nr),Wg(Yq,pr),Wg(Vq,or)));Df.getInstance();var a=1<window.devicePixelRatio;if(If(0,119)!=a){var b="f"+(Math.floor(119/31)+1),c=Hf(b)||0,c=a?c|67108864:c&-67108865;0==c?delete Ef[b]:(a=c.toString(16),Ef[b]=a.toString());var d,b=[];for(d in Ef)b.push(d+"="+escape(Ef[d]));d=b.join("&");cf("PREF",d,63072E3)}}),zr=nc(function(){var a=
tr;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();G("PL_ATT")&&(Lc=null);for(var a=0,b=fe.length;a<b;a++){var c=fe[a],d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}fe.length=0;a=Hc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Cc(a),b.parentNode.removeChild(b);ge=!1;lc("DCLKSTAT",0);zc(ar);ar.length=0;Xg(br);br.length=0;$q=!1;jq&&(jq.removeEventListener("SUBSCRIBE",nq),jq.removeEventListener("UNSUBSCRIBE",pq));jq=null;Xg(kq);kq.length=0;wr||(zc(eq),eq.length=
...
window.addEventListener?(window.addEventListener("load",yr),window.addEventListener("unload",zr)):window.attachEvent&&(window.attachEvent("onload",yr),window.attachEvent("onunload",zr));var Ar=Di.getInstance(),Br=ri(Ar);Br in Ii||(Ar.register(),Ar.Jc.push(xc("yt-uix-init-"+Br,Ar.init,Ar)),Ar.Jc.push(xc("yt-uix-dispose-"+Br,Ar.dispose,Ar)),Ii[Br]=Ar);})();
