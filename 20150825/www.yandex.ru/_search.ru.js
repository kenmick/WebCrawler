...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("0stojGZ9afUFBc5avCV9l5z9W2o")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("content"===e)return fe(t);if(""===e)return ye(t);if("bem"===e)return Ee(t);if("value"===e){var e=n;
return"input"===e?xe(t):"tumbler"===e&&"option"===s?Se(t):qe(t)}if("js"===e)return ue(t);if("live"===e)return"input"===n&&!!s==!1?Ie(t):qe(t);
if("auto-content"===e)return"auth"===n?Pe(t):qe(t);if("action"===e)return"auth"===n&&!!s==!1?Oe(t):qe(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Ae(t):"ticker"===e?je(t):qe(t)}return qe(t)
...
}return qe(t)}return"mix"===e?he(t):"env"===e?"i-global"===n?Re(t):qe(t):"default"===e?C(t):"jsAttr"===e?Le(t):"tag"===e?w(t):"cls"===e?Ne(t):"getLive"===e&&"input"===n&&!!s==!1?De(t):qe(t)
...
for(c.url&&(h.src=c.url);a=l.shift();)c[a]&&(h[a]=c[a]);return h}return E(t)}if("suggest2-item"===e){var e=s;
return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:E(t)}if("auth"===e){var e=s;
if("social-link"===e)return{role:"button",tabindex:0,title:t.ctx.title,"aria-label":t.ctx.title};if("social"===e)return{role:"group","aria-label":BEM.I18N("auth","social-log-in")};
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var f,_;return{method:"POST",action:t.ctx.url||(f=i,i="action",_=Oe(t),i=f,_),role:"form","aria-label":BEM.I18N("auth","auth")}
}return E(t)}if("checkbox"===e){var e=s;if("control"===e){var m=t.ctx.attrs||{};return m.id=t._checkboxAttrs.id,m.type="checkbox",m.autocomplete="off",r.disabled&&(m.disabled="disabled"),"yes"==r.checked&&(m.checked="checked"),m["aria-labelledby"]=t._labelId,m
}if("label"===e){var k=t.ctx.attrs||{};return k["for"]=t._checkboxAttrs.id,k.id=t._labelId,k["aria-hidden"]=!0,k
}return E(t)}if("select"===e){var e=s;return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?u(t):"list"===e?d(t):E(t)
}if("input"===e){var e=s;if("hint"===e)return{id:t._hintId,"for":t._inputId,"aria-hidden":!0};if("control"===e){var M=t.extend({id:t._inputId,name:t._name,placeholder:t._placeholder},t.ctx.controlAttrs);
return(t._value||0===t._value)&&(M.value=t._value),r.disabled&&(M.disabled="disabled"),t._live&&(M.autocomplete="off"),M["aria-labelledby"]=t._labelId+" "+t._hintId,M
}return E(t)}if("notice"===e)return"count"===s&&!t.ctx.url==!1?{href:t.ctx.url}:E(t);if("ticker"===e)return"value"===s?{title:t._count}:E(t);
if("tumbler"===e){var e=s;if("sticker"===e)return g(t);if("text"===e)return b(t);if("input"===e){var w,x=o.side;
return w="left"===x?t._checked?void 0:"checked":t._checked,{type:"radio",name:t.ctx.name,value:t.ctx.value,checked:w,disabled:t.ctx.disabled,"aria-labelledby":"left"===x?t._leftId:t._rightId}
}return"button"===e?v(t):E(t)}return"link"===e?y(t):"button"===e?p(t):E(t)}function u(t){if(!(t.__$anflg31!==!0)==!1){var e,i,n=(e=t.__$anflg31,t.__$anflg31=!0,i=u(t),t.__$anflg31=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function d(t){if(!(t.__$anflg30!==!0)==!1){var e,i,n=(e=t.__$anflg30,t.__$anflg30=!0,i=d(t),t.__$anflg30=e,i||{});
return n.role="select",n}return E(t)}function p(t){if(!(t.__$anflg21!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;
return t.extend((e=t.__$anflg21,t.__$anflg21=!0,i=p(t),t.__$anflg21=e,i),{onmousedown:t.ctx.counter})
}return f(t)}return f(t)}return f(t)}function f(t){if(!(t.__$anflg20!==!0)==!1){if(!!s==!1){if(!!t.ctx.url==!1){var e,i,n=t.ctx,o=(e=t.__$anflg20,t.__$anflg20=!0,i=p(t),t.__$anflg20=e,i),r={type:n.type||"button",name:n.name,value:n.value};
return t.extend(o,r)}return _(t)}return _(t)}return _(t)}function _(t){if(!(t.__$anflg19!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg19,t.__$anflg19=!0,i=p(t),t.__$anflg19=e,i),r={href:n.url,target:n.target};
return t.extend(o,r)}return m(t)}return m(t)}return m(t)}function m(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return i.tabindex=e.tabindex,i}return E(t)}function g(t){if(!(t.__$anflg11!==!0)==!1){var e,i,n=(e=t.__$anflg11,t.__$anflg11=!0,i=g(t),t.__$anflg11=e,i||{});
...
}),n)if(t.isSimple(n))s.href=n;else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,ke(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
}else s.role="button",s.tabindex||(s.tabindex=0);return s}function E(){return void 0}function w(t){var e=n;
if("b-icon"===e)return!!s==!1?"img":B(t);if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":B(t)
...
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":B(t)}if("checkbox"===e){var e=s;
return"control"===e?"input":"label"===e?"label":!!s==!1?"span":B(t)}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":B(t):"a11y"===e?"span":"items"===e?"ul":B(t)
}if("input"===e){var e=s;return"box"===e?"span":"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":B(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":B(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":B(t)}if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":B(t)
}return"link"===e?"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":B(t):"button"===e?!t.ctx.url==!1&&!!s==!1?"a":x(t):B(t)
}function x(t){return!!s==!1?"button":B(t)}function B(){return void 0}function C(t){var e=n;if("select"===e)return S(t);
if("popup"===e)return A(t);if("suggest2-item"===e){var e=s;return"icon"===e?R(t):"fact"===e?q(t):qe(t)
}return"dropdown"===e?"popup"===s&&!(t.__$anflg23!==!0)==!1?$(t):qe(t):"checkbox"===e?F(t):"button"===e?U(t):"input"===e?z(t):"auth"===e?Q(t):"tumbler"===e?Z(t):"i-global"===e?ae(t):qe(t)
}function S(t){return"group"===s?D(t):I(t)}function D(t){if(!(t.__$anflg32!==!0)==!1){var e=t.__$anflg32;
t.__$anflg32=!0;var i=t._labelId;return t._labelId=t.generateId(),D(t),t._labelId=i,void(t.__$anflg32=e)
}return I(t)}function I(t){return!(t.__$anflg28!==!0&&t.__$anflg29!==!0)==!1&&!!s==!1?P(t):T(t)}function P(t){var e,n,s,o,r,a,c,h=t.ctx,l=(e=i,i="js",n=de(t),i=e,n||{}).live;
if(l){var u=h.content.filter(function(t){return"control"===t.elem})[0].content;if(u.length){var d=function(t){for(var e,i,n=0;n<t.length&&(e=t[n],"option"===e.elem&&Object(e.attrs).selected?i=e:"option-group"===e.elem&&(i=d(e.content)),!i);n++);return i
},p=d(u);return p||(p=u[0],"option-group"===p.elem&&(p=p.content[0])),s=t.__$anflg28,t.__$anflg28=!0,r=t._initValue,t._initValue=p.attrs.value,a=t._initText,t._initText=p.content,c=S(t),t._initValue=r,t._initText=a,o=c,t.__$anflg28=s,o
}}var f=t.__$anflg29;t.__$anflg29=!0,S(t),t.__$anflg29=f}function T(t){return!(t.__$anflg27!==!0)==!1&&!!s==!1?O(t):qe(t)
}function O(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg27;t.__$anflg27=!0;var o=t._controlAttrs;
t._controlAttrs={id:i,name:e.name||i};var a=t._formSelect;t._formSelect={block:n,mods:r,tabindex:e.tabindex},S(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg27=s
}function A(t){return!!t._popupDefaults==!1&&!!s==!1?j(t):qe(t)}function j(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,A(t),t._popupDefaults=n
}function R(t){if(!(t.__$anflg26!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg26;t.__$anflg26=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),R(t),i.weather=n,void(t.__$anflg26=e)
}return L(t)}return L(t)}function L(t){return!(t.__$anflg25!==!0)==!1?N(t):qe(t)}function N(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(Object(t.ctx.attrs),{style:';background-image:url("'+e+'");'+(Object(t.ctx.attrs).style||"")}));
var i=t.__$anflg25;t.__$anflg25=!0,R(t),t.__$anflg25=i}function q(t){if(!(t.__$anflg24!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(Object(t.ctx.attrs),{style:";color:"+t.ctx.color+";"+(Object(t.ctx.attrs).style||"")});
var e=t.__$anflg24;return t.__$anflg24=!0,q(t),void(t.__$anflg24=e)}return qe(t)}return qe(t)}function $(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];
e.mix&&(n=n.concat(e.mix));var s=t.__$anflg23;t.__$anflg23=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,underMods:e.underMods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",ke(t),t.ctx=o,i=r,t.__$anflg23=s}function F(t){return!(t.__$anflg22!==!0)==!1&&!!s==!1?V(t):qe(t)
}function V(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg22;t.__$anflg22=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=t.ctx,h=c.mods;c.mods=s,F(t),t._checkboxAttrs=r,t._labelId=a,c.mods=h,t.__$anflg22=o
}function U(t){if(!(t.__$anflg18!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg18;return t.__$anflg18=!0,U(t),void(t.__$anflg18=e)}return qe(t)}return qe(t)}function z(t){var e=s;
return"hint"===e?H(t):"control"===e&&!(t.__$anflg15!==!0)==!1?W(t):K(t)}function H(t){if(!(t.__$anflg16!==!0)==!1){if(!!t._value==!1){if(!(0!==t._value)==!1){var e=t.ctx,i=e.elemMods||(e.elemMods={});
i.visibility="visible";var n=t.__$anflg16;return t.__$anflg16=!0,H(t),void(t.__$anflg16=n)}return K(t)
}return K(t)}return K(t)}function W(t){var e=t.__$anflg15;t.__$anflg15=!0;var n=t.ctx;t.ctx=[t._placeholder?{elem:"hint",elemMods:{fallback:"yes"},content:t._placeholder}:"",{elem:"box",content:t.ctx}];
var s=i;i="",ke(t),t.ctx=n,i=s,t.__$anflg15=e}function K(t){return!(t.__$anflg14!==!0)==!1&&!!s==!1?G(t):qe(t)
}function G(t){var e,n,s,o,a,c,h,l,u,d=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=xe(t),i=e,t.ctx=n,s),p=t.ctx.id||t.generateId(),f=t.ctx.mods||{},_=(o=i,i="getLive",a=De(t),i=o,a);
f.theme=f.theme||"normal",t.ctx.hasOwnProperty("placeholder")&&(c=i,i="value",h=t.ctx,t.ctx=t.ctx.placeholder,l=xe(t),i=c,t.ctx=h,u=l);
var m=t.__$anflg14;t.__$anflg14=!0;var g=t._inputId;t._inputId=p;var b=t._labelId;t._labelId="label"+p;
var v=t._hintId;t._hintId="hint"+p;var y=t._name;t._name=t.ctx.name||"";var k=t._value;t._value=d;var M=t._inputLink;
t._inputLink=!0;var E=t._disabled;t._disabled=r.disabled;var w=t._live;t._live=_;var x=t._placeholder;
t._placeholder=u;var B=t.ctx,C=B.mods;B.mods=f,z(t),t._inputId=g,t._labelId=b,t._hintId=v,t._name=y,t._value=k,t._inputLink=M,t._disabled=E,t._live=w,t._placeholder=x,B.mods=C,t.__$anflg14=m
}function Q(t){return"retpath"===s?Y(t):X(t)}function Y(t){if(!(t.__$anflg13!==!0)==!1){var e=t.__$anflg13;
t.__$anflg13=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,Y(t),t._retpath=i,void(t.__$anflg13=e)
}return X(t)}function X(t){return!(t.__$anflg12!==!0)==!1&&!!s==!1?J(t):qe(t)}function J(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",Q(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg12=o
}function Z(t){if("option"===s){if("left"===t.ctx.side){if(!(t.__$anflg9!==!0)==!1){var e=t.__$anflg9;
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",ke(t),t.ctx=n,i=o,void(t.__$anflg9=e)
}return te(t)}return te(t)}return ie(t)}function te(t){return!(t.__$anflg8!==!0)==!1?ee(t):ie(t)}function ee(t){var e,n,s=(e=i,i="value",n=Se(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",ke(t),t.ctx=r,i=a,t.__$anflg8=o}function ie(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",Z(t),t._disabled=i,void(t.__$anflg6=e)
}return ne(t)}return ne(t)}return ne(t)}function ne(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",Z(t),t._checked=i,void(t.__$anflg5=e)}return se(t)
}return se(t)}return se(t)}function se(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),Z(t),i.mods=n,void(t.__$anflg4=e)
}return oe(t)}return oe(t)}return oe(t)}function oe(t){return!(t.__$anflg3!==!0)==!1&&!!s==!1?re(t):qe(t)
}function re(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null,o=t.ctx.content;o&&o.length>0&&(s="left"===t.ctx.content[0].side?i:n);
var r=t.__$anflg3;t.__$anflg3=!0;var a=t._name;t._name=t.ctx.name||(t.ctx.name=e);var c=t._leftId;t._leftId=i;
var h=t._rightId;t._rightId=n;var l=t._sideId;t._sideId=s,Z(t),t._name=a,t._leftId=c,t._rightId=h,t._sideId=l,t.__$anflg3=r
}function ae(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?ce(t):qe(t)
}function ce(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function he(t){var e=n;if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return le(t)}return"suggest2-item"===e?"text"===s&&!(r&&"link"===r.interact)==!1&&!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:le(t):"suggest2"===e?!!s==!1?{block:"suggest2-detect",js:!0}:le(t):"dropdown"===e?!!s==!1?[{mods:{action:"closed"}}]:le(t):"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:le(t):"notice"===e?"count"===s&&!!t.ctx.url==!1?[{elem:"plain"}]:le(t):"ticker"===e&&"text"===s?[{block:"a11y-hidden"}]:le(t)
}function le(){return void 0}function ue(t){var e=n;return"select"===e?!!s==!1?de(t):pe(t):"suggest2-item"===e||"suggest2"===e||"dropdown"===e?!!s==!1?!0:pe(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):pe(t):"button"===e?!!s==!1?!0:pe(t):"input"===e?!!s==!1?{live:t._live}:pe(t):"auth"===e?!!s==!1?!0:pe(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):pe(t):"link"===e&&!t.ctx.tabindex==!1&&!!s==!1?{origTabindex:t.ctx.tabindex}:pe(t)
}function de(t){return t.extend({live:!1},t.ctx.js)}function pe(){return void 0}function fe(t){var e=n;
if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:ve(t);if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:ve(t);
if("suggest2-item"===e)return!(r&&"link"===r.interact)==!1&&!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:_e(t);
if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:ve(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:ve(t);if("input"===e){var e=s;
return"box"===e?me(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:ve(t)}if("auth"===e){var e=s;
return"register"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=register",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","register")}:ge(t):"remember"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=restore",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","remember")}:ge(t):"button"===e?!!t.ctx.content==!1?{block:"button",type:"submit",mods:{theme:"action",size:"m"},content:BEM.I18N("auth","logon")}:ge(t):"haunter"===e?!!t.ctx.content==!1?{block:"checkbox",mods:{theme:"normal",size:"m"},checkboxAttrs:{id:"auth-haunter",autocomplete:"off",name:"twoweeks",value:"no"},content:{elem:"label",content:BEM.I18N("auth","temporary")}}:ge(t):"password"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"passwd",content:[{elem:"hint",content:BEM.I18N("auth","password")},{elem:"control",attrs:{type:"password",maxlength:256,"aria-required":!0}}]}:ge(t):"username"===e&&!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"login",content:[{elem:"hint",content:BEM.I18N("auth","login")},{elem:"control",attrs:{"aria-required":!0}}]}:ge(t)
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Ae(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:ve(t)
}if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=je(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):ve(t)
}return"tumbler"===e?"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1&&!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:be(t):ve(t)
}function _e(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.escapeContent===!1?e.ctx.content:e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):ve(e)}function me(t){if(!(t.__$anflg17!==!0)==!1){if(!!r.clear==!1){var e,i;
return[(e=t.__$anflg17,t.__$anflg17=!0,i=me(t),t.__$anflg17=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
}return ve(t)}return ve(t)}function ge(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Pe(t),i=e,n),{elem:"retpath"}]
}return ve(t)}function be(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return ve(t)
}function ve(t){return t.ctx.content}function ye(t){return"popup"===n&&!t._popupDefaults==!1&&!!s==!1?(delete t._popupDefaults,void Qe(t)):ke(t)
}function ke(t){return!(t.__$anflg1!==!0)==!1&&!!t["i-global"]==!1?Me(t):qe(t)}function Me(t){for(var e,o,r,a,c,h,l,u,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];u=p.shift();)d[u]=(e=i,i="default",o=n,n="i-global",r=s,s=u,a=ae(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",l=Re(t),i=c,n=h,l),_=t.__$anflg1;t.__$anflg1=!0;var m=t["i-global"];
t["i-global"]=t.extend(d,f),ye(t),t["i-global"]=m,t.__$anflg1=_}function Ee(t){return"suggest2-item"===n&&"highlight"===s?!1:we(t)
}function we(){return void 0}function xe(t){return!t.isSimple(t.ctx)==!1&&!!s==!1?t.ctx:Be(t)}function Be(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;
t._buf=e;var o=i;return i="",ke(t),t._buf=n,i=o,e.join("")}return Ce(t)}return Ce(t)}function Ce(t){return!!s==!1?"":qe(t)
}function Se(t){return t.ctx.value||"left"!==t.ctx.side}function De(t){var e,n,s=(e=i,i="live",n=Ie(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function Ie(){return!1}function Pe(t){return!!t.ctx.content==!1&&!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Te(t)
}function Te(t){return!!s==!1?[]:qe(t)}function Oe(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function Ae(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function je(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Re(t){return!!s==!1?{}:qe(t)}function Le(){return void 0}function Ne(){return void 0}function qe(t){return!t.ctx==!1&&!t.ctx.link==!1&&!!t._.isSimple(t.ctx)==!1?$e(t):Fe(t)
}function $e(i){function n(){if("no-follow"===this.ctx.link)return void 0;var t=this._links[this.ctx.link];
return __r0=this.ctx,this.ctx=t,__r1=e(Qe,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Fe(t){return!a==!1&&!t.ctx==!1&&!t.ctx.cache==!1?Ve(t):Ue(t)
...
},t(e))}else e._buf.push(n.log[o]);return e._links=s,n.res}var _,m=[],g=e.ctx,b=g.cache;g.cache=null;
var v=e._cachePos;e._cachePos=e._buf.length;var y=e._cacheLog;e._cacheLog=m;var k=e._localLog;e._localLog=[],_=h(e);
var M=e._buf.slice(e._cachePos).join("");return M&&m.push(M),g.cache=b,e._cachePos=v,e._cacheLog=y,e._localLog=k,a.set(e.ctx.cache,{log:m,res:_}),_
}function Ue(t){var e=i;if("default"===e)return ze(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return void((n&&n!==!0||0===n)&&t._buf.push(n))}return!!t.ctx==!1?void t._listLength--:!t._.isArray(t.ctx)==!1?He(t):We(t)
}return Ke(t)}function ze(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,u,d,p,f,_,m,g,b,v,y,k,M,E,x,B,C,S,D,I,P,T=t.BEM,O=t.ctx,A=t._buf;
if(c=i,i="tag",v=w(t),i=c,P=v,"undefined"!=typeof P||(P=O.tag),"undefined"!=typeof P||(P="div"),P){var j,R;
n&&O.js!==!1&&(h=i,i="js",u=ue(t),i=h,R=u,R=R?t._.extend(O.js,R===!0?{}:R):O.js===!0?{}:O.js,R&&((j={})[T.INTERNAL.buildClass(n,O.elem)]=R)),A.push("<",P);
var L=(d=i,i="bem",p=Ee(t),i=d,p);"undefined"!=typeof L||(L="undefined"!=typeof O.bem?O.bem:O.block||O.elem);
var N=(f=i,i="cls",_=Ne(t),i=f,_);N||(N=O.cls);var q=O.block&&j&&!O.elem;if(L||N){if(A.push(' class="'),L){T.INTERNAL.buildClasses(n,O.elem,O.elemMods||O.mods,A);
var $=(m=i,i="mix",g=he(t),i=m,g);if(O.mix&&($=$?[].concat($,O.mix):O.mix),$){var F={};F[e(n,s)]=!0,t._.isArray($)||($=[$]);
for(var V=0;V<$.length;V++){var U=$[V];if(U){var z=U.block||U.elem,H=U.block||U._block||n,W=U.elem||U._elem||s,K=U.mods||r,G=U.elemMods||{};
if(z&&A.push(" "),T.INTERNAL[z?"buildClasses":"buildModsClasses"](H,U.elem||U._elem||(U.block?void 0:s),U.elemMods||U.mods,A),U.js&&((j||(j={}))[T.INTERNAL.buildClass(H,U.elem)]=U.js===!0?{}:U.js,q||(q=H&&!U.elem)),z&&!F[e(H,W)]){F[e(H,W)]=!0;
var Q=(b=n,n=H,a=s,s=W,y=r,r=K,k=o,o=G,M=i,i="mix",E=he(t),n=b,s=a,r=y,o=k,i=M,E);if(Q)for(var Y=0;Y<Q.length;Y++){var X=Q[Y];
(X.block||X.elem)&&F[e(X.block,X.elem)]||(X._block=H,X._elem=W,$.splice(V+1,0,X))}}}}}}N&&A.push(L?" ":"",N),q&&A.push(" i-bem"),A.push('"')
}if(j){var J=(x=i,i="jsAttr",B=Le(t),i=x,B);A.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(j)),'"')
}var Z=(C=i,i="attrs",S=l(t),i=C,S);if(Z=t._.extend(Z,O.attrs)){var te;for(te in Z)void 0!==Z[te]&&A.push(" ",te,'="',t._.attrEscape(Z[te]),'"')
}}if(t._.isShortTag(P))A.push("/>");else{P&&A.push(">");var ee=(D=i,i="content",I=fe(t),i=D,I);if(ee||0===ee){var L=n||s,ie=t._notNewList;
t._notNewList=!1;var ne=t.position;t.position=L?1:t.position;var se=t._listLength;t._listLength=L?1:t._listLength;
var oe=t.ctx;t.ctx=ee;var re=i;i="",ye(t),t._notNewList=ie,t.position=ne,t._listLength=se,t.ctx=oe,i=re
}P&&A.push("</",P,">")}}function He(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,ye(t),t.ctx=a}o||(t.position=s)}function We(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
var _=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,C(t),i=h,t._links=l,n=u,t._currBlock=d,s=p,r=f,o=_
...
p.last?(p.last.next=f,f.prev=p.last):p.first=f,c.ids[h]=p.last=f}}else{var _=this;t.each(n,function(t,e){_.on(t,e,s,a)
...
if(l in u){var d=a.list,p=u[l],f=p.prev,_=p.next;f?f.next=_:p===d.first&&(d.first=_),_?_.prev=f:p===d.last&&(d.last=f),delete u[l]
}}else delete this[e][n]}else delete this[e]}else{var m=this;t.each(n,function(t,e){m.un(t,e,o)})}return this
...
for(e&&(t=this);n>i;)delete t[arguments[i++]];return this},channel:function(i,n){return"boolean"==typeof i&&(n=i,i=e),i||(i="default"),n?void(a[i]&&(a[i].un(),delete a[i])):a[i]||(a[i]=new t.observable)
...
};if(i)if(i.className.match(/b-link_pseudo_yes/)||i.href&&i.href.match(/^mailto:/)||n.noRedirect===!0)r();
...
var _=new d(p[l],s,!!r);return delete p[l],c&&c.apply(_,x.call(arguments,4)),_}}function o(t,i,n,s){(t||(t={})).uniqId||(t.uniqId=(t.id?n+"-id-"+t.id:e.identify())+(s||e.identify()));
...
}function h(t){delete _[e.identify(t)]}function l(t,e){1===t.domElem.length?t.destruct(!0):t.domElem=t.domElem.not(e)
}var u=e(window),d=e(document),p={},f={},_={},m={},g={},b=t.blocks,v=t.INTERNAL,y=v.NAME_PATTERN,k=v.MOD_DELIM,M=v.ELEM_DELIM,E=v.buildModPostfix,w=v.buildClass,x=Array.prototype.slice,B=Array.prototype.reverse;
...
},_ctxTrigger:function(t,i){var n=this,s=m[n.__self._buildCtxEventName(t.type)],o={};s&&n.domElem.each(function(){for(var r=this,a=s.counter;r&&a;){var c=e.identify(r,!0);
...
i[t.substr(n+1,e-n-1)]=t.substr(e+1),++s}),s<t.length&&t.forEach(function(t){t in i||(i[t]="")}),i},_afterSetMod:function(t,i,n,s,o){if(!this._isDestructing){var r=this.__self,a=r._buildModClassPrefix(t,o),c=r._buildModValRE(t,o),h=""===i;
...
});else{var c=a._buildCtxEventName(n),h=m[c]||(m[c]={counter:0,ctxs:{}});t.each(function(){var t=e.identify(this),i=h.ctxs[t];
i||(i=h.ctxs[t]={},++h.counter),i[e.identify(o)+(r?e.identify(r):"")]={fn:o,data:s,ctx:r}})}else e.each(n,function(e,i){a._liveCtxBind(t,e,i,s)
});return a},liveCtxUnbind:function(t,e,i,n){return this._liveCtxUnbind(t,e,i,n)},_liveCtxUnbind:function(t,i,n,s){var o=this,r=m[i=o._buildCtxEventName(i)];
...
}),r.counter||delete m[i]),o},_extractElemNameFrom:function(t){if(t.__bemElemName)return t.__bemElemName;
...
this.state=e,window.location.hash=this._generateHashbang(e.url)}}),_borschik("e4mNX6WSEEnOzzK9_WR5JxLBwHk")&&!function(t,e){var i=1,n=!1;
...
var r,a={},c={};(r=e.match(/Android\s+([\d.]+)/))?a.android=r[1]:e.match(/\sHTC[\s_].*AppleWebKit/)?a.android="2.3":(r=e.match(/iPhone\sOS\s([\d_]+)/))?(a.ios=r[1].replace(/_/g,"."),c.iphone=!0):(r=e.match(/iPad.*OS\s([\d_]+)/))?(a.ios=r[1].replace(/_/g,"."),c.ipad=!0):(r=e.match(/Bada\/([\d.]+)/))?a.bada=r[1]:(r=e.match(/Windows\sPhone[^\d]*\s([\d.]+)/))?a.wp=r[1]:(r=e.match(/MSIE\s9/))?a.wp="7.5":a.other=!0,BEM.DOM.decl("i-ua",{onSetMod:{js:function(){var t=this.__self,e="other";
["ios","android","bada","wp","opera"].some(function(i){return t[i]&&(e=i)}),this.setMod("platform",e),t.hiDpi&&this.setMod("hi-dpi","yes")
}}},{ios:a.ios,iphone:c.iphone,ipad:c.ipad,android:a.android,bada:a.bada,wp:a.wp,other:a.other,dpr:i,hiDpi:n,ua:e,ie:o.ie,opera:o.opera})
}(window,navigator.userAgent),_borschik("y7kwd8srwWMa7KrW1CgMUftWyAg")&&!function(){var t,e,i;BEM.decl("i-ua",{},{canUseAjax:function(){return"undefined"==typeof t&&(t=(window.history&&"pushState"in window.history||"onhashchange"in window)&&this.isCookieEnabled()),t
...
},e.onload=function(){t(1==e.width&&1==e.height?i=!0:i=!1)},e.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="
...
}}),_borschik("K6rdwYf5DqX6xzq7A_M8mVrNIuw")&&!function(){var t=/([ -#%-*,-/:-;?-@[-\]_{}\u00a0-Â¡Â«Â·Â»Â¿Í¾ÎÕ-ÕÖ-ÖÖ¾××××³-×´Ø-ØØ-ØØØ-ØÙª-Ù­ÛÜ-Üß·-ß¹à¥¤-à¥¥à¥°à·´à¹à¹-à¹à¼-à¼à¼º-à¼½à¾à¿-à¿á-áá»á¡-á¨á­-á®\u1680á-áá«-á­áµ-á¶á-áá-áá -á \u180eá¥-á¥á§-á§á¨-á¨á­-á­ á°»-á°¿á±¾-á±¿\u2000-\u200aâ-\u2029\u202f-ââ-ââ-\u205fâ½-â¾â-ââ©-âªâ¨-âµâ-ââ¦-â¯â¦-â¦â§-â§â§¼-â§½â³¹-â³¼â³¾-â³¿â¸-â¸®â¸°\u3000-ãã-ãã-ãã°ã½ã ã»ê-êê³ê¾ê¡´-ê¡·ê£-ê£ê¤®-ê¤¯ê¥ê©-ê©ï´¾-ï´¿ï¸-ï¸ï¸°-ï¹ï¹-ï¹¡ï¹£ï¹¨ï¹ª-ï¹«ï¼-ï¼ï¼-ï¼ï¼-ï¼ï¼-ï¼ï¼-ï¼ ï¼»-ï¼½ï¼¿ï½ï½ï½-ï½¥\ud800\udd00-\udd01\udf9f\udfd0\ud802\udd1f\udd3f\ude50-\ude58\ud809\udc70-\udc73]+)/,e={trimByWord:function(e){var i=e.split(t);
return i.splice(-2),i.join("")},xmlEscape:function(t){return t?t.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/"/g,"&quot;").replace(/`/g,"&#x60;").replace(/'/g,"&#x27;"):""
}};"function"==typeof BEM&&"function"==typeof BEM.decl&&BEM.decl("i-text",{},e),"object"==typeof blocks&&(blocks["i-text"]=e)
}(),_borschik("QhyYub-eT4nJN-7jAnjAUyubYR4")&&BEM.DOM.decl("i-global",{onSetMod:{js:function(){this.__base.apply(this,arguments),this.__self.rstat=BEM.create({block:"b-statcounter",elem:"statface",elemMods:{type:"rstat"}});
...
t[e]=(t[e]||0)+$(this).outerHeight(!0)}),$.map(t,function(t,e){return e+":"+t}).join(";")},viewPortParamsCount:function(){var t=BEM.DOM.win,e=t.width(),i=t.scrollTop(),n=t.height(),s={t:i+$(".header").outerHeight(),r:e,b:i+n,l:0},o=function(t,e){if(t&&t.length){var i=t.offset(),n=i.top;
...
},_onKeyboard:function(i){var n=i.keyCode;return e[n]?void this._onPointer():void(t[n]&&"keyboard"!==this.interaction&&(this.domElem.attr("data-interaction","keyboard"),this.interaction="keyboard",this.bindTo("mousedown",this._onPointer)))
...
}},{get:function(){return t||(t=BEM.create("i-cookie"))}})}(),_borschik("jwcZf2KlH0Bat5QEZUFI-pAr2_o")&&BEM.DOM.decl("metrika",{onSetMod:{js:function(){var t=this.params.counter,e=BEM.blocks.location.getInstance();
...
}catch(i){}})}}}),_borschik("Y4MkrbXVthpo7UeZdRo-HWUeLZ8")&&(BEM.DOM.decl({name:"i-flashcookie",modName:"type",modVal:"iframe"},{onSetMod:{js:function(){Lego.block["i-flashcookie"].call(this.domElem,this.params)
...
n&&n.call(this,i)}}()),_borschik("TWvGy-UWrKLO34zzKQfxQzUgs-c")&&(BEM.DOM.decl({name:"i-flashcookie",modName:"type",modVal:"inline"},{onSetMod:{js:function(){Lego.block["i-flashcookie"].call(this.domElem,this.params)
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,l=t.host||"kiks.yandex",u=window,d=document,p=navigator,f=p.userAgent,_=p.mimeTypes,m=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+l.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+l+".ru/system/%s%d.swf",M="//"+l+".ru/fu",E="//"+l+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",D="always",I="height",P="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",R="ya_fc",L=i(x,B)+i(O,1)+i(I,1)+i("id",R)+i("tabindex","-1")+i("aria-hidden","true"),N=!1;
u.ya_fc_external=function(t,n,l,u){r=t,a=n,c=l,h=u||"fc";var d,p=_&&_[w]?_[w].enabledPlugin:0,f=N,y=0,x=s()?k.replace("%d",a).replace("%s",h):M.replace("%s",o());
...
}catch(I){}}return d=f?g?'<div style="'+B+'"><'+v+L+i("src",x)+i(P,T)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+L+">"+e("movie",x):"<"+v+L+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
i.src=e,i.style.cssText=O+s+I+s+"border:0;"+B,i.frameBorder=0,i.setAttribute("tabindex","-1"),i.setAttribute("aria-hidden","true"),n&&n.insertBefore(i,n.firstChild)
...
}}}(jQuery),_borschik("JAx3mh4cbXJCK9XJmFlUPJj_kPM")&&BEM.DOM.decl("popup",{getDefaultParams:function(){var t={left:15,right:15,top:15,bottom:15};
...
},this)},visibility:{visible:function(){this._onShown()},"":function(){this._onHidden()}}},show:function(t){var e;
...
var i=this._findParent(e);i&&this.setParent(i)}else this._userPosition=t;return this.setMod("visibility","outside").repaint()
...
},setContent:function(t){return BEM.DOM.update(this.elem("content"),t),this._resetDefault(),this._isShown&&this.repaint(),this
...
},_bindFocusEvents:function(){this._lastFocused=$($.dom.getActiveElement()[0]||this._scope);var t=this.__self._getFocusable(this.elem("content"));
...
},_mergeParams:function(t,e,i){var n={},s=Object.prototype.hasOwnProperty;return i||(i={}),t&&"object"==typeof t&&Object.keys(t).forEach(function(e){n[e]=t[e]
}),Object.keys(e).forEach(function(o){var r=s.call(i,o)?i[o].call(this,t[o],e[o]):e[o];n[o]=!r||"object"!=typeof r||Array.isArray(r)?r:t[o]?this._mergeParams(t[o],r,i):r
...
},_generateDirections:function(){if(this.__self._generateDirectionsCache)return this.__self._generateDirectionsCache;
for(var t=[["bottom","top"],["left","right"]],e=[["center","left","right"],["middle","top","bottom"]],i=e,n=t.length,s=[],o=0;n>o;o++)for(var r=t[o],a=r.length,c=0;a>c;c++)for(var h=e[o],l=h.length,u=0;l>u;u++)for(var d=i[o],p=d.length,f=0;p>f;f++)s.push({direction:r[c],axis:h[u],tail:{axis:d[f]}});
return this.__self._generateDirectionsCache=s,s},_repackDirParams:function(t){var e={},i=[];return("string"==typeof t||$.isPlainObject(t))&&(t=[t]),i=t.map(function(t){if("string"==typeof t){var i=t.split("-");
t={to:i[0],tail:{}},i[1]&&(t.axis=i[1]),i[2]&&(t.tail.axis=i[2])}var n=t.to;return e[n]||(e[n]=t),t.axis&&(n+="-"+t.axis),t.key=n,e[n]=t,n
},this),{directions:e,keys:i}},setViewport:function(t){return this._viewport=t,this},_pickDirection:function(){var t,e=this._order,i=this.hasMod("adaptive","yes")?e.length:1;
...
},_calcPos:function(t){this._calcPlacingSize(t);var e=this.getOwnerPos(),i=this.getOwnerSize(),n=this.getPlacingSize(),s=t.axis,o=this.params.position||{},r={},a=Object.prototype.hasOwnProperty;
...
})},_getFocusable:function(t){var e=$.data(t,"popup-getFocusable-id");e||(e=$.identify(),$.data(t,"popup-getFocusable-id",e)),e='*[data-popup-getFocusable-id="'+e+'"]';
var i="a[href], link, ";return BEM.blocks["i-ua"].opera<13&&(i=""),t.find(i+'*[tabindex], button, input:not([type="hidden"]), textarea, select, menuitem').filter(function(){var t=$(this),i=!0;
return parseInt(t.prop("tabindex"),10)<0||"hidden"===t.css("visibility")?!1:($(this).parentsUntil(e).each(function(){var t=$(this);
return"none"===t.css("display")?i=!1:void 0}),i)})},_enforcePageRepaint:function(){document.body.className+=""
},_generateDirectionsCache:null}),_borschik("8WQoowkMYUMdANww8iqmxqme1-s")&&BEM.DOM.decl("popup",{onSetMod:{js:function(){var t=$.identify();
...
}})}(),_borschik("LNRXnTKEnnJjIaOxEn1smJIzBHE")&&!function(t){if(t.dom)throw Error("$.dom namespace is already used");
t.dom={getActiveElement:function(){try{return t(document.activeElement)}catch(e){return t()}}},t.fn.isFocused=function(){return this.is(t.dom.getActiveElement())
}}(jQuery),_borschik("PBOC9zww9HpldTT7vKqRunAciCo")&&BEM.DOM.decl({block:"popup",modName:"type",modVal:"modal"},{getDefaultParams:function(){var t=this.__base();
...
return t.top=20,t}}),_borschik("KaZ_1nWe1TXdQAC0hOFgJr8OeBA")&&BEM.DOM.decl("radiobox",{onSetMod:{js:function(){var t=this;
...
return this.delMod(t,"checked").findElem(t,"control").prop("checked",!1),this._val=void 0,this.trigger("change",{current:void 0,prev:t}),this
...
})},_getRadioByElem:function(t){return t.closest(this.buildSelector("radio"))}}),_borschik("rZ3U7KvFxHpWtK0c-en7cbw47f0")&&BEM.DOM.decl("radiobox",{name:function(t){var e=this.elem("control");
...
},focused:{yes:function(){return this.isDisabled()?!1:(this._isControlFocused()||this.elem("control").focus(),this.setMod(this.elem("box"),"focused","yes"),void this.afterCurrentEvent(function(){this.trigger("focus")
}))},"":function(){this._isControlFocused()&&this.elem("control").blur(),this.delMod(this.elem("box"),"focused"),this.afterCurrentEvent(function(){this.trigger("blur")
...
}),void this.setMod(this.elem("box"),"checked",e))},disabled:function(t,e){this.elem("control").prop("disabled","yes"===e)
...
}}),_borschik("nW_pxWP_D3mtyJnjWnRKdHXDZvo")&&BEM.DOM.decl("overlay-message",{onSetMod:{js:function(){BEM.channel("overlay-message").on({show:this.show,hide:this.hide},this)
}},show:function(t,e){BEM.DOM.update(this.domElem,BEMHTML.apply(e.content)),this.setMod("visible","yes"),$.isFunction(e.onWindowBlur)&&BEM.DOM.win.one("blur",e.onWindowBlur.bind(this)),setTimeout(this.bindTo.bind(this,"click",this.hide),3e3)
},hide:function(){this.delMod("visible"),this.unbindFrom("click")}}),_borschik("5NO2qC3NgtpnDtgIztRjyKKG7NQ")&&BEM.DOM.decl("timing",{onSetMod:{js:function(){this.data={},this.visibilityState={visible:1,hidden:2,prerender:3}[this.getVisibilityState()],this.send()
...
return n&&n[e]?void((i?i(n[e]):n[e]>0)&&s.resolve(n[e],n)):s.reject("Property does not exist")};return n.on("tick",o),s.always(function(){n.un("tick",o)
...
t.vars["1201.1030"]&&(i+=encodeURIComponent(e)),document.createElement("IMG").src=i}},_normalizeMetrics:function(t){return $.each(t,function(e,i){return isNaN(i)||0>i?t=!1:void(t&&(t[e]=parseInt(i,10)))
...
}}),_borschik("_Ad6GPnR3kfU5EX25I9cM25NTq8")&&BEM.DOM.decl("main",{clearUrlParams:function(){var t=BEM.blocks.uri.parse(window.location.href);
...
},closeAdvancedSearch:function(){this.delMod("kind"),this.findBlockInside("advanced-search").reset()},onAjaxSuccess:function(t){this.clearUrlParams(),this.closePanel(!0),this.update(t),this.afterCurrentEvent(function(){BEM.DOM.win.scrollTop(0)
})},update:function(t){var e=t.params||{},i=e.scripts,n=e.styles,s=e.html;this.replaceContent(s),this.appendScripts(i),this.appendStyles(n)
},replaceContent:function(t){t?BEM.DOM.update(this.findElem("content"),t):this.showResultError()},appendStyles:function(t){t&&BEM.DOM.prepend(this.findBlockOutside("b-page").domElem,t)
},appendScripts:function(t){if(t){var e=BEM.blocks["i-global"].param("nonce");t.forEach(function(t){if(t){var i=document.createElement("script");
...
t.trigger("updateStart"),this.__base.apply(this,arguments),t.trigger("updateStop")}}),_borschik("tP2OS0l-LXRrSHsUaTjncGm1Agk")&&BEM.DOM.decl("default-search",{onSetMod:{js:function(){try{2!==window.external.IsSearchProviderInstalled(location.origin)&&this._show()
...
i.app_url=this.params.webItem.url,BEM.blocks.counter.log(t,i)}}),_borschik("PqksHYuzRJcvb2W5zVQrtJg1ri0")&&BEM.decl("counter",null,{log:function(t,e){var i=[];
if(t[1]&&i.push(t[1]),e)for(var n in e)i.push("-"+encodeURIComponent(n)+"="+encodeURIComponent(e[n]));
w(null,t[0],i.join(","))}}),_borschik("hLT6_HzpoVKa5pIUhRb0Qhibhkk")&&BEM.DOM.decl("main",{onSetMod:{js:function(){this.clearUrlParams();
...
},_onChannelToggle:function(t,e){return this._isSameContent(e)&&this._getMain().isPanelOpened()?void this.close():void this.open(e)
...
return this.findBlockInside("spin2").delMod("progress"),this.delMod("first"),t.isEmpty?this.showEmpty():(t.counter&&sh(t.counter),this.trigger("resized"),t.closeCounter&&(this.closeCounter=t.closeCounter),void this.trigger("updated"))
...
var e=this.css("counter-reset");return e=e&&e.split(" ")||"",e[1===e.length?0:e.length-2]===t}})}(jQuery),_borschik("AWS6uUu4b1QxDVmw-uMiOBxd96w")&&BEM.DOM.decl("main",{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this.hasMod(this.elem("left"),"fixed","yes")&&this._initBlock()
...
}}),_borschik("54FsKq8H7q3yhQ0UqgzhufAMzYE")&&BEM.decl("suggest2-popup",{onSetMod:{js:{inited:function(){this._popup=this.params.popup,this.bindSuggestEvents()
}}},show:function(){throw new Error("Ð­ÑÐ¾Ñ Ð¼ÐµÑÐ¾Ð´ Ð´Ð¾Ð»Ð¶ÐµÐ½ Ð±ÑÑÑ Ð¿ÐµÑÐµÐ¾Ð¿ÑÐµÐ´ÐµÐ»ÐµÐ½ Ð² Ð¼Ð¾Ð´Ð¸ÑÐ¸ÐºÐ°ÑÐ¾ÑÐµ _for")},hide:function(){throw new Error("Ð­ÑÐ¾Ñ Ð¼ÐµÑÐ¾Ð´ Ð´Ð¾Ð»Ð¶ÐµÐ½ Ð±ÑÑÑ Ð¿ÐµÑÐµÐ¾Ð¿ÑÐµÐ´ÐµÐ»ÐµÐ½ Ð² Ð¼Ð¾Ð´Ð¸ÑÐ¸ÐºÐ°ÑÐ¾ÑÐµ _for")
},setContent:function(t){return this._popup.setContent(t),this},isShown:function(){throw new Error("Ð­ÑÐ¾Ñ Ð¼ÐµÑÐ¾Ð´ Ð´Ð¾Ð»Ð¶ÐµÐ½ Ð±ÑÑÑ Ð¿ÐµÑÐµÐ¾Ð¿ÑÐµÐ´ÐµÐ»ÐµÐ½ Ð² Ð¼Ð¾Ð´Ð¸ÑÐ¸ÐºÐ°ÑÐ¾ÑÐµ _for")
},owner:function(t){return t?(this.params.owner=t,this):this.params.owner},get:function(){return this._popup
},width:function(t){return void 0===t?this._popup.domElem.outerWidth():(this._popup.domElem.outerWidth(t),this)
},destruct:function(){this._popup&&(this.unbindAllEvents(),this.__base.apply(this,arguments))},bindSuggestEvents:function(){return this.params.suggest.on({select:this._onSuggestSelect,update:this._onSuggestUpdate},this),this
},_onSuggestSelect:function(t,e){this.hide(e)},_onSuggestUpdate:function(t,e){e.items.length||this.hide({response:"empty"})
},unbindAllEvents:function(){return this.params.suggest.un("select").un("update"),this}}),_borschik("K-tWNBTXr1VYgFaCWy__wtJFvto")&&BEM.DOM.decl("suggest2-detect",{onSetMod:{js:{inited:function(){this.bindToDoc("keydown",function(t){this.__self._pressedKeyCode=t.which
...
}}}(jQuery),_borschik("Iq2b9A4rbXwoi1nUXucnlvqV9UI")&&BEM.DOM.decl("header",{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._openedSlide=null
...
}),e},_onScroll:function(t){this.delMod(t,"pressed")},_slideOnClick:function(t,e){var i=this;t.bindToDoc("click",function(n){var s=$(n.target);
t.containsDomElem(s)||s.is(i.elem("main"))||s.is(i.elem("action-i"))||i.delMod(e,"pressed")})},_onActionClick:function(t){t.preventDefault(),BEM.blocks["i-ua"].opera<13&&t.stopPropagation(),this.toggleMod(t.data.domElem,"pressed","yes","")
},_onActionKeyup:function(t){var e=BEM.blocks["i-ua"].opera<13;(!e&&13===t.keyCode||32===t.keyCode)&&(t.preventDefault(),this.toggleMod(t.data.domElem,"pressed","yes",""))
...
}}),_borschik("jGv9keOV0P5vPU8PqNjtXHRnJAA")&&BEM.DOM.decl("tooltip",{onSetMod:{js:{inited:function(){this._popup=null,this._owner=null
...
}),this.__base.apply(this,arguments)}}),_borschik("g-keHxBP9TOyojYJfkr83KB7esE")&&BEM.DOM.decl({block:"tooltip",modName:"autoclosable",modVal:"yes"},{onSetMod:{shown:{yes:function(){this.__base.apply(this,arguments),this.bindToDoc("keydown",this._onKeyDown)
},"":function(){this.unbindFromDoc("keydown"),this.__base.apply(this,arguments)}}},_onKeyDown:function(t){BEM.blocks.keycodes.is(t.keyCode,"ESC")&&this.delMod("shown")
}}),_borschik("fCcxyi2q2N370A46VW4RVCmmA6k")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DELETE:46,is:function(t){return Array.prototype.slice.call(arguments,1).some(function(e){return this[e]===t
},this)}}),_borschik("_TrLVuHiyhsdq_fWdnTpW7I5e3c")&&BEM.DOM.decl({block:"logo",modName:"tooltip",modVal:"yes"},{onSetMod:{js:function(){var t=this,e=this.findBlockOutside("b-page"),i=e.findBlockInside("main"),n=localStorage.getItem("last_show_tooltip"),s=+new Date,o=n?Math.round((s-n)/36e5):null,r=o>=72;
...
case _:this._params.height||this._$tableau.height(parseInt(i[1],10)+2*m);break;case f:this.close()}}}var s="https://yastatic.net",o="/tableau/tableau.html",r="tableau",a=r+"_opened",c=r+"_closed",h=r+"_device_",l=r+"__content",u=r+"__tail",d="tableau.",p=d+"ready",f=d+"close",_=d+"height",m=1,g=150,b="",v=!1,y=[],k={};
...
},i.prototype._reposition=function(){"number"==typeof this._top&&this._$tableau.css("top",this._top-m),"number"==typeof this._left&&this._$tableau.css("left",this._left-m),"number"==typeof this._tail&&this._$tail.css("left",this._tail)
...
},i.prototype._buildTail=function(){return e("<div/>",{"class":u})},i.prototype._buildAndAppendTableau=function(t,i,n){return e("<div/>",{"class":[r,h+t.device,c].join(" "),css:{width:t.width+2*m,height:t.height&&t.height+2*m,zIndex:t.zIndex}}).append(n).append(i).appendTo("body")
...
},_stopProgress:function(){return this._timeout?(this._clearTimers(),void this.update(0)):(this._clearTimers(),this.update(1,"finish"),void(this._timeout=setTimeout(function(){delete this._timeout,this.update(1,"hide")
}.bind(this),i)))},_clearTimers:function(){this._timeout&&(clearTimeout(this._timeout),delete this._timeout),this._interval&&(clearInterval(this._interval),delete this._interval)
...
}},_hide:function(){this._dropdown&&this._dropdown.hide()},_onClick:function(t){t.preventDefault(),this.__base.apply(this,arguments),this._dropdown&&this._dropdown.toggle(this.elem(this.elem("icon").length?"icon":"name"))
...
this._isMenuOpened()?w(i,t.off[0],t.off[1]):w(i,e[0],e[1])}}),_borschik("DwLEvvDqfoTuiFE1vuwGeV_2ErI")&&BEM.DOM.decl("dropdown",{onSetMod:{js:function(){var t=this,e=t.params,i=t._popup=t.findBlockOn(t.elem(e.popupElem),"popup");
i.on("show",this._onPopupShow,this).on("hide",this._onPopupHide,this),e.popupMethods.map(function(e){t[e]=i[e].bind(i)
...
},destruct:function(){this._popup&&(this._popup.un("show",this._onPopupShow,this).un("hide",this._onPopupHide,this),this._popup.domElem&&BEM.DOM.destruct(this._popup.domElem)),this.__base.apply(this,arguments)
...
}},_onPopupShow:function(){this.setMod("action","open").trigger("show")},_onPopupHide:function(){this.setMod("action","closed").trigger("hide")
...
})}}),_borschik("37dEdB3GojphoYvNWueCUY7jf2o")&&BEM.DOM.decl("popup",{onSetMod:{js:function(){this.__base(),this._tailPos={}
...
})},pressed:function(t,e){return this.isDisabled()?!1:void this.trigger("yes"===e?"press":"release")}},isDisabled:function(){return this.hasMod("disabled","yes")
},url:function(t){return"undefined"==typeof t?this._href:(this._href=t,this.isDisabled()||this.domElem.attr("href",t),this)
},_onClick:function(t){this.isDisabled()?t.preventDefault():this.afterCurrentEvent(function(){this.trigger("click")
})}},{live:function(){this.liveBindTo("leftclick tap",function(t){this._onClick(t)})}}),_borschik("51Lr7fUE6SX1NdJQ5ISiAWQIpFE")&&BEM.DOM.decl("button",{onSetMod:{js:function(){this.__base.apply(this,arguments)
...
},"":function(){this.unbindFromWin("unload").unbindFrom("keydown"),this._isControlFocused()&&this._getControl().blur(),this.trigger("blur")
}},disabled:function(t,e){this.__base.apply(this,arguments),"yes"===e&&this.domElem.keyup()},hovered:function(t,e){return this.isDisabled()?!1:void(""===e&&this.delMod("pressed"))
...
if(this._owner){var e=this._viewport;t.top-=e.scrollTop(),t.left-=e.scrollLeft()}return t}}),_borschik("ouv3n97Go_-N5WhhG2UzJH8MWqo")&&BEM.DOM.decl("click",{onSetMod:{js:function(){this.action=this.params.action,this.bindTo("click",this.onClick.bind(this))
...
t.execute()}}),_borschik("EfKMRWrfQCpa8TUZnTEQG9SYh9U")&&BEM.DOM.decl("clickable",{onSetMod:{js:function(){this.bindTo("click",this.onClick.bind(this))
}},onClick:function(t){t.originalEvent.handled=!0}}),_borschik("OQYYlNZLGXjmC2VipuLVfUuafP0")&&BEM.DOM.decl({block:"dropdown-menu",baseBlock:"dropdown"}),_borschik("fYqw_wHv7ns4l92N80FdvNjJaVs")&&BEM.DOM.decl("i-menu",{onElemSetMod:{item:{state:{current:function(t,e,i,n){if("disabled"==n)return!1;
...
if(this.params.oldMailCounter=i.oldMailCounter,this.params.hasMailBox=i.hasMailBox,this._disableRequest())return void BEM.DOM.update(this.domElem,BEM.I18N("user","ÐÐ¾ÑÑÐ°"));
...
}}),_borschik("o6961aPI5tMQLbyBkl9yat8mno8")&&BEM.DOM.decl({name:"user",modName:"account",modVal:"yes"},{onSetMod:{js:$.noop},update:function(t,e,i,n,s){this.params={uid:e,pos:s,avatarHost:"//avatars.yandex.net"},this._isRetina=BEM.blocks["i-ua"].hiDpi,this.updateIcon();
var o=[this.elem("first-letter").text(n.charAt(0)),n.slice(1)];this.elem("name").html(o),this.delMod("blank")
...
},getCountNotice:function(){return this._countNotice},setCountNotice:function(t){this._countNotice=t}}),_borschik("vWFEbuXPlYnzj7KDttne1tRcvm4")&&BEM.DOM.decl("auth",{onSetMod:{js:{inited:function(){this._username=this.findBlockInside("username","input").on("change",this._onInputChange,this),this._password=this.findBlockInside("password","input").on("change",this._onInputChange,this),this._button=this.findBlockInside("button","button"),this._error=null,this._errorOwner=null,this.bindTo("submit",this._onBeforeSubmit),this.redraw()
}}},destruct:function(){this._error&&this._error.destruct(),this.__base.apply(this,arguments)},_checkInput:function(t){var e=this,i=this.__self._getValidators(e,e._username.val(),e._password.val(),{checkEmpty:t}),n=i.every(function(t){var i=t();
return Array.isArray(i)?(e.showError(i[0],BEM.I18N("auth",i[1])),i[0].elem("control").attr("aria-invalid",!0),!1):!0
});return n&&(this.hideError(),this._username.elem("control").removeAttr("aria-invalid"),this._password.elem("control").removeAttr("aria-invalid")),n
},_onInputChange:function(){this._checkInput(!1)},enableButton:function(){return this._button.delMod("disabled"),this
},disableButton:function(){return this._button.setMod("disabled","yes"),this},_onBeforeSubmit:function(t){return this._username.val(this._username.val().trim()),this._checkInput(!0)?(this._onSubmit(t),void this.trigger("submit",t)):!1
...
},_getValidators:function(t,e,i,n){var s=n.checkEmpty,o=this;return[function(){return s&&0===e.length?[t._username,"fill-input"]:!0
},function(){return s&&0===i.length?[t._password,"fill-input"]:!0},function(){return/[Ð°-ÑÐ-Ð¯ÑÐ]/.test(i)?[t._password,"wrong-keyboard-layout"]:!0
},function(){return o._isUsernameValid(e,!s)?!0:[t._username,"wrong-characters"]},function(){return o._isPasswordValid(i)?!0:[t._password,"wrong-characters"]
},function(){return i&&i===e?[t._password,"wrong-password"]:!0}]}}),_borschik("8HuK6X5SQDrsntZClirOf6pgffo")&&BEM.DOM.decl("auth",{onSetMod:{js:{inited:function(){var t=this;
...
})}}}}),_borschik("NwJB-PUqYWVZlaWj5M0fAq3kIKs")&&BEM.DOM.decl("auth",{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._socialDropdown=null,this._initSocialProviders()
...
})}},_getSocialProviders:function(t,e){var i=this.elem("social");i.css("height",this.__self._socialStubHeight),$.getJSON(this.__self._getProvidersURL(t),function(t){i.css("height",""),e(t.providers)
})},_createSocial:function(t){return t.length?(BEM.DOM.update(this.elem("social"),BEMHTML.apply(this.__self._buildSocial(t,this._uniqId))),void(this._socialDropdown=this.findBlockInside("social","dropdown"))):(this.elem("social").remove(),void this.dropElemCache("social"))
},_onSocialClick:function(t){t.preventDefault();var e=BEM.blocks["i-global"];this._socialDropdown&&this._socialDropdown.hide(),BEM.blocks["social-broker"].start(function(){e.param("retpath")&&top.location.href!==e.param("retpath")?top.location.href=e.param("retpath"):top.location.reload()
},function(){},{provider:this.elemParams(t.data.domElem).provider})}},{live:function(){return this.__base.apply(this,arguments),this.liveBindTo("social-link","leftclick tap",function(t){this._onSocialClick(t)
...
}return s},_socialStubHeight:28}),_borschik("LGZqq3e1XGzniVJncwyhH5WAZr8")&&BEM.decl("social-broker",{_windowWidth:500,_windowHeight:280,onSetMod:{js:{inited:function(){this._window=null,this._timer=0,this._boundWindowMessageHandler=this._onWindowMessageHandler.bind(this)
...
},[]).join("&"),s&&"popup"!==s?void this._navigate(n):(this._window=window.open(n,r,a._getPopupParams(),!1),void(this._window&&(BEM.DOM.win.on("message",this._boundWindowMessageHandler),this._window.focus(),clearInterval(this._timer),this._timer=setInterval(function(){a.isClosed()&&(clearInterval(a._timer),BEM.DOM.win.off("message",a._boundWindowMessageHandler),a.onFailure({status:"error"}))
},500))))},_onWindowMessageHandler:function(t){var e=location.protocol+"//"+location.host;if(t.originalEvent.origin===e)try{var i=JSON.parse(t.originalEvent.data);
"ok"===i.status?this.onSuccess(i):"error"===i.status&&this.onFailure(i)}catch(n){}},isClosed:function(){if(!this._window)return!0;
...
}}),_borschik("Jr5GnIQpBr-is4wfC7x7LXMiMYM")&&!function(){BEM.DOM.decl("i-ua",{},{placeholder:"placeholder"in document.createElement("input")})
...
}),this):this.hasMod(this.elem("clear"),"pressed")?this:(this._focused=!1,this.delMod("focused"))},_focus:function(){return this.hasMod("disabled","yes")?!1:void this.elem("control").focus()
...
})}}),_borschik("Bqe3B-9IJx4a1-4iZkwhY1j1lgs")&&!function(){var t,e=[],i=function(){e.forEach(function(t){t.val(t.elem("control").val())
})};BEM.DOM.decl("input",{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._instanceIndex=e.push(this)-1;
var n=this.elem("control"),s=$.dom.getActiveElement(),o=this.params.autoFocus&&!s.is("input, textarea");
(s[0]===n[0]||o)&&(this.setMod("focused","yes")._focused=!0),t||(t=this.channel("sys").on({tick:i,idle:function(){t.un("tick",i)
...
},focused:function(){return this.__base.apply(this,arguments)===!1?!1:void(this._hasHint&&this._updateHint())
}},_updateHint:function(){this.toggleMod(this.elem("hint"),"visibility","visible",!this.val())}}),_borschik("2PS90af9GyFBq6GWaxATi33bz0Y")&&BEM.DOM.decl("tabs-navigation",{onAjaxSuccess:function(t){t.html&&(this.dropElemCache(),BEM.DOM.update(this.domElem,$(t.html).html()))
...
},updateRequeryVisible:function(t){this.elem("requery-visible").html(t)}}),_borschik("gWelOYrRPjlTN5fLe-kRivhi6zM")&&BEM.DOM.decl("input",{onSetMod:{js:function(){if(this.__base.apply(this,arguments),this.elem("found").length){var t=this.elem("control");
...
},setFound:function(t,e){this.elem("found").text(t),this.elem("query-holder").text(e),this.setPosition()
...
})}}}),_borschik("tbxoh75MGICWeUUSOzFaqBi70s4")&&!function(){var t=function(t){var e=t.charCode||t.keyCode||t.which||0,i=t.ctrlKey||t.altKey||t.metaKey,n=e>=48&&57>=e,s=e>=96&&105>=e,o=[e>=65&&90>=e,e>=1025&&1071>=e,0===e,231===e].some(Boolean);
...
}catch(n){}if(t(e)&&"input"!==i&&"textarea"!==i){var s=this.elem("control")[0],o=this.val();if(o.length>0&&" "!==o.slice(-1)&&(o+=" ",this.val(o)),s.createTextRange){var r=s.createTextRange();
r.collapse(!1),r.select()}else s.selectionStart&&s.setSelectionRange(o.length,o.length);this.setMod("focused","yes")
...
}}),_borschik("d1S9rj4zPr0qilw8wN8OvVni_oE")&&BEM.DOM.decl("suggest2",{onSetMod:{js:{inited:function(){this.params.form||this.findBlockOutside("suggest2-form"),this._lastSubmitTime=0,this._lastBlurTime=0,this._clear()
}}},_bodyHandler:function(t){if(!this._isDestructing){var e=$(t.target),i=this.containsDomElem(e)||this.params.form.containsDomElem(e);
i||(this._freezeInputFocus=!1)}},getDefaultParams:function(){return{submitBySelect:!1,updateOnEnterByKeyboard:!0,onFocus:"request",requestOnEmptyInput:!1,abortQueries:!1,sequentialQueriesTimeout:!1}
},destruct:function(){this.unbindAllEvents(),this.__base.apply(this,arguments)},init:function(){var t=this;
return t.params.form.on("submit",function(e,i){t._lastSubmitTime=(new Date).getTime(),t._isActualSearchCGIParams?t._isActualSearchCGIParams=!1:"suggest2-counter"!==i.data.block&&i.data.prevent!==!1&&this.removeHiddenInputs(),t._clear(),t._popup.hide()
}),t._input=t.params["suggest2-input"],t._popup=t.params["suggest2-popup"],t._inputValue=t._input.val(),t._model=t.initModel(),t._view=t.initView(),t._counter=t.initCounter(),t._model.on({response:this.setItems,reject:function(e,i){2===i.code&&(t._popup.hide(),t._clear())
}},t),t.bindToDoc("click tap leftclick",t._bodyHandler),t.bindEvents(),t},initModel:function(){return BEM.create("suggest2-model",this.params)
},getModel:function(){return this._model},initView:function(t,e){return BEM.create({block:"suggest2-view",mods:t||{}},e||{})
...
},show:function(){t._onShow()},hide:function(e,i){t._onHide(i)}}),t.params.form&&t.params.form.on("button-press",t._onSearchButtonMousedown,t),BEM.blocks["suggest2-item"].on(t.domElem,{"link-click":function(e,i){t._counter&&"_self"===$(i.$e.target).attr("target")&&i.$e.preventDefault()
}}),t},_onShow:function(){this.trigger("show")},_onHide:function(t){this.trigger("hide",t)},_onSearchButtonMousedown:function(){this._input.realVal(this._input.val()),this._popup.hide()
},unbindAllEvents:function(){var t=this;return t.unbindFromDoc("click tap leftclick"),t._input.unbindAllEvents(),t.params.form.un("submit"),t._model.un("response").un("reject"),t._popup.un("preshow").un("show").un("hide"),t.params.form&&t.params.form.un("button-press",t._onSearchButtonMousedown,t),t
...
},getPopupWidth:function(){},getInputWidth:function(){return 0},isNeedSubmitFormOnSelectItem:function(t){return this.params.submitBySelect&&"link"!==t.getMod("interact")
...
},_onFocus:function(){!this._popup.isShown()&&this._isBlur&&this.params.onFocus&&this._isLastBlurTimeLater(50)&&(this.getItems().length&&this._input.val()===this._text?(this._clearItems(),this._popup.show()):this._isMouseDown||"request"!==this.params.onFocus||this._doRequest())
...
})))},_onDownItem:function(){this._isBlur=!1,this._isMouseDown=!0}}),_borschik("OrM_4a7wgmCjUA-w2vNIe4-Xg1o")&&BEM.DOM.decl("suggest2",{getInputLeft:function(){return 0
},getInputWidth:function(){return 0},getContainerWidth:function(){return 0},getMetrics:function(){var t=this.getInputLeft(),e=this.getInputWidth(),i=this.getContainerWidth()-t;
return{marginLeft:t,minWidth:e>=i?i:e,maxWidth:i}},adjustView:function(){return{}}}),_borschik("mZLwvju1Li_grxjwrCiKH5hio1Q")&&BEM.DOM.decl("suggest2",{bindEvents:function(){var t=this;
...
return-1===n||n===i?(this._enterItemIndex=n,this._unselectItems(this._items[n]),this.trigger("out",{val:this._text,byKeyboard:!0})):(0>n?n=i-1:n>=i&&(n=0),void this._onEnterItem(this._items[n],!0))
...
},_onChange:function(t,e){e&&e.noSuggest||this.__base.apply(this,arguments)}}),_borschik("KcUgeNhltwShGEuZ55_HRFDTj9E")&&BEM.decl("suggest2-model",{onSetMod:{js:{inited:function(){this._requests=[]
...
}}}}),t}(jQuery),_borschik("8DSkwM_7X5YQUw5u6LeLHSzMBnk")&&BEM.decl("suggest2-provider",{getDefaultParams:function(){return{cache:!1,type:"GET",dataType:"jsonp",timeout:2e3}
},_lastQuery:null,get:function(t,e,i){var n=this,s=this.params.abortQueries,o=function(){i.call(n,t,e,n.convert(n._lastData))
};return n._lastText===t?this._lastQuery.always(o):(n._lastText=t,s&&null!==this._lastQuery&&this._lastQuery.abort(),void(this._lastQuery=$.ajax(n._extendParamsData(n.getRequestData(t,e))).done(function(t){n._lastData=t,s&&o()
}).fail(function(){n._lastData=[]}).always(function(){s||o()})))},convert:function(t){return{orig:t[0],items:t[1],meta:t[2]}
...
}}),_borschik("wqvbAc4W7zwK02024pFydiSIhKU")&&BEM.decl("suggest2-view",{html:function(t,e){return BEMHTML.apply(this.build(t,e))
...
}),c.push(s,$.extend({elem:"icon",elemMods:{size:"s"}},h)),e.fact&&c.push({elem:"fact",content:e.fact})
...
}}),_borschik("mzvMzCFKLCyqeHRynSLxDpHvLXY")&&BEM.decl("suggest2-view",{},{_getGroupType:function(t,e){return t.pers?"nah":~["nav"].indexOf(e)?e:"text"
},_getTextLabel:function(t){return BEM.I18N("suggest2",t)}}),_borschik("slDPDjzbFvzN3TQxZR7xgvC7bGI")&&BEM.decl("suggest2-input",{onSetMod:{js:{inited:function(){var t=this;
t._input=t.params.input,t.disableBrowserAutocomplete(),t.realVal(t.val()),t.bindEvents({change:function(e,i){t._onChange(e,i)
},clear:$.throttle(function(e,i){t._onClear(e,i)},300)}),t.bindSuggestEvents()}}},_onChange:function(t,e){this.trigger("change",e)
},_onClear:function(t,e){this.trigger("clear",e)},destruct:function(){this.unbindAllEvents(),this.__base.apply(this,arguments)
...
},moveCaretToEnd:function(){var t=this.getControl()[0],e=t.value.length;if("undefined"!=typeof t.createTextRange){var i=t.createTextRange();
i.collapse(!1),i.select()}else"number"==typeof t.selectionStart&&(t.scrollLeft=999999,t.setSelectionRange(e,e));
...
}},this),BEM.blocks["suggest2-item"].on(t.domElem,{tpah:this._onSuggestItemTpah,select:this._onSuggestItemSelect,enter:this._onSuggestItemEnter},this),this
},_onSuggestItemTpah:function(t,e){this._changeValueByEvent(t,e),this.moveCaretToEnd()},_onSuggestItemSelect:function(t,e){"link"!==t.block.getMod("interact")&&(this._changeValueByEvent(t,e),this.moveCaretToEnd())
},_onSuggestItemEnter:function(t,e){this.a11yActive(e.id),e.byKeyboard&&this.params.updateOnEnterByKeyboard&&(this._changeValueByEvent(t,e),this.moveCaretToEnd())
},unbindAllEvents:function(){return this._input.domElem&&this._bindedEventsNames.forEach(function(t){var e=this._eventsFilter(t);
...
}}),_borschik("0_lmdv3U7GCuZ2Ga8cBD5LmiPik")&&BEM.decl("suggest2-input",{onSetMod:{js:{inited:function(){var t=this;
t.__base.apply(this,arguments),t.bindEvents({keydown:function(e){t._onKeyDown(e)}},t)}}},_onKeyDown:function(t){t.which===this.params.suggest.__self.keyboard.enter&&this.trigger("enter")
...
}}),_borschik("oJAHdRltd9C8QusaALD_1MQl6BE")&&BEM.DOM.decl("suggest2-item",{},{live:function(){this.__base.apply(this,arguments),this.liveBindTo("mouseover mouseout mousedown leftclick",function(t){this.trigger(t.type,t)
}).liveBindTo("link","leftclick",function(t){this.trigger("link-click",{$e:t})})}}),_borschik("UHJS6OmpWxzzolRcRz06lkGsH2Q")&&BEM.DOM.decl({block:"suggest2-item",modName:"interact",modVal:"link"},{onSelect:function(t){var e=this;
e.__base.apply(e,arguments);var i=e.elem("link");return t||"_self"===i.attr("target")?function(){e._locationChange(i.attr("href"))
}:void 0},_locationChange:function(t){window.location=t},valOnSelect:function(){return!1}}),_borschik("fNIkwKgc_vMgpE8IfX5BIfRmmk8")&&BEM.DOM.decl({block:"suggest2",modName:"theme",modVal:"large"},{init:function(){this.__base.apply(this,arguments),this.adjustView()
},initView:function(t,e){return t=t||{},this.__base($.extend(t,{theme:"large",group:t.group||this.getMod("group")||"type"}),e)
},adjustView:function(){this.__base.apply(this,arguments);var t=this.getMetrics();this._view.setMarginLeft(t.marginLeft),this._view.setMinWidth(t.minWidth),this._view.setMaxWidth(t.maxWidth)
},getInputLeft:function(){var t=this._input.get().findElem("control"),e=t.offset(),i=t[0];if(!i)return 0;
var n=i.currentStyle?i.currentStyle:window.getComputedStyle(i),s=parseInt(n.borderLeftWidth,10)||0,o=parseInt(n.paddingLeft,10)||0;
return e.left+s+o},getInputWidth:function(){return this._input.get().domElem.outerWidth()},getContainerWidth:function(){return BEM.DOM.scope.width()
}}),_borschik("GTDzYSxQpAlJ6oxeH8Au9fmL3-Y")&&BEM.decl({block:"suggest2-view",modName:"theme",modVal:"large"},{build:function(){var t=this.__base.apply(this,arguments);
return t.mods.theme="large",t}}),_borschik("n3C3Uehw6D9c9ioYsxcO257PxfU")&&BEM.decl({block:"suggest2-view",modName:"theme",modVal:"large"},{getMinWidth:function(){return this._minWidth||0
},getMaxWidth:function(){return this._maxWidth||0},setMinWidth:function(t){return this._minWidth=t,this
},setMaxWidth:function(t){return this._maxWidth=t,this},getMarginLeft:function(){return this._marginLeft
},setMarginLeft:function(t){return this._marginLeft=t,this},build:function(){var t=this.__base.apply(this,arguments),e=["min-width:"+this.getMinWidth()+"px;"],i=this.getMaxWidth();
i&&e.push("max-width:"+i+"px;");var n=this.getMarginLeft();return n&&e.push("margin-left:"+n+"px;"),t.attrs={style:e.join(" ")},t
}}),_borschik("o9PPHDlMo4o5eJCKE01P4lw5b6o")&&BEM.decl({block:"suggest2-view",modName:"group",modVal:"type"},{buildItems:function(t){var e,i;
...
}.bind(this),[])}}),_borschik("6JX3PAdMsSVVqtR5hrbXQd40pm8")&&BEM.DOM.decl({block:"suggest2",modName:"adaptive",modVal:"yes"},{init:function(){this.__base.apply(this,arguments),this._boundResizeHandler=this._resizeHandler.bind(this),this.__self._bindToWinResize(this._boundResizeHandler)
},_resizeHandler:function(){this._popup.width(this.getPopupWidth())},destruct:function(){this.__self._unbindFromWinResize(this._boundResizeHandler),this._boundResizeHandler=null,this.__base.apply(this,arguments)
}},{_resizeCallbacks:[],_bindToWinResize:function(t){return this._resizeCallbacks.push(t),this},_unbindFromWinResize:function(t){for(var e=0;e<this._resizeCallbacks.length;e++)if(this._resizeCallbacks[e]===t)return this._resizeCallbacks.splice(e,1),this;
return this},_getResizeCallback:function(){return $.throttle(function(){var t=arguments;this._resizeCallbacks.forEach(function(e){e.apply(this,t)
},this)},300,this)},live:function(){this.__base.apply(this,arguments),this._resizeCallback=this._getResizeCallback(),BEM.DOM.win.on("resize",this._resizeCallback)
}}),_borschik("Y8xCxdYfG660MHi83pT5Ikrlf4w")&&BEM.DOM.decl({block:"suggest2",modName:"adaptive",modVal:"yes"},{_minWidth:0,_maxWidth:0,_resizeHandler:function(){this.__base.apply(this),this.hasMod("theme","large")&&this.adjustView()
},_onShow:function(){this.__base.apply(this),this.hasMod("theme","large")&&this._applyMetricsToContent()
},adjustView:function(){this.__base.apply(this,arguments);var t=this.getMetrics(),e=t.minWidth,i=t.maxWidth,n=!1;
return e!==this._minWidth&&(this._minWidth=e,n=!0),i!==this._maxWidth&&(this._maxWidth=i,n=!0),n&&this._popup.isShown()&&this._applyMetricsToContent(),t
},_applyMetricsToContent:function(){var t=this.findElem("content");this._minWidth&&t.css("min-width",this._minWidth),this._maxWidth&&t.css("max-width",this._maxWidth)
}}),_borschik("KbZRbUKx7Amyue6mJR2qq6GWLxQ")&&BEM.DOM.decl({block:"suggest2",modName:"group",modVal:"label"},{initView:function(t,e){return this.__base($.extend(t||{},{group:"label"}),$.extend(e||{},{label:this.params.label}))
}}),_borschik("-QuXxtSeTC8mTAyz1W6QEbQxKiQ")&&BEM.decl({block:"suggest2-view",modName:"group",modVal:"label"},{buildItems:function(t){var e,i;
...
}return i.push(this.buildItem(n)),t}.bind(this),[])}}),_borschik("Bpe64ld9JRM0Z1TnIYZ-dhOmDQ4")&&BEM.DOM.decl("suggest2-form",{onSetMod:{js:{inited:function(){this._isReady=!1,this._nodes=this.initNodes()
}}},getDefaultParams:function(){return{inputName:"input",buttonName:"button",popupName:"popup"}},destruct:function(){this._nodes.forEach(function(t){t.suggest.domElem&&BEM.DOM.destruct(t.suggest.domElem),this.unbindFormEvents(t),t.counter&&t.counter.destruct(),t.proxies.input.destruct(),t.proxies.popup.destruct()
...
},this)},bindFormEvents:function(t){var e=this;return t.button&&t.button.bindTo("click press",function(t){e._onButtonClick(t)
}),e.bindTo("submit",function(t,i){e.onSubmit(t,i)}),e},_onButtonClick:function(t){this.trigger("button-click",t)
},unbindFormEvents:function(t){var e=this;return t.button&&t.button.un("click press"),e.unbindFrom("submit"),e
},submit:function(t){return this.domElem.trigger("submit",t||{}),this},onSubmit:function(t,e){t.data=e||{},this.trigger("submit",t)
...
}}),_borschik("fsSDizET4vJv4nnBygu8W0g_b90")&&BEM.DOM.decl("suggest2-counter",{onSetMod:{js:{inited:function(){this.clear()
...
},attachReqID:function(){this._reqID=this.__self._generateReqID(),this.params.form.appendHiddenInputs([{name:"suggest_reqid",value:this._reqID}])
},bindEvents:function(){var t=this,e=t.params,i=e.suggest,n=e.form,s=i.getModel(),o=i.params["suggest2-input"],r=i.params["suggest2-popup"];
return n.on({"button-click":t._onFormButtonClick,submit:t._onFormSubmit},t),s.on({request:t._onModelRequest,response:t._onModelResponse},t),o.on({change:t._onInputChange,enter:t._onInputEnter},t),r.on({show:t._onPopupShow,hide:t._onPopupHide},t),BEM.blocks["suggest2-item"].on(i.domElem,"enter",t._onSuggestItemEnter,t),i.on({update:t._onSuggestUpdate,select:t._onSuggestSelect},t),t
},_onFormButtonClick:function(){"keyboard"!==this._path.submit&&(this._path.submit="button_by_mouse")
},_onFormSubmit:function(t,e){e.data.block!==this.__self.getName()&&e.data.prevent!==!1&&(this.params.preventSubmit&&(e.stopImmediatePropagation(),e.preventDefault()),this.submit())
},_onModelRequest:function(){this._requestTime=new Date},_onModelResponse:function(t,e){e.data.items&&(this._path.personal=this._hasPersonal(e.data.items)?"nah_not_used":"nah_not_shown",this._meta=e.data.meta||{},this._addTime(new Date-this._requestTime),this._renderTime=new Date,this._setMetaProps(e))
},_onInputChange:function(t,e){e&&"clear"!==e.source||(this._params.user_input=t.block.val(),this[this._firstChange?"_lastChange":"_firstChange"]=new Date),this._ratio.actionsCount++
},_onInputEnter:function(){this._path.submit="keyboard"},_onPopupShow:function(){this._path.state="not_used"
},_onPopupHide:function(t,e){"empty"===e.response&&(this._path.state="not_shown")},_onSuggestItemEnter:function(t,e){e.byKeyboard&&this.params.suggest.params.updateOnEnterByKeyboard&&(this._selectedText=e.val,this._path.state="suggest")
},_onSuggestUpdate:function(){this._addRenderTime(new Date-this._renderTime)},_onSuggestSelect:function(t,e){var i=this;
i._path.state=e.byKeyboard?"keyboard":"mouse",i._path.index=e.itemIndex+1,i._selectedText=e.val,e.item.hasMod("personal")&&(i._path.personal="nah_used"),i.params.submitBySelect&&(i._path.submit=e.byKeyboard?"keyboard":"click_by_mouse",i._params.pos=e.pos,i._params.text=this._selectedText),i.params.suggest.isNeedSubmitFormOnSelectItem(e.item)||i.submit({submitForm:!1,afterSendAjaxCallback:e.callbackOnSelect})
},unbindAllEvents:function(){var t=this.params,e=t.suggest,i=t.form;return i.un("button-click").un("submit"),e.getModel().un("request").un("response"),e.params["suggest2-input"].un("change").un("enter"),e.params["suggest2-popup"].un("show").un("hide"),e.un("select"),this
...
},_addTime:function(t){return this._times.push(t),this._params.times=this._times.join("."),this},_addRenderTime:function(t){return this._renderTimes.push(t),this._params.render_times=this._renderTimes.join("."),this
},_getData:function(){return{"*data":"url="+this.params.dataUrl}}},{_generateReqID:function(){var t=BEM.blocks["i-global"]&&BEM.blocks["i-global"].param("yandexuid")?BEM.blocks["i-global"].param("yandexuid"):this._random(9)+this._random(9);
...
}}),_borschik("VCUs4KpGs3WiQYrzRuppODxCKAU")&&BEM.decl({block:"suggest2-popup",modName:"for",modVal:"popup2"},{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._popup.on("beforeClose",function(){this.afterCurrentEvent(function(){BEM.blocks["suggest2-detect"].isPressedEscape()&&this.trigger("hide",{})
})},this)}}},show:function(t){return this._popup.domElem?(t&&this._popup.setContent(t),this.isShown()?this:(this.trigger("preshow"),this._popup.setAnchor(this.params.owner),this._popup.setMod("visible","yes"),this.trigger("show"),this)):this
},hide:function(t){return this.isShown()&&(this._popup.delMod("visible"),this.trigger("hide",t||{})),this
},isShown:function(){return this._popup?this._popup.hasMod("visible","yes"):!1}}),_borschik("20WyJQpdEPZB-6AMhP3V-2_Wbfc")&&BEM.DOM.decl("popup2",{onSetMod:{js:{inited:function(){this._parentPopup=void 0,this._zIndex=null,this._zIndexGroupLevel=null,this._isAttachedToScope=!1
...
},_unbindFromParentPopup:function(){return this._parentPopup&&this._parentPopup.un("beforeClose",this._onParentPopupClose,this),this._parentPopup=void 0,this
...
var t=this.__self._visiblePopupsZIndexes,e=this._zIndexGroupLevel,i=t[e],n=this._zIndex;return i||(i=t[e]=[(e+1)*this.__self.ZINDEX_FACTOR]),this._zIndex=i[i.length-1]+1,i.push(this._zIndex),this._zIndex!==n&&this.domElem.css("z-index",this._zIndex),this
...
},getDefaultParams:function(){return{zIndexGroupLevel:0}}},{live:!0,_visiblePopupsZIndexes:{},ZINDEX_FACTOR:1e3,_pointerPressEvent:"mousedown"}),_borschik("_61gGbPwL4ldJt9v8MG8f_VNO60")&&BEM.DOM.decl("popup2",{isShown:function(){return this.hasMod("visible","yes")
},hide:function(){return this.delMod("visible")},show:function(){return this.setMod("visible","yes")}}),_borschik("s9-RQ6nJTihYo3BvOqkuh_lPbgE")&&BEM.DOM.decl({block:"popup2",modName:"autoclosable",modVal:"yes"},{onSetMod:{visible:{yes:function(){this.__self._visiblePopupsStack.unshift(this),this.afterCurrentEvent(function(){this.domElem&&this.bindToDoc("leftclick tap",this._onDocClick)
...
}},{live:function(){BEM.DOM.doc.on("keydown",this._onDocKeyPress.bind(this))},_visiblePopupsStack:[],_onDocKeyPress:function(t){BEM.blocks.keycodes.is(t.keyCode,"ESC")&&this._visiblePopupsStack.length&&this._visiblePopupsStack[0].delMod("visible")
...
}).liveBindTo({modName:"pseudo",modVal:"yes"},"keyup",function(t){this._onKeyUp(t)})}}),_borschik("vGKWNWPgWY9kfpEhs2n7iWSgxfc")&&(BEM.DOM.decl("b-keyboard-loader",{onSetMod:{js:function(){Lego.block["b-keyboard-loader"].call(this.domElem,this.params)
...
}),!p.length)return void n("error");r.timeout&&(a=setTimeout(function(){var e=u.concat(d);t.each(p,function(i,n){-1===t.inArray(n,e)&&d.push(n)
}),n("error")},r.timeout)),t.each(h,function(i,n){t.isArray(n)?t.each(n,function(t,n){e(i,n)}):"string"==typeof n&&e(i,n)
})}},this.js=function(e,n){var s=t('script[src*="'+e+'"]');if(s.length)return void(s.attr("pending")?s.bind("scriptload",n):n());
...
},i.appendChild(r)},this.css=function(e,n){if(t('link[href*="'+e+'"]').length)return void n();var s=document.createElement("link");
...
}).liveBindTo("item-selector","leftclick",function(t){this.onItemSelectorClick(t)})}}),_borschik("RnkqIKfsBHAVxl7Q_zPiWeI-PPY")&&BEM.DOM.decl("content",{onSetMod:{js:function(){var t=this.findBlockOutside("main");
...
return i/n*100}}),_borschik("2a-EDcR9wCmW_Eysp4WLcN8DEDY")&&BEM.DOM.decl("select",{onSetMod:{js:function(){this._items=[],this._curItemIndex=-1,this._scrollableElemOutsidePopup=null,this._rowHeight=22,this.on("change",this._redrawParentPopup);
...
},focused:{yes:function(){return this.hasMod("disabled","yes")?!1:(this._useNativeControl()||this.bindTo("keydown",this._onKeyDown),void this.afterCurrentEvent(function(){this.trigger("focus")
}))},"":function(){this._useNativeControl()||this.delMod("opened").unbindFrom("keydown"),this.afterCurrentEvent(function(){this.trigger("blur")
...
},open:function(){return this.setMod("opened","yes")},close:function(){return this.delMod("opened")},val:function(t,e){if("undefined"==typeof t)return this.elem("control").val();
var i,n=-1;return this.findElem("option").each(function(e){this.value===t&&!this.disabled&&(i=$(this).parent("optgroup")[0],!(i&&i.disabled))&&(n=e)
}),n>-1&&this._selectedIndex(n,e),this},name:function(t){var e=this.elem("control");return arguments.length?(e.attr("name",t),this):e.attr("name")
},_selectedIndex:function(t,e){var i=this._getSelectedIndex();return"undefined"==typeof t||t===i?i:(this.elem("control").prop("selectedIndex",t),this._useNativeControl()||(this._setButtonText(this._getSelectedText()),this._items[0]&&this.delMod(this._items,"selected").setMod(this._items.eq(t),"selected","yes")),this.trigger("change",$.extend({index:t,prev:i},e)),t)
},setOptions:function(t){return t?(BEM.DOM.update(this.elem("control"),BEMHTML.apply($.map(t,this.__self._buildOption))),this.redraw()):this
},redraw:function(){return this._popup&&this._redrawList(),this.elem("control").trigger("change"),this
},_useNativeControl:function(){return null!==this.__self.useNativeControl?this.__self.useNativeControl:this.__self.useNativeControl="none"!==this.elem("control").css("display")
},_redrawParentPopup:function(){return this._isParentPopup()&&this._popup._parent.repaint(),this},_isParentPopup:function(){return this._popup&&this._popup._parent&&!this.hasMod("layout","fixed")
},_onSelectChange:function(){var t=this;t._setButtonText(t._getSelectedText()),t.trigger("change",{index:t._getSelectedIndex(),prev:-1})
},_onControlFocusInOut:function(t){this._useNativeControl()&&this.toggleMod("focused","yes","","focusin"===t.type)
...
}return this._scrollableElemOutsidePopup},_onButtonBlur:function(){if(this.isOpened()&&this._isPopupFocused())if(8===BEM.blocks["i-ua"].ie){var t=this._findScrollableElemOutsidePopup(),e=t.scrollTop();
...
},_isPopupFocused:function(){try{return this._getPopup().containsDomElem($(document.activeElement))}catch(t){return!1
}},_getButtonText:function(){return this._getButton().elem("text").text()},_setButtonText:function(t){t.length&&(this._getButton().elem("text").text(t),BEM.blocks["i-ua"].ie<10&&this.domElem.parent().css("outline",""))
},_isOutsideClicked:function(t,e){return this.containsDomElem($(e.target))},_getItemIndex:function(t){return $.inArray(t.get(0),this._items)
...
}},destruct:function(){this._outPopup&&this._outPopup.un("outside-click"),this.delMod("opened"),this._popup&&this._popup.domElem&&BEM.DOM.destruct(this._popup.domElem),this.__base.apply(this,arguments)
},getDefaultParams:function(){return{rows:15,popupMods:{direction:"down"}}}},{live:function(){this.liveBindTo("control","change",function(){this._onSelectChange()
}),this.liveBindTo("control","focusin focusout",function(t){this._onControlFocusInOut(t)}),this.liveBindTo("mousedown",function(t){this._onMouseDown(t)
}),this.liveInitOnBlockInsideEvent("focus","button",function(){this._onButtonFocus()}).liveInitOnBlockInsideEvent("blur","button",function(){this._onButtonBlur()
}).liveInitOnBlockInsideEvent("press","button",function(){this._onButtonPress()})},useNativeControl:null,_buildOption:function t(e){var i={};
return"option"===e.item?(i={block:"select",elem:"option",tag:"option",attrs:{value:e.value},content:e.content},e.disabled&&(i.attrs.disabled="disabled"),e.selected&&(i.attrs.selected="selected")):"optgroup"===e.item&&(i={elem:"option-group",tag:"optgroup",attrs:{label:e.label}},e.disabled&&(i.attrs.disabled="disabled"),i.content=Array.isArray(e.content)?e.content.map(function(e,i){return t(e,i)
}):e.content),i.block="select",i}}),_borschik("SmaEVeHIQTzg2rbS34tGgMD7aBc")&&BEM.DOM.decl("select",{onElemSetMod:{item:{hovered:function(){BEM.blocks["i-ua"].opera<13&&this._popup.domElem.css("display","inline").css("display","")
}}}}),_borschik("7r0lSBJElJKvRjAWi3nh9sbHVe8")&&BEM.DOM.decl("select",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._initButton()
}},_initButton:function(){},_redrawList:function(){var t,e=this,i=this._getPopup().domElem;return BEM.DOM.update(this.findElem(i,"list"),this.__self._buildItemsHtml(this.elem("control").children())),t=this.findElem(i,"item"),this._curItemIndex=-1,this._items=t.filter(function(){return!e.hasMod($(this),"label","yes")
}),this}},{_buildItemsHtml:function(t){function e(t,e,i){var n={block:"select",elem:"item",content:{elem:"text",tag:"span",content:e||" &nbsp; "},elemMods:{}};
return i&&(n.elemMods=i),n}function i(t,n){var c=t.length;if(c){var h=0;do{var l=$(t[h]),u=l.attr("disabled")&&{disabled:"yes"};
...
var d=o;o=r.pop(),o.push({block:"select",elem:"group",content:d})}else o.push(e(l,l.html(),$.extend(u,l.is(":selected")&&{selected:"yes"},n)))
}while(++h<c||(a=!1))}}var n="select",s={block:n,elem:"separator",tag:"i"},o=[],r=[],a=!1;return i(t),BEMHTML.apply(o)
}}),_borschik("AlvFf0ZmeOjMXrxeeDmVFScrWtQ")&&BEM.DOM.decl("select",{_redrawList:function(){this.__base();
...
s>i.height()-o?t=e-o:n&&o>s&&(t=e-i.height()+o),t&&i.scrollTop(t)}}},{SHADOW_OFFSET:1}),_borschik("5-oivzaZGsMoWKm2FBZmj_Czj04")&&BEM.DOM.decl("serp-adv__banner",{onSetMod:{js:function(){window.swfobject?this.initFlash():this.flashErrorCallback()
...
}})},this.domElem.append(this.params.html)}}),_borschik("iCWplFiBziDd9htAQhTxR1XVi7I")&&BEM.DOM.decl("serp-adv__counter",{onSetMod:{js:function(){if(this.elemParams(this.domElem).counterUrl){if(this.domElem.offset().top<BEM.DOM.win.height())return void this._createImage();
...
}}),_borschik("wJIv1TjX-I3RdPHZkMIVQ4hz-Xk")&&BEM.DOM.decl({block:"showcase",modName:"overflow",modVal:"scroll"},{onSetMod:{js:function(){this._wrap=this.elem("wrap"),this._wrapWidth=this._wrap.width(),this._itemWidth=this.elem("item").outerWidth(!0),this._listWidth=this._wrap.get(0).scrollWidth,this._setScrollMod(),this.bindTo("arrow","leftclick tap",this._onArrowClick).bindTo("wrap","scroll",$.throttle(this._setScrollMod,50,this)),BEM.blocks["b-page"].on("resize",this._onResize,this)
}},destruct:function(){this.__base.apply(this,arguments),BEM.blocks["b-page"].un("resize",this._onResize,this)
},_onArrowClick:function(t){var e="right"===this.getMod(t.data.domElem,"direction"),i=this._getOffset(e);
this._wrap.stop().animate({scrollLeft:i},300,this._setScrollMod.bind(this))},_getOffset:function(t){var e=Math.floor(this._wrapWidth/this._itemWidth),i=e>2?e-2:1,n=this._wrap.scrollLeft();
return n+this._itemWidth*(t?1:-1)*i},_setScrollMod:function(){var t,e=this._wrap.scrollLeft();return t=this._listWidth-this._wrapWidth<=0?"no":0===e?"right":e+this._wrapWidth<this._listWidth?"both":"left",this.setMod("scroll",t)
},_onResize:function(){this._wrapWidth=this._wrap.width(),this._setScrollMod()}}),_borschik("odlHPC881r0zVnCPIwGcOZKUNYk")&&BEM.DOM.decl("video",{onSetMod:{js:function(){var t=this.findBlockOn("serp-item"),e=this.findBlockInside("video-player"),i=t.params.preview&&t.params.preview.common?"common":"video";
...
},_onPreviewButtonStateChange:function(t){return this._skipToggle?void(this._skipToggle=!1):void this.togglePreview(this.getMod(t.block.domElem,"name"))
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("sw5VXJQhbIzG-HgymyBE-aupFhY")&&BEM.DOM.decl({block:"popup2",modName:"target"},{onSetMod:{js:{inited:function(){var t=this.__self.AVAILABLE_DIRECTIONS;
this.params.directions.forEach(function(e){if(-1===t.indexOf(e))throw new Error("Can't init popup with \""+e+'" direction. Available directions: '+t.join(", "))
...
},redraw:function(){if(!this.hasMod("visible","yes")&&!this.hasMod("outside","yes"))return this;var t=this._calcBestDrawingParams();
this.setMod("direction",t.direction);var e=this._lastDrawingCss,i=!1;return $.each(this._calcDrawingCss(t),function(t,n){e[t]!==n&&(e[t]=n,i=!0)
}),i&&this.domElem.css(e),this},_calcDrawingCss:function(t){return{left:t.left,top:t.top}},calcPossibleDrawingParams:function(){var t=this._calcTargetDimensions(),e=this._calcViewportDimensions(),i=this.params,n=i.mainOffset,s=i.secondaryOffset,o=i.viewportOffset;
...
},_onWinScollAndResize:function(){this.redraw()},getDefaultParams:function(){return $.extend(this.__base.apply(this,arguments),{mainOffset:0,secondaryOffset:0,viewportOffset:0,directions:this.__self.AVAILABLE_DIRECTIONS})
}},{VIEWPORT_ACCURACY_FACTOR:.99,AVAILABLE_DIRECTIONS:["bottom-left","bottom-center","bottom-right","top-left","top-center","top-right","right-top","right-center","right-bottom","left-top","left-center","left-bottom"]}),_borschik("poT4Nm4aEIHQT3PehyQC0SvIi44")&&!function(t){function e(t,e){return t.addClass("i-bem "+e).bem(e)
}BEM.DOM.decl({block:"popup2",modName:"target",modVal:"anchor"},{onSetMod:{js:{inited:function(){this.__base.apply(this,arguments),this._anchor=null,this._anchorParents=null,this._destructor=null,this._isAnchorVisible=void 0,this._updateIsAnchorVisible=t.throttle(this._updateIsAnchorVisible,this.__self.UPDATE_TARGET_VISIBILITY_THROTTLING_INTERVAL,this)
...
}},{UPDATE_TARGET_VISIBILITY_THROTTLING_INTERVAL:100});var i=BEM.DOM;i.decl("_popup2-destructor",{destruct:function(){this.trigger("destruct"),this.__base.apply(this,arguments)
...
},registerNoTransport:function(t){this.NO_TRANSPORT.push(t)}}),_borschik("bSHUT0JTZkk3M0AQ48VcYP_0WdM")&&!function(){function t(t){return window.YT?void setTimeout(t,1):i?void i.promise().done(t):(i=$.Deferred(),i.promise().done(t),window.onYouTubeIframeAPIReady=function(){i.resolve(),i=null,window.onYouTubeIframeAPIReady=null
}.bind(this),void $.getScript("//www.youtube.com/iframe_api"))}function e(t){var e;return[/(?:youtube\.com\/watch\?v=([\da-z\-_]+))/i,/(?:youtube\.com\/v\/([\da-z\-_]+))/i,/(?:youtu\.be\/([\da-z\-_]+))/i].some(function(i){var n=t.match(i);
...
var t=this.params,e="";return t.autoplay&&t.autoplayHtml?e=t.autoplayHtml:!t.autoplay&&t.noAutoplayHtml&&(e=t.noAutoplayHtml),e?void this._updateDomElem(e):void 0
...
}}(n);BEM.DOM.decl({block:"player",modName:"remote",modVal:"client"},r)}BEM.DOM.decl({block:"player",modName:"remote",modVal:"client"},{onSetMod:{js:function(){this._ready=!1,this._readyCommands=[],this._callPromises={},this._generateId(),this._startListenPostMessage(),this._iframe=this.elem("iframe")[0],this._updateIframeUrl(this.params.remoteServerUrl?this.params.remoteServerUrl:this._getServersUrl())
}},_getServersUrl:function(){return"//yastatic.net/video-player/"+this.__self.STATIC_VERSION+"/pages-desktop/player/player.html"
},_update:function(){var t=$.extend(this.params,{});return this.hasMod("transport","ajax")?void this._loadPlayer(function(e){"undefined"!=typeof e&&(e.autoplay||e.noautoplay)?(t.noAutoplayHtml=e.noautoplay.html,t.autoplayHtml=e.autoplay.html,this._callRemoteMethod("setParams",[t])):this.trigger("load-error")
}.bind(this)):void this._callRemoteMethod("setParams",[t])},_generateId:function(){this._id=this._uniqueId("player-remote-")
...
}}),_borschik("vFyI9lRGNMcKyEbItroeXUNPUQM")&&BEM.decl("serp-request",{onSetMod:{js:function(){if(this.__self._lockInstance)throw Error("serp-request: multiple initialization");
...
}},_onClientAjaxError:function(t,e){return 200===e.status||409===e.status?this.__self.reloadPage(this.__self.RELOAD_INVALID_RESULT):void this._execErrorCallbacks(t,this.__self.ERROR_AJAX,e)
...
},_showError:$.noop,_hideError:$.noop},{_instancesCount:0,BLOCKS:[]}),_borschik("bNEmb8RqUE6VQtHceDG_OMVnE8o")&&BEM.DOM.decl("serp",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._requestChannel=BEM.channel("serp-request")
...
}},{BLOCKS:["keyboard-shortcuts","input","b-counters","more","navigation","tabs-navigation","main","search2","z-entity-collection","feedback","serp-adv__add","advanced-search","footer__settings","user"]}),_borschik("54LGidGBeg8d4Es4o5zkGmgRuKs")&&BEM.DOM.decl("no-connection",{_onButtonClick:function(){var t=BEM.blocks["i-global"].param("yandexuid")!==$.cookie("yandexuid");
...
}}},{live:function(){this.liveBindTo("reload","click",function(){this._onButtonClick()})}}),_borschik("uqe478CNF-0baEm4uSBI_xgxOj0")&&BEM.DOM.decl("pager",{onSetMod:{js:function(){this.__base();
...
}.bind(this),50);t&&this.bindToWin("scroll",e)}}}),_borschik("fokyVw2gMIExO5GIkteEdcruefM")&&BEM.DOM.decl("pager",{getUrl:function(t){var e=this.params["forward"===t?"nextPage":"prevPage"];
return e!==!1&&BEM.blocks.location.getInstance().getUri().replaceParam("p",e).toString()},go:function(t){t&&BEM.blocks["serp-request"].navigateTo(t)
},goForward:function(){this.go(this.getUrl("forward"))},goBackward:function(){this.go(this.getUrl("backward"))
...
}}),_borschik("7Mnv96mU7srDRFxjzgWY34ffZ6M")&&BEM.DOM.decl("competitors",{onSetMod:{js:function(){var t=this.findBlockOutside("b-page");
...
this.domElem.css("position",t>0?"":"static")}}}),_borschik("RvX422Nabm-sQjt8nm__qFK3EWE")&&BEM.DOM.decl("internal-stripe",{onSetMod:{js:function(){this.init()
...
}}),_borschik("JKZF5-MP9-if81pDchL8iSvd9-M")&&BEM.DOM.decl("advanced-search",{onSetMod:{js:function(){!BEM.blocks["i-ua"].canUseAjax()&&this.setMod("ajax","no"),this.bindTo(this.domElem,"submit",function(t){t.preventDefault(),this.submit()
...
},this)},_controlValue:function(t){var e=t.__self.getName();if("check-button"===e)return t.hasMod("checked","yes")?t.val():"";
if("select"===e&&t.hasMod("miltiple","yes")){var i=t.val();return(null===i||0===i.length)&&(i=""),i}return t.val()
},_initFilterByName:function(t){var e=t.substr(0,1).toUpperCase()+t.substr(1),i="_init"+e;this[i]&&this[i]()
},submit:$.debounce(function(){var t=this.findBlockOutside("b-page"),e=t.findBlockInside("search")||t.findBlockInside("search2");
...
},this),this._checkButtons.forEach(function(t){t.__oldValue=t.hasMod("checked","yes")},this)},clear:function(){[].concat(this._inputs,this._selects,this._radioButtons).forEach(function(t){var e=t.__self.getName();
"radio-button"===e&&t.uncheckAll(),"select"===e&&t.hasMod("multiple","yes")&&t.uncheckAll(),t.val("undefined"==typeof t.params.defaultValue?"":t.params.defaultValue)
...
}),jQuery.param(t)}},{live:!0}),_borschik("KsSuPCLowDZrDdTXfNqt3LLZQ-4")&&BEM.DOM.decl({block:"input",modName:"emptiness",modVal:"check"},{onSetMod:{js:function(){this.__base.apply(this,arguments),this.on("change",this._checkEmptiness),this._checkEmptiness()
...
},hideCalendar:function(){this._getCalendarPopup().hide()},_setDateOnBlur:function(){if(this._selected=this.parseDate(this.val()),!this._selected)return void this.val("");
...
}return null}})}(),_borschik("VQD-9lQh-MRrkVzcYXlr2XpimJA")&&BEM.DOM.decl({name:"popup",modName:"iframe",val:"no"},{_getUnder:function(){return this._under||(this._under=$("<div></div>"))
...
}}}),_borschik("Tqh23BSjEIUcfSI92zir3MvZej8")&&BEM.DOM.decl({name:"select",modName:"multiple",modVal:"yes"},{val:function(t,e){if("undefined"==typeof t)return this.elem("control").val();
...
},_updateButtonText:function(){}}),_borschik("LwqrsKfwOBHdxPrCfhdWbCmwsss")&&BEM.DOM.decl({block:"select",modName:"emptiness",modVal:"check"},{onSetMod:{js:function(){this.__base.apply(this,arguments),this.on("change",this._checkEmptiness),this._checkEmptiness()
}},_isEqual:function(t,e){return Array.isArray(t)&&Array.isArray(e)?JSON.stringify(t.sort())===JSON.stringify(e.sort()):t===e
},_checkEmptiness:function(){var t=this.val(),e=this.findBlockOn(this.elem("button"),"button"),i=!t||Array.isArray(t)&&0===t.length,n=this.params.defaultValue;
"undefined"!=typeof n&&(i=this._isEqual(t,n)),this.toggleMod("has-value","yes","",!i),e.toggleMod("checked","yes","",!i)
}}),_borschik("msVejHG8WOmv_weHO4niC3xPO4I")&&BEM.DOM.decl({name:"select",modName:"advanced-mime",modVal:"yes"},{onSetMod:{js:function(){this._defaultText=this._getButtonText(),this.__base.apply(this,arguments)
...
}}})}(jQuery),_borschik("ANx2zuptlFqY90vDi0hAeKrDRTw")&&BEM.DOM.decl({block:"suggest2",modName:"theme",modVal:"normal"},{getPopupWidth:function(){return this._input.width()
...
}))},setSiteValue:function(t){this._siteInput.val(t,{suggest:!1})}}),_borschik("7YsEo5fKF24_qNNCN_FTFw25TPo")&&BEM.DOM.decl({block:"radio-button",baseBlock:"radiobox"},{onElemSetMod:{radio:{checked:function(t,e,i){this.__base.apply(this,arguments),this.setMod(t,"pressed",i)
...
return this.liveBindTo("radio","mousedown",function(t){this._onMouseDown(t)}),t}}),_borschik("hgwvkGteAq20AA8DynRFwiesym0")&&BEM.DOM.decl({block:"radio-button",modName:"uncheckable",modVal:"yes"},{onElemSetMod:{radio:{checked:{yes:function(){return this.__base.apply(this,arguments)
...
return void i.prop("checked",!1)}return this.__base.apply(this,arguments)},_onChange:function(t){var e=this.__self._getRadioByElem(t.data.domElem),i=this.hasMod(e,"checked","yes");
...
}),this._changing=!1)},this)}}),_borschik("K6pRCa0RAnhUAefWhbjVl3FPEZc")&&!function(){var t=50,e=85,i=$.inherit($.observable,{alreadySent:{},children:[],__constructor:function(t){this.tree=t,this.send=$.debounce(this.send,500,this)
...
var e=t.clientX-this._mouseX,i=t.clientY-this._mouseY,n=Math.sqrt(e*e+i*i);return n>10}}),_borschik("Yz8kNjctqBbfepkKnZFySXFnwSE")&&(BEM.decl("z-entity-image-load-counter",{},{TIMEOUT:1e3,start:function(){this._hasResourceTiming()&&(this._initCounter(),this.channel("serp-request").on("request",this._initCounter,this))
...
for(var n,s=0,o=this.tests.length;!n&&o>s;s++)n=this.tests[s].call(this);return!n&&this.isMSIE?"complete"==e.readyState?this.doDeferredTests():t.addEventListener("load",this.doDeferredTests.bind(this),!1):void this.report(n)
...
},prepareTests:function(){this.tests.push("MozBinding"in e.body.style?function(){var e=this.createTestElement(),i=t.getComputedStyle(e,"").MozBinding;
return i&&i.indexOf("about:abp")>-1?(this.probeTimeout=setTimeout(this.checkHiding.bind(this,e),1e3),h):void 0
}:t.opera&&t.opera.version()<13?function(){for(var t=e.querySelectorAll('style[type="text/css"]'),i=0,n=t.length;n>i;i++){var s=t[i].sheet.cssRules;
if(s.length){var o=s[0].selectorText;if(o&&o.toLowerCase().indexOf("#ad")>-1)return 20==o.split(",").length?h:c
}}}:function(){for(var t=e.documentElement.webkitShadowRoot||e.documentElement.shadowRoot,i=t?Array.apply(null,t.querySelectorAll("style")):[],n=Array.prototype.slice.call(e.querySelectorAll('head>style[type="text/css"]'),0),s=i.concat(n),o=0,r=s.length;r>o;o++){var a,l=s[o].sheet.cssRules;
...
}},destruct:function(){return d.destruct(),this.__base.apply(this,arguments)}}),d}}(window,document),function(t,e){function i(){p&&f&&console.log.apply(console,arguments)
