...
var t=function(){if(c[sNSStartup].bookingSticker.hasOwnProperty("noOrder")){return 0
}c[sNSStartup].bookingSticker.stickedElements.sort(function(L,K){if(L.data("elem-original-offset-top")>K.data("elem-original-offset-top")){return 1
...
}}}function f(m){m.find(".b-date-selector, .js--sb-dates__check-in, .js--sb-dates__check-out").dateSelector();
