...
(function(b,d){var c="fEJRUYPNCMVSHT";
function a(){if(booking.env.lp_cp_deals_no_dates_variant){b(".lp_promotion_cards_list_child").click(function(g){var f=1;
if(g&&g.target&&b(g.target).closest("h4").length){f=2
}d.track.custom_goal(c,f);
d.track.stage(c,3);
if(b(this).find(".lp_cp_deals_no_dates").length){d.track.stage(c,4)
}})
