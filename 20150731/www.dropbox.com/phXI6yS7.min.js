...
Demandbase.Config={clientId:"phXI6yS7",nonCompanyDefault:null,nonWatchDefault:null,getDomain:null,conditions:null,segments:null,ads:{key:"cd79a9f82c976038cd27dd4fc100b577",pixels:{ad:"1420577520",rt:"1420577553",cn:null}},analytics:{key:"cd79a9f82c976038cd27dd4fc100b577",fieldMap:{1:"demandbase_sid",2:"audience",3:"audience_segment",4:"company_name",5:"industry",6:"sub_industry",7:"revenue_range",8:"employee_range",9:"ip",10:"watch_list_account_type",11:"watch_list_account_status",12:"watch_list_campaign_code",
13:"state",14:"country_name",15:"fortune_1000",16:"forbes_2000",17:"b2b",18:"b2c",19:"city",20:"zip",21:"country",22:"web_site",23:"stock_ticker",24:"traffic",25:"marketing_alias",26:"employee_count",27:"street_address",28:"phone",29:"annual_sales"}},isFormPage:null,forms:{key:null,companyID:null,emailID:null},content:{key:null,mods:null}};"use strict";"undefined"===typeof window.console&&(window.console={log:function(){},debug:function(){}});
"undefined"===typeof window.localStorage&&(window.localStorage={getItem:function(){},setItem:function(){}});"undefined"===typeof JSON&&(JSON={stringify:function(){},parse:function(){}});Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1});Demandbase.Connectors=window.Demandbase.Connectors||{};
Demandbase.utils={name:"Demandbase API Utilities",logging:Demandbase.Config.logging||!1,debug:Demandbase.Config.debug||!1,callbackStack:[],isCurrentPage:function(a,b){function c(a){return 0===a.indexOf("//")?a.substring(2,a.length):a.replace(/^.*?:\/\//g,"")}function d(a){-1!==a.indexOf(e,a.length-e.length)&&(a=a.substring(0,a.length-1));-1!==a.indexOf("/",a.length-1)&&(a=a.substring(0,a.length-1));return a}if(!a)return!1;var e="#",f=document.location.hash,h=document.location.search,g=document.location.href;
window.top!==window.self&&(g=document.referrer);b&&(h=b.indexOf(e),-1===h&&(h=b.length),f=b.substring(b.indexOf(e),b.length),h=b.substring(b.indexOf("?"),h),g=b);a=c(a);a=a.replace(/^(www\.)/g,"");a=d(a);g=c(g);g=g.replace(/^(www\.)/g,"");g=d(g);-1===a.indexOf(e)&&-1!==g.indexOf(e)&&(g=g.substring(0,g.length-f.length));-1===a.indexOf("?")&&-1!==g.indexOf("?")&&(g=g.substring(0,g.length-h.length));g=d(g);return g===a},isFormPage:function(){var a=Demandbase.Config.forms.emailFields||[];Demandbase.Config.forms.emailID&&
...
c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];if(d.data){var e=d.data.category||"",f=d.data.action||"",h=d.data.label||"";"undefined"===typeof d.listener&&e&&f&&h?d.listener=function(){Demandbase.Connectors.Google_Analytics._cEvent(e,f,h);Demandbase.utils.log("Event listener ran....")}:e&&f&&h||this._log("Need to define a custom listener function or set data with category/action/label")}b.events.add(d)}},_setTrackerName:function(){var a="";"undefined"!==typeof Demandbase.Config.analytics.trackerName&&
