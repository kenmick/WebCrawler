            ...
            for (var e = this, r = 0; r < this.config.PerformUITriggers.length; r++) {
                ...
                switch (i) {
                  ...
                  case t.NativeUITriggerKind.MOUSE_OVER:
                    var s = n.EscapeHTML(this.config.Attempt), u = h(this.currentIntegration.GetMainContentElement()), m = new g.Countdown(u, s, 3, .6, !0, function() {
                        e.uiTriggerMouseOverDone = !0, e.currentIntegration.BeforeCarrierStart(), e.command(o.CommandKind.Perform), 
                        e.uiTriggerMouseOverDone = !1;
                    });
    ...
    var $ = jquery.jQuery, Lightbox = function(_super) {
        ...
        return __extends(Lightbox, _super), Lightbox.prototype.XDMFullscreen = function() {
            ...
            switch (this.state) {
              ...
              case "small":
                "material_landing_iframe" == this.currentMaterial && (this.state = "hide", this.switchStyleIframeFromMaterial(this.currentMaterial));
                break;
            ...
            switch (this.state) {
              ...
              case "hide":
                this.XDMIframeElement.hasClass("hide") ? this.XDMIframeElement.removeClass("hide").addClass("init") : this.XDMIframeElement.removeClass("small_landing").addClass("hide");
                break;
            ...
            if (isBrokenPositionFixed) {
                ...
                var ieFixRepositionBox = function() {
                    var t = ayl_element.GetCumulativeOffset(_this.rootElement[0]), e = t[0], i = t[1], s = ayl_element.GetScrollXY(), a = s[0], r = s[1], o = document.documentElement.clientWidth || document.body.clientWidth, l = document.documentElement.clientHeight || document.body.clientHeight;
                    _this.rootElement.css("position", "absolute"), _this.rootElement.css("top", r - i + "px"), 
                    _this.rootElement.css("left", a - e + "px"), _this.rootElement.css("height", l + "px"), 
                    _this.rootElement.css("width", o + "px");
                };
...
define("js/fo/native/integration/common/base", [ "require", "exports" ], function(t, e) {
    var n = function() {
        ...
        return t.prototype.Execute = function() {}, t.prototype.AfterExecute = function() {
            this.afterExecuteCallback();
        }, t.prototype.BeforeCarrierStart = function() {}, t.prototype.AfterCarrierEnding = function() {}, 
        t.prototype.GetInjectedNodes = function() {
...
define("js/fo/native/integration/tab/integration", [ "require", "exports", "util/str", "util/resource", "util/native/browser", "lib/jquery", "tab_variables", "omnitag/gostructs", "common/base", "native_tab_css" ], function(t, e, i, n, a, o, r, s, l, c) {
    ...
    var h, m, g = o.jQuery, u = "ayl_native_tab_", T = {
        EN: {
            TAB_YES: "Read more",
            TAB_NO: "No thanks"
        },
        ...
        function e() {
            t.apply(this, arguments), this.isLightboxDisplay = !1;
        }
        return __extends(e, t), e.prototype.getSponsor = function() {
            ...
            var t = document.createElement("div");
            t.className = "ayl_native_tab", h = t.id = u + i.EscapeHTML(this.Config.Attempt), 
            ...
            m.className = u + "call_yes", m.innerHTML = i.EscapeHTML(d(this.Config.Lang, f.TabTranslationTabYes));
            var g = document.createElement("li");
            g.className = u + "call_no", g.innerHTML = i.EscapeHTML(d(this.Config.Lang, f.TabTranslationTabNo)), 
            p.appendChild(m), p.appendChild(g), c.appendChild(p), o.appendChild(r), o.appendChild(l), 
            o.appendChild(c);
            var T = document.createElement("div");
            ...
            this.UITrigger(s.NativeUITriggerKind.CLICK), this.hideTab();
            ...
            var t = a.IEVersion();
            p(30, 10) && (t > -1 && 9 >= t && m.animate({
                right: "0"
            }, "slow"), this.isLightboxDisplay || this.showTab());
        }, e.prototype.showTab = function() {
            this.Config.TabDirection == s.TabDirectionKind.LEFT ? m.removeClass(u + "hide_left").addClass(u + "animate_left") : m.removeClass(u + "hide_right").addClass(u + "animate_right"), 
            this.isLightboxDisplay = !1;
        }, e.prototype.hideTab = function() {
            this.Config.TabDirection == s.TabDirectionKind.LEFT ? m.addClass(u + "hide_left") : m.addClass(u + "hide_right"), 
            this.isLightboxDisplay = !0;
        }, e.prototype.actionHandler = function() {
            var t = this;
            g(document).scroll(function() {
                t.scrollAction();
            }), m.find("." + u + "call_no").click(function(e) {
                t.closeAction();
            }), m.find("." + u + "call_yes").click(function() {
                t.clicAction();
            }), m.find("." + u + "img").click(function() {
                t.clicAction();
            }), m.find("." + u + "title").click(function() {
                t.clicAction();
            });
        }, e.prototype.BeforeCarrierStart = function() {
            this.isLightboxDisplay || this.hideTab(), t.prototype.BeforeCarrierStart.call(this);
        }, e.prototype.AfterCarrierEnding = function() {
            this.isLightboxDisplay && this.showTab(), t.prototype.AfterCarrierEnding.call(this);
        }, e.prototype.Execute = function() {
            var t = this.insertTemplate();
            document.body.appendChild(t), this.insertBaseUI(), m = g("#" + h), this.mainContentElement = t, 
...
define("js/fo/native/integration/util", [ "require", "exports", "omnitag/gostructs", "util/str", "lib/jquery" ], function(t, e, n, i, r) {
    function a(t, e, r) {
        var a = i.Untaint(t.Attempt);
        if (!r && a in d) return d[a];
        var o;
        switch (e.Kind) {
          case n.IntegrationSelectorKind.CSS:
            o = document.querySelector(i.Untaint(e.Css));
            break;

          case n.IntegrationSelectorKind.JAVASCRIPT:
            var c = new Function("g", "__break__", i.Untaint(e.Javascript) + "\nreturn __break__;"), u = new g(), l = new Object();
            c(u, l) === l && u.Element && (o = u.Element);
            break;

          default:
            throw new Error("Selector kind not implemented: " + e.Kind.toString());
        }
        return d[a] = o, o;
    }
    function o(t, e, i) {
        switch (t.IntegrationConfig.Kind) {
          case n.NativeIntegrationKind.TEMPLATE:
            c(t, t.IntegrationConfig.Template.Selector, e, i);
            break;

          case n.NativeIntegrationKind.CARD:
            c(t, t.IntegrationConfig.Card.Selector, e, i);
            break;

          case n.NativeIntegrationKind.VALIDATOR:
            c(t, t.IntegrationConfig.Validator.Selector, e, i);
            break;
          ...
          default:
            throw new Error("CheckIntegration: Integration not implemented for kind:" + t.IntegrationConfig.Kind.toString());
        }
    }
    function c(t, n, i, r) {
        var a = 5e3, o = Date.now(), c = function() {
            return Date.now() - o >= a ? void r() : e.QuerySelector(t, n, !0) ? void i() : void setTimeout(c, 200);
        };
        c();
    }
    ...
    e.QuerySelector = a, e.CheckIntegration = o;
});
//
