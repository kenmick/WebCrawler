...
}}function N(){if(this._markerWrapper&&this._markerWrapper.parentNode){this._markerWrapper.parentNode.removeChild(this._markerWrapper)
}this._removeDraggingListners()
...
if(q.b_states.overlay){if(p.content){q.setContent(p.content)
