...
if(f.b_states&&f.b_states.overlay){d.extend(g,i.getMarkerDimension(f))
...
while(q--){w=r[q];
if(w.b_states.overlay){w.content=this.getMarkerContent(w);
...
if(d.b_states.overlay){d.b_behaviors.hover=true;
...
if(d.b_states.overlay){d.b_behaviors.hover=false;
this.Interface.setMixedMarkerType(e,{zIndex:this.getMarkerZIndex(d)})
