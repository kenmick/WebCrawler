...
if(i.MJ(i.MG((i.MC(a[1])||{})["active"]))){h+=b[2]
}h+=b[3];
var g=i.MC(a[0]);
if((i.MJ(g+""==="hotel"))){h+=[b[4],i.MC(a[2]),b[1]].join("")
}else{if((i.MJ(g+""==="hotel_current"))){h+=[b[4],i.MC(a[2]),b[1]].join("")
}else{if((i.MJ(g+""==="hotel_soldout"))){h+=[b[4],i.MC(a[2]),b[1]].join("")
}else{if((i.MJ(g+""==="hotel_soldout_current"))){h+=[b[4],i.MC(a[2]),b[1]].join("")
}else{h+=[b[4],i.MC(a[2]),b[5]].join("")
}}}}h+=b[6];
return h
}
})());
...
booking.jstmpl("atlas_current_property_label",(function(){var b=['\u003cspan class="b_map_hp_current_hotel_label"\u003e\n            ',"\n                "," \n            ","\n            ","\n        \u003c/span\u003e"],a=["b_review_score","b_review_word"],e,d,c;
return function(f){var g="",h=this.fn;
g+=b[0];
if(h.MK(h.ATLAS_TRACK("ebcTGPbfRdcC"))){g+=[b[1],h.MC(a[0]),b[2]].join("")
}g+=[b[3],h.MC(a[1]),b[4]].join("");
return g
}
})());
