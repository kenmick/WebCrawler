...
var t = [ "\n	", '\n		\n\n		<li \n			class="', "c-autocomplete__item sb-autocomplete__item ", "sb-autocomplete__item--cjk ", "sb-autocomplete__item--airport ", "sb-autocomplete__item--city ", "sb-autocomplete__item--country ", "sb-autocomplete__item--district ", "sb-autocomplete__item--hotel ", "sb-autocomplete__item--landmark ", "sb-autocomplete__item--region ", "sb-autocomplete__item--theme ", "sb-autocomplete__item--theme-expanded ", "sb-autocomplete__item--newstyle ", '"\n			data-list-item\n			data-i="', '"\n			data-value="', '">', "", '<div class="sb_passion_highlight_wrapper">\n					<p class="sb_passion_highlight_inner">					\n						<i class="sb_passion_icon dficon-', '"></i>\n						<strong class="sb_passion_highlight_heading">', '</strong>\n						<b class="sb_passion_highlight_tagline">', "/private/search_box_theme_tagline/name", "</b>\n					</p>\n				</div>", ",&nbsp;", '<div class="sb-autocomplete__item--type">\n								<span class="sb-autocomplete__item--type--label">', "/destinationtype/{dest_type}/name", '</span>\n							</div>\n							<div class="sb-autocomplete__item__highlight--block">', "&nbsp;(", ")", '<span class="sb-autocomplete__badge sb-autocomplete__badge--popular">', "/private/search_top_50_badge/name", "</span>", "</div>", '<span class="sb-autocomplete__item__highlight">', '<span class="sb-autocomplete__item__extra">', "</li>\n	", "\n\n	", '\n		<li class="sb-autocomplete__google"></li>\n	', "\n" ], e = [ "results", "lc", "dest_type", "labels", "index", "value", "dest_id", "label", "hotel", "text", "match", "flags", "label_blocks", "highlighted", "label_highlighted", "additional_label", "is_powered_by_google" ];
return function(i) {
var s = "", n = this.fn;
function o(s) {
if (n.MD(e[0])) {
s += t[0], n.MN("index", 0), s += t[0];
var o = n.MC(e[0]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) {
if (i[0] = o[a - 1], s += t[1], s += t[2], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[1]))) && (s += t[3]), n.MJ(n.MB(e[2]) + "" == "airport") ? s += t[4] :n.MJ(n.MB(e[2]) + "" == "city") ? s += t[5] :n.MJ(n.MB(e[2]) + "" == "country") ? s += t[6] :n.MJ(n.MB(e[2]) + "" == "district") ? s += t[7] :n.MJ(n.MB(e[2]) + "" == "hotel") ? s += t[8] :n.MJ(n.MB(e[2]) + "" == "landmark") ? s += t[9] :n.MJ(n.MB(e[2]) + "" == "region") ? s += t[10] :n.MJ(n.MB(e[2]) + "" == "theme") && (s += t[11]), n.MJ(n.MB(e[2]) + "" == "theme") && n.MJ(2 == n.track_experiment("PVcLcDODAKWUMKKe")) && (s += t[12]), n.MJ(n.MB(e[3])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) && (s += t[13]), s += [ t[14], n.MC(e[4]), t[15], n.F.entities(n.MC(e[5])), t[16] ].join(""), s += t[17], n.MJ(n.MB(e[3])) && n.MJ(/zh|xt|ja|ko/.test(n.MB(e[1]))) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) && n.MJ(n.track_experiment_stage("loc_sb_autocomplete_newstyle", 1)), s += t[17], n.MJ(n.MB(e[3])) && n.MJ(!/zh|xt|ja|ko/.test(n.MB(e[1]))) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) && n.MJ(n.track_experiment_stage("loc_sb_autocomplete_newstyle", 2)), s += t[17], n.MJ(n.MB(e[2]) + "" == "theme") && n.MJ(2 == n.track_experiment("PVcLcDODAKWUMKKe"))) s += [ t[18], n.F.entities(n.MC(e[6])), t[19], n.F.entities(n.MC(e[7])), t[20], n.ME(t[21], n.MB, n.MN, null), t[22] ].join(""); else {
if (s += t[17], n.MJ(n.MB(e[3])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET"))) {
s += t[17];
var r = a, h = o, u = l, o = n.MC(e[3]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) i[0] = o[a - 1], s += t[17], n.MJ(a > 2) && (s += t[23]), s += t[17], n.MJ(1 == a) && (s += t[24], s += n.MJ(n.MB(e[2]) + "" == "hotel") ? [ t[17], n.ucfirst(n.MB(e[8])), t[17] ].join("") :[ t[17], n.F.entities(n.ME(t[25], n.MB, n.MN, null)), t[17] ].join(""), s += t[26]), s += [ t[17], n.F.entities(n.MB(e[9])), t[17] ].join(""), n.MD(e[10]) && (s += [ t[27], n.F.entities(n.MB(e[10])), t[28] ].join("")), s += t[17], n.MJ(1 == a) && (s += t[17], n.MJ(n.MG((n.MC(e[11]) || {}).popular)) && (s += t[17], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[1]))) && n.MJ(n.track_experiment_stage("PVdIGbGWZSXKbdRNYYdVTbLWZHOaO", 1)), s += [ t[29], n.F.entities(n.ME(t[30], n.MB, n.MN, null)), t[31] ].join("")), s += t[32]), s += t[17];
i.shift(), a = r, o = h, l = u, s += t[17];
} else if (n.MD(e[12])) {
s += t[17];
var r = a, h = o, u = l, o = n.MC(e[12]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) i[0] = o[a - 1], s += t[17], n.MD(e[13]) && (s += t[33]), s += [ t[17], n.F.entities(n.MC(e[9])), t[17] ].join(""), n.MD(e[13]) && (s += t[31]), s += t[17];
i.shift(), a = r, o = h, l = u, s += t[17];
} else n.MD(e[14]) ? s += [ t[17], n.MC(e[14]), t[17] ].join("") :n.MD(e[7]) && (s += [ t[17], n.F.entities(n.MC(e[7])), t[17] ].join(""));
s += t[17], n.MD(e[15]) && (s += [ t[34], n.MC(e[15]), t[31] ].join("")), s += t[17], n.MJ(n.MB(e[3])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) || (s += t[17], n.MJ(n.MG((n.MC(e[11]) || {}).popular)) && (s += t[17], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[1]))) && n.MJ(n.track_experiment_stage("PVdIGbGWZSXKbdRNYYdVTbLWZHOaO", 1)), s += [ t[29], n.F.entities(n.ME(t[30], n.MB, n.MN, null)), t[31] ].join("")), s += t[17]), s += t[17];
}
s += t[17], n.MN("index", n.MI(n.MB(e[4])) + n.MI(1)), s += t[17], s += t[35];
}
i.shift(), s += t[36], n.MD(e[16]) && (s += t[37]), s += t[38];
}
return s += t[38];
}
return s += t[0], s = o(s), s += t[38];
};
...
name:"dest_type",
value:""
} ]), this.options.ssafa && this.model.setFormAction("search"), B.et.track("PVSfPPPGOaYEO") && (this.model.use("dates"), this.model.dates.setPresets([])), this.emit("change");
},
validate:function() {
var t = !0, e = "";
...
"use strict";
var s = t("event-emitter"), n = t("et"), o = B.env.autocomplete_use_auth ? "/autocomplete_with_auth" :"/autocomplete";
function a(t) {
...
if (t && t.city) {
var s = !1;
!t.__upa__ && 0 === t.city.length && t.theme && t.theme.length > 0 && (s = n.track("PVdIZaeUSSZFDSIBOHHAYO")), t.__upa__ || 0 !== t.city.length || t.bbtoollocations && 0 !== t.bbtoollocations.length || s && t.theme && 0 !== t.theme.length ? (t.city = t.city.map(function(i, s) {
return !i.label && i.labels && (i.label = r(i.labels)), !i.labels || "zh" !== i.lc && "xt" !== i.lc && "ja" !== i.lc && "ko" !== i.lc || (i.label_blocks = h(i.labels)), i.ss = i.label, i.label_highlighted = i.label_highlighted || i.label, i.position = s, i._ef = i._ef || [], i._ef.push({
name:"ac_position",
value:s
}), i._ef.push({
name:"ac_langcode",
...
value:1
})), B.et.track("PVSfPPPGOaYEO") && ("city" == i.dest_type && "-2140479" == i.dest_id && (i._pd = [ {
name:"Tulip Festival",
check_in:{
year:2016,
month:3,
...
los:1
} ]), "city" == i.dest_type && "-666610" == i.dest_id && (i._pd = [ {
name:"Carnival",
check_in:{
year:2016,
month:1,
...
}).concat(t.results)), t.theme && (t.theme = t.theme.map(function(t, i) {
return t.ss = t.label, t._ef = t._ef || [], e._ssafa && (t._fasr = !0), t;
...
value:t.city.length
}), t._efd = t._efd || [], i(null, t)) :i(new Error("service-booking-no-results"), t);
...
this.emit("afterajax", t, i), l(i, t, e);
}.bind(this),
