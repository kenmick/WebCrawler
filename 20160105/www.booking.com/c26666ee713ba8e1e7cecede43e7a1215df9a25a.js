...
return -1;
}, F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", O = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = B.replace("w", "w#"), P = "\\[" + O + "*(" + B + ")(?:" + O + "*([*^$|!~]?=)" + O + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + O + "*\\]", W = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + P + ")*)|.*)\\)|)", $ = new RegExp(O + "+", "g"), z = new RegExp("^" + O + "+|((?:^|[^\\\\])(?:\\\\.)*)" + O + "+$", "g"), I = new RegExp("^" + O + "*," + O + "*"), X = new RegExp("^" + O + "*([>+~]|" + O + ")" + O + "*"), Q = new RegExp("=" + O + "*([^\\]'\"]*?)" + O + "*\\]", "g"), J = new RegExp(W), U = new RegExp("^" + R + "$"), V = {
ID:new RegExp("^#(" + B + ")"),
CLASS:new RegExp("^\\.(" + B + ")"),
...
return e[3] ? e[2] = e[4] || e[5] || "" :n && J.test(n) && (t = a(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3);
}
},
filter:{
TAG:function(e) {
...
lang:ue(function(e) {
return U.test(e || "") || ae.error("unsupported lang: " + e), e = e.replace(ne, re).toLowerCase(), function(t) {
var n;
...
for (n = a.length; n--; ) a[n] && (r = a[n].name, 0 === r.indexOf("data-") && (r = d.camelCase(r.slice(5)), P(o, r, i[r])));
...
}, J = d.access = function(e, t, n, r, i, o, a) {
...
var Be = /alpha\([^)]*\)/i, Re = /opacity\s*=\s*([^)]*)/, Pe = /^(none|table(?!-c[ea]).+)/, We = new RegExp("^(" + I + ")(.*)$", "i"), $e = new RegExp("^([+-])=(" + I + ")", "i"), ze = {
position:"absolute",
visibility:"hidden",
display:"block"
}, Ie = {
...
d.cssHooks[t] = {
get:function(e, n, r) {
if (n) return Pe.test(d.css(e, "display")) && 0 === e.offsetWidth ? d.swap(e, ze, function() {
return Ge(e, t, r);
}) :Ge(e, t, r);
},
set:function(e, n, r) {
var i = r && He(e);
return Ue(e, n, r ? Ve(e, t, r, c.boxSizing && "border-box" === d.css(e, "boxSizing", !1, i), i) :0);
}
};
...
}, qe.test(e) || (d.cssHooks[e + t].set = Ue);
}), d.fn.extend({
css:function(e, t) {
...
n || zt.test(e) ? r(e, i) :Jt(e + "[" + ("object" == typeof i ? t :"") + "]", i, n, r);
}); else if (n || "object" !== d.type(t)) r(e, t); else for (i in t) Jt(e + "[" + i + "]", t[i], n, r);
}
...
var e = this.type;
return this.name && !d(this).is(":disabled") && Qt.test(this.nodeName) && !Xt.test(e) && (this.checked || !U.test(e));
}).map(function(e, t) {
var n = d(this).val();
...
var Ut = 0, Vt = {}, Gt = d.ajaxSettings.xhr();
...
try {
var r = {};
e.migrateWarnings = [], e.migrateMute = !0, !e.migrateMute && t.console && t.console.log && t.console.log("JQMIGRATE: Logging is active"), e.migrateTrace === n && (e.migrateTrace = !e.migrateMute), e.migrateReset = function() {
...
var o;
if (t && "string" == typeof t && !e.isPlainObject(n) && (o = y.exec(e.trim(t))) && o[0] && ("<" !== t.charAt(0) && i("$(html) HTML strings must start with '<' character"), o[3] && i("$(html) HTML text after last tag is ignored"), "#" === o[0].charAt(0) && (i("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), n && n.context && (n = n.context), e.parseHTML)) return m.call(this, e.parseHTML(o[2], n, !0), n, r);
return m.apply(this, arguments);
}, e.fn.init.prototype = e.fn, e.parseJSON = function(e) {
if (!e && null !== e) return i("jQuery.parseJSON requires a valid JSON string"), null;
...
var T = e.event.add, C = e.event.remove, N = e.event.trigger, E = e.fn.toggle, k = e.fn.live, S = e.fn.die, j = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", A = new RegExp("\\b(?:" + j + ")\\b"), D = /(?:^|\s)hover(\.\S+|)\b/, L = function(t) {
if ("string" != typeof t || e.event.special.hover) return t;
return D.test(t) && i("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'"), t && t.replace(D, "mouseenter$1 mouseleave$1");
};
...
e !== document && A.test(t) && i("AJAX events should be attached to document: " + t), T.call(this, e, L(t || ""), n, r, o);
...
if (i("jQuery.fn.live() is deprecated"), k) return k.apply(this, arguments);
return e(this.context).on(t, this.selector, n, r), this;
}, e.fn.die = function(t, n) {
if (i("jQuery.fn.die() is deprecated"), S) return S.apply(this, arguments);
return e(this.context).off(t, this.selector || "**", n), this;
}, e.event.trigger = function(e, t, n, r) {
return n || A.test(e) || i("Global events are undocumented and deprecated"), N.call(this, e, t, n || document, r);
...
!function _() {
if (!document.getElementById("req_info")) return void setTimeout(_, 100);
t.onerror("3rd_JQUERY: jquery migrate " + H, 1, 1);
}();
}
}(jQuery, window);