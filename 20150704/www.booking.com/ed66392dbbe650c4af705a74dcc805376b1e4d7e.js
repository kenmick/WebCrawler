...
if(u.__did_you_mean__||(u.city&&u.city.length==0)){booking.env.trackExperiment("bLYUELMERZLFZDfeWffCRe");
if(u.city&&u.city.length==0&&u.__upa__&&u.__upa__.length){if(u.__js_upa__){}else{if(!booking.env.b_bbtool_address_search){booking.track.exp("bLYUELMNLNPORLO")
...
if(M===1){O[0].first=1
}}if(Q==1){if(w!="theme"&&J){if(O[U]!=c&&O[U].dest_type!="hotel"){n._renderItem(G,O[U],U,O.length)
}else{if(O[U]!=c){S++
}}}else{n._renderItem(G,O[U],U,O.length)
}}else{n._renderItem(G,O[U],U,O.length)
}}if(Q==1){var h=B.env.search_autocomplete_params.limit_total;
for(var I=g,A=g-S;
I<h&&S>0;
