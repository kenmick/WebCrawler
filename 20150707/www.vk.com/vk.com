...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang3_0.js':{v:3485},'index.css':{v:27},'index.js':{v:33},'ui_controls.css':{v:63},'ui_controls.js':{v:183}
}
</script>
...
<div><div class="scroll_fix">
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login" onsubmit="if (vklogin) {return true} else {quick_login();return false;}">
    ...
    <input type="hidden" name="lg_h" value="a2388490eb1440ea23" />
