...
if(B.track.getVariant("TDXbEeQMMKe")||B.track.getVariant("TDXbETcGKSaT")||B.track.getVariant("TDXbEecYaTHe")){B.define("gta/base-widget",function(){var c=function(d){this.dom={root:d,label:d.find(".gta-widget-label"),input:d.find(".gta-widget-input"),button:d.find(".gta-widget-submit"),message:d.find(".gta-widget-message")};
this.action=null;
...
var d=this;
$.ajax({url:d.action,type:"POST",data:d.payload,success:this.onSucessCallback.bind(d),error:this.onErrorCallback.bind(d)})
};
