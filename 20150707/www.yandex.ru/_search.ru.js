...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("oIN7K0MKs3bu_hBuS46fcoiw07A")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return xe(t);if("auto-content"===e)return"auth"===n?Se(t):Qe(t);if("action"===e)return"auth"===n?!!s==!1?Pe(t):Qe(t):Qe(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Te(t):"ticker"===e?Oe(t):Qe(t)}return Qe(t)
}if("mix"===e)return Me(t);if(""===e)return Le(t);if("value"===e){var e=n;return"input"===e?qe(t):"tumbler"===e?"option"===s?Ve(t):Qe(t):Qe(t)
}if("getLive"===e)return"input"===n?!!s==!1?Ue(t):Qe(t):Qe(t);if("live"===e)return"input"===n?!!s==!1?ze(t):Qe(t):Qe(t);
...
}return Qe(t)}return"default"===e?q(t):"env"===e?"i-global"===n?He(t):Qe(t):"content"===e?I(t):"jsAttr"===e?We(t):"tag"===e?C(t):"cls"===e?Ke(t):"bem"===e?Ae(t):Qe(t)
}function u(t){var e=n;if("b-icon"===e){if(!!s==!1){var a,c=t.ctx,h={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},u=["alt","width","height"];
for(c.url&&(h.src=c.url);a=u.shift();)c[a]&&(h[a]=c[a]);return h}return B(t)}if("checkbox"===e){var e=s;
...
}return B(t)}if("button"===e)return l(t);if("input"===e){var e=s;if("hint"===e)return{id:t._hintId,"for":t._inputId,"aria-hidden":!0};
if("control"===e){var f=t._.extend({id:t._inputId,name:t._name},t.ctx.controlAttrs);return(t._value||0===t._value)&&(f.value=t._value),r.disabled&&(f.disabled="disabled"),t._live&&(f.autocomplete="off"),f["aria-labelledby"]=t._labelId+" "+t._hintId,f
}return B(t)}if("notice"===e)return"count"===s?!t.ctx.url==!1?{href:t.ctx.url}:B(t):B(t);if("auth"===e){var e=s;
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var _,g;return{method:"POST",action:t.ctx.url||(_=i,i="action",g=Pe(t),i=_,g),role:"form","aria-label":BEM.I18N("auth","auth")}
}return B(t)}if("b-link"===e)return m(t);if("suggest2-item"===e){var e=s;return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:B(t)
}if("select"===e){var e=s;return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?b(t):"list"===e?v(t):B(t)
}if("tumbler"===e){var e=s;if("sticker"===e)return y(t);if("text"===e)return k(t);if("input"===e){var w,x=o.side;
...
}return"button"===e?M(t):B(t)}return"link"===e?E(t):"ticker"===e?"value"===s?{title:t._count}:B(t):B(t)
}function l(t){if(!(t.__$anflg32!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg32,t.__$anflg32=!0,i=l(t),t.__$anflg32=e,i),{onmousedown:t.ctx.counter})
}return d(t)}return d(t)}return d(t)}function d(t){if(!(t.__$anflg31!==!0)==!1){if(!!s==!1){if(!!t.ctx.url==!1){var e,i,n=t.ctx,o=(e=t.__$anflg31,t.__$anflg31=!0,i=l(t),t.__$anflg31=e,i),r={type:n.type||"button",name:n.name,value:n.value};
return t.extend(o,r)}return p(t)}return p(t)}return p(t)}function p(t){if(!(t.__$anflg30!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg30,t.__$anflg30=!0,i=l(t),t.__$anflg30=e,i),r={href:n.url,target:n.target};
return t.extend(o,r)}return f(t)}return f(t)}return f(t)}function f(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return i.tabindex=e.tabindex,i}return B(t)}function m(t){if(!(t.__$anflg23!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg23,t.__$anflg23=!0,i=m(t),t.__$anflg23=e,i||{}),o=t.ctx;
return o.counter&&(n.onmousedown=o.counter),n}return _(t)}return _(t)}function _(t){return!!s==!1?g(t):B(t)
}function g(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Ne(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
return h}function b(t){if(!(t.__$anflg18!==!0)==!1){var e,i,n=(e=t.__$anflg18,t.__$anflg18=!0,i=b(t),t.__$anflg18=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function v(t){if(!(t.__$anflg17!==!0)==!1){var e,i,n=(e=t.__$anflg17,t.__$anflg17=!0,i=v(t),t.__$anflg17=e,i||{});
return n.role="select",n}return B(t)}function y(t){if(!(t.__$anflg11!==!0)==!1){var e,i,n=(e=t.__$anflg11,t.__$anflg11=!0,i=y(t),t.__$anflg11=e,i||{});
return n["aria-hidden"]=!0,n}return B(t)}function k(t){if(!(t.__$anflg10!==!0)==!1){var e,i,n=(e=t.__$anflg10,t.__$anflg10=!0,i=k(t),t.__$anflg10=e,i||{});
return side=o.side,n.id="left"===side?t._leftId:t._rightId,n["aria-hidden"]=!0,n}return B(t)}function M(t){if(!(t.__$anflg7!==!0)==!1){if(!t._sideId==!1){var e,i,n=(e=t.__$anflg7,t.__$anflg7=!0,i=M(t),t.__$anflg7=e,i||{});
return n["aria-labelledby"]=t._sideId,n}return B(t)}return B(t)}function E(t){if(!(t.__$anflg2!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg2,t.__$anflg2=!0,i=E(t),t.__$anflg2=e,i||{}),o=t.ctx;
return o.counter&&(n.onmousedown=o.counter),n}return w(t)}return w(t)}function w(t){return!!s==!1?x(t):B(t)
}function x(t){var e=t.ctx,n=e.url,s={};if(["title","target","id","tabindex"].forEach(function(t){e[t]&&(s[t]=e[t])
}),n)if(t.isSimple(n))s.href=n;else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,Ne(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
}else s.role="button",s.tabindex||(s.tabindex=0);return s}function B(){return void 0}function C(t){var e=n;
if("b-icon"===e)return!!s==!1?"img":S(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":D(t):D(t);if("input"===e){var e=s;
return"box"===e?"span":"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":S(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":S(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":S(t)}if("checkbox"===e){var e=s;return"control"===e?"input":"label"===e?"label":!!s==!1?"span":S(t)
}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":S(t):"a11y"===e?"span":"items"===e?"ul":S(t)
}if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":S(t)
}if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":S(t)
}if("b-autocomplete-item"===e)return!!s==!1?"li":S(t);if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":S(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":S(t)}return"link"===e?"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":S(t):"b-link"===e?!!s==!1?"a":S(t):S(t)
}function D(t){return!!s==!1?"button":S(t)}function S(){return void 0}function I(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:R(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:R(t);if("input"===e){var e=s;
return"box"===e?P(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:R(t)}if("auth"===e){var e=s;
return"register"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=register",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","register")}:T(t):"remember"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=restore",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","remember")}:T(t):"button"===e?!!t.ctx.content==!1?{block:"button",type:"submit",mods:{theme:"action",size:"m"},content:BEM.I18N("auth","logon")}:T(t):"haunter"===e?!!t.ctx.content==!1?{block:"checkbox",mods:{theme:"normal",size:"m"},checkboxAttrs:{id:"auth-haunter",autocomplete:"off",name:"twoweeks",value:"no"},content:{elem:"label",content:BEM.I18N("auth","temporary")}}:T(t):"password"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"passwd",content:[{elem:"hint",content:BEM.I18N("auth","password")},{elem:"control",attrs:{type:"password",maxlength:256,"aria-required":!0}}]}:T(t):"username"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"login",content:[{elem:"hint",content:BEM.I18N("auth","login")},{elem:"control",attrs:{"aria-required":!0}}]}:T(t):T(t)
}if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:R(t);
if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Oe(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):R(t)
}if("suggest2-item"===e)return!(r&&"link"===r.interact)==!1?!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:O(t):O(t);
if("b-autocomplete-item"===e){if(!(r&&"lingvo"===r.type)==!1){if(!!s==!1){var c=t.ctx.data[1];return[{tag:"span",elem:"text",content:c.text},{tag:"span",elem:"translation",content:[" â ",c.translation]}]
}return A(t)}return A(t)}if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:R(t);
if("tumbler"===e)return"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1?!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:N(t):N(t);
if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Te(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:R(t)
}return R(t)}function P(t){if(!(t.__$anflg28!==!0)==!1){if(!!r.clear==!1){var e,i;return[(e=t.__$anflg28,t.__$anflg28=!0,i=P(t),t.__$anflg28=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
}return R(t)}return R(t)}function T(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Se(t),i=e,n),{elem:"retpath"}]
}return R(t)}function O(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):R(e)}function A(e){return!(r&&"foot"===r.type)==!1?!!s==!1?e.ctx.data.slice(1).map(function(t){return this._.isArray(t)?{tag:"span",elem:"foot",content:t[0]}:t
},t(e)):j(e):j(e)}function j(t){return!(r&&"nav"===r.type)==!1?!!s==!1?{elem:"link",tag:"a",attrs:{href:t._url,target:"_blank"},content:[{elem:"link-url",tag:"span",content:t._linkUrlContent},{elem:"link-info",tag:"span",content:t._linkInfoConten}]}:L(t):L(t)
}function L(t){if(!!s==!1){var e=t.ctx.data,i=BEM.blocks["i-common__string"],n=i.escapeHTML(t._.isArray(e)?e[1]:e);
return i.highlight(n,t.ctx.hl)}return R(t)}function N(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return R(t)
}function R(t){return t.ctx.content}function q(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg34!==!0)==!1?$(t):Qe(t):Qe(t);
if("button"===e)return U(t);if("input"===e)return z(t);if("auth"===e)return Q(t);if("checkbox"===e)return F(t);
if("select"===e)return ie(t);if("b-autocomplete-item"===e)return ce(t);if("popup"===e)return ue(t);if("tumbler"===e)return de(t);
if("i-global"===e)return ye(t);if("suggest2-item"===e){var e=s;return"icon"===e?Z(t):"fact"===e?ee(t):Qe(t)
}return Qe(t)}function $(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));
var s=t.__$anflg34;t.__$anflg34=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,underMods:e.underMods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",Ne(t),t.ctx=o,i=r,t.__$anflg34=s}function F(t){return!(t.__$anflg33!==!0)==!1?!!s==!1?V(t):Qe(t):Qe(t)
}function V(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg33;t.__$anflg33=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=t.ctx,h=c.mods;c.mods=s,F(t),t._checkboxAttrs=r,t._labelId=a,c.mods=h,t.__$anflg33=o
}function U(t){if(!(t.__$anflg29!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg29;return t.__$anflg29=!0,U(t),t.__$anflg29=e,void 0}return Qe(t)}return Qe(t)}function z(t){var e=s;
if("hint"===e)return!(t.__$anflg27!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?H(t):W(t):W(t):W(t);if("control"===e){if(!(t.__$anflg26!==!0)==!1){var n=t.__$anflg26;
t.__$anflg26=!0;var o=t.ctx;t.ctx={elem:"box",content:t.ctx};var r=i;return i="",Ne(t),t.ctx=o,i=r,t.__$anflg26=n,void 0
}return W(t)}return W(t)}function H(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg27,t.__$anflg27=!0,s=t.ctx,t.ctx=a,o=i,i="",r=Ne(t),t.ctx=s,i=o,n=r,t.__$anflg27=e,n
}function W(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?K(t):Qe(t):Qe(t)}function K(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=qe(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Ue(t),i=o,a);
u.theme=u.theme||"normal";var d=t.__$anflg12;t.__$anflg12=!0;var p=t._inputId;t._inputId=h;var f=t._labelId;
...
t._live=l;var k=t.ctx,M=k.mods;k.mods=u,z(t),t._inputId=p,t._labelId=f,t._hintId=m,t._name=_,t._value=g,t._inputLink=b,t._disabled=v,t._live=y,k.mods=M,t.__$anflg12=d
}function Q(t){return"retpath"===s?G(t):X(t)}function G(t){if(!(t.__$anflg25!==!0)==!1){var e=t.__$anflg25;
t.__$anflg25=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,G(t),t._retpath=i,t.__$anflg25=e,void 0
}return X(t)}function X(t){return!(t.__$anflg24!==!0)==!1?!!s==!1?Y(t):Qe(t):Qe(t)}function Y(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",Q(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg24=o
}function Z(t){if(!(t.__$anflg22!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg22;t.__$anflg22=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),Z(t),i.weather=n,t.__$anflg22=e,void 0
}return J(t)}return J(t)}function J(t){return!(t.__$anflg21!==!0)==!1?te(t):Qe(t)}function te(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg21;t.__$anflg21=!0,Z(t),t.__$anflg21=i}function ee(t){if(!(t.__$anflg20!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg20;return t.__$anflg20=!0,ee(t),t.__$anflg20=e,void 0}return Qe(t)}return Qe(t)}function ie(t){return"group"===s?ne(t):se(t)
}function ne(t){if(!(t.__$anflg19!==!0)==!1){var e=t.__$anflg19;t.__$anflg19=!0;var i=t._labelId;return t._labelId=t.generateId(),ne(t),t._labelId=i,t.__$anflg19=e,void 0
}return se(t)}function se(t){return!(t.__$anflg15!==!0&&t.__$anflg16!==!0)==!1?!!s==!1?oe(t):re(t):re(t)
}function oe(t){var e,n,s,o,r,a,c,h=t.ctx,u=(e=i,i="js",n=Be(t),i=e,n||{}).live;if(u){var l=h.content.filter(function(t){return"control"===t.elem
})[0].content;if(l.length){var d=function(t){for(var e,i,n=0;n<t.length&&(e=t[n],"option"===e.elem&&Object(e.attrs).selected?i=e:"option-group"===e.elem&&(i=d(e.content)),!i);n++);return i
},p=d(l);return p||(p=l[0],"option-group"===p.elem&&(p=p.content[0])),s=t.__$anflg15,t.__$anflg15=!0,r=t._initValue,t._initValue=p.attrs.value,a=t._initText,t._initText=p.content,c=ie(t),t._initValue=r,t._initText=a,o=c,t.__$anflg15=s,o
}}var f=t.__$anflg16;t.__$anflg16=!0,ie(t),t.__$anflg16=f}function re(t){return!(t.__$anflg14!==!0)==!1?!!s==!1?ae(t):Qe(t):Qe(t)
}function ae(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg14;t.__$anflg14=!0;var o=t._controlAttrs;
t._controlAttrs={id:i,name:e.name||i};var a=t._formSelect;t._formSelect={block:n,mods:r,tabindex:e.tabindex},ie(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg14=s
}function ce(t){return!(t.__$anflg13!==!0)==!1?!(r&&"nav"===r.type)==!1?!!s==!1?he(t):Qe(t):Qe(t):Qe(t)
}function he(t){var e,i,n,s,o,r,a=t.ctx.data,c=a[4],h=(c.match(/^\w[\w-]*:\/\//g)?"":"http://")+c,u=BEM.blocks["i-common__string"].escapeHTML(a[3]),l="&nbsp;&mdash;&nbsp;"+BEM.blocks["i-common__string"].highlight(a[2],t.ctx.hl);
return e=t.__$anflg13,t.__$anflg13=!0,n=t._linkUrlContent,t._linkUrlContent=u,s=t._linkInfoConten,t._linkInfoConten=l,o=t._url,t._url=h,r=ce(t),t._linkUrlContent=n,t._linkInfoConten=s,t._url=o,i=r,t.__$anflg13=e,i
}function ue(t){return!!t._popupDefaults==!1?!!s==!1?le(t):Qe(t):Qe(t)}function le(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,ue(t),t._popupDefaults=n
}function de(t){if("option"===s){if("left"===t.ctx.side){if(!(t.__$anflg9!==!0)==!1){var e=t.__$anflg9;
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Ne(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
}return pe(t)}return pe(t)}return me(t)}function pe(t){return!(t.__$anflg8!==!0)==!1?fe(t):me(t)}function fe(t){var e,n,s=(e=i,i="value",n=Ve(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",Ne(t),t.ctx=r,i=a,t.__$anflg8=o}function me(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",de(t),t._disabled=i,t.__$anflg6=e,void 0
}return _e(t)}return _e(t)}return _e(t)}function _e(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",de(t),t._checked=i,t.__$anflg5=e,void 0}return ge(t)
}return ge(t)}return ge(t)}function ge(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),de(t),i.mods=n,t.__$anflg4=e,void 0
}return be(t)}return be(t)}return be(t)}function be(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?ve(t):Qe(t):Qe(t)
}function ve(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null,o=t.ctx.content;o&&o.length>0&&(s="left"===t.ctx.content[0].side?i:n);
var r=t.__$anflg3;t.__$anflg3=!0;var a=t._name;t._name=t.ctx.name||(t.ctx.name=e);var c=t._leftId;t._leftId=i;
var h=t._rightId;t._rightId=n;var u=t._sideId;t._sideId=s,de(t),t._name=a,t._leftId=c,t._rightId=h,t._sideId=u,t.__$anflg3=r
}function ye(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?ke(t):Qe(t)
}function ke(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function Me(t){var e=n;if("dropdown"===e)return!!s==!1?[{mods:{action:"closed"}}]:we(t);
if("notice"===e)return"count"===s?!!t.ctx.url==!1?[{elem:"plain"}]:we(t):we(t);if("ticker"===e)return"text"===s?[{block:"a11y-hidden"}]:we(t);
if("suggest2-item"===e)return"text"===s?!(r&&"link"===r.interact)==!1?!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:we(t):we(t):we(t);
if("suggest2"===e)return!!s==!1?[{block:"suggest2-detect",js:!0}]:we(t);if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return we(t)}return"b-autocomplete-item"===e?!(r&&"foot"===r.type)==!1?!!s==!1?[{mods:{enterable:"no"}}]:Ee(t):Ee(t):"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:we(t):we(t)
}function Ee(t){return!!s==!1?[{mods:{pers:t.ctx.pers?"yes":""}}]:we(t)}function we(){return void 0}function xe(t){var e=n;
return"dropdown"===e||"button"===e||"auth"===e||"suggest2-item"===e?!!s==!1?!0:De(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):De(t):"select"===e?!!s==!1?Be(t):De(t):"b-autocomplete-item"===e?!(r&&"nav"===r.type)==!1?!!s==!1?{val:t._url}:Ce(t):Ce(t):"input"===e?!!s==!1?{live:t._live}:De(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):De(t):"link"===e?!t.ctx.tabindex==!1?!!s==!1?{origTabindex:t.ctx.tabindex}:De(t):De(t):"suggest2"===e?!!s==!1?!0:De(t):De(t)
}function Be(t){return t.extend({live:!1},t.ctx.js)}function Ce(t){return!!s==!1?!0:!t.ctx.search_cgi==!1?!t._.isArray(t.ctx.search_cgi)==!1?{cgi:t.ctx.search_cgi}:De(t):De(t)
}function De(){return void 0}function Se(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Ie(t):Ie(t)
}function Ie(t){return!!s==!1?[]:Qe(t)}function Pe(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function Te(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function Oe(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Ae(t){return"suggest2-item"===n?"highlight"===s?!1:je(t):je(t)}function je(){return void 0}function Le(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,si(t),void 0):Ne(t):Ne(t):Ne(t)
}function Ne(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?Re(t):Qe(t):Qe(t)}function Re(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=ye(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",u=He(t),i=c,n=h,u),m=t.__$anflg1;t.__$anflg1=!0;var _=t["i-global"];
t["i-global"]=t.extend(d,f),Le(t),t["i-global"]=_,t.__$anflg1=m}function qe(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:$e(t):$e(t)
}function $e(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Ne(t),t._buf=n,i=o,e.join("")
}return Fe(t)}return Fe(t)}function Fe(t){return!!s==!1?"":Qe(t)}function Ve(t){return t.ctx.value||"left"!==t.ctx.side
}function Ue(t){var e,n,s=(e=i,i="live",n=ze(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function ze(){return!1}function He(t){return!!s==!1?{}:Qe(t)}function We(){return void 0}function Ke(){return void 0
}function Qe(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Ge(t):Xe(t):Xe(t):Xe(t)}function Ge(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(si,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Xe(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?Ye(t):Ze(t):Ze(t):Ze(t)
}function Ye(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}function Ze(t){var e=i;if("default"===e)return Je(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?ti(t):ei(t)
}return ii(t)}function Je(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,D,S,P,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=C(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,N;
n&&A.js!==!1&&(h=i,i="js",l=xe(t),i=h,N=l,N=N?t._.extend(A.js,N===!0?{}:N):A.js===!0?{}:A.js,N&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=N)),j.push("<",T);
var R=(d=i,i="bem",p=Ae(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var q=(f=i,i="cls",m=Ke(t),i=f,m);q||(q=A.cls);var $=A.block&&L&&!A.elem;if(R||q){if(j.push(' class="'),R){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var F=(_=i,i="mix",g=Me(t),i=_,g);if(A.mix&&(F=F?[].concat(F,A.mix):A.mix),F){var V={};V[e(n,s)]=!0,t._.isArray(F)||(F=[F]);
for(var U=0;U<F.length;U++){var z=F[U];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,Q=z.mods||r,G=z.elemMods||{};
if(H&&j.push(" "),O.INTERNAL[H?"buildClasses":"buildModsClasses"](W,z.elem||z._elem||(z.block?void 0:s),z.elemMods||z.mods,j),z.js&&((L||(L={}))[O.INTERNAL.buildClass(W,z.elem)]=z.js===!0?{}:z.js,$||($=W&&!z.elem)),H&&!V[e(W,K)]){V[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=Me(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&V[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,F.splice(U+1,0,Z))}}}}}}q&&j.push(R?" ":"",q),$&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=We(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
}var te=(B=i,i="attrs",D=u(t),i=B,D);if(te=t._.extend(te,A.attrs)){var ee;for(ee in te)void 0!==te[ee]&&j.push(" ",ee,'="',t._.attrEscape(te[ee]),'"')
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(S=i,i="content",P=I(t),i=S,P);if(ie||0===ie){var R=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=R?1:t.position;var oe=t._listLength;t._listLength=R?1:t._listLength;
var re=t.ctx;t.ctx=ie;var ae=i;i="",Le(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}T&&j.push("</",T,">")}}function ti(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,Le(t),t.ctx=a}o||(t.position=s)}function ei(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
var m=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,q(t),i=h,t._links=u,n=l,t._currBlock=d,s=p,r=f,o=m
}function ii(){throw new Error(this)}function ni(t){return si(t||this)}function si(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(ni);
...
return decodeURIComponent(-1===n?e.substring(i):e.substring(i,n))}}(window.Lego),_borschik("-kYdf8Ku8Ih7GI4vnOjeHXwIfro")&&!function(t){t||(t=window.Lego={}),t.isSessionValid=function(){return!!t.getCookie("yandex_login")
}}(window.Lego),_borschik("11o16i2UjSKHSPElwVtu3J28Jy8")&&!function(t,e){e||(e=window.Lego={}),e.init||(e.init=function(i){return(i=e.params=t.extend({id:"",login:e.isSessionValid()?e.getCookie("yandex_login")||"":"",yandexuid:e.getCookie("yandexuid"),locale:"ru",retpath:window.location.toString(),"passport-host":"https://passport.yandex.ru","pass-host":"https://pass.yandex.ru","passport-msg":i.id,"social-host":"https://social.yandex.ru","lego-path":"/lego","show-counters-percent":100},i,e.params))["show-counters"]=Math.round(100*Math.random())<=i["show-counters-percent"],BEM.blocks["i-global"]._params||t.extend(BEM.blocks["i-global"]._params={},i),t(function(){i.oframebust&&e.oframebust(i.oframebust)
...
var m=new d(p[u],s,!!r);return delete p[u],c&&c.apply(m,x.call(arguments,4)),m}}function o(t,i,n,s){(t||(t={})).uniqId||(t.uniqId=(t.id?n+"-id-"+t.id:e.identify())+(s||e.identify()));
...
}var l=e(window),d=e(document),p={},f={},m={},_={},g={},b=t.blocks,v=t.INTERNAL,y=v.NAME_PATTERN,k=v.MOD_DELIM,M=v.ELEM_DELIM,E=v.buildModPostfix,w=v.buildClass,x=Array.prototype.slice,B=Array.prototype.reverse;
...
t!==e.ys("wprid")&&e.ys("wprid",t)}}),_borschik("S-geKR9KcwMgYYDZyAuHZrJYPxE")&&BEM.DOM.decl("b-page",{onSetMod:{js:function(){this.params.zoom_counter_data&&$(window).on("load",this._onLoad.bind(this)),this.__base.apply(this,arguments)
}},_onLoad:function(){var t=window.detectZoom&&window.detectZoom.zoom();t=t?"float-"+t:"disabled",w(this,this.params.zoom_counter_data[0],"zoom="+t)
}}),_borschik("o87tTQZCE8yZQYCmYBv_mxZDlYg")&&!function(t){t=t||{},t.oframebustMatchDomain=function(t,e){t="[object Array]"===Object.prototype.toString.call(t)?t:function(){var e=[];
...
}(window.Lego),_borschik("SpxJhBSEL3IaU1HGZal2vpN80nU")&&!function(t){t=t||{},t.oframebust=function(e){if(window.top.location!==window.location){var i=document.referrer.match(/^https?:\/\/([^:\/\s]+)\/?.*/);
...
}},{get:function(){return t||(t=BEM.create("i-cookie"))}})}(),_borschik("5dxQWRnJoHEJK09p8Z5ZDugH5Ic")&&BEM.DOM.decl({block:"metrika",modName:"serp",modVal:"yes"},{onSetMod:{js:function(){var t=this.params.counter,e=BEM.blocks.location.getInstance();
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',D="allowScriptAccess",S="always",I="height",P="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",N=i(x,B)+i(O,1)+i(I,1)+i("id",L),R=!1;
l.ya_fc_external=function(t,n,u,l){r=t,a=n,c=u,h=l||"fc";var d,p=m&&m[w]?m[w].enabledPlugin:0,f=R,y=0,x=s()?k.replace("%d",a).replace("%s",h):M.replace("%s",o());
...
}catch(I){}}return d=f?g?'<div style="'+B+'"><'+v+N+i("src",x)+i(P,T)+i(A,j)+i(D,S)+i("type",w)+"/></div>":(b?"<"+v+C+N+">"+e("movie",x):"<"+v+N+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(D,S)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
};var q=this,$=arguments.callee.load=function(t){var e,i;t.mode?(e="00",i="kfc"):e="07",q.replaceWith(l.ya_fc_external("07_2",e,"01",i))
...
}}}(jQuery),_borschik("D_eg1q4o0MmHDe1tiYawukVxE30")&&!function(t){var e,i=Object.prototype.hasOwnProperty,n=BEM.DOM,s=function(t){try{return t.activeElement
...
return d>0&&(p.height-=d),0>h&&(p.height+=h),0>u&&(p.width+=u),l>0&&(p.width-=l),p.height<0||p.width<0?f=0:(i=Math.abs(p.height*p.width),e=o.height*o.width,e!==i&&(f=i/e*100)),f
...
var n="a[href], link, ";return Object(t.browser).opera&&t.browser.version<13&&(n=""),e.find(n+'*[tabindex], button, input:not([type="hidden"]), textarea, select, menuitem').filter(function(){var e=t(this),n=!0;
...
}})}(),_borschik("DOWYWcmkfvSDldA6vh4IcrJP984")&&BEM.DOM.decl({block:"popup",modName:"type",modVal:"modal"},{getDefaultParams:function(){var t=this.__base();
...
return t.top=20,t}}),_borschik("Tg75l86QMloumL_amvZcYNtMdxg")&&!function(t,e){t.DOM.decl("radiobox",{onSetMod:{js:function(){var t=this;
...
},hide:function(){this.page.delMod("fade"),this.delMod("visible")}}),_borschik("D-1Vty10Cf5QOM31rSq5uzw7zIY")&&BEM.DOM.decl("popup",{onSetMod:{js:function(){this.__base(),this._tailPos={}
...
if(this._owner){var e=this._viewport;t.top-=e.scrollTop(),t.left-=e.scrollLeft()}return t}}),_borschik("dkarA-3xB6phAE6jhc1SISAYGLQ")&&BEM.DOM.decl("previewed",{onSetMod:{js:function(){this.url=this.params.url,this.checkable=this.params.checkable,this.bindTo("click",this._onClick),this.checkable&&(this.control=this.findBlockOn(this.domElem,this.params.block),this.contentPreviewContainer=this.findContentPreviewContainer().on("opened",this.onOpened,this).on("closed",this.updateCheckedState,this).on("loading",this.updateCheckedState,this).on("contentChanged",this.updateCheckedState,this)),this.contentPreviewContainer=this.findContentPreviewContainer()
}},findContentPreviewContainer:function(){return this.findBlockOutside("b-page").findBlockInside("content-preview")
},_onClick:function(t){t.originalEvent.handled||(this.contentPreviewContainer.isOpened()&&this.contentPreviewContainer.getUrl()===this.url?(!this.openTime||Date.now()-this.openTime>250)&&this.afterCurrentEvent(function(){this.contentPreviewContainer.close()
}):this.afterCurrentEvent(function(){if((!this.contentPreviewContainer.isOpened()||this.contentPreviewContainer.getUrl()!==this.url)&&this.params.metrika){var t=window.yaCounter30391147;
t&&t.reachGoal("CONTENT_PREVIEW_OPENED"),this.contentPreviewContainer.open({url:this.url})}}),t.originalEvent.handled=!0)
},updateCheckedState:function(){this.contentPreviewContainer.isOpened()&&this.contentPreviewContainer.getUrl()===this.url?this.checkControl():this.uncheckControl()
},onOpened:function(){this.openTime=Date.now(),this.updateCheckedState()},checkControl:function(){this.control.setMod("checked","yes")
},uncheckControl:function(){this.control.delMod("checked")},destruct:function(){this.params.checkable&&this.contentPreviewContainer.un("opened",this.onOpened,this).un("closed",this.updateCheckedState,this).un("loading",this.updateCheckedState,this).un("contentChanged",this.updateCheckedState,this),this.__base.apply(this,arguments)
}}),_borschik("PqksHYuzRJcvb2W5zVQrtJg1ri0")&&BEM.decl("counter",null,{log:function(t,e){var i=[];if(t[1]&&i.push(t[1]),e)for(var n in e)i.push("-"+encodeURIComponent(n)+"="+encodeURIComponent(e[n]));
...
},onElem:{inner:function(t){t.tag("span")}}}),_borschik("WOPISYtu0-MQY5Pr21AF2UQx0PM")&&BEM.DOM.decl({block:"popup",modName:"poll",modVal:"size"},{onSetMod:{visibility:{outside:function(){this.__base(),this._prevSize=this.getPopupSize()
...
}}}),_borschik("BYN79jM_JzzzxLAdYD27R3-HO-w")&&BEM.DOM.decl("cut",{onSetMod:{js:function(){this.bindTo("more","leftclick tap",this.onClick),this.hasMod("clickable-content","yes")&&this.bindTo("content","leftclick tap",this.onClick)
}},onClick:function(t){t.preventDefault(),this.open()},open:function(){this.hasMod("opened","yes")||(this.setMod("opened","yes"),this.params.openCounter&&BEM.blocks.counter.log(this.params.openCounter))
...
}).liveBindTo({modName:"pseudo",modVal:"yes"},"keyup",function(t){this._onKeyUp(t)})}}),_borschik("NA-QJ2YuFyCxRU40NmS3Z2wB2l0")&&BEM.decl("install-chrome-webstore-item-action",{execute:function(){var t=this.params.id&&BEM.blocks["chrome-webstore-item_type_"+this.params.id]?BEM.create("chrome-webstore-item_type_"+this.params.id,this.params.webItem):BEM.create("chrome-webstore-item",this.params.webItem);
...
},_chromeAppInstalled:function(){this._chromeAppCounter(this.counters.success)},_chromeAppInstallationFailed:function(t,e){this._chromeAppCounter(this.counters.failure,{error_code:e.errorCode})
},_chromeAppInstallationCancelled:function(){this._chromeAppCounter(this.counters.closePopup)},_chromeAppCounter:function(t,e){var i=Object.create(e||{});
i.app_url=this.params.webItem.url,BEM.blocks.counter.log(t,i)}}),_borschik("KRMr34WyOBflPY8gQ_8rT3clyiA")&&BEM.decl("chrome-webstore-item",{onSetMod:{js:function(){this.url=this.params.url
...
case"tr-ru":case"tr-tr":case"tr-ua":return 397}}}),_borschik("Y-qC0kaTHa6nwLc48ibm49fhxIQ")&&BEM.DOM.decl({block:"check-button",modName:"skipjs",modVal:"yes"},{onSetMod:{js:function(){}}}),_borschik("tsBRAilRAXihLlw4WnlNwHaR1dY")&&BEM.DOM.decl("serp-item",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._bindBackgroundEvents()
...
}).liveBindTo("box","leftclick tap",function(){this._onBoxClear()})}}),_borschik("--SzsvMGJK0FCBFpQeDBkgYqNVQ")&&!function(){var t=BEM.DOM,e=$.browser.opera&&$.browser.version<12.1?"keypress":"keydown";
...
var n=e._getPopup(),s=i.items||i;e.foot&&s.length&&-1===$.inArray(e.foot,s)&&s.push(e.foot),s.length?(e._curItemIndex=-1,t.update(n.elem("items"),e._buildItemsHtml(s),function(){n.isShown()||(n.show(e.elem("box")),e._setWidth()),e._items=n.findBlocksInside("b-autocomplete-item"),e.trigger("update-items")
...
},this),n.push({tag:"span",elem:"span",content:u(t.slice(s))}),n}}),_borschik("GbwZjt0gvgArvz6DQxZ4dcZLhGw")&&BEM.DOM.decl("b-autocomplete-item",{val:function(){return this.params.val||this.elem("text").text()||this.domElem.text()
},enter:function(){},select:function(){}}),_borschik("7_93ivVIwufl4adxRp5m3rI2MHU")&&(BEM.DOM.decl("b-autocomplete-item",{},{live:function(){this.liveBindTo("mouseover mouseout mousedown mouseup",function(t){this.trigger(t.type)
...
}})),_borschik("yEGO8iPQ4OOi84yhT4z8OU7mobU")&&BEM.DOM.decl({block:"b-autocomplete-item",modName:"nav",modVal:"yes"},{enter:function(){return!1
},select:function(t){return t&&$('<form style="display:none" action="'+this.val()+'" target="_blank"/>').appendTo("body").submit().remove(),{needEvent:!0}
}},{getUrl:function(t){return(t.match(/^\w[\w-]*:\/\//g)?"":"http://")+t}}),_borschik("lEH0hP2_HxgAyDuoTDE0P1LjAwA")&&(BEM.DOM.decl({block:"b-autocomplete-item",modName:"type",modVal:"nav"},{onSetMod:{js:function(){this.setMod("nav","yes")
...
}}})),_borschik("-GsKKEITmDL0ipd1lQBWk1LJ1iE")&&(BEM.DOM.decl({block:"b-autocomplete-item",modName:"type",modVal:"foot"},{select:function(){return!1
...
}))}})),_borschik("jQ7hXxPevuxWvNsEm2WPbzZv1Fw")&&BEM.HTML.decl({block:"b-autocomplete-item",modName:"type",modVal:"lingvo"},{onBlock:function(t){var e=t.param("data")[1];
...
}),!1}}),_borschik("4ONaZVUayBnZKS1NtskA_gI6tPs")&&BEM.DOM.decl("serp-item2",{onSetMod:{js:function(){this.bindTo("click",this.onClick.bind(this))
...
}(),_borschik("1KHRWuc3h5UgdmjUA5i9g1PUVa0")&&BEM.decl("i-statface",{onSetMod:{js:function(){this._data={},this._needSend=!1,this.hasMod("send","manual")||$(window).unload(this.changeThis(this.send))
...
}}),_borschik("2jmj7l5rSw0yVb_vlWAYkK_YBwk"),_borschik("Bm0ENg9LVuBaMhqp9kSS6DsNiG0")&&BEM.DOM.decl("hover-preview",{onSetMod:{js:function(){this.url=this.params.url,this.contentPreviewContainer=this.findBlockOutside("b-page").findBlockInside("content-preview"),this.bindTo("mouseenter",this.onMouseEnter),this.bindTo("mouseleave",this.onMouseLeave)
}},onMouseEnter:function(){this.contentPreviewContainer.getUrl()!==this.url&&this.contentPreviewContainer.preload(this.url);
var t=this.contentPreviewContainer.isOpened()?250:500;this.openTimeoutId=setTimeout(this.onOpenTimeout.bind(this),t)
},onMouseLeave:function(){clearTimeout(this.openTimeoutId)},onOpenTimeout:function(){if((!this.contentPreviewContainer.isOpened()||this.contentPreviewContainer.getUrl()!==this.url)&&this.params.metrika){var t=window.yaCounter30391147;
t&&t.reachGoal("CONTENT_PREVIEW_OPENED")}this.contentPreviewContainer.open({url:this.url})}}),_borschik("EicMbNnxsvRJzobNcbnE2_XAhlQ")&&BEM.DOM.decl({block:"serp-item",modName:"content-preview-mode",modVal:"available"},{onSetMod:{js:function(){var t=this.params.backgroundClickCounter;
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("3OX4-nKwSFWYBh6dxSsO7a67CkA")&&!function(t){var e=1e3;
BEM.DOM.decl("popup2",{onSetMod:{js:{inited:function(){this._parentPopup=t,this._zIndex=null,this._zIndexGroupLevel=null,this._isAttachedToScope=!1
}},visible:{yes:function(){this.trigger("beforeOpen"),this._isAttachedToScope||(BEM.DOM.scope.append(this.domElem),this._isAttachedToScope=!0),this._captureZIndex()._bindToParentPopup()._bindToPointerPress().bindTo("leftclick tap",this._setPreventHideByClick)
...
},getDefaultParams:function(){return{zIndexGroupLevel:0}}},{live:!0,_visiblePopupsZIndexes:{}})}(),_borschik("LwU9GaPH3veJhLknmccqu8kO9u0")&&BEM.DOM.decl("popup2",{_bindToPointerPress:function(){return this.bindTo("mousedown",this._setPreventHideByClick)
},_unbindFromPointerPress:function(){return this.unbindFrom("mousedown")}}),_borschik("_61gGbPwL4ldJt9v8MG8f_VNO60")&&BEM.DOM.decl("popup2",{isShown:function(){return this.hasMod("visible","yes")
},hide:function(){return this.delMod("visible")},show:function(){return this.setMod("visible","yes")}}),_borschik("8Foq-yXi6hpzHXv2IEbQ8acWRs4")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:41,DELETE:42}),_borschik("TWbgxi6hd7S5hLl8bDb7pctnVAI")&&!function(t,e){var i=.99,n=["bottom-left","bottom-center","bottom-right","top-left","top-center","top-right","right-top","right-center","right-bottom","left-top","left-center","left-bottom"],s=BEM.DOM.win;
...
}})}(jQuery),_borschik("VVe2X56Z6DQvJkYs4crT9CJEvrY")&&!function(t){function e(t,e){return t.addClass("i-bem "+e).bem(e)
...
},_calcTargetDimensions:function(){var t=this._anchor,e=t.offset();return{left:e.left,top:e.top,width:t.outerWidth(),height:t.outerHeight()}
...
},_calcIsAnchorVisible:function(){var e=this._anchor,i=e.offset(),n=i.left,s=i.top,o=n+e.outerWidth(),r=s+e.outerHeight(),a=this.getMod("direction"),c=Math.floor(this._checkDirection(a,"top")?s:r),h=Math.floor(this._checkDirection(a,"left")?n:o),u=!0;
return this._anchorParents.each(function(){if("BODY"===this.tagName)return!1;var e=t(this),i=/scroll|hidden|auto/,n=i.test(e.css("overflow-y")),s=i.test(e.css("overflow-x"));
if(n||s){var o=e.offset();if(n){var r=Math.floor(o.top);if(r>c||r+e.outerHeight()<c)return u=!1}if(s){var a=Math.floor(o.left);
return u=h>=a&&a+e.outerWidth()>=h}}}),u},_calcZIndexGroupLevel:function(){var t=this.__base.apply(this,arguments);
...
}}),_borschik("4kJtnEaFEnpS5fEAywHZT0MD1gM")&&BEM.DOM.decl({block:"popup2",modName:"autoclosable",modVal:"yes"},{onSetMod:{visible:{yes:function(){this.__self._visiblePopupsStack.unshift(this),this.afterCurrentEvent(function(){this.domElem&&this.bindToDoc("leftclick tap",this._onDocClick)
...
}}),_borschik("218Ivobyjb3KUDWNhDAuScNfuTg")&&BEM.DOM.decl("tumbler",{onSetMod:{js:function(){this._check(this.isChecked());
var t=this.elem("button").width();this._maxLeft=this.elem("box").width()-t,this._buttonWidth=t;var e=this.hasMod("disabled","yes");
this.elem("button").attr({role:"button",tabindex:e?-1:0,"aria-disabled":e,"aria-pressed":this.hasMod("checked")}),this.elem("input").attr({tabindex:-1,"aria-hidden":!0})
},checked:function(t,e){return this.isDisabled()?!1:(this._check(e),this.elem("button").attr("aria-pressed","yes"===e),this.trigger("change",{checked:!!e,value:this.val()}),void 0)
},disabled:function(t,e){var i="yes"===e;this.elem("button").attr({tabindex:i?-1:0,"aria-disabled":i})
}},toggle:function(){return this.toggleMod("checked","yes")},uncheck:function(){return this.delMod("checked")
},check:function(){return this.setMod("checked","yes")},val:function(t){if("undefined"==typeof t)return this.elem("input").filter(":checked").val();
var e=this.elem("input").filter(function(){return this.value===t});return e.length&&this[e.is(this.buildSelector("input","side","right"))?"check":"uncheck"](),this
},isChecked:function(){return this.hasMod("checked")},isDisabled:function(){return this.hasMod("disabled","yes")
},_check:function(t){return this.elem("input","side",t?"right":"left").attr("checked",!0)},_focus:function(){return this.elem("button").focus(),this
},_onChange:function(){return this.isDisabled()?this:this.toggle()},_onInputClick:function(t){return"left"===this.getMod(t.data.domElem,"side")?this.uncheck():this.check()
},_getXFromEvent:function(t){return"number"==typeof t.clientX?t.clientX:t.originalEvent.touches[0].clientX
},_setPositions:function(t,e){var i=Math.min(Math.max(t+e,0),this._maxLeft);this.elem("button").css("left",i),this.elem("sticker","position","left").css("width",i+this._buttonWidth),this.elem("sticker","position","right").css("width",this._maxLeft-i+this._buttonWidth)
}},{live:function(){var t={mouseover:{name:"hovered",val:"yes"},mouseout:{name:"hovered"},mousedown:{name:"pressed",val:"yes"},mouseup:{name:"pressed"},focusin:{name:"focused",val:"yes"},focusout:{name:"focused"}},e={over:"mouseover mouseout",start:"mousedown",stop:"mouseup touchend",move:"mousemove touchmove"},i=function(e){var i=t[e];
this.setMod(i.name,i.val||"")};this.liveBindTo([e.start,e.stop,e.over].join(" "),function(t){this.isDisabled()||i.call(this,t.type)
}).liveBindTo("label",e.stop,function(){this.isDisabled()||this._focus()}).liveBindTo("box",e.stop,function(t){1===t.which&&this._onChange(),this.isDisabled()||this.afterCurrentEvent(function(){this._focus()
})}).liveBindTo("button",e.stop,function(t){i.call(this,t.type),t.stopPropagation()}).liveBindTo("input","change",function(t){this._onInputClick(t)
}).liveBindTo("input","focusin",function(){this._focus()}).liveBindTo("button","focusin focusout",function(t){this.isDisabled()||i.call(this,t.type)
}).liveBindTo("button","keydown",function(t){if(!(t.shiftKey||t.ctrlKey||t.altKey||t.metaKey))switch(t.which){case 32:case 37:case 38:case 39:case 40:t.preventDefault()
}}).liveBindTo("button","keyup",function(t){if(!(t.shiftKey||t.ctrlKey||t.altKey||t.metaKey)){var e=t.which;
13===e||32===e?this._onChange():37===e||38===e?this.uncheck():(39===e||40===e)&&this.check()}}).liveBindTo("button",e.start,function(t){if(!this.isDisabled()&&1===t.which){var n=this._getXFromEvent(t),s=this.elem("button").position().left,o=!1,r=!1;
this.bindToDoc(e.move,$.throttle(function(t){o=!0,r||this._setPositions(s,this._getXFromEvent(t)-n)},30)).bindToDoc(e.stop,function(t){r=!0,this.unbindFromDoc(e.move+" "+e.stop),o?(this[parseInt(this.elem("button").css("left"),10)>this._maxLeft/2?"check":"uncheck"](),this.elem("button").css("left",""),this.elem("sticker").css("width","")):this.toggle(),i.call(this,t.type)
}),t.preventDefault()}})}}),_borschik("9QLAAdqCc0iG1A5XvbODKFmXe_Q")&&!function(t,e,i){"use strict";"undefined"!=typeof module&&module.exports?module.exports=i(e,t):"function"==typeof define&&define.amd?define("detect-zoom",function(){return i(e,t)
}):t[e]=i(e,t)}(window,"detectZoom",function(){var t=function(){return window.devicePixelRatio||1},e=function(){return{zoom:1,devicePxPerCssPx:1}
},i=function(){var e=Math.round(screen.deviceXDPI/screen.logicalXDPI*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},n=function(){var e=Math.round(document.documentElement.offsetHeight/window.innerHeight*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},s=function(){var e=Math.round(window.outerWidth/window.innerWidth*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},o=function(){var e=Math.round(window.outerWidth/window.innerWidth*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},r=function(){var e=90==Math.abs(window.orientation)?screen.height:screen.width,i=e/window.innerWidth;
return{zoom:i,devicePxPerCssPx:i*t()}},a=function(){var e=function(t){return t.replace(/;/g," !important;")
},i=document.createElement("div");i.innerHTML="1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>0",i.setAttribute("style",e("font: 100px/1em sans-serif; -webkit-text-size-adjust: none; text-size-adjust: none; height: auto; width: 1em; padding: 0; overflow: visible;"));
var n=document.createElement("div");n.setAttribute("style",e("width:0; height:0; overflow:hidden; visibility:hidden; position: absolute;")),n.appendChild(i),document.body.appendChild(n);
var s=1e3/i.clientHeight;return s=Math.round(100*s)/100,document.body.removeChild(n),{zoom:s,devicePxPerCssPx:s*t()}
},c=function(){var t=l("min--moz-device-pixel-ratio","",0,10,20,1e-4);return t=Math.round(100*t)/100,{zoom:t,devicePxPerCssPx:t}
},h=function(){return{zoom:c().zoom,devicePxPerCssPx:t()}},u=function(){var e=window.top.outerWidth/window.top.innerWidth;
return e=Math.round(100*e)/100,{zoom:e,devicePxPerCssPx:e*t()}},l=function(t,e,i,n,s,o){function r(i,n,s){var c=(i+n)/2;
if(0>=s||o>n-i)return c;var h="("+t+":"+c+e+")";return a(h).matches?r(c,n,s-1):r(i,c,s-1)}var a,c,h,u;
window.matchMedia?a=window.matchMedia:(c=document.getElementsByTagName("head")[0],h=document.createElement("style"),c.appendChild(h),u=document.createElement("div"),u.className="mediaQueryBinarySearch",u.style.display="none",document.body.appendChild(u),a=function(t){h.sheet.insertRule("@media "+t+"{.mediaQueryBinarySearch {text-decoration: underline} }",0);
var e="underline"==getComputedStyle(u,null).textDecoration;return h.sheet.deleteRule(0),{matches:e}});
var l=r(i,n,s);return u&&(c.removeChild(h),document.body.removeChild(u)),l},d=function(){var t=e;return isNaN(screen.logicalXDPI)||isNaN(screen.systemXDPI)?window.navigator.msMaxTouchPoints?t=n:window.chrome&&!(window.opera||navigator.userAgent.indexOf(" Opera")>=0)?t=s:Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")>0?t=o:"orientation"in window&&"webkitRequestAnimationFrame"in window?t=r:"webkitRequestAnimationFrame"in window?t=a:navigator.userAgent.indexOf("Opera")>=0?t=u:window.devicePixelRatio?t=h:c().zoom>.001&&(t=c):t=i,t
}();return{zoom:function(){return d().zoom},device:function(){return d().devicePxPerCssPx}}}),_borschik("5NO2qC3NgtpnDtgIztRjyKKG7NQ")&&BEM.DOM.decl("timing",{onSetMod:{js:function(){this.data={},this.visibilityState={visible:1,hidden:2,prerender:3}[this.getVisibilityState()],this.send()
...
t.trigger("updateStart"),this.__base.apply(this,arguments),t.trigger("updateStop")}}),_borschik("AMZB6FYCFsBCPgcPajfc7xmIPzA")&&BEM.DOM.decl("advanced-search",{onSetMod:{js:function(){!BEM.blocks["i-ua"].canUseAjax()&&this.setMod("ajax","no"),this.bindTo(this.domElem,"submit",function(t){t.preventDefault(),this.submit()
...
}),jQuery.param(t)}},{live:!0}),_borschik("leHgF4hwEChStLH262biSuLuA78")&&BEM.DOM.decl("input",{onSetMod:{js:function(){this.__base.apply(this,arguments),(this._hasHint=Boolean(this.elem("hint")[0]))&&this.on("change",this._updateHint)._updateHint()
...
}}}),_borschik("Dqo_kPir0MC01kDvrlQh6D4Ol98")&&BEM.DOM.decl({block:"popup",modName:"autosize",modVal:"yes"},{getDefaultParams:function(){var t=this.__base();
...
return i/n*100}}),_borschik("r4o5sSnylRFi99aqZ_GrowfDlvA")&&!function(t,e){function i(t){var e={};return"option"===t.item?(e={block:c,elem:"option",tag:"option",attrs:{value:t.value},content:t.content},t.disabled&&(e.attrs.disabled="disabled"),t.selected&&(e.attrs.selected="selected")):"optgroup"===t.item&&(e={elem:"option-group",tag:"optgroup",attrs:{label:t.label}},t.disabled&&(e.attrs.disabled="disabled"),e.content=Array.isArray(t.content)?t.content.map(function(t,e){return i(t,e)
...
e.DOM.decl("select",{onSetMod:{js:function(){this._items=[],this._curItemIndex=-1,this._scrollableElemOutsidePopup=null,this._rowHeight=22,this.on("change",this._redrawParentPopup);
...
}},_getButtonText:function(){return this._getButton().elem("text").text()},_setButtonText:function(t){t.length&&(this._getButton().elem("text").text(t),o&&this.domElem.parent().css("outline",""))
...
})}})}(jQuery,BEM),_borschik("-cHRV1_reBkwrWW8WpjAVF3F-RE")&&!function(t,e){var i=t.browser.opera&&t.browser.version<15;
...
}}),_borschik("Pv7lsIHOP7CIAGNqtz4VlyXzZ-4")&&BEM.DOM.decl("advanced-search",{onSetMod:{js:function(){this.__base.apply(this,arguments),this.bindTo(this.domElem,"submit",function(){this._lastRegionValue?(this._chooseRegion(this._lastRegionValue),this._checkboxMode()):this._resetRegionValue()
})}},_initRegion:function(){var t=this.findElem("wrap","type","region");this._input=this.findBlockInside(t,"input"),this._button=this.findBlockInside(t,"button"),this._suggest=this.findBlockInside(t,"suggest2"),this._checkbox=this.findBlockInside(t,"check-button"),this._regionMap={},this._lastRegionValue="",this._initRegionSuggest(),this._button.on("click",this._inputMode,this),this._input.on("focus",this._selectFirst,this),this._suggest.on("hide",this._selectNone,this),this._suggest.on("update",this._selectFirst,this),this._suggest.domElem.on("mousedown",function(t){t.preventDefault()
...
},this),this._input.bindTo("keydown",function(t){27===t.keyCode&&this._checkboxMode()}.bind(this))},_initRegionSuggest:function(){var t=this,e=this._suggest&&this._suggest.getModel();
...
var e=this.css("counter-reset");return e=e&&e.split(" ")||"",e[1===e.length?0:e.length-2]===t}})}(jQuery),_borschik("v8dfJc0sppyasYELtmrP3GbISPE")&&!function(){var t=50,e=85,i=$.inherit($.observable,{alreadySent:{},children:[],__constructor:function(t){this.tree=t,this.send=$.debounce(this.send,500,this)
...
},_showError:$.noop,_hideError:$.noop},{_instancesCount:0,BLOCKS:[]}),_borschik("x3X1kqRXFDQLP32Fc10PRbKFxLk")&&BEM.DOM.decl("serp",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._requestChannel=BEM.channel("serp-request")
...
i.app_url=this.params.webItem.url,BEM.blocks.counter.log(t,i)}}),_borschik("jHY3wRsoCaTG9eDh2J8rEsB5Pj4")&&BEM.DOM.decl("main",{onSetMod:{js:function(){this.clearUrlParams(),this.__base.apply(this,arguments)
...
},unbindEvents:function(){this.unbindFromDoc("leftclick.mainRight tap.mainRight")}},{_activeElements:[".serp-item__preview-btn",".serp-item_preview-active_yes",".z-images__link",".main__right-inner",".content-preview",".i-geo-point__cont",'[target="_blank"]',"ymaps",".video-thumb",".popup",".previewed"].join()}),_borschik("OiSq40QqPbvRjqwjcGzWs1hRjM8")&&BEM.DOM.decl("main",{onSetMod:{js:function(){this.__base.apply(this,arguments),this.centerColumn=this.elem("center"),this.rightColumn=this.elem("right"),this.rightColumnContent=this.elem("right-inner"),this.findContentLeftColumn(),this.channel("main").on("updateStop",this.findContentLeftColumn,this),this.bindToWin("scroll.mainRight",this.syncScroll,this),this.bindToWin("resize",this.syncScroll,this),this.on("panelClosed",this._unfixCenterHeight,this),/MSIE 8/i.test(navigator.userAgent)&&(this.ieOnlyModsSetup(),this.bindToWin("resize",$.throttle(this.ieOnlyModsSetup,100)))
...
["s","m","l"].forEach(function(n){t>e[n]&&(i=n)}),this.setMod("size",i)},_fixCenterHeight:function(t){this.centerColumn.css({"min-height":t})
...
}}),_borschik("o01NWj6FO4lxHWf58GP2KsnvkwE")&&BEM.DOM.decl("content-preview",{onSetMod:{js:function(){this.setMod("first","yes"),this._defaultParams=this.params,this._previousData={},this.channel("content-preview").on({update:this._onChannelUpdate,toggle:this._onChannelToggle},this),this.opened=!1,this._getMain().on("panelClosed",this._onPanelClosed,this)
...
},loadContent:function(t){this.shouldAppendContent?this._beforeAppend():(this._beforeUpdate(),BEM.DOM.destruct(this.elem("close-wrap"),!0),this.setMod(this.elem("close-wrap"),"hidden","yes")),t===this.preloadedUrl&&this.preloaded?this.setLoadedContent(this.preloadedData):this.preloading?this.shouldSetContentAfterPreload=!0:(this.loadRequest=this.__self.createLoadRequest(),this.loadRequest.get({},this.onLoadSuccess.bind(this),this.onLoadError.bind(this),this.getRequestParameters(t)))
...
},this)},_afterInit:function(){this._isInited=!0},_beforeAppend:function(){this._extraSpinTimeoutId=setTimeout(this.onStartExtraSpinnerTimeout.bind(this),this.__self.EXTRA_SPIN_DELAY)
...
},_afterAppend:function(){this._hideExtraPreloader(),this.findBlockOutside("main").syncScroll({newContent:!0})
...
},createCloser:function(t){return BEMHTML.apply({block:"b-link",mix:{block:"content-preview",elem:"close"},counter:t.closeCounter,content:[{block:"content-preview",elem:"close-icon"},{block:"content-preview",elem:"close-text",content:t.closeText}]})
...
}})}(jQuery,BEM),_borschik("dOkCNYJERkg9-MHKiEFge3KgWPk")&&!function(t){var e=t.browser,i=e.opera&&e.version<12.1?"keypress":"keydown";
...
})}})}(jQuery),_borschik("V5OW0hdvjEvP9CXBrSHgYvTvMhg")&&BEM.DOM.decl("tooltip",{onSetMod:{hovered:{yes:function(){this.bindTo("mouseleave",this._onMouseLeave)
...
}}(window,window.BEM),_borschik("7_v7KShpFNf1hH-2D_JqkORp_kE")&&BEM.DOM.decl("progress",{update:function(t,e){return this.setMod("timing",e||"").domElem.css({width:0>=t?"0":t>=1?"100%":(100*t).toPrecision(2)+"%"}).css("width"),this
...
}}),_borschik("tgItkAlULxXQ3I0cNuQ3yQiCdSs")&&BEM.DOM.decl("user",{onSetMod:{js:{inited:function(){if(this.__base.apply(this,arguments),this.elem("name").length){var t=this,e=t.elemParams("name");
...
})}}),_borschik("OQYYlNZLGXjmC2VipuLVfUuafP0")&&BEM.DOM.decl({block:"dropdown-menu",baseBlock:"dropdown"}),_borschik("2oaZj5YWLhtnQi8K3iru3nUvtlQ")&&!function(){BEM.DOM.decl("i-menu",{onElemSetMod:{item:{state:{current:function(t,e,i,n){if("disabled"==n)return!1;
...
}(),_borschik("j88OcvYeSgq3w3ct3XOdzA7c1Ss")&&BEM.DOM.decl("user-menu-update",{onSetMod:{js:{inited:function(){var t=this;
...
}return s}})}(),_borschik("1YVPKkpeQiQzDUi8iyo5LZQFP4E")&&BEM.decl("social-broker",{_windowWidth:500,_windowHeight:280,onSetMod:{js:{inited:function(){this._window=null,this._timer=0
...
for(n.url&&(i.src=n.url);e=s.shift();)n[e]&&(i[e]=n[e]);t.tag("img").attrs(i)}}),_borschik("Hg0tDCfpMcd0249qz_xWmeEqHEA")&&(BEM.DOM.decl("b-keyboard-loader",{onSetMod:{js:function(){Lego.block["b-keyboard-loader"].call(this.domElem,this.params)
...
var l;h.bind("keyboardOpened.lego",function(){s(),t("input:focus").focus()})}}(jQuery,window.Lego),_borschik("wqShwUwtyhbO7NzZXBcZDFOvEiM")&&!function(t){function e(){function e(t,e){u[t](e,function(t){"error"===t?d.push(e):l.push(e)&&r.each(e),s()
...
}}}),_borschik("Efg66r1cHEYvcZe_nvB4snmf0_s")&&BEM.DOM.decl("b-menu",{onElemSetMod:{trigger:{state:function(t,e,i){this.toggleMod(this.findElem(t.closest(this.buildSelector("layout-vert-cell")),"item-content").eq(0),"visibility","visible","opened"===i).trigger("trigger",{domElem:t,state:i})
...
}).liveBindTo("item-selector","leftclick",function(t){this.onItemSelectorClick(t)})}}),_borschik("P6u_oncky6F0AtNSGabRVGOFTp0")&&(BEM.DOM.decl("b-keyboard-popup",{onSetMod:{js:function(){Lego.block["b-keyboard-popup"].call(this.domElem,this.params)
...
}})},this.domElem.append(this.params.html)}}),_borschik("GPzouHPB1biFBpzcB7CsZY5qK6Q")&&BEM.DOM.decl("serp-adv__counter",{onSetMod:{js:function(){if(this.elemParams(this.domElem).counterUrl){if(this.domElem.offset().top<BEM.DOM.win.height())return this._createImage(),void 0;
...
},_onScroll:function(){BEM.DOM.win.scrollTop()+BEM.DOM.win.height()>=this.domElem.offset().top+15&&this._createImage()
...
}}),_borschik("fzy4rTQeVnc8Jvop-_v9Q_vLZfg")&&BEM.DOM.decl("competitors",{onSetMod:{js:function(){var t=this.findBlockOutside("b-page");
...
}.call(this,t)}},{lang:"ru"}),BEM.I18N.decl("input",{"Ð Ð°ÑÑÐ¸ÑÐµÐ½Ð½ÑÐ¹ Ð¿Ð¾Ð¸ÑÐº":"Ð Ð°ÑÑÐ¸ÑÐµÐ½Ð½ÑÐ¹ Ð¿Ð¾Ð¸ÑÐº"},{lang:"ru"}),BEM.I18N.decl("keyboard-shortcuts",{"ÐÐµÑÐ½ÑÑÑÑÑ Ð² Ð¿Ð¾Ð¸ÑÐºÐ¾Ð²ÑÑ ÑÑÑÐ¾ÐºÑ":"ÐÐµÑÐ½ÑÑÑÑÑ Ð² Ð¿Ð¾Ð¸ÑÐºÐ¾Ð²ÑÑ ÑÑÑÐ¾ÐºÑ","ÐÐºÐ»ÑÑÐ¸ÑÑ vim-ÑÐµÐ¶Ð¸Ð¼. ÐÐµÑÐµÐ¼ÐµÑÐµÐ½Ð¸Ðµ Ð¿Ð¾ Ð²ÑÐ´Ð°ÑÐµ Ð¿ÑÐ¸ Ð¿Ð¾Ð¼Ð¾ÑÐ¸ h, j, k, l.":"ÐÐºÐ»ÑÑÐ¸ÑÑ vim-ÑÐµÐ¶Ð¸Ð¼. ÐÐµÑÐµÐ¼ÐµÑÐµÐ½Ð¸Ðµ Ð¿Ð¾ Ð²ÑÐ´Ð°ÑÐµ Ð¿ÑÐ¸ Ð¿Ð¾Ð¼Ð¾ÑÐ¸ h, j, k, l.","ÐÐ»Ð°Ð²Ð¸Ð°ÑÑÑÐ½Ð¾Ðµ ÑÐ¿ÑÐ°Ð²Ð»ÐµÐ½Ð¸Ðµ":"ÐÐ»Ð°Ð²Ð¸Ð°ÑÑÑÐ½Ð¾Ðµ ÑÐ¿ÑÐ°Ð²Ð»ÐµÐ½Ð¸Ðµ","ÐÑÐºÑÑÑÑ ÑÑÑÐ»ÐºÑ":"ÐÑÐºÑÑÑÑ ÑÑÑÐ»ÐºÑ","ÐÑÐºÑÑÑÑ ÑÑÑÐ»ÐºÑ Ð² Ð½Ð¾Ð²Ð¾Ð¹ Ð²ÐºÐ»Ð°Ð´ÐºÐµ":"ÐÑÐºÑÑÑÑ ÑÑÑÐ»ÐºÑ Ð² Ð½Ð¾Ð²Ð¾Ð¹ Ð²ÐºÐ»Ð°Ð´ÐºÐµ","ÐÐµÑÐµÐ¹ÑÐ¸ Ð¸Ð· ÑÑÑÐ¾ÐºÐ¸ Ð¿Ð¾Ð¸ÑÐºÐ° Ðº ÑÐµÐ·ÑÐ»ÑÑÐ°ÑÐ°Ð¼ Ð¸ Ð¾Ð±ÑÐ°ÑÐ½Ð¾":"ÐÐµÑÐµÐ¹ÑÐ¸ Ð¸Ð· ÑÑÑÐ¾ÐºÐ¸ Ð¿Ð¾Ð¸ÑÐºÐ° Ðº ÑÐµÐ·ÑÐ»ÑÑÐ°ÑÐ°Ð¼ Ð¸ Ð¾Ð±ÑÐ°ÑÐ½Ð¾","ÐÐµÑÐµÐ¹ÑÐ¸ Ð½Ð° ÑÑÑÐ°Ð½Ð¸ÑÑ Ð²Ð¿ÐµÑÑÐ´":"ÐÐµÑÐµÐ¹ÑÐ¸ Ð½Ð° ÑÑÑÐ°Ð½Ð¸ÑÑ Ð²Ð¿ÐµÑÑÐ´","ÐÐµÑÐµÐ¹ÑÐ¸ Ð½Ð° ÑÑÑÐ°Ð½Ð¸ÑÑ Ð½Ð°Ð·Ð°Ð´":"ÐÐµÑÐµÐ¹ÑÐ¸ Ð½Ð° ÑÑÑÐ°Ð½Ð¸ÑÑ Ð½Ð°Ð·Ð°Ð´","ÐÐµÑÐµÐºÐ»ÑÑÐ¸ÑÑÑÑ Ñ ÑÐµÐ·ÑÐ»ÑÑÐ°ÑÐ¾Ð² Ð¿Ð¾Ð¸ÑÐºÐ° Ð½Ð° ÑÐ¿Ð¸ÑÐ¾Ðº ÑÐµÑÐ²Ð¸ÑÐ¾Ð² Ð¸ Ð¾Ð±ÑÐ°ÑÐ½Ð¾":"ÐÐµÑÐµÐºÐ»ÑÑÐ¸ÑÑÑÑ Ñ ÑÐµÐ·ÑÐ»ÑÑÐ°ÑÐ¾Ð² Ð¿Ð¾Ð¸ÑÐºÐ° Ð½Ð° ÑÐ¿Ð¸ÑÐ¾Ðº ÑÐµÑÐ²Ð¸ÑÐ¾Ð² Ð¸ Ð¾Ð±ÑÐ°ÑÐ½Ð¾","ÐÐµÑÐµÐ¼ÐµÑÑÐ¸ÑÑÑÑ Ð²Ð²ÐµÑÑ Ð¸Ð»Ð¸ Ð²Ð½Ð¸Ð·":"ÐÐµÑÐµÐ¼ÐµÑÑÐ¸ÑÑÑÑ Ð²Ð²ÐµÑÑ Ð¸Ð»Ð¸ Ð²Ð½Ð¸Ð·","ÐÐ¾ÐºÐ°Ð·Ð°ÑÑ ÑÑÑ Ð¿Ð¾Ð´ÑÐºÐ°Ð·ÐºÑ":"ÐÐ¾ÐºÐ°Ð·Ð°ÑÑ ÑÑÑ Ð¿Ð¾Ð´ÑÐºÐ°Ð·ÐºÑ"},{lang:"ru"}),BEM.I18N.decl("lang-switcher",{all:"ÐÑÑ"},{lang:"ru"}),BEM.I18N.decl("logo",{yandex:"Ð¯Ð½Ð´ÐµÐºÑ"},{lang:"ru"}),BEM.I18N.decl("navigation",{more:"ÐÑÑ","search-also":"ÐÐ°Ð¹ÑÐ¸ ÑÐ°ÐºÐ¶Ðµ","search-on":function(t){return"ÐÐ°Ð¹ÑÐ¸ "+t.query+" Ð² Ð´ÑÑÐ³Ð¸Ñ ÑÐµÑÐ²Ð¸ÑÐ°Ñ"
}},{lang:"ru"}),BEM.I18N.decl("navigation_spok_yes",{ÐÑÑ:"ÐÑÑ"},{lang:"ru"}),BEM.I18N.decl("notice",{notifications:"Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹"},{lang:"ru"}),BEM.I18N.decl("search2",{"search-button-text":"ÐÐ°Ð¹ÑÐ¸","search-input-label":"ÐÐ°Ð¿ÑÐ¾Ñ","search-service-label":"ÐÐ¾Ð¸ÑÐº Ð¿Ð¾ ÑÐµÑÐ²Ð¸ÑÑ","search-web-label":"ÐÐ¾Ð¸ÑÐº Ð² Ð¸Ð½ÑÐµÑÐ½ÐµÑÐµ"},{lang:"ru"}),BEM.I18N.decl("suggest2",{fact:"Ð¤Ð°ÐºÑÑ",group:"ÐÑÑÐ¿Ð¿Ð° Ð¿Ð¾Ð´ÑÐºÐ°Ð·Ð¾Ðº",nah:"ÐÑ Ð¸ÑÐºÐ°Ð»Ð¸",nav:"Ð¡Ð°Ð¹Ñ",text:"ÐÐ¾Ð¸ÑÐº",traffic:"ÐÑÐ¾Ð±ÐºÐ¸",weather:"ÐÐ¾Ð³Ð¾Ð´Ð°"},{lang:"ru"}),BEM.I18N.decl("suggest2-item",{"quick-answer":"ÐÑÑÑÑÑÐ¹ Ð¾ÑÐ²ÐµÑ"},{lang:"ru"}),BEM.I18N.decl("ticker__text",{notifications:"Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹"},{lang:"ru"}),BEM.I18N.decl("tumbler",{off:"ÐÑÐºÐ»",on:"ÐÐºÐ»"},{lang:"ru"}),BEM.I18N.decl("user",{ÐÐ¾ÑÑÐ°:"ÐÐ¾ÑÑÐ°","ÐÐ°Ð³ÑÑÐ·Ð¸ÑÑ ÑÐ°Ð¹Ð»Ñ":"ÐÐ°Ð³ÑÑÐ·Ð¸ÑÑ ÑÐ°Ð¹Ð»Ñ","Ð ÐµÐ´Ð°ÐºÑÐ¸ÑÐ¾Ð²Ð°ÑÑ ÑÐ¿Ð¸ÑÐ¾Ðº":"Ð ÐµÐ´Ð°ÐºÑÐ¸ÑÐ¾Ð²Ð°ÑÑ ÑÐ¿Ð¸ÑÐ¾Ðº","ÐÐ¾Ð±Ð°Ð²Ð¸ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ":"ÐÐ¾Ð±Ð°Ð²Ð¸ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ",enter:"ÐÐ¾Ð¹ÑÐ¸",exit:"ÐÑÐ¹ÑÐ¸",letter:function(t){return this.keyset("i-tanker__dynamic").key("plural_adv",{count:t.count,one:"Ð½Ð¾Ð²Ð¾Ðµ Ð¿Ð¸ÑÑÐ¼Ð¾",some:"Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÑÐ¼Ð°",many:"Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÐµÐ¼",none:"ÐÐµÑ Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÐµÐ¼"})
