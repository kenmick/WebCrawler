...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("CsoUs1OFFCXToDDoI24SXvzdsMo")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return ge(t);if("auto-content"===e)return"auth"===n?ye(t):$e(t);if("action"===e)return"auth"===n&&!!s==!1?Me(t):$e(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Ee(t):"ticker"===e?we(t):$e(t)}return $e(t)
}if("mix"===e)return _e(t);if(""===e)return Ce(t);if("value"===e){var e=n;return"input"===e?Ie(t):"tumbler"===e&&"option"===s?Oe(t):$e(t)
}if("getLive"===e)return"input"===n&&!!s==!1?Ae(t):$e(t);if("live"===e)return"input"===n&&!!s==!1?je(t):$e(t);
...
}return $e(t)}return"default"===e?O(t):"env"===e?"i-global"===n?Ne(t):$e(t):"content"===e?C(t):"jsAttr"===e?Re(t):"tag"===e?w(t):"cls"===e?Le(t):"bem"===e?xe(t):$e(t)
...
return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?_(t):"list"===e?m(t):E(t)}if("tumbler"===e){var e=s;
...
}return"button"===e?v(t):E(t)}return"link"===e?y(t):"notice"===e&&"count"===s&&!t.ctx.url==!1?{href:t.ctx.url}:E(t)
...
return i.tabindex=e.tabindex,i}return E(t)}function _(t){if(!(t.__$anflg17!==!0)==!1){var e,i,n=(e=t.__$anflg17,t.__$anflg17=!0,i=_(t),t.__$anflg17=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function m(t){if(!(t.__$anflg16!==!0)==!1){var e,i,n=(e=t.__$anflg16,t.__$anflg16=!0,i=m(t),t.__$anflg16=e,i||{});
...
}if("button"===e)return!t.ctx.url==!1&&!!s==!1?"a":x(t);if("input"===e){var e=s;return"box"===e?"span":"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":B(t)
...
if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:T(t);
if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:T(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:T(t);if("input"===e){var e=s;
return"box"===e?S(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:T(t)}if("auth"===e){var e=s;
return"register"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=register",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","register")}:D(t):"remember"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=restore",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","remember")}:D(t):"button"===e?!!t.ctx.content==!1?{block:"button",type:"submit",mods:{theme:"action",size:"m"},content:BEM.I18N("auth","logon")}:D(t):"haunter"===e?!!t.ctx.content==!1?{block:"checkbox",mods:{theme:"normal",size:"m"},checkboxAttrs:{id:"auth-haunter",autocomplete:"off",name:"twoweeks",value:"no"},content:{elem:"label",content:BEM.I18N("auth","temporary")}}:D(t):"password"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"passwd",content:[{elem:"hint",content:BEM.I18N("auth","password")},{elem:"control",attrs:{type:"password",maxlength:256,"aria-required":!0}}]}:D(t):"username"===e&&!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"login",content:[{elem:"hint",content:BEM.I18N("auth","login")},{elem:"control",attrs:{"aria-required":!0}}]}:D(t)
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Ee(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:T(t)
}if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=we(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):T(t)
}return"suggest2-item"===e?!(r&&"link"===r.interact)==!1&&!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:I(t):"popup"===e?!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:T(t):"tumbler"===e?"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1&&!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:P(t):T(t)
...
}return T(t)}return T(t)}function D(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=ye(t),i=e,n),{elem:"retpath"}]
}return T(t)}function I(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):T(e)}function P(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return T(t)
}function T(t){return t.ctx.content}function O(t){var e=n;if("dropdown"===e)return"popup"===s&&!(t.__$anflg32!==!0)==!1?A(t):$e(t);
if("checkbox"===e)return j(t);if("button"===e)return R(t);if("input"===e)return L(t);if("auth"===e)return U(t);
if("suggest2-item"===e){var e=s;return"icon"===e?K(t):"fact"===e?X(t):$e(t)}return"select"===e?Y(t):"popup"===e?ne(t):"tumbler"===e?oe(t):"i-global"===e?pe(t):$e(t)
...
var r=i;i="",Se(t),t.ctx=o,i=r,t.__$anflg32=s}function j(t){return!(t.__$anflg31!==!0)==!1&&!!s==!1?N(t):$e(t)
}function N(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
...
var e=t.__$anflg27;return t.__$anflg27=!0,R(t),void(t.__$anflg27=e)}return $e(t)}return $e(t)}function L(t){var e=s;
return"hint"===e?$(t):"control"===e&&!(t.__$anflg24!==!0)==!1?q(t):F(t)}function $(t){if(!(t.__$anflg25!==!0)==!1){if(!!t._value==!1){if(!(0!==t._value)==!1){var e=t.ctx,i=e.elemMods||(e.elemMods={});
i.visibility="visible";var n=t.__$anflg25;return t.__$anflg25=!0,$(t),void(t.__$anflg25=n)}return F(t)
}return F(t)}return F(t)}function q(t){var e=t.__$anflg24;t.__$anflg24=!0;var n=t.ctx;t.ctx=[t._placeholder?{elem:"hint",elemMods:{fallback:"yes"},content:t._placeholder}:"",{elem:"box",content:t.ctx}];
var s=i;i="",Se(t),t.ctx=n,i=s,t.__$anflg24=e}function F(t){return!(t.__$anflg12!==!0)==!1&&!!s==!1?V(t):$e(t)
}function V(t){var e,n,s,o,a,c,h,l,u,d=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Ie(t),i=e,t.ctx=n,s),p=t.ctx.id||t.generateId(),f=t.ctx.mods||{},_=(o=i,i="getLive",a=Ae(t),i=o,a);
f.theme=f.theme||"normal",t.ctx.hasOwnProperty("placeholder")&&(c=i,i="value",h=t.ctx,t.ctx=t.ctx.placeholder,l=Ie(t),i=c,t.ctx=h,u=l);
var m=t.__$anflg12;t.__$anflg12=!0;var g=t._inputId;t._inputId=p;var b=t._labelId;t._labelId="label"+p;
...
t._placeholder=u;var B=t.ctx,C=B.mods;B.mods=f,L(t),t._inputId=g,t._labelId=b,t._hintId=v,t._name=y,t._value=k,t._inputLink=M,t._disabled=E,t._live=w,t._placeholder=x,B.mods=C,t.__$anflg12=m
}function U(t){return"retpath"===s?H(t):z(t)}function H(t){if(!(t.__$anflg23!==!0)==!1){var e=t.__$anflg23;
t.__$anflg23=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,H(t),t._retpath=i,void(t.__$anflg23=e)
}return z(t)}function z(t){return!(t.__$anflg22!==!0)==!1&&!!s==!1?W(t):$e(t)}function W(t){var e,i,n,s;
...
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),K(t),i.weather=n,void(t.__$anflg21=e)
}return G(t)}return G(t)}function G(t){return!(t.__$anflg20!==!0)==!1?Q(t):$e(t)}function Q(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
...
var e=t.__$anflg19;return t.__$anflg19=!0,X(t),void(t.__$anflg19=e)}return $e(t)}return $e(t)}function Y(t){return"group"===s?J(t):Z(t)
}function J(t){if(!(t.__$anflg18!==!0)==!1){var e=t.__$anflg18;t.__$anflg18=!0;var i=t._labelId;return t._labelId=t.generateId(),J(t),t._labelId=i,void(t.__$anflg18=e)
}return Z(t)}function Z(t){return!(t.__$anflg14!==!0&&t.__$anflg15!==!0)==!1&&!!s==!1?te(t):ee(t)}function te(t){var e,n,s,o,r,a,c,h=t.ctx,l=(e=i,i="js",n=be(t),i=e,n||{}).live;
...
}}var f=t.__$anflg15;t.__$anflg15=!0,Y(t),t.__$anflg15=f}function ee(t){return!(t.__$anflg13!==!0)==!1&&!!s==!1?ie(t):$e(t)
...
}function ne(t){return!!t._popupDefaults==!1&&!!s==!1?se(t):$e(t)}function se(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
...
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Se(t),t.ctx=n,i=o,void(t.__$anflg9=e)
}return re(t)}return re(t)}return ce(t)}function re(t){return!(t.__$anflg8!==!0)==!1?ae(t):ce(t)}function ae(t){var e,n,s=(e=i,i="value",n=Oe(t),i=e,n),o=t.__$anflg8;
...
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",oe(t),t._disabled=i,void(t.__$anflg6=e)
}return he(t)}return he(t)}return he(t)}function he(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",oe(t),t._checked=i,void(t.__$anflg5=e)}return le(t)
}return le(t)}return le(t)}function le(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),oe(t),i.mods=n,void(t.__$anflg4=e)
}return ue(t)}return ue(t)}return ue(t)}function ue(t){return!(t.__$anflg3!==!0)==!1&&!!s==!1?de(t):$e(t)
...
}function pe(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?fe(t):$e(t)
...
for(var a in s)o[a]=s[a]}function _e(t){var e=n;if("dropdown"===e)return!!s==!1?[{mods:{action:"closed"}}]:me(t);
if("notice"===e)return"count"===s&&!!t.ctx.url==!1?[{elem:"plain"}]:me(t);if("ticker"===e)return"text"===s?[{block:"a11y-hidden"}]:me(t);
if("suggest2-item"===e)return"text"===s&&!(r&&"link"===r.interact)==!1&&!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:me(t);
if("suggest2"===e)return!!s==!1?[{block:"suggest2-detect",js:!0}]:me(t);if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return me(t)}return"input"===e&&"ahead"===s?[{block:"input",elem:"input"}]:me(t)
}function me(){return void 0}function ge(t){var e=n;return"dropdown"===e?!!s==!1?!0:ve(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):ve(t):"button"===e||"auth"===e||"suggest2-item"===e||"suggest2"===e?!!s==!1?!0:ve(t):"select"===e?!!s==!1?be(t):ve(t):"input"===e?!!s==!1?{live:t._live}:ve(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):ve(t):"link"===e&&!t.ctx.tabindex==!1&&!!s==!1?{origTabindex:t.ctx.tabindex}:ve(t)
}function be(t){return t.extend({live:!1},t.ctx.js)}function ve(){return void 0}function ye(t){return!!t.ctx.content==!1&&!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:ke(t)
}function ke(t){return!!s==!1?[]:$e(t)}function Me(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
...
}function xe(t){return"suggest2-item"===n&&"highlight"===s?!1:Be(t)}function Be(){return void 0}function Ce(t){return"popup"===n&&!t._popupDefaults==!1&&!!s==!1?(delete t._popupDefaults,void Qe(t)):Se(t)
}function Se(t){return!(t.__$anflg1!==!0)==!1&&!!t["i-global"]==!1?De(t):$e(t)}function De(t){for(var e,o,r,a,c,h,l,u,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];u=p.shift();)d[u]=(e=i,i="default",o=n,n="i-global",r=s,s=u,a=pe(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",l=Ne(t),i=c,n=h,l),_=t.__$anflg1;t.__$anflg1=!0;var m=t["i-global"];
t["i-global"]=t.extend(d,f),Ce(t),t["i-global"]=m,t.__$anflg1=_}function Ie(t){return!t.isSimple(t.ctx)==!1&&!!s==!1?t.ctx:Pe(t)
}function Pe(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Se(t),t._buf=n,i=o,e.join("")
}return Te(t)}return Te(t)}function Te(t){return!!s==!1?"":$e(t)}function Oe(t){return t.ctx.value||"left"!==t.ctx.side
...
}return s}function je(){return!1}function Ne(t){return!!s==!1?{}:$e(t)}function Re(){return void 0}function Le(){return void 0
}function $e(t){return!t.ctx==!1&&!t.ctx.link==!1&&!!t._.isSimple(t.ctx)==!1?qe(t):Fe(t)}function qe(i){function n(){if("no-follow"===this.ctx.link)return void 0;
...
var n=t.ctx;return void((n&&n!==!0||0===n)&&t._buf.push(n))}return!!t.ctx==!1?void t._listLength--:!t._.isArray(t.ctx)==!1?ze(t):We(t)
}return Ke(t)}function He(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,u,d,p,f,_,m,g,b,v,y,k,M,E,x,B,S,D,I,P,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=w(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var N,R;
n&&A.js!==!1&&(h=i,i="js",u=ge(t),i=h,R=u,R=R?t._.extend(A.js,R===!0?{}:R):A.js===!0?{}:A.js,R&&((N={})[O.INTERNAL.buildClass(n,A.elem)]=R)),j.push("<",T);
var L=(d=i,i="bem",p=xe(t),i=d,p);"undefined"!=typeof L||(L="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var $=(f=i,i="cls",_=Le(t),i=f,_);$||($=A.cls);var q=A.block&&N&&!A.elem;if(L||$){if(j.push(' class="'),L){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var F=(m=i,i="mix",g=_e(t),i=m,g);if(A.mix&&(F=F?[].concat(F,A.mix):A.mix),F){var V={};V[e(n,s)]=!0,t._.isArray(F)||(F=[F]);
...
if(z&&j.push(" "),O.INTERNAL[z?"buildClasses":"buildModsClasses"](W,H.elem||H._elem||(H.block?void 0:s),H.elemMods||H.mods,j),H.js&&((N||(N={}))[O.INTERNAL.buildClass(W,H.elem)]=H.js===!0?{}:H.js,q||(q=W&&!H.elem)),z&&!V[e(W,K)]){V[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=_e(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var J=X[Y];
(J.block||J.elem)&&V[e(J.block,J.elem)]||(J._block=W,J._elem=K,F.splice(U+1,0,J))}}}}}}$&&j.push(L?" ":"",$),q&&j.push(" i-bem"),j.push('"')
}if(N){var Z=(x=i,i="jsAttr",B=Re(t),i=x,B);j.push(" ",Z||"data-bem",'="',t._.attrEscape(JSON.stringify(N)),'"')
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(I=i,i="content",P=C(t),i=I,P);if(ie||0===ie){var L=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=L?1:t.position;var oe=t._listLength;t._listLength=L?1:t._listLength;
...
var _=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,O(t),i=h,t._links=l,n=u,t._currBlock=d,s=p,r=f,o=_
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,l=t.host||"kiks.yandex",u=window,d=document,p=navigator,f=p.userAgent,_=p.mimeTypes,m=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+l.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+l+".ru/system/%s%d.swf",M="//"+l+".ru/fu",E="//"+l+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",D="always",I="height",P="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",N="ya_fc",R=i(x,B)+i(O,1)+i(I,1)+i("id",N)+i("tabindex","-1")+i("aria-hidden","true"),L=!1;
u.ya_fc_external=function(t,n,l,u){r=t,a=n,c=l,h=u||"fc";var d,p=_&&_[w]?_[w].enabledPlugin:0,f=L,y=0,x=s()?k.replace("%d",a).replace("%s",h):M.replace("%s",o());
if(p)y=p.description.split("Shockwave Flash ")[1],f=parseInt(y,10)>=m;else if(b){f=L;try{f=new ActiveXObject("ShockwaveFlash.ShockwaveFlash."+m)
}catch(I){}}return d=f?g?'<div style="'+B+'"><'+v+R+i("src",x)+i(P,T)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+R+">"+e("movie",x):"<"+v+R+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
};var $=this,q=arguments.callee.load=function(t){var e,i;t.mode?(e="00",i="kfc"):e="07",$.replaceWith(u.ya_fc_external("07_2",e,"01",i))
};$.hasClass("i-flashcookie_autoload_no")||q(t)};Lego.block["i-flashcookie"]=function(i){var n=this.hasClass("i-flashcookie_type_inline")?e:t;
...
}}),_borschik("20WyJQpdEPZB-6AMhP3V-2_Wbfc")&&BEM.DOM.decl("popup2",{onSetMod:{js:{inited:function(){this._parentPopup=void 0,this._zIndex=null,this._zIndexGroupLevel=null,this._isAttachedToScope=!1
...
},hide:function(){return this.delMod("visible")},show:function(){return this.setMod("visible","yes")}}),_borschik("fCcxyi2q2N370A46VW4RVCmmA6k")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DELETE:46,is:function(t){return Array.prototype.slice.call(arguments,1).some(function(e){return this[e]===t
},this)}}),_borschik("sw5VXJQhbIzG-HgymyBE-aupFhY")&&BEM.DOM.decl({block:"popup2",modName:"target"},{onSetMod:{js:{inited:function(){var t=this.__self.AVAILABLE_DIRECTIONS;
...
w(null,t[0],i.join(","))}}),_borschik("ouv3n97Go_-N5WhhG2UzJH8MWqo")&&BEM.DOM.decl("click",{onSetMod:{js:function(){this.action=this.params.action,this.bindTo("click",this.onClick.bind(this))
...
}},onClick:function(t){t.originalEvent.handled=!0}}),_borschik("odlHPC881r0zVnCPIwGcOZKUNYk")&&BEM.DOM.decl("video",{onSetMod:{js:function(){var t=this.findBlockOn("serp-item"),e=this.findBlockInside("video-player"),i=t.params.preview&&t.params.preview.common?"common":"video";
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("s9-RQ6nJTihYo3BvOqkuh_lPbgE")&&BEM.DOM.decl({block:"popup2",modName:"autoclosable",modVal:"yes"},{onSetMod:{visible:{yes:function(){this.__self._visiblePopupsStack.unshift(this),this.afterCurrentEvent(function(){this.domElem&&this.bindToDoc("leftclick tap",this._onDocClick)
...
},_showError:$.noop,_hideError:$.noop},{_instancesCount:0,BLOCKS:[]}),_borschik("wV02XiWN09YOc224USiIxgP0hME")&&BEM.DOM.decl("serp",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._requestChannel=BEM.channel("serp-request")
...
},onAjaxSuccess:function(t){this.unbindFromWin("scroll");var e=this.params=t.params;return e&&e.html?(e.loadAt||this.params.html.indexOf("flashldr019.js")<0?BEM.DOM.update(this.domElem,e.html):this.flashCallback(),void this.init()):void BEM.DOM.update(this.domElem,"")
...
}}),_borschik("2PS90af9GyFBq6GWaxATi33bz0Y")&&BEM.DOM.decl("tabs-navigation",{onAjaxSuccess:function(t){t.html&&(this.dropElemCache(),BEM.DOM.update(this.domElem,$(t.html).html()))
...
})}}),_borschik("vGKWNWPgWY9kfpEhs2n7iWSgxfc")&&(BEM.DOM.decl("b-keyboard-loader",{onSetMod:{js:function(){Lego.block["b-keyboard-loader"].call(this.domElem,this.params)
