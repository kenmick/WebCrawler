...
}function l(){return f.map(this.markers,function(n){return{b_id:n.b_id,b_name:n.b_name,b_type:n.b_type,b_url:n.b_url,b_latitude:n.b_latitude,b_longitude:n.b_longitude,b_persistent:(n.data)?n.data.b_persistent:false,behaviors:(n.data)?n.data.behaviors:false}
})
