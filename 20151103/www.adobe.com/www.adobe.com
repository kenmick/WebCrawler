...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <script type="text/javascript" src="dtagent622_bxjpr23_1019.js" data-dtconfig="rid=RID_2418|rpid=-298322155|domain=adobe.com|tp=500,50,3|cors=1|bandwidth=300|reportUrl=https://www.adobe.com/dynaTraceMonitor"></script><link rel="icon" href="https://wwwimages2.adobe.com/include/img/favicon.ico" type="image/x-icon">
...
<main class="lobby">
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-max-takehiro-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="50% 15%" data-background-mobile-position="50% 50%" data-article-width="big" data-seed-background>
...
<ul>
    ...
    <li>Come to Adobe Summit 2016 in Las Vegas, March 20â24. Sign up before it sells out. </li>

    <li class="link">
        <a title=" Register today âº" href="http://summit.adobe.com/na/" target="_blank" class="base">
             Register today âº
        </a>
    </li>
