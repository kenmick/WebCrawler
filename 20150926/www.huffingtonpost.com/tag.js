...
define("js/fo/util/modifier", [ "require", "exports", "omnitag/gostructs", "util/str", "merger", "lib/jquery" ], function(e, t, r, n, a, i) {
    function o(e, t, n, a, i, o) {
        var f;
        switch (e) {
          case r.DatasourceKind.VAST:
            f = s;
            break;

          case r.DatasourceKind.VAST_LOCAL:
            f = s;
            break;

          case r.DatasourceKind.NEXTPERF:
            f = c;
            break;

          case r.DatasourceKind.APPNEXUS:
            f = d;
            break;

          case r.DatasourceKind.CRITEO:
            f = u;
            break;

          case r.DatasourceKind.ADVENTORI:
            f = l;
            break;
    ...
    function s(e, t, r, n, a) {
        -1 != r.indexOf(document.location.protocol) || g.support.cors || (r = r.replace(/https?:/, document.location.protocol));
        var i = {
            url: r,
            type: "GET",
            global: !1,
    ...
    function c(e, t, r, n, a) {
        ...
        window.nextperf = function(e) {
            clearTimeout(s), n(e), delete window.nextperf;
        };
    ...
    function l(e, t, r, n, a) {
        ...
        i.error = function(e, t, r) {
            ...
            clearTimeout(s), e.results && e.results.places && e.results.places.places && e.results.places.places.length > 0 ? n() : a();
        };
        var o = function() {
            n = function(e) {}, a();
        }, s = setTimeout(o, 2e3);
    ...
    function f(e, t) {
        if (t.ClickTracker && e.ClickTracker && (e.ClickTracker = n.Taint(n.Untaint(t.ClickTracker) + n.EncodeURIComponent(e.ClickTracker))), 
        t.PerformUITriggers && e.PerformUITriggers) for (var r = 0; r < e.PerformUITriggers.length; r++) {
            for (var i = !1, o = e.PerformUITriggers[r], s = 0; s < t.PerformUITriggers.length; s++) {
                var c = t.PerformUITriggers[r];
                c == o && (i = !0);
            }
            i || e.PerformUITriggers.splice(r, 1);
        }
        a.DeepMerge(e, t);
    }
    var g = i.jQuery;
