...
<script>window.wmTest=function(e){"use strict";function t(e,t){var o=parseInt(e.slice(0,13),16);return o%t===0}function o(e){return t(e,l)?null:"rejected"}var r,a=e.generateRandomSessionId(),l=2,n=9e5,s={GROUP:"portal_test_group",SESSION_ID:"portal_session_id",EXPIRES:"portal_test_group_expires"},g=!1;if(/www.wikipedia.org/.test(location.hostname)&&(l=200),window.localStorage){var i=localStorage.getItem(s.GROUP),S=localStorage.getItem(s.SESSION_ID),I=localStorage.getItem(s.EXPIRES),c=(new Date).getTime();I&&S&&i&&c<parseInt(I,10)?(a=S,r="null"===i?null:i):(r=o(a),localStorage.setItem(s.SESSION_ID,a),localStorage.setItem(s.GROUP,r)),localStorage.setItem(s.EXPIRES,c+n)}else r="rejected";return{loggingDisabled:g,sessionId:a,group:r}}(eventLoggingLite);</script>
<hr>
