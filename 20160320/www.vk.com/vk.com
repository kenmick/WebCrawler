...
<meta name="description" content="VK is the largest European social network with more than 100 million active users. Our goal is to keep old friends, ex-classmates, neighbours and co-workers in touch." />
...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang3_0.js':{v:3576},'index.css':{v:27},'index.js':{v:33},'ui_controls.css':{v:66},'ui_controls.js':{v:189}
}
var abp;
</script>

<link rel="stylesheet" type="text/css" href="/css/al/common.css?512" />
...
<div><div class="scroll_fix">
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login" onsubmit="if (vklogin) {return true} else {quick_login();return false;}">
    ...
    <input type="hidden" name="lg_h" value="9f8d430e644b0f573e" />
  ...
  <div class="content">
    <p><b>VK</b> is the largest European social network with more than <b>100 million</b> active users.</p>
