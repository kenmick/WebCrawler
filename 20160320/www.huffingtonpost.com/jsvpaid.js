...
m.Td = function() {
  return{"a.active":this.H ? this.H.Jc : -1, "a.framerate":this.H ? this.H.fd : -1, "a.geometric":this.H ? this.H.gd : -1, "a.psize":this.xe, "a.viewable":this.H ? this.H.Nb : -1, "a.viewableOpportunity":this.Oe, adapDetD:this.qa ? this.qa.hf : "", adNumber:this.Qd, playerRev:"ebe8fce"}
};
m.B = function(a) {
  switch(a.type) {
    case "AdLoaded":
...
function bg(a) {
  a = K(K(K(K(K(xd(Id() + "://log.adaptv.advertising.com/log?event\x3dclientstats"), "playerRev", "ebe8fce"), "pageUrl", a.qa.Na()), "sdkType", "js"), "depth", a.qa.Pd), "eov", Math.floor(1E6 * Math.random()));
