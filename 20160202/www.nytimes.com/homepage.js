...
with(obj||{}){
__p+='';
 var countyLeaders = Helpers.getCountyLeaders(race); 
__p+='\n<div class="eln-map-key">\n	';
 if (countyLeaders && countyLeaders.length > 0) { 
__p+='\n	  ';
 if ( countyLeaders[0].votes > 0 ) { 
__p+='<p class="eln-label">County leader</p>';
 } 
__p+='\n		';
 _.each(countyLeaders, function(d) { 
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav class="eln-navigation eln-desktop">\n\n    <a class="eln-title-button" href="//elections.nytimes.com" title="Election 2016">\n      <span class="eln-sprite eln-icon-ballot"></span>\n      <span class="eln-election-title">Election 2016</span>\n    </a>\n\n    <div class="eln-nav-items clearfix">\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/us/elections/primary-calendar-and-results.html">Primary Calendar</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/01/21/us/elections/iowa-new-hampshire-presidential-election-polls-clinton-trump-sanders-cruz.html">Polling</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/2016/primaries/iowa">Iowa</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/2016/primaries/new-hampshire">New Hampshire</a>\n      <!-- <a class="eln-nav-item" href="http://www.nytimes.com/elections/2016/primaries/south-carolina">South Carolina</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/2016/primaries/nevada">Nevada</a> -->\n    </div>\n\n</nav>\n\n<nav class="eln-navigation eln-mobile">\n\n    <div class="eln-nav-items clearfix">\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/us/elections/primary-calendar-and-results.html">Primary Calendar</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/interactive/2016/01/21/us/elections/iowa-new-hampshire-presidential-election-polls-clinton-trump-sanders-cruz.html">Polling</a>\n      <a class="eln-nav-item" href="http://www.nytimes.com/elections/2016/primaries/iowa">Iowa Preview</a>\n    </div>\n\n</nav>';
}
return __p;
...
var candidates = race.candidates.slice(0),
    ...
    show_more = options.show_more && candidates.length > max_candidates,
...
'</p>\n  ';
 if ( show_more ) { 
__p+='<p class="eln-note eln-collapse-candidates"><a class="eln-collapse" href="#">â Show fewer candidates</a></p>';
 } 
__p+='\n  ';
 if ( race.has_incumbent ) { 
__p+='<p class="eln-note">*Incumbent</p>';
 } 
__p+='\n  ';
 if ( race.updated ) { 
__p+='\n    <div class="eln-note eln-updated"><span class="eln-updated-label">Last updated </span><span class="eln-updated-time">'+
((__t=( Helpers.timeFormat(race.updated) ))==null?'':__t)+
'</span></div>\n  ';
 } 
__p+='\n  ';
 if ( race.race_calls ) { 
__p+='<div class="eln-note eln-race-calls">'+
((__t=( race.race_calls ))==null?'':__t)+
'</div>';
 } 
__p+='\n</div>';
}
...
if (typeof define === "function" && define.amd) {
  ...
  ], function(_, d3, moment, timezone) {
    define('lib/helpers',[],function() { return initializeHelpers(_, d3, timezone); });
  });
...
function initializeHelpers(_, d3, moment) {
  ...
  var Helpers = {
    ...
    dateFormat: function(timestamp) {
      ...
      return moment(timestamp).tz("America/New_York").format("MMMM D, YYYY");
    },
    ...
    getCountyLeaders: function(race) {
      var noResults = {
      ...
      return _.chain(race.counties)
        ...
        .sortBy(function(d) { return -d.votes })
        .uniq()
        .value();
    }
  }
...
define('nytg-vote-map/lib/vmap-pointer',['d3/3', './vmap-utils'], function(d3, utils) {
  ...
  api.create = function(surface) {
    ...
    function update() {
      ...
      var pagePos = d3.mouse(document.body);
      var prev = pos;
      var dx, dy;
      pos = {
        time: +new Date(),
...
define('nytg-vote-map/lib/vmap-transform',[
  ...
  function createTransform(opts) {
    ...
    */
    ...
    transform.updateDisplaySize = function(w, h) {
      var zoomOpts;
      ...
      updateK(); // kludge
      if (!contentBounds) {
        // If called before content bounds have been set, just return
        return;
      }
    ...
    */
    ...
    function navigateToBounds(target, duration) {
      ...
      if (utils.boundsAreEqual(pre, post)) {
        return;
      }
      updateK();
    ...
    function updateBounds(bbox) {
      ...
      if (!utils.boundsAreEqual(newBounds, viewBounds)) {
...
function(_, d3, utils) {
  ...
  function MapCanvas(container, proj, w, h) {
    var canv = container.append('canvas')
        .style({
          position: 'absolute',
          'z-index': 1,
          top: 0,
    ...
    this.drawFeatures = function(geom, style, draw, filter) {
      ...
      features.forEach(function(d) {
        ...
        if (stroke) {
          ctx.lineWidth = strokeWidth(d) * _pixelRatio;
...
define('nytg-vote-map/lib/vmap-popup',['d3/3', './vmap-utils'], function(d3, utils) {
  ...
  api.create = function(opts) {
    ...
    var hidden = true;
    var cachedInfo = null;
    var popup = opts.div ? d3.select(opts.div) : d3.select('body').append('div');
    ...
    // @pos {x, y} location of pointer relative to top, left of map container
    // TODO: option to change popup location relative to pointer
    popup.update = function(pos) {
      // var popRect = popup.node().getBoundingClientRect(),
      //     popWidth = popRect.right - popRect.left,
      // var popWidth = popup.node().offsetWidth,
  ...
  function VoteMap(el, opts) {
    ...
    */
    ...
    proj.on('change', function() {
      map.dispatchEvent('resize'); // before refreshMap() to allow styling
      refreshMap();
    });
    ...
    function updateSize() {
      ...
      proj.updateDisplaySize(rect.width, rect.height);
    }
...
define('map2016/map-colors',['../nytg-vote-map/lib/vmap-utils', '../nytg-vote-map/lib/vmap-color'], function(utils, vcolor) {
  var api = {};

  // #9a7ace, #3ca0a0, #eaa936, #ba4775, #e87f38, #a78c00, #57a33b, #3ab7dd, #d14646
  // #8989d1, #c1a73d, #77af52
  var candidateColors = {
    'clinton-22310': '#5b97d3',
    'omalley-22312': '#8b80d6',
    'sanders-22311': '#91cc6a',
    'bush-22321': '#ad494a',
    'carson-22322': '#f0e13a',
    'christie-22323': '#62add4',
    'cruz-22324': '#e7ba52',
    'fiorina-22326': '#5e8db3',
    'gilmore-22345': '#726860',
    'huckabee-22329': '#a55194',
    'kasich-22331': '#e0765c',
    'paul-22333': '#e7969c',
    'rubio-22335': '#8a497e',
    'santorum-22336': '#8c6d31',
    'trump-22337': '#d65454'
  };
  ...
  api.getBubbleColor = function(col) {
    return vcolor.getOverlayColor(col, 0xffffff, 0.75, 0.85);
  };
...
define('map2016/map-popup',['underscore/nyt', 'd3/3', 'templates', 'lib/helpers', './race-data-import'], function(_, d3, Templates, Helpers, DataImport) {
  ...
  api.getFilteredTableHtml = function(data, req) {
    ...
    var templateOpts = getTemplateOptions({
      // todo: overrides
      max_candidates: 3
    });
  ...
  function getTemplateOptions(overrides) {
    var opts = {
  ...
  function getResultsTable(feat, req, overrideOptions) {
    /*
    if (hitSelection) d3.select(hitSelection).classed("hover", false);

    hitSelection = el;
    d3.select(el).classed("hover", true);
    */

    var opts = getTemplateOptions(overrideOptions);

    var voteData = req.getResult(feat);
    // console.log('popup data:', voteData)
    ...
    */
    ...
    var html = Templates[templateName]({
      ...
      title: title,
      subtitle: subtitle,
      race: voteData ? formatResults(voteData, raceData) : '',
      partials: Templates,
      options: opts,
      state: state,
  ...
  function getTitle(feat, geo, opts) {
    ...
    } else if (geo == 'counties' && opts.townView) {
...
define('map2016/map-filters',[], function() {
  ...
  var leader2012Rxp = /^leader12-(.*)/;
  var leader2008Rxp = /^leader08-(.*)/;
  ...
  api.getFilter = function(req) {
    ...
    } else if (match = leader2012Rxp.exec(str)) {
      f = getLeader2012Filter(match[1]);

    } else if (match = leader2008Rxp.exec(str)) {
      f = getLeader2008Filter(match[1]);
  ...
  function getLeader2012Filter(key) {
    return function(d) {
      return d.properties.r12.indexOf(key) > -1;
    };
  }

  function getLeader2008Filter(key) {
    return function(d) {
      return d.properties.d08.indexOf(key) > -1;
    };
  }
...
define('map2016/map-layers',['./map-colors', './map-popup', './map-filters', '../nytg-vote-map/lib/vmap-utils', '../etagx'], function(Colors, Popup, Filters, utils, etagx) {
  ...
  function create(vmap, mapOpts) {
    ...
    api.getMapRequirements = function(races, opts) {
      ...
      req.geography_type = raceData.race_type == 'house' ? 'house_districts' : 'counties'; // TODO: state-level maps, no counties?
    ...
    api.compileLayers = function(req, geom) {
      ...
      } else if (mapType == 'leader-bubbles') {
      ...
      if (mapType == 'leader') {
        layers.push(getCountyBackgroundLyr(req, geom, LIGHT_STROKE));
      }
      ...
      if (showLabels(req)) {
        layers.push(getStateLabelDotLyr(req, geom));
        layers.push(getStateLabelLyr(req, geom));
      }
    ...
    function showLabels(req) {
      return !req.filter && vmap.width() > 300;
    }
    ...
    function getPopupRenderer(req, opts) {
      return function(feat) {
        try {
          ...
          etagx.track('Maps | Interactive', 'Hover | Tooltip', label, true);
        } catch(e) {}
    ...
    function calcBubbleSize(count, maxCount, reportingPct, featureCount) {
      var maxSize = (vmap.width() + vmap.height()) * 0.45 / Math.sqrt(featureCount);
      // set lower bound on bubble scale
      var minScale = 0.2;
      // Reach max bubble size at 40% tabulation
      var effectivePct = Math.min(reportingPct / 0.4, 1);
    ...
    function getMarginBubbleSize(req, features) {
      ...
      var weight = 1;
      var maxCount = data.max_county_margin * weight + data.max_county_votes * (1 - weight);
      ...
      return function(feat) {
        ...
        return calcBubbleSize(d.margin, maxCount, reportingPct, featureCount);
      };
    }
    ...
    */
    ...
    function getCountyMarginLyr(req, geom) {
      ...
      var lyr = {
        ...
        features: features,
        style: {
          radius: getMarginBubbleSize(req, features),
          fill: bubbleColor,
          stroke: 'rgba(0, 0, 0, 0.15)'
        }
      };
    ...
    function getStateLabelLyr(req, geom) {
      return {
        ...
        style: {
          ...
          dx: function(d) {return d.properties.dx || 0;},
          dy: function(d) {return d.properties.dy || 0;},
          'text-anchor': function(d) {
            var anchor = d.properties.anchor;
...
define('map2016/map-key',['jquery/nyt','templates','lib/helpers'], function($, Templates, Helpers) {
...
require([
  ...
  'map2016/map-key',
  'etagx',
  ], function($, _, Results, Map, MapKey, etagx) {
    ...
    if (eln_config.ic_config.on === true) {
      ...
      function fetch() {
        ...
        // var url = 'http://localhost:3000/2016/api/election/' + eln_config.election_date + '.json';
        d3.json(url, update);
      }
