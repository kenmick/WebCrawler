...
},findPendingState:function(){return this.getEnv().find(function(f){return/_REQUIRED|_CONFLICT/.test(f.state)
})
...
B.when({experiment:"MRLLJZCeMJYGO"}).run(function(){B.require("profile/social/social-connect-dialog/social-connect-dialog").onload()
});