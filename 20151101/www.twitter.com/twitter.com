...
<!--[if gt IE 9]><!--><html lang="en" data-scribe-reduced-action-queue="true"><!--<![endif]-->
  ...
  <script id="resolve_inline_redirects" nonce="kAEgQ4d+TVY/NC7vdmzBJw==">
...
;e();window.addEventListener?window.addEventListener("hashchange",e,!1):window.attachEvent&&window.attachEvent("onhashchange",e)})();
  ...
  <script id="swift_action_queue" nonce="kAEgQ4d+TVY/NC7vdmzBJw==">
...
a.getAttribute("contenteditable")=="true"}var a=(new Date).getTime(),b=1e4,c=/^([^\.]+\.)*twitter\.com$/,d=/^key/,e=["click","keydown","keypress","keyup"],f=[],g=null,i=!0,j={captured:[],ignored:[],direct:[],all:[]};for(var k=0,l;l=e[k];k++)document["on"+l
  ...
  <script id="composition_state" nonce="kAEgQ4d+TVY/NC7vdmzBJw==">
...
,b,!1)}})();
    ...
    <link rel="stylesheet" href="https://abs.twimg.com/a/1446193263/css/t1/twitter_core.bundle.css">
    <link rel="stylesheet" href="https://abs.twimg.com/a/1446193263/css/t1/twitter_logged_out.bundle.css">
...
<link rel="mask-icon" sizes="any" href="https://abs.twimg.com/a/1446193263/img/t1/favicon.svg" color="#55acee">
...
<link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="Twitter">
          ...
          <link rel="stylesheet" href="https://abs.twimg.com/a/1446193263/css/t1/twitter_more_1.bundle.css">
      <link rel="stylesheet" href="https://abs.twimg.com/a/1446193263/css/t1/twitter_more_2.bundle.css">

  </head>
  <body class="three-col logged-out front-page-photo-set front-page" 
data-fouc-class-names="swift-loading"
 dir="ltr">
      <script id="swift_loading_indicator" nonce="kAEgQ4d+TVY/NC7vdmzBJw==">
    ...
    <li class="dropdown js-language-dropdown">
      ...
      <div class="js-front-language">
        <form action="/sessions/change_locale" class="t1-form language" method="POST">
          ...
          <input type="hidden" name="authenticity_token" value="359243db1e4f02919aa79614821986c1278382d5">
        </form>
      </div>
    </li>
  </ul>
...
>
  ...
  <input type="hidden" value="359243db1e4f02919aa79614821986c1278382d5" name="authenticity_token">
      <input type="hidden" value="" name="ui_metrics" autocomplete="off">
      <input type="hidden" id="ui_metrics_seed" name="ui_metrics_seed" value="1446402691305" autocomplete="off">
</form>
...
>
  ...
  <input type="hidden" id="swift-module-path" value="https://abs.twimg.com/c/swift/en">
    ...
    <script src="https://abs.twimg.com/c/swift/en/init.2570ef278b204b14a56d3e3a0b2802987b61c163.js" async></script>
