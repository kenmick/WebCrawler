...
dcrmInit = function(){
    ...
    var SecondLoad = document.createElement('script');
    // create the second variable for your second javascript.

    SecondLoad.setAttribute('type', 'text/javascript'); //set attribute again
    SecondLoad.src = 'youtube_site.js'; //call the other js you want to load
    document.getElementById('ad-container_dc').appendChild(SecondLoad); //add child it to the container.
