ï»¿var WebBlender = function ($) {
    ...
    */
    var loadOrderPurchaseHtml = function (orderId, auth, parentElementId, environment, flight, clientType, culture, market, cv, iframeOptions, purchaseServiceVersion, jwt, beneficiaryData) {
        var postBody = {
            "OrderId": orderId,
            "Auth": auth,
            "Culture": culture,
        ...
        if (beneficiaryData) {
            postBody["BeneficiaryProfile"] = beneficiaryData; // has "email" , "firstName" and "lastName";
        }
