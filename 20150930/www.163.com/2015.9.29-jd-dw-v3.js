...
dwBox.width = (typeof(adInfoTempDw.width)=="undefined")?1904:adInfoTempDw.width;
...
dwBox.createElement = function(){
	document.body.insertAdjacentHTML("afterBegin","<div id='dwMainDiv' style='height:105px;'></div>");
	this.dwMainDiv = document.getElementById("dwMainDiv");
	
	this.topDiv = adBox.createDiv(960,105);
	...
	var IndexFlashBg = adBox.createSwf("IndexFlashBg20140417","100%","950px",dwBox.src);
...
//éåå·ç»ä½¸ï¹¢é¬å¶å¡é¹æ°æ£éªã¤æéå«â¬å½å¼¶éï¿½
dwBox.go = function(){
