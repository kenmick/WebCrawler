...
}function k(J,I,K){s.level&&s.report(s.events.TRACKING_ATTEMPT,{what:J,hash:I,id:K,variant:(J===u.experiment||J===u.stage)&&z(I)});
if(a(J,I,K)){switch(J){case u.experiment:d(u.experiment,I);
x.populate(I);
q(u.experiment,I);
return z(I);
case u.stage:d(u.stage,I,K);
x.populate(I+"|"+K);
q(u.stage,I,K);
return false;
case u.goal:d(u.goal,I);
q(u.goal,I);
return false;
case u.custom_goal:d(u.custom_goal,I,K);
q(u.custom_goal,I,K);
return false;
