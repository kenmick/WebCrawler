...
(function(c,h){var e="fEDCKZaOdPDcVYDEZRae",d="/ufi_weekend_deals?lang={LANG}&currency={CURRENCY}&aid={AID}",g=4;
var f=function(){if(h.env.lp_getaway_deals_on_index_running){var i=a({lang:h.env.b_lang_for_url,currency:h.env.b_selected_currency,aid:h.env.b_aid});
c.getJSON(i,b)
}};
