                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['96px', '93px', '108px', '88px', 'auto', 'auto'],
                            opacity: '1',
                            fill: ["rgba(0,0,0,0)",im+"price599.png",'0px','0px'],
                            transform: [[],[],[],['0']]
                        },
                        {
                            id: 'conditionsCopy',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['152px', '50px', '135px', '18px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"red24.png",'0px','0px']
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            type: 'image',
                            id: 'T2_1',
                            rect: ['25px', '159px', '200px', '15px', 'auto', 'auto'],
                    ...
                    dom: [
                        {
                            type: 'image',
                            transform: [[], [], [], ['0']],
                            rect: ['-51px', '-74px', '108px', '88px', 'auto', 'auto'],
                            id: 'price1299Copy',
                            opacity: '1',
                            display: 'none',
                            fill: ['rgba(0,0,0,0)', 'images/price599.png', '0px', '0px']
                        },
                        {
                            type: 'image',
                            transform: [[], [], [], ['1', '0']],
