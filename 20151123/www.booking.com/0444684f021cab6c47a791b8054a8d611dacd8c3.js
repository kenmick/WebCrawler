...
booking[sNSStartup]["discover_b_index"]={init:function(){$(".discover-b-index").swapTab("paging",{$tabButton:".dcbi-tab__btn",$tabButtonActive:".dcbi-tab__btn.active",tabButtonActiveClass:"active",$tabSectionContainer:".dcbi-countries",tabSectionContainerActiveClass:"active"})
}};
...
z=z||{};
if(B.atlas.getVariant("ebcTGPbfRdcC")){z=x.enforceDataFormat(z,function(E){if(/^hotel/.test(E.b_type)){E.b_states.overlay=true
}})
...
if(B.atlas.getVariant("ebcBUcSPWYNHICTae")||B.atlas.getVariant("ebcOQQTDCPZRVMUWe")){g.addPolygon.call(x,z.b_best_location_score_districts)
...
}}if(x&&x.data&&((/^hotel.*/.test(x.data.b_type)&&(B.atlas.getVariant("eGBUYSaBNHTXT")||B.atlas.getVariant("eGOQPBRNZRUXe")))||(/^city.*/.test(x.data.b_type)&&B.atlas.getVariant("ebcYSaBaUSBCHC")))){if(d||m){C.set("hoverMarker","");
