...
}function l(){return f.map(this.markers,function(n){return{b_id:n.b_id,b_name:n.b_name,b_type:n.b_type,b_url:n.b_url,b_latitude:n.b_latitude,b_longitude:n.b_longitude,b_persistent:(n.data)?n.data.b_persistent:false,b_behaviors:(n.data)?n.data.b_behaviors:false}
})
...
booking.jstmpl("atlas_iw_ufi",(function(){var b=['\u003cdiv class="iw-container iw-default iw-','"\u003e\n    \u003ch3\u003e\n        ',"\n        ","\n            \u003cspan\u003e","\u003c/span\u003e\n        ","\n    \u003c/h3\u003e\n\u003c/div\u003e"],a=["b_marker_type","b_name","b_text"],e,d,c;
return function(f){var g="",h=this.fn;
...
booking.jstmpl("atlas_iw_polygon",(function(){var b=['\n\u003cdiv class="iw-container iw-default iw-',' maps-iw-poly-dropshadow-container"\u003e\n\t\u003cdiv class="maps-iw-poly"\u003e\n\t\t\u003cdiv class="maps-iw-poly-inner"\u003e\n\t\t\t',"\n\t\t\u003c/div\u003e\n\t\u003c/div\u003e\n\u003c/div\u003e"],a=["b_marker_type","b_type","maps_recommended_neighbourhoods"],e,d,c;
return function(f){var g="",h=this.fn;
if(!(h.MD(a[0]))){h.MN(a[0],h.MC(a[1]))
}g+=[b[0],h.MC(a[0]),b[1],h.MB(a[2]),b[2]].join("");
return g
}
})());
