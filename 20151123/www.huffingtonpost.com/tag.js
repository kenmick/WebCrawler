...
define("js/fo/omnitag/gostructs", [ "require", "exports", "js/util/str" ], function(n, t, r) {
    ...
    var un = function() {
        ...
        return n.Cast = function(t) {
            ...
            i = r.Branding, n.Branding = void 0 === i ? i : on.Cast(i), n.SlideDelay = r.SlideDelay;
        }, n;
    }();
    t.Preview = un;
    var sn = function() {
    ...
    var vn = function() {
        ...
        return n.Cast = function(t) {
            ...
            n.Url = t.Url, n.SecondaryUrls = t.SecondaryUrls, n.Width = t.Width, i = t.RedirectionTarget, 
            n.RedirectionTarget = void 0 === i ? i : dn.Cast(i), n.ForbidIframe = t.ForbidIframe;
        }, n;
    }();
    t.Landing = vn;
    var Cn = function() {
...
define("js/fo/backend", [ "require", "exports", "util/str", "util/context", "util/merger", "util/modifier", "omnitag/gostructs", "util/informer", "util/trigger", "util/analytics", "lib/jquery", "native/main", "native/integration/util" ], function(t, e, n, i, a, o, s, r, l, c, u, d, f) {
    ...
    var p = u.jQuery, h = function() {
        ...
        return t.prototype.OmniTag = function(e, n) {
            var a = this, o = document.location.href;
            parent !== window && (o = document.referrer), e.Debug = window.__AYL_DEBUG_UID__ || null, 
            e.Origin = document.location.protocol + "//" + document.location.host, e.HasPostMessage = t.HAS_POST_MESSAGE, 
            e.HasHtml5Video = t.HAS_HTML5_VIDEO, e.Url = ("" + (e.Url || o)).substring(0, 1500), 
            e.TimeZone = 60 * new Date().getTimezoneOffset() * 1e3 * -1, e.IsAlternateJs = i.IsAlternateJs || null;
            var s = function(t) {
                a.totalPlacementsMetric = t.length;
                for (var e = 0; e < t.length; e++) {
                    var n = t[e], i = function(t) {
                        a.pickConfig(t);
                    }, o = function(t) {};
                    f.CheckIntegration(n, i, o);
                }
            };
            n ? n("GET", "/omniTag", e, s, null, !0) : this.ajax("GET", "/omniTag", e, null, s, null, !0);
...
define("js/fo/util/modifier", [ "require", "exports", "omnitag/gostructs", "util/str", "merger", "util/context", "lib/jquery" ], function(e, t, n, a, i, r, o) {
    function s(e, t, a, i, r, o) {
        var s;
        switch (e) {
    ...
    function c(e, t, n, i, o) {
        var s, c = function() {
            ...
            var n = e + "__";
            "string" != typeof t.data || t.data.substring(0, n.length) != n || u ? o() : (u = !0, 
            c = function() {}, window.detachEvent ? window.detachEvent("onmessage", l) : window.removeEventListener("message", l), 
            clearTimeout(s), t.data.indexOf("vasterror") > -1 ? o() : i(t.data.substring(n.length)), 
            m.removeEventListener("readystatechange", f), m.removeEventListener("load", f), 
            d(m));
        };
        window.attachEvent ? window.attachEvent("onmessage", l) : window.addEventListener("message", l);
        var f = function(e) {
            (!m.readyState || /loaded|complete/.test(m.readyState)) && (s = setTimeout(c, 2e3));
        }, m = document.createElement("iframe");
        m.style.position = "absolute", m.style.left = "-9999px", m.style.width = "1px", 
        m.style.height = "1px", m.style.display = "block";
        var w;
        w = {
            url: n,
            uid: e
        }, m.src = r.Omnitag.StaticPrefix + "/if-vast.html#" + a.EncodeURIParams(w), m.addEventListener("readystatechange", f), 
        m.addEventListener("load", f), document.body.appendChild(m);
    }
    ...
    function l(e, t, n, a, i) {
        var r, o = function() {
            ...
            if ("string" == typeof t.data && t.data.substring(0, n.length) == n) {
                ...
                clearTimeout(r);
                var u = t.data.substring(n.length);
                u ? a(u) : i(), d(c);
            }
        };
    ...
    function f(e, t, n, a, i) {
        var r = function(t) {
            var n = e + "__";
            if ("string" == typeof t.data && t.data.substring(0, n.length) == n) {
                window.detachEvent ? window.detachEvent("onmessage", r) : window.removeEventListener("message", r), 
                clearTimeout(c);
                var s = t.data.substring(n.length);
                s ? a(s) : i(), d(o);
            }
        };
        window.attachEvent ? window.attachEvent("onmessage", r) : window.addEventListener("message", r);
    ...
    function m(e, t, n, a, i) {
        ...
        r.error = function(e, t, n) {
            ...
            clearTimeout(s), e.results && e.results.places && e.results.places.places && e.results.places.places.length > 0 ? a() : i();
        };
        var o = function() {
            a = function(e) {}, i();
        }, s = setTimeout(o, 2e3);
    ...
    var v = o.jQuery;
    t.Call = s, t.MergeModifierConfig = w;
});
//
...
define("js/fo/util/trigger", [ "require", "exports", "util/str", "util/time", "util/context", "omnitag/gostructs" ], function(e, t, n, r, a, o) {
    function i(e, r, a, i) {
        function s() {
            t.MakeCallTriggers(e, r, c, i)(), d && clearTimeout(d);
        }
        i || (i = document.body);
        var d, c = t.IsAlreadyTriggered(e, r, a);
        if (c) {
            var l = n.Untaint(r.ApiPrefix) + "/pixel?event_kind=" + e.toString() + "&attempt=" + n.EscapeHTML(r.Attempt);
            a && (l += "&campaign=" + n.EscapeHTML(a)), d = setTimeout(s, 2500), u("img", l, i, s);
        } else switch (e) {
          case o.EventKind.PLAYLIST_CLICK:
            var l = n.Untaint(r.ApiPrefix) + "/pixel?event_kind=" + e.toString() + "&attempt=" + n.EscapeHTML(r.Attempt);
            a && (l += "&campaign=" + n.EscapeHTML(a)), u("img", l, i, s);
            break;
    ...
    function s(e, t, r) {
        var a = e.toString() + "-" + n.EscapeHTML(t.Attempt);
        r && (a += "-" + n.EscapeHTML(r));
        var o = !p[a];
        return p[a] = !0, o;
    }
    function d(e, t, n, r) {
        var a;
        return a = t.OnEvents ? t.OnEvents.Get(e, []).slice(0) : [], function() {
            c(a, n, t.Trusted, t.Disabled, r);
        };
    }
    function c(e, t, r, a, i) {
        if (e && 0 != e.length) {
            for (var s = [], d = [], c = [], u = [], p = [], h = [], v = 0; v < e.length; v++) {
                var E = e[v];
                if (E && (t || !E.OncePerAttempt)) {
                    switch (E.Guard) {
                    ...
                    switch (E.Kind) {
                      case o.OnEventKind.PIXEL_URL:
                        var f = n.SubstituteTokens(E.Url);
                        E.Isolated ? s.push(f) : d.push(f);
                        break;

                      case o.OnEventKind.JAVASCRIPT_URL:
                        var f = n.SubstituteTokens(E.Url);
                        E.Isolated ? c.push(f) : u.push(f);
                        break;

                      case o.OnEventKind.JAVASCRIPT_CODE:
                        E.Isolated ? p.push(E.Code) : h.push(E.Code);
                        break;
            ...
            l(o.OnEventKind.PIXEL_URL, s, !0, r, i), l(o.OnEventKind.PIXEL_URL, d, !1, r, i), 
            l(o.OnEventKind.JAVASCRIPT_URL, c, !0, r, i), l(o.OnEventKind.JAVASCRIPT_URL, u, !1, r, i), 
            l(o.OnEventKind.JAVASCRIPT_CODE, p, !0, r, i), l(o.OnEventKind.JAVASCRIPT_CODE, h, !1, r, i);
        }
    }
    function l(e, t, i, s, d) {
        if (0 !== t.length) {
            t = t.slice(0);
            for (var c = 0; c < t.length; c++) t[c] = n.Untaint(t[c]);
            var l = [];
            if (i) {
                var p = document.createElement("iframe");
                p.sandbox = "allow-same-origin allow-scripts", p.style.position = "absolute", p.style.left = "-9999px", 
                p.style.width = "1px", p.style.height = "1px", p.style.display = "block";
                var h;
                switch (e) {
                  case o.OnEventKind.PIXEL_URL:
                    for (var c = 0; c < t.length; c++) t[c] = n.EncodeURIComponent(t[c]);
                    h = {
                        type: "pxurl",
                        urls: t.join(",")
                    };
                ...
                h.rnd = Math.random().toString().substring(2), p.src = a.Omnitag.SandboxPrefix + "/sb.html#" + n.EncodeURIParams(h), 
                document.body.appendChild(p), l.push(p);
            } else switch (e) {
              case o.OnEventKind.PIXEL_URL:
                for (var c = 0; c < t.length; c++) l.push(u("img", t[c], d));
                break;

              case o.OnEventKind.JAVASCRIPT_URL:
                if (!s) throw new Error("Cannot execute untrusted javascript code in publisher website context");
                for (var c = 0; c < t.length; c++) u("script", t[c], d);
                break;

              case o.OnEventKind.JAVASCRIPT_CODE:
                if (!s) throw new Error("Cannot execute untrusted javascript code in publisher website context");
                for (var c = 0; c < t.length; c++) {
                    var v = new Function(t[c]);
                    setTimeout(v, 1);
                }
                break;
    ...
    function u(e, t, n, r) {
        ...
        switch (e) {
          case "script":
            ...
            o.async = !0, o.charset = "UTF-8", o.src = t, a = o;
            break;

          case "img":
            var i = document.createElement("img");
            i.setAttribute("style", "position:absolute; left:-9999px; width:1px; height:1px; display:block;"), 
            i.src = t, a = i;
        }
        a.onload = a.onreadystatechange = function(t, n) {
            (n || !a.readyState || /loaded|complete/.test(a.readyState)) && (a.onload = a.onreadystatechange = null, 
            a.parentNode && "img" == e && a.parentNode.removeChild(a), a = null, r && r());
        };
        var s = function() {
            document.body ? parent !== window ? document.body.appendChild(a) : n === document.body ? document.body.insertBefore(a, document.body.firstChild) : n.appendChild(a) : setTimeout(s, 200);
        };
        return s(), a;
    }
    var p = {};
    t.TriggerEvent = i, t.IsAlreadyTriggered = s, t.MakeCallTriggers = d;
});
//
...
define("js/fo/native/main", [ "require", "exports", "util/str", "omnitag/gostructs", "util/analytics", "nativestructs", "carrier/loader", "integration/loader", "lib/jquery", "lib/countdown", "util/trigger", "util/filter", "util/slideshow", "util/native/dom/element" ], function(e, n, t, r, i, o, a, c, g, s, u, m, l, d) {
    function f(e) {
        var n = new v(e);
        n.Inject();
    }
    ...
    var v = function() {
        ...
        return e.prototype.Inject = function() {
            var e = this, n = function() {
                e.config.Integration == r.NativeIntegrationKind.NONE ? e.registerPerformUITriggers() : e.currentIntegration.GetMainContentElement() ? (m.DisplayFilter(e.config, e.currentIntegration.GetMainContentElement()), 
                e.config.Integration == r.NativeIntegrationKind.INJECTOR && e.config.Content.Preview.Branding ? l.Slideshow(e.config, e.currentIntegration.GetMainContentElement()) : e.config.Integration == r.NativeIntegrationKind.TEMPLATE && e.config.Content.Preview.Branding ? l.Slideshow(e.config, e.currentIntegration.GetMainContentElement(), e.config.IntegrationConfig.Template.Placeholders.Image.Width, e.config.IntegrationConfig.Template.Placeholders.Image.Height) : e.config.Integration == r.NativeIntegrationKind.TAB && e.config.Content.Preview.Branding && l.Slideshow(e.config, e.currentIntegration.GetMainContentElement(), 327, 133), 
                e.command(o.CommandKind.DeclareSuccess)) : e.command(o.CommandKind.DeclareError);
            }, t = function(n) {
                e.uiTrigger(n);
            };
            this.currentIntegration = c.Load(this.config.Integration, this.config, n, t), this.currentIntegration.Execute();
        }, e.prototype.uiTrigger = function(e) {
            switch (e) {
              case r.NativeUITriggerKind.CLICK:
                this.isUITriggerClickEnabled && this.command(o.CommandKind.Perform);
                break;

              case r.NativeUITriggerKind.SCROLL:
                this.uiTriggerScrollDone || (this.uiTriggerScrollDone = !0, this.command(o.CommandKind.Perform));
                break;

              case r.NativeUITriggerKind.CLICK_CLOSE:
            ...
            for (var e = this, n = 0; n < this.config.PerformUITriggers.length; n++) {
                var i = this.config.PerformUITriggers[n];
                switch (i) {
                  case r.NativeUITriggerKind.LOAD:
                  ...
                  case r.NativeUITriggerKind.SCROLL:
                    var a = function() {
                        ...
                        switch (e.config.Carrier) {
                          case r.CarrierKind.ADREADER:
                            var t = I(e.currentIntegration.GetMainContentElement()), i = I(window).scrollTop(), o = i + window.innerHeight, a = t.outerWidth(!0) * (9 / 16) * .25 + t.outerHeight(!0), c = t.offset().top, g = c + a;
                            n = c >= i && o >= g;
                            break;

                          default:
                            n = d.IsVisibleElement(e.currentIntegration.GetMainContentElement(), 1);
                        }
                        return n;
                    }, c = function() {
                  ...
                  case r.NativeUITriggerKind.MOUSE_OVER:
                    var g = t.EscapeHTML(this.config.Attempt), u = I(this.currentIntegration.GetMainContentElement()), m = new s.Countdown(u, g, 275, .3, !0, function() {
                        e.uiTriggerMouseOverDone = !0, e.command(o.CommandKind.Perform), e.uiTriggerMouseOverDone = !1;
                    });
                    if (!m.IsDisplayable()) return;
                    var l = function() {
                        m.IsDisplayed() || e.currentCarrier || e.uiTriggerMouseOverDone || (m.Reset(), m.Display(function() {
                            m.Start();
                        }));
                    };
                    u.hover(function(e) {
                    ...
                    var f, h, v = u.position(), E = function(e) {
                        f = e.pageX, h = e.pageY, v.left <= f && f <= v.left + u.width() && v.top <= h && h <= v.top + u.height() && (u.off("mousemove", E), 
                        l());
                    };
                    u.on("mousemove", E);
                    break;
            ...
            if (!this.callbackDeclareRun) {
                switch (this.callbackDeclareRun = !0, i.DeclareInsertionSuccess(this.config), this.config.Genus) {
                  case r.GenusKind.SPONSOR_POST:
                    this.triggerEvent(r.EventKind.SPONSORPOST_INSERTION);
                    break;

                  default:
                    this.triggerEvent(r.EventKind.INSERTION);
                    var n = function() {
                        if (!e.currentIntegration) return !1;
                        var n = d.IsVisibleElement(e.currentIntegration.GetMainContentElement(), .5);
                        return n && e.triggerEvent(r.EventKind.VISIBLE_INSERTION), n;
                    }, t = function(e) {
                        n() && e && I(window).off(e.type, t);
                    };
                    I(window).on("scroll", t), I(window).on("resize", t), n();
                }
            ...
            var e = this;
            this.triggerEvent(r.EventKind.NATIVE_ACTION), this.currentCarrier ? this.currentCarrier.Execute() : (this.currentCarrier = a.Load(this.config.Carrier, this.currentIntegration.GetMainContentElement(), this.config, function() {
                e.currentCarrier = null, (e.config.Integration == r.NativeIntegrationKind.LIGHTBOX || e.config.Integration == r.NativeIntegrationKind.NONE) && e.triggerEvent(r.EventKind.GET_CONTENT), 
            ...
            this.triggerEvent(r.EventKind.NATIVE_REMOVE), this.currentIntegration.Remove(), 
            this.currentIntegration = null;
        }, e.prototype.triggerEvent = function(e) {
            u.TriggerEvent(e, this.config, this.config.Campaign, this.currentIntegration.GetMainContentElement());
        }, e;
    }();
});
//
...
define("js/fo/native/carrier/redirect", [ "require", "exports", "util/redir", "util/str", "omnitag/gostructs", "base" ], function(e, i, n, t, r, o) {
    var c = function(e) {
        function i() {
            e.apply(this, arguments), this.eventKind = r.EventKind.CLICK;
        }
        return __extends(i, e), i.prototype.Execute = function() {
            var e = this, i = this.config.Content.Landing, o = i.Url;
            this.config.ClickTracker && (o = t.Untaint(this.config.ClickTracker) + t.EncodeURIComponent(o));
            switch (i.RedirectionTarget) {
              case r.RedirectionTargetKind.SELF:
                window.open(n.RedirUrl(this.config, o, this.eventKind), "_self");
                break;

              case r.RedirectionTargetKind.TAB:
                window.open(n.RedirUrl(this.config, o, this.eventKind), "_blank");
                break;

              case r.RedirectionTargetKind.SELF_WITH_TAB:
                var c = document.URL;
                c += c.indexOf("?") ? "&aylvalidate=success" : "?aylvalidate=success", window.open(c, "_blank"), 
                setTimeout(function() {
                    window.location.href = n.RedirUrl(e.config, o, e.eventKind);
                }, 1e3);
            }
            this.endedCallback();
        }, i;
    ...
    i.SponsorpostRedirect = a;
});
//

define("js/fo/util/redir", [ "require", "exports", "util/str", "util/trigger" ], function(r, n, e, t) {
    function i(r, n, i) {
        var o = t.IsAlreadyTriggered(i, r);
        t.MakeCallTriggers(i, r, o, document.body)();
        var a = e.Untaint(r.ApiPrefix) + "/redir?attempt=" + e.EncodeURIComponent(r.Attempt) + "&campaign=" + e.EncodeURIComponent(r.Campaign);
        if (!n) throw new Error("Unknown redirection url");
        if (a += "&url=" + e.EncodeURIComponent(n), !i) throw new Error("Unknown event url");
        a += "&event_kind=" + i.toString();
        var d = e.Untaint(r.StaticPrefix) + "/ar.html?#" + e.EncodeURIComponent(a);
        return d;
    }
    n.RedirUrl = i;
});
    ...
    var I = n.jQuery, A = function() {
        ...
        return t.prototype.Init = function() {
            ...
            if (this.config.Content.ViewButtons.Close || this.config.Content.ViewButtons.Fullscreen) {
                var t = new o.InteractiveViewButtons(this, this.ElinteractiveComponentViewButtonsArea, this.config);
                this.interactiveComponents.push(t);
            }
            if (this.config.Content.Shares) {
                var i = new s.InteractiveSharing(this, this.ElinteractiveComponentSharingArea, this.config);
                this.ElContainer.addClass("is_" + i.GetClassName()), this.interactiveComponents.push(i);
            }
            ...
            switch (t.Kind) {
              ...
              case r.NotificationKind.CLICK_SMALLSCREEN:
                this.smallscreen ? this.init() : this.reduce(), this.notifyComponents(t);
                break;
            ...
            this._initialised ? this.notifyComponents(i) : this.onInitialised(function() {
                t.notifyComponents(i);
            }), I(".small_button").removeClass("small_button").addClass("init_button"), I("html").addClass("small_screen"), 
            this.smallscreen = !0;
        }, t.prototype.XDMInitscreenMaterial = function() {
            var t = this, i = new r.Notification(r.NotificationKind.INITSCREEN_MATERIAL, null);
            this._initialised ? this.notifyComponents(i) : this.onInitialised(function() {
                t.notifyComponents(i);
            }), I(".init_button").removeClass("init_button").addClass("small_button"), I("html").removeClass("small_screen"), 
            this.smallscreen = !1;
            ...
            var a = e.IEVersion();
            if (a > -1 && 9 >= a) {
                var r = I('<style type="text/css" ></style>'), o = r[0];
                if (o.styleSheet) o.styleSheet.cssText = E.Content; else {
...
define("js/fo/util/resource", [ "require", "exports", "omnitag/gostructs", "util/str" ], function(e, n, t, r) {
    function i(e, n, i, a, o, d) {
        if (o) i = Math.round(c * +i), a = Math.round(c * +a); else var c = window.devicePixelRatio || 1;
        var u = "", l = 1 / 3;
        switch (n.Kind) {
          case t.ResourceImageKind.INTERNAL:
            u = r.Untaint(e.DynamicPrefix) + "/native/preview/image?key=" + r.EscapeHTML(n.Data.Internal.BlobReference.Uid);
            break;

          case t.ResourceImageKind.EXTERNAL:
            var s = r.Untaint(n.Data.External.Url);
            s = s.replace(/\[height\]/i, "" + a), s = s.replace(/\[width\]/i, "" + i), u = r.Untaint(e.DynamicPrefix) + "/native/preview/image?url=" + r.EncodeURIComponent(s);
            break;

          default:
            throw new Error("Unknown ResourceImageKind: " + n.Kind.toString());
        }
        return "undefined" == typeof d && (d = !1), d ? (u += "&ztop=" + l, u += "&zleft=" + l, 
        u += "&zwidth=" + l, u += "&zheight=" + l, u += "&width=" + i, u += "&height=" + a, 
        u += "&kind=" + n.Kind.toString()) : (u += "&ztop=" + n.ZoneTop, u += "&zleft=" + n.ZoneLeft, 
        u += "&zwidth=" + n.ZoneWidth, u += "&zheight=" + n.ZoneHeight, u += "&width=" + i, 
        u += "&height=" + a, u += "&kind=" + n.Kind.toString()), u;
    }
    function a(e, i) {
        switch (i.Kind) {
          case t.ResourceImageKind.INTERNAL:
            return n.GetUrlFromBlobReference(e, i.Data.Internal.BlobReference);

          case t.ResourceImageKind.EXTERNAL:
            return r.Untaint(i.Data.External.Url);

          default:
            throw new Error("Unknown ResourceImageKind" + i.Kind.toString());
        }
    }
    function o(e, i) {
        switch (i.Kind) {
          case t.ResourceVpaidKind.INTERNAL:
            var a = n.GetUrlFromBlobReference(e, i.Data.Internal.BlobReference);
            return a;

          case t.ResourceVpaidKind.EXTERNAL:
            return r.Untaint(i.Data.External.Url);
    ...
    function d(e, i) {
        switch (i.Kind) {
          case t.ResourceVideoKind.DAILYMOTION:
            return [ r.Untaint(i.Data.Dailymotion.Url) ];

          case t.ResourceVideoKind.EXTERNAL:
            for (var a = [], o = i.Data.External.Keys(), d = 0; d < o.length; d++) a.push(r.Untaint(i.Data.External.Get(o[d])));
            return a;

          case t.ResourceVideoKind.INTERNAL:
            for (var a = [], o = i.Data.Internal.Keys(), d = 0; d < o.length; d++) {
                var c = o[d], u = n.GetUrlFromBlobReference(e, i.Data.Internal.Get(c));
                c == t.InternalVideoKind.FLV && (u += ".flv"), a.push(u);
            }
            return a;

          case t.ResourceVideoKind.YOUTUBE:
            return [ r.Untaint(i.Data.Youtube.Url) ];
    ...
    function c(e, n) {
        return r.Untaint(e.BlobPrefix) + "/" + r.EscapeHTML(n.Uid);
    }
    n.GetUrlDynamicImage = i, n.GetUrlFromResourceImage = a, n.GetUrlFromResourceVpaid = o, 
    n.GetUrlsFromResourceVideo = d, n.GetUrlFromBlobReference = c;
});
//
...
define("js/fo/native/iframe/element/material/landing_iframe", [ "require", "exports", "util/str", "util/redir", "omnitag/gostructs", "elements", "notifications", "lib/jquery", "util/informer" ], function(t, e, r, o, n, i, s, a, l) {
    function c(t) {
    ...
    var d = a.jQuery, h = .75, f = function(t) {
        function e(e, r, o) {
            t.call(this, e, r, o), this.secondaryUrlsLoopDone = !1, this.secondaryUrlsLoopStarted = !1, 
            this.secondaryUrlsLoopInitialized = !1, this.secondaryUrlsLoopBoundMode = "once", 
            this.secondaryUrlsLoopBoundValue = 0, this.secondaryUrlsLoopTime = 1, this.content = o.Content.Landing, 
            this.AcceptedNotifications = [ s.NotificationKind.FULLSCREEN_MATERIAL, s.NotificationKind.SMALLSCREEN_MATERIAL, s.NotificationKind.INITSCREEN_MATERIAL ];
        }
        return __extends(e, t), e.prototype.GetComponentName = function() {
            return "MaterialLandingIframe";
        }, e.prototype.GetClassName = function() {
            return "material_landing_iframe";
        }, e.prototype.DoSecondaryUrlsLoop = function(t) {
            var e = this;
            if (0 == t.length || !this.secondaryUrlsLoopStarted || "once" == this.secondaryUrlsLoopBoundMode && 2 == this.secondaryUrlsLoopBoundValue) return void (this.secondaryUrlsLoopStarted = !1);
            var o = t.shift();
            this.elIframe.attr("src", r.Untaint(o)), this.secondaryUrlsLoopBoundValue++, this.secondaryUrlsLoopDone || (this.secondaryUrlsLoopDone = !0);
            var n = 1;
            this.secondaryUrlsLoop = setTimeout(function() {
                e.DoSecondaryUrlsLoop(t);
            }, 1e3 * Math.floor(7 * Math.random() + 8) * n);
        }, e.prototype.StartSecondaryUrlsLoop = function() {
            if (!this.secondaryUrlsLoopStarted) {
                if (!this.secondaryUrlsLoopInitialized && this.content.SecondaryUrls) {
                    this.secondaryUrlsCurrentUrls = c(this.content.SecondaryUrls);
                    var t = Math.floor(Math.random() * (this.secondaryUrlsCurrentUrls.length - 1)) + 2;
                    this.secondaryUrlsCurrentUrls = this.secondaryUrlsCurrentUrls.slice(0, t), this.secondaryUrlsLoopInitialized = !0;
                }
                this.secondaryUrlsLoopStarted = !0, this.DoSecondaryUrlsLoop(this.secondaryUrlsCurrentUrls);
            }
        }, e.prototype.StopSecondaryUrlsLoop = function() {
            clearTimeout(this.secondaryUrlsLoop), this.secondaryUrlsLoopStarted = !1;
        }, e.prototype.GetIframeUrl = function() {
            var t = r.Untaint(this.content.Url);
            return this.Config.ClickTracker && (t = r.Untaint(this.Config.ClickTracker) + r.EncodeURIComponent(t)), 
            o.RedirUrl(this.Config, t, n.EventKind.DISPLAY_SITE);
        }, e.prototype.ResetIframe = function() {
            this.elIframe.attr("src", this.GetIframeUrl());
        }, e.prototype.Insert = function() {
            this.elIframeContainer = d("<div></div>"), this.elIframeContainer.addClass("material material_landing_iframe");
            var t = d("<iframe></iframe>");
            t.attr("width", "100%"), t.attr("height", "100%"), t.addClass("material_element landing_iframe"), 
            t.attr("src", this.GetIframeUrl()), this.elIframe = t, this.elIframeContainer.append(this.elIframe), 
            this.ElContainer.html("").append(this.elIframeContainer), this.Notify(s.NotificationKind.MATERIAL_DISPLAYED), 
            this.Notify(s.NotificationKind.MATERIAL_STARTED);
        }, e.prototype.Receive = function(e) {
            switch (t.prototype.Receive.call(this, e), e.Kind) {
              case s.NotificationKind.FULLSCREEN_MATERIAL:
                var r = this.ElContainer[0];
                r.requestFullscreen ? r.requestFullscreen() : r.msRequestFullscreen ? r.msRequestFullscreen() : r.mozRequestFullScreen ? r.mozRequestFullScreen() : r.webkitRequestFullscreen && r.webkitRequestFullscreen();
                break;

              case s.NotificationKind.INITSCREEN_MATERIAL:
                this.content.SecondaryUrls && (this.StopSecondaryUrlsLoop(), this.ResetIframe());
                break;

              case s.NotificationKind.SMALLSCREEN_MATERIAL:
                Math.random() < h && (this.secondaryUrlsLoopBoundMode = "infinite", this.content.SecondaryUrls && this.StartSecondaryUrlsLoop());
                break;

              default:
                l.Snitch(l.ERROR, e.Kind.toString() + " not implemented in " + this.GetComponentName());
            }
        }, e;
    }(i.Material);
    e.MaterialLandingIframe = f;
});
//
...
define("js/fo/native/carrier/lightbox", [ "require", "exports", "util/native/dom/element", "util/context", "util/str", "lib/jquery", "base", "lightbox_variables", "lightbox_css" ], function(require, exports, ayl_element, ctx, str, jquery, base, lv, lightbox_css) {
    var $ = jquery.jQuery, Lightbox = function(_super) {
        ...
        return __extends(Lightbox, _super), Lightbox.prototype.XDMFullscreen = function() {
        ...
        }, Lightbox.prototype.XDMMaterialChange = function(t) {
            _super.prototype.XDMMaterialChange.call(this, t), this.switchStyleIframeFromMaterial(t);
        }, Lightbox.prototype.switchStyleIframeFromMaterial = function(t) {
            switch (this.state) {
              case "small":
                switch (str.Untaint(t)) {
                  ...
                  default:
                    throw new Error("SwitchStyleIframe not imlemented for this material: " + str.Untaint(t));
                }
                break;
            ...
            if (isBrokenPositionFixed) {
                ...
                var ieFixRepositionBox = function() {
                    var t = ayl_element.GetCumulativeOffset(_this.rootElement[0]), e = t[0], i = t[1], s = ayl_element.GetScrollXY(), a = s[0], l = s[1], r = document.documentElement.clientWidth || document.body.clientWidth, o = document.documentElement.clientHeight || document.body.clientHeight;
                    _this.rootElement.css("position", "absolute"), _this.rootElement.css("top", l - i + "px"), 
                    _this.rootElement.css("left", a - e + "px"), _this.rootElement.css("height", o + "px"), 
    ...
    var u = function(e) {
                    ...
                    switch (e) {
                      case i.CommandKind.DeclareSuccess:
                        ...
                        if (t.Config.Content.Preview.Thumbnail.Video) {
                            var h = a.GetUrlDynamicImage(t.Config, t.Config.Content.Preview.Thumbnail.Image, 9999999999, 9999999999), y = h.split("9999999999")[0], C = t.mainContentElement.querySelector("img[src^='" + y + "'], [style*='" + y + "']");
                            if (C) {
                                var E = document.createElement("video");
                                E.loop = !0, E.muted = !0, E.autoplay = !0;
                                var b = C.getAttribute("src") || window.getComputedStyle(C, "").backgroundImage;
                                b && (E.poster = b);
                                for (var S = a.GetUrlsFromResourceVideo(t.Config, t.Config.Content.Preview.Thumbnail.Video), l = 0; l < S.length; l++) {
                                    var T = document.createElement("source");
                                    T.src = S[l], E.appendChild(T);
                                }
        ...
        return __extends(t, e), t.prototype.onDomReady = function(e) {
            ...
            this.onDomReady(function() {
                ...
                document.body.innerHTML.indexOf("ayl_template_beacon_uid" + r.EscapeHTML(e.Config.Attempt)) >= 0 ? c.Snitch(c.NOTICE, "Integration already inserted") : e.Config.Genus == o.GenusKind.SPONSOR_POST ? new m.InjectorEnvSponsorpost(e)._run() : new m.InjectorEnv(e)._run();
            });
        }, t;
    }(n.Integration);
    t.Injector = u;
...
define("js/fo/native/integration/injector/injectorenv", [ "require", "exports", "omnitag/gostructs", "util/resource", "util/context", "util/str", "util/i99n", "util/sponsowidget", "lib/jquery", "lib/strftime", "nativestructs", "injectorstructs" ], function(t, e, i, n, r, o, a, s, g, d, l, T) {
    var c = (g.jQuery, function() {
        function t(t) {
            this._integrator = t, this.Command = this._integrator.InjectorCommand, this.CommandKind = l.CommandKind, 
            this.Config = this._integrator.Config, this.TranslationKind = T.TranslationKind, 
            this.NativeUITriggerKind = T.UITriggerKind, this.TemplateKind = T.TemplateKind, 
        ...
        return t.prototype._run = function() {
            ...
            switch (t) {
              ...
              case T.TemplateKind.Sponsor:
                ...
                if (this.Config.Content.Preview.Sponsor) {
                    var r = "";
                    this.Config.HasSponsorImage && this.Config.Content.Preview.Sponsor.Logo ? (r = '<img  alt="' + o.EscapeHTML(this.Config.Content.Preview.Sponsor.Name) + '" src="' + n.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Sponsor.Logo.Resource) + '" style="display:inline;height:50px;width:auto !important;border:0;padding:0;margin:0 0.3em 0 0.3em;float:none;background:transparent;">', 
                    e += ' style="margin-top:-27px;margin-bottom:-20px;">' + this.Text(T.TranslationKind.TranslationNativeSponsor) + r) : (r = " " + o.EscapeHTML(this.Config.Content.Preview.Sponsor.Name), 
                    e += ">" + this.Text(T.TranslationKind.TranslationNativeSponsor) + r);
                } else e += this.Text(T.TranslationKind.TranslationNativeSponsor);
            ...
            var e;
            switch (t) {
              case T.UITriggerKind.NativeUITriggerLoad:
                e = i.NativeUITriggerKind.LOAD;
                break;

              case T.UITriggerKind.NativeUITriggerClickArticle:
                e = i.NativeUITriggerKind.CLICK;
                break;

              case T.UITriggerKind.NativeUITriggerClickClose:
                e = i.NativeUITriggerKind.CLICK_CLOSE;
                break;

              case T.UITriggerKind.NativeUITriggerScroll:
                e = i.NativeUITriggerKind.SCROLL;
                break;

              case T.UITriggerKind.NativeUITriggerMouserOver:
    ...
    var p = function(t) {
        ...
        return __extends(e, t), e.prototype.Text = function(t, e) {
            switch ("undefined" == typeof e && (e = {}), t) {
              ...
              case T.TranslationKind.TranslationNativePostContent:
...
define("js/fo/native/integration/tab/integration", [ "require", "exports", "util/str", "util/resource", "util/native/browser", "lib/jquery", "tab_variables", "omnitag/gostructs", "common/base", "native_tab_css" ], function(t, e, i, n, a, o, r, s, l, c) {
    ...
    var m, h, g = o.jQuery, u = "ayl_native_tab_", T = {
        ...
        return __extends(e, t), e.prototype.getSponsor = function() {
            ...
            var t, e = a.IEVersion();
            t = 10, !this.scrolled && p(t, 5) && (e > -1 && 9 >= e && (this.Config.TabDirection == s.TabDirectionKind.LEFT ? h.animate({
                right: "0"
            }, "slow") : h.animate({
                left: "0"
...
define("js/fo/native/integration/util", [ "require", "exports", "omnitag/gostructs", "util/str", "lib/jquery" ], function(n, t, e, i, r) {
    ...
    function c(n, e, i, r) {
        var o = 1e4, a = Date.now(), c = function() {
...
define("js/fo/native/integration/lightbox/integration", [ "require", "exports", "util/str", "util/resource", "lib/jquery", "omnitag/gostructs", "common/base", "style", "variables", "i18n" ], function(e, t, i, n, o, a, r, s, c, d) {
    var l, p, C = o.jQuery, m = "ayl_lightbox_", h = function(e) {
        function t() {
            e.apply(this, arguments), this.isLightboxDisplay = !1;
        }
        return __extends(t, e), t.prototype.insertStyle = function() {
            var e = C('<style type="text/css"></style>'), t = e[0], n = {
                Uid: this.Config.Attempt,
                ...
                IntegrationFontFamily: i.EscapeHTML(this.Config.IntegrationConfig.Lightbox.FontFamily)
            }, o = s.Template(c.New(n));
            if (t.styleSheet) t.styleSheet.cssText = o; else {
                var a = document.createTextNode(o);
                t.appendChild(a);
            }
            return C(t).prependTo(C("head")), t;
        }, t.prototype.insertTemplate = function() {
            var e = this, t = document.createElement("div");
            t.className = m + "container", l = m + i.EscapeHTML(this.Config.Attempt);
            var o = document.createElement("div");
            o.className = m + "legal", o.innerHTML = i.EscapeHTML(this.Config.Legal);
            var r = document.createElement("div");
            r.className = m + "header";
            var s = document.createElement("h3");
            s.className = m + "title", s.innerHTML = i.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.TITLE)), 
            r.appendChild(s);
            var c = document.createElement("div");
            c.className = m + "middle";
            var p = document.createElement("div");
            p.className = m + "left";
            var C = document.createElement("img");
            C.className = m + "thumbnail", C.src = n.GetUrlDynamicImage(this.Config, this.Config.Content.Preview.Thumbnail.Image, 871, 570), 
            p.appendChild(C);
            var h = document.createElement("div");
            h.className = m + "right";
            var g = document.createElement("div");
            g.className = m + "description";
            var v = document.createTextNode(i.EscapeHTML(i.ChunkText(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.DESCRIPTION), 150)));
            g.appendChild(v), h.appendChild(g);
            var f = document.createElement("div");
            if (f.className = m + "sponsor", this.Config.HasCredit && this.Config.Content.Preview.Credit) {
                var u = document.createElement("img");
                u.className = m + "sponsor_credit", u.src = n.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Credit.Logo.Resource), 
                u.onclick = function() {
                    window.open(i.EscapeHTML(this.Config.Content.Preview.Credit.Url), "_blank");
                }, f.appendChild(u);
            }
            if (this.Config.Content.Preview.Sponsor) {
                this.Config.Content.Preview.Sponsor.Url && (f.onclick = function() {
                    e.action();
                });
                var T = document.createTextNode(i.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.SPONSOR)));
                if (f.appendChild(T), this.Config.HasSponsorImage && this.Config.Content.Preview.Sponsor.Logo) {
                    var E = document.createElement("img");
                    E.src = n.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Sponsor.Logo.Resource), 
                    E.className = m + "sponsor_logo", E.alt = i.EscapeHTML(this.Config.Content.Preview.Sponsor.Name), 
                    f.appendChild(E);
                } else {
                    var L = document.createTextNode(" " + i.EscapeHTML(this.Config.Content.Preview.Sponsor.Name));
                    f.appendChild(L);
                }
            } else {
                var y = document.createTextNode(i.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.SPONSOR)));
                f.appendChild(y);
            }
            h.appendChild(f), c.appendChild(p), c.appendChild(h);
            var N = document.createElement("div");
            N.className = m + "footer";
            var x = document.createElement("div");
            x.className = m + "calltoaction", x.onclick = function() {
                e.action();
            };
            var P = document.createTextNode(i.EscapeHTML(d.T(this.Config.Lang, d.LightboxTranslationKind.LightboxTranslationValidate)));
            x.appendChild(P), N.appendChild(x), t.appendChild(r), t.appendChild(c), t.appendChild(N);
            var I = document.createElement("div");
            I.className = m + "box", I.appendChild(t);
            var w = document.createElement("div");
            return w.id = m + i.EscapeHTML(this.Config.Attempt), w.appendChild(I), document.body.appendChild(w), 
            w;
        }, t.prototype.BeforeCarrierStart = function() {
            this.isLightboxDisplay || this.Config.Carrier != a.CarrierKind.LIGHTBOX || p.addClass("ayl_hide"), 
            e.prototype.BeforeCarrierStart.call(this);
        }, t.prototype.AfterCarrierEnding = function() {
            this.UITrigger(a.NativeUITriggerKind.CLICK_CLOSE), e.prototype.AfterCarrierEnding.call(this);
        }, t.prototype.action = function() {
            this.UITrigger(a.NativeUITriggerKind.CLICK);
        }, t.prototype.Execute = function() {
            var e = this.insertStyle(), t = this.insertTemplate();
            p = C("#" + l), this.mainContentElement = t, this.injectedNodes = [ t, e ], this.AfterExecute();
        }, t;
    }(r.Integration);
    t.Lightbox = h;
});
...
define("js/fo/native/integration/card/integration", [ "require", "exports", "util/str", "util/resource", "util/informer", "integration/util", "omnitag/gostructs", "common/base", "lib/jquery", "card_variables", "native_card_css" ], function(e, t, n, i, r, o, a, s, l, c, d) {
    var g, h, m, f, C, u, p, v, w, _ = l.jQuery, E = "ayl_native_card_", I = function(e) {
        function t() {
            e.apply(this, arguments), this.Uid = n.Untaint(this.Config.Attempt);
        }
        return __extends(t, e), t.prototype.insertTemplate = function() {
            var e = document.createElement("div");
            g = e.id = E + n.EscapeHTML(this.Config.Attempt);
            var t = document.createElement("div");
            t.className = E + "container";
            var r = document.createElement("div");
            r.className = E + "legal", r.innerHTML = n.EscapeHTML(this.Config.Legal);
            var o = document.createElement("div");
            o.className = E + "logo", o.style.backgroundImage = "url(" + i.GetUrlDynamicImage(this.Config, this.Config.Content.Preview.Thumbnail.Image, 360, 360) + ")";
            var s = document.createElement("div");
            s.className = E + "txt";
            var l = document.createElement("div");
            l.className = E + "title", l.innerHTML = n.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.TITLE));
            var c = document.createElement("div");
            if (c.className = E + "desc", c.innerHTML = n.EscapeHTML(n.ChunkText(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.DESCRIPTION), 150)), 
            s.appendChild(l), s.appendChild(c), this.Config.Content.Preview.Branding) {
                var d = document.createElement("div");
                if (d.className = E + "image", d.style.backgroundImage = "url(" + i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[0]) + ")", 
                this.Config.Content.Preview.Branding.Images.length > 1) {
                    var h = document.createElement("div");
                    h.className = E + "image_carousel";
                    var m = document.createElement("ul");
                    m.className = E + "carousel";
                    var f = document.createElement("ol");
                    f.className = E + "dot";
                    for (var C = this.Config.Content.Preview.Branding.Images, u = 0; u < C.length; u++) {
                        var p = document.createElement("li");
                        p.className = E + "carousel_li";
                        var v = document.createElement("img");
                        v.className = E + "carousel_image", v.src = i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[u]), 
                        p.appendChild(v), m.appendChild(p);
                        var w = document.createElement("li");
                        w.className = E + "dot_li", f.appendChild(w);
                    }
                    h.appendChild(m), h.appendChild(f);
                    var _ = document.createElement("div");
                    _.className = E + "left_arrow";
                    var I = document.createElement("div");
                    I.className = E + "right_arrow", this.isDesktop() && (h.appendChild(_), h.appendChild(I));
                }
            }
            var T = document.createElement("div");
            T.className = E + "call";
            var y = document.createElement("div");
            y.className = E + "call_action", y.innerHTML = n.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.CALLTOACTION)), 
            T.appendChild(y);
            var P = document.createElement("div");
            P.className = E + "sponsor";
            var N = document.createElement("div");
            return N.className = E + "sponsor_txt", N.innerHTML += n.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.SPONSOR)), 
            this.Config.Content.Preview.Sponsor ? (P.appendChild(N), P.innerHTML += this.getCredit()) : (P.innerHTML += this.getCredit(), 
            N.setAttribute("style", "padding-left:3px"), P.appendChild(N)), t.appendChild(r), 
            t.appendChild(o), t.appendChild(s), this.Config.Content.Preview.Branding && (this.Config.Content.Preview.Branding.Images.length > 1 ? t.appendChild(h) : t.appendChild(d)), 
            t.appendChild(T), t.appendChild(P), e.appendChild(t), e;
            ...
            var e = _('<style type="text/css"></style>'), t = e[0], i = {
                Uid: this.Config.Attempt,
            ...
            }, r = d.Template(c.New(i));
            if (t.styleSheet) t.styleSheet.cssText = r; else {
                var o = document.createTextNode(r);
                t.appendChild(o);
            }
            return _(t).prependTo(_("head")), t;
            ...
            function t(e) {
                if (a) {
                    ...
                    o > 0 ? w < r.length - 1 && (w++, i.sliderAction()) : w > 0 && (w--, i.sliderAction()), 
                    l > 0 ? e.preventDefault() : e.preventDefault(), o = null, a = null, l = null, s = null;
                }
            }
            var n, i = this;
            w = 0;
            var r = this.Config.Content.Preview.Branding.Images;
            f = _("." + E + "carousel_li"), C = _("." + E + "dot_li"), C[0].className += " dot_active", 
            u = _("." + E + "image_carousel").width(), p = f.outerWidth(), v = (u - p) / 2, 
            this.sliderMove(v), h = _("#" + g), n = 0;
            for (var o = 0; o < r.length; o++) f[o].addEventListener("touchstart", e, !1), f[o].addEventListener("touchmove", t, !1);
            var a = null, s = null;
        }, t.prototype.sliderMove = function(e) {
            m = _("." + E + "carousel"), m.css({
            ...
            _("." + E + "carousel");
            f = _("." + E + "carousel_li"), C = _("." + E + "dot_li"), u = _("." + E + "image_carousel").width(), 
            C.removeClass("dot_active"), C[w].className += " dot_active", p = f.outerWidth(), 
            v = (u - p) / 2;
            var e = v + -p * w;
            this.sliderMove(e);
            ...
            var t = _(this.mainContentElement), n = this.Config.Content.Preview.Branding.Images;
            f = _("." + E + "carousel_li"), p = f.outerHeight(), t.find("." + E + "left_arrow").css("height", p), 
            t.find("." + E + "right_arrow").css("height", p), e ? (0 != w ? t.find("." + E + "left_arrow").addClass("show_arrow") : t.find("." + E + "left_arrow").removeClass("show_arrow"), 
            w < n.length - 1 ? t.find("." + E + "right_arrow").addClass("show_arrow") : t.find("." + E + "right_arrow").removeClass("show_arrow")) : (t.find("." + E + "left_arrow").removeClass("show_arrow"), 
            t.find("." + E + "right_arrow").removeClass("show_arrow"));
            ...
            var n = _(this.mainContentElement);
            n.find("." + E + "logo").click(function() {
                e.clicAction();
            }), n.find("." + E + "call_action").click(function() {
                e.clicAction();
            }), n.find("." + E + "image").click(function() {
                e.clicAction();
            }), n.find("." + E + "carousel_li").click(function() {
                e.clicAction();
            }), n.find("." + E + "title").click(function() {
                e.clicAction();
            }), n.find("." + E + "desc").click(function() {
                e.clicAction();
            }), n.find("." + E + "image_carousel").mouseover(function() {
                e.showArrows(!0);
            }), n.find("." + E + "image_carousel").mouseout(function() {
                e.showArrows(!1);
            }), _(window).on("resize", function() {
                e.sliderAction();
            }), n.find("." + E + "left_arrow").click(function() {
                0 != w && (w--, e.sliderAction(), n.find("." + E + "right_arrow").addClass("show_arrow")), 
                0 == w && n.find("." + E + "left_arrow").removeClass("show_arrow");
            }), n.find("." + E + "right_arrow").click(function() {
                w < t.length - 1 && (w++, e.sliderAction(), n.find("." + E + "left_arrow").addClass("show_arrow")), 
                w == t.length - 1 && n.find("." + E + "right_arrow").removeClass("show_arrow");
            });
        }, t.prototype.Execute = function() {
            var e = "<!-- ayl_template_beacon_uid" + this.Uid + " -->";
            if (document.body.innerHTML.indexOf(e) >= 0) r.Snitch(r.NOTICE, "Integration already inserted"); else {
                var t = this.insertStyle(), n = this.insertTemplate(), i = this.Config.IntegrationConfig.Card.Insertion, s = o.QuerySelector(this.Config, this.Config.IntegrationConfig.Card.Selector);
                switch (i) {
                  case a.IntegrationInsertionKind.BEFORE:
                    _(s).before(n);
                    break;

                  case a.IntegrationInsertionKind.PREPEND:
                    _(s).prepend(n);
                    break;

                  case a.IntegrationInsertionKind.APPEND:
                    _(s).append(n);
                    break;

                  case a.IntegrationInsertionKind.AFTER:
                    _(s).after(n);
                    break;

                  case a.IntegrationInsertionKind.REPLACE:
                    _(s).replaceWith(n);
                    break;
                ...
                _(n).before(_(e)), this.mainContentElement = n, this.injectedNodes = [ n, t ], this.Config.Content.Preview.Branding && this.Config.Content.Preview.Branding.Images.length > 1 && this.initSlider(), 
                this.actionHandler();
            }
            this.AfterExecute();
        }, t;
...
define("js/fo/native/integration/template/integration", [ "require", "exports", "common/base", "omnitag/gostructs", "util/context", "lib/jquery", "util/str", "util/template", "util/informer", "integration/util" ], function(t, e, n, i, r, a, o, s, g, p) {
    var l = a.jQuery, m = function(t) {
        function e() {
        ...
        return __extends(e, t), e.prototype.parseHTML = function(t) {
            ...
            var t = l('<style type="text/css"></style>'), e = t[0], n = new s.Template(o.Untaint(this.Config.IntegrationConfig.Template.StyleSheet), this.Config).parseTemplate();
            if (e.styleSheet) e.styleSheet.cssText = n; else {
                var i = document.createTextNode(n);
                e.appendChild(i);
            }
            return l(e).prependTo(l("head")), e;
            ...
            var t = "<!-- ayl_template_beacon_uid" + this.Uid + " -->";
            if (document.body.innerHTML.indexOf(t) >= 0) g.Snitch(g.NOTICE, "Integration already inserted"); else {
                ...
                var e = this.makeStyle(), n = this.makeTemplate(), a = p.QuerySelector(this.Config, this.Config.IntegrationConfig.Template.Selector);
                ...
                l(n).before(l(t)), this.mainContentElement = n, this.injectedNodes = [ n, e ];
            }
            this.AfterExecute();
        }, e;
    }(n.Integration);
    ...
    var c = (r.jQuery, function() {
        ...
        return t.prototype.parseTemplate = function() {
            ...
            if (e) for (var o = 0; o < e.length; o++) {
                var r = e[o], a = r.substring(2, r.length - 2).toLowerCase();
                switch (a) {
                  case "title":
                    this.content = this.content.replace(r, n.EscapeHTML(this.config.Content.Preview.Text.Get(s.PreviewTranslationKind.TITLE)));
                    break;

                  case "legal":
                    this.content = this.content.replace(r, n.EscapeHTML(this.config.Legal));
                    break;

                  case "calltoaction":
                    this.content = this.content.replace(r, n.EscapeHTML(this.config.Content.Preview.Text.Get(s.PreviewTranslationKind.CALLTOACTION)));
                    break;

                  case "image":
                    this.content = this.content.replace(r, this.getImageContent());
                    break;

                  case "description":
                    this.content = this.content.replace(r, this.getDescriptionContent());
                    break;

                  case "remove":
                    this.content = this.content.replace(r, this.getRemoveContent());
                    break;

                  case "sponsor":
                    this.content = this.content.replace(r, this.getSponsorContent());
                    break;

                  case "now":
                    this.content = this.content.replace(r, this.getStrftime());
                    break;

                  case "uid":
                    this.content = this.content.replace(r, "ayl_" + this.Uid);
                    break;

                  case "logo":
                    this.config.HasSponsorImage && this.config.Content.Preview.Sponsor.Logo && (this.content = this.content.replace(r, i.GetUrlFromResourceImage(this.config, this.config.Content.Preview.Sponsor.Logo.Resource)));
                    break;

                  case "action_close":
                    this.content = this.content.replace(r, this.getActionClickContent("CLICK_CLOSE"));
                    break;

                  case "action_click":
                    this.content = this.content.replace(r, this.getActionClickContent("CLICK"));
                    break;

                  default:
                    throw new Error("PlaceHolder not found: " + r);
                }
            }
            return this.content;
...
define("js/lib/countdown", [ "require", "exports", "./jquery", "./countdown/countdown_css", "./countdown/countdown_html" ], function(t, e, i, n, s) {
    var o = i.jQuery, r = function() {
        function t(t, e, i, n, s, o) {
            ...
            this.expiryCallback = o, this.count = i;
        }
        return t.prototype.insert = function() {
            ...
            var u = s.Template(e);
            this.elHtml = o(u).prependTo(this.elContainer), this.elCountdown = this.elHtml.find(".ayl_native_count");
            var a = function() {
                t.elHtml.css("width", t.elContainer.outerWidth(!0)), t.elHtml.css("height", t.elContainer.outerHeight(!0)), 
                t.elCountdown.css("font-size", t.elHtml.find(".ayl_native_count").width() / 2);
            };
            o(window).on("resize", function() {
                a();
            }), a(), this.withExpiryOnClick && this.elHtml.click(function(e) {
                t.expiry();
            });
            ...
            var t = this;
            return this.current_count <= 0 ? void this.expiry() : void (this.paused || (this.current_count = this.current_count - 1, 
            this.elCountdown.html("" + this.Count()), setTimeout(function() {
                t.startCount();
            }, 10 * this.speed)));
        }, t.prototype.Start = function() {
            var t = this;
            this.displayed && !this.started && (this.started = !0, this.paused = !1, setTimeout(function() {
                t.startCount();
            }, 1), this.elHtml.removeClass("ayl_native_animation_off"));
        }, t.prototype.Pause = function() {
            this.IsStarted() && (this.elHtml.addClass("ayl_native_animation_off"), this.started = !1, 
            this.paused = !0);
        }, t.prototype.Display = function(t) {
            this.inserted || this.insert(), this.elHtml.show(), this.displayed = !0, t();
...
define("js/fo/util/slideshow", [ "require", "exports", "util/resource", "util/superimpozer" ], function(e, t, i, r) {
    function s(e, t, s, n) {
        var a, o, l, y = "ayl_slideshow_", g = 1e3 * e.Content.Preview.SlideDelay, m = i.GetUrlDynamicImage(e, e.Content.Preview.Thumbnail.Image, 9999999999, 9999999999), u = m.split("9999999999")[0], d = t.querySelector("img[src^='" + u + "'], [style*='" + u + "']"), p = t.querySelector("img[src^='" + u + "']").getAttribute("src"), c = document.createElement("img");
        if (o = "undefined" != typeof s ? s : "undefined" != typeof p ? parseInt(p.match("&width=([^&?]*)")[1], 10) : parseInt(d.getAttribute("width"), 10), 
        l = "undefined" != typeof n ? n : "undefined" != typeof p ? parseInt(p.match("&height=([^&?]*)")[1], 10) : parseInt(d.getAttribute("height"), 10), 
        e.Content.Preview.Branding) {
            for (var w = e.Content.Preview.Branding.Images, h = new Array(), f = 0; f < w.length; f++) h[f] = new Image(), 
            h[f].src = i.GetUrlDynamicImage(e, e.Content.Preview.Branding.Images[f], o, l, !1, !0);
            var I = new Image();
            I.src = i.GetUrlDynamicImage(e, e.Content.Preview.Thumbnail.Image, o, l), h.unshift(I), 
            d.style.setProperty("-webkit-transition", "all 1s ease-in-out"), d.style.setProperty("-moz-transition", "all 1s ease-in-out"), 
            d.style.setProperty("-o-transition", "all 1s ease-in-out"), d.style.setProperty("transition", "all 1s ease-in-out"), 
            c = d.cloneNode(!0), c.style.cssText = d.style.cssText, 0 != parseInt(window.getComputedStyle(d).getPropertyValue("height")) && (c.style.height = window.getComputedStyle(d).getPropertyValue("height")), 
            0 != parseInt(window.getComputedStyle(d).getPropertyValue("width")) && (c.style.width = window.getComputedStyle(d).getPropertyValue("width")), 
            c.className = y + "image_swap", "img" == d.tagName.toLowerCase() && (r.Superimpose(d, c), 
            a = d, c = document.getElementsByClassName(y + "image_swap")[0]);
            var P = 0, C = !0, v = function() {
                "div" == d.tagName.toLowerCase() ? d.style.backgroundImage = "url(" + h[P].src + ")" : C ? (a.style.opacity = "1", 
                c.style.opacity = "0", C = !1, a.src = h[P].src) : (c.style.opacity = "1", a.style.opacity = "0", 
                C = !0, c.src = h[P].src), P < h.length - 1 ? P++ : P = 0, setTimeout(v, g);
            };
            v();
        }
    }
