(function(){var g,aa=aa||{},m=this;function q(a){return void 0!==a}
function r(a,b,c){a=a.split(".");c=c||m;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&q(b)?c[d]=b:c[d]?c=c[d]:c=c[d]={}}
...
function Fa(a,b){for(var c=0,d=qa(String(a)).split("."),e=qa(String(b)).split("."),f=Math.max(d.length,e.length),h=0;0==c&&h<f;h++){var k=d[h]||"",l=e[h]||"",n=RegExp("(\\d*)(\\D*)","g"),p=RegExp("(\\d*)(\\D*)","g");do{var M=n.exec(k)||["","",""],G=p.exec(l)||["","",""];if(0==M[0].length&&0==G[0].length)break;c=Ga(0==M[1].length?0:parseInt(M[1],10),0==G[1].length?0:parseInt(G[1],10))||Ga(0==M[2].length,0==G[2].length)||Ga(M[2],G[2])}while(0==c)}return c}
...
function F(a,b){return a?a.dataset?a.dataset[ac(b)]:a.getAttribute("data-"+b):null}
...
if("undefined"!==typeof a&&!D("Trident")&&!D("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(q(c.next)){c=c.next;var a=c.wc;c.wc=null;a()}};
...
!ga(m.setImmediate)||m.Window&&m.Window.prototype&&!D("Edge")&&m.Window.prototype.setImmediate==m.setImmediate?(fc||(fc=gc()),fc(a)):m.setImmediate(a)}}
...
function sc(a,b){a.Ha?b.call(void 0):(a.U||(a.U=[]),a.U.push(q(void 0)?v(b,void 0):b))}
rc.prototype.L=function(){if(this.U)for(;this.U.length;)this.U.shift()()};
function tc(a){a&&"function"==typeof a.dispose&&a.dispose()}
;function H(a){rc.call(this);this.A=1;this.j=[];this.l=0;this.f=[];this.oa={};this.B=Boolean(a)}
y(H,rc);g=H.prototype;g.subscribe=function(a,b,c){var d=this.oa[a];d||(d=this.oa[a]=[]);var e=this.A;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.A=e+3;d.push(e);return e};
...
g.va=function(a){var b=this.f[a];if(b){var c=this.oa[b];0!=this.l?(this.j.push(a),this.f[a+1]=ba):(c&&Za(c,a),delete this.f[a],delete this.f[a+1],delete this.f[a+2])}return!!b};
...
g.clear=function(a){if(a){var b=this.oa[a];b&&(z(b,this.va,this),delete this.oa[a])}else this.f.length=0,this.oa={}};
g.Y=function(a){if(a){var b=this.oa[a];return b?b.length:0}a=0;for(b in this.oa)a+=this.Y(b);return a};
g.L=function(){H.J.L.call(this);this.clear();this.j.length=0};var vc=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};r("yt.config_",vc,void 0);r("yt.tokens_",window.yt&&window.yt.tokens_||{},void 0);var wc=window.yt&&window.yt.msgs_||t("window.ytcfg.msgs")||{};r("yt.msgs_",wc,void 0);function xc(a){var b=arguments;if(1<b.length){var c=b[0];vc[c]=b[1]}else for(c in b=b[0],b)vc[c]=b[c]}
function J(a,b){return a in vc?vc[a]:b}
function K(a,b){ga(a)&&(a=yc(a));return window.setTimeout(a,b)}
function zc(a,b){ga(a)&&(a=yc(a));window.setInterval(a,b)}
...
function Ac(a,b){var c=t("yt.logging.errors.log");c?c(a,b):(c=J("ERRORS",[]),c.push([a,b]),xc("ERRORS",c))}
function Bc(a,b,c){var d=b||{};if(a=a in wc?wc[a]:c)for(var e in d)a=a.replace(new RegExp("\\$"+e,"gi"),function(){return d[e]});
return a}
function Cc(a){var b="MASTHEAD_NOTIFICATIONS_LABEL"in wc?wc.MASTHEAD_NOTIFICATIONS_LABEL:{},c=J("I18N_PLURAL_RULES")||function(a){return 1==a?"one":"other"};
return(b=b["case"+a]||b[c(a)])?b.replace("#",a.toString()):a+""}
var Dc="Microsoft Internet Explorer"==navigator.appName;var Ec=t("yt.pubsub.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.va;H.prototype.publish=H.prototype.G;H.prototype.clear=H.prototype.clear;r("yt.pubsub.instance_",Ec,void 0);var Fc=t("yt.pubsub.subscribedKeys_")||{};r("yt.pubsub.subscribedKeys_",Fc,void 0);var Gc=t("yt.pubsub.topicToKeys_")||{};r("yt.pubsub.topicToKeys_",Gc,void 0);var Hc=t("yt.pubsub.isSynchronous_")||{};r("yt.pubsub.isSynchronous_",Hc,void 0);
var Ic=t("yt.pubsub.skipSubId_")||null;r("yt.pubsub.skipSubId_",Ic,void 0);function O(a,b,c){var d=Jc();if(d){var e=d.subscribe(a,function(){if(!Ic||Ic!=e){var d=arguments,h=function(){Fc[e]&&b.apply(c||window,d)};
try{Hc[a]?h():K(h,0)}catch(k){Ac(k)}}},c);
Fc[e]=!0;Gc[a]||(Gc[a]=[]);Gc[a].push(e);return e}return 0}
function Kc(a){var b=Jc();b&&("number"==typeof a?a=[a]:"string"==typeof a&&(a=[parseInt(a,10)]),z(a,function(a){b.unsubscribeByKey(a);delete Fc[a]}))}
...
function Mc(a){Gc[a]&&(a=Gc[a],z(a,function(a){Fc[a]&&delete Fc[a]}),a.length=0)}
function Nc(a){var b=Jc();if(b)if(b.clear(a),a)Mc(a);else for(var c in Gc)Mc(c)}
function Jc(){return t("yt.pubsub.instance_")}
...
function Rc(a,b){var c=Sc(a),d=document.getElementById(c),e=d&&F(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=O(c,b),h=""+ia(b);Tc[h]=e}f||(d=Uc(a,c,function(){F(d,"loaded")||($b(d,"loaded","true"),P(c),K(w(Nc,c),0))}))}}
...
function Zc(a,b,c){if(a=J(a,void 0)){var d=w(Wc,a,b);if(c)var e=O(c,function(){Kc(e);d()});
else d()}}
function Yc(a,b){var c=$c(a),d=document.getElementById(c),e=d&&F(d,"loaded"),f=d&&!e;if(e)return b&&b(),d;b&&(O(c,b),ia(b));return f?d:d=ad(a,c,function(){F(d,"loaded")||($b(d,"loaded","true"),P(c),K(w(Nc,c),0))})}
...
var Xc=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function bd(a,b){this.x=q(a)?a:0;this.y=q(b)?b:0}
...
g.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var ed=Mb(),Q=D("Trident")||D("MSIE"),fd=D("Edge"),gd=fd||Q,hd=D("Gecko")&&!(-1!=Jb.toLowerCase().indexOf("webkit")&&!D("Edge"))&&!(D("Trident")||D("MSIE"))&&!D("Edge"),id=-1!=Jb.toLowerCase().indexOf("webkit")&&!D("Edge"),jd=D("Macintosh"),kd=D("Windows");function ld(){var a=Jb;if(hd)return/rv\:([^\);]+)(\)|;)/.exec(a);if(fd)return/Edge\/([\d\.]+)/.exec(a);if(Q)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(id)return/WebKit\/(\S+)/.exec(a)}
...
function Jd(a,b,c){var d=arguments,e=document,f=d[0],h=d[1];if(!sd&&h&&(h.name||h.type)){f=["<",f];h.name&&f.push(' name="',sa(h.name),'"');if(h.type){f.push(' type="',sa(h.type),'"');var k={};Ib(k,h);delete k.type;h=k}f.push(">");f=f.join("")}f=e.createElement(f);h&&(u(h)?f.className=h:ea(h)?f.className=h.join(" "):Cd(f,h));2<d.length&&Kd(e,f,d);return f}
function Kd(a,b,c){function d(c){c&&b.appendChild(u(c)?a.createTextNode(c):c)}
for(var e=2;e<c.length;e++){var f=c[e];!fa(f)||ha(f)&&0<f.nodeType?d(f):z(Ld(f)?cb(f):f,d)}}
...
function Sd(a){return q(a.firstElementChild)?a.firstElementChild:Td(a.firstChild,!0)}
...
function Wd(){var a=Xd,b;if(vd&&!(Q&&pd("9")&&!pd("10")&&m.SVGElement&&a instanceof m.SVGElement)&&(b=a.parentElement))return b;b=a.parentNode;return ha(b)&&1==b.nodeType?b:null}
...
function Ld(a){if(a&&"number"==typeof a.length){if(ha(a))return"function"==typeof a.item||"string"==typeof a.item;if(ga(a))return"function"==typeof a.item}return!1}
...
he[" "]=ba;function ie(a,b){try{return he(a[b]),!0}catch(c){}return!1}
...
function we(a){var b=a.offsetWidth,c=a.offsetHeight,d=id&&!b&&!c;return q(b)&&!d||!a.getBoundingClientRect?new dd(b,c):(a=oe(a),new dd(a.right-a.left,a.bottom-a.top))}
...
var Me=t("yt.dom.getNextId_");if(!Me){Me=function(){return++Ne};
r("yt.dom.getNextId_",Me,void 0);var Ne=0}function Oe(a){var b=a.cloneNode(!1);"TR"==b.tagName||"SELECT"==b.tagName?z(a.childNodes,function(a){b.appendChild(Oe(a))}):b.innerHTML=a.innerHTML;
return b}
...
function Te(){pb(document.body,"hide-players",!1);var a=Ad("preserve-players");z(a,function(a){C(a,"preserve-players")})}
...
var Ve={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};var Cb=t("yt.events.listeners_")||{};r("yt.events.listeners_",Cb,void 0);var We=t("yt.events.counter_")||{count:0};r("yt.events.counter_",We,void 0);function Xe(a,b,c,d){return Bb(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
...
function $e(a,b,c,d){return af(a,b,c,function(a){return A(a,d)})}
...
function Ze(a){a&&("string"==typeof a&&(a=[a]),z(a,function(a){if(a in Cb){var c=Cb[a],d=c[0],e=c[1],f=c[3],c=c[4];d.removeEventListener?d.removeEventListener(e,f,c):d.detachEvent&&d.detachEvent("on"+e,f);delete Cb[a]}}))}
...
function ef(){var a=R(F(df,"target-id"));a.setAttribute("tabindex","0");a.focus();a=re(R("page-container")).y;window.scrollBy(0,-a)}
...
function nf(a,b,c){if(ea(b))for(var d=0;d<b.length;d++)nf(a,String(b[d]),c);else null!=b&&c.push("&",a,""===b?"":"=",encodeURIComponent(String(b)))}
...
var sf=/\s*;\s*/;function tf(a,b,c,d,e,f){if(/[;=\s]/.test(b))throw Error('Invalid cookie name "'+b+'"');if(/[;\r\n]/.test(c))throw Error('Invalid cookie value "'+c+'"');q(d)||(d=-1);f=f?";domain="+f:"";e=e?";path="+e:"";d=0>d?"":0==d?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(x()+1E3*d)).toUTCString();a.f.cookie=b+"="+c+f+e+d+""}
...
g.remove=function(a,b,c){var d=q(this.get(a));tf(this,a,"",0,b,c);return d};
...
function Af(a){if(a instanceof zf)return a;if("function"==typeof a.za)return a.za(!1);if(fa(a)){var b=0,c=new zf;c.next=function(){for(;;){if(b>=a.length)throw yf;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function Bf(a,b,c){if(fa(a))try{z(a,b,c)}catch(d){if(d!==yf)throw d;}else{a=Af(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==yf)throw d;}}}
function Cf(a){if(fa(a))return cb(a);a=Af(a);var b=[];Bf(a,function(a){b.push(a)});
return b}
...
;function If(a){return a.Y&&"function"==typeof a.Y?a.Y():fa(a)||u(a)?a.length:vb(a)}
function Jf(a){if(a.Z&&"function"==typeof a.Z)return a.Z();if(u(a))return a.split("");if(fa(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return yb(a)}
function Kf(a){if(a.xa&&"function"==typeof a.xa)return a.xa();if(!a.Z||"function"!=typeof a.Z){if(fa(a)||u(a)){var b=[];a=a.length;for(var c=0;c<a;c++)b.push(c);return b}return zb(a)}}
function Lf(a,b){if(a.forEach&&"function"==typeof a.forEach)a.forEach(b,void 0);else if(fa(a)||u(a))z(a,b,void 0);else for(var c=Kf(a),d=Jf(a),e=d.length,f=0;f<e;f++)b.call(void 0,d[f],c&&c[f],a)}
function Mf(a,b){if("function"==typeof a.every)return a.every(b,void 0);if(fa(a)||u(a))return Ra(a,b,void 0);for(var c=Kf(a),d=Jf(a),e=d.length,f=0;f<e;f++)if(!b.call(void 0,d[f],c&&c[f],a))return!1;return!0}
;function Nf(a,b){this.j=this.F=this.A="";this.D=null;this.B=this.f="";this.C=!1;var c;a instanceof Nf?(this.C=q(b)?b:a.C,Of(this,a.A),this.F=a.F,Pf(this,a.j),Qf(this,a.D),this.f=a.f,Rf(this,a.l.clone()),this.B=a.B):a&&(c=String(a).match(gf))?(this.C=!!b,Of(this,c[1]||"",!0),this.F=Sf(c[2]||""),Pf(this,c[3]||"",!0),Qf(this,c[4]),this.f=Sf(c[5]||"",!0),Rf(this,c[6]||"",!0),this.B=Sf(c[7]||"")):(this.C=!!b,this.l=new Tf(null,0,this.C))}
...
function eg(a,b,c){ea(c)||(c=[String(c)]);fg(a.l,b,c)}
function gg(a){ag(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^x()).toString(36));return a}
...
a.A=b}
;var kg={},lg=0,mg=t("yt.net.ping.workerUrl_")||null;r("yt.net.ping.workerUrl_",mg,void 0);function ng(a){try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||a&&og(a,void 0)}catch(b){a&&og(a,void 0)}}
function og(a,b){var c=new Image,d=""+lg++;kg[d]=c;c.onload=c.onerror=function(){b&&kg[d]&&b();delete kg[d]};
c.src=a}
;function pg(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=ra(e[0]||""),e=ra(e[1]||"");f in b?ea(b[f])?db(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function wg(a){return(a=R(a))?!("none"==a.style.display||A(a,"hid")):!1}
function xg(a){if(a=R(a))wg(a)?(ye(a,!1),B(a,"hid")):(ye(a,!0),C(a,"hid"))}
function yg(a){z(arguments,function(a){!fa(a)||a instanceof Element?vg(a,!0):z(a,function(a){yg(a)})})}
function zg(a){z(arguments,function(a){!fa(a)||a instanceof Element?vg(a,!1):z(a,function(a){zg(a)})})}
function Ag(a){z(arguments,function(a){fa(a)?z(a,function(a){Ag(a)}):xg(a)})}
;function Bg(a,b,c,d,e,f,h){var k,l;if(k=c.offsetParent){var n="HTML"==k.tagName||"BODY"==k.tagName;n&&"static"==ne(k,"position")||(l=re(k),n||(n=(n=ze(k))&&hd?-k.scrollLeft:!n||gd&&pd("8")||"visible"==ne(k,"overflowX")?k.scrollLeft:k.scrollWidth-k.clientWidth-k.scrollLeft,l=cd(l,new bd(n,k.scrollTop))))}k=l||new bd;l=xe(a);if(n=qe(a)){var p=new ge(n.left,n.top,n.right-n.left,n.bottom-n.top),n=Math.max(l.left,p.left),M=Math.min(l.left+l.width,p.left+p.width);if(n<=M){var G=Math.max(l.top,p.top),p=
Math.min(l.top+l.height,p.top+p.height);G<=p&&(l.left=n,l.top=G,l.width=M-n,l.height=p-G)}}n=wd(a);G=wd(c);if(n.f!=G.f){M=n.f.body;var G=Id(G.f),p=new bd(0,0),L;L=(L=yd(M))?Id(L):window;if(ie(L,"parent")){var I=M;do{var gb=L==G?re(I):se(I);p.x+=gb.x;p.y+=gb.y}while(L&&L!=G&&L!=L.parent&&(I=L.frameElement)&&(L=L.parent))}M=cd(p,re(M));!Q||9<=rd||ee(n)||(M=cd(M,Gd(n.f)));l.left+=M.x;l.top+=M.y}a=Cg(a,b);b=new bd(a&2?l.left+l.width:l.left,a&1?l.top+l.height:l.top);b=cd(b,k);e&&(b.x+=(a&2?-1:1)*e.x,b.y+=
(a&1?-1:1)*e.y);var E;h&&(E=qe(c))&&(E.top-=k.y,E.right-=k.x,E.bottom-=k.y,E.left-=k.x);e=E;E=b.clone();b=Cg(c,d);d=ve(c);a=d.clone();E=E.clone();a=a.clone();k=0;if(f||0!=b)b&2?E.x-=a.width+(f?f.right:0):f&&(E.x+=f.left),b&1?E.y-=a.height+(f?f.bottom:0):f&&(E.y+=f.top);h&&(e?(f=E,b=a,k=0,65==(h&65)&&(f.x<e.left||f.x>=e.right)&&(h&=-2),132==(h&132)&&(f.y<e.top||f.y>=e.bottom)&&(h&=-5),f.x<e.left&&h&1&&(f.x=e.left,k|=1),h&16&&(l=f.x,f.x<e.left&&(f.x=e.left,k|=4),f.x+b.width>e.right&&(b.width=Math.min(e.right-
...
h=256,k=h);f=new ge(0,0,0,0);f.left=E.x;f.top=E.y;f.width=a.width;f.height=a.height;h=k;h&496||(E=new bd(f.left,f.top),E instanceof bd?(e=E.x,E=E.y):(e=E,E=void 0),c.style.left=ue(e,!1),c.style.top=ue(E,!1),a=new dd(f.width,f.height),d==a||d&&a&&d.width==a.width&&d.height==a.height||(f=a,d=yd(c),e=ee(wd(d)),!Q||pd("10")||e&&pd("8")?(c=c.style,hd?c.MozBoxSizing="border-box":id?c.WebkitBoxSizing="border-box":c.boxSizing="border-box",c.width=Math.max(f.width,0)+"px",c.height=Math.max(f.height,0)+"px"):
...
function Gg(a,b,c){var d=J("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=J("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=hf(window.location.href);e&&d.push(e);e=hf(a);if(Ua(d,e)||!e&&0==a.lastIndexOf("/",0))if(d=kf(a),d=lf(d))d=J("SMALLER_SESSION_TEMPDATA_NAME")?"ST-"+Ha(d).toString(36):"s_tempdata-"+Ha(d),e=b?pf(b):"",wf(d,e,5,"/"),b&&(b=b.itct||b.ved,d=t("yt.logging.screenreporter.storeParentElement"),b&&d&&d(new Eg))}if(c)return!1;Fg(a);return!0}
;function Hg(a){var b=void 0;isNaN(b)&&(b=void 0);var c=t("yt.scheduler.instance.addJob");c?c(a,0,b):void 0===b?a():K(a,b||0)}
...
Lg.prototype.toString=function(){return this.topic};var Mg=t("yt.pubsub2.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.va;H.prototype.publish=H.prototype.G;H.prototype.clear=H.prototype.clear;r("yt.pubsub2.instance_",Mg,void 0);var Ng=t("yt.pubsub2.subscribedKeys_")||{};r("yt.pubsub2.subscribedKeys_",Ng,void 0);var Og=t("yt.pubsub2.topicToKeys_")||{};r("yt.pubsub2.topicToKeys_",Og,void 0);var Pg=t("yt.pubsub2.isAsync_")||{};r("yt.pubsub2.isAsync_",Pg,void 0);
r("yt.pubsub2.skipSubKey_",null,void 0);function Qg(a,b){var c=t("yt.pubsub2.instance_");if(c){var d=c.subscribe(a.toString(),function(c,f){if(!window.yt.pubsub2.skipSubKey_||window.yt.pubsub2.skipSubKey_!=d){var h=function(){if(Ng[d])try{if(f&&a instanceof Lg&&a!=c)try{f=Kg(a.f,f)}catch(h){throw h.message="yt.pubsub2 cross-binary conversion error for "+a.toString()+": "+h.message,h;}b.call(window,f)}catch(h){Ac(h)}};
Pg[a.toString()]?t("yt.scheduler.instance")?Hg(h):K(h,0):h()}});
Ng[d]=!0;Og[a.toString()]||(Og[a.toString()]=[]);Og[a.toString()].push(d)}}
;var Rg={},Sg="ontouchstart"in document;function Tg(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return de(c,function(a){return A(a,b)},d)}
...
g.init=ba;g.dispose=ba;g.uc=function(a,b,c){var d=this.aa(a,b);if(d&&(d=t(d))){var e=fb(arguments,2);eb(e,0,0,a);d.apply(null,e)}};
g.aa=function(a,b){return F(a,b)};function Wg(){this.f="button";this.j=null;this.l=[];this.A={}}
y(Wg,Vg);ca(Wg);function Xg(a,b){var c=b.iframeMask;c||(c=document.createElement("iframe"),c.src='javascript:""',c.className=U(a,"menu-mask"),zg(c),b.iframeMask=c);return c}
function Yg(a,b){if(b){var c=Zg(a,b);if(c){a.j=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");zg(c);a.uc(b,"button-menu-action",!1);var d=Xg(a,b),e=Le(c).toString();delete a.A[e];K(function(){d&&d.parentNode&&(zg(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=ce(b,U(a,"group"),void 0),f=
[U(a,"active")];
...
y($g,Vg);g=$g.prototype;g.Va=function(a){var b=Vg.prototype.Va.call(this,a);return b?b:a};
g.dispose=function(){$g.J.dispose.call(this);ah(this)};
g.aa=function(a,b){var c=$g.J.aa.call(this,a,b);return c?c:(c=$g.J.aa.call(this,a,"card-config"))&&(c=t(c))&&c[b]?c[b]:null};
g.nc=function(a){var b=this.Va(a);if(b){B(b,U(this,"active"));var c=bh(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;ch(this,a,c);var d=U(this,"card-visible"),e=this.aa(a,"card-delegate-show")&&this.aa(b,"card-action");this.uc(b,"card-action",a);this.j=a;zg(c);K(v(function(){e||(yg(c),P("yt-uix-card-show",b,a,c));dh(c);B(c,d);P("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
...
function ch(a,b,c){var d=a.aa(b,"orientation")||"horizontal",e=a.aa(b,"position"),f=!!a.aa(b,"force-position"),h=a.aa(b,"position-fixed"),d="horizontal"==d,k="bottomright"==e||"bottomleft"==e,l="topright"==e||"bottomright"==e,n,p;l&&k?(p=7,n=4):l&&!k?(p=6,n=5):!l&&k?(p=5,n=6):(p=4,n=7);var M=ze(document.body),e=ze(b);M!=e&&(p^=2);var G;d?(e=b.offsetHeight/2-12,G=new bd(-12,b.offsetHeight+6)):(e=b.offsetWidth/2-6,G=new bd(b.offsetWidth+6,-12));var L=ve(c),e=Math.min(e,(d?L.height:L.width)-24-6);6>
e&&(e=6,d?G.y+=12-b.offsetHeight/2:G.x+=12-b.offsetWidth/2);var I=null;f||(I=10);L=U(a,"card-flip");a=U(a,"card-reverse");pb(c,L,l);pb(c,a,k);I=Bg(b,p,c,n,G,null,I);!f&&I&&(I&48&&(l=!l,p^=2,n^=2),I&192&&(k=!k,p^=1,n^=1),pb(c,L,l),pb(c,a,k),Bg(b,p,c,n,G));h&&(b=parseInt(c.style.top,10),f=Gd(document).y,je(c,"position","fixed"),je(c,"top",b-f+"px"));M&&(c.style.right="",b=xe(c),b.left=b.left||parseInt(c.style.left,10),f=Ed(window),c.style.left="",c.style.right=f.width-b.left-b.width+"px");b=S("yt-uix-card-body-arrow",
c);f=S("yt-uix-card-border-arrow",c);d=d?k?"top":"bottom":!M&&l||M&&!l?"left":"right";b.setAttribute("style","");f.setAttribute("style","");b.style[d]=e+"px";f.style[d]=e+"px";k=S("yt-uix-card-arrow",c);l=S("yt-uix-card-arrow-background",c);k&&l&&(c="right"==d?ve(c).width-e-13:e+11,e=c/Math.sqrt(2),k.style.left=c+"px",k.style.marginLeft="1px",l.style.marginLeft=-e+"px",l.style.marginTop=e+"px")}
g.bb=function(a){if(a=this.Va(a)){var b=R(U(this,"card")+Le(a));b&&(C(a,U(this,"active")),C(b,U(this,"card-visible")),zg(b),this.j=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Pd(b.cardMask),b.cardMask=null))}};
function ah(a){a.j&&a.bb(a.j)}
g.Fe=function(a,b){var c=this.Va(a);if(c){if(b){var d=eh(this,c);if(!d)return;b instanceof Vb?d.innerHTML=Xb(b):Zd(d,b)}A(c,U(this,"active"))&&(c=bh(this,a,c),ch(this,a,c),yg(c),dh(c))}};
...
y(fh,$g);ca(fh);fh.prototype.nc=function(a){fh.J.nc.call(this,a);var b=this.Va(a);if(!F(b,"click-outside-persists")){var c=ia(a);if(this.l[c])return;var b=T(document,"click",v(this.B,this,a)),d=T(window,"blur",v(this.B,this,a));this.l[c]=[b,d]}a=T(window,"resize",v(this.Fe,this,a,void 0));this.A[c]=a};
...
hh.prototype.clone=function(){var a=new hh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==da(c)?a[b]=Fb(c):a[b]=c}return a};function mh(){return!1}
function nh(){return null}
;function oh(){return parseInt(J("DCLKSTAT",0),10)}
;function ph(){if(null==t("_lact",window)){var a=parseInt(J("LACT"),10),a=isFinite(a)?x()-Math.max(a,0):-1;r("_lact",a,window);-1==a&&qh();T(document,"keydown",qh);T(document,"keyup",qh);T(document,"mousedown",qh);T(document,"mouseup",qh);O("page-mouse",qh);O("page-scroll",qh);O("page-resize",qh)}}
function qh(){null==t("_lact",window)&&(ph(),t("_lact",window));var a=x();r("_lact",a,window);P("USER_ACTIVE")}
function rh(){var a=t("_lact",window);return null==a?-1:Math.max(x()-a,0)}
...
function Nh(a,b){if(a.gb)return!0;if(!sh){var c=b||t("window.event"),d=new vh(c,this),e=!0;if(!(0>c.keyCode||void 0!=c.returnValue)){a:{var f=!1;if(0==c.keyCode)try{c.keyCode=-1;break a}catch(l){f=!0}if(f||void 0==c.returnValue)c.returnValue=!0}c=[];for(f=d.currentTarget;f;f=f.parentNode)c.push(f);for(var f=a.type,h=c.length-1;!d.f&&0<=h;h--){d.currentTarget=c[h];var k=Qh(c[h],f,!0,d),e=e&&k}for(h=0;!d.f&&h<c.length;h++)d.currentTarget=c[h],k=Qh(c[h],f,!1,d),e=e&&k}return e}return Rh(a,new vh(b,this))}
function Kh(a){a=a[Fh];return a instanceof Ah?a:null}
var Sh="__closure_events_fn_"+(1E9*Math.random()>>>0);function Jh(a){if(ga(a))return a;a[Sh]||(a[Sh]=function(b){return a.handleEvent(b)});
return a[Sh]}
;var Th=D("Firefox"),Uh=Nb(),Vh=D("Safari")&&!(Nb()||D("Coast")||Mb()||D("Edge")||D("Silk")||D("Android"))&&!(D("iPhone")&&!D("iPod")&&!D("iPad")||D("iPad")||D("iPod"));function Wh(){var a;if(a=vf.get("PREF",void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Xh[d]=c.toString())}}}
ca(Wh);var Xh=t("yt.prefs.UserPrefs.prefs_")||{};r("yt.prefs.UserPrefs.prefs_",Xh,void 0);function Yh(a){if(/^f([1-9][0-9]*)$/.test(a))throw"ExpectedRegexMatch: "+a;}
...
;function di(){this.l=this.j=this.f=0;this.A="";var a=t("window.navigator.plugins"),b=t("window.navigator.mimeTypes"),a=a&&a["Shockwave Flash"],b=b&&b["application/x-shockwave-flash"],b=a&&b&&b.enabledPlugin&&a.description||"";if(a=b){var c=a.indexOf("Shockwave Flash");0<=c&&(a=a.substr(c+15));for(var c=a.split(" "),d="",a="",e=0,f=c.length;e<f;e++)if(d)if(a)break;else a=c[e];else d=c[e];d=d.split(".");c=parseInt(d[0],10)||0;d=parseInt(d[1],10)||0;e=0;if("r"==a.charAt(0)||"d"==a.charAt(0))e=parseInt(a.substr(1),
10)||0;a=[c,d,e]}else a=[0,0,0];this.A=b;b=a;this.f=b[0];this.j=b[1];this.l=b[2];if(0>=this.f){var h,k,l,n;if(Dc)try{h=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(p){h=null}else l=document.body,n=document.createElement("object"),n.setAttribute("type","application/x-shockwave-flash"),h=l.appendChild(n);if(h&&"GetVariable"in h)try{k=h.GetVariable("$version")}catch(p){k=""}l&&n&&l.removeChild(n);(h=k||"")?(h=h.split(" ")[1].split(","),h=[parseInt(h[0],10)||0,parseInt(h[1],10)||0,parseInt(h[2],
10)||0]):h=[0,0,0];this.f=h[0];this.j=h[1];this.l=h[2]}}
ca(di);function ei(a,b,c,d){b="string"==typeof b?b.split("."):[b,c,d];b[0]=parseInt(b[0],10)||0;b[1]=parseInt(b[1],10)||0;b[2]=parseInt(b[2],10)||0;return a.f>b[0]||a.f==b[0]&&a.j>b[1]||a.f==b[0]&&a.j==b[1]&&a.l>=b[2]}
...
y(ti,Ig);var ui=new Lg("timing-sent",ti);var vi=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{},wi=v(vi.clearResourceTimings||vi.webkitClearResourceTimings||vi.mozClearResourceTimings||vi.msClearResourceTimings||vi.oClearResourceTimings||ba,vi),xi=vi.mark?function(a){vi.mark(a)}:ba;
function yi(){zi();wi();r("yt.timing.pingSent_",!1,void 0)}
function Ai(){var a=Bi();if(a.aft)return a.aft;for(var b=J("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
...
function Ei(a){if(J("DEBUG_CSI_DATA")){var b=t("yt.timing.csiData");b||(b=[],r("yt.timing.csiData",b,void 0));b.push({page:location.href,time:new Date,args:a})}J("EXP_DEFER_CSI_PING")&&(N(t("yt.timing.deferredPingTimer_")),r("yt.timing.deferredPingArgs_",null,void 0));var c="https:"==window.location.protocol?"https://gg.google.com/csi":"http://csi.gstatic.com/csi",b="",d;for(d in a)b+="&"+d+"="+a[d];a=c+"?"+b.substring(1);b=J("CSI_LOG_WITH_YT")?"/csi_204?"+b.substring(1):null;window.navigator&&window.navigator.sendBeacon?
(ng(a),b&&ng(b)):(a&&og(a,void 0),b&&b&&og(b,void 0));r("yt.timing.pingSent_",!0,void 0)}
function Fi(a){if(J("EXP_DEFER_CSI_PING")){var b=t("yt.timing.deferredPingArgs_");b&&(a&&(b.yt_fss=a),Ei(b))}}
function Bi(){return Gi().tick}
function Gi(){return t("ytcsi.data_")||zi()}
function zi(){var a={tick:{},span:{},info:{}};r("ytcsi.data_",a,void 0);return a}
;var Hi={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function Ii(a,b){rc.call(this);this.B=this.K=a;this.W=b;this.F=!1;this.j={};this.Ja=this.S=null;this.ca=new H;sc(this,w(tc,this.ca));this.A={};this.C=this.Za=this.l=this.Qb=this.f=null;this.fa=!1;this.M=this.D=this.O=this.P=null;this.xb={};this.pd=["onReady"];this.yb=[];this.Rb=null;this.tc=0;this.ka={};Ji(this);this.Aa("onDetailedError",v(this.be,this));this.Aa("onTabOrderChange",v(this.md,this));this.Aa("onTabAnnounce",v(this.oc,this));this.Aa("WATCH_LATER_VIDEO_ADDED",v(this.ce,this));this.Aa("WATCH_LATER_VIDEO_REMOVED",
...
y(Ii,rc);var Ki=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=Ii.prototype;g.getId=function(){return this.W};
...
function Ri(a){if(!q(a.f.disable.flash)){var b=a.f.disable,c;c=ei(di.getInstance(),a.f.minVersion);b.flash=!c}return!a.f.disable.flash}
function Mi(a){var b;if(!(b=!a.f.html5&&Ri(a))){if(!q(a.f.disable.html5)){var c;b=!0;void 0!=a.f.args.deviceHasDisplay&&(b=a.f.args.deviceHasDisplay);if(2.2==mi)c=!0;else{a:{var d=b;b=t("yt.player.utils.videoElement_");b||(b=document.createElement("video"),r("yt.player.utils.videoElement_",b,void 0));try{if(b.canPlayType)for(var d=d?ri:si,e=0;e<d.length;e++)if(b.canPlayType(d[e])){c=null;break a}c="fmt.noneavailable"}catch(f){c="html5.missingapi"}}c=!c}c&&(c=Si(a)||a.f.assets.js);a.f.disable.html5=
...
function Si(a){var b=!0,c=Ui(a);c&&a.f&&(a=a.f,b=F(c,"version")==a.assets.js);return b&&!!t("yt.player.Application.create")}
g.Je=function(){if(!this.fa){var a=Si(this);a&&"html5"==Vi(this)?(this.C="html5",this.F||this.fb()):(Wi(this),this.C="html5",a&&this.O?(this.K.appendChild(this.O),this.fb()):(this.f.loaded=!0,this.P=v(function(){var a=this.K,c=this.f.clone();t("yt.player.Application.create")(a,c);this.fb()},this),this.fa=!0,a?this.P():(Oc(this.f.assets.js,this.P),Wc(this.f.assets.css))))}};
...
this.A[e]);Oi(this);this.Za&&this.Za(this.j);this.ca.G("onReady",this.j)}else this.tc=K(v(this.fb,this),50)}};
...
g.Aa=function(a,b){if(!this.isDisposed()){var c=Pi(this,b);if(c){if(!Ua(this.pd,a)&&!this.A[a]){var d=Yi(this,a);this.S&&this.S(a,d)}this.ca.subscribe(a,c);"onReady"==a&&this.F&&K(w(c,this.j),0)}}};
g.xe=function(a,b){if(!this.isDisposed()){var c=Pi(this,b);c&&this.ca.unsubscribe(a,c)}};
function Pi(a,b){var c=b;if("string"==typeof b){if(a.xb[b])return a.xb[b];c=function(){var a=t(b);a&&a.apply(m,arguments)};
a.xb[b]=c}return c?c:null}
function Yi(a,b){var c="ytPlayer"+b+a.W;a.A[b]=c;m[c]=function(c){var e=K(function(){if(!a.isDisposed()){a.ca.G(b,c);var f=a.ka,h=String(e);h in f&&delete f[h]}},0);
Eb(a.ka,String(e))};
return c}
...
b=this.f.messages.player_fallback||a;a=R("player-unavailable");if(R("unavailable-submessage")&&a){R("unavailable-submessage").innerHTML=b;var b=S("icon",a),c;if(c=b)c=b?b.dataset?ac("icon")in b.dataset:b.hasAttribute?!!b.hasAttribute("data-icon"):!!b.getAttribute("data-icon"):!1;c&&(b.src=F(b,"icon"));ye(a,!0);B(R("player"),"off-screen-trigger")}};
...
function Wi(a){Bi().dcp=x();xi("dcp");var b=J("TIMING_ACTION",void 0),c=Bi();if(t("yt.timing.ready_")&&b&&c._start&&Ai()){var b=!0,d=J("TIMING_WAIT",[]);if(d.length)for(var e=0,f=d.length;e<f;++e)if(!(d[e]in c)){b=!1;break}if(b)if(d=Bi(),c=Gi().span,e=Gi().info,b=t("yt.timing.reportbuilder_")){if(b=b(d,c,e,void 0))Ei(b),yi()}else{f=J("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:J("TIMING_ACTION",void 0)};if(vi.now&&vi.timing){var h=vi.timing.navigationStart+vi.now(),h=Math.round(x()-h);e.yt_hrd=
h}var h=J("TIMING_INFO",{}),k;for(k in h)e[k]=h[k];k=e.srt;delete e.srt;var l;k||0===k||(l=vi.timing||{},k=Math.max(0,l.responseStart-l.navigationStart),isNaN(k)&&e.pt&&(k=e.pt));if(k||0===k)e.srt=k;e.h5jse&&(h=window.location.protocol+t("ytplayer.config.assets.js"),(h=vi.getEntriesByName?vi.getEntriesByName(h)[0]:null)?e.h5jse=Math.round(e.h5jse-h.responseEnd):delete e.h5jse);d.aft=Ai();h=d._start;if("cold"==e.yt_lt){l||(l=vi.timing||{});var n;a:if(n=l,n.msFirstPaint)n=Math.max(0,n.msFirstPaint);
else{var p=window.chrome;if(p&&(p=p.loadTimes,ga(p))){var p=p(),M=1E3*Math.min(p.requestTime||Infinity,p.startLoadTime||Infinity),M=Infinity===M?0:n.navigationStart-M;n=Math.max(0,Math.round(1E3*p.firstPaintTime+M)||0);break a}n=0}0<n&&n>h&&(d.fpt=n);n=c||Gi().span;p=l.redirectEnd-l.redirectStart;0<p&&(n.rtime_=p);p=l.domainLookupEnd-l.domainLookupStart;0<p&&(n.dns_=p);p=l.connectEnd-l.connectStart;0<p&&(n.tcp_=p);p=l.connectEnd-l.secureConnectionStart;l.secureConnectionStart>=l.navigationStart&&
0<p&&(n.stcp_=p);p=l.responseStart-l.requestStart;0<p&&(n.req_=p);p=l.responseEnd-l.responseStart;0<p&&(n.rcv_=p);vi.getEntriesByType&&Di(d)}p=Bi();l=p.pbr;n=p.vc;p=p.pbs;l&&n&&p&&l<n&&n<p&&1==Gi().info.yt_vis&&"youtube"==f&&(Gi().info.yt_lt="hot_bg",f=d.vc,l=d.pbs,delete d.aft,c.aft=Math.round(l-f));(f=J("PREVIOUS_ACTION"))&&(e.pa=f);e.p=J("CLIENT_PROTOCOL")||"unknown";e.t=J("CLIENT_TRANSPORT")||"unknown";window.navigator&&window.navigator.sendBeacon&&(e.ba=1);for(var G in e)"_"!=G.charAt(0)&&(b[G]=
e[G]);d.ps=x();G={};var e=[],L;for(L in d)"_"!=L.charAt(0)&&(n=Math.max(Math.round(d[L]-h),0),G[L]=n,e.push(L+"."+n));b.rt=e.join(",");L=b;var d=[],I;for(I in c)"_"!=I.charAt(0)&&d.push(I+"."+c[I]);L.it=d.join(",");(I=t("ytdebug.logTiming"))&&I(b,G,c);yi();J("EXP_DEFER_CSI_PING")?(Fi(),r("yt.timing.deferredPingArgs_",b,void 0),I=K(Fi,0),r("yt.timing.deferredPingTimer_",I,void 0)):Ei(b);I=new ti(G.aft+(k||0));(L=t("yt.pubsub2.instance_"))&&L.publish.call(L,ui.toString(),ui,I)}}a.cancel();Ji(a);a.C=
null;a.f&&(a.f.loaded=!1);I=Ui(a);"html5"==Vi(a)?a.O=I:I&&I.destroy&&I.destroy();Nd(a.K);Ze(a.yb);a.yb.length=0;a.D=null;a.M=null}
g.cancel=function(){this.P&&Vc(this.f.assets.js,this.P);N(this.tc);this.fa=!1};
g.L=function(){Wi(this);if(this.O&&this.f&&this.f.args.fflags&&-1!=this.f.args.fflags.indexOf("new_html5_dispose=true"))try{this.O.destroy()}catch(b){Ac(b)}this.xb=null;for(var a in this.A)m[this.A[a]]=null;this.j=null;delete this.K;delete this.B;this.f&&(this.Qb=this.f=this.f.fallback=null);Ii.J.L.call(this)};var Zi={},$i="player_uid_"+(1E9*Math.random()>>>0);function aj(a,b){a=u(a)?zd(a):a;b=lh(b);var c=$i+"_"+ia(a),d=Zi[c];if(d)return d.mc(b),d.j;d=new Ii(a,c);Zi[c]=d;P("player-added",d.j);sc(d,w(bj,d));K(function(){d.mc(b)},0);
return d.j}
function bj(a){Zi[a.getId()]=null}
function cj(a){a=R(a);if(!a)return null;var b=$i+"_"+ia(a),c=Zi[b];c||(c=new Ii(a,b),Zi[b]=c);return c.j}
;var dj=t("yt.abuse.botguardInitialized")||mh;r("yt.abuse.botguardInitialized",dj,void 0);var ej=t("yt.abuse.invokeBotguard")||nh;r("yt.abuse.invokeBotguard",ej,void 0);var fj=t("yt.abuse.dclkstatus.checkDclkStatus")||oh;r("yt.abuse.dclkstatus.checkDclkStatus",fj,void 0);var gj=t("yt.player.exports.navigate")||Gg;r("yt.player.exports.navigate",gj,void 0);var hj=t("yt.player.embed")||aj;r("yt.player.embed",hj,void 0);var ij=t("yt.player.getPlayerByElement")||cj;r("yt.player.getPlayerByElement",ij,void 0);
var jj=t("yt.util.activity.init")||ph;r("yt.util.activity.init",jj,void 0);var kj=t("yt.util.activity.getTimeSinceActive")||rh;r("yt.util.activity.getTimeSinceActive",kj,void 0);var lj=t("yt.util.activity.setTimestamp")||qh;r("yt.util.activity.setTimestamp",lj,void 0);function mj(){pb(R("page-container"),"remote-connected",!!V)}
;var nj=!1;function oj(){var a=t("yt.player.getPlayerByElement");return a?a("player-api"):null}
function pj(a){pb(R("player-mole-container"),"watch-mole",a);a=R("player-mole-container");var b=R("player");nj=!b||A(b,"off-screen")||!a||A(a,"watch-mole");(a=oj())&&a.isReady()&&a.setMinimized(nj)}
;function qj(a,b,c,d){this.f=a;this.D=null;this.l=S("yt-dialog-fg",this.f)||this.f;if(a=S("yt-dialog-title",this.l)){var e="yt-dialog-title-"+ia(this.l);a.setAttribute("id",e);this.l.setAttribute("aria-labelledby",e)}this.l.setAttribute("tabindex","-1");this.K=S("yt-dialog-focus-trap",this.f);this.M=!1;this.A=new H;this.F=[];this.F.push($e(this.f,"click",v(this.Sd,this),"yt-dialog-dismiss"));this.F.push(T(this.K,"focus",v(this.rd,this),!0));rj(this);this.Ha=b;this.P=c;this.O=d;this.C=this.B=null;this.U=
!1}
...
function uj(a){var b=Bd("iframe",null,a.f);z(b,function(a){var b=F(a,"onload");b&&(b=t(b))&&T(a,"load",b);if(b=F(a,"src"))a.src=b},a);
return cb(b)}
function vj(a){z(document.getElementsByTagName("iframe"),function(b){-1==La(a,b)&&B(b,"iframe-hid")})}
function wj(){var a=Ad("iframe-hid");z(a,function(a){C(a,"iframe-hid")})}
g.Sd=function(a){a=a.currentTarget;a.disabled||(a=F(a,"action")||"",this.dismiss(a))};
g.dismiss=function(a){if(!this.isDisposed()){this.A.G("pre-all");this.A.G("pre-"+a);zg(this.f);ah(fh.getInstance());ah(gh.getInstance());this.l.setAttribute("tabindex","-1");if(!tj()){zg(this.j);C(document.body,"yt-dialog-active");Te();var b=oj();b&&b.isReady()&&this.U&&(b.playVideo(),this.U=!1);wj()}this.B&&(Ze(this.B),this.B=null);this.C&&(Ze(this.C),this.C=null);if(b=this.f){var c=F(b,"player-ready-pubsub-key");c&&(Kc(c),bc(b,"player-ready-pubsub-key"))}this.A.G("post-all");P("yt-ui-dialog-hide-complete",
this);"cancel"==a&&P("yt-ui-dialog-cancelled",this);this.A&&this.A.G("post-"+a);this.D&&this.D.focus()}};
g.Id=function(a){K(v(function(){this.Ha||27!=a.keyCode||this.dismiss("cancel")},this),0);
...
g.dispose=function(){wg(this.f)&&this.dismiss("dispose");Ze(this.F);this.F.length=0;K(v(function(){this.D=null},this),0);
this.K=this.l=null;this.A.dispose();this.A=null;this.M=!0};
g.rd=function(a){a.stopPropagation();xj(this)};
function xj(a){K(v(function(){this.l&&this.l.focus()},a),0)}
r("yt.ui.Dialog",qj,void 0);var yj=null,zj={"consent.google.com":!0,"consent.youtube.com":!0,"consent-daily-0.sandbox.google.com":!0,"consent-daily-1.sandbox.google.com":!0,"consent-daily-2.sandbox.google.com":!0,"consent-daily-3.sandbox.google.com":!0,"consent-daily-4.sandbox.google.com":!0,"consent-daily-5.sandbox.google.com":!0,"consent-daily-6.sandbox.google.com":!0,"consent-autopush.sandbox.google.com":!0};
function Aj(){var a=R("yt-consent");$e(a,"click",Bj,"consent-close");$e(a,"click",Cj,"consent-review");T(window,"message",Dj);J("CONSENT_SHOW_DIALOG")&&(Ej(),a=R("yt-consent-dialog-content"),ug(pf({a:"consent",consent:"forced"})),$e(a,"click",Fj,"yt-dialog-dismiss"))}
function Bj(){C(document.body,"sitewide-consent-visible");wf("HideTicker","true",86400,"/");ug(pf({a:"consent",consent:"later"}))}
function Cj(){Ej();ug(pf({a:"consent",consent:"review"}))}
function Fj(a){a=a.currentTarget;a.disabled||(a=F(a,"action")||"",qj.prototype.dismiss(a),ug(pf({a:"consent",consent:"dismiss"})))}
...
e.clientHeight!=f&&(d=b.scrollHeight,f=b.offsetHeight);b=d>c?d>f?d:f:d<f?d:f}}}a.j.style.height=b+"px";yg(a.j)}Se(a.f);b=uj(a);vj(b);a.B=T(document,"keydown",v(a.Id,a));b=a.f;e=O("player-added",a.$b,a);$b(b,"player-ready-pubsub-key",e);a.$b();a.P&&(a.C=T(document,"click",v(a.se,a)));yg(a.f);a.l.setAttribute("tabindex","0");xj(a);B(document.body,"yt-dialog-active");a=Wg.getInstance();a.j&&Yg(a,a.j);ah(fh.getInstance());ah(gh.getInstance())}}
function Dj(a){var b=a&&a.data,c=a&&a.origin;a=a&&a.source;var d=!1,e=hf(c);if(zj[e]&&zj.hasOwnProperty(e)&&!J("MENDEL_FLAG_CONSENT_URL_OVERRIDE")){switch(b){case "cb-user-closed":yj.dispose();break;case "cb-ui-done-early":yj.dismiss("close");d=!0;break;case "cb-ui-done":case "cb-already-consented":yj.dismiss("close");d=!0;break;case "verify-origin":a.parent==window&&a.postMessage("verify-origin-reply",c)}d&&(C(document.body,"sitewide-consent-visible"),ug(pf({a:"consent",consent:"done"})))}}
...
function Vj(a,b){b=b||{};for(var c in Wj){var d=J(Wj[c]),e;if(e=d){e=a;var f=void 0;f=window.location.href;var h=e.match(gf)[1]||null,k=hf(e);h&&k?(e=e.match(gf),f=f.match(gf),e=e[3]==f[3]&&e[1]==f[1]&&e[4]==f[4]):e=k?hf(f)==k&&(Number(f.match(gf)[4]||null)||null)==(Number(e.match(gf)[4]||null)||null):!0;e||(e=c,f=J("CORS_HEADER_WHITELIST")||{},e=(h=hf(a))?(f=f[h])?Ua(f,e):!1:!0)}e&&(b[c]=d)}return b}
function Xj(a,b){var c=J("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.jf&&(!hf(a)||b.withCredentials||hf(a)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.sa&&b.sa[c])}
function Yj(a,b){var c=b.format||"JSON";b.kf&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=J("XSRF_FIELD_NAME",void 0),e=J("XSRF_TOKEN",void 0),f=b.Qa;f&&(f[d]&&delete f[d],a=rg(a,f||{}));var h=b.postBody||"",f=b.sa;Xj(a,b)&&(f||(f={}),f[d]=e);f&&u(h)&&(d=pg(h),Ib(d,f),h=pf(d));var k=!1,l,n=Uj(a,function(a){if(!k){k=!0;l&&N(l);var d;a:switch(a&&"status"in a?a.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:d=
...
b.tb&&0<b.timeout&&(l=K(function(){k||(k=!0,n.abort(),N(l),b.tb.call(b.context||m,n))},b.timeout));
return n}
function Zj(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=Lj(a));break;case "XML":if(b=(b=b.responseXML)?ak(b):null)d={},z(b.getElementsByTagName("*"),function(a){d[a.tagName]=bk(a)})}c&&ck(d);
return d}
function ck(a){if(ha(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);c?a[b]=Dg(Pb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax"),a[b]):ck(a[b])}}
function ak(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function bk(a){var b="";z(a.childNodes,function(a){b+=a.nodeValue});
return b}
...
y(dk,rc);var ek=[];g=dk.prototype;g.Fa=function(a,b,c,d){ea(b)||(b&&(ek[0]=b.toString()),b=ek);for(var e=0;e<b.length;e++){var f=Ih(a,b[e],c||this.handleEvent,d||!1,this.j||this);if(!f)break;this.f[f.key]=f}return this};
g.kc=function(a,b,c,d,e){if(ea(b))for(var f=0;f<b.length;f++)this.kc(a,b[f],c,d,e);else c=c||this.handleEvent,e=e||this.j||this,c=Jh(c),d=!!d,b=a&&a[wh]?Eh(a.Ma,String(b),c,d,e):a?(a=Kh(a))?Eh(a,b,c,d,e):null:null,b&&(Ph(b),delete this.f[b.key]);return this};
...
y(fk,rc);fk.prototype[wh]=!0;g=fk.prototype;g.ic=function(a){this.ia=a};
...
;function ik(){}
ca(ik);ik.prototype.f=0;function jk(a){fk.call(this);this.B=a||wd();this.ka=null;this.Oa=!1;this.f=null;this.j=void 0;this.S=this.W=this.C=null;this.ya=!1}
y(jk,fk);g=jk.prototype;g.Gd=ik.getInstance();g.getId=function(){return this.ka||(this.ka=":"+(this.Gd.f++).toString(36))};
...
function nk(a,b){a.W&&z(a.W,b,void 0)}
...
y(ok,jk);ok.prototype.Da=function(){z(this.Ja,Ze);Kc(this.fa);ok.J.Da.call(this)};function pk(){ok.call(this);this.D=this.l=this.A=null;this.K="horizontal";this.F=null}
y(pk,ok);pk.prototype.Ca=function(){pk.J.Ca.call(this);this.K=F(this.wa(),"overflowable-list-orientation")||"horizontal";this.A=kk(this,"parent-list");this.F=kk(this,"overflow-container");this.l=kk(this,"overflow-list");kk(this,"overflowable-list-item");this.D=kk(this,"overflowable-list-more-button")};
function qk(){var a=Ad("overflowable-list-root",rk),b=[];z(a,function(a){var d=new pk;mk(d,a);b.push(d)});
return b}
...
return this.l.replace(this.j,d)};var rk,Ek,Fk,Gk;function Hk(a){Yj("/playlist_video_ajax?action_add_to_playlist=1",{method:"POST",Qa:{feature:a.feature||null,authuser:a.gf||null,pageid:a.pageId||null},sa:{video_ids:a.videoIds||null,source_playlist_id:a.sourcePlaylistId||null,full_list_id:a.fullListId||null,delete_from_playlists:a.lf||null,add_to_playlists:a.ff||null,plid:J("PLAYBACK_ID")||null},context:a.context,onError:a.onError,X:function(b,c){var d=c.result;if(d&&d.actions)for(var d=d.actions,e=0;e<d.length;e++){var f=d[e];"send_follow_on_ping_action"==
...
g.Ca=function(){Ik.J.Ca.call(this);this.O=this.wa();this.ca=parseInt(F(this.O,"max-title-length"),10)||0;this.K=kk(this,"create-button");this.A=kk(this,"cancel-button");this.D=kk(this,"privacy-button");var a=lk(this);this.l=kk(this,"title-input");a.Fa(this.l,"keyup",this.Tc);a.Fa(this.l,"paste",this.Tc);a.Fa(this.O,"reset",this.Wd);a.Fa(this.O,"submit",this.Xd);this.P=kk(this,"create-playlist-widget-privacy-menu");this.M=kk(this,"is-selected");a=O("yt-uix-menu-item-clicked",v(this.ee,this));this.fa.push(a)};
...
g.ee=function(a){Yd(this.P,a)&&(a=ce(a,"yt-ui-menu-item",void 0),Kk(this,a),a=F(a,"value"),kk(this,"privacy-value-input").value=a)};
function Kk(a,b){var c;c=Wg.getInstance();c=S(U(c,"content"),a.D);var d;ud&&"innerText"in b?d=b.innerText.replace(/(\r\n|\r|\n)/g,"\n"):(d=[],be(b,d,!0),d=d.join(""));d=d.replace(/ \xAD /g," ").replace(/\xAD/g,"");d=d.replace(/\u200B/g,"");ud||(d=d.replace(/ +/g," "));" "!=d&&(d=d.replace(/^\s*/,""));Zd(c,qa(d));c=S("is-selected",a.P);C(c,"is-selected");B(b,"is-selected");c=F(b,"privacy-state");$b(a.D,"privacy-state",c)}
function Lk(a,b){Qe(a.K,b);a.A&&Qe(a.A,b);Qe(a.l,b);Qe(a.D,b)}
function Jk(a){a.l.value="";var b=kk(a,"title-input-container");C(b,"yt-uix-form-error");b=S("yt-uix-form-error-message",b);Pd(b);Qe(a.D,!0);(b=S("is-selected",a.P))&&a.M&&b!=a.M&&Kk(a,a.M);Qe(a.K,!1);a.A&&Qe(a.A,!0);Qe(a.l,!0)}
...
g.Ud=function(a,b){Jk(this);this.F&&ga(this.F.Gb)&&this.F.Gb({playlistId:b.result.playlistId,playlistName:b.result.playlistName,ue:b.result.playlistUrl});P("yt-uix-videoactionmenu-hide")};
g.Td=function(a,b){if(b&&b.errors&&b.errors.length){var c=kk(this,"title-input-container"),d=b.errors[0];B(c,"yt-uix-form-error");if(d){var e=S("yt-uix-form-error-message",c);e?e.innerHTML=d:(d=Jd("span","yt-uix-form-error-message",document.createTextNode(String(d))),d.setAttribute("role","alert"),c.appendChild(d))}Lk(this,!0)}};
g.Wd=function(){Jk(this);this.F&&ga(this.F.Fb)&&this.F.Fb()};function Mk(a){Ig.call(this,1,arguments);this.f=a}
y(Mk,Ig);function Nk(a,b,c){Ig.call(this,1,arguments);this.f=c}
y(Nk,Ig);var Ok=new Lg("subscription-subscribe-success",Nk),Pk=new Lg("subscription-unsubscribe-success",Mk);var Qk,Rk,Sk={bf:"content-snap-width-1",cf:"content-snap-width-2",df:"content-snap-width-3"};function Tk(){var a=[],b;for(b in Sk)a.push(Sk[b]);return a}
...
function gl(a,b,c,d,e){O(a,function(a){var h=c.apply(null,arguments);if(d){var k=S("guide-count-value",h);if(k){var l=k.innerHTML;""===l.trim()||isNaN(l)||Zd(k,parseInt(l,10)+d)}}!h&&e&&(k=e.f(a),(l=S("guide-item-container",R("behavior-id-guide-playlists-section")))&&k&&Od(l,k,0));ll(b,!!h,a?a.title:null)||((k=S("guide-item-update-notification",h))&&Pd(k),k=kl(b),B(k,"guide-item-update-notification"),h.appendChild(k),K(w(B,h,"showing-update-notification"),0),K(w(C,h,"showing-update-notification"),
2E3))})}
...
function ml(a,b,c){ll(b,!!a)||(b=kl(b),B(b,"guide-item-removal-notification"),a.appendChild(b),K(w(B,a,"removing-guide-item"),0),K(function(){Pd(a);P(c)},2E3))}
function ll(a,b,c){if(b&&Yk())return!1;Nd(al);al.appendChild(kl(a,c));B(document.body,"show-guide-button-notification");K(w(C,document.body,"show-guide-button-notification"),2E3);return!0}
...
;var nl=[],ol=[],pl=[];
function ql(){rk=R("guide");Ek=R("guide-channels");Fk=R("appbar-guide-menu");Gk=R("appbar-guide-iframe-mask");dl();rk&&(Uk(),A(document.body,"exp-scrollable-guide")||rl(),nl.push($e(rk,"click",sl,"guide-sort-choice")),A(document.body,"exp-scrollable-guide")?(tl(xk(!0)),ol.push(O("page-resize",tl))):ol.push(O("page-resize",ul)),ol.push(O("guide-channel-section-updated",vl)),ol.push(O("guide-playlist-section-updated",w(ul,w(xk,!0)))),ol.push(O("force-reload-subscriptions",wl)),ol.push(O("update-guide-subscriptions",
xl)),ol.push(O("guide-hidden",yl)))}
function zl(a,b){z(Ad("guide-flyout-container",rk),function(c){nl.push(T(c,a,b))})}
function Al(a){Bl(a.currentTarget)}
function yl(){var a=Ad("guide-flyout-container",rk);z(a,function(a){Bl(a)})}
...
function Cl(a){a=a.currentTarget;var b=S("guide-flyout",a),c=S("guide-flyout-trigger",a),d=S("guide-flyout-iframe-mask",a),e=S("guide-flyout",a),f=Ce(e),h=S("guide-channels-list",a),k=xk(!0),l=S("guide-flyout-trigger",a),n=S("guide-flyout-iframe-mask",a),p=k.height-(Fk?Fk.offsetTop:0);h.style.maxHeight=p-f.top-f.bottom+"px";f=ve(e).height;h=ve(l);l=te(l);p=Math.min(p-f,Math.max(0,k.height-l.y-h.height/2-f/2));h=l.x+h.width;k=k.width-l.x;e.style.bottom=p+"px";n&&(n.style.height=f+"px",n.style.bottom=
p+"px");"rtl"==document.body.getAttribute("dir")?(e.style.right=k+"px",e.style.left="",n&&(n.style.right=k+"px",n.style.left="")):(e.style.left=h+"px",e.style.right="",n&&(n.style.left=h+"px",n.style.right=""));B(b,"flyout-shown");d&&B(d,"flyout-shown");B(c,"on-hover");P("yt-dom-content-change",a)}
...
function sl(a){var b=S("guide-sort-button"),c=F(b,"guide-sort")||"",d=F(a.currentTarget,"guide-sort")||"";c!=d&&($b(b,"guide-sort",d),Yj("/guide_channels_ajax?action_set_guide_sort=1",{method:"POST",Qa:{sort:d},format:"JSON",X:function(a,b){xl(b);var c=Ad("guide-sort-choice");z(c,function(a){var b=F(a,"guide-sort");Wg.getInstance();a=a.parentNode;var b=d==b,c=Pe("span","yt-uix-button-icon-wrapper",a);if(!c&&b){var e=Jd("span",{"class":"yt-uix-button-icon-wrapper yt-uix-button-icon-checkbox"}),f=Jd("div",
{"class":"yt-uix-button-icon-dropdown-checked"});e.appendChild(f);Od(a,e,0)}vg(c,b)})}}))}
function xl(a){var b=a.channels;b&&(a=R("guide-subscriptions-section"),b=Md(b),Qd(b,a),pl=qk(),El(),a=Ad("yt-uix-tooltip-tip-visible"),z(a,function(a){C(a,"yt-uix-tooltip-tip-visible")}))}
function El(){rl();P("yt-dom-content-change",rk)}
function vl(){Ek&&(Ek.firstElementChild?El():wl())}
function Fl(a){var b=Ad("guide-item",rk);return Sa(b,function(b){return F(b,"serialized-endpoint")==a})}
function tl(a){je(Fk,"max-height",a.height-50+"px")}
function ul(a){if(pl&&!A(document.body,"exp-scrollable-guide")){var b=Gl(a),c=pl.length,d=0;pl.sort(sk||kb);z(pl,function(a,f){var h=tk(a)-d,h=Math.min(h,b/(c-f));b-=(c-f)*h;var h=d+=h,h=h-(h>=tk(a)?0:a.D?vk(a,a.D):0),h=Math.max(wk(a),h),k=uk(a,a.A);if(k>h)for(;k>h;){var l;l=a.A;if(l=q(l.lastElementChild)?l.lastElementChild:Td(l.lastChild,!1)){var n=vk(a,l),k=k-n;Od(a.l,l,0)}else break}else if(k<h){for(l=document.createDocumentFragment();!Va(Rd(a.l));)if(n=Sd(a.l)){var p=vk(a,n);if(k+p<=h)k+=p,l.appendChild(n);
else break}else break;a.A.appendChild(l)}pb(a.F,"empty-overflow-list",!!Va(Rd(a.l)))});
Dl()}}
function Gl(a){var b=Fk,c=R("guide-container");if(!c||!b)return 0;var d=Ce(c),d=d.top+d.bottom,c=Sd(c).clientHeight,e=0;z(pl,function(a){e+=a.A?uk(a,a.A):0;e+=Va(Rd(a.l))?0:a.D?vk(a,a.D):0});
...
y(Hl,rc);g=Hl.prototype;g.start=function(){this.stop();this.A=!1;var a=Il(this),b=Jl(this);a&&!b&&this.j.mozRequestAnimationFrame?(this.f=Ih(this.j,"MozBeforePaint",this.l),this.j.mozRequestAnimationFrame(null),this.A=!0):this.f=a&&b?a.call(this.j,this.l):this.j.setTimeout(dc(this.l),20)};
...
g.wd=function(){this.A&&this.f&&Ph(this.f);this.f=null;this.C.call(this.B,x())};
...
function ym(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);vm(a,c);var d=a?a.split(":"):[],e=c.h||qm(),f=Pl(Ul,"ah",Sl());if(f["::"]&&d.length){for(var h=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,n=h.length&&h[h.length-1]||null,p=n;n&&n.hint==l||(p={hint:l,features:[]},h.push(p));p.features.push(k)}var M=h.length;if(1<M){var G=c.callback;G&&(c.callback=function(){0==--M&&G()})}for(;d=h.shift();)zm(d.features,c,d.hint)}else zm(d||[],c,e)}
function zm(a,b,c){function d(a,b){if(M)return 0;Kl.clearTimeout(p);G.push.apply(G,I);var d=((Tl||{}).config||{}).update;d?d(f):f&&Pl(Ul,"cu",[]).push(f);if(b){$l("me0",a,L);try{wm(b,c,n)}finally{$l("me1",a,L)}}return 1}
a=Rl(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var p=null,M=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=Pl(Xl(c),"r",[]).sort(),G=Pl(Xl(c),"L",[]).sort(),L=[].concat(l);0<h&&(p=Kl.setTimeout(function(){M=!0;k()},h));
var I=sm(a,G);if(I.length){var I=sm(a,l),gb=Pl(Ul,"CP",[]),E=gb.length;gb[E]=function(a){function b(){var a=gb[E+1];a&&a()}
function c(b){gb[E]=null;d(I,a)&&Wl(function(){e&&e();b()})}
if(!a)return 0;$l("ml1",I,L);0<E&&gb[E-1]?gb[E]=function(){c(b)}:c(b)};
if(I.length){var Qi="loaded_"+Ul.I++;Tl[Qi]=function(a){gb[E](a);Tl[Qi]=null};
a=im(c,I,"gapi."+Qi,l);l.push.apply(l,I);$l("ml0",I,L);b.sync||Kl.___gapisync?tm(a):um(a)}else gb[E](Nl)}else d(I)&&e&&e()}
...
;Tl.load=function(a,b){return xm(function(){return ym(a,b)})};function Am(a){a=ga(a)?{callback:a}:a||{};a._c&&a._c.jsl&&a._c.jsl.h||Ib(a,{_c:{jsl:{h:J("GAPI_HINT_PARAMS",void 0)}}});if(a.gapiHintOverride||J("GAPI_HINT_OVERRIDE")){var b=qg(document.location.href).gapi_jsh;b&&Ib(a,{_c:{jsl:{h:b}}})}ym("iframes",a)}
;function Bm(){var a={action_get_delegate_accounts:1,owner_picker_redirect_url:J("OWNER_PICKER_REDIRECT_URL")};a.o=J("CREATOR_CONTEXT","U");return a}
;function Cm(a,b,c,d,e,f){this.f=null;this.F=c;this.A=a;this.D=b;this.l=d;this.B=J("GOOGLEPLUS_HOST")+(e?"/u/"+e:"")+(f?"/b/"+f:"")+"/_/notifications/frame";this.j=R(a)}
...
g=Hm.prototype;g.Ee=function(){this.B?(Im(this),Gm(this.j,!0),C(this.f,"yt-uix-gen204")):(K(v(this.We,this),0),Gm(this.j,!1),B(this.f,"yt-uix-gen204"))};
g.We=function(){this.j.close();Jm(this,!0);B(this.f,"sb-notif-clicked");var a=this.j,b={maxWidgetHeight:a.C()};Em(a.f,"onShowNotificationsOnly",b);this.B=!0};
function Jm(a,b){b?(sb(a.A,"sb-off","sb-on"),B(a.A,"sb-card-notif")):(sb(a.A,"sb-on","sb-off"),C(a.A,"sb-card-notif"))}
function Im(a){Jm(a,!1);a.B=!1;C(a.f,"sb-notif-clicked")}
...
g.nd=function(){6E5<rh()?Gm(this.j,!1):Gm(this.j,!0)};var Lm="";function Mm(){Am(function(){var a=R("sb-button-notify"),b=new Hm(J("SANDBAR_LOCALE",void 0),J("SESSION_INDEX",void 0),J("DELEGATED_SESSION_ID",void 0));T(a,"click",v(b.Ee,b));P("sandbar-init")})}
function Nm(){if("U"==J("CREATOR_CONTEXT","U")){var a=Ad("yt-masthead-account-picker-user-option"),b=kf(window.location.href);z(a,function(a){if(-1!=a.href.indexOf("action_handle_signin")){var c;c=rg(a.href,{next:b});Zb(a,kf(c))}})}else{var a=Ad("yt-masthead-account-picker-owner-option"),c=jf();
if(c){var d=c.indexOf(";");-1!=d&&(c=c.substring(0,d))}c&&z(a,function(a){var b=qg(a.href).next;b&&(b=lf(b)+(c?"#"+c:""),b=rg(a.href,{next:b}),Zb(a,kf(b)))})}}
function Om(){C(document.body,"sitewide-ticker-visible");P("masthead-ticker-close")}
function Pm(){var a=J("SBOX_JS_URL",Lm);if(a){Lm=a;var b=t("yt.www.masthead.searchbox.init");b?b():Qm(a,function(){var a;try{a=t("yt.www.masthead.searchbox.init"),a()}catch(b){throw b.message=b.message+' sbox type: "'+da(a)+'"',b;}})}}
...
function Rm(){t("yt.www.masthead.searchbox.init")||(Vc(Lm,Qk),Qk=null)}
function Sm(){var a=R("masthead-search-term");a&&a.focus()}
function Tm(){vg("search-btn",!!R("masthead-search-term").value)}
;var Um,Vm,Wm,Xm;var Ym=!1,Zm=!1;function $m(){if(Um=R("masthead-appbar")){Vm=R("masthead-positioner");Wm=R("masthead-positioner-height-offset");Uk();an();bn();cn=new Hl(dn);var a=en;t("yt.scheduler.instance")&&(a=function(){Hg(en)});
...
function en(){S("appbar-content-hidable");nn=S("appbar-content-trigger");(Zm=A(document.body,"always-autohide-masthead"))?bc(Rk,"position-fixed"):$b(Rk,"position-fixed","true");Zm||nn?on=T(window,"scroll",pn):qn();Xm=!!R("appbar-guide-menu")&&Zk();Ym?(Xm||(pb(Vk,"guide-pinned",!1),Xk(!1),Fk&&(Fk.scrollTop=0)),mn()):Ym=!0;var a=-1*te(Vm).y,b=document.body.scrollHeight,c=a-(b-document.body.clientHeight);0<c&&(document.body.style.minHeight=b+c+"px");Hd(document).scrollTop+=a;rn=Gd(document).y;sn();tn();
Dl()}
function gn(){nn=null;qn()}
function sn(){if(!nn||un)vg(Um,!0);else{var a=ve(nn).height,b=ve(Vm).height,b=te(Vm).y+b,a=Math.floor(te(nn).y)+a,c=A(document.body,"appbar-hidden"),d=Hd(document);c&&a<b+40?(d.scrollTop+=40,vg(Um,!0),C(document.body,"appbar-hidden"),vn()):!c&&b<a&&(d.scrollTop-=40,B(document.body,"appbar-hidden"),vn())}}
function vn(){un=!0;K(function(){un=!1;A(document.body,"appbar-hidden")&&vg(Um,!1)},300)}
var un=!1;function mn(){Xm&&(pb(Vk,"guide-pinned",1251<=(window.innerWidth||document.documentElement.clientWidth)),Xk($k()&&wn));xn()}
function xn(){if(A(document.body,"flex-width-enabled-snap")){var a;a=$k()&&Yk();var b=(window.innerWidth||document.documentElement.clientWidth)-21-50;1251<=(window.innerWidth||document.documentElement.clientWidth)&&a&&(b-=230);a=1262<=b?"content-snap-width-3":1056<=b?"content-snap-width-2":"content-snap-width-1";A(kn,a)||(ob(kn,hn),B(kn,a),P("yt-dom-content-change"))}else ob(kn,hn)}
function yn(){return R("appbar-guide-menu")}
function bn(){var a=A(document.body,"appbar-hidden"),b=te(Vm).y,c=ve(Vm).height;zn=a?b+c:b+c-40}
...
function ln(){var a=te(Vm).y,b=ve(Vm).height;Wm.style.height=a+b+"px";var c=yn();c&&(A(document.body,"appbar-hidden")?c.style.marginTop=a+b+"px":c.style.marginTop=a+b-40+"px",Dl());bn()}
...
function Mn(a,b){var c=If(b);if(a.Y()>c)return!1;!(b instanceof Kn)&&5<c&&(b=new Kn(b));return Mf(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.lb&&"function"==typeof c.lb?c.lb(a):fa(c)||u(c)?Ua(c,a):xb(c,a)})}
g.za=function(){return this.f.za(!1)};function Nn(){}
;var On={Xe:"atp",af:"ska",Ze:"que",Ye:"mus",$e:"sus"};function Pn(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Kn;this.theme="u";a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",this.username=a.user||"",this.avatar=a.userAvatarUri||"",this.theme=a.theme||"u",this.capabilities=new Kn(Na((a.capabilities||"").split(","),w(wb,On))))}
...
Sn.prototype.parse=function(a){return this.f(a)};function Tn(a,b){fk.call(this);this.f=a||1;this.j=b||m;this.l=v(this.De,this);this.A=x()}
y(Tn,fk);g=Tn.prototype;g.enabled=!1;g.ma=null;function Un(a,b){a.f=b;a.ma&&a.enabled?(a.stop(),a.start()):a.ma&&a.stop()}
g.De=function(){if(this.enabled){var a=x()-this.A;0<a&&a<.8*this.f?this.ma=this.j.setTimeout(this.l,this.f-a):(this.ma&&(this.j.clearTimeout(this.ma),this.ma=null),gk(this,"tick"),this.enabled&&(this.ma=this.j.setTimeout(this.l,this.f),this.A=x()))}};
g.start=function(){this.enabled=!0;this.ma||(this.ma=this.j.setTimeout(this.l,this.f),this.A=x())};
...
y(Wn,rc);g=Wn.prototype;g.Lb=!1;g.ec=0;g.ab=null;g.xd=function(a){this.f=arguments;this.ab||this.ec?this.Lb=!0:Xn(this)};
...
function ko(a){a.lc=x()+a.B;vo(a,a.B)}
...
g.pe=function(){this.jb=null;var a=x();0<=a-this.lc?(2!=this.ib&&this.f.ra(3),oo(this),this.Xa=2,W(),ro(this)):vo(this,this.lc-a)};
...
g.Oc=function(a,b){this.Ea=a.qb;if(0==this.na)if(b){try{var c=this.j.parse(b)}catch(d){c=this.f;c.qa=this.Ea;Eo(c,2);return}this.pb=c[0];this.kb=c[1]}else c=this.f,c.qa=this.Ea,Eo(c,2);else if(2==this.na)if(this.Kb)W(),this.cc=x();else if("11111"==b){if(W(),this.Kb=!0,this.Bb=x(),c=this.Bb-this.cd,!Q||10<=rd||500>c)this.Ea=200,this.ha.cancel(),W(),Fo(this.f,this,!0)}else W(),this.Bb=this.cc=x(),this.Kb=!1};
...
y(Go,fk);var Ho=/^https?$/i,Io=["POST","PUT"];g=Go.prototype;
...
function No(a){return Q&&pd(9)&&"number"==typeof a.timeout&&q(a.ontimeout)}
...
function Po(a,b){if(a.f){Mo(a);var c=a.f,d=a.O[0]?ba:null;a.f=null;a.O=null;b||gk(a,"ready");try{c.onreadystatechange=d}catch(e){}}}
...
y(Uo,uh);function Vo(a,b){uh.call(this,"timingevent",a);this.size=b}
y(Vo,uh);function Wo(a){uh.call(this,"serverreachability",a)}
y(Wo,uh);g=Ro.prototype;g.connect=function(a,b,c,d,e){W();this.Wb=b;this.nb=c||{};d&&q(e)&&(this.nb.OSID=d,this.nb.OAID=e);this.La=new Ao(this);this.La.Xb=null;this.La.j=this.B;this.La.connect(a)};
function Xo(a){Yo(a);if(3==a.f){var b=a.rb++,c=a.Cb.clone();ag(c,"SID",a.l);ag(c,"RID",b);ag(c,"TYPE","terminate");Zo(a,c);b=new eo(a,0,a.l,b,void 0);b.ib=2;b.Ka=gg(c.clone());(new Image).src=b.Ka;b.ub=x();ko(b)}$o(a)}
...
g.Hb=function(a){var b;if(this.T==a)ap(this),this.T=null,b=2;else if(this.da==a)this.da=null,b=1;else return;this.qa=a.qb;if(0!=this.f)if(a.ta)1==b?(x(),gk(To,new Vo(To,a.Ya?a.Ya.length:0)),cp(this),this.A.length=0):gp(this);else{var c=a.Xa,d;if(!(d=3==c||7==c||0==c&&0<this.qa)){if(d=1==b)this.da||this.Na||1==this.f||2<=this.ob?d=!1:(this.Na=uo(v(this.Sc,this,a),ip(this,this.ob)),this.ob++,d=!0);d=!(d||2==b&&hp(this))}if(d)switch(c){case 1:Eo(this,5);break;case 4:Eo(this,10);break;case 3:Eo(this,
...
g.isActive=function(){return!0};function mp(a,b){Tn.call(this);this.B=0;if(ga(a))b&&(a=v(a,b));else if(a&&ga(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.D=a;Ih(this,"tick",v(this.C,this));this.stop();Un(this,5E3+2E4*Math.random())}
y(mp,Tn);mp.prototype.C=function(){if(500<this.f){var a=this.f;24E4>2*a&&(a*=2);Un(this,a)}this.D()};
mp.prototype.start=function(){mp.J.start.call(this);this.B=x()+this.f};
mp.prototype.stop=function(){this.B=0;mp.J.stop.call(this)};function np(a,b){this.M=a;this.A=b;this.l=new H;this.j=new mp(this.Le,this);this.f=null;this.K=!1;this.C=null;this.U="";this.F=this.B=0;this.D=[]}
...
g.Le=function(){this.j.stop();var a=this.f,b=0;a.T&&b++;a.da&&b++;0!=b?this.j.start():this.connect(this.C,this.B)};function rp(){rc.call(this);this.A=new H;sc(this,w(tc,this.A))}
y(rp,rc);rp.prototype.subscribe=function(a,b,c){return this.isDisposed()?0:this.A.subscribe(a,b,c)};
...
;function aq(){}
;function bq(){}
y(bq,aq);bq.prototype.Y=function(){var a=0;Bf(this.za(!0),function(){a++});
return a};
bq.prototype.clear=function(){var a=Cf(this.za(!0)),b=this;z(a,function(a){b.remove(a)})};function cq(a){this.f=a}
...
fq.prototype.j=function(a,b){q(b)?this.f.zd(a,Mj(b)):this.f.remove(a)};
...
function iq(a){return!q(a)||a instanceof hq?a:new hq(a)}
gq.prototype.j=function(a,b){gq.J.j.call(this,a,iq(b))};
gq.prototype.l=function(a){a=gq.J.get.call(this,a);if(!q(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
gq.prototype.get=function(a){if(a=this.l(a)){if(a=a.data,!q(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function jq(a){this.f=a}
y(jq,gq);function kq(a){var b=a.creation;a=a.expiration;return!!a&&a<x()||!!b&&b>x()}
jq.prototype.j=function(a,b,c){if(b=iq(b)){if(c){if(c<x()){jq.prototype.remove.call(this,a);return}b.expiration=c}b.creation=x()}jq.J.j.call(this,a,b)};
...
y(lq,jq);function mq(a,b){var c=[];Bf(b,function(a){var b;try{b=lq.prototype.l.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}q(b)?kq(b)&&c.push(a):c.push(a)},a);
return c}
...
function xq(a,b,c,d){var e=a.f;if(q(d)?d:a.j)e="https://"+a.l+a.A+a.f;return qf(e+b,c||{})}
function yq(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,X:w(a.C,d,!0),onError:w(a.B,e),tb:w(a.D,e)};c&&(a.sa=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Yj(b,a)}
...
y(Jq,rp);Jq.prototype.la=function(){return this.screens};
...
y(Nq,rp);var Oq=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=Nq.prototype;g.start=function(){!this.f&&isNaN(this.j)&&this.Vc()};
...
g.Me=function(a){this.f=null;a.status&&404==a.status?this.l>=Oq.length?this.G("pairingFailed",Error("DIAL polling timed out")):(a=Oq[this.l],this.j=K(v(this.Vc,this),a),this.l++):this.G("pairingFailed",Error("Server error "+a.status))};
...
y(hr,Jq);g=hr.prototype;g.start=function(){ir(this)&&this.G("screenChange");ar()&&jr(this);N(this.f);this.f=K(v(this.start,this),1E4)};
...
y(lr,rp);g=lr.prototype;g.start=function(){var a=parseInt(sq("yt-remote-fast-check-period")||"0",10);(this.B=x()-144E5<a?0:a)?nr(this):(this.B=x()+3E5,qq("yt-remote-fast-check-period",this.B),this.fc())};
...
function nr(a){isNaN(a.l)||N(a.l);a.l=K(v(a.fc,a),0<a.B&&a.B<x()?2E4:1E4)}
...
function rr(a){var b={};z(a.C(),function(a){a.token?b[a.token]=a.id:this.R("Requesting availability of screen w/o lounge token.")});
return b}
...
y(zr,rp);g=zr.prototype;g.Ib=function(a){this.l=a;this.G("sessionScreen",this.l)};
...
g.L=function(){this.hc("");zr.J.L.call(this)};function Br(a,b){zr.call(this,a,b,"CastSession");this.f=null;this.C=0;this.B=null;this.F=v(this.Re,this);this.D=v(this.re,this);this.C=K(v(function(){Cr(this,null)},this),12E4)}
y(Br,zr);g=Br.prototype;g.gc=function(a){if(this.f){if(this.f==a)return;Ar(this,"Overriding cast sesison with new session object");this.f.removeUpdateListener(this.F);this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D)}this.f=a;this.f.addUpdateListener(this.F);this.f.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.D);this.B&&Dr(this);Er(this,"getMdxSessionStatus")};
...
g.hc=ba;g.L=function(){this.info("disposeInternal");N(this.C);this.C=0;this.f&&(this.f.removeUpdateListener(this.F),this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D));this.f=null;Br.J.L.call(this)};
...
function Er(a,b,c){a.info("sendYoutubeMessage_: "+b+" "+Mj(c));var d={};d.type=b;c&&(d.data=c);a.f?a.f.sendMessage("urn:x-cast:com.google.youtube.mdx",d,ba,v(function(){Ar(this,"Failed to send message: "+b+".")},a)):Ar(a,"Sending yt message without session: "+Mj(d))}
...
g.Dc=function(a,b,c,d){tr(this.M,this.j.label,a,this.j.friendlyName,v(function(e){e?b(e):0<=d?(Ar(this,"Screen "+a+" appears to be offline. "+d+" retries left."),K(v(this.Dc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.kd=function(){return this.f};
g.Re=function(a){this.isDisposed()||a||(Ar(this,"Cast session died."),this.ga())};function Fr(a,b){zr.call(this,a,b,"DialSession");this.C=this.K=null;this.O="";this.B=null;this.F=ba;this.D=NaN;this.P=v(this.Ue,this);this.f=ba}
y(Fr,zr);g=Fr.prototype;g.gc=function(a){this.C=a;this.C.addUpdateListener(this.P)};
g.eb=function(a){this.B=a;this.F()};
g.stop=function(){this.f();this.f=ba;N(this.D);this.C?this.C.stop(v(this.ga,this,null),v(this.ga,this,"Failed to stop DIAL device.")):this.ga()};
g.L=function(){this.f();this.f=ba;N(this.D);this.C&&this.C.removeUpdateListener(this.P);this.C=null;Fr.J.L.call(this)};
function Gr(a){a.f=a.M.hd(a.O,a.j.label,a.j.friendlyName,v(function(a){this.f=ba;this.Ib(a)},a),v(function(a){this.f=ba;
this.ga(a)},a))}
g.Ue=function(a){this.isDisposed()||a||(Ar(this,"DIAL session died."),this.f(),this.f=ba,this.ga())};
...
g.bc=function(a){this.O=Cq();if(this.B){var b=new chrome.cast.DialLaunchResponse(!0,Hr(this));a(b);Gr(this)}else this.F=v(function(){N(this.D);this.F=ba;this.D=NaN;var b=new chrome.cast.DialLaunchResponse(!0,Hr(this));a(b);Gr(this)},this),this.D=K(v(function(){this.F()},this),100)};
...
this.bc(b)},this))};function Ir(a,b){zr.call(this,a,b,"ManualSession");this.f=K(v(this.eb,this,null),150)}
y(Ir,zr);Ir.prototype.stop=function(){this.ga()};
Ir.prototype.gc=ba;Ir.prototype.eb=function(){N(this.f);this.f=NaN;var a=Iq(this.M.la(),this.j.label);a?this.Ib(a):this.ga(Error("No such screen"))};
...
Np(Kr),this.j.subscribe("onlineScreenChange",v(this.jd,this)),this.l=Lr(this),chrome.cast.setCustomReceivers(this.l,ba,v(function(a){this.R("Failed to set initial custom receivers: "+Mj(a))},this)),this.G("yt-remote-cast2-availability-change",Mr(this)),b(!0))},this),v(function(a){this.R("Failed to initialize API: "+Mj(a));
b(!1)},this))};
...
ba,v(function(a){this.R("Failed to set initial custom receivers: "+Mj(a))},this)));
...
g.L=function(){this.j.unsubscribe("onlineScreenChange",v(this.jd,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.B);var a=Kr,b=t("yt.mdx.remote.debug.handlers_");Za(b||[],a);tc(this.f);Jr.J.L.call(this)};
...
g.jd=function(){if(!this.isDisposed()){var a=Mr(this);this.l=Lr(this);Nr("Updating custom receivers: "+Mj(this.l));chrome.cast.setCustomReceivers(this.l,ba,v(function(){this.R("Failed to set custom receivers.")},this));
...
function Yr(){Sr("dispose");var a=Zr();a&&a.dispose();$r=null;r("yt.mdx.remote.cloudview.instance_",null,void 0);as(!1);Kc(bs);bs.length=0}
...
function js(a){a.audioTrackId=null;a.A=null;a.f=-1;a.B=0;a.C=x()}
...
function ms(a,b){a.B=b;a.C=x()}
function ns(a){switch(a.f){case 1:return(x()-a.C)/1E3+a.B;case -1E3:return 0}return a.B}
...
hs.prototype.clone=function(){return new hs(qs(this))};function rs(a,b){rp.call(this);this.f=0;this.B=a;this.F=[];this.D=new sp;this.C=NaN;this.l=this.j=null;this.O=v(this.Md,this);this.K=v(this.sb,this);this.M=v(this.Ld,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.jc,this),ts(this))):c=3;0!=c&&(b?this.jc(c):K(v(function(){this.jc(c)},this),0));
us(this,ds())}
y(rs,rp);function vs(a){return new hs(a.B.getPlayerContextData())}
g=rs.prototype;g.play=function(){1==this.f?(this.j?this.j.play(null,ba,v(function(){this.R("Failed to play video with cast v2 channel.");ws(this,"play")},this)):ws(this,"play"),xs(this,1,ns(vs(this))),ys(this)):zs(this,this.play)};
g.pause=function(){1==this.f?(this.j?this.j.pause(null,ba,v(function(){this.R("Failed to pause video with cast v2 channel.");ws(this,"pause")},this)):ws(this,"pause"),xs(this,2,ns(vs(this))),ys(this)):zs(this,this.pause)};
g.stop=function(){if(1==this.f){this.j?this.j.stop(null,ba,v(function(){this.R("Failed to stop video with cast v2 channel.");ws(this,"stopVideo")},this)):ws(this,"stopVideo");
var a=vs(this);ks(a);As(this,a);ys(this)}else zs(this,this.stop)};
g.qc=function(a){1==this.f?ws(this,"addVideos",{listId:a}):zs(this,w(this.qc,a))};
g.Zc=function(a){if(1==this.f){ws(this,"removeVideo",{videoId:a});var b=vs(this);b.j||(b.remove(a),As(this,b))}else zs(this,w(this.Zc,a))};
g.Kc=function(a,b,c){1==this.f?ws(this,"moveVideo",{videoId:a,delta:(b>=c?c:c-1)-b}):zs(this,w(this.Kc,a,b,c))};
g.Hc=function(a){1==this.f?ws(this,"insertVideo",{videoId:a}):zs(this,w(this.Hc,a))};
function Bs(a,b,c,d,e){var f=vs(a);d=d||0;var h={videoId:b,currentIndex:d,listId:e||f.j};os(f,b,d);q(c)&&(ms(f,c),h.currentTime=c);ws(a,"setPlaylist",h);e||As(a,f)}
g.Xc=function(a,b){if(1==this.f){var c=vs(this);os(c,a,b);ws(this,"previous");As(this,c)}else zs(this,w(this.Xc,a,b))};
g.fd=function(a,b){if(1==this.f){var c=vs(this);os(c,a,b);ws(this,"next");As(this,c)}else zs(this,w(this.fd,a,b))};
...
function ts(a){z(["remotePlayerChange","remoteQueueChange"],function(a){this.F.push(this.B.subscribe(a,w(this.ae,a),this))},a)}
function Cs(a){z(a.F,function(a){this.B.unsubscribeByKey(a)},a);
a.F.length=0}
...
function ys(a){N(a.C);a.C=K(v(function(){this.G("remotePlayerChange");this.C=NaN},a),2E3)}
...
function Fs(a){a.C=K(v(function(){this.N("Connecting timeout");this.B(1)},a),2E4)}
function Hs(a){N(a.C);a.C=NaN}
function Js(a){N(a.M);a.M=NaN}
function Ks(a){Is(a);a.S=K(v(function(){Ls(this,"getNowPlaying")},a),2E4)}
function Is(a){N(a.S);a.S=NaN}
function Ms(a){var b=a.f;return!!b.f&&3==b.f.f&&isNaN(a.C)}
g.Rd=function(){this.N("Channel opened");this.W&&(this.W=!1,Js(this),this.M=K(v(function(){this.N("Timing out waiting for a screen.");this.B(1)},this),15E3));
...
this.H.videoIds)?"playlistModified"!=a.action&&"nowPlayingPlaylist"!=a.action||this.G("remoteQueueChange"):this.G("remoteQueueChange");q(f)&&(a=parseInt(f,10),a=isNaN(a)?-1:a,-1==a&&-1E3==this.H.f&&(a=-1E3),0==a&&"0"==h&&(a=-1),c=c||a!=this.H.f,this.H.f=a,1==this.H.f?Ks(this):Is(this));h&&(a=parseInt(h,10),ms(this.H,isNaN(a)?0:a),c=!0);q(k)&&(a=parseInt(k,10),isNaN(a)||(c=c||this.H.volume!=a,this.H.volume=a),q(l)&&(l="true"==l,c=c||this.H.l!=l,this.H.l=l));c&&this.G("remotePlayerChange")}}};
...
Y.prototype.getPlayerContextData=Y.prototype.fa;Y.prototype.Ia=function(a){var b=new hs(a);b.videoId&&b.videoId!=this.H.videoId&&(this.l=b.videoId,N(this.F),this.F=K(v(this.ye,this),5E3));var c=[];this.H.j==b.j&&this.H.videoId==b.videoId&&this.H.index==b.index&&ib(this.H.videoIds,b.videoIds)||c.push("remoteQueueChange");this.H.f==b.f&&this.H.volume==b.volume&&this.H.l==b.l&&ns(this.H)==ns(b)&&Mj(this.H.A)==Mj(b.A)||c.push("remotePlayerChange");this.H.reset(a);z(c,function(a){this.G(a)},this)};
...
return b?b.id:""};
Y.prototype.getOtherConnectedRemoteId=Y.prototype.O;Y.prototype.D=function(){var a=this.f;return a.j.enabled?a.j.B-x():NaN};
...
Y.prototype.reconnect=Y.prototype.Za;function Os(a){N(a.K);a.K=K(v(a.B,a,1),864E5)}
...
function $s(){if(!t("yt.mdx.remote.castv2_")&&!at&&(Va(Xa)&&db(Xa,sq("yt-remote-online-dial-devices")||[]),Ws())){var a=Zs();a?(a.removeReceiverListener("YouTube",bt),a.addReceiverListener("YouTube",bt),Xs("API initialized in the other binary")):(a=new cast.Api,r("yt.mdx.remote.castapi.api_",a,void 0),a.addReceiverListener("YouTube",bt),a.setReloadTabRequestHandler&&a.setReloadTabRequestHandler(function(){K(function(){window.location.reload(!0)},1E3)}),Np(Ys),Xs("API initialized"));
at=!0}}
function ct(a){var b=Ta(Xa,function(b){return b.id==a.id});
0<=b&&(Xa[b]=Aq(a))}
function bt(a){a.length&&Xs("Updating receivers: "+Mj(a));dt(a);P("yt-remote-cast-device-list-update");z(et(),function(a){ft(a.id)});
z(a,function(a){if(a.isTabProjected){var c=gt(a.id);Xs("Detected device: "+c.id+" is tab projected. Firing DEVICE_TAB_PROJECTED event.");K(function(){P("yt-remote-cast-device-tab-projected",c.id)},1E3)}})}
...
var at=!1,Xa=t("yt.mdx.remote.castapi.devices_")||[];r("yt.mdx.remote.castapi.devices_",Xa,void 0);function jt(a){rp.call(this);this.B=0;this.Ga=kt();this.C=NaN;this.D=a;this.N("Initializing local screens: "+$p(this.Ga));this.l=lt();this.N("Initializing account screens: "+$p(this.l));this.Tb=null;this.f=[];this.j=[];mt(this,et()||[]);this.N("Initializing DIAL devices: "+Bq(this.j));a=Yp(cr());nt(this,a);this.N("Initializing online screens: "+$p(this.f));this.B=x()+3E5;ot(this)}
y(jt,rp);g=jt.prototype;g.N=function(a){Qp("RM",a)};
...
O("yt-remote-cast-device-status-update",a.He,a);a.Yc();var b=x()>a.B?2E4:1E4;zc(v(a.Yc,a),b)}
...
function mt(a,b){var c=!1;z(b,function(a){var b=Iq(this.Ga,a.id);b&&b.name!=a.name&&(this.N("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
...
var e={method:"POST",sa:{lounge_token:c.join(",")},context:a,X:function(a,b){var c=[];z(b.screens||[],function(a){"online"==a.status&&c.push(d[a.loungeToken])});
...
ut(this);rt(this,b)}}))}
function wt(a,b){z(bb(a.Ga,a.l),function(a){var d=Sa(b,function(b){return a.id==b.screenId});
...
y(xt,Jq);g=xt.prototype;g.la=function(a){return this.ea.$_gs(a)};
...
X.prototype.$_st=X.prototype.start;X.prototype.$_gspc=X.prototype.Qe;X.prototype.$_gsppc=X.prototype.hd;X.prototype.$_c=X.prototype.contains;X.prototype.$_g=X.prototype.get;X.prototype.$_a=X.prototype.Pb;X.prototype.$_un=X.prototype.Mb;X.prototype.$_r=X.prototype.remove;X.prototype.$_gs=X.prototype.la;X.prototype.$_gos=X.prototype.gd;X.prototype.$_s=X.prototype.subscribe;X.prototype.$_ubk=X.prototype.va;function zt(a,b,c){a?r("yt.mdx.remote.castv2_",!0,void 0):$s();pq&&oq();Qq();At||(At=new wq,gr()&&(At.f="/api/loungedev"));Bt||a||(Bt=new jt(At),Bt.subscribe("screenPair",Ct),Bt.subscribe("managedScreenChange",Dt),Bt.subscribe("onlineReceiverChange",function(){P("yt-remote-receiver-availability-change")}));
Et||(Et=t("yt.mdx.remote.deferredProxies_")||[],r("yt.mdx.remote.deferredProxies_",Et,void 0));Ft(b);b=Gt();if(a&&!b){var d=new X(At);r("yt.mdx.remote.screenService_",d,void 0);b=Gt();Qr(d,function(a){a?Ht()&&es(Ht(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){P("yt-remote-receiver-availability-change")})},!(!c||!c.loadCastApiSetupScript))}if(c&&!t("yt.mdx.remote.initialized_")){r("yt.mdx.remote.initialized_",!0,void 0);
...
function Rt(){if(Bt){var a=Bt;N(a.C);a.C=NaN}a:{if(a=Tt())if(a=a.getOtherConnectedRemoteId()){It("Do not stop DIAL due to "+a);Ut();break a}(a=t("yt.mdx.remote.currentDialId_"))?(It("Stopping DIAL: "+a),it(a),Ut()):(a=Qt())&&a.f&&(It("Stopping DIAL: "+a.f),it(a.f))}fs()?Zr().stopSession():Wr("stopSession called before API ready.");(a=Tt())?a.disconnect(1):(Lc("yt-remote-before-disconnect",1),Lc("yt-remote-connection-change",!1));Vt(null)}
...
function Zt(a){r("yt.mdx.remote.currentScreenId_",a,void 0);if(Bt){var b=Bt;b.B=x()+3E5;if((b.Tb=a)&&(a=vt(b,a))&&!Hq(b.f,a)){var c=cb(b.f);c.push(a);nt(b,c,!0)}}}
...
function St(a,b){Ka(!Ht());Zt(a.id);var c=new Y(At,a,Nt());c.connect(b,t("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){Lc("yt-remote-before-disconnect",a)});
...
var Jt=[];function $t(a){ok.call(this);this.K={Gb:a.Gb,Fb:v(function(){fh.getInstance().bb(this.wa());ga(a.Fb)&&a.Fb()},this)};
this.A=this.l=null}
y($t,ok);$t.prototype.Ca=function(){$t.J.Ca.call(this);this.l=R(F(this.wa(),"dialog-id"));if(!this.l)throw Error("Cannot find create playlist widget dialog.");lk(this).Fa(document,"click",this.D);var a=O("yt-uix-card-show",v(this.F,this));this.fa.push(a);a=S("create-playlist-widget-form",this.l);this.A=new Ik(this.K);mk(this.A,a)};
...
function tu(a,b,c){ou&&1==ou.f&&(a.call(m),c&&K(function(){c()},0),q(b)&&P("queue-change",b))}
...
onError:function(){}})}
var Gu=[];var Hu;function Iu(){if(!Hu){var a=R("watch-queue");if(!a)return[];Hu=S("watch-queue-items-list",a)}var b=[],a=Rd(Hu);z(a,function(a){(a=F(a,"video-id"))&&b.push(a)});
return b}
...
Lu.push($e(null,"click",Ru,"watch-queue-video-menu-choice"));Lu.push($e(null,"click",Su,"watch-queue-menu-choice"));fu=new zk(R("watch-queue-count-msg").innerHTML,["count","total"]);gu=Ck(R("watch-queue-loading-template"));Tu=0;cu=!1;var a=R("watch-queue-save-as-playlist-widget");a&&(eu=new $t({Gb:Uu}),mk(eu,a));bu=null;zt(!!J("MDX_ENABLE_CASTV2"),!0,{device:"Desktop",app:"youtube-desktop",isSignedIn:J("LOGGED_IN")});zt(!!J("MDX_ENABLE_CASTV2"),!!J("MDX_ENABLE_QUEUE"));Gu.push(O("yt-remote-connection-change",
...
function gv(){var a=!1;if(!V||!wg(rb)||!J("PAGE_NAME"))return hv(),a;var b=iv(),c=jv();kv()&&c&&b!=c&&(lv(c),b=c);c=!!J("LIST_ID");if(b=kv()&&!!b&&(b==J("VIDEO_ID")||b==du)&&!c){var d=R("player-playlist");d&&!fv()&&(C(rb,"mole-notification"),Od(d,Xd,0),P("watch-queue-show",1),mv(),a=!0)}else Wd()!=rb&&(rb.appendChild(Xd),P("watch-queue-show",0),Ju(),a=!0);d=R("placeholder-playlist");b||c?yg(d):zg(d);hv();return a}
function lv(a){if(bu){var b=!!V,c=b&&!(a&&(a==J("VIDEO_ID")||a==du));pj(c);b&&kv()&&(c?P("watch-queue-show",0):P("watch-queue-show",1));if(bu.isReady())bu.loadVideoById(a);else{var d=function(){bu.loadVideoById(a);bu.removeEventListener("onReady",d)};
...
function Wu(){C(rb,"mole-notification");du="";mj();gv();var a=bu;a&&a.addEventListener("onStateChange",nv)}
function Xu(){sb(rb,"mole-expanded","mole-collapsed");var a=bu;a&&a.removeEventListener("onStateChange",nv)}
function kv(){return"watch"==J("PAGE_NAME")}
function tv(a){if(a!=ov()){var b=Iu(),c=b[0];uv()&&(c=b[vv()+1]);if(a!=c)if(Ua(b,a)){var d=La(b,a),b=La(b,c);vu(a,d,b)}else wu(a)}}
function Mu(a){if(a.currentTarget==ku){if(rv()){var b=Rd(Z);a=vv();b=b.length;a=(b+a-1)%b;wv(a);mv();(b=ov())&&V&&V.Xc(b,a)}}else if(a.currentTarget==lu)rv()&&(a=Rd(Z),a=(vv()+1)%a.length,wv(a),mv(),(b=ov())&&V&&V.fd(b,a));else if(a.currentTarget==mu)zg(mu),yg(nu),V?(a=Iu(),!jv()&&a[0]?Bs(V,a[0]):V.play()):bu&&bu.playVideo();else if(a.currentTarget==nu)zg(nu),yg(mu),V?V.pause():bu&&bu.pauseVideo();else if(A(a.currentTarget,"remove-item-watch-queue-button")){if(a=ce(a.currentTarget,"watch-queue-item"),
b=F(a,"video-id"))B(a,"fade-out"),ru(b)}else A(a.currentTarget,"expand-video-watch-queue-button")&&xv(a.currentTarget)}
function Su(a){var b=F(a.currentTarget,"action");yv[b](a.currentTarget);a=a||window.event;a.cancelBubble=!0;a.stopPropagation&&a.stopPropagation();Yg(Wg.getInstance(),ju)}
function Ou(a){Wd()==rb&&a.currentTarget==hu&&(a=bf(a),a&&A(a,"overflow-menu-choice")||(qb("mole-expanded"),qb("mole-collapsed")))}
function Ru(a){var b=F(a.currentTarget,"action");zv[b](a.currentTarget)}
function Pu(){C(rb,"mole-notification");A(rb,"mole-expanded")&&Ju();Yg(Wg.getInstance(),ju)}
function Qu(a){A(a.currentTarget,"fade-out")&&(Pd(a.currentTarget),pv(jv()),Av());Ju()}
function Nu(a){a=ce(a.currentTarget,"watch-queue-item");if(!A(a,"currently-playing")){var b=Rd(Z),b=La(b,a);wv(b);(a=F(a,"video-id"))&&V&&Bs(V,a,0,b)}}
...
function ov(){var a=S("currently-playing",Z);return a?F(a,"video-id")||"":""}
function pv(a){a=La(Iu(),a);0<=a?uv()&&vv()==a||(wv(a),mv()):Cv()}
function wv(a){if(rv()){Cv();var b=Rd(Z);b[a]&&B(b[a],"currently-playing");Dv()}}
function Cv(){if(rv()){var a=S("currently-playing",Z);a&&C(a,"currently-playing");Dv()}}
...
function av(){wg(rb)&&B(rb,"mole-notification")}
...
function Dv(){var a=Iu().length,b=1>=a,c=uv()?vv():-1;ku.disabled=b||0==c;lu.disabled=b||c==a-1;Ev();if(0!=a){var d=null,a=Rd(Z);z(a,function(a){var b=F(a,"video-id"),c=S("play-next",a),k=S("goto-video-page",a);pb(k,"disabled",kv()&&b==J("VIDEO_ID")&&!J("LIST_ID"));A(a,"currently-playing")?(d=a,zg(c)):d?(d=null,pb(c,"disabled",!0)):pb(c,"disabled",!1)})}}
function Av(){Dv();Va(Iu())?Fv():Gv();P("watch-queue-update")}
function Hv(){Tu=0;N(Iv);Iv=NaN}
function Jv(){cu=!1;isNaN(Iv)&&(Iv=K(function(){Iv=NaN;Tu++;Kv()},Math.min(3E4,1E3*Math.pow(2,Tu))))}
function rv(){var a=Sd(Z);return!!a&&A(a,"watch-queue-item")}
...
function Lv(a,b){cu=!1;if(Z&&b&&(b.html||!jv())&&(Hv(),V)){var c=Iu(),d=[],e=Md(b.html),f=Na(e.childNodes,function(a){return ha(a)&&1==a.nodeType});
z(f,function(a){a=F(a,"video-id");d.push(a)});
0==c.length&&Nd(Z);if(0==d.length)Nd(Z),P("watch-queue-empty"),Av();else if(!ib(c,d)){if(d.length==c.length+1){for(var h=0;h<c.length&&c[h]==d[h];)h++;var k=cb(c);eb(k,h,0,d[h]);if(ib(k,d)){Od(Z,f[h],h);B(f[h],"fade-in");K(function(){C(f[h],"fade-in")},0);
pv(jv());Ju();Av();return}}if(d.length==c.length-1){for(e=0;e<d.length&&c[e]==d[e];)e++;k=cb(c);$a(k,e);if(ib(k,d)){c=Rd(Z);B(c[e],"fade-out");pv(jv());return}}Nd(Z);Va(f)||(z(f,function(a){Z.appendChild(a)}),Ju(),pv(jv()));
Av()}}}
...
function Mv(a){kv()&&(a!=J("VIDEO_ID")||J("LIST_ID")?(K(function(){Bv(a)},100),du=a):gv())}
function Yu(a){Nv=a}
...
function Fv(){Wd()!=rb&&rb.appendChild(Xd);var a=R("placeholder-playlist");J("LIST_ID")?yg(a):zg(a);sb(rb,"mole-expanded","mole-collapsed");zg(rb);hv();P("watch-queue-hide",0)}
...
function Uv(a,b){var c=S("yt-picker-content",a);if(c){var d=Bd(null,"yt-picker-section",c);z(d,v(Vv,null,Math.floor((b||c.offsetWidth)/180)))}else Ac(Error(".yt-picker-content missing"),"WARNING")}
...
r("yt.www.masthead.dismissCookieAlert",function(){tg("GC_OK",void 0);Wh.getInstance();bi(110,!0);wf("PREF",ci(),63072E3,"/")},void 0);
r("yt.www.masthead.dismissReturnToMobileMessage",function(){tg("NO_MWEB",void 0);zg(R("return-to-mobile"))},void 0);
r("yt.www.masthead.handleAccountPickerClick",function(){var a=R("yt-masthead-multilogin");if(F(a,"loaded"))Nm();else{var b=Bm();b[J("XSRF_FIELD_NAME",void 0)]=J("XSRF_TOKEN",void 0);spf.load("/delegate_account_ajax",{method:"POST",postData:pf(b),onDone:function(){$b(a,"loaded","true");Nm()}})}},void 0);
r("yt.www.masthead.loadSearchbox",Pm,void 0);r("yt.net.cookies.set",wf,void 0);r("yt.net.cookies.remove",xf,void 0);r("yt.www.picker.load",function(a){var b=F(a,"picker-key"),c=F(a,"picker-position"),d="yt-picker-"+b+"-"+c;if(c=R(d))a=F(a,"button-menu-id")==d,d=F(c,"loaded"),Sv(c,b,!!a,!!d)},void 0);
r("yt.www.picker.displayLang",function(){Rv("language")},void 0);
r("yt.www.picker.applyGrid",Uv,void 0);
r("ytbin.www.pageframe.setup",function(){Zc("GUIDE_DELAYLOADED_CSS");Zc("PAGE_FRAME_DELAYLOADED_CSS",w(C,document.body,"delayed-frame-styles-not-in"),J("WAIT_TO_DELAYLOAD_FRAME_CSS")?"yt-www-pageFrameCssNotifications-load":null);Ge=R("a11y-announcements-container");He=R("a11y-announcements-message");O("a11y-announce",ff);O("init",cf);if(df=R("a11y-skip-nav"))cf(),T(df,"click",ef);null!=Ie||Je();Ie&&(nb(document.body,["yt-high-contrast-mode","yt-high-contrast-mode-"+Ie]),Zc("HIGH_CONTRAST_MODE_CSS"));
S("guide-module-loading")||ql();Aj();Rk=S("yt-masthead-user-icon");$e(R("ticker"),"click",Om,"yt-uix-close");S("exp-searchbox-redesign")&&(T(R("yt-masthead-content"),"click",Sm),T(R("masthead-search-term"),"keyup",Tm));J("SANDBAR_ENABLED")&&Mm();Pm();$m();(rb=R("watch-queue-mole"))?Ku():J("MDX_ENABLE_CASTV2")&&zt(!0,!1,{device:"Desktop",app:"youtube-desktop",isSignedIn:J("LOGGED_IN")});J("YOODLE_IS_ANIMATED")&&Oc(J("YOODLE_JS_URL",void 0),function(){t("yt.www.masthead.AnimatedYoodle.init")(J("YOODLE_ANIMATION_FRAMES"),
J("YOODLE_ANIMATION_DURATION"),J("YOODLE_ANIMATION_DELAY"),J("YOODLE_STOP_ON_LAST_FRAME"))});
J("SAFETY_MODE_PENDING")&&Rv("safetymode")},void 0);
