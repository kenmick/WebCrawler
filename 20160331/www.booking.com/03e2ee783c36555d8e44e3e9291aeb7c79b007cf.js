...
if(!a(k)){return _r_( k);
}if(k.forEach){k.forEach(function(l,i,m){_i_("96bbb:534");j.call(g,l,i,m)
;_r_()})
}else{for(f=0,h=k.length;
f<h;
++f){j.call(g,k[f],f,k)
}}return _r_( k);
}function c(h,g){_i_("96bbb:74");var f=b(h,function(i){_i_("96bbb:509");return _r_( i===g);
});
return _r_((f>-1)?true:false);
}return _r_({each:d,find:e,findIndex:b,isArray:a,contains:c});
});
B.atlas.define("util-getset",function(){_i_("96bbb:4");function a(b){_i_("96bbb:75");this.set=function(c,d){_i_("96bbb:367");if(c){b[c]=d;
return _r_( d);
}return _r_( undefined);
};
this.get=function(c){_i_("96bbb:368");return _r_( c?b[c]:undefined);
}
;_r_()}return _r_( a);
});
...
}var l=function(p,q,o){_i_("96bbb:369");var n="success";
o.success.call(o.context,p,n,q);
d(n,q,o)
;_r_()};
var j=function(n,p,q,o){_i_("96bbb:370");o.error.call(o.context,q,p,n);
d(p,q,o)
;_r_()};
var d=function(n,p,o){_i_("96bbb:371");o.complete.call(o.context,p,n)
;_r_()};
m.onload=function(){_i_("96bbb:372");var n,o;
...
m.onerror=function(){_i_("96bbb:373");j(null,"error",m,e);
return _r_();
};
m.open(e.type,e.url);
...
function h(){_i_("96bbb:310");if(a.SUBSCRIPTIONS&&b.jst){n={};
j.each(a.SUBSCRIPTIONS,function(o,p){_i_("96bbb:552");j.each(p,function(q,r){_i_("96bbb:590");if(r.name&&r.touched===true){n[r.name]=b.jst[r.name]
};_r_()})
;_r_()})
}return _r_( n);
}function f(){_i_("96bbb:311");j.post(m,{sid:l.b_sid,pid:l.pageview_id,context:"atlas",data:JSON.stringify({metrics:i.metrics,actions:i.actions,experiments:h()})});
i={metrics:[],actions:[]}
;_r_()}function g(q,p){_i_("96bbb:312");var r,o=window.performance&&window.performance.now?window.performance.now():new Date().getTime();
if(c){clearTimeout(c)
}p=p||"";
...
if(!f){return _r_();
}B.atlas.require(["polygons"],function(h){_i_("96bbb:374");h.createPolygon.call(e,{clickable:false,fillColor:"#ff0000",fillOpacity:0.1,strokeColor:"#ff0000",strokeOpacity:0.5,strokeWeight:1,paths:[f.ne,[f.sw[0],f.ne[1]],f.sw,[f.ne[0],f.sw[1]]]});
...
k.set=function(o,p){_i_("96bbb:375");if(o){i[o]=p;
return _r_( p);
}return _r_( f);
};
k.get=function(o){_i_("96bbb:376");return _r_( o?i[o]:f);
};
d.extend(k,new a(k));
k.trigger("pre-init");
k.$domNode=d(j.options.domNode);
function l(o){_i_("96bbb:319");setTimeout(function(){_i_("96bbb:538");n=true;
k.Interface=o;
k.trigger("ready",k)
;_r_()},4)
;_r_()}h.unshift(m,"center","options","analytics","goals");
h.push("debug");
B.atlas.require(h,function(s){_i_("96bbb:377");var p,o,r,q=[].slice.call(arguments,1);
for(p=0,o=q.length;
p<o;
++p){r=q[p];
...
s.init(k,i,l)
;_r_()});
k.done=function g(o){_i_("96bbb:378");if(n){o.call(k)
}else{k.on("ready",o)
};_r_()};
...
k.initialize(l,i,h)
}g.prototype.initialize=function(m,i,h){_i_("96bbb:320");var k=this,j=k.get("isInitialized"),l=this.get("domNode");
if(j){return _r_( false);
}b(l,k);
i.unshift(m);
B.atlas.require(i,function(n){_i_("96bbb:539");c.each([].slice.call(arguments,1),function(o){_i_("96bbb:585");if(o&&o.init){o.init.call(k)
}else{if(o){f.extend(k,o)
}};_r_()});
k.trigger("api-before-load");
n.init(k,h,function(o){_i_("96bbb:586");setTimeout(function(){_i_("96bbb:597");k.set("hasLoaded",true);
k.Interface=o;
k.trigger("ready",k)
;_r_()},4)
;_r_()})
...
g.prototype.done=function(h){_i_("96bbb:321");if(this.get("hasLoaded")){h.call(this)
...
function j(r){_i_("96bbb:322");if(o){console.debug("Atlas event: "+r)
};_r_()}function h(u,t){_i_("96bbb:323");var s=this,r=[];
t=t||null;
j(u);
if(m.hasOwnProperty(u)){b.each(m[u],function(v,w){_i_("96bbb:562");w.handler.call(s,t,w.args,u);
if(w.once){r.push([u,w.handler])
};_r_()});
b.each(r,function(v,w){_i_("96bbb:563");p(w[0],w[1])
;_r_()})
}if(d){B.atlas.track(u,d.get("id"))
}if(n.hasOwnProperty(u)){b.each(n[u],function(v,w){_i_("96bbb:564");w.handler.call(s,t,w.args,u)
;_r_()})
};_r_()}function i(s,u,r,t){_i_("96bbb:324");s=(s&&typeof s==="string")?[s]:s;
b.each(s,function(w,v){_i_("96bbb:540");if(t){n[v]=n[v]||[];
n[v].push({handler:u,args:r||null})
}else{m[v]=m[v]||[];
m[v].push({handler:u,args:r||null})
};_r_()})
;_r_()}function e(s,t,r){_i_("96bbb:325");s=(s&&typeof s==="string")?[s]:s;
b.each(s,function(v,u){_i_("96bbb:541");m[u]=m[u]||[];
m[u].push({handler:t,args:r||null,once:true})
;_r_()})
;_r_()}function p(r,s){_i_("96bbb:326");if(m.hasOwnProperty(r)&&(!s||s===true)){m[r]=[]
}else{if(m.hasOwnProperty(r)){m[r]=b.grep(m[r],function(t){_i_("96bbb:591");return _r_( t.handler!==s);
})
}};_r_()}function g(r){_i_("96bbb:327");return _r_( m[r]||[]);
}function l(){_i_("96bbb:328");var r=[];
b.each(m,function(s){_i_("96bbb:542");r.push(s)
;_r_()});
return _r_( r);
}function k(r){_i_("96bbb:329");o=r;
return _r_( o);
}i([c.MARKERS_SHOW,c.TILES_LOAD],function(t,s,r){_i_("96bbb:379");if(r===c.MARKERS_SHOW&&q&&!f){h(c.LOAD,d.get("id"))
...
B.atlas.require(l,function(){_i_("96bbb:380");var m=m=[].slice.call(arguments,0);
c.extend.apply(j,[j].concat(m));
h(j)
;_r_()},null,true)
;_r_()}d.prototype.done=function(j){_i_("96bbb:330");j.call(this)
;_r_()};
return _r_( d);
});
jQuery.extend(B.atlas,(function(i,d){_i_("96bbb:66");var b=null,g=null;
function c(){_i_("96bbb:313");b=null;
g=null
;_r_()}function j(){_i_("96bbb:314");var k=d.atlas.SUBSCRIPTIONS;
b={};
g={};
if(!k||!d.jst){return _r_();
}i.each(k,function(l,m){_i_("96bbb:511");i.each(m,function(n,q){_i_("96bbb:579");try{if(q.name&&q.cond&&d.jst.hasOwnProperty(q.name)&&q.old){b[q.name]=parseInt(d.jst[q.name],10);
...
;_r_()})
}function a(k){_i_("96bbb:315");if(!b){j()
}return _r_( b.hasOwnProperty(k)?b[k]:false);
}function e(l,m){_i_("96bbb:316");var n=[],k=[],o=d.atlas.SUBSCRIPTIONS;
if(!o||!l||!o.hasOwnProperty(l)){return _r_( false);
}o[l].forEach(function(p){_i_("96bbb:512");if(a(p.name)!==false&&!p.touched&&m===p.instanceId){if(p.stage){if(g[p.name]){d.et.stage(p.name,p.stage)
...
}k.forEach(function(p){_i_("96bbb:513");d.track.stage.apply(null,p)
;_r_()})
}function h(m,k){_i_("96bbb:317");var n=d.atlas.SUBSCRIPTIONS,l=n&&n.templates?n.templates:[];
l.some(function(o){_i_("96bbb:514");if(o.name===m&&a(o.name)!==false){if(g[o.name]){d.et.stage(o.name,k||o.stage)
}else{d.track.stage(m,k||o.stage)
}return _r_( true);
}return _r_( false);
});
return _r_( true);
}function f(l){_i_("96bbb:318");var m=d.atlas.SUBSCRIPTIONS,k=m&&m.templates?m.templates:[];
k.some(function(n){_i_("96bbb:515");if(n.name===l&&a(n.name)!==false){if(!n.touched){if(g[n.name]){d.et.track(n.name)
}else{d.track.exp(l)
}n.touched=true
}return _r_( true);
}return _r_( false);
...
return _r_( a(l));
}d.run("Xfgrwdtafew").onLoad(function(){_i_("96bbb:363");if(!b){j()
};_r_()});
...
this.extend(f)
};_r_()}a.prototype={extend:function(h){_i_("96bbb:381");var f=d(h),e=this.sw,g=this.ne;
...
},reset:function(){_i_("96bbb:382");this.ne=this.sw=null
;_r_()},getNorthEast:function(){_i_("96bbb:383");return _r_( this.ne||new c(0,0));
},getSouthWest:function(){_i_("96bbb:384");return _r_( this.sw||new c(0,0));
},setNorthEast:function(e){_i_("96bbb:385");this.ne=d(e)
;_r_()},setSouthWest:function(e){_i_("96bbb:386");this.sw=d(e)
;_r_()},getCenter:function(){_i_("96bbb:387");return _r_( new c((this.sw.lat+this.ne.lat)/2,(this.sw.lng+this.ne.lng)/2));
},isEmpty:function(){_i_("96bbb:388");return _r_((!this.sw&&!this.ne)||(this.sw.toString()===this.ne.toString()));
},equals:function(e){_i_("96bbb:389");return _r_( e instanceof a?this.toString()===e.toString():false);
},intersects:function(g){_i_("96bbb:390");var e=this.sw,i=this.ne,f=g.sw,h=g.ne;
return _r_( h.lat>=e.lat||f.lat<=i.lat||h.lng>=e.lng||f.lng<=i.lng);
},union:function(e){_i_("96bbb:391");this.extend(e.getSouthWest());
this.extend(e.getNorthEast());
return _r_( this);
},contains:function(g){_i_("96bbb:392");var i,f,e,h;
...
},toMOMString:function(){_i_("96bbb:393");b(this.sw);
b(this.ne);
return _r_([this.sw.lng,this.sw.lat,this.ne.lng,this.ne.lat].join(","));
},toString:function(){_i_("96bbb:394");b(this.sw);
b(this.ne);
...
this.lng=+b||0
}};_r_()}a.prototype={set:function(c,b){_i_("96bbb:395");this.lat=+c;
this.lng=+b;
return _r_( this);
},clone:function(){_i_("96bbb:396");return _r_( new a(this.lat,this.lng));
},toString:function(){_i_("96bbb:397");return _r_(["[",this.lat,",",this.lng,"]"].join(""));
}};
return _r_( a);
});
...
;_r_()}f.prototype={extend:function(h){_i_("96bbb:398");this.bounds.extend(h);
this.zoom=false;
return _r_( this);
},extrapolate:function(i,l){_i_("96bbb:399");var k=new d(i),m=b.latLngToPoint(k,l),n=new e(this.width/2,this.height/2),h=new e(m.x+n.x,m.y-n.y),j=new e(m.x-n.x,m.y+n.y);
this.setNorthEast(b.pointToLatLng(h,l));
this.setSouthWest(b.pointToLatLng(j,l));
return _r_( this);
},getCenter:function(k){_i_("96bbb:400");var i=this.bounds.getCenter(),j=this.getZoom(),h;
if(k){h=b.latLngToPoint(i,j).subtract(k);
i=b.pointToLatLng(h,j)
}return _r_( i);
},getNorthWest:function(){_i_("96bbb:401");var h=this.bounds.getCenter(),j=this.getZoom(),l=new e(this.width/2,this.height/2),k=b.latLngToPoint(h,j),i=k.subtract(l);
return _r_( b.pointToLatLng(i,j));
},getSouthEast:function(){_i_("96bbb:402");var i=this.bounds.getCenter(),j=this.getZoom(),l=new e(this.width/2,this.height/2),k=b.latLngToPoint(i,j),h=k.add(l);
return _r_( b.pointToLatLng(h,j));
},setNorthEast:function(h){_i_("96bbb:403");this.bounds.setNorthEast(h)
;_r_()},setSouthWest:function(h){_i_("96bbb:404");this.bounds.setSouthWest(h)
;_r_()},getZoom:function(h,m){_i_("96bbb:405");var q=h||g,j=true,i=this.bounds.getNorthEast(),n=this.bounds.getSouthWest(),k=new d(i.lat,n.lng),l=new d(n.lat,i.lng),o,p;
if(!this.zoom){m=m||a;
...
},latLngToPixel:function(j){_i_("96bbb:406");var i=this.getZoom(),h=b.latLngToPoint(this.getNorthWest(),i);
return _r_( b.latLngToPoint(j,i).subtract(h));
},pixelToLatLng:function(h){_i_("96bbb:407");var j=this.getZoom(),i=b.latLngToPoint(this.getNorthWest(),j);
return _r_( b.pointToLatLng(h.add(i),j));
},getDistance:function(i,h){_i_("96bbb:408");return _r_( b.getDistance(i,h));
},toString:function(){_i_("96bbb:409");return _r_( this.bounds.toString());
}};
return _r_( f);
});
B.atlas.define("geometry.point",function(){_i_("96bbb:16");function a(b,c){_i_("96bbb:103");this.x=+b;
this.y=+c
;_r_()}a.prototype={set:function(b,c){_i_("96bbb:410");this.x=+b;
this.y=+c;
return _r_( this);
},clone:function(){_i_("96bbb:411");return _r_( new a(this.x,this.y));
},add:function(b){_i_("96bbb:412");return _r_( new a(this.x+b.x,this.y+b.y));
},subtract:function(b){_i_("96bbb:413");return _r_( new a(this.x-b.x,this.y-b.y));
},toString:function(){_i_("96bbb:414");return _r_(["[",this.x,",",this.y,"]"].join(""));
}};
return _r_( a);
});
...
;_r_()}return _r_({init:function(){_i_("96bbb:364");var e=this;
if(!B.atlas){return _r_();
}d.each(a,function(g,h){_i_("96bbb:553");var f={topic:h.evt,value:h.value||""};
...
b=[{evt:"load",name:"atlas_hp_open",condition:a.hp,filter:function(e){_i_("96bbb:516");if(e==="tdotPOI"){return _r_( false);
}return _r_( true);
}},{evt:"load",name:"atlas_sr_open",condition:a.sr},{evt:"load",name:"atlas_lp_open",condition:a.lp},{evt:"close",name:"atlas_hp_close",condition:a.hp},{evt:"close",name:"atlas_sr_close",condition:a.sr},{evt:"close",name:"atlas_lp_close",condition:a.lp},{evt:"marker-click",name:"atlas_hp_click_property",condition:a.hp,filter:function(e){_i_("96bbb:517");return _r_( !/city|airport/.test(e.type));
}},{evt:"marker-click",name:"atlas_sr_click_property",condition:a.sr,filter:function(e){_i_("96bbb:518");return _r_( !/city|airport|vpm/.test(e.type));
}},{evt:"marker-click",name:"atlas_lp_click_property",condition:a.lp,filter:function(e){_i_("96bbb:519");return _r_( !/city|airport/.test(e.type));
}},{evt:"marker-click",name:"atlas_hp_click_ufi",condition:a.hp,filter:function(e){_i_("96bbb:520");return _r_(/city/.test(e.type));
}},{evt:"marker-click",name:"atlas_sr_click_ufi",condition:a.sr,filter:function(e){_i_("96bbb:521");return _r_(/city/.test(e.type)&&!/vpm/.test(e.type));
}},{evt:"marker-click",name:"atlas_sr_click_airport",condition:a.sr,filter:function(e){_i_("96bbb:522");return _r_(/airport/.test(e.type));
}},{evt:"marker-click",name:"atlas_lp_click_ufi",condition:a.lp,filter:function(e){_i_("96bbb:523");return _r_(/city/.test(e.type));
}},{evt:"marker-click",name:"atlas_lp_click_airport",condition:a.lp,filter:function(e){_i_("96bbb:524");return _r_(/airport/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_hp_hover_property",condition:a.hp,filter:function(e){_i_("96bbb:525");return _r_( !/city|airport/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_sr_hover_property",condition:a.sr,filter:function(e){_i_("96bbb:526");return _r_( !/city|airport/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_lp_hover_property",condition:a.lp,filter:function(e){_i_("96bbb:527");return _r_( !/city|airport/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_hp_hover_ufi",condition:a.hp,filter:function(e){_i_("96bbb:528");return _r_(/city/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_sr_hover_ufi",condition:a.sr,filter:function(e){_i_("96bbb:529");return _r_(/city/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_sr_hover_airport",condition:a.sr,filter:function(e){_i_("96bbb:530");return _r_(/airport/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_lp_hover_ufi",condition:a.lp,filter:function(e){_i_("96bbb:531");return _r_(/city/.test(e.type));
}},{evt:"marker-hover-triggered",name:"atlas_lp_hover_airport",condition:a.lp,filter:function(e){_i_("96bbb:532");return _r_(/airport/.test(e.type));
}}];
...
}return _r_({init:function(){_i_("96bbb:365");var e=this;
if(this.get("id")){return _r_();
}d.each(b,function(g,f){_i_("96bbb:554");if(f.condition){e.on(f.evt,c,f,true)
};_r_()})
}});
});
$(function(){_i_("96bbb:24");if(!B.atlas){return _r_();
}B.atlas.define("iw-ajax",["jQuery","util-env","util-array"],function(b,d,j){_i_("96bbb:331");var c=[],a=[];
function i(n,q){_i_("96bbb:415");var m=j.findIndex(c,function(r){_i_("96bbb:580");return _r_( r[0]===n);
}),p=c[m],o;
if(m>-1){o=p[2];
if(p[1]!=q){o.abort();
c.splice(m);
...
return _r_( l);
}}function k(m){_i_("96bbb:416");var l=j.findIndex(c,function(o){_i_("96bbb:581");return _r_( o[0]===m);
}),n=c[l];
if(typeof n=="object"){n[3].length=0
};_r_()}function g(m){_i_("96bbb:417");var l=this.get("markerDetailsURL");
if(!l){l=d.get("markerDetailsURL");
this.set("markerDetailsURL",l)
}return _r_( l+";hotel_id="+m);
}function e(n){_i_("96bbb:418");var m,l=this;
m=j.find(a,function(o){_i_("96bbb:582");return _r_( o[0]===l&&o[1]==n);
});
return _r_((m)?m[2]:false);
}function h(s,r,l){_i_("96bbb:419");var q,m=g.call(this,s),p=this,n=e.call(p,s),o=i(p,s);
o=o||[];
o[3]=o[3]&&o[3].length>0&&o[1]==s?o[3]:[];
o[3].push(r);
if(!l&&n){j.each(o[3],function(t){_i_("96bbb:587");if(typeof t==="function"){t.apply(p,[n])
};_r_()});
k(p);
return _r_( n);
}if(o[3].length>1){return _r_();
}p.trigger("iw-get-before",p);
q=b.ajax({url:m,error:function(u,t){_i_("96bbb:592");if(t!=="abort"){p.trigger("iw-get-fail",p)
};_r_()},success:function(u){_i_("96bbb:593");if(!u){return _r_();
}var v=j.find(c,function(w){_i_("96bbb:599");return _r_( w[0]===p);
}),t=v[3];
j.each(t,function(w){_i_("96bbb:598");if(typeof w==="function"&&u.b_hotels){w.apply(p,[u.b_hotels[s]])
};_r_()});
k(p);
...
c.push(o);
return _r_( q);
}function f(){_i_("96bbb:420");a.length=0
...
function d(o){_i_("96bbb:122");l[o]=B.jstmpl(o)&&B.jstmpl(o).name!=="__no_op__"?B.jstmpl(o):B.jstmpl("atlas_iw_default");
return _r_( l[o]||{render:function(){}});
}function c(){_i_("96bbb:123");var o=this;
this.IW=this.IW||{};
if(this.IW.OPTIONS){return _r_();
}this.IW.OPTIONS=e.extend({},g,{mapOffset:this.get("offset")});
a();
this.on("offset-change",function(p){_i_("96bbb:421");o.IW.OPTIONS.mapOffset=p
;_r_()})
}function a(){_i_("96bbb:124");if(!B.jstmpl){return _r_();
}B.jstmpl.fn.HELPER_FROM_FRICE=function(o){_i_("96bbb:422");return _r_((B.env.map_vars.translation_from.replace("price_placeholder",o)).replace("price_placeholdernbsp;","$ "));
};
B.jstmpl.fn.HELPER_IS_DEFINED=function(o){_i_("96bbb:423");return _r_( !!o||o===0||o===false);
};
B.jstmpl.fn.HELPER_ENV=function(o){_i_("96bbb:424");return _r_((B.env.hasOwnProperty(o))?B.env[o]:"");
};
B.jstmpl.fn.HELPER_IW_B_BLOCKS=function(q,o,p){_i_("96bbb:425");if(!q){return _r_( false);
}if(q[o]&&q[o][p]){return _r_( q[o][p]);
}if(q.b_room_group&&q.b_room_group[o]&&q.b_room_group[o][p]){return _r_( q.b_room_group[o][p]);
}return _r_( false);
};
B.jstmpl.fn.ATLAS_GET_VARIANT=function(o){_i_("96bbb:426");return _r_((B.atlas&&B.atlas.getVariant)?B.atlas.getVariant(o):false);
};
B.jstmpl.fn.ATLAS_TRACK=function(o){_i_("96bbb:427");return _r_((B.atlas&&B.atlas.trackInTemplate)?B.atlas.trackInTemplate(o):false);
};
B.jstmpl.fn.ATLAS_STAGE=function(p,o){_i_("96bbb:428");return _r_((B.atlas&&B.atlas.stageInTemplate)?B.atlas.stageInTemplate(p,o):true);
};
B.jstmpl.fn.ATLAS_ENV=function(o){_i_("96bbb:429");return _r_((o)?b.get(o):false);
};
B.jstmpl.fn.strings=function(q){_i_("96bbb:430");var o="";
try{o=B.strings(q)
}catch(p){B.reportError&&B.reportError(p,"Atlas: B.strings not found")
}return _r_( o);
}
}function k(o){_i_("96bbb:125");c.call(this);
this.IW.OPTIONS=e.extend({},this.IW.OPTIONS,o)
;_r_()}function f(p,o){_i_("96bbb:126");if(!this.IW.cur){this.IW.cur=new this.Interface.IW(p,this)
}else{this.IW.cur.open(p,o)
};_r_()}function m(r,q){_i_("96bbb:127");var p={},o=this.Interface.getMarker(r);
...
f.call(this,p,true)
};_r_()}function j(t,s,r){_i_("96bbb:128");var p={},o=this.Interface.getMarker(t),q;
if(!this.IW){c.call(this)
...
f.call(this,p)
};_r_()}function h(s,t,r,q){_i_("96bbb:129");var p,o={};
if(!this.IW){c.call(this)
}p=(!r&&q)?d.call(this,q):null;
r=r||((p)?p.render(t):"");
e.extend(o,this.IW.OPTIONS,{latLng:[s[0],s[1]],content:r});
f.call(this,o)
;_r_()}function n(){_i_("96bbb:130");if(this.IW&&this.IW.cur){this.IW.cur.close()
};_r_()}return _r_({closeIW:n,setIW:k,openIW:j,openIWLatLng:h,openIWLoading:m});
});
B.atlas.define("labels",[],function(){_i_("96bbb:26");function b(e){_i_("96bbb:131");var d;
if(!this.Interface.Overlay){return _r_( false);
}d=this.get("labelOverlay")||this.set("labelOverlay",new this.Interface.Overlay({},this));
return _r_( d.add(e));
}function a(){_i_("96bbb:132");var d=this.get("labelOverlay");
if(!d||!this.Interface.Overlay){return _r_( false);
}return _r_( d.removeAll());
}function c(e){_i_("96bbb:133");var d=this.get("labelOverlay");
if(!d||!this.Interface.Overlay){return _r_( false);
}return _r_( d.remove(e));
}return _r_({addLabel:b,removeLabel:c,removeLabels:a});
});
B.atlas.define("hover",function(){_i_("96bbb:27");function c(){_i_("96bbb:134");this.on("marker-hover",function(d){_i_("96bbb:431");a.call(this,d.data.b_id)
;_r_()});
this.on("marker-out",function(d){_i_("96bbb:432");b.call(this,d.data.b_id)
;_r_()})
;_r_()}function a(f){_i_("96bbb:135");var d=this.Interface.getMarker(f),e=(d)?d.iconType||d.b_type:"";
this.Interface.setMarkerType(f,this.getHover(e))
;_r_()}function b(f){_i_("96bbb:136");var d=this.Interface.getMarker(f),e=(d)?d.iconType||d.b_type:"";
this.Interface.setMarkerType(f,this.getIcon(e))
;_r_()}return _r_({addIconEvents:c,setIconHover:a,setIconOut:b});
});
B.atlas.define("mixed-markers-hover",function(){_i_("96bbb:28");function a(f){_i_("96bbb:137");var e=this.Interface.getMixedMarker(f);
...
};_r_()}function c(g){_i_("96bbb:138");if(typeof g==="undefined"){this.setIconActive(undefined);
return _r_();
...
}}}function b(g){_i_("96bbb:139");var f=this.Interface.getActiveMixedMarkers();
var e=this;
f.forEach(function(i){_i_("96bbb:433");var h;
...
;_r_()}function d(f){_i_("96bbb:140");var e=this.Interface.getMixedMarker(f);
...
function l(s){_i_("96bbb:141");var r,q=[];
for(r in s){if(s.hasOwnProperty(r)){q.push(s[r])
}}return _r_( q);
}function a(s,r){_i_("96bbb:142");var q=(g.isArray(s))?s:l(s);
this.pruneMarkers(q);
this.addMarkers(q,r)
;_r_()}function n(){_i_("96bbb:143");return _r_( this.Interface.getActiveMarkers());
}function f(){_i_("96bbb:144");this.Interface.clearMarkers()
;_r_()}function e(q){_i_("96bbb:145");this.Interface.clearMarker(q)
;_r_()}function i(r){_i_("96bbb:146");var q=(g.isArray(r))?r:l(r);
this.Interface.pruneOutboundedMarkers();
this.addMarkers(q)
;_r_()}function o(u){_i_("96bbb:147");var t,s,r=this.Interface.getActiveMarkers(),q=r.length;
while(q--){t=r[q].b_id;
s=u.length;
while(s--){if(u[s].b_id===t){break
}}if(s<0&&t){this.Interface.clearMarker(t)
}};_r_()}function d(r,q){_i_("96bbb:148");var x,t,y=[],s=0,v=this.Interface,u=(g.isArray(r))?r:l(r),w=u.length;
...
;_r_()}function j(s){_i_("96bbb:149");var r,q=this.Interface.getMarker(s);
if(q){r=this.getIcon(q.b_type);
this.Interface.setMarkerType(s,r)
};_r_()}function m(q){_i_("96bbb:150");this.Interface.centerMarker(q,this.get("offset"))
;_r_()}function c(q){_i_("96bbb:151");this.Interface.panMarker(q,this.get("offset"))
;_r_()}function b(r,q){_i_("96bbb:152");if(q){this.Interface.setMarkerType(r,this.getIcon(q),q)
};_r_()}function p(q){_i_("96bbb:153");return _r_( this.Interface.getMarker(q));
}function h(r,q){_i_("96bbb:154");return _r_( this.Interface.setMarkerOptions(r,q));
}function k(){_i_("96bbb:155");return _r_( this.Interface.markersExist());
...
}B.atlas.define("mixed-markers",["util-object","util-array"],function(h,f){_i_("96bbb:332");function g(u){_i_("96bbb:434");var t,s=[];
if(f.isArray(u)){return _r_( u);
}for(t in u){if(u.hasOwnProperty(t)){s.push(u[t])
}}return _r_( s);
}function i(u,t){_i_("96bbb:435");var s=g(u);
this.pruneMarkers(s);
this.addMarkers(s,t)
;_r_()}function q(){_i_("96bbb:436");return _r_( this.Interface.getActiveMixedMarkers());
}function m(){_i_("96bbb:437");this.Interface.clearMixedMarkers()
;_r_()}function o(s){_i_("96bbb:438");this.Interface.clearMixedMarker(s)
;_r_()}function k(t){_i_("96bbb:439");var s=g(t);
this.Interface.pruneOutboundedMixedMarkers();
this.addMarkers(s)
;_r_()}function n(w){_i_("96bbb:440");var v,u,t=this.Interface.getActiveMixedMarkers(),s=t.length;
while(s--){v=t[s].b_id;
u=w.length;
while(u--){if(w[u].b_id===v){break
}}if(u<0&&v){this.Interface.clearMixedMarker(v)
}};_r_()}function a(A,w){_i_("96bbb:441");var y,v,u=[],x=0,t=g(A),s=t.length;
this.trigger("markers-create",this);
while(s--){y=t[s];
...
;_r_()}function b(u){_i_("96bbb:442");var t,s=this.Interface.getMixedMarker(u);
...
}};_r_()}function c(s){_i_("96bbb:443");this.Interface.centerMixedMarker(s,this.get("offset"))
;_r_()}function j(s){_i_("96bbb:444");this.Interface.panMixedMarker(s,this.get("offset"))
;_r_()}function p(u,t){_i_("96bbb:445");var s=this.Interface.getMixedMarker(u);
if(t&&s){s.b_type=t;
...
}};_r_()}function e(s){_i_("96bbb:446");return _r_( this.Interface.getMixedMarker(s));
}function l(t,s){_i_("96bbb:447");return _r_( this.Interface.setMixedMarkerOptions(t,s));
}function r(){_i_("96bbb:448");return _r_( this.Interface.mixedMarkersExist());
}function d(s){_i_("96bbb:449");if(typeof this.Interface.getMixedMarkerPosition==="function"){return _r_( this.Interface.getMixedMarkerPosition(s));
...
function f(k){_i_("96bbb:156");var j=k.Interface?k.Interface.getBoundingBox():k.get("bounds"),l="";
if(j&&j.SW){l=[j.SW[1],j.SW[0],j.NE[1],j.NE[0]].join(",")
}else{if(j&&j.toMOMString){l=j.toMOMString()
}}return _r_( l);
}function h(l){_i_("96bbb:157");var k,j,m;
for(k=0,j=c.length;
k<j;
++k){m=c[k];
if(m[0]===l){m[1].abort();
...
}function a(n){_i_("96bbb:158");var m,k=this.getMarkersURL(),j=this,l=f(j);
h(j);
if(!l){return _r_();
}j.trigger("markers-get-before",j);
m=b.ajax({url:k+";BBOX="+l,error:function(p,o){_i_("96bbb:555");if(o!=="abort"){j.trigger("markers-get-fail",j)
};_r_()},success:function(o){_i_("96bbb:556");j.trigger("markers-get-success",o,j);
...
c.push([j,m])
}function g(j){_i_("96bbb:159");return _r_( this.set("markersOnMapURL",j||d.get("markersOnMapURL")));
}function e(){_i_("96bbb:160");return _r_( this.get("markersOnMapURL")||d.get("markersOnMapURL"));
}function i(j){_i_("96bbb:161");var k=this.getMarkersURL();
...
B.atlas.define("overlay-markers-content",[],function(){_i_("96bbb:32");function a(d){_i_("96bbb:162");return _r_( B.jstmpl("atlas_overlay_marker").render(d));
}function b(d){_i_("96bbb:163");return _r_( parseInt(B.jstmpl("atlas_overlay_marker_zindex").render(d),10));
}function c(d){_i_("96bbb:164");var e=B.jstmpl("atlas_overlay_marker_dimension").render(d).split(",");
return _r_({w:parseInt(e[0],10),h:parseInt(e[1],10)});
}return _r_({getMarkerContent:a,getMarkerZIndex:b,getMarkerDimension:c});
});
B.atlas.define("offset",["geometry.point"],function(a){_i_("96bbb:33");function b(c,e){_i_("96bbb:165");var d=new a(c,e);
this.set("offset",d);
this.trigger("offset-change",d)
;_r_()}return _r_({setOffset:b});
});
B.atlas.define("options",function(){_i_("96bbb:34");function c(i,j){_i_("96bbb:166");this.Interface.configZoomControl(i,j)
;_r_()}function f(){_i_("96bbb:167");this.Interface.hideZoomControl()
;_r_()}function b(i){_i_("96bbb:168");this.Interface.setMaxZoom(i);
this.set("maxZoom",i)
;_r_()}function h(i){_i_("96bbb:169");this.Interface.setMinZoom(i);
this.set("minZoom",i)
;_r_()}function a(i){_i_("96bbb:170");this.Interface.setZoom(i)
;_r_()}function d(i){_i_("96bbb:171");this.Interface.setMapType(i)
;_r_()}function e(){_i_("96bbb:172");return _r_( this.Interface.getMapType());
}function g(){_i_("96bbb:173");return _r_( this.Interface.getZoom());
}return _r_({configZoomControl:c,hideZoomControl:f,setMapType:d,getMapType:e,setMaxZoom:b,setMinZoom:h,setZoom:a,getZoom:g});
});
B.atlas.define("places",function(){_i_("96bbb:35");function d(f,g,e){_i_("96bbb:174");if(!f){return _r_();
}this.Interface.getPlaceDetails(f,g,e)
}function a(e,f){_i_("96bbb:175");if(!e){return _r_();
}if(typeof this.Interface.getGeocodeDetails==="function"){this.Interface.getGeocodeDetails(e,f)
}}function c(f,g,e){_i_("96bbb:176");if(!f||!this.Interface.searchPlaces){return _r_();
}this.Interface.searchPlaces(f,g,e)
}function b(){_i_("96bbb:177");return _r_( this.Interface.checkPlacesApi&&this.Interface.checkPlacesApi());
...
function b(d){_i_("96bbb:178");return _r_( new this.Interface.Polygon(c.extend({},a,d),this.Interface));
...
function h(m,k){_i_("96bbb:179");var n=document.createDocumentFragment(),l=k.get("$container");
c.each(m.reverse(),function(o,p){_i_("96bbb:450");var q;
if(!o){return _r_();
...
l.append(n)
;_r_()}function i(k){_i_("96bbb:180");var l=k.get("$domNode"),m=l.data("map"),n=f('<div class="'+e+'_container" />');
n.append(l.children());
f(document.createElement("img")).bind("load",function(){_i_("96bbb:588");l.addClass(j);
k.trigger("load")
...
}function a(m){_i_("96bbb:181");var k=this,l=k.get("$container");
l=l||i(k);
if(m){h(m,k)
}l.find(b).each(function(n,o){_i_("96bbb:451");k.renderMarker(o)
;_r_()});
k.trigger("render")
;_r_()}function d(n){_i_("96bbb:182");var k=f(n),p=this.get("offset"),o=(k.data("coords")||"0,0").split(","),m=new g(+o[0],+o[1]),q=this.latLngToPixel(m),l=this.getIcon(k.data("marker-type"));
...
B.atlas.define("zoom",function(){_i_("96bbb:38");function b(c){_i_("96bbb:183");var f=c||this.get("maxZoom"),e=this.getZoom(),d;
if(e<f){d=e+1;
this.setZoom(d);
if(e+1===f){return _r_( true);
}else{return _r_( false);
}}else{return _r_( true);
}}function a(f){_i_("96bbb:184");var e=f||this.get("minZoom"),d=this.getZoom(),c;
if(d>e){c=d-1;
this.setZoom(c);
...
B.atlas.define("transit-layer",function(){_i_("96bbb:39");function a(){_i_("96bbb:185");if(typeof this.Interface.addTransitLayer==="function"){this.Interface.addTransitLayer()
};_r_()}function b(){_i_("96bbb:186");if(typeof this.Interface.removeTransitLayer==="function"){this.Interface.removeTransitLayer()
};_r_()}return _r_({addTransitLayer:a,removeTransitLayer:b});
});
B.atlas.define("provider-google-autocomplete-result",["util-object","util-array","util-getset"],function(e,d,c){_i_("96bbb:40");function a(h){_i_("96bbb:187");var g=[];
d.each(h.slice(1),function(i){_i_("96bbb:452");if(i.value){g.push(i.value)
};_r_()});
return _r_( g.join(", "));
}function b(g){_i_("96bbb:188");return _r_( g&&g.length?g[0].value||"":"");
}function f(i,j){_i_("96bbb:189");var g=this,h={map:j,data:{id:i.place_id,title:b(i.terms),address:a(i.terms),description:i.description,matched_substrings:i.matched_substrings,types:i.types}};
e.extend(h,i);
e.extend(g,c.call(g,h))
;_r_()}f.prototype.getDetails=function(i){_i_("96bbb:333");var g=this.get("map"),h=this.get("place_id");
...
function f(j,k){_i_("96bbb:190");var i=k.map&&k.map.getBounds(),h={input:j.query};
if(i){h.bounds=i
}else{if(j.lat&&j.lon){h.location=new google.maps.LatLng(j.lat,j.lon);
h.radius=Math.min(parseInt(j.radius,10),b)
}}return _r_( h);
}function c(i,j){_i_("96bbb:191");var h=[];
if(i.length>0){e.each(i,function(k){_i_("96bbb:544");if(k.place_id&&k.terms){h.push(new g(k,j))
};_r_()})
}return _r_( h);
}function d(j,l,i){_i_("96bbb:192");var h=this,k=f(j,h);
a=a||new google.maps.places.AutocompleteService();
a.getPlacePredictions(k,function(n,m){_i_("96bbb:453");if(m&&m.indexOf("OK")>-1&&n){l(c(n,h))
}else{if(typeof i==="function"){i(m,k)
}};_r_()})
;_r_()}return _r_({autocomplete:d});
});
B.atlas.define("provider-google-bounds",function(){_i_("96bbb:42");function a(){_i_("96bbb:193");var d=this.map.getBounds(),c=null,b,e;
...
B.atlas.define("provider-google-center",function(){_i_("96bbb:43");function f(j){_i_("96bbb:194");var g=this.map.getCenter(),i=j?{x:j.x*-1,y:j.y*-1}:{},h=j?this.getOffsetLatLng([g.lat(),g.lng()],i):g;
return _r_([h.lat(),h.lng()]);
}function c(h,g){_i_("96bbb:195");return _r_( new google.maps.LatLng(h,g));
}function d(g,h){_i_("96bbb:196");this.map.panBy(g,h)
;_r_()}function b(){_i_("96bbb:197");google.maps.event.trigger(this.map,"resize")
;_r_()}function a(g,h){_i_("96bbb:198");this.map.setCenter(this.getOffsetLatLng(g,h))
;_r_()}function e(g,h){_i_("96bbb:199");this.map.panTo(this.getOffsetLatLng(g,h))
...
function d(e){_i_("96bbb:200");return _r_( new google.maps.LatLng(e[0],e[1]));
}function b(e,f){_i_("96bbb:201");var g={};
c.extend(g,e,{center:d(e.center),readius:e.readius,map:f.map});
this.ubber=f;
this.core=new google.maps.Circle(g)
;_r_()}b.prototype={setOptions:function(e){_i_("96bbb:454");var f={};
if(e.center){e.center=d(e.center)
}c.extend(f,e);
this.core.setOptions(f);
return _r_( this);
},getCenter:function(){_i_("96bbb:455");var e=this.core.getCenter();
return _r_([e.lat(),e.lng()]);
},on:function(e,h,g){_i_("96bbb:456");var f=this;
a.push({context:this,evt:e,handler:h,listener:google.maps.event.addListener(this.core,e,function(){_i_("96bbb:594");f.ubber.ubber.trigger("circle-"+e,this);
h.call(f,g)
;_r_()})});
return _r_( this);
},off:function(f,g){_i_("96bbb:457");var i,h,e=a.length;
while(e--){i=a[e];
if(i.context===this&&i.evt===f&&i.handler===g){h=a.splice(e,1);
if(h.length===1&&h[0].listener){h[0].listener.remove()
}break
}}return _r_( this);
},setCenter:function(e){_i_("96bbb:458");this.core.setCenter(d(e));
return _r_( this);
},hide:function(){_i_("96bbb:459");this.core.setVisible(false);
return _r_( this);
},show:function(){_i_("96bbb:460");this.core.setVisible(true);
return _r_( this);
},remove:function(){_i_("96bbb:461");var f,e=a.length;
...
B.atlas.define("provider-google-events",function(){_i_("96bbb:45");function a(){_i_("96bbb:202");var c=google.maps.event,b=this.ubber,d;
c.addListener(this.map,"dragstart",function(){_i_("96bbb:462");b.trigger("drag-start")
;_r_()});
c.addListener(this.map,"dragend",function(){_i_("96bbb:463");b.trigger("drag")
;_r_()});
c.addListener(this.map,"zoom_changed",function(){_i_("96bbb:464");var e=b.Interface,f=(e&&e.map)?e.map.getZoom():0;
b.trigger("zoom",f)
;_r_()});
c.addListener(this.map,"dblclick",function(){_i_("96bbb:465");b.trigger("doubleclick")
;_r_()});
c.addListener(this.map,"idle",function(){_i_("96bbb:466");b.trigger("idle")
;_r_()});
c.addListener(this.map,"resize",function(){_i_("96bbb:467");b.trigger("resize")
;_r_()});
c.addListener(this.map,"bounds_changed",function(){_i_("96bbb:468");if(d){clearTimeout(d)
}d=setTimeout(function(){_i_("96bbb:583");b.trigger("bounds-change")
;_r_()},150)
;_r_()});
c.addListener(this.map,"tilesloaded",function(){_i_("96bbb:469");b.trigger("tiles-load")
;_r_()});
c.addListener(this.map,"maptypeid_changed",function(){_i_("96bbb:470");b.trigger("map-type-change",this.getMapTypeId())
;_r_()})
...
function b(g,f){_i_("96bbb:203");var h=f.Interface.map;
this.ubber=f;
this.config={};
this.isOpen=false;
...
this.setMap(h)
;_r_()}b.prototype.remove=function(){_i_("96bbb:334");if(this.$domNode){this.$domNode.remove();
this.$domNode=null
}this.setMap(null)
;_r_()};
b.prototype.draw=function(){_i_("96bbb:335");var g=this,h=this.config,f=(h.isFixed)?this.ubber.$domNode:d(this.getPanes().floatPane);
if(!this.$domNode){this.$domNode=d('<div class="'+e+'"/>');
this.$domNode.appendTo(f).bind("mousemove",function(i){_i_("96bbb:589");i.stopPropagation()
;_r_()}).delegate(h.closeSelector,"click",function(i){_i_("96bbb:565");i.stopPropagation();
g.close()
;_r_()});
this.open()
}else{if(!h.isFixed&&this.isOpen){this.setPosition()
}};_r_()};
b.prototype.checkOverlay=function(j,h){_i_("96bbb:336");var i=this.ubber.get("topOverlay"),g=i?i:this.ubber.$domNode,f=this.getPanes().floatPane;
if(j&&h.get(0)!==g.get(0)){h.appendTo(g)
}else{if(!j&&h.get(0)!==f){h.appendTo(d(f))
}};_r_()};
b.prototype.open=function(h,g){_i_("96bbb:337");var k=d.extend(this.config,(h||{})),j=[e,k.className],i=this.$domNode,f=this.getProjection();
...
b.prototype.getPosition=function(g,f){_i_("96bbb:338");var h=this.config;
return _r_({x:f.x+h.offset.x-g.outerWidth()/2,y:f.y+h.offset.y});
};
b.prototype.setPosition=function(){_i_("96bbb:339");var g,m,l,k=this.config,h=this.$domNode,f=this.getProjection(),j=(k.getPosition)||this.getPosition,i=new google.maps.LatLng(k.latLng[0],k.latLng[1]);
if(!f||!this.$domNode){return _r_();
...
b.prototype.close=function(){_i_("96bbb:340");if(this.$domNode){this.isOpen=false;
this.$domNode.addClass(a);
this.$domNode.hide();
this.ubber.trigger("iw-close")
};_r_()};
b.prototype.panMap=function(){_i_("96bbb:341");var h=this.getMap(),g=this.config,n=d(h.getDiv()),i=this.$domNode,p=n.width(),l=n.height(),k=i.outerWidth()/2,o=i.outerHeight(),f=this.getProjection().fromLatLngToContainerPixel(new google.maps.LatLng(g.latLng[0],g.latLng[1])),m=0,j=0;
...
B.atlas.define("provider-google-markers",["jQuery","util-array"],function(f,l){_i_("96bbb:47");function g(o){_i_("96bbb:204");return _r_( l.findIndex(this.markers,function(p){_i_("96bbb:471");return _r_( p.b_id===String(o));
}));
}function c(){_i_("96bbb:205");var s,r=this.markers,q=r.length,p=google.maps.event,o=this.map.getBounds();
while(q--){s=r[q];
if(o&&!o.contains(s.getPosition())&&!s.data.b_persistent){p.clearInstanceListeners(s);
s.setMap(null);
r.splice(q,1)
}};_r_()}function e(){_i_("96bbb:206");var p,o=this.markers.length;
while(o--){p=this.markers[o];
google.maps.event.clearInstanceListeners(p);
p.setMap(null)
}this.markers=[]
;_r_()}function d(q){_i_("96bbb:207");var o=g.call(this,q),p=(o>-1)?this.markers[o]:null;
if(p){google.maps.event.clearInstanceListeners(p);
p.setMap(null);
this.markers.splice(o,1)
};_r_()}function i(){_i_("96bbb:208");return _r_( this.markers?this.markers.length>0:false);
}function n(o){_i_("96bbb:209");return _r_( l.find(this.markers,function(p){_i_("96bbb:472");return _r_( p.b_id===String(o));
}));
}function m(){_i_("96bbb:210");return _r_( f.map(this.markers,function(o){_i_("96bbb:473");return _r_({b_id:o.b_id,b_name:o.b_name,b_type:o.b_type,b_url:o.b_url,b_latitude:o.b_latitude,b_longitude:o.b_longitude,b_persistent:(o.data)?o.data.b_persistent:false,b_behaviors:(o.data)?o.data.b_behaviors:false,b_states:(o.data)?o.data.b_states:false});
}));
}function b(t,q,p){_i_("96bbb:211");var r=google.maps,s=this.getMarker(t),o;
...
};_r_()}function k(s,r){_i_("96bbb:212");var q=this,p=this.getMarker(s),o=q.map.getProjection();
if(p){if(o){q.map.setCenter(this.getOffsetLatLng(p.getPosition(),r))
}else{q.ubber.once("idle",function(){_i_("96bbb:566");q.map.setCenter(this.getOffsetLatLng(p.getPosition(),r))
;_r_()})
}};_r_()}function a(s,r){_i_("96bbb:213");var q=this,o=q.map.getProjection(),p=this.getMarker(s);
if(p){if(o){q.map.panTo(q.getOffsetLatLng(p.getPosition(),r))
}else{q.ubber.once("idle",function(){_i_("96bbb:567");q.map.panTo(q.getOffsetLatLng(p.getPosition(),r))
;_r_()})
}};_r_()}function h(q,p){_i_("96bbb:214");var o=this.getMarker(q);
if(o){o.setOptions(p)
};_r_()}function j(s){_i_("96bbb:215");var r,u=B.env,p=google.maps,t=p.event,o=this.ubber,w=s.icon,v,q;
...
r.setMap(this.map);
t.addListener(r,"click",function(x){_i_("96bbb:474");o.trigger("marker-click",{evt:x,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this.data})
;_r_()});
t.addListener(r,"mouseover",function(x){_i_("96bbb:475");o.trigger("marker-hover",{evt:x,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this.data})
;_r_()});
t.addListener(r,"mouseout",function(x){_i_("96bbb:476");o.trigger("marker-out",{evt:x,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this.data})
;_r_()});
this.markers.push(r)
...
B.atlas.define("provider-google-offset",["geo.projection"],function(a){_i_("96bbb:48");function b(f,i){_i_("96bbb:216");var h,l,k,g,d=google.maps,e=this.map,c=("lat" in f)?f:new google.maps.LatLng(f[0],f[1]),j=e.getProjection();
if(i){j=a.pointToLatLng(i,e.getZoom());
c=new google.maps.LatLng(c.lat()-j.lat,c.lng()-j.lng)
}return _r_( c);
}return _r_({getOffsetLatLng:b});
});
B.atlas.define("provider-google-options",function(){_i_("96bbb:49");function c(j,l){_i_("96bbb:217");var k=google.maps.ZoomControlStyle,i=google.maps.ControlPosition;
...
;_r_()}function f(){_i_("96bbb:218");this.map.setOptions({zoomControl:false})
;_r_()}function d(j){_i_("96bbb:219");var k=j.toUpperCase(),i=google.maps.MapTypeId;
if(i.hasOwnProperty(k)){this.map.setMapTypeId(i[k])
};_r_()}function e(){_i_("96bbb:220");return _r_( this.map.getMapTypeId());
}function b(i){_i_("96bbb:221");this.map.setOptions({maxZoom:i})
;_r_()}function h(i){_i_("96bbb:222");this.map.setOptions({minZoom:i})
;_r_()}function a(i){_i_("96bbb:223");this.map.setOptions({zoom:i})
;_r_()}function g(){_i_("96bbb:224");return _r_( this.map.getZoom());
...
function g(j){_i_("96bbb:225");var i=j.options.queue;
while(i.length){j.render(i.pop())
}j.options.ubber.trigger("first_overlays_rendered")
;_r_()}function e(i){_i_("96bbb:226");var k=i.options.type,j=i.getPanes();
...
};_r_()}function d(i){_i_("96bbb:227");var j=i.domNode;
...
return _r_( j);
}function a(j,i){_i_("96bbb:228");this.options=h.extend({ubber:i,queue:[],items:[],type:"float"},j);
h.extend(this,new google.maps.OverlayView());
this.setMap(i.Interface.map)
;_r_()}a.prototype.onAdd=function(){_i_("96bbb:342");g(this)
;_r_()};
a.prototype.render=function(j){_i_("96bbb:343");var l=this.options,i=l.items,k=d(j||{});
...
a.prototype.position=function(k,m){_i_("96bbb:344");var j=this.getProjection(),i=google.maps,n,o,l;
...
a.prototype.add=function(j){_i_("96bbb:345");var k=this.options,i=this.options.queue;
...
a.prototype.remove=function(m){_i_("96bbb:346");var i=this.options.items,k=this.options.overlayNode,j,l;
j=f.findIndex(i,function(n){_i_("96bbb:557");return _r_( n.id===m);
});
if(j>-1){l=i.splice(j,1)[0]
}if(k&&l&&k.contains(l.domNode)){k.removeChild(l.domNode)
};_r_()};
a.prototype.removeAll=function(){_i_("96bbb:347");var i=this.options.items,j=this.options.overlayNode,k;
while(j&&i.length){k=i.pop().domNode;
if(j.contains(k)){j.removeChild(k)
}}this.options.items=[]
;_r_()};
a.prototype.draw=function(){_i_("96bbb:348");var j,i=this;
g(this);
j=this.options.items;
j.forEach(function(k){_i_("96bbb:545");i.position(k.options,k.domNode)
;_r_()})
;_r_()};
a.prototype.onRemove=function(){_i_("96bbb:349");var i=this.options.items,j=this.options.overlayNode;
while(j&&i.length){j.removeChild(i.pop().domNode)
};_r_()};
return _r_({Overlay:a});
});
B.atlas.define("provider-google-place-util",["util-object","geo.latLng","util-array"],function(e,f,d){_i_("96bbb:51");function g(m,j){_i_("96bbb:229");var n="",k=Number.POSITIVE_INFINITY,l;
d.each(j,function(o){_i_("96bbb:477");l=d.findIndex(m,function(p){_i_("96bbb:584");return _r_( o===p);
});
if(l>-1&&l<k){k=l;
n=m[k]
};_r_()});
return _r_( n);
}function c(k){_i_("96bbb:230");var j=k.geometry&&k.geometry.location?k.geometry.location:new google.maps.LatLng(0,0),m=new f(j.lat(),j.lng()),l=k.query||"";
if(l&&l.types){k.type=g(k.types||[],l.types)
}return _r_({id:k.place_id,source:"google",coordinates:m,location:j,data:k});
}function b(j){_i_("96bbb:231");var m=google.maps,l=e.extend({position:this.get("location")},j||{}),k=l.icon;
if(k){l.icon={url:k.url,size:new m.Size(k.w,k.h),origin:new m.Point(k.x,k.y)};
if(k.z){l.zIndex=k.z
}}return _r_( l);
}function i(p,n,k){_i_("96bbb:232");var l,j,o,m=p[0];
for(l=0,j=p.length;
l<j;
++l){o=p[l];
...
}function a(j){_i_("96bbb:233");var l=google.maps.event,k=this;
l.addListener(j,"click",function(m){_i_("96bbb:478");k.trigger("click",m)
;_r_()});
l.addListener(j,"mouseover",function(m){_i_("96bbb:479");k.trigger("mouseover",m)
;_r_()});
l.addListener(j,"mouseout",function(m){_i_("96bbb:480");k.trigger("mouseout",m)
;_r_()})
;_r_()}function h(k){_i_("96bbb:234");var l=google.maps.event,j=this;
l.addListener(k,"closeclick",function(m){_i_("96bbb:481");j.trigger("close",m)
;_r_()})
;_r_()}return _r_({transform:c,normalizeMarker:b,setMarkerEvents:a,setIWEvents:h,getBestImage:i});
});
B.atlas.define("provider-google-place",["pubsub","provider-google-place-util","util-object","jQuery"],function(a,e,d,c){_i_("96bbb:52");function b(g,f){_i_("96bbb:235");var i=e.transform(g),h=this;
i.atlas=f;
if(i.data){i.data.getImage=function(j){_i_("96bbb:546");return _r_( h.getImage.call(h,j));
}
}d.extend(this,a.call(this));
this.get=function(j){_i_("96bbb:482");return _r_( j?i[j]:i.data);
};
this.set=function(j,k){_i_("96bbb:483");if(j){i[j]=k;
return _r_( k);
}return _r_( undefined);
}
;_r_()}b.prototype.extend=function(f){_i_("96bbb:350");this.set("data",d.extend(this.get("data")||{},f));
return _r_( this);
};
b.prototype.render=function(f){_i_("96bbb:351");if(this.get("atlas").Interface.map){this.renderMarker(f)
}else{this.renderHTML(f)
}this.set("isRendered",true)
;_r_()};
b.prototype.renderMarker=function(g){_i_("96bbb:352");var f=this.get("marker"),j=this.get("atlas").Interface.map,i=google.maps,h=e.normalizeMarker.call(this,g);
if(!j){return _r_();
...
b.prototype.renderHTML=function(f){_i_("96bbb:353");var i=this.get("$domNode"),g=c(this.get("atlas").get("resultsNode")),h=f.className,j=f.content||"";
if(!i){i=this.set("$domNode",c('<div class="'+h+'"/>'));
i.html(j);
g.append(i)
}else{i.html(j)
};_r_()};
b.prototype.remove=function(){_i_("96bbb:354");if(this.get("atlas")&&this.get("atlas").Interface.map){this.removeMarker()
}else{this.removeHTML()
}this.set("isRendered",false)
;_r_()};
b.prototype.removeMarker=function(){_i_("96bbb:355");var f=this.get("marker");
if(f){f.setMap(null);
f.set("marker",null)
};_r_()};
b.prototype.removeHTML=function(){_i_("96bbb:356");c(this.get("$domNode")).remove();
this.set("$domNode",null)
;_r_()};
b.prototype.getImage=function(g){_i_("96bbb:357");var j=this.get("data"),i=g?g.width:80,f=g?g.height:80,h;
...
b.prototype.getDetails=function(h){_i_("96bbb:358");var f=this.get("atlas"),g=this.get("id");
f.getPlaceDetails({placeId:g},h,this)
;_r_()};
b.prototype.getMarkerConfig=function(g){_i_("96bbb:359");var h=this.get("coordinates"),f;
f={b_id:this.get("id"),b_latitude:h.lat,b_longitude:h.lng,data:this.get("data")};
d.extend(f,g);
return _r_( f);
};
b.prototype.open=function(h){_i_("96bbb:360");var g=this.get("iw"),f=this.get("marker"),j=this.get("atlas").Interface.map,i=d.extend({},h||{});
if(!j){return _r_();
...
b.prototype.close=function(){_i_("96bbb:361");var f=this.get("iw");
return _r_( f?f.close():false);
};
return _r_( b);
});
B.atlas.define("provider-google-places",["util-array","geo.latLng","provider-google-place"],function(c,g,a){_i_("96bbb:53");function b(p,l,o){_i_("96bbb:236");var n=[],m=o.exclude||[];
c.each(p,function(q){_i_("96bbb:484");var r=false;
c.each(m,function(s){_i_("96bbb:568");if(c.contains(q.types||[],s)){r=true
};_r_()});
if(!r&&q.geometry&&q.geometry.location){q.query=o;
n.push(new a(q,l))
};_r_()});
return _r_( n);
}function f(p){_i_("96bbb:237");var m=google.maps,o=p.bounds,n=p.location,q,l;
...
}function e(){_i_("96bbb:238");var l=this.ubber,m=this.map||l.get("attributionNode");
return _r_( l.get("placesService")||l.set("placesService",new google.maps.places.PlacesService(m)));
}function k(){_i_("96bbb:239");var l=this.ubber;
return _r_( l.get("GeocodeService")||l.set("GeocodeService",new google.maps.Geocoder));
}function h(o,p,n){_i_("96bbb:240");var m=this.ubber,l=this.getPlacesService();
m.trigger("places-search",o);
if(!o||!p||!(o.location||o.bounds)){return _r_();
}o=f(o);
l.nearbySearch(o,function(s,r,q){_i_("96bbb:485");var t;
...
}function i(r,p,o){_i_("96bbb:241");var n=this.ubber,m=this.getPlacesService(),l=typeof p=="object",q={success:l&&p.success?p.success:p,error:l&&p.error?p.error:function(){}};
n.trigger("places-details",r);
m.getDetails(r,function(u,t){_i_("96bbb:486");var s,v="fail";
...
;_r_()})
;_r_()}function d(q,o){_i_("96bbb:242");var n=this.ubber,m=this.getGeocodeService(),l=typeof o==="object",p={success:l&&o.success?o.success:o,error:l&&o.error?o.error:function(){}};
n.trigger("geocode-details",q);
m.geocode(q,function(s,r){_i_("96bbb:487");if(r===google.maps.GeocoderStatus.OK&&c.isArray(s)&&s[0]){p.success.call(n,s[0])
}else{p.error.call(n,r,"fail",s)
};_r_()})
;_r_()}function j(){_i_("96bbb:243");return _r_( !!(google&&google.maps&&google.maps.places));
...
function b(e){_i_("96bbb:244");return _r_( d.map(e,function(f){_i_("96bbb:488");return _r_( new google.maps.LatLng(f[0],f[1]));
}));
}function a(e,f){_i_("96bbb:245");var g={};
d.extend(g,e,{paths:b(e.paths),map:f.map});
this.ubber=f;
this.core=new google.maps.Polygon(g)
;_r_()}a.prototype={setOptions:function(e){_i_("96bbb:489");var f={};
if(e.paths){e.paths=b(e.paths)
}d.extend(f,e);
this.core.setOptions(f);
return _r_( this);
},getCenter:function(){_i_("96bbb:490");var e,f=new google.maps.LatLngBounds();
this.core.getPath().forEach(function(g){_i_("96bbb:569");f.extend(g)
;_r_()});
e=f.getCenter();
return _r_([e.lat(),e.lng()]);
},on:function(e,h,g){_i_("96bbb:491");var f=this;
c.push({context:this,evt:e,handler:h,listener:google.maps.event.addListener(this.core,e,function(){_i_("96bbb:595");f.ubber.ubber.trigger("polygon-"+e,this);
h.call(f,g)
;_r_()})});
return _r_( this);
},off:function(f,g){_i_("96bbb:492");var i,h,e=c.length;
while(e--){i=c[e];
if(i.context===this&&i.evt===f&&i.handler===g){h=c.splice(e,1);
if(h.length===1&&h[0].listener){h[0].listener.remove()
}break
}}return _r_( this);
},setPaths:function(e){_i_("96bbb:493");this.core.setPaths(b(e));
return _r_( this);
},hide:function(){_i_("96bbb:494");this.core.setVisible(false);
return _r_( this);
},show:function(){_i_("96bbb:495");this.core.setVisible(true);
return _r_( this);
},remove:function(){_i_("96bbb:496");var f,e=c.length;
...
B.atlas.define("provider-google-style",function(){_i_("96bbb:55");return _r_({setStyle:function(a){_i_("96bbb:366");this.map.setOptions({styles:a})
;_r_()}});
});
B.atlas.define("provider-google-transit-layer",function(){_i_("96bbb:56");function a(){_i_("96bbb:246");var c;
if(this.transitLayer){c=this.transitLayer
}else{c=new google.maps.TransitLayer();
this.transitLayer=c
}this.transitLayer.setMap(this.map)
;_r_()}function b(){_i_("96bbb:247");if(this.transitLayer){this.transitLayer.setMap(null)
};_r_()}return _r_({addTransitLayer:a,removeTransitLayer:b});
});
B.atlas.define("provider-google-overlay-marker",["util-object"],function(p){_i_("96bbb:57");function d(R){_i_("96bbb:248");R=R||{};
this._ready=false;
this._dragging=false;
if(R.visible==undefined){R.visible=true
}if(R.anchor==undefined){R.anchor=Q.BOTTOM
}this.setValues(R)
;_r_()}function F(){_i_("96bbb:249");return _r_( this.get("visible"));
}function m(R){_i_("96bbb:250");this.set("visible",R)
;_r_()}function i(){_i_("96bbb:251");if(this._ready){this._markerWrapper.style.display=this.getVisible()?"":"none";
this.draw()
};_r_()}function a(R){_i_("96bbb:252");this.set("flat",!!R)
;_r_()}function P(){_i_("96bbb:253");this.get("flat")
;_r_()}function K(){_i_("96bbb:254");return _r_( this.get("width"));
}function w(){_i_("96bbb:255");return _r_( this.get("height"));
}function l(R){_i_("96bbb:256");this.set("shadow",R);
this.flat_changed()
;_r_()}function h(){_i_("96bbb:257");return _r_( this.get("shadow"));
}function z(){_i_("96bbb:258");if(!this._ready){return _r_();
...
}function b(R){_i_("96bbb:259");this.set("zIndex",R)
;_r_()}function I(){_i_("96bbb:260");return _r_( this.get("zIndex"));
}function g(){_i_("96bbb:261");if(this.getZIndex()&&this._ready){this._markerWrapper.style.zIndex=this.getZIndex()
};_r_()}function M(){_i_("96bbb:262");return _r_( this.get("draggable"));
}function o(R){_i_("96bbb:263");this.set("draggable",!!R)
;_r_()}function u(){_i_("96bbb:264");if(this._ready){if(this.getDraggable()){this._addDragging(this._markerWrapper)
}else{this._removeDragListeners()
}};_r_()}function v(){_i_("96bbb:265");return _r_( this.get("position"));
}function E(R){_i_("96bbb:266");this.set("position",R)
;_r_()}function k(){_i_("96bbb:267");this.draw()
;_r_()}function A(){_i_("96bbb:268");return _r_( this.get("anchor"));
}function C(R){_i_("96bbb:269");this.set("anchor",R)
;_r_()}function j(){_i_("96bbb:270");this.draw()
;_r_()}function J(T){_i_("96bbb:271");var S=document.createElement("DIV"),R;
S.innerHTML=T;
...
}}function y(R){_i_("96bbb:272");if(!R){return _r_();
}var S;
while(S=R.firstChild){R.removeChild(S)
}}function f(R){_i_("96bbb:273");this.set("content",R)
;_r_()}function x(){_i_("96bbb:274");return _r_( this.get("content"));
}function q(){_i_("96bbb:275");if(!this._markerContent){return _r_();
...
}}function s(R){_i_("96bbb:276");if(!this._ready){return _r_();
}var S="";
...
}}function n(S){_i_("96bbb:277");if(!this.getDraggable()){return _r_();
...
this._markerWrapper.onselectstart=function(){_i_("96bbb:547");return _r_( false);
};
this._addDraggingListeners();
google.maps.event.trigger(this,"dragstart")
}}function G(){_i_("96bbb:278");if(!this.getDraggable()){return _r_();
...
this.draw()
}}function e(X){_i_("96bbb:279");if(!this.getDraggable()||!this._dragging){this.stopDrag();
return _r_();
...
}function D(){_i_("96bbb:280");if(this._draggableListner){google.maps.event.removeListener(this._draggableListner);
delete this._draggableListner
}this._setCursor("")
;_r_()}function r(S){_i_("96bbb:281");if(!S){return _r_();
}var R=this;
this._draggableListner=google.maps.event.addDomListener(S,"mousedown",function(T){_i_("96bbb:533");R.startDrag(T)
;_r_()});
this._setCursor("draggable")
}function O(){_i_("96bbb:282");var R=this;
if(this._markerWrapper.setCapture){this._markerWrapper.setCapture(true);
this._draggableListner=[google.maps.event.addDomListener(this._markerWrapper,"mousemove",function(S){_i_("96bbb:570");R.drag(S)
;_r_()},true),google.maps.event.addDomListener(this._markerWrapper,"mouseup",function(){_i_("96bbb:571");R.stopDrag();
R._markerWrapper.releaseCapture()
;_r_()},true)]
}else{this._draggingListeners=[google.maps.event.addDomListener(window,"mousemove",function(S){_i_("96bbb:572");R.drag(S)
;_r_()},true),google.maps.event.addDomListener(window,"mouseup",function(){_i_("96bbb:573");R.stopDrag()
;_r_()},true)]
};_r_()}function H(){_i_("96bbb:283");if(this._draggableListner){for(var R=0,S;
S=this._draggableListner[R];
R++){google.maps.event.removeListener(S)
}this._draggingListeners.length=0
};_r_()}function c(){_i_("96bbb:284");var S=this.getAnchor();
...
}function t(){_i_("96bbb:285");if(!this._markerWrapper){this._markerWrapper=document.createElement("DIV");
...
var S=this;
google.maps.event.addDomListener(this._markerContent,"click",function(T){_i_("96bbb:549");google.maps.event.trigger(S,"click",T)
;_r_()});
google.maps.event.addDomListener(this._markerContent,"mouseover",function(T){_i_("96bbb:550");google.maps.event.trigger(S,"mouseover",T)
;_r_()});
google.maps.event.addDomListener(this._markerContent,"mouseout",function(T){_i_("96bbb:551");google.maps.event.trigger(S,"mouseout",T)
;_r_()})
}this._ready=true;
...
;_r_()}function L(){_i_("96bbb:286");if(!this._ready||this._dragging){return _r_();
...
}}function N(){_i_("96bbb:287");if(this._markerContent&&this._markerContent.parentNode){this._markerContent.parentNode.removeChild(this._markerContent)
...
B.atlas.define("provider-google-mixed-markers",["util-array","util-object","provider-google-overlay-marker"],function(n,c,g){_i_("96bbb:58");function l(q){_i_("96bbb:288");return _r_( n.findIndex(this.markers,function(r){_i_("96bbb:497");if(r){return _r_( r.b_id===String(q));
}}));
}function d(){_i_("96bbb:289");var u,t=this.markers,s=t.length,r=google.maps.event,q=this.map.getBounds();
while(s--){u=t[s];
if(q&&!q.contains(u.getPosition())&&!u.data.b_persistent){r.clearInstanceListeners(u);
u.setMap(null);
t.splice(s,1)
}};_r_()}function h(){_i_("96bbb:290");var r,q=this.markers.length;
while(q--){r=this.markers[q];
google.maps.event.clearInstanceListeners(r);
r.setMap(null)
}this.markers=[]
;_r_()}function i(s){_i_("96bbb:291");var q=l.call(this,s),r=(q>-1)?this.markers[q]:null;
if(r){google.maps.event.clearInstanceListeners(r);
r.setMap(null);
this.markers.splice(q,1)
};_r_()}function m(){_i_("96bbb:292");return _r_( this.markers?this.markers.length>0:false);
}function f(s){_i_("96bbb:293");var r;
try{r=n.find(this.markers,function(t){_i_("96bbb:560");if(t){return _r_( t.b_id===String(s));
}})
}catch(q){B.reportError&&B.reportError(q,"Error in getMixedMarker")
}return _r_( r);
}function p(){_i_("96bbb:294");var q;
try{q=this.markers.map(function(t){_i_("96bbb:561");var s={};
Object.keys(t).forEach(function(u){_i_("96bbb:596");if(/^b_/.test(u)){s[u]=t[u]
};_r_()});
return _r_( s);
})
}catch(r){B.reportError&&B.reportError(r,"Error in getActiveMixedMarkers")
}return _r_( q||[]);
}function b(u,s,r){_i_("96bbb:295");var t=this.getMixedMarker(u),q;
...
}};_r_()}function o(u,t){_i_("96bbb:296");var r=this,s=this.getMixedMarker(u),q=r.map.getProjection();
if(s){if(q){r.map.setCenter(this.getOffsetLatLng(s.getPosition(),t))
}else{r.ubber.once("idle",function(){_i_("96bbb:575");r.map.setCenter(this.getOffsetLatLng(s.getPosition(),t))
;_r_()})
}};_r_()}function k(u,t){_i_("96bbb:297");var r=this,q=r.map.getProjection(),s=this.getMixedMarker(u);
if(s){if(q){r.map.panTo(r.getOffsetLatLng(s.getPosition(),t))
}else{r.ubber.once("idle",function(){_i_("96bbb:576");r.map.panTo(r.getOffsetLatLng(s.getPosition(),t))
;_r_()})
}};_r_()}function j(s,q){_i_("96bbb:298");var r=this.getMixedMarker(s);
if(r){r.setOptions(q)
};_r_()}function a(s){_i_("96bbb:299");var u,w=B.env,r=google.maps,v=r.event,q=this.ubber,y,t,x;
...
v.addListener(u,"click",function(z){_i_("96bbb:498");if(z&&typeof z.preventDefault==="function"){z.preventDefault()
}q.trigger("marker-click",{evt:z,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this})
;_r_()});
v.addListener(u,"mouseover",function(z){_i_("96bbb:499");q.trigger("marker-hover",{evt:z,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this})
;_r_()});
v.addListener(u,"mouseout",function(z){_i_("96bbb:500");q.trigger("marker-out",{evt:z,id:this.b_id,type:this.b_type,latLng:[this.b_latitude,this.b_longitude],data:this})
;_r_()});
this.markers.push(u)
}function e(u){_i_("96bbb:300");var r=new google.maps.OverlayView(),s=this.getMixedMarker(u),q,t;
r.draw=function(){};
r.setMap(this.map);
q=r.getProjection();
...
function m(x){_i_("96bbb:301");return _r_((x instanceof Array)?x:false);
}function c(y,z){_i_("96bbb:302");this.markers=[];
...
k=new j(a,c);
function o(y,x,z){_i_("96bbb:303");if(!k.isLoading){k.append("GLOBAL_ATLAS_GOOGLE_MAPS_CALLBACK",y)
}k.queue(y,x,z,c)
...
a=new h(c,b);
function f(j,i,k){_i_("96bbb:305");if(!a.isLoading){a.get(j)
}a.queue(j,i,k,b)
;_r_()}return _r_({init:f});
});
B.atlas.define("provider-loader",["jQuery","util-env"],function(f,i){_i_("96bbb:61");var b=i.get("killSwitch"),h={};
function a(k,l){_i_("96bbb:306");if(h.hasOwnProperty(k)){return _r_( h[k]);
}this.url=k;
...
this.Interface=l;
h[k]=this
}a.prototype={queue:function g(){_i_("96bbb:504");var k=[].slice.call(arguments,0);
if(this.isLoaded){this.getInterface.apply(this,k)
}else{this.stack.push(k)
};_r_()},get:function d(k){_i_("96bbb:505");var l=this,m=this.url;
if(b){return _r_();
}if(k.get("channel")){m=e(m,"channel",k.get("channel"))
}f.getScript(m,function(){_i_("96bbb:577");k.trigger("api-load",k);
l.isLoaded=true;
while(l.stack.length>0){l.getInterface.apply(l,l.stack.pop())
};_r_()});
this.isLoading=true
},append:function c(n,k){_i_("96bbb:506");var l=document.createElement("script"),m=this,p=this.url;
if(b){return _r_();
}window[n]=function o(){_i_("96bbb:578");k.trigger("api-load",k);
m.isLoaded=true;
...
this.isLoading=true
},getInterface:function j(m,k,n,l){_i_("96bbb:507");l=l||this.Interface;
n.call(m,new l(k,m))
;_r_()}};
function e(k,m,n){_i_("96bbb:307");var l=new RegExp("\\b("+m+"=).*?(&|$)");
...
function b(i,k){_i_("96bbb:308");var j=this;
j.ubber=k;
B.atlas.require(["provider-google-places"],function(){_i_("96bbb:508");var l=[].slice.call(arguments,0);
while(l.length>0){g.extend(j,l.pop())
};_r_()})
;_r_()}$.extend(b.prototype,e);
a=new h(c,b);
function f(j,i,k){_i_("96bbb:309");if(!a.isLoading){a.append("GLOBAL_ATLAS_GOOGLE_MAPS_CALLBACK",j)
}a.queue(j,i,k,b)
;_r_()}return _r_({init:f});
});
