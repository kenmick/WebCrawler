...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("DXIafnbSeA9dxiYxo1XU66lbank")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return xe(t);if("live"===e){var e=n;return"checkbox"===e?!!s==!1?De(t):Xe(t):"input"===e?!!s==!1?Ie(t):Xe(t):Xe(t)
}if("auto-content"===e)return"auth"===n?Pe(t):Xe(t);if("action"===e)return"auth"===n?!!s==!1?Oe(t):Xe(t):Xe(t);
if("mix"===e)return Me(t);if("bem"===e)return Le(t);if(""===e)return Re(t);if("value"===e){var e=n;return"input"===e?$e(t):"tumbler"===e?"option"===s?ze(t):Xe(t):Xe(t)
}if("public-params"===e)return"i-global"===n?He(t):Xe(t);if("js-params"===e)return"b-page"===n?!!s==!1?We(t):Xe(t):Xe(t);
if("default"===e)return q(t);if("env"===e)return"i-global"===n?Ke(t):Xe(t);if("content"===e)return T(t);
if("jsAttr"===e)return Ge(t);if("tag"===e)return D(t);if("cls"===e)return Qe(t);if("format-value"===e){if("value"===s){var e=n;
return"notice"===e?Ae(t):"ticker"===e?je(t):Xe(t)}return Xe(t)}return Xe(t)}function u(t){var e=n;if("b-icon"===e){if(!!s==!1){var a,c=t.ctx,h={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},u=["alt","width","height"];
for(c.url&&(h.src=c.url);a=u.shift();)c[a]&&(h[a]=c[a]);return h}return S(t)}if("checkbox"===e){var e=s;
...
}return S(t)}if("button"===e)return l(t);if("input"===e){var e=s;if("hint"===e)return{id:t._hintId,"for":t._inputId,"aria-hidden":!0};
...
}return S(t)}if("notice"===e)return"count"===s?!t.ctx.url==!1?{href:t.ctx.url}:S(t):S(t);if("auth"===e){var e=s;
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var m,g;return{method:"POST",action:t.ctx.url||(m=i,i="action",g=Oe(t),i=m,g),role:"form","aria-label":BEM.I18N("auth","auth")}
}return S(t)}if("b-link"===e)return _(t);if("suggest2-item"===e){var e=s;return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:S(t)
}if("select"===e){var e=s;return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?v(t):"list"===e?y(t):S(t)
}if("tumbler"===e){var e=s;if("sticker"===e)return k(t);if("text"===e)return M(t);if("input"===e){var b,x=o.side;
return b="left"===x?t._checked?void 0:"checked":t._checked,{type:"radio",name:t.ctx.name,value:t.ctx.value,checked:b,disabled:t.ctx.disabled,"aria-labelledby":"left"===x?t._leftId:t._rightId}
}return"button"===e?E(t):S(t)}return"link"===e?w(t):"ticker"===e?"value"===s?{title:t._count}:S(t):S(t)
}function l(t){if(!(t.__$anflg29!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg29,t.__$anflg29=!0,i=l(t),t.__$anflg29=e,i),{onmousedown:t.ctx.counter})
}return d(t)}return d(t)}return d(t)}function d(t){if(!(t.__$anflg28!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg28,t.__$anflg28=!0,i=l(t),t.__$anflg28=e,i),a={href:n.url};
return n.target&&(a.target=n.target),r.disabled&&(a["aria-disabled"]=!0),t._.extend(o,a)}return p(t)}return p(t)
}return p(t)}function p(t){return!(t.__$anflg27!==!0)==!1?!!s==!1?!!t.ctx.url==!1?f(t):m(t):m(t):m(t)
}function f(t){for(var e,i,n,s=t.ctx,o=(e=t.__$anflg27,t.__$anflg27=!0,i=l(t),t.__$anflg27=e,i),a={type:s.type||"button"},c=["name","value"];n=c.shift();)s[n]&&(a[n]=s[n]);
return r.disabled&&(a.disabled="disabled"),t._.extend(o,a)}function m(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return e.tabindex&&(i.tabindex=e.tabindex),i}return S(t)}function _(t){if(!(t.__$anflg21!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg21,t.__$anflg21=!0,i=_(t),t.__$anflg21=e,i||{}),o=t.ctx;
return o.title&&(n.title=o.title),o.target&&(n.target=o.target),o.counter&&(n.onmousedown=o.counter),n.href=o.url,n
}return g(t)}return g(t)}function g(t){return!!s==!1?b(t):S(t)}function b(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Fe(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
return h}function v(t){if(!(t.__$anflg16!==!0)==!1){var e,i,n=(e=t.__$anflg16,t.__$anflg16=!0,i=v(t),t.__$anflg16=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function y(t){if(!(t.__$anflg15!==!0)==!1){var e,i,n=(e=t.__$anflg15,t.__$anflg15=!0,i=y(t),t.__$anflg15=e,i||{});
return n.role="select",n}return S(t)}function k(t){if(!(t.__$anflg11!==!0)==!1){var e,i,n=(e=t.__$anflg11,t.__$anflg11=!0,i=k(t),t.__$anflg11=e,i||{});
return n["aria-hidden"]=!0,n}return S(t)}function M(t){if(!(t.__$anflg10!==!0)==!1){var e,i,n=(e=t.__$anflg10,t.__$anflg10=!0,i=M(t),t.__$anflg10=e,i||{});
return side=o.side,n.id="left"===side?t._leftId:t._rightId,n["aria-hidden"]=!0,n}return S(t)}function E(t){if(!(t.__$anflg7!==!0)==!1){if(!t._sideId==!1){var e,i,n=(e=t.__$anflg7,t.__$anflg7=!0,i=E(t),t.__$anflg7=e,i||{});
return n["aria-labelledby"]=t._sideId,n}return S(t)}return S(t)}function w(t){if(!(t.__$anflg2!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg2,t.__$anflg2=!0,i=w(t),t.__$anflg2=e,i||{}),o=t.ctx;
return o.title&&(n.title=o.title),o.target&&(n.target=o.target),o.counter&&(n.onmousedown=o.counter),n.href=o.url,n
}return x(t)}return x(t)}function x(t){if(!(t.__$anflg1!==!0)==!1){if(!(r&&"yes"===r.disabled)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg1,t.__$anflg1=!0,i=w(t),t.__$anflg1=e,i||{});
return n.tabindex=-1,n["aria-disabled"]=!0,n}return B(t)}return B(t)}return B(t)}function B(t){return!!s==!1?C(t):S(t)
}function C(t){var e=t.ctx,n={};if(["title","target","id","tabindex"].forEach(function(t){e.hasOwnProperty(t)&&(n[t]=String(e[t]))
}),null!==e.url&&"undefined"!=typeof e.url)if(t.isSimple(e.url))n.href=String(e.url);else{var s=[],o=i;
i="";var r=t._buf;t._buf=s;var a=t.ctx;t.ctx=e.url,Fe(t),i=o,t._buf=r,t.ctx=a,n.href=s.join("")}else n.role="button",n.tabindex||(n.tabindex="0");
return n}function S(){return void 0}function D(t){var e=n;if("b-icon"===e)return!!s==!1?"img":P(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":I(t):I(t);
if("input"===e){var e=s;return"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":P(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":P(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":P(t)}if("checkbox"===e){var e=s;return"control"===e?"input":"label"===e?"label":!!s==!1?"span":P(t)
}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":P(t):"a11y"===e?"span":"items"===e?"ul":P(t)
}if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":P(t)
}if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":P(t)
}if("b-autocomplete-item"===e)return!!s==!1?"li":P(t);if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":P(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":P(t)}return"link"===e?"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":P(t):"b-link"===e?!!s==!1?"a":P(t):P(t)
}function I(t){return!!s==!1?"button":P(t)}function P(){return void 0}function T(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:F(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:F(t);if("auth"===e){var e=s;
return"register"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=register",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","register")}:O(t):"remember"===e?!!t.ctx.content==!1?{block:"button",mods:{theme:"pseudo",size:"s"},url:t.ctx.url||[t._passportHost,"/passport?mode=restore",t._paramFrom,t._paramRetpath].join(""),content:BEM.I18N("auth","remember")}:O(t):"button"===e?!!t.ctx.content==!1?{block:"button",type:"submit",mods:{theme:"action",size:"m"},content:BEM.I18N("auth","logon")}:O(t):"haunter"===e?!!t.ctx.content==!1?{block:"checkbox",mods:{theme:"normal",size:"m"},checkboxAttrs:{id:"auth-haunter",autocomplete:"off",name:"twoweeks",value:"no"},content:{elem:"label",content:BEM.I18N("auth","temporary")}}:O(t):"password"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"passwd",content:[{elem:"hint",content:BEM.I18N("auth","password")},{elem:"control",attrs:{type:"password",maxlength:256,"aria-required":!0}}]}:O(t):"username"===e?!!t.ctx.content==!1?{block:"input",mods:{theme:"normal",size:"m"},name:"login",content:[{elem:"hint",content:BEM.I18N("auth","login")},{elem:"control",attrs:{"aria-required":!0}}]}:O(t):O(t)
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Ae(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",count:t.ctx.content}]:F(t)
}if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:F(t);
if("suggest2-item"===e)return!(r&&"link"===r.interact)==!1?!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:A(t):A(t);
...
}return j(t)}return j(t)}if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:F(t);
if("input"===e)return"ahead"===s?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:F(t);if("tumbler"===e)return"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1?!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:R(t):R(t);
if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=je(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):F(t)
}return F(t)}function O(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Pe(t),i=e,n),{elem:"retpath"}]
}return F(t)}function A(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):F(e)}function j(e){return!(r&&"foot"===r.type)==!1?!!s==!1?e.ctx.data.slice(1).map(function(t){return this._.isArray(t)?{tag:"span",elem:"foot",content:t[0]}:t
},t(e)):L(e):L(e)}function L(t){return!(r&&"nav"===r.type)==!1?!!s==!1?{elem:"link",tag:"a",attrs:{href:t._url,target:"_blank"},content:[{elem:"link-url",tag:"span",content:t._linkUrlContent},{elem:"link-info",tag:"span",content:t._linkInfoConten}]}:N(t):N(t)
}function N(t){if(!!s==!1){var e=t.ctx.data,i=BEM.blocks["i-common__string"],n=i.escapeHTML(t._.isArray(e)?e[1]:e);
return i.highlight(n,t.ctx.hl)}return F(t)}function R(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return F(t)
}function F(t){return t.ctx.content}function q(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg31!==!0)==!1?$(t):Xe(t):Xe(t);
if("button"===e)return z(t);if("input"===e)return H(t);if("auth"===e)return X(t);if("checkbox"===e)return U(t);
if("select"===e)return se(t);if("b-autocomplete-item"===e)return ce(t);if("popup"===e)return ue(t);if("tumbler"===e)return de(t);
if("i-global"===e)return ye(t);if("suggest2-item"===e){var e=s;return"icon"===e?te(t):"fact"===e?ne(t):Xe(t)
}return Xe(t)}function $(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));
var s=t.__$anflg31;t.__$anflg31=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",Fe(t),t.ctx=o,i=r,t.__$anflg31=s}function U(t){return!(t.__$anflg30!==!0)==!1?!!s==!1?V(t):Xe(t):Xe(t)
}function V(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg30;t.__$anflg30=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=e.mods;e.mods=s,U(t),t._checkboxAttrs=r,t._labelId=a,e.mods=c,t.__$anflg30=o
}function z(t){if(!(t.__$anflg26!==!0)==!1){if(!!s==!1){var e=t.ctx.mods||{};e.theme=e.theme||"normal";
var i=t.__$anflg26;t.__$anflg26=!0;var n=t.ctx,o=n.mods;return n.mods=e,z(t),n.mods=o,t.__$anflg26=i,void 0
}return Xe(t)}return Xe(t)}function H(t){var e=s;return"hint"===e?!(t.__$anflg25!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?W(t):G(t):G(t):G(t):"control"===e?!(t.__$anflg24!==!0)==!1?!!r.clear==!1?K(t):G(t):G(t):G(t)
}function W(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg25,t.__$anflg25=!0,s=t.ctx,t.ctx=a,o=i,i="",r=Fe(t),t.ctx=s,i=o,n=r,t.__$anflg25=e,n
}function K(t){var e=t.__$anflg24;t.__$anflg24=!0;var n=t.ctx;t.ctx={elem:"box",tag:"span",content:[t.ctx,{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]};
var s=i;i="",Fe(t),t.ctx=n,i=s,t.__$anflg24=e}function G(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?Q(t):Xe(t):Xe(t)
}function Q(t){var e,n,s,o=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=$e(t),i=e,t.ctx=n,s),a=t.ctx.id||t.generateId(),c=t.ctx.mods||{},h=t.ctx.js||{};
c.theme=c.theme||"normal";var u=t.__$anflg12;t.__$anflg12=!0;var l=t._inputId;t._inputId=a;var d=t._labelId;
...
t._live=h.live||!1;var v=t.ctx,y=v.mods;v.mods=c,H(t),t._inputId=l,t._labelId=d,t._hintId=p,t._name=f,t._value=m,t._inputLink=_,t._disabled=g,t._live=b,v.mods=y,t.__$anflg12=u
}function X(t){return"retpath"===s?Y(t):Z(t)}function Y(t){if(!(t.__$anflg23!==!0)==!1){var e=t.__$anflg23;
t.__$anflg23=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,Y(t),t._retpath=i,t.__$anflg23=e,void 0
}return Z(t)}function Z(t){return!(t.__$anflg22!==!0)==!1?!!s==!1?J(t):Xe(t):Xe(t)}function J(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",X(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg22=o
}function te(t){if(!(t.__$anflg20!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg20;t.__$anflg20=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),te(t),i.weather=n,t.__$anflg20=e,void 0
}return ee(t)}return ee(t)}function ee(t){return!(t.__$anflg19!==!0)==!1?ie(t):Xe(t)}function ie(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg19;t.__$anflg19=!0,te(t),t.__$anflg19=i}function ne(t){if(!(t.__$anflg18!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg18;return t.__$anflg18=!0,ne(t),t.__$anflg18=e,void 0}return Xe(t)}return Xe(t)}function se(t){return"group"===s?oe(t):re(t)
}function oe(t){if(!(t.__$anflg17!==!0)==!1){var e=t.__$anflg17;t.__$anflg17=!0;var i=t._labelId;return t._labelId=t.generateId(),oe(t),t._labelId=i,t.__$anflg17=e,void 0
}return re(t)}function re(t){return!(t.__$anflg14!==!0)==!1?!!s==!1?ae(t):Xe(t):Xe(t)}function ae(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg14;
t.__$anflg14=!0;var o=t._controlAttrs;t._controlAttrs={id:i,name:e.name||i,tabindex:e.tabindex};var a=t._formSelect;
t._formSelect={block:n,mods:r,tabindex:e.tabindex},se(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg14=s
}function ce(t){return!(t.__$anflg13!==!0)==!1?!(r&&"nav"===r.type)==!1?!!s==!1?he(t):Xe(t):Xe(t):Xe(t)
...
}function ue(t){return!!t._popupDefaults==!1?!!s==!1?le(t):Xe(t):Xe(t)}function le(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
...
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Fe(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
}return pe(t)}return pe(t)}return me(t)}function pe(t){return!(t.__$anflg8!==!0)==!1?fe(t):me(t)}function fe(t){var e,n,s=(e=i,i="value",n=ze(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",Fe(t),t.ctx=r,i=a,t.__$anflg8=o}function me(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
...
}return be(t)}return be(t)}return be(t)}function be(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?ve(t):Xe(t):Xe(t)
}function ve(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null;t.ctx.content&&(s="left"===t.ctx.content[0].side?i:n);
var o=t.__$anflg3;t.__$anflg3=!0;var r=t._name;t._name=t.ctx.name||(t.ctx.name=e);var a=t._leftId;t._leftId=i;
var c=t._rightId;t._rightId=n;var h=t._sideId;t._sideId=s,de(t),t._name=r,t._leftId=a,t._rightId=c,t._sideId=h,t.__$anflg3=o
}function ye(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?ke(t):Xe(t)
...
if("dropdown"===e||"button"===e||"auth"===e||"suggest2-item"===e)return!!s==!1?!0:Se(t);if("checkbox"===e){if(!!s==!1){var o,a,c=t.ctx.js,h=Object(c).hasOwnProperty("live")?c.live:(o=i,i="live",a=De(t),i=o,a);
return{live:h}}return Se(t)}return"select"===e?!!s==!1?!0:Se(t):"b-autocomplete-item"===e?!(r&&"nav"===r.type)==!1?!!s==!1?{val:t._url}:Be(t):Be(t):"input"===e?!!s==!1?Ce(t):Se(t):"tumbler"===e?!!s==!1?!0:Se(t):"link"===e?!t.ctx.hasOwnProperty("tabindex")==!1?{origTabindex:String(t.ctx.tabindex)}:Se(t):"suggest2"===e?!!s==!1?!0:Se(t):Se(t)
}function Be(t){return!!s==!1?!0:!t.ctx.search_cgi==!1?!t._.isArray(t.ctx.search_cgi)==!1?{cgi:t.ctx.search_cgi}:Se(t):Se(t)
}function Ce(t){var e,n,s=(e=i,i="live",n=Ie(t),i=e,n),o=t.ctx.js;if(o){if(o.autoFocus&&o.live)throw new Error('input block can\'t have both "live" and "autoFocus" enabled');
"live"in o&&(s=o.live),o.autoFocus&&(s=!1)}return"gradient"==r.popup?{live:s,popupMods:{gradient:"yes"}}:{live:s}
}function Se(){return void 0}function De(){return!1}function Ie(){return!1}function Pe(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Te(t):Te(t)
}function Te(t){return!!s==!1?[]:Xe(t)}function Oe(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
...
}function Le(t){return"suggest2-item"===n?"highlight"===s?!1:Ne(t):Ne(t)}function Ne(){return void 0}function Re(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,ri(t),void 0):Fe(t):Fe(t):Fe(t)
}function Fe(t){return!!t["i-global"]==!1?qe(t):Xe(t)}function qe(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=ye(t),i=e,n=o,s=r,a);
t["i-global"]=t._.extend(d,(c=i,i="env",h=n,n="i-global",u=Ke(t),i=c,n=h,u)),ri(t)}function $e(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Ue(t):Ue(t)
}function Ue(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Fe(t),t._buf=n,i=o,e.join("")
}return Ve(t)}return Ve(t)}function Ve(t){return!!s==!1?"":Xe(t)}function ze(t){return t.ctx.value||"left"!==t.ctx.side
}function He(t){var e=s;return"areScriptsAsync"===e||"isPageLoadCounter"===e||"geoanswer"===e||"isCounterHeights"===e||"isGameEnabled"===e||"pid"===e||"lr"===e||"ajaxUrl"===e||"framebuster"===e||"shownResult"===e||"isCounterSerpview"===e||"pg"===e||"cache"===e||"nahodki"===e||"pref-ajax"===e||"tld"===e||"maxAjaxUrlLength"===e||"reqid"===e||"nonce"===e||"query"===e||"serpRequestExtraParams"===e?!0:!s==!1?{id:1,lang:1,tld:1,"content-region":1,"user-region":1,login:1,displayName:1,index:1,yandexuid:1,"passport-host":1,"pass-host":1,"passport-msg":1,"static-host":1,"lego-static-host":1,"social-host":1,clck:1,"click-host":1,"export-host":1,"i-host":1,"social-retpath":1,"lego-path":1,sid:1,retpath:1,uid:1}[s]||!1:Xe(t)
}function We(t){var e,o,r,a,c,h=t["i-global"],u={},l={block:"i-global",js:u};for(c in h)h.hasOwnProperty(c)&&(e=i,i="public-params",o=n,n="i-global",r=s,s=c,a=He(t),i=e,n=o,s=r,a)&&(u[c]=h[c]);
return l}function Ke(t){return!!s==!1?{}:Xe(t)}function Ge(){return void 0}function Qe(){return void 0
}function Xe(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Ye(t):Ze(t):Ze(t):Ze(t)}function Ye(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(ri,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Ze(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?Je(t):ti(t):ti(t):ti(t)
}function Je(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}function ti(t){var e=i;if("default"===e)return ei(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?ii(t):ni(t)
}return si(t)}function ei(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,C,S,I,P,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=D(t),i=c,P=v,"undefined"!=typeof P||(P=A.tag),"undefined"!=typeof P||(P="div"),P){var L,N;
n&&A.js!==!1&&(h=i,i="js",l=xe(t),i=h,N=l,N=N?t._.extend(A.js,N===!0?{}:N):A.js===!0?{}:A.js,N&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=N)),j.push("<",P);
var R=(d=i,i="bem",p=Le(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var F=(f=i,i="cls",m=Qe(t),i=f,m);F||(F=A.cls);var q=A.block&&L&&!A.elem;if(R||F){if(j.push(' class="'),R){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var $=(_=i,i="mix",g=Me(t),i=_,g);if(A.mix&&($=$?[].concat($,A.mix):A.mix),$){var U={};U[e(n,s)]=!0,t._.isArray($)||($=[$]);
for(var V=0;V<$.length;V++){var z=$[V];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,G=z.mods||r,Q=z.elemMods||{};
if(H&&j.push(" "),O.INTERNAL[H?"buildClasses":"buildModsClasses"](W,z.elem||z._elem||(z.block?void 0:s),z.elemMods||z.mods,j),z.js&&((L||(L={}))[O.INTERNAL.buildClass(W,z.elem)]=z.js===!0?{}:z.js,q||(q=W&&!z.elem)),H&&!U[e(W,K)]){U[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=Me(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&U[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,$.splice(V+1,0,Z))}}}}}}F&&j.push(R?" ":"",F),q&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=Ge(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
...
}}if(t._.isShortTag(P))j.push("/>");else{P&&j.push(">");var ie=(S=i,i="content",I=T(t),i=S,I);if(ie||0===ie){var R=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=R?1:t.position;var oe=t._listLength;t._listLength=R?1:t._listLength;
var re=t.ctx;t.ctx=ie;var ae=i;i="",Re(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}P&&j.push("</",P,">")}}function ii(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,Re(t),t.ctx=a}o||(t.position=s)}function ni(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
}function si(){throw new Error(this)}function oi(t){return ri(t||this)}function ri(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(oi);
...
}}),_borschik("ShgATzASB-ROJtabxwGoPQHpFf4")&&!function(t){t=t||{},t.oframebustMatchDomain=function(t,e){t="[object Array]"===Object.prototype.toString.call(t)?t:function(){var e=[];
...
return"undefined"==typeof t?e.attr("name"):(e.attr("name",t),this)}}),_borschik("f6eKZk0PhCBFVSlgNXHL-Z0dr2Y")&&BEM.DOM.decl("paranja",{onSetMod:{js:function(){var t=this;
...
},hide:function(){this.page.delMod("fade"),this.delMod("visible")}}),_borschik("nt8Z1jIII0CUhBo2aH9GNFavEGU")&&BEM.DOM.decl("popup",{onSetMod:{js:function(){this.__base(),this._tailPos={}
...
})}}),_borschik("DgYV8KJtpcC4RKBz7TlnBocQDLs")&&BEM.DOM.decl("input",{onSetMod:{js:function(){this._val=this.elem("control").val()
...
}).liveBindTo("box","leftclick tap",function(){this._onBoxClear()})}}),_borschik("mG0rPDzYJLaCa9ggbBrh3vxRcdQ")&&!function(){var t=BEM.DOM,e=$.browser.opera&&$.browser.version<12.1?"keypress":"keydown";
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("8Foq-yXi6hpzHXv2IEbQ8acWRs4")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:41,DELETE:42}),_borschik("ZV86YNdyXic0O2Iehtyg8_mHDk0")&&!function(){var t,e=1e3,i={};
...
}}),_borschik("nbe8Jx19MDU3AAvTjjjTf8fCcfw")&&BEM.DOM.decl("tumbler",{onSetMod:{js:function(){this._check(this.isChecked());
...
this.setMod(i.name,i.val||"")};return this.liveBindTo([e.start,e.stop,e.over].join(" "),function(t){this.isDisabled()||i.call(this,t.type)
...
}),t.preventDefault()}}),!1}}),_borschik("9QLAAdqCc0iG1A5XvbODKFmXe_Q")&&!function(t,e,i){"use strict";
"undefined"!=typeof module&&module.exports?module.exports=i(e,t):"function"==typeof define&&define.amd?define("detect-zoom",function(){return i(e,t)
...
}}}),d}}(window,document),_borschik("tP2OS0l-LXRrSHsUaTjncGm1Agk")&&BEM.DOM.decl("default-search",{onSetMod:{js:function(){try{2!==window.external.IsSearchProviderInstalled(location.origin)&&this._show()
...
}},{lang:"ru"}),BEM.I18N.decl("navigation_spok_yes",{ÐÑÑ:"ÐÑÑ"},{lang:"ru"}),BEM.I18N.decl("notice",{notifications:"Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹"},{lang:"ru"}),BEM.I18N.decl("search2",{"search-button-text":"ÐÐ°Ð¹ÑÐ¸","search-input-label":"ÐÐ°Ð¿ÑÐ¾Ñ","search-service-label":"ÐÐ¾Ð¸ÑÐº Ð¿Ð¾ ÑÐµÑÐ²Ð¸ÑÑ","search-web-label":"ÐÐ¾Ð¸ÑÐº Ð² Ð¸Ð½ÑÐµÑÐ½ÐµÑÐµ"},{lang:"ru"}),BEM.I18N.decl("suggest2",{fact:"Ð¤Ð°ÐºÑÑ",group:"ÐÑÑÐ¿Ð¿Ð° Ð¿Ð¾Ð´ÑÐºÐ°Ð·Ð¾Ðº",nah:"ÐÑ Ð¸ÑÐºÐ°Ð»Ð¸",nav:"Ð¡Ð°Ð¹Ñ",text:"ÐÐ¾Ð¸ÑÐº",traffic:"ÐÑÐ¾Ð±ÐºÐ¸",weather:"ÐÐ¾Ð³Ð¾Ð´Ð°"},{lang:"ru"}),BEM.I18N.decl("suggest2-item",{"quick-answer":"ÐÑÑÑÑÑÐ¹ Ð¾ÑÐ²ÐµÑ"},{lang:"ru"}),BEM.I18N.decl("ticker__text",{notifications:"Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹"},{lang:"ru"}),BEM.I18N.decl("tumbler",{off:"ÐÑÐºÐ»",on:"ÐÐºÐ»"},{lang:"ru"}),BEM.I18N.decl("user",{"ÐÐ°Ð³ÑÑÐ·Ð¸ÑÑ ÑÐ°Ð¹Ð»Ñ":"ÐÐ°Ð³ÑÑÐ·Ð¸ÑÑ ÑÐ°Ð¹Ð»Ñ","Ð ÐµÐ´Ð°ÐºÑÐ¸ÑÐ¾Ð²Ð°ÑÑ ÑÐ¿Ð¸ÑÐ¾Ðº":"Ð ÐµÐ´Ð°ÐºÑÐ¸ÑÐ¾Ð²Ð°ÑÑ ÑÐ¿Ð¸ÑÐ¾Ðº","ÐÐ¾Ð±Ð°Ð²Ð¸ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ":"ÐÐ¾Ð±Ð°Ð²Ð¸ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ",enter:"ÐÐ¾Ð¹ÑÐ¸",exit:"ÐÑÐ¹ÑÐ¸",letter:function(t){return this.keyset("i-tanker__dynamic").key("plural_adv",{count:t.count,one:"Ð½Ð¾Ð²Ð¾Ðµ Ð¿Ð¸ÑÑÐ¼Ð¾",some:"Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÑÐ¼Ð°",many:"Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÐµÐ¼",none:"ÐÐµÑ Ð½Ð¾Ð²ÑÑ Ð¿Ð¸ÑÐµÐ¼"})
