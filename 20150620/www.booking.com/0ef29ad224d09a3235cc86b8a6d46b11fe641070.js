...
p.prototype.renderCollapsedAvailability=function(){if(this._currentList.hotels_count&&!h.isEnabled()&&B.track.getVariant("PcVBcdEQJHGBIJIYDZLQC")){var w=B.jstmpl("listview_collpased_availability").render({numRooms:B.search.group("value").rooms,adults:B.search.group("value").adults,children:B.search.group("value").children,checkin:this._currentList.hotels[0].availability.checkin_localized_date_short,checkout:this._currentList.hotels[0].availability.checkout_localized_date_short});
