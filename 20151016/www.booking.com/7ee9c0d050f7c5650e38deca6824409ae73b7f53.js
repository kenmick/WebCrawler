...
if(B.env.b_run_se_unity){var d=B.require("search/destination/service"),i=B.require("search/destination/service-b");
...
if(B.track.getVariant("PAPXBcaWVZMYCMXC")==1&&B.track.getVariant("PVdIcdRAOAcEUC")==1){var n=o.item.dest_id,l=o.item.dest_type,h="/get_recommended_facilities?lang="+B.env.b_lang_for_url+"&dest_id="+n+"&dest_type="+l,k=$("#destinationSearch"),m=$("#facilityList");
m.empty();
...
if(B.track.getVariant("PAPXBcaWVZMYCMXC")==1&&B.track.getVariant("PVdIcdJOeRe")==1){var i=o.item.dest_id,h="/get_top_districts?lang="+B.env.b_lang_for_url+"&city_id="+i+"&limit=3",k=$("#destinationSearch"),j=$("#districtList");
j.empty();
...
if(B.track.getVariant("PAPXBcaWVZMYCMXC")==1&&booking.track.getVariant("PVdIcdRAOAcEUC")=="1"){var i="";
...
}}if(B.track.getVariant("PAPXBcaWVZMYCMXC")==1&&booking.track.getVariant("PVdIcdJOeRe")=="1"){var i="";
