var Banner = ( function( ) 
{
    ...
    Banner.prototype.ready = function() 
    {
        ...
        if(this.close)this.close.addEventListener("click", this.onExit.bind( this ) );
        ...
        DC.addEventListener(DC.events.EXIT_FULLSCREEN, this.onExitFullscreen.bind( this ) );
    ...
    /*********************
        Video Methods
    **********************/
    Banner.prototype.onExitFullscreen = function()
     {
        DC.hideVideo();
        this.onVideoComplete();
    }
