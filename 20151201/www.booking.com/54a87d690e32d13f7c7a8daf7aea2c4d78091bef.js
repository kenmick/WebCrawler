...
if(((h.MJ(h.MC(a[4]))&&h.MJ(h.MC(a[1])))&&(h.MJ(h.ATLAS_STAGE("ebcBUGCPeeFGbFJFC"))&&h.MJ(h.ATLAS_TRACK("ebcBUGCPeeFGbFJFC"))))){g+=[b[6],h.MG(((h.MC(a[1])||[])[0]||{})["price"]),b[7]].join("");
if(!((h.MJ(h.ATLAS_TRACK("ebcBUGCPeeFGbFJFC")==2)))){g+=b[8];
if((h.MJ(h.MC(a[2]))&&h.MJ(h.MC(a[3])))){g+=[b[9],h.MC(a[2]),b[10],h.MC(a[3]),b[8]].join("")
}g+=b[11]
}g+=b[12]
}else{g+=b[11];
if((h.MJ(h.MC(a[2]))&&h.MJ(h.MC(a[3])))){g+=[b[8],h.MC(a[2]),b[13],h.MC(a[3]),b[11]].join("")
}else{g+=[b[8],h.MB(a[5]),b[11]].join("")
}g+=b[14]
}g+=b[15];
return g
}
