...
i(c).css(F)
}function n(){var K,J=new RegExp("(?:"+y+"-)(.+)","i"),H=J.exec(a.hash),G={center:[l,E],zoom:b},F=i(window).scrollTop(),I=50;
g=false;
...
}if(!B.atlas.assert.tdot&&B.env.b_action=="hotel"){v.addClass("b_map_container_fixed").css({top:B.atlas.getVariant("ebcBUeHdZBJJGOaT")?30:I,bottom:30})
