function iCast_Play_2136295() {
    if (mutex_lock() == -1) {
       setTimeout(iCast_Play_2136295, 100)
    } else {
        iCast_Start_Enabled_2136295 = true
    }
}
if (typeof mutex_lock != "undefined") {
    iCast_Start_Enabled_2136295 = false;
    iCast_Play_2136295()
}
!function(){
	var _win=window,
	_dc=_win.document,
	_track_url = "http://track.ra.icast.cn/icast3/?cid=47079&r=[rnd]&pos_id=1600&ad_id=249954&",
	_ad_id = 2136295,
	_pos_id = 1600,
	_download = "http://ra.gtimg.com/icast/2136295/",
	...
	_um_imp="http://v.admaster.com.cn/i/a56800,b637908,c440,i0,m202,h[M_IESID],f[M_ADIP],t[rnd]",
	_um_clk="",
	_clk_url="http://c.l.qq.com/lclick?seq=20150630000351&loc=WWW_RM_RightMove1",
	_is_done=0,
	_length="length",
	_track_pool = [],
	_util = {
	...
	function run(){
		...
		"poses":{
			...
			"materials":{"main":{"type":"swf","f":"1.swf","w":400,"h":300}}
			}
		], 
		"extdPos":[
			{"tag":"crn",
		...
		"displayLogic":{	
			"init":[
				["freq_2136295","DailyCounter","*ad_life",1],
				["dt1","DownTimer","=0.02"],
				["dt2","DownTimer","=0.02"],
				["ct1","Counter"],
				["ct3","Counter"],
