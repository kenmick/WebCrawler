...
booking.lightbox.show(booking.jstmpl("ge_about_lightbox").render(),{customWrapperClassName:"ge-about-lightbox-wrapper"},function(g){c(".ge-mod-button").click(function(){booking.lightbox.hide();
return false
})
})
})
...
n.unshift({b_classname:d[93],b_ge_freebies:d[37],b_ge_discount:d[37]});
p();
n.shift();
x+=d[99];
return x
...
if(booking.track.getVariant("cQHDHOeWWbeEfHfGET")&&!e.env.b_ge_has_seen_onboarding_on_login){booking.lightbox.show(booking.jstmpl("ge_about_lightbox").render(),{customWrapperClassName:"ge-about-lightbox-wrapper"},function(){c(".ge-mod-button").click(function(){booking.lightbox.hide();
return false
})
})
...
(function(c){B[sNSExperiments][c]={init:function(){if(B.track.getVariant(c)){$(document.body).on("submit",function(d){d.isDefaultPrevented()||$(this).addClass(c)
})
}}}
})("YdVSfPTDPUPcC");
...
var h=(0===g("MWCMcKNBaCFJVKe"));
var e=(f&&h);
if(e){(function(l,j){var k=g(j);
if(!(k===0||k===1)){return
...
}if(f){(function(l,j){var k=g(j);
if(!(k===0||k===1||k===2)){return
}function m(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(o,n){if(k===1){n.params.mr=1
}else{if(k===2){n.params.mr=0.7
}}d(j);
c.track.stage(j,1)
})
}if(c[sNSExperiments]){c[sNSExperiments][j]={priority:9,init:m,initElse:m}
...
}if(e&&c.env.b_lang_for_url==="en-us"){(function(l,j){var k=g(j);
if(!(k===0||k===1)){return
...
c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(n,m){if(typeof(m.params)!=="undefined"&&typeof(m.params.term)!=="undefined"){if(g(j)===1){m.params.eb=(m.params.eb||0)|l
}d(j)
}})
}if(c[sNSExperiments]){c[sNSExperiments][j]={priority:9,init:k,initElse:k}
}else{k()
}})("PVdIGbGWZSBVaHEEKBNKe")
}if(f&&c.env.b_lang_for_url.match(/^en/)&&c.env.b_site_type_id==1){(function(k,j){function l(){var m=g(j);
d(j);
if(!m){return
...
if(!(k===0||k===1||k===2)){return
}function m(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(o,n){if(k===1){n.params.e_cpc=1
}else{if(k===2){n.params.e_cpc=2
}}d(j)
});
c.eventEmitter.bind("AUTOCOMPLETE:afterAjax",function(o,n){if(n.data&&n.data.__first_result_is_country__){c.track.stage(j,1)
}})
}if(c[sNSExperiments]){c[sNSExperiments][j]={priority:9,init:m,initElse:m}
}else{m()
}})(window.jQuery,"PVHbdRNYYdCIO")
}if(f){(function(k,j){function l(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(o,n){var m=g(j);
if(m){n.params.limit_total=15
}d(j)
});
c.eventEmitter.bind("AUTOCOMPLETE:afterAjax",function(q,n){var m=g(j);
