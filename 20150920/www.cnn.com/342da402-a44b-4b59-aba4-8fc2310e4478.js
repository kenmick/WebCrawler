...
// Generated on: 9/18/2015 5:44:12 AM (UTC 9/18/2015 10:44:12 AM)
...
if (ct_dispatcher.configName == 'Release_24082015')
{
	configFoundPHC = true;
			(function(){
...
if (ct_dispatcher.configName == 'Release_09102015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 9\/18\/2015 5:44:12 AM (UTC 9\/18\/2015 10:44:12 AM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
...
if (ct_dispatcher.configName == 'Dev_09102015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 9\/18\/2015 5:44:12 AM (UTC 9\/18\/2015 10:44:12 AM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
