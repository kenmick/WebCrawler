...
;function Oq(a){P.call(this,1,arguments);this.Hb=a}
...
function cr(a,b,c,d){var e=new Uh(a);R(ci,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&qr(b,c);$d("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",$b:f,S:c,ca:function(b,c){var d=c.response;R(ei,new Xh(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&K("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Nq(d.actions)},
Wb:function(){R(di,e)}})}
function er(a,b,c,d,e){var f=new Uh(a);R(hi,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&qr(c,d);$d("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",$b:h,S:d,ca:function(a,b){var c=b.response;R(ji,f);c.actions&&Nq(c.actions)},
Wb:function(){R(ii,f)}})}
