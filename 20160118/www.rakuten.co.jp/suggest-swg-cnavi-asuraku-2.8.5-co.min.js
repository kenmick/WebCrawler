/*
 ...
 Date : 2015-12-03 18:49:46
 suggest - swg.js 2.8.5
 Copyright (c) 2015 Rakuten.Inc
 Date : 2015-12-03 18:49:46
 suggest - cnavi.js 2.8.5
 Copyright (c) 2015 Rakuten.Inc
 Date : 2015-12-03 18:49:46
 suggest - asuraku.js 2.8.5
 Copyright (c) 2015 Rakuten.Inc
 Date : 2015-12-03 18:49:46
*/
...
(a.lastInput=c,a.backup=c,a.readyState=0,clearTimeout(a.waitTimeout),clearInterval(a.showTimer),clearTimeout(h),h=setTimeout(function(){a.index=-1;a.mouseMove=0;a.maxIndex=0;b.invokeFunction(a,"search");a.waitTimeout=setTimeout(function(){clearInterval(a.showTimer)},a.pollingTime*a.retryCount);clearInterval(a.showTimer);a.showTimer=setInterval(function(){2>a.readyState||(a.suggest.append(a.remarks),clearTimeout(a.waitTimeout),clearInterval(a.showTimer),3>a.readyState?setTimeout(function(){a.showInternal()},
