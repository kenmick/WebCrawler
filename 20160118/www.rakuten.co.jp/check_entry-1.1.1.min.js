...
"undefined"==typeof JSON)a.localStorage.isSupport=!1;a.getSettings()&&a.begin()}},beginTestMode:function(c){"already"===c?a.showAlreadyEntry():"nonentry"===c&&a.showNonEntry();var b=a.getSettings();if(1==a.settings.testmodealert){var c="already"===c?"¥¨¥ó¥È¥ê¡¼ºÑ¤ß":"Ì¤¥¨¥ó¥È¥ê¡¼",d=a.eobj.checkentry.attr("id");alert("¥Æ¥¹¥È¥â¡¼¥É¡¡:¡¡"+c+"\n\n¥Á¥§¥Ã¥¯ÂÐ¾Ý¡¡:¡¡"+d+"\ncheckEntryConfigÀßÄê¡¡:¡¡"+(b?"OK":"NG¢Í³ÎÇ§¤·¤Æ¤¯¤À¤µ¤¤")+"\n¥¨¥ó¥È¥ê¡¼ºÑ¤ßÍ×ÁÇ¡¡:¡¡"+(0<a.eobj.alreadyentry.length?"Í­¤ê":"Ìµ¤·¢Í³ÎÇ§¤·¤Æ¤¯¤À¤µ¤¤")+"\nÌ¤¥¨¥ó¥È¥ê¡¼Í×ÁÇ¡¡:¡¡"+(0<a.eobj.nonentry.length?"Í­¤ê":
"Ìµ¤·¢Í³ÎÇ§¤·¤Æ¤¯¤À¤µ¤¤")+"\nÀßÄê¤µ¤ì¤Æ¤¤¤ë¥­¥ã¥ó¥Ú¡¼¥óID¡¡:¡¡"+a.settings.campaignid)}},indexOf:function(a,b){for(var d=0;d<a.length;d++)if(a[d]===b)return d;return-1},getSettings:function(){a.settings=g.RJS_Helpers.readAttr(a.eobj.config,a.settings);if(""==a.settings.jsonurl||""==a.settings.campaignid)return!1;a.settings.ajaxtimeout*=1E3;a.eobj.config.remove();return!0},getLocalStorage:function(){a.localStorage.alreadyEntryList=localStorage[a.localStorage.key]==e?[]:JSON.parse(localStorage[a.localStorage.key]);return a},
