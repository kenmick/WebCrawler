...
function exitClickHandler() {
  ...
  document.getElementById('iner').innerHTML = '<img id="pixelClick" height="1" width="1" style="border-style:block;" alt="" src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/945504334/?value=1.00&currency_code=EUR&label=qRJmCMDQy18QzoDtwgM&guid=ON&script=0">';
}
/**
 * Shows the YT player.
 */
function showYTPlayer0(containerId) {
  if (!creative.dom.ytplayer0) {
    ...
    ytp.setAttribute('video-url', 'https://www.youtube.com/watch?v=F8-jOu5vOHk');
