...
window._AdSameObj_CY2698.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20151212a/fc.swf",
	target: "_blank",
	clsbtn: 0,
	clickUrl: "http://sambaclk.adsame.com/c?z=samba&la=0&si=13&ci=4314&c=5847&or=5565&l=6346&bg=6260&b=6353&u=https://ju.mmstat.com/?url=https://1212.taobao.com/?02&spm=a1z15.20.4415.17303&ad_id=1001321058e705fc53bd&am_id=&cm_id=&pm_id=&campaign_id=570701",
...
window._AdSameObj_CY2698.b1 = new _as_divfl({
	...
	btnHeight: 31,
	btns: [{
	url: _as_bro.isChrome() ? "":"http://rm.sina.com.cn/bj_chuanyang/tb20151212a/close.jpg",
...
window._AdSameObj_CY2698.f2 = new _as_fl({
	width: 85,
	height: 130,
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/tb20151212a/fb.swf",
	target: "_blank",
...
window._AdSameObj_CY2698.run = function() {
	...
	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://samba.adsame.com/s?z=samba&c=5847&l=6346\' />";
	if (_as_bro.isIe6()) {
	...
	if(_as_bro.isChrome()){
		...
		closediv.innerHTML = '<img style="width:77px;height:31px;" src="http://rm.sina.com.cn/bj_chuanyang/tb20151212a/close.jpg">';
		if(!adsame_ss){
			document.getElementById("adsame_closebtn").style.display = "none";
		}
	}
