/* 1.0.0.53.1 - 2015-12-03 15:22:51 */
...
function x1L(x1jV){if(x1p){var x1tf=x1k7().indexOf('msn.com')!==-1?x15+'positioning-update/'+x1jV:x15+x1jV;x1aR(x1tf);if(x1mF.x1mH){x1aR(x1mG);}
