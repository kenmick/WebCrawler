...
g.oa=function(a){if(a=this.Ha(a)){var b=R(U(this,"card")+Ze(a));b&&(E(a,U(this,"active")),E(b,U(this,"card-visible")),Pg(b),this.A=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Zd(b.cardMask),b.cardMask=null))}};
...
g.Mc=function(a,b,c){c.preventDefault();b=qe(c.target,"button");b&&b.disabled||(a=(b=this.M(a,"card-target"))?R(b):a,b=this.Ha(a),this.M(b,"disabled")||(C(b,U(this,"active"))?(this.oa(a),E(b,U(this,"active"))):(this.nb(a),D(b,U(this,"active")))))};
...
g.oa=function(a){Jh.H.oa.call(this,a);a=la(a);var b=this.c[a];b&&(nf(b),this.c[a]=null);if(b=this.f[a])nf(b),this.f[a]=null};
...
g.$c=function(a){if(Lh!=a){Lh&&(this.oa(Lh),Lh=null);var b=v(this.nb,this,a),c=parseInt(this.M(a,"delay-show"),10),b=J(b,-1<c?c:200);bc(a,"card-timer",b.toString());Lh=a;a.alt&&(bc(a,"card-alt",a.alt),a.alt="");a.title&&(bc(a,"card-title",a.title),a.title="")}};
...
function cj(a){a.D=!1;if(a.ka)for(var b in a.j)a.ka(b,a.j[b]);for(var c in a.ga)L(parseInt(c,10));a.ga={};a.T=null;a.ka=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=v(a.Da,a);a.api.removeEventListener=v(a.kf,a);a.api.destroy=v(a.dispose,a);a.api.getLastError=v(a.Xd,a);a.api.getPlayerType=v(a.Yd,a);a.api.getCurrentVideoConfig=v(a.Wd,a);a.api.loadNewVideoConfig=v(a.xc,a);a.api.isReady=v(a.Lf,a)}
...
e.yt_hrd=k}var k=I("TIMING_INFO",{}),l;for(l in k)e[l]=k[l];l=e.srt;delete e.srt;var n;l||0===l||(n=Pi.timing||{},l=Math.max(0,n.responseStart-n.navigationStart),isNaN(l)&&e.pt&&(l=e.pt));if(l||0===l)e.srt=Math.round(l);e.h5jse&&(k=window.location.protocol+t("ytplayer.config.assets.js"),(k=Pi.getEntriesByName?Pi.getEntriesByName(k)[0]:null)?e.h5jse=Math.round(e.h5jse-k.responseEnd):delete e.h5jse);d.aft=Ui();k=d._start;if("cold"==e.yt_lt){n||(n=Pi.timing||{});var q;a:if(q=n,q.msFirstPaint)q=Math.max(0,
q.msFirstPaint);else{var x=window.chrome;if(x&&(x=x.loadTimes,ia(x))){var x=x(),K=1E3*Math.min(x.requestTime||Infinity,x.startLoadTime||Infinity),K=Infinity===K?0:q.navigationStart-K;q=Math.max(0,Math.round(1E3*x.firstPaintTime+K)||0);break a}q=0}0<q&&q>k&&(d.fpt=q);q=c||$i().span;x=n.redirectEnd-n.redirectStart;0<x&&(q.rtime_=x);x=n.domainLookupEnd-n.domainLookupStart;0<x&&(q.dns_=x);x=n.connectEnd-n.connectStart;0<x&&(q.tcp_=x);x=n.connectEnd-n.secureConnectionStart;n.secureConnectionStart>=n.navigationStart&&
...
A(Ok,Kk);g=Ok.prototype;g.me=Nk.getInstance();g.getId=function(){return this.ka||(this.ka=":"+(this.me.c++).toString(36))};
...
;function Bl(){var a=Kd("promoted-button-container");B(a,function(a){var c;a:{var d=G(a,"promo-id");c=parseInt(G(a,"promo-impression-cap"),10)||0;var e=parseInt(G(a,"promo-impression-delay"),10)||0;if(d&&0<c&&0<e){var d="yt-hint-"+d,f=vl(d)||{},h=f.lastSeen,f=f.impressions||0;if(h&&z()-new Date(h)<1E3*e||f>=c){c=!1;break a}f={lastSeen:z(),impressions:f+1};tl(d,f,2592E3)}c=!0}c?(c=Jh.getInstance(),c.Dd(a),"hidden"!=window.getComputedStyle(a).visibility&&c.nb(a),a&&(a=t("yt.dom.VisibilityMonitor.delegateByClass")(a,
t("yt.dom.VisibilityMonitor.States.VISIBLE"),Al,"generic-promo-impression-logging"),zl.push(a))):(a=S("generic-promo-impression-logging",a))&&E(a,"generic-promo-impression-logging")})}
;function Cl(a,b,c){this.j=a;this.f=null;(a=b||null)||(a=Dl(this.j));a="("+a.join("|")+")";a=ra("__%s__",a);this.f=new RegExp(a,"g");this.c=c||{}}
var El=/__([a-z]+(?:_[a-z]+)*)__/g;function Fl(a,b){var c=Gl(R(a));return new Cl(c,b,void 0)}
...
return b}
Cl.prototype.render=function(a,b,c){var d=v(function(d,f){b&&(f=b(f));return c?a[f]||this.c[f]||"":ua(a[f]||this.c[f]||"")},this);
...
g.Ne=function(a){ie(this.T,a)&&(a=se(a,"yt-ui-menu-item"),Nl(this,a),a=G(a,"value"),Pk(this,"privacy-value-input").value=a)};
function Nl(a,b){var c;c=qh.getInstance();c=S(U(c,"content"),a.D);je(c,sa(oe(b)));c=S("is-selected",a.T);E(c,"is-selected");D(b,"is-selected");c=G(b,"privacy-state");bc(a.D,"privacy-state",c)}
function Ol(a,b){df(a.L,b);a.l&&df(a.l,b);df(a.A,b);df(a.D,b)}
function Ml(a){a.A.value="";var b=Pk(a,"title-input-container");E(b,"yt-uix-form-error");b=S("yt-uix-form-error-message",b);Zd(b);df(a.D,!0);(b=S("is-selected",a.T))&&a.O&&b!=a.O&&Nl(a,a.O);df(a.L,!1);a.l&&df(a.l,!0);df(a.A,!0)}
g.Fe=function(a){a.preventDefault();a=this.S;var b={context:this,Z:this.Ce,onError:this.Be};b.method=a.method.toUpperCase();if("POST"==b.method){var c;c=[];Kj(a,c,Nj);c=c.join("&");b.gf=c}else{var d=new Rf;Kj(a,d,Mj);Sf(d);c={};for(var e=0;e<d.c.length;e++){var f=d.c[e];c[f]=d.f[f]}d=b.Ta||{};Hb(d,c);b.Ta=d}ck(a.action,b);Ol(this,!1)};
g.Ce=function(a,b){Ml(this);this.K&&ia(this.K.Mb)&&this.K.Mb({df:b.result.playlistId,fg:b.result.playlistName,ef:b.result.playlistUrl});O("yt-uix-videoactionmenu-hide")};
g.Be=function(a,b){if(b&&b.errors&&b.errors.length){var c=Pk(this,"title-input-container"),d=b.errors[0];D(c,"yt-uix-form-error");if(d){var e=S("yt-uix-form-error-message",c);e?e.innerHTML=d:(d=Td("span","yt-uix-form-error-message",document.createTextNode(String(d))),d.setAttribute("role","alert"),c.appendChild(d))}Ol(this,!0)}};
g.Ee=function(){Ml(this);this.K&&ia(this.K.Lb)&&this.K.Lb()};function Pl(a){Zg.call(this,1,arguments);this.c=a}
A(Pl,Zg);function Ql(a,b,c){Zg.call(this,1,arguments);this.c=c}
A(Ql,Zg);var Rl=new bh("subscription-subscribe-success",Ql),Sl=new bh("subscription-unsubscribe-success",Pl);var Tl,Ul,Vl={Uf:"content-snap-width-1",Vf:"content-snap-width-2",Wf:"content-snap-width-3"};function Wl(){var a=[],b;for(b in Vl)a.push(Vl[b]);return a}
;function Xl(){Yl=Ld("html",void 0,void 0)[0];Zl=R("appbar-guide-button")}
function $l(a,b){var c=b||!1,d=C(Yl,"show-guide");pb(Yl,"show-guide",a);Zl&&Zl.setAttribute("aria-expanded",a);a&&!C(document.documentElement,"no-focus-outline")&&c?(c=S("guide-item",R("guide-container")))&&c.focus():O("guide-hidden");if(a&&!d||!a&&d){d="";if(c=R("page"))d=c.className;d=Ef({"module-id":"guide-main",expanded:!0,auto:!1,"page-class":d,notification:!1});Kg("a=guide-toggled"+(d?"&"+d:""),void 0)}(d=R("page"))&&Ag&&(c=d.style.width,d.style.width="99.99%",ve(d.offsetWidth),d.style.width=
c)}
function am(){return C(Yl,"show-guide")}
function bm(){return C(document.body,"guide-pinning-enabled")}
function cm(){return bm()&&C(Yl,"guide-pinned")}
var Yl=null,Zl=null;var dm;function em(){this.c=fm}
function gm(){function a(){var a=S("guide-likes-playlist-icon");if(a)return se(a,"guide-notification-item")}
dm=R("appbar-main-guide-notification-container");hm(function(){return S("guide-item-container",R("behavior-id-guide-playlists-section"))});
im("yt-uix-playlistlike-unliked","appbar-guide-notification-playlist-unlike");jm("addto-menu-video-added","appbar-guide-notification-playlist-video-added",km,null,new em);im("addto-menu-video-removed","appbar-guide-notification-playlist-video-removed");var b=w(R,"VLWL-guide-item");jm("WATCH_LATER_VIDEO_ADDED","appbar-guide-notification-watch-later-video-added",b,1);jm("WATCH_LATER_VIDEO_REMOVED","appbar-guide-notification-watch-later-video-removed",b,-1);jm("yt-uix-videolike-liked","appbar-guide-notification-video-like",
a,1);jm("yt-uix-videolike-unliked","appbar-guide-notification-video-unlike",a,-1);gh(Sl,lm);gh(Rl,mm)}
function fm(a){if(!a||R(a.id))return null;var b=["ID","URL","TITLE","NOTIFICATION_OVERLAY_MESSAGE"];a=("RD"==a.playlistType?Fl("appbar-guide-item-template-mix",b):Fl("appbar-guide-item-template-playlist",b)).render({ID:"VL"+a.id,URL:a.url,TITLE:a.title,NOTIFICATION_OVERLAY_MESSAGE:a.title});return ef(a)}
function km(a){return R("VL"+a.id+"-guide-item")}
function nm(a,b){var c=Gl(R(a)),c=ef(c);if(b){var d=S("appbar-guide-notification-text-content",c);if(d){var e=document.createTextNode(String(" "+b));d&&e&&d.appendChild(e)}}return c}
function jm(a,b,c,d,e){M(a,function(a){var h=c.apply(null,arguments);if(d){var k=S("guide-count-value",h);if(k){var l=k.innerHTML;""===l.trim()||isNaN(l)||je(k,parseInt(l,10)+d)}}!h&&e&&(k=e.c(a),(l=S("guide-item-container",R("behavior-id-guide-playlists-section")))&&k&&Yd(l,k,0));om(b,!!h,a?a.title:null)||((k=S("guide-item-update-notification",h))&&Zd(k),k=nm(b),D(k,"guide-item-update-notification"),h.appendChild(k),J(w(D,h,"showing-update-notification"),0),J(w(E,h,"showing-update-notification"),
2E3))})}
function hm(a){var b=fm;M("yt-uix-playlistlike-liked",function(){var c=a(),d=b.apply(null,arguments);om("appbar-guide-notification-playlist-like",!!c)||(Yd(c,d,0),O("guide-playlist-section-updated"))})}
function im(a,b){var c=km;M(a,function(){var a=c.apply(null,arguments);pm(a,b,"guide-playlist-section-updated")})}
function pm(a,b,c){om(b,!!a)||(b=nm(b),D(b,"guide-item-removal-notification"),a.appendChild(b),J(w(D,a,"removing-guide-item"),0),J(function(){Zd(a);O(c)},2E3))}
function om(a,b,c){if(b&&am())return!1;Xd(dm);dm.appendChild(nm(a,c));D(document.body,"show-guide-button-notification");J(w(E,document.body,"show-guide-button-notification"),2E3);return!0}
function mm(a){var b;R("guide-subscriptions-promo")?(O("force-reload-subscriptions"),b=!0):b=!1;b||(b=R("guide-channels"),a=a.c,a=Fl("appbar-guide-item-template-channel",["ID","URL","TITLE","THUMBNAIL_URL","NOTIFICATION_OVERLAY_MESSAGE"]).render({ID:a.external_id,URL:a.url,TITLE:a.title,THUMBNAIL_URL:a.thumbnail,NOTIFICATION_OVERLAY_MESSAGE:a.title}),a=ef(a),om("appbar-guide-notification-subscription",!!b)||(Yd(b,a,0),O("guide-channel-section-updated")))}
function lm(a){a=a.c;pm(a?R(a+"-guide-item"):null,"appbar-guide-notification-unsubscription","guide-channel-section-updated")}
;var qm=[],rm=[],sm=[];
function tm(){Wk=R("guide");Hl=R("guide-channels");Il=R("appbar-guide-menu");Jl=R("appbar-guide-iframe-mask");gm();Wk&&(Xl(),C(document.body,"exp-scrollable-guide")||um(),qm.push(of(Wk,"click",vm,"guide-sort-choice")),C(document.body,"exp-scrollable-guide")?(wm(bl(!0)),rm.push(M("page-resize",wm))):rm.push(M("page-resize",xm)),rm.push(M("guide-channel-section-updated",ym)),rm.push(M("guide-playlist-section-updated",w(xm,w(bl,!0)))),rm.push(M("force-reload-subscriptions",zm)),rm.push(M("update-guide-subscriptions",
Am)),rm.push(M("guide-hidden",Bm)),Bl())}
function Cm(a,b){B(Kd("guide-flyout-container",Wk),function(c){qm.push(T(c,a,b))})}
function Dm(a){Em(a.currentTarget)}
function Bm(){var a=Kd("guide-flyout-container",Wk);B(a,function(a){Em(a)})}
function Em(a){var b=S("guide-flyout",a),c=S("guide-flyout-trigger",a);a=S("guide-flyout-iframe-mask",a);E(b,"flyout-shown");a&&E(a,"flyout-shown");E(c,"on-hover")}
function Fm(a){a=a.currentTarget;var b=S("guide-flyout",a),c=S("guide-flyout-trigger",a),d=S("guide-flyout-iframe-mask",a),e=S("guide-flyout",a),f=Qe(e),h=S("guide-channels-list",a),k=bl(!0),l=S("guide-flyout-trigger",a),n=S("guide-flyout-iframe-mask",a),q=k.height-(Il?Il.offsetTop:0);h.style.maxHeight=q-f.top-f.bottom+"px";f=Je(e).height;h=Je(l);l=He(l);q=Math.min(q-f,Math.max(0,k.height-l.y-h.height/2-f/2));h=l.x+h.width;k=k.width-l.x;e.style.bottom=q+"px";n&&(n.style.height=f+"px",n.style.bottom=
...
function um(){Hl=R("guide-channels");sm=Vk();xm(bl(!0));Cm("mouseenter",Fm);Cm("mouseleave",Dm)}
function vm(a){var b=S("guide-sort-button"),c=G(b,"guide-sort")||"",d=G(a.currentTarget,"guide-sort")||"";c!=d&&(bc(b,"guide-sort",d),ck("/guide_channels_ajax?action_set_guide_sort=1",{method:"POST",Ta:{sort:d},format:"JSON",Z:function(a,b){Am(b);var c=Kd("guide-sort-choice");B(c,function(a){var b=G(a,"guide-sort");qh.getInstance();a=a.parentNode;var b=d==b,c=cf("span","yt-uix-button-icon-wrapper",a);if(!c&&b){var e=Td("span",{"class":"yt-uix-button-icon-wrapper yt-uix-button-icon-checkbox"}),f=Td("div",
{"class":"yt-uix-button-icon-dropdown-checked"});e.appendChild(f);Yd(a,e,0)}Lg(c,b)})}}))}
function Am(a){var b=a.channels;b&&(a=R("guide-subscriptions-section"),b=Wd(fd(b)),$d(b,a),sm=Vk(),Hm(),a=Kd("yt-uix-tooltip-tip-visible"),B(a,function(a){E(a,"yt-uix-tooltip-tip-visible")}))}
function Hm(){um();O("yt-dom-content-change",Wk)}
function ym(){Hl&&(Hl.firstElementChild?Hm():zm())}
function Im(a){var b=Kd("guide-item",Wk);return Ta(b,function(b){return G(b,"serialized-endpoint")==a})}
function wm(a){xe(Il,"max-height",a.height-50+"px")}
function xm(a){if(sm&&!C(document.body,"exp-scrollable-guide")){var b=Jm(a),c=sm.length,d=0;sm.sort(Xk||kb);B(sm,function(a,f){var h=Yk(a)-d,h=Math.min(h,b/(c-f));b-=(c-f)*h;var h=d+=h,h=h-(h>=Yk(a)?0:a.D?$k(a,a.D):0),h=Math.max(al(a),h),k=Zk(a,a.l);if(k>h)for(;k>h;){var l;l=a.l;if(l=p(l.lastElementChild)?l.lastElementChild:ce(l.lastChild,!1)){var n=$k(a,l),k=k-n;Yd(a.A,l,0)}else break}else if(k<h){for(l=document.createDocumentFragment();!Wa(ae(a.A));)if(n=be(a.A)){var q=$k(a,n);if(k+q<=h)k+=q,l.appendChild(n);
else break}else break;a.l.appendChild(l)}pb(a.K,"empty-overflow-list",!!Wa(ae(a.A)))});
Gm()}}
function Jm(a){var b=Il,c=R("guide-container");if(!c||!b)return 0;var d=Qe(c),d=d.top+d.bottom,c=be(c).clientHeight,e=0;B(sm,function(a){e+=a.l?Zk(a,a.l):0;e+=Wa(ae(a.A))?0:a.D?$k(a,a.D):0});
...
;function Km(a,b,c){tc.call(this);this.c=null;this.A=!1;this.B=a;this.l=c;this.f=b||window;this.j=v(this.C,this)}
A(Km,tc);Km.prototype.stop=function(){if(null!=this.c){var a=Lm(this),b=Mm(this);a&&!b&&this.f.mozRequestAnimationFrame?Ek(this.c):a&&b?b.call(this.f,this.c):this.f.clearTimeout(this.c)}this.c=null};
Km.prototype.C=function(){this.A&&this.c&&Ek(this.c);this.c=null;this.B.call(this.l,z())};
...
function Cn(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);zn(a,c);var d=a?a.split(":"):[],e=c.h||un(),f=Sm(Xm,"ah",Vm());if(f["::"]&&d.length){for(var h=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,n=h.length&&h[h.length-1]||null,q=n;n&&n.hint==l||(q={hint:l,Oc:[]},h.push(q));q.Oc.push(k)}var x=h.length;if(1<x){var K=c.callback;K&&(c.callback=function(){0==--x&&K()})}for(;d=h.shift();)Dn(d.Oc,c,d.hint)}else Dn(d||[],c,e)}
function Dn(a,b,c){function d(a,b){if(x)return 0;Nm.clearTimeout(q);K.push.apply(K,W);var d=((Wm||{}).config||{}).update;d?d(f):f&&Sm(Xm,"cu",[]).push(f);if(b){cn("me0",a,Q);try{An(b,c,n)}finally{cn("me1",a,Q)}}return 1}
a=Um(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var q=null,x=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=Sm($m(c),"r",[]).sort(),K=Sm($m(c),"L",[]).sort(),Q=[].concat(l);0<h&&(q=Nm.setTimeout(function(){x=!0;k()},h));
var W=wn(a,K);if(W.length){var W=wn(a,l),ga=Sm(Xm,"CP",[]),y=ga.length;ga[y]=function(a){function b(){var a=ga[y+1];a&&a()}
function c(b){ga[y]=null;d(W,a)&&Zm(function(){e&&e();b()})}
if(!a)return 0;cn("ml1",W,Q);0<y&&ga[y-1]?ga[y]=function(){c(b)}:c(b)};
if(W.length){var wj="loaded_"+Xm.I++;Wm[wj]=function(a){ga[y](a);Wm[wj]=null};
a=mn(c,W,"gapi."+wj,l);l.push.apply(l,W);cn("ml0",W,Q);b.sync||Nm.___gapisync?xn(a):yn(a)}else ga[y](Qm)}else d(W)&&e&&e()}
...
;Wm.load=function(a,b){return Bn(function(){return Cn(a,b)})};function En(a){a=ia(a)?{callback:a}:a||{};a._c&&a._c.jsl&&a._c.jsl.h||Hb(a,{_c:{jsl:{h:I("GAPI_HINT_PARAMS",void 0)}}});if(a.gapiHintOverride||I("GAPI_HINT_OVERRIDE")){var b=Hg(document.location.href).gapi_jsh;b&&Hb(a,{_c:{jsl:{h:b}}})}Cn("iframes",a)}
;function Fn(){var a={action_get_delegate_accounts:1,owner_picker_redirect_url:I("OWNER_PICKER_REDIRECT_URL")};a.o=I("CREATOR_CONTEXT","U");return a}
;function Gn(a,b,c,d,e,f){this.c=null;this.D=c;this.A=a;this.C=b;this.j=d;this.l=I("GOOGLEPLUS_HOST")+(e?"/u/"+e:"")+(f?"/b/"+f:"")+"/_/notifications/frame";this.f=R(a)}
...
;function Ln(a,b,c){this.l=!1;this.j=0;this.A=R("sb-container");if(this.c=R("sb-button-notify"))this.C=cf("SPAN","yt-uix-button-content",this.c),this.D=cf("IMG","yt-uix-button-icon-bell",this.c);this.B=R("sb-onepick-target");this.f=new Gn("sb-target","sb-onepick-target",v(this.uf,this),a,b,c);this.f.load({hideNotificationWidget:v(this.Tc,this),showOnepick:v(this.pf,this),hideOnepick:v(this.ke,this)});this.R=Je(this.B);this.sd();T(window,"resize",v(this.sd,this));T(window,"click",v(this.Tc,this));ci();
Bc(v(this.Rd,this),12E4)}
g=Ln.prototype;g.tf=function(){this.l?(Mn(this),Kn(this.f,!0),E(this.c,"yt-uix-gen204")):(J(v(this.Nf,this),0),Kn(this.f,!1),D(this.c,"yt-uix-gen204"))};
g.Nf=function(){this.f.close();Nn(this,!0);D(this.c,"sb-notif-clicked");var a=this.f,b={maxWidgetHeight:a.B()};In(a.c,"onShowNotificationsOnly",b);this.l=!0};
function Nn(a,b){b?(rb(a.A,"sb-off","sb-on"),D(a.A,"sb-card-notif")):(rb(a.A,"sb-on","sb-off"),E(a.A,"sb-card-notif"))}
function Mn(a){Nn(a,!1);a.l=!1;E(a.c,"sb-notif-clicked")}
g.Tc=function(){this.l&&(this.f.close(),Mn(this),On(this))};
g.uf=function(a){this.j=a;On(this)};
function On(a){if(a.C){var b=a.j+"";100<=a.j&&(b=Dc("MASTHEAD_NOTIFICATIONS_COUNT_99PLUS"));je(a.C,b)}a.c&&(0==a.j?rb(a.c,"sb-notif-on","sb-notif-off"):rb(a.c,"sb-notif-off","sb-notif-on"),b=Ec(a.j),a.D&&a.D.setAttribute("alt",b))}
...
g.Rd=function(){6E5<ei()?Kn(this.f,!1):Kn(this.f,!0)};var Pn="";function Qn(){var a=R("yt-masthead-doodle-first-frame"),b=R("logo-container"),c=I("YOODLE_IMG_SRC"),d=new Image;d.src=c;c=Td("img",{id:"logo","class":"logo doodle",usemap:"#doodle",src:c,style:I("YOODLE_EXTRA_ATTRS")});Yd(b,c,0);d.onload=function(){Zd(a)}}
function Rn(){En(function(){var a=R("sb-button-notify"),b=new Ln(I("SANDBAR_LOCALE",void 0),I("SESSION_INDEX",void 0),I("DELEGATED_SESSION_ID",void 0));T(a,"click",v(b.tf,b));O("sandbar-init")})}
function Sn(){if("U"==I("CREATOR_CONTEXT","U")){var a=Kd("yt-masthead-account-picker-user-option"),b=zf(window.location.href);B(a,function(a){if(-1!=a.href.indexOf("action_handle_signin")){var c;c=Ig(a.href,{next:b});ac(a,zf(c))}})}else{var a=Kd("yt-masthead-account-picker-owner-option"),c=yf();
...
function Tn(){E(document.body,"sitewide-ticker-visible");O("masthead-ticker-close")}
function Un(){var a=I("SBOX_JS_URL",Pn);if(a){Pn=a;var b=t("yt.www.masthead.searchbox.init");b?b():Vn(a,function(){var a;try{a=t("yt.www.masthead.searchbox.init"),a()}catch(b){throw b.message=b.message+' sbox type: "'+da(a)+'"',b;}})}}
function Vn(a,b){var c=R("masthead-search-term");if(c){var d,e,f=function(){Wn();Tl=b;Sc(a,b);nf([d,e])};
d=mf(c,"mouseover",f);e=mf(c,"keypress",f)}}
function Wn(){t("yt.www.masthead.searchbox.init")||(Zc(Pn,Tl),Tl=null)}
function Xn(){var a=R("masthead-search-term");a&&a.focus()}
;var Yn,Zn,$n,ao;var bo=!1,co=!1;function eo(){if(Yn=R("masthead-appbar")){Zn=R("masthead-positioner");$n=R("masthead-positioner-height-offset");Xl();fo();go();ho=new Km(io);var a=jo;t("yt.scheduler.instance")&&(a=function(){Yg(jo)});
ko.push(M("init",a));ko.push(M("dispose",lo));mo=Wl();fi.getInstance();no(ki(0,128)?ki(0,129):!0);oo=Ld("html",void 0,void 0)[0];ko.push(M("masthead-ticker-close",po));ko.push(M("appbar-guide-delay-load",fo));ko.push(M("page-resize",qo));bo||jo()}}
function jo(){S("appbar-content-hidable");ro=S("appbar-content-trigger");(co=C(document.body,"always-autohide-masthead"))?dc(Ul,"position-fixed"):bc(Ul,"position-fixed","true");co||ro?so=T(window,"scroll",to):uo();ao=!!R("appbar-guide-menu")&&bm();bo?(ao||(pb(Yl,"guide-pinned",!1),$l(!1),Il&&(Il.scrollTop=0)),qo()):bo=!0;var a=-1*He(Zn).y,b=document.body.scrollHeight,c=a-(b-document.body.clientHeight);0<c&&(document.body.style.minHeight=b+c+"px");Rd(document).scrollTop+=a;vo=Qd(document).y;wo();xo();
Gm()}
function lo(){ro=null;uo()}
function wo(){if(!ro||yo)Lg(Yn,!0);else{var a=Je(ro).height,b=Je(Zn).height,b=He(Zn).y+b,a=Math.floor(He(ro).y)+a,c=C(document.body,"appbar-hidden"),d=Rd(document);c&&a<b+40?(d.scrollTop+=40,Lg(Yn,!0),E(document.body,"appbar-hidden"),zo()):!c&&b<a&&(d.scrollTop-=40,D(document.body,"appbar-hidden"),zo())}}
function zo(){yo=!0;J(function(){yo=!1;C(document.body,"appbar-hidden")&&Lg(Yn,!1)},300)}
var yo=!1;function qo(){ao&&(pb(Yl,"guide-pinned",1251<=(window.innerWidth||document.documentElement.clientWidth)),$l(cm()&&Ao));Bo()}
function Bo(){if(C(document.body,"flex-width-enabled-snap")){var a;a=cm()&&am();var b=(window.innerWidth||document.documentElement.clientWidth)-21-50;1251<=(window.innerWidth||document.documentElement.clientWidth)&&a&&(b-=230);a=1262<=b?"content-snap-width-3":1056<=b?"content-snap-width-2":"content-snap-width-1";C(oo,a)||(ob(oo,mo),D(oo,a),O("yt-dom-content-change"))}else ob(oo,mo)}
function Co(){return R("appbar-guide-menu")}
function go(){var a=C(document.body,"appbar-hidden"),b=He(Zn).y,c=Je(Zn).height;Do=a?b+c:b+c-40}
...
function fo(){if(!Jo){var a=Co();if(!a||S("guide-module-loading",a)){var b=R("appbar-guide-button");if(!b)return;Ko.push(mf(b,"click",function(){O("appbar-show-guide")}))}Io();
Ko.push(of(a,"click",xo,"guide-item"));Ko.push(T(a,"mouseleave",Lo));Ko.push(T(document.body,"click",Eo));a=S("appbar-guide-toggle");Ko.push(T(a,"click",Mo));Jo=!0}}
function xo(){No=!cm()}
function Lo(){No&&($l(!1),No=!1)}
function Mo(){var a=!am();$l(a,!0);a&&O("yt-dom-content-change");cm()&&no(a);Bo()}
function no(a){li(128,!0);li(129,a);Kf("PREF",mi(),63072E3,"/");Ao=a}
function uo(){nf(so);ho&&ho.stop();so=""}
function to(){if(null==ho.c){var a=ho;a.stop();a.A=!1;var b=Lm(a),c=Mm(a);b&&!c&&a.f.mozRequestAnimationFrame?(a.c=xk(a.f,"MozBeforePaint",a.j),a.f.mozRequestAnimationFrame(null),a.A=!0):a.c=b&&c?b.call(a.f,a.j):a.f.setTimeout(fc(a.j),20)}}
function po(){var a=He(Zn).y,b=Je(Zn).height;$n.style.height=a+b+"px";var c=Co();c&&(C(document.body,"appbar-hidden")?c.style.marginTop=a+b+"px":c.style.marginTop=a+b-40+"px",Gm());go()}
...
function Po(a){var b=typeof a;return"object"==b&&a||"function"==b?"o"+la(a):b.substr(0,1)+a}
...
function Qo(a,b){var c=Vf(b);if(a.Y()>c)return!1;!(b instanceof Oo)&&5<c&&(b=new Oo(b));return Zf(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.qb&&"function"==typeof c.qb?c.qb(a):fa(c)||u(c)?Va(c,a):wb(c,a)})}
g.Ca=function(){return this.c.Ca(!1)};function Ro(){}
;var So={Of:"atp",Tf:"ska",Rf:"que",Qf:"mus",Sf:"sus"};function To(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";new Oo;a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",new Oo(Oa((a.capabilities||"").split(","),w(vb,So))))}
To.prototype.equals=function(a){return a?this.id==a.id:!1};function Uo(a,b){this.f=a;this.c=b||null}
;function Vo(){this.c=z()}
new Vo;Vo.prototype.set=function(a){this.c=a};
Vo.prototype.reset=function(){this.set(z())};
...
Wo.prototype.parse=function(a){return this.c(a)};function Xo(a,b){Kk.call(this);this.c=a||1;this.f=b||m;this.A=v(this.sf,this);this.l=z()}
A(Xo,Kk);g=Xo.prototype;g.Ia=!1;g.ma=null;function Yo(a,b){a.c=b;a.ma&&a.Ia?(a.stop(),a.Qa()):a.ma&&a.stop()}
g.sf=function(){if(this.Ia){var a=z()-this.l;0<a&&a<.8*this.c?this.ma=this.f.setTimeout(this.A,this.c-a):(this.ma&&(this.f.clearTimeout(this.ma),this.ma=null),Lk(this,"tick"),this.Ia&&(this.ma=this.f.setTimeout(this.A,this.c),this.l=z()))}};
g.Qa=function(){this.Ia=!0;this.ma||(this.ma=this.f.setTimeout(this.A,this.c),this.l=z())};
...
function Zo(a,b,c){if(ia(a))c&&(a=v(a,c));else if(a&&"function"==typeof a.handleEvent)a=v(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:m.setTimeout(a,b||0)}
;function $o(a,b,c){tc.call(this);this.A=null!=c?v(a,c):a;this.j=b;this.f=v(this.Ue,this);this.c=[]}
A($o,tc);g=$o.prototype;g.Rb=!1;g.lc=0;g.cb=null;g.Zd=function(a){this.c=arguments;this.cb||this.lc?this.Rb=!0:ap(this)};
...
;var ep;function fp(){}
A(fp,bp);function gp(a){return(a=dp(a))?new ActiveXObject(a):new XMLHttpRequest}
...
function mp(a,b){a.yb=z();op(a);a.Sa=a.Na.clone();og(a.Sa,"t",a.C);a.Bb=0;a.W=a.c.cc(a.c.Ab()?b:null);0<a.hc&&(a.Pb=new $o(v(a.Fd,a,a.W),a.hc));a.A.Ka(a.W,"readystatechange",a.hf);var c=a.Za?Eb(a.Za):{};a.ab?(a.Wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.W.send(a.Sa,a.Wb,a.ab,c)):(a.Wb="GET",a.zd&&!od&&(c.Connection="close"),a.W.send(a.Sa,a.Wb,null,c));a.c.va(1)}
g.hf=function(a){a=a.target;var b=this.Pb;b&&3==pp(a)?b.Zd():this.Fd(a)};
g.Fd=function(a){try{if(a==this.W)a:{var b=pp(this.W),c=this.W.l,d=this.W.getStatus();if(P&&!zd(10)||od&&!yd("420+")){if(4>b)break a}else if(3>b||3==b&&!kd&&!qp(this.W))break a;this.Wa||4!=b||7==c||(8==c||0>=d?this.c.va(3):this.c.va(2));rp(this);var e=this.W.getStatus();this.ub=e;var f=qp(this.W);(this.wa=200==e)?(4==b&&sp(this),this.B?(tp(this,b,f),kd&&this.wa&&3==b&&(this.A.Ka(this.f,"tick",this.ff),this.f.Qa())):up(this,f),this.wa&&!this.Wa&&(4==b?this.c.Nb(this):(this.wa=!1,op(this)))):(this.$a=
...
function sp(a){rp(a);vc(a.Pb);a.Pb=null;a.f.stop();a.A.removeAll();if(a.W){var b=a.W;a.W=null;Bp(b);b.dispose()}a.xa&&(a.xa=null)}
...
g=Fp.prototype;g.fc=null;g.ia=null;g.Qb=!1;g.Cd=null;g.Eb=null;g.jc=null;g.gc=null;g.na=null;g.Ja=-1;g.tb=null;g.ob=null;g.connect=function(a){this.gc=a;a=Gp(this.c,null,this.gc);vp();this.Cd=z();var b=this.c.D;null!=b?(this.tb=b[0],(this.ob=b[1])?(this.na=1,Hp(this)):(this.na=2,Ip(this))):(og(a,"MODE","init"),this.ia=new hp(this,0,void 0,void 0,void 0),this.ia.Za=this.fc,np(this.ia,a,!1,null,!0),this.na=0)};
...
function Ip(a){var b=a.c.R;if(null!=b)vp(),b?(vp(),Kp(a.c,a,!1)):(vp(),Kp(a.c,a,!0));else if(a.ia=new hp(a,0,void 0,void 0,void 0),a.ia.Za=a.fc,b=a.c,b=Gp(b,b.Ab()?a.tb:null,a.gc),vp(),!P||zd(10))og(b,"TYPE","xmlhttp"),np(a.ia,b,!1,a.tb,!1);else{og(b,"TYPE","html");var c=a.ia;a=!!a.tb;c.jb=3;c.Na=qg(b.clone());yp(c,a)}}
g.cc=function(a){return this.c.cc(a)};
g.Wc=function(){return!1};
g.kd=function(a,b){this.Ja=a.ub;if(0==this.na)if(b){try{var c=this.f.parse(b)}catch(d){c=this.c;c.ua=this.Ja;Jp(c,2);return}this.tb=c[0];this.ob=c[1]}else c=this.c,c.ua=this.Ja,Jp(c,2);else if(2==this.na)if(this.Qb)vp(),this.jc=z();else if("11111"==b){if(vp(),this.Qb=!0,this.Eb=z(),c=this.Eb-this.Cd,!P||zd(10)||500>c)this.Ja=200,this.ia.cancel(),vp(),Kp(this.c,this,!0)}else vp(),this.Eb=this.jc=z(),this.Qb=!1};
g.Nb=function(){this.Ja=this.ia.ub;if(this.ia.wa)0==this.na?this.ob?(this.na=1,Hp(this)):(this.na=2,Ip(this)):2==this.na&&(a=!1,(a=!P||zd(10)?this.Qb:200>this.jc-this.Eb?!1:!0)?(vp(),Kp(this.c,this,!0)):(vp(),Kp(this.c,this,!1)));else{0==this.na?vp():2==this.na&&vp();var a=this.c;a.ua=this.Ja;Jp(a,2)}};
...
A(Lp,Kk);var Mp=/^https?$/i,Np=["POST","PUT"];g=Lp.prototype;
...
this.ga&&(this.c.responseType=this.ga);zb(this.c)&&(this.c.withCredentials=this.ka);try{Rp(this),0<this.C&&(this.O=Sp(this.c),Ro(Op(this,"Will abort after "+this.C+"ms if incomplete, xhr2 "+this.O)),this.O?(this.c.timeout=this.C,this.c.ontimeout=v(this.Sc,this)):this.L=Zo(this.Sc,this.C,this)),Ro(Op(this,"Sending request")),this.D=!0,this.c.send(a),this.D=!1}catch(f){Ro(Op(this,"Send error: "+f.message)),Pp(this,f)}};
function Sp(a){return P&&yd(9)&&ha(a.timeout)&&p(a.ontimeout)}
...
A(Zp,jk);function $p(a,b){jk.call(this,"timingevent",a);this.size=b}
A($p,jk);function aq(a){jk.call(this,"serverreachability",a)}
A(aq,jk);g=Wp.prototype;g.connect=function(a,b,c,d,e){vp();this.ec=b;this.rb=c||{};d&&p(e)&&(this.rb.OSID=d,this.rb.OAID=e);this.Oa=new Fp(this);this.Oa.fc=null;this.Oa.f=this.l;this.Oa.connect(a)};
function bq(a){cq(a);if(3==a.c){var b=a.vb++,c=a.Fb.clone();ng(c,"SID",a.j);ng(c,"RID",b);ng(c,"TYPE","terminate");dq(a,c);b=new hp(a,0,a.j,b,void 0);b.jb=2;b.Na=qg(c.clone());(new Image).src=b.Na;b.yb=z();op(b)}eq(a)}
...
function dq(a,b){if(a.ca){var c=a.ca.Pc(a);c&&sb(c,function(a,c){ng(b,c,a)})}}
...
g.nd=function(){this.Ea=null;this.U=new hp(this,0,this.j,"rpc",this.B);this.U.Za=null;this.U.hc=0;var a=this.Dc.clone();ng(a,"RID","rpc");ng(a,"SID",this.j);ng(a,"CI",this.Vb?"0":"1");ng(a,"AID",this.eb);dq(this,a);if(!P||zd(10))ng(a,"TYPE","xmlhttp"),np(this.U,a,!0,this.Hb,!1);else{ng(a,"TYPE","html");var b=this.U,c=!!this.Hb;b.jb=3;b.Na=qg(a.clone());yp(b,c)}};
...
function Gp(a,b,c){var d=rg(c);if(""!=d.f)b&&bg(d,b+"."+d.f),cg(d,d.C);else var e=window.location,d=sg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.rb&&sb(a.rb,function(a,b){ng(d,b,a)});
...
g.Gc=function(){};
g.ac=function(){};
g.Pc=function(){return{}};function qq(a,b){Xo.call(this);this.B=0;if(ia(a))b&&(a=v(a,b));else if(a&&ia(a.handleEvent))a=v(a.handleEvent,a);else throw Error("Invalid listener argument");this.D=a;xk(this,"tick",v(this.C,this));this.stop();Yo(this,5E3+2E4*Math.random())}
A(qq,Xo);qq.prototype.C=function(){if(500<this.c){var a=this.c;24E4>2*a&&(a*=2);Yo(this,a)}this.D()};
qq.prototype.Qa=function(){qq.H.Qa.call(this);this.B=z()+this.c};
qq.prototype.stop=function(){this.B=0;qq.H.stop.call(this)};function rq(a,b){this.sa=a;this.A=b;this.j=new H;this.f=new qq(this.Bf,this);this.c=null;this.K=!1;this.B=null;this.R="";this.D=this.l=0;this.C=[]}
A(rq,pq);g=rq.prototype;g.subscribe=function(a,b,c){return this.j.subscribe(a,b,c)};
...
g.dispose=function(){this.K||(this.K=!0,this.j.clear(),sq(this),vc(this.j))};
g.isDisposed=function(){return this.K};
...
g.Bf=function(){this.f.stop();var a=this.c,b=0;a.U&&b++;a.da&&b++;0!=b?this.f.Qa():this.connect(this.B,this.l)};function vq(){tc.call(this);this.A=new H;uc(this,w(vc,this.A))}
A(vq,tc);vq.prototype.subscribe=function(a,b,c){return this.isDisposed()?0:this.A.subscribe(a,b,c)};
...
;var Hq=z(),Iq=null,Jq=Array(50),Kq=-1,Lq=!1;function Mq(a){Nq();Iq.push(a);Oq(Iq)}
function Pq(a,b){Nq();var c=Iq,d=Qq(a,String(b));Wa(c)?Rq(d):(Oq(c),B(c,function(a){a(d)}))}
...
function Oq(a){var b=Jq;if(b[0]){var c=Kq,d=Lq?c:-1;do{var d=(d+1)%50,e=b[d];B(a,function(a){a(e)})}while(d!=c);
Jq=Array(50);Kq=-1;Lq=!1}}
function Qq(a,b){var c=(z()-Hq)/1E3;c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")}
...
function Xq(a){return ea(a)?Pa(a,Wq):[]}
function Yq(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+(a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+"}":"null"}
function Zq(a){return ea(a)?"["+Pa(a,Yq).join(",")+"]":"null"}
;function $q(a){this.A=this.j="";this.c="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(a.match(wf)[4]||null)||null||"";b&&(this.A=":"+b);this.j=xf(a)||"";a=Ib;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ha(a,"10.0")&&(this.f=!1))}
...
function er(a){a=a||[];return"["+Pa(a,function(a){return a?a.toString():"null"}).join(",")+"]"}
...
function gr(a){return Pa(a,function(a){return dr(a)})}
function hr(){return Pa(Ya,function(a){return new cr(a)})}
function ir(a,b){return a||b?a&&b?a.id==b.id&&a.name==b.name:!1:!0}
function jr(a,b){return Ta(a,function(a){return a.id==b})}
function kr(a,b){return Ta(a,function(a){return a||b?!a!=!b?!1:a.id==b.id:!0})}
function lr(a,b){return Ta(a,function(a){return Tq(a,b)})}
;function mr(a){vq.call(this);this.D=a;this.c=[]}
A(mr,vq);mr.prototype.la=function(){return this.c};
...
function or(a,b){var c=a.c.length!=b.length;a.c=Oa(a.c,function(a){return!!kr(b,a)});
for(var d=0,e=b.length;d<e;d++)c=nr(a,b[d])||c;return c}
function pr(a,b){var c=a.c.length;a.c=Oa(a.c,function(a){return!(a||b?!a!=!b?0:a.id==b.id:1)});
return a.c.length<c}
...
A(rr,vq);var sr=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=rr.prototype;g.stop=function(){this.c&&(this.c.abort(),this.c=null);isNaN(this.f)||(L(this.f),this.f=NaN)};
...
g.Cf=function(a){this.c=null;a.status&&404==a.status?this.j>=sr.length?this.F("pairingFailed",Error("DIAL polling timed out")):(a=sr[this.j],this.f=J(v(this.rd,this),a),this.j++):this.F("pairingFailed",Error("Server error "+a.status))};
g.Ef=function(){this.c=null;this.F("pairingFailed",Error("Server not responding"))};var tr;function ur(){var a=vr(),b=wr();Va(a,b);if(xr()){var c=a,d;d=0;for(var e=c.length,f;d<e;){var h=d+e>>1,k;k=kb(b,c[h]);0<k?d=h+1:(e=h,f=!k)}d=f?d:~d;0>d&&fb(c,-(d+1),0,b)}a=yr(a);if(Wa(a))try{Lf("remote_sid")}catch(l){}else try{Kf("remote_sid",a.join(","),-1,"/")}catch(l){}}
function vr(){var a=vl("yt-remote-connected-devices")||[];a.sort(kb);return a}
function yr(a){if(Wa(a))return[];var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return Pa(a,function(a,b){return 0==b?a:a.substring(c.length)})}
function zr(a){tl("yt-remote-connected-devices",a,86400)}
function wr(){if(Ar)return Ar;var a=vl("yt-remote-device-id");a||(a=fr(),tl("yt-remote-device-id",a,31536E3));for(var b=vr(),c=1,d=a;Va(b,d);)c++,d=a+"#"+c;return Ar=d}
function Br(){return vl("yt-remote-session-browser-channel")}
function xr(){return vl("yt-remote-session-screen-id")}
function Cr(a){5<a.length&&(a=a.slice(a.length-5));var b=Pa(Dr(),function(a){return a.loungeToken}),c=Pa(a,function(a){return a.loungeToken});
Sa(c,function(a){return!Va(b,a)})&&Er();
...
function Jr(a,b){tl("yt-remote-session-browser-channel",a);tl("yt-remote-session-screen-id",b);var c=vr(),d=wr();Va(c,d)||c.push(d);zr(c);ur()}
function Kr(a){a||(wl("yt-remote-session-screen-id"),wl("yt-remote-session-video-id"));ur();a=vr();$a(a,wr());zr(a)}
...
A(Mr,mr);g=Mr.prototype;g.lb=function(){Nr(this)&&this.F("screenChange");Fr()&&Or(this);L(this.f);this.f=J(v(this.lb,this),1E4)};
...
g.J=function(){L(this.f);Mr.H.J.call(this)};
function Or(a){if(a.c.length){var b=Pa(a.c,function(a){return a.id}),c=ar(a.j,"/pairing/get_lounge_token_batch");
...
function Nr(a){var b=Xq(Dr()),b=Oa(b,function(a){return!a.uuid});
return or(a,b)}
function Pr(a,b){Cr(Pa(a.c,Vq));b&&Er()}
;function Qr(a,b){vq.call(this);this.B=b;for(var c=vl("yt-remote-online-screen-ids")||"",c=c?c.split(","):[],d={},e=this.B(),f=0,h=e.length;f<h;++f){var k=e[f].id;d[k]=Va(c,k)}this.c=d;this.C=a;this.j=this.l=NaN;this.f=null;Rr("Initialized with "+Qj(this.c))}
A(Qr,vq);g=Qr.prototype;g.isEmpty=function(){return Cb(this.c)};
g.update=function(){Rr("Updating availability on schedule.");var a=this.B(),b=tb(this.c,function(b,d){return b&&!!lr(a,d)},this);
Sr(this,b)};
...
g.J=function(){L(this.j);this.j=NaN;this.f&&(this.f.abort(),this.f=null);Qr.H.J.call(this)};
function Sr(a,b){var c;a:if(ub(b)!=ub(a.c))c=!1;else{c=yb(b);for(var d=0,e=c.length;d<e;++d)if(!a.c[c[d]]){c=!1;break a}c=!0}c||(Rr("Updated online screens: "+Qj(a.c)),a.c=b,a.F("screenChange"));Ur(a)}
function Vr(a){isNaN(a.j)||L(a.j);a.j=J(v(a.oc,a),0<a.l&&a.l<z()?2E4:1E4)}
g.oc=function(){L(this.j);this.j=NaN;this.f&&this.f.abort();var a=Wr(this);if(ub(a)){var b=ar(this.C,"/pairing/get_screen_availability"),c={lounge_token:yb(a).join(",")};this.f=br(this.C,b,c,v(this.Se,this,a),v(this.Re,this))}else Sr(this,{}),Vr(this)};
g.Se=function(a,b){this.f=null;var c=yb(Wr(this));if(ib(c,yb(a))){for(var c=b.screens||[],d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;Sr(this,d);Vr(this)}else this.P("Changing Screen set during request."),this.oc()};
...
function Wr(a){var b={};B(a.B(),function(a){a.token?b[a.token]=a.id:this.P("Requesting availability of screen w/o lounge token.")});
return b}
function Ur(a){var b=yb(tb(a.c,function(a){return a}));
...
Gr(Pa(a,Vq))}
;function X(a){mr.call(this,"ScreenService");this.C=a;this.f=this.j=null;this.l=[];this.B={};Xr(this)}
A(X,mr);g=X.prototype;g.lb=function(){this.j.lb();var a=this.f,b;b=parseInt(vl("yt-remote-fast-check-period")||"0",10);b=z()-144E5<b?0:b;a.l=b;a.l?Vr(a):(a.l=z()+3E5,tl("yt-remote-fast-check-period",a.l),a.oc());this.c.length&&(this.F("screenChange"),this.f.isEmpty()||this.F("onlineScreenChange"))};
...
g.la=function(a){return a?this.c:cb(this.c,Oa(this.l,function(a){return!this.contains(a)},this))};
g.Hd=function(){return Oa(this.la(!0),function(a){return!!this.f.c[a.id]},this)};
...
g.Jd=function(a,b,c,d,e){qr(this,"getDialScreenByPairingCode "+a+" / "+b);var f=new rr(this.C,a,b,c);f.subscribe("pairingComplete",v(function(a){vc(f);d(Zr(this,a))},this));
...
function Zr(a,b){var c=a.get(b.id);c?(c.uuid=b.uuid,b=c):((c=lr(a.l,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.l.push(b),tl("yt-remote-automatic-screen-cache",Pa(a.l,Vq)));cs(a);a.B[b.uuid]=b.id;tl("yt-remote-device-id-map",a.B,31536E3);return b}
function cs(a){a.B=vl("yt-remote-device-id-map")||{}}
X.prototype.dispose=X.prototype.dispose;function ds(a,b,c){vq.call(this);this.T=c;this.L=a;this.f=b;this.j=null}
A(ds,vq);g=ds.prototype;g.Ob=function(a){this.j=a;this.F("sessionScreen",this.j)};
...
g.J=function(){this.qc("");ds.H.J.call(this)};function gs(a,b){ds.call(this,a,b,"CastSession");this.c=null;this.B=0;this.l=null;this.D=v(this.Hf,this);this.C=v(this.af,this);this.B=J(v(function(){hs(this,null)},this),12E4)}
A(gs,ds);g=gs.prototype;g.pc=function(a){if(this.c){if(this.c==a)return;es(this,"Overriding cast sesison with new session object");this.c.removeUpdateListener(this.D);this.c.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.C)}this.c=a;this.c.addUpdateListener(this.D);this.c.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.C);this.l&&is(this);js(this,"getMdxSessionStatus")};
...
g.qc=ba;g.J=function(){fs(this,"disposeInternal");L(this.B);this.B=0;this.c&&(this.c.removeUpdateListener(this.D),this.c.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.C));this.c=null;gs.H.J.call(this)};
...
function hs(a,b){L(a.B);if(b){if(fs(a,"onConnectedScreenId_: Received screenId: "+b),!a.j||a.j.id!=b){var c=v(a.Ob,a),d=v(a.ha,a);a.Qc(b,c,d,5)}}else a.ha(Error("Waiting for session status timed out."))}
g.Qc=function(a,b,c,d){Yr(this.L,this.f.label,a,this.f.friendlyName,v(function(e){e?b(e):0<=d?(es(this,"Screen "+a+" appears to be offline. "+d+" retries left."),J(v(this.Qc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
A(ks,ds);g=ks.prototype;g.pc=function(a){this.B=a;this.B.addUpdateListener(this.S)};
g.fb=function(a){this.l=a;this.D()};
g.stop=function(){this.c();this.c=ba;L(this.C);this.B?this.B.stop(v(this.ha,this,null),v(this.ha,this,"Failed to stop DIAL device.")):this.ha()};
g.J=function(){this.c();this.c=ba;L(this.C);this.B&&this.B.removeUpdateListener(this.S);this.B=null;ks.H.J.call(this)};
...
g.ic=function(a){this.O=fr();if(this.l){var b=new chrome.cast.DialLaunchResponse(!0,ms(this));a(b);ls(this)}else this.D=v(function(){L(this.C);this.D=ba;this.C=NaN;var b=new chrome.cast.DialLaunchResponse(!0,ms(this));a(b);ls(this)},this),this.C=J(v(function(){this.D()},this),100)};
...
this.ic(b)},this))};function ns(a,b){ds.call(this,a,b,"ManualSession");this.c=J(v(this.fb,this,null),150)}
A(ns,ds);ns.prototype.stop=function(){this.ha()};
ns.prototype.pc=ba;ns.prototype.fb=function(){L(this.c);this.c=NaN;var a=lr(this.L.la(),this.f.label);a?this.Ob(a):this.ha(Error("No such screen"))};
ns.prototype.J=function(){L(this.c);this.c=NaN;ns.H.J.call(this)};function os(a){vq.call(this);this.f=a;this.c=null;this.B=!1;this.j=[];this.l=v(this.Pe,this)}
A(os,vq);g=os.prototype;
...
function us(a,b){return b?Ta(a.j,function(a){return Tq(b,a.label)},a):null}
...
g.Jf=function(){this.isDisposed()?this.P("Stopping session on disposed cast v2"):this.c?(this.c.stop(),vc(this.c),this.c=null):ts("Stopping non-existing session")};
g.requestSession=function(){chrome.cast.requestSession(v(this.ld,this),v(this.Te,this))};
g.J=function(){this.f.unsubscribe("onlineScreenChange",v(this.Kd,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.l);var a=ps,b=t("yt.mdx.remote.debug.handlers_");$a(b||[],a);vc(this.c);os.H.J.call(this)};
...
function vs(a,b,c){vc(a.c);(a.c=b)?(c?a.F("yt-remote-cast2-receiver-resumed",b.f):a.F("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",v(a.md,a,b)),b.j?a.F("yt-remote-cast2-session-change",b.j):c&&a.c.fb(null)):a.F("yt-remote-cast2-session-change",null)}
...
b.receiverType==chrome.cast.ReceiverType.CAST&&(ts("onSessionEstablished_: manual to cast session change "+b.friendlyName),vc(this.c),this.c=new gs(this.f,b),this.c.subscribe("sessionScreen",v(this.md,this,this.c)),this.c.fb(null));this.c.pc(a)}}};
...
function qs(a){var b=a.f.Hd(),c=a.c&&a.c.f;a=Pa(b,function(a){c&&Tq(a,c.label)&&(c=null);var b=a.uuid?a.uuid:a.id,f=us(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
...
var Gs=null;function xs(){var a;a=0<=Ib.search(/\ (CrMo|Chrome|CriOS)\//);return zg||a}
function zs(a){var b=!1;if(!Gs){var c=t("yt.mdx.remote.cloudview.instance_");c||(c=new os(a),c.subscribe("yt-remote-cast2-availability-change",function(a){tl("yt-remote-cast-available",a);O("yt-remote-cast2-availability-change",a)}),c.subscribe("yt-remote-cast2-receiver-selected",function(a){ys("onReceiverSelected: "+a.friendlyName);
tl("yt-remote-cast-receiver",a);O("yt-remote-cast2-receiver-selected",a)}),c.subscribe("yt-remote-cast2-receiver-resumed",function(a){ys("onReceiverResumed: "+a.friendlyName);
...
function Bs(a){Ds(!0);As(!1);Gs.init(!1,function(b){b?(Hs(!0),O("yt-remote-cast2-api-ready")):(Cs("Failed to initialize cast API."),Ds(!1),wl("yt-remote-cast-available"),wl("yt-remote-cast-receiver"),Es());a(b)})}
...
function Ps(a){a.R=null;a.B=null;a.f=-1;a.C=0;a.D=z()}
...
function Ss(a,b){a.C=b;a.D=z()}
function Ts(a){switch(a.f){case 1:return(z()-a.D)/1E3+a.C;case -1E3:return 0}return a.C}
function Us(a,b){Os(a,"setVideoId");var c=a.index;a.index=Ma(a.V,b);c!=a.index&&Ps(a)}
function Vs(a,b,c){var d=a.c;a.c=b;a.index=c;b!=d&&Ps(a)}
function Ws(a,b,c){Os(a,"setPlaylist");c=c||Rs(a);ib(a.V,b)&&c==Rs(a)||(a.V=db(b),Us(a,c))}
Ns.prototype.remove=function(a){Os(this,"remove");var b=Rs(this);return $a(this.V,a)?(this.index=Ma(this.V,b),!0):!1};
function Xs(a){var b={};b.videoIds=db(a.V);b.index=a.index;b.listId=a.j;b.videoId=a.c;b.playerState=a.f;b.volume=a.A;b.muted=a.l;b.audioTrackId=a.R;b.trackData=Fb(a.B);b.playerTime=a.C;b.playerTimeAt=a.D;return b}
...
$s(this,Ks())}
A(Ys,vq);function at(a){return new Ns(a.l.getPlayerContextData())}
...
g.J=function(){L(this.B);this.B=NaN;it(this);this.l=null;this.C.clear();$s(this,null);Ys.H.J.call(this)};
function Zs(a){B(["remotePlayerChange","remoteQueueChange"],function(a){this.D.push(this.l.subscribe(a,w(this.Je,a),this))},a)}
function it(a){B(a.D,function(a){this.l.unsubscribeByKey(a)},a);
a.D.length=0}
...
function dt(a){L(a.B);a.B=J(v(function(){this.F("remotePlayerChange");this.B=NaN},a),2E3)}
...
g.P=function(a){Pq("CP",a)};function Y(a,b,c){vq.call(this);this.B=NaN;this.X=!1;this.K=this.D=this.T=this.L=NaN;this.S=[];this.j=this.G=this.c=null;this.Ma=a;this.S.push(T(window,"beforeunload",v(this.ae,this)));this.f=[];this.G=new Ns;3==c["mdx-version"]&&(this.G.j="RQ"+b.token);this.$=b.id;this.c=kt(this,c);this.c.subscribe("handlerOpened",this.ze,this);this.c.subscribe("handlerClosed",this.ve,this);this.c.subscribe("handlerError",this.we,this);this.G.j?this.c.subscribe("handlerMessage",this.xe,this):this.c.subscribe("handlerMessage",
...
g.J=function(){nt(this);ot(this);pt(this);L(this.D);this.D=NaN;L(this.K);this.K=NaN;this.j=null;nf(this.S);this.S.length=0;this.c.dispose();Y.H.J.call(this);this.f=this.G=this.c=null};
...
function lt(a){a.B=J(v(function(){this.N("Connecting timeout");this.l(1)},a),2E4)}
function nt(a){L(a.B);a.B=NaN}
function pt(a){L(a.L);a.L=NaN}
function qt(a){ot(a);a.T=J(v(function(){rt(this,"getNowPlaying")},a),2E4)}
function ot(a){L(a.T);a.T=NaN}
function tt(a){var b=a.c;return!!b.c&&3==b.c.c&&isNaN(a.B)}
g.ze=function(){this.N("Channel opened");this.X&&(this.X=!1,pt(this),this.L=J(v(function(){this.N("Timing out waiting for a screen.");this.l(1)},this),15E3));
Jr(tq(this.c),this.$)};
...
function wt(a,b){var c=b.c.videoId;delete b.c.videoId;c==a.G.c&&(Cb(b.c)?a.G.B=null:a.G.B=b.c,a.F("remotePlayerChange"))}
...
g.xe=function(a){a.c?this.N("Received: action="+a.f+", params="+Qj(a.c)):this.N("Received: action="+a.f+" {}");switch(a.f){case "loungeStatus":a=Oj(a.c.devices);this.f=Pa(a,function(a){return new To(a)});
a=!!Ta(this.f,function(a){return"LOUNGE_SCREEN"==a.type});
ut(this,a);break;case "loungeScreenConnected":ut(this,!0);break;case "loungeScreenDisconnected":bb(this.f,function(a){return"LOUNGE_SCREEN"==a.type});
ut(this,!1);break;case "remoteConnected":var b=new To(Oj(a.c.device));Ta(this.f,function(a){return a.equals(b)})||Za(this.f,b);
break;case "remoteDisconnected":b=new To(Oj(a.c.device));bb(this.f,function(a){return a.equals(b)});
...
g.ye=function(a){a.c?this.N("Received: action="+a.f+", params="+Qj(a.c)):this.N("Received: action="+a.f);Ct(this,a);Dt(this,a);if(tt(this)){var b=this.G.clone(),c=!1,d,e,f,h,k,l;a.c&&(d=a.c.videoId||a.c.video_id,e=a.c.videoIds||a.c.video_ids,f=a.c.state,h=a.c.currentTime||a.c.current_time,k=a.c.volume,l=a.c.muted,p(a.c.currentError)&&Oj(a.c.currentError));if("onSubtitlesTrackChanged"==a.f)d==Rs(this.G)&&(delete a.c.videoId,Cb(a.c)?this.G.B=null:this.G.B=a.c,this.F("remotePlayerChange"));else if(Rs(this.G)||
"onStateChange"!=a.f){"playlistModified"!=a.f&&"nowPlayingPlaylist"!=a.f||e?(d||"nowPlaying"!=a.f&&"nowPlayingPlaylist"!=a.f?d||(d=Rs(this.G)):Us(this.G,""),e&&(e=e.split(","),Ws(this.G,e,d))):Ws(this.G,[]);e=this.G;var n=d;Os(e,"add");n&&!Va(e.V,n)?(e.V.push(n),e=!0):e=!1;e&&rt(this,"getPlaylist");d&&Us(this.G,d);b.index==this.G.index&&ib(b.V,this.G.V)?"playlistModified"!=a.f&&"nowPlayingPlaylist"!=a.f||this.F("remoteQueueChange"):this.F("remoteQueueChange");p(f)&&(a=parseInt(f,10),a=isNaN(a)?-1:
...
function Ct(a,b){switch(b.f){case "loungeStatus":var c=Oj(b.c.devices);a.f=Pa(c,function(a){return new To(a)});
break;case "loungeScreenDisconnected":bb(a.f,function(a){return"LOUNGE_SCREEN"==a.type});
break;case "remoteConnected":var d=new To(Oj(b.c.device));Ta(a.f,function(a){return a.equals(d)})||Za(a.f,d);
break;case "remoteDisconnected":d=new To(Oj(b.c.device)),bb(a.f,function(a){return a.equals(d)})}}
function Dt(a,b){var c=!1;if("loungeStatus"==b.f)c=!!Ta(a.f,function(a){return"LOUNGE_SCREEN"==a.type});
...
Y.prototype.getPlayerContextData=Y.prototype.fa;Y.prototype.Ba=function(a){var b=new Ns(a);b.c&&b.c!=this.G.c&&(this.j=b.c,L(this.D),this.D=J(v(this.lf,this),5E3));var c=[];this.G.j==b.j&&this.G.c==b.c&&this.G.index==b.index&&ib(this.G.V,b.V)||c.push("remoteQueueChange");this.G.f==b.f&&this.G.A==b.A&&this.G.l==b.l&&Ts(this.G)==Ts(b)&&Qj(this.G.B)==Qj(b.B)||c.push("remotePlayerChange");this.G.reset(a);B(c,function(a){this.F(a)},this)};
...
Y.prototype.reconnect=Y.prototype.Va;function vt(a){L(a.K);a.K=J(v(a.l,a,1),864E5)}
...
function It(){if(!t("yt.mdx.remote.castv2_")&&!Jt&&(Wa(Ya)&&eb(Ya,vl("yt-remote-online-dial-devices")||[]),Et())){var a=Ht();a?(a.removeReceiverListener("YouTube",Kt),a.addReceiverListener("YouTube",Kt),Ft("API initialized in the other binary")):(a=new cast.Api,r("yt.mdx.remote.castapi.api_",a,void 0),a.addReceiverListener("YouTube",Kt),a.setReloadTabRequestHandler&&a.setReloadTabRequestHandler(function(){J(function(){window.location.reload(!0)},1E3)}),Mq(Gt),Ft("API initialized"));
Jt=!0}}
function Lt(a){var b=Ua(Ya,function(b){return b.id==a.id});
0<=b&&(Ya[b]=dr(a))}
function Kt(a){a.length&&Ft("Updating receivers: "+Qj(a));Mt(a);O("yt-remote-cast-device-list-update");B(Nt(),function(a){Ot(a.id)});
B(a,function(a){if(a.isTabProjected){var c=Pt(a.id);Ft("Detected device: "+c.id+" is tab projected. Firing DEVICE_TAB_PROJECTED event.");J(function(){O("yt-remote-cast-device-tab-projected",c.id)},1E3)}})}
function Qt(a,b){Ft("Updating "+a+" activity status: "+Qj(b));var c=Pt(a);c?(b.activityId&&(c.c=b.activityId),c.status="running"==b.status?"RUNNING":"stopped"==b.status?"STOPPED":"error"==b.status?"ERROR":"UNKNOWN","RUNNING"!=c.status&&(c.c=""),Lt(c),O("yt-remote-cast-device-status-update",c)):Ft("Device not found")}
function Nt(){It();return hr()}
function Mt(a){a=Pa(a,function(a){var c=a.id,d;d=a.name;d=-1!=d.indexOf("&")?"document"in m?Ca(d):Ea(d):d;c={id:c,name:d};if(a=Pt(a.id))c.activityId=a.c,c.status=a.status;return c});
Xa();eb(Ya,a)}
function Pt(a){var b=Nt();return Ta(b,function(b){return b.id==a})||null}
...
var Jt=!1,Ya=t("yt.mdx.remote.castapi.devices_")||[];r("yt.mdx.remote.castapi.devices_",Ya,void 0);function St(a){vq.call(this);this.l=0;this.La=Tt();this.B=NaN;this.C=a;this.N("Initializing local screens: "+Zq(this.La));this.j=Ut();this.N("Initializing account screens: "+Zq(this.j));this.bc=null;this.c=[];this.f=[];Vt(this,Nt()||[]);this.N("Initializing DIAL devices: "+er(this.f));a=Xq(Hr());Wt(this,a);this.N("Initializing online screens: "+Zq(this.c));this.l=z()+3E5;Xt(this)}
A(St,vq);g=St.prototype;g.N=function(a){Pq("RM",a)};
g.P=function(a){Pq("RM",a)};
function Ut(){var a=Tt(),b=Xq(Hr());return Oa(b,function(b){return!kr(a,b)})}
function Tt(){var a=Xq(Dr());return Oa(a,function(a){return!a.uuid})}
function Xt(a){M("yt-remote-cast-device-list-update",function(){var a=Nt();Vt(this,a||[])},a);
...
g.vd=function(){var a=Nt()||[];Wa(a)||Vt(this,a);a=Yt(this);Wa(a)||(Ra(a,function(a){return!kr(this.j,a)},this)&&Fr()?Zt(this):$t(this,a))};
function au(a,b){var c=Yt(a);return Oa(b,function(a){return a.uuid?(a=jr(this.f,a.uuid),!!a&&"RUNNING"==a.status):!!kr(c,a)},a)}
function Vt(a,b){var c=!1;B(b,function(a){var b=lr(this.La,a.id);b&&b.name!=a.name&&(this.N("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
c&&(a.N("Renaming due to DIAL."),bu(a));Ir(gr(b));var d=!ib(a.f,b,ir);d&&a.N("Updating DIAL devices: "+er(a.f)+" to "+er(b));a.f=b;Wt(a,a.c);d&&a.F("onlineReceiverChange")}
...
function Wt(a,b,c){var d=au(a,b),e=!ib(a.c,d,Uq);if(e||c)Wa(b)||Gr(Pa(d,Vq));e&&(a.N("Updating online screens: "+Zq(a.c)+" -> "+Zq(d)),a.c=d,a.F("onlineReceiverChange"))}
function $t(a,b){var c=[],d={};B(b,function(a){a.token&&(d[a.token]=a,c.push(a.token))});
...
function Zt(a){var b=Yt(a),c=Pa(b,function(a){return a.id});
Wa(c)||(a.N("Updating lounge tokens for: "+Qj(c)),ck(ar(a.C,"/pairing/get_lounge_token_batch"),{qa:{screen_ids:c.join(",")},method:"POST",context:a,Z:function(a,c){du(this,c.screens||[]);this.La=Oa(this.La,function(a){return!!a.token});
bu(this);$t(this,b)}}))}
function du(a,b){B(cb(a.La,a.j),function(a){var d=Ta(b,function(b){return a.id==b.screenId});
d&&(a.token=d.loungeToken)})}
function bu(a){var b=Tt();ib(a.La,b,Uq)||(a.N("Saving local screens: "+Zq(b)+" to "+Zq(a.La)),Cr(Pa(a.La,Vq)),Wt(a,a.c,!0),Vt(a,Nt()||[]),a.F("managedScreenChange",Yt(a)))}
g.Rc=function(a,b){for(var c=Yt(this),c=Pa(c,function(a){return a.name}),d=a,e=2;Va(c,d);)d=b.call(m,e),e++;
return d};
function cu(a,b){var c=lr(Yt(a),b);a.N("Found screen: "+Yq(c)+" with key: "+b);return c}
function Yt(a){return cb(a.j,Oa(a.La,function(a){return!kr(this.j,a)},a))}
...
A(eu,mr);g=eu.prototype;g.la=function(a){return this.ea.$_gs(a)};
...
X.prototype.$_st=X.prototype.lb;X.prototype.$_gspc=X.prototype.Gf;X.prototype.$_gsppc=X.prototype.Jd;X.prototype.$_c=X.prototype.contains;X.prototype.$_g=X.prototype.get;X.prototype.$_a=X.prototype.Xb;X.prototype.$_un=X.prototype.Ub;X.prototype.$_r=X.prototype.remove;X.prototype.$_gs=X.prototype.la;X.prototype.$_gos=X.prototype.Hd;X.prototype.$_s=X.prototype.subscribe;X.prototype.$_ubk=X.prototype.ya;function fu(a,b,c){a?r("yt.mdx.remote.castv2_",!0,void 0):It();sl&&rl();ur();gu||(gu=new $q,Lr()&&(gu.c="/api/loungedev"));hu||a||(hu=new St(gu),hu.subscribe("screenPair",iu),hu.subscribe("managedScreenChange",ju),hu.subscribe("onlineReceiverChange",function(){O("yt-remote-receiver-availability-change")}));
ku||(ku=t("yt.mdx.remote.deferredProxies_")||[],r("yt.mdx.remote.deferredProxies_",ku,void 0));lu(b);b=mu();if(a&&!b){var d=new X(gu);r("yt.mdx.remote.screenService_",d,void 0);b=mu();ws(d,function(a){a?nu()&&Ls(nu(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){O("yt-remote-receiver-availability-change")})},!(!c||!c.loadCastApiSetupScript))}if(c&&!t("yt.mdx.remote.initialized_")){r("yt.mdx.remote.initialized_",!0,void 0);
ou("Initializing: "+Qj(c));pu.push(M("yt-remote-cast2-availability-change",function(){O("yt-remote-receiver-availability-change")}));
pu.push(M("yt-remote-cast2-receiver-selected",function(){qu();O("yt-remote-auto-connect","cast-selector-receiver")}));
pu.push(M("yt-remote-cast2-session-change",ru));pu.push(M("yt-remote-connection-change",function(a){a?Ls(nu(),"YouTube TV"):tu()||(Ls(null,null),Js())}));
...
function yu(){if(hu){var a=hu;L(a.B);a.B=NaN}a:{if(a=Au())if(a=a.getOtherConnectedRemoteId()){ou("Do not stop DIAL due to "+a);Bu();break a}(a=t("yt.mdx.remote.currentDialId_"))?(ou("Stopping DIAL: "+a),Rt(a),Bu()):(a=xu())&&a.uuid&&(ou("Stopping DIAL: "+a.uuid),Rt(a.uuid))}Ms()?Fs().stopSession():Cs("stopSession called before API ready.");(a=Au())?a.disconnect(1):(Pc("yt-remote-before-disconnect",1),Pc("yt-remote-connection-change",!1));Cu(null)}
...
function Gu(a){r("yt.mdx.remote.currentScreenId_",a,void 0);if(hu){var b=hu;b.l=z()+3E5;if((b.bc=a)&&(a=cu(b,a))&&!kr(b.c,a)){var c=db(b.c);c.push(a);Wt(b,c,!0)}}}
...
function Cu(a){var b=Au();qu();a?Au():(Gu(""),Bu());r("yt.mdx.remote.connection_",a,void 0);ku&&(B(ku,function(b){b(a)}),ku.length=0);
...
var gu=null,ku=null,Fu=null,hu=null;function lu(a){var b=uu();if(Cb(b)){var b=wr(),c=vl("yt-remote-session-name")||"",d=vl("yt-remote-session-app")||"",b={device:"REMOTE_CONTROL",id:b,name:c,app:d};a&&(b["mdx-version"]=3);r("yt.mdx.remote.channelParams_",b,void 0)}}
...
var pu=[];function Hu(a){Tk.call(this);this.L={Mb:a.Mb,Lb:v(function(){Jh.getInstance().oa(this.za());ia(a.Lb)&&a.Lb()},this)};
this.l=this.A=null}
A(Hu,Tk);Hu.prototype.Fa=function(){Hu.H.Fa.call(this);this.A=R(G(this.za(),"dialog-id"));if(!this.A)throw Error("Cannot find create playlist widget dialog.");Qk(this).Ka(document,"click",this.D);var a=M("yt-uix-card-show",v(this.K,this));this.ga.push(a);a=S("create-playlist-widget-form",this.A);this.l=new Ll(this.L);Rk(this.l,a)};
...
A(Iu,nh);ca(Iu);g=Iu.prototype;g.register=function(){oh(this,"mouseenter",this.ed);oh(this,"mouseleave",this.Kb)};
...
g.Mf=function(a){this.pb(a,"scroll-action");O("yt-dom-content-change",a)};var Ju,Ku,V,Lu,Mu,Nu,Ou,Pu,Qu,Ru,Su,Tu,Uu,Vu,Wu,Z,he;var Xu;function Yu(a,b){this.type=a;this.V=b||[]}
...
function lv(a){Xu=a;Xu.subscribe("remoteQueueChange",function(){O("queue-change",new Yu(2))})}
function mv(){var a=Du();vc(Xu);Xu=null;a?lv(a):O("queue-change",new Yu(2))}
function av(a,b,c){Xu&&1==Xu.c&&(a.call(m),c&&J(function(){c()},0),p(b)&&O("queue-change",b))}
function bv(a,b){ck("/watch_queue_ajax",{method:"POST",Ta:{action_remove_from_watch_queue:1},qa:{list:"WQ",video_ids:b.join(",")},Z:function(){O("queue-change",a)},
onError:function(){}})}
var nv=[];var ov;function pv(){if(!ov){var a=R("watch-queue");if(!a)return[];ov=S("watch-queue-items-list",a)}var b=[],a=ae(ov);B(a,function(a){(a=G(a,"video-id"))&&b.push(a)});
return b}
;function qv(){O("yt-dom-content-change",Z)}
r("yt.www.watchqueue.loadThumbnails",qv,void 0);
function rv(){he=R("watch-queue");Qu=S("watch-queue-control-bar",he);Ru=S("watch-queue-count",Qu);Su=S("yt-uix-button-dark-overflow-action-menu",Qu);Tu=S("prev-watch-queue-button",he);Uu=S("next-watch-queue-button",he);Vu=S("play-watch-queue-button",he);Wu=S("pause-watch-queue-button",he);Z=S("watch-queue-items-list",he);tv.push(of(he,"click",uv,"yt-uix-button"));tv.push(of(he,"click",vv,"watch-queue-video"));tv.push(of(he,"click",wv,"control-bar-button"));tv.push(T(Z,Ye,xv));tv.push(of(Z,Ye,yv,"watch-queue-item"));
tv.push(of(null,"click",zv,"watch-queue-video-menu-choice"));tv.push(of(null,"click",Av,"watch-queue-menu-choice"));Ou=new Cl(R("watch-queue-count-msg").innerHTML,["count","total"]);Pu=Fl(R("watch-queue-loading-template"));Bv=0;Lu=!1;var a=R("watch-queue-save-as-playlist-widget");a&&(Nu=new Hu({Mb:Cv}),Rk(Nu,a));Ku=null;fu(!!I("MDX_ENABLE_CASTV2"),!0,{device:"Desktop",app:"youtube-desktop",isSignedIn:I("LOGGED_IN")});fu(!!I("MDX_ENABLE_CASTV2"),!!I("MDX_ENABLE_QUEUE"));nv.push(M("yt-remote-connection-change",
mv));(a=Du())&&lv(a);Dv.push(M("init",Ev));Dv.push(M("dispose",Fv));Dv.push(M("yt-remote-before-disconnect",Gv));Dv.push(M("yt-remote-connection-change",Hv));Hv();Ev();Dv.push(M("queue-change",Iv));Dv.push(M("watch-queue-addto-video-added",Jv));Dv.push(M("watch-queue-addto-video-removed",Jv));Dv.push(M("watch-queue-addto-video-play-next",Kv));Dv.push(M("watch-queue-addto-video-play-now",Lv));Dv.push(M("watch-queue-addto-playlist-added",Jv));Dv.push(M("watch-queue-addto-playlist-removed",Jv));Dv.push(M("watch-queue-addto-playlist-play-next",
Mv));Dv.push(M("watch-queue-addto-playlist-play-now",Nv))}
function Ov(){var a=R("player-playlist");return a?ge()==a:!1}
function Pv(){var a=!1;if(!V||!Mg(Ju)||!I("PAGE_NAME"))return Qv(),a;var b=Rv(),c=Sv();Tv()&&c&&b!=c&&(Uv(c),b=c);c=!!I("LIST_ID");if(b=Tv()&&!!b&&(b==I("VIDEO_ID")||b==Mu)&&!c){var d=R("player-playlist");d&&!Ov()&&(E(Ju,"mole-notification"),Yd(d,he,0),O("watch-queue-show",1),Vv(),a=!0)}else ge()!=Ju&&(Ju.appendChild(he),O("watch-queue-show",0),qv(),a=!0);d=R("placeholder-playlist");b||c?Og(d):Pg(d);Qv();return a}
function Uv(a){if(Ku){var b=!!V,c=b&&!(a&&(a==I("VIDEO_ID")||a==Mu));Ij(c);b&&Tv()&&(c?O("watch-queue-show",0):O("watch-queue-show",1));if(Ku.isReady())Ku.loadVideoById(a);else{var d=function(){Ku.loadVideoById(a);Ku.removeEventListener("onReady",d)};
...
function Ev(){E(Ju,"mole-notification");Mu="";Fj();Pv();var a=Ku;a&&a.addEventListener("onStateChange",Wv)}
function Fv(){rb(Ju,"mole-expanded","mole-collapsed");var a=Ku;a&&a.removeEventListener("onStateChange",Wv)}
function Tv(){return"watch"==I("PAGE_NAME")}
function aw(a){if(a!=Xv()){var b=pv(),c=b[0];bw()&&(c=b[cw()+1]);if(a!=c)if(Va(b,a)){var d=Ma(b,a),b=Ma(b,c);cv(a,d,b)}else dv(a)}}
function uv(a){if(a.currentTarget==Tu){if($v()){var b=ae(Z);a=cw();b=b.length;a=(b+a-1)%b;dw(a);Vv();(b=Xv())&&V&&V.ud(b,a)}}else if(a.currentTarget==Uu)$v()&&(a=ae(Z),a=(cw()+1)%a.length,dw(a),Vv(),(b=Xv())&&V&&V.Gd(b,a));else if(a.currentTarget==Vu)Pg(Vu),Og(Wu),V?(a=pv(),!Sv()&&a[0]?ht(V,a[0]):V.play()):Ku&&Ku.playVideo();else if(a.currentTarget==Wu)Pg(Wu),Og(Vu),V?V.pause():Ku&&Ku.pauseVideo();else if(C(a.currentTarget,"remove-item-watch-queue-button")){if(a=qe(a.currentTarget,null,"watch-queue-item"),
b=G(a,"video-id"))D(a,"fade-out"),$u(b)}else C(a.currentTarget,"expand-video-watch-queue-button")&&ew(a.currentTarget)}
function Av(a){var b=G(a.currentTarget,"action");fw[b](a.currentTarget);a=a||window.event;a.cancelBubble=!0;a.stopPropagation&&a.stopPropagation();uh(qh.getInstance(),Su)}
function wv(a){ge()==Ju&&a.currentTarget==Qu&&(a=qf(a),a&&C(a,"overflow-menu-choice")||(qb(Ju,"mole-expanded"),qb(Ju,"mole-collapsed")))}
function zv(a){var b=G(a.currentTarget,"action");gw[b](a.currentTarget)}
function xv(){E(Ju,"mole-notification");C(Ju,"mole-expanded")&&qv();uh(qh.getInstance(),Su)}
function yv(a){C(a.currentTarget,"fade-out")&&(Zd(a.currentTarget),Yv(Sv()),hw());qv()}
function vv(a){a=qe(a.currentTarget,null,"watch-queue-item");if(!C(a,"currently-playing")){var b=ae(Z),b=Ma(b,a);dw(b);(a=G(a,"video-id"))&&V&&ht(V,a,0,b)}}
function Cv(a){var b=a.df,c=a.ef;b&&c&&(a={V:pv().join(","),Vd:b,Z:function(){Wg(c)}},Kl(a))}
function ew(a){C(a,"disabled")||(a=G(a,"video-id"))&&iw(a)}
function bw(){return!!S("currently-playing",Z)}
function cw(){var a=S("currently-playing",Z);if(a){var b=ae(Z);return Ma(b,a)}return 0}
function Xv(){var a=S("currently-playing",Z);return a?G(a,"video-id")||"":""}
function Yv(a){a=Ma(pv(),a);0<=a?bw()&&cw()==a||(dw(a),Vv()):jw()}
function dw(a){if($v()){jw();var b=ae(Z);b[a]&&D(b[a],"currently-playing");kw()}}
function jw(){if($v()){var a=S("currently-playing",Z);a&&E(a,"currently-playing");kw()}}
...
function Jv(){Mg(Ju)&&D(Ju,"mole-notification")}
...
function kw(){var a=pv().length,b=1>=a,c=bw()?cw():-1;Tu.disabled=b||0==c;Uu.disabled=b||c==a-1;lw();if(0!=a){var d=null,a=ae(Z);B(a,function(a){var b=G(a,"video-id"),c=S("play-next",a),k=S("goto-video-page",a);pb(k,"disabled",Tv()&&b==I("VIDEO_ID")&&!I("LIST_ID"));C(a,"currently-playing")?(d=a,Pg(c)):d?(d=null,pb(c,"disabled",!0)):pb(c,"disabled",!1)})}}
function hw(){kw();Wa(pv())?mw():nw();O("watch-queue-update")}
function ow(){Bv=0;L(pw);pw=NaN}
function qw(){Lu=!1;isNaN(pw)&&(pw=J(function(){pw=NaN;Bv++;rw()},Math.min(3E4,1E3*Math.pow(2,Bv))))}
function $v(){var a=be(Z);return!!a&&C(a,"watch-queue-item")}
...
function tw(a,b){Lu=!1;if(Z&&b&&(b.html||!Sv())&&(ow(),V)){var c=pv(),d=[],e=Wd(fd(b.html)),f=Oa(e.childNodes,function(a){return fe(a)});
B(f,function(a){a=G(a,"video-id");d.push(a)});
0==c.length&&Xd(Z);if(0==d.length)Xd(Z),O("watch-queue-empty"),hw();else if(!ib(c,d)){if(d.length==c.length+1){for(var h=0;h<c.length&&c[h]==d[h];)h++;var k=db(c);fb(k,h,0,d[h]);if(ib(k,d)){Yd(Z,f[h],h);D(f[h],"fade-in");J(function(){E(f[h],"fade-in")},0);
Yv(Sv());qv();hw();return}}if(d.length==c.length-1){for(e=0;e<d.length&&c[e]==d[e];)e++;k=db(c);ab(k,e);if(ib(k,d)){c=ae(Z);D(c[e],"fade-out");Yv(Sv());return}}Xd(Z);Wa(f)||(B(f,function(a){Z.appendChild(a)}),qv(),Yv(Sv()));
hw()}}}
function Vv(){var a=S("currently-playing",Z);if(a){var b=Iu.getInstance(),c=Z;if(c&&a){var d=Kd(U(b,"scroll-unit"),c),a=Ma(d,a);if(0<=a&&!(!c||isNaN(a)||0>a)&&(b=Kd(U(b,"scroll-unit"),c),!(0>=b.length))){a>=b.length&&(a=b.length-1);if(b.length){var d=b[0],e=d.offsetHeight;1<b.length&&(e=b[1].offsetTop-d.offsetTop);d=e}else d=0;e=c.offsetHeight;a>Math.max(Math.floor(c.scrollTop/d),0)-1&&(d=Math.floor(e/d),e=b.length,a+d>e&&(a=e-d+1));0>a&&(a=0);a=b[a].offsetTop;c&&!isNaN(a)&&(0>a&&(a=0),c.scrollTop=
a,bc(c,"scroller-offset",a+""),O("yt-dom-content-change",c))}}}qv()}
function iw(a){a=Ff("/watch",{v:a});Wg(a)}
function uw(a){Tv()&&(a!=I("VIDEO_ID")||I("LIST_ID")?(J(function(){iw(a)},100),Mu=a):Pv())}
function Gv(a){vw=a}
function Hv(){var a=Du();vc(V);V=null;ow();Xd(Z);hw();a?(V=a,V.subscribe("proxyStateChange",ww),V.subscribe("remotePlayerChange",xw),vw=null):mw();2!=vw&&(Fj(),O("watch-queue-remote-connection",!!a))}
function nw(){Og(Ju);if(!Pv()){var a=ge()==Ju?0:1;O("watch-queue-show",a)}}
function mw(){ge()!=Ju&&Ju.appendChild(he);var a=R("placeholder-playlist");I("LIST_ID")?Og(a):Pg(a);rb(Ju,"mole-expanded","mole-collapsed");Pg(Ju);Qv();O("watch-queue-hide",0)}
function ww(a,b){ow();1==b&&rw()}
function xw(){var a=at(V);Zv(1==a.f)}
function Iv(){if(V){var a=Xv(),b=Sv();b&&b!=a&&Yv(b);b&&(Ov()||Mu==b)&&uw(b);rw()}}
var fw={"remove-all":function(){kv();Xd(Z);hw();O("watch-queue-empty");mw()},
"save-as-playlist":function(){if(!Wa(pv())){var a=Nu;Jh.getInstance().nb(a.za())}},
disconnect:function(){yu()}},gw={"play-next":function(a){C(a,"disabled")||(a=G(a,"video-id"))&&aw(a)},
"goto-video-page":ew},tv=[],Dv=[],Bv=0,pw=NaN,vw=null;var yw;function zw(a){Aw(R("yt-picker-"+a+"-footer"),a,!1,!1,!0);R("footer").scrollIntoView()}
function Aw(a,b,c,d,e){c||(yw&&yw!=a&&Pg(yw),yw=a,e?Og(a):Qg(a));d?S("yt-close",a).focus():(c={},c["action_"+b]=1,c.base_url=window.location.href.split("#",1)[0],ck("/picker_ajax",{format:"JSON",method:"GET",Ta:c,Z:v(Bw,null,a),onError:function(){Pg(a)}}))}
function Bw(a,b,c){if(c&&c.html){bc(a,"loaded",1);a.innerHTML=c.html;Cw(a);c=(b=document.body||Rd(document))||Rd(document);var d=Fe(a),e=Fe(c),f=Te(c);if(c==Rd(document)){var h=d.x-c.scrollLeft,d=d.y-c.scrollTop;P&&!zd(10)&&(h+=f.left,d+=f.top)}else h=d.x-e.x-f.left,d=d.y-e.y-f.top;var f=c.clientHeight-a.offsetHeight,e=c.scrollLeft,k=c.scrollTop,e=e+Math.min(h,Math.max(h-(c.clientWidth-a.offsetWidth),0)),k=k+Math.min(d,Math.max(d-f,0));c=new hd(e,k);b.scrollLeft=c.x;b.scrollTop=c.y;S("yt-close",a).focus()}else Pg(a)}
function Cw(a,b){var c=S("yt-picker-content",a);if(c){var d=Ld(null,"yt-picker-section",c);B(d,v(Dw,null,Math.floor((b||c.offsetWidth)/180)))}else Cc(Error(".yt-picker-content missing"),"WARNING")}
...
;r("yt.www.guide.setup",tm,void 0);r("yt.www.guide.selectGuideItem",function(a){if(Wk){var b=null,c=S("guide-item-selected",Wk);c&&(b=G(c,"serialized-endpoint")||"");b!=a&&(b&&E(c,"guide-item-selected"),a&&(a=Im(a))&&D(a,"guide-item-selected"))}},void 0);
...
r("yt.www.masthead.handleAccountPickerClick",function(){var a=R("yt-masthead-multilogin");if(G(a,"loaded"))Sn();else{var b=Fn();b[I("XSRF_FIELD_NAME",void 0)]=I("XSRF_TOKEN",void 0);spf.load("/delegate_account_ajax",{method:"POST",postData:Ef(b),onDone:function(){bc(a,"loaded","true");Sn()}})}},void 0);
r("yt.www.masthead.loadSearchbox",Un,void 0);r("yt.net.cookies.set",Kf,void 0);r("yt.net.cookies.remove",Lf,void 0);r("yt.www.picker.load",function(a){var b=G(a,"picker-key"),c=G(a,"picker-position"),d="yt-picker-"+b+"-"+c;if(c=R(d))a=G(a,"button-menu-id")==d,d=G(c,"loaded"),Aw(c,b,!!a,!!d)},void 0);
...
S("guide-module-loading")||tm();N.init();Ul=S("yt-masthead-user-icon");of(R("ticker"),"click",Tn,"yt-uix-close");S("exp-searchbox-redesign")&&T(R("yt-masthead-content"),"click",Xn);I("SANDBAR_ENABLED")&&Rn();I("YOODLE_DELAY_LOAD_EXP")&&I("YOODLE_IS_ANIMATED")&&Qn();Un();eo();(Ju=R("watch-queue-mole"))?rv():I("MDX_ENABLE_CASTV2")&&fu(!0,!1,{device:"Desktop",app:"youtube-desktop",isSignedIn:I("LOGGED_IN")});I("YOODLE_IS_ANIMATED")&&Sc(I("YOODLE_JS_URL",void 0),function(){t("yt.www.masthead.AnimatedYoodle.init")(I("YOODLE_ANIMATION_FRAMES"),
I("YOODLE_ANIMATION_DURATION"),I("YOODLE_ANIMATION_DELAY"),I("YOODLE_STOP_ON_LAST_FRAME"))});
I("SAFETY_MODE_PENDING")&&zw("safetymode")},void 0);
