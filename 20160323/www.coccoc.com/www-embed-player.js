...
h}var h=H("TIMING_INFO",{}),k;for(k in h)d[k]=h[k];k=d.srt;delete d.srt;var l;k||0===k||(l=S.timing||{},k=Math.max(0,l.responseStart-l.navigationStart),isNaN(k)&&d.pt&&(k=d.pt));if(k||0===k)d.srt=Math.round(k);d.h5jse&&(h=window.location.protocol+r("ytplayer.config.assets.js"),(h=S.getEntriesByName?S.getEntriesByName(h)[0]:null)?d.h5jse=Math.round(d.h5jse-h.responseEnd):delete d.h5jse);c.aft=oh();h=c._start;if("cold"==d.yt_lt){l||(l=S.timing||{});var n;a:if(n=l,n.msFirstPaint)n=Math.max(0,n.msFirstPaint);
else{var u=window.chrome;if(u&&(u=u.loadTimes,ia(u))){var u=u(),ca=1E3*Math.min(u.requestTime||Infinity,u.startLoadTime||Infinity),ca=Infinity===ca?0:n.navigationStart-ca;n=Math.max(0,Math.round(1E3*u.firstPaintTime+ca)||0);break a}n=0}0<n&&n>h&&(c.fpt=n);n=a||ph().span;u=l.redirectEnd-l.redirectStart;0<u&&(n.rtime_=u);u=l.domainLookupEnd-l.domainLookupStart;0<u&&(n.dns_=u);u=l.connectEnd-l.connectStart;0<u&&(n.tcp_=u);u=l.connectEnd-l.secureConnectionStart;l.secureConnectionStart>=l.navigationStart&&
0<u&&(n.stcp_=u);u=l.responseStart-l.requestStart;0<u&&(n.req_=u);u=l.responseEnd-l.responseStart;0<u&&(n.rcv_=u);S.getEntriesByType&&sh(c);(l=H("SPEEDINDEX_FOR_ACTIONS",void 0))&&-1<l.indexOf(f)&&(l=sc(),f=dh(),l=sc()-l,0<f.Eb&&(d.si=f.Eb,c.vsc=th(f.Yc),a.sid=l));l=[];if(document.querySelector&&S&&S.getEntriesByName){var f={'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'script[name="scheduler/scheduler"]':"sj",'script[name="desktop_polymer/desktop_polymer"]':"dpj",
...
g.tc=function(){};
g.Pb=function(){};
g.yc=function(){return{}};function Eo(a,b){jn.call(this);this.A=0;if(ia(a))b&&(a=w(a,b));else if(a&&ia(a.handleEvent))a=w(a.handleEvent,a);else throw Error("Invalid listener argument");this.C=a;Dm(this,"tick",w(this.B,this));this.stop();kn(this,5E3+2E4*Math.random())}
...
Eo.prototype.stop=function(){this.A=0;Eo.I.stop.call(this)};function Fo(a,b){this.sa=a;this.l=b;this.j=new G;this.h=new Eo(this.Le,this);this.f=null;this.J=!1;this.A=null;this.K="";this.C=this.o=0;this.B=[]}
y(Fo,Do);g=Fo.prototype;g.subscribe=function(a,b,c){return this.j.subscribe(a,b,c)};
...
function Go(a,b){a.C=b||0;a.h.stop();a.f&&(3==a.f.f&&wo(a.f),po(a.f));a.C=0}
...
g.wc=function(){var a=this.h;a.stop();kn(a,5E3+2E4*Math.random());this.A=null;this.o=0;if(this.B.length){a=this.B;this.B=[];for(var b=0,c=a.length;b<c;++b)uo(this.f,a[b])}this.F("handlerOpened")};
...
g.uc=function(a,b){if("S"==b[0])this.K=b[1];else if("gracefulReconnect"==b[0]){var c=this.h;c.stop();kn(c,500);this.h.Fa();po(this.f)}else this.F("handlerMessage",new km(b[0],b[1]))};
...
this.Rd,this);Io(this.f,b.token);this.subscribe("remoteQueueChange",function(){var a=this.D.f;Ak()&&U("yt-remote-session-video-id",a)},this)}
y(Y,V);g=Y.prototype;
...
a,Ek())}else this.H("Connecting without params"),this.f.connect({},a,Ek());So(this)};
g.dispose=function(){this.isDisposed()||(this.F("beforeDispose"),To(this,3));Y.I.dispose.call(this)};
g.G=function(){Uo(this);Vo(this);Wo(this);J(this.C);this.C=NaN;J(this.J);this.J=NaN;this.j=null;Xe(this.Z);this.Z.length=0;this.f.dispose();Y.I.G.call(this);this.h=this.D=this.f=null};
g.H=function(a){Mj("conn",a)};
g.Fd=function(){this.o(2)};
function Ro(a,b){return new Fo(ak(a.Pa,"/bc",void 0,!1),b)}
...
Nk(Ho(this.f),this.ha)};
g.Od=function(){this.H("Channel closed");isNaN(this.A)?Ok(!0):Ok();this.dispose()};
g.Pd=function(a){Ok();isNaN(this.B())?(this.H("Channel error: "+a+" without reconnection"),this.dispose()):(this.S=!0,this.H("Channel error: "+a+" with reconnection in "+this.B()+" ms"),To(this,2))};
...
$o(this,!1);break;case "remoteConnected":var b=new vk(Ad(a.f.device));Pa(this.h,function(a){return a.equals(b)})||Ta(this.h,b);
...
g.Rd=function(a){a.f?this.H("Received: action="+a.h+", params="+M(a.f)):this.H("Received: action="+a.h);gp(this,a);hp(this,a);if(Zo(this)){var b=this.D.clone(),c=!1,d,e,f,h,k,l;a.f&&(d=a.f.videoId||a.f.video_id,e=a.f.videoIds||a.f.video_ids,f=a.f.state,h=a.f.currentTime||a.f.current_time,k=a.f.volume,l=a.f.muted,p(a.f.currentError)&&Ad(a.f.currentError));if("onSubtitlesTrackChanged"==a.h)d==Mo(this.D)&&(delete a.f.videoId,pb(a.f)?this.D.o=null:this.D.o=a.f,this.F("remotePlayerChange"));else if(Mo(this.D)||
...
function gp(a,b){switch(b.h){case "loungeStatus":var c=Ad(b.f.devices);a.h=A(c,function(a){return new vk(a)});
...
Y.prototype.getProxyState=Y.prototype.ua;Y.prototype.o=function(a){this.H("Disconnecting with "+a);Uo(this);this.F("beforeDisconnect",a);1==a&&Ok();Go(this.f,a);this.dispose()};
...
Y.prototype.sendMessage=Y.prototype.va;function ip(a){V.call(this);this.o=0;this.ka=kp();this.cb=NaN;this.zb="";this.A=a;this.H("Initializing local screens: "+Xj(this.ka));this.j=lp();this.H("Initializing account screens: "+Xj(this.j));this.Rb=null;this.f=[];this.h=[];mp(this,fm()||[]);this.H("Initializing DIAL devices: "+ek(this.h));a=Vj(Kk());np(this,a);this.H("Initializing online screens: "+Xj(this.f));this.o=x()+3E5;op(this)}
y(ip,V);var pp=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=ip.prototype;g.H=function(a){Mj("RM",a)};
...
W.prototype.$_st=W.prototype.Za;W.prototype.$_gspc=W.prototype.Qe;W.prototype.$_gsppc=W.prototype.ad;W.prototype.$_c=W.prototype.contains;W.prototype.$_g=W.prototype.get;W.prototype.$_a=W.prototype.Kb;W.prototype.$_un=W.prototype.Hb;W.prototype.$_r=W.prototype.remove;W.prototype.$_gs=W.prototype.$;W.prototype.$_gos=W.prototype.$c;W.prototype.$_s=W.prototype.subscribe;W.prototype.$_ubk=W.prototype.oa;function Dp(){var a=!!H("MDX_ENABLE_CASTV2"),b=!!H("MDX_ENABLE_QUEUE"),c={device:"Desktop",app:"youtube-desktop"};a?q("yt.mdx.remote.castv2_",!0,void 0):Zl();ij&&hj();xk();Ep||(Ep=new Zj,Pk()&&(Ep.f="/api/loungedev"));Z||a||(Z=new ip(Ep),Z.subscribe("screenPair",Fp),Z.subscribe("managedScreenChange",Gp),Z.subscribe("onlineReceiverChange",function(){K("yt-remote-receiver-availability-change")}));
