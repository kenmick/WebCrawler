...
this.notifyFavicon&&this.changeFavicon(this.notifyFavicon);
...
G.unshift({b_size:d[3],b_classname:d[21],b_color:d[20],b_tooltip:d[4]});
K();
G.shift();
...
G.unshift({b_ge_freebies:d[39],b_classname:d[128],b_ge_discount:d[39],b_tooltip:d[4]});
o();
G.shift();
