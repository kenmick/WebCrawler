...
(function() {
    ...
    PAYPAL.Marketing.FloatingBar.prototype = {
            ...
            if (this._haveNamedAnchors()) {
                ...
                this._events.push(this._$navLinks.on('click', function(e) {
                    ...
                    if (target.indexOf('#') === 0 && !$this.hasClass('no-scroll')) {
                        ...
                        _this._doScroll(target, _this._opts.offset);
                    }
                }));
            }
        ...
        /**
         * On sticky nav link clicks, highlight the clicked link and scroll to the matching section
         */
        _onClick: function(e) {
            var $target = $(e.target),
                target = $target.attr('data-target') || this._getNamedAnchor($target);
            ...
            if (target.indexOf('#') === 0) {
                ...
                if (!$this.hasClass('no-scroll')) {
                    ...
                    $(e.currentTarget).addClass('current');
                    this._doScroll(target, this._opts.offset);
                }
            }
        },
        ...
        _stick: function() {
            ...
            // $('.hero-bg.hero-pop-out img').fadeout();
        },
        ...
        _highlightOnScroll: function() {
            ...
            var fromTop, $elementsAbove, current, id;
            ...
            if (this._lastHighlightedId !== id && !$('#' + id).hasClass('no-scroll')) {
                ...
                this._$navLinks.filter('[href$=#' + id + ']').addClass('current');
            }
        },
...
$(function()
{
    ...
    // reducing height of hero-banner area if notification exists
    ...
    var notificationstatus = JSON.parse(localStorage.getItem("notification-seen"));
...
$(window).load(function() {
	...
	*/
    ...
    CONSTANTS['active-digital-wallets'] = 162;
