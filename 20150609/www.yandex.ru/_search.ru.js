...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("U-b5PqJRDiYZ9vzq8Q6VzoK7yQ8")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
for(a.url&&(c.src=a.url);o=h.shift();)a[o]&&(c[o]=a[o]);return c}return C(t)}if("auth"===e){var e=s;if("social-link"===e)return{role:"button",tabindex:0,title:t.ctx.title,"aria-label":t.ctx.title};
...
if(!!s==!1){var u,d;return{method:"POST",action:t.ctx.url||(u=i,i="action",d=Ee(t),i=u,d),role:"form","aria-label":BEM.I18N("auth","auth")}
}return C(t)}if("checkbox"===e){var e=s;if("control"===e){var p=t.ctx.attrs||{};return p.id=t._checkboxAttrs.id,p.type="checkbox",p.autocomplete="off",r.disabled&&(p.disabled="disabled"),"yes"==r.checked&&(p.checked="checked"),p["aria-labelledby"]=t._labelId,p
}if("label"===e){var f=t.ctx.attrs||{};return f["for"]=t._checkboxAttrs.id,f.id=t._labelId,f["aria-hidden"]=!0,f
}return C(t)}if("button"===e)return m(t);if("b-link"===e)return l(t);if("notice"===e)return"count"===s?!t.ctx.url==!1?{href:t.ctx.url}:C(t):C(t);
if("ticker"===e)return"value"===s?{title:t._count}:C(t);if("suggest2-item"===e){var e=s;return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:C(t)
}if("select"===e){var e=s;return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?y(t):"list"===e?k(t):C(t)
}if("link"===e)return M(t);if("input"===e){var e=s;if("hint"===e)return{id:t._hintId,"for":t._inputId,"aria-hidden":!0};
if("control"===e){var _=t._.extend({id:t._inputId,name:t._name},t.ctx.controlAttrs);return(t._value||0===t._value)&&(_.value=t._value),r.disabled&&(_.disabled="disabled"),t._live&&(_.autocomplete="off"),_["aria-labelledby"]=t._labelId+" "+t._hintId,_
}return C(t)}return C(t)}function l(t){return!(t.__$anflg22!==!0)==!1?!!s==!1?d(t):p(t):p(t)}function d(t){for(var e,i,n,s=(e=t.__$anflg22,t.__$anflg22=!0,i=l(t),t.__$anflg22=e,i||{}),o=t.ctx,r=o.url,a=o.counter,c=t["i-global"],h=["title","target"],u=/^(https?:)?\/\/([^.?#\/]+\.)*?yandex\.(ru|by|ua|kz|com|com\.tr|net|st)(:\d{1,5})?([#\/?].*)?$/,d=c&&c.isYandexNet&&!c.isPumpkin&&a&&-1===a.indexOf(c.redirPrefix)&&r&&r.match(/^(https?:)?\/\//)&&!r.match(u);n=h.pop();)o[n]&&(s[n]=o[n]);
return a&&(s.onmousedown=a),s.href=d?"//h.yandex.net/?"+encodeURIComponent(r):r,s}function p(t){return!!s==!1?f(t):C(t)
}function f(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=De(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
return h}function m(t){if(!(t.__$anflg18!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg18,t.__$anflg18=!0,i=m(t),t.__$anflg18=e,i),{onmousedown:t.ctx.counter})
}return _(t)}return _(t)}return _(t)}function _(t){if(!(t.__$anflg17!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg17,t.__$anflg17=!0,i=m(t),t.__$anflg17=e,i),a={href:n.url};
return n.target&&(a.target=n.target),r.disabled&&(a["aria-disabled"]=!0),t._.extend(o,a)}return g(t)}return g(t)
}return g(t)}function g(t){return!(t.__$anflg16!==!0)==!1?!!s==!1?!!t.ctx.url==!1?b(t):v(t):v(t):v(t)
}function b(t){for(var e,i,n,s=t.ctx,o=(e=t.__$anflg16,t.__$anflg16=!0,i=m(t),t.__$anflg16=e,i),a={type:s.type||"button"},c=["name","value"];n=c.shift();)s[n]&&(a[n]=s[n]);
return r.disabled&&(a.disabled="disabled"),t._.extend(o,a)}function v(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return e.tabindex&&(i.tabindex=e.tabindex),i}return C(t)}function y(t){if(!(t.__$anflg6!==!0)==!1){var e,i,n=(e=t.__$anflg6,t.__$anflg6=!0,i=y(t),t.__$anflg6=e,i||{});
...
return n}function C(){return void 0}function S(t){var e=n;if("b-icon"===e)return!!s==!1?"img":I(t);if("auth"===e){var e=s;
return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":I(t)}if("checkbox"===e){var e=s;return"control"===e?"input":"label"===e?"label":!!s==!1?"span":I(t)
}if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":D(t):D(t);if("b-autocomplete-item"===e)return!!s==!1?"li":I(t);
if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":I(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":I(t)}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":I(t):"a11y"===e?"span":"items"===e?"ul":I(t)
...
}if("b-link"===e)return!!s==!1?"a":I(t);if("link"===e)return"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":I(t);
if("input"===e){var e=s;return"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":I(t)
}return I(t)}function D(t){return!!s==!1?"button":I(t)}function I(){return void 0}function P(t){var e=n;
if("b-autocomplete-item"===e){if(!(r&&"lingvo"===r.type)==!1){if(!!s==!1){var o=t.ctx.data[1];return[{tag:"span",elem:"text",content:o.text},{tag:"span",elem:"translation",content:[" â ",o.translation]}]
...
}function H(){return void 0}function z(t){var e=n;if("b-autocomplete-item"===e)return W(t);if("dropdown"===e)return"popup"===s?!(t.__$anflg20!==!0)==!1?G(t):qe(t):qe(t);
...
}function W(t){return!(t.__$anflg21!==!0)==!1?!(r&&"nav"===r.type)==!1?!!s==!1?K(t):qe(t):qe(t):qe(t)
...
return e=t.__$anflg21,t.__$anflg21=!0,n=t._linkUrlContent,t._linkUrlContent=u,s=t._linkInfoConten,t._linkInfoConten=l,o=t._url,t._url=h,r=W(t),t._linkUrlContent=n,t._linkInfoConten=s,t._url=o,i=r,t.__$anflg21=e,i
}function G(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));var s=t.__$anflg20;
t.__$anflg20=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",De(t),t.ctx=o,i=r,t.__$anflg20=s}function Q(t){return!(t.__$anflg19!==!0)==!1?!!s==!1?Y(t):qe(t):qe(t)
}function Y(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg19;t.__$anflg19=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=e.mods;e.mods=s,Q(t),t._checkboxAttrs=r,t._labelId=a,e.mods=c,t.__$anflg19=o
}function X(t){if(!(t.__$anflg15!==!0)==!1){if(!!s==!1){var e=t.ctx.mods||{};e.theme=e.theme||"normal";
var i=t.__$anflg15;t.__$anflg15=!0;var n=t.ctx,o=n.mods;return n.mods=e,X(t),n.mods=o,t.__$anflg15=i,void 0
}return qe(t)}return qe(t)}function Z(t){var e=s;return"hint"===e?!(t.__$anflg14!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?J(t):ee(t):ee(t):ee(t):"control"===e?!(t.__$anflg13!==!0)==!1?!!r.clear==!1?te(t):ee(t):ee(t):ee(t)
}function J(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg14,t.__$anflg14=!0,s=t.ctx,t.ctx=a,o=i,i="",r=De(t),t.ctx=s,i=o,n=r,t.__$anflg14=e,n
}function te(t){var e=t.__$anflg13;t.__$anflg13=!0;var n=t.ctx;t.ctx={elem:"box",tag:"span",content:[t.ctx,{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]};
var s=i;i="",De(t),t.ctx=n,i=s,t.__$anflg13=e}function ee(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?ie(t):qe(t):qe(t)
...
}function ne(t){return"retpath"===s?se(t):oe(t)}function se(t){if(!(t.__$anflg12!==!0)==!1){var e=t.__$anflg12;
t.__$anflg12=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,se(t),t._retpath=i,t.__$anflg12=e,void 0
}return oe(t)}function oe(t){return!(t.__$anflg11!==!0)==!1?!!s==!1?re(t):qe(t):qe(t)}function re(t){var e,i,n,s;
...
var o=t.__$anflg11;t.__$anflg11=!0;var r=t._passportHost;t._passportHost=e;var a=t._paramRetpath;t._paramRetpath=i?"&retpath="+encodeURIComponent(i):"";
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",ne(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg11=o
...
w(null,t[0],i.join(","))}}),_borschik("pvEWjtjE1Ec3bbWntiBA4nTA-D0")&&BEM.DOM.decl("clickable",{onSetMod:{js:function(){this.action=this.params.action,this.bindTo("click",this.onClick.bind(this))
...
}},{NAV_ITEMS_GAP:10,live:!1}),_borschik("80_j2Ix0WT0HUOW37imQWpogMW4")&&BEM.DOM.decl("header",{onSetMod:{js:function(){this.__base.apply(this,arguments);
...
},hide:function(){this.delMod(this.elem("main"),"line")}},this)}},activateAdvancedSearch:function(){this.findBlockInside("advanced-search").initBlock(),this.setMod("type","advanced"),this.main.setMod("kind","advanced-search")
...
t?t.openAdvancedSearch():this._pressAdvButton()}}),_borschik("_DgOxD59RT3e3UNcy7IC9Wst_MA")&&!function(t){var e=t.event.special.outsideclick={add:function(i){t(document).on("click."+i.guid,e.handler.bind(this))
...
}}),_borschik("c30ZhDelmBs8kHhMuVA9GHh7s90")&&BEM.DOM.decl("pager",{onSetMod:{js:function(){this.__base();
