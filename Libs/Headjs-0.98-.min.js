ï»¿(function(a,v){function f(a){n[n.length]=a}function l(a){p.className=p.className.replace(RegExp("\\b"+a+"\\b"),"")}function j(a,d){for(var b=0,c=a.length;b<c;b++)d.call(a,a[b],b)}function r(){p.className=p.className.replace(/ (w-|eq-|gt-|gte-|lt-|lte-|portrait|no-portrait|landscape|no-landscape)\d+/g,"");var b=a.innerWidth||p.clientWidth,d=a.outerWidth||a.screen.width;g.screen.innerWidth=b;g.screen.outerWidth=d;f("w-"+b);j(c.screens,function(a){b>a?(c.screensCss.gt&&f("gt-"+a),c.screensCss.gte&&f("gte-"+
