    ...
    var $ = jquery.jQuery, Lightbox = function(_super) {
        ...
        return __extends(Lightbox, _super), Lightbox.prototype.XDMFullscreen = function() {
            ...
            switch (this.state) {
              ...
              case "small":
                "material_landing_iframe" == this.currentMaterial ? (this.state = "hide", this.switchStyleIframeFromMaterial(this.currentMaterial)) : (this.XDMIframeElement.addClass("close_lightbox_init"), 
                setTimeout(function() {
                    _super.prototype.ended.call(t);
                }, 1100));
                break;
            ...
            if (isBrokenPositionFixed) {
                ...
                var ieFixRepositionBox = function() {
                    var t = ayl_element.GetCumulativeOffset(_this.rootElement[0]), e = t[0], i = t[1], s = ayl_element.GetScrollXY(), a = s[0], o = s[1], r = document.documentElement.clientWidth || document.body.clientWidth, l = document.documentElement.clientHeight || document.body.clientHeight;
                    _this.rootElement.css("position", "absolute"), _this.rootElement.css("top", o - i + "px"), 
