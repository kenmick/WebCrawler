...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("GKulPjONPY7zH_3uXiTaszwSJvk")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
var N=(d=i,i="bem",p=Se(t),i=d,p);"undefined"!=typeof N||(N="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(D=i,i="content",I=P(t),i=D,I);if(ie||0===ie){var N=n||s,ne=t._notNewList;
...
}catch(P){}}return d=f?g?'<div style="'+B+'"><'+v+R+i("src",x)+i(I,T)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+R+">"+e("movie",x):"<"+v+R+i("type",w)+i("data",x)+">")+e(I,T)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
