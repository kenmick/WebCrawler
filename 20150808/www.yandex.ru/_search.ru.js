...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("a1P1CJzjgGfgTFuus9id9Y-7k9A")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
(J.block||J.elem)&&V[e(J.block,J.elem)]||(J._block=W,J._elem=K,F.splice(U+1,0,J))}}}}}}q&&j.push(N?" ":"",q),$&&j.push(" i-bem"),j.push('"')
