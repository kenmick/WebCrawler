...
a.customData=d||{};c.trigger(a)}};b(".liquidlist").each(function(c,a){var d=b(a);if("true"===d.attr("userasta")){var f=setTimeout(function(){d.parent().show();new e(d)},1E3);d.bind("liquidlistrastaloaded",function(){clearTimeout(f);new e(d)})}else b(function(){new e(a)})})}})();
