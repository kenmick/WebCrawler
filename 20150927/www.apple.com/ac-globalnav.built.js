...
};u._initializeFlyoutListeners=function(){var C;C=("onpopstate" in window)?"popstate":"beforeunload";
k(window,C,this._hideFlyouts.bind(this));k(document,"keydown",this._onBodyKeydown.bind(this));
...
}if(C){this.searchReveal.remove();this._onSearchHideEnd()}else{this.searchReveal.hide()
}if(!this._isBreakpointWithMenu()){c.unlock()}};u._onSearchHideEnd=function(){this._searchVisible=false;
