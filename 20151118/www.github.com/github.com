...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="93D2815D:6792:1CA317D8:564CBD47" name="octolytics-dimension-request_id" />
...
<meta content="Rails, view, dashboard#index" data-pjax-transient="true" name="analytics-event" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta content="d65071ff17ce6190be7cbbef9e91b82d288993d3" name="form-nonce" />
...
<div class="marketing-section-signup">
  <div class="container">
      <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/join" autocomplete="off" class="form-signup-home js-form-signup-home" data-form-nonce="d65071ff17ce6190be7cbbef9e91b82d288993d3" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="6X/Hz/g8nZRahrmoyRT4bkcFKAK4h+nKQrRH7yU9yFhMmiU2YtDFyI3SVc+flGZKLL8CUVTMxWfUNbhmgsY6ew==" /></div>        <dl class="form">
          <dd>
        ...
        <dl class="form">
          <dd>
            <input type="text" name="user[email]" class="textfield js-email-notice-trigger" placeholder="Your email" aria-label="Your email" data-autocheck-url="/signup_check/email" data-throttle-delay="300">
          </dd>
        </dl>
        <dl class="form">
          <dd>
...
<div class="marketing-section">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.01255s from github-fe117-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
