...
}(function(){var p=$.fn.bind,q=$.fn.unbind,r=$.fn.live,o=$.fn.on;
$.fn.bind=c(p);
$.fn.live=c(r);
$.fn.on=c(o);
$.fn.unbind=function(){var t=m.apply(arguments),w,u;
if(this.length){w=j(t);
u=w.handler.bookingClicktaleEventHandlerID;
if(u&&f[u]){t[w.handlerIndex]=f[u]
...
var d=0;
var e;
g.extend({noticeAdd:function(A){if(!g.canShowNotice()||g.isNoticesDisabled()){return false
}d++;
...
d.prototype.onSucessCallback=function(e){if(e.isOk==="true"){this.showMessage("success");
this.enableInputs()
...
d.prototype.onErrorCallback=function(){this.showMessage("error");
this.enableInputs()
};
...
c.prototype.validate=function(){B.track.stage("TDXbEcWNCBQcDMFLUGDZHXRT",2);
...
H+=d[1];
if(((I.MJ(d[127]+""==="freebie_icon"))&&((I.MJ(d[4]+""===""))||(I.MJ(d[4]==0))))){H+=d[5];
...
if(I.MJ(d[17])){H+=d[5];
var r="";
r+=[d[19],I.MC(c[65]),d[19],d[128],d[19]].join("");
...
I.MN(c[11],[d[19],I.MC(c[65]),d[19],d[128],d[19]].join(""));
H+=d[9];
...
if(((I.MJ(I.MC(c[20])+""==="mg_family"))||(I.MJ(I.MC(c[35])+""==="emk")))){H+=d[82];
I.MN(c[34],undefined);
H+=d[5]
}else{H+=d[82];
I.MN(c[34],d[83]);
...
I.MN(c[36],[d[84],I.MC(c[34]),d[85]].join(""));
H+=d[9]
}else{if(I.MJ(d[39])){H+=d[36];
I.MN(c[36],[d[86],I.MC(c[34]),d[85]].join(""));
H+=d[9]
}else{if(I.MJ(d[39])){H+=d[36];
I.MN(c[36],[d[87],I.MC(c[34]),d[85]].join(""));
H+=d[9]
}else{H+=d[36];
I.MN(c[36],[d[88],I.MC(c[63]),I.MC(c[34]),d[85]].join(""));
H+=d[9]
}}}H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],I.MC(c[63]),d[91],d[128],d[92]].join("");
if(I.MD(c[41])){H+=[d[93],I.MC(c[63]),d[94],(I.MC(c[37])||"auto"),d[95],(I.MC(c[38])||"inline-block"),d[96],(I.MC(c[39])||"baseline"),d[97],I.MC(c[40]),d[92]].join("")
}H+=d[98]
}else{if((I.MJ(V+""==="freebie_icon"))){H+=d[9];
I.MN(c[36],[d[99],I.MC(c[12]),I.MC(c[34]),d[85]].join(""));
H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],I.MC(c[63]),d[91],d[128],d[92]].join("");
if(I.MD(c[41])){H+=[d[93],I.MC(c[63]),d[94],(I.MC(c[37])||"auto"),d[95],(I.MC(c[38])||"inline-block"),d[96],(I.MC(c[39])||"baseline"),d[97],I.MC(c[40]),d[92]].join("")
}H+=d[98]
}else{H+=d[9];
I.MN(c[36],[d[100],I.MC(c[65]),d[101],I.MC(c[63]),I.MC(c[34]),d[85]].join(""));
H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],I.MC(c[63]),d[102],d[128],d[92]].join("");
if(I.MD(c[41])){H+=[d[93],I.MC(c[63]),d[94],(I.MC(c[37])||"auto"),d[95],(I.MC(c[38])||"inline-block"),d[96],(I.MC(c[39])||"baseline"),d[97],I.MC(c[40]),d[92]].join("")
}H+=d[103]
}}H+=d[81]
}else{if(I.MD(c[44])){H+=d[5];
var r="";
r+=[d[104],I.MC(c[43]),d[101],I.MC(c[65]),d[101],I.MC(c[63]),d[19],d[128],d[19]].join("");
if(I.MD(c[8])){r+=I.MC(c[7])
}r+=d[19];
I.MN(c[11],r);
...
G.unshift({b_type:d[127],b_genius_img:d[17]});
M();
G.shift();
H+=d[62]
}function M(){H+=d[2];
...
G.unshift({b_type:d[127],b_genius_iconfont:d[17]});
L();
G.shift();
H+=d[5]
}H+=d[1]
...
I.MN(c[36],[d[88],d[3],I.MC(c[34]),d[85]].join(""));
H+=d[9]
}}}H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],d[3],d[91],d[21],d[92]].join("");
if(I.MD(c[41])){H+=[d[93],d[3],d[94],(I.MC(c[37])||"auto"),d[95],(I.MC(c[38])||"inline-block"),d[96],(I.MC(c[39])||"baseline"),d[97],I.MC(c[40]),d[92]].join("")
}H+=d[98]
}else{if((I.MJ(V+""==="freebie_icon"))){H+=d[9];
I.MN(c[36],[d[99],I.MC(c[12]),I.MC(c[34]),d[85]].join(""));
H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],d[3],d[91],d[21],d[92]].join("");
...
I.MN(c[36],[d[100],d[20],d[101],d[3],I.MC(c[34]),d[85]].join(""));
H+=[d[89],I.STATIC_HOSTNAME(I.MC(c[36]),0,0,0),d[90],d[3],d[102],d[21],d[92]].join("");
if(I.MD(c[41])){H+=[d[93],d[3],d[94],(I.MC(c[37])||"auto"),d[95],(I.MC(c[38])||"inline-block"),d[96],(I.MC(c[39])||"baseline"),d[97],I.MC(c[40]),d[92]].join("")
}H+=d[103]
}}H+=d[81]
}else{if(I.MD(c[44])){H+=d[5];
var r="";
r+=[d[104],I.MC(c[43]),d[101],d[20],d[101],d[3],d[19],d[21],d[19]].join("");
if(I.MD(c[8])){r+=I.MC(c[7])
}r+=d[19];
I.MN(c[11],r);
H+=[d[105],I.MC(c[11]),d[23],I.MC(c[5]),d[106]].join("")
...
G.unshift({b_color:d[20],b_classname:d[21],b_size:d[3],b_tooltip:d[4]});
K();
G.shift();
H+=[d[109],I.MB(c[45]),d[110]].join("");
if(I.MJ(I.MG((I.MC(c[46])||{})["is_aspiring"]))){H+=[d[111],I.MG((I.MC(c[46])||{})["num_stays"]),d[112]].join("")
}H+=d[113];
if(I.MJ(I.MG((I.MC(c[46])||{})["is_aspiring"]))){H+=[d[9],(G.unshift({num_stays_needed:I.MG((I.MC(c[46])||{})["num_stays_left"])}),(e=I.VP(d[114],(I.MI((I.MC(c[46])["num_stays_left"]||0))+I.MI(0)))),G.shift(),e),d[115]].join("")
}else{H+=d[9];
...
if(I.MJ(I.MG((I.MC(c[46])||{})["is_aspiring"]))){H+=[d[9],(G.unshift({num_stays_needed:I.MG((I.MC(c[46])||{})["num_stays_left"])}),(e=I.VP(d[117],(I.MI((I.MC(c[46])["num_stays_left"]||0))+I.MI(0)))),G.shift(),e),d[115]].join("")
}else{H+=d[9];
if(I.MJ(I.MG((I.MC(c[46])||{})["num_stays"]))){H+=[d[36],I.MB(c[49]),d[9]].join("")
}else{H+=[d[36],I.MB(c[50]),d[9]].join("")
}H+=d[115]
}H+=[d[118],I.MB(c[51]),d[119]].join("");
if(I.MD(c[53])){H+=I.MB(c[52])
}else{H+=I.MB(c[54])
}H+=d[120];
if(I.MD(c[53])){H+=I.MB(c[55])
}else{H+=I.MB(c[56])
}H+=[d[121],I.MB(c[57]),d[120],I.MB(c[58]),d[122],I.MB(c[59]),d[120],I.MB(c[60]),d[123],I.MB(c[61]),d[120],I.MB(c[62]),d[124]].join("");
if(!(I.MJ(I.MG((I.MC(c[46])||{})["is_aspiring"])))){H+=d[125];
G.unshift({b_classname:d[128],b_ge_discount:d[39],b_ge_freebies:d[39],b_tooltip:d[4]});
o();
G.shift();
H+=[d[138],I.MB(c[71]),d[139]].join("")
}H+=[d[140],I.MB(c[72]),d[141]].join("");
return H
}
})());
"use strict";
...
B.when({events:"ready",experiment:"bLYSRffECIAaKLPLTLSddbabSLT"}).run(function(){$("#frm").submit(function(c){if($(".sb_child_ages_empty_zero:selected").length){if(B.et.stage("bLYSRffECIAaKLPLTLSddbabSLT",1)){c.preventDefault();
...
}if(booking.track.getVariant("MRLLYYJWcDcIBZXAHWe")){return
}var e=this;
...
if(!(k===0||k===1)){return
}function m(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(o,n){if(k===1){n.params.e_acronyms=1
}d(j)
});
c.eventEmitter.bind("AUTOCOMPLETE:afterAjax",function(o,n){if(n.data&&n.data.__deb__&&(n.data.__deb__.s&16)==16){c.track.stage(j,1);
c.track.stage(j,2)
}})
}if(c[sNSExperiments]){c[sNSExperiments][j]={priority:9,init:m,initElse:m}
}else{m()
...
B.when({condition:B.env.b_site_type_id==1,events:["ready"]}).require([],function(){var c="PVdIZKZPHcNVBUKcaZdFOLRe";
B.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(g,f){var d=B.et.track(c);
if(d){f.params.e_pdb=1
}});
B.eventEmitter.bind("AUTOCOMPLETE:afterAjax",function(g,d){var f=B.et.track(c);
if(d&&d.data&&d.data.city&&Array.isArray(d.data.city)){d.data.city.forEach(function(e,h){e.__new_popular__=false;
if(e.flags&&e.flags.popular){if(f==1){delete e.flags.popular
}if(f==2){e.__new_popular__=true
}B.et.stage("PVdIZKZPHcNVBUKcaZdFOLRe",1)
}})
}})
});
B.when({condition:B.env.b_can_run_sau,events:["ready"]}).require([],function(){$("#destination, .sb-destination__input").bind("keydown",function(){B.track.stage("PVdIESZHO",2)
})
});
...
$(document).keyup(function(d){if($("body").hasClass("has_ultra_focus")&&d.keyCode==27){$("body").removeClass("has_ultra_focus");
$overlay.fadeOut("fast")
}})
...
(function(){var d=B.env,c=d.b_site_type==="www",e=d.b_action;
if(!B.when){return
}B.when({condition:c&&e==="index",events:"ready",experiment:"bCbCUSOONJdDBKDXKe",stage:1});
B.when({condition:c&&e==="index",events:"load",experiment:"bCbCUSOONJdDBKDXKe",stage:2});
B.when({condition:c&&e==="searchresults",events:"ready",experiment:"bCbCUSOONWNMXC",stage:1});
B.when({condition:c&&e==="searchresults",events:"load",experiment:"bCbCUSOONWNMXC",stage:2});
B.when({condition:c&&e==="hotel",events:"ready",experiment:"bCbCUSOONDSDXKe",stage:1});
B.when({condition:c&&e==="hotel",events:"load",experiment:"bCbCUSOONDSDXKe",stage:2})
}());
if(booking.env.enable_scripts_tracking){booking.env.scripts_tracking.main.run=true
}B.when({events:"ready",experiment:"bLNRXaVYccPJKeIYSYHDQIDPBFO",stage:"1"}).run(function(){$(".js-guest-configuration-wrapper__trigger").click(function(c){c.preventDefault();
B.et.stage("bLNRXaVYccPJKeIYSYHDQIDPBFO",2);
