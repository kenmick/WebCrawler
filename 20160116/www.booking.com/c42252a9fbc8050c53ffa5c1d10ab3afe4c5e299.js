...
}var n=booking.track.getVariant("BOebRRDOLdJOUTUKUDfAMO");
...
if(n&&q){B.track.stage("BOebRRDVdJOUTUKUDfAMO",1);
switch(booking.env.b_action){case"searchresults":pss_growl_design_consistency_stage=2;
break;
case"hotel":pss_growl_design_consistency_stage=3;
break;
case"booking":pss_growl_design_consistency_stage=4;
break;
default:pss_growl_design_consistency_stage=5;
break
...
if(n){B.track.stage("BOebRRDVdJOUTUKUDfAMO",6)
}}if(n&&!p){B.track.stage("BOebRRDVdJOUTUKUDfAMO",7)
...
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PVZVAAZSBMBHKdRfLFaeXC";
e.on("beforeajax",function(f,h){var j=d.track("PVdIYROdVaC");
...
e.on("afterajax",function(f,h){var g=d.track("PVdIYROdVaC");
if(g===1){if(h&&h.__show_theme_flag__){d.stage(c,1)
}}})
});
