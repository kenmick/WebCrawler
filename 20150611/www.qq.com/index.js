...
window._AdSameObj_CY3646 = {};
var cyis1 = true;
var cyis2 = false;

window._AdSameObj_CY3646.setis = function(val){
	cyis1=val;
	cyis2=!val;};
window._AdSameObj_CY3646.setis(_as_dts("_as_crazy3646",2));

window._AdSameObj_CY3646.status=0;

window._AdSameObj_CY3646.fc = function(cmd, args) {
	switch (cmd)
	{
	case "replay":
		if (mutex_lock()==0) {
		window._AdSameObj_CY3646.b1.show();


		window._AdSameObj_CY3646.b2.hide();


		window._AdSameObj_CY3646.status=1;
		}
		break;
	...
	case "closeBig":
		...
		window._AdSameObj_CY3646.b1.hide();
	...
	case "close":
			...
			window._AdSameObj_CY3646.b1.destroy();
			window._AdSameObj_CY3646.b2.destroy();
...
window._AdSameObj_CY3646.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://ra.gtimg.com/adsame/2101517/1000300.swf",
	clsbtn: 0,
	clickUrl: "http://c.l.qq.com/lclick?seq=20150609000080&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY3646.f1",
	fscmdfc: window._AdSameObj_CY3646.fc,
    paras:{
    	this_obj:window._AdSameObj_CY3646.fc
   	}
});
window._AdSameObj_CY3646.b1 = new _as_divfl({
	width: 1000,
	height: 300,
	hAlign: "center",
	vAlign: "bottom",
	...
	followScroll: 1,
	firstScreen: 0,
	flash: window._AdSameObj_CY3646.f1,
	selfName: "window._AdSameObj_CY3646.b1",
	iniShow: cyis1
});
window._AdSameObj_CY3646.b1.onAfterHide = function() {


		window._AdSameObj_CY3646.b2.show();
	mutex_unlock();
}

window._AdSameObj_CY3646.f2 = new _as_fl({
	width: 20,
	height: 100,
	srcUrl: "http://ra.gtimg.com/adsame/2101517/20100.swf",
	repfc: "window._AdSameObj_CY3646.fc(\"replay\")",
	clsfc: "window._AdSameObj_CY3646.fc(\"close\")",
	clickUrl: "http://c.l.qq.com/lclick?seq=20150609000080&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY3646.f2",
	fscmdfc: window._AdSameObj_CY3646.fc,
    paras:{
    	this_obj:window._AdSameObj_CY3646.fc
   	}
});
window._AdSameObj_CY3646.b2 = new _as_divfl({
	width: 20,
	height: 100,
	...
	firstScreen: 0,
	alwaysShow: 0,
	flash: window._AdSameObj_CY3646.f2,
	selfName: "window._AdSameObj_CY3646.b2",
	iniShow: (cyis2 || 0)
});


window._AdSameObj_CY3646.run = function() {
	if(window._AdSameObj_CY3646.inited)return;
	window._AdSameObj_CY3646.inited=true;
	var s = function() {

	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://samba.adsame.com/s?z=samba&c=5312&l=5799\' />";
    var trackcode2 = "<img style=\'width:0px;height:0px;display:none\' src=\'http://qq.m.cn.miaozhen.com/x/k=2007422&p=6uDof&dx=0&rt=2&ns=__IP__&ni=__IESID__&v=__LOC__&o=http://amch.questionmarket.com/adsc/d1379092/30/1452642/adscout.php?ord=[randnum]\' />";
	if (_as_bro.isIe6()) {
	...
	window._AdSameObj_CY3646.b1.create(window._AdSameObj_CY3646.f1.getcode()+trackcode+trackcode2+ifmcode);
	window._AdSameObj_CY3646.b1.show();
	window._AdSameObj_CY3646.b2.create(window._AdSameObj_CY3646.f2.getcode()+ifmcode);
	window._AdSameObj_CY3646.b2.show();



	window._AdSameObj_CY3646.status=cyis1;
