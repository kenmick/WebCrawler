...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="publishid" content="1181767.0.103.0"/>
<title>æ°åç½_ä¼ æ­ä¸­å½ æ¥éä¸ç</title>
<meta name="keywords" content="æ°é»ä¸­å¿,æ¶æ¿,äººäºä»»å,å½é,å°æ¹,é¦æ¸¯,å°æ¹¾,æ¾³é¨,åäºº,åäº,å¾ç,è´¢ç»,æ¿æ,è¡ç¥¨,æ¿äº§,æ±½è½¦,ä½è²,å¥¥è¿,æ³æ²»,å»æ¿,ç¤¾ä¼,ç§æ,äºèç½,æè²,æå¨±,çµè§å§,çµå½±,è§é¢,è®¿è°,ç´æ­,ä¸é¢" />
<meta name="description" content="ä¸­å½ä¸»è¦éç¹æ°é»ç½ç«,ä¾ææ°åç¤¾éå¸å¨ççéç¼ç½ç»,è®°èéå¸ä¸ç100å¤ä¸ªå½å®¶åå°åº,å°æ¹é¢éåå¸å¨å½31ä¸ªçå¸èªæ²»åº,æ¯å¤©24å°æ¶åæ¶ä½¿ç¨6ç§è¯­è¨æ»å¨åç¨¿,æå¨ãåç¡®ãåæ¶æ­åå½åå¤éè¦æ°é»åéå¤§çªåäºä»¶,åä¼è¦ç200å¤ä¸ªå½å®¶åå°åº,åå±è®ºåæ¯å¨çç¥åçä¸­æè®ºåã" />
...
<link rel="stylesheet" href="http://www.news.cn/2014/styles/common.css?v111" />
<link rel="stylesheet" href="http://www.news.cn/2014/styles/index.css" />
<style type="text/css" media="screen">
/* topBody
--------------------------------------------------*/
#topBody { width: 100%; height: 33px; line-height: 33px; background:#4098d7 url(http://www.news.cn/2014/images/xh_bg.png) repeat-x 0px 0px; text-align: center; margin-bottom:10px; }
...
#topBody .topCont a { display: inline-block; height: 33px; line-height: 33px; color: #fff;font-size:12px; }
#weather{ position:relative}
#weather iframe{ position:absolute;top:4px;top:5px\9;top:5px\0;#top:4px;left:-25px;}
/* headerBody
--------------------------------------------------*/
...
#headerBody .headerRT .lang { float:right; width: 500px; height: 30px; overflow: hidden; text-align: right; font-size: 0px; background: url(http://www.news.cn/2014/images/xh_language.jpg) no-repeat 0px 0px; position:relative; }
...
#headerBody .headerRB .reportItem .report03 a {background-position:0px -78px;}
#headerBody .headerRB .reportItem .report04 a {background-position:0px -117px;}
...
/* navBody
--------------------------------------------------*/
#navBody { width: 1000px; height: 52px; padding: 10px 0; margin: 0 auto 10px auto; background:#48a6eb url(http://www.news.cn/2014/images/xh_bg.png) repeat-x 0px -34px; position: relative; z-index: 1; }
...
/* headLine
--------------------------------------------------*/
#headLine { width: 1000px; margin: 0 auto 10px auto; border: 1px solid #e4e4e4; background: #f7f7f7; position: relative; }
...
#headLine .headLineL { float: left; width: 775px; margin: 0 10px; _margin: 0 5px; padding: 10px 0; }
#headLine .headLineLT { overflow: hidden; }
...
#headLine .headLineR { float: right; width: 170px; height: 420px; margin-top: 10px; padding: 60px 15px 0 14px; border-left: 1px solid #eaeaea; overflow:hidden; background: url(http://www.news.cn/2014/images/xh_bg_learning.png) no-repeat 50% 0px; position: relative; }
#headLine .headLineR .learningLink { display: block; width: 177px; height: 55px; position: absolute; top: 0px; left: 10px; }
#headLine h1 { text-align: center; margin: 10px 0; _padding-top:10px; }
#headLine h1 a { height: 44px; line-height: 44px; font-family: \5FAE\8F6F\96C5\9ED1; font-size: 32px; font-weight: bold; color: #0e649a; }
...
#headLine .videoFocusBox .pic i { dis