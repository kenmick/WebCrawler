	...
	var handlers = {
		...
		load_more: function(e){
			...
			if (BF_STATIC.hp_type == 'life') {
				...
				load_url = BF_STATIC.web_root + '/buzz' + '?country=uk' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else if (BF_STATIC.hp_type == 'uknews') {
				load_url = BF_STATIC.web_root + '/news' + '?country=uk' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else if (BF_STATIC.hp_type == 'aunews') {
				load_url = BF_STATIC.web_root + '/news' + '?country=au' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else if (BF_STATIC.hp_type == 'francenews') {
				load_url = BF_STATIC.web_root + '/news' + '?country=fr' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else if (BF_STATIC.hp_type == 'canadanews') {
				load_url = BF_STATIC.web_root + '/news' + '?country=ca' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else if (BF_STATIC.hp_type == 'francebuzz') {
				load_url = BF_STATIC.web_root + '/buzz' + '?country=fr' + '&p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
			else {
				load_url = BF_STATIC.web_root + '/'+ BF_STATIC.hp_type +'?p=' + pages[current_tab] + '&z=' + BF_STATIC.z;
			}
