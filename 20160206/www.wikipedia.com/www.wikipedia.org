...
<button class="formBtn" type="submit" name="go"><img width="12" height="13" src="portal/wikipedia.org/assets/img/12px-Vector_search_icon.svg.png" srcset="portal/wikipedia.org/assets/img/18px-Vector_search_icon.svg.png 1.5x, portal/wikipedia.org/assets/img/24px-Vector_search_icon.svg.png 2x" alt="Search"></button>
