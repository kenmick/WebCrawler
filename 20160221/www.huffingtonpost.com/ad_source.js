                      ...
                      case "MediaFiles":
                        ...
                        if(l) {
                          for(r.mediaFiles = [], l = H(l), I = 0;I < l.length;I++) {
                            var E = l[I];
                            "MediaFile" == E.nodeName && (z = new zc, z.bitrate = E.getAttribute("bitrate"), z.delivery = E.getAttribute("delivery"), z.width = E.getAttribute("width"), z.height = E.getAttribute("height"), z.type = E.getAttribute("type"), z.apiFramework = E.getAttribute("apiFramework"), (E = X(E)) && (z.url = E), r.mediaFiles.push(z))
                          }
                        }
                        break;
                      case "AdParameters":
