...
// Generated by CoffeeScript 1.7.1
var defaultCreateNode, getPath, k, reportSriError, v, _ref;
...
requirejs.createNode = function(config, moduleName, url) {
  var hash, haveSri, isFallback, node, path, pathConfig, staticRelativePath;
  node = defaultCreateNode(config, moduleName, url);
