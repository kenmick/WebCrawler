...
}},init:function(){if(booking.env.b_action=="hotel"||(booking.env.b_action=="searchresults"&&booking.track.getVariant("YcWVTbKCBPdGGWcOCKe"))){return
...
if(booking.env.b_action=="hotel"||(booking.env.b_action=="searchresults"&&booking.track.getVariant("YcWVTbKCBPdGGWcOCKe"))){return
...
if(booking.track.getVariant("IZVFUZZOZbEfKFWC")===1||booking.track.getVariant("YcWVFUZZOZbEfKFWC")===1){$(".uc_language a.popover_trigger").click(function(){e()
})
}$(".uc_language a.popover_trigger").click(function(){B.track.stage("YcWVFUZZOZbEfKFWC",1)
});
...
}$(".js-uc-cug-signup-menu-prompt-button, .js-uc-cug-signup-menu-prompt-link").click(function(){B.track.stage("PcVBcTaNFMGUbAXKAFXbWC",1)
})
});
B.runExp("PcVBcTaNFMGUbAXKAFXbWC").onLoad(function(){if($.cookie("tfl_signup_notification_prompt")){return
}$.cookie("tfl_signup_notification_prompt",1);
booking[sNSExperiments].user_center_bar.positionPopover($(".js-uc-notifications .user_center_popover"),{});
