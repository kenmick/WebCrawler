...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("Fxo3f_oXSNM4MEerqydmIWZezlY")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
}if("mix"===e)return Me(t);if(""===e)return Le(t);if("value"===e){var e=n;return"input"===e?qe(t):"tumbler"===e?"option"===s?Ue(t):Qe(t):Qe(t)
}if("getLive"===e)return"input"===n?!!s==!1?Ve(t):Qe(t):Qe(t);if("live"===e)return"input"===n?!!s==!1?ze(t):Qe(t):Qe(t);
...
}function D(t){return!!s==!1?"button":I(t)}function I(){return void 0}function S(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:R(t);
...
}return R(t)}return R(t)}function T(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Ie(t),i=e,n),{elem:"retpath"}]
...
if("button"===e)return V(t);if("input"===e)return z(t);if("auth"===e)return Q(t);if("checkbox"===e)return F(t);
...
var r=i;i="",Ne(t),t.ctx=o,i=r,t.__$anflg34=s}function F(t){return!(t.__$anflg33!==!0)==!1?!!s==!1?U(t):Qe(t):Qe(t)
}function U(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
...
}function V(t){if(!(t.__$anflg29!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg29;return t.__$anflg29=!0,V(t),t.__$anflg29=e,void 0}return Qe(t)}return Qe(t)}function z(t){var e=s;
...
}function W(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?K(t):Qe(t):Qe(t)}function K(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=qe(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Ve(t),i=o,a);
...
}return pe(t)}return pe(t)}return me(t)}function pe(t){return!(t.__$anflg8!==!0)==!1?fe(t):me(t)}function fe(t){var e,n,s=(e=i,i="value",n=Ue(t),i=e,n),o=t.__$anflg8;
...
}return Fe(t)}return Fe(t)}function Fe(t){return!!s==!1?"":Qe(t)}function Ue(t){return t.ctx.value||"left"!==t.ctx.side
}function Ve(t){var e,n,s=(e=i,i="live",n=ze(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
var F=(_=i,i="mix",g=Me(t),i=_,g);if(A.mix&&(F=F?[].concat(F,A.mix):A.mix),F){var U={};U[e(n,s)]=!0,t._.isArray(F)||(F=[F]);
for(var V=0;V<F.length;V++){var z=F[V];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,Q=z.mods||r,G=z.elemMods||{};
if(H&&j.push(" "),O.INTERNAL[H?"buildClasses":"buildModsClasses"](W,z.elem||z._elem||(z.block?void 0:s),z.elemMods||z.mods,j),z.js&&((L||(L={}))[O.INTERNAL.buildClass(W,z.elem)]=z.js===!0?{}:z.js,$||($=W&&!z.elem)),H&&!U[e(W,K)]){U[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=Me(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&U[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,F.splice(V+1,0,Z))}}}}}}q&&j.push(R?" ":"",q),$&&j.push(" i-bem"),j.push('"')
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(I=i,i="content",P=S(t),i=I,P);if(ie||0===ie){var R=n||s,ne=t._notNewList;
...
}catch(S){}}return d=f?g?'<div style="'+B+'"><'+v+N+i("src",x)+i(P,T)+i(A,j)+i(D,I)+i("type",w)+"/></div>":(b?"<"+v+C+N+">"+e("movie",x):"<"+v+N+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(D,I)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
if(this._owner){var e=this._viewport;t.top-=e.scrollTop(),t.left-=e.scrollLeft()}return t}}),_borschik("HmJLUYYV6DJMw9uf3rf670n4Y4E")&&BEM.DOM.decl("previewed",{onSetMod:{js:function(){this.url=this.params.url,this.checkable=this.params.checkable,this.bindTo("click",this._onClick),this.checkable&&(this.control=this.findBlockOn(this.domElem,this.params.block),this.channel("content-preview").on({closed:this.uncheckControl,"before-update":this._onBeforeUpdate},this)),this.contentPreviewContainer=this.findContentPreviewContainer()
}},findContentPreviewContainer:function(){return this.findBlockOutside("b-page").findBlockInside("content-preview")
},_onClick:function(t){if(!t.originalEvent.handled){if(this.contentPreviewContainer.isOpened()&&this.contentPreviewContainer.getUrl()===this.url)this.afterCurrentEvent(function(){this.contentPreviewContainer.close()
});else{if(this.params.metrika){var e=window.yaCounter30391147;e&&e.reachGoal("CONTENT_PREVIEW_OPENED")
}this.afterCurrentEvent(function(){this.contentPreviewContainer.open({url:this.url})})}t.originalEvent.handled=!0
}},_onBeforeUpdate:function(t,e){this.url===e.url?this.checkControl():this.uncheckControl()},checkControl:function(){this.control.setMod("checked","yes")
},uncheckControl:function(){this.control.delMod("checked")},destruct:function(){this.params.checkable&&(this.channel("content-preview").un("closed",this.uncheckControl,this),this.channel("content-preview").un("before-update",this._onBeforeUpdate,this)),this.__base.apply(this,arguments)
...
BEM.blocks.counter.log(this.params.counter,{state:e})}}}),_borschik("NA-QJ2YuFyCxRU40NmS3Z2wB2l0")&&BEM.decl("install-chrome-webstore-item-action",{execute:function(){var t=this.params.id&&BEM.blocks["chrome-webstore-item_type_"+this.params.id]?BEM.create("chrome-webstore-item_type_"+this.params.id,this.params.webItem):BEM.create("chrome-webstore-item",this.params.webItem);
...
}}),_borschik("EicMbNnxsvRJzobNcbnE2_XAhlQ")&&BEM.DOM.decl({block:"serp-item",modName:"content-preview-mode",modVal:"available"},{onSetMod:{js:function(){var t=this.params.backgroundClickCounter;
...
}}),_borschik("UuGuI4GJfdXHwpr9cbbtPf13xoU")&&BEM.DOM.decl("content-preview",{onSetMod:{js:function(){this.setMod("first","yes"),this._defaultParams=this.params,this._previousData={},this.channel("content-preview").on({update:this._onChannelUpdate,toggle:this._onChannelToggle},this),this.opened=!1,this._getMain().on("panelClosed",this._onPanelClosed,this)
}},_onPanelClosed:function(){this.opened=!1,this.channel("content-preview").trigger("closed")},open:function(t){this._getMain().openPanel(),this.opened=!0,this.update(t)
},close:function(){this._getMain().closePanel(),this.opened=!1},isOpened:function(){return this.opened
},getUrl:function(){return this.url},_onChannelUpdate:function(t,e){this.update(e)},_onChannelToggle:function(t,e){return this._isSameContent(e)&&this._getMain().isPanelOpened()?(this.close(),void 0):(this.open(e),void 0)
...
},update:function(t){if(this.channel("content-preview").trigger("before-update",t),this._isInited||this._afterInit(),!this._isSameContent(t)){this._previousData=t,this.url=t.url,this.params=$.extend(!0,[],this._defaultParams,t),this.setMod("transition","yes"),!t.content&&!t.partial&&this.delMod("updated");
...
}).liveBindTo({modName:"pseudo",modVal:"yes"},"keyup",function(t){this._onKeyUp(t)})}}),_borschik("t4tZW1k45GVaJAzwOAoOvfPHuCg")&&BEM.HTML.decl("b-icon",{onBlock:function(t){var e,i={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},n=t.params(),s=["alt","width","height"];
