...
if(i&&i.target){if(e.track.getVariant("fEFHMPdTUFQZcbYUGTFHaO")==3&&b(i.target).closest(".lp_promotions_cards_btn_iteration").length){g=b(this).closest("li").find("h4 a").attr("href")
}else{if(!b(i.target).closest("h4").length){h="sr-url";
g=b(this).closest("li").data(h)
}}if(b(i.target).closest(".lp_promotions_cards_btn_iteration").length){e.track.stage("fEFHMPdTUFQZcbYUGTFHaO",1);
