...
function sohuad_buttom_n(){
	...
	if(isIe6){
		// SohuBottomAdWrapper_css = "width:100%;height:32px;position:absolute;z-index:999;left:0px;top: expression(eval((document.compatMode&&document.compatMode=='CSS1Compat')?documentElement.scrollTop+documentElement.clientHeight-32:document.body.scrollTop+document.body.clientHeight-32));";
		// SohuBottomAdWrapper_css = "width:100%;height:32px;position:absolute;z-index:999;left:0px;top: expression(eval((document.compatMode&&document.compatMode=='CSS1Compat')?document.body.scrollTop+document.body.clientHeight-32:documentElement.scrollTop+documentElement.clientHeight-32));";
		SohuBottomAdWrapper_css = "width:100%;height:32px;position:absolute;z-index:999;left:0px;top:"+(_M.clientHeight-32)+"px";
	}else{
		SohuBottomAdWrapper_css = "width:100%;height:32px;bottom:0;left:0;position:fixed;z-index:999;";
	...
	//var control_list = '<div id="hover_over" style="background:#fff;background-color: rgb(255, 255, 255);filter:alpha(opacity=1);-moz-opacity:0.01;opacity:0.01;width:910px;height:32px;position:absolute;top:0;left:0;cursor:pointer;cursor:hand;"></div><div id="bottom_close" style="width:39px;height:16px;position:absolute;bottom:0;right:20px;"><a><img src="http://images.sohu.com/bill/tongyong/close0910.png"></a></div><div id="bottom_replay" style="width:39px;height:16px;position:absolute;top:0;right:0;"><a><img src="http://images.sohu.com/bill/s2012/gates/all/replay_h.png"></a></div>';
	var control_list = '<div id="bottom_close" style="width:39px;height:16px;position:absolute;bottom:0;right:20px;"><a><img src="http://images.sohu.com/bill/tongyong/close0910.png"></a></div><div id="bottom_replay" style="width:39px;height:16px;position:absolute;top:0;right:0;"><a><img src="http://images.sohu.com/bill/s2012/gates/all/replay_h.png"></a></div>';
...
//	});
	...
	var SohuBottomAd2_css = 'width:950px;height:80px;margin:0 auto;position:relative;';
	if(isIe6){
		// SohuBottomAdWrapper2_css = "width:100%;height:80px;position:absolute;z-index:999;left:0px;top: expression(eval((document.compatMode&&document.compatMode=='CSS1Compat')?document.body.scrollTop+document.body.clientHeight-80:documentElement.scrollTop+documentElement.clientHeight-80));";
		SohuBottomAdWrapper2_css = "width:100%;height:80px;position:absolute;z-index:999;left:0px;top:"+(_M.clientHeight -80)+"px";
	}else{
		SohuBottomAdWrapper2_css = "width:100%;height:80px;bottom:0;left:0;position:fixed;z-index:999;";
	}
	...
	var control_list2 = '<div id="bottom_close2" style="width:39px;height:16px;position:absolute;top:0;right:20px;"><a><img src="http://images.sohu.com/bill/tongyong/close0910.png"></a></div>';
...
function sohuad_buttom_b(){
	...
	var sohuFlash2 = new sohuFlash(NEWAD.big,"_344bf2c22b357ed2412c67e811128d8a","950","80","7");
