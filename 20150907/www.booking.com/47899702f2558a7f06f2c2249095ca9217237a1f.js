...
D.getIW(C.id,function(E){if(B.atlas.getVariant("eGBUYSaBTbYFbVKIGcTAcHe")){D.trigger("iw-mini-better-price");
if(x==C.id){D.set("currentHotel",E)
...
if(B.atlas.getVariant("eGYSaBXeHbCNHLDEMO")){E.transLengthOfStayExperiment=v.get("transLengthOfStayExperiment")
...
}if(B.atlas.getVariant("eGYSaBbTZSEISUaDZGTGC")||B.atlas.getVariant("eGfESAcCJZUNZXQeJVUcDcRe")){G.off("marker-hover",b);
G.off("marker-out",z);
G.once("iw-close",function(){G.on("marker-hover",b);
G.on("marker-out",z)
})
...
if(B.atlas.getVariant("eGYSaBXeHbCNHLDEMO")){I.transLengthOfStayExperiment=v.get("transLengthOfStayExperiment")
...
if(B.atlas.getVariant("eGYSaBXeHbCNHLDEMO")){J.transLengthOfStayExperiment=v.get("transLengthOfStayExperiment")
}if(B.atlas.getVariant("eGBUYSaBTbYFbVKIGcTAcHe")){G.trigger("iw-mini-better-price");
if(x==E){G.set("currentHotel",J)
}}if(/hotel.*/.test(C.data.b_type)){G.trigger("iw-hotel-selectable");
if(B.atlas.getVariant("ebcBUYSaBKHLLT",1)||B.atlas.getVariant("ebcOQPBRYCWfae",1)){g(G,C,{extraClasses:["map-hotel--selectable"]})
}else{g(G,C)
}}else{g(G,C)
}if((B.atlas.getVariant("eGBUYSaBNHTXT")||B.atlas.getVariant("eGOQPBRNZRUXe"))&&/hotel.*/.test(C.data.b_type)){window.setTimeout(function(){G.trigger("iw-control-show",{markerId:E,data:C.data})
},0)
}else{G.openIW(E,J)
