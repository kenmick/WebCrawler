...
if(m.indexOf(o)===-1&&i(o,n)){m.push(o)}}document[q]=null;k(p);g(n);return m}},{"@marcom/ac-dom-nodes/isDocumentFragment":15,"@marcom/ac-dom-nodes/isElement":16,"@marcom/ac-dom-nodes/remove":18,"@marcom/ac-polyfills/Array/prototype.indexOf":47}],29:[function(b,c,a){c.exports={getWindow:function(){return window
...
}return f}}},{}],31:[function(c,d,b){var g=c("./helpers/globals");var f=c("@marcom/ac-function/once");
function a(){var h=g.getDocument();return !!h.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":29,"@marcom/ac-function/once":30}],32:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":29,"@marcom/ac-function/once":30}],33:[function(b,c,a){var f=b("./extend");
