...
G.unshift({b_color:d[20],b_classname:d[21],b_tooltip:d[4],b_size:d[3]});
K();
G.shift();
...
G.unshift({b_ge_freebies:d[39],b_ge_discount:d[39],b_tooltip:d[4],b_classname:d[128]});
o();
G.shift();
...
}if(e&&c.env.b_lang_for_url.match(/^ja/)){(function(k,j){function l(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(n,m){m.params.e_jpn=2
})
}l()
})(window.jQuery)
