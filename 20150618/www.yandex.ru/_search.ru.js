...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("9UTN2oClGVZaMVpCVy-d0T3bm1s")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return Ce(t);if("live"===e){var e=n;return"checkbox"===e?!!s==!1?Pe(t):Ze(t):"input"===e?!!s==!1?Te(t):Ze(t):Ze(t)
}if("auto-content"===e)return"auth"===n?Oe(t):Ze(t);if("action"===e)return"auth"===n?!!s==!1?je(t):Ze(t):Ze(t);
if("mix"===e)return we(t);if("bem"===e)return Re(t);if(""===e)return qe(t);if("value"===e){var e=n;return"input"===e?Ve(t):"tumbler"===e?"option"===s?We(t):Ze(t):Ze(t)
}if("public-params"===e)return"i-global"===n?Ke(t):Ze(t);if("js-params"===e)return"b-page"===n?!!s==!1?Ge(t):Ze(t):Ze(t);
if("default"===e)return U(t);if("env"===e)return"i-global"===n?Qe(t):Ze(t);if("content"===e)return A(t);
if("jsAttr"===e)return Xe(t);if("tag"===e)return P(t);if("cls"===e)return Ye(t);if("format-value"===e){if("value"===s){var e=n;
return"notice"===e?Le(t):"ticker"===e?Ne(t):Ze(t)}return Ze(t)}return Ze(t)}function u(t){var e=n;if("b-icon"===e){if(!!s==!1){var a,c=t.ctx,h={src:"//yastatic.net/lego/_/La6qi18Z8LwgnZdsAr1qy1GwCwo.gif",alt:""},u=["alt","width","height"];
for(c.url&&(h.src=c.url);a=u.shift();)c[a]&&(h[a]=c[a]);return h}return I(t)}if("checkbox"===e){var e=s;
...
}return I(t)}if("button"===e)return l(t);if("input"===e){var e=s;if("hint"===e)return{id:t._hintId,"for":t._inputId,"aria-hidden":!0};
...
}return I(t)}if("notice"===e)return"count"===s?!t.ctx.url==!1?{href:t.ctx.url}:I(t):I(t);if("auth"===e){var e=s;
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var m,g;return{method:"POST",action:t.ctx.url||(m=i,i="action",g=je(t),i=m,g),role:"form","aria-label":BEM.I18N("auth","auth")}
}return I(t)}if("b-link"===e)return _(t);if("suggest2-item"===e){var e=s;return"link"===e?{href:t.ctx.url,target:t.ctx.target}:"bullet"===e?{"aria-hidden":!0}:I(t)
}if("select"===e){var e=s;return"group"===e?{role:"group","aria-labelledby":t._labelId}:"item"===e?y(t):"list"===e?k(t):I(t)
}if("tumbler"===e){var e=s;if("sticker"===e)return M(t);if("text"===e)return E(t);if("input"===e){var b,v=o.side;
return b="left"===v?t._checked?void 0:"checked":t._checked,{type:"radio",name:t.ctx.name,value:t.ctx.value,checked:b,disabled:t.ctx.disabled,"aria-labelledby":"left"===v?t._leftId:t._rightId}
}return"button"===e?w(t):I(t)}return"link"===e?x(t):"ticker"===e?"value"===s?{title:t._count}:I(t):I(t)
...
return e.tabindex&&(i.tabindex=e.tabindex),i}return I(t)}function _(t){return!(t.__$anflg21!==!0)==!1?!!s==!1?g(t):b(t):b(t)
}function g(t){for(var e,i,n,s=(e=t.__$anflg21,t.__$anflg21=!0,i=_(t),t.__$anflg21=e,i||{}),o=t.ctx,r=o.url,a=o.counter,c=t["i-global"],h=["title","target"],u=/^(https?:)?\/\/([^.?#\/]+\.)*?yandex\.(ru|by|ua|kz|com|com\.tr|net|st)(:\d{1,5})?([#\/?].*)?$/,l=c&&c.isYandexNet&&!c.isPumpkin&&a&&-1===a.indexOf(c.redirPrefix)&&r&&r.match(/^(https?:)?\/\//)&&!r.match(u);n=h.pop();)o[n]&&(s[n]=o[n]);
return a&&(s.onmousedown=a),s.href=l?"//h.yandex.net/?"+encodeURIComponent(r):r,s}function b(t){return!!s==!1?v(t):I(t)
}function v(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=$e(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
return h}function y(t){if(!(t.__$anflg16!==!0)==!1){var e,i,n=(e=t.__$anflg16,t.__$anflg16=!0,i=y(t),t.__$anflg16=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function k(t){if(!(t.__$anflg15!==!0)==!1){var e,i,n=(e=t.__$anflg15,t.__$anflg15=!0,i=k(t),t.__$anflg15=e,i||{});
return n.role="select",n}return I(t)}function M(t){if(!(t.__$anflg11!==!0)==!1){var e,i,n=(e=t.__$anflg11,t.__$anflg11=!0,i=M(t),t.__$anflg11=e,i||{});
return n["aria-hidden"]=!0,n}return I(t)}function E(t){if(!(t.__$anflg10!==!0)==!1){var e,i,n=(e=t.__$anflg10,t.__$anflg10=!0,i=E(t),t.__$anflg10=e,i||{});
return side=o.side,n.id="left"===side?t._leftId:t._rightId,n["aria-hidden"]=!0,n}return I(t)}function w(t){if(!(t.__$anflg7!==!0)==!1){if(!t._sideId==!1){var e,i,n=(e=t.__$anflg7,t.__$anflg7=!0,i=w(t),t.__$anflg7=e,i||{});
return n["aria-labelledby"]=t._sideId,n}return I(t)}return I(t)}function x(t){return!(t.__$anflg2!==!0)==!1?!!s==!1?B(t):C(t):C(t)
}function B(t){for(var e,i,n,s=(e=t.__$anflg2,t.__$anflg2=!0,i=x(t),t.__$anflg2=e,i||{}),o=t.ctx,r=o.url,a=o.counter,c=t["i-global"],h=["title","target"],u=/^(https?:)?\/\/([^.?#\/]+\.)*?yandex\.(ru|by|ua|kz|com|com\.tr|net|st)(:\d{1,5})?([#\/?].*)?$/,l=c&&c.isYandexNet&&!c.isPumpkin&&a&&-1===a.indexOf(c.redirPrefix)&&r&&r.match(/^(https?:)?\/\//)&&!r.match(u);n=h.pop();)o[n]&&(s[n]=o[n]);
return a&&(s.onmousedown=a),s.href=l?"//h.yandex.net/?"+encodeURIComponent(r):r,s}function C(t){if(!(t.__$anflg1!==!0)==!1){if(!(r&&"yes"===r.disabled)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg1,t.__$anflg1=!0,i=x(t),t.__$anflg1=e,i||{});
return n.tabindex=-1,n["aria-disabled"]=!0,n}return D(t)}return D(t)}return D(t)}function D(t){return!!s==!1?S(t):I(t)
}function S(t){var e=t.ctx,n={};if(["title","target","id","tabindex"].forEach(function(t){e.hasOwnProperty(t)&&(n[t]=String(e[t]))
}),null!==e.url&&"undefined"!=typeof e.url)if(t.isSimple(e.url))n.href=String(e.url);else{var s=[],o=i;
i="";var r=t._buf;t._buf=s;var a=t.ctx;t.ctx=e.url,$e(t),i=o,t._buf=r,t.ctx=a,n.href=s.join("")}else n.role="button",n.tabindex||(n.tabindex="0");
return n}function I(){return void 0}function P(t){var e=n;if("b-icon"===e)return!!s==!1?"img":O(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":T(t):T(t);
if("input"===e){var e=s;return"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":O(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":O(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":O(t)}if("checkbox"===e){var e=s;return"control"===e?"input":"label"===e?"label":!!s==!1?"span":O(t)
}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":O(t):"a11y"===e?"span":"items"===e?"ul":O(t)
}if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":O(t)
}if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":O(t)
}if("b-autocomplete-item"===e)return!!s==!1?"li":O(t);if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":O(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":O(t)}return"link"===e?"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":O(t):"b-link"===e?!!s==!1?"a":O(t):O(t)
}function T(t){return!!s==!1?"button":O(t)}function O(){return void 0}function A(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:$(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:$(t);if("auth"===e){var e=s;
...
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Le(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",count:t.ctx.content}]:$(t)
}if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:$(t);
if("suggest2-item"===e)return!(r&&"link"===r.interact)==!1?!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:L(t):L(t);
...
}return N(t)}return N(t)}if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:$(t);
if("input"===e)return"ahead"===s?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:$(t);if("tumbler"===e)return"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1?!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:q(t):q(t);
if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Ne(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):$(t)
}return $(t)}function j(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Oe(t),i=e,n),{elem:"retpath"}]
}return $(t)}function L(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):$(e)}function N(e){return!(r&&"foot"===r.type)==!1?!!s==!1?e.ctx.data.slice(1).map(function(t){return this._.isArray(t)?{tag:"span",elem:"foot",content:t[0]}:t
},t(e)):R(e):R(e)}function R(t){return!(r&&"nav"===r.type)==!1?!!s==!1?{elem:"link",tag:"a",attrs:{href:t._url,target:"_blank"},content:[{elem:"link-url",tag:"span",content:t._linkUrlContent},{elem:"link-info",tag:"span",content:t._linkInfoConten}]}:F(t):F(t)
}function F(t){if(!!s==!1){var e=t.ctx.data,i=BEM.blocks["i-common__string"],n=i.escapeHTML(t._.isArray(e)?e[1]:e);
return i.highlight(n,t.ctx.hl)}return $(t)}function q(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return $(t)
}function $(t){return t.ctx.content}function U(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg31!==!0)==!1?V(t):Ze(t):Ze(t);
if("button"===e)return W(t);if("input"===e)return K(t);if("auth"===e)return Z(t);if("checkbox"===e)return H(t);
if("select"===e)return re(t);if("b-autocomplete-item"===e)return ue(t);if("popup"===e)return de(t);if("tumbler"===e)return fe(t);
if("i-global"===e)return Me(t);if("suggest2-item"===e){var e=s;return"icon"===e?ie(t):"fact"===e?oe(t):Ze(t)
}return Ze(t)}function V(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));
...
var r=i;i="",$e(t),t.ctx=o,i=r,t.__$anflg31=s}function H(t){return!(t.__$anflg30!==!0)==!1?!!s==!1?z(t):Ze(t):Ze(t)
}function z(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg30;t.__$anflg30=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=e.mods;e.mods=s,H(t),t._checkboxAttrs=r,t._labelId=a,e.mods=c,t.__$anflg30=o
}function W(t){if(!(t.__$anflg26!==!0)==!1){if(!!s==!1){var e=t.ctx.mods||{};e.theme=e.theme||"normal";
var i=t.__$anflg26;t.__$anflg26=!0;var n=t.ctx,o=n.mods;return n.mods=e,W(t),n.mods=o,t.__$anflg26=i,void 0
}return Ze(t)}return Ze(t)}function K(t){var e=s;return"hint"===e?!(t.__$anflg25!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?G(t):X(t):X(t):X(t):"control"===e?!(t.__$anflg24!==!0)==!1?!!r.clear==!1?Q(t):X(t):X(t):X(t)
}function G(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg25,t.__$anflg25=!0,s=t.ctx,t.ctx=a,o=i,i="",r=$e(t),t.ctx=s,i=o,n=r,t.__$anflg25=e,n
}function Q(t){var e=t.__$anflg24;t.__$anflg24=!0;var n=t.ctx;t.ctx={elem:"box",tag:"span",content:[t.ctx,{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]};
var s=i;i="",$e(t),t.ctx=n,i=s,t.__$anflg24=e}function X(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?Y(t):Ze(t):Ze(t)
}function Y(t){var e,n,s,o=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Ve(t),i=e,t.ctx=n,s),a=t.ctx.id||t.generateId(),c=t.ctx.mods||{},h=t.ctx.js||{};
...
t._live=h.live||!1;var v=t.ctx,y=v.mods;v.mods=c,K(t),t._inputId=l,t._labelId=d,t._hintId=p,t._name=f,t._value=m,t._inputLink=_,t._disabled=g,t._live=b,v.mods=y,t.__$anflg12=u
}function Z(t){return"retpath"===s?J(t):te(t)}function J(t){if(!(t.__$anflg23!==!0)==!1){var e=t.__$anflg23;
t.__$anflg23=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,J(t),t._retpath=i,t.__$anflg23=e,void 0
}return te(t)}function te(t){return!(t.__$anflg22!==!0)==!1?!!s==!1?ee(t):Ze(t):Ze(t)}function ee(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",Z(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg22=o
}function ie(t){if(!(t.__$anflg20!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg20;t.__$anflg20=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),ie(t),i.weather=n,t.__$anflg20=e,void 0
}return ne(t)}return ne(t)}function ne(t){return!(t.__$anflg19!==!0)==!1?se(t):Ze(t)}function se(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg19;t.__$anflg19=!0,ie(t),t.__$anflg19=i}function oe(t){if(!(t.__$anflg18!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg18;return t.__$anflg18=!0,oe(t),t.__$anflg18=e,void 0}return Ze(t)}return Ze(t)}function re(t){return"group"===s?ae(t):ce(t)
}function ae(t){if(!(t.__$anflg17!==!0)==!1){var e=t.__$anflg17;t.__$anflg17=!0;var i=t._labelId;return t._labelId=t.generateId(),ae(t),t._labelId=i,t.__$anflg17=e,void 0
}return ce(t)}function ce(t){return!(t.__$anflg14!==!0)==!1?!!s==!1?he(t):Ze(t):Ze(t)}function he(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg14;
t.__$anflg14=!0;var o=t._controlAttrs;t._controlAttrs={id:i,name:e.name||i,tabindex:e.tabindex};var a=t._formSelect;
t._formSelect={block:n,mods:r,tabindex:e.tabindex},re(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg14=s
}function ue(t){return!(t.__$anflg13!==!0)==!1?!(r&&"nav"===r.type)==!1?!!s==!1?le(t):Ze(t):Ze(t):Ze(t)
}function le(t){var e,i,n,s,o,r,a=t.ctx.data,c=a[4],h=(c.match(/^\w[\w-]*:\/\//g)?"":"http://")+c,u=BEM.blocks["i-common__string"].escapeHTML(a[3]),l="&nbsp;&mdash;&nbsp;"+BEM.blocks["i-common__string"].highlight(a[2],t.ctx.hl);
return e=t.__$anflg13,t.__$anflg13=!0,n=t._linkUrlContent,t._linkUrlContent=u,s=t._linkInfoConten,t._linkInfoConten=l,o=t._url,t._url=h,r=ue(t),t._linkUrlContent=n,t._linkInfoConten=s,t._url=o,i=r,t.__$anflg13=e,i
}function de(t){return!!t._popupDefaults==!1?!!s==!1?pe(t):Ze(t):Ze(t)}function pe(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,de(t),t._popupDefaults=n
}function fe(t){if("option"===s){if("left"===t.ctx.side){if(!(t.__$anflg9!==!0)==!1){var e=t.__$anflg9;
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",$e(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
}return me(t)}return me(t)}return ge(t)}function me(t){return!(t.__$anflg8!==!0)==!1?_e(t):ge(t)}function _e(t){var e,n,s=(e=i,i="value",n=We(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",$e(t),t.ctx=r,i=a,t.__$anflg8=o}function ge(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",fe(t),t._disabled=i,t.__$anflg6=e,void 0
}return be(t)}return be(t)}return be(t)}function be(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",fe(t),t._checked=i,t.__$anflg5=e,void 0}return ve(t)
}return ve(t)}return ve(t)}function ve(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),fe(t),i.mods=n,t.__$anflg4=e,void 0
}return ye(t)}return ye(t)}return ye(t)}function ye(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?ke(t):Ze(t):Ze(t)
}function ke(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null;t.ctx.content&&(s="left"===t.ctx.content[0].side?i:n);
var o=t.__$anflg3;t.__$anflg3=!0;var r=t._name;t._name=t.ctx.name||(t.ctx.name=e);var a=t._leftId;t._leftId=i;
var c=t._rightId;t._rightId=n;var h=t._sideId;t._sideId=s,fe(t),t._name=r,t._leftId=a,t._rightId=c,t._sideId=h,t.__$anflg3=o
}function Me(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?Ee(t):Ze(t)
}function Ee(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function we(t){var e=n;if("dropdown"===e)return!!s==!1?[{mods:{action:"closed"}}]:Be(t);
...
return{mods:{position:i}}}return Be(t)}return"b-autocomplete-item"===e?!(r&&"foot"===r.type)==!1?!!s==!1?[{mods:{enterable:"no"}}]:xe(t):xe(t):"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:Be(t):Be(t)
}function xe(t){return!!s==!1?[{mods:{pers:t.ctx.pers?"yes":""}}]:Be(t)}function Be(){return void 0}function Ce(t){var e=n;
if("dropdown"===e||"button"===e||"auth"===e||"suggest2-item"===e)return!!s==!1?!0:Ie(t);if("checkbox"===e){if(!!s==!1){var o,a,c=t.ctx.js,h=Object(c).hasOwnProperty("live")?c.live:(o=i,i="live",a=Pe(t),i=o,a);
return{live:h}}return Ie(t)}return"select"===e?!!s==!1?!0:Ie(t):"b-autocomplete-item"===e?!(r&&"nav"===r.type)==!1?!!s==!1?{val:t._url}:De(t):De(t):"input"===e?!!s==!1?Se(t):Ie(t):"tumbler"===e?!!s==!1?!0:Ie(t):"link"===e?!t.ctx.hasOwnProperty("tabindex")==!1?{origTabindex:String(t.ctx.tabindex)}:Ie(t):"suggest2"===e?!!s==!1?!0:Ie(t):Ie(t)
}function De(t){return!!s==!1?!0:!t.ctx.search_cgi==!1?!t._.isArray(t.ctx.search_cgi)==!1?{cgi:t.ctx.search_cgi}:Ie(t):Ie(t)
}function Se(t){var e,n,s=(e=i,i="live",n=Te(t),i=e,n),o=t.ctx.js;if(o){if(o.autoFocus&&o.live)throw new Error('input block can\'t have both "live" and "autoFocus" enabled');
"live"in o&&(s=o.live),o.autoFocus&&(s=!1)}return"gradient"==r.popup?{live:s,popupMods:{gradient:"yes"}}:{live:s}
}function Ie(){return void 0}function Pe(){return!1}function Te(){return!1}function Oe(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Ae(t):Ae(t)
}function Ae(t){return!!s==!1?[]:Ze(t)}function je(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function Le(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function Ne(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Re(t){return"suggest2-item"===n?"highlight"===s?!1:Fe(t):Fe(t)}function Fe(){return void 0}function qe(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,ci(t),void 0):$e(t):$e(t):$e(t)
}function $e(t){return!!t["i-global"]==!1?Ue(t):Ze(t)}function Ue(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=Me(t),i=e,n=o,s=r,a);
t["i-global"]=t._.extend(d,(c=i,i="env",h=n,n="i-global",u=Qe(t),i=c,n=h,u)),ci(t)}function Ve(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:He(t):He(t)
}function He(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",$e(t),t._buf=n,i=o,e.join("")
}return ze(t)}return ze(t)}function ze(t){return!!s==!1?"":Ze(t)}function We(t){return t.ctx.value||"left"!==t.ctx.side
}function Ke(t){var e=s;return"areScriptsAsync"===e||"isPageLoadCounter"===e||"geoanswer"===e||"isCounterHeights"===e||"isGameEnabled"===e||"pid"===e||"lr"===e||"ajaxUrl"===e||"framebuster"===e||"shownResult"===e||"isCounterSerpview"===e||"pg"===e||"cache"===e||"nahodki"===e||"pref-ajax"===e||"tld"===e||"maxAjaxUrlLength"===e||"reqid"===e||"nonce"===e||"query"===e||"serpRequestExtraParams"===e?!0:!s==!1?{id:1,lang:1,tld:1,"content-region":1,"user-region":1,login:1,displayName:1,index:1,yandexuid:1,"passport-host":1,"pass-host":1,"passport-msg":1,"static-host":1,"lego-static-host":1,"social-host":1,clck:1,"click-host":1,"export-host":1,"i-host":1,"social-retpath":1,"lego-path":1,sid:1,retpath:1,uid:1}[s]||!1:Ze(t)
}function Ge(t){var e,o,r,a,c,h=t["i-global"],u={},l={block:"i-global",js:u};for(c in h)h.hasOwnProperty(c)&&(e=i,i="public-params",o=n,n="i-global",r=s,s=c,a=Ke(t),i=e,n=o,s=r,a)&&(u[c]=h[c]);
return l}function Qe(t){return!!s==!1?{}:Ze(t)}function Xe(){return void 0}function Ye(){return void 0
}function Ze(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Je(t):ti(t):ti(t):ti(t)}function Je(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(ci,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function ti(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?ei(t):ii(t):ii(t):ii(t)
}function ei(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}function ii(t){var e=i;if("default"===e)return ni(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?si(t):oi(t)
}return ri(t)}function ni(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,C,D,S,I,T=t.BEM,O=t.ctx,j=t._buf;
if(c=i,i="tag",v=P(t),i=c,I=v,"undefined"!=typeof I||(I=O.tag),"undefined"!=typeof I||(I="div"),I){var L,N;
n&&O.js!==!1&&(h=i,i="js",l=Ce(t),i=h,N=l,N=N?t._.extend(O.js,N===!0?{}:N):O.js===!0?{}:O.js,N&&((L={})[T.INTERNAL.buildClass(n,O.elem)]=N)),j.push("<",I);
var R=(d=i,i="bem",p=Re(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof O.bem?O.bem:O.block||O.elem);
var F=(f=i,i="cls",m=Ye(t),i=f,m);F||(F=O.cls);var q=O.block&&L&&!O.elem;if(R||F){if(j.push(' class="'),R){T.INTERNAL.buildClasses(n,O.elem,O.elemMods||O.mods,j);
var $=(_=i,i="mix",g=we(t),i=_,g);if(O.mix&&($=$?[].concat($,O.mix):O.mix),$){var U={};U[e(n,s)]=!0,t._.isArray($)||($=[$]);
for(var V=0;V<$.length;V++){var H=$[V];if(H){var z=H.block||H.elem,W=H.block||H._block||n,K=H.elem||H._elem||s,G=H.mods||r,Q=H.elemMods||{};
if(z&&j.push(" "),T.INTERNAL[z?"buildClasses":"buildModsClasses"](W,H.elem||H._elem||(H.block?void 0:s),H.elemMods||H.mods,j),H.js&&((L||(L={}))[T.INTERNAL.buildClass(W,H.elem)]=H.js===!0?{}:H.js,q||(q=W&&!H.elem)),z&&!U[e(W,K)]){U[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=we(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&U[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,$.splice(V+1,0,Z))}}}}}}F&&j.push(R?" ":"",F),q&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=Xe(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
}var te=(B=i,i="attrs",C=u(t),i=B,C);if(te=t._.extend(te,O.attrs)){var ee;for(ee in te)void 0!==te[ee]&&j.push(" ",ee,'="',t._.attrEscape(te[ee]),'"')
}}if(t._.isShortTag(I))j.push("/>");else{I&&j.push(">");var ie=(D=i,i="content",S=A(t),i=D,S);if(ie||0===ie){var R=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=R?1:t.position;var oe=t._listLength;t._listLength=R?1:t._listLength;
var re=t.ctx;t.ctx=ie;var ae=i;i="",qe(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}I&&j.push("</",I,">")}}function si(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,qe(t),t.ctx=a}o||(t.position=s)}function oi(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
var m=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,U(t),i=h,t._links=u,n=l,t._currBlock=d,s=p,r=f,o=m
}function ri(){throw new Error(this)}function ai(t){return ci(t||this)}function ci(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(ai);
...
}),t.preventDefault()}}),!1}}),_borschik("5NO2qC3NgtpnDtgIztRjyKKG7NQ")&&BEM.DOM.decl("timing",{onSetMod:{js:function(){this.data={},this.visibilityState={visible:1,hidden:2,prerender:3}[this.getVisibilityState()],this.send()
...
}},{NAV_ITEMS_GAP:10,live:!1}),_borschik("BF89NMZXLSSuMBYHTVEkipCf9Ek")&&BEM.DOM.decl("header",{onSetMod:{js:function(){this.__base.apply(this,arguments);
