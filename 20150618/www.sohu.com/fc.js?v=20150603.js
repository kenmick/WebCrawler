...
function set_logo(c){var a=c.getAttribute('logo');if(/(lt|rt|lb|rb)/.test(a)){var d=document.createElement("a");d.className="kz-logo kz-logo-"+a;d.setAttribute("mo","logo");d.target="_blank";d.href='http://www.kuaizitech.com/';d.innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;";c.appendChild(d);}}
