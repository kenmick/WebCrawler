...
define("js/fo/native/integration/lightbox/integration", [ "require", "exports", "util/str", "util/resource", "lib/jquery", "omnitag/gostructs", "common/base", "style", "variables", "i18n" ], function(e, t, i, n, o, a, r, s, l, c) {
    var d, p, m = o.jQuery, C = "ayl_lightbox_", h = function(e) {
        function t() {
            e.apply(this, arguments), this.isLightboxDisplay = !1;
        }
        return __extends(t, e), t.prototype.insertStyle = function() {
            var e = m('<style type="text/css"></style>'), t = e[0], n = {
                Uid: this.Config.Attempt,
            ...
            }, o = s.Template(l.New(n));
            if (t.styleSheet) t.styleSheet.cssText = o; else {
                var a = document.createTextNode(o);
                t.appendChild(a);
            }
            return m(t).prependTo(m("head")), t;
        }, t.prototype.insertTemplate = function() {
            var e = this, t = document.createElement("div");
            t.className = C + "container", d = C + i.EscapeHTML(this.Config.Attempt);
            var o = document.createElement("div");
            o.className = C + "legal", o.innerHTML = i.EscapeHTML(this.Config.Legal);
            var r = document.createElement("div");
            r.className = C + "header";
            var s = document.createElement("h3");
            s.className = C + "title", s.innerHTML = i.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.TITLE)), 
            r.appendChild(s);
            var l = document.createElement("div");
            l.className = C + "middle";
            var p = document.createElement("div");
            p.className = C + "left";
            var m = document.createElement("img");
            m.className = C + "thumbnail", m.src = n.GetUrlDynamicImage(this.Config, this.Config.Content.Preview.Thumbnail.Image, 871, 570), 
            p.appendChild(m);
            var h = document.createElement("div");
            h.className = C + "right";
            var g = document.createElement("div");
            g.className = C + "description";
            ...
            if (f.className = C + "sponsor", this.Config.HasCredit && this.Config.Content.Preview.Credit) {
                var u = document.createElement("img");
                u.className = C + "sponsor_credit", u.src = n.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Credit.Logo.Resource), 
                u.onclick = function() {
            ...
            if (this.Config.Content.Preview.Sponsor) {
                ...
                if (f.appendChild(T), this.Config.HasSponsorImage && this.Config.Content.Preview.Sponsor.Logo) {
                    ...
                    E.className = C + "sponsor_logo", E.alt = i.EscapeHTML(this.Config.Content.Preview.Sponsor.Name), 
                    f.appendChild(E);
                } else {
                    var y = document.createTextNode(" " + i.EscapeHTML(this.Config.Content.Preview.Sponsor.Name));
                    f.appendChild(y);
                }
            } else {
                var L = document.createTextNode(i.EscapeHTML(this.Config.Content.Preview.Text.Get(a.PreviewTranslationKind.SPONSOR)));
                f.appendChild(L);
            }
            h.appendChild(f), l.appendChild(p), l.appendChild(h);
            var x = document.createElement("div");
            x.className = C + "footer";
            var N = document.createElement("div");
            N.className = C + "calltoaction", N.onclick = function() {
                e.action();
            };
            var P = document.createTextNode(i.EscapeHTML(c.T(this.Config.Lang, c.LightboxTranslationKind.LightboxTranslationValidate)));
            N.appendChild(P), x.appendChild(N), t.appendChild(r), t.appendChild(l), t.appendChild(x);
            var w = document.createElement("div");
            w.className = C + "box", w.appendChild(t);
            var S = document.createElement("div");
            return S.id = C + i.EscapeHTML(this.Config.Attempt), S.appendChild(w), document.body.appendChild(S), 
            S;
            ...
            this.isLightboxDisplay && p.removeClass("ayl_hide"), e.prototype.AfterCarrierEnding.call(this);
        }, t.prototype.action = function() {
            this.UITrigger(a.NativeUITriggerKind.CLICK);
        }, t.prototype.Execute = function() {
            var e = this.insertStyle(), t = this.insertTemplate();
            p = m("#" + d), this.mainContentElement = t, this.injectedNodes = [ t, e ], this.AfterExecute();
        }, t;
    }(r.Integration);
    t.Lightbox = h;
});
