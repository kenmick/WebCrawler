...
define("js/fo/util/trigger", [ "require", "exports", "util/str", "util/time", "util/context", "omnitag/gostructs" ], function(e, t, n, r, o, a) {
    function i(e, t, r, o) {
        function i() {
            s(p, u, t.Trusted, t.Disabled, o), h && clearTimeout(h);
        }
        o || (o = document.body);
        var d = e.toString() + "-" + n.EscapeHTML(t.Attempt);
        r && (d += "-" + n.EscapeHTML(r));
        var u = !l[d];
        l[d] = !0;
        var p;
        p = t.OnEvents ? t.OnEvents.Get(e, []).slice(0) : [];
        var h;
        if (u) {
            var v = n.Untaint(t.ApiPrefix) + "/pixel?event_kind=" + e.toString() + "&attempt=" + n.EscapeHTML(t.Attempt);
            r && (v += "&campaign=" + n.EscapeHTML(r)), h = setTimeout(i, 2500), c("img", v, o, i);
        } else switch (e) {
          case a.EventKind.PLAYLIST_CLICK:
            var v = n.Untaint(t.ApiPrefix) + "/pixel?event_kind=" + e.toString() + "&attempt=" + n.EscapeHTML(t.Attempt);
            r && (v += "&campaign=" + n.EscapeHTML(r)), c("img", v, o, i);
            break;
    ...
    function s(e, t, r, o, i) {
        if (e && 0 != e.length) {
            for (var s = [], c = [], l = [], u = [], p = [], h = [], v = 0; v < e.length; v++) {
                var E = e[v];
                if (E && (t || !E.OncePerAttempt)) {
                    switch (E.Guard) {
                      case a.OnEventGuardKind.ALWAYS:
                        break;

                      case a.OnEventGuardKind.HAVE_CAMPAIGN:
                        if (o) continue;
                        break;

                      case a.OnEventGuardKind.NO_CAMPAIGN:
                        if (!o) continue;
                        break;
                    ...
                    switch (E.Kind) {
                      case a.OnEventKind.PIXEL_URL:
                        var f = n.SubstituteTokens(E.Url);
                        E.Isolated ? s.push(f) : c.push(f);
                        break;

                      case a.OnEventKind.JAVASCRIPT_URL:
                        var f = n.SubstituteTokens(E.Url);
                        E.Isolated ? l.push(f) : u.push(f);
                        break;

                      case a.OnEventKind.JAVASCRIPT_CODE:
            ...
            d(a.OnEventKind.PIXEL_URL, s, !0, r, i), d(a.OnEventKind.PIXEL_URL, c, !1, r, i), 
            d(a.OnEventKind.JAVASCRIPT_URL, l, !0, r, i), d(a.OnEventKind.JAVASCRIPT_URL, u, !1, r, i), 
            d(a.OnEventKind.JAVASCRIPT_CODE, p, !0, r, i), d(a.OnEventKind.JAVASCRIPT_CODE, h, !1, r, i);
        }
    }
    function d(e, t, i, s, d) {
        if (0 !== t.length) {
            t = t.slice(0);
            for (var l = 0; l < t.length; l++) t[l] = n.Untaint(t[l]);
            var u = [];
            if (i) {
                ...
                switch (e) {
                  case a.OnEventKind.PIXEL_URL:
                    for (var l = 0; l < t.length; l++) t[l] = n.EncodeURIComponent(t[l]);
                    h = {
                        type: "pxurl",
                        urls: t.join(",")
                    };
                ...
                h.rnd = Math.random().toString().substring(2), p.src = o.Omnitag.SandboxPrefix + "/sb.html#" + n.EncodeURIParams(h), 
                document.body.appendChild(p), u.push(p);
            } else switch (e) {
              case a.OnEventKind.PIXEL_URL:
                for (var l = 0; l < t.length; l++) u.push(c("img", t[l], d));
                break;

              case a.OnEventKind.JAVASCRIPT_URL:
                if (!s) throw new Error("Cannot execute untrusted javascript code in publisher website context");
                for (var l = 0; l < t.length; l++) c("script", t[l], d);
                break;

              case a.OnEventKind.JAVASCRIPT_CODE:
                if (!s) throw new Error("Cannot execute untrusted javascript code in publisher website context");
                for (var l = 0; l < t.length; l++) {
                    var v = new Function(t[l]);
                    setTimeout(v, 1);
                }
                break;
            ...
            if (u.length > 0) {
                var E = new r.Timer({
                    callback: function() {
                        for (var e = 0; e < u.length; e++) u[e].parentNode && u[e].parentNode.removeChild(u[e]);
                    },
                    delay: 1e4
                });
                E.Start();
    ...
    function c(e, t, n, r) {
        ...
        switch (e) {
          case "script":
            ...
            a.async = !0, a.charset = "UTF-8", a.src = t, o = a;
            break;
        ...
        o.onload = o.onreadystatechange = function(t, n) {
            (n || !o.readyState || /loaded|complete/.test(o.readyState)) && (o.onload = o.onreadystatechange = null, 
            o.parentNode && "img" == e && o.parentNode.removeChild(o), o = null, r && r());
        };
        var s = function() {
            document.body ? parent !== window ? document.body.appendChild(o) : n === document.body ? document.body.insertBefore(o, document.body.firstChild) : n.appendChild(o) : setTimeout(s, 200);
        };
        return s(), o;
    }
    var l = {};
...
define("js/fo/util/slideshow", [ "require", "exports", "util/resource" ], function(e, t, s) {
    function i(e, t, i, n) {
        var a, r, o, l = "ayl_slideshow_", y = 1e3 * e.Content.Preview.SlideDelay, g = s.GetUrlDynamicImage(e, e.Content.Preview.Thumbnail.Image, 9999999999, 9999999999), m = g.split("9999999999")[0], u = t.querySelector("img[src^='" + m + "'], [style*='" + m + "']"), d = document.createElement("img");
        if (r = "undefined" == typeof i ? parseInt(u.getAttribute("width"), 10) : i, o = "undefined" == typeof n ? parseInt(u.getAttribute("height"), 10) : n, 
        e.Content.Preview.Branding) {
            for (var c = e.Content.Preview.Branding.Images, w = new Array(), p = 0; p < c.length; p++) w[p] = new Image(), 
            w[p].src = s.GetUrlDynamicImage(e, e.Content.Preview.Branding.Images[p], r, o, !1, !0);
            var h = new Image();
            h.src = s.GetUrlDynamicImage(e, e.Content.Preview.Thumbnail.Image, r, o), w.unshift(h), 
            u.style.setProperty("-webkit-transition", "all 1s ease-in-out"), u.style.setProperty("-moz-transition", "all 1s ease-in-out"), 
            u.style.setProperty("-o-transition", "all 1s ease-in-out"), u.style.setProperty("transition", "all 1s ease-in-out"), 
            d = u.cloneNode(!0), d.style.cssText = u.style.cssText, d.style.position = "absolute", 
            d.style.top = "0", d.style.left = "0", 0 != parseInt(window.getComputedStyle(u).getPropertyValue("height")) && (d.style.height = window.getComputedStyle(u).getPropertyValue("height")), 
            0 != parseInt(window.getComputedStyle(u).getPropertyValue("width")) && (d.style.width = window.getComputedStyle(u).getPropertyValue("width")), 
            d.className = l + "image_swap", "img" == u.tagName.toLowerCase() && (a = u, a.insertAdjacentHTML("afterend", d.outerHTML), 
            d = document.getElementsByClassName(l + "image_swap")[0]);
            var f = 0, I = !0, P = function() {
                "div" == u.tagName.toLowerCase() ? u.style.backgroundImage = "url(" + w[f].src + ")" : I ? (a.style.opacity = "1", 
                d.style.opacity = "0", I = !1, a.src = w[f].src) : (d.style.opacity = "1", a.style.opacity = "0", 
                I = !0, d.src = w[f].src), f < w.length - 1 ? f++ : f = 0, setTimeout(P, y);
            };
            P();
        }
    }
