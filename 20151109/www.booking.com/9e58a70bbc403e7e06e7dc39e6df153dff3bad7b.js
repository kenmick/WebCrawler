...
G.unshift({b_genius_iconfont:d[17],b_type:d[129]});
L();
G.shift();
H+=d[5]
}H+=d[1]
...
G.unshift({b_type:d[6],b_genius_iconfont:d[17]});
O();
G.shift();
H+=d[62]
}function O(){H+=d[2];
...
G.unshift({b_size:d[3],b_tooltip:d[4],b_color:d[20],b_classname:d[21]});
K();
G.shift();
...
G.unshift({b_ge_freebies:d[39],b_tooltip:d[4],b_ge_discount:d[39],b_classname:d[130]});
o();
G.shift();
