...
define("js/fo/util/modifier", [ "require", "exports", "omnitag/gostructs", "util/str", "merger", "util/context", "lib/jquery" ], function(e, t, n, a, r, i, o) {
    ...
    function c(e, t, n, r, o) {
        var s, c = function() {
            ...
            var n = e + "__";
            "string" == typeof t.data && t.data.substring(0, n.length) == n ? (c = function() {}, 
            window.detachEvent ? window.detachEvent("onmessage", u) : window.removeEventListener("message", u), 
            clearTimeout(s), t.data.indexOf("error") > -1 ? o() : r(t.data.substring(n.length)), 
            f.removeEventListener("readystatechange", l), f.removeEventListener("load", l), 
            d(f)) : o();
        };
        window.attachEvent ? window.attachEvent("onmessage", u) : window.addEventListener("message", u);
        var l = function(e) {
            (!f.readyState || /loaded|complete/.test(f.readyState)) && (s = setTimeout(c, 500));
        }, f = document.createElement("iframe");
        f.style.position = "absolute", f.style.left = "-9999px", f.style.width = "1px", 
        f.style.height = "1px", f.style.display = "block";
        var g;
        g = {
            url: n,
            uid: e
        }, f.src = i.Omnitag.StaticPrefix + "/if-vast.html#" + a.EncodeURIParams(g), f.addEventListener("readystatechange", l), 
        f.addEventListener("load", l), document.body.appendChild(f);
    }
    ...
    function m(e, t) {
        if (t.ClickTracker && e.ClickTracker && (e.ClickTracker = a.Taint(a.Untaint(t.ClickTracker) + a.EncodeURIComponent(e.ClickTracker))), 
        t.PerformUITriggers && e.PerformUITriggers) for (var n = 0; n < e.PerformUITriggers.length; n++) {
            for (var i = !1, o = e.PerformUITriggers[n], s = 0; s < t.PerformUITriggers.length; s++) {
                var d = t.PerformUITriggers[n];
                d == o && (i = !0);
            }
            i || e.PerformUITriggers.splice(n, 1);
        }
        r.DeepMerge(e, t);
    }
    var v = o.jQuery;
    t.Call = s, t.MergeModifierConfig = m;
});
//
            ...
            for (var e = this, r = 0; r < this.config.PerformUITriggers.length; r++) {
                ...
                switch (i) {
                  ...
                  case t.NativeUITriggerKind.MOUSE_OVER:
                    var s = n.EscapeHTML(this.config.Attempt), u = h(this.currentIntegration.GetMainContentElement()), m = new g.Countdown(u, s, 299, .4, !0, function() {
