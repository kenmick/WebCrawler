...
function wb(a,b){var c=t("yt.logging.errors.log");c?c(a,b):(c=D("ERRORS",[]),c.push([a,b]),ub("ERRORS",c))}
...
x(ef,B);var gf=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];m=ef.prototype;m.qa=function(a,b){this.isDisposed()||(hf(this,a),b||jf(this),kf(this,b),this.D&&lf(this))};
function hf(a,b){a.ma=b;a.f=b.clone();a.h=a.f.attrs.id||a.h;"video-player"==a.h&&(a.h=a.T,a.f.attrs.id=a.T);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h);a.f.args.enablejsapi="1";a.f.args.playerapiid=a.T;a.da||(a.da=mf(a,a.f.args.jsapicallback||"onYouTubePlayerReady"));a.f.args.jsapicallback=null;var c=a.f.attrs.width;c&&(a.m.style.width=Fd(Number(c)||c,!0));if(c=a.f.attrs.height)a.m.style.height=Fd(Number(c)||c,!0)}
m.bb=function(){return this.ma};
function lf(a){a.f.loaded||(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function nf(a){if(!q(a.f.disable.flash)){var b=a.f.disable,c;c=Xd(Wd.getInstance(),a.f.minVersion);b.flash=!c}return!a.f.disable.flash}
function jf(a){var b;if(!(b=!a.f.html5&&nf(a))){if(!q(a.f.disable.html5)){var c;b=!0;void 0!=a.f.args.deviceHasDisplay&&(b=a.f.args.deviceHasDisplay);if(2.2==je)c=!0;else{a:{var d=b;b=t("yt.player.utils.videoElement_");b||(b=document.createElement("video"),r("yt.player.utils.videoElement_",b,void 0));try{if(b.canPlayType)for(var d=d?re:se,e=0;e<d.length;e++)if(b.canPlayType(d[e])){c=null;break a}c="fmt.noneavailable"}catch(f){c="html5.missingapi"}}c=!c}c&&(c=of(a)||a.f.assets.js);a.f.disable.html5=
!c;c||(a.f.args.html5_unavailable="1")}b=!!a.f.disable.html5}return b?nf(a)?"flash":"unsupported":"html5"}
function pf(a,b){if((!b||(5!=(df[b.errorCode]||5)?0:-1!=gf.indexOf(b.errorCode)))&&nf(a)){var c=qf(a);c&&c.stopVideo&&c.stopVideo();var d=a.f;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=zd(c));d.args.autoplay=1;d.args.html5_unavailable="1";hf(a,d);kf(a,"flash")}}
function kf(a,b){a.isDisposed()||(b||(b=jf(a)),("flash"==b?a.vb:"html5"==b?a.wb:a.xb).call(a))}
function of(a){var b=!0,c=qf(a);c&&a.f&&(a=a.f,b=A(c,"version")==a.assets.js);return b&&!!t("yt.player.Application.create")}
m.wb=function(){if(!this.Z){var a=of(this);a&&"html5"==rf(this)?(this.B="html5",this.D||this.N()):(sf(this),this.B="html5",a&&this.P?(this.l.appendChild(this.P),this.N()):(this.f.loaded=!0,this.R=w(function(){var a=this.l,c=this.f.clone();t("yt.player.Application.create")(a,c);this.N()},this),this.Z=!0,a?this.R():(Lb(this.f.assets.js,this.R),ee(this.f.assets.css))))}};
m.vb=function(){var a=this.f.clone();if(!this.C){var b=qf(this);b&&(this.C=document.createElement("span"),this.C.tabIndex=0,ue(this.$,this.C,"focus",this.Ea),this.K=document.createElement("span"),this.K.tabIndex=0,ue(this.$,this.K,"focus",this.Ea),b.parentNode&&b.parentNode.insertBefore(this.C,b),b.parentNode&&b.parentNode.insertBefore(this.K,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==rf(this))this.B="flash",this.D||ae(a,!1,w(this.N,this));
else{sf(this);this.B="flash";this.f.loaded=!0;b=this.l;b=v(b)?yc(b):b;a=zd(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=Wd.getInstance();Xd(c,a.minVersion)?(c=be(a,c),$d(b,c,a)):de(b,a,c);this.N()}};
m.Ea=function(){qf(this).focus()};
function qf(a){var b=H(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
m.N=function(){if(!this.isDisposed()){var a=qf(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.Z=!1,a.isNotServable&&a.isNotServable(this.f.args.video_id))pf(this);else{ff(this);this.D=!0;a=qf(this);a.addEventListener&&(this.S=tf(this,a,"addEventListener"));a.removeEventListener&&(this.ca=tf(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.api[d]||(this.api[d]=tf(this,a,
d))}for(var e in this.j)this.S(e,this.j[e]);lf(this);this.da&&this.da(this.api);this.U.O("onReady",this.api)}else this.va=E(w(this.N,this),50)}};
function tf(a,b,c){var d=b[c];return function(){try{return a.ka=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.ka=e,wb(e,"WARNING"))}}}
...
m.A=function(a,b){if(!this.isDisposed()){var c=mf(this,b);if(c){if(!wa(this.Wa,a)&&!this.j[a]){var d=uf(this,a);this.S&&this.S(a,d)}this.U.subscribe(a,c);"onReady"==a&&this.D&&E(ma(c,this.api),0)}}};
m.ub=function(a,b){if(!this.isDisposed()){var c=mf(this,b);c&&this.U.unsubscribe(a,c)}};
function mf(a,b){var c=b;if("string"==typeof b){if(a.ea[b])return a.ea[b];c=function(){var a=t(b);a&&a.apply(n,arguments)};
a.ea[b]=c}return c?c:null}
function uf(a,b){var c="ytPlayer"+b+a.T;a.j[b]=c;n[c]=function(c){var e=E(function(){if(!a.isDisposed()){a.U.O(b,c);var f=a.aa,g=String(e);g in f&&delete f[g]}},0);
Ha(a.aa,String(e))};
return c}
...
O,void 0)):af(b);N(Ke,new Je(ya.aft+(k||0)))}}a.cancel();ff(a);a.B=null;a.f&&(a.f.loaded=!1);O=qf(a);"html5"==rf(a)?a.P=O:O&&O.destroy&&O.destroy();Ec(a.l);ve(a.$);a.C=null;a.K=null}
m.cancel=function(){if(this.R){var a=this.R;this.f.assets.js&&a&&(a=""+ga(a),(a=Rb[a])&&Hb(a))}window.clearTimeout(this.va);this.Z=!1};
m.G=function(){sf(this);if(this.P&&this.f)try{this.P.destroy()}catch(b){wb(b)}this.ea=null;for(var a in this.j)n[this.j[a]]=null;this.ma=this.f=this.api=null;delete this.l;delete this.m;ef.X.G.call(this)};var vf={},wf="player_uid_"+(1E9*Math.random()>>>0);function xf(a,b){a=v(a)?yc(a):a;b=zd(b);var c=wf+"_"+ga(a),d=vf[c];if(d)return d.qa(b),d.api;d=new ef(a,c);vf[c]=d;Ib("player-added",d.api);pb(d,ma(yf,d));E(function(){d.qa(b)},0);
return d.api}
function yf(a){vf[a.T]=null}
function zf(a){a=H(a);if(!a)return null;var b=wf+"_"+ga(a),c=vf[b];c||(c=new ef(a,b),vf[b]=c);return c.api}
;var Af=t("yt.abuse.botguardInitialized")||Tb;r("yt.abuse.botguardInitialized",Af,void 0);var Bf=t("yt.abuse.invokeBotguard")||Ub;r("yt.abuse.invokeBotguard",Bf,void 0);var Cf=t("yt.abuse.dclkstatus.checkDclkStatus")||Wb;r("yt.abuse.dclkstatus.checkDclkStatus",Cf,void 0);var Df=t("yt.player.exports.navigate")||ud;r("yt.player.exports.navigate",Df,void 0);var Ef=t("yt.player.embed")||xf;r("yt.player.embed",Ef,void 0);var Ff=t("yt.player.getPlayerByElement")||zf;r("yt.player.getPlayerByElement",Ff,void 0);
var Gf=t("yt.util.activity.init")||Zc;r("yt.util.activity.init",Gf,void 0);var Hf=t("yt.util.activity.getTimeSinceActive")||ad;r("yt.util.activity.getTimeSinceActive",Hf,void 0);var If=t("yt.util.activity.setTimestamp")||$c;r("yt.util.activity.setTimestamp",If,void 0);var R={},Jf="ontouchstart"in document;function Kf(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return Oc(c,function(a){return Yb(a,b)},!0,d)}
function S(a){var b="mouseover"==a.type&&"mouseenter"in R||"mouseout"==a.type&&"mouseleave"in R,c=a.type in R||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=R[b],d;for(d in c.o){var e=Kf(b,d,a.target);e&&!Oc(a.relatedTarget,function(a){return a==e},!0)&&c.O(d,e,b,a)}}if(b=R[a.type])for(d in b.o)(e=Kf(a.type,d,a.target))&&b.O(d,e,a.type,a)}}
I(document,"blur",S,!0);I(document,"change",S,!0);I(document,"click",S);I(document,"focus",S,!0);I(document,"mouseover",S);I(document,"mouseout",S);I(document,"mousedown",S);I(document,"keydown",S);I(document,"keyup",S);I(document,"keypress",S);I(document,"cut",S);I(document,"paste",S);Jf&&(I(document,"touchstart",S),I(document,"touchend",S),I(document,"touchcancel",S));function Lf(a){this.m=a;this.j={};this.ga=[];this.l=[]}
function T(a,b){return"yt-uix"+(a.m?"-"+a.m:"")+(b?"-"+b:"")}
Lf.prototype.unregister=function(){Hb(this.ga);this.ga.length=0;Ie(this.l);this.l.length=0};
Lf.prototype.init=aa;Lf.prototype.dispose=aa;function Mf(a,b,c){a.l.push(P(b,c,a))}
...
function Nf(a,b){Xa(a,"tooltip-text",b)}
;function Of(){Lf.call(this,"sessionlink")}
x(Of,Lf);ba(Of);Of.prototype.register=function(){U(this,"mousedown",this.f);U(this,"click",this.f)};
Of.prototype.unregister=function(){V(this,"mousedown",this.f);V(this,"click",this.f)};
Of.prototype.f=function(a){var b;if(b=A(a,"sessionlink-target")||a.href||""){var c;c=A(a,"sessionlink")||"";c=od(c);(a=parseInt(A(a,"sessionlink-lifetime")||"",10))?rd(b,c,a):rd(b,c)}};function Pf(a){L.call(this,1,arguments);this.f=a}
x(Pf,L);function W(a){L.call(this,1,arguments);this.f=a}
x(W,L);function Qf(a,b){L.call(this,1,arguments);this.f=a;this.h=b}
x(Qf,L);function Rf(a,b,c,d,e){L.call(this,2,arguments);this.h=a;this.f=b;this.l=c||null;this.j=d||null;this.m=e||null}
x(Rf,L);function Sf(a,b,c){L.call(this,1,arguments);this.f=a;this.h=b}
x(Sf,L);function Tf(a,b,c,d,e,f,g){L.call(this,1,arguments);this.h=a;this.B=b;this.f=c;this.C=d||null;this.l=e||null;this.j=f||null;this.m=g||null}
x(Tf,L);
var Uf=new M("subscription-batch-subscribe",Pf),Vf=new M("subscription-batch-unsubscribe",Pf),Wf=new M("subscription-pref-email",Qf),Xf=new M("subscription-subscribe",Rf),Yf=new M("subscription-subscribe-loading",W),Zf=new M("subscription-subscribe-loaded",W),$f=new M("subscription-subscribe-success",Sf),ag=new M("subscription-subscribe-external",Rf),bg=new M("subscription-unsubscribe",Tf),cg=new M("subscription-unsubscirbe-loading",W),dg=new M("subscription-unsubscribe-loaded",W),eg=new M("subscription-unsubscribe-success",W),
fg=new M("subscription-external-unsubscribe",Tf),gg=new M("subscription-enable-ypc",W),hg=new M("subscription-disable-ypc",W);function ig(a){var b=document.location.protocol+"//"+document.domain+"/post_login",b=id(b,"mode","subscribe"),b=id("/signin?context=popup","next",b),b=id(b,"feature","sub_button");if(b=window.open(b,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var c=Fb("LOGGED_IN",function(b){Hb(D("LOGGED_IN_PUBSUB_KEY",void 0));ub("LOGGED_IN",!0);a(b)});
ub("LOGGED_IN_PUBSUB_KEY",c);b.moveTo((screen.width-375)/2,(screen.height-440)/2)}}
r("yt.pubsub.publish",Ib,void 0);function jg(a){return eval("("+a+")")}
;var kg=null;"undefined"!=typeof XMLHttpRequest?kg=function(){return new XMLHttpRequest}:"undefined"!=typeof ActiveXObject&&(kg=function(){return new ActiveXObject("Microsoft.XMLHTTP")});function lg(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&vb(b)(k)}
var k=kg&&kg();if(!("open"in k))return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;c=(c||"GET").toUpperCase();d=d||"";k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);f="POST"==c;if(e=mg(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(f=!1);f&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);return k}
function mg(a,b){b=b||{};var c;c||(c=window.location.href);var d=J(1,a),e=cd(J(3,a));d&&e?(d=c,c=a.match(bd),d=d.match(bd),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?cd(J(3,c))==e&&(Number(J(4,c))||null)==(Number(J(4,a))||null):!0;for(var f in ng){if((e=d=D(ng[f]))&&!(e=c)){var e=f,g=D("CORS_HEADER_WHITELIST")||{},h=cd(J(3,a));e=h?(g=g[h])?wa(g,e):!1:!0}e&&(b[f]=d)}return b}
function og(a,b){var c=D("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.Fb&&(!cd(J(3,a))||b.withCredentials||cd(J(3,a))==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.I&&b.I[c])}
function pg(a,b){var c=b.format||"JSON";b.Gb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=D("XSRF_FIELD_NAME",void 0),e=D("XSRF_TOKEN",void 0),f=b.La;f&&(f[d]&&delete f[d],a=pd(a,f||{}));var g=b.Hb||"",f=b.I;og(a,b)&&(f||(f={}),f[d]=e);f&&v(g)&&(d=od(g),Ka(d,f),g=hd(d));var h=!1,k,l=lg(a,function(a){if(!h){h=!0;k&&window.clearTimeout(k);var d;a:switch(a&&"status"in a?a.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:d=
!0;break a;default:d=!1}var e=null;if(d||400<=a.status&&500>a.status)e=qg(c,a,b.Eb);if(d)a:{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||n;d?b.V&&b.V.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.oa&&b.oa.call(f,a,e)}},b.method,g,b.headers,b.responseType,b.withCredentials);
b.qb&&0<b.timeout&&(k=E(function(){h||(h=!0,l.abort(),window.clearTimeout(k),b.qb.call(b.context||n,l))},b.timeout))}
function qg(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=jg(a));break;case "XML":if(b=(b=b.responseXML)?rg(b):null)d={},y(b.getElementsByTagName("*"),function(a){d[a.tagName]=sg(a)})}c&&tg(d);
return d}
function tg(a){if(fa(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d;d=Va(a[b],null);a[c]=d}else tg(a[b])}}
function rg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function sg(a){var b="";y(a.childNodes,function(a){b+=a.nodeValue});
return b}
var ng={"X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};function ug(){Lf.call(this,"tooltip");this.f=0;this.h={}}
x(ug,Lf);ba(ug);m=ug.prototype;m.register=function(){U(this,"mouseover",this.fa);U(this,"mouseout",this.H);U(this,"focus",this.Aa);U(this,"blur",this.xa);U(this,"click",this.H);U(this,"touchstart",this.Ka);U(this,"touchend",this.ha);U(this,"touchcancel",this.ha)};
m.unregister=function(){V(this,"mouseover",this.fa);V(this,"mouseout",this.H);V(this,"focus",this.Aa);V(this,"blur",this.xa);V(this,"click",this.H);V(this,"touchstart",this.Ka);V(this,"touchend",this.ha);V(this,"touchcancel",this.ha);this.dispose();ug.X.unregister.call(this)};
m.dispose=function(){for(var a in this.h)this.H(this.h[a]);this.h={}};
m.fa=function(a){if(!(this.f&&1E3>na()-this.f)){var b=parseInt(A(a,"tooltip-hide-timer"),10);b&&(Za(a,"tooltip-hide-timer"),window.clearTimeout(b));var b=w(function(){vg(this,a);Za(a,"tooltip-show-timer")},this),c=parseInt(A(a,"tooltip-show-delay"),10)||0,b=E(b,c);
Xa(a,"tooltip-show-timer",b.toString());a.title&&(Nf(a,wg(a)),a.title="");b=ga(a).toString();this.h[b]=a}};
m.H=function(a){var b=parseInt(A(a,"tooltip-show-timer"),10);b&&(window.clearTimeout(b),Za(a,"tooltip-show-timer"));b=w(function(){if(a){var b=H(xg(this,a));b&&(yg(b),b&&b.parentNode&&b.parentNode.removeChild(b),Za(a,"content-id"));(b=H(xg(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Za(a,"tooltip-hide-timer")},this);
...
m.Ka=function(a,b,c){c.changedTouches&&(this.f=0,a=Kf(b,T(this),c.changedTouches[0].target),this.fa(a))};
m.ha=function(a,b,c){c.changedTouches&&(this.f=na(),a=Kf(b,T(this),c.changedTouches[0].target),this.H(a))};
function zg(a,b){Nf(a,b);var c=A(a,"content-id");(c=H(c))&&Hc(c,b)}
function wg(a){return A(a,"tooltip-text")||a.title}
function vg(a,b){if(b){var c=wg(b);if(c){var d=H(xg(a,b));if(!d){d=document.createElement("div");d.id=xg(a,b);d.className=T(a,"tip");var e=document.createElement("div");e.className=T(a,"tip-body");var f=document.createElement("div");f.className=T(a,"tip-arrow");var g=document.createElement("div");g.setAttribute("aria-hidden","true");g.className=T(a,"tip-content");var h=Ag(a,b),k=xg(a,b,"content");g.id=k;Xa(b,"content-id",k);e.appendChild(g);h&&d.appendChild(h);d.appendChild(e);d.appendChild(f);var k=
Kc(b),l=xg(a,b,"arialabel"),f=document.createElement("div");Zb(f,T(a,"arialabel"));f.id=l;"rtl"==document.body.getAttribute("dir")?Hc(f,c+" "+k):Hc(f,k+" "+c);b.setAttribute("aria-labelledby",l);k=Sc()||document.body;k.appendChild(f);k.appendChild(d);zg(b,c);(c=parseInt(A(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",Zb(g,T(a,"normal-wrap")));g=Yb(b,T(a,"reverse"));Bg(a,b,d,e,h,g)||Bg(a,b,d,e,h,!g);var p=T(a,"tip-visible");E(function(){Zb(d,p)},0)}}}}
...
function xg(a,b,c){a=T(a);var d=b.__yt_uid_key;d||(d=Qc(),b.__yt_uid_key=d);b=a+d;c&&(b+="-"+c);return b}
function Ag(a,b){var c=null;jc&&Yb(b,T(a,"masked"))&&((c=H("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),Ud(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=T(a,"tip-mask")));return c}
function yg(a){var b=H("yt-uix-tooltip-shared-mask"),c=b&&Oc(b,function(b){return b==a},!1,2);
b&&c&&(b.parentNode.removeChild(b),Vd(b),document.body.appendChild(b))}
;function Cg(){Lf.call(this,"subscription-button")}
x(Cg,Lf);ba(Cg);Cg.prototype.register=function(){U(this,"click",this.ra);Mf(this,Yf,this.Ga);Mf(this,Zf,this.Fa);Mf(this,$f,this.pb);Mf(this,cg,this.Ga);Mf(this,dg,this.Fa);Mf(this,eg,this.sb);Mf(this,gg,this.ib);Mf(this,hg,this.gb)};
Cg.prototype.unregister=function(){V(this,"click",this.ra);Cg.X.unregister.call(this)};
var Nc={sa:"hover-enabled",Oa:"yt-uix-button-subscribe",Pa:"yt-uix-button-subscribed",yb:"ypc-enabled",Qa:"yt-uix-button-subscription-container",Ra:"yt-subscription-button-disabled-mask-container"},Dg={zb:"channel-external-id",Sa:"subscriber-count-show-when-subscribed",Ta:"subscriber-count-tooltip",Ua:"subscriber-count-title",Ab:"href",ta:"is-subscribed",Bb:"parent-url",Cb:"clicktracking",Va:"style-type",ua:"subscription-id",Db:"target",Xa:"ypc-enabled"};m=Cg.prototype;
m.ra=function(a){var b=A(a,"href"),c;c=(c=D("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!D("SESSION_INDEX")&&!D("LOGGED_IN"));if(b)a=A(a,"target")||"_self",window.open(b,a);else if(c){b=A(a,"channel-external-id");c=A(a,"clicktracking");var d;if(A(a,"ypc-enabled")){d=A(a,"ypc-item-type");var e=A(a,"ypc-item-id");d={itemType:d,itemId:e,subscriptionElement:a}}else d=null;e=A(a,"parent-url");if(A(a,"is-subscribed")){var f=A(a,"subscription-id");N(bg,new Tf(b,f,d,a,c,e))}else N(Xf,new Rf(b,
d,c,e))}else Eg(this,a)};
...
m.Ja=function(a,b,c){b?(Xa(a,Dg.ta,"true"),c&&Xa(a,Dg.ua,c)):(Za(a,Dg.ta),Za(a,Dg.ua));Fg(a)};
m.Ia=function(a,b){var c;c=Mc(a);cc(c,Nc.Ra,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function Fg(a){var b=A(a,Dg.Va),c=!!A(a,"is-subscribed"),b="-"+b,d=Nc.Pa+b;cc(a,Nc.Oa+b,!c);cc(a,d,c);A(a,Dg.Ta)&&!A(a,Dg.Sa)&&(b=T(ug.getInstance()),cc(a,b,!c),a.title=c?"":A(a,Dg.Ua));c?E(function(){Zb(a,Nc.sa)},1E3):$b(a,Nc.sa)}
m.ab=function(a){var b=!!A(a,"ypc-item-type"),c=!!A(a,"ypc-item-id");!A(a,"ypc-enabled")&&b&&c&&(Zb(a,"ypc-enabled"),Xa(a,Dg.Xa,"true"))};
m.$a=function(a){A(a,"ypc-enabled")&&($b(a,"ypc-enabled"),Za(a,"ypc-enabled"))};
function Gg(a,b){var c=zc(T(a));return ta(c,function(a){return b==A(a,"channel-external-id")},a)}
m.Ya=function(a,b,c){var d=Da(arguments,2);y(a,function(a){b.apply(this,xa(a,d))},this)};
m.M=function(a,b,c){var d=Gg(this,a),d=xa([d],Da(arguments,1));this.Ya.apply(this,d)};
function Eg(a,b){var c=w(function(a){a.discoverable_subscriptions&&ub("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.ra(b)},a);
ig(c)}
;var Hg=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};r("yt.uix.widgets_",Hg,void 0);function Ig(a){a=a.getInstance();var b=T(a);b in Hg||(a.register(),a.ga.push(Fb("yt-uix-init-"+b,a.init,a)),a.ga.push(Fb("yt-uix-dispose-"+b,a.dispose,a)),Hg[b]=a)}
;var Jg="",Kg="",Lg="",Mg="",Ng="",Og="",Pg="",Qg="",Rg="",Sg="",Tg="",Ug="",Vg="",Wg="",Xg="",Yg="",Zg="",$g="",ah="",bh="",bc=null,ch=[],X=0,Y=0,Z=null;
function dh(){window.addEventListener("message",function(a){a.data&&(a=JSON.parse(a.data),a["video-masthead-autoplay-zeroth-quartile"]?Jg=a["video-masthead-autoplay-zeroth-quartile"]:a["video-masthead-autoplay-first-quartile"]?Kg=a["video-masthead-autoplay-first-quartile"]:a["video-masthead-autoplay-second-quartile"]?Lg=a["video-masthead-autoplay-second-quartile"]:a["video-masthead-autoplay-third-quartile"]?Mg=a["video-masthead-autoplay-third-quartile"]:a["video-masthead-autoplay-fourth-quartile"]?
Ng=a["video-masthead-autoplay-fourth-quartile"]:a["video-masthead-watch-zeroth-quartile"]?Og=a["video-masthead-watch-zeroth-quartile"]:a["video-masthead-watch-first-quartile"]?Pg=a["video-masthead-watch-first-quartile"]:a["video-masthead-watch-second-quartile"]?Qg=a["video-masthead-watch-second-quartile"]:a["video-masthead-watch-third-quartile"]?Rg=a["video-masthead-watch-third-quartile"]:a["video-masthead-watch-fourth-quartile"]?Sg=a["video-masthead-watch-fourth-quartile"]:a["video-masthead-clickthrough"]?
Tg=a["video-masthead-clickthrough"]:a["video-masthead-clickthrough-tracking"]?Ug=a["video-masthead-clickthrough-tracking"]:a["video-masthead-cta-tracking"]?Wg=a["video-masthead-cta-tracking"]:a["video-masthead-cta-clickthrough"]?Vg=a["video-masthead-cta-clickthrough"]:a["video-masthead-video-wall-clickthrough-tracking"]?Xg=a["video-masthead-video-wall-clickthrough-tracking"]:a["video-masthead-subscribe-clickthrough-tracking"]?Yg=a["video-masthead-subscribe-clickthrough-tracking"]:a["video-masthead-channel-clickthrough-tracking"]?
Zg=a["video-masthead-channel-clickthrough-tracking"]:a["video-masthead-mute-click-tracking"]?$g=a["video-masthead-mute-click-tracking"]:a["video-masthead-unmute-click-tracking"]?ah=a["video-masthead-unmute-click-tracking"]:a["video-masthead-skip-autoplay-click-tracking"]&&(bh=a["video-masthead-skip-autoplay-click-tracking"]))},!1)}
function eh(a){bc=H("video-masthead-container");dh();ch.push(Xc(fh,"video-masthead-video-player-clicktarget"));ch.push(Xc(gh,"video-masthead-cta"));ch.push(Xc(hh,"video-masthead-video-wall"));ch.push(Xc(ih,"video-masthead-subscribe-button"));ch.push(Xc(jh,"video-masthead-channel-element"));ch.push(Xc(kh,"yt-uix-button-skip-autoplay"));ch.push(Xc(lh,"yt-uix-button-mute-autoplay"));ch.push(Xc(mh,"yt-uix-button-unmute-autoplay"));Z.addCueRange("onAutoplay",X,X+Y/4);Z.addCueRange("onAutoplayFirstQuartile",
...
function nh(a){a.data==YT.PlayerState.ENDED&&(K(Ng),ac())}
function oh(a){switch(a.data){case "onAutoplay":K(Jg);break;case "onAutoplayFirstQuartile":K(Kg);break;case "onAutoplaySecondQuartile":K(Lg);break;case "onAutoplayThirdQuartile":K(Mg);break;case "onAutoplayFourthQuartile":Z.pauseVideo(),K(Ng),ac()}}
function jh(){K(Zg)}
function ih(){K(Yg)}
function hh(){K(Xg)}
function fh(){K(Ug);if(Tg){var a={};Og&&(a.part2viewed=Og);Pg&&(a.videoplaytime25=Pg);Qg&&(a.videoplaytime50=Qg);Rg&&(a.videoplaytime75=Rg);Sg&&(a.videoplaytime100=Sg);var b={};b.clickThroughUrl=Tg;b.source="VideoMasthead";b.event="ClickToWatch";b.pings=a;window.top.postMessage(b,"*")}}
function gh(){K(Wg);Vg&&window.open(Vg)}
function kh(){Yb(bc,"autoplay")&&(K(bh),Zb(bc,"transition-to-thumbnail"),ac())}
function lh(){Zb(bc,"muted");Z&&(Z.mute(),K($g))}
function mh(){$b(bc,"muted");Z&&(Z.unMute(),K(ah))}
;function ph(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&K(c.data.follow_on_url)}}
;function qh(a){L.call(this,1,arguments);this.ya=a}
x(qh,L);function rh(a,b){L.call(this,2,arguments);this.h=a;this.f=b}
x(rh,L);function sh(a,b,c,d){L.call(this,1,arguments);this.f=b;this.j=c||null;this.h=d||null}
x(sh,L);function th(a,b){L.call(this,1,arguments);this.h=a;this.f=b||null}
x(th,L);function uh(a){L.call(this,1,arguments)}
x(uh,L);var vh=new M("ypc-core-load",qh),wh=new M("ypc-guide-sync-success",rh),xh=new M("ypc-purchase-success",sh),yh=new M("ypc-subscription-cancel",uh),zh=new M("ypc-subscription-cancel-success",th),Ah=new M("ypc-init-subscription",uh);var Bh=!1,Ch=[],Dh=[];function Eh(a){a.f?Bh?N(ag,a):N(vh,new qh(function(){N(Ah,new uh(a.f))})):Fh(a.h,a.l,a.j,a.m)}
function Gh(a){a.f?Bh?N(fg,a):N(vh,new qh(function(){N(yh,new uh(a.f))})):Hh(a.h,a.B,a.l,a.j,a.m)}
function Ih(a){Jh(Aa(a.f))}
function Kh(a){Lh(Aa(a.f))}
function Mh(a){Nh(a.f,a.h,null)}
function Oh(a,b,c,d){Nh(a,b,c,d)}
function Ph(a){var b=a.h,c=a.f.subscriptionId;b&&c&&N($f,new Sf(b,c,a.f.channelInfo))}
function Qh(a){var b=a.f;Ea(a.h,function(a,d){N($f,new Sf(d,a,b[d]))})}
function Rh(a){N(eg,new W(a.h.itemId));a.f&&a.f.length&&(Sh(a.f,eg),Sh(a.f,gg))}
function Fh(a,b,c,d){var e=new W(a);N(Yf,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=D("PLAYBACK_ID"))&&(c.plid=d);(d=D("EVENT_ID"))&&(c.ei=d);b&&Th(b,c);pg("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",La:f,I:c,V:function(b,c){var d=c.response;N($f,new Sf(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&Ib("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&ph(d.actions)},
oa:function(){N(Zf,e)}})}
function Hh(a,b,c,d,e){var f=new W(a);N(cg,f);var g={};d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=D("PLAYBACK_ID"))&&(d.plid=a);(a=D("EVENT_ID"))&&(d.ei=a);c&&Th(c,d);pg("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",La:g,I:d,V:function(a,b){var c=b.response;N(eg,f);c.actions&&ph(c.actions)},
oa:function(){N(dg,f)}})}
function Nh(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);pg("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",I:e,onError:function(){d&&d()}})}}
function Jh(a){if(a.length){var b=Ca(a,0,40);N("subscription-batch-subscribe-loading");Sh(b,Yf);var c={};c.a=b.join(",");var d=function(){N("subscription-batch-subscribe-loaded");Sh(b,Zf)};
pg("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",I:c,V:function(c,f){d();var g=f.response,h=g.id;if("array"==ca(h)&&h.length==b.length){var k=g.channel_info_map;y(h,function(a,c){var d=b[c];N($f,new Sf(d,a,k[d]))});
a.length?Jh(a):N("subscription-batch-subscribe-finished")}},
onError:function(){d();N("subscription-batch-subscribe-failure")}})}}
function Lh(a){if(a.length){var b=Ca(a,0,40);N("subscription-batch-unsubscribe-loading");Sh(b,cg);var c={};c.c=b.join(",");var d=function(){N("subscription-batch-unsubscribe-loaded");Sh(b,dg)};
pg("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",I:c,V:function(){d();Sh(b,eg);a.length&&Lh(a)},
onError:function(){d()}})}}
function Sh(a,b){y(a,function(a){N(b,new W(a))})}
function Th(a,b){var c=od(a),d;for(d in c)b[d]=c[d]}
;r("yt.setConfig",ub,void 0);I(window,"load",function(){var a=D("VIDEO_ID",void 0);X=D("AUTOPLAY_START_TIME",void 0);Y=D("AUTOPLAY_DURATION",void 0);var b=D("PLAYER_CONFIG",void 0);fa(b)&&v(a)&&fa(YT)&&ea(YT.ready)&&ea(YT.Player)&&YT.ready(function(){Z=new YT.Player("video-masthead-video-player",{height:"250",width:"850",videoId:a,playerVars:b,events:{onReady:eh,onStateChange:nh,onCueRangeEnter:oh}})})});
Ig(Of);Bh=!0;Dh.push(P(Xf,Eh),P(bg,Gh));Bh||(Dh.push(P(ag,Eh),P(fg,Gh),P(Uf,Ih),P(Vf,Kh),P(Wf,Mh)),Ch.push(Fb("subscription-prefs",Oh)),Dh.push(P(xh,Ph),P(zh,Rh),P(wh,Qh)));Ig(Cg);})();
