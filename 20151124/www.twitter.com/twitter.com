...
<!--[if gt IE 9]><!--><html lang="en" data-scribe-reduced-action-queue="true"><!--<![endif]-->
  ...
  <script id="resolve_inline_redirects" nonce="Hd+oV+JabePAAFtS0zRZ7g==">
...
;e();window.addEventListener?window.addEventListener("hashchange",e,!1):window.attachEvent&&window.attachEvent("onhashchange",e)})();
  ...
  <script id="swift_action_queue" nonce="Hd+oV+JabePAAFtS0zRZ7g==">
...
a.getAttribute("contenteditable")=="true"}var a=(new Date).getTime(),b=1e4,c=/^([^\.]+\.)*twitter\.com$/,d=/^key/,e=["click","keydown","keypress","keyup"],f=[],g=null,i=!0,j={captured:[],ignored:[],direct:[],all:[]};for(var k=0,l;l=e[k];k++)document["on"+l
  ...
  <script id="composition_state" nonce="Hd+oV+JabePAAFtS0zRZ7g==">
...
,b,!1)}})();
    ...
    <link rel="stylesheet" href="https://abs.twimg.com/a/1448086555/css/t1/twitter_core.bundle.css">
    <link rel="stylesheet" href="https://abs.twimg.com/a/1448086555/css/t1/twitter_logged_out.bundle.css">
...
<link rel="mask-icon" sizes="any" href="https://abs.twimg.com/a/1448086555/img/t1/favicon.svg" color="#55acee">
...
<link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="Twitter">
          ...
          <link rel="stylesheet" href="https://abs.twimg.com/a/1448086555/css/t1/twitter_more_1.bundle.css">
      <link rel="stylesheet" href="https://abs.twimg.com/a/1448086555/css/t1/twitter_more_2.bundle.css">

  </head>
  <body class="three-col logged-out front-page-photo-set front-page" 
data-fouc-class-names="swift-loading"
 dir="ltr">
      <script id="swift_loading_indicator" nonce="Hd+oV+JabePAAFtS0zRZ7g==">
    ...
    <li class="dropdown js-language-dropdown">
      ...
      <div class="js-front-language">
        <form action="/sessions/change_locale" class="t1-form language" method="POST">
          ...
          <input type="hidden" name="authenticity_token" value="2054742b6a48a60cc0c3b3f261f68a456664d236">
        </form>
      </div>
    </li>
  </ul>
...
>
  ...
  <input type="hidden" value="2054742b6a48a60cc0c3b3f261f68a456664d236" name="authenticity_token">
      <input type="hidden" value="" name="ui_metrics" autocomplete="off">
      <input type="hidden" id="ui_metrics_seed" name="ui_metrics_seed" value="1448386892333" autocomplete="off">
