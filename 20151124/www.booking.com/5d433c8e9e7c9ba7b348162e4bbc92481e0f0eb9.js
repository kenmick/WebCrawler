...
}if(B.atlas.getVariant("ebcBUcSPWYNHICTEZWDTPcHe")&&(B.atlas.getVariant("YdVNYEETUXSGUVTTQXadNbHbfC")||B.atlas.getVariant("YdVTaHHeYKBQYaUeGXRZcSRFJO"))){if(F!==null&&F[1]){E.centralPolygonCoords=i("#"+F[1]).data("centralPolygon")||""
}else{E.centralPolygonCoords=""
}}u.show();
h.trigger("open",E);
