...
(function (window) {
  ...
  Model.prototype.getData = function (succes, erorr) {
    ...
    Enabler.setProfileId(1061846);
    var devDynamicContent = {};

    devDynamicContent.Feed_970x250= [{}];
    devDynamicContent.Feed_970x250[0]._id = 0;
    devDynamicContent.Feed_970x250[0].uniqueId = 1;
    devDynamicContent.Feed_970x250[0].Game_1 = "Gotham";
    devDynamicContent.Feed_970x250[0].Game_2 = "Arrow";
    devDynamicContent.Feed_970x250[0].Game_3 = "The Vampires Diaries";
    devDynamicContent.Feed_970x250[0].Frame_1 = "Secrets and sacrifice";
    devDynamicContent.Feed_970x250[0].Frame_2 = "Gangsters and good guys";
    devDynamicContent.Feed_970x250[0].Frame_3 = "Crusades and corruption";
    devDynamicContent.Feed_970x250[0].Legals_1 = "\u00A9 2015 Elex. All other trademarks are the property of their respective owners.";
    ...
    devDynamicContent.Feed_970x250[0].Legals_3 = "THE VAMPIRE DIARIES and all related characters and elements are trademarks of<br\/>and \u00A9  Warner Bros. Entertainment Inc. All Rights Reserved.";
    devDynamicContent.Feed_970x250[0].Copy_EndFrame_1 = "Google Play TV has landed";
    devDynamicContent.Feed_970x250[0].Copy_EndFrame_2 = "Discover unmissable shows";
    devDynamicContent.Feed_970x250[0].Copy_EndFrame_3 = "Get the pilots free, until Nov 16";
    devDynamicContent.Feed_970x250[0].Copy_CTA = "Watch Now";
    devDynamicContent.Feed_970x250[0].ExitURL = {};
    devDynamicContent.Feed_970x250[0].ExitURL.Url = "https://play.google.com/store/apps/collection/promotion_3001b09_gamesfestival_games?utm_source=emea_co&utm_medium=yt&utm_content=Oct0115&utm_campaign=TitlePromo&pcampaignid=MKT-AC-emea-uk-dsk-co-yt-gm-TitlePromo-Oct0115-1-mh_uk%7Cpid_%epid!-cid_%ecid!-aid_%eaid!";
    ...
    devDynamicContent.Feed_970x250[0].videoURL.Progressive_Url = "https://gcdn.2mdn.net/videoplayback/id/a7fcb0d63d22b053/itag/59/source/doubleclick/ratebypass/yes/acao/yes/ip/0.0.0.0/ipbits/0/expire/3590938117/sparams/id,itag,source,ratebypass,acao,ip,ipbits,expire/signature/1C350C93F55500946711BED855FDDE80074F1AD9.7DBC24FC7C1E36CD629A26197294516C095D598D/key/ck2/file/file.mp4";
    devDynamicContent.Feed_970x250[0].videoURL.Stream_Url = "";
    devDynamicContent.Feed_970x250[0].Folder_Name = "Banner_970x250";
...
(function (window) {
  ...
  View.prototype.addFrame = function (id, text, speed, delay) {
    ...
    TweenLite.fromTo(copy, speed*.5, {alpha: 0, delay: delay, force3D: true}, {
      alpha: 1,
      force3D: true
    });
    TweenLite.fromTo(copy, speed, {scale: 0.8, delay: delay, force3D: true}, {
      scale: 1.2,
      force3D: true
    });
    TweenLite.to(_this.legals, 1, {delay: speed - 2, alpha: 0});
    TweenLite.to(_this.gameName, 1, {delay: speed - 2, alpha: 0});
    TweenLite.to(copy, 1, {alpha: 0, delay: speed - 2, ease: Power2.easeOut});
  ...
  Controller.prototype.addVideoCuePoints = function () {
    ...
    var cuepoints = {
      ...
      0.25: function () {
        ...
        _this.view.setCopy(_this.copy);
        _this.view.addFrame('frame-1', _this.model.dynamicContent.Frame_1, 5.25, 0);
      },
      4.75: function () {
        ...
        _this.view.setCopy(_this.copy);
        _this.view.addFrame('frame-2', _this.model.dynamicContent.Frame_2, 4.55, 0);
      },
      8.5: function () {
        ...
        _this.view.addFrame('frame-3', _this.model.dynamicContent.Frame_3, 4.75, 0);
      },
