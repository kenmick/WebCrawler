...
<!--[if gt IE 9]><!--><html lang="en" data-scribe-reduced-action-queue="true"><!--<![endif]-->
  ...
  <script id="resolve_inline_redirects" nonce="yWtsI6xgy7BrUjfX2yJ+XQ==">
...
;e();window.addEventListener?window.addEventListener("hashchange",e,!1):window.attachEvent&&window.attachEvent("onhashchange",e)})();
  ...
  <script id="swift_action_queue" nonce="yWtsI6xgy7BrUjfX2yJ+XQ==">
...
a.getAttribute("contenteditable")=="true"}var a=(new Date).getTime(),b=1e4,c=/^([^\.]+\.)*twitter\.com$/,d=/^key/,e=["click","keydown","keypress","keyup"],f=[],g=null,i=!0,j={captured:[],ignored:[],direct:[],all:[]};for(var k=0,l;l=e[k];k++)document["on"+l
  ...
  <script id="composition_state" nonce="yWtsI6xgy7BrUjfX2yJ+XQ==">
...
,b,!1)}})();
    ...
    <link rel="stylesheet" href="https://abs.twimg.com/a/1442456431/css/t1/twitter_logged_out.bundle.css">
...
data-fouc-class-names="swift-loading"
 dir="ltr">
      <script id="swift_loading_indicator" nonce="yWtsI6xgy7BrUjfX2yJ+XQ==">
      ...
      <li class="dropdown js-language-dropdown">
        ...
        <div class="js-front-language">
          <form action="/sessions/change_locale" class="t1-form language" method="POST">
            ...
            <input type="hidden" name="authenticity_token" value="fed32f9ebb7a5f94ce3fc509dc62c2ebfc03f1e1">
          </form>
        </div>
      </li>
    </ul>
...
>
  ...
  <input type="hidden" value="fed32f9ebb7a5f94ce3fc509dc62c2ebfc03f1e1" name="authenticity_token">
      <input type="hidden" value="" name="ui_metrics" autocomplete="off">
      <input type="hidden" id="ui_metrics_seed" name="ui_metrics_seed" value="1442790342964" autocomplete="off">
</form>
...
<div id="media-edit-dialog" class="modal-container"></div>
  ...
  <input type="hidden" id="swift-module-path" value="https://abs.twimg.com/c/swift/en">
    ...
    <script src="https://abs.twimg.com/c/swift/en/init.4b7a5350f1179235d91ef6d617f3330c882a2303.js" async></script>
