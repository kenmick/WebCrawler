...
(function(e, i) {
    ...
    t.extend({
        ...
        type: function(e) {
            ...
            return typeof e === 'object' || typeof e === 'function' ? j[li.call(e)] || 'object' : typeof e
        },
        isPlainObject: function(e) {
            ...
            try {
                if (e.constructor && !w.call(e, 'constructor') && !w.call(e.constructor.prototype, 'isPrototypeOf')) {
                    return !1
                }
            } catch (n) {
                return !1
    ...
    ye = t(n);
    (function(e, i) {
        var j, a, W, s, H, te, U, F, k, x, c, p, d, u, S, O, N, l = 'sizzle' + -(new Date()),
            m = e.document,
            g = 0,
            me = 0,
            ce = X(),
                ...
                if ((w = pe.exec(e))) {
                    if ((o = w[1])) {
                        if (p === 9) {
                            ...
                            if (t.ownerDocument && (r = t.ownerDocument.getElementById(o)) && N(t, r) && r.id === o) {
                                i.push(r);
                                return i
                            }
                        }
                    } else if (w[2]) {
                        y.apply(i, t.getElementsByTagName(e));
                        return i
                    } else if ((o = w[3]) && a.getElementsByClassName && t.getElementsByClassName) {
                        y.apply(i, t.getElementsByClassName(o));
                        return i
                    }
                };
                if (a.qsa && (!u || !u.test(e))) {
                    ...
                    if (g) {
                        try {
                            y.apply(i, k.querySelectorAll(g));
                            return i
                        } catch (s) {} finally {
                            if (!v) {
        ...
        x = r.setDocument = function(e) {
            ...
            if ((a.matchesSelector = Q.test((O = p.webkitMatchesSelector || p.mozMatchesSelector || p.oMatchesSelector || p.msMatchesSelector)))) {
                f(function(e) {
                    a.disconnectedMatch = O.call(e, 'div');
                    O.call(e, '[s!=\'\']:x');
                    S.push('!=', G)
                })
            };
