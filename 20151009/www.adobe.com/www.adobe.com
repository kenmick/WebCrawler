...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <script type="text/javascript" src="/dtagent622_bxjpr23_1019.js" data-dtconfig="rid=RID_2418|rpid=1390015669|domain=adobe.com|tp=500,50,3|cors=1|bandwidth=300|reportUrl=dynaTraceMonitor"></script><link rel="icon" href="https://wwwimages2.adobe.com/include/img/favicon.ico" type="image/x-icon">
...
<main class="lobby">
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-max-pre-announce-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="50% 15%" data-article-width="big" data-seed-background>
