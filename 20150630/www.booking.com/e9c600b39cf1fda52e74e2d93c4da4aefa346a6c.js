...
if(booking.env.autocomplete_bbtoollocations&&x.bbtoollocations&&x.bbtoollocations.length){x.bbtoollocations.forEach(function(i){if(i.name&&i.address){i.label_highlighted="<b>"+this._escapeHTML(i.name)+"</b>, "+this._escapeHTML(i.address)
}},this);
