...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang3_0.js':{v:3586},'index.css':{v:27},'index.js':{v:33},'ui_controls.css':{v:66},'ui_controls.js':{v:191}
}
var abp;
</script>
...
<div><div class="scroll_fix">
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login" onsubmit="if (vklogin) {return true} else {quick_login();return false;}">
    ...
    <input type="hidden" name="lg_h" value="7ccd97b4bd338578b6" />
