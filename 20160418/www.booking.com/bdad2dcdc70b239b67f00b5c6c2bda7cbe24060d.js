if(booking.env.enable_scripts_tracking){booking.env.scripts_tracking.calendar2={loaded:true,run:false}
...
(function(g,b,f,e,c){_i_("79db:2");var d=g.require("window-scroller");
var a=10;
...
;_r_()},initMarkup:function(){_i_("79db:35");var m=this.getOption_("title"),j=(this.options.closeButton)?'<div class="c2-calendar-close-button"><i class="c2-calendar-close-button-icon">Ã</i></div>':"";
var k="";
var l=this.options.calendarWidth+"px";
var h="";
if(g.env.b_lang_for_url==="zh-cn"&&g.env.b_upcoming_chinese_holidays&&g.et.track("MKMBYPKFcFPAZSATIbYO")===2){h=g.jstmpl("china_suggest_holiday_dates").render({b_upcoming_chinese_holidays:g.env.b_upcoming_chinese_holidays})
}var i='<div style="width:'+l+';" class="'+this.getCalendarClassname()+'"><div class="c2-calendar-header">'+k+m+j+"</div>"+h+'<div class="c2-calendar-body"><div class="c2-button c2-button-earlier"><span class="c2-button-inner">&larr;</span></div><div class="c2-button c2-button-further"><span class="c2-button-inner">&rarr;</span></div><div class="c2-calendar-viewport"><div class="c2-calendar-inner">'+this.createMonths()+'</div></div><div class="c2-calendar-footer"></div></div></div>';
this.$calendarElement=e(i);
...
;_r_()})
;_r_()}(booking,booking.tools,booking.calendar2,$));
if(booking.env.enable_scripts_tracking){booking.env.scripts_tracking.calendar2.run=true
};