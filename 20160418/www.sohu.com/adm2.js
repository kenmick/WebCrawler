...
_I = (isIE) ? 1 : 0.75,
_J = (isIE) ? "px": "pt",
_K = "<script type='text/javascript'",
_L = "</script>",
_N = false,
_O = _P = new Array(),
crsr = (isIE ? "cursor:hand": "cursor:pointer") + ";border-bottom:1px solid #000000;color:#000000;font-size:12px '\u7039\u5b29\u7d8b';",
_M = (document.compatMode == "CSS1Compat") ? document.documentElement: document.body,
_R = "http://images.sohu.com/bill/s2011/gates/gif/",
_S = _R + "bg.jpg",
_T = _R + "play.png";
if(null!=[/MSIE (\d)\.0/i.exec(navigator.userAgent)][0]){
...
function getElementPos(_86) {
    ...
    if (el.getBoundingClientRect) {
        ...
        return {x: box.left + _8d,y: box.top + _8c};
    } else {
