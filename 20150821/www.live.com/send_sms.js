        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Status !== 'Error') {
                    ...
                    //show error message
                    $("#status").html('<p class="small">We are sorry, an error occurred while sending your message. Please try again shortly.</p>');
                }
            },
            error: function (err) {
                //show error message
    ...
    $("#button").click(function () {
        ...
        //if it is sms
            ...
            if (phoneTxt !== '' && phoneTxt.match(phonePattern)) {
                ...
                $("#status").html('<p class="small">Please enter a valid 10-digit phone number. Format: 000-000-0000</p>');
                $("#textbox").css('background-image', 'url(https://sc.imp.live.com/content/dam/imp/surfaces/mail_signin/v3/img/ol_sms_offer/ring-blue.png)')
                //show error message
            }
