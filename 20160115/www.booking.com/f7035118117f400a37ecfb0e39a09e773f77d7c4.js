...
if (this.input.value != n && this.setValue(n), this.input.setSelectionRange) this.input.setSelectionRange(i, s); else if (this.input.createTextRange) {
...
t = t || {}, null === this.valueBuffer || t.preserveInputValue || (this.setValue(this.valueBuffer), t.preserveFocus && this.fixIEFocusLoss()), -1 != this.highlightedIndex && this.$items.eq(this.highlightedIndex).removeClass("-highlighted"), this.highlightedIndex = -1;
},
...
choose:function(t) {
this.selectedIndex = t, this.selectedValue = this.items[t].value, this.setValue(this.selectedValue), this.reset();
},
reset:function(t) {
t = t || {}, -1 != this.highlightedIndex && this.$items.eq(this.highlightedIndex).removeClass("-highlighted"), this.listHide(), t.hard && (this.resetFlags(), this.selectedIndex = -1, this.selectedValue = null, this.setValue(""));
},
resetFlags:function() {
...
if (i[0] = o[a - 1], s += t[2], n.MJ(n.MB(e[1])) && n.MJ(/zh|xt|ja|ko/.test(n.MB(e[2]))) && n.MJ(n.track_experiment_stage("YdVSfPYPaEYZBMURET", 1)), s += t[3], n.MJ(n.MB(e[1])) && n.MJ(!/zh|xt|ja|ko/.test(n.MB(e[2]))) && n.MJ(n.track_experiment_stage("YdVSfPYPaEYZBMURET", 2)), s += t[4], s += t[5], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[2]))) && (s += t[6]), n.MJ(n.MB(e[3]) + "" == "airport") ? s += t[7] :n.MJ(n.MB(e[3]) + "" == "city") ? s += t[8] :n.MJ(n.MB(e[3]) + "" == "country") ? s += t[9] :n.MJ(n.MB(e[3]) + "" == "district") ? s += t[10] :n.MJ(n.MB(e[3]) + "" == "hotel") ? s += t[11] :n.MJ(n.MB(e[3]) + "" == "landmark") ? s += t[12] :n.MJ(n.MB(e[3]) + "" == "region") ? s += t[13] :n.MJ(n.MB(e[3]) + "" == "theme") && (s += t[14]), n.MJ(n.MB(e[3]) + "" == "theme") && (s += t[15]), n.MJ(n.MB(e[1])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) && (s += t[16]), s += [ t[17], n.MC(e[4]), t[18], n.F.entities(n.MC(e[5])), t[19] ].join(""), s += t[20], n.MJ(n.MB(e[3]) + "" == "theme")) s += [ t[21], n.F.entities(n.MC(e[6])), t[22] ].join(""), n.MJ(n.track_experiment("PVdIOHHAVCMILFPWcZMO")) ? (s += t[23], n.MN(e[7], t[24]), s += [ t[20], n.ME(t[25], n.MB, n.MN, null), t[26], n.ME(t[27], n.MB, n.MN, null), t[28] ].join("")) :s += [ t[23], n.F.entities(n.MC(e[8])), t[26], n.ME(t[29], n.MB, n.MN, null), t[28] ].join(""), s += t[30]; else {
if (s += t[20], n.MJ(n.MB(e[1])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET"))) {
s += t[20];
var h = a, r = o, u = l, o = n.MC(e[1]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) i[0] = o[a - 1], s += t[20], n.MJ(a > 2) && (s += t[31]), s += t[20], n.MJ(1 == a) && (s += t[32], s += n.MJ(n.MB(e[3]) + "" == "hotel") ? [ t[20], n.ucfirst(n.MB(e[9])), t[20] ].join("") :[ t[20], n.F.entities(n.ME(t[33], n.MB, n.MN, null)), t[20] ].join(""), s += t[34]), s += [ t[20], n.F.entities(n.MB(e[10])), t[20] ].join(""), n.MD(e[11]) && (s += [ t[35], n.F.entities(n.MB(e[11])), t[36] ].join("")), s += t[20], n.MJ(1 == a) && (s += t[20], n.MJ(n.MG((n.MC(e[12]) || {}).popular)) && (s += t[20], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[2]))) && n.MJ(n.track_experiment_stage("PVdIGbGWZSXKbdRNYYdVTbLWZHOaO", 1)), s += [ t[37], n.F.entities(n.ME(t[38], n.MB, n.MN, null)), t[39] ].join("")), s += t[40]), s += t[20];
i.shift(), a = h, o = r, l = u, s += t[20];
} else if (n.MD(e[13])) {
s += t[20];
var h = a, r = o, u = l, o = n.MC(e[13]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) i[0] = o[a - 1], s += t[20], n.MD(e[14]) && (s += t[41]), s += [ t[20], n.F.entities(n.MC(e[10])), t[20] ].join(""), n.MD(e[14]) && (s += t[39]), s += t[20];
i.shift(), a = h, o = r, l = u, s += t[20];
} else n.MD(e[15]) ? s += [ t[20], n.MC(e[15]), t[20] ].join("") :n.MD(e[8]) && (s += [ t[20], n.F.entities(n.MC(e[8])), t[20] ].join(""));
s += t[20], n.MD(e[16]) && (s += [ t[42], n.MC(e[16]), t[39] ].join("")), s += t[20], n.MJ(n.MB(e[1])) && n.MJ(n.track_experiment("YdVSfPYPaEYZBMURET")) || (s += t[20], n.MJ(n.MG((n.MC(e[12]) || {}).popular)) && (s += t[20], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[2]))) && n.MJ(n.track_experiment_stage("PVdIGbGWZSXKbdRNYYdVTbLWZHOaO", 1)), s += [ t[37], n.F.entities(n.ME(t[38], n.MB, n.MN, null)), t[39] ].join("")), s += t[20]), s += t[20];
}
s += t[20], n.MN("index", n.MI(n.MB(e[4])) + n.MI(1)), s += t[20], s += t[43];
}
i.shift(), s += t[1], n.MD(e[17]) && (s += t[44]), s += t[45];
}
return s += t[45];
}
return s += t[0], s = o(s), s += t[45];
};
...
}, this.$errors = this.$el.find("[data-error-id]"), this.$clear = this.$el.find('[data-clear=""]'), s.prototype.init.apply(this, arguments), this.model = n.getInstance(this.options.modelId), this.model.use("destination"), this.model.on("change", this.modelChange.bind(this)), this.model.on("validation", this.modelValidation.bind(this)), this.options.gpOnly && this.model.destination.configurePredictions({
gpo:1
...
_shat:1
}), this.templateResults = B.jstmpl("search_destination_autocomplete_results"), this.toggleClear();
},
addInputEventListeners:function() {
s.prototype.addInputEventListeners.apply(this, arguments), this.$clear.length && this.$clear.on("click", this.clearClick.bind(this));
},
modelChange:function(t) {
if ("destination" == t.group) {
var e = this.model.destination.get();
e.ss != this.input.value && this.setValue(e.ss), t.onlyCurrentCountry && (this.$input.focus(), this.autocomplete());
}
},
...
setValue:function(t) {
s.prototype.setValue.apply(this, arguments), this.toggleClear();
},
toggleClear:function() {
this.$clear.length && this.$clear.toggleClass("-visible", "" !== this.input.value);
},
listShow:function() {
...
}), clearTimeout(this.timer), this.model.destination.abortPredictions(), this.toggleClear(), t.fromFocus || (this.isDeletion ? this.model.destination.reset() :this.postAutocomplete(), this.timer = setTimeout(function() {
...
this.data.ss = t.ss, this.data.dest_id = t.dest_id, this.data.dest_type = t.dest_type, this.data.place_id = t.place_id, this.data.latitude = t.latitude, this.data.longitude = t.longitude, t._ef = t._ef || [], t._ef.push({
name:"dest_id",
...
i.ss = t, i.gpf = this.options.gpf, this.options.onlyCurrentCountry && (i.e_acf_i = B.env.b_country_id, i.e_acf_t = "country"), this.searchInstance = s.search(i, n.bind(this)), this.model.setFields("destinationOriginal", [ {
name:"ss_raw",
value:i.ss
...
this.model.destination.set(s), this.options.autoSubmit && this.model.submit();
}
});
...
"use strict";
var s = t("event-emitter"), n = B.env.b_map_center_latitude || B.env.b_latitude || void 0, o = B.env.b_map_center_longitude || B.env.b_longitude || void 0, a = 3e4, l = [ "ChIJNy0jzGPMUQ4RWpboPw0ztMY", "ChIJ2xJC2SwmsUcRBqiHnUEubtY", "ChIJT-IyeGHurw0Rx89nUEaYTPM", "ChIJk_Swujrurw0R7yS_X2BSuD4" ], h = {
...
s.__upa__ = e.filter(d).slice(0, 5).map(function(e, i) {
e = e.get("data");
var s = {
upa:!0,
nr_hotels:0,
...
function c(t, e, i) {
t = t || {}, t.id = t.place_id = e.id, t.name = e.name, t.latitude = e.geometry.location.lat(), t.longitude = e.geometry.location.lng(), t.place_types = e.types, t.dest_type = h[e.types && e.types[0]] || "landmark", t._ef = t._ef || [], t._ef.push({
name:"ss_short",
value:e.name
}), i(null, t);
}
...
function a(t, e, i) {
t && t.city ? t.__upa__ || 0 !== t.city.length || t.bbtoollocations && 0 !== t.bbtoollocations.length || t.theme && 0 !== t.theme.length ? (t.city = t.city.map(function(e, i) {
return !e.label && e.labels && (e.label = l(e.labels)), !e.labels || "zh" !== e.lc && "xt" !== e.lc && "ja" !== e.lc && "ko" !== e.lc || (e.label_blocks = h(e.labels)), e.ss = e.label, e.label_highlighted = e.label_highlighted || e.label, e.position = i, e._ef = e._ef || [], e._ef.push({
name:"ac_position",
value:i
}), e._ef.push({
name:"ac_langcode",
...
return e.ss = e.label, e._ef = e._ef || [], e._ef.push({
name:"ac_position",
...
gpf:!0
}), this.options.e_v && (this.model.e_v = !0), this.model.on("init", this.modelChange.bind(this)), this.model.on("change", this.modelChange.bind(this)), this.model.on("submit", this.modelSubmit.bind(this)), this.$form = this.$el.is("form") ? this.$el :this.$el.find("form:eq(0)"), this.$form.submit(this.formSubmit.bind(this)), this.initCurrentCountryField(), o.on("beforeajax", function(t, e) {
...
B.et.track("PVSfZJAMdLHDDWRe") && this.updateHiddenFields();
},
...
t.push(i.name), -1 != l.indexOf(i.name) && (e = !0);
}), this.$form.find("input").filter(function() {
return e && -1 != l.indexOf(this.name) || -1 != t.indexOf(this.name);
