...
if(B.track.getVariant("TDXbEeQMMKe")||B.track.getVariant("TDXbETcGKSaT")){B.define("gta/phone-validation",function(){var c=$.noop;
var d=$.noop;
var k=$.noop;
var g=$.noop;
...
if(c.env.b_lang_for_url.match(/^en/)){(function(j,g){var h=e(g);
if(!(h===0||h===1)){return
