...
B.when({condition:B.env.b_site_type_id==1&&B.env.b_action=="index",events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PAcbdQNZCYEIUDeTTEC";
e.on("beforeajax",function(f,h){var j=d.track("PVdIYROdVaC");
if(j===0){var g=d.track(c);
...
B.when({condition:B.env.b_site_type_id==1&&B.env.b_action=="index",events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PAcbdQNZCYEIUDBCeXUFeXe";
e.on("beforeajax",function(f,h){var j=d.track("PVdIYROdVaC");
if(j===0){var g=d.track(c);
if(g){h.e_brick_themes=2;
...
B.when({condition:B.env.b_site_type_id==1&&B.env.b_action=="index",events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PAcbdQNZCYEIUJUSOMcaT";
e.on("beforeajax",function(f,h){var j=d.track("PVdIYROdVaC");
if(j===0){var g=d.track(c);
if(g){h.e_brick_themes=2;
h.e_themes_msm_1=1
...
e.on("afterajax",function(f,h){var g=d.track("PVdIYROdVaC");
if(g===0&&h&&h.__theme_msm__){d.stage(c,1);
d.stage(c,2)
}})
});
...
B.when({events:"ready",stage:0}).run(function(f){var d="NVFMEPbBXDaVWKMcCVaHWNLT",g=f("font-face-on-load"),k={woff:"//q-ec.bstatic.com/static/css/fonticons_clean/base64/woff/e145a43a91a42af24471003a90ffa8acd2c138d4.css",opentype:"//r-ec.bstatic.com/static/css/fonticons_clean/base64/opentype/24246cb239183c38e50a61fd8e441ef124c80c52.css",truetype:"//q-ec.bstatic.com/static/css/fonticons_clean/base64/truetype/2056e1c3320927430850a856274091089a911198.css"},h=function(){if(B.et.track(d)==2){$("body").removeClass("iconfont_is_loading")
