...
B.eventEmitter.unbind(T.join(" "),v);
...
}function H(e){if(typeof e==="string"){return[].slice.call(document.querySelectorAll(e))
...
}else{if(jQuery&&e instanceof jQuery){return e.toArray()
