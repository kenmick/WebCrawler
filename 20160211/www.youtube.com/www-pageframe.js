...
;var Ri=t("yt.abuse.botguardInitialized")||yh;r("yt.abuse.botguardInitialized",Ri,void 0);var Si=t("yt.abuse.invokeBotguard")||zh;r("yt.abuse.invokeBotguard",Si,void 0);var Ti=t("yt.abuse.dclkstatus.checkDclkStatus")||Ah;r("yt.abuse.dclkstatus.checkDclkStatus",Ti,void 0);var Ui=t("yt.player.exports.navigate")||Kg;r("yt.player.exports.navigate",Ui,void 0);var Wi=t("yt.player.embed")||Oi;r("yt.player.embed",Wi,void 0);var Xi=t("yt.player.getPlayerByElement")||Qi;r("yt.player.getPlayerByElement",Xi,void 0);
...
if(J.length){var Vi="loaded_"+Ul.I++;Tl[Vi]=function(a){jb[D](a);Tl[Vi]=null};
a=im(c,J,"gapi."+Vi,l);l.push.apply(l,J);$l("ml0",J,M);b.sync||Kl.___gapisync?tm(a):um(a)}else jb[D](Nl)}else d(J)&&e&&e()}
...
g.Z=function(){for(var a=[],b=this.f.length-1;0<=b;--b)a.push(this.f[b]);for(var c=this.j.length,b=0;b<c;++b)a.push(this.j[b]);return a};function up(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);return a?50<=parseInt(a[1],10):!1}
var vp=document.currentScript&&-1!=document.currentScript.src.indexOf("?loadGamesSDK")?"/cast_game_sender.js":"/cast_sender.js",wp=["boadgeojelhgndaghljhdicfkmllpafd","dliochdbjfkdbacpmhlcpmleaejidimm","fmfcbgogabcbclcofgocippekhfcmgfj"],xp=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl","enhhojjnijigcajfphajepfemndkmdlo"],yp=up()?xp.concat(wp):wp.concat(xp);function zp(a,b){var c=new XMLHttpRequest;c.onreadystatechange=function(){4==c.readyState&&200==c.status&&b(!0)};
c.onerror=function(){b(!1)};
try{c.open("GET",a,!0),c.send()}catch(d){b(!1)}}
function Ap(a){if(a>=yp.length)Bp();else{var b=yp[a],c="chrome-extension://"+b+vp;0<=wp.indexOf(b)?zp(c,function(d){d?(window.chrome.cast=window.chrome.cast||{},window.chrome.cast.extensionId=b,Cp(c,Bp)):Ap(a+1)}):Cp(c,function(){Ap(a+1)})}}
function Cp(a,b){var c=document.createElement("script");c.onerror=b;c.src=a;(document.head||document.documentElement).appendChild(c)}
function Bp(){var a=window.__onGCastApiAvailable;a&&"function"==typeof a&&a(!1,"No cast extension found")}
function Dp(){if(window.chrome){var a=window.navigator.userAgent;if(0<=a.indexOf("Android")&&0<=a.indexOf("Chrome/")&&window.navigator.presentation)a=up()?"50":"",Cp("//www.gstatic.com/eureka/clank"+a+vp,Bp);else{if(0<=window.navigator.userAgent.indexOf("CriOS")&&(a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost)){a({command:"cast.sender.init"});return}Ap(0)}}else Bp()}
;var Ep=x(),Fp=null,Gp=Array(50),Hp=-1,Ip=!1;function Jp(a){Kp();Fp.push(a);Lp(Fp)}
function Mp(a,b){Kp();var c=Fp,d=Np(a,String(b));Va(c)?Op(d):(Lp(c),z(c,function(a){a(d)}))}
function Kp(){Fp||(Fp=t("yt.mdx.remote.debug.handlers_")||[],r("yt.mdx.remote.debug.handlers_",Fp,void 0))}
function Op(a){var b=(Hp+1)%50;Hp=b;Gp[b]=a;Ip||(Ip=49==b)}
function Lp(a){var b=Gp;if(b[0]){var c=Hp,d=Ip?c:-1;do{var d=(d+1)%50,e=b[d];z(a,function(a){a(e)})}while(d!=c);
Gp=Array(50);Hp=-1;Ip=!1}}
function Np(a,b){var c=(x()-Ep)/1E3;c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")}
;function Pp(a){a=a||{};this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.f=a.uuid||a.dialId||""}
function Qp(a,b){return!!b&&(a.id==b||a.f==b)}
function Rp(a,b){return a||b?!a!=!b?!1:a.id==b.id&&a.token==b.token&&a.name==b.name&&a.f==b.f:!0}
function Sp(a){return{name:a.name,screenId:a.id,loungeToken:a.token,dialId:a.f}}
function Tp(a){return new Pp(a)}
function Up(a){return ea(a)?Oa(a,Tp):[]}
function Vp(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+(a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.f?".."+a.f.slice(-6):"-")+"}":"null"}
function Wp(a){return ea(a)?"["+Oa(a,Vp).join(",")+"]":"null"}
;function Xp(){}
;function Yp(){}
y(Yp,Xp);Yp.prototype.Y=function(){var a=0;Ff(this.Aa(!0),function(){a++});
return a};
Yp.prototype.clear=function(){var a=Gf(this.Aa(!0)),b=this;z(a,function(a){b.remove(a)})};function Zp(a){this.f=a}
y(Zp,Yp);g=Zp.prototype;g.isAvailable=function(){if(!this.f)return!1;try{return this.f.setItem("__sak","1"),this.f.removeItem("__sak"),!0}catch(a){return!1}};
...
return d};
g.clear=function(){this.f.clear()};
g.key=function(a){return this.f.key(a)};function $p(){var a=null;try{a=window.localStorage||null}catch(b){}this.f=a}
y($p,Zp);function aq(){var a=null;try{a=window.sessionStorage||null}catch(b){}this.f=a}
y(aq,Zp);function bq(a){this.f=a}
bq.prototype.j=function(a,b){p(b)?this.f.Ed(a,lj(b)):this.f.remove(a)};
bq.prototype.get=function(a){var b;try{b=this.f.get(a)}catch(c){return}if(null!==b)try{return jj(b)}catch(c){throw"Storage: Invalid value was encountered";}};
bq.prototype.remove=function(a){this.f.remove(a)};function cq(a){this.f=a}
y(cq,bq);function dq(a){this.data=a}
function eq(a){return!p(a)||a instanceof dq?a:new dq(a)}
cq.prototype.j=function(a,b){cq.L.j.call(this,a,eq(b))};
cq.prototype.l=function(a){a=cq.L.get.call(this,a);if(!p(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
cq.prototype.get=function(a){if(a=this.l(a)){if(a=a.data,!p(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function fq(a){this.f=a}
y(fq,cq);function gq(a){var b=a.creation;a=a.expiration;return!!a&&a<x()||!!b&&b>x()}
fq.prototype.j=function(a,b,c){if(b=eq(b)){if(c){if(c<x()){fq.prototype.remove.call(this,a);return}b.expiration=c}b.creation=x()}fq.L.j.call(this,a,b)};
fq.prototype.l=function(a,b){var c=fq.L.l.call(this,a);if(c)if(!b&&gq(c))fq.prototype.remove.call(this,a);else return c};function hq(a){this.f=a}
y(hq,fq);function iq(a,b){var c=[];Ff(b,function(a){var b;try{b=hq.prototype.l.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}p(b)?gq(b)&&c.push(a):c.push(a)},a);
return c}
function jq(a,b){var c=iq(a,b);z(c,function(a){hq.prototype.remove.call(this,a)},a)}
function kq(){var a=lq;jq(a,a.f.Aa(!0))}
;function mq(a,b,c){var d=c&&0<c?c:0;c=d?x()+1E3*d:0;if((d=d?lq:nq)&&window.JSON){u(b)||(b=JSON.stringify(b,void 0));try{d.j(a,b,c)}catch(e){d.remove(a)}}}
function oq(a){if(!nq&&!lq||!window.JSON)return null;var b;try{b=nq.get(a)}catch(c){}if(!u(b))try{b=lq.get(a)}catch(c){}if(!u(b))return null;try{b=JSON.parse(b,void 0)}catch(c){}return b}
function pq(a){nq&&nq.remove(a);lq&&lq.remove(a)}
var lq,qq=new $p;lq=qq.isAvailable()?new hq(qq):null;var nq,rq=new aq;nq=rq.isAvailable()?new hq(rq):null;function sq(a){this.B=this.l="";this.f="/api/lounge";this.j=!0;a=a||document.location.href;var b=Number(a.match(lf)[4]||null)||null||"";b&&(this.B=":"+b);this.l=mf(a)||"";a=Jb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Fa(a,"10.0")&&(this.j=!1))}
function tq(a,b,c,d){var e=a.f;if(p(d)?d:a.j)e="https://"+a.l+a.B+a.f;return uf(e+b,c||{})}
function uq(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,W:w(a.C,d,!0),onError:w(a.A,e),sb:w(a.D,e)};c&&(a.ta=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return xj(b,a)}
sq.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
sq.prototype.A=function(a,b){a(Error("Request error: "+b.status))};
sq.prototype.D=function(a){a(Error("request timed out"))};function vq(a){this.f=this.name=this.id="";this.status="UNKNOWN";a&&(this.id=a.id||"",this.name=a.name||"",this.f=a.activityId||"",this.status=a.status||"UNKNOWN")}
function wq(a){return{id:a.id,name:a.name,activityId:a.f,status:a.status}}
vq.prototype.toString=function(){return"{id:"+this.id+",name:"+this.name+",activityId:"+this.f+",status:"+this.status+"}"};
function xq(a){a=a||[];return"["+Oa(a,function(a){return a?a.toString():"null"}).join(",")+"]"}
;function yq(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)})}
function zq(a){return Oa(a,function(a){return wq(a)})}
function Aq(){return Oa(Xa,function(a){return new vq(a)})}
function Bq(a,b){return a||b?a&&b?a.id==b.id&&a.name==b.name:!1:!0}
function Cq(a,b){return Sa(a,function(a){return a.id==b})}
function Dq(a,b){return Sa(a,function(a){return a||b?!a!=!b?!1:a.id==b.id:!0})}
function Eq(a,b){return Sa(a,function(a){return Qp(a,b)})}
;function Fq(a){sp.call(this);this.D=a;this.screens=[]}
y(Fq,sp);Fq.prototype.ma=function(){return this.screens};
Fq.prototype.contains=function(a){return!!Dq(this.screens,a)};
Fq.prototype.get=function(a){return a?Eq(this.screens,a):null};
function Gq(a,b){var c=a.get(b.f)||a.get(b.id);if(c){var d=c.name;c.id=b.id||c.id;c.name=b.name;c.token=b.token;c.f=b.f||c.f;return c.name!=d}a.screens.push(b);return!0}
function Hq(a,b){var c=a.screens.length!=b.length;a.screens=Na(a.screens,function(a){return!!Dq(b,a)});
for(var d=0,e=b.length;d<e;d++)c=Gq(a,b[d])||c;return c}
function Iq(a,b){var c=a.screens.length;a.screens=Na(a.screens,function(a){return!(a||b?!a!=!b?0:a.id==b.id:1)});
return a.screens.length<c}
Fq.prototype.info=function(a){Mp(this.D,a)};function Jq(a,b,c,d){sp.call(this);this.F=a;this.D=b;this.A=c;this.C=d;this.l=0;this.f=null;this.j=NaN}
y(Jq,sp);var Kq=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=Jq.prototype;g.start=function(){!this.f&&isNaN(this.j)&&this.Yc()};
g.stop=function(){this.f&&(this.f.abort(),this.f=null);isNaN(this.j)||(K(this.j),this.j=NaN)};
g.K=function(){this.stop();Jq.L.K.call(this)};
g.Yc=function(){this.j=NaN;this.f=xj(tq(this.F,"/pairing/get_screen"),{method:"POST",ta:{pairing_code:this.D},timeout:5E3,W:v(this.Ze,this),onError:v(this.Ye,this),sb:v(this.$e,this)})};
g.Ze=function(a,b){this.f=null;var c=b.screen||{};c.dialId=this.A;c.name=this.C;this.G("pairingComplete",new Pp(c))};
g.Ye=function(a){this.f=null;a.status&&404==a.status?this.l>=Kq.length?this.G("pairingFailed",Error("DIAL polling timed out")):(a=Kq[this.l],this.j=I(v(this.Yc,this),a),this.l++):this.G("pairingFailed",Error("Server error "+a.status))};
g.$e=function(){this.f=null;this.G("pairingFailed",Error("Server not responding"))};var Lq;function Mq(){var a=Nq(),b=Oq();Ua(a,b);if(Pq()){var c=a,d;d=0;for(var e=c.length,f;d<e;){var h=d+e>>1,k;k=kb(b,c[h]);0<k?d=h+1:(e=h,f=!k)}d=f?d:~d;0>d&&eb(c,-(d+1),0,b)}a=Qq(a);if(Va(a))try{Bf("remote_sid")}catch(l){}else try{Af("remote_sid",a.join(","),-1,"/")}catch(l){}}
function Nq(){var a=oq("yt-remote-connected-devices")||[];a.sort(kb);return a}
function Qq(a){if(Va(a))return[];var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return Oa(a,function(a,b){return 0==b?a:a.substring(c.length)})}
function Rq(a){mq("yt-remote-connected-devices",a,86400)}
function Oq(){if(Sq)return Sq;var a=oq("yt-remote-device-id");a||(a=yq(),mq("yt-remote-device-id",a,31536E3));for(var b=Nq(),c=1,d=a;Ua(b,d);)c++,d=a+"#"+c;return Sq=d}
function Tq(){return oq("yt-remote-session-browser-channel")}
function Pq(){return oq("yt-remote-session-screen-id")}
function Uq(a){5<a.length&&(a=a.slice(a.length-5));var b=Oa(Vq(),function(a){return a.loungeToken}),c=Oa(a,function(a){return a.loungeToken});
Ra(c,function(a){return!Ua(b,a)})&&Wq();
mq("yt-remote-local-screens",a,31536E3)}
function Vq(){return oq("yt-remote-local-screens")||[]}
function Wq(){mq("yt-remote-lounge-token-expiration",!0,86400)}
function Xq(){return!oq("yt-remote-lounge-token-expiration")}
function Yq(a){mq("yt-remote-online-screens",a,60)}
function Zq(){return oq("yt-remote-online-screens")||[]}
function $q(a){mq("yt-remote-online-dial-devices",a,30)}
function ar(a,b){mq("yt-remote-session-browser-channel",a);mq("yt-remote-session-screen-id",b);var c=Nq(),d=Oq();Ua(c,d)||c.push(d);Rq(c);Mq()}
function br(a){a||(pq("yt-remote-session-screen-id"),pq("yt-remote-session-video-id"));Mq();a=Nq();Za(a,Oq());Rq(a)}
function cr(){if(!Lq){var a;a=new $p;(a=a.isAvailable()?a:null)&&(Lq=new bq(a))}return Lq?!!Lq.get("yt-remote-use-staging-server"):!1}
var Sq="";function dr(a){Fq.call(this,"LocalScreenService");this.j=a;this.f=NaN;er(this);this.info("Initializing with "+Wp(this.screens))}
y(dr,Fq);g=dr.prototype;g.start=function(){er(this)&&this.G("screenChange");Xq()&&fr(this);K(this.f);this.f=I(v(this.start,this),1E4)};
g.Ob=function(a,b){er(this);Gq(this,a);gr(this,!1);this.G("screenChange");b(a);a.token||fr(this)};
g.remove=function(a,b){var c=er(this);Iq(this,a)&&(gr(this,!1),c=!0);b(a);c&&this.G("screenChange")};
g.Lb=function(a,b,c,d){var e=er(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,gr(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.G("screenChange")};
g.K=function(){K(this.f);dr.L.K.call(this)};
function fr(a){if(a.screens.length){var b=Oa(a.screens,function(a){return a.id}),c=tq(a.j,"/pairing/get_lounge_token_batch");
uq(a.j,c,{screen_ids:b.join(",")},v(a.Id,a),v(a.Hd,a))}}
g.Id=function(a){er(this);var b=this.screens.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}gr(this,!b);b&&Mp(this.D,"Missed "+b+" lounge tokens.")};
g.Hd=function(a){Mp(this.D,"Requesting lounge tokens failed: "+a)};
function er(a){var b=Up(Vq()),b=Na(b,function(a){return!a.f});
return Hq(a,b)}
function gr(a,b){Uq(Oa(a.screens,Sp));b&&Wq()}
;function hr(a,b){sp.call(this);this.C=b;for(var c=oq("yt-remote-online-screen-ids")||"",c=c?c.split(","):[],d={},e=this.C(),f=0,h=e.length;f<h;++f){var k=e[f].id;d[k]=Ua(c,k)}this.f=d;this.D=a;this.l=this.A=NaN;this.j=null;ir("Initialized with "+lj(this.f))}
y(hr,sp);g=hr.prototype;g.start=function(){var a=parseInt(oq("yt-remote-fast-check-period")||"0",10);(this.A=x()-144E5<a?0:a)?jr(this):(this.A=x()+3E5,mq("yt-remote-fast-check-period",this.A),this.hc())};
g.isEmpty=function(){return Db(this.f)};
g.update=function(){ir("Updating availability on schedule.");var a=this.C(),b=ub(this.f,function(b,d){return b&&!!Eq(a,d)},this);
kr(this,b)};
function lr(a,b,c){var d=tq(a.D,"/pairing/get_screen_availability");uq(a.D,d,{lounge_token:b.token},v(function(a){a=a.screens||[];for(var d=0,h=a.length;d<h;++d)if(a[d].loungeToken==b.token){c("online"==a[d].status);return}c(!1)},a),v(function(){c(!1)},a))}
g.K=function(){K(this.l);this.l=NaN;this.j&&(this.j.abort(),this.j=null);hr.L.K.call(this)};
function kr(a,b){var c;a:if(vb(b)!=vb(a.f))c=!1;else{c=zb(b);for(var d=0,e=c.length;d<e;++d)if(!a.f[c[d]]){c=!1;break a}c=!0}c||(ir("Updated online screens: "+lj(a.f)),a.f=b,a.G("screenChange"));mr(a)}
function jr(a){isNaN(a.l)||K(a.l);a.l=I(v(a.hc,a),0<a.A&&a.A<x()?2E4:1E4)}
g.hc=function(){K(this.l);this.l=NaN;this.j&&this.j.abort();var a=nr(this);if(vb(a)){var b=tq(this.D,"/pairing/get_screen_availability"),c={lounge_token:zb(a).join(",")};this.j=uq(this.D,b,c,v(this.re,this,a),v(this.qe,this))}else kr(this,{}),jr(this)};
g.re=function(a,b){this.j=null;var c=zb(nr(this));if(gb(c,zb(a))){for(var c=b.screens||[],d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;kr(this,d);jr(this)}else this.P("Changing Screen set during request."),this.hc()};
g.qe=function(a){this.P("Screen availability failed: "+a);this.j=null;jr(this)};
function ir(a){Mp("OnlineScreenService",a)}
g.P=function(a){Mp("OnlineScreenService",a)};
function nr(a){var b={};z(a.C(),function(a){a.token?b[a.token]=a.id:this.P("Requesting availability of screen w/o lounge token.")});
return b}
function mr(a){var b=zb(ub(a.f,function(a){return a}));
b.sort(kb);b.length?mq("yt-remote-online-screen-ids",b.join(","),60):pq("yt-remote-online-screen-ids");a=Na(a.C(),function(a){return!!this.f[a.id]},a);
Yq(Oa(a,Sp))}
;function X(a){Fq.call(this,"ScreenService");this.C=a;this.f=this.j=null;this.l=[];this.A={};or(this)}
y(X,Fq);g=X.prototype;g.start=function(){this.j.start();this.f.start();this.screens.length&&(this.G("screenChange"),this.f.isEmpty()||this.G("onlineScreenChange"))};
g.Ob=function(a,b,c){this.j.Ob(a,b,c)};
g.remove=function(a,b,c){this.j.remove(a,b,c);this.f.update()};
g.Lb=function(a,b,c,d){this.j.contains(a)?this.j.Lb(a,b,c,d):(a="Updating name of unknown screen: "+a.name,Mp(this.D,a),d(Error(a)))};
...
function pr(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);c||(c=a.A[b]);var h=a.ma();if(h=(c?Eq(h,c):null)||Eq(h,b)){h.f=b;var k=qr(a,h);lr(a.f,k,function(a){e(a?k:null)})}else c?rr(a,c,v(function(a){var f=qr(this,new Pp({name:d,
screenId:c,loungeToken:a,dialId:b||""}));lr(this.f,f,function(a){e(a?f:null)})},a),f):e(null)}
g.md=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new Jq(this.C,a,b,c);f.subscribe("pairingComplete",v(function(a){uc(f);d(qr(this,a))},this));
f.subscribe("pairingFailed",function(a){uc(f);e(a)});
f.start();return v(f.stop,f)};
function sr(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];return null}
g.Hc=function(a,b){for(var c=2,d=b(a,c);sr(this,d);){c++;if(20<c)return a;d=b(a,c)}return d};
g.bf=function(a,b,c,d){xj(tq(this.C,"/pairing/get_screen"),{method:"POST",ta:{pairing_code:a},timeout:5E3,W:v(function(a,d){var h=new Pp(d.screen||{});if(!h.name||sr(this,h.name))h.name=this.Hc(h.name,b);c(qr(this,h))},this),
...
function rr(a,b,c,d){a.info("requestLoungeToken_ for "+b);var e={ta:{screen_ids:b},method:"POST",context:a,W:function(a,e){var k=e&&e.screens||[];k[0]&&k[0].screenId==b?c(k[0].loungeToken):d(Error("Missing lounge token in token response"))},
onError:function(){d(Error("Request screen lounge token failed"))}};
xj(tq(a.C,"/pairing/get_lounge_token_batch"),e)}
function tr(a){a.screens=a.j.ma();var b=a.A,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.f=c[e.id]||""}a.info("Updated manual screens: "+Wp(a.screens))}
g.Jd=function(){tr(this);this.G("screenChange");this.f.update()};
function or(a){ur(a);a.j=new dr(a.C);a.j.subscribe("screenChange",v(a.Jd,a));tr(a);a.l=Up(oq("yt-remote-automatic-screen-cache")||[]);ur(a);a.info("Initializing automatic screens: "+Wp(a.l));a.f=new hr(a.C,v(a.ma,a,!0));a.f.subscribe("screenChange",v(function(){this.G("onlineScreenChange")},a))}
function qr(a,b){var c=a.get(b.id);c?(c.f=b.f,b=c):((c=Eq(a.l,b.f))?(c.id=b.id,c.token=b.token,b=c):a.l.push(b),mq("yt-remote-automatic-screen-cache",Oa(a.l,Sp)));ur(a);a.A[b.f]=b.id;mq("yt-remote-device-id-map",a.A,31536E3);return b}
function ur(a){a.A=oq("yt-remote-device-id-map")||{}}
X.prototype.dispose=X.prototype.dispose;function vr(a,b,c){sp.call(this);this.S=c;this.M=a;this.j=b;this.l=null}
y(vr,sp);g=vr.prototype;g.Gb=function(a){this.l=a;this.G("sessionScreen",this.l)};
g.ha=function(a){this.isDisposed()||(a&&wr(this,""+a),this.l=null,this.G("sessionScreen",null))};
g.info=function(a){Mp(this.S,a)};
function wr(a,b){Mp(a.S,b)}
g.od=function(){return null};
g.jc=function(a){var b=this.j;a?(b.displayStatus=new chrome.cast.ReceiverDisplayStatus(a,[]),b.displayStatus.showStop=!0):b.displayStatus=null;chrome.cast.setReceiverDisplayStatus(b,v(function(){this.info("Updated receiver status for "+b.friendlyName+": "+a)},this),v(function(){wr(this,"Failed to update receiver status for: "+b.friendlyName)},this))};
g.K=function(){this.jc("");vr.L.K.call(this)};function xr(a,b){vr.call(this,a,b,"CastSession");this.f=null;this.C=0;this.A=null;this.F=v(this.cf,this);this.D=v(this.Ae,this);this.C=I(v(function(){yr(this,null)},this),12E4)}
y(xr,vr);g=xr.prototype;g.ic=function(a){if(this.f){if(this.f==a)return;wr(this,"Overriding cast sesison with new session object");this.f.removeUpdateListener(this.F);this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D)}this.f=a;this.f.addUpdateListener(this.F);this.f.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.D);this.A&&zr(this);Ar(this,"getMdxSessionStatus")};
g.cb=function(a){this.info("launchWithParams: "+lj(a));this.A=a;this.f&&zr(this)};
...
g.jc=ba;g.K=function(){this.info("disposeInternal");K(this.C);this.C=0;this.f&&(this.f.removeUpdateListener(this.F),this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D));this.f=null;xr.L.K.call(this)};
function zr(a){var b=a.A.videoId||a.A.videoIds[a.A.index];b&&Ar(a,"flingVideo",{videoId:b,currentTime:a.A.currentTime||0});a.A=null}
function Ar(a,b,c){a.info("sendYoutubeMessage_: "+b+" "+lj(c));var d={};d.type=b;c&&(d.data=c);a.f?a.f.sendMessage("urn:x-cast:com.google.youtube.mdx",d,ba,v(function(){wr(this,"Failed to send message: "+b+".")},a)):wr(a,"Sending yt message without session: "+lj(d))}
g.Ae=function(a,b){if(!this.isDisposed())if(b){var c=kj(b);if(c){var d=""+c.type,c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+lj(c));switch(d){case "mdxSessionStatus":yr(this,c.screenId);break;default:wr(this,"Unknown youtube message: "+d)}}else wr(this,"Unable to parse message.")}else wr(this,"No data in message.")};
function yr(a,b){K(a.C);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.l||a.l.id!=b){var c=v(a.Gb,a),d=v(a.ha,a);a.Gc(b,c,d,5)}}else a.ha(Error("Waiting for session status timed out."))}
g.Gc=function(a,b,c,d){pr(this.M,this.j.label,a,this.j.friendlyName,v(function(e){e?b(e):0<=d?(wr(this,"Screen "+a+" appears to be offline. "+d+" retries left."),I(v(this.Gc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.od=function(){return this.f};
g.cf=function(a){this.isDisposed()||a||(wr(this,"Cast session died."),this.ha())};function Br(a,b){vr.call(this,a,b,"DialSession");this.C=this.J=null;this.N="";this.A=null;this.F=ba;this.D=NaN;this.R=v(this.ff,this);this.f=ba}
y(Br,vr);g=Br.prototype;g.ic=function(a){this.C=a;this.C.addUpdateListener(this.R)};
...
g.K=function(){this.f();this.f=ba;K(this.D);this.C&&this.C.removeUpdateListener(this.R);this.C=null;Br.L.K.call(this)};
function Cr(a){a.f=a.M.md(a.N,a.j.label,a.j.friendlyName,v(function(a){this.f=ba;this.Gb(a)},a),v(function(a){this.f=ba;
this.ha(a)},a))}
g.ff=function(a){this.isDisposed()||a||(wr(this,"DIAL session died."),this.f(),this.f=ba,this.ha())};
function Dr(a){var b={};b.pairingCode=a.N;if(a.A){var c=a.A.index||0,d=a.A.currentTime||0;b.v=a.A.videoId||a.A.videoIds[c];b.t=d}cr()&&(b.env_useStageMdx=1);return tf(b)}
g.bc=function(a){this.N=yq();if(this.A){var b=new chrome.cast.DialLaunchResponse(!0,Dr(this));a(b);Cr(this)}else this.F=v(function(){K(this.D);this.F=ba;this.D=NaN;var b=new chrome.cast.DialLaunchResponse(!0,Dr(this));a(b);Cr(this)},this),this.D=I(v(function(){this.F()},this),100)};
g.Pd=function(a,b){pr(this.M,this.J.receiver.label,a,this.j.friendlyName,v(function(a){a&&a.token?(this.Gb(a),b(new chrome.cast.DialLaunchResponse(!1))):this.bc(b)},this),v(function(a){wr(this,"Failed to get DIAL screen: "+a);
this.bc(b)},this))};function Er(a,b){vr.call(this,a,b,"ManualSession");this.f=I(v(this.cb,this,null),150)}
y(Er,vr);Er.prototype.stop=function(){this.ha()};
Er.prototype.ic=ba;Er.prototype.cb=function(){K(this.f);this.f=NaN;var a=Eq(this.M.ma(),this.j.label);a?this.Gb(a):this.ha(Error("No such screen"))};
Er.prototype.K=function(){K(this.f);this.f=NaN;Er.L.K.call(this)};function Fr(a){sp.call(this);this.j=a;this.f=null;this.C=!1;this.l=[];this.A=v(this.oe,this)}
y(Fr,sp);g=Fr.prototype;
...
Jp(Gr),this.j.subscribe("onlineScreenChange",v(this.nd,this)),this.l=Hr(this),chrome.cast.setCustomReceivers(this.l,ba,v(function(a){this.P("Failed to set initial custom receivers: "+lj(a))},this)),this.G("yt-remote-cast2-availability-change",Ir(this)),b(!0))},this),v(function(a){this.P("Failed to initialize API: "+lj(a));
b(!1)},this))};
g.Je=function(a,b){Jr("Setting connected screen ID: "+a+" -> "+b);if(this.f){var c=this.f.l;if(!a||c&&c.id!=a)Jr("Unsetting old screen status: "+this.f.j.friendlyName),uc(this.f),this.f=null}if(a&&b){if(!this.f){c=Eq(this.j.ma(),a);if(!c){Jr("setConnectedScreenStatus: Unknown screen.");return}var d=Kr(this,c);d||(Jr("setConnectedScreenStatus: Connected receiver not custom..."),d=new chrome.cast.Receiver(c.f?c.f:c.id,c.name),d.receiverType=chrome.cast.ReceiverType.CUSTOM,this.l.push(d),chrome.cast.setCustomReceivers(this.l,
ba,v(function(a){this.P("Failed to set initial custom receivers: "+lj(a))},this)));
Jr("setConnectedScreenStatus: new active receiver: "+d.friendlyName);Lr(this,new Er(this.j,d),!0)}this.f.jc(b)}else Jr("setConnectedScreenStatus: no screen.")};
function Kr(a,b){return b?Sa(a.l,function(a){return Qp(b,a.label)},a):null}
...
g.ef=function(){this.isDisposed()?this.P("Stopping session on disposed cast v2"):this.f?(this.f.stop(),uc(this.f),this.f=null):Jr("Stopping non-existing session")};
g.requestSession=function(){chrome.cast.requestSession(v(this.Sc,this),v(this.se,this))};
g.K=function(){this.j.unsubscribe("onlineScreenChange",v(this.nd,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.A);var a=Gr,b=t("yt.mdx.remote.debug.handlers_");Za(b||[],a);uc(this.f);Fr.L.K.call(this)};
function Jr(a){Mp("Controller",a)}
g.P=function(a){Mp("Controller",a)};
function Gr(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)}
function Ir(a){return a.C||!!a.l.length||!!a.f}
function Lr(a,b,c){uc(a.f);(a.f=b)?(c?a.G("yt-remote-cast2-receiver-resumed",b.j):a.G("yt-remote-cast2-receiver-selected",b.j),b.subscribe("sessionScreen",v(a.Tc,a,b)),b.l?a.G("yt-remote-cast2-session-change",b.l):c&&a.f.cb(null)):a.G("yt-remote-cast2-session-change",null)}
g.Tc=function(a,b){this.f==a&&(b||Lr(this,null),this.G("yt-remote-cast2-session-change",b))};
g.oe=function(a,b){if(!this.isDisposed())if(a)switch(Jr("onReceiverAction_ "+a.label+" / "+a.friendlyName+"-- "+b),b){case chrome.cast.ReceiverAction.CAST:if(this.f)if(this.f.j.label!=a.label)Jr("onReceiverAction_: Stopping active receiver: "+this.f.j.friendlyName),this.f.stop();else{Jr("onReceiverAction_: Casting to active receiver.");this.f.l&&this.G("yt-remote-cast2-session-change",this.f.l);break}switch(a.receiverType){case chrome.cast.ReceiverType.CUSTOM:Lr(this,new Er(this.j,a));break;case chrome.cast.ReceiverType.DIAL:Lr(this,
new Br(this.j,a));break;case chrome.cast.ReceiverType.CAST:Lr(this,new xr(this.j,a));break;default:this.P("Unknown receiver type: "+a.receiverType)}break;case chrome.cast.ReceiverAction.STOP:this.f&&this.f.j.label==a.label?this.f.stop():this.P("Stopping receiver w/o session: "+a.friendlyName)}else this.P("onReceiverAction_ called without receiver.")};
g.ce=function(a){if(this.isDisposed())return Promise.reject(Error("disposed"));var b=a.receiver;b.receiverType!=chrome.cast.ReceiverType.DIAL&&(this.P("Not DIAL receiver: "+b.friendlyName),b.receiverType=chrome.cast.ReceiverType.DIAL);var c=this.f?this.f.j:null;if(!c||c.label!=b.label)return this.P("Receiving DIAL launch request for non-clicked DIAL receiver: "+b.friendlyName),Promise.reject(Error("illegal DIAL launch"));if(c&&c.label==b.label&&c.receiverType!=chrome.cast.ReceiverType.DIAL){if(this.f.l)return Jr("Reselecting dial screen."),
this.G("yt-remote-cast2-session-change",this.f.l),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.P('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);Lr(this,new Br(this.j,b))}b=this.f;b.J=a;return b.J.appState==chrome.cast.DialAppState.RUNNING?new Promise(v(b.Pd,b,(b.J.extraData||{}).screenId||null)):new Promise(v(b.bc,b))};
g.Sc=function(a){if(!this.isDisposed()){Jr("New cast session ID: "+a.sessionId);var b=a.receiver;if(b.receiverType!=chrome.cast.ReceiverType.CUSTOM){if(!this.f)if(b.receiverType==chrome.cast.ReceiverType.CAST)Jr("Got resumed cast session before resumed mdx connection."),Lr(this,new xr(this.j,b),!0);else{this.P("Got non-cast session without previous mdx receiver event, or mdx resume.");return}var c=this.f.j,d=Eq(this.j.ma(),c.label);d&&Qp(d,b.label)&&c.receiverType!=chrome.cast.ReceiverType.CAST&&
b.receiverType==chrome.cast.ReceiverType.CAST&&(Jr("onSessionEstablished_: manual to cast session change "+b.friendlyName),uc(this.f),this.f=new xr(this.j,b),this.f.subscribe("sessionScreen",v(this.Tc,this,this.f)),this.f.cb(null));this.f.ic(a)}}};
g.df=function(){return this.f?this.f.od():null};
g.se=function(a){this.isDisposed()||(this.P("Failed to estabilish a session: "+lj(a)),a.code!=chrome.cast.ErrorCode.CANCEL&&Lr(this,null))};
g.pe=function(a){Jr("Receiver availability updated: "+a);if(!this.isDisposed()){var b=Ir(this);this.C=a==chrome.cast.ReceiverAvailability.AVAILABLE;Ir(this)!=b&&this.G("yt-remote-cast2-availability-change",Ir(this))}};
function Hr(a){var b=a.j.ld(),c=a.f&&a.f.j;a=Oa(b,function(a){c&&Qp(a,c.label)&&(c=null);var b=a.f?a.f:a.id,f=Kr(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a}
g.nd=function(){if(!this.isDisposed()){var a=Ir(this);this.l=Hr(this);Jr("Updating custom receivers: "+lj(this.l));chrome.cast.setCustomReceivers(this.l,ba,v(function(){this.P("Failed to set custom receivers.")},this));
var b=Ir(this);b!=a&&this.G("yt-remote-cast2-availability-change",b)}};
Fr.prototype.setLaunchParams=Fr.prototype.Ke;Fr.prototype.setConnectedScreenStatus=Fr.prototype.Je;Fr.prototype.stopSession=Fr.prototype.ef;Fr.prototype.getCastSession=Fr.prototype.df;Fr.prototype.requestSession=Fr.prototype.requestSession;Fr.prototype.init=Fr.prototype.init;Fr.prototype.dispose=Fr.prototype.dispose;function Mr(a,b,c){Nr()?Pr(a)&&(Qr(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?Rr(b):(window.__onGCastApiAvailable=function(a,c){a?Rr(b):(Sr("Failed to load cast API: "+c),Tr(!1),Qr(!1),pq("yt-remote-cast-available"),pq("yt-remote-cast-receiver"),Ur(),b(!1))},c?Rc("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):Dp())):Or("Cannot initialize because not running Chrome")}
function Ur(){Or("dispose");var a=Vr();a&&a.dispose();Wr=null;r("yt.mdx.remote.cloudview.instance_",null,void 0);Xr(!1);Nc(Yr);Yr.length=0}
function Zr(){Or("clearCurrentReciever");pq("yt-remote-cast-receiver")}
function $r(){return oq("yt-remote-cast-installed")?Vr()?Wr.getCastSession():(Sr("getCastSelector: Cast is not initialized."),null):(Sr("getCastSelector: Cast API is not installed!"),null)}
function as(a,b){bs()?Vr().setConnectedScreenStatus(a,b):Sr("setConnectedScreenStatus called before ready.")}
var Wr=null;function Nr(){var a;a=0<=Jb.search(/\ (CrMo|Chrome|CriOS)\//);return Fh||a}
function cs(a){Wr.init(!1,a)}
function Pr(a){var b=!1;if(!Wr){var c=t("yt.mdx.remote.cloudview.instance_");c||(c=new Fr(a),c.subscribe("yt-remote-cast2-availability-change",function(a){mq("yt-remote-cast-available",a);P("yt-remote-cast2-availability-change",a)}),c.subscribe("yt-remote-cast2-receiver-selected",function(a){Or("onReceiverSelected: "+a.friendlyName);
mq("yt-remote-cast-receiver",a);P("yt-remote-cast2-receiver-selected",a)}),c.subscribe("yt-remote-cast2-receiver-resumed",function(a){Or("onReceiverResumed: "+a.friendlyName);
mq("yt-remote-cast-receiver",a)}),c.subscribe("yt-remote-cast2-session-change",function(a){Or("onSessionChange: "+Vp(a));
a||pq("yt-remote-cast-receiver");P("yt-remote-cast2-session-change",a)}),r("yt.mdx.remote.cloudview.instance_",c,void 0),b=!0);
Wr=c}Or("cloudview.createSingleton_: "+b);return b}
function Vr(){Wr||(Wr=t("yt.mdx.remote.cloudview.instance_"));return Wr}
function Rr(a){Tr(!0);Qr(!1);cs(function(b){b?(Xr(!0),P("yt-remote-cast2-api-ready")):(Sr("Failed to initialize cast API."),Tr(!1),pq("yt-remote-cast-available"),pq("yt-remote-cast-receiver"),Ur());a(b)})}
function Or(a){Mp("cloudview",a)}
function Sr(a){Mp("cloudview",a)}
function Tr(a){Or("setCastInstalled_ "+a);mq("yt-remote-cast-installed",a)}
function bs(){return!!t("yt.mdx.remote.cloudview.apiReady_")}
function Xr(a){Or("setApiReady_ "+a);r("yt.mdx.remote.cloudview.apiReady_",a,void 0)}
function Qr(a){r("yt.mdx.remote.cloudview.initializing_",a,void 0)}
var Yr=[];function ds(a){this.videoIds=null;this.index=-1;this.videoId=this.j="";this.volume=this.f=-1;this.l=!1;this.audioTrackId=null;this.C=this.A=0;this.B=null;this.reset(a)}
function es(a,b){if(a.j)throw Error(b+" is not allowed in V3.");}
function fs(a){a.audioTrackId=null;a.B=null;a.f=-1;a.A=0;a.C=x()}
ds.prototype.reset=function(a){this.videoIds=[];this.j="";gs(this);this.volume=-1;this.l=!1;a&&(this.videoIds=a.videoIds,this.index=a.index,this.j=a.listId,this.videoId=a.videoId,this.f=a.playerState,this.volume=a.volume,this.l=a.muted,this.audioTrackId=a.audioTrackId,this.B=a.trackData,this.A=a.playerTime,this.C=a.playerTimeAt)};
function gs(a){a.index=-1;a.videoId="";fs(a)}
function hs(a){return a.j?a.videoId:a.videoIds[a.index]}
function is(a,b){a.A=b;a.C=x()}
function js(a){switch(a.f){case 1:return(x()-a.C)/1E3+a.A;case -1E3:return 0}return a.A}
ds.prototype.setVideoId=function(a){es(this,"setVideoId");var b=this.index;this.index=La(this.videoIds,a);b!=this.index&&fs(this);return-1!=b};
function ks(a,b,c){var d=a.videoId;a.videoId=b;a.index=c;b!=d&&fs(a)}
function ls(a,b,c){es(a,"setPlaylist");c=c||hs(a);gb(a.videoIds,b)&&c==hs(a)||(a.videoIds=cb(b),a.setVideoId(c))}
ds.prototype.remove=function(a){es(this,"remove");var b=hs(this);return Za(this.videoIds,a)?(this.index=La(this.videoIds,b),!0):!1};
function ms(a){var b={};b.videoIds=cb(a.videoIds);b.index=a.index;b.listId=a.j;b.videoId=a.videoId;b.playerState=a.f;b.volume=a.volume;b.muted=a.l;b.audioTrackId=a.audioTrackId;b.trackData=Gb(a.B);b.playerTime=a.A;b.playerTimeAt=a.C;return b}
ds.prototype.clone=function(){return new ds(ms(this))};function ns(a,b){sp.call(this);this.f=0;this.A=a;this.F=[];this.D=new tp;this.C=NaN;this.l=this.j=null;this.N=v(this.Ud,this);this.J=v(this.rb,this);this.M=v(this.Td,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.lc,this),os(this))):c=3;0!=c&&(b?this.lc(c):I(v(function(){this.lc(c)},this),0));
ps(this,$r())}
y(ns,sp);function qs(a){return new ds(a.A.getPlayerContextData())}
g=ns.prototype;g.play=function(){1==this.f?(this.j?this.j.play(null,ba,v(function(){this.P("Failed to play video with cast v2 channel.");rs(this,"play")},this)):rs(this,"play"),ts(this,1,js(qs(this))),us(this)):vs(this,this.play)};
g.pause=function(){1==this.f?(this.j?this.j.pause(null,ba,v(function(){this.P("Failed to pause video with cast v2 channel.");rs(this,"pause")},this)):rs(this,"pause"),ts(this,2,js(qs(this))),us(this)):vs(this,this.pause)};
g.stop=function(){if(1==this.f){this.j?this.j.stop(null,ba,v(function(){this.P("Failed to stop video with cast v2 channel.");rs(this,"stopVideo")},this)):rs(this,"stopVideo");
var a=qs(this);gs(a);ws(this,a);us(this)}else vs(this,this.stop)};
g.uc=function(a){1==this.f?rs(this,"addVideos",{listId:a}):vs(this,w(this.uc,a))};
g.bd=function(a){if(1==this.f){rs(this,"removeVideo",{videoId:a});var b=qs(this);b.j||(b.remove(a),ws(this,b))}else vs(this,w(this.bd,a))};
g.Nc=function(a,b,c){1==this.f?rs(this,"moveVideo",{videoId:a,delta:(b>=c?c:c-1)-b}):vs(this,w(this.Nc,a,b,c))};
g.Kc=function(a){1==this.f?rs(this,"insertVideo",{videoId:a}):vs(this,w(this.Kc,a))};
function xs(a,b,c,d,e){var f=qs(a);d=d||0;var h={videoId:b,currentIndex:d,listId:e||f.j};ks(f,b,d);p(c)&&(is(f,c),h.currentTime=c);rs(a,"setPlaylist",h);e||ws(a,f)}
g.$c=function(a,b){if(1==this.f){var c=qs(this);ks(c,a,b);rs(this,"previous");ws(this,c)}else vs(this,w(this.$c,a,b))};
g.kd=function(a,b){if(1==this.f){var c=qs(this);ks(c,a,b);rs(this,"next");ws(this,c)}else vs(this,w(this.kd,a,b))};
g.Ec=function(){if(1==this.f){rs(this,"clearPlaylist");var a=qs(this);a.reset();ws(this,a);us(this)}else vs(this,this.Ec)};
g.dispose=function(){if(3!=this.f){var a=this.f;this.f=3;this.G("proxyStateChange",a,this.f)}ns.L.dispose.call(this)};
g.K=function(){K(this.C);this.C=NaN;ys(this);this.A=null;this.D.clear();ps(this,null);ns.L.K.call(this)};
function os(a){z(["remotePlayerChange","remoteQueueChange"],function(a){this.F.push(this.A.subscribe(a,w(this.ie,a),this))},a)}
function ys(a){z(a.F,function(a){this.A.unsubscribeByKey(a)},a);
a.F.length=0}
function vs(a,b){50>a.D.Y()&&a.D.j.push(b)}
function ts(a,b,c){var d=qs(a);is(d,c);-1E3!=d.f&&(d.f=b);ws(a,d)}
function rs(a,b,c){a.A.sendMessage(b,c)}
function ws(a,b){ys(a);a.A.setPlayerContextData(ms(b));os(a)}
...
function us(a){K(a.C);a.C=I(v(function(){this.G("remotePlayerChange");this.C=NaN},a),2E3)}
g.ie=function(a){("remotePlayerChange"!=a||isNaN(this.C))&&this.G(a)};
function ps(a,b){a.l&&(a.l.removeUpdateListener(a.N),a.l.removeMediaListener(a.J),a.rb(null));a.l=b;a.l&&(Mp("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.N),a.l.addMediaListener(a.J),a.l.media.length&&a.rb(a.l.media[0]))}
g.Ud=function(a){if(!a)this.rb(null),ps(this,null);else if(this.l.receiver.volume){a=this.l.receiver.volume;var b=qs(this);if(b.volume!=a.level||b.l!=a.muted)Mp("CP","Cast volume update: "+a.level+(a.muted?" muted":"")),b.volume=Math.round(100*a.level||0),b.l=!!a.muted,ws(this,b),us(this)}};
g.rb=function(a){Mp("CP","Cast media: "+!!a);this.j&&this.j.removeUpdateListener(this.M);if(this.j=a)this.j.addUpdateListener(this.M),zs(this),us(this)};
function zs(a){var b=a.j.customData;if(a.j.media){var c=a.j.media,d=qs(a);c.contentId!=d.videoId&&Mp("CP","Cast changing video to: "+c.contentId);d.videoId=c.contentId;d.f=b.playerState;is(d,a.j.getEstimatedTime());ws(a,d)}else Mp("CP","No cast media video. Ignoring state update.")}
g.Td=function(a){a?(zs(this),us(this)):this.rb(null)};
g.P=function(a){Mp("CP",a)};function Y(a,b,c){sp.call(this);this.C=NaN;this.V=!1;this.J=this.F=this.S=this.M=NaN;this.R=[];this.l=this.H=this.f=null;this.Ja=a;this.R.push(T(window,"beforeunload",v(this.Fd,this)));this.j=[];this.H=new ds;3==c["mdx-version"]&&(this.H.j="RQ"+b.token);this.X=b.id;this.f=As(this,c);this.f.subscribe("handlerOpened",this.Zd,this);this.f.subscribe("handlerClosed",this.Vd,this);this.f.subscribe("handlerError",this.Wd,this);this.H.j?this.f.subscribe("handlerMessage",this.Xd,this):this.f.subscribe("handlerMessage",
this.Yd,this);rp(this.f,b.token);this.subscribe("remoteQueueChange",function(){var a=this.H.videoId;Pq()&&mq("yt-remote-session-video-id",a)},this)}
y(Y,sp);g=Y.prototype;
g.connect=function(a,b){if(b){if(this.H.j){var c=b.listId,d=b.videoId,e=b.index,f=b.currentTime||0;5>=f&&(f=0);h={videoId:d,currentTime:f};c&&(h.listId=c);p(e)&&(h.currentIndex=e);c&&(this.H.j=c);this.H.videoId=d;this.H.index=e||0}else{var d=b.videoIds[b.index],f=b.currentTime||0;5>=f&&(f=0);var h={videoIds:d,videoId:d,currentTime:f};this.H.videoIds=[d];this.H.index=0}this.H.state=3;is(this.H,f);this.O("Connecting with setPlaylist and params: "+lj(h));this.f.connect({method:"setPlaylist",params:lj(h)},
a,Tq())}else this.O("Connecting without params"),this.f.connect({},a,Tq());Bs(this)};
g.dispose=function(){this.isDisposed()||(this.G("beforeDispose"),Cs(this,3));Y.L.dispose.call(this)};
g.K=function(){Ds(this);Es(this);Fs(this);K(this.F);this.F=NaN;K(this.J);this.J=NaN;this.l=null;cf(this.R);this.R.length=0;this.f.dispose();Y.L.K.call(this);this.j=this.H=this.f=null};
g.O=function(a){Mp("conn",a)};
g.Fd=function(){this.A(2)};
function As(a,b){return new op(tq(a.Ja,"/bc",void 0,!1),b)}
function Cs(a,b){a.G("proxyStateChange",b)}
function Bs(a){a.C=I(v(function(){this.O("Connecting timeout");this.A(1)},a),2E4)}
function Ds(a){K(a.C);a.C=NaN}
function Fs(a){K(a.M);a.M=NaN}
function Gs(a){Es(a);a.S=I(v(function(){Hs(this,"getNowPlaying")},a),2E4)}
function Es(a){K(a.S);a.S=NaN}
function Is(a){var b=a.f;return!!b.f&&3==b.f.f&&isNaN(a.C)}
g.Zd=function(){this.O("Channel opened");this.V&&(this.V=!1,Fs(this),this.M=I(v(function(){this.O("Timing out waiting for a screen.");this.A(1)},this),15E3));
ar(qp(this.f),this.X)};
g.Vd=function(){this.O("Channel closed");isNaN(this.C)?br(!0):br();this.dispose()};
g.Wd=function(a){br();isNaN(this.D())?(this.O("Channel error: "+a+" without reconnection"),this.dispose()):(this.V=!0,this.O("Channel error: "+a+" with reconnection in "+this.D()+" ms"),Cs(this,2))};
function Js(a,b){b&&(Ds(a),Fs(a));b==Is(a)?b&&(Cs(a,1),Hs(a,"getSubtitlesTrack")):b?(a.N()&&a.H.reset(),Cs(a,1),Hs(a,"getNowPlaying"),Ks(a)):a.A(1)}
function Ls(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.H.videoId&&(Db(b.params)?a.H.B=null:a.H.B=b.params,a.G("remotePlayerChange"))}
function Ms(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);a.H.j=b.params.listId||a.H.j;ks(a.H,c,d);a.G("remoteQueueChange")}
function Ns(a,b){b.params=b.params||{};Ms(a,b);Os(a,b)}
function Os(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);is(a.H,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.H.f&&(c=-1E3);a.H.f=c;1==a.H.f?Gs(a):Es(a);a.G("remotePlayerChange")}
function Ps(a,b){var c="true"==b.params.muted;a.H.volume=parseInt(b.params.volume,10);a.H.l=c;a.G("remotePlayerChange")}
...
Js(this,a);break;case "loungeScreenConnected":Js(this,!0);break;case "loungeScreenDisconnected":ab(this.j,function(a){return"LOUNGE_SCREEN"==a.type});
Js(this,!1);break;case "remoteConnected":var b=new Qn(jj(a.params.device));Sa(this.j,function(a){return a.equals(b)})||Ya(this.j,b);
break;case "remoteDisconnected":b=new Qn(jj(a.params.device));ab(this.j,function(a){return a.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":Ms(this,a);break;case "nowPlaying":Ns(this,a);break;case "onStateChange":Os(this,a);break;case "onVolumeChanged":Ps(this,a);break;case "onSubtitlesTrackChanged":Ls(this,a);break;default:this.O("Unrecognized action: "+a.action)}};
g.Yd=function(a){a.params?this.O("Received: action="+a.action+", params="+lj(a.params)):this.O("Received: action="+a.action);Qs(this,a);Rs(this,a);if(Is(this)){var b=this.H.clone(),c=!1,d,e,f,h,k,l;a.params&&(d=a.params.videoId||a.params.video_id,e=a.params.videoIds||a.params.video_ids,f=a.params.state,h=a.params.currentTime||a.params.current_time,k=a.params.volume,l=a.params.muted,p(a.params.currentError)&&jj(a.params.currentError));if("onSubtitlesTrackChanged"==a.action)d==hs(this.H)&&(delete a.params.videoId,
Db(a.params)?this.H.B=null:this.H.B=a.params,this.G("remotePlayerChange"));else if(hs(this.H)||"onStateChange"!=a.action){"playlistModified"!=a.action&&"nowPlayingPlaylist"!=a.action||e?(d||"nowPlaying"!=a.action&&"nowPlayingPlaylist"!=a.action?d||(d=hs(this.H)):this.H.setVideoId(""),e&&(e=e.split(","),ls(this.H,e,d))):ls(this.H,[]);e=this.H;var n=d;es(e,"add");n&&!Ua(e.videoIds,n)?(e.videoIds.push(n),e=!0):e=!1;e&&Hs(this,"getPlaylist");d&&this.H.setVideoId(d);b.index==this.H.index&&gb(b.videoIds,
this.H.videoIds)?"playlistModified"!=a.action&&"nowPlayingPlaylist"!=a.action||this.G("remoteQueueChange"):this.G("remoteQueueChange");p(f)&&(a=parseInt(f,10),a=isNaN(a)?-1:a,-1==a&&-1E3==this.H.f&&(a=-1E3),0==a&&"0"==h&&(a=-1),c=c||a!=this.H.f,this.H.f=a,1==this.H.f?Gs(this):Es(this));h&&(a=parseInt(h,10),is(this.H,isNaN(a)?0:a),c=!0);p(k)&&(a=parseInt(k,10),isNaN(a)||(c=c||this.H.volume!=a,this.H.volume=a),p(l)&&(l="true"==l,c=c||this.H.l!=l,this.H.l=l));c&&this.G("remotePlayerChange")}}};
function Qs(a,b){switch(b.action){case "loungeStatus":var c=jj(b.params.devices);a.j=Oa(c,function(a){return new Qn(a)});
...
function Rs(a,b){var c=!1;if("loungeStatus"==b.action)c=!!Sa(a.j,function(a){return"LOUNGE_SCREEN"==a.type});
else if("loungeScreenConnected"==b.action)c=!0;else if("loungeScreenDisconnected"==b.action)c=!1;else return;if(!isNaN(a.M))if(c)Fs(a);else return;c==Is(a)?c&&Cs(a,1):c?(Ds(a),a.N()&&a.H.reset(),Cs(a,1),Hs(a,"getNowPlaying"),Ks(a)):a.A(1)}
g.Ie=function(){if(this.l){var a=this.l;this.l=null;this.H.videoId!=a&&Hs(this,"getNowPlaying")}};
Y.prototype.subscribe=Y.prototype.subscribe;Y.prototype.unsubscribeByKey=Y.prototype.wa;Y.prototype.ga=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.D())?Is(this)&&(a=1):a=2);return a};
Y.prototype.getProxyState=Y.prototype.ga;Y.prototype.A=function(a){this.O("Disconnecting with "+a);Ds(this);this.G("beforeDisconnect",a);1==a&&br();pp(this.f,a);this.dispose()};
Y.prototype.disconnect=Y.prototype.A;Y.prototype.fa=function(){var a=this.H;this.l&&(a=this.H.clone(),ks(a,this.l,a.index));return ms(a)};
Y.prototype.getPlayerContextData=Y.prototype.fa;Y.prototype.za=function(a){var b=new ds(a);b.videoId&&b.videoId!=this.H.videoId&&(this.l=b.videoId,K(this.F),this.F=I(v(this.Ie,this),5E3));var c=[];this.H.j==b.j&&this.H.videoId==b.videoId&&this.H.index==b.index&&gb(this.H.videoIds,b.videoIds)||c.push("remoteQueueChange");this.H.f==b.f&&this.H.volume==b.volume&&this.H.l==b.l&&js(this.H)==js(b)&&lj(this.H.B)==lj(b.B)||c.push("remotePlayerChange");this.H.reset(a);z(c,function(a){this.G(a)},this)};
...
Y.prototype.reconnect=Y.prototype.Ka;function Ks(a){K(a.J);a.J=I(v(a.A,a,1),864E5)}
function Hs(a,b,c){c?a.O("Sending: action="+b+", params="+lj(c)):a.O("Sending: action="+b);a.f.sendMessage(b,c)}
Y.prototype.la=function(a,b){Hs(this,a,b);Ks(this)};
Y.prototype.sendMessage=Y.prototype.la;function Ss(){if(!("cast"in window))return!1;var a=window.cast||{};return"ActivityStatus"in a&&"Api"in a&&"LaunchRequest"in a&&"Receiver"in a}
function Ts(a){Mp("CAST",a)}
function Us(a){var b=Vs();b&&b.logMessage&&b.logMessage(a)}
function Ws(){if(!t("yt.mdx.remote.castv2_")&&!Xs&&(Va(Xa)&&db(Xa,oq("yt-remote-online-dial-devices")||[]),Ss())){var a=Vs();a?(a.removeReceiverListener("YouTube",Ys),a.addReceiverListener("YouTube",Ys),Ts("API initialized in the other binary")):(a=new cast.Api,r("yt.mdx.remote.castapi.api_",a,void 0),a.addReceiverListener("YouTube",Ys),a.setReloadTabRequestHandler&&a.setReloadTabRequestHandler(function(){I(function(){window.location.reload(!0)},1E3)}),Jp(Us),Ts("API initialized"));
Xs=!0}}
function Zs(a){var b=Ta(Xa,function(b){return b.id==a.id});
0<=b&&(Xa[b]=wq(a))}
function Ys(a){a.length&&Ts("Updating receivers: "+lj(a));$s(a);P("yt-remote-cast-device-list-update");z(at(),function(a){bt(a.id)});
z(a,function(a){if(a.isTabProjected){var c=ct(a.id);Ts("Detected device: "+c.id+" is tab projected. Firing DEVICE_TAB_PROJECTED event.");I(function(){P("yt-remote-cast-device-tab-projected",c.id)},1E3)}})}
function dt(a,b){Ts("Updating "+a+" activity status: "+lj(b));var c=ct(a);c?(b.activityId&&(c.f=b.activityId),c.status="running"==b.status?"RUNNING":"stopped"==b.status?"STOPPED":"error"==b.status?"ERROR":"UNKNOWN","RUNNING"!=c.status&&(c.f=""),Zs(c),P("yt-remote-cast-device-status-update",c)):Ts("Device not found")}
function at(){Ws();return Aq()}
function $s(a){a=Oa(a,function(a){var c=a.id,d;d=a.name;d=-1!=d.indexOf("&")?"document"in m?Aa(d):Ca(d):d;c={id:c,name:d};if(a=ct(a.id))c.activityId=a.f,c.status=a.status;return c});
Wa();db(Xa,a)}
function ct(a){var b=at();return Sa(b,function(b){return b.id==a})||null}
function bt(a){var b=ct(a),c=Vs();c&&b&&b.f&&c.getActivityStatus(b.f,function(b){"error"==b.status&&(b.status="stopped");dt(a,b)})}
function et(a){Ws();var b=ct(a),c=Vs();c&&b&&b.f?(Ts("Stopping cast activity"),c.stopActivity(b.f,w(dt,a))):Ts("Dropping cast activity stop")}
function Vs(){return t("yt.mdx.remote.castapi.api_")}
var Xs=!1,Xa=t("yt.mdx.remote.castapi.devices_")||[];r("yt.mdx.remote.castapi.devices_",Xa,void 0);function ft(a){sp.call(this);this.A=0;this.Ha=gt();this.C=NaN;this.D=a;this.O("Initializing local screens: "+Wp(this.Ha));this.l=ht();this.O("Initializing account screens: "+Wp(this.l));this.Ub=null;this.f=[];this.j=[];it(this,at()||[]);this.O("Initializing DIAL devices: "+xq(this.j));a=Up(Zq());jt(this,a);this.O("Initializing online screens: "+Wp(this.f));this.A=x()+3E5;kt(this)}
y(ft,sp);g=ft.prototype;g.O=function(a){Mp("RM",a)};
g.P=function(a){Mp("RM",a)};
function ht(){var a=gt(),b=Up(Zq());return Na(b,function(b){return!Dq(a,b)})}
function gt(){var a=Up(Vq());return Na(a,function(a){return!a.f})}
function kt(a){L("yt-remote-cast-device-list-update",function(){var a=at();it(this,a||[])},a);
...
g.ad=function(){var a=at()||[];Va(a)||it(this,a);a=lt(this);Va(a)||(Qa(a,function(a){return!Dq(this.l,a)},this)&&Xq()?mt(this):nt(this,a))};
function ot(a,b){var c=lt(a);return Na(b,function(a){return a.f?(a=Cq(this.j,a.f),!!a&&"RUNNING"==a.status):!!Dq(c,a)},a)}
function it(a,b){var c=!1;z(b,function(a){var b=Eq(this.Ha,a.id);b&&b.name!=a.name&&(this.O("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
c&&(a.O("Renaming due to DIAL."),pt(a));$q(zq(b));var d=!gb(a.j,b,Bq);d&&a.O("Updating DIAL devices: "+xq(a.j)+" to "+xq(b));a.j=b;jt(a,a.f);d&&a.G("onlineReceiverChange")}
g.Se=function(a){var b=Cq(this.j,a.id);b&&(this.O("Updating DIAL device: "+b.id+"("+b.name+") from status: "+b.status+" to status: "+a.status+" and from activityId: "+b.f+" to activityId: "+a.f),b.f=a.f,b.status=a.status,$q(zq(this.j)));jt(this,this.f)};
function jt(a,b,c){var d=ot(a,b),e=!gb(a.f,d,Rp);if(e||c)Va(b)||Yq(Oa(d,Sp));e&&(a.O("Updating online screens: "+Wp(a.f)+" -> "+Wp(d)),a.f=d,a.G("onlineReceiverChange"))}
function nt(a,b){var c=[],d={};z(b,function(a){a.token&&(d[a.token]=a,c.push(a.token))});
...
var e=this.Ub?qt(this,this.Ub):null;e&&!Dq(c,e)&&c.push(e);jt(this,c,!0)}};
xj(tq(a.D,"/pairing/get_screen_availability"),e)}
function mt(a){var b=lt(a),c=Oa(b,function(a){return a.id});
Va(c)||(a.O("Updating lounge tokens for: "+lj(c)),xj(tq(a.D,"/pairing/get_lounge_token_batch"),{ta:{screen_ids:c.join(",")},method:"POST",context:a,W:function(a,c){rt(this,c.screens||[]);this.Ha=Na(this.Ha,function(a){return!!a.token});
pt(this);nt(this,b)}}))}
function rt(a,b){z(bb(a.Ha,a.l),function(a){var d=Sa(b,function(b){return a.id==b.screenId});
d&&(a.token=d.loungeToken)})}
function pt(a){var b=gt();gb(a.Ha,b,Rp)||(a.O("Saving local screens: "+Wp(b)+" to "+Wp(a.Ha)),Uq(Oa(a.Ha,Sp)),jt(a,a.f,!0),it(a,at()||[]),a.G("managedScreenChange",lt(a)))}
g.Hc=function(a,b){for(var c=lt(this),c=Oa(c,function(a){return a.name}),d=a,e=2;Ua(c,d);)d=b.call(m,e),e++;
return d};
function qt(a,b){var c=Eq(lt(a),b);a.O("Found screen: "+Vp(c)+" with key: "+b);return c}
function lt(a){return bb(a.l,Na(a.Ha,function(a){return!Dq(this.l,a)},a))}
;function tt(a){Fq.call(this,"ScreenServiceProxy");this.ea=a;this.f=[];this.f.push(this.ea.$_s("screenChange",v(this.af,this)));this.f.push(this.ea.$_s("onlineScreenChange",v(this.he,this)))}
y(tt,Fq);g=tt.prototype;g.ma=function(a){return this.ea.$_gs(a)};
...
g.K=function(){for(var a=0,b=this.f.length;a<b;++a)this.ea.$_ubk(this.f[a]);this.f.length=0;this.ea=null;tt.L.K.call(this)};
g.af=function(){this.G("screenChange")};
g.he=function(){this.G("onlineScreenChange")};
X.prototype.$_st=X.prototype.start;X.prototype.$_gspc=X.prototype.bf;X.prototype.$_gsppc=X.prototype.md;X.prototype.$_c=X.prototype.contains;X.prototype.$_g=X.prototype.get;X.prototype.$_a=X.prototype.Ob;X.prototype.$_un=X.prototype.Lb;X.prototype.$_r=X.prototype.remove;X.prototype.$_gs=X.prototype.ma;X.prototype.$_gos=X.prototype.ld;X.prototype.$_s=X.prototype.subscribe;X.prototype.$_ubk=X.prototype.wa;function ut(a,b,c){a?r("yt.mdx.remote.castv2_",!0,void 0):Ws();lq&&kq();Mq();vt||(vt=new sq,cr()&&(vt.f="/api/loungedev"));wt||a||(wt=new ft(vt),wt.subscribe("screenPair",xt),wt.subscribe("managedScreenChange",zt),wt.subscribe("onlineReceiverChange",function(){P("yt-remote-receiver-availability-change")}));
At||(At=t("yt.mdx.remote.deferredProxies_")||[],r("yt.mdx.remote.deferredProxies_",At,void 0));Bt(b);b=Ct();if(a&&!b){var d=new X(vt);r("yt.mdx.remote.screenService_",d,void 0);b=Ct();Mr(d,function(a){a?Dt()&&as(Dt(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){P("yt-remote-receiver-availability-change")})},!(!c||!c.loadCastApiSetupScript))}if(c&&!t("yt.mdx.remote.initialized_")){r("yt.mdx.remote.initialized_",!0,void 0);
Et("Initializing: "+lj(c));Ft.push(L("yt-remote-cast2-availability-change",function(){P("yt-remote-receiver-availability-change")}));
Ft.push(L("yt-remote-cast2-receiver-selected",function(){Gt();P("yt-remote-auto-connect","cast-selector-receiver")}));
Ft.push(L("yt-remote-cast2-session-change",Ht));Ft.push(L("yt-remote-connection-change",function(a){a?as(Dt(),"YouTube TV"):It()||(as(null,null),Zr())}));
var e=Jt();c.isAuto&&(e.id+="#dial");e.name=c.device;e.app=c.app;Et(" -- with channel params: "+lj(e));Kt(e);a&&b.start();Dt()||Lt()}}
function Mt(){var a=Dt();if(!a)return null;if(!wt){var b=Ct().ma();return Eq(b,a)}return qt(wt,a)}
function Ht(a){Et("remote.onCastSessionChange_: "+Vp(a));if(a){var b=Mt();b&&b.id==a.id?as(b.id,"YouTube TV"):(b&&Nt(),Ot(a,1))}else Nt()}
function Nt(){if(wt){var a=wt;K(a.C);a.C=NaN}a:{if(a=Pt())if(a=a.getOtherConnectedRemoteId()){Et("Do not stop DIAL due to "+a);Qt();break a}(a=t("yt.mdx.remote.currentDialId_"))?(Et("Stopping DIAL: "+a),et(a),Qt()):(a=Mt())&&a.f&&(Et("Stopping DIAL: "+a.f),et(a.f))}bs()?Vr().stopSession():Sr("stopSession called before API ready.");(a=Pt())?a.disconnect(1):(Oc("yt-remote-before-disconnect",1),Oc("yt-remote-connection-change",!1));Rt(null)}
function St(){var a=Pt();return a&&3!=a.getProxyState()?new ns(a,void 0):null}
function Et(a){Mp("remote",a)}
function Tt(){return t("yt.mdx.remote.screenService_")}
function Ct(){if(!Ut){var a=Tt();Ut=a?new tt(a):null}return Ut}
function Dt(){return t("yt.mdx.remote.currentScreenId_")}
function Vt(a){r("yt.mdx.remote.currentScreenId_",a,void 0);if(wt){var b=wt;b.A=x()+3E5;if((b.Ub=a)&&(a=qt(b,a))&&!Dq(b.f,a)){var c=cb(b.f);c.push(a);jt(b,c,!0)}}}
function Qt(){r("yt.mdx.remote.currentDialId_","",void 0)}
function Gt(){r("yt.mdx.remote.connectData_",null,void 0)}
function Pt(){return t("yt.mdx.remote.connection_")}
function Rt(a){var b=Pt();Gt();a?Ka(!Pt()):(Vt(""),Qt());r("yt.mdx.remote.connection_",a,void 0);At&&(z(At,function(b){b(a)}),At.length=0);
b&&!a?Oc("yt-remote-connection-change",!1):!b&&a&&P("yt-remote-connection-change",!0)}
function It(){var a=Pq();if(!a)return null;if(Tt()){var b=Ct().ma();return Eq(b,a)}return wt?qt(wt,a):null}
function Ot(a,b){Ka(!Dt());Vt(a.id);var c=new Y(vt,a,Jt());c.connect(b,t("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){Oc("yt-remote-before-disconnect",a)});
c.subscribe("beforeDispose",function(){Pt()&&(Pt(),Rt(null))});
Rt(c)}
function Lt(){var a=It();a?(Et("Resume connection to: "+Vp(a)),Ot(a,0)):(br(),Zr(),Et("Skipping connecting because no session screen found."))}
function xt(a){Et("Paired with: "+Vp(a));a?Ot(a,1):Rt(null)}
function zt(){var a=Dt();a&&!Mt()&&(Et("Dropping current screen with id: "+a),Nt());It()||br()}
var vt=null,At=null,Ut=null,wt=null;function Bt(a){var b=Jt();if(Db(b)){var b=Oq(),c=oq("yt-remote-session-name")||"",d=oq("yt-remote-session-app")||"",b={device:"REMOTE_CONTROL",id:b,name:c,app:d};a&&(b["mdx-version"]=3);r("yt.mdx.remote.channelParams_",b,void 0)}}
function Jt(){return t("yt.mdx.remote.channelParams_")||{}}
function Kt(a){a?(mq("yt-remote-session-app",a.app),mq("yt-remote-session-name",a.name)):(pq("yt-remote-session-app"),pq("yt-remote-session-name"));r("yt.mdx.remote.channelParams_",a,void 0)}
var Ft=[];function Wt(a){ok.call(this);this.M={Eb:a.Eb,Db:v(function(){jh.getInstance().ab(this.xa());ga(a.Db)&&a.Db()},this)};
this.A=this.B=null}
y(Wt,ok);Wt.prototype.Da=function(){Wt.L.Da.call(this);this.B=R(F(this.xa(),"dialog-id"));if(!this.B)throw Error("Cannot find create playlist widget dialog.");lk(this).Ga(document,"click",this.F);var a=L("yt-uix-card-show",v(this.J,this));this.ga.push(a);a=S("create-playlist-widget-form",this.B);this.A=new Ik(this.M);mk(this.A,a)};
Wt.prototype.Ea=function(){this.B=null;this.A.dispose();this.A=null;Wt.L.Ea.call(this)};
Wt.prototype.F=function(a){be(this.B,ff(a))||jh.getInstance().ab(this.xa())};
Wt.prototype.J=function(a){a==this.xa()&&kk(this.A,"title-input").focus()};function Xt(){this.f="scroller";this.j={}}
y(Xt,Zg);ca(Xt);Xt.prototype.dispose=function(){for(var a in this.j){var b=this.j[a],c=this.aa(b,"scroller-mousewheel-listener")||"";ac(b,"scroller-mousewheel-listener","");var d=this.aa(b,"scroller-scroll-listener")||"";ac(b,"scroller-scroll-listener","");cf(c);cf(d);ac(b,"scroller-scroll-listener","");b&&(b=ia(b).toString(),delete this.j[b])}this.j={}};var rb,Yt,V,Zt,$t,au,bu,cu,du,eu,fu,gu,hu,iu,ju,Z,ae;var ku;function lu(a,b){this.type=a;this.videoIds=b||[]}
function mu(a,b){xj("/watch_queue_ajax",{method:"POST",Qa:{action_check_playability:1},ta:{video_ids:a.join(",")},W:function(a,d){d&&ea(d)?b(d):b([])},
onError:function(){b([])}})}
function nu(a){u(a)&&(a=[a]);var b=new lu(1,a);ku?ou(function(){z(a,function(a){ku.bd(a)})},b,void 0):pu(b,a)}
function qu(a,b,c){var d=new lu(2);ku&&ou(function(){ku.Nc(a,b,c)},d,void 0)}
function ru(a){mu([a],function(b){Va(b)||tu(a)})}
function tu(a){var b=new lu(2);ku&&ou(function(){ku.Kc(a)},b,void 0)}
function uu(a){var b=new lu(2);ku&&ou(function(){ku.uc(a)},b,void 0)}
function vu(a,b,c){b?mu([b],function(d){Va(d)||wu(a,b,c)}):wu(a,b,c)}
function wu(a,b,c){ku&&ou(function(){b&&xs(ku,b,0,0,a)},void 0,c)}
function xu(a,b,c){mu(b,function(b){Va(b)||!Ua(b,a)||yu(a,b,c)})}
function yu(a,b,c){ku&&ou(function(){var c=ku;xs(c,a);rs(c,"updatePlaylist",{videoIds:b.join(",")})},void 0,c)}
function zu(){var a=new lu(2);ku&&ou(function(){ku.stop();ku.Ec()},a,void 0)}
function Au(a){ku=a;ku.subscribe("remoteQueueChange",function(){P("queue-change",new lu(2))})}
function Bu(){var a=St();uc(ku);ku=null;a?Au(a):P("queue-change",new lu(2))}
function ou(a,b,c){ku&&1==ku.f&&(a.call(m),c&&I(function(){c()},0),p(b)&&P("queue-change",b))}
function pu(a,b){xj("/watch_queue_ajax",{method:"POST",Qa:{action_remove_from_watch_queue:1},ta:{list:"WQ",video_ids:b.join(",")},W:function(){P("queue-change",a)},
onError:function(){}})}
var Cu=[];var Du;function Eu(){if(!Du){var a=R("watch-queue");if(!a)return[];Du=S("watch-queue-items-list",a)}var b=[],a=Vd(Du);z(a,function(a){(a=F(a,"video-id"))&&b.push(a)});
return b}
;function Fu(){P("yt-dom-content-change",Z)}
r("yt.www.watchqueue.loadThumbnails",Fu,void 0);
function Gu(){ae=R("watch-queue");du=S("watch-queue-control-bar",ae);eu=S("watch-queue-count",du);fu=S("yt-uix-button-dark-overflow-action-menu",du);gu=S("prev-watch-queue-button",ae);hu=S("next-watch-queue-button",ae);iu=S("play-watch-queue-button",ae);ju=S("pause-watch-queue-button",ae);Z=S("watch-queue-items-list",ae);Hu.push(df(ae,"click",Iu,"yt-uix-button"));Hu.push(df(ae,"click",Ju,"watch-queue-video"));Hu.push(df(ae,"click",Ku,"control-bar-button"));Hu.push(T(Z,Oe,Lu));Hu.push(df(Z,Oe,Mu,"watch-queue-item"));
Hu.push(df(null,"click",Nu,"watch-queue-video-menu-choice"));Hu.push(df(null,"click",Ou,"watch-queue-menu-choice"));bu=new zk(R("watch-queue-count-msg").innerHTML,["count","total"]);cu=Ck(R("watch-queue-loading-template"));Pu=0;Zt=!1;var a=R("watch-queue-save-as-playlist-widget");a&&(au=new Wt({Eb:Qu}),mk(au,a));Yt=null;ut(!!H("MDX_ENABLE_CASTV2"),!0,{device:"Desktop",app:"youtube-desktop",isSignedIn:H("LOGGED_IN")});ut(!!H("MDX_ENABLE_CASTV2"),!!H("MDX_ENABLE_QUEUE"));Cu.push(L("yt-remote-connection-change",
Bu));(a=St())&&Au(a);Ru.push(L("init",Su));Ru.push(L("dispose",Tu));Ru.push(L("yt-remote-before-disconnect",Uu));Ru.push(L("yt-remote-connection-change",Vu));Vu();Su();Ru.push(L("queue-change",Wu));Ru.push(L("watch-queue-addto-video-added",Xu));Ru.push(L("watch-queue-addto-video-removed",Xu));Ru.push(L("watch-queue-addto-video-play-next",Yu));Ru.push(L("watch-queue-addto-video-play-now",Zu));Ru.push(L("watch-queue-addto-playlist-added",Xu));Ru.push(L("watch-queue-addto-playlist-removed",Xu));Ru.push(L("watch-queue-addto-playlist-play-next",
$u));Ru.push(L("watch-queue-addto-playlist-play-now",av))}
function bv(){var a=R("player-playlist");return a?$d()==a:!1}
function cv(){var a=!1;if(!V||!Ag(rb)||!H("PAGE_NAME"))return dv(),a;var b=ev(),c=fv();gv()&&c&&b!=c&&(hv(c),b=c);c=!!H("LIST_ID");if(b=gv()&&!!b&&(b==H("VIDEO_ID")||b==$t)&&!c){var d=R("player-playlist");d&&!bv()&&(C(rb,"mole-notification"),Sd(d,ae,0),P("watch-queue-show",1),iv(),a=!0)}else $d()!=rb&&(rb.appendChild(ae),P("watch-queue-show",0),Fu(),a=!0);d=R("placeholder-playlist");b||c?Cg(d):Dg(d);dv();return a}
function hv(a){if(Yt){var b=!!V,c=b&&!(a&&(a==H("VIDEO_ID")||a==$t));dj(c);b&&gv()&&(c?P("watch-queue-show",0):P("watch-queue-show",1));if(Yt.isReady())Yt.loadVideoById(a);else{var d=function(){Yt.loadVideoById(a);Yt.removeEventListener("onReady",d)};
Yt.addEventListener("onReady",d)}}}
function ev(){return Yt&&Yt.isReady()?Yt.getVideoData().video_id:""}
function fv(){return V?qs(V).videoId:""}
function jv(a){ev()!=kv()&&lv(ev());mv(1==a);cv()}
function dv(){Yt&&(ev()?Zt||dj(!!V&&(Ag(rb)||nv())&&$d()==rb):dj(!1))}
function Su(){C(rb,"mole-notification");$t="";aj();cv();var a=Yt;a&&a.addEventListener("onStateChange",jv)}
function Tu(){sb(rb,"mole-expanded","mole-collapsed");var a=Yt;a&&a.removeEventListener("onStateChange",jv)}
function gv(){return"watch"==H("PAGE_NAME")}
function ov(a){if(a!=kv()){var b=Eu(),c=b[0];pv()&&(c=b[qv()+1]);if(a!=c)if(Ua(b,a)){var d=La(b,a),b=La(b,c);qu(a,d,b)}else ru(a)}}
function Iu(a){if(a.currentTarget==gu){if(nv()){var b=Vd(Z);a=qv();b=b.length;a=(b+a-1)%b;rv(a);iv();(b=kv())&&V&&V.$c(b,a)}}else if(a.currentTarget==hu)nv()&&(a=Vd(Z),a=(qv()+1)%a.length,rv(a),iv(),(b=kv())&&V&&V.kd(b,a));else if(a.currentTarget==iu)Dg(iu),Cg(ju),V?(a=Eu(),!fv()&&a[0]?xs(V,a[0]):V.play()):Yt&&Yt.playVideo();else if(a.currentTarget==ju)Dg(ju),Cg(iu),V?V.pause():Yt&&Yt.pauseVideo();else if(A(a.currentTarget,"remove-item-watch-queue-button")){if(a=ge(a.currentTarget,"watch-queue-item"),
b=F(a,"video-id"))B(a,"fade-out"),nu(b)}else A(a.currentTarget,"expand-video-watch-queue-button")&&tv(a.currentTarget)}
function Ou(a){var b=F(a.currentTarget,"action");uv[b](a.currentTarget);a=a||window.event;a.cancelBubble=!0;a.stopPropagation&&a.stopPropagation();bh($g.getInstance(),fu)}
function Ku(a){$d()==rb&&a.currentTarget==du&&(a=ff(a),a&&A(a,"overflow-menu-choice")||(qb("mole-expanded"),qb("mole-collapsed")))}
function Nu(a){var b=F(a.currentTarget,"action");vv[b](a.currentTarget)}
function Lu(){C(rb,"mole-notification");A(rb,"mole-expanded")&&Fu();bh($g.getInstance(),fu)}
function Mu(a){A(a.currentTarget,"fade-out")&&(Td(a.currentTarget),lv(fv()),wv());Fu()}
function Ju(a){a=ge(a.currentTarget,"watch-queue-item");if(!A(a,"currently-playing")){var b=Vd(Z),b=La(b,a);rv(b);(a=F(a,"video-id"))&&V&&xs(V,a,0,b)}}
function Qu(a){var b=a.playlistId,c=a.De;b&&c&&(a={videoIds:Eu().join(","),fullListId:b,W:function(){Jg(c)}},Hk(a))}
function tv(a){A(a,"disabled")||(a=F(a,"video-id"))&&xv(a)}
function pv(){return!!S("currently-playing",Z)}
function qv(){var a=S("currently-playing",Z);if(a){var b=Vd(Z);return La(b,a)}return 0}
function kv(){var a=S("currently-playing",Z);return a?F(a,"video-id")||"":""}
function lv(a){a=La(Eu(),a);0<=a?pv()&&qv()==a||(rv(a),iv()):yv()}
function rv(a){if(nv()){yv();var b=Vd(Z);b[a]&&B(b[a],"currently-playing");zv()}}
function yv(){if(nv()){var a=S("currently-playing",Z);a&&C(a,"currently-playing");zv()}}
function Yu(a){ov(a);Xu()}
function Zu(a){V&&xs(V,a);a!=kv()&&(hv(a),Xu());$t=a}
function $u(a){Eu();pv()&&qv();uu(a);Xu()}
function av(a,b,c){b&&(c?xu(b,c,function(){$t=b}):vu(a,b,function(){$t=b}),Xu())}
function Xu(){Ag(rb)&&B(rb,"mole-notification")}
function Av(){var a=pv()?qv()+1:0,b=Eu().length;0<a&&0<b?eu.innerHTML=bu.render({count:a,total:b}):Rd(eu)}
function mv(a){a?(Dg(iu),Cg(ju)):(Dg(ju),Cg(iu))}
function zv(){var a=Eu().length,b=1>=a,c=pv()?qv():-1;gu.disabled=b||0==c;hu.disabled=b||c==a-1;Av();if(0!=a){var d=null,a=Vd(Z);z(a,function(a){var b=F(a,"video-id"),c=S("play-next",a),k=S("goto-video-page",a);pb(k,"disabled",gv()&&b==H("VIDEO_ID")&&!H("LIST_ID"));A(a,"currently-playing")?(d=a,Dg(c)):d?(d=null,pb(c,"disabled",!0)):pb(c,"disabled",!1)})}}
function wv(){zv();Va(Eu())?Bv():Cv();P("watch-queue-update")}
function Dv(){Pu=0;K(Ev);Ev=NaN}
function Fv(){Zt=!1;isNaN(Ev)&&(Ev=I(function(){Ev=NaN;Pu++;Gv()},Math.min(3E4,1E3*Math.pow(2,Pu))))}
function nv(){var a=Wd(Z);return!!a&&A(a,"watch-queue-item")}
function Gv(){if(!Zt){Zt=!0;var a;ku?(a=Pt(),a="RQ"+(a?a.getLoungeToken():"")):a="WQ";xj("/watch_queue_ajax",{method:"GET",Qa:{action_get_watch_queue_items:1,list:a},W:Hv,onError:Fv,sb:Fv});nv()?Cv():(Z.innerHTML=cu.render({}),wv())}}
function Hv(a,b){Zt=!1;if(Z&&b&&(b.html||!fv())&&(Dv(),V)){var c=Eu(),d=[],e=Qd(b.html),f=Na(e.childNodes,function(a){return ha(a)&&1==a.nodeType});
z(f,function(a){a=F(a,"video-id");d.push(a)});
0==c.length&&Rd(Z);if(0==d.length)Rd(Z),P("watch-queue-empty"),wv();else if(!gb(c,d)){if(d.length==c.length+1){for(var h=0;h<c.length&&c[h]==d[h];)h++;var k=cb(c);eb(k,h,0,d[h]);if(gb(k,d)){Sd(Z,f[h],h);B(f[h],"fade-in");I(function(){C(f[h],"fade-in")},0);
lv(fv());Fu();wv();return}}if(d.length==c.length-1){for(e=0;e<d.length&&c[e]==d[e];)e++;k=cb(c);$a(k,e);if(gb(k,d)){c=Vd(Z);B(c[e],"fade-out");lv(fv());return}}Rd(Z);Va(f)||(z(f,function(a){Z.appendChild(a)}),Fu(),lv(fv()));
wv()}}}
function iv(){var a=S("currently-playing",Z);if(a){var b=Xt.getInstance(),c=Z;if(c&&a){var d=Ed(U(b,"scroll-unit"),c),a=La(d,a);if(0<=a&&!(!c||isNaN(a)||0>a)&&(b=Ed(U(b,"scroll-unit"),c),!(0>=b.length))){a>=b.length&&(a=b.length-1);if(b.length){var d=b[0],e=d.offsetHeight;1<b.length&&(e=b[1].offsetTop-d.offsetTop);d=e}else d=0;e=c.offsetHeight;a>Math.max(Math.floor(c.scrollTop/d),0)-1&&(d=Math.floor(e/d),e=b.length,a+d>e&&(a=e-d+1));0>a&&(a=0);a=b[a].offsetTop;c&&!isNaN(a)&&(0>a&&(a=0),c.scrollTop=
a,ac(c,"scroller-offset",a+""),P("yt-dom-content-change",c))}}}Fu()}
function xv(a){a=uf("/watch",{v:a});Jg(a)}
function Iv(a){gv()&&(a!=H("VIDEO_ID")||H("LIST_ID")?(I(function(){xv(a)},100),$t=a):cv())}
function Uu(a){Jv=a}
function Vu(){var a=St();uc(V);V=null;Dv();Rd(Z);wv();a?(V=a,V.subscribe("proxyStateChange",Kv),V.subscribe("remotePlayerChange",Lv),Jv=null):Bv();2!=Jv&&(aj(),P("watch-queue-remote-connection",!!a))}
function Cv(){Cg(rb);if(!cv()){var a=$d()==rb?0:1;P("watch-queue-show",a)}}
function Bv(){$d()!=rb&&rb.appendChild(ae);var a=R("placeholder-playlist");H("LIST_ID")?Cg(a):Dg(a);sb(rb,"mole-expanded","mole-collapsed");Dg(rb);dv();P("watch-queue-hide",0)}
function Kv(a,b){Dv();1==b&&Gv()}
function Lv(){var a=qs(V);mv(1==a.f)}
function Wu(){if(V){var a=kv(),b=fv();b&&b!=a&&lv(b);b&&(bv()||$t==b)&&Iv(b);Gv()}}
var uv={"remove-all":function(){zu();Rd(Z);wv();P("watch-queue-empty");Bv()},
"save-as-playlist":function(){if(!Va(Eu())){var a=au;jh.getInstance().pc(a.xa())}},
disconnect:function(){Nt()}},vv={"play-next":function(a){A(a,"disabled")||(a=F(a,"video-id"))&&ov(a)},
"goto-video-page":tv},Hu=[],Ru=[],Pu=0,Ev=NaN,Jv=null;var Mv;function Nv(a){Ov(R("yt-picker-"+a+"-footer"),a,!1,!1,!0);R("footer").scrollIntoView()}
function Ov(a,b,c,d,e){c||(Mv&&Mv!=a&&Dg(Mv),Mv=a,e?Cg(a):Eg(a));d?S("yt-close",a).focus():(c={},c["action_"+b]=1,c.base_url=window.location.href.split("#",1)[0],xj("/picker_ajax",{format:"JSON",method:"GET",Qa:c,W:v(Pv,null,a),onError:function(){Dg(a)}}))}
function Pv(a,b,c){if(c&&c.html){ac(a,"loaded",1);a.innerHTML=c.html;Qv(a);c=(b=document.body||Ld(document))||Ld(document);var d=ve(a),e=ve(c),f=Je(c);if(c==Ld(document)){var h=d.x-c.scrollLeft,d=d.y-c.scrollTop;Q&&!td(10)&&(h+=f.left,d+=f.top)}else h=d.x-e.x-f.left,d=d.y-e.y-f.top;var f=c.clientHeight-a.offsetHeight,e=c.scrollLeft,k=c.scrollTop,e=e+Math.min(h,Math.max(h-(c.clientWidth-a.offsetWidth),0)),k=k+Math.min(d,Math.max(d-f,0));c=new ed(e,k);b.scrollLeft=c.x;b.scrollTop=c.y;S("yt-close",a).focus()}else Dg(a)}
function Qv(a,b){var c=S("yt-picker-content",a);if(c){var d=Fd(null,"yt-picker-section",c);z(d,v(Rv,null,Math.floor((b||c.offsetWidth)/180)))}else Cc(Error(".yt-picker-content missing"),"WARNING")}
function Rv(a,b){for(var c=Fd(null,"yt-picker-item",b),d=Math.ceil(c.length/a),e,f=document.createElement("div"),h=0;h<a;h++){e=document.createElement("div");e.className="yt-picker-grid";for(var k=d*h;k<d*(h+1);k++)c[k]&&e.appendChild(c[k]);e.children.length&&f.appendChild(e)}c=Se(f);for(Rd(b);0<c.childNodes.length;)b.appendChild(c.childNodes[0])}
...
r("yt.www.masthead.loadSearchbox",Qm,void 0);r("yt.net.cookies.set",Af,void 0);r("yt.net.cookies.remove",Bf,void 0);r("yt.www.picker.load",function(a){var b=F(a,"picker-key"),c=F(a,"picker-position"),d="yt-picker-"+b+"-"+c;if(c=R(d))a=F(a,"button-menu-id")==d,d=F(c,"loaded"),Ov(c,b,!!a,!!d)},void 0);
r("yt.www.picker.displayLang",function(){Nv("language")},void 0);
r("yt.www.picker.applyGrid",Qv,void 0);
...
S("guide-module-loading")||ql();O.init();Rk=S("yt-masthead-user-icon");df(R("ticker"),"click",Pm,"yt-uix-close");S("exp-searchbox-redesign")&&(T(R("yt-masthead-content"),"click",Tm),T(R("masthead-search-term"),"keyup",Um));H("SANDBAR_ENABLED")&&Nm();H("YOODLE_DELAY_LOAD_EXP")&&H("YOODLE_IS_ANIMATED")&&Mm();Qm();an();(rb=R("watch-queue-mole"))?Gu():H("MDX_ENABLE_CASTV2")&&ut(!0,!1,{device:"Desktop",app:"youtube-desktop",isSignedIn:H("LOGGED_IN")});H("YOODLE_IS_ANIMATED")&&Rc(H("YOODLE_JS_URL",void 0),
...
H("SAFETY_MODE_PENDING")&&Nv("safetymode")},void 0);
