...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("SROxneGPyLPScyUhAAxtkXqAe84")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return xe(t);if("auto-content"===e)return"auth"===n?Ie(t):Qe(t);if("action"===e)return"auth"===n?!!s==!1?Pe(t):Qe(t):Qe(t);
...
}return Qe(t)}return"default"===e?q(t):"env"===e?"i-global"===n?He(t):Qe(t):"content"===e?S(t):"jsAttr"===e?We(t):"tag"===e?C(t):"cls"===e?Ke(t):"bem"===e?Ae(t):Qe(t)
...
}function g(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Re(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
...
}),n)if(t.isSimple(n))s.href=n;else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,Re(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
}else s.role="button",s.tabindex||(s.tabindex=0);return s}function B(){return void 0}function C(t){var e=n;
if("b-icon"===e)return!!s==!1?"img":I(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":D(t):D(t);if("input"===e){var e=s;
return"box"===e?"span":"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":I(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":I(t)}if("ticker"===e){var e=s;
return"value"===e||"text"===e?"span":I(t)}if("checkbox"===e){var e=s;return"control"===e?"input":"label"===e?"label":!!s==!1?"span":I(t)
}if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":I(t):"a11y"===e?"span":"items"===e?"ul":I(t)
}if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":I(t)
}if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":I(t)
}if("b-autocomplete-item"===e)return!!s==!1?"li":I(t);if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":I(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":I(t)}return"link"===e?"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":I(t):"b-link"===e?!!s==!1?"a":I(t):I(t)
}function D(t){return!!s==!1?"button":I(t)}function I(){return void 0}function S(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:N(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:N(t);if("input"===e){var e=s;
return"box"===e?P(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:N(t)}if("auth"===e){var e=s;
...
if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Oe(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):N(t)
...
}return A(t)}return A(t)}if("popup"===e)return!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:N(t);
if("tumbler"===e)return"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1?!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:R(t):R(t);
if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Te(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:N(t)
}return N(t)}function P(t){if(!(t.__$anflg28!==!0)==!1){if(!!r.clear==!1){var e,i;return[(e=t.__$anflg28,t.__$anflg28=!0,i=P(t),t.__$anflg28=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
}return N(t)}return N(t)}function T(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Ie(t),i=e,n),{elem:"retpath"}]
}return N(t)}function O(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):N(e)}function A(e){return!(r&&"foot"===r.type)==!1?!!s==!1?e.ctx.data.slice(1).map(function(t){return this._.isArray(t)?{tag:"span",elem:"foot",content:t[0]}:t
...
return i.highlight(n,t.ctx.hl)}return N(t)}function R(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return N(t)
}function N(t){return t.ctx.content}function q(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg34!==!0)==!1?$(t):Qe(t):Qe(t);
...
var r=i;i="",Re(t),t.ctx=o,i=r,t.__$anflg34=s}function F(t){return!(t.__$anflg33!==!0)==!1?!!s==!1?V(t):Qe(t):Qe(t)
...
t.__$anflg26=!0;var o=t.ctx;t.ctx={elem:"box",content:t.ctx};var r=i;return i="",Re(t),t.ctx=o,i=r,t.__$anflg26=n,void 0
}return W(t)}return W(t)}function H(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg27,t.__$anflg27=!0,s=t.ctx,t.ctx=a,o=i,i="",r=Re(t),t.ctx=s,i=o,n=r,t.__$anflg27=e,n
...
}function Q(t){return"retpath"===s?G(t):Y(t)}function G(t){if(!(t.__$anflg25!==!0)==!1){var e=t.__$anflg25;
...
}return Y(t)}function Y(t){return!(t.__$anflg24!==!0)==!1?!!s==!1?X(t):Qe(t):Qe(t)}function X(t){var e,i,n,s;
...
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Re(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
...
var a=i;i="",Re(t),t.ctx=r,i=a,t.__$anflg8=o}function me(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
...
}function De(){return void 0}function Ie(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Se(t):Se(t)
}function Se(t){return!!s==!1?[]:Qe(t)}function Pe(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
...
}function Ae(t){return"suggest2-item"===n?"highlight"===s?!1:je(t):je(t)}function je(){return void 0}function Le(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,si(t),void 0):Re(t):Re(t):Re(t)
}function Re(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?Ne(t):Qe(t):Qe(t)}function Ne(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=ye(t),i=e,n=o,s=r,a);
...
}function $e(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Re(t),t._buf=n,i=o,e.join("")
...
}function Qe(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Ge(t):Ye(t):Ye(t):Ye(t)}function Ge(i){function n(){if("no-follow"===this.ctx.link)return void 0;
...
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Ye(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?Xe(t):Ze(t):Ze(t):Ze(t)
}function Xe(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}return ii(t)}function Je(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,D,I,P,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=C(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,R;
n&&A.js!==!1&&(h=i,i="js",l=xe(t),i=h,R=l,R=R?t._.extend(A.js,R===!0?{}:R):A.js===!0?{}:A.js,R&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=R)),j.push("<",T);
var N=(d=i,i="bem",p=Ae(t),i=d,p);"undefined"!=typeof N||(N="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var q=(f=i,i="cls",m=Ke(t),i=f,m);q||(q=A.cls);var $=A.block&&L&&!A.elem;if(N||q){if(j.push(' class="'),N){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
...
var Y=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=Me(t),n=b,s=a,r=y,o=k,i=M,E);if(Y)for(var X=0;X<Y.length;X++){var Z=Y[X];
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(I=i,i="content",P=S(t),i=I,P);if(ie||0===ie){var N=n||s,ne=t._notNewList;
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',D="allowScriptAccess",I="always",S="height",P="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",R=i(x,B)+i(O,1)+i(S,1)+i("id",L),N=!1;
l.ya_fc_external=function(t,n,u,l){r=t,a=n,c=u,h=l||"fc";var d,p=m&&m[w]?m[w].enabledPlugin:0,f=N,y=0,x=s()?k.replace("%d",a).replace("%s",h):M.replace("%s",o());
...
}catch(S){}}return d=f?g?'<div style="'+B+'"><'+v+R+i("src",x)+i(P,T)+i(A,j)+i(D,I)+i("type",w)+"/></div>":(b?"<"+v+C+R+">"+e("movie",x):"<"+v+R+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(D,I)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
i.src=e,i.style.cssText=O+s+S+s+"border:0;"+B,i.frameBorder=0,i.setAttribute("tabindex","-1"),i.setAttribute("aria-hidden","true"),n&&n.insertBefore(i,n.firstChild)
...
}):BEM.blocks["content-preview"].preload(n)},this)}}),_borschik("kxXrKGqsyUogLh7UM4XuSPAU7wE")&&BEM.DOM.decl({block:"nav-answers",modName:"search",modVal:"yes"},{onSetMod:{js:function(){this._counter=this.params.counter,this._input=this.findBlockInside("input").elem("control")[0],this.bindTo("search-form","submit",this.onSubmit)
...
}),t.preventDefault()}})}}),_borschik("qDZU0IcJG9yDcshdKUlhyTqJ3BM")&&!function(t,e,i){"use strict";"undefined"!=typeof module&&module.exports?module.exports=i(e,t):"function"==typeof define&&define.amd?define("detect-zoom",function(){return i(e,t)
...
},i=function(){var e=Math.round(document.documentElement.offsetHeight/window.innerHeight*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},n=function(){var e=Math.round(window.outerWidth/window.innerWidth*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},s=function(){var e=Math.round(window.outerWidth/window.innerWidth*100)/100;return{zoom:e,devicePxPerCssPx:e*t()}
},o=function(){var e=90===Math.abs(window.orientation)?screen.height:screen.width,i=e/window.innerWidth;
return{zoom:i,devicePxPerCssPx:i*t()}},r=function(){var e=function(t){return t.replace(/;/g," !important;")
...
},a=function(){var t=u("min--moz-device-pixel-ratio","",0,10,20,1e-4);return t=Math.round(100*t)/100,{zoom:t,devicePxPerCssPx:t}
},c=function(){return{zoom:a().zoom,devicePxPerCssPx:t()}},h=function(){var e=window.top.outerWidth/window.top.innerWidth;
return e=Math.round(100*e)/100,{zoom:e,devicePxPerCssPx:e*t()}},u=function(t,e,i,n,s,o){function r(i,n,s){var c=(i+n)/2;
...
var l=r(i,n,s);return u&&(c.removeChild(h),document.body.removeChild(u)),l},l=function(){var t=e;return window.navigator.msMaxTouchPoints?t=i:window.chrome&&!(window.opera||navigator.userAgent.indexOf(" Opera")>=0)?t=n:Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")>0?t=s:"orientation"in window&&"webkitRequestAnimationFrame"in window?t=o:"webkitRequestAnimationFrame"in window?t=r:navigator.userAgent.indexOf("Opera")>=0?t=h:window.devicePixelRatio?t=c:a().zoom>.001&&(t=a),t
}();return{zoom:function(){return l().zoom},device:function(){return l().devicePxPerCssPx}}}),_borschik("5NO2qC3NgtpnDtgIztRjyKKG7NQ")&&BEM.DOM.decl("timing",{onSetMod:{js:function(){this.data={},this.visibilityState={visible:1,hidden:2,prerender:3}[this.getVisibilityState()],this.send()
...
},unbindEvents:function(){this.unbindFromDoc("leftclick.mainRight tap.mainRight")}},{_activeElements:[".serp-item__preview-btn",".serp-item_preview-active_yes",".z-images__link",".main__right-inner",".content-preview",".i-geo-point__cont",'[target="_blank"]',"ymaps",".video-thumb",".popup",".previewed"].join()}),_borschik("si8bqbUWNhkJBNpI_P-a60FdiJ0")&&BEM.DOM.decl("main",{onSetMod:{js:function(){this.__base.apply(this,arguments),this.centerColumn=this.elem("center"),this.rightColumn=this.elem("right"),this.rightColumnContent=this.elem("right-inner"),this.findContentLeftColumn(),this.channel("main").on("updateStop",this.findContentLeftColumn,this),this.bindToWin("scroll.mainRight",this.syncScroll,this),this.bindToWin("resize",this.syncScroll,this),this.on("panelClosed",this._unfixCenterHeight,this)
}},findContentLeftColumn:function(){this.contentLeftColumn=this.findBlockInside("content").elem("left")
},_throttleTrigger:$.throttle(function(t){this.trigger(t)},200),_fixCenterHeight:function(t){this.centerColumn.css({"min-height":t})
