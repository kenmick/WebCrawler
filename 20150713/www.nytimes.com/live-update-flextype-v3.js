...
define( 'live-updates-flextype-promo', [
	...
	var Widget = function (id, flexData) {
		...
		$( '#' + id ).html( ['<div id="', widgetId, '" class="eln-sul" style="display: none; height: 170px; margin-bottom: 15px; clear: both">',
		...
		lu = LiveUpdates("#" + widgetId, {
			...
			poll: true,
			feedUrl: staticPath + 'live-updates-' + flexData.event_id + '.json',
