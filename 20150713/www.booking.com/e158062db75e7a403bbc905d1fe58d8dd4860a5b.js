...
f.extend(l,{hotel_soldout:j({url:d,w:16,h:28,x:198,y:33}),hotel:j({url:d,w:16,h:28,x:215,y:33}),hotel_comp_set:j({url:d,w:16,h:28,x:153,y:33})});
...
B[sNSExperiments]["fEWKRaJHJUeXdVCMFHdZae"]=(function(){var d=10000;
var e="fEWKRaJHJUeXdVCMFHdZae";
var g=$(window);
function f(){a(function(){B.track.stage(e,2);
h()
},d);
$(".dont_leave_close_btn").click(c);
$(".dont_leave_dsf_pop_up_darker_bg").click(c)
}function b(){a(function(){B.track.stage(e,2)
},d)
...
}function c(){$(".dont_leave_dsf_pop_up_darker_bg").addClass("hide").removeClass("show");
$(".dont_leave_dsf_pop_up").addClass("hide").removeClass("show")
}function a(j,k){var i;
var m=function(){clearTimeout(i);
i=setTimeout(l,k)
};
var l=function(){g.unbind("mousemove",m);
j()
};
g.bind("mousemove",m)
}return{init:f,initElse:b}
})();
