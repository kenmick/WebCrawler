...
B.define("gta/sms-widget",["gta/base-widget"],function(d){var c=function(f){d.apply(this,arguments);
this.action="/send_app_sms_v2";
this.dom.countryFlagsDropdown=this.dom.root.find(".gta-country-flag-dropdown");
this.countryCode="";
if(this.dom.countryFlagsDropdown.length){try{B.require("gta/country-flags-dropdown").init(this,this.dom.countryFlagsDropdown.get(0))
}catch(g){}}};
...
d("PVdIYROdVaDXKe");
if(1===e("PVdIYROdVaDXKe")){(function(j,g){var h=e(g);
if(!(h===0||h===1||h===2)){return
}function k(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(m,l){if(h===1){l.params.mr=1
}else{if(h===2){l.params.mr=0.7
}}d(g);
c.track.stage(g,1)
})
...
if(isNaN(h)){return
}function k(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(m,l){if(!l.params.hasOwnProperty("v")){l.params.v=h
}});
