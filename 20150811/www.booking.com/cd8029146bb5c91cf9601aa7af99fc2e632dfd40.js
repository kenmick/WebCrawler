...
(function(d,g){var c=g.components.require("legacy-emitter"),e="fESJXOTEcYWADeFNZBRe";
...
F.on(F.EVENTS.IW_CLOSE,function(){$(".fly-dropdown.wl-dropdown").hide()
})
}})
...
}function F(){var I=y.position(),H={width:k(window).width()-2*I.left,height:k(window).height()-2*I.top};
k(c).css(H);
y.css(H)
...
(function(d,c,a){var b={paging:function(e){var g={$tabButton:".rlp-main-section-tab__btn",$tabButtonActive:".rlp-main-section-tab__btn--active",tabButtonActiveClass:"rlp-main-section-tab__btn--active",$tabSectionContainer:".rlp-main-section-hotels--tab-waterfall",tabSectionContainerActiveClass:"rlp-main-section-hotels--tab-active-waterfall",callback:null};
var f=d.extend({},g,e);
