...
Demandbase.Config={clientId:"phXI6yS7",nonCompanyDefault:null,nonWatchDefault:null,getDomain:null,conditions:null,segments:null,key:"cd79a9f82c976038cd27dd4fc100b577",ads:{pixels:{ad:null,rt:null,cn:null}},analytics:{key:"cd79a9f82c976038cd27dd4fc100b577",fieldMap:{1:"demandbase_sid",2:"audience",3:"audience_segment",4:"company_name",5:"industry",6:"sub_industry",7:"revenue_range",8:"employee_range",9:"ip",10:"watch_list_account_type",11:"watch_list_account_status",12:"watch_list_campaign_code",13:"state",
14:"country_name",15:"fortune_1000",16:"forbes_2000",17:"b2b",18:"b2c",19:"city",20:"zip",21:"country",22:"web_site",23:"stock_ticker",24:"traffic",25:"marketing_alias",26:"employee_count",27:"street_address",28:"phone",29:"annual_sales"}},isFormPage:function(){europe_iso="AL AD AM AT BY BE BA BG CH CY CZ DE DK EE ES FO FI FR GB GE GI GR HU HR IE IS IT LT LU LV MC MK MT NO NL PL PT RO RU SE SI SK SM TR UA VA".split(" ");try{for(var a=Demandbase.Config.forms.emailFields||[],b=Demandbase.Config.forms.companyID,
c=0;c<europe_iso.length;c++)if(Demandbase.IP.CompanyProfile.country===europe_iso[c])return!1;Demandbase.Config.forms.emailID&&a.push(Demandbase.Config.forms.emailID);for(c=0;c<a.length;c++){var d=Demandbase.utils.getElementByIdOrName(a[c]),e=Demandbase.utils.getElementByIdOrName(b);if(d&&e)return!0}}catch(g){window.console?window.console.log(g.message):""}return!1},forms:{companyID:"Company",emailID:"Email",enableMktoAutoAdd:!0,fieldMap:{demandbase_sid:"dbdemandbasesid",watch_list_account_type:"dbwatchlistaccounttype",
...
Demandbase.Config.getDomain()&&Demandbase.Domain.load();Demandbase._isInitialized=!0};Demandbase.version="1.11"})();(function(a,b,c){b.addEventListener?b.addEventListener(a,c,!1):b.attachEvent?b.attachEvent(a,c):Demandbase.utils.log("Message listener not attached.  Unable to receive ECT message.")})("message",window,Demandbase.utils.ect.listener);
