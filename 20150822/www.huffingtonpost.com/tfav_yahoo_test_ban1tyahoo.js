ï»¿(function(){
    var cmp_id = "yahoo_test";
    var cmp_id_date = cmp_id+'_ADLOOX_DATE';
    var ban_id = "ban1tyahoo";
    var cname = "yahoo";
    var fw_version = "2";
    var has_fw = "1";
    ...
    var hash_adnxs    = "";
    var fwed          = false;
    var loadbalancing = ['data01.adlooxtracking.com','data02.adlooxtracking.com','data03.adlooxtracking.com','data04.adlooxtracking.com','data08.adlooxtracking.com','data09.adlooxtracking.com','data10.adlooxtracking.com','data11.adlooxtracking.com','data134.adlooxtracking.com','data29.adlooxtracking.com','data31.adlooxtracking.com','data32.adlooxtracking.com','data33.adlooxtracking.com','data34.adlooxtracking.com','data35.adlooxtracking.com','data36.adlooxtracking.com','data37.adlooxtracking.com','data38.adlooxtracking.com','data39.adlooxtracking.com','data40.adlooxtracking.com','data41.adlooxtracking.com','data42.adlooxtracking.com','data43.adlooxtracking.com','data44.adlooxtracking.com','data45.adlooxtracking.com','data46.adlooxtracking.com','data47.adlooxtracking.com','data48.adlooxtracking.com','data49.adlooxtracking.com','data50.adlooxtracking.com','data51.adlooxtracking.com','data52.adlooxtracking.com'];
    var tabname       = typeof tab_adloox_alerte_id_yahoo !== "undefined" ? tab_adloox_alerte_id_yahoo : (typeof tab_adloox_alerte_id_yahoo !== "undefined" ? tab_adloox_alerte_id_yahoo : false );
    ...
    var get_macro_urls = function() {
        ...
        var re = /http[s]?\:\/\/[a-z]*\.adlooxtracking\.com\/ads\/js.*yahoo_test_ban1tyahoo.*[#|\?](.*)/;
    ...
    var send_to_tagco = function(tagc_arr){
     ...
     try{
         transaction_id=tab_adloox_transaction_id_yahoo[0];
        }
         catch(err){
        }
    ...
    if (document.getElementById(img_id_visi) == null) {
        adloox_video = 1;
        var adloox_elii = document.createElement('img');
        adloox_elii.src = 'about:blank';
        adloox_elii.id = img_id_visi;
        adloox_elii.width = 0;
        ...
        adloox_elii_java.src = 'about:blank';
        adloox_elii_java.id = img_id_java;
    ...
    if ( fnPreState() !== "prerender" ) {
        ...
        url_ic =  ('https:' == document.location.protocol ? "https://" : "http://")  + servername + "/ads/" + v_ic + "?adloox_transaction_id=" + escape(transaction_id) + "&visite_id=" + escape(visite_id) + "&client="+cname+"&id_editeur=" + escape(str_alerte_ids) + "&type=regie_quotidienne&banniere="+ban_id+"&campagne=" + escape(cmp_id) + "&os=&navigateur=&methode=" + escape(methode) + "&fai=" + escape(document.title) + "&alerte=" + escape(alerte_finale) + "&alerte_desc=" + escape(alerte_desc) + "&data=" + uniq_hash + "&js=" + escape(script_src) + "&fw=" + has_fw +"&version="+ fw_version + "&iframe=" + is_iframe + "&hadnxs=" + hash_adnxs + "&ua=" + escape(navigator.userAgent) + "&url_referrer=" + escape(uri_courant);
    ...
    var send_alert = function(alert_title,alert_url,alert_content,true_alert){
        ...
        if( !alert_sent ){
            ...
            if( alert_desc.length > 0 ){
                ...
                var url = "//" + servername + "/ads/image_alerte_contenu.php?client="+cname+"&type=regie_quotidienne&banniere=" + ban_id + "&campagne=" + cmp_id + "&methode=" + escape(methode) + "&fai=new1_" + escape(document.title) + "&alerte=0&alerte_desc=" + escape(alert_desc) + "&id_editeur=" + str_alerte_ids + "&url_referrer=" + escape(uri_courant) + "&iframe=" + is_iframe + "&true_alert=" + true_alert;
    ...
    * */
    ...
    var array_fw_lv = ["01net.com","20minutes.fr","750g.com","accuweather.com","actu.orange.fr","actualite.bfmtv.com","actualite.portail.free.fr","actuanimaux.com","actucine.com","adaccess.fr","allocine.fr","allofamille.fr","alt.mail.aol.com","answers.com","audit.adnxs.net","autotrader.co.uk","avito.ru","bfmtv.com","bourse.latribune.fr","boursematch.com","boursorama.com","capital.fr","caradisiac.com","chaines.free.fr","channel5.com","chat.nrj.fr","clubic.com","commentcamarche.net","console.appnexus.com","cotemaison.fr","covoiturage.fr","cuisine.notrefamille.com","cuisineaz.com","dailymail.co.uk","dailymotion.com","deezer.com","disney.fr","easyvols.fr","ebay.com.au","ebay.fr.myebay","europe1.fr","eurosport.fr","evene.fr","facebook.com","femmes.fr.msn.com","femmes.orange.fr","femmes.portail.free.fr","fnac.com","foot01.com","football365.fr","footmercato.net","forum.telecharger.01net.com","fr.cinema.yahoo.com","fr.linkedin.com","fr.mappy.com","fr.msn.com","fr.news.yahoo.com","fr.tv.yahoo.com","fr.viadeo.com","france.lachainemeteo.com","france.meteofrance.com","francefootball.fr","free.lequipe.fr","google.com.au","google.fr","guardian.co.uk","immobilier.portail.free.fr","info.sfr.fr","informationhospitaliere.com","jeuxvideo.com","lacentrale.fr","lachainemeteo.com","laposte.net","larousse.fr","latribune.fr","lavoixdunord.fr","lci.tf1.fr","leboncoin.fr","lefigaro.fr","leguide.com","lejdd.fr","leparisien.fr","lephoceen.fr","lepoint.fr","leprogres.fr","lequipe.fr","lequipemag.fr","letudiant.fr","lexpress.fr","liberation.fr","linternaute.com","mail.aol.com","mail.aol.fr","mail.voila.fr","mail.yahoo.com","marieclaire.fr","marmiton.org","meetic.fr","mercato365.com","mescoloriages.com","meteofrance.com","metrofrance.com","millenium.org","orange.co.uk","orange.fr","ouest-france.fr","pagesjaunes.fr","parismatch.com","paristeam.fr","paruvendu.fr","planet.fr","playtv.fr","portail.free.fr","pro.orange.fr","programme-tv.net","programme-tv.orange.fr","ratp.fr","reverso.net","rmc.fr","rmcdecouverte.com","rmcsport.bfmtv.com","rmcsport.fr","routard.com","rtl.fr","rue89.com","search.free.fr","securite.01net.com","seloger.com","seloger.fr","services.portail.free.fr","societe.com","sport24.lefigaro.fr","sports.fr","sports.orange.fr","sporx.com","sudouest.fr","techpour.com","tf1.fr","tomsguide.fr","touslesdrivers.com","verif.com","viadeo.com","viamichelin.fr","videos.tf1.fr","webmail1c.orange.fr","webmail1d.orange.fr","webmail1e.orange.fr","webmail1f.orange.fr","webmail1g.orange.fr","webmail1h.orange.fr","webmail1j.orange.fr","webmail1k.orange.fr","webmail1m.orange.fr","webmail1n.orange.fr","webmail1p.orange.fr","webmail22.orange.fr","wordreference.com","xe.com","youtube.com"];
    var fw_version = "2";
    var is_lv = (function(){
        for (var i = 0; i < array_fw_lv.length; i++) {
            var matches = rurl_decode.match(/^(?:(?:https?|file|ftp)\:\/\/(?:\/)*)?(?:www\.)?([^\/?#]+)(?:[\/?#]|$)/i);
            var domain = matches && matches[1];
            if (domain == array_fw_lv[i]){
                return true;
            }
        }
        return false;
...
var adl_F_Visi = function() {
    ...
    if( isFirefox || isSafeFrame || isIE ){
        ...
        **/
        ...
        var logData = function( cantbeacon ){
            if( !got_resp_from_flash ) { return false; }
            if( visi_mraid ) { return false; }
            if( visi_sent ) { return false; }
            visi_sent = true;
            var vi = adl_v.nb_sec_done >= sec_visi ? 2 : 0;
            var atf = user_p.browser.match(/firefox/i) ? 1 : wasATF;
...
var adl_J_Visi = function() {
    ...
    var seekAd = function() {
        ...
        if(el.tagName == "HEAD" || search_player){
            el = getPlayer(window);
        }
    ...
    var element_is_in_iframe = function(el){
    ...
    var getIframeOffset = function(pel) {
        ...
        var el = pel;
        var win = window;
        var el_in_iframe = element_is_in_iframe(el);
    ...
    var isVisibleNormal = function() {
        ...
        var vHauteur = (((cadreVisible.yMax - elementVisible.yMin) / ad.height) >= tx_visi);
        if (cadreVisible.yMin > elementVisible.yMin) {
            vHauteur = (((cadreVisible.yMin - elementVisible.yMin) / tx_visi) <= ad.height);
        }
        var vLargeur = (((cadreVisible.xMax - elementVisible.xMin) / ad.width) >= tx_visi);
        if (cadreVisible.xMin > elementVisible.xMin) {
            vLargeur = (((cadreVisible.xMin - elementVisible.xMin) / tx_visi) <= ad.width);
        }
    ...
    var logData = function( cantbeacon ){
        ...
        var vi = adl_v.nb_sec_done >= sec_visi ? 2 : 0;
        var fsize = ad.width+"x"+ad.height;
        //var deb = inFriendlyIframe ? "friendlyjs" : "js";
        var deb = typeof mraid !== 'undefined' ? 'mraid' : '_'; 
        var url = ('https:' == document.location.protocol ? "https://" : "http://")+adl_v.se+"/ads/iv2.php?adloox_transaction_id=" + escape(adl_v.t) + "&client=" + escape(adl_v.c) + "&banniere=" + escape(adl_v.b) + "&visible="+vi+"&visite_id=" + escape(adl_v.id) + "&url=" + escape(adl_v.u) + "&campagne=" + escape(adl_v.cmp) + "&a_d=" + escape(adl_v.nb_sec_done) + "&p_d=" + Math.round((new Date() - adl_v.sTime)/1000) + "&browser=" + user_p.browser + "&editeur_id=" + escape(adl_v.ed) + "&wasatf="+wasATF+"&hash="+uniq_hash+"&hash_adnxs="+hash_adnxs+"&size="+fsize+"&visi_debug="+deb+tagco_var+"&anticache=" + Math.floor(Math.random() * 100000000);
        var appendImgUnload = function(url){
            var im_unl = document.createElement("img");
            im_unl.src = url;
...
if(should_process_visi) {
    ...
    * */
    ...
    var fake = (function(){
        if ((!isOpera && user_p.browser.match(/opera/i)) || (navigator.userAgent.indexOf(" OPR/") >= 0 && !window.chrome)) fake = true;
        else if (!isChrome && user_p.browser.match(/chrome/i)) return true;
        else if (!isFirefox && user_p.browser.match(/firefox/i)) return true;
        else if (!isIE && user_p.browser.match(/(msie)/i)) return true;
        else if (!isSafari && user_p.browser.match(/safari/i)) return true;
        return false;
    })();
    var send_fraud = function(type){
        if( uri_courant.indexOf("app.spotify.com") > 1 ) return false;
        if( is_fraud_sent ) return false;
        var el = document.createElement("img");
        el.src = "//" + servername + "/ads/activity.php?client="+ cname +"&type_d="+ type +"&id_editeur=" + str_alerte_ids + "&fc=1&campagne=" + cmp_id_date + "&had="+hash_adnxs+"&website=" + escape(uri_courant);
