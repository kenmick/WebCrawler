...
var b, v;
return "hotel" === B.env.b_action && "win" !== t.platform && a.addClass("growls_no_scroll"), B.env.rtl && b && v && (d = "__placement_" + v), d && a.addClass(d), r = e("<div></div>").addClass("notice-item-wrapper").addClass(f), c = "" == t.destination ? "<p>" + t.text + "</p>" :'<p><a href="' + t.destination + '">' + t.text + "</a></p>", "all" == t.close ? (s = e("<div></div>").hide().addClass("notice-item " + m + t.type + " " + t.addClassName).appendTo(a).html(c).animate(t.inEffect, t.inEffectDuration).wrap(r).bind(n, function(n) {
