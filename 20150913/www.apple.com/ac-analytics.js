...
}}var n=o.c_r("s_vnum_n2_us");if(n){o.c_w("s_vnum_n2_us","domain = apple.com; path = /",m)
}var j=o.c_r("s_vi");if(j){o.c_w("s_vi","domain = apple.com; path = /",m)}var p=o.c_r("s_pv");
if(p){o.c_w("s_pv","",63072000)}function q(u){var t=u.href;return t}o.getObjectID=q;
if(typeof(iTunesDetected)==="function"){var l=document.createElement("object");
...
}if(q.exception){return}return" ("+n(x)+")"}var o=/[\Ã¬\Ã®\Ã«\Ã­]/g;function r(x){if(typeof x==="string"){x=x.replace(o,"")
