...
(function(){if(navigator.plugins&&navigator.plugins.length){var a=navigator.plugins["Shockwave Flash"];if(a&&(iq=!0,a.description)){jq(a.description);return}if(navigator.plugins["Shockwave Flash 2.0"]){iq=!0;return}}if(navigator.mimeTypes&&navigator.mimeTypes.length&&(iq=(a=navigator.mimeTypes["application/x-shockwave-flash"])&&a.enabledPlugin)){jq(a.enabledPlugin.description);return}try{var b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7");iq=!0;jq(b.GetVariable("$version"));return}catch(c){}try{b=
