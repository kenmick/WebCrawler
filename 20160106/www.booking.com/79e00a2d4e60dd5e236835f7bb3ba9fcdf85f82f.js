...
n++){f[0]=p[n-1];
m+=b[2];
if((((h.MJ(h.MB(a[1]))&&(h.MJ(/zh|xt|ja|ko/.test(h.MB(a[2])))))&&h.MJ(h.track_experiment("YdVSfPYPaEYZBMURET")))&&h.MJ(h.track_experiment_stage("loc_sb_autocomplete_newstyle",1)))){}m+=b[3];
if((((h.MJ(h.MB(a[1]))&&(h.MJ(!/zh|xt|ja|ko/.test(h.MB(a[2])))))&&h.MJ(h.track_experiment("YdVSfPYPaEYZBMURET")))&&h.MJ(h.track_experiment_stage("loc_sb_autocomplete_newstyle",2)))){}m+=b[4];
m+=b[5];
