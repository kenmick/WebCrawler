...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <script type="text/javascript" src="/dtagent61_bxjpr23_8175.js" data-dtconfig="rid=RID_2418|rpid=-1109754682|domain=adobe.com|tp=500,50,3|cors=1|bandwidth=300|reportUrl=dynaTraceMonitor"></script><link rel="icon" href="https://wwwimages2.adobe.com/include/img/favicon.ico" type="image/x-icon">
...
<main class="lobby">
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-max-pre-announce-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="50% 15%" data-seed-background data-article-width="big">
	
    <article class="grid-offset-1 ">
        <section>

    
    <h1>See how it all connects at Adobe MAX.</h1>
<p>Join over 6,000 creatives at Adobe MAX and get a front row seat to the future of Creative Cloud. From what's new to what's next. It's your entire creative world. Perfectly in sync.<br>
</p>
...
<ul>
    <li>
        <a title="Sign up to watch the keynote" href="http://www.max.adobe.com/sessions/max-online/sign-up/?promoid=XB5KHRQY&mv=other" target="_self" class="cta">
            Sign up to watch the keynote
        </a>
    </li>
    ...
    <li>
        <a title="We have Creative Cloud plans for everyone, starting at $9.99/mo." href="https://creative.adobe.com/plans?store_code=en&promoid=KSDPZ" target="_self" class="offers cta">
    ...
    <figcaption class="align-end grid-offset-2 ">
        <section><h2>
    <a href="https://www.behance.net/gallery/28187535/Adobe-MAX-2015?promoid=KSDQA" class="base cta">MAX by Dave Kinsey</a>
...
<ul>
    ...
    <li class="cac">
        <a href="https://color.adobe.com/#themeID/6764714" target="_self">
            <img src="http://wwwimages.adobe.com/content/dam/acom/themeids/6/7/6764714.png"/>
        </a>
    </li>
