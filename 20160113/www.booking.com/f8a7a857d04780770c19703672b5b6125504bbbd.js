...
this.model.destination.set(s), this.model.submit();
}
});
...
gpf:!0
}), this.options.e_v && (this.model.e_v = !0), this.model.on("submit", this.modelSubmit.bind(this)), this.$form = this.$el.is("form") ? this.$el :this.$el.find("form:eq(0)"), this.$form.submit(this.formSubmit.bind(this)), this.initCurrentCountryField(), o.on("beforeajax", function(t, e) {
...
i.push(t.name), -1 != l.indexOf(t.name) && (s = !0);
}), this.$form.find("input").filter(function() {
return s && -1 != l.indexOf(this.name) || -1 != i.indexOf(this.name);
