...
},inputFocus:function(){_p=_o;_o="368:152";this.model.destination.initPredictions();
...
this.options=f(this.$el,{modelId:{name:"sb-id",type:String,required:true},gpf:{name:"sb-gpf",type:Boolean},_ssce:{name:"sb-ssce",type:Boolean}});
...
}},onlyCurrentCountryChange:function(){_p=_o;_o="368:344";this.model.destination.setOnlyCurrentCountry(this.$onlyCurrentCountry.is(":checked"))
