...
function startAnimation() {
	...
	tl.set(panImage, { scale:.86, x:-50, y:-60}, "Intro");
	...
	tl.to(panImage, 4, {x:-390, y:-210, scale:1, rotation:0.01, ease: Power1.easeInOut}, 'StartPan-=.25'); 	
	tl.call(unblurme, [], this, 'StartPan+=.5');	

	tl.to(headline2, .5,{opacity: 1}, 'StartPan+=2');
	tl.to(listingbottom, .75, { opacity:1, ease: Power1.easeOut}, 'StartPan+=4.5');
	tl.to(headline2, .5,{opacity: 0}, 'StartPan+=4.5');
