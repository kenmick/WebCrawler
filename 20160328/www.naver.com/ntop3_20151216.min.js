...
},setShortcut:function(a){if(a.name=="ë ì¨"){if(!TS.cache.topWeather){var b=$Ajax("/include/timesquare/top_weather.html",{timeout:3,onload:function(c){var d=c.text();TS.cache.topWeather=d;TS._bindShortcut(d)
...
}}else{TS._bindShortcut('<a href="'+a.url+'" class="qlink">'+a.name+"</a>");TS.attachShortcutClickTag()}},setLifeShortcut:function(){if(!TS.cache.lifeShortcut){TS.cache.lifeShortcut='<a href="#" id="ts_region" class="qdown"><span class="blind">íì¬ ìì¹</span><strong>êµ­ë´ <span class="dep2">&gt;</span> ìì¸</strong><span class="blind">ì§ì­ì¤ì  ë ì´ì´ ì´ê¸°</span></a>'
...
if(!b){return}var c=$Element(b);var d="squ.add";switch(c.html()){case"TVí¸ì±í":d="squ.tvpro";break;case"ì¤í¬ì¸ ":d="squ.sports";break;case"êµíµ":d="squ.traffic";break;case"ë¶ëì°":d="squ.land";break;case"ì¦ì":case"ì¦ê¶":break
}clickcr(a.currentElement,d,"","",a._event)}},LifeWeather:{data:{template:'<a onclick="clickcr(this,\'squ.sweather\',\'\',\'\',event)" href="{=URL}" class="tw_a" title="ë ì¨íì´ì§ë¡ ì´ë"><span class="to"><span class="tw_box"><strong class="tw_tit">íì¬</strong><span class="deg"><em>{=CUR_TEMP}</em>â</span><span class="tsq_wtb tsq_wtb{=CUR_CODE}" title="{=CUR_TEXT}">{=CUR_TEXT}</span></span></span><span class="ym"><span class="tw_box"><strong class="tw_tit">ë´ì¼ì¤ì </strong><span class="deg"><em>{=TAM_TEMP}</em>â</span><span class="tsq_wtb tsq_wtb{=TAM_CODE}" title="{=TAM_TEXT}">{=TAM_TEXT}</span></span></span><span class="ya"><span class="tw_box"><strong class="tw_tit">ë´ì¼ì¤í</strong><span class="deg"><em>{=TPM_TEMP}</em>â</span><span class="tsq_wtb tsq_wtb{=TPM_CODE}" title="{=TPM_TEXT}">{=TPM_TEXT}</span></span></span></a>',domestic:{level1Arr:[{code:"01",name:"ê°ìë"},{code:"02",name:"ê²½ê¸°ë"},{code:"03",name:"ê²½ìë¨ë"},{code:"04",name:"ê²½ìë¶ë"},{code:"05",name:"ê´ì£¼ê´ì­ì"},{code:"06",name:"ëêµ¬ê´ì­ì"},{code:"07",name:"ëì ê´ì­ì"},{code:"08",name:"ë¶ì°ê´ì­ì"},{code:"09",name:"ìì¸í¹ë³ì"},{code:"17",name:"ì¸ì¢í¹ë³ìì¹ì"},{code:"10",name:"ì¸ì°ê´ì­ì"},{code:"11",name:"ì¸ì²ê´ì­ì"},{code:"12",name:"ì ë¼ë¨ë"},{code:"13",name:"ì ë¼ë¶ë"},{code:"14",name:"ì ì£¼ë"},{code:"15",name:"ì¶©ì²­ë¨ë"},{code:"16",name:"ì¶©ì²­ë¶ë"}],level2Map:{},level3Map:{}}},init:function(){this.level0={};
...
d.show("block");$$.getSingle("#ts_region strong").innerHTML="êµ­ë´<span class='dep2'> &gt; </span>"+d.attr("data-name")}},5000)}},rollingStop:function(){clearInterval(this.interval)},_setPage:function(){var a=$$.getSingle(".tsq_weather",TS.pan);
...
}},_updateNav:function(h){var g=0;var f=TS.LifeWeather.level0;var e=TS.LifeWeather.level1;var d=TS.LifeWeather.level2;var c=TS.LifeWeather.level3;var b="";if(TS.LifeWeather.isWorld()){b="<a href='#' data-level='0'>í´ì¸</a>"
}else{b="<a href='#' data-level='0'>êµ­ë´</a>"}if(e.code||f.code&&!h){b+=" &gt; <a href='#' data-level='1'>";b+=(e.name)?e.name:(TS.LifeWeather.isWorld()?"êµ­ê°":"ê´ì­ì/ë");b+="</a>";g=1}if(d.name!=""&&(d.code||e.code&&!h)){b+=" &gt; <a href='#' data-level='2'>";
b+=(d.name)?d.name:(TS.LifeWeather.isWorld()?"ëì":"ì/êµ°êµ¬");b+="</a>";g=2}if(!TS.LifeWeather.isWorld()&&(c.code||d.code&&!h)){b+=" &gt; <a href='#' data-level='3'>";b+=(c.name)?c.name:"ë/ì/ë©´";b+="</a>";g=3
}$Element("scroll8_nav").html(b);var a=$Element($$.getSingle("#scroll8_nav a[data-level="+g+"]"));a.html("<strong>"+a.html()+"</strong>")},_showLevel0List:function(){var a="";if(TS.LifeWeather.isWorld()){a="<li><a href='#' data-level='0' data-code='1' data-name='êµ­ë´'>êµ­ë´</a></li><li class='on'><a href='#' data-level='0' data-code='2' data-name='í´ì¸'>í´ì¸</a></li>"
}else{a="<li class='on'><a href='#' data-level='0' data-code='1' data-name='êµ­ë´'>êµ­ë´</a></li><li><a href='#' data-level='0' data-code='2' data-name='í´ì¸'>í´ì¸</a></li>"}this._updateList(a,TS.LifeWeather.level0.code)
...
break}}if(e==null){TS.failMsg("[TIMESQUARE - LIFE_WEATHER] í´ë¹ êµ­ê°ì ëìë¥¼ ì°¾ì§ ëª»íììµëë¤."+TS.LifeWeather.level1.code);return}for(var a in e){var d=e[a];b+="<li><a href='#' data-level='2' data-code='"+d.regionCode+"' data-name='"+d.cityName+"'>"+d.cityName+"</a></li>"
...
TS.LifeWeather._setCookie();TS.LifeWeather._setPage();TS.LifeWeather.ScrollBox.hide();break}}}}},Wiget:{open:function(){var a=$Element($$.getSingle(".ly_tsq_wg",TS.timesquare));if(a.child().length==0){a.html('<h5>ìíìì ¯</h5><ul><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EC%83%9D%EB%85%84%EC%9B%94%EC%9D%BC+%EC%9A%B4%EC%84%B8&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.fortune\',\'\',\'\',event);"><span class="wgi wgi1"></span>ì´ì¸</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%ED%99%98%EC%9C%A8&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.exchange\',\'\',\'\',event);"><span class="wgi wgi2"></span>íì¨</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EA%B3%84%EC%82%B0%EA%B8%B0&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.calculator\',\'\',\'\',event);"><span class="wgi wgi3"></span>ê³ì°ê¸°</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EB%8B%A8%EC%9C%84%EB%B3%80%ED%99%98&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.measure\',\'\',\'\',event);"><span class="wgi wgi4"></span>ë¨ìë³í</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EC%84%B8%EA%B3%84%EC%8B%9C%EA%B0%84&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.worldtime\',\'\',\'\',event);"><span class="wgi wgi5"></span>ì¸ê³ìê³</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EB%84%A4%EC%9D%B4%EB%B2%84+%ED%83%80%EC%9D%B4%EB%A8%B8&ie=utf8&sm=tab_she&qdt=0" onclick="clickcr(this,\'tsw.timer\',\'\',\'\',event);"><span class="wgi wgi6"></span>íì´ë¨¸</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=%EB%8B%AC%EB%A0%A5&sm=top_tsw&fbm=1&ie=utf8" onclick="clickcr(this,\'tsw.calendar\',\'\',\'\',event);"><span class="wgi wgi7"></span>ë¬ë ¥</a></li><li><a target="_blank" href="http://search.naver.com/search.naver?where=nexearch&query=tv%ED%8E%B8%EC%84%B1%ED%91%9C&sm=top_tsw&fbm=1&acr=1&acq=TV&qdt=0&ie=utf8" onclick="clickcr(this,\'tsw.tvpro\',\'\',\'\',event);"><span class="wgi wgi8"></span>TVí¸ì±í</a></li></ul><a href="#" class="tsq_wg_close" onclick="clickcr(this,\'tsw.close\',\'\',\'\',event);TimeSquare.Wiget.close();return false;">ìíìì ¯ ë ì´ì´ ë«ê¸°</a>')
...
b.attr("value","ì£¼ê°")}},onClick:function(){var a=$$.getSingle(".tsq_news_wrap > .tsq_finan > .finan_search .input_finan",TS.pan);var c=$$.getSingle("form",TS.pan);if(a&&c){var b=$Element(a);if(!b.hasClass("focus")){location.replace("http://finance.naver.com/")
...
$ElementList("#theme_config .radio-mark").removeClass("radio-checked");b.query(".radio-mark").addClass("radio-checked");b.query("input").attr("checked",true);clickcr(a.element,"tcg."+c,"","",a._event)}},Opencast:{cache:{},template:{prefix:'<div class="opc"><h4 class="opc_tit"><a href="http://opencast.naver.com/{=id}/{=seq}" onclick="return clickcr(this,\'{=nclkArea}.title\',\'\',\'\', event);">{=volumeTitle }</a></h4><div class="opc_origin"><a href="http://opencast.naver.com/{=id}" onclick="return clickcr(this,\'{=nclkArea}.cast\',\'\',\'\', event);">{=title }</a><em> No.{=seq }</em><span class="bar"> | </span><a href="#" class="rd" data-cast-id="{=id}"><span></span> êµ¬ë</a></div>',"1":'<div class="opc_type_th"><div class="th"><a href="{=articles[0].url }" onclick="return clickcr(this,\'{=nclkArea}.contents\',\'\',\'\', event);"><span class="thumb"><img src="{=articles[0].thumbnailUrl}" width="142" height="83" alt="{=articles[0].title }"><span class="mask"></span></span><span class="t">{=articles[0].title }</span></a></div><ul>{for idx:article in articles}{if idx != 0}<li><a href="{=article.url }" onclick="return clickcr(this,\'{=nclkArea}.contents\',\'\',\'\', event);">{=article.title }</a></li>{/if}{/for}</ul></div>',"3":'<ul class="opc_type_lst">{for idx:article in articles}<li><a href="{=article.url }" onclick="return clickcr(this,\'{=nclkArea}.contents\',\'\',\'\', event);"><span class="thumb"><img src="{=article.thumbnailUrl }" width="142" height="83" alt="{=article.title }"><span class="mask"></span></span><span class="t">{=article.title }</span></a></li>{/for}</ul>'},ERR_SERVER_CHECKING:-8,ERR_UNSUBSCRIBE_MYCAST:-3,HTML_SERVER_CHECKING:'<div class="opc_alert"><span class="ic_alert"></span><p class="oa1">MYìºì¤í¸ ìë² ì ê²ì¤ìëë¤.</p><p class="oa2">ìë² ì ê²ì¼ë¡ ì¼ìì ì¼ë¡ MYìºì¤í¸ ëª©ë¡ì ê°ì ¸ì¬ ì ììµëë¤.<br>ì ì íì ë¤ì ìëí´ ì£¼ì¸ì.</p></div>',HTML_SERVER_ERROR:'<div class="opc_alert"><span class="ic_alert"></span><p class="oa3">ì¼ìì ì¸ ì¥ì ë¡ ìºì¤í¸ ëª©ë¡ì ê°ì ¸ì¬ ì ììµëë¤.</p><p class="oa2">ì ì íì ë¤ì ìëí´ ì£¼ì¸ì.</p></div>',emptyCastHTML:'<div class="opc"><div class="opc_subs"><a href="http://opencast.naver.com/"><span class="ic_subs"></span><p>ë ë¤ìí ìºì¤í¸ë¥¼ êµ¬ëí´ë³´ì¸ì</p></a></div></div>',SIZE:4,init:function(){if(this.isInited){return
...
var d=a.attr("data-cast-id");if(this.subsCastIdArr.has(d)){a.className("del");a.html("<span></span> í´ì§")}else{a.className("rd");a.html("<span></span> êµ¬ë")}}}},setContents:function(a,i,j){this.curCode=a;
...
}},Layer:{Logout:{html:'<div id="opc_layer_logout" class="ly_oc ly_oc2"><p>ë¡ê·¸ì¸ í MYìºì¤í¸ë¥¼<br>ì´ì©í´ë³´ì¸ì.</p><a href="#" title="ë«ê¸°" class="close" onclick="TC.Opencast.Layer.leave(\'opc_layer_logout\');return false;">ë«ê¸°</a><span class="arrow"></span></div>',show:function(){TC.Opencast.Layer.leave("opc_layer_logout");
var a=$Element($$.getSingle("#themecast_contents .opc_w .opc_cate a[data-code=S99]"));a.afterHTML(this.html)}},LogoutSubs:{html:'<div id="opc_layer_logout_subs" class="ly_oc ly_oc2"><p>ë¡ê·¸ì¸ í êµ¬ëíê¸°ë¥¼<br>ì´ì©í´ ë³´ì¸ì.</p><a href="#" title="ë«ê¸°" class="close" onclick="TC.Opencast.Layer.leave(\'opc_layer_logout_subs\');return false;">ë«ê¸°</a></div>',show:function(a){TC.Opencast.Layer.leave("opc_layer_logout_subs");
a.afterHTML(this.html)}},Subs:{template:'<div class="ly_subs" id="opc_layer_subs"><h5 class="blind">êµ¬ëì¤ì  íì¸ì°½</h5><p class="subs_title"><strong title="{=title}">{=title}</strong> ìºì¤í¸ê°<br>êµ¬ëëììµëë¤.</p><p class="subs_d">MYìºì¤í¸ì ë¤ì´ë²meìì íì¸ í  ì ììµëë¤.</p><div class="subs_act"><a href="http://opencast.naver.com/home/myCastFlow.nhn" class="btn_my" onclick="return clickcr(this,\'oct*s.mycast\',\'\',\'\', event);">MYìºì¤í¸ê°ê¸°</a><a href="http://me.naver.com/" class="btn_me" onclick="return clickcr(this,\'oct*s.naverme\',\'\',\'\', event);">ë¤ì´ë²meê°ê¸°</a></div><a href="#" onclick="clickcr(this,\'oct*s.close\',\'\',\'\', event);TC.Opencast.Layer.leave(\'opc_layer_subs\');return false;" title="ë«ê¸°" class="btn_close">ë«ê¸°</a></div>',show:function(c,d){TC.Opencast.Layer.leave("opc_layer_subs");
var b={};b.title=d;var a=$Template(this.template).process(b);c.afterHTML(a)}},UnSubs:{template:'<div id="opc_layer_unsubs" class="ly_subs ly_subs_del" ><h5 class="blind">êµ¬ëí´ì§ íì¸ì°½</h5><p class="subs_title"><strong title="{=title}">{=title}</strong> ìºì¤í¸ë¥¼<br>êµ¬ëí´ì§ íìê² ìµëê¹?</p><div class="subs_act"><a href="#" class="btn_check" onclick="clickcr(this,\'oct*c.ok\',\'\',\'\', event);TC.Opencast.unsubscribe(\'{=castId}\');return false;">íì¸</a><a href="#" onclick="clickcr(this,\'oct*c.cancel\',\'\',\'\', event);TC.Opencast.Layer.leave(\'opc_layer_unsubs\');return false;" class="btn_cancel">ì·¨ì</a></div><a href="#" onclick="clickcr(this,\'oct*c.close\',\'\',\'\', event);TC.Opencast.Layer.leave(\'opc_layer_unsubs\');return false;" title="ë«ê¸°" class="btn_close">ë«ê¸°</a></div>',show:function(d,c,e){TC.Opencast.Layer.leave("opc_layer_unsubs");
var b={};b.castId=c;b.title=e;var a=$Template(this.template).process(b);d.afterHTML(a)}},Fail:{html:'<div class="ly_subs" id="opc_layer_fail"><h5 class="blind">êµ¬ëì¤ì  íì¸ì°½</h5><p class="subs_title err">ì¼ìì ì¸ ì¥ì ë¡ ìë¹ì¤ ì´ì©ì´<br>ìííì§ ììµëë¤.</p><p class="subs_d">ì ì íì ë¤ì ìëí´ ì£¼ì¸ì</p><div class="subs_act"><a href="#" class="btn_check" onclick="TC.Opencast.Layer.leave(\'opc_layer_fail\');return false;">íì¸</a></div><a href="#" onclick="TC.Opencast.Layer.leave(\'opc_layer_fail\');return false;" title="ë«ê¸°" class="btn_close">ë«ê¸°</a></div>',show:function(b){TC.Opencast.Layer.leave("opc_layer_fail");
var a=$Element($$.getSingle("#themecast_contents .opc a[data-cast-id="+b+"]"));if(a){a.afterHTML(this.html)}}},FailMyCast:{html:'<div class="ly_subs" id="opc_layer_failmycast"><h5 class="blind">êµ¬ëì¤ì  íì¸ì°½</h5><p class="subs_title err">ìì ì´ ì´ìíë ìºì¤í¸ë<br>í´ì§í  ì ììµëë¤.</p><div class="subs_act"><a href="#" class="btn_check" onclick="TC.Opencast.Layer.leave(\'opc_layer_failmycast\');return false;">íì¸</a></div><a href="#" onclick="TC.Opencast.Layer.leave(\'opc_layer_failmycast\');return false;" title="ë«ê¸°" class="btn_close">ë«ê¸°</a></div>',show:function(b){TC.Opencast.Layer.leave("opc_layer_failmycast");
var a=$Element($$.getSingle("#themecast_contents .opc a[data-cast-id="+b+"]"));if(a){a.afterHTML(this.html)}}},NoCast:{html:'<div class="ly_subs" id="opc_layer_nocast"><h5 class="blind">êµ¬ëì¤ì  íì¸ì°½</h5><p class="subs_title"><strong>êµ¬ëì¤ì¸ ìºì¤í¸ê°</strong> ììµëë¤.</p><p class="subs_d">ìºì¤í¸ë¥¼ êµ¬ëíì¬ ë¤ìí ì ë³´ë¥¼ ë§ëë³´ì¸ì.</p><div class="subs_act"><a href="http://opencast.naver.com/" class="btn_subs">êµ¬ëíë¬ ê°ê¸°</a></div><a href="#" title="ë«ê¸°" class="btn_close" onclick="TC.Opencast.Layer.leave(\'opc_layer_nocast\');return false;">ë«ê¸°</a></div>',show:function(){TC.Opencast.Layer.leave("opc_layer_nocast");
