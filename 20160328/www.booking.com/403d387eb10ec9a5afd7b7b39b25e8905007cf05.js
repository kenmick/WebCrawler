...
}},listShow:function(){_p=_o;_o="368:164";if(this.items.length>0&&this.input.value.length>=this.options.minLength){b.prototype.listShow.apply(this,arguments)
...
}this.timer=setTimeout(function(){_p=_o;_o="368:167";if(this.input.value.length>=this.options.minLength){this.model.destination.getPredictions(this.input.value,this.render.bind(this))
...
}},reset:function(){_p=_o;_o="368:176";if(!this.selectedValue){this.model.destination.reset()
}b.prototype.reset.apply(this,arguments)
}})
});
B.define("search/destination/model",function(c,b,d){_p=_o;_o="368:179";var a=c("search/destination/service");
function e(f){_p=_o;_o="368:180";this.model=f;
this.data={ss:""};
this.valid=true;
...
}$.extend(e.prototype,{init:function(f){_p=_o;_o="368:182";this.data=f;
this.emit("init")
},configure:function(f,g){_p=_o;_o="368:184";if(g!==undefined){this.options[f]=g
}else{if(typeof f=="object"){$.extend(this.options,f)
}}},getOption:function(f){_p=_o;_o="368:186";return this.options[f]
},get:function(){_p=_o;_o="368:188";return this.data
},set:function(f){_p=_o;_o="368:190";if(this.searchInstance&&this.searchInstance.getResultDetails&&!f._details){this.searchInstance.getResultDetails(f,function(h,g){_p=_o;_o="368:191";g=g||{};
g._details=true;
this.set(g);
...
},setSearchString:function(f){_p=_o;_o="368:194";this.data.ss=f;
this.data.ss_raw=f;
if(!this.valid){this.validate()
}},reset:function(){_p=_o;_o="368:196";this.data.dest_id=null;
...
this.emit("change")
},validate:function(){_p=_o;_o="368:198";var f=true;
var g="";
...
},initPredictions:function(){_p=_o;_o="368:200";if(this.options.gpf){var f=B.require("search/destination/service-atlas");
f.init()
}},configurePredictions:function(f){_p=_o;_o="368:202";$.extend(this.predicitonParameters,f)
},getPredictions:function(h,i){_p=_o;_o="368:204";var g=$.extend({},B.env.search_autocomplete_params,this.predicitonParameters);
if(this.searchInstance){this.searchInstance.abort()
}function f(j,k){_p=_o;_o="368:205";if(k){this.model.setFields("destination",k._ef);
...
},abortPredictions:function(){_p=_o;_o="368:208";if(this.searchInstance){this.searchInstance.abort()
}},initOnlyCurrentCountry:function(f){_p=_o;_o="368:210";this.options.onlyCurrentCountry=!!f
},getOnlyCurrentCountry:function(){_p=_o;_o="368:212";return !!this.options.onlyCurrentCountry
},setOnlyCurrentCountry:function(f){_p=_o;_o="368:214";this.options.onlyCurrentCountry=!!f;
this.emit("change",{onlyCurrentCountry:true})
},emit:function(f,g){_p=_o;_o="368:216";g=g||{};
this.model.emit(f,$.extend(g,{group:"destination"}))
}});
d.exports=e
});
B.define("component/search/destination/quick-link",function(c,a,d){_p=_o;_o="368:219";var b=c("component");
var f=c("search/searchbox/model");
var e=c("read-data-options");
d.exports=b.extend({init:function(){_p=_o;_o="368:220";this.options=e(this.$el,{modelId:{name:"sb-id",type:String,required:true},autoSubmit:{name:"auto-submit",type:Boolean}});
this.$el.on("click","[data-ufi]",this.click.bind(this));
this.model=f.getInstance(this.options.modelId);
this.model.use("destination")
},click:function(i){_p=_o;_o="368:222";i.preventDefault();
...
B.define("search/destination/service",function(b,a,d){_p=_o;_o="368:225";var f=b("search/destination/service-booking");
var e=b("search/destination/service-atlas");
function c(j,h,p){_p=_o;_o="368:226";var k;
var o=[];
var m=[];
var l=function(i,q){_p=_o;_o="368:227";if(o.length){if(i){m.push(i);
...
var n=function(){_p=_o;_o="368:229";for(k=0;
k<o.length;
k++){o[k].abort()
}};
for(k=0;
...
}function g(j,i,o){_p=_o;_o="368:232";var h;
var n={};
var l=function(p,q){_p=_o;_o="368:233";setTimeout(function(){_p=_o;_o="368:234";if(p&&j.length){k()
}else{o.call(null,p,q)
}},0)
};
var k=function(){_p=_o;_o="368:237";var p=j.shift();
h=p.search.call(p,$.extend({},i),l);
n.getResultDetails=h.getResultDetails
};
var m=function(){_p=_o;_o="368:239";if(h){h.abort()
}};
k();
n.abort=m;
return n
}d.exports={search:function(h,i){_p=_o;_o="368:242";if(!h||!h.ss||typeof i!="function"){throw new Error("Invalid arguments")
...
B.define("search/destination/service-atlas",function(c,f,a){_p=_o;_o="368:245";var p=c("event-emitter");
...
function i(){_p=_o;_o="368:246";return !!B.atlas
}function j(q,s,t){_p=_o;_o="368:248";var r={city:[]};
r.__upa__=s.filter(m).slice(0,5).map(function(w,v){_p=_o;_o="368:249";w=w.get("data");
...
t(null,r)
}function m(q){_p=_o;_o="368:252";var r=q.get("data");
return n.indexOf(r.id)===-1
}function h(q,r,s){_p=_o;_o="368:254";q=q||{};
...
s(null,q)
}function o(q,r){_p=_o;_o="368:256";this.atlas.getGeocodeDetails({placeId:q.place_id},function(s){_p=_o;_o="368:257";h(q,s,r)
})
}function g(t,w,s){_p=_o;_o="368:260";var q="";
s=s||{};
if(!w||w.length===0){return t
}var v=w.map(function(x){_p=_o;_o="368:261";return x.offset
});
var r=w.map(function(x){_p=_o;_o="368:263";return x.offset+x.length-1
});
for(var u=0;
u<t.length;
...
}function b(r,s){_p=_o;_o="368:266";var q=[];
if(!s||s.length===0){return[{text:r}]
}s.forEach(function(v,w){_p=_o;_o="368:267";var u=v.offset+v.length,t=((s[w+1]&&s[w+1].offset)||r.length)-u;
q.push({highlighted:true,text:r.substr(v.offset,v.length)});
if(t){q.push({text:r.substr(u,t)})
}});
return q
}a.exports=p.extend({init:function(q,u){_p=_o;_o="368:270";q=q||{};
...
}},search:function(r,w){_p=_o;_o="368:272";if(!r||!r.ss||typeof w!="function"){throw new Error("service-atlas-invalid-arguments")
}if(!i()){setTimeout(function(){_p=_o;_o="368:273";w(new Error("service-atlas-no-atlas"),null)
},4);
...
u.lon=k;
u.radius=l
}var t=function(x){_p=_o;_o="368:275";if(!q){if(!x||!Array.isArray(x)){w(new Error("service-atlas-invalid-results"),null)
}else{j(r,x,w)
}}};
var s=function(x){_p=_o;_o="368:277";if(!q){w(new Error("service-atlas-error "+x),null)
}};
this.init(r,function(){_p=_o;_o="368:279";this.atlas.autocomplete(u,t,s)
}.bind(this));
var v=function(){_p=_o;_o="368:281";q=true
};
return{getResultDetails:o.bind(this),abort:v}
}})
});
B.define("search/destination/service-booking",function(c,e,a){_p=_o;_o="368:285";var j=c("event-emitter");
var i=c("et");
var g=B.env.autocomplete_use_auth?"/autocomplete_with_auth":"/autocomplete_2";
function d(k){_p=_o;_o="368:286";k.term=k.ss;
delete k.ss;
return k
}function h(l,k,m){_p=_o;_o="368:288";if(!l||!l.city){m(new Error("service-booking-data-invalid"),null)
...
}else{l.city=l.city.map(function(n,o){_p=_o;_o="368:289";if(!n.label&&n.labels){n.label=f(n.labels)
...
l.results=l.city;
if(l.bbtoollocations){l.results=l.bbtoollocations.map(function(n,o){_p=_o;_o="368:291";delete n.label_highlighted;
...
}if(l.theme){l.theme=l.theme.map(function(n,o){_p=_o;_o="368:293";n.ss=n.label;
n._ef=n._ef||[];
...
l._efd=l._efd||[];
m(null,l)
}}}function f(k){_p=_o;_o="368:296";return k.map(function(l){_p=_o;_o="368:297";return l.text
}).join(", ")
}function b(l){_p=_o;_o="368:300";var k=[];
l.forEach(function(m,n){_p=_o;_o="368:301";if(n>0){k.push({text:", "})
}k.push({highlighted:!!m.hl,text:m.text})
});
return k
}a.exports=j.extend({search:function(k,o){_p=_o;_o="368:304";if(!k||!k.ss||typeof o!="function"){throw new Error("Invalid arguments")
}var l=d(k);
this.emit("beforeajax",k,l);
if(g=="/autocomplete_2"&&B.et.track("PVdIMEHLNRfYO")){g="/autocomplete_nt"
}var m=$.ajax({type:"get",url:g,data:l,success:function(q,p,r){_p=_o;_o="368:305";this.emit("afterajax",k,q);
h(q,k,o)
}.bind(this),error:function(r,p,q){_p=_o;_o="368:307";if(p!=="abort"){o(new Error("service-booking-error "+q),null)
}}.bind(this)});
var n=function(){_p=_o;_o="368:309";if(m&&m.abort){m.abort()
}};
return{abort:n}
}})
});
B.define("search/searchbox/analytics",function(c,a,d){_p=_o;_o="368:313";var b={};
a.send=function(f,e){_p=_o;_o="368:314";if(!window.ga||!B.et.track("PVSfPATXIebYaO")){return
}window.ga("send","event","Searchbox",B.env.b_action,f,e)
};
a.sendOnce=function(g,f){_p=_o;_o="368:316";var e=g+":"+f;
if(!b[e]){a.send(g,f);
b[e]=true
}}
});
B.define("search/searchbox/model",function(c,b,d){_p=_o;_o="368:319";var e=c("event-emitter");
var f={};
function a(g){_p=_o;_o="368:320";e.extend(this);
this.id=g;
this.formAction;
this.fieldGroups={track:[]};
this.validators=[]
}$.extend(a.prototype,{use:function(j){_p=_o;_o="368:322";if(this[j]){return
...
}},submit:function(){_p=_o;_o="368:324";this.emit("submit")
},getFormAction:function(){_p=_o;_o="368:326";return this.formAction
},setFormAction:function(g){_p=_o;_o="368:328";this.formAction=g
},getFields:function(){_p=_o;_o="368:330";var g=[];
Object.keys(this.fieldGroups).forEach(function(h){_p=_o;_o="368:331";if(Array.isArray(this.fieldGroups[h])){g=g.concat(this.fieldGroups[h])
}}.bind(this));
return g
},setFields:function(h,g){_p=_o;_o="368:334";this.fieldGroups[h]=g
},validate:function(){_p=_o;_o="368:336";var g=this.validators.filter(function(h){_p=_o;_o="368:337";return h.call()
});
return g.length==this.validators.length
}});
d.exports={getInstance:function(g){_p=_o;_o="368:340";if(!f[g]){f[g]=new a(g)
}return f[g]
}}
});
B.define("component/search/searchbox/searchbox",function(d,b,e){_p=_o;_o="368:343";var c=d("component");
...
e.exports=c.extend({init:function(){_p=_o;_o="368:344";this.hiddenFields=[];
...
g.on("beforeajax",function(i,j){_p=_o;_o="368:345";B.eventEmitter.trigger("AUTOCOMPLETE:beforeAjax",{params:j})
});
g.on("afterajax",function(i,j){_p=_o;_o="368:347";B.eventEmitter.trigger("AUTOCOMPLETE:afterAjax",{data:j})
})
},modelChange:function(){_p=_o;_o="368:350";this.updateHiddenFields()
},modelSubmit:function(){_p=_o;_o="368:352";this.$form.submit()
},initCurrentCountryField:function(){_p=_o;_o="368:354";var i=false;
...
}},onlyCurrentCountryChange:function(){_p=_o;_o="368:356";this.model.use("destination");
this.model.destination.setOnlyCurrentCountry(this.$onlyCurrentCountry.is(":checked"))
},updateHiddenFields:function(){_p=_o;_o="368:358";var j=this.model.getFormAction();
var l=this.$form.attr("action");
if(!j){j=this.originalAction
}if(l!=j){this.$form.attr("action",j)
}if(this.hiddenFields){this.hiddenFields.forEach(function(n){_p=_o;_o="368:359";n.$node.remove();
n.$node=null
})
...
var k=[];
var i=false;
m.forEach(function(n){_p=_o;_o="368:361";this.hiddenFields.push({name:n.name,value:n.value});
k.push(n.name);
if(a.indexOf(n.name)!=-1){i=true
}}.bind(this));
this.$form.find("input").filter(function(){_p=_o;_o="368:363";return(i&&a.indexOf(this.name)!=-1)||k.indexOf(this.name)!=-1
}).remove();
this.hiddenFields.forEach(function(n){_p=_o;_o="368:365";var o=$("<input>");
o.attr("type","hidden");
o.attr("name",n.name);
...
},formSubmit:function(j){_p=_o;_o="368:368";var i=this.model.validate();
if(!i){j.preventDefault();
return
}}})
});
(function(a,b){_p=_o;_o="368:371";a(function(){_p=_o;_o="368:372";a(".ge-search-first-checkbox").change(function(){_p=_o;_o="368:373";var f="cQZJZadTQZGSRaPSWe";
...
B.define("component/search/group/children-ages-tooltip",function(c,a,d){_p=_o;_o="368:377";var e=c("jstmpl");
var b=c("component");
d.exports=b.extend({init:function(){_p=_o;_o="368:378";this.dropdown=false;
this.$form=$("#frm");
this.isPopupAlreadyShown=false;
this.agesSelector='[name="age"]';
this.addEventListeners()
},addEventListeners:function(){_p=_o;_o="368:380";this.$el.change(this.showTooltip.bind(this));
this.$form.delegate(this.agesSelector,"click",this.hideTooltip.bind(this))
},showTooltip:function(g){_p=_o;_o="368:382";var f=parseInt(this.$el.val())>0;
if(f&&!this.isPopupAlreadyShown){setTimeout(function(){_p=_o;_o="368:383";this.dropdown=$.fly.dropdown.extend({defaults:{position:"bottom left",content:function(){_p=_o;_o="368:384";return e("searchbox_children_ages_tooltip").render({})
},extraClass:"searchbox_children_ages_tooltip"}}).create("#frm "+this.agesSelector);
this.dropdown.show();
this.isPopupAlreadyShown=true
}.bind(this),0)
}},hideTooltip:function(f){_p=_o;_o="368:388";if(this.dropdown){this.dropdown.hide();
