...
var jc=function(){if(bc&&p.opera){var a;var b=p.opera.version;try{a=b()}catch(c){a=b}return a}a="";(b=hc())&&(a=b?b[1]:"");return G&&(b=ic(),null!=b&&b>parseFloat(a))?String(b):a}(),kc={};
...
;var Me={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function Ne(a,b){B.call(this);this.B=this.m=a;this.T=b;this.F=!1;this.h={};this.aa=this.S=null;this.U=new C;ob(this,ma(pb,this.U));this.l={};this.C=this.ca=this.j=this.ha=this.f=null;this.Y=!1;this.K=this.D=this.P=this.R=null;this.da={};this.Sa=["onReady"];this.Z=new le(this);ob(this,ma(pb,this.Z));this.fa=null;this.ra=NaN;this.$={};Oe(this);this.A("onDetailedError",v(this.ib,this));this.A("onTabOrderChange",v(this.Va,this));this.A("onTabAnnounce",v(this.sa,this));this.A("WATCH_LATER_VIDEO_ADDED",
v(this.jb,this));this.A("WATCH_LATER_VIDEO_REMOVED",v(this.kb,this));Ed||(this.A("onMouseWheelCapture",v(this.fb,this)),this.A("onMouseWheelRelease",v(this.gb,this)));this.A("onAdAnnounce",v(this.sa,this));this.L=new le(this);ob(this,ma(pb,this.L));this.ga=!1;this.ea=null}
