...
function Vj(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,ca:pa(a.A,d,!0),onError:pa(a.o,e),gb:pa(a.B,e)};c&&(a.S=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Xd(b,a)}
...
g.Ic=function(){this.h=NaN;this.f=Xd(Uj(this.F,"/pairing/get_screen"),{method:"POST",S:{pairing_code:this.B},timeout:5E3,ca:v(this.Ke,this),onError:v(this.Je,this),gb:v(this.Le,this)})};
...
x(al,V);g=al.prototype;g.ub=function(a){this.j=a;this.D("sessionScreen",this.j)};
...
function dl(a,b){J(a.A);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.j||a.j.id!=b){var c=v(a.ub,a),d=v(a.aa,a);a.pc(b,c,d,5)}}else a.aa(Error("Waiting for session status timed out."))}
...
function hl(a){a.f=a.K.Uc(a.N,a.h.label,a.h.friendlyName,v(function(a){this.f=t;this.ub(a)},a),v(function(a){this.f=t;
this.aa(a)},a))}
...
g.Fd=function(a,b){Vk(this.K,this.J.receiver.label,a,this.h.friendlyName,v(function(a){a&&a.token?(this.ub(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Ub(b)},this),v(function(a){bl(this,"Failed to get DIAL screen: "+a);
...
jl.prototype.Zb=t;jl.prototype.Sa=function(){J(this.f);this.f=NaN;var a=hk(this.K.$(),this.h.label);a?this.ub(a):this.aa(Error("No such screen"))};
...
function Dm(a){if(!ga(a)&&a&&!a.Ua){var b=a.src;if(b&&b[km])rm(b.j,a);else{var c=a.type,d=a.f;b.removeEventListener?b.removeEventListener(c,d,a.nb):b.detachEvent&&b.detachEvent(Am(c),d);vm--;(c=ym(b))?(rm(c,a),0==c.h&&(c.src=null,b[tm]=null)):nm(a)}}}
function Am(a){return a in um?um[a]:um[a]="on"+a}
function Em(a,b,c,d){var e=!0;if(a=ym(a))if(b=a.f[b.toString()])for(b=b.concat(),a=0;a<b.length;a++){var f=b[a];f&&f.nb==c&&!f.Ua&&(f=Fm(f,d),e=e&&!1!==f)}return e}
function Fm(a,b){var c=a.listener,d=a.rb||a.src;a.lb&&Dm(a);return c.call(d,b)}
...
g.sb=function(a,b,c,d){return pm(this.j,String(a),b,c,d)};
...
function Jm(a,b,c,d){b=a.j.f[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var h=b[f];if(h&&!h.Ua&&h.nb==c){var k=h.listener,l=h.rb||h.src;h.lb&&rm(a.j,h);e=!1!==k.call(l,d)&&e}}return e&&0!=d.Mc}
...
x(gn,D);var hn=[];g=gn.prototype;g.sb=function(a,b,c,d){ea(b)||(b&&(hn[0]=b.toString()),b=hn);for(var e=0;e<b.length;e++){var f=wm(a,b[e],c||this.handleEvent,d||!1,this.h||this);if(!f)break;this.f[f.key]=f}return this};
...
g=pn.prototype;g.Ia=null;g.na=!1;g.Wa=null;g.bc=null;g.ib=null;g.Va=null;g.Aa=null;g.Da=null;g.Ka=null;g.O=null;g.kb=0;g.oa=null;g.Cb=null;g.Ja=null;g.cb=-1;g.Nc=!0;g.Fa=!1;g.Sb=0;g.wb=null;var qn={},rn={};g=pn.prototype;g.setTimeout=function(a){this.o=a};
...
g.ge=function(a){this.Fa||(zn(this),this.na=a,this.f.tb(this),this.f.ma(4))};
...
function Cn(a){a.f.tc()||a.Fa||a.f.tb(a)}
...
function On(a){var b=a.f.J;if(null!=b)X(),b?(X(),Qn(a.f,a,!1)):(X(),Qn(a.f,a,!0));else if(a.da=new pn(a,0,void 0,void 0,void 0),a.da.Ia=a.Qb,b=a.f,b=Mn(b,b.jb()?a.bb:null,a.Rb),X(),!L||td(10))Bg(b,"TYPE","xmlhttp"),un(a.da,b,!1,a.bb,!1);else{Bg(b,"TYPE","html");var c=a.da;a=!!a.bb;c.Va=3;c.Aa=Dg(b.clone());En(c,a)}}
g.Lb=function(a){return this.f.Lb(a)};
g.tc=function(){return!1};
g.Bc=function(a,b){this.ya=a.cb;if(0==this.fa)if(b){try{var c=this.h.parse(b)}catch(d){c=this.f;c.ka=this.ya;Pn(c,2);return}this.bb=c[0];this.Xa=c[1]}else c=this.f,c.ka=this.ya,Pn(c,2);else if(2==this.fa)if(this.xb)X(),this.Vb=w();else if("11111"==b){if(X(),this.xb=!0,this.ob=w(),c=this.ob-this.Qc,!L||td(10)||500>c)this.ya=200,this.da.cancel(),X(),Qn(this.f,this,!0)}else X(),this.ob=this.Vb=w(),this.xb=!1};
g.tb=function(){this.ya=this.da.cb;if(this.da.na)0==this.fa?this.Xa?(this.fa=1,Nn(this)):(this.fa=2,On(this)):2==this.fa&&(a=!1,(a=!L||td(10)?this.xb:200>this.Vb-this.ob?!1:!0)?(X(),Qn(this.f,this,!0)):(X(),Qn(this.f,this,!1)));else{0==this.fa?X():2==this.fa&&X();var a=this.f;a.ka=this.ya;Pn(a,2)}};
...
g=bo.prototype;g.$a=null;g.W=null;g.L=null;g.Pb=null;g.pb=null;g.ic=null;g.qb=null;g.fb=0;g.Hd=0;g.T=null;g.Ca=null;g.xa=null;g.Ha=null;g.Ba=null;g.Bb=null;g.Ra=-1;g.uc=-1;g.ka=-1;g.ab=0;g.Pa=0;g.Ga=8;var eo=new Hm;function fo(a){gm.call(this,"statevent",a)}
...
function io(a){jo(a);if(3==a.f){var b=a.fb++,c=a.pb.clone();O(c,"SID",a.j);O(c,"RID",b);O(c,"TYPE","terminate");ko(a,c);b=new pn(a,0,a.j,b,void 0);b.Va=2;b.Aa=Dg(c.clone());(new Image).src=b.Aa;b.ib=w();vn(b)}lo(a)}
...
function po(a,b){if(1==a.f){if(!b){a.fb=Math.floor(1E5*Math.random());var c=a.fb++,d=new pn(a,0,"",c,void 0);d.Ia=null;var e=qo(a),f=a.pb.clone();O(f,"RID",c);a.B&&O(f,"CVER",a.B);ko(a,f);sn(d,f,e);a.W=d;a.f=2}}else 3==a.f&&(b?ro(a,b):0!=a.h.length&&(a.W||ro(a)))}
function ro(a,b){var c,d;b?6<a.Ga?(a.h=a.l.concat(a.h),a.l.length=0,c=a.fb-1,d=qo(a)):(c=b.F,d=b.Ka):(c=a.fb++,d=qo(a));var e=a.pb.clone();O(e,"SID",a.j);O(e,"RID",c);O(e,"AID",a.Ra);ko(a,e);c=new pn(a,0,a.j,c,a.ab+1);c.Ia=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.W=c;sn(c,e,d)}
...
g.Ec=function(){this.xa=null;this.L=new pn(this,0,this.j,"rpc",this.A);this.L.Ia=null;this.L.Sb=0;var a=this.ic.clone();O(a,"RID","rpc");O(a,"SID",this.j);O(a,"CI",this.Bb?"0":"1");O(a,"AID",this.Ra);ko(this,a);if(!L||td(10))O(a,"TYPE","xmlhttp"),un(this.L,a,!0,this.qb,!1);else{O(a,"TYPE","html");var b=this.L,c=!!this.qb;b.Va=3;b.Aa=Dg(a.clone());En(b,c)}};
function Qn(a,b,c){a.Bb=c;a.ka=b.ya;a.qd(1,0);a.pb=Mn(a,null,a.Pb);oo(a)}
g.Bc=function(a,b){if(0!=this.f&&(this.L==a||this.W==a))if(this.ka=a.cb,this.W==a&&3==this.f)if(7<this.Ga){var c;try{c=this.o.parse(b)}catch(f){c=null}if(ea(c)&&3==c.length)if(0==c[0])a:{if(!this.xa){if(this.L)if(this.L.ib+3E3<this.W.ib)mo(this),this.L.cancel(),this.L=null;else break a;to(this);X()}}else this.uc=c[1],0<this.uc-this.Ra&&37500>c[2]&&this.Bb&&0==this.Pa&&!this.Ha&&(this.Ha=Fn(v(this.Id,this),6E3));else Pn(this,11)}else"y2f%"!=b&&Pn(this,11);else if(this.L==a&&mo(this),!/^[\s\xa0]*$/.test(b)){c=
this.o.parse(b);ea(c);for(var d=0;d<c.length;d++){var e=c[d];this.Ra=e[0];e=e[1];2==this.f?"c"==e[0]?(this.j=e[1],this.qb=e[2],e=e[3],null!=e?this.Ga=e:this.Ga=6,this.f=3,this.T&&this.T.mc(this),this.ic=Mn(this,this.jb()?this.qb:null,this.Pb),so(this)):"stop"==e[0]&&Pn(this,7):3==this.f&&("stop"==e[0]?Pn(this,7):"noop"!=e[0]&&this.T&&this.T.lc(this,e),this.Pa=0)}}};
