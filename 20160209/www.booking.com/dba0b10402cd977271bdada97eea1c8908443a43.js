...
if(k.et.track("PVSfPJUIcIKHXe")){if((l&&m)&&(l.valueOf()>m.valueOf())){o=l.valueOf()-m.valueOf()
...
}$(".js-b-selectbox__groupselection").change(function(){if(parseInt($(this).val())===3){$(".js-multi-room-rooms").val(B.Group.rooms.length);
