...
if(h&&h.b_states&&h.b_states.overlay){this.Interface.setMixedMarkerType(i,{zIndex:this.getMarkerZIndex(h)})
...
var j=this,i=[],h=[];
10904;
k.forEach(function(m){m=j.Interface.getMixedMarker(m.b_id);
...
if(h&&h.b_states&&h.b_states.overlay){h.b_behaviors.visited=true;
this.Interface.setMixedMarkerType(i,{content:this.getMarkerContent(h),zIndex:this.getMarkerZIndex(h)})
}else{h.b_behaviors.visited=true;
this.Interface.setMixedMarkerType(i,this[d(h)](h?h.iconType||h.b_type:""))
