...
if(l.__suggestions__&&l.__suggestions__.updated_suggestion){l.ef.push({name:"suggested_term",value:l.__suggestions__.updated_suggestion})
}m(null,l)
...
}if(l.__suggestions__&&l.__suggestions__.has_results){j.results.push({id:"suggestion",type:"suggestion",text:l.__suggestions__.initial_term,suggestedTerm:l.__suggestions__.updated_suggestion,suggestion:l.__suggestions__,ef:false});
j.suggestion=l.__suggestions__
