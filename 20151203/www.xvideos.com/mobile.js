...
function mobileReplacePlayerDivTwoQual(type, mp4urllow, mp4urlhigh, thumburl, channel, viddefaut) {
	...
	if (type == "html5player") {
		text = "<video poster=\"" + thumburl + "\" src=\"" + mp4url + "\" width=\"582\" height=\"380\" autobuffer controls></video><br />";
	...
	if (type == "html5playerautoplay") {
		player.innerHTML = "<video poster=\"" + thumburl + "\" src=\"" + mp4url + "\" width=\"600\" height=\"380\" autobuffer controls autoplay /><br />";
	}
	if (type == "tablet") {
		text = "<video poster=\"" + thumburl + "\" src=\"" + mp4url + "\" width=\"582\" height=\"400\" autobuffer controls></video><br />";
		text += "<div style='width: 570px; text-align: center; font-size: 24px; border: 2px #333 solid; margin: 3px; padding: 20px; display: block; background: #AAA;'>" +
				"<a href=\"" + mp4urllow + "\" style='margin: auto; width: 170px;'>" +
						"View Low Qual</a>";
