...
<!--[if gt IE 9]><!--><html lang="en" data-scribe-reduced-action-queue="true"><!--<![endif]-->
  ...
  <script id="resolve_inline_redirects" nonce="aAIm5VI+SIkbB1j4NREuuQ==">
...
;e();window.addEventListener?window.addEventListener("hashchange",e,!1):window.attachEvent&&window.attachEvent("onhashchange",e)})();
  ...
  <script id="swift_action_queue" nonce="aAIm5VI+SIkbB1j4NREuuQ==">
...
a.getAttribute("contenteditable")=="true"}var a=(new Date).getTime(),b=1e4,c=/^([^\.]+\.)*twitter\.com$/,d=/^key/,e=["click","keydown","keypress","keyup"],f=[],g=null,i=!0,j={captured:[],ignored:[],direct:[],all:[]};for(var k=0,l;l=e[k];k++)document["on"+l
  ...
  <script id="composition_state" nonce="aAIm5VI+SIkbB1j4NREuuQ==">
...
,b,!1)}})();
    ...
    <link rel="stylesheet" href="https://abs.twimg.com/a/1441703789/css/t1/twitter_core.bundle.css">
    <link rel="stylesheet" href="https://abs.twimg.com/a/1441703789/css/t1/twitter_logged_out.bundle.css">
...
<link rel="mask-icon" sizes="any" href="https://abs.twimg.com/a/1441703789/img/t1/favicon.svg" color="#55acee">
...
<link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="Twitter">
          ...
          <link rel="stylesheet" href="https://abs.twimg.com/a/1441703789/css/t1/twitter_more_1.bundle.css">
      <link rel="stylesheet" href="https://abs.twimg.com/a/1441703789/css/t1/twitter_more_2.bundle.css">

  </head>
  <body class="three-col logged-out front-page-photo-set front-page" 
data-fouc-class-names="swift-loading"
 dir="ltr">
      <script id="swift_loading_indicator" nonce="aAIm5VI+SIkbB1j4NREuuQ==">
    ...
    <ul class="nav secondary-nav language-dropdown"><li class="dropdown js-language-dropdown">
        ...
        <div class="js-front-language">
          <form action="/sessions/change_locale" class="t1-form language" method="POST">
            ...
            <input type="hidden" name="authenticity_token" value="75d9de83a521ae0d50b64ee9bff3df2991e9550a">
          </form>
        </div>
  ...
  <label class="t1-label password js-password">
    ...
    <input type="hidden" id="ui_metrics_seed" name="ui_metrics_seed" value="1441840499226" autocomplete="off">
...
<input type="hidden" value="75d9de83a521ae0d50b64ee9bff3df2991e9550a" name="authenticity_token"/>
...
<div id="media-edit-dialog" class="modal-container"></div>
  ...
  <input type="hidden" id="swift-module-path" value="https://abs.twimg.com/c/swift/en">
    ...
    <script src="https://abs.twimg.com/c/swift/en/init.50f0352da001958e4bf8f524213f9cc379b3b185.js" async></script>
