...
B.define("date-formatter",function(e,d,f){var g=B.env.b_date_format,c=B.env.b_month_for_formatted_date,h=B.env.b_weekday_formatted_date;
h[0]=h[7];
d.format=function(k,t){if(!k||k.year===undefined||k.month===undefined||k.day===undefined){throw new Error("date-formatter: invalid date provided")
...
booking[sNSExperiments]["eDUbKSPEIEZPPLWIGJDSaTfRe"]=(function(e,d){function c(){var f=false;
d(".pp_bpg_tooltip_holder").bind("mouseenter",function(){f=true;
setTimeout(function(){if(f){e.track.stage("eDUbKSPEIEZPPLWIGJDSaTfRe",1)
}},300)
});
d(".pp_bpg_tooltip_holder").bind("mouseleave",function(){f=false
})
...
}},_attachEvents:function(){var j=this;
var h=false;
this.$el.bind("mouseenter",function(){h=true;
setTimeout(function(){if(h){j.domHelper.$content.html(j.content);
j._position_tt();
j.domHelper.$parent.css({display:"block"});
setTimeout(function(){j.domHelper.$parent.removeClass("tt-fancy-holder--hidden")
},10)
}},j.delay)
}).bind("mouseleave",function(){h=false;
...
if(k){if(j){c("show");
$("body").bind("click.resize_partners",function(m){if(m&&m.target&&$(m.target).hasClass("no-trigger-resize")){return
...
}}}function d(){$("body").unbind("click.resize_partners");
e.moveTo(0,0);
$(e).trigger("resize");
c("hide")
...
g("#frm").bind("submit",function(n){var m;
...
}}}function c(l){l.find(".b-date-selector, .js--sb-searchbox-dates__check-in, .js--sb-searchbox-dates__check-out").dateSelector();
...
h=setTimeout(function(){g.track.stage(e,3)
},1000)
...
B.when({events:"ready",experiment:"NVFMEPbBXDaVWKMcCVaHWNLT"}).run(function(f){var d="NVFMEPbBXDaVWKMcCVaHWNLT",g=f("font-face-on-load"),k={woff:"//r-ec.bstatic.com/static/css/fonticons_clean/base64/woff/c9c03b45e375e72e42a401c016ae8a326c830d3c.css",opentype:"//r-ec.bstatic.com/static/css/fonticons_clean/base64/opentype/7cf1a72fd6275ec7028e655d78a76849c4f417be.css",truetype:"//r-ec.bstatic.com/static/css/fonticons_clean/base64/truetype/c2ab8c3656227a192e69c800fe78b162a098c3e4.css"},h=function(){if(B.et.track(d)==2){$("body").removeClass("iconfont_is_loading")
