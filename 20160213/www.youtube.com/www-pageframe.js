...
g=Ed.prototype;g.xa=function(a){return u(a)?this.f.getElementById(a):a};
...
g.Dd=Wd;g.contains=ee;function me(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
...
;var Ne,Oe,Pe;function Qe(){var a=Dd(),b=a.f,c=a.createElement("div");c.style.backgroundColor="rgb(1, 2, 3)";a.appendChild(b.body,c);b=te(c,"backgroundColor");b=b.replace(/ /g,"");Pe="rgb(0,0,0)"===b?"black":"rgb(255,255,255)"===b?"white":null;a.Dd(c)}
...
g.ya=function(){return Bf(this).keys};
g.Z=function(){return Bf(this).values};
g.isEmpty=function(){return!this.f.cookie};
g.Y=function(){return this.f.cookie?(this.f.cookie||"").split(zf).length:0};
...
Gf.prototype.Aa=function(){return this};
function Hf(a){if(a instanceof Gf)return a;if("function"==typeof a.Aa)return a.Aa(!1);if(fa(a)){var b=0,c=new Gf;c.next=function(){for(;;){if(b>=a.length)throw Ff;if(b in a)return a[b++];b++}};
...
return b}
;function Kf(a,b){this.j={};this.f=[];this.Ra=this.l=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)Lf(this,arguments[d],arguments[d+1])}else if(a){a instanceof Kf?(c=a.ya(),d=a.Z()):(c=zb(a),d=yb(a));for(var e=0;e<c.length;e++)Lf(this,c[e],d[e])}}
g=Kf.prototype;g.Y=function(){return this.l};
g.Z=function(){Mf(this);for(var a=[],b=0;b<this.f.length;b++)a.push(this.j[this.f[b]]);return a};
g.ya=function(){Mf(this);return this.f.concat()};
g.kb=function(a){for(var b=0;b<this.f.length;b++){var c=this.f[b];if(Nf(this.j,c)&&this.j[c]==a)return!0}return!1};
g.equals=function(a,b){if(this===a)return!0;if(this.l!=a.Y())return!1;var c=b||Of;Mf(this);for(var d,e=0;d=this.f[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function Of(a,b){return a===b}
g.isEmpty=function(){return 0==this.l};
g.clear=function(){this.j={};this.Ra=this.l=this.f.length=0};
g.remove=function(a){return Nf(this.j,a)?(delete this.j[a],this.l--,this.Ra++,this.f.length>2*this.l&&Mf(this),!0):!1};
...
function Lf(a,b,c){Nf(a.j,b)||(a.l++,a.f.push(b),a.Ra++);a.j[b]=c}
...
g.Aa=function(a){Mf(this);var b=0,c=this.Ra,d=this,e=new Gf;e.next=function(){if(c!=d.Ra)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw Ff;var e=d.f[b++];return a?e:d.j[e]};
return e};
function Nf(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
;function Pf(a){return a.Y&&"function"==typeof a.Y?a.Y():fa(a)||u(a)?a.length:vb(a)}
function Qf(a){if(a.Z&&"function"==typeof a.Z)return a.Z();if(u(a))return a.split("");if(fa(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return yb(a)}
function Rf(a){if(a.ya&&"function"==typeof a.ya)return a.ya();if(!a.Z||"function"!=typeof a.Z){if(fa(a)||u(a)){var b=[];a=a.length;for(var c=0;c<a;c++)b.push(c);return b}return zb(a)}}
...
g=$f.prototype;g.Y=function(){ig(this);return this.j};
...
g.ya=function(){ig(this);for(var a=this.f.Z(),b=this.f.ya(),c=[],d=0;d<b.length;d++)for(var e=a[d],f=0;f<e.length;f++)c.push(b[d]);return c};
g.Z=function(a){ig(this);var b=[];if(u(a))kg(this,a)&&(b=bb(b,this.f.get(jg(this,a))));else{a=this.f.Z();for(var c=0;c<a.length;c++)b=bb(b,a[c])}return b};
...
function Ng(a,b,c){var d=H("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=H("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=pf(window.location.href);e&&d.push(e);e=pf(a);if(Ua(d,e)||!e&&0==a.lastIndexOf("/",0))if(d=rf(a),d=sf(d))d=H("SMALLER_SESSION_TEMPDATA_NAME")?"ST-"+Ha(d).toString(36):"s_tempdata-"+Ha(d),e=b?wf(b):"",Df(d,e,5,"/"),b&&(b=b.itct||b.ved,d=t("yt.logging.screenreporter.storeParentElement"),b&&d&&d(new Lg))}if(c)return!1;Mg(a);return!0}
...
function Qg(a){if(!a.Ra){var b={};a.call(b);a.Ra=b.version}return a.Ra}
...
Sg.prototype.toString=function(){return this.topic};var Tg=t("yt.pubsub2.instance_")||new vc;vc.prototype.subscribe=vc.prototype.subscribe;vc.prototype.unsubscribeByKey=vc.prototype.wa;vc.prototype.publish=vc.prototype.G;vc.prototype.clear=vc.prototype.clear;r("yt.pubsub2.instance_",Tg,void 0);var Ug=t("yt.pubsub2.subscribedKeys_")||{};r("yt.pubsub2.subscribedKeys_",Ug,void 0);var Vg=t("yt.pubsub2.topicToKeys_")||{};r("yt.pubsub2.topicToKeys_",Vg,void 0);var Wg=t("yt.pubsub2.isAsync_")||{};r("yt.pubsub2.isAsync_",Wg,void 0);
...
function ah(a){var b="mouseover"==a.type&&"mouseenter"in Yg||"mouseout"==a.type&&"mouseleave"in Yg,c=a.type in Yg||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Yg[b],d;for(d in c.qa){var e=$g(b,d,a.target);e&&!ke(a.relatedTarget,function(a){return a==e})&&c.G(d,e,b,a)}}if(b=Yg[a.type])for(d in b.qa)(e=$g(a.type,d,a.target))&&b.G(d,e,a.type,a)}}
...
g.aa=function(a,b){return F(a,b)};function ch(){this.f="button";this.j=null;this.l=[];this.B={}}
...
function eh(a,b){if(b){var c=fh(a,b);if(c){a.j=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");Gg(c);a.yc(b,"button-menu-action",!1);var d=dh(a,b),e=Se(c).toString();delete a.B[e];I(function(){d&&d.parentNode&&(Gg(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=je(b,U(a,"group"),void 0),f=
[U(a,"active")];
e&&f.push(U(a,"group-active"));ob(b,f);P("yt-uix-button-menu-hide",b);ff(a.l);a.l.length=0}}
function fh(a,b){if(!b.widgetMenu){var c=a.aa(b,"button-menu-id"),c=c&&R(c),d=U(a,"menu");c?nb(c,[d,U(a,"menu-external")]):c=S(d,b);b.widgetMenu=c}return b.widgetMenu}
;function gh(a){this.f=a;this.j=null}
y(gh,bh);g=gh.prototype;g.Va=function(a){var b=bh.prototype.Va.call(this,a);return b?b:a};
g.dispose=function(){gh.L.dispose.call(this);hh(this)};
g.aa=function(a,b){var c=gh.L.aa.call(this,a,b);return c?c:(c=gh.L.aa.call(this,a,"card-config"))&&(c=t(c))&&c[b]?c[b]:null};
g.pc=function(a){var b=this.Va(a);if(b){B(b,U(this,"active"));var c=ih(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;jh(this,a,c);var d=U(this,"card-visible"),e=this.aa(a,"card-delegate-show")&&this.aa(b,"card-action");this.yc(b,"card-action",a);this.j=a;Gg(c);I(v(function(){e||(Fg(c),P("yt-uix-card-show",b,a,c));kh(c);B(c,d);P("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function ih(a,b,c){var d=c||b,e=U(a,"card");c=lh(a,d);var f=R(U(a,"card")+Se(d));if(f)return a=S(U(a,"card-body"),f),ee(a,c)||(Wd(c),a.appendChild(c)),f;f=document.createElement("div");f.id=U(a,"card")+Se(d);f.className=e;(d=a.aa(d,"card-class"))&&nb(f,d.split(/\s+/));d=document.createElement("div");d.className=U(a,"card-border");b=a.aa(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var h=document.createElement("div");
...
function lh(a,b){var c=b.cardContentNode;if(!c){var d=U(a,"content"),e=U(a,"card-content");(c=(c=a.aa(b,"card-id"))?R(c):S(d,b))||(c=document.createElement("div"));sb(c,d,e);b.cardContentNode=c}return c}
...
y(mh,gh);ca(mh);mh.prototype.pc=function(a){mh.L.pc.call(this,a);var b=this.Va(a);if(!F(b,"click-outside-persists")){var c=ia(a);if(this.l[c])return;var b=T(document,"click",v(this.A,this,a)),d=T(window,"blur",v(this.A,this,a));this.l[c]=[b,d]}a=T(window,"resize",v(this.Qe,this,a,void 0));this.B[c]=a};
mh.prototype.ab=function(a){mh.L.ab.call(this,a);a=ia(a);var b=this.l[a];b&&(ff(b),this.l[a]=null);if(b=this.B[a])ff(b),this.B[a]=null};
mh.prototype.A=function(a,b){je(b.target,"yt-uix"+(this.f?"-"+this.f:"")+"-card",void 0)||this.ab(a)};function nh(){gh.call(this,"hovercard")}
y(nh,gh);ca(nh);function oh(a,b,c,d){this.f=a;this.D=null;this.l=S("yt-dialog-fg",this.f)||this.f;if(a=S("yt-dialog-title",this.l)){var e="yt-dialog-title-"+ia(this.l);a.setAttribute("id",e);this.l.setAttribute("aria-labelledby",e)}this.l.setAttribute("tabindex","-1");this.J=S("yt-dialog-focus-trap",this.f);this.ca=!1;this.B=new vc;this.F=[];this.F.push(gf(this.f,"click",v(this.$d,this),"yt-dialog-dismiss"));this.F.push(T(this.J,"focus",v(this.wd,this),!0));ph(this);this.M=b;this.N=c;this.Ia=d;this.C=this.A=null}
...
g.wd=function(a){a.stopPropagation();vh(this)};
...
y(hi,sc);function ii(a,b,c,d){d=Ac(v(d,a.j));b.addEventListener(c,d);a.f.push({target:b,name:c,zc:d})}
hi.prototype.Kb=function(a){for(var b=0;b<this.f.length;b++)if(this.f[b]==a){this.f.splice(b,1);a.target.removeEventListener(a.name,a.zc);break}};
function ji(a){for(;a.f.length;){var b=a.f.pop();b.target.removeEventListener(b.name,b.zc)}}
hi.prototype.K=function(){ji(this);hi.L.K.call(this)};function ki(a){Pg.call(this,1,arguments)}
...
;var yi={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function zi(a,b){sc.call(this);this.C=this.A=a;this.X=b;this.J=!1;this.j={};this.za=this.V=null;this.ka=new vc;tc(this,w(uc,this.ka));this.B={};this.D=this.Ja=this.l=this.Pb=this.f=null;this.fa=!1;this.M=this.F=this.R=this.S=null;this.Ka={};this.ud=["onReady"];this.ga=new hi(this);tc(this,w(uc,this.ga));this.Sb=null;this.xc=NaN;this.la={};Ai(this);this.Ba("onDetailedError",v(this.je,this));this.Ba("onTabOrderChange",v(this.qd,this));this.Ba("onTabAnnounce",v(this.sc,this));this.Ba("WATCH_LATER_VIDEO_ADDED",
v(this.ke,this));this.Ba("WATCH_LATER_VIDEO_REMOVED",v(this.le,this));Hh||(this.Ba("onMouseWheelCapture",v(this.fe,this)),this.Ba("onMouseWheelRelease",v(this.ge,this)));this.Ba("onAdAnnounce",v(this.sc,this));this.N=new hi(this);tc(this,w(uc,this.N));this.Rb=!1;this.Qb=null}
y(zi,sc);var Bi=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=zi.prototype;g.getId=function(){return this.X};
g.oc=function(a,b){this.isDisposed()||(Ci(this,a),b||Di(this),Ei(this,b),this.J&&Fi(this))};
function Ci(a,b){a.Pb=b;a.f=b.clone();a.l=a.f.attrs.id||a.l;"video-player"==a.l&&(a.l=a.X,a.f.attrs.id=a.X);a.C.id==a.l&&(a.l+="-player",a.f.attrs.id=a.l);a.f.args.enablejsapi="1";a.f.args.playerapiid=a.X;a.Ja||(a.Ja=Gi(a,a.f.args.jsapicallback||"onYouTubePlayerReady"));a.f.args.jsapicallback=null;var c=a.f.attrs.width;c&&(a.C.style.width=Be(Number(c)||c,!0));if(c=a.f.attrs.height)a.C.style.height=Be(Number(c)||c,!0)}
g.xd=function(){return this.Pb};
function Fi(a){a.f.loaded||(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.j.loadVideoByPlayerVars(a.f.args):a.j.cueVideoByPlayerVars(a.f.args))}
...
g.Ve=function(){if(!this.fa){var a=Ii(this);a&&"html5"==Li(this)?(this.D="html5",this.J||this.eb()):(Mi(this),this.D="html5",a&&this.R?(this.A.appendChild(this.R),this.eb()):(this.f.loaded=!0,this.S=v(function(){var a=this.A,c=this.f.clone();t("yt.player.Application.create")(a,c);this.eb()},this),this.fa=!0,a?this.S():(Rc(this.f.assets.js,this.S),Zc(this.f.assets.css))))}};
g.Ue=function(){var a=this.f.clone();if(!this.F){var b=Ki(this);b&&(this.F=document.createElement("span"),this.F.tabIndex=0,ii(this.ga,this.F,"focus",this.Oc),this.M=document.createElement("span"),this.M.tabIndex=0,ii(this.ga,this.M,"focus",this.Oc),b.parentNode&&b.parentNode.insertBefore(this.F,b),b.parentNode&&b.parentNode.insertBefore(this.M,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Li(this))this.D="flash",this.J||Xh(a,!1,v(this.eb,this));
else{Mi(this);this.D="flash";this.f.loaded=!0;b=this.A;b=u(b)?Gd(b):b;a=Ah(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=Sh.getInstance();Th(c,a.minVersion)?(c=Yh(a,c),Wh(b,c,a)):$h(b,a,c);this.eb()}};
g.Oc=function(){Ki(this).focus()};
function Ki(a){var b=R(a.l);!b&&a.C&&a.C.querySelector&&(b=a.C.querySelector("#"+a.l));return b}
g.eb=function(){if(!this.isDisposed()){var a=Ki(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.fa=!1,a.isNotServable&&a.isNotServable(this.f.args.video_id))Ji(this);else{Ai(this);this.J=!0;a=Ki(this);a.addEventListener&&(this.V=Ni(this,a,"addEventListener"));a.removeEventListener&&(this.za=Ni(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.j[d]||(this.j[d]=Ni(this,a,d))}for(var e in this.B)this.V(e,
this.B[e]);Fi(this);this.Ja&&this.Ja(this.j);this.ka.G("onReady",this.j)}else this.xc=I(v(this.eb,this),50)}};
function Ni(a,b,c){var d=b[c];return function(){try{return a.Sb=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Sb=e,Cc(e,"WARNING"))}}}
function Ai(a){a.J=!1;if(a.za)for(var b in a.B)a.za(b,a.B[b]);for(var c in a.la)K(parseInt(c,10));a.la={};a.V=null;a.za=null;for(var d in a.j)a.j[d]=null;a.j.addEventListener=v(a.Ba,a);a.j.removeEventListener=v(a.He,a);a.j.destroy=v(a.dispose,a);a.j.getLastError=v(a.yd,a);a.j.getPlayerType=v(a.zd,a);a.j.getCurrentVideoConfig=v(a.xd,a);a.j.loadNewVideoConfig=v(a.oc,a);a.j.isReady=v(a.gf,a)}
g.gf=function(){return this.J};
g.Ba=function(a,b){if(!this.isDisposed()){var c=Gi(this,b);if(c){if(!Ua(this.ud,a)&&!this.B[a]){var d=Oi(this,a);this.V&&this.V(a,d)}this.ka.subscribe(a,c);"onReady"==a&&this.J&&I(w(c,this.j),0)}}};
g.He=function(a,b){if(!this.isDisposed()){var c=Gi(this,b);c&&this.ka.unsubscribe(a,c)}};
function Gi(a,b){var c=b;if("string"==typeof b){if(a.Ka[b])return a.Ka[b];c=function(){var a=t(b);a&&a.apply(m,arguments)};
a.Ka[b]=c}return c?c:null}
function Oi(a,b){var c="ytPlayer"+b+a.X;a.B[b]=c;m[c]=function(c){var e=I(function(){if(!a.isDisposed()){a.ka.G(b,c);var f=a.la,h=String(e);h in f&&delete f[h]}},0);
Eb(a.la,String(e))};
return c}
g.qd=function(a){a=a?be:ae;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.F||b==this.M||(b.focus(),b!=document.activeElement));)b=a(b)};
...
g.fe=function(){this.Rb||(Ih?(this.Qb=Nd(document),ii(this.N,window,"scroll",this.ze),ii(this.N,this.A,"touchmove",this.ue)):(ii(this.N,this.A,"mousewheel",this.Pc),ii(this.N,this.A,"wheel",this.Pc)),this.Rb=!0)};
g.ge=function(){ji(this.N);this.Rb=!1};
...
g.zd=function(){return this.D||Li(this)};
...
e[G]);d.ps=x();G={};var e=[],M;for(M in d)"_"!=M.charAt(0)&&(n=Math.round(d[M]-h),G[M]=n,e.push(M+"."+n));b.rt=e.join(",");M=b;var d=[],J;for(J in c)"_"!=J.charAt(0)&&d.push(J+"."+c[J]);M.it=d.join(",");(J=t("ytdebug.logTiming"))&&J(b,G,c);pi();H("EXP_DEFER_CSI_PING")?(wi(),r("yt.timing.deferredPingArgs_",b,void 0),J=I(wi,0),r("yt.timing.deferredPingTimer_",J,void 0)):vi(b);J=new ki(G.aft+(k||0));(M=t("yt.pubsub2.instance_"))&&M.publish.call(M,li.toString(),li,J)}}a.cancel();Ai(a);a.D=null;a.f&&(a.f.loaded=
!1);J=Ki(a);"html5"==Li(a)?a.R=J:J&&J.destroy&&J.destroy();Ud(a.A);ji(a.ga);a.F=null;a.M=null}
g.cancel=function(){this.S&&Yc(this.f.assets.js,this.S);K(this.xc);this.fa=!1};
g.K=function(){Mi(this);if(this.R&&this.f)try{this.R.destroy()}catch(b){Cc(b)}this.Ka=null;for(var a in this.B)m[this.B[a]]=null;this.Pb=this.f=this.j=null;delete this.A;delete this.C;zi.L.K.call(this)};var Pi={},Qi="player_uid_"+(1E9*Math.random()>>>0);function Ri(a,b){a=u(a)?Gd(a):a;b=Ah(b);var c=Qi+"_"+ia(a),d=Pi[c];if(d)return d.oc(b),d.j;d=new zi(a,c);Pi[c]=d;P("player-added",d.j);tc(d,w(Si,d));I(function(){d.oc(b)},0);
return d.j}
function Si(a){Pi[a.getId()]=null}
function Ti(a){a=R(a);if(!a)return null;var b=Qi+"_"+ia(a),c=Pi[b];c||(c=new zi(a,b),Pi[b]=c);return c.j}
...
;var O={},hj=null;O.qc={"consent.google.com":!0,"consent.youtube.com":!0,"consent-daily-0.sandbox.google.com":!0,"consent-daily-1.sandbox.google.com":!0,"consent-daily-2.sandbox.google.com":!0,"consent-daily-3.sandbox.google.com":!0,"consent-daily-4.sandbox.google.com":!0,"consent-daily-5.sandbox.google.com":!0,"consent-daily-6.sandbox.google.com":!0,"consent-autopush.sandbox.google.com":!0};O.gc=!1;
O.init=function(){var a=R("yt-consent");gf(a,"click",O.Kd,"consent-close");gf(a,"click",O.Ld,"consent-review");T(window,"message",O.Ge);H("CONSENT_SHOW_DIALOG")&&(a=R("yt-consent-dialog-content"),O.mc(a),O.gd(),Bg(wf({a:"consent",consent:"forced"})),gf(a,"click",O.Gd,"yt-dialog-dismiss"))};
O.Kd=function(){C(document.body,"sitewide-consent-visible");Df("HideTicker","true",86400,"/");Bg(wf({a:"consent",consent:"later"}))};
O.Ld=function(){O.gd();Bg(wf({a:"consent",consent:"review"}))};
O.Gd=function(a){a=a.currentTarget;a.disabled||(a=F(a,"action")||"",oh.prototype.dismiss(a),Bg(wf({a:"consent",consent:"dismiss"})),O.ub())};
O.gd=function(){var a=R("yt-consent-dialog");if(a){var b=!!H("CONSENT_SHOW_DIALOG");hj=new oh(a,b,!b);O.fc();O.Me();a=hj;if(!a.isDisposed()){a.D=document.activeElement;if(!a.Ia){a.j||(a.j=R("yt-dialog-bg"),a.j||(a.j=document.createElement("div"),a.j.id="yt-dialog-bg",a.j.className="yt-dialog-bg",document.body.appendChild(a.j)));a:{var c=window,d=c.document,b=0;if(d){var b=d.body,e=d.documentElement;if(!e||!b){b=0;break a}c=Ld(c).height;if(Md(d)&&e.scrollHeight)b=e.scrollHeight!=c?e.scrollHeight:e.offsetHeight;
else{var d=e.scrollHeight,f=e.offsetHeight;e.clientHeight!=f&&(d=b.scrollHeight,f=b.offsetHeight);b=d>c?d>f?d:f:d<f?d:f}}}a.j.style.height=b+"px";Fg(a.j)}Ze(a.f);b=sh(a);th(b);a.A=T(document,"keydown",v(a.Qd,a));a.mc(a.f);a.N&&(a.C=T(document,"click",v(a.Be,a)));Fg(a.f);a.l.setAttribute("tabindex","0");vh(a);B(document.body,"yt-dialog-active");a=ch.getInstance();a.j&&eh(a,a.j);hh(mh.getInstance());hh(nh.getInstance())}}};
O.fc=function(){try{var a=fj();a&&(a.isReady()?(1==a.getPlayerState(a.getPresentingPlayerType())&&(O.gc=!0),a.pauseVideo()):a.addEventListener("onReady",O.fc))}catch(b){Cc(b)}};
O.ub=function(){try{var a=fj();a&&a.isReady()&&O.gc&&($e(),a.playVideo(),O.gc=!1)}catch(b){Cc(b)}};
...
function xj(a,b){b=b||{};for(var c in yj){var d=H(yj[c]),e;if(e=d){e=a;var f=void 0;f=window.location.href;var h=e.match(of)[1]||null,k=pf(e);h&&k?(e=e.match(of),f=f.match(of),e=e[3]==f[3]&&e[1]==f[1]&&e[4]==f[4]):e=k?pf(f)==k&&(Number(f.match(of)[4]||null)||null)==(Number(e.match(of)[4]||null)||null):!0;e||(e=c,f=H("CORS_HEADER_WHITELIST")||{},e=(h=pf(a))?(f=f[h])?Ua(f,e):!1:!0)}e&&(b[c]=d)}return b}
function zj(a,b){var c=H("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.wf&&(!pf(a)||b.withCredentials||pf(a)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.ta&&b.ta[c])}
function Aj(a,b){var c=b.format||"JSON";b.xf&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=H("XSRF_FIELD_NAME",void 0),e=H("XSRF_TOKEN",void 0),f=b.Qa;f&&(f[d]&&delete f[d],a=yg(a,f||{}));var h=b.postBody||"",f=b.ta;zj(a,b)&&(f||(f={}),f[d]=e);f&&u(h)&&(d=wg(h),Ib(d,f),h=wf(d));var k=!1,l,n=wj(a,function(a){if(!k){k=!0;l&&K(l);var d;a:switch(a&&"status"in a?a.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:d=
...
y(gk,sc);var hk=[];g=gk.prototype;g.Ga=function(a,b,c,d){ea(b)||(b&&(hk[0]=b.toString()),b=hk);for(var e=0;e<b.length;e++){var f=Vj(a,b[e],c||this.handleEvent,d||!1,this.j||this);if(!f)break;this.f[f.key]=f}return this};
...
this.f={}};
g.K=function(){gk.L.K.call(this);this.removeAll()};
g.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented");};function ik(){sc.call(this);this.l=new Nj(this);this.Ja=this;this.ka=null}
y(ik,sc);ik.prototype[Jj]=!0;g=ik.prototype;g.kc=function(a){this.ka=a};
g.addEventListener=function(a,b,c,d){Vj(this,a,b,c,d)};
g.removeEventListener=function(a,b,c,d){bk(this,a,b,c,d)};
function jk(a,b){var c,d=a.ka;if(d){c=[];for(var e=1;d;d=d.ka)c.push(d),++e}var d=a.Ja,e=b,f=e.type||e;if(u(e))e=new Hj(e,d);else if(e instanceof Hj)e.target=e.target||d;else{var h=e,e=new Hj(f,d);Ib(e,h)}var h=!0,k;if(c)for(var l=c.length-1;!e.f&&0<=l;l--)k=e.currentTarget=c[l],h=kk(k,f,!0,e)&&h;e.f||(k=e.currentTarget=d,h=kk(k,f,!0,e)&&h,e.f||(h=kk(k,f,!1,e)&&h));if(c)for(l=0;!e.f&&l<c.length;l++)k=e.currentTarget=c[l],h=kk(k,f,!1,e)&&h}
g.K=function(){ik.L.K.call(this);this.removeAllListeners();this.ka=null};
g.Ga=function(a,b,c,d){return Oj(this.l,String(a),b,c,d)};
...
function kk(a,b,c,d){b=a.l.f[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var h=b[f];if(h&&!h.fb&&h.yb==c){var k=h.listener,l=h.Cb||h.src;h.xb&&Qj(a.l,h);e=!1!==k.call(l,d)&&e}}return e&&0!=d.ed}
;function lk(){}
ca(lk);lk.prototype.f=0;function mk(a){ik.call(this);this.C=a||Dd();this.la=null;this.Oa=!1;this.f=null;this.j=void 0;this.V=this.X=this.D=null;this.za=!1}
y(mk,ik);g=mk.prototype;g.Od=lk.getInstance();g.getId=function(){return this.la||(this.la=":"+(this.Od.f++).toString(36))};
g.xa=function(){return this.f};
function nk(a,b){return a.f?S(b,a.f||a.C.f):null}
function ok(a){a.j||(a.j=new gk(a));return a.j}
g.kc=function(a){if(this.D&&this.D!=a)throw Error("Method not supported");mk.L.kc.call(this,a)};
...
function pk(a,b){if(a.Oa)throw Error("Component already rendered");if(b){a.za=!0;var c=Fd(b);a.C&&a.C.f==c||(a.C=Dd(b));a.f=b;a.Da()}else throw Error("Invalid element to decorate");}
g.Da=function(){this.Oa=!0;qk(this,function(a){!a.Oa&&a.xa()&&a.Da()})};
g.Ea=function(){qk(this,function(a){a.Oa&&a.Ea()});
this.j&&this.j.removeAll();this.Oa=!1};
g.K=function(){this.Oa&&this.Ea();this.j&&(this.j.dispose(),delete this.j);qk(this,function(a){a.dispose()});
!this.za&&this.f&&Wd(this.f);this.D=this.f=this.V=this.X=null;mk.L.K.call(this)};
function qk(a,b){a.X&&z(a.X,b,void 0)}
g.removeChild=function(a,b){if(a){var c=u(a)?a:a.getId(),d;this.V&&c?(d=this.V,d=(null!==d&&c in d?d[c]:void 0)||null):d=null;a=d;if(c&&a){d=this.V;c in d&&delete d[c];Za(this.X,a);b&&(a.Ea(),a.f&&Wd(a.f));c=a;if(null==c)throw Error("Unable to set parent component");c.D=null;mk.L.kc.call(c,null)}}if(!a)throw Error("Child is not in parent component");return a};function rk(a){mk.call(this,a);this.Ka=[];this.ga=[]}
y(rk,mk);rk.prototype.Ea=function(){z(this.Ka,ff);Nc(this.ga);rk.L.Ea.call(this)};function sk(){rk.call(this);this.F=this.B=this.A=null;this.M="horizontal";this.J=null}
y(sk,rk);sk.prototype.Da=function(){sk.L.Da.call(this);this.M=F(this.xa(),"overflowable-list-orientation")||"horizontal";this.A=nk(this,"parent-list");this.J=nk(this,"overflow-container");this.B=nk(this,"overflow-list");nk(this,"overflowable-list-item");this.F=nk(this,"overflowable-list-more-button")};
...
function zk(a){var b=S("overflowable-list-item",a.xa());return b?yk(a,b):0}
...
f.name&&f.data&&f.data.follow_on_url&&(f=f.data.follow_on_url)&&vg(f,void 0)}a.W.call(this,b,c)},
dc:a.dc,withCredentials:!1})}
;function Lk(a){rk.call(this);this.J=a;this.fa=0;this.R=this.N=this.A=this.M=this.F=this.B=this.S=null}
y(Lk,rk);g=Lk.prototype;
g.Da=function(){Lk.L.Da.call(this);this.R=this.xa();this.fa=parseInt(F(this.R,"max-title-length"),10)||0;this.M=nk(this,"create-button");this.A=nk(this,"cancel-button");this.F=nk(this,"privacy-button");var a=ok(this);this.B=nk(this,"title-input");a.Ga(this.B,"keyup",this.Wc);a.Ga(this.B,"paste",this.Wc);a.Ga(this.R,"reset",this.de);a.Ga(this.R,"submit",this.ee);this.S=nk(this,"create-playlist-widget-privacy-menu");this.N=nk(this,"is-selected");a=L("yt-uix-menu-item-clicked",v(this.me,this));this.ga.push(a)};
g.Ea=function(){Mk(this);this.N=this.A=this.M=this.S=this.F=this.B=null;Lk.L.Ea.call(this)};
g.Wc=function(){var a=Xe,b=this.M,c=qa(this.B.value).length;a(b,0<c&&(!this.fa||c<=this.fa))};
...
function Mk(a){a.B.value="";var b=nk(a,"title-input-container");C(b,"yt-uix-form-error");b=S("yt-uix-form-error-message",b);Wd(b);Xe(a.F,!0);(b=S("is-selected",a.S))&&a.N&&b!=a.N&&Nk(a,a.N);Xe(a.M,!1);a.A&&Xe(a.A,!0);Xe(a.B,!0)}
g.ee=function(a){a.preventDefault();a=this.R;var b={context:this,W:this.be,onError:this.ae};b.method=a.method.toUpperCase();if("POST"==b.method){var c;c=[];ij(a,c,lj);c=c.join("&");b.postBody=c}else{var d=new Kf;ij(a,d,kj);Mf(d);c={};for(var e=0;e<d.f.length;e++){var f=d.f[e];c[f]=d.j[f]}d=b.Qa||{};Ib(d,c);b.Qa=d}Aj(a.action,b);Ok(this,!1)};
g.be=function(a,b){Mk(this);this.J&&ga(this.J.Eb)&&this.J.Eb({playlistId:b.result.playlistId,playlistName:b.result.playlistName,De:b.result.playlistUrl});P("yt-uix-videoactionmenu-hide")};
...
g.de=function(){Mk(this);this.J&&ga(this.J.Db)&&this.J.Db()};function Pk(a){Pg.call(this,1,arguments);this.f=a}
...
function vl(a){var b=S("guide-sort-button"),c=F(b,"guide-sort")||"",d=F(a.currentTarget,"guide-sort")||"";c!=d&&(ac(b,"guide-sort",d),Aj("/guide_channels_ajax?action_set_guide_sort=1",{method:"POST",Qa:{sort:d},format:"JSON",W:function(a,b){Al(b);var c=Hd("guide-sort-choice");z(c,function(a){var b=F(a,"guide-sort");ch.getInstance();a=a.parentNode;var b=d==b,c=We("span","yt-uix-button-icon-wrapper",a);if(!c&&b){var e=Qd("span",{"class":"yt-uix-button-icon-wrapper yt-uix-button-icon-checkbox"}),f=Qd("div",
...
else break}else break;a.A.appendChild(l)}pb(a.J,"empty-overflow-list",!!Va(Yd(a.B)))});
Gl()}}
...
function zl(){Aj("/guide_channels_ajax?action_load_subs_and_footer=1",{format:"JSON",W:function(a,b){Al(b)}})}
;function Kl(a,b,c){sc.call(this);this.f=null;this.B=!1;this.C=a;this.A=c;this.j=b||window;this.l=v(this.Bd,this)}
...
g.Bd=function(){this.B&&this.f&&ck(this.f);this.f=null;this.C.call(this.A,x())};
g.K=function(){this.stop();Kl.L.K.call(this)};
...
a=qm(a);jm.test(c)||gm("invalid_callback");b=rm(b);d=d&&d.length?rm(d):null;return[encodeURIComponent(a.Ce).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.tc?"/am="+e(a.tc):"",a.cd?"/rs="+e(a.cd):"",a.pd?"/t="+e(a.pd):"","/cb=",e(c)].join("")}
...
;function Km(a,b,c){this.A=!1;this.l=0;this.B=R("sb-container");if(this.f=R("sb-button-notify"))this.D=We("SPAN","yt-uix-button-content",this.f),this.F=We("IMG","yt-uix-button-icon-bell",this.f);this.C=R("sb-onepick-target");this.j=new Fm("sb-target","sb-onepick-target",v(this.Re,this),a,b,c);this.j.load({hideNotificationWidget:v(this.Jc,this),showOnepick:v(this.Le,this),hideOnepick:v(this.Nd,this)});this.J=Ce(this.C);this.Zc();T(window,"resize",v(this.Zc,this));T(window,"click",v(this.Jc,this));Eh();
...
g.Jc=function(){this.A&&(this.j.close(),Lm(this),Nm(this))};
...
g.Zc=function(){this.C.style.top=Math.max((Ld(window).height-this.J.height)/2,0)+"px"};
...
g=On.prototype;g.Y=function(){return this.f.Y()};
...
g.equals=function(a){return this.Y()==Pf(a)&&Qn(this,a)};
function Qn(a,b){var c=Pf(b);if(a.Y()>c)return!1;!(b instanceof On)&&5<c&&(b=new On(b));return Tf(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.kb&&"function"==typeof c.kb?c.kb(a):fa(c)||u(c)?Ua(c,a):xb(c,a)})}
g.Aa=function(){return this.f.Aa(!1)};function Rn(){}
...
y(Xn,ik);g=Xn.prototype;g.enabled=!1;g.na=null;function Yn(a,b){a.f=b;a.na&&a.enabled?(a.stop(),a.start()):a.na&&a.stop()}
g.Oe=function(){if(this.enabled){var a=x()-this.A;0<a&&a<.8*this.f?this.na=this.j.setTimeout(this.B,this.f-a):(this.na&&(this.j.clearTimeout(this.na),this.na=null),jk(this,"tick"),this.enabled&&(this.na=this.j.setTimeout(this.B,this.f),this.A=x()))}};
...
g.K=function(){Xn.L.K.call(this);this.stop();delete this.j};
...
y($n,sc);g=$n.prototype;g.Jb=!1;g.ec=0;g.$a=null;g.Cd=function(a){this.f=arguments;this.$a||this.ec?this.Jb=!0:ao(this)};
g.stop=function(){this.$a&&(m.clearTimeout(this.$a),this.$a=null,this.Jb=!1,this.f=[])};
g.pause=function(){this.ec++};
g.K=function(){$n.L.K.call(this);this.stop()};
g.te=function(){this.$a=null;this.Jb&&!this.ec&&(this.Jb=!1,ao(this))};
...
g=io.prototype;g.Wa=null;g.ua=!1;g.ib=null;g.nc=null;g.tb=null;g.gb=null;g.La=null;g.Pa=null;g.Ya=null;g.U=null;g.wb=0;g.va=null;g.Nb=null;g.Xa=null;g.pb=-1;g.fd=!0;g.Sa=!1;g.$b=0;g.Hb=null;var jo={},ko={};g=io.prototype;g.setTimeout=function(a){this.A=a};
function lo(a,b,c){a.gb=1;a.La=ng(b.clone());a.Ya=c;a.C=!0;mo(a,null)}
function no(a,b,c,d,e){a.gb=1;a.La=ng(b.clone());a.Ya=null;a.C=c;e&&(a.fd=!1);mo(a,d)}
function mo(a,b){a.tb=x();oo(a);a.Pa=a.La.clone();lg(a.Pa,"t",a.D);a.wb=0;a.U=a.f.Vb(a.f.vb()?b:null);0<a.$b&&(a.Hb=new $n(v(a.jd,a,a.U),a.$b));a.B.Ga(a.U,"readystatechange",a.Fe);var c=a.Wa?Fb(a.Wa):{};a.Ya?(a.Nb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.U.send(a.Pa,a.Nb,a.Ya,c)):(a.Nb="GET",a.fd&&!ld&&(c.Connection="close"),a.U.send(a.Pa,a.Nb,null,c));a.f.sa(1)}
g.Fe=function(a){a=a.target;var b=this.Hb;b&&3==po(a)?b.Cd():this.jd(a)};
g.jd=function(a){try{if(a==this.U)a:{var b=po(this.U),c=this.U.A,d=this.U.getStatus();if(Q&&!wd(10)||ld&&!vd("420+")){if(4>b)break a}else if(3>b||3==b&&!hd&&!qo(this.U))break a;this.Sa||4!=b||7==c||(8==c||0>=d?this.f.sa(3):this.f.sa(2));ro(this);var e=this.U.getStatus();this.pb=e;var f=qo(this.U);(this.ua=200==e)?(4==b&&so(this),this.C?(to(this,b,f),hd&&this.ua&&3==b&&(this.B.Ga(this.j,"tick",this.Ee),this.j.start())):uo(this,f),this.ua&&!this.Sa&&(4==b?this.f.Fb(this):(this.ua=!1,oo(this)))):(this.Xa=
400==e&&0<f.indexOf("Unknown SID")?3:0,W(),so(this),vo(this))}}catch(h){this.U&&qo(this.U)}finally{}};
function to(a,b,c){for(var d=!0;!a.Sa&&a.wb<c.length;){var e=wo(a,c);if(e==ko){4==b&&(a.Xa=4,W(),d=!1);break}else if(e==jo){a.Xa=4;W();d=!1;break}else uo(a,e)}4==b&&0==c.length&&(a.Xa=1,W(),d=!1);a.ua=a.ua&&d;d||(so(a),vo(a))}
g.Ee=function(){var a=po(this.U),b=qo(this.U);this.wb<b.length&&(ro(this),to(this,a,b),this.ua&&4!=a&&oo(this))};
...
function xo(a,b){a.tb=x();oo(a);var c=b?window.location.hostname:"";a.Pa=a.La.clone();hg(a.Pa,"DOMAIN",c);hg(a.Pa,"t",a.D);try{a.va=new ActiveXObject("htmlfile")}catch(n){so(a);a.Xa=7;W();vo(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var h=c.charAt(f);if("<"==h)e=e+"\\x3c";else if(">"==h)e=e+"\\x3e";else{if(h in Ea)h=Ea[h];else if(h in Da)h=Ea[h]=Da[h];else{var k=h,l=h.charCodeAt(0);if(31<l&&127>l)k=h;else{if(256>l){if(k="\\x",16>l||256<l)k+="0"}else k="\\u",4096>l&&(k+=
"0");k+=l.toString(16).toUpperCase()}h=Ea[h]=k}e+=h}}d+='<script>document.domain="'+e+'"\x3c/script>'}d+="</body></html>";c=Kg(Pb("b/12014412"),d);a.va.open();a.va.write(Yb(c));a.va.close();a.va.parentWindow.m=v(a.xe,a);a.va.parentWindow.d=v(a.Xc,a,!0);a.va.parentWindow.rpcClose=v(a.Xc,a,!1);c=a.va.createElement("DIV");a.va.parentWindow.document.body.appendChild(c);d=Ub(a.Pa.toString());d=sa(Sb(d));d=Kg(Pb("b/12014412"),'<iframe src="'+d+'"></iframe>');c.innerHTML=Yb(d);a.f.sa(1)}
g.xe=function(a){yo(v(this.we,this,a),0)};
g.we=function(a){this.Sa||(ro(this),uo(this,a),oo(this))};
g.Xc=function(a){yo(v(this.ve,this,a),0)};
g.ve=function(a){this.Sa||(so(this),this.ua=a,this.f.Fb(this),this.f.sa(4))};
g.cancel=function(){this.Sa=!0;so(this)};
function oo(a){a.nc=x()+a.A;zo(a,a.A)}
...
g.ye=function(){this.ib=null;var a=x();0<=a-this.nc?(2!=this.gb&&this.f.sa(3),so(this),this.Xa=2,W(),vo(this)):zo(this,this.nc-a)};
function vo(a){a.f.Lc()||a.Sa||a.f.Fb(a)}
function so(a){ro(a);uc(a.Hb);a.Hb=null;a.j.stop();a.B.removeAll();if(a.U){var b=a.U;a.U=null;Ao(b);b.dispose()}a.va&&(a.va=null)}
function uo(a,b){try{a.f.Rc(a,b),a.f.sa(4)}catch(c){}}
...
g=Eo.prototype;g.Yb=null;g.ia=null;g.Ib=!1;g.hd=null;g.zb=null;g.cc=null;g.Zb=null;g.oa=null;g.Fa=-1;g.ob=null;g.jb=null;g.connect=function(a){this.Zb=a;a=Fo(this.f,null,this.Zb);W();this.hd=x();var b=this.f.F;null!=b?(this.ob=b[0],(this.jb=b[1])?(this.oa=1,Go(this)):(this.oa=2,Ho(this))):(lg(a,"MODE","init"),this.ia=new io(this,0,void 0,void 0,void 0),this.ia.Wa=this.Yb,no(this.ia,a,!1,null,!0),this.oa=0)};
function Go(a){var b=Fo(a.f,a.jb,"/mail/images/cleardot.gif");ng(b);Bo(b.toString(),5E3,v(a.sd,a),3,2E3);a.sa(1)}
g.sd=function(a){if(a)this.oa=2,Ho(this);else{W();var b=this.f;b.ra=b.Ma.Fa;Io(b,9)}a&&this.sa(2)};
function Ho(a){var b=a.f.J;if(null!=b)W(),b?(W(),Jo(a.f,a,!1)):(W(),Jo(a.f,a,!0));else if(a.ia=new io(a,0,void 0,void 0,void 0),a.ia.Wa=a.Yb,b=a.f,b=Fo(b,b.vb()?a.ob:null,a.Zb),W(),!Q||wd(10))lg(b,"TYPE","xmlhttp"),no(a.ia,b,!1,a.ob,!1);else{lg(b,"TYPE","html");var c=a.ia;a=!!a.ob;c.gb=3;c.La=ng(b.clone());xo(c,a)}}
g.Vb=function(a){return this.f.Vb(a)};
g.Lc=function(){return!1};
g.Rc=function(a,b){this.Fa=a.pb;if(0==this.oa)if(b){try{var c=this.j.parse(b)}catch(d){c=this.f;c.ra=this.Fa;Io(c,2);return}this.ob=c[0];this.jb=c[1]}else c=this.f,c.ra=this.Fa,Io(c,2);else if(2==this.oa)if(this.Ib)W(),this.cc=x();else if("11111"==b){if(W(),this.Ib=!0,this.zb=x(),c=this.zb-this.hd,!Q||wd(10)||500>c)this.Fa=200,this.ia.cancel(),W(),Jo(this.f,this,!0)}else W(),this.zb=this.cc=x(),this.Ib=!1};
g.Fb=function(){this.Fa=this.ia.pb;if(this.ia.ua)0==this.oa?this.jb?(this.oa=1,Go(this)):(this.oa=2,Ho(this)):2==this.oa&&(a=!1,(a=!Q||wd(10)?this.Ib:200>this.cc-this.zb?!1:!0)?(W(),Jo(this.f,this,!0)):(W(),Jo(this.f,this,!1)));else{0==this.oa?W():2==this.oa&&W();var a=this.f;a.ra=this.Fa;Io(a,2)}};
g.vb=function(){return this.f.vb()};
g.isActive=function(){return this.f.isActive()};
g.sa=function(a){this.f.sa(a)};function Ko(a){ik.call(this);this.headers=new Kf;this.S=a||null;this.j=!1;this.R=this.f=null;this.fa=this.J="";this.A=0;this.C="";this.B=this.X=this.F=this.V=!1;this.D=0;this.M=null;this.ga="";this.N=this.la=!1}
y(Ko,ik);var Lo=/^https?$/i,Mo=["POST","PUT"];g=Ko.prototype;
g.send=function(a,b,c,d){if(this.f)throw Error("[goog.net.XhrIo] Object is active with another request="+this.J+"; newUri="+a);b=b?b.toUpperCase():"GET";this.J=a;this.C="";this.A=0;this.fa=b;this.V=!1;this.j=!0;this.f=this.S?ho(this.S):ho(fo);this.R=this.S?co(this.S):co(fo);this.f.onreadystatechange=v(this.Qc,this);try{Rn(No(this,"Opening Xhr")),this.X=!0,this.f.open(b,String(a),!0),this.X=!1}catch(f){Rn(No(this,"Error opening Xhr: "+f.message));Oo(this,f);return}a=c||"";var e=this.headers.clone();
d&&Sf(d,function(a,b){Lf(e,b,a)});
d=Sa(e.ya(),Po);c=m.FormData&&a instanceof m.FormData;!Ua(Mo,b)||d||c||Lf(e,"Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(a,b){this.f.setRequestHeader(b,a)},this);
this.ga&&(this.f.responseType=this.ga);Ab(this.f)&&(this.f.withCredentials=this.la);try{Qo(this),0<this.D&&(this.N=Ro(this.f),Rn(No(this,"Will abort after "+this.D+"ms if incomplete, xhr2 "+this.N)),this.N?(this.f.timeout=this.D,this.f.ontimeout=v(this.Ic,this)):this.M=Zn(this.Ic,this.D,this)),Rn(No(this,"Sending request")),this.F=!0,this.f.send(a),this.F=!1}catch(f){Rn(No(this,"Send error: "+f.message)),Oo(this,f)}};
function Ro(a){return Q&&vd(9)&&"number"==typeof a.timeout&&p(a.ontimeout)}
function Po(a){return"content-type"==a.toLowerCase()}
g.Ic=function(){"undefined"!=typeof aa&&this.f&&(this.C="Timed out after "+this.D+"ms, aborting",this.A=8,No(this,this.C),jk(this,"timeout"),Ao(this,8))};
function Oo(a,b){a.j=!1;a.f&&(a.B=!0,a.f.abort(),a.B=!1);a.C=b;a.A=5;So(a);To(a)}
function So(a){a.V||(a.V=!0,jk(a,"complete"),jk(a,"error"))}
function Ao(a,b){a.f&&a.j&&(No(a,"Aborting"),a.j=!1,a.B=!0,a.f.abort(),a.B=!1,a.A=b||7,jk(a,"complete"),jk(a,"abort"),To(a))}
g.K=function(){this.f&&(this.j&&(this.j=!1,this.B=!0,this.f.abort(),this.B=!1),To(this,!0));Ko.L.K.call(this)};
g.Qc=function(){this.isDisposed()||(this.X||this.F||this.B?Uo(this):this.ne())};
g.ne=function(){Uo(this)};
function Uo(a){if(a.j&&"undefined"!=typeof aa)if(a.R[1]&&4==po(a)&&2==a.getStatus())No(a,"Local request error detected and ignored");else if(a.F&&4==po(a))Zn(a.Qc,0,a);else if(jk(a,"readystatechange"),4==po(a)){No(a,"Request complete");a.j=!1;try{var b=a.getStatus(),c;a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=String(a.J).match(of)[1]||null;if(!f&&m.self&&m.self.location)var h=m.self.location.protocol,
...
function Qo(a){a.f&&a.N&&(a.f.ontimeout=null);"number"==typeof a.M&&(m.clearTimeout(a.M),a.M=null)}
...
function No(a,b){return b+" ["+a.fa+" "+a.J+" "+a.getStatus()+"]"}
;function Vo(a,b,c){this.D=a||null;this.f=1;this.j=[];this.B=[];this.A=new Wn(null,!0);this.F=b||null;this.J=null!=c?c:null}
function Wo(a,b){this.f=a;this.map=b;this.context=null}
g=Vo.prototype;g.lb=null;g.da=null;g.T=null;g.Xb=null;g.Ab=null;g.wc=null;g.Bb=null;g.qb=0;g.Rd=0;g.$=null;g.Na=null;g.Ca=null;g.Ua=null;g.Ma=null;g.Mb=null;g.bb=-1;g.Mc=-1;g.ra=-1;g.nb=0;g.Za=0;g.Ta=8;var Xo=new ik;function Yo(a){Hj.call(this,"statevent",a)}
y(Yo,Hj);function Zo(a,b){Hj.call(this,"timingevent",a);this.size=b}
y(Zo,Hj);function $o(a){Hj.call(this,"serverreachability",a)}
y($o,Hj);g=Vo.prototype;g.connect=function(a,b,c,d,e){W();this.Xb=b;this.lb=c||{};d&&p(e)&&(this.lb.OSID=d,this.lb.OAID=e);this.Ma=new Eo(this);this.Ma.Yb=null;this.Ma.j=this.A;this.Ma.connect(a)};
function ap(a){bp(a);if(3==a.f){var b=a.qb++,c=a.Ab.clone();hg(c,"SID",a.l);hg(c,"RID",b);hg(c,"TYPE","terminate");cp(a,c);b=new io(a,0,a.l,b,void 0);b.gb=2;b.La=ng(c.clone());(new Image).src=b.La;b.tb=x();oo(b)}dp(a)}
function bp(a){if(a.Ma){var b=a.Ma;b.ia&&(b.ia.cancel(),b.ia=null);b.Fa=-1;a.Ma=null}a.T&&(a.T.cancel(),a.T=null);a.Ca&&(m.clearTimeout(a.Ca),a.Ca=null);ep(a);a.da&&(a.da.cancel(),a.da=null);a.Na&&(m.clearTimeout(a.Na),a.Na=null)}
...
function gp(a){a.da||a.Na||(a.Na=yo(v(a.Vc,a),0),a.nb=0)}
g.Vc=function(a){this.Na=null;hp(this,a)};
...
function cp(a,b){if(a.$){var c=a.$.Fc(a);c&&tb(c,function(a,c){hg(b,c,a)})}}
...
return c.join("&")}
function lp(a){a.T||a.Ca||(a.C=1,a.Ca=yo(v(a.Uc,a),0),a.Za=0)}
function mp(a){if(a.T||a.Ca||3<=a.Za)return!1;a.C++;a.Ca=yo(v(a.Uc,a),np(a,a.Za));a.Za++;return!0}
g.Uc=function(){this.Ca=null;this.T=new io(this,0,this.l,"rpc",this.C);this.T.Wa=null;this.T.$b=0;var a=this.wc.clone();hg(a,"RID","rpc");hg(a,"SID",this.l);hg(a,"CI",this.Mb?"0":"1");hg(a,"AID",this.bb);cp(this,a);if(!Q||wd(10))hg(a,"TYPE","xmlhttp"),no(this.T,a,!0,this.Bb,!1);else{hg(a,"TYPE","html");var b=this.T,c=!!this.Bb;b.gb=3;b.La=ng(a.clone());xo(b,c)}};
function Jo(a,b,c){a.Mb=c;a.ra=b.Fa;a.vd(1,0);a.Ab=Fo(a,null,a.Xb);gp(a)}
g.Rc=function(a,b){if(0!=this.f&&(this.T==a||this.da==a))if(this.ra=a.pb,this.da==a&&3==this.f)if(7<this.Ta){var c;try{c=this.A.parse(b)}catch(f){c=null}if(ea(c)&&3==c.length)if(0==c[0])a:{if(!this.Ca){if(this.T)if(this.T.tb+3E3<this.da.tb)ep(this),this.T.cancel(),this.T=null;else break a;mp(this);W()}}else this.Mc=c[1],0<this.Mc-this.bb&&37500>c[2]&&this.Mb&&0==this.Za&&!this.Ua&&(this.Ua=yo(v(this.Sd,this),6E3));else Io(this,11)}else"y2f%"!=b&&Io(this,11);else if(this.T==a&&ep(this),!/^[\s\xa0]*$/.test(b)){c=
this.A.parse(b);ea(c);for(var d=0;d<c.length;d++){var e=c[d];this.bb=e[0];e=e[1];2==this.f?"c"==e[0]?(this.l=e[1],this.Bb=e[2],e=e[3],null!=e?this.Ta=e:this.Ta=6,this.f=3,this.$&&this.$.Dc(this),this.wc=Fo(this,this.vb()?this.Bb:null,this.Xb),lp(this)):"stop"==e[0]&&Io(this,7):3==this.f&&("stop"==e[0]?Io(this,7):"noop"!=e[0]&&this.$&&this.$.Cc(this,e),this.Za=0)}}};
...
g.Fb=function(a){var b;if(this.T==a)ep(this),this.T=null,b=2;else if(this.da==a)this.da=null,b=1;else return;this.ra=a.pb;if(0!=this.f)if(a.ua)1==b?(x(),jk(Xo,new Zo(Xo,a.Ya?a.Ya.length:0)),gp(this),this.B.length=0):lp(this);else{var c=a.Xa,d;if(!(d=3==c||7==c||0==c&&0<this.ra)){if(d=1==b)this.da||this.Na||1==this.f||2<=this.nb?d=!1:(this.Na=yo(v(this.Vc,this,a),np(this,this.nb)),this.nb++,d=!0);d=!(d||2==b&&mp(this))}if(d)switch(c){case 1:Io(this,5);break;case 4:Io(this,10);break;case 3:Io(this,
...
function Io(a,b){if(2==b||9==b){var c=null;a.$&&(c=null);var d=v(a.Ne,a);c||(c=new Uf("//www.google.com/images/cleardot.gif"),ng(c));Co(c.toString(),1E4,d)}else W();op(a,b)}
g.Ne=function(a){a?W():(W(),op(this,8))};
function op(a,b){a.f=0;a.$&&a.$.Bc(a,b);dp(a);bp(a)}
function dp(a){a.f=0;a.ra=-1;if(a.$)if(0==a.B.length&&0==a.j.length)a.$.Tb(a);else{var b=cb(a.B),c=cb(a.j);a.B.length=0;a.j.length=0;a.$.Tb(a,b,c)}}
...
g.Vb=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new Ko;a.la=!1;return a};
...
g.sa=function(){jk(Xo,new $o(Xo))};
function W(){jk(Xo,new Yo(Xo))}
g.vb=function(){return!(!Q||wd(10))};
function pp(){}
g=pp.prototype;g.Dc=function(){};
g.Cc=function(){};
g.Bc=function(){};
g.Tb=function(){};
...
qp.prototype.start=function(){qp.L.start.call(this);this.C=x()+this.f};
qp.prototype.stop=function(){this.C=0;qp.L.stop.call(this)};function rp(a,b){this.M=a;this.B=b;this.l=new vc;this.j=new qp(this.Xe,this);this.f=null;this.ca=!1;this.C=null;this.J="";this.F=this.A=0;this.D=[]}
...
g.Dc=function(){var a=this.j;a.stop();Yn(a,5E3+2E4*Math.random());this.C=null;this.A=0;if(this.D.length){a=this.D;this.D=[];for(var b=0,c=a.length;b<c;++b)fp(this.f,a[b])}this.G("handlerOpened")};
g.Bc=function(a,b){var c=2==b&&401==this.f.ra;if(4!=b&&!c){if(6==b||410==this.f.ra)c=this.j,c.stop(),Yn(c,500);this.j.start()}this.G("handlerError",b)};
...
g.Cc=function(a,b){if("S"==b[0])this.J=b[1];else if("gracefulReconnect"==b[0]){var c=this.j;c.stop();Yn(c,500);this.j.start();ap(this.f)}else this.G("handlerMessage",new Un(b[0],b[1]))};
...
vp.prototype.wa=function(a){return this.isDisposed()?!1:this.B.wa(a)};
vp.prototype.G=function(a,b){return this.isDisposed()?!1:this.B.G.apply(this.B,arguments)};function wp(){this.f=[];this.j=[]}
g=wp.prototype;g.Y=function(){return this.f.length+this.j.length};
...
g.Z=function(){for(var a=[],b=this.f.length-1;0<=b;--b)a.push(this.f[b]);for(var c=this.j.length,b=0;b<c;++b)a.push(this.j[b]);return a};function xp(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);return a?50<=parseInt(a[1],10):!1}
...
;function $p(){}
;function aq(){}
y(aq,$p);aq.prototype.Y=function(){var a=0;If(this.Aa(!0),function(){a++});
return a};
aq.prototype.clear=function(){var a=Jf(this.Aa(!0)),b=this;z(a,function(a){b.remove(a)})};function bq(a){this.f=a}
...
g.Aa=function(a){var b=0,c=this.f,d=new Gf;d.next=function(){if(b>=c.length)throw Ff;var d;d=c.key(b++);if(a)return d;d=c.getItem(d);if(!u(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
g.clear=function(){this.f.clear()};
...
eq.prototype.j=function(a,b){p(b)?this.f.Ed(a,oj(b)):this.f.remove(a)};
...
fq.prototype.j=function(a,b){fq.L.j.call(this,a,hq(b))};
fq.prototype.l=function(a){a=fq.L.get.call(this,a);if(!p(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
iq.prototype.j=function(a,b,c){if(b=hq(b)){if(c){if(c<x()){iq.prototype.remove.call(this,a);return}b.expiration=c}b.creation=x()}iq.L.j.call(this,a,b)};
iq.prototype.l=function(a,b){var c=iq.L.l.call(this,a);if(c)if(!b&&jq(c))iq.prototype.remove.call(this,a);else return c};function kq(a){this.f=a}
...
function nq(){var a=oq;mq(a,a.f.Aa(!0))}
...
function xq(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,W:w(a.C,d,!0),onError:w(a.A,e),sb:w(a.D,e)};c&&(a.ta=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Aj(b,a)}
...
y(Iq,vp);Iq.prototype.ma=function(){return this.screens};
...
y(Mq,vp);var Nq=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=Mq.prototype;g.start=function(){!this.f&&isNaN(this.j)&&this.Yc()};
g.stop=function(){this.f&&(this.f.abort(),this.f=null);isNaN(this.j)||(K(this.j),this.j=NaN)};
g.K=function(){this.stop();Mq.L.K.call(this)};
g.Yc=function(){this.j=NaN;this.f=Aj(wq(this.F,"/pairing/get_screen"),{method:"POST",ta:{pairing_code:this.D},timeout:5E3,W:v(this.Ze,this),onError:v(this.Ye,this),sb:v(this.$e,this)})};
g.Ze=function(a,b){this.f=null;var c=b.screen||{};c.dialId=this.A;c.name=this.C;this.G("pairingComplete",new Sp(c))};
g.Ye=function(a){this.f=null;a.status&&404==a.status?this.l>=Nq.length?this.G("pairingFailed",Error("DIAL polling timed out")):(a=Nq[this.l],this.j=I(v(this.Yc,this),a),this.l++):this.G("pairingFailed",Error("Server error "+a.status))};
...
g.K=function(){K(this.f);gr.L.K.call(this)};
function ir(a){if(a.screens.length){var b=Oa(a.screens,function(a){return a.id}),c=wq(a.j,"/pairing/get_lounge_token_batch");
xq(a.j,c,{screen_ids:b.join(",")},v(a.Id,a),v(a.Hd,a))}}
g.Id=function(a){hr(this);var b=this.screens.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}jr(this,!b);b&&Pp(this.D,"Missed "+b+" lounge tokens.")};
g.Hd=function(a){Pp(this.D,"Requesting lounge tokens failed: "+a)};
...
y(kr,vp);g=kr.prototype;g.start=function(){var a=parseInt(rq("yt-remote-fast-check-period")||"0",10);(this.A=x()-144E5<a?0:a)?mr(this):(this.A=x()+3E5,pq("yt-remote-fast-check-period",this.A),this.hc())};
...
g.K=function(){K(this.l);this.l=NaN;this.j&&(this.j.abort(),this.j=null);kr.L.K.call(this)};
...
function mr(a){isNaN(a.l)||K(a.l);a.l=I(v(a.hc,a),0<a.A&&a.A<x()?2E4:1E4)}
g.hc=function(){K(this.l);this.l=NaN;this.j&&this.j.abort();var a=qr(this);if(vb(a)){var b=wq(this.D,"/pairing/get_screen_availability"),c={lounge_token:zb(a).join(",")};this.j=xq(this.D,b,c,v(this.re,this,a),v(this.qe,this))}else nr(this,{}),mr(this)};
g.re=function(a,b){this.j=null;var c=zb(qr(this));if(gb(c,zb(a))){for(var c=b.screens||[],d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;nr(this,d);mr(this)}else this.P("Changing Screen set during request."),this.hc()};
...
function sr(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);c||(c=a.A[b]);var h=a.ma();if(h=(c?Hq(h,c):null)||Hq(h,b)){h.f=b;var k=tr(a,h);or(a.f,k,function(a){e(a?k:null)})}else c?ur(a,c,v(function(a){var f=tr(this,new Sp({name:d,
screenId:c,loungeToken:a,dialId:b||""}));or(this.f,f,function(a){e(a?f:null)})},a),f):e(null)}
g.md=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new Mq(this.C,a,b,c);f.subscribe("pairingComplete",v(function(a){uc(f);d(tr(this,a))},this));
...
g.Hc=function(a,b){for(var c=2,d=b(a,c);vr(this,d);){c++;if(20<c)return a;d=b(a,c)}return d};
g.bf=function(a,b,c,d){Aj(wq(this.C,"/pairing/get_screen"),{method:"POST",ta:{pairing_code:a},timeout:5E3,W:v(function(a,d){var h=new Sp(d.screen||{});if(!h.name||vr(this,h.name))h.name=this.Hc(h.name,b);c(tr(this,h))},this),
...
function ur(a,b,c,d){a.info("requestLoungeToken_ for "+b);var e={ta:{screen_ids:b},method:"POST",context:a,W:function(a,e){var k=e&&e.screens||[];k[0]&&k[0].screenId==b?c(k[0].loungeToken):d(Error("Missing lounge token in token response"))},
onError:function(){d(Error("Request screen lounge token failed"))}};
Aj(wq(a.C,"/pairing/get_lounge_token_batch"),e)}
function wr(a){a.screens=a.j.ma();var b=a.A,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.f=c[e.id]||""}a.info("Updated manual screens: "+Zp(a.screens))}
g.Jd=function(){wr(this);this.G("screenChange");this.f.update()};
function rr(a){xr(a);a.j=new gr(a.C);a.j.subscribe("screenChange",v(a.Jd,a));wr(a);a.l=Xp(rq("yt-remote-automatic-screen-cache")||[]);xr(a);a.info("Initializing automatic screens: "+Zp(a.l));a.f=new kr(a.C,v(a.ma,a,!0));a.f.subscribe("screenChange",v(function(){this.G("onlineScreenChange")},a))}
...
g.K=function(){this.jc("");yr.L.K.call(this)};function Ar(a,b){yr.call(this,a,b,"CastSession");this.f=null;this.C=0;this.A=null;this.F=v(this.cf,this);this.D=v(this.Ae,this);this.C=I(v(function(){Br(this,null)},this),12E4)}
y(Ar,yr);g=Ar.prototype;g.ic=function(a){if(this.f){if(this.f==a)return;zr(this,"Overriding cast sesison with new session object");this.f.removeUpdateListener(this.F);this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D)}this.f=a;this.f.addUpdateListener(this.F);this.f.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.D);this.A&&Cr(this);Dr(this,"getMdxSessionStatus")};
...
g.jc=ba;g.K=function(){this.info("disposeInternal");K(this.C);this.C=0;this.f&&(this.f.removeUpdateListener(this.F),this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.D));this.f=null;Ar.L.K.call(this)};
...
function Br(a,b){K(a.C);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.l||a.l.id!=b){var c=v(a.Gb,a),d=v(a.ha,a);a.Gc(b,c,d,5)}}else a.ha(Error("Waiting for session status timed out."))}
g.Gc=function(a,b,c,d){sr(this.M,this.j.label,a,this.j.friendlyName,v(function(e){e?b(e):0<=d?(zr(this,"Screen "+a+" appears to be offline. "+d+" retries left."),I(v(this.Gc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.od=function(){return this.f};
g.cf=function(a){this.isDisposed()||a||(zr(this,"Cast session died."),this.ha())};function Er(a,b){yr.call(this,a,b,"DialSession");this.C=this.J=null;this.N="";this.A=null;this.F=ba;this.D=NaN;this.R=v(this.ff,this);this.f=ba}
y(Er,yr);g=Er.prototype;g.ic=function(a){this.C=a;this.C.addUpdateListener(this.R)};
...
g.K=function(){this.f();this.f=ba;K(this.D);this.C&&this.C.removeUpdateListener(this.R);this.C=null;Er.L.K.call(this)};
function Fr(a){a.f=a.M.md(a.N,a.j.label,a.j.friendlyName,v(function(a){this.f=ba;this.Gb(a)},a),v(function(a){this.f=ba;
this.ha(a)},a))}
g.ff=function(a){this.isDisposed()||a||(zr(this,"DIAL session died."),this.f(),this.f=ba,this.ha())};
function Gr(a){var b={};b.pairingCode=a.N;if(a.A){var c=a.A.index||0,d=a.A.currentTime||0;b.v=a.A.videoId||a.A.videoIds[c];b.t=d}fr()&&(b.env_useStageMdx=1);return wf(b)}
g.bc=function(a){this.N=Bq();if(this.A){var b=new chrome.cast.DialLaunchResponse(!0,Gr(this));a(b);Fr(this)}else this.F=v(function(){K(this.D);this.F=ba;this.D=NaN;var b=new chrome.cast.DialLaunchResponse(!0,Gr(this));a(b);Fr(this)},this),this.D=I(v(function(){this.F()},this),100)};
g.Pd=function(a,b){sr(this.M,this.J.receiver.label,a,this.j.friendlyName,v(function(a){a&&a.token?(this.Gb(a),b(new chrome.cast.DialLaunchResponse(!1))):this.bc(b)},this),v(function(a){zr(this,"Failed to get DIAL screen: "+a);
this.bc(b)},this))};function Hr(a,b){yr.call(this,a,b,"ManualSession");this.f=I(v(this.cb,this,null),150)}
y(Hr,yr);Hr.prototype.stop=function(){this.ha()};
Hr.prototype.ic=ba;Hr.prototype.cb=function(){K(this.f);this.f=NaN;var a=Hq(this.M.ma(),this.j.label);a?this.Gb(a):this.ha(Error("No such screen"))};
Hr.prototype.K=function(){K(this.f);this.f=NaN;Hr.L.K.call(this)};function Ir(a){vp.call(this);this.j=a;this.f=null;this.C=!1;this.l=[];this.A=v(this.oe,this)}
...
Mp(Jr),this.j.subscribe("onlineScreenChange",v(this.nd,this)),this.l=Kr(this),chrome.cast.setCustomReceivers(this.l,ba,v(function(a){this.P("Failed to set initial custom receivers: "+oj(a))},this)),this.G("yt-remote-cast2-availability-change",Lr(this)),b(!0))},this),v(function(a){this.P("Failed to initialize API: "+oj(a));
b(!1)},this))};
g.Je=function(a,b){Mr("Setting connected screen ID: "+a+" -> "+b);if(this.f){var c=this.f.l;if(!a||c&&c.id!=a)Mr("Unsetting old screen status: "+this.f.j.friendlyName),uc(this.f),this.f=null}if(a&&b){if(!this.f){c=Hq(this.j.ma(),a);if(!c){Mr("setConnectedScreenStatus: Unknown screen.");return}var d=Nr(this,c);d||(Mr("setConnectedScreenStatus: Connected receiver not custom..."),d=new chrome.cast.Receiver(c.f?c.f:c.id,c.name),d.receiverType=chrome.cast.ReceiverType.CUSTOM,this.l.push(d),chrome.cast.setCustomReceivers(this.l,
ba,v(function(a){this.P("Failed to set initial custom receivers: "+oj(a))},this)));
Mr("setConnectedScreenStatus: new active receiver: "+d.friendlyName);Or(this,new Hr(this.j,d),!0)}this.f.jc(b)}else Mr("setConnectedScreenStatus: no screen.")};
...
g.K=function(){this.j.unsubscribe("onlineScreenChange",v(this.nd,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.A);var a=Jr,b=t("yt.mdx.remote.debug.handlers_");Za(b||[],a);uc(this.f);Ir.L.K.call(this)};
...
function Or(a,b,c){uc(a.f);(a.f=b)?(c?a.G("yt-remote-cast2-receiver-resumed",b.j):a.G("yt-remote-cast2-receiver-selected",b.j),b.subscribe("sessionScreen",v(a.Tc,a,b)),b.l?a.G("yt-remote-cast2-session-change",b.l):c&&a.f.cb(null)):a.G("yt-remote-cast2-session-change",null)}
g.Tc=function(a,b){this.f==a&&(b||Or(this,null),this.G("yt-remote-cast2-session-change",b))};
...
g.Sc=function(a){if(!this.isDisposed()){Mr("New cast session ID: "+a.sessionId);var b=a.receiver;if(b.receiverType!=chrome.cast.ReceiverType.CUSTOM){if(!this.f)if(b.receiverType==chrome.cast.ReceiverType.CAST)Mr("Got resumed cast session before resumed mdx connection."),Or(this,new Ar(this.j,b),!0);else{this.P("Got non-cast session without previous mdx receiver event, or mdx resume.");return}var c=this.f.j,d=Hq(this.j.ma(),c.label);d&&Tp(d,b.label)&&c.receiverType!=chrome.cast.ReceiverType.CAST&&
b.receiverType==chrome.cast.ReceiverType.CAST&&(Mr("onSessionEstablished_: manual to cast session change "+b.friendlyName),uc(this.f),this.f=new Ar(this.j,b),this.f.subscribe("sessionScreen",v(this.Tc,this,this.f)),this.f.cb(null));this.f.ic(a)}}};
...
function Kr(a){var b=a.j.ld(),c=a.f&&a.f.j;a=Oa(b,function(a){c&&Tp(a,c.label)&&(c=null);var b=a.f?a.f:a.id,f=Nr(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a}
g.nd=function(){if(!this.isDisposed()){var a=Lr(this);this.l=Kr(this);Mr("Updating custom receivers: "+oj(this.l));chrome.cast.setCustomReceivers(this.l,ba,v(function(){this.P("Failed to set custom receivers.")},this));
...
gs.prototype.clone=function(){return new gs(ps(this))};function qs(a,b){vp.call(this);this.f=0;this.A=a;this.F=[];this.D=new wp;this.C=NaN;this.l=this.j=null;this.N=v(this.Ud,this);this.J=v(this.rb,this);this.M=v(this.Td,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.lc,this),rs(this))):c=3;0!=c&&(b?this.lc(c):I(v(function(){this.lc(c)},this),0));
ts(this,cs())}
...
g.bd=function(a){if(1==this.f){vs(this,"removeVideo",{videoId:a});var b=us(this);b.j||(b.remove(a),zs(this,b))}else ys(this,w(this.bd,a))};
g.Nc=function(a,b,c){1==this.f?vs(this,"moveVideo",{videoId:a,delta:(b>=c?c:c-1)-b}):ys(this,w(this.Nc,a,b,c))};
g.Kc=function(a){1==this.f?vs(this,"insertVideo",{videoId:a}):ys(this,w(this.Kc,a))};
...
g.$c=function(a,b){if(1==this.f){var c=us(this);ns(c,a,b);vs(this,"previous");zs(this,c)}else ys(this,w(this.$c,a,b))};
g.kd=function(a,b){if(1==this.f){var c=us(this);ns(c,a,b);vs(this,"next");zs(this,c)}else ys(this,w(this.kd,a,b))};
g.Ec=function(){if(1==this.f){vs(this,"clearPlaylist");var a=us(this);a.reset();zs(this,a);xs(this)}else ys(this,this.Ec)};
g.dispose=function(){if(3!=this.f){var a=this.f;this.f=3;this.G("proxyStateChange",a,this.f)}qs.L.dispose.call(this)};
g.K=function(){K(this.C);this.C=NaN;Bs(this);this.A=null;this.D.clear();ts(this,null);qs.L.K.call(this)};
...
function ts(a,b){a.l&&(a.l.removeUpdateListener(a.N),a.l.removeMediaListener(a.J),a.rb(null));a.l=b;a.l&&(Pp("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.N),a.l.addMediaListener(a.J),a.l.media.length&&a.rb(a.l.media[0]))}
...
g.P=function(a){Pp("CP",a)};function Y(a,b,c){vp.call(this);this.C=NaN;this.V=!1;this.J=this.F=this.S=this.M=NaN;this.R=[];this.l=this.H=this.f=null;this.Ja=a;this.R.push(T(window,"beforeunload",v(this.Fd,this)));this.j=[];this.H=new gs;3==c["mdx-version"]&&(this.H.j="RQ"+b.token);this.X=b.id;this.f=Ds(this,c);this.f.subscribe("handlerOpened",this.Zd,this);this.f.subscribe("handlerClosed",this.Vd,this);this.f.subscribe("handlerError",this.Wd,this);this.H.j?this.f.subscribe("handlerMessage",this.Xd,this):this.f.subscribe("handlerMessage",
...
g.connect=function(a,b){if(b){if(this.H.j){var c=b.listId,d=b.videoId,e=b.index,f=b.currentTime||0;5>=f&&(f=0);h={videoId:d,currentTime:f};c&&(h.listId=c);p(e)&&(h.currentIndex=e);c&&(this.H.j=c);this.H.videoId=d;this.H.index=e||0}else{var d=b.videoIds[b.index],f=b.currentTime||0;5>=f&&(f=0);var h={videoIds:d,videoId:d,currentTime:f};this.H.videoIds=[d];this.H.index=0}this.H.state=3;ls(this.H,f);this.O("Connecting with setPlaylist and params: "+oj(h));this.f.connect({method:"setPlaylist",params:oj(h)},
a,Wq())}else this.O("Connecting without params"),this.f.connect({},a,Wq());Es(this)};
g.dispose=function(){this.isDisposed()||(this.G("beforeDispose"),Fs(this,3));Y.L.dispose.call(this)};
g.K=function(){Gs(this);Hs(this);Is(this);K(this.F);this.F=NaN;K(this.J);this.J=NaN;this.l=null;ff(this.R);this.R.length=0;this.f.dispose();Y.L.K.call(this);this.j=this.H=this.f=null};
g.O=function(a){Pp("conn",a)};
g.Fd=function(){this.A(2)};
function Ds(a,b){return new rp(wq(a.Ja,"/bc",void 0,!1),b)}
function Fs(a,b){a.G("proxyStateChange",b)}
function Es(a){a.C=I(v(function(){this.O("Connecting timeout");this.A(1)},a),2E4)}
...
g.Zd=function(){this.O("Channel opened");this.V&&(this.V=!1,Is(this),this.M=I(v(function(){this.O("Timing out waiting for a screen.");this.A(1)},this),15E3));
dr(tp(this.f),this.X)};
g.Vd=function(){this.O("Channel closed");isNaN(this.C)?er(!0):er();this.dispose()};
g.Wd=function(a){er();isNaN(this.D())?(this.O("Channel error: "+a+" without reconnection"),this.dispose()):(this.V=!0,this.O("Channel error: "+a+" with reconnection in "+this.D()+" ms"),Fs(this,2))};
function Ms(a,b){b&&(Gs(a),Is(a));b==Ls(a)?b&&(Fs(a,1),Ks(a,"getSubtitlesTrack")):b?(a.N()&&a.H.reset(),Fs(a,1),Ks(a,"getNowPlaying"),Ns(a)):a.A(1)}
...
g.Xd=function(a){a.params?this.O("Received: action="+a.action+", params="+oj(a.params)):this.O("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=mj(a.params.devices);this.j=Oa(a,function(a){return new Tn(a)});
...
break;case "gracefulDisconnect":break;case "playlistModified":Ps(this,a);break;case "nowPlaying":Qs(this,a);break;case "onStateChange":Rs(this,a);break;case "onVolumeChanged":Ss(this,a);break;case "onSubtitlesTrackChanged":Os(this,a);break;default:this.O("Unrecognized action: "+a.action)}};
g.Yd=function(a){a.params?this.O("Received: action="+a.action+", params="+oj(a.params)):this.O("Received: action="+a.action);Ts(this,a);Us(this,a);if(Ls(this)){var b=this.H.clone(),c=!1,d,e,f,h,k,l;a.params&&(d=a.params.videoId||a.params.video_id,e=a.params.videoIds||a.params.video_ids,f=a.params.state,h=a.params.currentTime||a.params.current_time,k=a.params.volume,l=a.params.muted,p(a.params.currentError)&&mj(a.params.currentError));if("onSubtitlesTrackChanged"==a.action)d==ks(this.H)&&(delete a.params.videoId,
...
else if("loungeScreenConnected"==b.action)c=!0;else if("loungeScreenDisconnected"==b.action)c=!1;else return;if(!isNaN(a.M))if(c)Is(a);else return;c==Ls(a)?c&&Fs(a,1):c?(Gs(a),a.N()&&a.H.reset(),Fs(a,1),Ks(a,"getNowPlaying"),Ns(a)):a.A(1)}
g.Ie=function(){if(this.l){var a=this.l;this.l=null;this.H.videoId!=a&&Ks(this,"getNowPlaying")}};
Y.prototype.subscribe=Y.prototype.subscribe;Y.prototype.unsubscribeByKey=Y.prototype.wa;Y.prototype.ga=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.D())?Ls(this)&&(a=1):a=2);return a};
Y.prototype.getProxyState=Y.prototype.ga;Y.prototype.A=function(a){this.O("Disconnecting with "+a);Gs(this);this.G("beforeDisconnect",a);1==a&&er();sp(this.f,a);this.dispose()};
...
Y.prototype.getPlayerContextData=Y.prototype.fa;Y.prototype.za=function(a){var b=new gs(a);b.videoId&&b.videoId!=this.H.videoId&&(this.l=b.videoId,K(this.F),this.F=I(v(this.Ie,this),5E3));var c=[];this.H.j==b.j&&this.H.videoId==b.videoId&&this.H.index==b.index&&gb(this.H.videoIds,b.videoIds)||c.push("remoteQueueChange");this.H.f==b.f&&this.H.volume==b.volume&&this.H.l==b.l&&ms(this.H)==ms(b)&&oj(this.H.B)==oj(b.B)||c.push("remotePlayerChange");this.H.reset(a);z(c,function(a){this.G(a)},this)};
...
Y.prototype.reconnect=Y.prototype.Ka;function Ns(a){K(a.J);a.J=I(v(a.A,a,1),864E5)}
function Ks(a,b,c){c?a.O("Sending: action="+b+", params="+oj(c)):a.O("Sending: action="+b);a.f.sendMessage(b,c)}
Y.prototype.la=function(a,b){Ks(this,a,b);Ns(this)};
Y.prototype.sendMessage=Y.prototype.la;function Vs(){if(!("cast"in window))return!1;var a=window.cast||{};return"ActivityStatus"in a&&"Api"in a&&"LaunchRequest"in a&&"Receiver"in a}
...
var $s=!1,Xa=t("yt.mdx.remote.castapi.devices_")||[];r("yt.mdx.remote.castapi.devices_",Xa,void 0);function it(a){vp.call(this);this.A=0;this.Ha=jt();this.C=NaN;this.D=a;this.O("Initializing local screens: "+Zp(this.Ha));this.l=kt();this.O("Initializing account screens: "+Zp(this.l));this.Ub=null;this.f=[];this.j=[];lt(this,dt()||[]);this.O("Initializing DIAL devices: "+Aq(this.j));a=Xp(br());mt(this,a);this.O("Initializing online screens: "+Zp(this.f));this.A=x()+3E5;nt(this)}
y(it,vp);g=it.prototype;g.O=function(a){Pp("RM",a)};
...
g.ad=function(){var a=dt()||[];Va(a)||lt(this,a);a=ot(this);Va(a)||(Qa(a,function(a){return!Gq(this.l,a)},this)&&$q()?pt(this):qt(this,a))};
function rt(a,b){var c=ot(a);return Na(b,function(a){return a.f?(a=Fq(this.j,a.f),!!a&&"RUNNING"==a.status):!!Gq(c,a)},a)}
function lt(a,b){var c=!1;z(b,function(a){var b=Hq(this.Ha,a.id);b&&b.name!=a.name&&(this.O("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
c&&(a.O("Renaming due to DIAL."),tt(a));cr(Cq(b));var d=!gb(a.j,b,Eq);d&&a.O("Updating DIAL devices: "+Aq(a.j)+" to "+Aq(b));a.j=b;mt(a,a.f);d&&a.G("onlineReceiverChange")}
g.Se=function(a){var b=Fq(this.j,a.id);b&&(this.O("Updating DIAL device: "+b.id+"("+b.name+") from status: "+b.status+" to status: "+a.status+" and from activityId: "+b.f+" to activityId: "+a.f),b.f=a.f,b.status=a.status,cr(Cq(this.j)));mt(this,this.f)};
function mt(a,b,c){var d=rt(a,b),e=!gb(a.f,d,Up);if(e||c)Va(b)||ar(Oa(d,Vp));e&&(a.O("Updating online screens: "+Zp(a.f)+" -> "+Zp(d)),a.f=d,a.G("onlineReceiverChange"))}
...
var e=this.Ub?ut(this,this.Ub):null;e&&!Gq(c,e)&&c.push(e);mt(this,c,!0)}};
Aj(wq(a.D,"/pairing/get_screen_availability"),e)}
function pt(a){var b=ot(a),c=Oa(b,function(a){return a.id});
Va(c)||(a.O("Updating lounge tokens for: "+oj(c)),Aj(wq(a.D,"/pairing/get_lounge_token_batch"),{ta:{screen_ids:c.join(",")},method:"POST",context:a,W:function(a,c){vt(this,c.screens||[]);this.Ha=Na(this.Ha,function(a){return!!a.token});
tt(this);qt(this,b)}}))}
function vt(a,b){z(bb(a.Ha,a.l),function(a){var d=Sa(b,function(b){return a.id==b.screenId});
d&&(a.token=d.loungeToken)})}
function tt(a){var b=jt();gb(a.Ha,b,Up)||(a.O("Saving local screens: "+Zp(b)+" to "+Zp(a.Ha)),Xq(Oa(a.Ha,Vp)),mt(a,a.f,!0),lt(a,dt()||[]),a.G("managedScreenChange",ot(a)))}
g.Hc=function(a,b){for(var c=ot(this),c=Oa(c,function(a){return a.name}),d=a,e=2;Ua(c,d);)d=b.call(m,e),e++;
return d};
function ut(a,b){var c=Hq(ot(a),b);a.O("Found screen: "+Yp(c)+" with key: "+b);return c}
function ot(a){return bb(a.l,Na(a.Ha,function(a){return!Gq(this.l,a)},a))}
...
y(wt,Iq);g=wt.prototype;g.ma=function(a){return this.ea.$_gs(a)};
...
g.K=function(){for(var a=0,b=this.f.length;a<b;++a)this.ea.$_ubk(this.f[a]);this.f.length=0;this.ea=null;wt.L.K.call(this)};
g.af=function(){this.G("screenChange")};
g.he=function(){this.G("onlineScreenChange")};
X.prototype.$_st=X.prototype.start;X.prototype.$_gspc=X.prototype.bf;X.prototype.$_gsppc=X.prototype.md;X.prototype.$_c=X.prototype.contains;X.prototype.$_g=X.prototype.get;X.prototype.$_a=X.prototype.Ob;X.prototype.$_un=X.prototype.Lb;X.prototype.$_r=X.prototype.remove;X.prototype.$_gs=X.prototype.ma;X.prototype.$_gos=X.prototype.ld;X.prototype.$_s=X.prototype.subscribe;X.prototype.$_ubk=X.prototype.wa;function xt(a,b,c){a?r("yt.mdx.remote.castv2_",!0,void 0):Zs();oq&&nq();Pq();zt||(zt=new vq,fr()&&(zt.f="/api/loungedev"));At||a||(At=new it(zt),At.subscribe("screenPair",Bt),At.subscribe("managedScreenChange",Ct),At.subscribe("onlineReceiverChange",function(){P("yt-remote-receiver-availability-change")}));
...
function Pt(){var a=Gt();if(!a)return null;if(!At){var b=Ft().ma();return Hq(b,a)}return ut(At,a)}
...
function Yt(a){r("yt.mdx.remote.currentScreenId_",a,void 0);if(At){var b=At;b.A=x()+3E5;if((b.Ub=a)&&(a=ut(b,a))&&!Gq(b.f,a)){var c=cb(b.f);c.push(a);mt(b,c,!0)}}}
...
function Lt(){var a=Sq();if(!a)return null;if(Wt()){var b=Ft().ma();return Hq(b,a)}return At?ut(At,a):null}
...
var It=[];function Zt(a){rk.call(this);this.M={Eb:a.Eb,Db:v(function(){mh.getInstance().ab(this.xa());ga(a.Db)&&a.Db()},this)};
this.A=this.B=null}
y(Zt,rk);Zt.prototype.Da=function(){Zt.L.Da.call(this);this.B=R(F(this.xa(),"dialog-id"));if(!this.B)throw Error("Cannot find create playlist widget dialog.");ok(this).Ga(document,"click",this.F);var a=L("yt-uix-card-show",v(this.J,this));this.ga.push(a);a=S("create-playlist-widget-form",this.B);this.A=new Lk(this.M);pk(this.A,a)};
Zt.prototype.Ea=function(){this.B=null;this.A.dispose();this.A=null;Zt.L.Ea.call(this)};
Zt.prototype.F=function(a){ee(this.B,jf(a))||mh.getInstance().ab(this.xa())};
Zt.prototype.J=function(a){a==this.xa()&&nk(this.A,"title-input").focus()};function $t(){this.f="scroller";this.j={}}
y($t,bh);ca($t);$t.prototype.dispose=function(){for(var a in this.j){var b=this.j[a],c=this.aa(b,"scroller-mousewheel-listener")||"";ac(b,"scroller-mousewheel-listener","");var d=this.aa(b,"scroller-scroll-listener")||"";ac(b,"scroller-scroll-listener","");ff(c);ff(d);ac(b,"scroller-scroll-listener","");b&&(b=ia(b).toString(),delete this.j[b])}this.j={}};var rb,au,V,bu,cu,du,eu,fu,gu,hu,iu,ju,ku,lu,mu,Z,de;var nu;function ou(a,b){this.type=a;this.videoIds=b||[]}
function pu(a,b){Aj("/watch_queue_ajax",{method:"POST",Qa:{action_check_playability:1},ta:{video_ids:a.join(",")},W:function(a,d){d&&ea(d)?b(d):b([])},
onError:function(){b([])}})}
function qu(a){u(a)&&(a=[a]);var b=new ou(1,a);nu?ru(function(){z(a,function(a){nu.bd(a)})},b,void 0):tu(b,a)}
function uu(a,b,c){var d=new ou(2);nu&&ru(function(){nu.Nc(a,b,c)},d,void 0)}
function vu(a){pu([a],function(b){Va(b)||wu(a)})}
function wu(a){var b=new ou(2);nu&&ru(function(){nu.Kc(a)},b,void 0)}
...
function tu(a,b){Aj("/watch_queue_ajax",{method:"POST",Qa:{action_remove_from_watch_queue:1},ta:{list:"WQ",video_ids:b.join(",")},W:function(){P("queue-change",a)},
onError:function(){}})}
...
function Lu(a){if(a.currentTarget==ju){if(qv()){var b=Yd(Z);a=uv();b=b.length;a=(b+a-1)%b;vv(a);lv();(b=nv())&&V&&V.$c(b,a)}}else if(a.currentTarget==ku)qv()&&(a=Yd(Z),a=(uv()+1)%a.length,vv(a),lv(),(b=nv())&&V&&V.kd(b,a));else if(a.currentTarget==lu)Gg(lu),Fg(mu),V?(a=Hu(),!iv()&&a[0]?As(V,a[0]):V.play()):au&&au.playVideo();else if(a.currentTarget==mu)Gg(mu),Fg(lu),V?V.pause():au&&au.pauseVideo();else if(A(a.currentTarget,"remove-item-watch-queue-button")){if(a=je(a.currentTarget,"watch-queue-item"),
...
function Tu(a){var b=a.playlistId,c=a.De;b&&c&&(a={videoIds:Hu().join(","),fullListId:b,W:function(){Mg(c)}},Kk(a))}
...
function Jv(){if(!bu){bu=!0;var a;nu?(a=St(),a="RQ"+(a?a.getLoungeToken():"")):a="WQ";Aj("/watch_queue_ajax",{method:"GET",Qa:{action_get_watch_queue_items:1,list:a},W:Kv,onError:Iv,sb:Iv});qv()?Fv():(Z.innerHTML=fu.render({}),zv())}}
...
"save-as-playlist":function(){if(!Va(Hu())){var a=du;mh.getInstance().pc(a.xa())}},
...
function Rv(a,b,c,d,e){c||(Pv&&Pv!=a&&Gg(Pv),Pv=a,e?Fg(a):Hg(a));d?S("yt-close",a).focus():(c={},c["action_"+b]=1,c.base_url=window.location.href.split("#",1)[0],Aj("/picker_ajax",{format:"JSON",method:"GET",Qa:c,W:v(Sv,null,a),onError:function(){Gg(a)}}))}
