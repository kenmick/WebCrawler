...
a.os=b.__getOS(j.os);a.osVersion=b.__getOSVersion(j.versionString,a.os);return a
};k.exports=i},{"./data":54,"ac-polyfills/Array/prototype.filter":66,"ac-polyfills/Array/prototype.some":67}],53:[function(d,g,f){g.exports={getDocumentMode:function(){var a;
if(document.documentMode){a=parseInt(document.documentMode,10)}else{a=5;if(document.compatMode){if(document.compatMode==="CSS1Compat"){a=7
...
}return false}l.exports=k(i);l.exports.original=i},{"./helpers/globals":27,"@marcom/ac-function/once":37}],60:[function(j,p,k){var n=j("@marcom/ac-classlist/add");
...
}}};p.exports=q},{"@marcom/ac-classlist/add":7,"@marcom/ac-classlist/remove":17,"@marcom/ac-object/extend":64}],61:[function(m,l,h){var j="data-focus-method";
function i(a,b){this._target=a||document.body;this._attr=b||j;this._focusMethod=false;
...
this._onBlur=this._onBlur.bind(this);this._bindEvents()}var k=i.prototype;k._bindEvents=function(){if(this._target.addEventListener){this._target.addEventListener("keydown",this._onKeyDown);
...
}};k._onKeyDown=function(a){this._focusMethod="key"};k._onMouseDown=function(a){this._focusMethod="mouse"
};k._onTouchStart=function(a){this._focusMethod="touch"};k._onFocus=function(a){a.target.setAttribute(this._attr,this._focusMethod)
};k._onBlur=function(a){a.target.removeAttribute(this._attr)};l.exports=i},{}],62:[function(m,k,h){m("@marcom/ac-polyfills");
...
})}},{"./FeatureDetect":60,"./FocusManager":61,"./defaultTests":63,"@marcom/ac-polyfills":"@marcom/ac-polyfills"}],63:[function(m,l,n){var k=m("@marcom/ac-browser");
...
},{"@marcom/ac-browser":3,"@marcom/ac-feature/svgAvailable":56,"@marcom/ac-feature/touchAvailable":58}],64:[function(k,j,g){k("@marcom/ac-polyfills/Array/prototype.forEach");
...
}}}});return b}},{"@marcom/ac-polyfills/Array/prototype.forEach":65}],65:[function(f,i,g){if(!Array.prototype.forEach){Array.prototype.forEach=function h(a,b){var c=Object(this);
var l;var d;if(typeof a!=="function"){throw new TypeError("No function object passed to forEach.")
}for(l=0;l<this.length;l+=1){d=c[l];a.call(b,d,l,c)}}}},{}],66:[function(f,i,g){if(!Array.prototype.filter){Array.prototype.filter=function h(a,b){var c=Object(this);
var n=c.length>>>0;var d;var m=[];if(typeof a!=="function"){throw new TypeError(a+" is not a function")
}for(d=0;d<n;d+=1){if(d in c&&a.call(b,c[d],d,c)){m.push(c[d])}}return m}}},{}],67:[function(f,i,g){if(!Array.prototype.some){Array.prototype.some=function h(a,b){var d=Object(this);
var l=d.length>>>0;var c;if(typeof a!=="function"){throw new TypeError(a+" is not a function")
}for(c=0;c<l;c+=1){if(c in d&&a.call(b,d[c],c,d)===true){return true}}return false
}}},{}],68:[function(o,m,i){o("@marcom/ac-headjs");var l=o("@marcom/ac-classlist");
var k=o("@marcom/ac-browser");var j=o("@marcom/ac-feature");var n=(function(){var b=document.documentElement;
...
}else{l.add(b,f+d)}}}}());m.exports=n.htmlClass()},{"@marcom/ac-browser":3,"@marcom/ac-classlist":14,"@marcom/ac-feature":28,"@marcom/ac-headjs":62}]},{},[68]);