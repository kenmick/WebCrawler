...
G.unshift({b_genius_img:d[106],b_type:d[130]});
r=M(r);
G.shift();
r+=d[59];
return r
...
G.unshift({b_type:d[130],b_genius_iconfont:d[106]});
r=L(r);
G.shift();
r+=d[3]
}r+=d[1]
...
G.unshift({b_genius_iconfont:d[106],b_type:d[107]});
r=O(r);
G.shift();
r+=d[59];
return r
...
G.unshift({b_size:d[108],b_color:d[109],b_classname:d[110],b_tooltip:d[111]});
H=K(H);
G.shift();
...
G.unshift({b_classname:d[140],b_ge_freebies:d[36],b_tooltip:d[111],b_ge_discount:d[36]});
H=o(H);
G.shift();
