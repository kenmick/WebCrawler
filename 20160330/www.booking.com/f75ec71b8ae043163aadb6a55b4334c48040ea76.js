...
}if(this.options.e_saas){this.model.destination.configurePredictions({gpm:1})
...
B.define("search/destination/service",function(c,d,b){_p=_o;_o="368:223";var a=c("search/destination/service-booking");
var h=c("search/destination/service-atlas");
function i(l,u,q){_p=_o;_o="368:224";var n,p;
var j=[];
var k=[];
var o=0;
var s={results:[],_ef:[],_efd:[]};
var t=undefined;
var r=function(v,w){_p=_o;_o="368:225";o++;
if(j.length){if(v){k.push(v)
}else{if(s===null){s=w
}else{e(s,w)
}}if(o==j.length){if(k.length==j.length){q.call(null,k[0],null)
}else{q.call(null,null,s)
}}}};
var m=function(){_p=_o;_o="368:227";for(n=0;
n<j.length;
n++){j[n].abort()
}};
for(n=0;
n<l.length;
n++){p=l[n].search.call(l[n],$.extend({},u),r);
if(p.getResultDetails){t=p.getResultDetails
}j.push(p)
}return{abort:m,getResultDetails:t}
}function e(k,j){_p=_o;_o="368:230";k.results=k.results.concat(j.results);
k._ef=k._ef.concat(j._ef);
k._efd=k._efd.concat(j._efd);
k.is_powered_by_google=k.is_powered_by_google||j.is_powered_by_google;
if(k.is_powered_by_google){k.city=undefined;
k.__upa__=k.results
}else{k.city=k.results;
k.__upa__=undefined
}k.city=k.results;
k.__js_upa__=k.is_powered_by_google
}function g(k,j,q){_p=_o;_o="368:232";var l;
var p=[];
var n=[];
var m=function(r,s){_p=_o;_o="368:233";if(p.length){if(r){n.push(r);
if(n.length==p.length){q.call(null,r,s)
}}else{q.call(null,r,s);
for(l=0;
l<p.length;
l++){p[l].abort()
}}}};
var o=function(){_p=_o;_o="368:235";for(l=0;
l<p.length;
l++){p[l].abort()
}};
for(l=0;
l<k.length;
l++){p.push(k[l].search.call(k[l],$.extend({},j),m))
}return{abort:o}
}function f(l,k,q){_p=_o;_o="368:238";var j;
var p={};
var n=function(r,s){_p=_o;_o="368:239";setTimeout(function(){_p=_o;_o="368:240";if(r&&l.length){m()
}else{q.call(null,r,s)
}},0)
};
var m=function(){_p=_o;_o="368:243";var r=l.shift();
j=r.search.call(r,$.extend({},k),n);
p.getResultDetails=j.getResultDetails
};
var o=function(){_p=_o;_o="368:245";if(j){j.abort()
}};
m();
p.abort=o;
return p
}b.exports={search:function(j,k){_p=_o;_o="368:248";if(!j||!j.ss||typeof k!="function"){throw new Error("Invalid arguments")
}if(j.gpo){return h.search(j,k)
}else{if(j.fesp_acf_i||j.fesp_acf_i_regions||j.fesp_acf_i_cities){return a.search(j,k)
}else{if(j.gpm){return i([a,h],j,k)
}else{if(j.gpr){return g([a,h],j,k)
}else{if(j.gpf){return f([a,h],j,k)
}else{return a.search(j,k)
}}}}}}}
});
B.define("search/destination/service-atlas",function(c,f,a){_p=_o;_o="368:251";var p=c("event-emitter");
...
function i(){_p=_o;_o="368:252";return !!B.atlas
}function j(q,s,t){_p=_o;_o="368:254";var r={city:[]};
r.__upa__=s.filter(m).slice(0,5).map(function(w,v){_p=_o;_o="368:255";w=w.get("data");
...
t(null,r)
}function m(q){_p=_o;_o="368:258";var r=q.get("data");
return n.indexOf(r.id)===-1
}function h(q,r,s){_p=_o;_o="368:260";q=q||{};
...
s(null,q)
}function o(q,r){_p=_o;_o="368:262";this.atlas.getGeocodeDetails({placeId:q.place_id},function(s){_p=_o;_o="368:263";h(q,s,r)
})
}function g(t,w,s){_p=_o;_o="368:266";var q="";
s=s||{};
if(!w||w.length===0){return t
}var v=w.map(function(x){_p=_o;_o="368:267";return x.offset
});
var r=w.map(function(x){_p=_o;_o="368:269";return x.offset+x.length-1
});
for(var u=0;
u<t.length;
...
}function b(r,s){_p=_o;_o="368:272";var q=[];
if(!s||s.length===0){return[{text:r}]
}s.forEach(function(v,w){_p=_o;_o="368:273";var u=v.offset+v.length,t=((s[w+1]&&s[w+1].offset)||r.length)-u;
q.push({highlighted:true,text:r.substr(v.offset,v.length)});
if(t){q.push({text:r.substr(u,t)})
}});
return q
}a.exports=p.extend({init:function(q,u){_p=_o;_o="368:276";q=q||{};
...
}},search:function(r,w){_p=_o;_o="368:278";if(!r||!r.ss||typeof w!="function"){throw new Error("service-atlas-invalid-arguments")
}if(!i()){setTimeout(function(){_p=_o;_o="368:279";w(new Error("service-atlas-no-atlas"),null)
},4);
...
u.lon=k;
u.radius=l
}var t=function(x){_p=_o;_o="368:281";if(!q){if(!x||!Array.isArray(x)){w(new Error("service-atlas-invalid-results"),null)
}else{j(r,x,w)
}}};
var s=function(x){_p=_o;_o="368:283";if(!q){w(new Error("service-atlas-error "+x),null)
}};
this.init(r,function(){_p=_o;_o="368:285";this.atlas.autocomplete(u,t,s)
}.bind(this));
var v=function(){_p=_o;_o="368:287";q=true
};
return{getResultDetails:o.bind(this),abort:v}
}})
});
B.define("search/destination/service-booking",function(c,e,a){_p=_o;_o="368:291";var j=c("event-emitter");
var i=c("et");
var g=B.env.autocomplete_use_auth?"/autocomplete_with_auth":"/autocomplete_2";
function d(k){_p=_o;_o="368:292";k.term=k.ss;
delete k.ss;
return k
}function h(l,k,m){_p=_o;_o="368:294";if(!l||!l.city){m(new Error("service-booking-data-invalid"),null)
...
}else{l.city=l.city.map(function(n,o){_p=_o;_o="368:295";if(!n.label&&n.labels){n.label=f(n.labels)
...
l.results=l.city;
if(l.bbtoollocations){l.results=l.bbtoollocations.map(function(n,o){_p=_o;_o="368:297";delete n.label_highlighted;
...
}if(l.theme){l.theme=l.theme.map(function(n,o){_p=_o;_o="368:299";n.ss=n.label;
n._ef=n._ef||[];
...
l._efd=l._efd||[];
m(null,l)
}}}function f(k){_p=_o;_o="368:302";return k.map(function(l){_p=_o;_o="368:303";return l.text
}).join(", ")
}function b(l){_p=_o;_o="368:306";var k=[];
l.forEach(function(m,n){_p=_o;_o="368:307";if(n>0){k.push({text:", "})
}k.push({highlighted:!!m.hl,text:m.text})
});
return k
}a.exports=j.extend({search:function(k,o){_p=_o;_o="368:310";if(!k||!k.ss||typeof o!="function"){throw new Error("Invalid arguments")
}var l=d(k);
this.emit("beforeajax",k,l);
if(g=="/autocomplete_2"&&B.et.track("PVdIMEHLNRfYO")){g="/autocomplete_nt"
}var m=$.ajax({type:"get",url:g,data:l,success:function(q,p,r){_p=_o;_o="368:311";this.emit("afterajax",k,q);
h(q,k,o)
}.bind(this),error:function(r,p,q){_p=_o;_o="368:313";if(p!=="abort"){o(new Error("service-booking-error "+q),null)
}}.bind(this)});
var n=function(){_p=_o;_o="368:315";if(m&&m.abort){m.abort()
}};
return{abort:n}
}})
});
B.define("search/searchbox/analytics",function(c,a,d){_p=_o;_o="368:319";var b={};
a.send=function(f,e){_p=_o;_o="368:320";if(!window.ga||!B.et.track("PVSfPATXIebYaO")){return
}window.ga("send","event","Searchbox",B.env.b_action,f,e)
};
a.sendOnce=function(g,f){_p=_o;_o="368:322";var e=g+":"+f;
if(!b[e]){a.send(g,f);
b[e]=true
}}
});
B.define("search/searchbox/model",function(c,b,d){_p=_o;_o="368:325";var e=c("event-emitter");
var f={};
function a(g){_p=_o;_o="368:326";e.extend(this);
this.id=g;
this.formAction;
this.fieldGroups={track:[]};
this.validators=[]
}$.extend(a.prototype,{use:function(j){_p=_o;_o="368:328";if(this[j]){return
...
}},submit:function(){_p=_o;_o="368:330";this.emit("submit")
},getFormAction:function(){_p=_o;_o="368:332";return this.formAction
},setFormAction:function(g){_p=_o;_o="368:334";this.formAction=g
},getFields:function(){_p=_o;_o="368:336";var g=[];
Object.keys(this.fieldGroups).forEach(function(h){_p=_o;_o="368:337";if(Array.isArray(this.fieldGroups[h])){g=g.concat(this.fieldGroups[h])
}}.bind(this));
return g
},setFields:function(h,g){_p=_o;_o="368:340";this.fieldGroups[h]=g
},validate:function(){_p=_o;_o="368:342";var g=this.validators.filter(function(h){_p=_o;_o="368:343";return h.call()
});
return g.length==this.validators.length
}});
d.exports={getInstance:function(g){_p=_o;_o="368:346";if(!f[g]){f[g]=new a(g)
}return f[g]
}}
});
B.define("component/search/searchbox/searchbox",function(d,b,e){_p=_o;_o="368:349";var c=d("component");
...
e.exports=c.extend({init:function(){_p=_o;_o="368:350";this.hiddenFields=[];
...
g.on("beforeajax",function(i,j){_p=_o;_o="368:351";B.eventEmitter.trigger("AUTOCOMPLETE:beforeAjax",{params:j})
});
g.on("afterajax",function(i,j){_p=_o;_o="368:353";B.eventEmitter.trigger("AUTOCOMPLETE:afterAjax",{data:j})
})
},modelChange:function(){_p=_o;_o="368:356";this.updateHiddenFields()
},modelSubmit:function(){_p=_o;_o="368:358";this.$form.submit()
},initCurrentCountryField:function(){_p=_o;_o="368:360";var i=false;
...
}},onlyCurrentCountryChange:function(){_p=_o;_o="368:362";this.model.use("destination");
this.model.destination.setOnlyCurrentCountry(this.$onlyCurrentCountry.is(":checked"))
},updateHiddenFields:function(){_p=_o;_o="368:364";var j=this.model.getFormAction();
var l=this.$form.attr("action");
if(!j){j=this.originalAction
}if(l!=j){this.$form.attr("action",j)
}if(this.hiddenFields){this.hiddenFields.forEach(function(n){_p=_o;_o="368:365";n.$node.remove();
n.$node=null
})
...
var k=[];
var i=false;
m.forEach(function(n){_p=_o;_o="368:367";this.hiddenFields.push({name:n.name,value:n.value});
k.push(n.name);
if(a.indexOf(n.name)!=-1){i=true
}}.bind(this));
this.$form.find("input").filter(function(){_p=_o;_o="368:369";return(i&&a.indexOf(this.name)!=-1)||k.indexOf(this.name)!=-1
}).remove();
this.hiddenFields.forEach(function(n){_p=_o;_o="368:371";var o=$("<input>");
o.attr("type","hidden");
o.attr("name",n.name);
...
},formSubmit:function(j){_p=_o;_o="368:374";var i=this.model.validate();
if(!i){j.preventDefault();
return
}}})
});
(function(a,b){_p=_o;_o="368:377";a(function(){_p=_o;_o="368:378";a(".ge-search-first-checkbox").change(function(){_p=_o;_o="368:379";var f="cQZJZadTQZGSRaPSWe";
...
B.define("component/search/group/children-ages-tooltip",function(c,a,d){_p=_o;_o="368:383";var e=c("jstmpl");
var b=c("component");
d.exports=b.extend({init:function(){_p=_o;_o="368:384";this.dropdown=false;
this.$form=$("#frm");
this.isPopupAlreadyShown=false;
this.agesSelector='[name="age"]';
this.addEventListeners()
},addEventListeners:function(){_p=_o;_o="368:386";this.$el.change(this.showTooltip.bind(this));
this.$form.delegate(this.agesSelector,"click",this.hideTooltip.bind(this))
},showTooltip:function(g){_p=_o;_o="368:388";var f=parseInt(this.$el.val())>0;
if(f&&!this.isPopupAlreadyShown){setTimeout(function(){_p=_o;_o="368:389";this.dropdown=$.fly.dropdown.extend({defaults:{position:"bottom left",content:function(){_p=_o;_o="368:390";return e("searchbox_children_ages_tooltip").render({})
},extraClass:"searchbox_children_ages_tooltip"}}).create("#frm "+this.agesSelector);
this.dropdown.show();
this.isPopupAlreadyShown=true
}.bind(this),0)
}},hideTooltip:function(f){_p=_o;_o="368:394";if(this.dropdown){this.dropdown.hide();
