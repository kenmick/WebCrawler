/* 1.0.0.57.0 - 2016-03-29 17:10:42 */
var x14=true;var x1k,x15,x1fN,x1m,x1D,x1J,x1n,x1mG,x1j3,x1n6,adperf_present,x1h=navigator.appVersion.toLowerCase(),x1qy=navigator.userAgent,x19=x1qy.toLowerCase(),x1n7,x1n8,x1oi,x1oj;var x1jG,x1jH,x1fE,x1jI,x1jJ,x1jK,x1mF={};var adperf_version='1.0.0';var x1C;var weborama_display_tag,adperfobj;weborama_display_tag=weborama_display_tag||adperfobj;adperfobj=(weborama_display_tag&&!weborama_display_tag.x1sa&&weborama_display_tag)||adperfobj||{};adperfobj.x1sa=true;if(adperfobj.admire_script_counting!==undefined){x14=!!adperfobj.admire_script_counting;}
function x1I(){if(adperfobj.forcesecure===true){return true;}
...
return x1cM;}
function x1nE(x1ne){x1ne=x1ne||{};var x1n9=x1I(),x1qz=x1ne.cachebuster===false?'':'?r='+Math.random();x1fN=x1ne.mediapath||'';var x1qA='_scrambled.js';x15='http://cstatic.weborama.fr/js/advertiserv2/';if(x1ne.script_variant===undefined&&(x1k7().indexOf('msn.com')!==-1||x1k7().indexOf('autoscout24.nl')!==-1)){x1ne.script_variant='positioning-update';}
if(x1ne.script_variant==='positioning-update'||x1ne.script_variant==='preprod'){x15+=x1ne.script_variant+'/';}
x1m='http://'+(x1ne.fullhost||(x1ne.host+'.solution.weborama.fr'))+'/fcgi-bin/dispatch.fcgi';x1J=x15+'adperf_launch_'+adperf_version+x1qA;x1D=x1ne.admire_id?"":x1m;x1j3="";x1n=x15+'adperf_'+'debug_'+adperf_version+x1qA;x1mG=x15+'adperf_'+'adapter_'+adperf_version+x1qA;x1J=x1Q(x1J,x1n9);x1n=x1Q(x1n,x1n9);x1mG=x1Q(x1mG,x1n9);x1D=x1Q(x1D,x1n9);x1m=x1Q(x1m,x1n9);x15=x1Q(x15,x1n9);x1fN=x1Q(x1fN,x1n9);x1j3=x1Q(x1j3,x1n9);}
function x1S(x1x){if((typeof x1x!=='undefined')&&(x1x!=='')&&(x1x!=='undefined')&&(x1x!=='null')&&(x1x!==null)&&(x1x!==false)){return true;}
return false;}
function x1o_(x1nr){if(typeof x1nr==='string'){return/^([a-z]+:)?\/\//i.test(x1nr);}
return false;}
function x1uk(x1fF){return/weborama\.(nl|fr|com)$/i.test(x1fF);}
...
if(x1ea!=self&&x1ea!=self.parent){return false;}
var x1jM=document.domain,x1jO;while(x1jM.split('.').length>=2){try{document.domain=x1jM;try{x1jO=x1ea.document.domain;return true;}catch(x1o){}
}catch(x1o){}
x1jM=x1jM.substr(x1jM.indexOf('.')+1,x1jM.length);}
return false;}
function x13(x1ea,x1pf){var x12=false;x1pf=x1pf!==undefined?x1pf:true;try{x12=document.domain===x1ea.document.domain;}catch(x1o){x12=false;}
if(!x12&&x1pf){try{document.domain=x1ea.document.domain;x12=true;}catch(x1o){x12=x16(x1ea);}
}
return x12;}
function x1jQ(){}
function x1M(x1hq){if(x1hq.indexOf('http')===0){if(x1I()){x1hq=x1Q(x1hq,true);}
var x1x=x1C.length;x1C[x1x]=new Image(1,1);x1C[x1x].onerror=x1C[x1x].onload=function(){try{x1jQ();}catch(x1o){}
};x1C[x1x].src=x1hq;}
}
...
if(top!==self){try{x1pg=document.referrer.match(/([^\/\/][a-z0-9_\-]+\.?[^\/]+)+/gi)[1];}catch(x1o){}
}
...
function x1L(x1jV){if(x1p){if(adperfobj&&adperfobj.script_variant!==undefined){x1nE(adperfobj);}
x1aR(x15+x1jV);if(x1mF.x1mH){x1aR(x1mG);}
}else if(typeof x1bb!=='undefined'){x1bb.x1c();x17();}
}
function x1j(){try{x1jH=escape(document.location);x1jG=escape((top!==null&&top.location!==null&&typeof top.location.href==='string')?top.document.referrer:x1N.referrer);}catch(x1o){}
...
try{x1od=!!x1bV.contentWindow.document;}catch(x1o){x1od=false;}
...
x1ba=(x1h.indexOf('win')>=0||x19.indexOf('windows')>=0);x1qC=parseFloat((x1qy.match(/Windows NT (\d+\.\d+)/)||[])[1]||0);x1K=(x19.indexOf('linux')>=0&&x19.indexOf('android')===-1);x1og=navigator.platform==='BlackBerry';x1e=(x19.indexOf('android')>=0?parseFloat(x19.slice(x19.indexOf('android')+8))||true:false);x1H=(x19.indexOf('iphone')>=0);x1G=(x19.indexOf('ipad')>=0);x1F=(x1H||x1G);if(x1F){try{x1F=parseFloat(x19.match(/(ipad|iphone).*os\s([\d_]+)/)[2].replace(/_/,'.').replace(/_/g,''));}catch(x1o){x1F=true;}
}
...
var screenad=screenad||{};screenad.campaignfreq=screenad.flightfreq=1;var adperf_burst=adperfobj.burst;var x1p=(typeof adperf_present==='undefined'||adperf_present.indexOf(adperf_version+':')<0)?true:false;if(x1p){var x1O=self,x1N=x1O.document,x1P,x1U,x1ba,x1qC,x1K,x1e,x1F,x1og,x1T,x1t_,x1t,x1_,x11,x1l,x1y,x1A,x1lM,x1oh,x1sn,x1H,x1G,x1ao,x1R,x1pN,x1q=0,x1s,x1ok=false,x1aj='',x1i,x1V;x1C=[];if(x1y&&x1y<11){if(x1y>=6){try{x1i=new ActiveXObject('ShockwaveFlash.ShockwaveFlash');x1i.AllowScriptAccess='always';x1aj=x1i.GetVariable('$version').replace(/[a-zA-Z]/g,'');x1q=parseInt(x1aj,10);x1s=parseInt(x1aj.split(',')[2],10);}catch(x1o){}
}
}
