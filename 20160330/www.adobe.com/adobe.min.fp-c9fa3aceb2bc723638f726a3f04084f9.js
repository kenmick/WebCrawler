...
}},request:function(b,c){var a=null;
$.ajax({type:"POST",url:b,data:{gid:Adobe.GoCart.Gid[1],gtoken:Adobe.GoCart.Gtoken[1]}}).done(function(d){Adobe.GoCart.debug(["Adobe.GoCart.request complete",d]);
a=d
}).fail(function(d,e){Adobe.GoCart.debug(["Adobe.GoCart.request fail:",d,e]);
a=e
}).always(function(){if(typeof c!="undefined"){c(a)
}return a
})
}};
