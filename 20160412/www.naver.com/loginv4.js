...
function ipCheckOff() {
	...
	if (label != null) {
		...
		$('ckb_type').title='IP ë³´ìì´ êº¼ì ¸ ììµëë¤. IPë³´ìì ì¬ì©íë ¤ë©´ ì íí´ì£¼ì¸ì.';
	}
	setSmartLevel(-1);
	var scriptElement = document.createElement('script');
...
function ipCheckOn(level) {
	...
	$('ckb_type').title='IP ë³´ìì´ ì¼ì ¸ ììµëë¤. IPë³´ìì ì¬ì©íì§ ìì¼ìë ¤ë©´ ì íì í´ì í´ì£¼ì¸ì.';
	setSmartLevel(level);
	var scriptElement = document.createElement('script');
...
var loginNClicks = {
	...
	anchorTextNClicksNamePair : [
		[ "IPë³´ì", "log_off.ipcheck" ],
		[ "íìê°ì", "log_off.registration" ],
		[ "ë¹ë°ë²í¸ ì°¾ê¸°", "log_off.searchpass" ],
		[ "ëìë§ ë³´ê¸°", "log_off*k.help" ],
		[ "ì¼íì© ë¡ê·¸ì¸", "log_off.loginone" ]
	],
	installed : false,
	isMSIE : fc_isIE,
