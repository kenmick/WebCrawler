...
define("sjs/matrix/ad/form/couplet", 
	...
	options : {
			tpl : "<div class=\"{{id}}_left\" style=\"width:{{l_width}}px;position:absolute;float:left;\">"
					...
					+	"<a style=\"cursor:pointer;border-bottom:1px solid #000000;color:#000000;font-size:12px;float:left;\">" + unescape("%u5173%u95ED") + "</a>"
					+"</div>"
				+"</div>"
				+"<div class=\"{{id}}_right\" style=\"width:{{r_width}}px;position:absolute;float:right;\">"
					...
					+	"background:url(http://images.sohu.com/bill/s2011/gates/gif/bg.jpg) repeat-x;\">"
					+	"<a style=\"cursor:pointer;border-bottom:1px solid #000000;color:#000000;font-size:12px;float:right;right: 0px;\">" + unescape("%u5173%u95ED") + "</a>"
					+"</div>"
				+"</div>",
			left_n : "resource",
			right_n : "resource1",
