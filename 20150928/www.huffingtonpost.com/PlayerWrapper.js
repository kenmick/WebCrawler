/*jslint nomen: true, white: true, unparam: true*/
/*global requirejs: true */

( function( root ) {
	'use strict';	
    
	root.getPlayer = function ( video, movie ) {

        var player;
        
        video.setAttribute( "class", "video-js vjs-tech vjs-default-skin gacdn" );
        
        videojs.streamrail = { enabled: true, key: '6bb24cc3'};
...
(function() {
    ...
    s.src = function(a) {
        ...
        t.i.isArray(a) ? ma(this, a) : "string" === typeof a ? this.src({
            src: a
        }) : ( a instanceof Object || typeof a === "object" ) && (a.type && !window.videojs[this.Ua].canPlaySource(a) ? ma(this, [a]) : (this.K.src = a.src, this.Gc = a.type || "", this.I(function() {
