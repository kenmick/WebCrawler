...
<![endif]-->
  ...
  <script type="text/javascript">/*<![CDATA[*/ (function(undefined){if(!window.bbc){window.bbc={}}var ROLLING_PERIOD_DAYS=30;window.bbc.Mandolin=function(id,segments,opts){var now=new Date().getTime(),storedItem,DEFAULT_START=now,DEFAULT_RATE=1,COOKIE_NAME="ckpf_mandolin";opts=opts||{};this._id=id;this._segmentSet=segments;this._store=new window.window.bbc.Mandolin.Storage(COOKIE_NAME);this._opts=opts;this._rate=(opts.rate!==undefined)?+opts.rate:DEFAULT_RATE;this._startTs=(opts.start!==undefined)?new Date(opts.start).getTime():new Date(DEFAULT_START).getTime();this._endTs=(opts.end!==undefined)?new Date(opts.end).getTime():daysFromNow(ROLLING_PERIOD_DAYS);this._signupEndTs=(opts.signupEnd!==undefined)?new Date(opts.signupEnd).getTime():this._endTs;this._segment=null;if(typeof id!=="string"){throw new Error("Invalid Argument: id must be defined and be a string")}if(Object.prototype.toString.call(segments)!=="[object Array]"){throw new Error("Invalid Argument: Segments are required.")}if(opts.rate!==undefined&&(opts.rate<0||opts.rate>1)){throw new Error("Invalid Argument: Rate must be between 0 and 1.")}if(this._startTs>this._endTs){throw new Error("Invalid Argument: end date must occur after start date.")}if(!(this._startTs<this._signupEndTs&&this._signupEndTs<=this._endTs)){throw new Error("Invalid Argument: SignupEnd must be between start and end date")}removeExpired.call(this,now);var overrides=window.bbccookies.get().match(/ckns_mandolin_setSegments=([^;]+)/);if(overrides!==null){eval("overrides = "+decodeURIComponent(RegExp.$1)+";");if(overrides[this._id]&&this._segmentSet.indexOf(overrides[this._id])==-1){throw new Error("Invalid Override: overridden segment should exist in segments array")}}if(overrides!==null&&overrides[this._id]){this._segment=overrides[this._id]}else{if((storedItem=this._store.getItem(this._id))){this._segment=storedItem.segment}else{if(this._startTs<=now&&now<this._signupEndTs&&now<=this._endTs&&this._store.isEnabled()===true){this._segment=pick(segments,this._rate);if(opts.end===undefined){this._store.setItem(this._id,{segment:this._segment})}else{this._store.setItem(this._id,{segment:this._segment,end:this._endTs})}log.call(this,"mandolin_segment")}}}log.call(this,"mandolin_view")};window.bbc.Mandolin.prototype.getSegment=function(){return this._segment};function log(actionType,params){var that=this;require(["istats-1"],function(istats){istats.log(actionType,that._id+":"+that._segment,params?params:{})})}function removeExpired(expires){var items=this._store.getItems(),expiresInt=+expires;for(var key in items){if(items[key].end!==undefined&&+items[key].end<expiresInt){this._store.removeItem(key)}}}function getLastExpirationDate(data){var winner=0,rollingExpire=daysFromNow(ROLLING_PERIOD_DAYS);for(var key in data){if(data[key].end===undefined&&rollingExpire>winner){winner=rollingExpire}else{if(+data[key].end>winner){winner=+data[key].end}}}return(winner)?new Date(winner):new Date(rollingExpire)}window.bbc.Mandolin.prototype.log=function(params){log.call(this,"mandolin_log",params)};window.bbc.Mandolin.prototype.convert=function(params){log.call(this,"mandolin_convert",params);this.convert=function(){}};function daysFromNow(n){var endDate;endDate=new Date().getTime()+(n*60*60*24)*1000;return endDate}function pick(segments,rate){var picked,min=0,max=segments.length-1;if(typeof rate==="number"&&Math.random()>rate){return null}do{picked=Math.floor(Math.random()*(max-min+1))+min}while(picked>max);return segments[picked]}window.bbc.Mandolin.Storage=function(name){validateCookieName(name);this._cookieName=name;this._isEnabled=(bbccookies.isAllowed(this._cookieName)===true&&bbccookies.cookiesEnabled()===true)};window.bbc.Mandolin.Storage.prototype.setItem=function(key,value){var storeData=this.getItems();storeData[key]=value;this.save(storeData);return value};window.bbc.Mandolin.Storage.prototype.isEnabled=function(){return this._isEnabled};window.bbc.Mandolin.Storage.prototype.getItem=function(key){var storeData=this.getItems();return storeData[key]};window.bbc.Mandolin.Storage.prototype.removeItem=function(key){var storeData=this.getItems();delete storeData[key];this.save(storeData)};window.bbc.Mandolin.Storage.prototype.getItems=function(){return deserialise(this.readCookie(this._cookieName)||"")};window.bbc.Mandolin.Storage.prototype.save=function(data){window.bbccookies.set(this._cookieName+"="+encodeURIComponent(serialise(data))+"; expires="+getLastExpirationDate(data).toUTCString()+";")};window.bbc.Mandolin.Storage.prototype.readCookie=function(name){var nameEq=name+"=",ca=window.bbccookies.get().split("; "),i,c;validateCookieName(name);for(i=0;i<ca.length;i++){c=ca[i];if(c.indexOf(nameEq)===0){return decodeURIComponent(c.substring(nameEq.length,c.length))}}return null};function serialise(o){var str="";for(var p in o){if(o.hasOwnProperty(p)){str+='"'+p+'"'+":"+(typeof o[p]==="object"?(o[p]===null?"null":"{"+serialise(o[p])+"}"):'"'+o[p].toString()+'"')+","}}return str.replace(/,\}/g,"}").replace(/,$/g,"")}function deserialise(str){var o;str="{"+str+"}";if(!validateSerialisation(str)){throw"Invalid input provided for deserialisation."}eval("o = "+str);return o}var validateSerialisation=(function(){var OBJECT_TOKEN="<Object>",ESCAPED_CHAR='"\\n\\r\\u2028\\u2029\\u000A\\u000D\\u005C',ALLOWED_CHAR="([^"+ESCAPED_CHAR+"]|\\\\["+ESCAPED_CHAR+"])",KEY='"'+ALLOWED_CHAR+'+"',VALUE='(null|"'+ALLOWED_CHAR+'*"|'+OBJECT_TOKEN+")",KEY_VALUE=KEY+":"+VALUE,KEY_VALUE_SEQUENCE="("+KEY_VALUE+",)*"+KEY_VALUE,OBJECT_LITERAL="({}|{"+KEY_VALUE_SEQUENCE+"})",objectPattern=new RegExp(OBJECT_LITERAL,"g");return function(str){if(str.indexOf(OBJECT_TOKEN)!==-1){return false}while(str.match(objectPattern)){str=str.replace(objectPattern,OBJECT_TOKEN)}return str===OBJECT_TOKEN}})();function validateCookieName(name){if(name.match(/ ,;/)){throw"Illegal name provided, must be valid in browser cookie."}}})(); /*]]>*/</script>  <script type="text/javascript">  document.documentElement.className += (document.documentElement.className? ' ' : '') + 'orb-js';  fig.manager.confirm(); </script> <script src="http://static.bbci.co.uk/frameworks/barlesque/3.7.3/orb/4/script/orb/api.min.js"></script> <script type="text/javascript"> var blq = { environment: function() { return 'live'; } } </script>   <script type="text/javascript"> /*<![CDATA[*/ function oqsSurveyManager(w, flag) { if (flag !== 'OFF') { w.document.write('<script type="text/javascript" src="http://static.bbci.co.uk/frameworks/barlesque/3.7.3/orb/4/script/vendor/edr.min.js"><'+'/script>'); } } oqsSurveyManager(window, 'ON'); /*]]>*/ </script>             <!-- BBCDOTCOM template: responsive webservice  -->
        <!-- BBCDOTCOM head --><script type="text/javascript"> /*<![CDATA[*/ var _sf_startpt = (new Date()).getTime(); /*]]>*/ </script><style type="text/css">.bbccom_display_none{display:none;}</style><script type="text/javascript"> /*<![CDATA[*/ var bbcdotcomConfig, googletag = googletag || {}; googletag.cmd = googletag.cmd || []; var bbcdotcom = false; (function(){ if(typeof require !== 'undefined') { require({ paths:{ "bbcdotcom":"http://static.bbci.co.uk/bbcdotcom/1.4.0/script" } }); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ var bbcdotcom = { adverts: { keyValues: { set: function() {} } }, advert: { write: function () {}, show: function () {}, isActive: function () { return false; }, layout: function() { return { reset: function() {} } } }, config: { init: function() {}, isActive: function() {}, setSections: function() {}, isAdsEnabled: function() {}, setAdsEnabled: function() {}, isAnalyticsEnabled: function() {}, setAnalyticsEnabled: function() {}, setAssetPrefix: function() {}, setVersion: function () {}, setJsPrefix: function() {}, setSwfPrefix: function() {}, setCssPrefix: function() {}, setConfig: function() {}, getAssetPrefix: function() {}, getJsPrefix: function () {}, getSwfPrefix: function () {}, getCssPrefix: function () {} }, survey: { init: function(){ return false; } }, data: {}, init: function() {}, objects: function(str) { return false; }, locale: { set: function() {}, get: function() {} }, setAdKeyValue: function() {}, utils: { addEvent: function() {}, addHtmlTagClass: function() {}, log: function () {} }, addLoadEvent: function() {} }; /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (typeof orb !== 'undefined' && typeof orb.fig === 'function') { if (orb.fig('ad') && orb.fig('uk') == 0) { bbcdotcom.data = { ads: (orb.fig('ad') ? 1 : 0), stats: (orb.fig('uk') == 0 ? 1 : 0), statsProvider: orb.fig('ap') }; } } else { document.write('<script type="text/javascript" src="'+('https:' == document.location.protocol ? 'https://ssl.bbc.com' : 'http://tps.bbc.com')+'/wwscripts/data">\x3C/script>'); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (typeof orb === 'undefined' || typeof orb.fig !== 'function') { bbcdotcom.data = { ads: bbcdotcom.data.a, stats: bbcdotcom.data.b, statsProvider: bbcdotcom.data.c }; } if (bbcdotcom.data.ads == 1) { document.write('<script type="text/javascript" src="'+('https:' == document.location.protocol ? 'https://ssl.bbc.co.uk' : 'http://www.bbc.co.uk')+'/wwscripts/flag">\x3C/script>'); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (window.bbcdotcom && (typeof bbcdotcom.flag == 'undefined' || (typeof bbcdotcom.data.ads !== 'undefined' && bbcdotcom.flag.a != 1))) { bbcdotcom.data.ads = 0; } if (/[?|&]ads/.test(window.location.href) || /(^|; )ads=on; /.test(document.cookie) || /; ads=on(; |$)/.test(document.cookie)) { bbcdotcom.data.ads = 1; bbcdotcom.data.stats = 1; } if (window.bbcdotcom && (bbcdotcom.data.ads == 1 || bbcdotcom.data.stats == 1)) { bbcdotcom.assetPrefix = "http://static.bbci.co.uk/bbcdotcom/1.4.0/"; if (/(sandbox|int)(.dev)*.bbc.co*/.test(window.location.href) || /[?|&]ads-debug/.test(window.location.href) || document.cookie.indexOf('ads-debug=') !== -1) { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/1.4.0/script/orb/individual.js">\x3C/script>'); } else { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/1.4.0/script/orb/bbcdotcom.js">\x3C/script>'); } if(/[\\?&]ads=([^&#]*)/.test(window.location.href)) { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/1.4.0/script/orb/adverts/adSuites.js">\x3C/script>'); } } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (window.bbcdotcom && (bbcdotcom.data.ads == 1 || bbcdotcom.data.stats == 1)) { bbcdotcomConfig = {"adFormat":"standard","adKeyword":"","adMode":"smart","adsEnabled":true,"appAnalyticsSections":"","asyncEnabled":true,"disableInitialLoad":false,"advertInfoPageUrl":"http:\/\/www.bbc.co.uk\/faqs\/online\/adverts_general","advertisementText":"Advertisement","analyticsEnabled":true,"appName":"wwhp","assetPrefix":"http:\/\/static.bbci.co.uk\/bbcdotcom\/1.4.0\/","continuousPlayEnabled":true,"customAdParams":[],"customStatsParams":[],"headline":"","id":"","inAssociationWithText":"in association with","keywords":"","language":"","orbTransitional":false,"outbrainEnabled":true,"palEnv":"live","productName":"","sections":[],"siteCatalystEnabled":true,"comScoreEnabled":true,"comscoreSite":"bbc-global-test","comscoreID":"18897612","comscorePageName":"home","slots":"","sponsoredByText":"is sponsored by","adsByGoogleText":"Ads by Google","summary":"","type":"","staticBase":"\/bbcdotcom","staticHost":"http:\/\/static.bbci.co.uk","staticVersion":"1.4.0","staticPrefix":"http:\/\/static.bbci.co.uk\/bbcdotcom\/1.4.0","dataHttp":"tps.bbc.com","dataHttps":"ssl.bbc.com","flagHttp":"www.bbc.co.uk","flagHttps":"ssl.bbc.co.uk","analyticsHttp":"sa.bbc.com","analyticsHttps":"ssa.bbc.com"}; bbcdotcom.config.init(bbcdotcomConfig, bbcdotcom.data, window.location, window.document); bbcdotcom.config.setAssetPrefix("http://static.bbci.co.uk/bbcdotcom/1.4.0/"); bbcdotcom.config.setVersion("1.4.0"); document.write('<!--[if IE 7]><script type="text/javascript">bbcdotcom.config.setIE7(true);\x3C/script><![endif]-->'); document.write('<!--[if IE 8]><script type="text/javascript">bbcdotcom.config.setIE8(true);\x3C/script><![endif]-->'); document.write('<!--[if IE 9]><script type="text/javascript">bbcdotcom.config.setIE9(true);\x3C/script><![endif]-->'); if (/[?|&]ex-dp/.test(window.location.href) || document.cookie.indexOf('ex-dp=') !== -1) { bbcdotcom.utils.addHtmlTagClass('bbcdotcom-ex-dp'); } } })(); /*]]>*/ </script>            <script type="text/javascript">/*<![CDATA[*/
    ...
    <h2 class="module__title">&nbsp;</h2>
        ...
        <li class="media-list__item media-list__item--1">
            <div class="media media--hero media--primary media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/C1A4/production/_88127594_9d208cbf-da73-46f4-9c1c-78ad72ed344e.jpg" data-alt="A Syrian refugee in a wheelchair at the Turkish border"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/C1A4/production/_88127594_9d208cbf-da73-46f4-9c1c-78ad72ed344e.jpg" alt="A Syrian refugee in a wheelchair at the Turkish border" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-middle-east-35503343"
                                  rev="hero1|headline" >
                                                            Refugees mass at Turkey-Syria border                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Some 15,000 Syrians are massed at the Turkish border after fleeing a government offensive in Aleppo, the UN and Turkey say.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-middle-east-35503343"
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/E2CB/production/_88095085_topgear2_976bbc.jpg" data-alt="Matt LeBlanc with Chris Evans and 'The Stig'"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/E2CB/production/_88095085_topgear2_976bbc.jpg" alt="Matt LeBlanc with Chris Evans and 'The Stig'" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.co.uk/news/entertainment-arts-35500879"
                                  rev="hero2|headline" >
                                                            Matt LeBlanc 'amazed' by Top Gear reaction                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.co.uk/news/entertainment-arts-35500879"
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/14960/production/_88102348_c0286346-zika_virus,_tem-spl.jpg" data-alt="Zika virus"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/14960/production/_88102348_c0286346-zika_virus,_tem-spl.jpg" alt="Zika virus" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/health-35493892"
                                  rev="hero3|headline" >
                                                            Zika virus: 13 key unanswered questions                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/health-35493892"
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/EBBE/production/_88105306_644eded9-d76e-4ba4-aa65-9963463428c2.jpg" data-alt="Student playing a French game"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/EBBE/production/_88105306_644eded9-d76e-4ba4-aa65-9963463428c2.jpg" alt="Student playing a French game" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/world-europe-35496893"
                                  rev="hero4|headline" >
                                                            Changes in French spelling spark controversy                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/world-europe-35496893"
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/dj/p03hdj0p.jpg" data-alt="A pod of bottlenose dolphins (Tursiops truncatus) (Credit: Georgette Douwma/naturepl.com)"><img src="http://ichef.bbci.co.uk/wwhp/144/ibroadcast/images/live/p0/3h/dj/p03hdj0p.jpg" alt="A pod of bottlenose dolphins (Tursiops truncatus) (Credit: Georgette Douwma/naturepl.com)" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/earth/story/20160204-cute-and-cuddly-dolphins-are-secretly-murderers"
                                  rev="hero5|headline" >
                                                            The disturbing truth about dolphins                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/earth/story/20160204-cute-and-cuddly-dolphins-are-secretly-murderers"
     ...
     <div class="module__content"> <ul class="media-list media-list--fixed-height">         
        <li class="media-list__item media-list__item--1">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/A9F8/production/_88121534_cadpw0rw0aeserh.jpg" data-alt="New York crane collapse"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="New York crane collapse" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-us-canada-35505329"
                                  rev="news|headline" >
                                                            Massive crane collapses in New York                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            A large construction crane has collapsed in lower Manhattan in New York City, killing one person and injuring at least two others.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-us-canada-35505329"
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/430A/production/_88126171_88126170.jpg" data-alt="Julian Assange outside the Ecuadorean embassy"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Julian Assange outside the Ecuadorean embassy" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/uk-35504237"
                                  rev="news|headline" >
                                                            UK brands Assange ruling 'ridiculous'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The UK foreign secretary brands as &quot;ridiculous&quot; a UN panel's ruling that Julian Assange be allowed to go free, but the Wikileaks founder demands the decision be respected.                                                    </p>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/654C/production/_88123952_pope_kirill_composite.jpg" data-alt="Pope Francis (left) and Patriarch Kirill"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Pope Francis (left) and Patriarch Kirill" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35500973"
                                  rev="news|headline" >
                                                            Pope set for historic Patriarch meeting                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Pope Francis is to hold a historic first meeting with Patriarch Kirill, the head of Russian Orthodox Church, in Cuba.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35500973"
                          rev="news|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Pope set for historic Patriarch meeting                </a>
            </div>
     ...
     <div class="module__content"> <ul class="media-list media-list--fixed-height">         
        <li class="media-list__item media-list__item--1">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/11690/production/_88121317_gettyimages-505390678.jpg" data-alt="Arsene Wenger"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Arsene Wenger" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/sport/football/35502898"
                                  rev="sport|headline" >
                                                            'TV cash will not cut ticket prices'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Arsenal boss Arsene Wenger says television revenue Premier League clubs get will be used to buy players.                                                    </p>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/1F4B/production/_88111080_gettyimages-51666253.jpg" data-alt="Wang Junxia from China celebrates on the podium during the medal ceremony after winning the gold medal in the women's Olympic 5,000m event at the Olympic Stadium in Atlanta, Georgia, 28 July 1996"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Wang Junxia from China celebrates on the podium during the medal ceremony after winning the gold medal in the women's Olympic 5,000m event at the Olympic Stadium in Atlanta, Georgia, 28 July 1996" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-asia-china-35499442"
                                  rev="sport|headline" >
                                                            IAAF investigates China doping letter                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The International Association of Athletics Federations says it is investigating a historic letter alleged forced doping in the Chinese sport.                                                    </p>
                    
                                            <a class="media__tag tag tag--sport" href="/news/world/asia/china"
                                  rev="sport|source" >China</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="/news/world-asia-china-35499442"
                          rev="sport|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    IAAF investigates China doping letter                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/10685/production/_88050276_fans_collage.jpg" data-alt="Six Nations fans"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Six Nations fans" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/sport/rugby-union/35471997"
                                  rev="sport|headline" >
                                                            The most intriguing Six Nations ever?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            New coaches, exciting debutants and a sense of the unknown increase anticipation of the Six Nations that starts this weekend.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/sport/rugby-union/35471997"
                          rev="sport|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    The most intriguing Six Nations ever?                </a>
            </div>
     ...
     </ul> </div> </section> <div class="advert advert--mpu"><!-- BBCDOTCOM slot mpu --><div id="bbccom_mpu_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('mpu', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </section>       <section class="module module--weather" data-wwhp-module="weather"> <div class="module__content"> <div class="weather"> <h2 class="weather__location"> London Weather <a class="weather__edit" role="link" href="#">Edit</a> </h2> <form class="weather__form" action="/wwhp"> <div class="weather__search"> <input class="weather__input" placeholder="Enter city, town or region" name="location_term" autocomplete="off"> <button class="weather__submit" type="submit" value=""> <span class="icon icon--search"></span> </button> </div> <p class="weather__error"></p> <ul class="weather__results"></ul> </form> <ul class="weather__forecasts">  <li class="forecast--1 forecast"> <a class="forecast__link" href="/weather/2643743?day=0"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/8.gif" alt="Thick Cloud"> <h3 class="forecast__day">Fri</h3>  <p class="forecast__low">10&deg;C</p> </a> </li>  <li class="forecast--2 forecast"> <a class="forecast__link" href="/weather/2643743?day=1"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/8.gif" alt="Thick Cloud"> <h3 class="forecast__day">Sat</h3>  <p class="forecast__high">12&deg;C</p>  <p class="forecast__low">6&deg;C</p> </a> </li>  <li class="forecast--3 forecast"> <a class="forecast__link" href="/weather/2643743?day=2"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/3.gif" alt="Sunny Intervals"> <h3 class="forecast__day">Sun</h3>  <p class="forecast__high">10&deg;C</p>  <p class="forecast__low">7&deg;C</p> </a> </li>  <li class="forecast--4 forecast"> <a class="forecast__link" href="/weather/2643743?day=3"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/14.gif" alt="Heavy Rain Shower"> <h3 class="forecast__day">Mon</h3>  <p class="forecast__high">10&deg;C</p>  <p class="forecast__low">5&deg;C</p> </a> </li>  </ul> </div> </div> </section>     <!-- Error: (null) Module not found or invalid -->
     ...
     <div class="module__content"> <div class="container"> <div class="editors-picks "> <ul class="media-list media-list--fixed-height layout--featured">         
        <li class="media-list__item media-list__item--1">
            <div class="media media--padded media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/65/p03h65cx.jpg" data-alt="Nobody could have predicted what it does to people"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Nobody could have predicted what it does to people" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/future/story/20160201-a-tick-bite-that-makes-you-allergic-to-red-meat"
                                  rev="editors-picks|headline" >
                                                            How this insect can change what you eat                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Nobody could have predicted what it does to people                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/future/story/20160201-a-tick-bite-that-makes-you-allergic-to-red-meat"
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3g/n7/p03gn7k2.jpg" data-alt="Looking for an adventure this year? Look no further."><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Looking for an adventure this year? Look no further." /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20160125-five-bone-chilling-destinations"
                                  rev="editors-picks|headline" >
                                                            Five of the scariest places on Earth                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Looking for an adventure this year? Look no further.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/travel/story/20160125-five-bone-chilling-destinations"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Five of the scariest places on Earth                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/g5/p03hg5b6.jpg" data-alt="Scammers and sales schemes are harder to spot. Here's how"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Scammers and sales schemes are harder to spot. Here's how" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20160204-why-less-is-much-much-more-on-linkedin"
                                  rev="editors-picks|headline" >
                                                            Avoid these types on LinkedIn                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Scammers and sales schemes are harder to spot. Here's how                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/capital/story/20160204-why-less-is-much-much-more-on-linkedin"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Avoid these types on LinkedIn                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/hp/p03hhp9y.jpg" data-alt="They are not exactly useful"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="They are not exactly useful" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/earth/story/20160204-why-do-humans-have-chins"
                                  rev="editors-picks|headline" >
                                                            What's the point of having a chin?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            They are not exactly useful                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/earth/story/20160204-why-do-humans-have-chins"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    What's the point of having a chin?                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/n0/p03hn03g.jpg" data-alt="As fast as an Aston Martin, as capable as a Range Rover, as opulent as a Bentley"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="As fast as an Aston Martin, as capable as a Range Rover, as opulent as a Bentley" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/autos/story/20160205-is-this-the-worlds-greatest-suv"
                                  rev="editors-picks|headline" >
                                                            Is this the world's greatest SUV?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            As fast as an Aston Martin, as capable as a Range Rover, as opulent as a Bentley                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/autos/story/20160205-is-this-the-worlds-greatest-suv"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Is this the world's greatest SUV?                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--6">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/lx/p03hlxww.jpg" data-alt="The Coen brothersâ newest is their first feel-good film"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="The Coen brothersâ newest is their first feel-good film" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/culture/story/20160205-hail-caesar-is-the-coen-brothers-first-feelgood-film"
                                  rev="editors-picks|headline" >
                                                            Hail, Caesar! is âa surprising treatâ                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The Coen brothersâ newest is their first feel-good film                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/culture/story/20160205-hail-caesar-is-the-coen-brothers-first-feelgood-film"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Hail, Caesar! is âa surprising treatâ                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--7">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/A000/production/_88106904_rukundo_promo976abc.jpg" data-alt="Noela Rukundo"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Noela Rukundo" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/magazine-35496480"
                                  rev="editors-picks|headline" >
                                                            Spared by the hitmen with principles                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            One year ago a group of gunmen was hired to kill a woman, but the hit did not go as planned and she...                                                    </p>
     ...
     </ul> </div>   <div class="most-popular"> <div class="top-list"> <h2 class="top-list__heading">Latest Business News</h2> <ul class="top-list__list">  <li class="top-list-item top-list-item__1 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/business-35504435"   rev="most-popular|link" > <span class="top-list-item__bullet">1</span> <h3 class="top-list-item__headline">US economy adds 151,000 jobs in January</h3> </a> </li>  <li class="top-list-item top-list-item__2 top-list-item--ranked top-list-item--even"> <a class="top-list-item__link" href="/news/business-35499916"   rev="most-popular|link" > <span class="top-list-item__bullet">2</span> <h3 class="top-list-item__headline">VW delays publishing its results</h3> </a> </li>  <li class="top-list-item top-list-item__3 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/live/business-35439178"   rev="most-popular|link" > <span class="top-list-item__bullet">3</span> <h3 class="top-list-item__headline">Business live: US markets fall after jobs data</h3> </a> </li>  <li class="top-list-item top-list-item__4 top-list-item--ranked top-list-item--even"> <a class="top-list-item__link" href="/news/business-35500088"   rev="most-popular|link" > <span class="top-list-item__bullet">4</span> <h3 class="top-list-item__headline">'No UK crimes' by flash crash trader</h3> </a> </li>  <li class="top-list-item top-list-item__5 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/business-35499576"   rev="most-popular|link" > <span class="top-list-item__bullet">5</span> <h3 class="top-list-item__headline">Toyota profit up 5% on US demand</h3> </a> </li>  </ul> </div> </div>  <div class="advert advert--native"><!-- BBCDOTCOM slot native --><div id="bbccom_native_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('native', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </section>      <section class="module module--collapse-images module--special-features module--primary-special-features"> <div class="module__content"> <ul class="features">   <li class="feature feature--1"> <h2 class="feature__title"> <a class="feature__link" href="http://www.bbc.com/news/business-11428889"   rev="primary-special-features|header" > Technology of Business </a> </h2> <div class="feature__content">     
        
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/118E6/production/_88101917_88075048.jpg" data-alt="Brooklyn Beckham"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Brooklyn Beckham" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35483480"
                                  rev="primary-special-features|headline" >
                                                            Brand it like Beckham: How social media is changing fashion                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/business-35483480"
            ...
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/A34F/production/_88070814_johnmutauinhisworkshopinmutare.jpg" data-alt="John Mutau"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="John Mutau" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35482142"
                                  rev="primary-special-features|headline" >
                                                            Where coffin-making is a lucrative business                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/business-35482142"
                          rev="primary-special-features|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Where coffin-making is a lucrative business                </a>
            </div>
     ...
     <div class="module__content"> <div class="video video--noslick" id="video" data-wwhp-module="video"> <div class="video__player"> <div id="player" class="video__smp"></div>     
            ...
            <div class="media media--primary media--overlay block-link--no-filter media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/k3/p03hk3fr.jpg" data-alt="Shkreli refuses to answer questions"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Shkreli refuses to answer questions" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35498307"
                                  rev="video|headline" >
                                                            Shkreli refuses to answer questions in Congress                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Martin Shkreli, former head of Turing Pharmaceuticals refuses to answer questions at a congressional hearing focused on the company's drug pricing policy.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/business-35498307"
     ...
     </div> <div class="video__content"> <ul class="video__tabs">  <li class="video__tab"> <a class="video__tab__link" role="link" data-category="recommended" href="#"> Recommended </a> </li>  <li class="video__tab"> <a class="video__tab__link" role="link" data-category="most-watched" href="#"> Most Watched </a> </li>  <li class="video__tab"> <a class="video__tab__link" role="link" data-category="latest" href="#"> Latest </a> </li>  </ul> <div class="video__viewport"> <ul class="video__items">  <li class="video__item video__item video__item--0 video__item--recommended" data-category="recommended" data-index="0" data-category-index="0" data-video="{&quot;id&quot;:&quot;201602042116-shkreli-refuses-to-answer-questions-in-congress&quot;,&quot;type&quot;:&quot;video&quot;,&quot;title&quot;:&quot;Shkreli refuses to answer questions in Congress&quot;,&quot;url&quot;:&quot;http:\/\/www.bbc.com\/news\/business-35498307&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/ibroadcast\/images\/live\/p0\/3h\/k3\/p03hk3fr.jpg&quot;,&quot;imgalttext&quot;:&quot;Shkreli refuses to answer questions&quot;,&quot;pid&quot;:&quot;p03hjn7d&quot;,&quot;duration&quot;:&quot;PT41S&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;summary&quot;:&quot;Martin Shkreli, former head of Turing Pharmaceuticals refuses to answer questions at a congressional hearing focused on the company's drug pricing policy.&quot;,&quot;allowadvertising&quot;:true,&quot;source&quot;:&quot;us-canada-news&quot;,&quot;customsource&quot;:false,&quot;sourcename&quot;:&quot;US &amp;amp; Canada&quot;,&quot;sourceurl&quot;:&quot;http:\/\/www.bbc.com\/news\/world\/us_and_canada&quot;,&quot;sourceid&quot;:&quot;us-canada-news&quot;,&quot;itemtype&quot;:&quot;curated&quot;}">     
            ...
            <div class="media media--video media--horizontal media--primary media--icon block-link">
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35498307"
                                  rev="video|headline" >
                                                            Shkreli refuses to answer questions in...                                                    </a>
                    </h3>
     ...
     </li>  <li class="video__item video__item video__item--1 video__item--recommended" data-category="recommended" data-index="1" data-category-index="1" data-video="{&quot;id&quot;:&quot;201602041811-president-obama-visits-baltimore-mosque&quot;,&quot;type&quot;:&quot;video&quot;,&quot;title&quot;:&quot;President Obama visits Baltimore mosque&quot;,&quot;url&quot;:&quot;http:\/\/www.bbc.com\/news\/world-us-canada-35489062&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/16AF7\/production\/_88091929_88091926.jpg&quot;,&quot;imgalttext&quot;:&quot;President Obama visits Baltimore mosque&quot;,&quot;pid&quot;:&quot;p03hgvfv&quot;,&quot;duration&quot;:&quot;PT2M26S&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;summary&quot;:&quot;In a rebuke to comments by some Republican presidential candidates, President Obama stressed that Muslim Americans were \&quot;part of America too\&quot;&quot;,&quot;allowadvertising&quot;:true,&quot;source&quot;:&quot;us-canada-news&quot;,&quot;customsource&quot;:false,&quot;sourcename&quot;:&quot;US &amp;amp; Canada&quot;,&quot;sourceurl&quot;:&quot;http:\/\/www.bbc.com\/news\/world\/us_and_canada&quot;,&quot;sourceid&quot;:&quot;us-canada-news&quot;,&quot;itemtype&quot;:&quot;curated&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/16AF7/production/_88091929_88091926.jpg" data-alt="President Obama visits Baltimore mosque"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="President Obama visits Baltimore mosque" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/world-us-canada-35489062"
                                  rev="video|headline" >
                                                            President Obama visits Baltimore mosque                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/world-us-canada-35489062"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    President Obama visits Baltimore mosque                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--2 video__item--recommended" data-category="recommended" data-index="2" data-category-index="2" data-video="{&quot;id&quot;:&quot;201602041250-how-quick-was-matt-leblanc-on-top-gear-track&quot;,&quot;type&quot;:&quot;video&quot;,&quot;title&quot;:&quot;How quick was Matt LeBlanc on Top Gear track?&quot;,&quot;url&quot;:&quot;http:\/\/www.bbc.co.uk\/news\/entertainment-arts-35492325&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/ibroadcast\/images\/live\/p0\/3h\/hp\/p03hhpp0.jpg&quot;,&quot;imgalttext&quot;:&quot;Matt LeBlanc&quot;,&quot;pid&quot;:&quot;p03hhpn7&quot;,&quot;duration&quot;:&quot;PT2M3S&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;summary&quot;:&quot;Friends star Matt LeBlanc appeared on Top Gear in 2012 - he was a Star in a Reasonably Priced Car.&quot;,&quot;allowadvertising&quot;:true,&quot;source&quot;:&quot;entertainment&quot;,&quot;customsource&quot;:false,&quot;sourcename&quot;:&quot;Entertainment&quot;,&quot;sourceurl&quot;:&quot;http:\/\/www.bbc.com\/news\/entertainment_and_arts\/&quot;,&quot;sourceid&quot;:&quot;entertainment&quot;,&quot;itemtype&quot;:&quot;curated&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/hp/p03hhpp0.jpg" data-alt="Matt LeBlanc"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Matt LeBlanc" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.co.uk/news/entertainment-arts-35492325"
                                  rev="video|headline" >
                                                            How quick was Matt LeBlanc on Top Gear track?                                                    </a>
                    </h3>

                    
                                            <a class="media__tag tag tag--entertainment" href="http://www.bbc.com/news/entertainment_and_arts/"
                                  rev="video|source" >Entertainment</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="http://www.bbc.co.uk/news/entertainment-arts-35492325"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    How quick was Matt LeBlanc on Top Gear track?                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--3 video__item--recommended" data-category="recommended" data-index="3" data-category-index="3" data-video="{&quot;id&quot;:&quot;201602032013-is-commanders-take-refuge-in-libya&quot;,&quot;type&quot;:&quot;video&quot;,&quot;title&quot;:&quot;IS commanders 'take refuge' in Libya&quot;,&quot;url&quot;:&quot;http:\/\/www.bbc.com\/news\/world-africa-35487145&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/C3BC\/production\/_88080105_misrataboss_ps.jpg&quot;,&quot;imgalttext&quot;:&quot;IS commanders 'take refuge' in Libya&quot;,&quot;pid&quot;:&quot;p03hfj8r&quot;,&quot;duration&quot;:&quot;PT49S&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;summary&quot;:&quot;The head of intelligence in the Libyan city of Misrata says several senior commanders from the so-called Islamic State group have moved to Libya where they are taking refuge.&quot;,&quot;source&quot;:&quot;african-news&quot;,&quot;customsource&quot;:false,&quot;allowadvertising&quot;:false,&quot;sourcename&quot;:&quot;Africa&quot;,&quot;sourceurl&quot;:&quot;http:\/\/www.bbc.com\/news\/world\/africa&quot;,&quot;sourceid&quot;:&quot;african-news&quot;,&quot;itemtype&quot;:&quot;curated&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/C3BC/production/_88080105_misrataboss_ps.jpg" data-alt="IS commanders 'take refuge' in Libya"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="IS commanders 'take refuge' in Libya" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/world-africa-35487145"
                                  rev="video|headline" >
                                                            IS commanders 'take refuge' in Libya                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/world-africa-35487145"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    IS commanders 'take refuge' in Libya                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--4 video__item--recommended" data-category="recommended" data-index="4" data-category-index="4" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;Sea lion pup rescued from restaurant&quot;,&quot;url&quot;:&quot;\/news\/science-environment-35499932&quot;,&quot;summary&quot;:&quot;SeaWorld's Jody Westberg describes rescuing a sea lion pup from a San Diego restaurant&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/1438F\/production\/_88113828_88111865.jpg&quot;,&quot;imgalttext&quot;:&quot;Sea lion pup&quot;,&quot;pid&quot;:&quot;p03hlmrw&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Science &amp;amp; Environment&quot;,&quot;sourceurl&quot;:&quot;\/news\/science_and_environment&quot;,&quot;created&quot;:&quot;2016-02-05T09:11:08+00:00&quot;,&quot;updated&quot;:&quot;2016-02-05T09:11:08+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;sourceid&quot;:&quot;videos&quot;,&quot;itemtype&quot;:&quot;feed&quot;,&quot;allowadvertising&quot;:true,&quot;clippid&quot;:&quot;p03hlmrq&quot;,&quot;duration&quot;:&quot;PT59S&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/1438F/production/_88113828_88111865.jpg" data-alt="Sea lion pup"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Sea lion pup" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/science-environment-35499932"
                                  rev="video|headline" >
                                                            Sea lion pup rescued from restaurant                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/science-environment-35499932"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Sea lion pup rescued from restaurant                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--5 video__item--most-watched" data-category="most-watched" data-index="5" data-category-index="0" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;title&quot;:&quot;Volcano erupts in southern Japan&quot;,&quot;url&quot;:&quot;\/news\/world-asia-35499937&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/7E42\/production\/_88122323_p03hmkvy.jpg&quot;,&quot;pid&quot;:&quot;p03hmkv0&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Asia&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/asia&quot;,&quot;summary&quot;:&quot;A volcano in southern Japan erupted on Friday&quot;,&quot;imgalttext&quot;:&quot;Erupting volcano&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;allowadvertising&quot;:true,&quot;clippid&quot;:&quot;p03hmktt&quot;,&quot;duration&quot;:&quot;PT41S&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/7E42/production/_88122323_p03hmkvy.jpg" data-alt="Erupting volcano"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Erupting volcano" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-asia-35499937"
                                  rev="video|headline" >
                                                            Volcano erupts in southern Japan                                                    </a>
                    </h3>
     ...
     </li>  <li class="video__item video__item video__item--6 video__item--most-watched" data-category="most-watched" data-index="6" data-category-index="1" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;title&quot;:&quot;Sweden vs Russia - A new Cold War front?&quot;,&quot;url&quot;:&quot;\/news\/world-europe-35489753&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/608F\/production\/_88091742_88091740.jpg&quot;,&quot;allowadvertising&quot;:true,&quot;pid&quot;:&quot;p03hgrnz&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;duration&quot;:&quot;PT3M6S&quot;,&quot;sourcename&quot;:&quot;Europe&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/europe&quot;,&quot;summary&quot;:&quot;Paul Adams reports from the island of Gotland on why Sweden is concerned about Russian provocation.&quot;,&quot;imgalttext&quot;:&quot;Map showing Sweden and Russia&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/608F/production/_88091742_88091740.jpg" data-alt="Map showing Sweden and Russia"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Map showing Sweden and Russia" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35489753"
                                  rev="video|headline" >
                                                            Sweden vs Russia - A new Cold War front?                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35489753"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Sweden vs Russia - A new Cold War front?                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--7 video__item--most-watched" data-category="most-watched" data-index="7" data-category-index="2" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;title&quot;:&quot;Refugees stranded in Greek terminal&quot;,&quot;url&quot;:&quot;\/news\/world-europe-35505552&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/16FB4\/production\/_88123149_p03hmrdt.jpg&quot;,&quot;pid&quot;:&quot;p03hmrck&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Europe&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/europe&quot;,&quot;summary&quot;:&quot;Refugees are facing a third night stranded in a passenger terminal in Greece due to a blockade of the streets.&quot;,&quot;imgalttext&quot;:&quot;Refugees in Piraeus&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;allowadvertising&quot;:true,&quot;clippid&quot;:&quot;p03hmrcd&quot;,&quot;duration&quot;:&quot;PT59S&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/16FB4/production/_88123149_p03hmrdt.jpg" data-alt="Refugees in Piraeus"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Refugees in Piraeus" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35505552"
                                  rev="video|headline" >
                                                            Refugees stranded in Greek terminal                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35505552"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Refugees stranded in Greek terminal                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--8 video__item--most-watched" data-category="most-watched" data-index="8" data-category-index="3" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;title&quot;:&quot;British woman guilty of joining IS&quot;,&quot;url&quot;:&quot;\/news\/uk-35444919&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/E812\/production\/_88001495_tareenashakil.jpg&quot;,&quot;allowadvertising&quot;:true,&quot;pid&quot;:&quot;p03gz9k9&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;duration&quot;:&quot;PT2M37S&quot;,&quot;sourcename&quot;:&quot;UK&quot;,&quot;sourceurl&quot;:&quot;\/news\/uk&quot;,&quot;summary&quot;:&quot;A mother has been found guilty of taking her toddler son to Syria to join so-called Islamic State.&quot;,&quot;imgalttext&quot;:&quot;Tareena Shakil&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/E812/production/_88001495_tareenashakil.jpg" data-alt="Tareena Shakil"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Tareena Shakil" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/uk-35444919"
                                  rev="video|headline" >
                                                            British woman guilty of joining IS                                                    </a>
                    </h3>
     ...
     </li>  <li class="video__item video__item video__item--9 video__item--latest" data-category="latest" data-index="9" data-category-index="0" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;Why do Delhi\u2019s homeless prefer streets to shelters?&quot;,&quot;url&quot;:&quot;\/news\/world-asia-india-35484388&quot;,&quot;summary&quot;:&quot;Tens of thousands of people are homeless in Delhi, and many risk death in the cold weather by choosing the streets over shelters.&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/AAE3\/production\/_88074734_495d41bb-db83-41ec-8906-950f27c88f49.jpg&quot;,&quot;imgalttext&quot;:&quot;Delhi's homeless spending a cold night on the streets&quot;,&quot;pid&quot;:&quot;p03hjbpm&quot;,&quot;duration&quot;:&quot;PT1M37S&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;India&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/asia\/india&quot;,&quot;created&quot;:&quot;2016-02-05T00:00:47+00:00&quot;,&quot;updated&quot;:&quot;2016-02-05T00:00:47+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;allowadvertising&quot;:true}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/AAE3/production/_88074734_495d41bb-db83-41ec-8906-950f27c88f49.jpg" data-alt="Delhi's homeless spending a cold night on the streets"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Delhi's homeless spending a cold night on the streets" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-asia-india-35484388"
                                  rev="video|headline" >
                                                            Why do Delhiâs homeless prefer streets to...                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-asia-india-35484388"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Why do Delhiâs homeless prefer streets to shelters?                </a>
            </div>

        
     </li>  <li class="video__item video__item video__item--10 video__item--latest" data-category="latest" data-index="10" data-category-index="1" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;The best supermodels in the world?&quot;,&quot;url&quot;:&quot;\/news\/entertainment-arts-35500433&quot;,&quot;summary&quot;:&quot;Ben Stiller and Owen Wilson return in Zoolander 2&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/CD1F\/production\/_88111525_p03hll58.jpg&quot;,&quot;imgalttext&quot;:&quot;Ben Stiller and Owen Wilson&quot;,&quot;pid&quot;:&quot;p03hll4x&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Entertainment &amp;amp; Arts&quot;,&quot;sourceurl&quot;:&quot;\/news\/entertainment_and_arts&quot;,&quot;created&quot;:&quot;2016-02-05T09:15:05+00:00&quot;,&quot;updated&quot;:&quot;2016-02-05T09:15:05+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;allowadvertising&quot;:true,&quot;clippid&quot;:&quot;p03hll4v&quot;,&quot;duration&quot;:&quot;PT3M8S&quot;}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/CD1F/production/_88111525_p03hll58.jpg" data-alt="Ben Stiller and Owen Wilson"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Ben Stiller and Owen Wilson" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/entertainment-arts-35500433"
                                  rev="video|headline" >
                                                            The best supermodels in the world?                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/entertainment-arts-35500433"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    The best supermodels in the world?                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--11 video__item--latest" data-category="latest" data-index="11" data-category-index="2" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;Rare Ferrari to go under the hammer&quot;,&quot;url&quot;:&quot;\/news\/world-europe-35498979&quot;,&quot;summary&quot;:&quot;A 1957 Ferrari 335 Sport Scaglietti is expected to fetch up to 32m euros ($34m) at auction in Paris.&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/CF62\/production\/_88109035_88109033.jpg&quot;,&quot;imgalttext&quot;:&quot;A rare Ferrari 335 Sport Scaglietti is expected to fetch millions of euros at auction&quot;,&quot;pid&quot;:&quot;p03hkj44&quot;,&quot;duration&quot;:&quot;PT1M1S&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Europe&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/europe&quot;,&quot;created&quot;:&quot;2016-02-05T01:22:10+00:00&quot;,&quot;updated&quot;:&quot;2016-02-05T01:22:10+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;allowadvertising&quot;:true}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/CF62/production/_88109035_88109033.jpg" data-alt="A rare Ferrari 335 Sport Scaglietti is expected to fetch millions of euros at auction"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="A rare Ferrari 335 Sport Scaglietti is expected to fetch millions of euros at auction" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35498979"
                                  rev="video|headline" >
                                                            Rare Ferrari to go under the hammer                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35498979"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Rare Ferrari to go under the hammer                </a>
            </div>
      ...
      <div class="channel__ad"> <div class="advert advert--module_channel-international advert--sponsor"><!-- BBCDOTCOM slot module_channel-international --><div id="bbccom_module_channel-international_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('module_channel-international', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </div>   <div class="channel channel--bbc-world-news channel--2"> <h2 class="channel__title"> <a class="channel__title__link" href="http://www.bbc.com/news/world_radio_and_tv/"   rev="bbc-world-news|header" > <span class="channel__title__icon icon icon--tv"></span> BBC World News </a> </h2> <div class="channel__content">     
            ...
            <div class="media channel__media block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/BF35/production/_88094984_king_abdullah_economic_city.jpg" data-alt="King Abdullah Economic City"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="King Abdullah Economic City" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-middle-east-35491061"
                                  rev="bbc-world-news|headline" >
                                                            HARDtalk: Saudi's $100bn construction project                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Will one of the world's largest construction projects taking place in Saudi Arabia be a success?                                                    </p>
                    
                    
                </div>

                <a class="block-link__overlay-link"
                   href="/news/world-middle-east-35491061"
     ...
     <div class="module__content"> <div class="container"> <div class="more-bbc "> <ul class="media-list media-list--fixed-height layout--featured">         
        <li class="media-list__item media-list__item--1">
            <div class="media media--padded media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/860C/production/_87961343_de27-1.jpg" data-alt="Demis Hassabis"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Demis Hassabis" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/35501537"
                                  rev="more-bbc|headline" >
                                                            Google AI will play live Go match                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Google has announced the next challenge for its AI software - to play a live-streamed Go match...                                                    </p>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/ht/p03hhtp5.jpg" data-alt="Experience a world where water is both an enemy â and a cherished friend"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Experience a world where water is both an enemy â and a cherished friend" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20160126-the-dutch-war-against-water"
                                  rev="more-bbc|headline" >
                                                            One countryâs endless war against water                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Experience a world where water is both an enemy â and a cherished friend                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/travel/story/20160126-the-dutch-war-against-water"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    One countryâs endless war against water                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/20FA/production/_88124480_malikpa.jpg" data-alt="Zayn Malik"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Zayn Malik" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/entertainment-arts-35505276"
                                  rev="more-bbc|headline" >
                                                            Zayn Malik debuts at number one                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Zayn Malik's debut single, Pillowtalk, has gone straight to the top of the UK singles charts.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/entertainment-arts-35505276"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Zayn Malik debuts at number one                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/01B8/production/_88104400_b6010524-oak_tree_at_sunrise-spl.jpg" data-alt="trees"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="trees" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/science-environment-35496350"
                                  rev="more-bbc|headline" >
                                                            'Wrong type of trees' boost warming                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Scientists say replacing broadleaved species with conifers over the past two centuries has increased...                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/science-environment-35496350"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    'Wrong type of trees' boost warming                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/AC7C/production/_88065144_gettyimages-506972062-1.jpg" data-alt="Aedes aegypti mosquitoes inside a lab"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Aedes aegypti mosquitoes inside a lab" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35490524"
                                  rev="more-bbc|headline" >
                                                            First Zika pregnancy case in Europe                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Spain confirms that a pregnant woman has been diagnosed with the Zika virus - the first such case in...                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35490524"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    First Zika pregnancy case in Europe                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--6">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3g/05/p03g058k.jpg" data-alt="Casual gone awry: why some companies think itâs time to bring back dress codes"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Casual gone awry: why some companies think itâs time to bring back dress codes" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20160120-have-we-taken-casual-workwear-too-far"
                                  rev="more-bbc|headline" >
                                                            You wore that to work?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Casual gone awry: why some companies think itâs time to bring back dress codes                                                    </p>
        ...
        <li class="media-list__item media-list__item--7">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/jp/p03hjpt5.jpg" data-alt="A new Dadâs Army film re-examines whether comedy about conflict is in good taste"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="A new Dadâs Army film re-examines whether comedy about conflict is in good taste" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/culture/story/20160204-is-it-wrong-to-find-humour-in-war"
                                  rev="more-bbc|headline" >
                                                            Is it wrong to find humour in war?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            A new Dadâs Army film re-examines whether comedy about conflict is in good taste                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/culture/story/20160204-is-it-wrong-to-find-humour-in-war"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Is it wrong to find humour in war?                </a>
            </div>
     ...
     </ul> </div>   <div class="correspondent-headlines"> <div class="top-list"> <h2 class="top-list__heading"><span class="top-list__heading__intro">From Our </span>Correspondents</h2> <ul class="top-list__list">  <li class="top-list-item top-list-item__1 top-list-item--avatar top-list-item--odd"> <a class="top-list-item__link" href="http://www.bbc.com/news/election-us-2016-35487343"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2x/05/p02x05s9.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> Is it time to 'Ebb with Jeb'?  <span class="top-list-item__byline">By Jon Sopel</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__2 top-list-item--avatar top-list-item--even"> <a class="top-list-item__link" href="http://www.bbc.com/news/uk-politics-eu-referendum-35482638"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2x/8g/p02x8gbf.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> Is the reform deal a dose of reality for the EU?  <span class="top-list-item__byline">By Mark Mardell</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__3 top-list-item--avatar top-list-item--odd"> <a class="top-list-item__link" href="http://www.bbc.co.uk/news/world-us-canada-35438548"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/33/sr/p033sr67.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> American exceptionalism in a time of malaise  <span class="top-list-item__byline">By Nick Bryant</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__4 top-list-item--avatar top-list-item--even"> <a class="top-list-item__link" href="http://www.bbc.com/news/world-asia-india-35457661"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2z/7p/p02z7pxl.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> Why Asia should worry about Zika too  <span class="top-list-item__byline">By Justin Rowlatt</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__5 top-list-item--avatar top-list-item--odd"> <a class="top-list-item__link" href="http://www.bbc.co.uk/news/election-us-2016-35462570"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2z/b2/p02zb2rl.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> US election: Winners and losers after Iowa vote  <span class="top-list-item__byline">By Anthony Zurcher</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__6 top-list-item--avatar top-list-item--even"> <a class="top-list-item__link" href="http://www.bbc.com/news/election-us-2016-35456648"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2x/06/p02x061g.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> Confessions of a four-time caucus correspondent  <span class="top-list-item__byline">By Katty Kay</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__7 top-list-item--avatar top-list-item--odd"> <a class="top-list-item__link" href="http://www.bbc.com/news/election-us-2016-35425100"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2z/b2/p02zb2rl.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> The 11 cards that sum up the Republican race  <span class="top-list-item__byline">By Anthony Zurcher</span>  </h3> </a> </li>  <li class="top-list-item top-list-item__8 top-list-item--avatar top-list-item--even"> <a class="top-list-item__link" href="http://www.bbc.com/news/uk-politics-35418070"   rev="correspondents|link" >  <div class="top-list-item__bullet"> <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/2x/8g/p02x8gbf.jpg" data-alt=""><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="" /></div></div> </div>  <h3 class="top-list-item__headline"> Fear and loathing will power drama of EU debate  <span class="top-list-item__byline">By Mark Mardell</span>  </h3> </a> </li>  </ul> </div> </div>  </div> </div> </section>      <section class="module module--collapse-images module--special-features module--secondary-special-features"> <div class="module__content"> <ul class="features">   <li class="feature feature--1"> <h2 class="feature__title"> <a class="feature__link" href="http://www.bbc.com/capital/columns/business-traveller"   rev="secondary-special-features|header" > Business Traveller </a> </h2> <div class="feature__content">     
        
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3h/6z/p03h6zzm.jpg" data-alt="(Credit: Great Divide)"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="(Credit: Great Divide)" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20160201-have-a-beer-smile-and-dont-be-afraid-to-chat"
                                  rev="secondary-special-features|headline" >
                                                            'Beer is big business' in this laid-back metropolis                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/capital/story/20160201-have-a-beer-smile-and-dont-be-afraid-to-chat"
            ...
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/EC47/production/_87978406_globe.jpg" data-alt="globe"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="globe" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35429233"
                                  rev="secondary-special-features|headline" >
                                                            The students going to China to study in English                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/business-35429233"
                          rev="secondary-special-features|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    The students going to China to study in English                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--1">
            <div class="media media--padded media--primary media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/90B9/production/_88094073_976-5693_munro.jpg" data-alt="You Lookin' at Me? - Nicola Munro / www.igpoty.com"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/90B9/production/_88094073_976-5693_munro.jpg" alt="You Lookin' at Me? - Nicola Munro / www.igpoty.com" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/magazine-35476291"
                                  rev="world-in-pictures1|headline" >
                                                            Winning photos from beautiful gardens                                                    </a>
                    </h3>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/C68B/production/_88072805_ds9b0100creditpaulwilliams_bbc.jpg" data-alt="A chipmunk collecting acorns during the fall"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/C68B/production/_88072805_ds9b0100creditpaulwilliams_bbc.jpg" alt="A chipmunk collecting acorns during the fall" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/in-pictures-35471724"
                                  rev="world-in-pictures2|headline" >
                                                            In pictures: The forests of New England                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/in-pictures-35471724"
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/22D1/production/_88031980_1eyesasbigasplates.jpg" data-alt="Agnes from series Eyes as Big as Plates: Karoline Hjorth &amp; Riitta Ikonen"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/22D1/production/_88031980_1eyesasbigasplates.jpg" alt="Agnes from series Eyes as Big as Plates: Karoline Hjorth &amp; Riitta Ikonen" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/in-pictures-35459172"
                                  rev="world-in-pictures3|headline" >
                                                            Ageing - the bigger picture                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/in-pictures-35459172"
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/F8D9/production/_88050736_promohigh-res-ddecj6.jpg" data-alt="Depiction of the Great Fire of London, 1666"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/F8D9/production/_88050736_promohigh-res-ddecj6.jpg" alt="Depiction of the Great Fire of London, 1666" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/magazine-35418272"
                                  rev="world-in-pictures4|headline" >
                                                            The grid system for London that never happened                                                    </a>
                    </h3>
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/11D05/production/_88056927_vnvphotosnocaptions10.jpg" data-alt="Malack"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/11D05/production/_88056927_vnvphotosnocaptions10.jpg" alt="Malack" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/in-pictures-35460945"
                ...
                <a class="block-link__overlay-link"
                   href="/news/in-pictures-35460945"
