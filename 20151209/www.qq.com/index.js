...
window._AdSameObj_CY2422607 = {};
var cyis1 = true;
var cyis2 = false;

window._AdSameObj_CY2422607.setis = function(val){
	cyis1=val;
	cyis2=!val;};
window._AdSameObj_CY2422607.setis(_as_dts("_as_crazy2422607",2));

window._AdSameObj_CY2422607.status=0;

window._AdSameObj_CY2422607.fc = function(cmd, args) {
	switch (cmd)
	{
	case "replay":
		if (mutex_lock()==0) {
		window._AdSameObj_CY2422607.b1.show();


		window._AdSameObj_CY2422607.b2.hide();


		window._AdSameObj_CY2422607.status=1;
		}
		break;
	...
	case "closeBig":
		...
		window._AdSameObj_CY2422607.b1.hide();
	...
	case "close":
			...
			window._AdSameObj_CY2422607.b1.destroy();
			window._AdSameObj_CY2422607.b2.destroy();
...
window._AdSameObj_CY2422607.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://ra.gtimg.com/adsame/2422607/1000300.swf",
	target: "_blank",
	clsbtn: 0,
	clickUrl: "http://c.l.qq.com/lclick?seq=20151209000258&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY2422607.f1",
	fscmdfc: window._AdSameObj_CY2422607.fc,
    paras:{
    	this_obj:window._AdSameObj_CY2422607.fc
   	}
});
window._AdSameObj_CY2422607.b1 = new _as_divfl({
	width: 1000,
	height: 300,
	hAlign: "center",
	vAlign: "bottom",
	...
	followScroll: 1,
	firstScreen: 0,
	flash: window._AdSameObj_CY2422607.f1,
	selfName: "window._AdSameObj_CY2422607.b1",
	iniShow: cyis1
});
window._AdSameObj_CY2422607.b1.onAfterHide = function() {


		window._AdSameObj_CY2422607.b2.show();
	mutex_unlock();
}

window._AdSameObj_CY2422607.f2 = new _as_fl({
	width: 20,
	height: 100,
	srcUrl: "http://ra.gtimg.com/adsame/2422607/20100.swf",
	target: "_blank",
	repfc: "window._AdSameObj_CY2422607.fc(\"replay\")",
	clsfc: "window._AdSameObj_CY2422607.fc(\"close\")",
	clickUrl: "http://c.l.qq.com/lclick?seq=20151209000258&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY2422607.f2",
	fscmdfc: window._AdSameObj_CY2422607.fc,
    paras:{
    	this_obj:window._AdSameObj_CY2422607.fc
   	}
});
window._AdSameObj_CY2422607.b2 = new _as_divfl({
	width: 20,
	height: 100,
	...
	firstScreen: 0,
	alwaysShow: 0,
	flash: window._AdSameObj_CY2422607.f2,
	selfName: "window._AdSameObj_CY2422607.b2",
	iniShow: (cyis2 || 0)
});


window._AdSameObj_CY2422607.run = function() {
	if(window._AdSameObj_CY2422607.inited)return;
	window._AdSameObj_CY2422607.inited=true;
	var s = function() {

	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://imp.gentags.net/nimp/iv-1665/st-22/oi-401950/cr-2/adv-403/or-4569/pcon-0/imei=__IMEI__&mac=__MAC__&android=__ANDROIDID__&idfa=__IDFA__&opid=__OPENUDID__&os=__OS__/http://jdisp.jd.com/d/75647\' />";
        if (_as_bro.isIe6()) {
	...
	window._AdSameObj_CY2422607.b1.create(window._AdSameObj_CY2422607.f1.getcode()+trackcode+ifmcode);
	window._AdSameObj_CY2422607.b1.show();
	window._AdSameObj_CY2422607.b2.create(window._AdSameObj_CY2422607.f2.getcode()+ifmcode);
	window._AdSameObj_CY2422607.b2.show();



	window._AdSameObj_CY2422607.status=cyis1;
...
window._AdSameObj_CY2422607.run();
