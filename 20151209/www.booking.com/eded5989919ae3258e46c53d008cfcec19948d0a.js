...
if(f){n.getLists().then(function(){n.setCurrentList({id:f});
n.show()
})
...
}booking[sNSStartup].aff_new_header_menu={priority:9,opening_state:0,cur_open:"",max_select_height:240,is_ie:0,openSlow:false,init:function(){var c=this;
...
$("body").click(function(e){if(c.opening_state==2){var d=$(e.target);
if($(d).length){c.closeSelect()
}}});
$(".aff_select_box").click(function(d){if(c.opening_state==0){c.openSelect($(this).attr("data-target"),$(this).attr("data-parentclass"))
}else{if(c.cur_open!=$(this).attr("data-target")){c.closeSelect($(this).attr("data-target"),$(this).attr("data-parentclass"))
}else{c.closeSelect()
}}})
...
$margin_adjust=f-g,$arrow_margin_adjust=f-8,$pLeft=$(l).css("left");
...
if(d.hasClass("aff_languages_popover")){t=$(".aff_current_language_foldout .aff_select_foldout_wrap");
n=$(".language_flags").length;
if(n==3){t.css({width:"600px"});
d.css({width:"600px",right:"0"})
}else{if(n==2){t.css({width:"400px"});
d.css({width:"400px",right:"0"})
}else{t.css({width:"200px"});
d.css({width:"200px",right:"0"})
...
h.unshift({b_classname:d[117],b_color:d[118],b_size:d[119],b_tooltip:d[120]});
U=l(U);
h.shift();
...
h.unshift({b_classname:d[149],b_ge_discount:d[36],b_ge_freebies:d[36],b_tooltip:d[120]});
U=H(U);
h.shift();
...
if((j.MJ(d[67]+""==="discount"))){r+=[d[44],j.MC(c[5]),d[45]].join("")
}else{r+=[d[47],d[67],d[48]].join("")
}r+=d[49];
return r
}function t(r){r+=d[43];
if((j.MJ(d[71]+""==="discount"))){r+=[d[44],j.MC(c[5]),d[45]].join("")
}else{r+=[d[47],d[71],d[48]].join("")
}r+=d[49];
return r
}function m(r){r+=d[43];
...
if((j.MJ(j.track_experiment("ge_high_demand_freebies_wifi_parking")==2))){r+=d[64];
if(j.MJ(j.MG((j.MC(c[33])||{})["b_genius_perks_widget_parking"]))){r+=d[65];
if(j.MD(c[31])){r+=d[54]
}r+=d[66];
o.unshift({b_freebie:d[67]});
r=w(r);
o.shift();
r+=[d[68],j.ME(d[69],j.MB,j.MN,null),d[70]].join("")
}r+=d[64];
if(j.MJ(j.MG((j.MC(c[33])||{})["b_genius_perks_widget_wifi"]))){r+=d[65];
if(j.MD(c[31])){r+=d[54]
}r+=d[66];
o.unshift({b_freebie:d[71]});
r=t(r);
o.shift();
r+=[d[68],j.ME(d[72],j.MB,j.MN,null),d[70]].join("")
}r+=d[59]
}return r
}function l(r){r+=d[1];
o.unshift({b_genius_iconfont:d[115],b_type:d[116]});
r=q(r);
o.shift();
r+=d[59];
return r
...
D+=j.F.html(E);
D+=d[10]
}D+=[d[74],j.MC(c[15])].join("");
if(j.MD(c[24])){D+=d[75]
}else{if(j.MD(c[24])){D+=d[76]
}}D+=d[77];
...
if(((j.MJ(j.MC(c[26])+""==="mg_family"))||(j.MJ(j.MC(c[41])+""==="emk")))){D+=d[88];
j.MN(c[40],undefined);
D+=d[3]
}else{D+=d[88];
j.MN(c[40],d[89]);
...
j.MN(c[42],[d[90],j.MC(c[40]),d[91]].join(""));
D+=d[6]
}else{if(j.MD(c[38])){D+=d[33];
j.MN(c[42],[d[92],j.MC(c[40]),d[91]].join(""));
D+=d[6]
}else{if(j.MD(c[39])){D+=d[33];
j.MN(c[42],[d[93],j.MC(c[40]),d[91]].join(""));
D+=d[6]
}else{D+=d[33];
j.MN(c[42],[d[94],j.MC(c[0]),j.MC(c[40]),d[91]].join(""));
D+=d[6]
}}}D+=[d[95],j.STATIC_HOSTNAME(j.MC(c[42]),0,0,0),d[96],j.MC(c[0]),d[97],j.MC(c[17]),d[98]].join("");
if(j.MD(c[47])){D+=[d[99],j.MC(c[0]),d[100],(j.MC(c[43])||"auto"),d[101],(j.MC(c[44])||"inline-block"),d[102],(j.MC(c[45])||"baseline"),d[103],j.MC(c[46]),d[98]].join("")
}D+=d[104]
}else{if((j.MJ(C+""==="freebie_icon"))){D+=d[6];
j.MN(c[42],[d[105],j.MC(c[19]),j.MC(c[40]),d[91]].join(""));
D+=[d[95],j.STATIC_HOSTNAME(j.MC(c[42]),0,0,0),d[96],j.MC(c[0]),d[97],j.MC(c[17]),d[98]].join("");
if(j.MD(c[47])){D+=[d[99],j.MC(c[0]),d[100],(j.MC(c[43])||"auto"),d[101],(j.MC(c[44])||"inline-block"),d[102],(j.MC(c[45])||"baseline"),d[103],j.MC(c[46]),d[98]].join("")
}D+=d[104]
}else{D+=d[6];
j.MN(c[42],[d[106],j.MC(c[16]),d[107],j.MC(c[0]),j.MC(c[40]),d[91]].join(""));
D+=[d[95],j.STATIC_HOSTNAME(j.MC(c[42]),0,0,0),d[96],j.MC(c[0]),d[108],j.MC(c[17]),d[98]].join("");
if(j.MD(c[47])){D+=[d[99],j.MC(c[0]),d[100],(j.MC(c[43])||"auto"),d[101],(j.MC(c[44])||"inline-block"),d[102],(j.MC(c[45])||"baseline"),d[103],j.MC(c[46]),d[98]].join("")
}D+=d[109]
}}D+=d[87]
}else{if(j.MD(c[50])){D+=d[3];
var r="";
r+=[d[110],j.MC(c[49]),d[107],j.MC(c[16]),d[107],j.MC(c[0]),d[15],j.MC(c[17]),d[15]].join("");
if(j.MD(c[11])){r+=j.MC(c[10])
}r+=d[15];
j.MN(c[15],r);
D+=[d[111],j.MC(c[15]),d[17],j.MC(c[8]),d[112]].join("")
}else{D+=d[113]
}}}D+=d[114];
j.MN("b_type","");
D+=d[1];
...
o.unshift({b_classname:d[117],b_color:d[118],b_size:d[119],b_tooltip:d[120]});
A=l(A);
o.shift();
A+=[d[121],j.MB(c[51]),d[122]].join("");
j.MN("num_stays_needed",(j.MI(5)-j.MI(j.MC(c[52])["renewal_info"]["stays_count_since_genius"])));
A+=[d[123],j.VP(d[124],"num_stays_needed"),d[125],j.MG(((j.MC(c[52])||{})["renewal_info"]||{})["stays_count_since_genius"]),d[126],j.MB(c[53]),d[127],(o.unshift({renewal_date:j.MG(((j.MC(c[52])||{})["renewal_info"]||{})["genius_renewal_date"])}),(e=j.VP(d[128],"num_stays_needed")),o.shift(),e),d[129],j.MB(c[54]),d[130]].join("");
return A
}
})());
"use strict";
...
}}}$(".sr_no_desc_users").each(function(){var h=$(this).attr("data-number-of-users");
$(this).parents(".sr_item").find("a").on("click",function(){booking.google.trackEvent(booking.google.clickTracker,"SR Urgency","sr_no_desc_users: "+h)
})
});
booking.google.trackEvent(booking.google.clickTracker,"SR Urgency","Overall users urgency: "+$(".sr_no_desc_users").length);
booking.google.trackEvent(booking.google.clickTracker,"SR Urgency","Overall history urgency: "+$(".lastbooking").length);
...
if(booking.env.b_ge_is_aspiring_genius){booking.et.customGoal("cQHFOPSTcbXRAdSeae",1)
