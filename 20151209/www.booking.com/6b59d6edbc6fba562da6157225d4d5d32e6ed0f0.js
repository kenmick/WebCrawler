...
}C.b_marker_type=(x.data)?x.data.b_marker_type:"";
C.b_map_nights=q.get("checkinCheckoutInterval");
C.map_price_per_x_nights_txt=q.get("transPricePerXNights");
if(B.atlas.getVariant("ebcMKTIGSOJFDZSIWe")){z.trigger("cheap-price");
var A=B.atlas.require("cheapest-price");
...
C.trigger("iw-control-show",{markerId:z,data:x.data});
if(B.atlas.getVariant("ebcMKTIGSOJFDZSIWe")){C.trigger("cheap-price");
var H=B.atlas.require("cheapest-price");
