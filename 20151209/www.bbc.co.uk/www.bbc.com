...
<![endif]-->
  ...
  <script type="text/javascript">/*<![CDATA[*/ (function(undefined){if(!window.bbc){window.bbc={}}var ROLLING_PERIOD_DAYS=30;window.bbc.Mandolin=function(id,segments,opts){var now=new Date().getTime(),storedItem,DEFAULT_START=now,DEFAULT_RATE=1,COOKIE_NAME="ckpf_mandolin";opts=opts||{};this._id=id;this._segmentSet=segments;this._store=new window.window.bbc.Mandolin.Storage(COOKIE_NAME);this._opts=opts;this._rate=(opts.rate!==undefined)?+opts.rate:DEFAULT_RATE;this._startTs=(opts.start!==undefined)?new Date(opts.start).getTime():new Date(DEFAULT_START).getTime();this._endTs=(opts.end!==undefined)?new Date(opts.end).getTime():daysFromNow(ROLLING_PERIOD_DAYS);this._signupEndTs=(opts.signupEnd!==undefined)?new Date(opts.signupEnd).getTime():this._endTs;this._segment=null;if(typeof id!=="string"){throw new Error("Invalid Argument: id must be defined and be a string")}if(Object.prototype.toString.call(segments)!=="[object Array]"){throw new Error("Invalid Argument: Segments are required.")}if(opts.rate!==undefined&&(opts.rate<0||opts.rate>1)){throw new Error("Invalid Argument: Rate must be between 0 and 1.")}if(this._startTs>this._endTs){throw new Error("Invalid Argument: end date must occur after start date.")}if(!(this._startTs<this._signupEndTs&&this._signupEndTs<=this._endTs)){throw new Error("Invalid Argument: SignupEnd must be between start and end date")}removeExpired.call(this,now);var overrides=window.bbccookies.get().match(/ckns_mandolin_setSegments=([^;]+)/);if(overrides!==null){eval("overrides = "+decodeURIComponent(RegExp.$1)+";");if(overrides[this._id]&&this._segmentSet.indexOf(overrides[this._id])==-1){throw new Error("Invalid Override: overridden segment should exist in segments array")}}if(overrides!==null&&overrides[this._id]){this._segment=overrides[this._id]}else{if((storedItem=this._store.getItem(this._id))){this._segment=storedItem.segment}else{if(this._startTs<=now&&now<this._signupEndTs&&now<=this._endTs&&this._store.isEnabled()===true){this._segment=pick(segments,this._rate);if(opts.end===undefined){this._store.setItem(this._id,{segment:this._segment})}else{this._store.setItem(this._id,{segment:this._segment,end:this._endTs})}log.call(this,"mandolin_segment")}}}log.call(this,"mandolin_view")};window.bbc.Mandolin.prototype.getSegment=function(){return this._segment};function log(actionType,params){var that=this;require(["istats-1"],function(istats){istats.log(actionType,that._id+":"+that._segment,params?params:{})})}function removeExpired(expires){var items=this._store.getItems(),expiresInt=+expires;for(var key in items){if(items[key].end!==undefined&&+items[key].end<expiresInt){this._store.removeItem(key)}}}function getLastExpirationDate(data){var winner=0,rollingExpire=daysFromNow(ROLLING_PERIOD_DAYS);for(var key in data){if(data[key].end===undefined&&rollingExpire>winner){winner=rollingExpire}else{if(+data[key].end>winner){winner=+data[key].end}}}return(winner)?new Date(winner):new Date(rollingExpire)}window.bbc.Mandolin.prototype.log=function(params){log.call(this,"mandolin_log",params)};window.bbc.Mandolin.prototype.convert=function(params){log.call(this,"mandolin_convert",params);this.convert=function(){}};function daysFromNow(n){var endDate;endDate=new Date().getTime()+(n*60*60*24)*1000;return endDate}function pick(segments,rate){var picked,min=0,max=segments.length-1;if(typeof rate==="number"&&Math.random()>rate){return null}do{picked=Math.floor(Math.random()*(max-min+1))+min}while(picked>max);return segments[picked]}window.bbc.Mandolin.Storage=function(name){validateCookieName(name);this._cookieName=name;this._isEnabled=(bbccookies.isAllowed(this._cookieName)===true&&bbccookies.cookiesEnabled()===true)};window.bbc.Mandolin.Storage.prototype.setItem=function(key,value){var storeData=this.getItems();storeData[key]=value;this.save(storeData);return value};window.bbc.Mandolin.Storage.prototype.isEnabled=function(){return this._isEnabled};window.bbc.Mandolin.Storage.prototype.getItem=function(key){var storeData=this.getItems();return storeData[key]};window.bbc.Mandolin.Storage.prototype.removeItem=function(key){var storeData=this.getItems();delete storeData[key];this.save(storeData)};window.bbc.Mandolin.Storage.prototype.getItems=function(){return deserialise(this.readCookie(this._cookieName)||"")};window.bbc.Mandolin.Storage.prototype.save=function(data){window.bbccookies.set(this._cookieName+"="+encodeURIComponent(serialise(data))+"; expires="+getLastExpirationDate(data).toUTCString()+";")};window.bbc.Mandolin.Storage.prototype.readCookie=function(name){var nameEq=name+"=",ca=window.bbccookies.get().split("; "),i,c;validateCookieName(name);for(i=0;i<ca.length;i++){c=ca[i];if(c.indexOf(nameEq)===0){return decodeURIComponent(c.substring(nameEq.length,c.length))}}return null};function serialise(o){var str="";for(var p in o){if(o.hasOwnProperty(p)){str+='"'+p+'"'+":"+(typeof o[p]==="object"?(o[p]===null?"null":"{"+serialise(o[p])+"}"):'"'+o[p].toString()+'"')+","}}return str.replace(/,\}/g,"}").replace(/,$/g,"")}function deserialise(str){var o;str="{"+str+"}";if(!validateSerialisation(str)){throw"Invalid input provided for deserialisation."}eval("o = "+str);return o}var validateSerialisation=(function(){var OBJECT_TOKEN="<Object>",ESCAPED_CHAR='"\\n\\r\\u2028\\u2029\\u000A\\u000D\\u005C',ALLOWED_CHAR="([^"+ESCAPED_CHAR+"]|\\\\["+ESCAPED_CHAR+"])",KEY='"'+ALLOWED_CHAR+'+"',VALUE='(null|"'+ALLOWED_CHAR+'*"|'+OBJECT_TOKEN+")",KEY_VALUE=KEY+":"+VALUE,KEY_VALUE_SEQUENCE="("+KEY_VALUE+",)*"+KEY_VALUE,OBJECT_LITERAL="({}|{"+KEY_VALUE_SEQUENCE+"})",objectPattern=new RegExp(OBJECT_LITERAL,"g");return function(str){if(str.indexOf(OBJECT_TOKEN)!==-1){return false}while(str.match(objectPattern)){str=str.replace(objectPattern,OBJECT_TOKEN)}return str===OBJECT_TOKEN}})();function validateCookieName(name){if(name.match(/ ,;/)){throw"Illegal name provided, must be valid in browser cookie."}}})(); /*]]>*/</script>  <script type="text/javascript">  document.documentElement.className += (document.documentElement.className? ' ' : '') + 'orb-js';  fig.manager.confirm(); </script> <script src="http://static.bbci.co.uk/frameworks/barlesque/3.2.4/orb/4/script/orb/api.min.js"></script> <script type="text/javascript"> var blq = { environment: function() { return 'live'; } } </script>   <script type="text/javascript"> /*<![CDATA[*/ function oqsSurveyManager(w, flag) { if (flag !== 'OFF') { w.document.write('<script type="text/javascript" src="http://static.bbci.co.uk/frameworks/barlesque/3.2.4/orb/4/script/vendor/edr.js"><'+'/script>'); } } oqsSurveyManager(window, 'ON'); /*]]>*/ </script>             <!-- BBCDOTCOM template: responsive webservice  -->
        <!-- BBCDOTCOM head --><script type="text/javascript"> /*<![CDATA[*/ var _sf_startpt = (new Date()).getTime(); /*]]>*/ </script><style type="text/css">.bbccom_display_none{display:none;}</style><script type="text/javascript"> /*<![CDATA[*/ var bbcdotcomConfig, googletag = googletag || {}; googletag.cmd = googletag.cmd || []; var bbcdotcom = false; (function(){ if(typeof require !== 'undefined') { require({ paths:{ "bbcdotcom":"http://static.bbci.co.uk/bbcdotcom/0.3.345/script" } }); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ var bbcdotcom = { adverts: { keyValues: { set: function() {} } }, advert: { write: function () {}, show: function () {}, isActive: function () { return false; }, layout: function() { return { reset: function() {} } } }, config: { init: function() {}, isActive: function() {}, setSections: function() {}, isAdsEnabled: function() {}, setAdsEnabled: function() {}, isAnalyticsEnabled: function() {}, setAnalyticsEnabled: function() {}, setAssetPrefix: function() {}, setVersion: function () {}, setJsPrefix: function() {}, setSwfPrefix: function() {}, setCssPrefix: function() {}, setConfig: function() {}, getAssetPrefix: function() {}, getJsPrefix: function () {}, getSwfPrefix: function () {}, getCssPrefix: function () {} }, survey: { init: function(){ return false; } }, data: {}, init: function() {}, objects: function(str) { return false; }, locale: { set: function() {}, get: function() {} }, setAdKeyValue: function() {}, utils: { addEvent: function() {}, addHtmlTagClass: function() {}, log: function () {} }, addLoadEvent: function() {} }; /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (typeof orb !== 'undefined' && typeof orb.fig === 'function') { if (orb.fig('ad') && orb.fig('uk') == 0) { bbcdotcom.data = { ads: (orb.fig('ad') ? 1 : 0), stats: (orb.fig('uk') == 0 ? 1 : 0), statsProvider: orb.fig('ap') }; } } else { document.write('<script type="text/javascript" src="'+('https:' == document.location.protocol ? 'https://ssl.bbc.com' : 'http://tps.bbc.com')+'/wwscripts/data">\x3C/script>'); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (typeof orb === 'undefined' || typeof orb.fig !== 'function') { bbcdotcom.data = { ads: bbcdotcom.data.a, stats: bbcdotcom.data.b, statsProvider: bbcdotcom.data.c }; } if (bbcdotcom.data.ads == 1) { document.write('<script type="text/javascript" src="'+('https:' == document.location.protocol ? 'https://ssl.bbc.co.uk' : 'http://www.bbc.co.uk')+'/wwscripts/flag">\x3C/script>'); } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (window.bbcdotcom && (typeof bbcdotcom.flag == 'undefined' || (typeof bbcdotcom.data.ads !== 'undefined' && bbcdotcom.flag.a != 1))) { bbcdotcom.data.ads = 0; } if (/[?|&]ads/.test(window.location.href) || /(^|; )ads=on; /.test(document.cookie) || /; ads=on(; |$)/.test(document.cookie)) { bbcdotcom.data.ads = 1; bbcdotcom.data.stats = 1; } if (window.bbcdotcom && (bbcdotcom.data.ads == 1 || bbcdotcom.data.stats == 1)) { bbcdotcom.assetPrefix = "http://static.bbci.co.uk/bbcdotcom/0.3.345/"; if (/(sandbox|int)(.dev)*.bbc.co*/.test(window.location.href) || /[?|&]ads-debug/.test(window.location.href) || document.cookie.indexOf('ads-debug=') !== -1) { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/0.3.345/script/orb/individual.js">\x3C/script>'); } else { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/0.3.345/script/orb/bbcdotcom.js">\x3C/script>'); } if(/[\\?&]ads=([^&#]*)/.test(window.location.href)) { document.write('<script type="text/javascript" src="http://static.bbci.co.uk/bbcdotcom/0.3.345/script/orb/adverts/adSuites.js">\x3C/script>'); } } })(); /*]]>*/ </script><script type="text/javascript"> /*<![CDATA[*/ (function(){ if (window.bbcdotcom && (bbcdotcom.data.ads == 1 || bbcdotcom.data.stats == 1)) { bbcdotcomConfig = {"adFormat":"standard","adKeyword":"","adMode":"smart","adsEnabled":true,"appAnalyticsSections":"","asyncEnabled":true,"disableInitialLoad":false,"advertInfoPageUrl":"http:\/\/www.bbc.co.uk\/faqs\/online\/adverts_general","advertisementText":"Advertisement","analyticsEnabled":true,"appName":"wwhp","assetPrefix":"http:\/\/static.bbci.co.uk\/bbcdotcom\/0.3.345\/","continuousPlayEnabled":true,"customAdParams":[],"customStatsParams":[],"headline":"","id":"","inAssociationWithText":"in association with","keywords":"","language":"","orbTransitional":false,"outbrainEnabled":true,"palEnv":"live","productName":"","sections":[],"siteCatalystEnabled":true,"comScoreEnabled":true,"comscoreSite":"bbc-global-test","comscoreID":"18897612","comscorePageName":"home","slots":"","sponsoredByText":"is sponsored by","adsByGoogleText":"Ads by Google","summary":"","type":"","staticBase":"\/bbcdotcom","staticHost":"http:\/\/static.bbci.co.uk","staticVersion":"0.3.345","staticPrefix":"http:\/\/static.bbci.co.uk\/bbcdotcom\/0.3.345","dataHttp":"tps.bbc.com","dataHttps":"ssl.bbc.com","flagHttp":"www.bbc.co.uk","flagHttps":"ssl.bbc.co.uk","analyticsHttp":"sa.bbc.com","analyticsHttps":"ssa.bbc.com"}; bbcdotcom.config.init(bbcdotcomConfig, bbcdotcom.data, window.location, window.document); bbcdotcom.config.setAssetPrefix("http://static.bbci.co.uk/bbcdotcom/0.3.345/"); bbcdotcom.config.setVersion("0.3.345"); document.write('<!--[if IE 7]><script type="text/javascript">bbcdotcom.config.setIE7(true);\x3C/script><![endif]-->'); document.write('<!--[if IE 8]><script type="text/javascript">bbcdotcom.config.setIE8(true);\x3C/script><![endif]-->'); document.write('<!--[if IE 9]><script type="text/javascript">bbcdotcom.config.setIE9(true);\x3C/script><![endif]-->'); if (/[?|&]ex-dp/.test(window.location.href) || document.cookie.indexOf('ex-dp=') !== -1) { bbcdotcom.utils.addHtmlTagClass('bbcdotcom-ex-dp'); } } })(); /*]]>*/ </script>            <script type="text/javascript">/*<![CDATA[*/
 ...
 <script type="text/javascript"> /* <![CDATA[ */ define('id-statusbar-config', { 'translation_signedout': "Sign in", 'translation_signedin': "Your account", 'use_overlay' : false, 'signin_url' : "https://ssl.bbc.com/id/signin", 'locale' : "en-GB", 'policyname' : "", 'ptrt' : "http://www.bbc.com/" }); var map = {};  map['idcta/statusbar'] = 'http://static.bbci.co.uk/id/0.32.25/modules/idcta/statusbar'; require({paths: map}); /* ]]> */ </script>   <script type="text/javascript"> require(['istats-1'], function(istats){ if (typeof(document) != 'undefined' && typeof(document.cookie) != 'undefined') { var cookieAphidMatch = document.cookie.match(/ckpf_APHID=([^;]*)/); if (cookieAphidMatch && typeof(cookieAphidMatch[1]) == 'string') { istats.addLabels({'bbc_hid': cookieAphidMatch[1]}); } } })(); </script>    <script type="text/javascript"> (function () { if (! window.require) { throw new Error('idcta: could not find require module'); } var map = {}; map['idapp-1'] = 'http://static.bbci.co.uk/idapp/0.71.81/modules/idapp/idapp-1'; map['idcta/idcta-1'] = 'http://static.bbci.co.uk/id/0.32.25/modules/idcta/idcta-1'; map['idcta/idCookie'] = 'http://static.bbci.co.uk/id/0.32.25/modules/idcta/idCookie'; map['idcta/overlayManager'] = 'http://static.bbci.co.uk/id/0.32.25/modules/idcta/overlayManager'; require({paths: map}); define('id-config', {"idapp":{"version":"0.71.81","hostname":"ssl.bbc.com","insecurehostname":"www.bbc.com","tld":"bbc.com"},"idtranslations":{"version":"0.33.27"},"identity":{"baseUrl":"https:\/\/talkback.live.bbc.co.uk\/identity","cookieAgeDays":730,"accessTokenCookieName":"ckns_IDA-ATKN"},"pathway":{"name":null,"staticAssetUrl":"http:\/\/static.bbci.co.uk\/idapp\/0.71.81\/modules\/idapp\/idapp-1\/View.css"},"idpurl":"https:\/\/idp.api.bbc.co.uk\/idp\/oauth2\/authorize?client_id=bbc-co-uk&response_type=code&scope=openid+play.bbcstore.r+plays.any.w+plays.any.r+follows.any.w+follows.any.r+favourites.any.w+favourites.any.r+idm.basic.r+feedback.any.r+feedback.any.w+loves.any.r+loves.any.w&module=bbc-co-uk&state=ptrt%3Dhttp%3A%2F%2Fwww.bbc.com%2F%26locale%3Den-GB&redirect_uri=https%3A%2F%2Fssl.bbc.com%2Fid%2Foauth2%2Fconsume%2Fidp.bbc.co.uk"}); })(); </script> <script type="text/javascript"> require(['idcta/idCookie'], function(idCookie){ if (typeof(document) != 'undefined' && typeof(document.cookie) != 'undefined') { var idCookieInstance = idCookie.getInstance(); /* Timestamp in milliseconds for the 6am on 27th of October 2015 */ var timestamp27thOct = 1445925600000; /* Only select users who signed in before the dooms day and were not downgraded yet */ if (idCookieInstance.hasCookie() && idCookieInstance.timestamp != '' && parseInt(idCookieInstance.timestamp) > 0 && parseInt(idCookieInstance.timestamp) < timestamp27thOct && !idCookieInstance.isDowngraded()) { /* iPlayer uplift is session cookie, so downgrade based on this cookie missed 20% users. To cover all the users with our fix, ut is nor uncoditional: all users that have not been downgraded before will now be downgraded */ idCookieInstance.downgrade(); } } }); </script>    <style type="text/css"> .orb-nav-pri .orb-nav-id a { position: relative; padding-left: 26px; } .orb-nav-pri .orb-nav-id img { position: absolute; left: 8px; top: 0.612em; } .orb-js .orb-nav-id-default #idcta-image { visibility: hidden; } .orb-nav-pri .orb-nav-id span { position: absolute; height: 1px; width: 1px; overflow: hidden; clip: rect(1px 1px 1px 1px); clip: rect(1px, 1px, 1px, 1px); } @media screen and (min-width: 600px) { .orb-nav-pri .orb-nav-id a { padding-left: 34px; } .orb-nav-pri .orb-nav-id img { left: 16px; top: 0.862em; } .orb-nav-pri .orb-icon-id { padding-left: 42px; background-position: 16px -92px; } } @media screen and (min-width: 1008px) { .orb-nav-pri .orb-nav-id a { padding-left: 42px; min-width: 8.62em; } .orb-nav-pri .orb-nav-id span { position: static; } .orb-js .orb-nav-id-default #idcta-username { visibility: hidden; } } @media screen and (min-width: 1280px) { .b-pw-1280 .orb-nav-pri .orb-nav-id a { padding-left: 46px; } .b-pw-1280 .orb-nav-pri .orb-nav-id img { left: 20px; } } .orb-nav-pri .orb-nav-id a:focus, .orb-nav-pri .orb-nav-id a:hover, .orb-nav-pri .orb-nav-id a:active { border-bottom-color: #1188BB; } </style>     <!-- Webapp: WWHP international homepage -->
    ...
    <link rel="apple-touch-icon" href="http://static.bbci.co.uk/wwhp/1.91.0/responsive/img/apple-touch/apple-touch-180.jpg">

    <!--[if (gt IE 8) | (IEMobile)]><!-->
<link href="http://static.bbci.co.uk/wwhp/1.91.0/responsive/css/wwhp.min.css" rel="stylesheet" />
<!--<![endif]-->
<!--[if (lt IE 9) & (!IEMobile)]>
<link href="http://static.bbci.co.uk/wwhp/1.91.0/responsive/css/old-ie.min.css" rel="stylesheet" />
<![endif]-->    <script src="http://static.bbci.co.uk/wwhp/1.91.0/modules/vendor/bower/modernizr/modernizr.js"></script>
    <script>
        (function () {
            if (window.bbcdotcom) {
            ...
            require(["domReady","compiled"], function (domReady) {
                domReady(function () {
                    require(['app'], function (app) {
                        app.init(window, {
                            staticPrefix: 'http://static.bbci.co.uk/wwhp/1.91.0/',
    ...
    <h2 class="module__title">&nbsp;</h2>
        ...
        <li class="media-list__item media-list__item--1">
            <div class="media media--hero media--primary media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/37CA/production/_87128241_0aadb8fd-7bc5-4e05-85bc-04cbca81c08a.jpg" data-alt="The two attackers at the Chicago O'Hare International Airport on 27 July 2014"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/37CA/production/_87128241_0aadb8fd-7bc5-4e05-85bc-04cbca81c08a.jpg" alt="The two attackers at the Chicago O'Hare International Airport on 27 July 2014" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-us-canada-35055104"
                                  rev="hero1|headline" >
                                                            California pair 'plotted before dating'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The couple behind the San Bernardino attack that killed 14 people were radicalised before they started dating, the director of the FBI has said.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-us-canada-35055104"
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/lk/p03blkhs.jpg" data-alt="Donald Trump speaking and gesturing with his hand"><img src="http://ichef.bbci.co.uk/wwhp/144/ibroadcast/images/live/p0/3b/lk/p03blkhs.jpg" alt="Donald Trump speaking and gesturing with his hand" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.co.uk/news/blogs-trending-35049955"
                                  rev="hero2|headline" >
                                                            Trump 'should be banned from entering the UK'                                                    </a>
                    </h3>

                    
                                            <a class="media__tag tag tag--trending" href="http://www.bbc.co.uk/news/blogs-trending-35049955"
                                  rev="hero2|source" >Trending</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="http://www.bbc.co.uk/news/blogs-trending-35049955"
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/044D/production/_87110110_87109806.jpg" data-alt="millionaire conservationist Douglas Tompkins stands on his land in Chile in this January 2000 file photo"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/044D/production/_87110110_87109806.jpg" alt="millionaire conservationist Douglas Tompkins stands on his land in Chile in this January 2000 file photo" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/world-latin-america-35048095"
                                  rev="hero3|headline" >
                                                            US clothing billionaire dies in kayak accident                                                    </a>
                    </h3>

                    
                                            <a class="media__tag tag tag--latin-america" href="/news/world/latin_america"
                                  rev="hero3|source" >Latin America</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/world-latin-america-35048095"
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/ck/p03bcksp.jpg" data-alt="City of London Distillery, London, England, Britain, United Kingdom, Europe"><img src="http://ichef.bbci.co.uk/wwhp/144/ibroadcast/images/live/p0/3b/ck/p03bcksp.jpg" alt="City of London Distillery, London, England, Britain, United Kingdom, Europe" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20151207-is-this-liquor-london-in-a-bottle"
                                  rev="hero4|headline" >
                                                            A rare find in the City of London                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/travel/story/20151207-is-this-liquor-london-in-a-bottle"
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--overlay block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/1587E/production/_87109188_mo_photoby_thomasskou_3.jpg" data-alt="MÃ"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/1587E/production/_87109188_mo_photoby_thomasskou_3.jpg" alt="MÃ" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/entertainment-arts-35038571"
                                  rev="hero5|headline" >
                                                            The voice behind Spotify's most-played song                                                    </a>
                    </h3>

                    
                                            <a class="media__tag tag tag--entertainment---arts" href="/news/entertainment_and_arts"
                                  rev="hero5|source" >Entertainment &amp; Arts</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/entertainment-arts-35038571"
     ...
     <div class="module__content"> <ul class="media-list media-list--fixed-height">         
        <li class="media-list__item media-list__item--1">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/50FA/production/_87103702_87103701.jpg" data-alt="An Afghan security member secures the site after an attack on Police station in Kandahar"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="An Afghan security member secures the site after an attack on Police station in Kandahar" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-asia-35043938"
                                  rev="news|headline" >
                                                            Taliban kill dozens at Kandahar airport                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Dozens of people are killed in a Taliban attack on a heavily fortified civilian and military airfield in the southern Afghan city of Kandahar.                                                    </p>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/D900/production/_87125555_498513862.jpg" data-alt="Donald Trump"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Donald Trump" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-us-canada-35055626"
                                  rev="news|headline" >
                                                            Trump: 'I will never leave this race'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Republican presidential candidate Donald Trump says he &quot;will never leave this race&quot; despite calls for him to step aside.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-us-canada-35055626"
                          rev="news|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Trump: 'I will never leave this race'                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/1BF0/production/_87125170_030496518-1.jpg" data-alt="In this photo made from video footage provided by the Russian defence ministry on 9 December 2015, a Russian bomber drops bombs on a target."><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="In this photo made from video footage provided by the Russian defence ministry on 9 December 2015, a Russian bomber drops bombs on a target." /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-europe-35049591"
                                  rev="news|headline" >
                                                            Russia 'wants Syria ethnic cleansing'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Turkey's Prime Minister Ahmet Davutoglu accuses Russia of attempting &quot;ethnic cleansing&quot; with its air strikes in northern Syria.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-europe-35049591"
                          rev="news|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Russia 'wants Syria ethnic cleansing'                </a>
            </div>
     ...
     <div class="module__content"> <ul class="media-list media-list--fixed-height">         
        <li class="media-list__item media-list__item--1">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/2C91/production/_87090411_garry_monk_rex_sad.jpg" data-alt="Garry Monk"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Garry Monk" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/sport/football/34762862"
                                  rev="sport|headline" >
                                                            Swansea part with manager Monk                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Swansea City part company with manager Garry Monk after only one win in 11 Premier League games.                                                    </p>
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media  block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/EFB2/production/_87126316_gettasdf.jpg" data-alt="Swansea City"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Swansea City" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/sport/live/34413818"
                                  rev="sport|headline" >
                                                            Monk leaves Swansea - reaction                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Reaction to manager Garry Monk leaving Swansea, Champions League build-up, debate, gossip and the best of social media.                                                    </p>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/7BA4/production/_87125613_mm_fury_rant_to_spoty.jpg" data-alt="World heavyweight champion Tyson Fury"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="World heavyweight champion Tyson Fury" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/uk-35055146"
                                  rev="sport|headline" >
                                                            Fury on Sports Personality criticism                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            World heavyweight champion Tyson Fury responds to criticism about his inclusion on the BBC Sports Personality of the Year's shortlist by quoting from the Bible.                                                    </p>
                    
                                            <a class="media__tag tag tag--sport" href="/news/uk"
                                  rev="sport|source" >UK</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="/news/uk-35055146"
                          rev="sport|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Fury on Sports Personality criticism                </a>
            </div>
     ...
     </ul> </div> </section> <div class="advert advert--mpu"><!-- BBCDOTCOM slot mpu --><div id="bbccom_mpu_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('mpu', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </section>       <section class="module module--weather" data-wwhp-module="weather"> <div class="module__content"> <div class="weather"> <h2 class="weather__location"> London Weather <a class="weather__edit">Edit</a> </h2> <form class="weather__form" action="/wwhp"> <div class="weather__search"> <input class="weather__input" placeholder="Enter city, town or region" name="location_term" autocomplete="off"> <button class="weather__submit" type="submit" value=""> <span class="icon icon--search"></span> </button> </div> <p class="weather__error"></p> <ul class="weather__results"></ul> </form> <ul class="weather__forecasts">  <li class="forecast--1 forecast"> <a class="forecast__link" href="/weather/2643743?day=0"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/7.gif" alt="Light Cloud"> <h3 class="forecast__day">Wed</h3>  <p class="forecast__low">10&deg;C</p> </a> </li>  <li class="forecast--2 forecast"> <a class="forecast__link" href="/weather/2643743?day=1"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/12.gif" alt="Light Rain"> <h3 class="forecast__day">Thu</h3>  <p class="forecast__high">13&deg;C</p>  <p class="forecast__low">8&deg;C</p> </a> </li>  <li class="forecast--3 forecast"> <a class="forecast__link" href="/weather/2643743?day=2"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/15.gif" alt="Heavy Rain"> <h3 class="forecast__day">Fri</h3>  <p class="forecast__high">11&deg;C</p>  <p class="forecast__low">5&deg;C</p> </a> </li>  <li class="forecast--4 forecast"> <a class="forecast__link" href="/weather/2643743?day=3"   rev="weather|link" > <img class="forecast__image" src="http://static.bbci.co.uk/weather/0.5.284/images/icons/individual_56_icons/en_on_light_bg/12.gif" alt="Light Rain"> <h3 class="forecast__day">Sat</h3>  <p class="forecast__high">10&deg;C</p>  <p class="forecast__low">6&deg;C</p> </a> </li>  </ul> </div> </div> </section>     <!-- Error: (null) Module not found or invalid -->
     ...
     <div class="module__content"> <div class="container"> <div class="editors-picks "> <ul class="media-list media-list--fixed-height layout--featured">         
        <li class="media-list__item media-list__item--1">
            <div class="media media--padded media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/39/tl/p039tlsj.jpg" data-alt="'Iâve visited more than 15 countries in two years'"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="'Iâve visited more than 15 countries in two years'" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20151201-travelling-with-a-powerless-passport"
                                  rev="editors-picks|headline" >
                                                            How to travel when youâre not rich                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            'Iâve visited more than 15 countries in two years'                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/travel/story/20151201-travelling-with-a-powerless-passport"
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/92E0/production/_87100673_gettyimages-76030868.jpg" data-alt="Gamer during e-sports with headset on"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Gamer during e-sports with headset on" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/magazine-35026796"
                                  rev="editors-picks|headline" >
                                                            Making a fortune - just by playing games                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Professional computer gamers often spend 12 hours a day practising for competitions where they can...                                                    </p>
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/31/p03b31bz.jpg" data-alt="The tunes that defined their era"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="The tunes that defined their era" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/culture/story/20151204-whats-the-song-of-your-generation"
                                  rev="editors-picks|headline" >
                                                            Whatâs the song of your generation?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The tunes that defined their era                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/culture/story/20151204-whats-the-song-of-your-generation"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Whatâs the song of your generation?                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/lm/p03blmrz.jpg" data-alt="Reindeer noses arenât red â but they are amazing in another way"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Reindeer noses arenât red â but they are amazing in another way" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/earth/story/20151209-why-reindeer-noses-are-more-amazing-than-you-think"
                                  rev="editors-picks|headline" >
                                                            The truth about reindeer                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Reindeer noses arenât red â but they are amazing in another way                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/earth/story/20151209-why-reindeer-noses-are-more-amazing-than-you-think"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    The truth about reindeer                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--6">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/mf/p03bmfzt.jpg" data-alt="Can Italy's innovative Me Electric Scooter reinvent an icon?"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Can Italy's innovative Me Electric Scooter reinvent an icon?" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/autos/story/20151209-outsmarting-the-vespa"
                                  rev="editors-picks|headline" >
                                                            Outsmarting the Vespa                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Can Italy's innovative Me Electric Scooter reinvent an icon?                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/autos/story/20151209-outsmarting-the-vespa"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Outsmarting the Vespa                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--7">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/l7/p03bl796.jpg" data-alt="There are four kinds of drunk. Which are you?"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="There are four kinds of drunk. Which are you?" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/future/story/20151207-quiz-find-out-what-kind-of-drunk-you-are"
                                  rev="editors-picks|headline" >
                                                            What is your drunk personality?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            There are four kinds of drunk. Which are you?                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/future/story/20151207-quiz-find-out-what-kind-of-drunk-you-are"
                          rev="editors-picks|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    What is your drunk personality?                </a>
            </div>
     ...
     </ul> </div>   <div class="most-popular"> <div class="top-list"> <h2 class="top-list__heading">Latest Business News</h2> <ul class="top-list__list">  <li class="top-list-item top-list-item__1 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/business-35049250"   rev="most-popular|link" > <span class="top-list-item__bullet">1</span> <h3 class="top-list-item__headline">Mining shares claw back losses</h3> </a> </li>  <li class="top-list-item top-list-item__2 top-list-item--ranked top-list-item--even"> <a class="top-list-item__link" href="/news/business-35051469"   rev="most-popular|link" > <span class="top-list-item__bullet">2</span> <h3 class="top-list-item__headline">VW cuts tally of cars hit by CO2 issue</h3> </a> </li>  <li class="top-list-item top-list-item__3 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/live/business-35008144"   rev="most-popular|link" > <span class="top-list-item__bullet">3</span> <h3 class="top-list-item__headline">Commodity stocks recover; VW motors on emissions news</h3> </a> </li>  <li class="top-list-item top-list-item__4 top-list-item--ranked top-list-item--even"> <a class="top-list-item__link" href="/news/business-35052546"   rev="most-popular|link" > <span class="top-list-item__bullet">4</span> <h3 class="top-list-item__headline">Middle East chain bans Trump products</h3> </a> </li>  <li class="top-list-item top-list-item__5 top-list-item--ranked top-list-item--odd"> <a class="top-list-item__link" href="/news/business-35051353"   rev="most-popular|link" > <span class="top-list-item__bullet">5</span> <h3 class="top-list-item__headline">Yahoo reverses Alibaba spin-off plan</h3> </a> </li>  </ul> </div> </div>  <div class="advert advert--native"><!-- BBCDOTCOM slot native --><div id="bbccom_native_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('native', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </section>      <section class="module module--collapse-images module--special-features module--primary-special-features"> <div class="module__content"> <ul class="features">   <li class="feature feature--1"> <h2 class="feature__title"> <a class="feature__link" href="http://www.bbc.com/news/business-15870435"   rev="primary-special-features|header" > My Business </a> </h2> <div class="feature__content">     
        
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/11B52/production/_87103527_e62855dc-f4b0-4c9f-ae09-c6b0c161e106.jpg" data-alt="Igor Gligorov - founder of Soulines"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Igor Gligorov - founder of Soulines" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/news/business-35041053"
                                  rev="primary-special-features|headline" >
                                                            Good vibrations: The return of the turntable                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/news/business-35041053"
     ...
     </div> <div class="feature__ad"> <div class="advert advert--module_feature-1 advert--sponsor"><!-- BBCDOTCOM slot module_feature-1 --><div id="bbccom_module_feature-1_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('module_feature-1', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </li>  <li class="feature-ad"> <div class="advert advert--mpu_middle"><!-- BBCDOTCOM slot mpu_middle --><div id="bbccom_mpu_middle_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('mpu_middle', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </li>   <li class="feature feature--2"> <h2 class="feature__title"> <a class="feature__link" href="http://www.bbc.com/capital/columns/business-traveller"   rev="primary-special-features|header" > Business Traveller </a> </h2> <div class="feature__content">     
        
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/37/lx/p037lx54.jpg" data-alt="(Credit: Thinkstock)"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="(Credit: Thinkstock)" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20151208-smile-youre-in-asias-friendliest-metropolis"
                                  rev="primary-special-features|headline" >
                                                            Asia's friendliest city?                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/capital/story/20151208-smile-youre-in-asias-friendliest-metropolis"
                          rev="primary-special-features|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Asia's friendliest city?                </a>
            </div>
     ...
     <div class="module__content"> <div class="video video--noslick" id="video" data-wwhp-module="video"> <div class="video__player"> <div id="player" class="video__smp"></div>     
            ...
            <div class="media media--primary media--overlay block-link--no-filter media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/620D/production/_87110152_87110150.jpg" data-alt="Donald Trump speaking to Barbara Walters on ABC World News Tonight"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Donald Trump speaking to Barbara Walters on ABC World News Tonight" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-us-canada-35047736"
                                  rev="video|headline" >
                                                            Donald Trump: 'I am not a bigot'                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Speaking to Barbara Walters on ABC World News Tonight, Donald Trump says he is not a bigot following his call for a complete ban on Muslims entering the US.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-us-canada-35047736"
     ...
     </div> <div class="video__content"> <ul class="video__tabs">  <li class="video__tab"> <a class="video__tab__link" data-category="recommended"> Recommended </a> </li>  <li class="video__tab"> <a class="video__tab__link" data-category="most-watched"> Most Watched </a> </li>  <li class="video__tab"> <a class="video__tab__link" data-category="latest"> Latest </a> </li>  </ul> <div class="video__viewport"> <ul class="video__items">  <li class="video__item video__item video__item--0 video__item--recommended" data-category="recommended" data-index="0" data-category-index="0" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;Donald Trump: 'I am not a bigot'&quot;,&quot;url&quot;:&quot;\/news\/world-us-canada-35047736&quot;,&quot;summary&quot;:&quot;Speaking to Barbara Walters on ABC World News Tonight, Donald Trump says he is not a bigot following his call for a complete ban on Muslims entering the US.&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/620D\/production\/_87110152_87110150.jpg&quot;,&quot;imgalttext&quot;:&quot;Donald Trump speaking to Barbara Walters on ABC World News Tonight&quot;,&quot;pid&quot;:&quot;p03bk0zm&quot;,&quot;duration&quot;:&quot;PT1M45S&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;US &amp;amp; Canada&quot;,&quot;sourceurl&quot;:&quot;\/news\/world\/us_and_canada&quot;,&quot;created&quot;:&quot;2015-12-09T04:56:35+00:00&quot;,&quot;updated&quot;:&quot;2015-12-09T04:56:35+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;sourceid&quot;:&quot;videos&quot;,&quot;itemtype&quot;:&quot;feed&quot;,&quot;allowadvertising&quot;:true}">     
     ...
     </li>  <li class="video__item video__item video__item--1 video__item--recommended" data-category="recommended" data-index="1" data-category-index="1" data-video="{&quot;id&quot;:&quot;201512072128-hong-kongs-derelict-and-abandoned-history&quot;,&quot;type&quot;:&quot;video&quot;,&quot;title&quot;:&quot;Hong Kong's derelict and abandoned history&quot;,&quot;url&quot;:&quot;http:\/\/www.bbc.com\/news\/world-asia-china-34929470&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\
data-category-index="3" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;Jolie and Pitt on new film By the Sea&quot;,&quot;url&quot;:&quot;\/news\/entertainment-arts-35047735&quot;,&quot;summary&quot;:&quot;Angelina Jolie and Brad Pitt are acting together in a new film, By the Sea, which see them appearing on the same screen for the first time in 10 years.&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/9F61\/production\/_87110804_87110803.jpg&quot;,&quot;imgalttext&quot;:&quot;By the Sea&quot;,&quot;pid&quot;:&quot;p03bkklw&quot;,&quot;duration&quot;:&quot;PT3M27S&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Entertainment &amp;amp; Arts&quot;,&quot;sourceurl&quot;:&quot;\/news\/entertainment_and_arts&quot;,&quot;created&quot;:&quot;2015-12-09T07:12:08+00:00&quot;,&quot;updated&quot;:&quot;2015-12-09T07:12:08+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;allowadvertising&quot;:true}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/9F61/production/_87110804_87110803.jpg" data-alt="By the Sea"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="By the Sea" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/entertainment-arts-35047735"
                                  rev="video|headline" >
                                                            Jolie and Pitt on new film By the Sea                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/entertainment-arts-35047735"
                          rev="video|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Jolie and Pitt on new film By the Sea                </a>
            </div>
     ...
     </li>  <li class="video__item video__item video__item--14 video__item--latest" data-category="latest" data-index="14" data-category-index="4" data-video="{&quot;contenttype&quot;:&quot;video&quot;,&quot;num&quot;:&quot;10&quot;,&quot;type&quot;:&quot;MAP&quot;,&quot;title&quot;:&quot;How Osama Bin Laden gave CIA the slip&quot;,&quot;url&quot;:&quot;\/news\/magazine-34999074&quot;,&quot;summary&quot;:&quot;In December 2001, CIA station chief Gary Berntsen led a team of men in Afghanistan to find Osama Bin Laden. He speaks to Witness about the mission to find the world's most wanted man.&quot;,&quot;img&quot;:&quot;http:\/\/ichef.bbci.co.uk\/wwhp\/800\/cpsprodpb\/15465\/production\/_87114178_87114177.jpg&quot;,&quot;imgalttext&quot;:&quot;Osama Bin Laden&quot;,&quot;pid&quot;:&quot;p03b247m&quot;,&quot;duration&quot;:&quot;PT5M2S&quot;,&quot;pidtype&quot;:&quot;Version&quot;,&quot;sourcename&quot;:&quot;Magazine&quot;,&quot;sourceurl&quot;:&quot;\/news\/magazine&quot;,&quot;created&quot;:&quot;2015-12-09T00:08:32+00:00&quot;,&quot;updated&quot;:&quot;2015-12-09T00:08:32+00:00&quot;,&quot;origincode&quot;:&quot;cpsprodpb&quot;,&quot;gelicon&quot;:&quot;video&quot;,&quot;allowadvertising&quot;:true}">     
        
            <div class="media media--video media--horizontal media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/15465/production/_87114178_87114177.jpg" data-alt="Osama Bin Laden"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Osama Bin Laden" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/magazine-34999074"
                                  rev="video|headline" >
                                                            How Osama Bin Laden gave CIA the slip                                                    </a>
                    </h3>
      ...
      <div class="channel__ad"> <div class="advert advert--module_channel-international advert--sponsor"><!-- BBCDOTCOM slot module_channel-international --><div id="bbccom_module_channel-international_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('module_channel-international', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </div> </div>   <div class="channel channel--bbc-world-news channel--2"> <h2 class="channel__title"> <a class="channel__title__link" href="http://www.bbc.com/news/world_radio_and_tv/"   rev="bbc-world-news|header" > <span class="channel__title__icon icon icon--tv"></span> BBC World News </a> </h2> <div class="channel__content">     
            ...
            <div class="media channel__media block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/83C3/production/_87113733_reynolds.jpg" data-alt="Burt Reynolds, Hollywood actor"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Burt Reynolds, Hollywood actor" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/entertainment-arts-35037872"
                                  rev="bbc-world-news|headline" >
                                                            HARDtalk: Burt Reynolds                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Actor Burt Reynolds on the racism he found in Hollywood against Native Americans                                                    </p>
                    
                    
                </div>

                <a class="block-link__overlay-link"
                   href="/news/entertainment-arts-35037872"
     ...
     <div class="module__content"> <div class="container"> <div class="more-bbc "> <ul class="media-list media-list--fixed-height layout--featured">         
        <li class="media-list__item media-list__item--1">
            <div class="media media--padded media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/39/wx/p039wxbt.jpg" data-alt="How to bounce back from getting the chop"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="How to bounce back from getting the chop" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/capital/story/20151207-this-is-why-how-you-handle-rejection-says-a-lot-about-you"
                                  rev="more-bbc|headline" >
                                                            You're fired! Now what?                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            How to bounce back from getting the chop                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/capital/story/20151207-this-is-why-how-you-handle-rejection-says-a-lot-about-you"
        ...
        <li class="media-list__item media-list__item--2">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/14794/production/_87106838_turk2.jpg" data-alt="Turkson"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Turkson" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/science-environment-35040477"
                                  rev="more-bbc|headline" >
                                                            Birth control 'solution' to climate                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            One of the Catholic Church's most senior prelates has said that birth control could &quot;offer a...                                                    </p>
                    
                                            <a class="media__tag tag tag--health" href="/news/science_and_environment"
                                  rev="more-bbc|source" >Science &amp; Environment</a>
                    
                </div>

                <a class="block-link__overlay-link"
                   href="/news/science-environment-35040477"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Birth control 'solution' to climate                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/39/v4/p039v41p.jpg" data-alt="People sail halfway around the world to reach these fabled islands"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="People sail halfway around the world to reach these fabled islands" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/travel/story/20151203-an-exiled-island-turned-private-tropical-paradise"
                                  rev="more-bbc|headline" >
                                                            An exiled island turned private Eden                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            People sail halfway around the world to reach these fabled islands                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/travel/story/20151203-an-exiled-island-turned-private-tropical-paradise"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    An exiled island turned private Eden                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/AE85/production/_86077644_elba_beasts2_netflix.jpg" data-alt="Beasts of No Nation"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Beasts of No Nation" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/entertainment-arts-35055234"
                                  rev="more-bbc|headline" >
                                                            Brits lead charge at SAG awards                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            Dame Helen Mirren and Idris Elba lead the British charge at the Screen Actors Guild Awards, both...                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/entertainment-arts-35055234"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Brits lead charge at SAG awards                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/12279/production/_87116347_gettyimages-455692374.jpg" data-alt="Netflix"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Netflix" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/technology-35051054"
                                  rev="more-bbc|headline" >
                                                            Media services to be portable in EU                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The European Commission announces plans that will allow people to take their online subscriptions...                                                    </p>
        ...
        <li class="media-list__item media-list__item--6">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/hz/p03bhz1y.jpg" data-alt="CitroÃ«n E-Mehari"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="CitroÃ«n E-Mehari" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/autos/story/20151208-citron-finds-its-happy-place"
                                  rev="more-bbc|headline" >
                                                            CitroÃ«n finds its happy place                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The French carmaker mines its history with the sunny E-Mehari resort car.                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/autos/story/20151208-citron-finds-its-happy-place"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    CitroÃ«n finds its happy place                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--7">
            <div class="media media--padded block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/535D/production/_87114312_87114309.jpg" data-alt="Artist's impression of Juice at Jupiter"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Artist's impression of Juice at Jupiter" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="/news/science-environment-35051034"
                                  rev="more-bbc|headline" >
                                                            Deal signed to build Jupiter probe                                                    </a>
                    </h3>

                                            <p class="media__summary">
                                                            The European Space Agency signs a 350m-euro contract with Airbus to build a spacecraft to...                                                    </p>
                ...
                <a class="block-link__overlay-link"
                   href="/news/science-environment-35051034"
                          rev="more-bbc|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    Deal signed to build Jupiter probe                </a>
            </div>
            ...
            <div class="media media--overlay media--primary block-link">
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/culture/story/20151126-festive-gift-ideas-and-inspiration-2015-men-over-50"
     ...
     </div> <div class="feature__ad"> <div class="advert advert--module_feature-3 advert--sponsor"><!-- BBCDOTCOM slot module_feature-3 --><div id="bbccom_module_feature-3_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('module_feature-3', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </div> </li>  <li class="feature-ad"> <div class="advert advert--mpu_bottom"><!-- BBCDOTCOM slot mpu_bottom --><div id="bbccom_mpu_bottom_1_2_3_4" class="bbccom_slot" aria-hidden="true"><div class="bbccom_advert"><script type="text/javascript"> /*<![CDATA[*/ (function() { if (window.bbcdotcom && bbcdotcom.asyncSlot) { bbcdotcom.slotAsync('mpu_bottom', [1,2,3,4]); } })(); /*]]>*/ </script></div></div></div> </li>   <li class="feature feature--2"> <h2 class="feature__title"> <a class="feature__link" href="http://www.bbc.com/culture/tags/the-100-greatest-british-novels"   rev="secondary-special-features|header" > The 100 Greatest British Novels </a> </h2> <div class="feature__content">     
        
            <div class="media media--overlay media--primary block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/ibroadcast/images/live/p0/3b/jg/p03bjg44.jpg" data-alt="Woman reading (Thinkstock)"><img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAAALAAAAAAQAAkAAAIKhI+py+0Po5yUFQA7" alt="Woman reading (Thinkstock)" /></div></div>                </div>

                
                <div class="media__content">

                    <h3 class="media__title">
                        <a class="media__link" href="http://www.bbc.com/culture/story/20151204-the-25-greatest-british-novels"
                                  rev="secondary-special-features|headline" >
                                                            The 25 greatest British novels                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="http://www.bbc.com/culture/story/20151204-the-25-greatest-british-novels"
                          rev="secondary-special-features|overlay"                    tabindex="-1"
                   aria-hidden="true">
                    The 25 greatest British novels                </a>
            </div>
        ...
        <li class="media-list__item media-list__item--3">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/83D9/production/_86835733_gettyimages-138039969.jpg" data-alt="Caribbean Sun"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/83D9/production/_86835733_gettyimages-138039969.jpg" alt="Caribbean Sun" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/world-africa-34838437"
                                  rev="world-in-pictures3|headline" >
                                                            In pictures: Challenging perceptions of Africa through art                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/world-africa-34838437"
        ...
        <li class="media-list__item media-list__item--4">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/0B96/production/_87066920_532c982e-8bea-401a-acda-7c4f927ef586.jpg" data-alt="Rescue workers in Cumbria"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/0B96/production/_87066920_532c982e-8bea-401a-acda-7c4f927ef586.jpg" alt="Rescue workers in Cumbria" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/in-pictures-35021153"
                                  rev="world-in-pictures4|headline" >
                                                            Storm Desmond disruption in pictures                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/in-pictures-35021153"
        ...
        <li class="media-list__item media-list__item--5">
            <div class="media media--padded media--icon block-link">
                <div class="media__image">
                    <div class="responsive-image"><div class="delayed-image-load" data-src="http://ichef.bbci.co.uk/wwhp/{width}/cpsprodpb/6B63/production/_87019472_rs2435_luxsiyasivakumar-scr.jpg" data-alt="ICS volunteers pictured during the construction phase of the Eco-San and Health Camps programme"><img src="http://ichef.bbci.co.uk/wwhp/144/cpsprodpb/6B63/production/_87019472_rs2435_luxsiyasivakumar-scr.jpg" alt="ICS volunteers pictured during the construction phase of the Eco-San and Health Camps programme" /></div></div>                </div>
                ...
                <div class="media__content">
                    ...
                    <h3 class="media__title">
                        <a class="media__link" href="/news/in-pictures-34995983"
                                  rev="world-in-pictures5|headline" >
                                                            In pictures: International Volunteer Day                                                    </a>
                    </h3>
                ...
                <a class="block-link__overlay-link"
                   href="/news/in-pictures-34995983"
