...
eval(function(E,I,A,D,J,K,L,H){function C(A){return A<62?String.fromCharCode(A+=A<26?65:A<52?71:-4):A<63?'_':A<64?'$':C(A>>6)+C(A&63)}while(A>0)K[C(D--)]=I[--A];function N(A){return K[A]==L[A]?A:K[A]}if(''.replace(/^/,String)){var M=E.match(J),B=M[0],F=E.split(J),G=0;if(E.indexOf(F[0]))F=[''].concat(F);do{H[A++]=F[G++];H[A++]=N(B)}while(B=M[G]);H[A++]=F[G]||'';return H.join('')}return E.replace(J,N)}('L f(A){G.S=i(A.S,"AdSame\\u5e7f\\u544a");G.e=i(A.speed,20);G.U=i(A.titleHeight,K);G.b=i(A.createOrder,["BU","BC","Y"]);G.p=BF;G.h=K;f.0.constructor.g(G,A);G.3="bottom"}_as_extend(f,_as_divfl,{4:L(E){H(G.3=="N")G.N=G.l;d G.N=J.k.a-G.R-G.l;H(G.$=="T")G.T=G.t;d G.T=J.k.BL-G.m-G.t;1{M D=J.4();H(!D)I O;D.o(G.T,G.N,G.m,G.R-G.U);M B="<x>";B+="<r><S>"+G.S+"</S></r>";B+="<n BK=\'W\' ";B+="c=\'9:q;BI:q;\'>";H(G.U>K)B+="<Y c=\'BA:BM;N:-"+G.U+"V;\'>";B+=E;H(G.U>K)B+="</Y>";B+="</n>";B+="</x>";M C=D.BB;C.BD(B)}5(A){I O}I D},BN:L(F){H(u.isChrome())I O;M E=K;H(u.isSafari())E=28;H(u.BG())E=165;H(G.3=="N")G.N=G.l;d G.N=J.k.availHeight-G.R-G.l-E;H(G.$=="T")G.T=G.t;d G.T=J.k.availWidth-G.m-G.t;1{M D=J.open("","","N="+G.N+",T="+G.T+",a="+(G.R-G.U)+",BL="+G.m+",status=W,toolbar=W,menubar=W,"+"location=W,resizable=W,scrollbars=W",O);H(!D)I O}5(A){I O}1{M B="<x>";B+="<r><S>"+G.S+"</S></r>";B+="<n BK=\'W\' ";B+="c=\'overflow:hidden;9:q;BI:q;\'>";H(G.U>K)B+="<Y c=\'BA:BM;N:-"+G.U+"V;\'>";B+=F;H(G.U>K)B+="</Y>";B+="</n>";B+="</x>";M C=D.BB;C.BD(B);H(G.BH>-Q&&!G.j)G.j=G.BS+".X.close()"}5(A){I O}I D},BQ:L(A){H(G.BH>-Q&&!G.j)G.j=G.BS+".BR()";I f.0._.g(G,A)},_:L(D){H(G.P>=K)I;H(z G.b.2=="undefined"||G.b.2<Q)I;M C=G,A=C.b.2,E=K,B=J.v(L(){switch(C.b[E]){BP"BU":M F=C.BN(D);8;BP"BC":F=C.4(D);8;default:F=C.BQ(D)}H(F){C.X=F;C.p=C.b[E];H(C.p!="Y")C.P=Q;J.Z(B)}H(++E>=A)J.Z(B)},1000)},o:L(){H(G.P>K)I;M C=G,A=L(){C.y.6=L(){C.y.6=BF;H(C.p=="Y"){C.h=C.R;C.R=Q;f.0.o.g(C)}};C.y.o()};H(C.P>=K)A();d M B=J.v(L(){H(C.P<K)I;J.Z(B);A()},500)},6:L(){G.P=BW;M D=G.X.c,C=G,A=Q,E=parseInt(G.h/G.e),B=J.v(L(){H(C.P<K){J.Z(B);I O}M F=C.BT!="7"?C.BV():K;D.N=(C.w()+F-E*A).s()+"V";D.a=(E*A).s()+"V";H(++A>C.e){D.N=(C.w()+F).s()+"V";D.a=(C.h).s()+"V";C.R=C.h;C.P=Q;J.Z(B);C.setpos(true)}},BE);I O},BR:L(){H(z G.BO=="L")H(G.BO.g(G)===O)I O;H(G.P!=Q)I;G.P=BX;M D=G.X.c,C=G,A=Q,E=parseInt(G.R/G.e),B=J.v(L(){H(C.P<K){J.Z(B);I O}M F=C.BT!="7"?C.BV():K;D.a=(C.R-E*A)+"V";D.N=(C.w()+F+E*A)+"V";H(++A>C.e){D.N=(C.w()+F+C.R)+"V";D.a="1px";D.display="none";H(!u.BG())C.X.parentNode.removeChild(C.X);C.X=-Q;C.P=-Q;J.Z(B);H(z C.BJ=="L")C.BJ.g(C)}},BE)}})','this|if|return|window|0|function|var|top|false|flag|1|h|title|left|th|px|no|handle|div|clearInterval|height|order|style|else|sp|_as_divflpv|call|orgh|_as_setcf|autoclsfc|screen|vp|w|body|show|type|0px|head|toString|hp|_as_bro|setInterval|gett|html|fl|typeof|superclass|try|length|va|createPopup|catch|onAfterShow|fixed|break|margin|create|ha|position|document|popup|write|100|null|isOpera|autocls|padding|onAfterDestroy|scroll|width|relative|createWin|onBeforeDestroy|case|createDiv|destroy|name|at|win|getst|2|3'.split('|'),82,87,/[\w\$]+/g,{},{},[]))
...
function _as_fv(A){this.clk=_as_setcf(A.clickUrl,"");this.tag=_as_setcf(A.target,"_blank");this.dbName=_as_setcf(A.dbName,"adsame");this.adServer=_as_setcf(A.adServer,"");this.flashId=_as_setcf(A.flashId,0);this.expandId=_as_setcf(A.expandId,0);this.replayId=_as_setcf(A.replayId,0);this.pauseId=_as_setcf(A.pauseId,0);this.stopId=_as_setcf(A.stopId,0);this.soundId=_as_setcf(A.soundId,0);this.timeLineIds=_as_setcf(A.timeLineIds,0);this.mailId=_as_setcf(A.mailId,0);this.mailSubject=_as_setcf(A.mailSubject,"");this.mailContent=_as_setcf(A.mailContent,"");this.expand=_as_setcf(A.expand,"1");this.pmflag=_as_setcf(A.pmflag,"1");_as_fv.superclass.constructor.call(this,A)}_as_extend(_as_fv,_as_fl,{getparas:function(){var A="db="+escape(this.dbName);A+="&expand="+escape(this.expand);A+="&pmflag="+escape(this.pmflag);A+="&sccamid="+escape(this.flashId);A+="&clickId="+escape(this.expandId);A+="&posturl="+escape(this.adServer);A+="&clickurl="+escape(this.clk);A+="&target="+escape(this.tag);A+="&reopenId="+escape(this.replayId);A+="&playPauseId="+escape(this.pauseId);A+="&stopId="+escape(this.stopId);A+="&soundId="+escape(this.soundId);A+="&timepointId="+escape(this.timeLineIds);A+="&mailSubject="+this.mailSubject;A+="&mailId="+escape(this.mailId);A+="&mailBody="+this.mailContent;A+="&hiddenflag=0&flvPath=";return A}})
window._AdSameObj_SMB4792 = {};
var smbis1 = true;

window._AdSameObj_SMB4792.status=0;
window._AdSameObj_SMB4792.fc = function(cmd, args) {
	switch(cmd) {
	case "sambaStoped":
		window._AdSameObj_SMB4792.status=0;
		break;
	case "sambaRestarted":
		window._AdSameObj_SMB4792.status=1;
		break;
	case "close":
		window._AdSameObj_SMB4792.c.destroy();
		window._AdSameObj_SMB4792.status=0;

		break;
	}
}
window._AdSameObj_SMB4792.f = new _as_fv({
	selfName: "window._AdSameObj_SMB4792.f",
	width: 300,
	height: 300,
	id: "VideoPlayer",
	srcUrl: "http://rm.sina.com.cn/bj_chuanyang/jnd_160317/300300.swf",
	adServer: "http://samba.adsame.com",
	clickUrl: "http://sambaclk.adsame.com/c?z=samba&la=0&si=13&ci=4392&c=5940&or=5644&l=6438&bg=6352&b=6448&u=http://travel.sina.com.cn/z/canadatv/",
	target: "_blankl",
	dbName: "samba",
	flashId: 3887,
	replayId: 25587,
	...
	stopId: 25589,
	soundId: 25593,
	timeLineIds: "25594,25595,25596,25597,25598",
	mailId: 25592,
	mailSubject: "",
	mailContent: "",
	fscmdfc: window._AdSameObj_SMB4792.fc
});

window._AdSameObj_SMB4792.c = new _as_divfl({
	selfName: "window._AdSameObj_SMB4792.c",
	width: 300,
	height: 300,
	hPadding: 0,
	vPadding: 0,
	...
	vAlign: "bottom",
	title: "",
	flash: window._AdSameObj_SMB4792.f,
	speed: 5
});
window._AdSameObj_SMB4792.run = function() {
	if(window._AdSameObj_SMB4792.inited)return;
	window._AdSameObj_SMB4792.inited=true;
	if (smbis1) {
	var trackcode = "";
	var ifmcode = "";
	trackcode = "<img style=\'width:0px;height:0px;display:none\' src=\'http://samba.adsame.com/s?z=samba&c=5940&l=6438\' />";
	if (_as_bro.isIe6()) {
	...
	window._AdSameObj_SMB4792.c.create(window._AdSameObj_SMB4792.f.getcode()+trackcode+ifmcode);
	window._AdSameObj_SMB4792.c.show();
	document.getElementById(window._AdSameObj_SMB4792.c.id).style.zIndex = "11000";
	window._AdSameObj_SMB4792.status=1;
	}
	setTimeout(function(){
		try {
			window.sinaadsROC.done(window.sinaadsROC.videoWindow);
		} catch (e) {}
	},500)
}
window._AdSameObj_SMB4792.run();

function VideoWindow_click(){
	try
	{
