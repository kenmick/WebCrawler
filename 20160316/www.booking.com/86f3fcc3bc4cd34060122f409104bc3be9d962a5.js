...
for(var t=1,n=u.length,r;
t<=n;
t++){f[0]["fe_room"]=r=u[t-1];
y+=b[5];
i.MN("aux",r.b_children_ages);
y+=b[6];
...
y+=b[2]
}y+=[b[8],i.ME(b[9],i.MB,i.MN,null),b[10]].join("");
var u=(i.seq(1,i.MB(a[3]))||[]);
f.unshift({i:null});
for(var t=1,n=u.length,o;
t<=n;
t++){f[0]["i"]=o=u[t-1];
y+=[b[11],i.F.entities(o.value),b[12]].join("");
if((i.MJ(i.MB(a[4])==o.value))){y+=b[13]
}y+=[b[14],o.value,b[15]].join("")
}f.shift();
y+=[b[16],i.ME(b[17],i.MB,i.MN,null),b[18]].join("");
var u=(i.seq(1,i.MB(a[5]))||[]);
f.unshift({i:null});
for(var t=1,n=u.length,o;
t<=n;
t++){f[0]["i"]=o=u[t-1];
y+=[b[11],i.F.entities(o.value),b[12]].join("");
if((i.MJ(i.MB(a[6])==o.value))){y+=b[13]
}y+=[b[14],o.value,b[15]].join("")
}f.shift();
y+=[b[19],i.ME(b[20],i.MB,i.MN,null),b[21]].join("");
var u=(i.seq(0,i.MB(a[7]))||[]);
f.unshift({i:null});
for(var t=1,n=u.length,o;
t<=n;
t++){f[0]["i"]=o=u[t-1];
y+=[b[11],i.F.entities(o.value),b[12]].join("");
if((i.MJ(i.MB(a[8])==o.value))){y+=b[13]
}y+=[b[14],o.value,b[15]].join("")
}f.shift();
y+=b[22];
if(i.MD(a[11])){y+=b[23];
if((i.MJ(i.MB(a[8])==1))){y+=i.ME(b[24],i.MB,i.MN,null)
}else{y+=i.ME(b[25],i.MB,i.MN,null)
}y+=b[26];
i.MN("fe_child_i",0);
y+=b[7];
var u=(i.MC(a[1])||[]);
...
var x=n;
var k=v;
var u=((r||{})["b_children_ages"]||[]);
f.unshift({fe_child_age:null});
for(var t=1,n=u.length,v;
t<=n;
t++){f[0]["fe_child_age"]=v=u[t-1];
y+=[b[28],i.F.entities(i.MC(a[9])),b[29]].join("");
var p=t;
var j=u;
var w=n;
var m=o;
var u=(i.seq(0,i.MB(a[10]))||[]);
f.unshift({i:null});
for(var t=1,n=u.length,o;
t<=n;
t++){f[0]["i"]=o=u[t-1];
y+=[b[30],i.F.entities(o.value),b[12]].join("");
if(((i.MJ(v+""!==""))&&(i.MJ(v==o.value)))){y+=b[13]
}y+=[b[14],o.value,b[31]].join("")
}f.shift();
t=p;
u=j;
n=w;
o=m;
y+=b[32];
i.MN("fe_child_i",(i.MI(i.MB(a[9]))+i.MI(1)));
y+=b[27]
}f.shift();
t=q;
u=l;
