...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang3_0.js':{v:3520},'index.css':{v:27},'index.js':{v:33},'ui_controls.css':{v:64},'ui_controls.js':{v:186}
}
</script>

<link rel="stylesheet" type="text/css" href="/css/al/common.css?505" />
...
<div><div class="scroll_fix">
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login" onsubmit="if (vklogin) {return true} else {quick_login();return false;}">
    ...
    <input type="hidden" name="lg_h" value="2568b9b05f9e27f632" />
  ...
  <a class="bnav_a" href="/support?act=new" onclick="return nav.go(this, event);" style="display: none;">help</a>
...
<p id="footer">
  <div class="copy_lang"><a href="/about">VK</a> &copy; 2015 <a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 16, hash: '08953e7bde952575e8'})">Fran&#231;ais</a><a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 3, hash: '08953e7bde952575e8'})">English</a><a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 0, hash: '08953e7bde952575e8'})">Ðóññêèé</a><a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 1, hash: '08953e7bde952575e8'})">Óêðà¿íñüêà</a><a class="bnav_lang" onclick="if (vk.al) { showBox('lang.php', {act: 'lang_dialog', all: 1}, {params: {dark: true, bodyStyle: 'padding: 0px'}, noreload: true}); } else { changeLang(1); } return false;">all languages »</a></div>
