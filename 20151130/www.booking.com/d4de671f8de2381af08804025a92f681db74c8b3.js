...
if(B.env.cookie_warning&&!f.cookie("cookie_notice_shown")){var h=this,e=f("#cookie_warning"),c=function(){if(!B.env.cookie_warning_excluded_country){f(document).unbind("click.cookieMessage")
...
$(".uc_language a.popover_trigger").click(function(){h()
});
...
$.get(booking.env.b_languages_url,function(o){$("#current_language").html(o);
...
if(B.env.b_run_OQQSSXWe){var p=B.require("searchresults/events");
...
G.unshift({b_type:d[130],b_genius_img:d[107]});
r=M(r);
G.shift();
r+=d[59];
return r
...
G.unshift({b_color:d[108],b_tooltip:d[109],b_size:d[110],b_classname:d[111]});
H=K(H);
G.shift();
...
G.unshift({b_tooltip:d[109],b_classname:d[140],b_ge_freebies:d[36],b_ge_discount:d[36]});
H=o(H);
G.shift();
