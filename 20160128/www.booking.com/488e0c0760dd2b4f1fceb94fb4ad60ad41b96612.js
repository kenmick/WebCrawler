...
y.on("mouseleave",".iw-overlay-hotel .mini, .iw-overlay-hotel-current .mini",function(){var P=k(this).data("marker-id"),O=M.getMarker(P);
if(!(P&&O)){return
...
y.on("click",".iw-overlay-hotel .mini, .iw-overlay-hotel-current .mini",function(){var P=k(this).data("marker-id"),O=M.getMarker(P);
if(!(P&&O)){return
...
g.delegate(".js-map-hotel__link","click",function(){f.map.trigger("iw-click-title")
}).delegate(".js-map-hotel__button","click",function(){f.map.trigger("iw-click-button")
})
};
...
b.prototype.updateRender=function(h){this.fixHotelUrl(h);
...
b.prototype.clearMarkerId=function(){this.set("markerIdList");
...
return r
}function n(r){if((g.MJ(g.MC(a[102]))&&(g.MJ(/^(searchresults|hotel)$/.test(g.ATLAS_ENV("action")))))){r+=b[3];
...
return r
}function m(r){if((g.MJ(g.MC(a[102]))&&(g.MJ(/^(searchresults|hotel)$/.test(g.ATLAS_ENV("action")))))){r+=b[3];
g.MN(a[101],g.MC(a[102]));
r+=b[6]
}r+=b[2];
if((g.MJ(g.MC(a[104]))&&(g.MJ(g.ATLAS_STAGE("ebcBUYSaBaeJBZNSTHT"))&&g.MJ(g.ATLAS_TRACK("ebcBUYSaBaeJBZNSTHT"))))){r+=b[3];
