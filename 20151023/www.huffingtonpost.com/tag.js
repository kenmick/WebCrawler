...
define("js/fo/native/iframe/element/material/landing_iframe", [ "require", "exports", "util/str", "elements", "notifications", "lib/jquery", "util/informer" ], function(t, e, o, r, n, i, s) {
    function a(t) {
    ...
    var l = i.jQuery, c = function(t) {
        function e(e, o, r) {
            ...
            this.AcceptedNotifications = [ n.NotificationKind.FULLSCREEN_MATERIAL, n.NotificationKind.SMALLSCREEN_MATERIAL, n.NotificationKind.INITSCREEN_MATERIAL ];
        }
        return __extends(e, t), e.prototype.GetComponentName = function() {
            ...
            if (!this.secondaryUrlsLoopStarted) {
                if (!this.secondaryUrlsLoopInitialized) {
                    this.secondaryUrlsCurrentUrls = a(this.content.SecondaryUrls);
            ...
            this.elIframeContainer = l("<div></div>"), this.elIframeContainer.addClass("material material_landing_iframe");
            var t = l("<iframe></iframe>");
            ...
            this.ElContainer.html("").append(this.elIframeContainer), this.Notify(n.NotificationKind.MATERIAL_DISPLAYED), 
            this.Notify(n.NotificationKind.MATERIAL_STARTED);
        }, e.prototype.Receive = function(e) {
            switch (t.prototype.Receive.call(this, e), e.Kind) {
              case n.NotificationKind.FULLSCREEN_MATERIAL:
                var o = this.ElContainer[0];
              ...
              case n.NotificationKind.INITSCREEN_MATERIAL:
                this.StopSecondaryUrlsLoop(), this.ResetIframe();
                break;

              case n.NotificationKind.SMALLSCREEN_MATERIAL:
