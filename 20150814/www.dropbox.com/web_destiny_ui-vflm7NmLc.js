...
define(['external/modernizr', 'jquery', 'modules/core/browser', 'modules/core/html', 'modules/core/i18n', 'modules/core/notify', 'modules/core/uri', 'modules/clean/components/ajax_form', 'modules/clean/em_string', 'modules/clean/gandalf_util', 'modules/clean/unity/features', 'modules/clean/unity/features/destiny_logger', 'modules/clean/unity/features/web_destiny'], function(Modernizr, $j, Browser, HTML, _arg, Notify, URI, AjaxForm, Emstring, GandalfUtil, UnityFeatures, DestinyLogger, WebDestiny) {
