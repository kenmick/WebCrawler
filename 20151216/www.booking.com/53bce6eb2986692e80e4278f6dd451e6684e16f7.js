...
B.when({condition:B.env.b_site_type_id==1,events:["ready"]}).require(["et","search/destination/service-booking"],function(e,f){var d="PVdIZKZPHcNVBUKcaZdFOLRe";
var c=e.track(d);
if(c){f.on("beforeajax",function(g,h){h.e_pdbd=c
});
f.on("afterajax",function(g,h){if(h&&h.__hit_new_model_badge__){e.stage(d,1)
}})
}});
...
B.when({condition:B.env.b_site_type_id==1,events:["ready"]}).require(["et","search/destination/service-booking"],function(e,f){var d="PVcLcDODAKWUMKKe";
var c=e.track(d);
...
B.when({condition:B.env.b_site_type_id==3,events:["ready"]}).require(["et","search/destination/service-booking"],function(e,f){var d="PADPQfQMTMGCCYEIC";
var c=e.track(d);
if(c){f.on("beforeajax",function(g,h){h.e_hact=c
});
f.on("afterajax",function(g,h){if(h&&h.theme){e.stage(d,1)
...
B.when({condition:B.env.b_site_type_id==2,events:["ready"]}).require(["et","search/destination/service-booking"],function(e,f){var d="PVBEcLcDODAKWUMKKe";
var c=e.track(d);
if(c){f.on("beforeajax",function(g,h){h.e_hact=c
});
f.on("afterajax",function(g,h){if(h&&h.theme){e.stage(d,1)
