...
if(r&&q){q.b_type=r;
if(typeof this.updateMarkerStates==="function"){this.updateMarkerStates(q)
}if(q.b_states.overlay){this.Interface.setMixedMarkerType(s,{content:this.getMarkerContent(q),zIndex:this.getMarkerZIndex(q)})
