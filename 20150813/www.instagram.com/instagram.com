...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js not-logged-in "> <!--<![endif]-->
  ...
  WebFontConfig = {
    custom: {
      ...
      urls: ['//instagramstatic-a.akamaihd.net/bluebar/61d683a/cache/styles/fonts.css']
    }
  };
</script>
<script src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/scripts/webfont.js" type="text/javascript" async></script>
...
<meta property="og:image" content="https://instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/apple-touch-icon-144x144-precomposed.png" />
...
<link href="https://instagram.com/?hl=mr" rel="alternate" hreflang="mr" />
        ...
        <link rel="icon" sizes="any" mask href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/favicon.svg">
        <meta name="theme-color" content="#125688">
        <link rel="Shortcut Icon" type="image/x-icon" href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/favicon.ico">
    
    
        <link rel="apple-touch-icon-precomposed" href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/apple-touch-icon-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/apple-touch-icon-72x72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/ico/apple-touch-icon-144x144-precomposed.png">
    
    
    <link href="//instagramstatic-a.akamaihd.net/bluebar/61d683a/cache/styles/public/public-main.css" type="text/css" rel="stylesheet"></link>

    
    
    <script src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/cache/bundles/en_US_SplashPage.js" type="text/javascript"></script>
        ...
        <div class="home-content">
            <div class="home-phones" id="iphone">
                <div id="iphone-overlay">
                    <img src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/homepage/screenshot1.jpg" class="active" />
                    <img src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/homepage/screenshot2.jpg" />
                    <img src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/homepage/screenshot3.jpg" />
                    <img src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/homepage/screenshot4.jpg" />
                    <img src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/homepage/screenshot5.jpg" />
                </div>
  ...
  <img
    ...
    src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/appstore-install-badges/badge_ios_english-en.png"
  />
</a>
                                <a
  class="platform-badge"
  ...
  <img
    ...
    class="platform-badge-image"
    src="//instagramstatic-a.akamaihd.net/bluebar/61d683a/images/appstore-install-badges/english_get.png"
  />
</a>
                            </div>
                        </div>
    ...
    <script src=//instagramstatic-a.akamaihd.net/bluebar/61d683a/scripts/polyfills/es5-shim.min.js></script>
<script src=//instagramstatic-a.akamaihd.net/bluebar/61d683a/scripts/polyfills/es5-sham.min.js></script>
<script type="text/javascript">window._sharedData = {"static_root":"\/\/instagramstatic-a.akamaihd.net\/bluebar\/61d683a","entry_data":{},"hostname":"instagram.com","platform":{"is_touch":false,"app_platform":"web"},"qe":{"su":false},"display_properties_server_guess":{"viewport_width":360,"pixel_ratio":1.5},"country_code":"FR","language_code":"en","gatekeepers":{"tr":false},"config":{"dismiss_app_install_banner_until":null,"viewer":null,"csrf_token":"54714402e0ccdce3d71ad8c2085f2677"},"environment_switcher_visible_server_guess":true};</script>
