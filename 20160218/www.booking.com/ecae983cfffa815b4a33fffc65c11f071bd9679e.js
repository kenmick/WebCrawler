...
}function q(){if(B.atlas.getVariant("HMDCceGECAFSdfCMYEZUVBC")===1){g="//r-ec.bstatic.com/static/img/map/hotel_sr/2d10bbd94863a15c3c1321c824d8a08749e13e97.png";
...
i=o.height();
h=o.width();
g.css({left:k.x,top:k.y}).animate({left:j.left,top:j.top},200);
o.css({width:0,height:0}).animate({width:h,height:i},200)
