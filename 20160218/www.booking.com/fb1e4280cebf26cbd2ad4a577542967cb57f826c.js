...
var k=function(){if(B.env.b_action==="searchresults"&&$(".sr_item--highlighted").hasClass("soldout_property")&&B.et.track("OLcRQZCBQcDMJaXe")){return
...
e.on("afterajax",function(f,g){d.stage(c,1);
...
B.when({condition:!B.env.b_is_bbtool_user,events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PVdIdJXIVIQHYO";
e.on("beforeajax",function(f,h){var g=d.track(c);
h.e_msm=g?1:0
});
e.on("afterajax",function(f,g){d.stage(c,1)
...
B.define("profile/social/social-connect-dialog/social-connect-dialog",function(d,c,e){var f=d("profile/social/social-connect/social-connect");
...
B.when({condition:B.env.b_run_google_connect,experiment:"MRLLJZCeMJYGO"}).run(function(){B.require("profile/social/social-connect-dialog/social-connect-dialog").onload()
});
