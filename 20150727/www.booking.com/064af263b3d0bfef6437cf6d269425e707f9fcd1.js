...
f.exports=B.require("component").extend({init:function(){var l=this;
var m=booking[sNSStartup].wlData;
var j=this.$el.find(".js-lists-header-button"),k="lists-header-button--flash",h=[m.EVENTS.EDITHOTEL];
B.eventEmitter.bind(h.join(" "),function(n,q){j.addClass(k);
setTimeout(function(){j.removeClass(k)
},600);
if(B.track.getVariant("PcVBcadffQDBeKe")){var p=l.$el.find(".lists-header-button__count"),o=Number(p.text());
p.text(o+(q.params.new_state?1:-1))
}});
c.on("liststore:loading",function(n){$(".lists-header-button").toggleClass("lists-header-button--loading",n);
if(g.isEnabled()){$(".js-uc-listview-lightbox").toggleClass("uc-listview-loading",n)
}})
}})
});
...
$("#login_redesign").click(function(){if($(this).hasClass("bp_bs2_signin_transition")){$(".bs2_inline_signin_box").slideToggle(200)
}else{$(".bs2_inline_signin_box").toggle()
...
booking.jstmpl("language_menu",(function(){var d=["\n    ","\n        ",'\n    \u003cdiv class="select_foldout_wrap"\u003e\n        \u003cp\u003e',"\u003c/p\u003e\n        ",'\n            \u003cul class="language_flags"\u003e\n                ',' \u003cli class="lang_'," selected_country",'" data-lang="','"\u003e \u003ca href="','" class="no_target_blank"\u003e \u003cspan class="selsymbol"\u003e\u003cspan class="flag_16 sflag slang-','"\u003e \u003c/span\u003e\u003c/span\u003e \u003cspan class="seldescription"\u003e','\u003c/span\u003e \u003ci class="loading_indicator"\u003e\u003c/i\u003e \u003c/a\u003e \u003c/li\u003e ',"\n            \u003c/ul\u003e\n        ","\n    \u003c/div\u003e\n","\n"],c=["title","columns","lang","lang_dropdown_top_langs","popular_languages","lang_dropdown_all_langs","languages"],g,f,e;
...
if(n.MD(c[4])){l+=d[1];
h.unshift({title:n.MB(c[3]),columns:n.MB(c[4])});
o();
h.shift();
l+=d[0]
}l+=d[0];
