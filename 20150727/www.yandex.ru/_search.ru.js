...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("AiZ11F9KlQ6ID9w3iAEoxgQSsBs")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return ve(t);if("auto-content"===e)return"auth"===n?Me(t):$e(t);if("action"===e)return"auth"===n?!!s==!1?we(t):$e(t):$e(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?xe(t):"ticker"===e?Be(t):$e(t)}return $e(t)
}if("mix"===e)return ge(t);if(""===e)return De(t);if("value"===e){var e=n;return"input"===e?Te(t):"tumbler"===e?"option"===s?je(t):$e(t):$e(t)
}if("getLive"===e)return"input"===n?!!s==!1?Le(t):$e(t):$e(t);if("live"===e)return"input"===n?!!s==!1?Ne(t):$e(t):$e(t);
if("public-params"===e){if("i-global"===n){var e=s;return"areScriptsAsync"===e||"isPageLoadCounter"===e||"geoanswer"===e||"isCounterHeights"===e||"serpRequestExtraParams"===e||"isCounterSerpview"===e||"lr"===e||"ajaxUrl"===e||"framebuster"===e||"shownResult"===e||"pg"===e||"cache"===e||"nahodki"===e||"pref-ajax"===e||"tld"===e||"maxAjaxUrlLength"===e||"reqid"===e||"nonce"===e||"query"===e||"pid"===e?!0:!s==!1?{id:1,lang:1,tld:1,"content-region":1,"user-region":1,login:1,displayName:1,index:1,yandexuid:1,"passport-host":1,"pass-host":1,"passport-msg":1,"static-host":1,"lego-static-host":1,"social-host":1,clck:1,"click-host":1,"export-host":1,"i-host":1,"social-retpath":1,"lego-path":1,sid:1,retpath:1,uid:1}[s]||!1:$e(t)
}return $e(t)}return"default"===e?L(t):"env"===e?"i-global"===n?Re(t):$e(t):"content"===e?I(t):"jsAttr"===e?qe(t):"tag"===e?C(t):"cls"===e?Fe(t):"bem"===e?Ce(t):$e(t)
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var _,g;return{method:"POST",action:t.ctx.url||(_=i,i="action",g=we(t),i=_,g),role:"form","aria-label":BEM.I18N("auth","auth")}
...
}function l(t){if(!(t.__$anflg31!==!0)==!1){if(!t.ctx.counter==!1){if(!!s==!1){var e,i;return t.extend((e=t.__$anflg31,t.__$anflg31=!0,i=l(t),t.__$anflg31=e,i),{onmousedown:t.ctx.counter})
}return d(t)}return d(t)}return d(t)}function d(t){if(!(t.__$anflg30!==!0)==!1){if(!!s==!1){if(!!t.ctx.url==!1){var e,i,n=t.ctx,o=(e=t.__$anflg30,t.__$anflg30=!0,i=l(t),t.__$anflg30=e,i),r={type:n.type||"button",name:n.name,value:n.value};
return t.extend(o,r)}return p(t)}return p(t)}return p(t)}function p(t){if(!(t.__$anflg29!==!0)==!1){if(!t.ctx.url==!1){if(!!s==!1){var e,i,n=t.ctx,o=(e=t.__$anflg29,t.__$anflg29=!0,i=l(t),t.__$anflg29=e,i),r={href:n.url,target:n.target};
return t.extend(o,r)}return f(t)}return f(t)}return f(t)}function f(t){if(!!s==!1){var e=t.ctx,i={role:"button"};
return i.tabindex=e.tabindex,i}return B(t)}function m(t){if(!(t.__$anflg22!==!0)==!1){if(!!s==!1){var e,i,n=(e=t.__$anflg22,t.__$anflg22=!0,i=m(t),t.__$anflg22=e,i||{}),o=t.ctx;
return o.counter&&(n.onmousedown=o.counter),n}return _(t)}return _(t)}function _(t){return!!s==!1?g(t):B(t)
}function g(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Ie(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
return h}function b(t){if(!(t.__$anflg17!==!0)==!1){var e,i,n=(e=t.__$anflg17,t.__$anflg17=!0,i=b(t),t.__$anflg17=e,i||{});
return n.role="option",n}return{id:t.generateId()}}function v(t){if(!(t.__$anflg16!==!0)==!1){var e,i,n=(e=t.__$anflg16,t.__$anflg16=!0,i=v(t),t.__$anflg16=e,i||{});
...
}),n)if(t.isSimple(n))s.href=n;else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,Ie(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
}else s.role="button",s.tabindex||(s.tabindex=0);return s}function B(){return void 0}function C(t){var e=n;
if("b-icon"===e)return!!s==!1?"img":D(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":S(t):S(t);if("input"===e){var e=s;
return"box"===e?"span":"hint"===e?"label":"control"===e?"input":"ahead-hint"===e||"ahead-filler"===e?"span":!!s==!1?"span":D(t)
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":D(t)}if("checkbox"===e){var e=s;
return"control"===e?"input":"label"===e?"label":!!s==!1?"span":D(t)}if("b-link"===e)return!!s==!1?"a":D(t);
if("suggest2"===e){var e=s;return"content"===e?!(r&&"normal"===r.theme)==!1?"ul":D(t):"a11y"===e?"span":"items"===e?"ul":D(t)
}if("suggest2-item"===e){var e=s;return"icon"===e?"span":"link"===e?"a":"bullet"===e?"span":"highlight"===e?"b":"fact"===e?"span":"text"===e?t.ctx.tag||"span":!!s==!1?"li":D(t)
}if("select"===e){var e=s;return"text"===e?"span":"option-group"===e?"optgroup":"option"===e?"option":!!s==!1?"span":D(t)
}if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":D(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":D(t)}if("link"===e)return"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":D(t);
if("ticker"===e){var e=s;return"value"===e||"text"===e?"span":D(t)}return D(t)}function S(t){return!!s==!1?"button":D(t)
}function D(){return void 0}function I(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:j(t);
if("checkbox"===e)return!!s==!1?[{elem:"box",tag:"span",elemMods:"yes"===r.checked?{checked:"yes"}:"",content:[{elem:"control",attrs:t.ctx.checkboxAttrs||{}},{elem:"tick",tag:"i"}]},t.ctx.content]:j(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:j(t);if("input"===e){var e=s;
return"box"===e?P(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:j(t)}if("auth"===e){var e=s;
...
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=xe(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:j(t)
}if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Be(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):j(t)
}return"suggest2-item"===e?!(r&&"link"===r.interact)==!1?!!s==!1?{elem:"link",url:t.ctx.url,target:t.ctx.target||"_blank",content:t.ctx.content}:O(t):O(t):"popup"===e?!!s==!1?[{elem:"under",mods:t.ctx.underMods},t.ctx.content]:j(t):"tumbler"===e?"box"===s?[{elem:"sticker",elemMods:{position:"left"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","on")}},{elem:"sticker",elemMods:{position:"right"},content:{elem:"sticker-label",content:BEM.I18N("tumbler","off")}},{elem:"button"}]:!(void 0===t.ctx.content)==!1?!!s==!1?[{elem:"option",side:"left"},{elem:"option",side:"right"}]:A(t):A(t):j(t)
}function P(t){if(!(t.__$anflg27!==!0)==!1){if(!!r.clear==!1){var e,i;return[(e=t.__$anflg27,t.__$anflg27=!0,i=P(t),t.__$anflg27=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
}return j(t)}return j(t)}function T(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Me(t),i=e,n),{elem:"retpath"}]
}return j(t)}function O(e){var i=s;return"fact"===i?!(r&&"nav"===r.type)==!1?e.xmlEscape(e.ctx.content):[{block:"suggest2",elem:"a11y",content:BEM.I18N("suggest2-item","quick-answer")+": "},e.xmlEscape(e.ctx.content)]:"highlight"===i?e.xmlEscape(e.ctx.content):"text"===i?Array.isArray(e.ctx.content)?e.ctx.content.map(function(t){return"string"==typeof t?this.xmlEscape(t):t
},t(e)):e.xmlEscape(e.ctx.content):j(e)}function A(t){if(!(t._.isArray(t.ctx.content)&&1===t.ctx.content.length)==!1){var e=t.ctx.content;
return"left"!==e[0].side?[{elem:"option",side:"left"},e]:[e,{elem:"option",side:"right"}]}return j(t)
}function j(t){return t.ctx.content}function L(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg33!==!0)==!1?N(t):$e(t):$e(t);
if("checkbox"===e)return R(t);if("button"===e)return F(t);if("input"===e)return $(t);if("auth"===e)return H(t);
if("suggest2-item"===e){var e=s;return"icon"===e?G(t):"fact"===e?Z(t):$e(t)}return"select"===e?J(t):"popup"===e?oe(t):"tumbler"===e?ae(t):"i-global"===e?me(t):$e(t)
}function N(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));var s=t.__$anflg33;
t.__$anflg33=!0;var o=t.ctx;t.ctx={block:"popup",mix:n,mods:e.mods,underMods:e.underMods,attrs:e.attrs,js:e.js,content:[{elem:"tail"},{elem:"content",content:e.content}]};
var r=i;i="",Ie(t),t.ctx=o,i=r,t.__$anflg33=s}function R(t){return!(t.__$anflg32!==!0)==!1?!!s==!1?q(t):$e(t):$e(t)
}function q(t){var e=t.ctx,i=e.checkboxAttrs||{},n=i.id||t.generateId(),s=e.mods||{};s.theme=s.theme||"normal";
var o=t.__$anflg32;t.__$anflg32=!0;var r=t._checkboxAttrs;t._checkboxAttrs=i.id?i:{id:"id"+n};var a=t._labelId;
t._labelId="label"+n;var c=t.ctx,h=c.mods;c.mods=s,R(t),t._checkboxAttrs=r,t._labelId=a,c.mods=h,t.__$anflg32=o
}function F(t){if(!(t.__$anflg28!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg28;return t.__$anflg28=!0,F(t),t.__$anflg28=e,void 0}return $e(t)}return $e(t)}function $(t){var e=s;
if("hint"===e)return!(t.__$anflg26!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?V(t):U(t):U(t):U(t);if("control"===e){if(!(t.__$anflg25!==!0)==!1){var n=t.__$anflg25;
t.__$anflg25=!0;var o=t.ctx;t.ctx={elem:"box",content:t.ctx};var r=i;return i="",Ie(t),t.ctx=o,i=r,t.__$anflg25=n,void 0
}return U(t)}return U(t)}function V(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg26,t.__$anflg26=!0,s=t.ctx,t.ctx=a,o=i,i="",r=Ie(t),t.ctx=s,i=o,n=r,t.__$anflg26=e,n
}function U(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?z(t):$e(t):$e(t)}function z(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Te(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Le(t),i=o,a);
...
t._live=l;var k=t.ctx,M=k.mods;k.mods=u,$(t),t._inputId=p,t._labelId=f,t._hintId=m,t._name=_,t._value=g,t._inputLink=b,t._disabled=v,t._live=y,k.mods=M,t.__$anflg12=d
}function H(t){return"retpath"===s?W(t):K(t)}function W(t){if(!(t.__$anflg24!==!0)==!1){var e=t.__$anflg24;
t.__$anflg24=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,W(t),t._retpath=i,t.__$anflg24=e,void 0
}return K(t)}function K(t){return!(t.__$anflg23!==!0)==!1?!!s==!1?Q(t):$e(t):$e(t)}function Q(t){var e,i,n,s;
...
var o=t.__$anflg23;t.__$anflg23=!0;var r=t._passportHost;t._passportHost=e;var a=t._paramRetpath;t._paramRetpath=i?"&retpath="+encodeURIComponent(i):"";
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",H(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg23=o
}function G(t){if(!(t.__$anflg21!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg21;t.__$anflg21=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),G(t),i.weather=n,t.__$anflg21=e,void 0
}return X(t)}return X(t)}function X(t){return!(t.__$anflg20!==!0)==!1?Y(t):$e(t)}function Y(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg20;t.__$anflg20=!0,G(t),t.__$anflg20=i}function Z(t){if(!(t.__$anflg19!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg19;return t.__$anflg19=!0,Z(t),t.__$anflg19=e,void 0}return $e(t)}return $e(t)}function J(t){return"group"===s?te(t):ee(t)
}function te(t){if(!(t.__$anflg18!==!0)==!1){var e=t.__$anflg18;t.__$anflg18=!0;var i=t._labelId;return t._labelId=t.generateId(),te(t),t._labelId=i,t.__$anflg18=e,void 0
}return ee(t)}function ee(t){return!(t.__$anflg14!==!0&&t.__$anflg15!==!0)==!1?!!s==!1?ie(t):ne(t):ne(t)
}function ie(t){var e,n,s,o,r,a,c,h=t.ctx,u=(e=i,i="js",n=ye(t),i=e,n||{}).live;if(u){var l=h.content.filter(function(t){return"control"===t.elem
...
},p=d(l);return p||(p=l[0],"option-group"===p.elem&&(p=p.content[0])),s=t.__$anflg14,t.__$anflg14=!0,r=t._initValue,t._initValue=p.attrs.value,a=t._initText,t._initText=p.content,c=J(t),t._initValue=r,t._initText=a,o=c,t.__$anflg14=s,o
}}var f=t.__$anflg15;t.__$anflg15=!0,J(t),t.__$anflg15=f}function ne(t){return!(t.__$anflg13!==!0)==!1?!!s==!1?se(t):$e(t):$e(t)
}function se(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg13;t.__$anflg13=!0;var o=t._controlAttrs;
t._controlAttrs={id:i,name:e.name||i};var a=t._formSelect;t._formSelect={block:n,mods:r,tabindex:e.tabindex},J(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg13=s
}function oe(t){return!!t._popupDefaults==!1?!!s==!1?re(t):$e(t):$e(t)}function re(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,oe(t),t._popupDefaults=n
}function ae(t){if("option"===s){if("left"===t.ctx.side){if(!(t.__$anflg9!==!0)==!1){var e=t.__$anflg9;
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Ie(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
}return ce(t)}return ce(t)}return ue(t)}function ce(t){return!(t.__$anflg8!==!0)==!1?he(t):ue(t)}function he(t){var e,n,s=(e=i,i="value",n=je(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",Ie(t),t.ctx=r,i=a,t.__$anflg8=o}function ue(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",ae(t),t._disabled=i,t.__$anflg6=e,void 0
}return le(t)}return le(t)}return le(t)}function le(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",ae(t),t._checked=i,t.__$anflg5=e,void 0}return de(t)
}return de(t)}return de(t)}function de(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),ae(t),i.mods=n,t.__$anflg4=e,void 0
}return pe(t)}return pe(t)}return pe(t)}function pe(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?fe(t):$e(t):$e(t)
}function fe(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null,o=t.ctx.content;o&&o.length>0&&(s="left"===t.ctx.content[0].side?i:n);
var r=t.__$anflg3;t.__$anflg3=!0;var a=t._name;t._name=t.ctx.name||(t.ctx.name=e);var c=t._leftId;t._leftId=i;
var h=t._rightId;t._rightId=n;var u=t._sideId;t._sideId=s,ae(t),t._name=a,t._leftId=c,t._rightId=h,t._sideId=u,t.__$anflg3=r
}function me(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?_e(t):$e(t)
}function _e(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function ge(t){var e=n;if("dropdown"===e)return!!s==!1?[{mods:{action:"closed"}}]:be(t);
if("notice"===e)return"count"===s?!!t.ctx.url==!1?[{elem:"plain"}]:be(t):be(t);if("ticker"===e)return"text"===s?[{block:"a11y-hidden"}]:be(t);
if("suggest2-item"===e)return"text"===s?!(r&&"link"===r.interact)==!1?!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:be(t):be(t):be(t);
if("suggest2"===e)return!!s==!1?[{block:"suggest2-detect",js:!0}]:be(t);if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return be(t)}return"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:be(t):be(t)
}function be(){return void 0}function ve(t){var e=n;return"dropdown"===e?!!s==!1?!0:ke(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):ke(t):"button"===e||"auth"===e||"suggest2-item"===e||"suggest2"===e?!!s==!1?!0:ke(t):"select"===e?!!s==!1?ye(t):ke(t):"input"===e?!!s==!1?{live:t._live}:ke(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):ke(t):"link"===e?!t.ctx.tabindex==!1?!!s==!1?{origTabindex:t.ctx.tabindex}:ke(t):ke(t):ke(t)
}function ye(t){return t.extend({live:!1},t.ctx.js)}function ke(){return void 0}function Me(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Ee(t):Ee(t)
}function Ee(t){return!!s==!1?[]:$e(t)}function we(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function xe(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function Be(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Ce(t){return"suggest2-item"===n?"highlight"===s?!1:Se(t):Se(t)}function Se(){return void 0}function De(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Ye(t),void 0):Ie(t):Ie(t):Ie(t)
}function Ie(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?Pe(t):$e(t):$e(t)}function Pe(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=me(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",u=Re(t),i=c,n=h,u),m=t.__$anflg1;t.__$anflg1=!0;var _=t["i-global"];
t["i-global"]=t.extend(d,f),De(t),t["i-global"]=_,t.__$anflg1=m}function Te(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Oe(t):Oe(t)
}function Oe(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Ie(t),t._buf=n,i=o,e.join("")
}return Ae(t)}return Ae(t)}function Ae(t){return!!s==!1?"":$e(t)}function je(t){return t.ctx.value||"left"!==t.ctx.side
}function Le(t){var e,n,s=(e=i,i="live",n=Ne(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function Ne(){return!1}function Re(t){return!!s==!1?{}:$e(t)}function qe(){return void 0}function Fe(){return void 0
}function $e(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Ve(t):Ue(t):Ue(t):Ue(t)}function Ve(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(Ye,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function Ue(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?ze(t):He(t):He(t):He(t)
}function ze(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}function He(t){var e=i;if("default"===e)return We(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?Ke(t):Qe(t)
}return Ge(t)}function We(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,S,D,P,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=C(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,N;
n&&A.js!==!1&&(h=i,i="js",l=ve(t),i=h,N=l,N=N?t._.extend(A.js,N===!0?{}:N):A.js===!0?{}:A.js,N&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=N)),j.push("<",T);
var R=(d=i,i="bem",p=Ce(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var q=(f=i,i="cls",m=Fe(t),i=f,m);q||(q=A.cls);var F=A.block&&L&&!A.elem;if(R||q){if(j.push(' class="'),R){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var $=(_=i,i="mix",g=ge(t),i=_,g);if(A.mix&&($=$?[].concat($,A.mix):A.mix),$){var V={};V[e(n,s)]=!0,t._.isArray($)||($=[$]);
for(var U=0;U<$.length;U++){var z=$[U];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,Q=z.mods||r,G=z.elemMods||{};
if(H&&j.push(" "),O.INTERNAL[H?"buildClasses":"buildModsClasses"](W,z.elem||z._elem||(z.block?void 0:s),z.elemMods||z.mods,j),z.js&&((L||(L={}))[O.INTERNAL.buildClass(W,z.elem)]=z.js===!0?{}:z.js,F||(F=W&&!z.elem)),H&&!V[e(W,K)]){V[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=ge(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&V[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,$.splice(U+1,0,Z))}}}}}}q&&j.push(R?" ":"",q),F&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=qe(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
}var te=(B=i,i="attrs",S=u(t),i=B,S);if(te=t._.extend(te,A.attrs)){var ee;for(ee in te)void 0!==te[ee]&&j.push(" ",ee,'="',t._.attrEscape(te[ee]),'"')
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(D=i,i="content",P=I(t),i=D,P);if(ie||0===ie){var R=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=R?1:t.position;var oe=t._listLength;t._listLength=R?1:t._listLength;
var re=t.ctx;t.ctx=ie;var ae=i;i="",De(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}T&&j.push("</",T,">")}}function Ke(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,De(t),t.ctx=a}o||(t.position=s)}function Qe(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
var m=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,L(t),i=h,t._links=u,n=l,t._currBlock=d,s=p,r=f,o=m
}function Ge(){throw new Error(this)}function Xe(t){return Ye(t||this)}function Ye(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(Xe);
...
}}),_borschik("IBsg3T_ytgR-W1a-nkVbhmJXUQY"),_borschik("ZOlD_vpvY-lz6FnJfD1F07uPDr8")&&BEM.DOM.decl("i-services",{onSetMod:{js:function(){this._searchInput=(this.findBlockInside("search")||this.findBlockInside("search2")).findBlockInside("input")
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",D="always",I="height",P="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",N=i(x,B)+i(O,1)+i(I,1)+i("id",L),R=!1;
...
}catch(I){}}return d=f?g?'<div style="'+B+'"><'+v+N+i("src",x)+i(P,T)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+N+">"+e("movie",x):"<"+v+N+i("type",w)+i("data",x)+">")+e(P,T)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
};var q=this,F=arguments.callee.load=function(t){var e,i;t.mode?(e="00",i="kfc"):e="07",q.replaceWith(l.ya_fc_external("07_2",e,"01",i))
};q.hasClass("i-flashcookie_autoload_no")||F(t)};Lego.block["i-flashcookie"]=function(i){var n=this.hasClass("i-flashcookie_type_inline")?e:t;
...
t.execute()}}),_borschik("-g8syBEA7J5pCfbit0cJ0MvWiXs")&&BEM.HTML.decl("b-link",{onBlock:function(t){t.tag("a").attr("href",t.param("url"));
...
}}}),_borschik("NA-QJ2YuFyCxRU40NmS3Z2wB2l0")&&BEM.decl("install-chrome-webstore-item-action",{execute:function(){var t=this.params.id&&BEM.blocks["chrome-webstore-item_type_"+this.params.id]?BEM.create("chrome-webstore-item_type_"+this.params.id,this.params.webItem):BEM.create("chrome-webstore-item",this.params.webItem);
...
}),!1}}),_borschik("odlHPC881r0zVnCPIwGcOZKUNYk")&&BEM.DOM.decl("video",{onSetMod:{js:function(){var t=this.findBlockOn("serp-item"),e=this.findBlockInside("video-player"),i=t.params.preview&&t.params.preview.common?"common":"video";
...
}}),_borschik("B2IESVNd9q2A41MCAMLX14OrbxQ")&&BEM.DOM.decl("x-serp-item",{onSetMod:{js:function(){this.bindTo("click",this.onClick.bind(this))
}},onClick:function(t){if(!t.originalEvent.handled&&this.params.counter){var e=this.hasMod("checked","yes")?"checked":"unchecked";
BEM.blocks.counter.log(this.params.counter,{state:e})}}}),_borschik("Z5a90H0KSOhNy3SqT5zm9XnBIxU")&&BEM.DOM.decl("x-preview",{onSetMod:{js:function(){this.url=this.params.url,this.contentPreviewContainer=this.findContentPreviewContainer(),this.bindTo("click",this.onClick)
}},findContentPreviewContainer:function(){return this.findBlockOutside("b-page").findBlockInside("content-preview")
},onClick:function(t){t.originalEvent.handled||(this.contentPreviewContainer.isOpened()&&this.contentPreviewContainer.getUrl()===this.url?(!this.openTime||Date.now()-this.openTime>250)&&this.afterCurrentEvent(function(){this.contentPreviewContainer.close()
}):this.afterCurrentEvent(function(){if(!this.contentPreviewContainer.isOpened()||this.contentPreviewContainer.getUrl()!==this.url){var t=window.yaCounter30391147;
...
}).liveBindTo({modName:"pseudo",modVal:"yes"},"keyup",function(t){this._onKeyUp(t)})}}),_borschik("fkyQXTCdiJUWP-ks6P2aqLvaVHQ")&&BEM.DOM.decl("x-preview-checker",{onSetMod:{js:function(){this.url=this.params.url,this.control=this.findBlockOn(this.domElem,this.params.block),this.contentPreviewContainer=this.findContentPreviewContainer().on("opened",this.updateCheckedState,this).on("closed",this.updateCheckedState,this).on("loading",this.updateCheckedState,this).on("contentChanged",this.updateCheckedState,this)
}},findContentPreviewContainer:function(){return this.findBlockOutside("b-page").findBlockInside("content-preview")
...
},destruct:function(){this.contentPreviewContainer.un("opened",this.updateCheckedState,this).un("closed",this.updateCheckedState,this).un("loading",this.updateCheckedState,this).un("contentChanged",this.updateCheckedState,this),this.__base.apply(this,arguments)
}}),_borschik("JgXK822QSX_Eha0oDE96UEG-Vyw")&&BEM.DOM.decl("x-hover-preview",{onSetMod:{js:function(){this.url=this.params.url,this.contentPreviewContainer=this.findBlockOutside("b-page").findBlockInside("content-preview"),this.bindTo("mouseenter",this.onMouseEnter),this.bindTo("mouseleave",this.onMouseLeave)
...
}),jQuery.param(t)}},{live:!0}),_borschik("TY9ZhhqH1cBNpQSZZiUA-5uukms")&&BEM.DOM.decl("input",{onSetMod:{js:function(){this._val=this.elem("control").val()
...
},_showError:$.noop,_hideError:$.noop},{_instancesCount:0,BLOCKS:[]}),_borschik("OCzf8JAUR_XuP5m9gSaXOzjScyk")&&BEM.DOM.decl("serp",{onSetMod:{js:function(){this.__base.apply(this,arguments),this._requestChannel=BEM.channel("serp-request")
...
case m:this._params.height||this._$tableau.height(parseInt(i[1],10)+2*_);break;case f:this.close()}}}var s="https://yastatic.net",o="/tableau/tableau.html",r="tableau",a=r+"_opened",c=r+"_closed",h=r+"_device_",u=r+"__content",l=r+"__tail",d="tableau.",p=d+"ready",f=d+"close",m=d+"height",_=1,g=150,b="",v=!1,y=[],k={};
...
});i[o]=s}}),(t.host||s)+(t.path||o+"?"+e.param(i))},i.prototype._buildIframe=function(t){return e("<iframe/>",{"class":u,src:t,frameborder:0,allowtransparency:!0})
},i.prototype._buildTail=function(){return e("<div/>",{"class":l})},i.prototype._buildAndAppendTableau=function(t,i,n){return e("<div/>",{"class":[r,h+t.device,c].join(" "),css:{width:t.width+2*_,height:t.height&&t.height+2*_,zIndex:t.zIndex}}).append(n).append(i).appendTo("body")
...
}}(jQuery,jQuery.Tableau),_borschik("7_v7KShpFNf1hH-2D_JqkORp_kE")&&BEM.DOM.decl("progress",{update:function(t,e){return this.setMod("timing",e||"").domElem.css({width:0>=t?"0":t>=1?"100%":(100*t).toPrecision(2)+"%"}).css("width"),this
...
},e.lang(u),e}(new a)}(this,"undefined"==typeof BEM?{}:BEM),BEM.I18N.decl("auth",{auth:"ÐÐ²ÑÐ¾ÑÐ¸Ð·Ð°ÑÐ¸Ñ","fill-input":"ÐÐ°Ð¿Ð¾Ð»Ð½Ð¸ÑÐµ ÑÑÐ¾ Ð¿Ð¾Ð»Ðµ",login:"ÐÐ¾Ð³Ð¸Ð½",logon:"ÐÐ¾Ð¹ÑÐ¸",more:"ÐÑÑ",password:"ÐÐ°ÑÐ¾Ð»Ñ",permanent:"ÐÐ°Ð¿Ð¾Ð¼Ð½Ð¸ÑÑ Ð¼ÐµÐ½Ñ",register:"Ð ÐµÐ³Ð¸ÑÑÑÐ°ÑÐ¸Ñ",remember:"ÐÑÐ¿Ð¾Ð¼Ð½Ð¸ÑÑ Ð¿Ð°ÑÐ¾Ð»Ñ","social-log-in":"ÐÐ¾Ð¹ÑÐ¸ Ð¿ÑÐ¸ Ð¿Ð¾Ð¼Ð¾ÑÐ¸ ÑÐ¾ÑÐ¸Ð°Ð»ÑÐ½Ð¾Ð¹ ÑÐµÑÐ¸",temporary:"Ð§ÑÐ¶Ð¾Ð¹ ÐºÐ¾Ð¼Ð¿ÑÑÑÐµÑ","wrong-characters":"ÐÐµÐ´Ð¾Ð¿ÑÑÑÐ¸Ð¼ÑÐ¹ Ð²Ð²Ð¾Ð´","wrong-keyboard-layout":"Ð¡Ð¼ÐµÐ½Ð¸ÑÐµ ÑÐ°ÑÐºÐ»Ð°Ð´ÐºÑ","wrong-password":"ÐÐ°ÑÐ¾Ð»Ñ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ ÑÐ¾Ð²Ð¿Ð°Ð´Ð°ÑÑ Ñ Ð»Ð¾Ð³Ð¸Ð½Ð¾Ð¼"},{lang:"ru"}),BEM.I18N.decl("b-keyboard-loader",{keyboard:"ÐÐ»Ð°Ð²Ð¸Ð°ÑÑÑÐ°"},{lang:"ru"}),BEM.I18N.decl("chrome-webstore-item",{"ÐÑ ÑÐ¼Ð¾Ð¶ÐµÑÐµ Ð²ÐµÑÐ½ÑÑÑ Ð²ÑÐµ ÐºÐ°Ðº Ð±ÑÐ»Ð¾ Ð² Ð»ÑÐ±Ð¾Ðµ Ð²ÑÐµÐ¼Ñ.":"ÐÑ ÑÐ¼Ð¾Ð¶ÐµÑÐµ Ð²ÐµÑÐ½ÑÑÑ Ð²ÑÐµ ÐºÐ°Ðº Ð±ÑÐ»Ð¾ Ð² Ð»ÑÐ±Ð¾Ðµ Ð²ÑÐµÐ¼Ñ.","ÐÐ°Ð¶Ð¼Ð¸ÑÐµ ÐºÐ½Ð¾Ð¿ÐºÑ":"ÐÐ°Ð¶Ð¼Ð¸ÑÐµ ÐºÐ½Ð¾Ð¿ÐºÑ","Ð§ÑÐ¾Ð±Ñ Ð´Ð¾Ð±Ð°Ð²Ð¸ÑÑ Ð²Ð¸Ð·ÑÐ°Ð»ÑÐ½ÑÐµ Ð·Ð°ÐºÐ»Ð°Ð´ÐºÐ¸.":"Ð§ÑÐ¾Ð±Ñ Ð´Ð¾Ð±Ð°Ð²Ð¸ÑÑ Ð²Ð¸Ð·ÑÐ°Ð»ÑÐ½ÑÐµ Ð·Ð°ÐºÐ»Ð°Ð´ÐºÐ¸.","Ð§ÑÐ¾Ð±Ñ ÑÐ´ÐµÐ»Ð°ÑÑ Ð¯Ð½Ð´ÐµÐºÑ Ð¿Ð¾Ð¸ÑÐºÐ¾Ð¼ Ð¿Ð¾ ÑÐ¼Ð¾Ð»ÑÐ°Ð½Ð¸Ñ.":"Ð§ÑÐ¾Ð±Ñ ÑÐ´ÐµÐ»Ð°ÑÑ Ð¯Ð½Ð´ÐµÐºÑ Ð¿Ð¾Ð¸ÑÐºÐ¾Ð¼ Ð¿Ð¾ ÑÐ¼Ð¾Ð»ÑÐ°Ð½Ð¸Ñ."},{lang:"ru"}),BEM.I18N.decl("copyright",{link:function(t){return"ÐÐÐ Â«"+t.content+"Â»"
