...
// WR version: 15.0
// Recording ratio: 0.5
// Generated on: 7/26/2015 7:58:26 AM (UTC 7/26/2015 12:58:26 PM)
...
ClickTaleCDNHTTPSRewrite('https://cdnssl.clicktale.net/www04/pcc/023bc397-b998-4163-acae-65e421c0d27e.js?DeploymentConfigName=Release_16072015&Version=1'):
'http://cdn.clicktale.net/www04/pcc/023bc397-b998-4163-acae-65e421c0d27e.js?DeploymentConfigName=Release_16072015&Version=1');
...
if (ct_UA.t == ct_UA.IE) {
    ...
    if ((location.href.toLowerCase().indexOf('www.adobe.com/jp/creativecloud.html') != -1  
        && typeof ClickTaleGetUID == 'function' && (ClickTaleGetUID() == null || ClickTaleGetUID() == 0)) || document.cookie.indexOf('WRUID_BOOST') > -1) {
        window.ClickTaleUIDCookieName = 'WRUID_BOOST';
        window.ClickTaleCookieExpiryDays = 21;
        Ratio = 1;
    }
