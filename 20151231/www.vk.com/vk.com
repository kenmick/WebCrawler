...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang3_0.js':{v:3563},'index.css':{v:27},'index.js':{v:33},'ui_controls.css':{v:66},'ui_controls.js':{v:188}
}
</script>
...
<link type="text/css" rel="stylesheet" href="/css/al/index.css?27"></link><link type="text/css" rel="stylesheet" href="/css/ui_controls.css?66"></link><script type="text/javascript" src="/js/loader_nav18942_3.js"></script><script type="text/javascript" src="/js/al/common.js?1129_178"></script><script type="text/javascript" src="/js/lang3_0.js?3563"></script><link rel="alternate" media="only screen and (max-width: 640px)" href="http://m.vk.com/" /><link rel="alternate" href="android-app://com.vkontakte.android/vkontakte/m.vk.com/" /><script type="text/javascript" src="/js/al/index.js?33"></script><script type="text/javascript" src="/js/lib/ui_controls.js?188"></script><style>#page_header.p_head1 .left {width:65px;} #page_header.p_head1 .back, #page_header.p_head1 .left, #page_header.p_head1 .right, #page_header.p_head1 #top_logo_down {background-image: url(/images/hat_vk_ny_2.gif);}
.is_2x #page_header.p_head1 .back, .is_2x #page_header.p_head1 .left, .is_2x #page_header.p_head1 .right, .is_2x #page_header.p_head1 #top_logo_down {background-image: url(/images/hat_vk_ny_2_2x.gif)</style>
...
<div><div class="scroll_fix">
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login" onsubmit="if (vklogin) {return true} else {quick_login();return false;}">
    ...
    <input type="hidden" name="lg_h" value="91e05da7c9498d6082" />
