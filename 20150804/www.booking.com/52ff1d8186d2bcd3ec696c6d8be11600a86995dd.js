...
}booking.components.define("checkin-checkout-selector",function(c,b){c.components.extend(this,"legacy-emitter");
var a=1000*60*60*24;
...
booking.components.define("date-selector",function(h,d){h.components.extend(this,"legacy-emitter");
...
booking.components.define("checkin-checkout-calendar-input",function(c,b){c.components.extend(this,"legacy-emitter");
c.components.extend(this,"checkin-checkout-selector");
var a=1000*60*60*24;
this.init=function(d){this.context=d;
this.globalEmitter=c.components.require("legacy-emitter");
...
booking.components.define("date-selector-input",function(c,b){c.components.extend(this,"legacy-emitter");
...
(function(d,c,a){var b={paging:function(e){var g={$tabButton:".rlp_body_section_tab_btn",$tabButtonActive:".rlp_body_section_tab_btn.active",$tabSectionContainer:".rlp_body_section-container",callback:null};
var f=d.extend({},g,e);
return this.each(function(){var h=d(this);
d(f.$tabButton,this).bind("click",function(){var k=d(this);
var i=d(f.$tabButtonActive).index();
var j=k.index();
if(i!==j){d(f.$tabButtonActive,h).removeClass("active");
k.addClass("active");
d(f.$tabSectionContainer,h).eq(i).removeClass("active");
d(f.$tabSectionContainer,h).eq(j).addClass("active")
...
booking[sNSStartup].lightbox.show("https://www.youtube.com/embed/so36g3PJ3yM",{bCloseButton:false,iframe:true,iframeWidth:853,iframeHeight:480})
})
}());
