(function() {
  var creativeDefinition = {
    ...
    exitEvents: [
      {
        name: 'exit_button',
        reportingId: '1651116',
        url: 'http://www.3ds.com/industries/consumer-goods-retail/if-we/?scid\x3dext_3ext_ban_ifwe15_ifwe15pr_cnn-ros-1-300x250-cgr-std',
        targetWindow: '_blank',
        windowProperties: ''
      }
    ],
    ...
    childFiles: [
      {
        name: '2_main_banner.swf',
        url: '/ads/richmedia/studio/pv2/30766594/20140325103956415/2_main_banner.swf',
        isVideo: false,
        transcodeInformation: null
      },
      {
        name: 'DS_300x250_backup.gif',
        url: '/ads/richmedia/studio/pv2/30766594/20140325103956415/DS_300x250_backup.gif',
        isVideo: false,
        transcodeInformation: null
      }
    ],
    ...
    primaryAssets: [
      {
        ...
        width: '300',
        height: '250',
        servingPath: '/ads/richmedia/studio/pv2/30766594/20140325103956415/1_polite_load.swf',
        zIndex: '1000000',
        customCss: '',
...
layoutsApi: null
  ...
  var creativeId = '57601908';
  var adId = '289722933';
  var templateVersion = '200_78';
