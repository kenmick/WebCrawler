...
// Generated on: 7/22/2015 9:09:45 AM (UTC 7/22/2015 2:09:45 PM)
...
if (ct_dispatcher.configName == 'Release_17062015')
{
	configFoundPHC = true;
			(function(){
...
if (ct_dispatcher.configName == 'Release_06072015')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 7\/22\/2015 9:09:45 AM (UTC 7\/22\/2015 2:09:45 PM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
...
if (ct_dispatcher.configName == 'dev_CNNF-38')
{
	configFoundPHC = true;
			(function(){
	var script = ClickTaleXHTMLCompliantScriptTagCreate("\/\/ Copyright 2006-2015 ClickTale Ltd., US Patent Pending\r\n\/\/ PID: 49\r\n\/\/ Generated on: 7\/22\/2015 9:09:45 AM (UTC 7\/22\/2015 2:09:45 PM)\r\n\r\nvar WRInitTime=(new Date()).getTime();\r\n\r\n\/\/ Start of custom user-defined settings code\r\n\r\n\/\/ End of custom user-defined settings code\r\n\r\n");
