...
g.J=function(){H.H.J.call(this);this.clear();this.f.length=0};var xc=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};q("yt.config_",xc,void 0);q("yt.tokens_",window.yt&&window.yt.tokens_||{},void 0);var yc=window.yt&&window.yt.msgs_||t("window.ytcfg.msgs")||{};q("yt.msgs_",yc,void 0);function zc(a){var b=arguments;if(1<b.length){var c=b[0];xc[c]=b[1]}else for(c in b=b[0],b)xc[c]=b[c]}
...
var Fc=window.performance&&window.performance.timing&&window.performance.now&&window.__yt_experimental_now?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()},Gc="Microsoft Internet Explorer"==navigator.appName;var Hc=t("yt.pubsub.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.ya;H.prototype.publish=H.prototype.F;H.prototype.clear=H.prototype.clear;q("yt.pubsub.instance_",Hc,void 0);var Ic=t("yt.pubsub.subscribedKeys_")||{};q("yt.pubsub.subscribedKeys_",Ic,void 0);var Jc=t("yt.pubsub.topicToKeys_")||{};q("yt.pubsub.topicToKeys_",Jc,void 0);var Kc=t("yt.pubsub.isSynchronous_")||{};q("yt.pubsub.isSynchronous_",Kc,void 0);
var Lc=t("yt.pubsub.skipSubId_")||null;q("yt.pubsub.skipSubId_",Lc,void 0);function M(a,b,c){var d=Mc();if(d){var e=d.subscribe(a,function(){if(!Lc||Lc!=e){var d=arguments,h;h=function(){Ic[e]&&b.apply(c||window,d)};
...
var jf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};var Bb=t("yt.events.listeners_")||{};q("yt.events.listeners_",Bb,void 0);var kf=t("yt.events.counter_")||{count:0};q("yt.events.counter_",kf,void 0);function lf(a,b,c,d){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Ab(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
...
Math.min(l.top+l.height,r.top+r.height);K<=r&&(l.left=n,l.top=K,l.width=x-n,l.height=r-K)}}n=Ed(a);K=Ed(c);if(n.c!=K.c){x=n.c.body;var K=Qd(K.c),r=new fd(0,0),Q;Q=(Q=Gd(x))?Qd(Q):window;if(we(Q,"parent")){var W=x;do{var ga=Q==K?Fe(W):Ge(W);r.x+=ga.x;r.y+=ga.y}while(Q&&Q!=K&&Q!=Q.parent&&(W=Q.frameElement)&&(Q=Q.parent))}x=gd(r,Fe(x));!P||xd(9)||Nd(n.c)||(x=gd(x,Od(n.c)));l.left+=x.x;l.top+=x.y}a=Sg(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new fd(b,l.top+(a&1?l.height:0));b=gd(b,k);e&&(b.x+=
...
bh.prototype.toString=function(){return this.f};var ch=t("yt.pubsub2.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.ya;H.prototype.publish=H.prototype.F;H.prototype.clear=H.prototype.clear;q("yt.pubsub2.instance_",ch,void 0);var dh=t("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",dh,void 0);var eh=t("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",eh,void 0);var fh=t("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",fh,void 0);
...
function Qh(a){var b=Jd("iframe",null,a.c);B(b,function(a){var b=G(a,"onload");b&&(b=t(b))&&T(a,"load",b);if(b=G(a,"src"))a.src=b},a);
return db(b)}
...
;function ci(){if(null==t("_lact",window)){var a=parseInt(I("LACT"),10),a=isFinite(a)?z()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&di();T(document,"keydown",di);T(document,"keyup",di);T(document,"mousedown",di);T(document,"mouseup",di);M("page-mouse",di);M("page-scroll",di);M("page-resize",di)}}
function di(){null==t("_lact",window)&&(ci(),t("_lact",window));var a=z();q("_lact",a,window);O("USER_ACTIVE")}
...
ca(fi);var gi=t("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",gi,void 0);function hi(a){if(/^f([1-9][0-9]*)$/.test(a))throw"ExpectedRegexMatch: "+a;}
...
10)||0;a=[c,d,e]}else a=[0,0,0];this.A=b;b=a;this.c=b[0];this.f=b[1];this.j=b[2];if(0>=this.c){var h,k,l,n;if(Gc)try{h=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(r){h=null}else l=document.body,n=document.createElement("object"),n.setAttribute("type","application/x-shockwave-flash"),h=l.appendChild(n);if(h&&"GetVariable"in h)try{k=h.GetVariable("$version")}catch(r){k=""}l&&n&&l.removeChild(n);(h=k||"")?(h=h.split(" ")[1].split(","),h=[parseInt(h[0],10)||0,parseInt(h[1],10)||0,parseInt(h[2],
...
function fj(a,b){if(!a.isDisposed()){if(!b){var c;if(!(c=!a.c.html5&&ij(a))){if(!p(a.c.disable.html5)){var d;c=!0;void 0!=a.c.args.deviceHasDisplay&&(c=a.c.args.deviceHasDisplay);if(2.2==wi)d=!0;else{a:{var e=c;c=t("yt.player.utils.videoElement_");c||(c=document.createElement("video"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Bi:Ci,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(h){d="html5.missingapi"}}d=!d}d&&(d=lj(a)||a.c.assets.js);
...
e.yt_hrd=k}var k=I("TIMING_INFO",{}),l;for(l in k)e[l]=k[l];l=e.srt;delete e.srt;var n;void 0===d.srt&&(l||0===l||(n=Pi.timing||{},l=Math.max(0,n.responseStart-n.navigationStart),isNaN(l)&&e.pt&&(l=e.pt)),l||0===l)&&(e.srt=Math.round(l));e.h5jse&&(k=window.location.protocol+t("ytplayer.config.assets.js"),(k=Pi.getEntriesByName?Pi.getEntriesByName(k)[0]:null)?e.h5jse=Math.round(e.h5jse-k.responseEnd):delete e.h5jse);d.aft=Ui();k=d._start;if("cold"==e.yt_lt){n||(n=Pi.timing||{});var r;a:if(r=n,r.msFirstPaint)r=
Math.max(0,r.msFirstPaint);else{var x=window.chrome;if(x&&(x=x.loadTimes,ia(x))){var x=x(),K=1E3*Math.min(x.requestTime||Infinity,x.startLoadTime||Infinity),K=Infinity===K?0:r.navigationStart-K;r=Math.max(0,Math.round(1E3*x.firstPaintTime+K)||0);break a}r=0}0<r&&r>k&&(d.fpt=r);r=c||$i().span;x=n.redirectEnd-n.redirectStart;0<x&&(r.rtime_=x);x=n.domainLookupEnd-n.domainLookupStart;0<x&&(r.dns_=x);x=n.connectEnd-n.connectStart;0<x&&(r.tcp_=x);x=n.connectEnd-n.secureConnectionStart;n.secureConnectionStart>=
n.navigationStart&&0<x&&(r.stcp_=x);x=n.responseStart-n.requestStart;0<x&&(r.req_=x);x=n.responseEnd-n.responseStart;0<x&&(r.rcv_=x);Pi.getEntriesByType&&Xi(d);(n=I("SPEEDINDEX_FOR_ACTIONS",void 0))&&-1<n.indexOf(h)&&(n=Fc(),h=Ii(),r=Fc(),0<h.Sb&&(e.si=h.Sb,d.vsc=Wi(h.Ed),d.sics=n,d.sice=r));n=[];if(document.querySelector&&Pi&&Pi.getEntriesByName){var h={'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'script[name="scheduler/scheduler"]':"sj",'script[name="desktop_polymer/desktop_polymer"]':"dpj",
'link[rel="import"][name="desktop_polymer"]':"dph"},Q;for(Q in h)if(r=document.querySelector(Q))x="",K=r.nodeName,"SCRIPT"==K?x=r.src:"LINK"==K&&(x=r.href),x&&(r=Pi.getEntriesByName(x))&&r[0]&&n.push(h[Q]+"."+Math.round(r[0].duration))}n.length&&(e.rs=n.join(","))}h=Vi();Q=h.pbr;n=h.vc;h=h.pbs;Q&&n&&h&&Q<n&&n<h&&1==$i().info.yt_vis&&"youtube"==f&&($i().info.yt_lt="hot_bg",Q=d.vc,f=d.pbs,delete d.aft,c.aft=Math.round(f-Q));(Q=I("PREVIOUS_ACTION"))&&(e.pa=Q);e.p=I("CLIENT_PROTOCOL")||"unknown";e.t=
...
;var vj=t("yt.abuse.botguardInitialized")||$h;q("yt.abuse.botguardInitialized",vj,void 0);var wj=t("yt.abuse.invokeBotguard")||ai;q("yt.abuse.invokeBotguard",wj,void 0);var yj=t("yt.abuse.dclkstatus.checkDclkStatus")||bi;q("yt.abuse.dclkstatus.checkDclkStatus",yj,void 0);var zj=t("yt.player.exports.navigate")||Xg;q("yt.player.exports.navigate",zj,void 0);var Aj=t("yt.player.embed")||sj;q("yt.player.embed",Aj,void 0);var Bj=t("yt.player.getPlayerByElement")||uj;q("yt.player.getPlayerByElement",Bj,void 0);
var Cj=t("yt.util.activity.init")||ci;q("yt.util.activity.init",Cj,void 0);var Dj=t("yt.util.activity.getTimeSinceActive")||ei;q("yt.util.activity.getTimeSinceActive",Dj,void 0);var Ej=t("yt.util.activity.setTimestamp")||di;q("yt.util.activity.setTimestamp",Ej,void 0);function Fj(){pb(R("page-container"),"remote-connected",!!V)}
...
function En(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Bn(a,c);var d=a?a.split(":"):[],e=c.h||wn(),f=Um(Zm,"ah",Xm());if(f["::"]&&d.length){for(var h=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,n=h.length&&h[h.length-1]||null,r=n;n&&n.hint==l||(r={hint:l,Oc:[]},h.push(r));r.Oc.push(k)}var x=h.length;if(1<x){var K=c.callback;K&&(c.callback=function(){0==--x&&K()})}for(;d=h.shift();)Fn(d.Oc,c,d.hint)}else Fn(d||[],c,e)}
function Fn(a,b,c){function d(a,b){if(x)return 0;Pm.clearTimeout(r);K.push.apply(K,W);var d=((Ym||{}).config||{}).update;d?d(f):f&&Um(Zm,"cu",[]).push(f);if(b){en("me0",a,Q);try{Cn(b,c,n)}finally{en("me1",a,Q)}}return 1}
a=Wm(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var r=null,x=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=Um(bn(c),"r",[]).sort(),K=Um(bn(c),"L",[]).sort(),Q=[].concat(l);0<h&&(r=Pm.setTimeout(function(){x=!0;k()},h));
...
function Pq(){Kq||(Kq=t("yt.mdx.remote.debug.handlers_")||[],q("yt.mdx.remote.debug.handlers_",Kq,void 0))}
...
function Kt(){if(!t("yt.mdx.remote.castv2_")&&!Lt&&(Wa(Ya)&&eb(Ya,vl("yt-remote-online-dial-devices")||[]),Gt())){var a=Jt();a?(a.removeReceiverListener("YouTube",Mt),a.addReceiverListener("YouTube",Mt),Ht("API initialized in the other binary")):(a=new cast.Api,q("yt.mdx.remote.castapi.api_",a,void 0),a.addReceiverListener("YouTube",Mt),a.setReloadTabRequestHandler&&a.setReloadTabRequestHandler(function(){J(function(){window.location.reload(!0)},1E3)}),Oq(It),Ht("API initialized"));
Lt=!0}}
...
var Lt=!1,Ya=t("yt.mdx.remote.castapi.devices_")||[];q("yt.mdx.remote.castapi.devices_",Ya,void 0);function Ut(a){xq.call(this);this.l=0;this.La=Vt();this.B=NaN;this.C=a;this.N("Initializing local screens: "+ar(this.La));this.j=Wt();this.N("Initializing account screens: "+ar(this.j));this.bc=null;this.c=[];this.f=[];Xt(this,Pt()||[]);this.N("Initializing DIAL devices: "+gr(this.f));a=Zq(Jr());Yt(this,a);this.N("Initializing online screens: "+ar(this.c));this.l=z()+3E5;Zt(this)}
