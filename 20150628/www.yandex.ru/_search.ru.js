...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("bcIUxRGBimSMQFHlpMa1cnO0OZA")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
}if("getLive"===e)return"input"===n?!!s==!1?Ve(t):Qe(t):Qe(t);if("live"===e)return"input"===n?!!s==!1?He(t):Qe(t):Qe(t);
...
}return Qe(t)}return"default"===e?q(t):"env"===e?"i-global"===n?ze(t):Qe(t):"content"===e?S(t):"jsAttr"===e?We(t):"tag"===e?C(t):"cls"===e?Ke(t):"bem"===e?Ae(t):Qe(t)
...
return o.title&&(n.title=o.title),o.target&&(n.target=o.target),o.counter&&(n.onmousedown=o.counter),n.href=o.url,n
}return _(t)}return _(t)}function _(t){return!!s==!1?g(t):B(t)}function g(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Ne(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
...
return o.title&&(n.title=o.title),o.target&&(n.target=o.target),o.counter&&(n.onmousedown=o.counter),n.href=o.url,n
}return w(t)}return w(t)}function w(t){return!!s==!1?x(t):B(t)}function x(t){var e=t.ctx,n=e.url,s={};
if(["title","target","id","tabindex"].forEach(function(t){e[t]&&(s[t]=e[t])}),n)if(t.isSimple(n))s.href=n;
else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,Ne(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
...
if("button"===e)return V(t);if("input"===e)return H(t);if("auth"===e)return Q(t);if("checkbox"===e)return F(t);
...
var e=t.__$anflg29;return t.__$anflg29=!0,V(t),t.__$anflg29=e,void 0}return Qe(t)}return Qe(t)}function H(t){var e=s;
if("hint"===e)return!(t.__$anflg27!==!0)==!1?!!t._value==!1?!(0!==t._value)==!1?z(t):W(t):W(t):W(t);if("control"===e){if(!(t.__$anflg26!==!0)==!1){var n=t.__$anflg26;
t.__$anflg26=!0;var o=t.ctx;t.ctx={elem:"box",content:t.ctx};var r=i;return i="",Ne(t),t.ctx=o,i=r,t.__$anflg26=n,void 0
}return W(t)}return W(t)}function z(t){var e,n,s,o,r,a=t.ctx,c=a.elemMods||(a.elemMods={});return c.visibility="visible",e=t.__$anflg27,t.__$anflg27=!0,s=t.ctx,t.ctx=a,o=i,i="",r=Ne(t),t.ctx=s,i=o,n=r,t.__$anflg27=e,n
...
t._live=l;var k=t.ctx,M=k.mods;k.mods=u,H(t),t._inputId=p,t._labelId=f,t._hintId=m,t._name=_,t._value=g,t._inputLink=b,t._disabled=v,t._live=y,k.mods=M,t.__$anflg12=d
...
var f=(c=i,i="env",h=n,n="i-global",u=ze(t),i=c,n=h,u),m=t.__$anflg1;t.__$anflg1=!0;var _=t["i-global"];
...
}function Ve(t){var e,n,s=(e=i,i="live",n=He(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function He(){return!1}function ze(t){return!!s==!1?{}:Qe(t)}function We(){return void 0}function Ke(){return void 0
...
for(var V=0;V<F.length;V++){var H=F[V];if(H){var z=H.block||H.elem,W=H.block||H._block||n,K=H.elem||H._elem||s,Q=H.mods||r,G=H.elemMods||{};
if(z&&j.push(" "),O.INTERNAL[z?"buildClasses":"buildModsClasses"](W,H.elem||H._elem||(H.block?void 0:s),H.elemMods||H.mods,j),H.js&&((L||(L={}))[O.INTERNAL.buildClass(W,H.elem)]=H.js===!0?{}:H.js,$||($=W&&!H.elem)),z&&!U[e(W,K)]){U[e(W,K)]=!0;
...
BEM.blocks.counter.log(this.params.counter,{state:e})}}}),_borschik("24y9AmTomQyNUGMv9wfPVKUBQeA")&&BEM.decl("install-chrome-webstore-item-action",{execute:function(){var t=this.params.id?BEM.create("chrome-webstore-item_type_"+this.params.id,this.params.webItem):BEM.create("chrome-webstore-item",this.params.webItem);
