...
u.hotels.forEach(function(x){var w=q.getHotelIndexById({hotel_id:j(x),list_id:r.id});
...
if(u.list_id){t.hotels.forEach(function(w,x){if(j(w)===String(u.hotel_id)){q=w;
p=x
}})
}else{r._lists.forEach(function(w){w.hotels.forEach(function(x,y){if(j(x)===String(u.hotel_id)){q=x;
p=y
}})
})
...
this.store=u;
this._isShown=false;
B.eventEmitter.bind("hotel:updated",function(y,z){w.setHotelAvailability(z,z.availability||{},{updateNights:true,silent:true})
});
...
p.prototype.templateData=function(y){var w={from_list:1};
if(B.track.getVariant(n)){$.extend(w,{goToRoomTable:true})
}var x=$.extend({},y,{b_guest_country:B.env.b_guest_country,b_countrycode:y.cc1,b_bookings_owned:B.env.b_bookings_owned,b_partner_channel_id:B.env.b_partner_channel_id,absolute_url:this.buildHotelLink(y),book_now_url:this.buildHotelLink(y,w),has_availability:(!$.isEmptyObject(y.availability)&&typeof y.availability.is_available!=="undefined"),available:Boolean(y.availability.is_available),edit:Boolean(y.edit),is_desktop:B.env.b_site_type_id==="1",is_logged_in:B.env.auth_level>0});
return x
};
...
p.prototype.renderHotel=function(x){if(B.track.getVariant("PcVBcTLEVcPbADDFZNINKe")){this.renderHotels(this.currentList())
...
var A=$.extend({hotels_count:C.hotels_count,hotels:C.hotels.map(function(D){return y.templateData(D)
...
B.define("component/lists/listview-empty-list",function(d,c,e){booking.jstmpl("listview_empty_list_recently_viewed",(function(){var h=['\n    \u003cdiv class="js-listview-empty-list-recently-viewed"\u003e\n        ',"\n            \u003ch2\u003eRecently viewed hotels\u003c/h2\u003e\n\n            ",'\n                \u003cdiv class="listview__hotel listview__hotel--current clearfix"\u003e\n                    \u003ca class="image" href="','"\u003e\n                        \u003cdiv\n                            class="listview__hotel__image js-listview-hotel-image"\n                            style="background-image: url(',');"\u003e\u003c/div\u003e\n                    \u003c/a\u003e\n\n                    \u003cdiv class="meta"\u003e\n                        \u003cdiv class="meta__name clearfix"\u003e\n                            \u003ca class="listview__hotel__title"\u003e','\u003c/a\u003e\n                        \u003c/div\u003e\n\n                        \u003cdiv class="meta__tip"\u003e','\u003c/div\u003e\n                    \u003c/div\u003e\n\n                    \u003cdiv class="listview__add"\u003e\n                        \u003cbutton\n                            data-hotel-id="','"\n                            class="b-button b-button_primary js-listview-add-hotel"\n                            type="button"\u003e\n                            \u003cspan class="b-button__text"\u003e',"\u003c/span\u003e\n                        \u003c/button\u003e\n                    \u003c/div\u003e\n                \u003c/div\u003e\n            ","\n        ","\n    \u003c/div\u003e\n"],g=["recentlyViewedHotels","hotel_url","main_photo_square150","hotel_name","do_you_want_to_save","hotel_id","do_you_want_to_save_cta"],l,k,j;
return function(m){var n="",o=this.fn;
n+=h[0];
if(o.MD(g[0])){n+=h[1];
var t=(o.MC(g[0])||[]);
m.unshift(null);
for(var p=1,q=t.length;
p<=q;
p++){m[0]=t[p-1];
n+=[h[2],o.MB(g[1]),h[3],o.STATIC_HOSTNAME(o.MB(g[2]),0,0,0),h[4],o.MB(g[3]),h[5],o.MB(g[4]),h[6],o.MB(g[5]),h[7],o.MB(g[6]),h[8]].join("")
}m.shift();
n+=h[9]
}n+=h[10];
return n
...
var f={_hotels:[],get:function(h){var g=this;
...
},n=function(){var z=d.jstmpl("number_selector_buttons").render({id:"rooms",value:l,label:h(".js-change_travel_party_box").attr("data-rooms-label"),min_value:1,max_value:30,rerender:1});
...
u<g;
u++){var y=u+1;
x+=d.jstmpl("number_selector_buttons").render({id:"child_age_"+y+"_age",has_selectbox:1,value:(c[u])?c[u]:0,label:"",min_value:0,max_value:17,rerender:1,last:(u===(g-1))?1:0})
}r=d.jstmpl("number_selector_group_ages_container").render({nr_of_children:g,group_ages:x})
}d.search.group("rooms",l);
d.search.group("adults",f);
d.search.group("children",g);
d.search.group("childrenAges",c);
h(".js-change_travel_party_box__group_input").html(z+t+w+r);
k()
...
h(".js-change_travel_party_button_container").delegate(".js-number_selector_buttons__plus, .js-number_selector_buttons__minus","click",function(){var z,r,t;
if(h(this).hasClass("js-number_selector_buttons__minus")){z=true
}else{if(h(this).hasClass("js-number_selector_buttons__plus")){z=false
}}var x=h(this).siblings(".js-number_selector_buttons__result");
var w=h(this).parents(".js-number_selector_buttons");
if(w.attr("data-id").indexOf("child_age")>-1){var y=x.find(".js-number_selector_group_ages_selectbox");
r=parseInt(y.val());
if(z){t=r-1
}else{t=r+1
}y.find("option[value="+t+"]").attr("selected",true);
o()
...
if(this.getNotifications("unseen").length>0||this._hasMultipleTravelGuides){this.delayedSeen()
}},delayedSeen:function(){var f=this.$root.find('.js-uc-notification a[href="'+window.location.href+'"]').closest(".js-uc-notification");
var e=this.getNotificationData(f);
if(this._hasMultipleTravelGuides&&e!=null&&(e.type=="multiple_travel_guides"||e.type=="explorer_available")){d.track.stage("PcVBcYAZbHDUFYQDbbTXQae",2)
}if(!f.length||e===null||e.seen){return
}d.track.stage("PcVBcadffRBbITBYbOUEaJPae",1);
if(d.track.getVariant("PcVBcadffRBbITBYbOUEaJPae")){this.seen(e,true);
this.updateState();
this.markAsSeen([e])
...
d.track.exp("PcVBcadffRBbITBYbOUEaJPae")
...
if(e._hasMultipleTravelGuides){d.track.stage("PcVBcYAZbHDUFYQDbbTXQae",1)
...
this.$root.delegate(".js-uc-notification a","click",function(f){var g=e.getNotificationFromEvent(f);
if(!g.seen){d.track.stage("PcVBcadffRBbITBYbOUEaJPae",1);
if(d.track.getVariant("PcVBcadffRBbITBYbOUEaJPae")){e.markAsSeen([g])
}}if(e._hasMultipleTravelGuides&&(g.type=="multiple_travel_guides"||g.type=="explorer_available")){d.track.stage("PcVBcYAZbHDUFYQDbbTXQae",2)
}});
