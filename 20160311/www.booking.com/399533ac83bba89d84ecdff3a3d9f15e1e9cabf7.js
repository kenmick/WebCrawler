...
}if(y&&y.b_official_districts&&B.atlas.getVariant("ebcaeDeeELSEO")){B.atlas.require(["district-label"],function(E){_p=_o;_o="899b:647";E.add({map:w,districts:y.b_official_districts})
})
...
}function n(r){_p=_o;_o="899b:1181";r+=b[156];
...
if((f.MJ(f.MC(a[109]))&&(f.MJ(/^(searchresults|hotel)$/.test(f.ATLAS_ENV("action")))))){r+=b[3];
...
return r
}function g(u){_p=_o;_o="899b:1193";f.MN(a[13],b[32]);
u+=b[5];
f.MN(a[14],b[33]);
u+=b[4];
f.MN(a[15],undefined);
...
booking[sNSExperiments]["cQHHMVHSGFO"]=(function(f,h){_p=_o;_o="899b:2025";var a=f(".book-challenge__stamp--current");
var d=f(".book-challenge__message");
var c=f(".book-challenge__message-inner");
var e,b;
function g(){_p=_o;_o="899b:2026";f(".book-challenge__stamp--booked").on("mouseenter",function(){_p=_o;_o="899b:2027";b=f(this).index()+1;
if(e){clearInterval(e)
}d.addClass("book-challenge__message__arrow--stamp"+b);
a.removeClass("book-challenge__stamp--current");
c.addClass("book-challenge__message-hover")
});
f(".book-challenge__stamp--booked").on("mouseleave",function(){_p=_o;_o="899b:2029";d.removeClass("book-challenge__message__arrow--stamp"+b);
e=setTimeout(function(){_p=_o;_o="899b:2030";a.addClass("book-challenge__stamp--current");
c.removeClass("book-challenge__message-hover")
},100)
})
}return{init:g}
})(jQuery,booking);
