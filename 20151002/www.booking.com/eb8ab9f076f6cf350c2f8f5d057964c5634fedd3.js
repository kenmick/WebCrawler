...
var f=function(){if(h.env.lp_getaway_deals_on_index_running){if(typeof h.env.lp_getaway_deals_on_index_ufis!=="string"||!h.env.lp_getaway_deals_on_index_ufis){return h.track.custom_goal(e,2)
}var i=a({lang:h.env.b_lang_for_url,currency:h.env.b_selected_currency,aid:h.env.b_aid,ufis:h.env.lp_getaway_deals_on_index_ufis.replace("[","").replace("]","")});
c.getJSON(i,b)
}};
