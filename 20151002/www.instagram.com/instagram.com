...
Instagram
  ...
  WebFontConfig = {
    custom: {
      ...
      urls: ['//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/cache/styles/fonts.css']
    }
  };
</script>
<script src="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/scripts/webfont.js" type="text/javascript" async></script>
    ...
    <meta id="viewport" name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, minimum-scale=1, maximum-scale=1">
        ...
        <link rel="Shortcut Icon" type="image/x-icon" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/favicon.ico"><link rel="mask-icon" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/favicon.svg" color="#125688">
    
    
        <link rel="apple-touch-icon-precomposed" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/apple-touch-icon-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/apple-touch-icon-72x72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/images/ico/apple-touch-icon-144x144-precomposed.png">
...
<link href="https://instagram.com/?hl=mr" rel="alternate" hreflang="mr" />
    ...
    <script src=//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/scripts/polyfills/es5-shim.min.js></script>
<script src=//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/scripts/polyfills/es5-sham.min.js></script>
<script type="text/javascript">window._sharedData = {"static_root":"\/\/instagramstatic-a.akamaihd.net\/bluebar\/c0d52a5","entry_data":{"LandingPage":[{"__query_string":"?","__path":"\/","challenge":null,"__get_params":{}}]},"hostname":"instagram.com","platform":"web","qe":{"su":false},"display_properties_server_guess":{"viewport_width":360,"pixel_ratio":1.5},"country_code":"FR","language_code":"en","gatekeepers":{"rhp":true,"logged_out_search":true},"config":{"dismiss_app_install_banner_until":null,"viewer":null,"csrf_token":"29c7bd9669f5512ef9d49e7221b93e3f"},"environment_switcher_visible_server_guess":true};</script>
<script src="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/cache/bundles/en_US_webpack-common.js" type="text/javascript"></script>
<script src="//instagramstatic-a.akamaihd.net/bluebar/c0d52a5/cache/bundles/en_US_LandingPage.js" type="text/javascript"></script>
