...
<style type="text/css">
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-bold-webfont.eot/115b1f7f9c04.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-bold-webfont.svg/e55a9d6051e8.svg') format("svg");
    font-weight: bold;
    font-style: normal; }
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-boldit-webfont.eot/1cbb869da891.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-boldit-webfont.svg/29948a2d3c58.svg') format("svg");
    font-weight: bold;
    font-style: italic; }
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-reg-webfont.eot/12af77715cee.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-reg-webfont.svg/c33d2fd56309.svg') format("svg");
    font-weight: normal;
    font-style: normal; }
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-regit-webfont.eot/1bbbd1312b0d.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-regit-webfont.svg/876278d4b189.svg') format("svg");
    font-weight: normal;
    font-style: italic; }
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-sbold-webfont.eot/5016edf79e1d.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-sbold-webfont.svg/868597833e49.svg') format("svg");
    font-weight: 600;
    font-style: normal; }
</style>
  ...
  @font-face {
    ...
    src: url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-light-webfont.eot/63c84728610f.eot') format("embedded-opentype"),
      ...
      url(' //instagramstatic-a.akamaihd.net/h1/webfonts/proximanova-light-webfont.svg/858f6a9b7ef3.svg') format("svg");
    font-weight: 300;
    font-style: normal; }
</style>
    ...
    <meta id="viewport" name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, minimum-scale=1, maximum-scale=1">
        ...
        <link rel="Shortcut Icon" type="image/x-icon" href="//instagramstatic-a.akamaihd.net/h1/images/ico/favicon.ico/7cdab0872b15.ico"><link rel="mask-icon" href="//instagramstatic-a.akamaihd.net/h1/images/ico/favicon.svg/dfde15ef1533.svg" color="#125688">
    
    
        <link rel="apple-touch-icon-precomposed" href="//instagramstatic-a.akamaihd.net/h1/images/ico/apple-touch-icon-precomposed.png/29d68fc587d7.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="//instagramstatic-a.akamaihd.net/h1/images/ico/apple-touch-icon-72x72-precomposed.png/3f5e04d85488.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="//instagramstatic-a.akamaihd.net/h1/images/ico/apple-touch-icon-114x114-precomposed.png/29d68fc587d7.png">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="//instagramstatic-a.akamaihd.net/h1/images/ico/apple-touch-icon-144x144-precomposed.png/52fcc0fc09e4.png">
...
<script type="text/javascript">window._sharedData = {"country_code":"FR","language_code":"en","gatekeepers":{"rhp":true},"qs":"{\"shift\":10,\"header\":\"ZYxqQxUgZlZcW5RtKLu3xmYU4bbdsatU\",\"edges\":100,\"blob\":\"AQDijZhKLs3S4eCyCiCdsvUlEpODOFVHHw3RHsGNQeBRMHfVrcxMqvH3Npr_WOeVKCkn4rhNJTb79QBKlNPI43NxccisXS8jzGQx2RSI0ULrRjM_C8lMXqcL9npzTdOytWGOG2ZmrOtNn9F2MzUcRFeynVoJg5tHhFjfkbCyjEbaUlQ_V0k9nsc1G-Gmw5RHJfRIpBIswdF7BXRGREWUvX52y0wDpZjSoGwduPXEIEYzqg\",\"iterations\":7,\"size\":42}","static_root":"\/\/instagramstatic-a.akamaihd.net\/bluebar\/b70b514","platform":"web","hostname":"www.instagram.com","entry_data":{"LandingPage":[{"__query_string":"?","__path":"\/","__get_params":{}}]},"qe":{"su":{"p":{"enabled":"true"},"g":"test"}},"display_properties_server_guess":{"viewport_width":360,"pixel_ratio":1.5},"config":{"viewer":null,"csrf_token":"30670df609095b6817456d493613d8f9"},"environment_switcher_visible_server_guess":true};</script>
<script src="//instagramstatic-a.akamaihd.net/h1/bundles/en_US_Commons.js/1b0aed2e6b7a.js" type="text/javascript"></script>
<script src="//instagramstatic-a.akamaihd.net/h1/bundles/en_US_LandingPage.js/df95ae9536b0.js" type="text/javascript"></script>
