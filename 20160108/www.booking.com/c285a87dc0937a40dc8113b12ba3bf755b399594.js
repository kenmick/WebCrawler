...
if (o && e.setCookieOnClose(), o && (B.track.stage("BOebRRDOQPQeHOcTTDbQNZAUBO", 1), B.track.stage("BOebRRDOLcNTBZGHO", 1), B.env.b_action)) switch (B.env.b_action) {
case "hotel":
...
e += t[35];
var o = "";
if (a.MJ(a.MC(n[25])) && a.MJ(a.MC(n[26]) + "" == "www") && (a.MJ(a.MC(n[27]) + "" == "hotel") || a.MJ(a.MC(n[27]) + "" == "searchresults")) && (o += t[36]), a.MN(n[24], o), e += t[37], a.MD(n[24])) {
e += t[38];
var r = "";
...
b_size:t[123],
b_tooltip:t[124]
}), o = F(o), i.shift(), o += [ t[125], a.MB(n[51]), t[126] ].join(""), a.MJ(a.MG((a.MC(n[52]) || {}).is_aspiring)) && (o += [ t[127], a.MG((a.MC(n[52]) || {}).num_stays), t[128] ].join("")), o += t[15], a.MJ(a.MC(n[53])) && (o += t[129]), o += t[130], a.MJ(a.MG((a.MC(n[52]) || {}).is_aspiring)) ? o += [ t[6], (i.unshift({
...
var i = e.search.dates();
if (t(n.currentTarget).attr("data-sb-ssnc")) return;
return i.mode !== e.Search.DateModes.NODATES && "valid" !== i.checkin.type && "valid" !== i.checkout.type && i.setMode(e.Search.DateModes.NODATES), i.validate();
