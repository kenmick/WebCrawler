...
if (i[0] = o[a - 1], s += t[1], s += t[2], n.MJ(/zh|xt|ja|ko/.test(n.MB(e[1]))) && (s += t[3]), n.MJ(n.MB(e[2]) + "" == "airport") ? s += t[4] :n.MJ(n.MB(e[2]) + "" == "city") ? s += t[5] :n.MJ(n.MB(e[2]) + "" == "country") ? s += t[6] :n.MJ(n.MB(e[2]) + "" == "district") ? s += t[7] :n.MJ(n.MB(e[2]) + "" == "hotel") ? s += t[8] :n.MJ(n.MB(e[2]) + "" == "landmark") ? s += t[9] :n.MJ(n.MB(e[2]) + "" == "region") ? s += t[10] :n.MJ(n.MB(e[2]) + "" == "theme") && (s += t[11]), n.MJ(n.MB(e[2]) + "" == "theme") && n.MJ(2 == n.track_experiment("PVcLcDODAKWUMKKe")) && (s += t[12]), s += [ t[13], n.MC(e[3]), t[14], n.F.entities(n.MC(e[4])), t[15] ].join(""), s += t[16], n.MJ(n.MB(e[2]) + "" == "theme") && n.MJ(2 == n.track_experiment("PVcLcDODAKWUMKKe"))) s += [ t[17], n.F.entities(n.MC(e[5])), t[18], n.F.entities(n.MC(e[6])), t[19], n.ME(t[20], n.MB, n.MN, null), t[21] ].join(""); else {
if (s += t[16], n.MD(e[7])) {
s += t[16];
var r = a, h = o, u = l, o = n.MC(e[7]) || [];
i.unshift(null);
for (var a = 1, l = o.length; l >= a; a++) i[0] = o[a - 1], s += t[16], n.MD(e[8]) && (s += t[22]), s += [ t[16], n.F.entities(n.MC(e[9])), t[16] ].join(""), n.MD(e[8]) && (s += t[23]), s += t[16];
i.shift(), a = r, o = h, l = u, s += t[16];
} else n.MD(e[10]) ? s += [ t[16], n.MC(e[10]), t[16] ].join("") :n.MD(e[6]) && (s += [ t[16], n.F.entities(n.MC(e[6])), t[16] ].join(""));
s += t[16], n.MD(e[11]) && (s += [ t[24], n.MC(e[11]), t[23] ].join("")), s += t[16], n.MJ(n.MG((n.MC(e[12]) || {}).popular)) && (s += [ t[25], n.F.entities(n.ME(t[26], n.MB, n.MN, null)), t[23] ].join("")), s += t[16];
}
s += t[16], n.MN("index", n.MI(n.MB(e[3])) + n.MI(1)), s += t[16], s += t[27];
}
i.shift(), s += t[28], n.MD(e[13]) && (s += t[29]), s += t[30];
}
return s += t[30];
}
return s += t[0], s = o(s), s += t[30];
};
