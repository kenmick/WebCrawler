            ...
            var l = function(t) {
                ...
                for (var e = 0; e < t.length; e++) {
                    var i = t[e], a = function(t) {
                        ...
                        r.Snitch(r.NOTICE, "Not insertable or double insertion: " + n.Untaint(t[0].PlacementName) + ": " + n.Untaint(t[0].Placement));
                    };
...
define("js/fo/util/resource", [ "require", "exports", "omnitag/gostructs", "util/str" ], function(e, n, r, t) {
    function i(e, n, i, a, o, c) {
        if (o) i = Math.round(d * +i), a = Math.round(d * +a); else var d = window.devicePixelRatio || 1;
        var l = "";
        switch (n.Kind) {
          case r.ResourceImageKind.INTERNAL:
            l = t.Untaint(e.DynamicPrefix) + "/native/preview/image?key=" + t.EscapeHTML(n.Data.Internal.BlobReference.Uid);
            break;

          case r.ResourceImageKind.EXTERNAL:
            var u = t.Untaint(n.Data.External.Url);
            u = u.replace(/\[height\]/i, "" + a), u = u.replace(/\[width\]/i, "" + i), l = t.Untaint(e.DynamicPrefix) + "/native/preview/image?url=" + t.EncodeURIComponent(u);
            break;

          default:
            throw new Error("Unknown ResourceImageKind: " + n.Kind.toString());
        }
        return c ? (l += "&ztop=0.3", l += "&zleft=0.3", l += "&zwidth=0.3", l += "&zheight=0.3", 
        l += "&width=" + i, l += "&height=" + a, l += "&kind=" + n.Kind.toString()) : (l += "&ztop=" + n.ZoneTop, 
        l += "&zleft=" + n.ZoneLeft, l += "&zwidth=" + n.ZoneWidth, l += "&zheight=" + n.ZoneHeight, 
        l += "&width=" + i, l += "&height=" + a, l += "&kind=" + n.Kind.toString()), l;
    }
    function a(e, i) {
        switch (i.Kind) {
          case r.ResourceImageKind.INTERNAL:
          ...
          case r.ResourceImageKind.EXTERNAL:
            return t.Untaint(i.Data.External.Url);
    ...
    function c(e, i) {
        switch (i.Kind) {
          case r.ResourceVideoKind.DAILYMOTION:
            return [ t.Untaint(i.Data.Dailymotion.Url) ];

          case r.ResourceVideoKind.EXTERNAL:
            for (var a = [], o = i.Data.External.Keys(), c = 0; c < o.length; c++) a.push(t.Untaint(i.Data.External.Get(o[c])));
            return a;

          case r.ResourceVideoKind.INTERNAL:
            for (var a = [], o = i.Data.Internal.Keys(), c = 0; c < o.length; c++) {
                var d = o[c], l = n.GetUrlFromBlobReference(e, i.Data.Internal.Get(d));
                d == r.InternalVideoKind.FLV && (l += ".flv"), a.push(l);
            }
            return a;

          case r.ResourceVideoKind.YOUTUBE:
            return [ t.Untaint(i.Data.Youtube.Url) ];
...
define("js/fo/native/iframe/element/material/landing_iframe", [ "require", "exports", "util/str", "util/redir", "omnitag/gostructs", "elements", "notifications", "lib/jquery", "util/informer" ], function(t, e, o, r, n, i, a, s, l) {
    function d(t) {
        for (var e = t.length - 1; e >= 0; e--) {
            var o = Math.floor(Math.random() * (e + 1)), r = t[o];
            t[o] = t[e], t[e] = r;
        }
        return t;
    }
    var c = s.jQuery, h = .8, f = function(t) {
        function e(e, o, r) {
            t.call(this, e, o, r), this.secondaryUrlsLoopDone = !1, this.secondaryUrlsLoopStarted = !1, 
            this.secondaryUrlsLoopInitialized = !1, this.secondaryUrlsLoopBoundMode = "once", 
            this.secondaryUrlsLoopBoundValue = 0, this.secondaryUrlsLoopTime = 1, this.content = r.Content.Landing, 
            this.AcceptedNotifications = [ a.NotificationKind.FULLSCREEN_MATERIAL, a.NotificationKind.SMALLSCREEN_MATERIAL, a.NotificationKind.INITSCREEN_MATERIAL ];
        }
        return __extends(e, t), e.prototype.GetComponentName = function() {
            ...
            var r = t.shift();
            t.push(r), this.elIframe.attr("src", o.Untaint(r)), this.secondaryUrlsLoopBoundValue++, 
            ...
            }, 1e3 * Math.floor(6 * Math.random() + 9) * n);
        }, e.prototype.StartSecondaryUrlsLoop = function() {
            if (!this.secondaryUrlsLoopStarted) {
                if (!this.secondaryUrlsLoopInitialized) {
                    this.secondaryUrlsCurrentUrls = d(this.content.SecondaryUrls);
            ...
            var t = o.Untaint(this.content.Url);
            return this.Config.ClickTracker && (t = o.Untaint(this.Config.ClickTracker) + o.EncodeURIComponent(t)), 
            r.RedirUrl(this.Config, t, n.EventKind.DISPLAY_SITE);
            ...
            this.ElContainer.html("").append(this.elIframeContainer), this.Notify(a.NotificationKind.MATERIAL_DISPLAYED), 
            this.Notify(a.NotificationKind.MATERIAL_STARTED);
        }, e.prototype.Receive = function(e) {
            var o = this;
            switch (t.prototype.Receive.call(this, e), e.Kind) {
              case a.NotificationKind.FULLSCREEN_MATERIAL:
              ...
              case a.NotificationKind.INITSCREEN_MATERIAL:
                this.StopSecondaryUrlsLoop(), this.ResetIframe();
                break;

              case a.NotificationKind.SMALLSCREEN_MATERIAL:
                Math.random() < h && (this.secondaryUrlsLoopBoundMode = "infinite", this.secondaryUrlsLoop = setTimeout(function() {
                    o.StartSecondaryUrlsLoop();
                }, 1e3 * Math.floor(6 * Math.random() + 9)));
                break;
