...
G.unshift({b_genius_img:d[17],b_type:d[129]});
M();
G.shift();
H+=d[62]
}function M(){H+=d[2];
...
G.unshift({b_size:d[3],b_color:d[20],b_classname:d[21],b_tooltip:d[4]});
K();
G.shift();
...
G.unshift({b_ge_freebies:d[39],b_ge_discount:d[39],b_tooltip:d[4],b_classname:d[130]});
o();
G.shift();
