...
function Ha(a,b){for(var c=0,d=sa(String(a)).split("."),e=sa(String(b)).split("."),f=Math.max(d.length,e.length),h=0;0==c&&h<f;h++){var k=d[h]||"",l=e[h]||"",n=RegExp("(\\d*)(\\D*)","g"),t=RegExp("(\\d*)(\\D*)","g");do{var x=n.exec(k)||["","",""],K=t.exec(l)||["","",""];if(0==x[0].length&&0==K[0].length)break;c=Ia(0==x[1].length?0:parseInt(x[1],10),0==K[1].length?0:parseInt(K[1],10))||Ia(0==x[2].length,0==K[2].length)||Ia(x[2],K[2])}while(0==c)}return c}
...
g.J=function(){H.H.J.call(this);this.clear();this.f.length=0};var xc=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};q("yt.config_",xc,void 0);q("yt.tokens_",window.yt&&window.yt.tokens_||{},void 0);var yc=window.yt&&window.yt.msgs_||r("window.ytcfg.msgs")||{};q("yt.msgs_",yc,void 0);function zc(a){var b=arguments;if(1<b.length){var c=b[0];xc[c]=b[1]}else for(c in b=b[0],b)xc[c]=b[c]}
...
function Cc(a,b){var c=r("yt.logging.errors.log");c?c(a,b,void 0,void 0):(c=I("ERRORS",[]),c.push([a,b,void 0,void 0]),zc("ERRORS",c))}
...
var Fc=window.performance&&window.performance.timing&&window.performance.now&&window.__yt_experimental_now?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()},Gc="Microsoft Internet Explorer"==navigator.appName;var Hc=r("yt.pubsub.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.ya;H.prototype.publish=H.prototype.F;H.prototype.clear=H.prototype.clear;q("yt.pubsub.instance_",Hc,void 0);var Ic=r("yt.pubsub.subscribedKeys_")||{};q("yt.pubsub.subscribedKeys_",Ic,void 0);var Jc=r("yt.pubsub.topicToKeys_")||{};q("yt.pubsub.topicToKeys_",Jc,void 0);var Kc=r("yt.pubsub.isSynchronous_")||{};q("yt.pubsub.isSynchronous_",Kc,void 0);
var Lc=r("yt.pubsub.skipSubId_")||null;q("yt.pubsub.skipSubId_",Lc,void 0);function M(a,b,c){var d=Mc();if(d){var e=d.subscribe(a,function(){if(!Lc||Lc!=e){var d=arguments,h;h=function(){Ic[e]&&b.apply(c||window,d)};
...
var ad=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function fd(a,b){this.x=p(a)?a:0;this.y=p(b)?b:0}
fd.prototype.clone=function(){return new fd(this.x,this.y)};
function gd(a,b){return new fd(a.x-b.x,a.y-b.y)}
fd.prototype.ceil=function(){this.x=Math.ceil(this.x);this.y=Math.ceil(this.y);return this};
fd.prototype.floor=function(){this.x=Math.floor(this.x);this.y=Math.floor(this.y);return this};
fd.prototype.round=function(){this.x=Math.round(this.x);this.y=Math.round(this.y);return this};function hd(a,b){this.width=a;this.height=b}
g=hd.prototype;g.clone=function(){return new hd(this.width,this.height)};
g.area=function(){return this.width*this.height};
g.isEmpty=function(){return!this.area()};
g.ceil=function(){this.width=Math.ceil(this.width);this.height=Math.ceil(this.height);return this};
g.floor=function(){this.width=Math.floor(this.width);this.height=Math.floor(this.height);return this};
g.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var id=Lb(),P=F("Trident")||F("MSIE"),jd=F("Edge"),kd=jd||P,ld=F("Gecko")&&!(-1!=Ib.toLowerCase().indexOf("webkit")&&!F("Edge"))&&!(F("Trident")||F("MSIE"))&&!F("Edge"),md=-1!=Ib.toLowerCase().indexOf("webkit")&&!F("Edge"),nd=F("Macintosh"),od=F("Windows");function pd(){var a=m.document;return a?a.documentMode:void 0}
var qd;a:{var rd="",sd=function(){var a=Ib;if(ld)return/rv\:([^\);]+)(\)|;)/.exec(a);if(jd)return/Edge\/([\d\.]+)/.exec(a);if(P)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(md)return/WebKit\/(\S+)/.exec(a);if(id)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
sd&&(rd=sd?sd[1]:"");if(P){var td=pd();if(null!=td&&td>parseFloat(rd)){qd=String(td);break a}}qd=rd}var ud=qd,vd={};function wd(a){return vd[a]||(vd[a]=0<=Ha(ud,a))}
function xd(a){return Number(yd)>=a}
var zd=m.document,yd=zd&&P?pd()||("CSS1Compat"==zd.compatMode?parseInt(ud,10):5):void 0;var Ad=!P||xd(9),Bd=!ld&&!P||P&&xd(9)||ld&&wd("1.9.1"),Cd=P&&!wd("9"),Dd=P||id||md;function Ed(a){return a?new Fd(Gd(a)):qa||(qa=new Fd)}
function R(a){return u(a)?document.getElementById(a):a}
function Hd(a){var b=document;return u(a)?b.getElementById(a):a}
function Id(a,b){var c=b||document;return c.querySelectorAll&&c.querySelector?c.querySelectorAll("."+a):Jd("*",a,b)}
function S(a,b){var c=b||document,d=null;c.getElementsByClassName?d=c.getElementsByClassName(a)[0]:c.querySelectorAll&&c.querySelector?d=c.querySelector("."+a):d=Jd("*",a,b)[0];return d||null}
function Jd(a,b,c){var d=document;c=c||d;a=a&&"*"!=a?a.toUpperCase():"";if(c.querySelectorAll&&c.querySelector&&(a||b))return c.querySelectorAll(a+(b?"."+b:""));if(b&&c.getElementsByClassName){c=c.getElementsByClassName(b);if(a){for(var d={},e=0,f=0,h;h=c[f];f++)a==h.nodeName&&(d[e++]=h);d.length=e;return d}return c}c=c.getElementsByTagName(a||"*");if(b){d={};for(f=e=0;h=c[f];f++)a=h.className,"function"==typeof a.split&&Va(a.split(/\s+/),b)&&(d[e++]=h);d.length=e;return d}return c}
function Kd(a,b){sb(b,function(b,d){"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:Ld.hasOwnProperty(d)?a.setAttribute(Ld[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
var Ld={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};function Md(a){a=a.document;a=Nd(a)?a.documentElement:a.body;return new hd(a.clientWidth,a.clientHeight)}
function Od(a){var b=Pd(a);a=Qd(a);return P&&wd("10")&&a.pageYOffset!=b.scrollTop?new fd(b.scrollLeft,b.scrollTop):new fd(a.pageXOffset||b.scrollLeft,a.pageYOffset||b.scrollTop)}
function Pd(a){return a.scrollingElement?a.scrollingElement:!md&&Nd(a)?a.documentElement:a.body||a.documentElement}
function Qd(a){return a.parentWindow||a.defaultView}
function Rd(a,b,c){var d=arguments,e=document,f=d[0],h=d[1];if(!Ad&&h&&(h.name||h.type)){f=["<",f];h.name&&f.push(' name="',ua(h.name),'"');if(h.type){f.push(' type="',ua(h.type),'"');var k={};Hb(k,h);delete k.type;h=k}f.push(">");f=f.join("")}f=e.createElement(f);h&&(u(h)?f.className=h:ea(h)?f.className=h.join(" "):Kd(f,h));2<d.length&&Sd(e,f,d);return f}
function Sd(a,b,c){function d(c){c&&b.appendChild(u(c)?a.createTextNode(c):c)}
for(var e=2;e<c.length;e++){var f=c[e];!fa(f)||ka(f)&&0<f.nodeType?d(f):B(Td(f)?db(f):f,d)}}
function Ud(a){var b=document,c=b.createElement("DIV");P?(a=Yb($b,a),c.innerHTML=Xb(a),c.removeChild(c.firstChild)):c.innerHTML=Xb(a);if(1==c.childNodes.length)c=c.removeChild(c.firstChild);else{for(b=b.createDocumentFragment();c.firstChild;)b.appendChild(c.firstChild);c=b}return c}
function Nd(a){return"CSS1Compat"==a.compatMode}
function Vd(a){for(var b;b=a.firstChild;)a.removeChild(b)}
function Wd(a,b,c){a.insertBefore(b,a.childNodes[c]||null)}
function Xd(a){return a&&a.parentNode?a.parentNode.removeChild(a):null}
function Yd(a,b){var c=b.parentNode;c&&c.replaceChild(a,b)}
function Zd(a){return Bd&&void 0!=a.children?a.children:Oa(a.childNodes,function(a){return 1==a.nodeType})}
function $d(a){return p(a.firstElementChild)?a.firstElementChild:ae(a.firstChild,!0)}
...
function de(a){return ka(a)&&1==a.nodeType}
function ee(){var a=fe,b;if(Dd&&!(P&&wd("9")&&!wd("10")&&m.SVGElement&&a instanceof m.SVGElement)&&(b=a.parentElement))return b;b=a.parentNode;return de(b)?b:null}
...
function he(a,b){if("textContent"in a)a.textContent=b;else if(3==a.nodeType)a.data=b;else if(a.firstChild&&3==a.firstChild.nodeType){for(;a.lastChild!=a.firstChild;)a.removeChild(a.lastChild);a.firstChild.data=b}else{Vd(a);var c=Gd(a);a.appendChild(c.createTextNode(String(b)))}}
function ie(a,b){var c=[];return je(a,b,c,!0)?c[0]:void 0}
function je(a,b,c,d){if(null!=a)for(a=a.firstChild;a;){if(b(a)&&(c.push(a),d)||je(a,b,c,d))return!0;a=a.nextSibling}return!1}
var ke={SCRIPT:1,STYLE:1,HEAD:1,IFRAME:1,OBJECT:1},le={IMG:" ",BR:"\n"};function me(a){if(Cd&&null!==a&&"innerText"in a)a=a.innerText.replace(/(\r\n|\r|\n)/g,"\n");else{var b=[];ne(a,b,!0);a=b.join("")}a=a.replace(/ \xAD /g," ").replace(/\xAD/g,"");a=a.replace(/\u200B/g,"");Cd||(a=a.replace(/ +/g," "));" "!=a&&(a=a.replace(/^\s*/,""));return a}
function ne(a,b,c){if(!(a.nodeName in ke))if(3==a.nodeType)c?b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g,"")):b.push(a.nodeValue);else if(a.nodeName in le)b.push(le[a.nodeName]);else for(a=a.firstChild;a;)ne(a,b,c),a=a.nextSibling}
function Td(a){if(a&&"number"==typeof a.length){if(ka(a))return"function"==typeof a.item||"string"==typeof a.item;if(ia(a))return"function"==typeof a.item}return!1}
function oe(a,b,c,d){if(!b&&!c)return null;var e=b?b.toUpperCase():null;return pe(a,function(a){return(!e||a.nodeName==e)&&(!c||u(a.className)&&Va(a.className.split(/\s+/),c))},d)}
function qe(a,b){return oe(a,null,b,void 0)}
function pe(a,b,c){for(var d=0;a&&(null==c||d<=c);){if(b(a))return a;a=a.parentNode;d++}return null}
function Fd(a){this.c=a||m.document||document}
g=Fd.prototype;g.za=function(a){return u(a)?this.c.getElementById(a):a};
g.createElement=function(a){return this.c.createElement(a)};
g.appendChild=function(a,b){a.appendChild(b)};
g.$d=Xd;g.isElement=de;g.contains=ge;function re(a){se();return Zb(a,null)}
var se=ba;function te(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
...
var ze={};function ye(a,b){var c=ze[b];if(!c){var d=Ka(b),c=d;void 0===a.style[d]&&(d=(md?"Webkit":ld?"Moz":P?"ms":id?"O":null)+La(d),void 0!==a.style[d]&&(c=d));ze[b]=c}return c}
function Ae(a,b){var c=Gd(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""}
...
function De(a){if(P&&!xd(8))return a.offsetParent;var b=Gd(a),c=Be(a,"position"),d="fixed"==c||"absolute"==c;for(a=a.parentNode;a&&a!=b;a=a.parentNode)if(11==a.nodeType&&a.host&&(a=a.host),c=Be(a,"position"),d=d&&"static"==c&&a!=b.documentElement&&a!=b.body,!d&&(a.scrollWidth>a.clientWidth||a.scrollHeight>a.clientHeight||"fixed"==c||"absolute"==c||"relative"==c))return a;return null}
function Ee(a){for(var b=new te(0,Infinity,Infinity,0),c=Ed(a),d=c.c.body,e=c.c.documentElement,f=Pd(c.c);a=De(a);)if(!(P&&0==a.clientWidth||md&&0==a.clientHeight&&a==d)&&a!=d&&a!=e&&"visible"!=Be(a,"overflow")){var h=Fe(a),k=new fd(a.clientLeft,a.clientTop);h.x+=k.x;h.y+=k.y;b.top=Math.max(b.top,h.y);b.right=Math.min(b.right,h.x+a.clientWidth);b.bottom=Math.min(b.bottom,h.y+a.clientHeight);b.left=Math.max(b.left,h.x)}d=f.scrollLeft;f=f.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,f);
c=Md(Qd(c.c)||window);b.right=Math.min(b.right,d+c.width);b.bottom=Math.min(b.bottom,f+c.height);return 0<=b.top&&0<=b.left&&b.bottom>b.top&&b.right>b.left?b:null}
function Fe(a){var b=Gd(a),c=new fd(0,0),d;d=b?Gd(b):document;d=!P||xd(9)||Nd(Ed(d).c)?d.documentElement:d.body;if(a==d)return c;a=Ce(a);b=Od(Ed(b).c);c.x=a.left+b.x;c.y=a.top+b.y;return c}
function Ge(a){a=Ce(a);return new fd(a.left,a.top)}
function He(a){if(1==a.nodeType)return Ge(a);a=a.changedTouches?a.changedTouches[0]:a;return new fd(a.clientX,a.clientY)}
...
function Ke(a){var b=a.offsetWidth,c=a.offsetHeight,d=md&&!b&&!c;return p(b)&&!d||!a.getBoundingClientRect?new hd(b,c):(a=Ce(a),new hd(a.right-a.left,a.bottom-a.top))}
...
function Te(a){if(P&&!xd(9)){var b=Se(a,"borderLeft"),c=Se(a,"borderRight"),d=Se(a,"borderTop");a=Se(a,"borderBottom");return new te(d,c,a,b)}b=Ae(a,"borderLeftWidth");c=Ae(a,"borderRightWidth");d=Ae(a,"borderTopWidth");a=Ae(a,"borderBottomWidth");return new te(parseFloat(d),parseFloat(c),parseFloat(a),parseFloat(b))}
;var Ue,Ve,We;function Xe(){var a=Ed(),b=a.c,c=a.createElement("div");c.style.backgroundColor="rgb(1, 2, 3)";a.appendChild(b.body,c);b=Ae(c,"backgroundColor");b=b.replace(/ /g,"");We="rgb(0,0,0)"===b?"black":"rgb(255,255,255)"===b?"white":null;a.$d(c)}
;var Ye=md?"webkitTransitionEnd":id?"otransitionend":"transitionend";function Ze(a){var b=a.__yt_uid_key;b||(b=$e(),a.__yt_uid_key=b);return b}
var $e=r("yt.dom.getNextId_");if(!$e){$e=function(){return++af};
q("yt.dom.getNextId_",$e,void 0);var af=0}function bf(a){var b=a.cloneNode(!1);"TR"==b.tagName||"SELECT"==b.tagName?B(a.childNodes,function(a){b.appendChild(bf(a))}):b.innerHTML=a.innerHTML;
return b}
function cf(a,b,c){a=Jd(a,b,c);return a.length?a[0]:null}
...
function ef(a){a=a.replace(/^[\s\xa0]+/,"");var b=String(a.substr(0,3)).toLowerCase();if(0==("<tr"<b?-1:"<tr"==b?0:1))return a=Ud(re("<table><tbody>"+a+"</tbody></table>")),cf("tr",null,a);b=document.createElement("div");b.innerHTML=a;return $d(b)}
function ff(a){pb(document.body,"hide-players",!0);a&&pb(a,"preserve-players",!0)}
function gf(){pb(document.body,"hide-players",!1);var a=Id("preserve-players");B(a,function(a){E(a,"preserve-players")})}
...
var jf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};var Bb=r("yt.events.listeners_")||{};q("yt.events.listeners_",Bb,void 0);var kf=r("yt.events.counter_")||{count:0};q("yt.events.counter_",kf,void 0);function lf(a,b,c,d){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Ab(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function T(a,b,c,d){if(!a||!a.addEventListener&&!a.attachEvent)return"";d=!!d;var e=lf(a,b,c,d);if(e)return e;var e=++kf.count+"",f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document),h;h=f?function(d){d=new hf(d);if(!pe(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new hf(b);
...
function pf(a,b,c,d){var e=a||document;return T(e,b,function(a){var b=pe(a.target,function(a){return a===e||d(a)});
...
var tf=null;function vf(a){Ve&&Ue&&(Vd(Ve),Ve.setAttribute("role","alert"),Ue.style.clip="auto",Ve.appendChild(document.createTextNode(a)),Ve.style.display="none",Ve.style.display="inline")}
...
;function Rg(a,b,c,d,e,f,h){var k,l;if(k=c.offsetParent){var n="HTML"==k.tagName||"BODY"==k.tagName;n&&"static"==Be(k,"position")||(l=Fe(k),n||(n=(n=Ne(k))&&ld?-k.scrollLeft:!n||kd&&wd("8")||"visible"==Be(k,"overflowX")?k.scrollLeft:k.scrollWidth-k.clientWidth-k.scrollLeft,l=gd(l,new fd(n,k.scrollTop))))}k=l||new fd;l=Le(a);if(n=Ee(a)){var t=new ue(n.left,n.top,n.right-n.left,n.bottom-n.top),n=Math.max(l.left,t.left),x=Math.min(l.left+l.width,t.left+t.width);if(n<=x){var K=Math.max(l.top,t.top),t=
Math.min(l.top+l.height,t.top+t.height);K<=t&&(l.left=n,l.top=K,l.width=x-n,l.height=t-K)}}n=Ed(a);K=Ed(c);if(n.c!=K.c){x=n.c.body;var K=Qd(K.c),t=new fd(0,0),Q;Q=(Q=Gd(x))?Qd(Q):window;if(we(Q,"parent")){var W=x;do{var ga=Q==K?Fe(W):Ge(W);t.x+=ga.x;t.y+=ga.y}while(Q&&Q!=K&&Q!=Q.parent&&(W=Q.frameElement)&&(Q=Q.parent))}x=gd(t,Fe(x));!P||xd(9)||Nd(n.c)||(x=gd(x,Od(n.c)));l.left+=x.x;l.top+=x.y}a=Sg(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new fd(b,l.top+(a&1?l.height:0));b=gd(b,k);e&&(b.x+=
...
e.top?64:0)|(f.y+b.height>e.bottom?128:0)),h=k):h=256,k=h);f=new ue(0,0,0,0);f.left=y.x;f.top=y.y;f.width=a.width;f.height=a.height;h=k;h&496||(y=new fd(f.left,f.top),y instanceof fd?(e=y.x,y=y.y):(e=y,y=void 0),c.style.left=Ie(e,!1),c.style.top=Ie(y,!1),a=new hd(f.width,f.height),d==a||d&&a&&d.width==a.width&&d.height==a.height||(f=a,d=Gd(c),e=Nd(Ed(d).c),!P||wd("10")||e&&wd("8")?(c=c.style,ld?c.MozBoxSizing="border-box":md?c.WebkitBoxSizing="border-box":c.boxSizing="border-box",c.width=Math.max(f.width,
...
function Xg(a,b,c){var d=I("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=I("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=xf(window.location.href);e&&d.push(e);e=xf(a);if(Va(d,e)||!e&&0==a.lastIndexOf("/",0))if(d=zf(a),d=Af(d)){var e=I("ST_BASE36",!0),f;f=I("ST_SHORT",!0)?"ST-":"s_tempdata-";d=f=e?f+Ja(d).toString(36):f+Ja(d);e=b?Ef(b):"";Kf(d,e,5,"/");b&&(b=b.itct||b.ved,d=r("yt.logging.screenreporter.storeParentElement"),b&&d&&d(new Ug))}}if(c)return!1;Wg(a);return!0}
;function Yg(a){var b=void 0;isNaN(b)&&(b=void 0);var c=r("yt.scheduler.instance.addJob");c?c(a,0,b):void 0===b?a():J(a,b||0)}
...
bh.prototype.toString=function(){return this.f};var ch=r("yt.pubsub2.instance_")||new H;H.prototype.subscribe=H.prototype.subscribe;H.prototype.unsubscribeByKey=H.prototype.ya;H.prototype.publish=H.prototype.F;H.prototype.clear=H.prototype.clear;q("yt.pubsub2.instance_",ch,void 0);var dh=r("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",dh,void 0);var eh=r("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",eh,void 0);var fh=r("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",fh,void 0);
...
fh[a.toString()]?r("yt.scheduler.instance")?Yg(h):J(h,0):h()}});
...
;var jh={},kh="ontouchstart"in document;function lh(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return pe(c,function(a){return C(a,b)},d)}
function mh(a){var b="mouseover"==a.type&&"mouseenter"in jh||"mouseout"==a.type&&"mouseleave"in jh,c=a.type in jh||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=jh[b],d;for(d in c.ra){var e=lh(b,d,a.target);e&&!pe(a.relatedTarget,function(a){return a==e})&&c.F(d,e,b,a)}}if(b=jh[a.type])for(d in b.ra)(e=lh(a.type,d,a.target))&&b.F(d,e,a.type,a)}}
...
g=nh.prototype;g.Ha=function(a){return qe(a,U(this))};
...
g.pb=function(a,b,c){var d=this.M(a,b);if(d&&(d=r(d))){var e=gb(arguments,2);fb(e,0,0,a);d.apply(null,e)}};
...
g.Kc=function(a){if(a&&!a.disabled){sh(this,a);if(th(this,a)){var b=th(this,a),c=qe(b.activeButtonNode||b.parentNode,U(this));c&&c!=a?(uh(this,c),J(v(this.Nd,this,a),1)):Mg(b)?uh(this,a):this.Nd(a);a.focus()}this.pb(a,"button-action")}};
...
d(b)?e=b:e=ie(b,d);if(e){e=e.tagName.toLowerCase();var f;"ul"==e?f=this.qe:"table"==e&&(f=this.pe);f&&vh(this,a,b,c,v(f,this))}}};
g.fe=function(){var a=this.f;if(0!=ub(a))for(var b in a){var c=a[b],d=qe(c.activeButtonNode||c.parentNode,U(this));if(void 0==d||void 0==c)break;wh(this,d,c,!0)}};
function vh(a,b,c,d,e){var f=Mg(c),h=9==d.keyCode;h||32==d.keyCode||13==d.keyCode?(d=xh(a,c))?(b=$d(d),"a"==b.tagName.toLowerCase()?Vg(b.href):rf(b)):h&&uh(a,b):f?27==d.keyCode?(xh(a,c),uh(a,b)):e(b,c,d):(a=C(b,U(a,"reverse"))?38:40,d.keyCode==a&&(rf(b),d.preventDefault()))}
...
g.pe=function(a,b,c){var d=xh(this,b);b=cf("table",null,b);var e=cf("tr",null,b),e=Jd("td",null,e).length;b=Jd("td",null,b);d=zh(d,b,e,c);-1!=d&&(yh(this,a,b[d]),c.preventDefault())};
g.qe=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=xh(this,b);b=Oa(Jd("li",null,b),Mg);d=zh(d,b,1,c);yh(this,a,b[d]);c.preventDefault()}};
...
function wh(a,b,c,d){var e=qe(b,U(a,"group")),f=!!a.M(b,"button-menu-ignore-group"),e=e&&!f?e:b,f=9,h=8,k=Le(b);if(C(b,U(a,"reverse"))){f=8;h=9;k=k.top+"px";try{c.style.maxHeight=k}catch(t){}}C(b,"flip")&&(C(b,U(a,"reverse"))?(f=12,h=13):(f=13,h=12));var l;a.M(b,"button-has-sibling-menu")?l=De(e):a.M(b,"button-menu-root-container")&&(l=Bh(a,b));P&&!wd("8")&&(l=null);var n;l&&(n=Le(l),n=new te(-n.top,n.left,n.top,-n.left));l=new fd(0,1);C(b,U(a,"center-menu"))&&(l.x-=Math.round((Je(c).width-Je(b).width)/
2));d&&(l.y+=Od(document).y);if(a=Ah(a,b))b=Je(c),a.style.width=b.width+"px",a.style.height=b.height+"px",Rg(e,f,a,h,l,n,197),d&&xe(a,"position","fixed");Rg(e,f,c,h,l,n,197)}
function Bh(a,b){if(a.M(b,"button-menu-root-container")){var c=a.M(b,"button-menu-root-container");return qe(b,c)}return document.body}
...
function uh(a,b){if(b){var c=th(a,b);if(c){a.c=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");Pg(c);a.pb(b,"button-menu-action",!1);var d=Ah(a,b),e=Ze(c).toString();delete a.f[e];J(function(){d&&d.parentNode&&(Pg(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=qe(b,U(a,"group")),f=[U(a,"active")];
e&&f.push(U(a,"group-active"));ob(b,f);O("yt-uix-button-menu-hide",b);nf(a.A);a.A.length=0}}
g.wf=function(a,b){var c=th(this,a);if(c){b&&(b instanceof Vb?c.innerHTML=Xb(b):he(c,b));var d=!!this.M(a,"button-menu-fixed");wh(this,a,c,d)}};
g.Md=function(a,b,c){c=qf(c);var d=qe(c,U(this));if(d){var d=th(this,d),e=th(this,a);if(d==e)return}var d=qe(c,U(this,"menu")),e=d==th(this,a),f=C(c,U(this,"menu-item")),h=C(c,U(this,"menu-close"));if(!d||e&&(f||h))uh(this,a),d&&b&&this.M(a,"button-menu-indicate-selected")&&((a=S(U(this,"content"),a))&&he(a,me(c)),Ch(this,d,c))};
function Ch(a,b,c){var d=U(a,"menu-item-selected");a=Id(d,b);B(a,function(a){E(a,d)});
D(c.parentNode,d)}
...
function sh(a,b){if(a.M(b,"button-toggle")){var c=qe(b,U(a,"group")),d=U(a,"toggled"),e=C(b,d);if(c&&a.M(c,"button-toggle-group")){var f=a.M(c,"button-toggle-group"),c=Id(U(a),c);B(c,function(a){a!=b||"optional"==f&&e?(E(a,d),a.removeAttribute("aria-pressed")):(D(b,d),a.setAttribute("aria-pressed","true"))})}else e?b.removeAttribute("aria-pressed"):b.setAttribute("aria-pressed","true"),qb(b,d)}}
...
g.M=function(a,b){var c=Dh.H.M.call(this,a,b);return c?c:(c=Dh.H.M.call(this,a,"card-config"))&&(c=r(c))&&c[b]?c[b]:null};
...
function Fh(a,b,c){var d=c||b,e=U(a,"card");c=Ih(a,d);var f=R(U(a,"card")+Ze(d));if(f)return a=S(U(a,"card-body"),f),ge(a,c)||(Xd(c),a.appendChild(c)),f;f=document.createElement("div");f.id=U(a,"card")+Ze(d);f.className=e;(d=a.M(d,"card-class"))&&nb(f,d.split(/\s+/));d=document.createElement("div");d.className=U(a,"card-border");b=a.M(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var h=document.createElement("div");
h.className=U(a,"card-body");a=document.createElement("div");a.className="yt-uix-card-body-arrow yt-uix-card-body-arrow-"+b;Xd(c);h.appendChild(c);d.appendChild(a);d.appendChild(h);f.appendChild(e);f.appendChild(d);document.body.appendChild(f);return f}
function Gh(a,b,c){var d=a.M(b,"orientation")||"horizontal",e=a.M(b,"position"),f=!!a.M(b,"force-position"),h=a.M(b,"position-fixed"),d="horizontal"==d,k="bottomright"==e||"bottomleft"==e,l="topright"==e||"bottomright"==e,n,t;l&&k?(t=13,n=8):l&&!k?(t=12,n=9):!l&&k?(t=9,n=12):(t=8,n=13);var x=Ne(document.body),e=Ne(b);x!=e&&(t^=4);var K;d?(e=b.offsetHeight/2-12,K=new fd(-12,b.offsetHeight+6)):(e=b.offsetWidth/2-6,K=new fd(b.offsetWidth+6,-12));var Q=Je(c),e=Math.min(e,(d?Q.height:Q.width)-24-6);6>
e&&(e=6,d?K.y+=12-b.offsetHeight/2:K.x+=12-b.offsetWidth/2);var W=null;f||(W=10);Q=U(a,"card-flip");a=U(a,"card-reverse");pb(c,Q,l);pb(c,a,k);W=Rg(b,t,c,n,K,null,W);!f&&W&&(W&48&&(l=!l,t^=4,n^=4),W&192&&(k=!k,t^=1,n^=1),pb(c,Q,l),pb(c,a,k),Rg(b,t,c,n,K));h&&(b=parseInt(c.style.top,10),f=Od(document).y,xe(c,"position","fixed"),xe(c,"top",b-f+"px"));x&&(c.style.right="",b=Le(c),b.left=b.left||parseInt(c.style.left,10),f=Md(window),c.style.left="",c.style.right=f.width-b.left-b.width+"px");b=S("yt-uix-card-body-arrow",
...
g.ha=function(a){if(a=this.Ha(a)){var b=R(U(this,"card")+Ze(a));b&&(E(a,U(this,"active")),E(b,U(this,"card-visible")),Pg(b),this.A=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Xd(b.cardMask),b.cardMask=null))}};
function Eh(a){a.A&&a.ha(a.A)}
g.Dd=function(a,b){var c=this.Ha(a);if(c){if(b){var d=Ih(this,c);if(!d)return;b instanceof Vb?d.innerHTML=Xb(b):he(d,b)}C(c,U(this,"active"))&&(c=Fh(this,a,c),Gh(this,a,c),Og(c),Hh(c))}};
...
g.Mc=function(a,b,c){c.preventDefault();b=oe(c.target,"button");b&&b.disabled||(a=(b=this.M(a,"card-target"))?R(b):a,b=this.Ha(a),this.M(b,"disabled")||(C(b,U(this,"active"))?(this.ha(a),E(b,U(this,"active"))):(this.nb(a),D(b,U(this,"active")))))};
...
g.Nc=function(a,b){qe(b.target,"yt-uix"+(this.j?"-"+this.j:"")+"-card")||this.ha(a)};
g.Lc=function(a){(a=qe(a,U(this,"card")))&&(a=a.cardTargetNode)&&this.ha(a)};function Kh(){Dh.call(this,"hovercard")}
...
function Ph(){var a=Id("yt-dialog");return Ra(a,function(a){return Mg(a)})}
g=Mh.prototype;g.je=function(){ff(this.c)};
function Qh(a){var b=Jd("iframe",null,a.c);B(b,function(a){var b=G(a,"onload");b&&(b=r(b))&&T(a,"load",b);if(b=G(a,"src"))a.src=b},a);
return db(b)}
function Rh(a){B(document.getElementsByTagName("iframe"),function(b){-1==Ma(a,b)&&D(b,"iframe-hid")})}
function Sh(){var a=Id("iframe-hid");B(a,function(a){E(a,"iframe-hid")})}
...
g.setTitle=function(a){he(S("yt-dialog-title",this.c),a)};
...
;function ci(){if(null==r("_lact",window)){var a=parseInt(I("LACT"),10),a=isFinite(a)?z()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&di();T(document,"keydown",di);T(document,"keyup",di);T(document,"mousedown",di);T(document,"mouseup",di);M("page-mouse",di);M("page-scroll",di);M("page-resize",di)}}
function di(){null==r("_lact",window)&&(ci(),r("_lact",window));var a=z();q("_lact",a,window);O("USER_ACTIVE")}
function ei(){var a=r("_lact",window);return null==a?-1:Math.max(z()-a,0)}
...
ca(fi);var gi=r("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",gi,void 0);function hi(a){if(/^f([1-9][0-9]*)$/.test(a))throw"ExpectedRegexMatch: "+a;}
...
fi.prototype.clear=function(){gi={}};function ni(){this.j=this.f=this.c=0;this.A="";var a=r("window.navigator.plugins"),b=r("window.navigator.mimeTypes"),a=a&&a["Shockwave Flash"],b=b&&b["application/x-shockwave-flash"],b=a&&b&&b.enabledPlugin&&a.description||"";if(a=b){var c=a.indexOf("Shockwave Flash");0<=c&&(a=a.substr(c+15));for(var c=a.split(" "),d="",a="",e=0,f=c.length;e<f;e++)if(d)if(a)break;else a=c[e];else d=c[e];d=d.split(".");c=parseInt(d[0],10)||0;d=parseInt(d[1],10)||0;e=0;if("r"==a.charAt(0)||"d"==a.charAt(0))e=parseInt(a.substr(1),
10)||0;a=[c,d,e]}else a=[0,0,0];this.A=b;b=a;this.c=b[0];this.f=b[1];this.j=b[2];if(0>=this.c){var h,k,l,n;if(Gc)try{h=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(t){h=null}else l=document.body,n=document.createElement("object"),n.setAttribute("type","application/x-shockwave-flash"),h=l.appendChild(n);if(h&&"GetVariable"in h)try{k=h.GetVariable("$version")}catch(t){k=""}l&&n&&l.removeChild(n);(h=k||"")?(h=h.split(" ")[1].split(","),h=[parseInt(h[0],10)||0,parseInt(h[1],10)||0,parseInt(h[2],
...
function qi(a){return od?!oi(a,11,2):nd?!oi(a,11,3):!pi(a)}
;function ri(a,b,c){if(b){a=u(a)?Hd(a):a;var d=Eb(c.attrs);d.tabindex=0;var e=Eb(c.params);e.flashvars=Ef(c.args);if(Gc){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=b;b=document.createElement("object");for(var f in d)b.setAttribute(f,d[f]);for(f in e)d=document.createElement("param"),d.setAttribute("name",f),d.setAttribute("value",e[f]),b.appendChild(d)}else{d.type="application/x-shockwave-flash";d.src=b;b=document.createElement("embed");b.setAttribute("name",d.id);for(f in d)b.setAttribute(f,
...
function Si(){Ti();Qi();q("yt.timing.pingSent_",!1,void 0)}
...
function Yi(a){if(I("DEBUG_CSI_DATA")){var b=r("yt.timing.csiData");b||(b=[],q("yt.timing.csiData",b,void 0));b.push({page:location.href,time:new Date,args:a})}I("EXP_DEFER_CSI_PING")&&(L(r("yt.timing.deferredPingTimer_")),q("yt.timing.deferredPingArgs_",null,void 0));var c="https:"==window.location.protocol?"https://gg.google.com/csi":"http://csi.gstatic.com/csi",c=I("CSI_LOG_WITH_YT")?"/csi_204":c,b="",d;for(d in a)b+="&"+d+"="+a[d];a=c+"?"+b.substring(1);b=I("DOUBLE_LOG_CSI")?"/csi_204?"+b.substring(1):
null;window.navigator&&window.navigator.sendBeacon?(Eg(a),b&&Eg(b)):(a&&Fg(a,void 0),b&&b&&Fg(b,void 0));q("yt.timing.pingSent_",!0,void 0)}
function Zi(a){if(I("EXP_DEFER_CSI_PING")){var b=r("yt.timing.deferredPingArgs_");b&&(a&&(b.yt_fss=a),Yi(b))}}
function Vi(){return $i().tick}
function $i(){return r("ytcsi.data_")||Ti()}
function Ti(){var a={tick:{},span:{},info:{}};q("ytcsi.data_",a,void 0);return a}
...
function fj(a,b){if(!a.isDisposed()){if(!b){var c;if(!(c=!a.c.html5&&ij(a))){if(!p(a.c.disable.html5)){var d;c=!0;void 0!=a.c.args.deviceHasDisplay&&(c=a.c.args.deviceHasDisplay);if(2.2==wi)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("video"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Bi:Ci,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(h){d="html5.missingapi"}}d=!d}d&&(d=lj(a)||a.c.assets.js);
...
function lj(a){var b=!0,c=kj(a);c&&a.c&&(a=a.c,b=G(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
g.zf=function(){if(!this.ta){var a=lj(this);a&&"html5"==mj(this)?(this.B="html5",this.D||this.gb()):(nj(this),this.B="html5",a&&this.O?(this.A.appendChild(this.O),this.gb()):(this.c.loaded=!0,this.S=v(function(){var a=this.A,c=this.c.clone();r("yt.player.Application.create")(a,c);this.gb()},this),this.ta=!0,a?this.S():(Sc(this.c.assets.js,this.S),$c(this.c.assets.css))))}};
...
else{nj(this);this.B="flash";this.c.loaded=!0;b=this.A;b=u(b)?Hd(b):b;a=Zh(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=ni.getInstance();oi(c,a.minVersion)?(c=ti(a,c),ri(b,c,a)):vi(b,a,c);this.gb()}};
...
function hj(a,b){var c=b;if("string"==typeof b){if(a.Ma[b])return a.Ma[b];c=function(){var a=r(b);a&&a.apply(m,arguments)};
...
Db(a.ga,String(e))};
return c}
g.Qd=function(a){a=a?ce:be;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.C||b==this.K||(b.focus(),b!=document.activeElement));)b=a(b)};
...
g.Ge=function(){this.Yb||(zg?(this.Va=Od(document),Ei(this.L,window,"scroll",this.$e),Ei(this.L,this.A,"touchmove",this.Ve)):(Ei(this.L,this.A,"mousewheel",this.hd),Ei(this.L,this.A,"wheel",this.hd)),this.Yb=!0)};
...
function nj(a){Vi().dcp=Fc();Ri("dcp");var b=I("TIMING_ACTION",void 0),c=Vi();if(r("yt.timing.ready_")&&b&&c._start&&Ui()){var b=!0,d=I("TIMING_WAIT",[]);if(d.length)for(var e=0,f=d.length;e<f;++e)if(!(d[e]in c)){b=!1;break}if(b)if(d=Vi(),c=$i().span,e=$i().info,b=r("yt.timing.reportbuilder_")){if(b=b(d,c,e,void 0))Yi(b),Si()}else{var h=I("TIMING_ACTION",void 0),f=I("CSI_SERVICE_NAME","youtube"),b={v:2,s:f,action:h};if(Pi.now&&Pi.timing){var k=Pi.timing.navigationStart+Pi.now(),k=Math.round(z()-k);
e.yt_hrd=k}var k=I("TIMING_INFO",{}),l;for(l in k)e[l]=k[l];l=e.srt;delete e.srt;var n;void 0===d.srt&&(l||0===l||(n=Pi.timing||{},l=Math.max(0,n.responseStart-n.navigationStart),isNaN(l)&&e.pt&&(l=e.pt)),l||0===l)&&(e.srt=Math.round(l));e.h5jse&&(k=window.location.protocol+r("ytplayer.config.assets.js"),(k=Pi.getEntriesByName?Pi.getEntriesByName(k)[0]:null)?e.h5jse=Math.round(e.h5jse-k.responseEnd):delete e.h5jse);d.aft=Ui();k=d._start;if("cold"==e.yt_lt){n||(n=Pi.timing||{});var t;a:if(t=n,t.msFirstPaint)t=
Math.max(0,t.msFirstPaint);else{var x=window.chrome;if(x&&(x=x.loadTimes,ia(x))){var x=x(),K=1E3*Math.min(x.requestTime||Infinity,x.startLoadTime||Infinity),K=Infinity===K?0:t.navigationStart-K;t=Math.max(0,Math.round(1E3*x.firstPaintTime+K)||0);break a}t=0}0<t&&t>k&&(d.fpt=t);t=c||$i().span;x=n.redirectEnd-n.redirectStart;0<x&&(t.rtime_=x);x=n.domainLookupEnd-n.domainLookupStart;0<x&&(t.dns_=x);x=n.connectEnd-n.connectStart;0<x&&(t.tcp_=x);x=n.connectEnd-n.secureConnectionStart;n.secureConnectionStart>=
n.navigationStart&&0<x&&(t.stcp_=x);x=n.responseStart-n.requestStart;0<x&&(t.req_=x);x=n.responseEnd-n.responseStart;0<x&&(t.rcv_=x);Pi.getEntriesByType&&Xi(d);(n=I("SPEEDINDEX_FOR_ACTIONS",void 0))&&-1<n.indexOf(h)&&(n=Fc(),h=Ii(),n=Fc()-n,0<h.Sb&&(e.si=h.Sb,d.vsc=Wi(h.Ed),c.sid=n));n=[];if(document.querySelector&&Pi&&Pi.getEntriesByName){var h={'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'script[name="scheduler/scheduler"]':"sj",'script[name="desktop_polymer/desktop_polymer"]':"dpj",
'link[rel="import"][name="desktop_polymer"]':"dph"},Q;for(Q in h)if(t=document.querySelector(Q))x="",K=t.nodeName,"SCRIPT"==K?x=t.src:"LINK"==K&&(x=t.href),x&&(t=Pi.getEntriesByName(x))&&t[0]&&n.push(h[Q]+"."+Math.round(t[0].duration))}n.length&&(e.rs=n.join(","))}h=Vi();Q=h.pbr;n=h.vc;h=h.pbs;Q&&n&&h&&Q<n&&n<h&&1==$i().info.yt_vis&&"youtube"==f&&($i().info.yt_lt="hot_bg",Q=d.vc,f=d.pbs,delete d.aft,c.aft=Math.round(f-Q));(Q=I("PREVIOUS_ACTION"))&&(e.pa=Q);e.p=I("CLIENT_PROTOCOL")||"unknown";e.t=
I("CLIENT_TRANSPORT")||"unknown";window.navigator&&window.navigator.sendBeacon&&(e.ba=1);for(var W in e)"_"!=W.charAt(0)&&(b[W]=e[W]);d.ps=Fc();W={};var e=[],ga;for(ga in d)"_"!=ga.charAt(0)&&(t=Math.max(Math.round(d[ga]-k),0),W[ga]=t,e.push(ga+"."+t));b.rt=e.join(",");ga=b;var d=[],y;for(y in c)"_"!=y.charAt(0)&&d.push(y+"."+Math.round(c[y]));ga.it=d.join(",");(y=r("ytdebug.logTiming"))&&y(b,W,c);Si();I("EXP_DEFER_CSI_PING")?(Zi(),q("yt.timing.deferredPingArgs_",b,void 0),y=J(Zi,0),q("yt.timing.deferredPingTimer_",
y,void 0)):Yi(b);y=new Gi(W.aft+(l||0));(ga=hh())&&ga.publish.call(ga,Hi.toString(),Hi,y)}}a.cancel();cj(a);a.B=null;a.c&&(a.c.loaded=!1);y=kj(a);"html5"==mj(a)?a.O=y:y&&y.destroy&&y.destroy();Vd(a.A);Fi(a.fa);a.C=null;a.K=null}
g.cancel=function(){this.S&&Zc(this.c.assets.js,this.S);L(this.yc);this.ta=!1};
g.J=function(){nj(this);if(this.O&&this.c)try{this.O.destroy()}catch(b){Cc(b)}this.Ma=null;for(var a in this.j)m[this.j[a]]=null;this.Zb=this.c=this.api=null;delete this.A;delete this.l;bj.H.J.call(this)};var qj={},rj="player_uid_"+(1E9*Math.random()>>>0);function sj(a,b){a=u(a)?Hd(a):a;b=Zh(b);var c=rj+"_"+la(a),d=qj[c];if(d)return d.xc(b),d.api;d=new bj(a,c);qj[c]=d;O("player-added",d.api);uc(d,w(tj,d));J(function(){d.xc(b)},0);
return d.api}
...
;var vj=r("yt.abuse.botguardInitialized")||$h;q("yt.abuse.botguardInitialized",vj,void 0);var wj=r("yt.abuse.invokeBotguard")||ai;q("yt.abuse.invokeBotguard",wj,void 0);var yj=r("yt.abuse.dclkstatus.checkDclkStatus")||bi;q("yt.abuse.dclkstatus.checkDclkStatus",yj,void 0);var zj=r("yt.player.exports.navigate")||Xg;q("yt.player.exports.navigate",zj,void 0);var Aj=r("yt.player.embed")||sj;q("yt.player.embed",Aj,void 0);var Bj=r("yt.player.getPlayerByElement")||uj;q("yt.player.getPlayerByElement",Bj,void 0);
var Cj=r("yt.util.activity.init")||ci;q("yt.util.activity.init",Cj,void 0);var Dj=r("yt.util.activity.getTimeSinceActive")||ei;q("yt.util.activity.getTimeSinceActive",Dj,void 0);var Ej=r("yt.util.activity.setTimestamp")||di;q("yt.util.activity.setTimestamp",Ej,void 0);function Fj(){pb(R("page-container"),"remote-connected",!!V)}
;var Gj=!1;function Hj(){var a=r("yt.player.getPlayerByElement");return a?a("player-api"):null}
...
N.Bd=function(){var a=R("yt-consent-dialog");if(a){var b=!!I("CONSENT_SHOW_DIALOG");Jj=new Mh(a,b,!b);N.mc();N.qf();a=Jj;if(!a.isDisposed()){a.C=document.activeElement;if(!a.L){a.f||(a.f=R("yt-dialog-bg"),a.f||(a.f=document.createElement("div"),a.f.id="yt-dialog-bg",a.f.className="yt-dialog-bg",document.body.appendChild(a.f)));a:{var c=window,d=c.document,b=0;if(d){var b=d.body,e=d.documentElement;if(!e||!b){b=0;break a}c=Md(c).height;if(Nd(d)&&e.scrollHeight)b=e.scrollHeight!=c?e.scrollHeight:e.offsetHeight;
...
A(kk,jk);
kk.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.currentTarget=b;var e=a.relatedTarget;e?ld&&(we(e,"nodeName")||(e=null)):"mouseover"==c?e=a.fromElement:"mouseout"==c&&(e=a.toElement);this.relatedTarget=e;null===d?(this.clientX=void 0!==a.clientX?a.clientX:a.pageX,this.clientY=void 0!==a.clientY?a.clientY:a.pageY):(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY);
...
function Ck(a,b){if(a.ib)return!0;if(!hk){var c=b||r("window.event"),d=new kk(c,this),e=!0;if(!(0>c.keyCode||void 0!=c.returnValue)){a:{var f=!1;if(0==c.keyCode)try{c.keyCode=-1;break a}catch(l){f=!0}if(f||void 0==c.returnValue)c.returnValue=!0}c=[];for(f=d.currentTarget;f;f=f.parentNode)c.push(f);for(var f=a.type,h=c.length-1;!d.c&&0<=h;h--){d.currentTarget=c[h];var k=Fk(c[h],f,!0,d),e=e&&k}for(h=0;!d.c&&h<c.length;h++)d.currentTarget=c[h],k=Fk(c[h],f,!1,d),e=e&&k}return e}return Gk(a,new kk(b,this))}
...
;function Nk(){}
ca(Nk);Nk.prototype.c=0;function Ok(a){Kk.call(this);this.B=a||Ed();this.la=null;this.Ra=!1;this.c=null;this.f=void 0;this.X=this.$=this.C=null;this.Ba=!1}
...
function Rk(a,b){if(a.Ra)throw Error("Component already rendered");if(b){a.Ba=!0;var c=Gd(b);a.B&&a.B.c==c||(a.B=Ed(b));a.c=b;a.Fa()}else throw Error("Invalid element to decorate");}
...
function Vk(){var a=Id("overflowable-list-root",Wk),b=[];B(a,function(a){var d=new Uk;Rk(d,a);b.push(d)});
return b}
function Xk(a,b){var c=Yk(a),d=Yk(b);return c<d?-1:c==d?0:1}
function Zk(a,b){var c=db(Id("overflowable-list-item",b));return Qa(c,function(a,b){return a+$k(this,b)},0,a)}
...
;function bl(a){if(!cl||a)cl=Md(window);return cl}
...
g.Ne=function(a){ge(this.T,a)&&(a=qe(a,"yt-ui-menu-item"),Pl(this,a),a=G(a,"value"),Pk(this,"privacy-value-input").value=a)};
function Pl(a,b){var c;c=qh.getInstance();c=S(U(c,"content"),a.D);he(c,sa(me(b)));c=S("is-selected",a.T);E(c,"is-selected");D(b,"is-selected");c=G(b,"privacy-state");bc(a.D,"privacy-state",c)}
function Ql(a,b){df(a.L,b);a.l&&df(a.l,b);df(a.A,b);df(a.D,b)}
function Ol(a){a.A.value="";var b=Pk(a,"title-input-container");E(b,"yt-uix-form-error");b=S("yt-uix-form-error-message",b);Xd(b);df(a.D,!0);(b=S("is-selected",a.T))&&a.O&&b!=a.O&&Pl(a,a.O);df(a.L,!1);a.l&&df(a.l,!0);df(a.A,!0)}
...
g.Be=function(a,b){if(b&&b.errors&&b.errors.length){var c=Pk(this,"title-input-container"),d=b.errors[0];D(c,"yt-uix-form-error");if(d){var e=S("yt-uix-form-error-message",c);e?e.innerHTML=d:(d=Rd("span","yt-uix-form-error-message",document.createTextNode(String(d))),d.setAttribute("role","alert"),c.appendChild(d))}Ql(this,!0)}};
...
;function Zl(){$l=Jd("html",void 0,void 0)[0];am=R("appbar-guide-button")}
...
function im(){function a(){var a=S("guide-likes-playlist-icon");if(a)return qe(a,"guide-notification-item")}
...
function lm(a,b,c,d,e){M(a,function(a){var h=c.apply(null,arguments);if(d){var k=S("guide-count-value",h);if(k){var l=k.innerHTML;""===l.trim()||isNaN(l)||he(k,parseInt(l,10)+d)}}!h&&e&&(k=e.c(a),(l=S("guide-item-container",R("behavior-id-guide-playlists-section")))&&k&&Wd(l,k,0));qm(b,!!h,a?a.title:null)||((k=S("guide-item-update-notification",h))&&Xd(k),k=pm(b),D(k,"guide-item-update-notification"),h.appendChild(k),J(w(D,h,"showing-update-notification"),0),J(w(E,h,"showing-update-notification"),
2E3))})}
function jm(a){var b=hm;M("yt-uix-playlistlike-liked",function(){var c=a(),d=b.apply(null,arguments);qm("appbar-guide-notification-playlist-like",!!c)||(Wd(c,d,0),O("guide-playlist-section-updated"))})}
function km(a,b){var c=mm;M(a,function(){var a=c.apply(null,arguments);rm(a,b,"guide-playlist-section-updated")})}
function rm(a,b,c){qm(b,!!a)||(b=pm(b),D(b,"guide-item-removal-notification"),a.appendChild(b),J(w(D,a,"removing-guide-item"),0),J(function(){Xd(a);O(c)},2E3))}
function qm(a,b,c){if(b&&cm())return!1;Vd(fm);fm.appendChild(pm(a,c));D(document.body,"show-guide-button-notification");J(w(E,document.body,"show-guide-button-notification"),2E3);return!0}
function om(a){var b;R("guide-subscriptions-promo")?(O("force-reload-subscriptions"),b=!0):b=!1;b||(b=R("guide-channels"),a=a.c,a=Hl("appbar-guide-item-template-channel",["ID","URL","TITLE","THUMBNAIL_URL","NOTIFICATION_OVERLAY_MESSAGE"]).render({ID:a.external_id,URL:a.url,TITLE:a.title,THUMBNAIL_URL:a.thumbnail,NOTIFICATION_OVERLAY_MESSAGE:a.title}),a=ef(a),qm("appbar-guide-notification-subscription",!!b)||(Wd(b,a,0),O("guide-channel-section-updated")))}
...
function Em(a,b){B(Id("guide-flyout-container",Wk),function(c){sm.push(T(c,a,b))})}
function Fm(a){Gm(a.currentTarget)}
function Dm(){var a=Id("guide-flyout-container",Wk);B(a,function(a){Gm(a)})}
...
function Hm(a){a=a.currentTarget;var b=S("guide-flyout",a),c=S("guide-flyout-trigger",a),d=S("guide-flyout-iframe-mask",a),e=S("guide-flyout",a),f=Qe(e),h=S("guide-channels-list",a),k=bl(!0),l=S("guide-flyout-trigger",a),n=S("guide-flyout-iframe-mask",a),t=k.height-(Kl?Kl.offsetTop:0);h.style.maxHeight=t-f.top-f.bottom+"px";f=Je(e).height;h=Je(l);l=He(l);t=Math.min(t-f,Math.max(0,k.height-l.y-h.height/2-f/2));h=l.x+h.width;k=k.width-l.x;e.style.bottom=t+"px";n&&(n.style.height=f+"px",n.style.bottom=
t+"px");"rtl"==document.body.getAttribute("dir")?(e.style.right=k+"px",e.style.left="",n&&(n.style.right=k+"px",n.style.left="")):(e.style.left=h+"px",e.style.right="",n&&(n.style.left=h+"px",n.style.right=""));D(b,"flyout-shown");d&&D(d,"flyout-shown");D(c,"on-hover");O("yt-dom-content-change",a)}
...
function xm(a){var b=S("guide-sort-button"),c=G(b,"guide-sort")||"",d=G(a.currentTarget,"guide-sort")||"";c!=d&&(bc(b,"guide-sort",d),ck("/guide_channels_ajax?action_set_guide_sort=1",{method:"POST",Ta:{sort:d},format:"JSON",Z:function(a,b){Cm(b);var c=Id("guide-sort-choice");B(c,function(a){var b=G(a,"guide-sort");qh.getInstance();a=a.parentNode;var b=d==b,c=cf("span","yt-uix-button-icon-wrapper",a);if(!c&&b){var e=Rd("span",{"class":"yt-uix-button-icon-wrapper yt-uix-button-icon-checkbox"}),f=Rd("div",
{"class":"yt-uix-button-icon-dropdown-checked"});e.appendChild(f);Wd(a,e,0)}Lg(c,b)})}}))}
function Cm(a){var b=a.channels;b&&(a=R("guide-subscriptions-section"),b=Ud(re(b)),Yd(b,a),um=Vk(),Jm(),a=Id("yt-uix-tooltip-tip-visible"),B(a,function(a){E(a,"yt-uix-tooltip-tip-visible")}))}
function Jm(){wm();O("yt-dom-content-change",Wk)}
function Am(){Jl&&(Jl.firstElementChild?Jm():Bm())}
function Km(a){var b=Id("guide-item",Wk);return Ta(b,function(b){return G(b,"serialized-endpoint")==a})}
function ym(a){xe(Kl,"max-height",a.height-50+"px")}
function zm(a){if(um&&!C(document.body,"exp-scrollable-guide")){var b=Lm(a),c=um.length,d=0;um.sort(Xk||kb);B(um,function(a,f){var h=Yk(a)-d,h=Math.min(h,b/(c-f));b-=(c-f)*h;var h=d+=h,h=h-(h>=Yk(a)?0:a.D?$k(a,a.D):0),h=Math.max(al(a),h),k=Zk(a,a.l);if(k>h)for(;k>h;){var l;l=a.l;if(l=p(l.lastElementChild)?l.lastElementChild:ae(l.lastChild,!1)){var n=$k(a,l),k=k-n;Wd(a.A,l,0)}else break}else if(k<h){for(l=document.createDocumentFragment();!Wa(Zd(a.A));)if(n=$d(a.A)){var t=$k(a,n);if(k+t<=h)k+=t,l.appendChild(n);
else break}else break;a.l.appendChild(l)}pb(a.K,"empty-overflow-list",!!Wa(Zd(a.A)))});
Im()}}
function Lm(a){var b=Kl,c=R("guide-container");if(!c||!b)return 0;var d=Qe(c),d=d.top+d.bottom,c=$d(c).clientHeight,e=0;B(um,function(a){e+=a.l?Zk(a,a.l):0;e+=Wa(Zd(a.A))?0:a.D?$k(a,a.D):0});
...
function En(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Bn(a,c);var d=a?a.split(":"):[],e=c.h||wn(),f=Um(Zm,"ah",Xm());if(f["::"]&&d.length){for(var h=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,n=h.length&&h[h.length-1]||null,t=n;n&&n.hint==l||(t={hint:l,Oc:[]},h.push(t));t.Oc.push(k)}var x=h.length;if(1<x){var K=c.callback;K&&(c.callback=function(){0==--x&&K()})}for(;d=h.shift();)Fn(d.Oc,c,d.hint)}else Fn(d||[],c,e)}
function Fn(a,b,c){function d(a,b){if(x)return 0;Pm.clearTimeout(t);K.push.apply(K,W);var d=((Ym||{}).config||{}).update;d?d(f):f&&Um(Zm,"cu",[]).push(f);if(b){en("me0",a,Q);try{Cn(b,c,n)}finally{en("me1",a,Q)}}return 1}
a=Wm(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var t=null,x=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=Um(bn(c),"r",[]).sort(),K=Um(bn(c),"L",[]).sort(),Q=[].concat(l);0<h&&(t=Pm.setTimeout(function(){x=!0;k()},h));
...
In.prototype.B=function(){return Md(window).height-60-20};
...
function Qn(a){if(a.C){var b=a.j+"";100<=a.j&&(b=Dc("MASTHEAD_NOTIFICATIONS_COUNT_99PLUS"));he(a.C,b)}a.c&&(0==a.j?rb(a.c,"sb-notif-on","sb-notif-off"):rb(a.c,"sb-notif-off","sb-notif-on"),b=Ec(a.j),a.D&&a.D.setAttribute("alt",b))}
g.pf=function(){rb(this.B,"sb-off","sb-on")};
g.ke=function(){rb(this.B,"sb-on","sb-off")};
g.sd=function(){this.B.style.top=Math.max((Md(window).height-this.R.height)/2,0)+"px"};
g.Rd=function(){6E5<ei()?Mn(this.f,!1):Mn(this.f,!0)};var Rn="";function Sn(){var a=R("yt-masthead-doodle-first-frame"),b=R("logo-container"),c=I("YOODLE_IMG_SRC"),d=new Image;d.src=c;c=Rd("img",{id:"logo","class":"logo doodle",usemap:"#doodle",src:c,style:I("YOODLE_EXTRA_ATTRS")});Wd(b,c,0);d.onload=function(){Xd(a)}}
...
function Un(){if("U"==I("CREATOR_CONTEXT","U")){var a=Id("yt-masthead-account-picker-user-option"),b=zf(window.location.href);B(a,function(a){if(-1!=a.href.indexOf("action_handle_signin")){var c;c=Ig(a.href,{next:b});ac(a,zf(c))}})}else{var a=Id("yt-masthead-account-picker-owner-option"),c=yf();
...
function Wn(){var a=I("SBOX_JS_URL",Rn);if(a){Rn=a;var b=r("yt.www.masthead.searchbox.init");b?b():Xn(a,function(){var a;try{a=r("yt.www.masthead.searchbox.init"),a()}catch(b){throw b.message=b.message+' sbox type: "'+da(a)+'"',b;}})}}
...
function Yn(){r("yt.www.masthead.searchbox.init")||(Zc(Rn,Vl),Vl=null)}
function Zn(){var a=R("masthead-search-term");a&&a.focus()}
;var $n,ao,bo,co;var eo=!1,fo=!1;function go(){if($n=R("masthead-appbar")){ao=R("masthead-positioner");bo=R("masthead-positioner-height-offset");Zl();ho();io();jo=new Mm(ko);var a=lo;r("yt.scheduler.instance")&&(a=function(){Yg(lo)});
mo.push(M("init",a));mo.push(M("dispose",no));oo=Yl();fi.getInstance();po(ki(0,128)?ki(0,129):!0);qo=Jd("html",void 0,void 0)[0];mo.push(M("masthead-ticker-close",ro));mo.push(M("appbar-guide-delay-load",ho));mo.push(M("page-resize",so));eo||lo()}}
function lo(){S("appbar-content-hidable");to=S("appbar-content-trigger");(fo=C(document.body,"always-autohide-masthead"))?dc(Wl,"position-fixed"):bc(Wl,"position-fixed","true");fo||to?uo=T(window,"scroll",vo):wo();co=!!R("appbar-guide-menu")&&dm();eo?(co||(pb($l,"guide-pinned",!1),bm(!1),Kl&&(Kl.scrollTop=0)),so()):eo=!0;var a=-1*He(ao).y,b=document.body.scrollHeight,c=a-(b-document.body.clientHeight);0<c&&(document.body.style.minHeight=b+c+"px");Pd(document).scrollTop+=a;xo=Od(document).y;yo();zo();
Im()}
function no(){to=null;wo()}
function yo(){if(!to||Ao)Lg($n,!0);else{var a=Je(to).height,b=Je(ao).height,b=He(ao).y+b,a=Math.floor(He(to).y)+a,c=C(document.body,"appbar-hidden"),d=Pd(document);c&&a<b+40?(d.scrollTop+=40,Lg($n,!0),E(document.body,"appbar-hidden"),Bo()):!c&&b<a&&(d.scrollTop-=40,D(document.body,"appbar-hidden"),Bo())}}
...
function Go(a){em()||qe(a.target,"appbar-guide-clickable-ancestor")||bm(!1)}
function ko(){var a=Math.max(0,Od(document).y),b=xo;xo=a;var c=b-a;0<c&&0==Ho?Ho=b:0>c&&(Ho=0);c=Math.min(0,Math.max(c+Io,-Fo));var d=fo;if(d){var e=a<Fo,b=a>b&&Math.abs(Io)<Fo;cm()&&b?a=!1:(a=d?!1:100<=Ho-a,a=e||b||a)}else a=!1;a&&Io!=c&&(ao.style.top=c+"px",Jo=Io=c,Ko());yo()}
...
function np(a,b){a.yb=z();pp(a);a.Sa=a.Na.clone();og(a.Sa,"t",a.C);a.Bb=0;a.W=a.c.cc(a.c.Ab()?b:null);0<a.hc&&(a.Pb=new bp(v(a.Fd,a,a.W),a.hc));a.A.Ka(a.W,"readystatechange",a.hf);var c=a.Za?Eb(a.Za):{};a.ab?(a.Wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.W.send(a.Sa,a.Wb,a.ab,c)):(a.Wb="GET",a.zd&&!md&&(c.Connection="close"),a.W.send(a.Sa,a.Wb,null,c));a.c.va(1)}
g.hf=function(a){a=a.target;var b=this.Pb;b&&3==qp(a)?b.Zd():this.Fd(a)};
g.Fd=function(a){try{if(a==this.W)a:{var b=qp(this.W),c=this.W.l,d=this.W.getStatus();if(P&&!xd(10)||md&&!wd("420+")){if(4>b)break a}else if(3>b||3==b&&!id&&!rp(this.W))break a;this.Wa||4!=b||7==c||(8==c||0>=d?this.c.va(3):this.c.va(2));sp(this);var e=this.W.getStatus();this.ub=e;var f=rp(this.W);(this.wa=200==e)?(4==b&&tp(this),this.B?(up(this,b,f),id&&this.wa&&3==b&&(this.A.Ka(this.f,"tick",this.ff),this.f.Qa())):vp(this,f),this.wa&&!this.Wa&&(4==b?this.c.Nb(this):(this.wa=!1,pp(this)))):(this.$a=
...
function Jp(a){var b=a.c.R;if(null!=b)wp(),b?(wp(),Lp(a.c,a,!1)):(wp(),Lp(a.c,a,!0));else if(a.ka=new jp(a,0,void 0,void 0,void 0),a.ka.Za=a.fc,b=a.c,b=Hp(b,b.Ab()?a.tb:null,a.gc),wp(),!P||xd(10))og(b,"TYPE","xmlhttp"),op(a.ka,b,!1,a.tb,!1);else{og(b,"TYPE","html");var c=a.ka;a=!!a.tb;c.jb=3;c.Na=qg(b.clone());zp(c,a)}}
g.cc=function(a){return this.c.cc(a)};
g.Wc=function(){return!1};
g.kd=function(a,b){this.Ja=a.ub;if(0==this.oa)if(b){try{var c=this.f.parse(b)}catch(d){c=this.c;c.ua=this.Ja;Kp(c,2);return}this.tb=c[0];this.ob=c[1]}else c=this.c,c.ua=this.Ja,Kp(c,2);else if(2==this.oa)if(this.Qb)wp(),this.jc=z();else if("11111"==b){if(wp(),this.Qb=!0,this.Eb=z(),c=this.Eb-this.Cd,!P||xd(10)||500>c)this.Ja=200,this.ka.cancel(),wp(),Lp(this.c,this,!0)}else wp(),this.Eb=this.jc=z(),this.Qb=!1};
g.Nb=function(){this.Ja=this.ka.ub;if(this.ka.wa)0==this.oa?this.ob?(this.oa=1,Ip(this)):(this.oa=2,Jp(this)):2==this.oa&&(a=!1,(a=!P||xd(10)?this.Qb:200>this.jc-this.Eb?!1:!0)?(wp(),Lp(this.c,this,!0)):(wp(),Lp(this.c,this,!1)));else{0==this.oa?wp():2==this.oa&&wp();var a=this.c;a.ua=this.Ja;Kp(a,2)}};
...
function Tp(a){return P&&wd(9)&&ha(a.timeout)&&p(a.ontimeout)}
...
g.nd=function(){this.Ea=null;this.U=new jp(this,0,this.j,"rpc",this.B);this.U.Za=null;this.U.hc=0;var a=this.Dc.clone();ng(a,"RID","rpc");ng(a,"SID",this.j);ng(a,"CI",this.Vb?"0":"1");ng(a,"AID",this.eb);eq(this,a);if(!P||xd(10))ng(a,"TYPE","xmlhttp"),op(this.U,a,!0,this.Hb,!1);else{ng(a,"TYPE","html");var b=this.U,c=!!this.Hb;b.jb=3;b.Na=qg(a.clone());zp(b,c)}};
...
function Pq(){Kq||(Kq=r("yt.mdx.remote.debug.handlers_")||[],q("yt.mdx.remote.debug.handlers_",Kq,void 0))}
...
g.J=function(){this.f.unsubscribe("onlineScreenChange",v(this.Kd,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.l);var a=rs,b=r("yt.mdx.remote.debug.handlers_");$a(b||[],a);vc(this.c);qs.H.J.call(this)};
...
function Gs(){As("dispose");var a=Hs();a&&a.dispose();Is=null;q("yt.mdx.remote.cloudview.instance_",null,void 0);Js(!1);Oc(Ks);Ks.length=0}
...
function Hs(){Is||(Is=r("yt.mdx.remote.cloudview.instance_"));return Is}
...
function Os(){return!!r("yt.mdx.remote.cloudview.apiReady_")}
function Js(a){As("setApiReady_ "+a);q("yt.mdx.remote.cloudview.apiReady_",a,void 0)}
function Cs(a){q("yt.mdx.remote.cloudview.initializing_",a,void 0)}
...
function Kt(){if(!r("yt.mdx.remote.castv2_")&&!Lt&&(Wa(Ya)&&eb(Ya,vl("yt-remote-online-dial-devices")||[]),Gt())){var a=Jt();a?(a.removeReceiverListener("YouTube",Mt),a.addReceiverListener("YouTube",Mt),Ht("API initialized in the other binary")):(a=new cast.Api,q("yt.mdx.remote.castapi.api_",a,void 0),a.addReceiverListener("YouTube",Mt),a.setReloadTabRequestHandler&&a.setReloadTabRequestHandler(function(){J(function(){window.location.reload(!0)},1E3)}),Oq(It),Ht("API initialized"));
Lt=!0}}
...
function Jt(){return r("yt.mdx.remote.castapi.api_")}
var Lt=!1,Ya=r("yt.mdx.remote.castapi.devices_")||[];q("yt.mdx.remote.castapi.devices_",Ya,void 0);function Ut(a){xq.call(this);this.l=0;this.La=Vt();this.B=NaN;this.C=a;this.N("Initializing local screens: "+ar(this.La));this.j=Wt();this.N("Initializing account screens: "+ar(this.j));this.bc=null;this.c=[];this.f=[];Xt(this,Pt()||[]);this.N("Initializing DIAL devices: "+gr(this.f));a=Zq(Jr());Yt(this,a);this.N("Initializing online screens: "+ar(this.c));this.l=z()+3E5;Zt(this)}
...
X.prototype.$_st=X.prototype.lb;X.prototype.$_gspc=X.prototype.Gf;X.prototype.$_gsppc=X.prototype.Jd;X.prototype.$_c=X.prototype.contains;X.prototype.$_g=X.prototype.get;X.prototype.$_a=X.prototype.Xb;X.prototype.$_un=X.prototype.Ub;X.prototype.$_r=X.prototype.remove;X.prototype.$_gs=X.prototype.ma;X.prototype.$_gos=X.prototype.Hd;X.prototype.$_s=X.prototype.subscribe;X.prototype.$_ubk=X.prototype.ya;function hu(a,b,c){a?q("yt.mdx.remote.castv2_",!0,void 0):Kt();sl&&rl();wr();iu||(iu=new br,Nr()&&(iu.c="/api/loungedev"));ju||a||(ju=new Ut(iu),ju.subscribe("screenPair",ku),ju.subscribe("managedScreenChange",lu),ju.subscribe("onlineReceiverChange",function(){O("yt-remote-receiver-availability-change")}));
mu||(mu=r("yt.mdx.remote.deferredProxies_")||[],q("yt.mdx.remote.deferredProxies_",mu,void 0));nu(b);b=ou();if(a&&!b){var d=new X(iu);q("yt.mdx.remote.screenService_",d,void 0);b=ou();ys(d,function(a){a?pu()&&Ns(pu(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){O("yt-remote-receiver-availability-change")})},!(!c||!c.loadCastApiSetupScript))}if(c&&!r("yt.mdx.remote.initialized_")){q("yt.mdx.remote.initialized_",!0,void 0);
...
function Au(){if(ju){var a=ju;L(a.B);a.B=NaN}a:{if(a=Cu())if(a=a.getOtherConnectedRemoteId()){qu("Do not stop DIAL due to "+a);Du();break a}(a=r("yt.mdx.remote.currentDialId_"))?(qu("Stopping DIAL: "+a),Tt(a),Du()):(a=zu())&&a.uuid&&(qu("Stopping DIAL: "+a.uuid),Tt(a.uuid))}Os()?Hs().stopSession():Es("stopSession called before API ready.");(a=Cu())?a.disconnect(1):(Pc("yt-remote-before-disconnect",1),Pc("yt-remote-connection-change",!1));Eu(null)}
function Fu(){var a=Cu();return a&&3!=a.getProxyState()?new $s(a,void 0):null}
function qu(a){Rq("remote",a)}
function Gu(){return r("yt.mdx.remote.screenService_")}
function ou(){if(!Hu){var a=Gu();Hu=a?new gu(a):null}return Hu}
function pu(){return r("yt.mdx.remote.currentScreenId_")}
function Iu(a){q("yt.mdx.remote.currentScreenId_",a,void 0);if(ju){var b=ju;b.l=z()+3E5;if((b.bc=a)&&(a=eu(b,a))&&!mr(b.c,a)){var c=db(b.c);c.push(a);Yt(b,c,!0)}}}
function Du(){q("yt.mdx.remote.currentDialId_","",void 0)}
function tu(){q("yt.mdx.remote.connectData_",null,void 0)}
function Cu(){return r("yt.mdx.remote.connection_")}
function Eu(a){var b=Cu();tu();a?Cu():(Iu(""),Du());q("yt.mdx.remote.connection_",a,void 0);mu&&(B(mu,function(b){b(a)}),mu.length=0);
...
function Bu(a,b){pu();Iu(a.id);var c=new Y(iu,a,wu());c.connect(b,r("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){Pc("yt-remote-before-disconnect",a)});
...
var iu=null,mu=null,Hu=null,ju=null;function nu(a){var b=wu();if(Cb(b)){var b=yr(),c=vl("yt-remote-session-name")||"",d=vl("yt-remote-session-app")||"",b={device:"REMOTE_CONTROL",id:b,name:c,app:d};a&&(b["mdx-version"]=3);q("yt.mdx.remote.channelParams_",b,void 0)}}
function wu(){return r("yt.mdx.remote.channelParams_")||{}}
function xu(a){a?(tl("yt-remote-session-app",a.app),tl("yt-remote-session-name",a.name)):(wl("yt-remote-session-app"),wl("yt-remote-session-name"));q("yt.mdx.remote.channelParams_",a,void 0)}
...
Ju.prototype.D=function(a){ge(this.A,qf(a))||Jh.getInstance().ha(this.za())};
...
g.Mf=function(a){this.pb(a,"scroll-action");O("yt-dom-content-change",a)};var Lu,Mu,V,Nu,Ou,Pu,Qu,Ru,Su,Tu,Uu,Vu,Wu,Xu,Yu,Z,fe;var Zu;function $u(a,b){this.type=a;this.V=b||[]}
...
onError:function(){}})}
var pv=[];var qv;function rv(){if(!qv){var a=R("watch-queue");if(!a)return[];qv=S("watch-queue-items-list",a)}var b=[],a=Zd(qv);B(a,function(a){(a=G(a,"video-id"))&&b.push(a)});
return b}
;function tv(){O("yt-dom-content-change",Z)}
q("yt.www.watchqueue.loadThumbnails",tv,void 0);
function uv(){fe=R("watch-queue");Su=S("watch-queue-control-bar",fe);Tu=S("watch-queue-count",Su);Uu=S("yt-uix-button-dark-overflow-action-menu",Su);Vu=S("prev-watch-queue-button",fe);Wu=S("next-watch-queue-button",fe);Xu=S("play-watch-queue-button",fe);Yu=S("pause-watch-queue-button",fe);Z=S("watch-queue-items-list",fe);vv.push(of(fe,"click",wv,"yt-uix-button"));vv.push(of(fe,"click",xv,"watch-queue-video"));vv.push(of(fe,"click",yv,"control-bar-button"));vv.push(T(Z,Ye,zv));vv.push(of(Z,Ye,Av,"watch-queue-item"));
...
function Qv(){var a=R("player-playlist");return a?ee()==a:!1}
function Rv(){var a=!1;if(!V||!Mg(Lu)||!I("PAGE_NAME"))return Sv(),a;var b=Tv(),c=Uv();Vv()&&c&&b!=c&&(Wv(c),b=c);c=!!I("LIST_ID");if(b=Vv()&&!!b&&(b==I("VIDEO_ID")||b==Ou)&&!c){var d=R("player-playlist");d&&!Qv()&&(E(Lu,"mole-notification"),Wd(d,fe,0),O("watch-queue-show",1),Xv(),a=!0)}else ee()!=Lu&&(Lu.appendChild(fe),O("watch-queue-show",0),tv(),a=!0);d=R("placeholder-playlist");b||c?Og(d):Pg(d);Sv();return a}
...
function Sv(){Mu&&(Tv()?Nu||Ij(!!V&&(Mg(Lu)||bw())&&ee()==Lu):Ij(!1))}
...
function wv(a){if(a.currentTarget==Vu){if(bw()){var b=Zd(Z);a=ew();b=b.length;a=(b+a-1)%b;fw(a);Xv();(b=Zv())&&V&&V.ud(b,a)}}else if(a.currentTarget==Wu)bw()&&(a=Zd(Z),a=(ew()+1)%a.length,fw(a),Xv(),(b=Zv())&&V&&V.Gd(b,a));else if(a.currentTarget==Xu)Pg(Xu),Og(Yu),V?(a=rv(),!Uv()&&a[0]?jt(V,a[0]):V.play()):Mu&&Mu.playVideo();else if(a.currentTarget==Yu)Pg(Yu),Og(Xu),V?V.pause():Mu&&Mu.pauseVideo();else if(C(a.currentTarget,"remove-item-watch-queue-button")){if(a=oe(a.currentTarget,null,"watch-queue-item"),
...
function yv(a){ee()==Lu&&a.currentTarget==Su&&(a=qf(a),a&&C(a,"overflow-menu-choice")||(qb(Lu,"mole-expanded"),qb(Lu,"mole-collapsed")))}
...
function Av(a){C(a.currentTarget,"fade-out")&&(Xd(a.currentTarget),$v(Uv()),jw());tv()}
function xv(a){a=oe(a.currentTarget,null,"watch-queue-item");if(!C(a,"currently-playing")){var b=Zd(Z),b=Ma(b,a);fw(b);(a=G(a,"video-id"))&&V&&jt(V,a,0,b)}}
...
function ew(){var a=S("currently-playing",Z);if(a){var b=Zd(Z);return Ma(b,a)}return 0}
function Zv(){var a=S("currently-playing",Z);return a?G(a,"video-id")||"":""}
function $v(a){a=Ma(rv(),a);0<=a?dw()&&ew()==a||(fw(a),Xv()):lw()}
function fw(a){if(bw()){lw();var b=Zd(Z);b[a]&&D(b[a],"currently-playing");mw()}}
...
function nw(){var a=dw()?ew()+1:0,b=rv().length;0<a&&0<b?Tu.innerHTML=Qu.render({count:a,total:b}):Vd(Tu)}
function aw(a){a?(Pg(Xu),Og(Yu)):(Pg(Yu),Og(Xu))}
function mw(){var a=rv().length,b=1>=a,c=dw()?ew():-1;Vu.disabled=b||0==c;Wu.disabled=b||c==a-1;nw();if(0!=a){var d=null,a=Zd(Z);B(a,function(a){var b=G(a,"video-id"),c=S("play-next",a),k=S("goto-video-page",a);pb(k,"disabled",Vv()&&b==I("VIDEO_ID")&&!I("LIST_ID"));C(a,"currently-playing")?(d=a,Pg(c)):d?(d=null,pb(c,"disabled",!0)):pb(c,"disabled",!1)})}}
...
function bw(){var a=$d(Z);return!!a&&C(a,"watch-queue-item")}
...
function vw(a,b){Nu=!1;if(Z&&b&&(b.html||!Uv())&&(qw(),V)){var c=rv(),d=[],e=Ud(re(b.html)),f=Oa(e.childNodes,function(a){return de(a)});
B(f,function(a){a=G(a,"video-id");d.push(a)});
0==c.length&&Vd(Z);if(0==d.length)Vd(Z),O("watch-queue-empty"),jw();else if(!ib(c,d)){if(d.length==c.length+1){for(var h=0;h<c.length&&c[h]==d[h];)h++;var k=db(c);fb(k,h,0,d[h]);if(ib(k,d)){Wd(Z,f[h],h);D(f[h],"fade-in");J(function(){E(f[h],"fade-in")},0);
$v(Uv());tv();jw();return}}if(d.length==c.length-1){for(e=0;e<d.length&&c[e]==d[e];)e++;k=db(c);ab(k,e);if(ib(k,d)){c=Zd(Z);D(c[e],"fade-out");$v(Uv());return}}Vd(Z);Wa(f)||(B(f,function(a){Z.appendChild(a)}),tv(),$v(Uv()));
jw()}}}
function Xv(){var a=S("currently-playing",Z);if(a){var b=Ku.getInstance(),c=Z;if(c&&a){var d=Id(U(b,"scroll-unit"),c),a=Ma(d,a);if(0<=a&&!(!c||isNaN(a)||0>a)&&(b=Id(U(b,"scroll-unit"),c),!(0>=b.length))){a>=b.length&&(a=b.length-1);if(b.length){var d=b[0],e=d.offsetHeight;1<b.length&&(e=b[1].offsetTop-d.offsetTop);d=e}else d=0;e=c.offsetHeight;a>Math.max(Math.floor(c.scrollTop/d),0)-1&&(d=Math.floor(e/d),e=b.length,a+d>e&&(a=e-d+1));0>a&&(a=0);a=b[a].offsetTop;c&&!isNaN(a)&&(0>a&&(a=0),c.scrollTop=
...
function Iv(a){xw=a}
function Jv(){var a=Fu();vc(V);V=null;qw();Vd(Z);jw();a?(V=a,V.subscribe("proxyStateChange",yw),V.subscribe("remotePlayerChange",zw),xw=null):ow();2!=xw&&(Fj(),O("watch-queue-remote-connection",!!a))}
function pw(){Og(Lu);if(!Rv()){var a=ee()==Lu?0:1;O("watch-queue-show",a)}}
function ow(){ee()!=Lu&&Lu.appendChild(fe);var a=R("placeholder-playlist");I("LIST_ID")?Og(a):Pg(a);rb(Lu,"mole-expanded","mole-collapsed");Pg(Lu);Sv();O("watch-queue-hide",0)}
function yw(a,b){qw();1==b&&uw()}
function zw(){var a=ct(V);aw(1==a.f)}
function Kv(){if(V){var a=Zv(),b=Uv();b&&b!=a&&$v(b);b&&(Qv()||Ou==b)&&ww(b);uw()}}
var hw={"remove-all":function(){mv();Vd(Z);jw();O("watch-queue-empty");ow()},
...
function Dw(a,b,c){if(c&&c.html){bc(a,"loaded",1);a.innerHTML=c.html;Ew(a);c=(b=document.body||Pd(document))||Pd(document);var d=Fe(a),e=Fe(c),f=Te(c);if(c==Pd(document)){var h=d.x-c.scrollLeft,d=d.y-c.scrollTop;P&&!xd(10)&&(h+=f.left,d+=f.top)}else h=d.x-e.x-f.left,d=d.y-e.y-f.top;var f=c.clientHeight-a.offsetHeight,e=c.scrollLeft,k=c.scrollTop,e=e+Math.min(h,Math.max(h-(c.clientWidth-a.offsetWidth),0)),k=k+Math.min(d,Math.max(d-f,0));c=new fd(e,k);b.scrollLeft=c.x;b.scrollTop=c.y;S("yt-close",a).focus()}else Pg(a)}
function Ew(a,b){var c=S("yt-picker-content",a);if(c){var d=Jd(null,"yt-picker-section",c);B(d,v(Fw,null,Math.floor((b||c.offsetWidth)/180)))}else Cc(Error(".yt-picker-content missing"),"WARNING")}
function Fw(a,b){for(var c=Jd(null,"yt-picker-item",b),d=Math.ceil(c.length/a),e,f=document.createElement("div"),h=0;h<a;h++){e=document.createElement("div");e.className="yt-picker-grid";for(var k=d*h;k<d*(h+1);k++)c[k]&&e.appendChild(c[k]);e.children.length&&f.appendChild(e)}c=bf(f);for(Vd(b);0<c.childNodes.length;)b.appendChild(c.childNodes[0])}
...
q("yt.www.masthead.dismissReturnToMobileMessage",function(){Kg("a=NO_MWEB",void 0);Pg(R("return-to-mobile"))},void 0);
q("yt.www.masthead.dismissChromeAlert",function(){fi.getInstance();li(163,!0);mi()},void 0);
q("yt.www.masthead.dismissTosAlert",function(){fi.getInstance();li(160,!0);mi()},void 0);
q("yt.www.masthead.handleAccountPickerClick",function(){var a=R("yt-masthead-multilogin");if(G(a,"loaded"))Un();else{var b=Hn();b[I("XSRF_FIELD_NAME",void 0)]=I("XSRF_TOKEN",void 0);spf.load("/delegate_account_ajax",{method:"POST",postData:Ef(b),onDone:function(){bc(a,"loaded","true");Un()}})}},void 0);
q("yt.www.masthead.loadSearchbox",Wn,void 0);q("yt.net.cookies.set",Kf,void 0);q("yt.net.cookies.remove",Lf,void 0);q("yt.www.picker.load",function(a){var b=G(a,"picker-key"),c=G(a,"picker-position"),d="yt-picker-"+b+"-"+c;if(c=R(d))a=G(a,"button-menu-id")==d,d=G(c,"loaded"),Cw(c,b,!!a,!!d)},void 0);
q("yt.www.picker.displayLang",function(){Bw("language")},void 0);
q("yt.www.picker.applyGrid",Ew,void 0);
q("ytbin.www.pageframe.setup",function(){cd("GUIDE_DELAYLOADED_CSS");cd("PAGE_FRAME_DELAYLOADED_CSS",w(E,document.body,"delayed-frame-styles-not-in"),I("WAIT_TO_DELAYLOAD_FRAME_CSS")?"yt-www-pageFrameCssNotifications-load":null);Ue=R("a11y-announcements-container");Ve=R("a11y-announcements-message");M("a11y-announce",vf);M("init",sf);if(tf=R("a11y-skip-nav"))sf(),T(tf,"click",uf);null!=We||Xe();We&&(nb(document.body,["yt-high-contrast-mode","yt-high-contrast-mode-"+We]),cd("HIGH_CONTRAST_MODE_CSS"));
S("guide-module-loading")||vm();N.init();Wl=S("yt-masthead-user-icon");of(R("ticker"),"click",Vn,"yt-uix-close");S("exp-searchbox-redesign")&&T(R("yt-masthead-content"),"click",Zn);I("SANDBAR_ENABLED")&&Tn();I("YOODLE_DELAY_LOAD_EXP")&&I("YOODLE_IS_ANIMATED")&&Sn();Wn();go();(Lu=R("watch-queue-mole"))?uv():I("MDX_ENABLE_CASTV2")&&hu(!0,!1,{device:"Desktop",app:"youtube-desktop",isSignedIn:I("LOGGED_IN")});I("YOODLE_IS_ANIMATED")&&Sc(I("YOODLE_JS_URL",void 0),function(){r("yt.www.masthead.AnimatedYoodle.init")(I("YOODLE_ANIMATION_FRAMES"),
