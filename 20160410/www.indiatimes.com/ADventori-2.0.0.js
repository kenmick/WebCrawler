...
(function(ADventori, window, undefined) {
  ...
  (function(ADventori) {
    ...
    Carousel.prototype.makeSlide = function(){
      ...
      setAttributes(adventoriAd, {"id": "adventoriAd", "onmouseover": "carousel.pause()", "onmouseout": "carousel.play()"});
      ...
      if(this.conf.navPrev && this.conf.navNext){
        adventoriNav.innerHTML = this.conf.navPrev + this.conf.navNext;
