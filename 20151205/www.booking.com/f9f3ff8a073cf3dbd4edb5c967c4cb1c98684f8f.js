...
h.unshift({b_genius_img:d[116],b_type:d[139]});
r=E(r);
h.shift();
r+=d[59];
return r
...
h.unshift({b_genius_iconfont:d[116],b_type:d[139]});
r=D(r);
h.shift();
r+=d[3]
}r+=d[1]
...
h.unshift({b_type:d[115],b_genius_iconfont:d[116]});
r=F(r);
h.shift();
r+=d[59];
return r
...
h.unshift({b_tooltip:d[117],b_classname:d[118],b_size:d[119],b_color:d[120]});
U=l(U);
h.shift();
...
h.unshift({b_ge_freebies:d[36],b_tooltip:d[117],b_ge_discount:d[36],b_classname:d[149]});
U=H(U);
h.shift();
