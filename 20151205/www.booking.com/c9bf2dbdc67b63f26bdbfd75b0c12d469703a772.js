...
}function c(d){if(/^hotel_soldout$/.test(d.b_type)){return{w:10,h:10}
}else{if(/^hotel/.test(d.b_type)){return{w:25,h:25}
...
s=new t.Marker({b_id:o.b_id,b_name:o.b_name,b_flags:o.b_flags,b_type:o.b_type,b_url:o.b_url,b_latitude:o.b_latitude,b_longitude:o.b_longitude,b_behaviors:o.b_behaviors,b_states:o.b_states,data:o,zIndex:o.zIndex,position:new t.LatLng(o.b_latitude,o.b_longitude),optimized:p,icon:{url:q.url,size:new t.Size(q.w,q.h),origin:new t.Point(q.x,q.y)}});
s.setMap(this.map);
...
}}else{if(q){q.iconType=o||q.iconType;
