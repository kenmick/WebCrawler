...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <script type="text/javascript" src="dtagent625_bxjpr23_3013.js" data-dtconfig="rid=RID_2418|rpid=1361493225|domain=adobe.com|tp=500,50,3|cors=1|bandwidth=300_m|cux=1|reportUrl=https://www.adobe.com/dynaTraceMonitor"></script><link rel="icon" href="https://wwwimages2.adobe.com/include/img/favicon.ico" type="image/x-icon">
...
<script type="application/ld+json">
  ...
  "potentialAction": {"@type":"SearchAction","target":"http://www.adobe.com/cfusion/search/index.cfm?term={search_term}&loc=en_us&source=sitelinks_searchbox","query-input":"required name=search_term"}
	...
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-max-ship-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="47% 0" data-background-mobile-position="50% 50%" data-seed-background>
    ...
    <h1>See what new can do.</h1>
<p>The latest apps are in. Great new features in Photoshop, Illustrator and all your Creative Cloud favorites. Plus new mobile apps to take your work to new places. And every asset â including Adobe Stock â at your fingertips. All connected through the power of CreativeSync.</p>
...
<ul>
    ...
    <li class="button">
        <a title="See what&#39;s new" href="/creativecloud/features.html?promoid=KSDPY" target="_self">See what&#39;s new</a>
    </li>
    ...
    <figcaption class="align-end grid-offset-2">
        <section><h2>
    <a href="https://www.behance.net/gallery/21547837/Paradise-in-the-future-25-Years-of-Photoshop?promoid=KSDQA" class="base cta">Paradise in the future by Ruben Alvarez</a>
...
<ul>
    ...
    <li class="cac">
        <a href="https://color.adobe.com/#themeID/7156385" target="_self">
            <img src="http://wwwimages.adobe.com/content/dam/acom/themeids/7/1/7156385.png"/>
        </a>
    </li>
    ...
    <li class="link">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-amc-summit-1-16.1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(2):before" data-background-position="35% 50%" data-background-mobile-position="50% 50%" data-seed-background>
    ...
    <h1>Donât miss Adobe Summit 2016.<br>
</h1>
<p>Join us March 20 â 24, in Las Vegas, for three days of inspirational keynotes, sessions, and entertainment. And learn from marketers, like you, who are using creativity, content, and data to create amazing new experiences for their customers. Register by January 31 and save US$200.<br>
</p>
...
<ul>
    ...
    <li class="button">
        <a title="Learn more" href="http://summit.adobe.com/?promoid=XKMMHJ6W&mv=other" target="_blank">Learn more</a>
    </li>
...
<ul>
    <li>
        <a title="Learn more about Marketing Cloud" href="/marketing-cloud.html?promoid=KTPAT" target="_self" class="cta">
            <i class="adobe-icon-marketing-cloud"></i>Learn more about Marketing Cloud
        </a>
    </li>
