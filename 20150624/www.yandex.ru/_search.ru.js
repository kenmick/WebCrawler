...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("ywsFMVQQiPT-fvAxVq8QRDFJSt4")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return xe(t);if("auto-content"===e)return"auth"===n?Ie(t):Qe(t);if("action"===e)return"auth"===n?!!s==!1?Se(t):Qe(t):Qe(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Te(t):"ticker"===e?Oe(t):Qe(t)}return Qe(t)
}if("mix"===e)return Me(t);if(""===e)return Le(t);if("value"===e){var e=n;return"input"===e?Fe(t):"tumbler"===e?"option"===s?Ve(t):Qe(t):Qe(t)
...
}return Qe(t)}return"default"===e?F(t):"env"===e?"i-global"===n?He(t):Qe(t):"content"===e?P(t):"jsAttr"===e?We(t):"tag"===e?D(t):"cls"===e?Ke(t):"bem"===e?Ae(t):Qe(t)
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var _,g;return{method:"POST",action:t.ctx.url||(_=i,i="action",g=Se(t),i=_,g),role:"form","aria-label":BEM.I18N("auth","auth")}
...
}else s.role="button",s.tabindex||(s.tabindex=0);return s}function B(){return void 0}function D(t){var e=n;
if("b-icon"===e)return!!s==!1?"img":I(t);if("button"===e)return!t.ctx.url==!1?!!s==!1?"a":C(t):C(t);if("input"===e){var e=s;
...
}function C(t){return!!s==!1?"button":I(t)}function I(){return void 0}function P(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:R(t);
if("button"===e)return!!s==!1?{elem:"text",tag:"span",content:t.ctx.content}:R(t);if("input"===e){var e=s;
return"box"===e?S(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:R(t)}if("auth"===e){var e=s;
...
}return R(t)}function S(t){if(!(t.__$anflg28!==!0)==!1){if(!!r.clear==!1){var e,i;return[(e=t.__$anflg28,t.__$anflg28=!0,i=S(t),t.__$anflg28=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
...
}function R(t){return t.ctx.content}function F(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg34!==!0)==!1?q(t):Qe(t):Qe(t);
if("button"===e)return U(t);if("input"===e)return z(t);if("auth"===e)return Q(t);if("checkbox"===e)return $(t);
...
}return Qe(t)}function q(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));
...
var r=i;i="",Ne(t),t.ctx=o,i=r,t.__$anflg34=s}function $(t){return!(t.__$anflg33!==!0)==!1?!!s==!1?V(t):Qe(t):Qe(t)
...
t._labelId="label"+n;var c=t.ctx,h=c.mods;c.mods=s,$(t),t._checkboxAttrs=r,t._labelId=a,c.mods=h,t.__$anflg33=o
...
}function W(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?K(t):Qe(t):Qe(t)}function K(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Fe(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Ue(t),i=o,a);
...
return"dropdown"===e||"button"===e||"auth"===e||"suggest2-item"===e?!!s==!1?!0:Ce(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):Ce(t):"select"===e?!!s==!1?Be(t):Ce(t):"b-autocomplete-item"===e?!(r&&"nav"===r.type)==!1?!!s==!1?{val:t._url}:De(t):De(t):"input"===e?!!s==!1?{live:t._live}:Ce(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):Ce(t):"link"===e?!t.ctx.tabindex==!1?!!s==!1?{origTabindex:t.ctx.tabindex}:Ce(t):Ce(t):"suggest2"===e?!!s==!1?!0:Ce(t):Ce(t)
}function Be(t){return t.extend({live:!1},t.ctx.js)}function De(t){return!!s==!1?!0:!t.ctx.search_cgi==!1?!t._.isArray(t.ctx.search_cgi)==!1?{cgi:t.ctx.search_cgi}:Ce(t):Ce(t)
}function Ce(){return void 0}function Ie(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:Pe(t):Pe(t)
}function Pe(t){return!!s==!1?[]:Qe(t)}function Se(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
...
t["i-global"]=t.extend(d,f),Le(t),t["i-global"]=_,t.__$anflg1=m}function Fe(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:qe(t):qe(t)
}function qe(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Ne(t),t._buf=n,i=o,e.join("")
}return $e(t)}return $e(t)}function $e(t){return!!s==!1?"":Qe(t)}function Ve(t){return t.ctx.value||"left"!==t.ctx.side
...
}return ii(t)}function Je(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,C,I,S,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=D(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,N;
...
var F=(f=i,i="cls",m=Ke(t),i=f,m);F||(F=A.cls);var q=A.block&&L&&!A.elem;if(R||F){if(j.push(' class="'),R){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var $=(_=i,i="mix",g=Me(t),i=_,g);if(A.mix&&($=$?[].concat($,A.mix):A.mix),$){var V={};V[e(n,s)]=!0,t._.isArray($)||($=[$]);
for(var U=0;U<$.length;U++){var z=$[U];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,Q=z.mods||r,G=z.elemMods||{};
if(H&&j.push(" "),O.INTERNAL[H?"buildClasses":"buildModsClasses"](W,z.elem||z._elem||(z.block?void 0:s),z.elemMods||z.mods,j),z.js&&((L||(L={}))[O.INTERNAL.buildClass(W,z.elem)]=z.js===!0?{}:z.js,q||(q=W&&!z.elem)),H&&!V[e(W,K)]){V[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=Me(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&V[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,$.splice(U+1,0,Z))}}}}}}F&&j.push(R?" ":"",F),q&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=We(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
}var te=(B=i,i="attrs",C=u(t),i=B,C);if(te=t._.extend(te,A.attrs)){var ee;for(ee in te)void 0!==te[ee]&&j.push(" ",ee,'="',t._.attrEscape(te[ee]),'"')
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(I=i,i="content",S=P(t),i=I,S);if(ie||0===ie){var R=n||s,ne=t._notNewList;
...
var m=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,F(t),i=h,t._links=u,n=l,t._currBlock=d,s=p,r=f,o=m
...
var d=b[t]||D.decl(t,{},{live:!0});if(!(d._liveInitable=!!d._processLive())||r||s.live===!1){r&&n.addClass("i-bem");
...
e.fn.bem=function(t,e){return s(t,this,e,!0)};var D=t.DOM=t.decl("i-bem__dom",{__constructor:function(t,i,n){var s=this;
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",D=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',C="allowScriptAccess",I="always",P="height",S="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",N=i(x,B)+i(O,1)+i(P,1)+i("id",L),R=!1;
...
}catch(P){}}return d=f?g?'<div style="'+B+'"><'+v+N+i("src",x)+i(S,T)+i(A,j)+i(C,I)+i("type",w)+"/></div>":(b?"<"+v+D+N+">"+e("movie",x):"<"+v+N+i("type",w)+i("data",x)+">")+e(S,T)+e(A,j)+e(C,I)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
i.src=e,i.style.cssText=O+s+P+s+"border:0;"+B,i.frameBorder=0,i.setAttribute("tabindex","-1"),i.setAttribute("aria-hidden","true"),n&&n.insertBefore(i,n.firstChild)
};var F=this,q=arguments.callee.load=function(t){var e,i;t.mode?(e="00",i="kfc"):e="07",F.replaceWith(l.ya_fc_external("07_2",e,"01",i))
};F.hasClass("i-flashcookie_autoload_no")||q(t)};Lego.block["i-flashcookie"]=function(i){var n=this.hasClass("i-flashcookie_type_inline")?e:t;
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("8Foq-yXi6hpzHXv2IEbQ8acWRs4")&&BEM.decl("keycodes",{},{BACKSPACE:8,TAB:9,ENTER:13,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:41,DELETE:42}),_borschik("3OX4-nKwSFWYBh6dxSsO7a67CkA")&&!function(t){var e=1e3;
...
},_unbindFromPointerPress:function(){return this.unbindFrom("mousedown")}}),_borschik("ZV86YNdyXic0O2Iehtyg8_mHDk0")&&!function(){var t,e=1e3,i={};
...
},_unbindFromPointerPress:function(){return this.unbindFrom("mousedown")}}),_borschik("TWbgxi6hd7S5hLl8bDb7pctnVAI")&&!function(t,e){var i=.99,n=["bottom-left","bottom-center","bottom-right","top-left","top-center","top-right","right-top","right-center","right-bottom","left-top","left-center","left-bottom"],s=BEM.DOM.win;
...
}})}(jQuery),_borschik("FuY2ML4i8d5BFiD6PrREbBzSAwQ")&&!function(t){var e,i=.99,n=["bottom-left","bottom-center","bottom-right","top-left","top-center","top-right","right-top","right-center","right-bottom","left-top","left-center","left-bottom"],s=BEM.DOM.win;
...
}})}(jQuery),_borschik("4kJtnEaFEnpS5fEAywHZT0MD1gM")&&BEM.DOM.decl({block:"popup2",modName:"autoclosable",modVal:"yes"},{onSetMod:{visible:{yes:function(){this.__self._visiblePopupsStack.unshift(this),this.afterCurrentEvent(function(){this.domElem&&this.bindToDoc("leftclick tap",this._onDocClick)
...
}}),_borschik("b8PK_n5CGTTH4Yd5cnE5h3MXHUY")&&!function(){function t(t){t.keyCode===BEM.blocks.keycodes.ESC&&e.length&&e[0].delMod("visible")
...
}}),_borschik("IW-vofw3Ls7wU05y-SYsxAbsrOU")&&BEM.DOM.decl({block:"popup2",modName:"theme",modVal:"normal"},{getDefaultParams:function(){return $.extend(this.__base(),{mainOffset:5,viewportOffset:5})
