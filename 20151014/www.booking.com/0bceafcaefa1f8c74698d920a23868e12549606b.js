...
n.unshift({b_type:d[106],b_genius_img:d[16]});
t();
n.shift();
x+=d[94]
}function t(){x+=d[2];
...
n.unshift({b_genius_iconfont:d[16],b_type:d[106]});
q();
n.shift();
x+=d[4]
}x+=d[1]
...
n.unshift({b_genius_iconfont:d[16],b_type:d[5]});
u();
n.shift();
x+=d[94]
}function u(){x+=d[2];
...
n.unshift({b_classname:d[20],b_tooltip:d[3],b_color:d[19]});
l();
n.shift();
...
n.unshift({b_classname:d[107],b_ge_discount:d[43],b_ge_freebies:d[43]});
p();
n.shift();
