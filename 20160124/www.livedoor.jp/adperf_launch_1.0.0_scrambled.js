/* 1.0.0.54.1 - 2016-01-13 17:29:08 */
...
return x1cM;}
function x1nE(x1ne){x1ne=x1ne||{};var x1n9=x1I(),x1qz=x1ne.cachebuster===false?'':'?r='+Math.random();x1fN=x1ne.mediapath||'';var x1qA='_scrambled.js';x15='http://cstatic.weborama.fr/js/advertiserv2/';if(x1ne.script_variant===undefined&&x1k7().indexOf('msn.com')!==-1){x1ne.script_variant='positioning-update';}
...
var x1jM=document.domain,x1jN=false,x1jO,x1jP;while(x1jM.split('.').length>=2){try{document.domain=x1jM;x1jO=x1ea+'.document.domain';x1jP=eval('try{'+x1jO+';x1jN=true} catch(x1o){}');if(x1jN){return true;}
}catch(x1o){}
x1jM=x1jM.substr(x1jM.indexOf('.')+1,x1jM.length);}
return false;}
function x13(x1ea,x1pf){var x12=false;x1pf=x1pf!==undefined?x1pf:true;eval('try{x12 = (document.domain === '+x1ea+'.document.domain);}catch(x1o){x12 = false;}');if(!x12&&x1pf){eval('try{document.domain = '+x1ea+'.document.domain;x12 = true;}catch(x1o){x12 = x16(x1ea);}');}
return x12;}
function x1jQ(){}
