...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("aUYFMGvZxso3N5Jh6f1oiaIfNbw")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return ge(t);if("auto-content"===e)return"auth"===n?ye(t):$e(t);if("action"===e)return"auth"===n?!!s==!1?Me(t):$e(t):$e(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Ee(t):"ticker"===e?we(t):$e(t)}return $e(t)
}if("mix"===e)return _e(t);if(""===e)return Ce(t);if("value"===e){var e=n;return"input"===e?Ie(t):"tumbler"===e?"option"===s?Te(t):$e(t):$e(t)
}if("getLive"===e)return"input"===n?!!s==!1?Ae(t):$e(t):$e(t);if("live"===e)return"input"===n?!!s==!1?je(t):$e(t):$e(t);
...
}return $e(t)}return"default"===e?T(t):"env"===e?"i-global"===n?Ne(t):$e(t):"content"===e?C(t):"jsAttr"===e?Le(t):"tag"===e?w(t):"cls"===e?Re(t):"bem"===e?xe(t):$e(t)
...
}function O(t){return t.ctx.content}function T(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg32!==!0)==!1?A(t):$e(t):$e(t);
if("checkbox"===e)return j(t);if("button"===e)return L(t);if("input"===e)return R(t);if("auth"===e)return U(t);
...
var r=i;i="",Se(t),t.ctx=o,i=r,t.__$anflg32=s}function j(t){return!(t.__$anflg31!==!0)==!1?!!s==!1?N(t):$e(t):$e(t)
...
}function L(t){if(!(t.__$anflg27!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg27;return t.__$anflg27=!0,L(t),t.__$anflg27=e,void 0}return $e(t)}return $e(t)}function R(t){var e=s;
return"hint"===e?$(t):"control"===e?!(t.__$anflg24!==!0)==!1?q(t):F(t):F(t)}function $(t){if(!(t.__$anflg25!==!0)==!1){if(!!t._value==!1){if(!(0!==t._value)==!1){var e=t.ctx,i=e.elemMods||(e.elemMods={});
i.visibility="visible";var n=t.__$anflg25;return t.__$anflg25=!0,$(t),t.__$anflg25=n,void 0}return F(t)
...
var s=i;i="",Se(t),t.ctx=n,i=s,t.__$anflg24=e}function F(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?V(t):$e(t):$e(t)
...
t._placeholder=u;var B=t.ctx,C=B.mods;B.mods=f,R(t),t._inputId=g,t._labelId=b,t._hintId=v,t._name=y,t._value=k,t._inputLink=M,t._disabled=E,t._live=w,t._placeholder=x,B.mods=C,t.__$anflg12=m
...
}return z(t)}function z(t){return!(t.__$anflg22!==!0)==!1?!!s==!1?W(t):$e(t):$e(t)}function W(t){var e,i,n,s;
...
var e=t.__$anflg19;return t.__$anflg19=!0,X(t),t.__$anflg19=e,void 0}return $e(t)}return $e(t)}function Y(t){return"group"===s?J(t):Z(t)
}function J(t){if(!(t.__$anflg18!==!0)==!1){var e=t.__$anflg18;t.__$anflg18=!0;var i=t._labelId;return t._labelId=t.generateId(),J(t),t._labelId=i,t.__$anflg18=e,void 0
}return Z(t)}function Z(t){return!(t.__$anflg14!==!0&&t.__$anflg15!==!0)==!1?!!s==!1?te(t):ee(t):ee(t)
...
}}var f=t.__$anflg15;t.__$anflg15=!0,Y(t),t.__$anflg15=f}function ee(t){return!(t.__$anflg13!==!0)==!1?!!s==!1?ie(t):$e(t):$e(t)
...
}function ne(t){return!!t._popupDefaults==!1?!!s==!1?se(t):$e(t):$e(t)}function se(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
...
}return ue(t)}return ue(t)}return ue(t)}function ue(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?de(t):$e(t):$e(t)
...
if("notice"===e)return"count"===s?!!t.ctx.url==!1?[{elem:"plain"}]:me(t):me(t);if("ticker"===e)return"text"===s?[{block:"a11y-hidden"}]:me(t);
if("suggest2-item"===e)return"text"===s?!(r&&"link"===r.interact)==!1?!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:me(t):me(t):me(t);
...
return{mods:{position:i}}}return me(t)}return"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:me(t):me(t)
...
}function Se(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?De(t):$e(t):$e(t)}function De(t){for(var e,o,r,a,c,h,l,u,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];u=p.shift();)d[u]=(e=i,i="default",o=n,n="i-global",r=s,s=u,a=pe(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",l=Ne(t),i=c,n=h,l),_=t.__$anflg1;t.__$anflg1=!0;var m=t["i-global"];
t["i-global"]=t.extend(d,f),Ce(t),t["i-global"]=m,t.__$anflg1=_}function Ie(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Pe(t):Pe(t)
}function Pe(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Se(t),t._buf=n,i=o,e.join("")
}return Oe(t)}return Oe(t)}function Oe(t){return!!s==!1?"":$e(t)}function Te(t){return t.ctx.value||"left"!==t.ctx.side
...
}return s}function je(){return!1}function Ne(t){return!!s==!1?{}:$e(t)}function Le(){return void 0}function Re(){return void 0
}function $e(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?qe(t):Fe(t):Fe(t):Fe(t)}function qe(i){function n(){if("no-follow"===this.ctx.link)return void 0;
...
}return Ke(t)}function He(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,u,d,p,f,_,m,g,b,v,y,k,M,E,x,B,S,D,I,P,O,T=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=w(t),i=c,O=v,"undefined"!=typeof O||(O=A.tag),"undefined"!=typeof O||(O="div"),O){var N,L;
n&&A.js!==!1&&(h=i,i="js",u=ge(t),i=h,L=u,L=L?t._.extend(A.js,L===!0?{}:L):A.js===!0?{}:A.js,L&&((N={})[T.INTERNAL.buildClass(n,A.elem)]=L)),j.push("<",O);
var R=(d=i,i="bem",p=xe(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var $=(f=i,i="cls",_=Re(t),i=f,_);$||($=A.cls);var q=A.block&&N&&!A.elem;if(R||$){if(j.push(' class="'),R){T.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
...
if(z&&j.push(" "),T.INTERNAL[z?"buildClasses":"buildModsClasses"](W,H.elem||H._elem||(H.block?void 0:s),H.elemMods||H.mods,j),H.js&&((N||(N={}))[T.INTERNAL.buildClass(W,H.elem)]=H.js===!0?{}:H.js,q||(q=W&&!H.elem)),z&&!V[e(W,K)]){V[e(W,K)]=!0;
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=_e(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var J=X[Y];
(J.block||J.elem)&&V[e(J.block,J.elem)]||(J._block=W,J._elem=K,F.splice(U+1,0,J))}}}}}}$&&j.push(R?" ":"",$),q&&j.push(" i-bem"),j.push('"')
}if(N){var Z=(x=i,i="jsAttr",B=Le(t),i=x,B);j.push(" ",Z||"data-bem",'="',t._.attrEscape(JSON.stringify(N)),'"')
...
}}if(t._.isShortTag(O))j.push("/>");else{O&&j.push(">");var ie=(I=i,i="content",P=C(t),i=I,P);if(ie||0===ie){var R=n||s,ne=t._notNewList;
...
var _=o;o=t.ctx.elemMods||{},n||s?t.position=(t.position||0)+1:t._listLength--,T(t),i=h,t._links=l,n=u,t._currBlock=d,s=p,r=f,o=_
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,l=t.host||"kiks.yandex",u=window,d=document,p=navigator,f=p.userAgent,_=p.mimeTypes,m=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+l.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+l+".ru/system/%s%d.swf",M="//"+l+".ru/fu",E="//"+l+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",D="always",I="height",P="wmode",O="window",T="width",A="bgcolor",j="#FFFFFF",N="ya_fc",L=i(x,B)+i(T,1)+i(I,1)+i("id",N)+i("tabindex","-1")+i("aria-hidden","true"),R=!1;
u.ya_fc_external=function(t,n,l,u){r=t,a=n,c=l,h=u||"fc";var d,p=_&&_[w]?_[w].enabledPlugin:0,f=R,y=0,x=s()?k.replace("%d",a).replace("%s",h):M.replace("%s",o());
if(p)y=p.description.split("Shockwave Flash ")[1],f=parseInt(y,10)>=m;else if(b){f=R;try{f=new ActiveXObject("ShockwaveFlash.ShockwaveFlash."+m)
}catch(I){}}return d=f?g?'<div style="'+B+'"><'+v+L+i("src",x)+i(P,O)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+L+">"+e("movie",x):"<"+v+L+i("type",w)+i("data",x)+">")+e(P,O)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
return this._firstFocusable=t.first(),this._lastFocusable=t.last(),this._skipReturnFocus=!1,0===this._firstFocusable.length?(this._skipReturnFocus=!0,void 0):(this.bindTo(this._lastFocused,"keydown",this._onLastFocusedKeyDown).bindTo(this._firstFocusable,"keydown",this._onFirstFocusableKeyDown).bindTo(this._lastFocusable,"keydown",this._onLastFocusableKeyDown),void 0)
...
}).bindTo("keydown",this._onKeyDown),this._isControlFocused()||this._getControl().focus(),this.trigger("focus"),void 0)
...
t.containsDomElem(s)||s.is(i.elem("main"))||s.is(i.elem("action-i"))||i.delMod(e,"pressed")})},_onActionClick:function(t){t.preventDefault(),/* istanbul ignore if */
BEM.blocks["i-ua"].opera<13&&t.stopPropagation(),this.toggleMod(t.data.domElem,"pressed","yes","")},_onActionKeyup:function(t){var e=BEM.blocks["i-ua"].opera<13;
(!e&&13===t.keyCode||32===t.keyCode)&&(t.preventDefault(),this.toggleMod(t.data.domElem,"pressed","yes",""))
...
})},_createSocial:function(t){return t.length?(BEM.DOM.update(this.elem("social"),BEMHTML.apply(this.__self._buildSocial(t,this._uniqId))),this._socialDropdown=this.findBlockInside("social","dropdown"),void 0):(this.elem("social").remove(),this.dropElemCache("social"),void 0)
...
for(n.url&&(i.src=n.url);e=s.shift();)n[e]&&(i[e]=n[e]);t.tag("img").attrs(i)}}),_borschik("vGKWNWPgWY9kfpEhs2n7iWSgxfc")&&(BEM.DOM.decl("b-keyboard-loader",{onSetMod:{js:function(){Lego.block["b-keyboard-loader"].call(this.domElem,this.params)
