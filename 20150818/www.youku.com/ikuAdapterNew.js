(function($){
	...
	//åºæ¯æ¥æº: 
	//"play_err" - æ­æ¾å¨éè¯¯çé¢
	//"play_bottom_down" - æ­æ¾å¨åºé¨ä¸è½½
	//"play_right_list" - æ­æ¾å³ä¾§åè¡¨
	//"poster_down" - ç¹æµ·æ¥ä¸è½½
	function ikuNewExecute( b, scene ){
		...
		if ( !step_flag ) {
			if ( scene == "play_err" )
				ret_str = "http://iku.youku.com/channelinstall/ywebplayererror";
			else if ( scene == "play_bottom_down" )
				ret_str = "http://iku.youku.com/channelinstall/ywebplayerbottom";
			else if ( scene == "play_right_list" )
				ret_str = "http://iku.youku.com/channelinstall/ywebplayerlist";
			else if ( scene == "poster_down" )
				ret_str = "http://iku.youku.com/channelinstall/ywebposter";
			else if ( scene == "show_down" )
				ret_str = "http://iku.youku.com/channelinstall/ywebshow";
		}
		return ret_str;
	}
