...
<main class="lobby">
	<section class="channels">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/lobby-bg-marvel-ste-loggedout-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(1):before" data-background-position="50% 15%" data-seed-background>
    ...
    <h1>Make it super.</h1>
<p>Kent State student Chad Lewis created a Marvel Avengers comic using Adobe Color CC on his phone, Photoshop Sketch on his iPad and Photoshop CC on his laptop. Try his techniques for yourself.<br>
</p>
...
<ul>
    <li>
        <a title="Take the tutorial" href="https://helpx.adobe.com/mobile-apps/how-to/sketch-comic-book.html?promoid=KSDPX" target="_self" class="cta">
            Take the tutorial
        </a>
    </li>
    ...
    <li>
        <a title="Students, save 60% on Creative Cloud, and get two months free when you prepay" href="https://creative.adobe.com/plans?plan=edu&promoid=KSDPZ" target="_self" class="offers cta">
            Students, save 60% on Creative Cloud, and get two months free when you prepay
        </a>
    </li>
    ...
    <figcaption class="align-end grid-offset-2 ">
        <section><h2>
    <a href="https://www.behance.net/chadlewisi7d2b?promoid=KSDQA" class="base cta">Avengers Origins by Chad Lewis</a>
...
<ul>
    ...
    <li class="cac">
        <a href="https://color.adobe.com/#themeID/6350167" target="_self">
            <img src="http://wwwimages.adobe.com/content/dam/acom/themeids/6/3/6350167.png"/>
        </a>
    </li>
...
<ul>
    ...
    <li class="link">
        ...
        <figure data-background="http://wwwimages.adobe.com/content/dam/acom/en/lobby/acrobat-lobby-worlds-best-pdf-solution-1400x860.jpg" data-background-selector="main.lobby figure:nth-of-type(3):before" data-background-position="64% 50%" data-seed-background>
    ...
    <h1>&nbsp;</h1>
<h1>The worldâs best PDF solution.<br>
Now even better.<br>
</h1>
<p>The all-new Acrobat is completely re-imagined. Now itâs even easier for you to create, edit and manage PDFs on your desktop. And if you want to do even more, subscribe to get mobile apps, online services and e-signing.<br>
</p>
...
<ul>
    ...
    <li>
        <a title="Learn more about eSign" href="https://acrobat.adobe.com/us/en/documents/features/sign-approve.html" target="_self" class="cta">
...
<ul>
    ...
    <li>
        <a title="Start your free, 30-day trial of Acrobat DC desktop" href="https://www.acrobat.com/en_us/free-trial-download.html" target="_self" class="cta">
            <i class="adobe-icon-color-doc-cloud text-6"></i>Start your free, 30-day trial of Acrobat DC desktop
        </a>
    </li>
