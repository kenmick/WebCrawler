...
(function(f,b,e,d,c){_p=_o;_o="e99:27";var a=10;
e.Calendar=function(g,h){_p=_o;_o="e99:28";this.id_=e.uid();
this.lazyEvents={};
this.days={};
this.daysIndex=[];
this.months={};
...
e.Calendar.prototype={constructor:e.Calendar,id:function(){_p=_o;_o="e99:30";return this.id_
},type:function(){_p=_o;_o="e99:32";return this.options&&this.options.type||"unknown"
},initBaseMarkup:function(g,i){_p=_o;_o="e99:34";this.$input=g;
...
},setOptions:function(g){_p=_o;_o="e99:36";var h=this.initialized&&(g.startDate||g.endDate);
...
}},setDefaultDates:function(){_p=_o;_o="e99:38";var h=this.options,g=h.defaultDate||null;
...
}},getCalendarClassname:function(){_p=_o;_o="e99:40";var g="c2-calendar";
...
this.bindEvents()
},refreshDisabledDays:function(){_p=_o;_o="e99:46";var g=this;
d.each(this.days,function(j,h){_p=_o;_o="e99:47";if(h.id()<=g.options.startDateId||h.id()>g.options.endDateId){h.addState("disabled")
}else{h.removeState("disabled")
}})
},initMarkup:function(){_p=_o;_o="e99:50";var k=this.getOption_("title"),h=(this.options.closeButton)?'<div class="c2-calendar-close-button"><i class="c2-calendar-close-button-icon">Ã</i></div>':"";
var i="";
...
},createMonths:function(){_p=_o;_o="e99:52";var j="",i=this.options,h=i.startDate.getFullYear(),l=i.endDate.getFullYear(),k=i.startDate.getMonth(),g=i.endDate.getMonth();
...
return j
},createMonth:function(i,j,h){_p=_o;_o="e99:54";var g=new e.Month(i,j,this),k=g.id();
this.months[k]=g;
this.monthsIndex.push(k);
return g
},createDay:function(i,j,h){_p=_o;_o="e99:56";var g=new e.Day(i,j,h),k=g.id();
if(k<this.options.startDateId||k>this.options.endDateId){g.addState("disabled")
}this.days[k]=g;
this.daysIndex.push(k);
return g
},getDay:function(g){_p=_o;_o="e99:58";return this.days[g]
},bindElementsToModels:function(){_p=_o;_o="e99:60";var g=this.$calendarElement.find(".c2-month"),j=this.$calendarElement.find(".c2-day");
...
}},setupOffsetsAndViewport_:function(){_p=_o;_o="e99:62";var j=this.options.borderWidth,g=this.options.monthWidth,m;
...
}},setCurrentMonth:function(g){_p=_o;_o="e99:64";if(!g){g=this.monthsIndex[0]
...
},getSelectedDay:function(){_p=_o;_o="e99:70";var g=this.getCurrentDay();
if(g&&this.days[g]){return this.days[g]
}else{return null
}},selectMonth:function(k,g){_p=_o;_o="e99:72";var g=g||{},j,i=this.getTargetMonth(k),h={type:"any"};
...
},getNextMonth:function(){_p=_o;_o="e99:74";var h=this.monthsIndex.indexOf(this.getCurrentMonth()),g=h+1;
return this.monthsIndex[g]
},getPreviousMonth:function(){_p=_o;_o="e99:76";var h=this.monthsIndex.indexOf(this.getCurrentMonth()),g=h-1;
return this.monthsIndex[g]
},getTargetMonth:function(i){_p=_o;_o="e99:78";var g=this.monthsIndex.indexOf(i),h=g+this.options.monthsVisible-1,j;
if(h>=this.monthsIndex.length){j=h-(this.monthsIndex.length-1);
h=h-j;
g=g-j
}return this.monthsIndex[g]
},getVisibleMonths:function(){_p=_o;_o="e99:80";var g=this.monthsIndex.slice(0),h=this.monthsIndex.indexOf(this.getCurrentMonth());
g=g.slice(h,h+this.options.monthsVisible);
return g
},setOffset_:function(j,g){_p=_o;_o="e99:82";var h="margin-left",i={};
i[h]=-j;
...
},selectDay:function(h,i){_p=_o;_o="e99:86";if(!h){return false
}var j=this.days[h],g;
...
},selectRange:function(l,n){_p=_o;_o="e99:88";var o=this.daysIndex.indexOf(l),m=this.daysIndex.indexOf(n)+1,h=this.daysIndex.slice(o,m);
...
},highlightRange:function(j,l,i){_p=_o;_o="e99:90";if(!this.highlightedRanges_){this.highlightedRanges_={}
...
},unHighlightRange:function(g){_p=_o;_o="e99:92";if(this.highlightedRanges_[g]){this.deleteRange_(g);
this.removeState(f.calendar2.STATES.RANGE_SELECTED);
this.fireCallback("onRangeUnHighlighted",g)
}},createRange_:function(h,j){_p=_o;_o="e99:94";for(var l=0,g=h.length;
l<g;
...
},deleteRange_:function(j){_p=_o;_o="e99:96";var h=this.highlightedRanges_[j];
...
}},shown:function(){_p=_o;_o="e99:98";return !this.hasState(f.calendar2.STATES.HIDDEN)
},changeInput:function(g){_p=_o;_o="e99:100";this.$input=g
...
}},hide:function(){_p=_o;_o="e99:104";f.eventEmitter.trigger("CALENDAR:closed",{id:this.id(),instance:this});
this.addState(f.calendar2.STATES.HIDDEN);
this.fireCallback("onHide")
},toggle:function(){_p=_o;_o="e99:106";if(this.shown()){this.hide()
}else{this.show()
}},fitHorizontalPosition:function(){_p=_o;_o="e99:108";var l=window,h=this.$element,j=this.$calendarElement,k=this.options.direction==="rtl",i=k?"right":"left",n=0,m=h.offset().left,g=j.outerWidth()+a;
if(k){n=(h.width()+m)-g
}else{n=d(l).width()-(m+g);
if(m+n<a){n=-a
}}if(n<0){j.css(i,n)
}else{j.css(i,0)
}},fitVerticalPosition:function(){_p=_o;_o="e99:110";var i=d(window),h=i.scrollTop(),g=this.$calendarElement,j=a+g.offset().top+g.height()-i.height();
if(j>h){f.WindowScroller.scrollToOffset(j)
}},fitVerticalPositionAbsolute:function(){_p=_o;_o="e99:112";var g=this.$input.offset();
this.$element.css({position:"absolute",top:g.top,left:g.left})
},resetModes:function(){_p=_o;_o="e99:114";this.selectRange()
},adjustHeight:function(h){_p=_o;_o="e99:116";var j=this.getVisibleMonths(),g=0,l=0;
for(var k=0;
k<j.length;
...
},fireCallback:function(h){_p=_o;_o="e99:120";var g=[].slice.call(arguments,1);
g.unshift(this);
if(this.options[h]&&typeof this.options[h]==="function"){this.options[h].apply(this,g)
}},bindEvents:function(){_p=_o;_o="e99:122";var g=this,h=d(window);
if(!this.eventsAttached){this.$input.bind("keydown",function(i){_p=_o;_o="e99:123";g.onKeyDown(i)
});
this.$input.bind("click touchstart",function(i){_p=_o;_o="e99:125";g.toggle();
return false
});
this.$element.bind("toggleCalendar",function(){_p=_o;_o="e99:127";g.toggle()
});
this.$element.bind("showCalendar",function(){_p=_o;_o="e99:129";g.show()
});
this.$element.bind("hideCalendar",function(){_p=_o;_o="e99:131";g.hide()
});
this.$element.click(function(i){_p=_o;_o="e99:133";if(d(i.target).parents(".b-link_external").length===0){i.preventDefault();
i.stopPropagation()
}});
h.click(function(){_p=_o;_o="e99:135";if(g.shown()){g.hide()
}});
h.resize(function(){_p=_o;_o="e99:137";g.fitHorizontalPosition()
});
h.resize((function(){_p=_o;_o="e99:139";var l=100,n,k=+new Date()-l-1,i,m,j=function(){_p=_o;_o="e99:140";if(g.shown()){g.onReflow()
}};
return function(){_p=_o;_o="e99:142";window.clearTimeout(n);
i=+new Date();
m=i-k;
if(m>=l){k=i;
j()
...
},bindLazyLoadingEvents:function(){_p=_o;_o="e99:146";this.$element.bind("mouseenter.calendar2",d.proxy(this.onElementMouseEnter,this));
...
},addState:function(g){_p=_o;_o="e99:150";if(!this.states_[g]){this.states_[g]=true;
this.$element.addClass(this.getStateClassName_(g))
}},removeState:function(g){_p=_o;_o="e99:152";if(this.states_[g]){this.states_[g]=false;
this.$element.removeClass(this.getStateClassName_(g))
}},hasState:function(g){_p=_o;_o="e99:154";return !!this.states_[g]
},getStateClassName_:function(g){_p=_o;_o="e99:156";return g?"c2-wrapper-s-"+g:""
},onElementMouseEnter:function(){_p=_o;_o="e99:158";this.unbindLazyLoadingEvents();
this.initLazyMethods()
},onElementTouchStart:function(g){_p=_o;_o="e99:160";g.preventDefault();
this.unbindLazyLoadingEvents();
this.$element.bind("lazyInitiated",d.proxy(function(){_p=_o;_o="e99:161";this.show();
this.$element.unbind("lazyInitiated")
},this));
this.initLazyMethods()
},onDayClick:function(h){_p=_o;_o="e99:164";h.preventDefault();
h.stopPropagation();
var g=h.currentTarget.getAttribute("data-id");
this.fireCallback("onDayClick",g);
this.selectDay(g,{type:"user"})
},onCloseButtonClick:function(g){_p=_o;_o="e99:166";g.preventDefault();
g.stopPropagation();
this.hide()
},onFurtherButtonClick:function(g){_p=_o;_o="e99:168";g.preventDefault();
g.stopPropagation();
...
}},onEarlierButtonClick:function(g){_p=_o;_o="e99:170";g.preventDefault();
g.stopPropagation();
this.selectMonth(this.getPreviousMonth())
},onMonthShown:function(h,g){_p=_o;_o="e99:172";if(g){if(g.type==="first"){this.$calendarElement.find(".c2-button-earlier").addClass("c2-button-s-disabled")
...
},onDateSelected:function(l,i,k){_p=_o;_o="e99:174";var h=this.getDay(i),m=e.monthId(h.getYear(),h.getMonth()),g=this.getVisibleMonths(),j=k||{};
...
}},onDayMouseEnter:function(h){_p=_o;_o="e99:176";h.preventDefault();
var g=this.getDay(h.currentTarget.getAttribute("data-id"));
g.addState("hilighted");
this.fireCallback("onDayMouseEnter",g)
},onDayMouseLeave:function(h){_p=_o;_o="e99:178";h.preventDefault();
var g=this.getDay(h.currentTarget.getAttribute("data-id"));
g.removeState("hilighted");
this.fireCallback("onDayMouseLeave",g)
},onExternalMonthSelected:function(i,h){_p=_o;_o="e99:180";var j=h.value,g=e.monthId(j.year,j.month);
this.selectMonth(g)
},onExternalDateSelected:function(j,i){_p=_o;_o="e99:182";var g=i.value,h;
if(!g){return
}h=e.dayId(g.year,g.month,g.date);
if(!h){return
}if(this.getCurrentDay()===h){return
}this.selectDay(h)
},onExternalRangeSelected:function(j,i){_p=_o;_o="e99:184";var g,l,k,h;
if(!i){return
}g=i.startValue;
l=i.endValue;
if(!(g&&l)){return
...
},hilightToday:function(){_p=_o;_o="e99:186";var h=e.today(),g=this.getDay(e.dayId(h.getFullYear(),h.getMonth(),h.getDate()));
...
},onKeyDown:function(g){_p=_o;_o="e99:194";this.fireCallback("onKeyDown",g)
},adjustArrowPosition:function(){_p=_o;_o="e99:196";var j,h,g,i;
...
},customData_:{},setCustomVariable_:function(g,h){_p=_o;_o="e99:200";if(!g){throw new Error("setCustomVariable method requires a name parameter")
}if(typeof h==="undefined"&&this.customData_.hasOwnProperty(g)){delete this.customData_[g]
}this.customData_[g]=h;
return this
},getCustomVariable_:function(g){_p=_o;_o="e99:202";if(!g){throw new Error("getCustomVariable method requires a name parameter")
...
}}},getOption_:function(g,j){_p=_o;_o="e99:206";var h,i;
