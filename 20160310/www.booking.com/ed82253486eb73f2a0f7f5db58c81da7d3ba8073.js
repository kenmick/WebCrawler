...
},open:function(){_p=_o;_o="a37:3241";if(B.env.b_lang==="ru"||(B.env.b_lang==="en"&&B.env.ip_country==="ru")){B.et.stage("YdVaKVTQWUVYUbSET",1)
...
booking[sNSExperiments]["VOGOQRTWXMeUECUJaecO"]=(function(e,c){_p=_o;_o="a37:4263";function d(){_p=_o;_o="a37:4264";var j="VOGOQRTWXMeUECUJaecO",f=c(".b-booker-type__input"),h=c(".b-booker-type__input_business-booker"),g=c(".extra-business-field__container"),k=c(".extra-business-field__input");
if(h.prop("checked")){e.track.stage(j,1)
}f.click(function(){_p=_o;_o="a37:4265";if(c(this).hasClass("b-booker-type__input_business-booker")){e.track.stage(j,1);
...
B[sNSExperiments]["GWcOCBFO"]=(function(n,x,u,F,k){_p=_o;_o="a37:4269";var f=u.require("hijri-calendar");
function t(){_p=_o;_o="a37:4270";if(!u.search.dates("checkin")){k("#homein").find(".calendarLink").trigger("show")
}}function y(Q,L){_p=_o;_o="a37:4272";var N=L.search||u.search;
var K=N.dates("checkin"),P=N.dates("checkout"),M=N.dates(L.type),O=K&&P&&K.type==="valid"&&P.type==="valid";
k.fn.calendar2("each",function(R){_p=_o;_o="a37:4273";if(L.search){if(L.search!==R.search){return
...
}function A(L,K){_p=_o;_o="a37:4276";k.fn.calendar2("each",function(M){_p=_o;_o="a37:4277";if(K.id!==M.id()){M.trigger("hide")
}})
}function H(){_p=_o;_o="a37:4280";k.fn.calendar2("hide")
}function c(){_p=_o;_o="a37:4282";var K=new Date();
return K
}function m(){_p=_o;_o="a37:4284";var K=G();
K.setDate(K.getDate()-1);
return K
}function w(){_p=_o;_o="a37:4286";var K=u.calendar2.today();
K.setDate(K.getDate()+1);
return K
}function G(){_p=_o;_o="a37:4288";var K=u.calendar2.today();
K=new Date(K.getFullYear()+1,K.getMonth()+1,0);
return K
}function z(Q,K,L){_p=_o;_o="a37:4290";var O=this.search||u.search;
if(!(Q||K)){return
}var P=Q.type(),N,M;
...
}}function C(K,L){_p=_o;_o="a37:4292";if(L.which===13&&!K.shown()){k("#frm").submit();
L.preventDefault()
}}function o(P){_p=_o;_o="a37:4294";var O=P.search||u.search;
...
}P.$calendarElement.delegate(".c2-calendar-header_hijri-toggle","click",function(S){_p=_o;_o="a37:4295";S.preventDefault();
...
}}function h(L,O){_p=_o;_o="a37:4298";var K="";
...
}function J(L,K){_p=_o;_o="a37:4300";if(L.year&&K.year&&L.year!==K.year){return u.jstmpl.translations("ar_islamic_calendar_two_years",null,{first_hijri_month:u.jstmpl.translations(L.hijri_month_tag),second_hijri_month:u.jstmpl.translations(K.hijri_month_tag),first_year:L.hijri_year,second_year:K.hijri_year})
...
function I(Q,R){_p=_o;_o="a37:4302";var S,O,K,P,M;
...
j(Q,K,P,M)
}}}}function j(P,K,O,M){_p=_o;_o="a37:4304";var S=r(K,O,M);
...
}function r(K,M,L){_p=_o;_o="a37:4306";if(L>0&&K&&K.type==="valid"&&M&&M.type==="valid"){return u.jstmpl("length_of_stay_detailed").render({b_interval:L,b_checkin_date_formatted:u.formatter.date(K.toString(),"short_date_with_weekday_without_year"),b_checkout_date_formatted:u.formatter.date(M.toString(),"short_date_with_weekday")})
}return""
}function d(L,K){_p=_o;_o="a37:4308";var M;
if(K===e){M=L.getSelectedDay();
if(M){M.removeState("selected")
}}}function q(M,K){_p=_o;_o="a37:4310";var L=this.search||u.search;
M.rangeHighlightTimeout=n.setTimeout(function(){_p=_o;_o="a37:4311";if(M.rangeHighlightTimeout){M.unHighlightRange(e);
...
}function p(){_p=_o;_o="a37:4314";var K="";
if(f.available()){K+=u.jstmpl("hijri_toggle").render({type:this.type(),hijri_visible:false})
}return K
}function g(K){_p=_o;_o="a37:4316";k.fn.calendar2("each",function(L){_p=_o;_o="a37:4317";L.addState("hijri-enabled")
})
}function l(K){_p=_o;_o="a37:4320";k.fn.calendar2("each",function(L){_p=_o;_o="a37:4321";L.removeState("hijri-enabled")
})
}function E(){_p=_o;_o="a37:4324";if(!u.calendar2||(u.env.b_is_tdot_traffic&&u.env.b_action==="book"&&u.env.b_book_stage===2)){return
...
Q.each(function(S,T){_p=_o;_o="a37:4325";var R=k(T),U=R.attr("rel")||R.data("type")||R.data("calendar2-type");
...
}}function D(){_p=_o;_o="a37:4328";}return{init:E,initElse:D,priority:8}
}(window,document,booking,booking.env,$));
function popup_cancel_big_index(c){_p=_o;_o="a37:4331";window.open(c,"","toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=yes,resizable=1,width=950,height=500,left=200,top=200");
return false
}(function(d){_p=_o;_o="a37:4333";if(d.getElementById("reactive_text_items")){var c=function(){_p=_o;_o="a37:4334";var f=$("#reactive_text_items span").map(function(){_p=_o;_o="a37:4335";return"("+decodeURIComponent($(this).text())+")"
}).get();
return new RegExp(f.join("|"),"i")
};
var e=function(){_p=_o;_o="a37:4338";return $("#reactive_text_items").children().length>0
};
$(function(){_p=_o;_o="a37:4340";var g,h;
var f=c();
h=function(){_p=_o;_o="a37:4341";var j=$(this).val();
...
(function(){_p=_o;_o="a37:4345";var c="HOGeVdCScESFbLRFQNRSITXeUMATNC";
booking[sNSExperiments][c]={init:d,initElse:d};
function d(){_p=_o;_o="a37:4346";booking.eventEmitter.bind("account-onboarding-modal-show",function(){_p=_o;_o="a37:4347";booking.track.exp(c);
if(booking.track.getVariant(c)){$.cookie("wl252-gotit","true",{expires:365,path:"/",domain:booking.env.b_domain_end})
}})
}})();
(function(){_p=_o;_o="a37:4351";var g=window.jQuery;
...
var h=g(window);
var c;
function e(){_p=_o;_o="a37:4352";clearTimeout(c);
c=setTimeout(function(){_p=_o;_o="a37:4353";var n;
var m=h.width()||1000;
var l;
clearTimeout(c);
g(j.selector_badge).each(function(p,o){_p=_o;_o="a37:4354";n=g(o);
...
}function d(){_p=_o;_o="a37:4358";e();
g(window).on("resize",e)
}k.ensureNamespaceExists(sNSExperiments);
k[sNSExperiments][f]={priority:9,init:d}
})();
(function(){_p=_o;_o="a37:4361";var c="AaSDBcfERVXEUYPBRUDKe";
function d(){_p=_o;_o="a37:4362";B.eventEmitter.bind("tooltip.show",function(g,f){_p=_o;_o="a37:4363";var f=$(f);
...
booking[sNSStartupLoad].flash_deals_for_city={priority:9,init:function(){_p=_o;_o="a37:4367";$("#flash_deal_city_sr #city_deal").change(function(){_p=_o;_o="a37:4368";$("#flash_deal_city_sr")[0].submit()
})
}};
booking.components.define("ge-lightbox",function(f,c){_p=_o;_o="a37:4371";function e(k){_p=_o;_o="a37:4372";var l=k.data;
var j=k.template;
var g=k.onOpen||function(){_p=_o;_o="a37:4373";};
var h=k.wrapperClassName||"ge-about-lightbox-wrapper";
f.require("profile/profile-menu/profile-menu").hide();
setTimeout(function(){_p=_o;_o="a37:4375";c("#tooltip_wrap").hide()
},300);
c(".user_center_popover").hide();
f.lightbox.show(f.jstmpl(j).render(l),{customWrapperClassName:h},function(m){_p=_o;_o="a37:4377";c(".ge-mod-button").click(function(){_p=_o;_o="a37:4378";f.lightbox.hide();
return false
});
if(g){g(m)
}})
}function d(h){_p=_o;_o="a37:4382";var g=h.element;
c("body").delegate(g,"click",function(j){_p=_o;_o="a37:4383";j.preventDefault();
e(h)
})
}return{setup:d,open:e}
});
booking[sNSExperiments]["cQZeCJEcDHET"]=(function(d,f){_p=_o;_o="a37:4387";var c=f.components.require("ge-lightbox");
function e(){_p=_o;_o="a37:4388";c.setup({element:".genius-user-account-sign .clickable-area",template:"ge_about_lightbox",data:{b_genius_user:f.env.b_genius_user||{}}})
}return{init:e}
})(jQuery,booking);
booking.components.define("ge-lightbox",function(f,c){_p=_o;_o="a37:4391";function e(k){_p=_o;_o="a37:4392";var l=k.data;
var j=k.template;
var g=k.onOpen||function(){_p=_o;_o="a37:4393";};
var h=k.wrapperClassName||"ge-about-lightbox-wrapper";
f.require("profile/profile-menu/profile-menu").hide();
setTimeout(function(){_p=_o;_o="a37:4395";c("#tooltip_wrap").hide()
},300);
c(".user_center_popover").hide();
f.lightbox.show(f.jstmpl(j).render(l),{customWrapperClassName:h},function(m){_p=_o;_o="a37:4397";c(".ge-mod-button").click(function(){_p=_o;_o="a37:4398";f.lightbox.hide();
return false
});
if(g){g(m)
}})
}function d(h){_p=_o;_o="a37:4402";var g=h.element;
c("body").delegate(g,"click",function(j){_p=_o;_o="a37:4403";j.preventDefault();
e(h)
})
}return{setup:d,open:e}
});
booking[sNSExperiments]["cQHFOPSTcbXRAdSeae"]=(function(d,f){_p=_o;_o="a37:4407";var c=f.components.require("ge-lightbox");
function e(){_p=_o;_o="a37:4408";if(f.env.b_ge_is_aspiring_genius){c.setup({element:".ge-progress-aspiring",template:"ge_about_lightbox",data:{b_genius_user:f.env.b_genius_user||{}}})
}}return{init:e}
})(jQuery,booking);
booking.components.define("ge-lightbox",function(f,c){_p=_o;_o="a37:4411";function e(k){_p=_o;_o="a37:4412";var l=k.data;
var j=k.template;
var g=k.onOpen||function(){_p=_o;_o="a37:4413";};
var h=k.wrapperClassName||"ge-about-lightbox-wrapper";
f.require("profile/profile-menu/profile-menu").hide();
setTimeout(function(){_p=_o;_o="a37:4415";c("#tooltip_wrap").hide()
},300);
c(".user_center_popover").hide();
f.lightbox.show(f.jstmpl(j).render(l),{customWrapperClassName:h},function(m){_p=_o;_o="a37:4417";c(".ge-mod-button").click(function(){_p=_o;_o="a37:4418";f.lightbox.hide();
return false
});
if(g){g(m)
}})
}function d(h){_p=_o;_o="a37:4422";var g=h.element;
c("body").delegate(g,"click",function(j){_p=_o;_o="a37:4423";j.preventDefault();
e(h)
})
}return{setup:d,open:e}
});
booking[sNSExperiments]["cQHXYYbCYZSYO"]=(function(d,f){_p=_o;_o="a37:4427";var c=f.components.require("ge-lightbox");
function e(){_p=_o;_o="a37:4428";if(f.env.b_ge_genius_user_should_renew){console.log("Setting up lightbox");
...
(function(d,h){_p=_o;_o="a37:4431";var g;
var f;
var l;
var c=0;
function e(){_p=_o;_o="a37:4432";var m=d(document).scrollTop();
var n=h.tools.dom.getBounds(g);
n.top=f+m;
n.bottom=f+n.height+m;
return n
}function k(o){_p=_o;_o="a37:4434";if(!g){g=d(".notice-wrap")
}if(!g.length){return
...
(function p(r){_p=_o;_o="a37:4435";var q=d(".displace_growl:visible");
var t=e();
m=f;
q.each(function(){_p=_o;_o="a37:4436";var x=h.tools.dom.getBounds(this);
var w=x.bottom;
...
}function j(){_p=_o;_o="a37:4440";if(!window.navigator||!navigator.platform||navigator.platform.indexOf("Mac")==-1){return
}d(".uc_genius_tooltip").addClass("displace_growl");
h.eventEmitter.bind("growl:show",function(n,m){_p=_o;_o="a37:4441";k(m)
})
}h.ensureNamespaceExists(sNSStartup);
B[sNSStartup].ge_adjust_growls_to_user_notice_popups={priority:9,init:j}
})(window.jQuery,window.booking);
booking[sNSExperiments]["cQPHBAEWPAfJPESaO"]={init:function(){_p=_o;_o="a37:4445";var f=this,e=booking.track.getVariant("cQPHBAEWPAfJPESaO"),c,d;
if(e===2||e===3){$('li.uc-notification[data-type="extension_announce"] a').click(function(g){_p=_o;_o="a37:4446";g.preventDefault();
c=$("#promo-chrome-ext-container");
d=$("#promo-chrome-ext");
$(".user_center_popover").hide();
f.initLightbox(c,d);
booking[sNSStartup].lightbox.show($("#promo-chrome-ext-container"),{customWrapperClassName:"chrome-ext-container",bAnimation:true,bCloseButton:true,hideCallBack:function(){_p=_o;_o="a37:4447";if(e===2&&booking.env.b_lang==="en"){f.stopAnimation(d);
f.resetAnimation(d)
}},positionAfterCallBack:function(){_p=_o;_o="a37:4449";if(e===2&&booking.env.b_lang==="en"){f.resetAnimation(d);
f.startAnimation(d)
}}});
d.find(".cta-install-now a").click(function(){_p=_o;_o="a37:4451";g.preventDefault();
chrome.webstore.install(booking.env.b_chrome_extension_install_url,function(){_p=_o;_o="a37:4452";booking[sNSStartup].lightbox.hide()
})
});
d.find(".cta-play-again a").click(function(){_p=_o;_o="a37:4455";g.preventDefault();
f.resetAnimation(d);
f.startAnimation(d)
})
})
}},initElse:function(){_p=_o;_o="a37:4459";},initLightbox:function(c,d){_p=_o;_o="a37:4461";d.hide().removeClass("hidden").show()
},resetAnimation:function(c){_p=_o;_o="a37:4463";c.find(".cel-header").hide().css({width:"362px",height:"72px",left:"189px",top:"242px"});
...
},startAnimation:function(c){_p=_o;_o="a37:4465";c.queue("promoAnim",function(){_p=_o;_o="a37:4466";$(this).find(".cel-header").delay(100).fadeIn(1000).delay(1000).fadeOut(1000);
$(this).dequeue("promoAnim")
}).delay(4500,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4468";$(this).find(".step-1").fadeIn(500).delay(2000).fadeOut(500);
$(this).dequeue("promoAnim")
}).delay(3500,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4470";$(this).find(".popup-step-1").css("opacity",0).css("top",55).slideDown(250).animate({opacity:1,top:"+=11"},{queue:false,duration:250}).delay(2000).queue(function(){_p=_o;_o="a37:4471";$(this).removeClass("part-1").addClass("part-2").delay(500).find(".cel-input__username").css({width:0,display:"block"}).animate({width:260},1500);
$(this).dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4473";$(this).removeClass("part-2").addClass("part-3").delay(500).find(".cel-input__password").css({width:0,display:"block"}).animate({width:260},1500);
$(this).dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4475";$(this).fadeOut(500).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(7000,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4478";c.find(".cel-badge").fadeIn(250);
c.find(".popup-step-2").css("opacity",0).css("top",55).slideDown(250).animate({opacity:1,top:"+=11"},{queue:false,duration:250}).delay(2000).queue(function(){_p=_o;_o="a37:4479";c.find(".cel-badge").fadeOut(250);
$(this).fadeOut(500).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(2500,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4482";$(this).find(".step-2").fadeIn(500).delay(2000).fadeOut(500);
$(this).dequeue("promoAnim")
}).delay(3500,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4484";$(this).find(".popup-step-3").css("opacity",0).css("top",55).slideDown(250).animate({opacity:1,top:"+=11"},{queue:false,duration:250}).delay(2000).queue(function(){_p=_o;_o="a37:4485";$(this).removeClass("part-1").addClass("part-2").dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4487";$(this).removeClass("part-2").addClass("part-3").dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4489";$(this).fadeOut(500).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(7000,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4492";$(this).find(".popup-step-4").css("opacity",0).css("top",55).slideDown(250).animate({opacity:1,top:"+=11"},{queue:false,duration:250}).delay(2000).queue(function(){_p=_o;_o="a37:4493";$(this).removeClass("part-1").addClass("part-2").dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4495";$(this).removeClass("part-2").addClass("part-3").dequeue()
}).delay(2000).queue(function(){_p=_o;_o="a37:4497";$(this).fadeOut(500).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(7000,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4500";$(this).find(".step-3").fadeIn(500).delay(2000).fadeOut(500);
$(this).dequeue("promoAnim")
}).delay(3500,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4502";c.find(".cel-badge").fadeIn(250);
c.find(".popup-step-5").css("opacity",0).css("top",55).slideDown(250).animate({opacity:1,top:"+=11"},{queue:false,duration:250}).delay(3000).queue(function(){_p=_o;_o="a37:4503";c.find(".cel-badge").fadeOut(250);
$(this).fadeOut(500).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(4000,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4506";c.find(".cel-header").delay(1000).css({opacity:1}).fadeIn(1000).delay(1000).animate({width:181,height:36,top:130},750);
$(this).dequeue("promoAnim")
}).delay(4000,"promoAnim");
c.queue("promoAnim",function(){_p=_o;_o="a37:4508";c.queue(function(){_p=_o;_o="a37:4509";(function d(){_p=_o;_o="a37:4510";c.find("li:hidden:first").delay(1000).fadeIn(500,d)
})();
$(this).dequeue()
}).delay(7000).queue(function(){_p=_o;_o="a37:4513";c.find(".cta-install-now,.cta-play-again").fadeIn();
$(this).dequeue()
});
$(this).dequeue("promoAnim")
}).delay(3500,"promoAnim");
c.dequeue("promoAnim")
},stopAnimation:function(c){_p=_o;_o="a37:4517";c.clearQueue("promoAnim");
c.stop("promoAnim",true,true)
}};
(function(e,c){_p=_o;_o="a37:4519";function d(){_p=_o;_o="a37:4520";if(e.user&&e.user.showGeniusForGoogle){booking.eventEmitter.bind("auth-dialog:show",function(){_p=_o;_o="a37:4521";c(".user_center_popover").css("z-index","999");
e[sNSStartup].lightbox.rePosition();
c(".user_access_email").focus()
})
}}c(document).ready(d)
}(window.booking,window.jQuery));
booking.components.define("ge-lightbox",function(f,c){_p=_o;_o="a37:4525";function e(k){_p=_o;_o="a37:4526";var l=k.data;
var j=k.template;
var g=k.onOpen||function(){_p=_o;_o="a37:4527";};
var h=k.wrapperClassName||"ge-about-lightbox-wrapper";
f.require("profile/profile-menu/profile-menu").hide();
setTimeout(function(){_p=_o;_o="a37:4529";c("#tooltip_wrap").hide()
},300);
c(".user_center_popover").hide();
f.lightbox.show(f.jstmpl(j).render(l),{customWrapperClassName:h},function(m){_p=_o;_o="a37:4531";c(".ge-mod-button").click(function(){_p=_o;_o="a37:4532";f.lightbox.hide();
return false
});
if(g){g(m)
}})
}function d(h){_p=_o;_o="a37:4536";var g=h.element;
c("body").delegate(g,"click",function(j){_p=_o;_o="a37:4537";j.preventDefault();
e(h)
})
}return{setup:d,open:e}
});
(function(d,f){_p=_o;_o="a37:4541";var c="cQZGSRaPSZQOWVRdMJO";
function e(){_p=_o;_o="a37:4542";if(f.user.fromGeniusDomain){f.track.exp(c);
...
booking.components.define("ge-lightbox",function(f,c){_p=_o;_o="a37:4545";function e(k){_p=_o;_o="a37:4546";var l=k.data;
var j=k.template;
var g=k.onOpen||function(){_p=_o;_o="a37:4547";};
var h=k.wrapperClassName||"ge-about-lightbox-wrapper";
f.require("profile/profile-menu/profile-menu").hide();
setTimeout(function(){_p=_o;_o="a37:4549";c("#tooltip_wrap").hide()
},300);
c(".user_center_popover").hide();
f.lightbox.show(f.jstmpl(j).render(l),{customWrapperClassName:h},function(m){_p=_o;_o="a37:4551";c(".ge-mod-button").click(function(){_p=_o;_o="a37:4552";f.lightbox.hide();
return false
});
if(g){g(m)
}})
}function d(h){_p=_o;_o="a37:4556";var g=h.element;
c("body").delegate(g,"click",function(j){_p=_o;_o="a37:4557";j.preventDefault();
e(h)
})
}return{setup:d,open:e}
});
(function(f,h){_p=_o;_o="a37:4561";var e="cQHXYYcDHET";
var d="cQHXYYcDHBNET";
function c(){_p=_o;_o="a37:4562";f.ajax({type:"post",url:"/genius_renewal_message_seen",data:{}})
}function g(){_p=_o;_o="a37:4564";if(h.env.b_action=="book"){return
...
k.open({data:{b_genius_user:h.env.b_genius_user||{}},template:"ge_renew_lightbox",wrapperClassName:"ge-renew-lightbox-wrapper",onOpen:function(){_p=_o;_o="a37:4565";h.eventEmitter.bind("modal:close",c)
}})
}}h.ensureNamespaceExists(sNSExperiments);
h[sNSExperiments][e]={init:g,initElse:g}
}(window.jQuery,window.booking));
booking[sNSExperiments]["cQPbbadAHHKe"]={init:function(){_p=_o;_o="a37:4569";if(booking.env.priceWatch.b_price_alert_all_canceled){booking[sNSStartup].lightbox.show($(".js-price-watch-unsubscribe--all"),{customWrapperClassName:"price-watch-unsubscribe-wrapper"})
}}};
(function(d,f){_p=_o;_o="a37:4571";var c="cQHFAUADHYfFNFET";
function e(){_p=_o;_o="a37:4572";if(f.env.b_reg_user_is_genius){f.eventEmitter.bind("user_access_menu_open",function(){_p=_o;_o="a37:4573";if(d(".genius-user-account-sign").length){f.track.exp(c)
}})
}}f.ensureNamespaceExists(sNSExperiments);
f[sNSExperiments][c]={init:e,initElse:e}
}(window.jQuery,window.booking));
(function(){_p=_o;_o="a37:4577";var e=window.jQuery;
var g=window.booking;
var c="bHOffPZAZYdUJBbLHe";
function f(){_p=_o;_o="a37:4578";g.eventEmitter.bind(g.Search.Events.GROUP_CHANGED,function(m,l){_p=_o;_o="a37:4579";if(l){var k=parseInt(l.adults),h=l.childrenAges,j="";
e.each(new Array(k),function(o){_p=_o;_o="a37:4580";j+="A";
if(o!==k-1){j+=","
}});
if(h){e.each(h,function(o){_p=_o;_o="a37:4582";j+=","+h[o]
})
}}e(".js-first-room-param-setup").val(j)
})
}function d(){_p=_o;_o="a37:4586";}g.ensureNamespaceExists(sNSExperiments);
...
B.when({condition:$("#frm").length,events:"load",experiment:"bLNHPZAZddaCSaKXe"}).run(function(){_p=_o;_o="a37:4589";var g=$(".js-multi_room_configuration__rooms"),c=$(".js-hide_when_multiple_rooms"),j="g-hidden",e=$(".b-form-children-ages"),d=$(".js-multi_room_configuration__params");
...
}$(".js-b-selectbox__groupselection").change(function(){_p=_o;_o="a37:4590";var k=parseInt($(this).val());
...
B.eventEmitter.bind(B.Search.Events.MULTI_GROUP_CHANGED,function(l,k){_p=_o;_o="a37:4592";var m="";
...
$(".js-multi-room-guest-configuration-wrapper").delegate(".js-multi-room-rooms","change",function(){_p=_o;_o="a37:4594";var k=parseInt($(this).val());
...
$(".js-multi-room-guest-configuration-wrapper").delegate(".js-multi-room-adults","change",function(){_p=_o;_o="a37:4596";var k=parseInt($(this).attr("data-room-id")),l=parseInt($(this).val());
B.Group.rooms[k-1].adults=l;
B.eventEmitter.trigger(B.Search.Events.MULTI_GROUP_CHANGED)
});
$(".js-multi-room-guest-configuration-wrapper").delegate(".js-multi-room-ages","change",function(){_p=_o;_o="a37:4598";var l=parseInt($(this).attr("data-room-id")),m=parseInt($(this).attr("data-child-id")),k=parseInt($(this).val());
B.Group.rooms[l-1].children[m-1]={years:k};
B.eventEmitter.trigger(B.Search.Events.MULTI_GROUP_CHANGED)
});
$(".js-multi-room-guest-configuration-wrapper").delegate(".js-multi-room-children","change",function(){_p=_o;_o="a37:4600";var k=parseInt($(this).attr("data-room-id")),l=parseInt($(this).val());
...
B.when({events:"ready",condition:$("#frm").length}).run(function(){_p=_o;_o="a37:4603";var c=false,d=false;
if(B.et.track("bLYSRffECIAaKLPLTQWGJXWdIGWe")){$("#frm").delegate(".b-children-ages-configurator__element","click",function(){_p=_o;_o="a37:4604";if(d){d.hide();
d.destroy()
}});
$(".b-selectbox__element[name=group_children]").change(function(){_p=_o;_o="a37:4606";if(parseInt($(this).val())>0&&!c){setTimeout(function(){_p=_o;_o="a37:4607";d=$.fly.dropdown.extend({defaults:{position:"bottom left",content:function(){_p=_o;_o="a37:4608";return B.jstmpl("searchbox_children_ages_tooltip").render({})
},extraClass:"searchbox_children_ages_tooltip"}}).create(".b-children-ages-configurator__element");
d.show();
c=true
},0)
}})
}$(".b-selectbox__element[name=group_children]").change(function(){_p=_o;_o="a37:4612";B.et.stage("bLYSRffECIAaKLPLTQWGJXWdIGWe",1)
});
$("#frm").delegate(".b-children-ages-configurator__element","change",function(){_p=_o;_o="a37:4614";B.et.stage("bLYSRffECIAaKLPLTQWGJXWdIGWe",2)
})
});
(function(){_p=_o;_o="a37:4617";var f=window.jQuery;
var h=window.booking;
var d="bLYSRbNJdQJJHMVGRCfDaWe";
function c(){_p=_o;_o="a37:4618";f("#frm").submit(function(){_p=_o;_o="a37:4619";if(f(".b-children-ages-configurator__element").length){var k=true,j=false;
f(".b-children-ages-configurator__element").each(function(){_p=_o;_o="a37:4620";if(!(f(this).find(":selected").hasClass("sb_child_ages_empty_zero")||f(this).find(":selected").hasClass("sb_child_ages_not_empty_zero"))){k=false
...
(function(g,d){_p=_o;_o="a37:4629";var f=g.require("et");
var c=/show_non_age_message=1/.test(location.href);
var e="bLYSRbNJdQJJHMVGRCfDaPDYGZfBFO";
g.when({condition:d("#frm").length,events:"load",action:"index"}).run(function(j){_p=_o;_o="a37:4630";var h=d("#frm");
var l=h.find("[name=group_children]");
var k=d('<input type="hidden" name="show_non_age_message" value="1">');
h.on("submit",function(o){_p=_o;_o="a37:4631";var n=parseInt(l.val());
var m=h.find("[name=age]").find(":selected.sb_child_ages_empty_zero").length;
if(n&&m){h.append(k)
}})
});
g.when({condition:c&&d("#frm").length,events:"load",action:"searchresults",experiment:e}).run(function(k){_p=_o;_o="a37:4634";var n=null;
var j=200;
var h=(g.env.rtl)?"left":"right";
var m="searchbox_children_age_default_12_dropdown";
var l=f.track("PAHBYROdVaC");
if(l!=1&&l!=2){return
}setTimeout(function(){_p=_o;_o="a37:4635";n=d.fly.dropdown.extend({defaults:{position:h,content:function(){_p=_o;_o="a37:4636";return g.jstmpl("searchbox_children_ages_default_12_tooltip").render({})
},extraClass:m},actions:{click:function(o){_p=_o;_o="a37:4638";if(d(o.target).is("select")){this.hide();
f.stage(e,2)
}}},_autohide:function(){_p=_o;_o="a37:4640";},init:function(){_p=_o;_o="a37:4642";this.bind(this.events.show,function(){_p=_o;_o="a37:4643";d("."+m).delegate(".fly-dropdown-close","click",function(o){_p=_o;_o="a37:4644";n.hide();
f.stage(e,3)
})
})
...
(function(){_p=_o;_o="a37:4651";var f=window.jQuery;
var h=window.booking;
var d="bLYSRfLdLUNbCcGZfKe";
function c(){_p=_o;_o="a37:4652";f("select[name=age]").focus(function(){_p=_o;_o="a37:4653";h.track.stage(d,1)
})
}function g(){_p=_o;_o="a37:4656";c()
}function e(){_p=_o;_o="a37:4658";c()
}h.ensureNamespaceExists(sNSExperiments);
h[sNSExperiments][d]={priority:9,init:g,initElse:e}
})();
booking[sNSExperiments].header_2012=(function(){_p=_o;_o="a37:4661";var c=function(){_p=_o;_o="a37:4662";$("#b_nav_profile").bind("click",function(){_p=_o;_o="a37:4663";$(this).toggleClass("selected");
...
$(".profile_login_switcher").bind("click",function(){_p=_o;_o="a37:4665";$("#profile_forms").toggleClass("profile_sign-in").toggleClass("profile_sign-up")
});
$("select","#header_currency").bind("change",function(){_p=_o;_o="a37:4667";$(this).parent("form").submit()
});
$("select","#header_language").bind("change",function(){_p=_o;_o="a37:4669";$(this).parent("form").submit()
})
};
var d=function(){_p=_o;_o="a37:4672";c()
};
return{init:d}
}());
(function(){_p=_o;_o="a37:4675";var e=window.jQuery;
var g=window.booking;
var d="faNfCfHbcGRcdFO";
function f(){_p=_o;_o="a37:4676";e(".user_center_option").one("click",c)
}function c(){_p=_o;_o="a37:4678";g.track.stage(d,1)
}g.ensureNamespaceExists(sNSExperiments);
g[sNSExperiments][d]={init:f,initElse:f}
})();
booking[sNSStartup].improve_calendar_closing={priority:9,init:function(){_p=_o;_o="a37:4681";$(document.body).click(function(e){_p=_o;_o="a37:4682";var d=$(e.target).parents("#calendar_popup").length;
var c=$(e.target).parents(".calendarLink").length;
if(!d&&!c){$(this).trigger("close_calendar",e.target)
}});
return true
}};
booking[sNSExperiments]["cDPdWSXAPLHRT"]=(function(e,c){_p=_o;_o="a37:4685";function d(){_p=_o;_o="a37:4686";if(e.clickStore){booking.events.on("user_center_bar:init",function(){_p=_o;_o="a37:4687";var f=e.clickStore.get$("uc-trigger");
if(f){e.track.stage("cDPdWSXAPLHRT",1);
e.track.stage("cDPdWSXAPLHRT",2);
if(e.track.getVariant("cDPdWSXAPLHRT")==2){setTimeout(function(){_p=_o;_o="a37:4688";c(f.originalEvent.target).closest(".popover_trigger").triggerHandler(f)
},0)
}}})
}}return{init:d}
})(booking,jQuery);
B.run("YdVSPMEZaZGNVaKbNXTbdBcNKNMSUZJANaKe").onReady(function(){_p=_o;_o="a37:4693";var c="YdVSPMEZaZGNVaKbNXTbdBcNKNMSUZJANaKe";
var d=function(){_p=_o;_o="a37:4694";B.track.stage(c,1);
$(this).off("hover",d)
};
if(["hotel"].indexOf(B.env.b_action)>=0&&B.env.b_guest_country==="fr"){$(".no_booking_fees_fr_tooltip").on("hover",d)
}});
B.run("YdVDbYWTRSSEaMHe").onReady(function(){_p=_o;_o="a37:4697";$(".search_summary_block .dates .search_summary_toggle_button").bind("click",function(d){_p=_o;_o="a37:4698";var c="#frm .b-form-checkout *";
d.preventDefault();
...
}window.setTimeout(function(){_p=_o;_o="a37:4699";B.Search.openDatepicker({duration:0,selector:c})
},10)
}else{B.track.exp("YdVDbYWTRSSEaMYFHbdBJbCMC")
}})
});
(function(){_p=_o;_o="a37:4703";var c="YdVDEZRETWRGPVLFQCSET";
booking[sNSExperiments][c]=(function(e,h){_p=_o;_o="a37:4704";var k="loc-theme-search_active-num-",m="loc-theme-search-showcase_num-",d="loc-theme-search_demo",g={switchedToAnyTheme:2,switchedToTheme2:3,switchedToTheme3:4,switchedToTheme1:5};
function j(n,o){_p=_o;_o="a37:4705";this.$container=h(n);
...
}}h.extend(j.prototype,{run:function(){_p=_o;_o="a37:4707";var n=this;
this.$bars.bind("mouseover",function(){_p=_o;_o="a37:4708";var p=h(this).closest(".loc-theme-search-showcase"),o=f(p,m);
n.setActive(o,function(){_p=_o;_o="a37:4709";l(g.switchedToAnyTheme);
if(o==2){l(g.switchedToTheme2)
}else{if(o==3){l(g.switchedToTheme3)
}else{if(o==1){l(g.switchedToTheme1)
}}}})
});
this.$container.bind("mouseover",function(){_p=_o;_o="a37:4712";if(n.isDemoRunning){n.stopDemo()
}})
},setActive:function(n,o){_p=_o;_o="a37:4715";f(this.$container,k,n);
if(this.activeTimer){clearTimeout(this.activeTimer)
}if(o){this.activeTimer=setTimeout(o,500)
}},showDemo:function(){_p=_o;_o="a37:4717";var o=this,n=[2,1];
this.$container.addClass(d);
h.each(n,function(q,p){_p=_o;_o="a37:4718";var r=setTimeout(function(){_p=_o;_o="a37:4719";o.setActive(p);
if(q===n.length-1){o.stopDemo()
}},400*(q+1));
o.demoTimers.push(r)
})
},stopDemo:function(){_p=_o;_o="a37:4723";while(this.demoTimers.length){clearTimeout(this.demoTimers.shift())
}this.$container.removeClass(d)
}});
function l(n){_p=_o;_o="a37:4725";e.track.custom_goal(c,n)
}function f(o,t,r){_p=_o;_o="a37:4727";var u=r===null,p=!u&&arguments.length>2,q=new RegExp("^"+t+"(.*)$"),n;
h(o).each(function(x,y){_p=_o;_o="a37:4728";var w=h(y);
h.each((y.className||"").split(/ +/),function(C,A){_p=_o;_o="a37:4729";var z=String(A).match(q);
if(!z){return
...
return n
}return{init:function(){_p=_o;_o="a37:4733";new j(".loc-theme-search")
},initElse:function(){_p=_o;_o="a37:4735";}}
})(booking,jQuery)
})();
(function(c){_p=_o;_o="a37:4739";B[sNSExperiments][c]={init:function(){_p=_o;_o="a37:4740";$(document.body).bind("submit",function(d){_p=_o;_o="a37:4741";if($(d.target).attr("role")=="search"&&!d.isDefaultPrevented()){$(this).addClass(c)
}})
}}
})("YdVSfPTDPUPcC");
(function(c){_p=_o;_o="a37:4745";B[sNSExperiments][c]={init:function(){_p=_o;_o="a37:4746";$(".default_cur_lang_settings").find(".decline_settings, .accept_settings, .close_settings").click(function(){_p=_o;_o="a37:4747";$(".default_cur_lang_settings").hide();
$("#bodyconstraint").addClass("slideUp");
$("body").addClass("body-slide-up")
});
if(B.track.getVariant(c)==2){$(".default_cur_lang_settings_content_wrapper [data-trigger]").click(function(){_p=_o;_o="a37:4749";$($(this).data("trigger")).first().click();
$(".user_center_option").trigger("mouseleave");
return false
})
}}}
})("YdVJWcDOHQFVAFAOIEeUeKe");
B.run("YdAcCcdNANKBYbaTaTaET").onReady(function(){_p=_o;_o="a37:4753";if(B.track.getVariant("YdAcCcdNANKBYbaTaTaET")){booking[sNSStartup].rewrite_tt.ttClass+=" rtl_tooltip_class"
}B.eventEmitter.one("tooltip.show",function(){_p=_o;_o="a37:4754";B.track.exp("YdAcCcdNANKBYbaTaTaET")
})
});
B.run("YdVecTYWRbQFdBJOTXNXe").onReady(function(){_p=_o;_o="a37:4757";B.track.onView(".deal-badge-wrapper_vip-choice").exp("YdVecTYWRbQFdBJOTXNXe")
});
(function(c){_p=_o;_o="a37:4759";$(".profile-area__nav").delegate(".js-insiderguides-track","click",function(f){_p=_o;_o="a37:4760";var d=$(this).data("trackname");
c.google.trackEvent("Insider Guides","Profile Nav Click",[c.env.b_action,":",d].join(" "))
})
})(booking);
booking[sNSExperiments]["fEDRMYBXRXZXe"]=(function(){_p=_o;_o="a37:4763";var c=function(){_p=_o;_o="a37:4764";if($("#error404page").length){booking.track.exp("fEDRMYBXRXZXe")
}$("#errorReport").click(function(f){_p=_o;_o="a37:4765";f.preventDefault();
...
booking[sNSExperiments]["fEDDSMbRebC"]=(function(){_p=_o;_o="a37:4769";$.fn.lp_placeholder=function(){_p=_o;_o="a37:4770";var f=$(this),e=document.createElement("input");
if("placeholder" in e){return
}d();
f.bind("focus",function(){_p=_o;_o="a37:4771";d();
f.parent().addClass("focus")
});
f.bind("blur",function(){_p=_o;_o="a37:4773";d();
f.parent().removeClass("focus")
});
f.bind("keydown",function(h){_p=_o;_o="a37:4775";var g=h.which;
if(g>41){f.removeClass("placeholder")
}else{if(g==8&&f.val().length==1){f.addClass("placeholder")
}}});
function d(){_p=_o;_o="a37:4777";var g=!f.val()?"addClass":"removeClass";
f[g]("placeholder")
}};
function c(){_p=_o;_o="a37:4780";var d=$(".experiment_lp_new_deal_box_wrapper");
if(!d.length||$.cookie("viewedBCheckBounce")){return
}d.find(".experiment_lp_new_deal_box_email_input").lp_placeholder();
d.find(".experiment_lp_new_deal_box_exit_btn").click(function(){_p=_o;_o="a37:4781";B.lightbox.hide()
});
d.find("input[type=submit]").click(function(){_p=_o;_o="a37:4783";B.track.custom_goal("fEDDSMbRebC",2)
});
if(B.track.getVariant("fEDDSMbRebC")==1){d.bind("show-up",function(){_p=_o;_o="a37:4785";B.track.custom_goal("fEDDSMbRebC",1)
})
}else{setTimeout(function(){_p=_o;_o="a37:4787";booking[sNSStartup].lightbox.show(d,{customWrapperClassName:booking.env.notificationLightboxContainerClass||"notification-lightbox-container"});
B.track.custom_goal("fEDDSMbRebC",1);
$.cookie("viewedBCheckBounce","true",{expires:30,path:"/",domain:booking.env.b_domain_end})
},5000)
}}return{init:c}
})();
booking[sNSExperiments]["fEWUZbdJKbIYUYYeLT"]=(function(){_p=_o;_o="a37:4791";function c(){_p=_o;_o="a37:4792";$(".ga-sh-tracker").click(function(){_p=_o;_o="a37:4793";var d=$(this).data("google-track-event-category")||"Click",f=d.toLowerCase(),h=$(this).data("google-track-event-label")||"",g=$(this).data("google-track-event-action")||"",g=g.replace(/\n/g,""),j=[];
...
booking[sNSExperiments]["fEJRUYBPbIbOedZFNbKSPTNDIKe"]=(function(){_p=_o;_o="a37:4797";function c(){_p=_o;_o="a37:4798";B.components.require("track-pageviews").initTracking("fEJRUYBPbIbOedZFNbKSPTNDIKe","lp_tpvbpg",!!B.env.run_lp_cp_bold_date_picker_bpg_for_all)
}return{init:c,initElse:c}
})();
booking[sNSExperiments]["fEWWFIMNFHBUBMWQIORe"]=(function(){_p=_o;_o="a37:4801";function c(){_p=_o;_o="a37:4802";B.components.require("track-pageviews").initTracking("fEWWFIMNFHBUBMWQIORe","lp_tpvrpf",!!B.env.lp_city_remove_popular_filters)
}return{init:c,initElse:c}
})();
booking[sNSExperiments]["IZdPZPUcHCbXfVXMHO"]=(function(k,g){_p=_o;_o="a37:4805";var d;
var f="IZdPZPUcHCbXfVXMHO";
function j(){_p=_o;_o="a37:4806";e();
d=g(".mb-masthead__map");
if(d.length){h(d.data("latitude"),d.data("longitude"),d.data("hotel-name"))
}if(booking.env.confirmationPrint){window.setTimeout(function(){_p=_o;_o="a37:4807";g(".js-print-confirmation-start").click()
},1000)
}}function h(p,o,m){_p=_o;_o="a37:4810";if(window.google&&google.maps){c(p,o,m)()
...
}}function c(n,m,l){_p=_o;_o="a37:4812";return function(){_p=_o;_o="a37:4813";var o=new google.maps.LatLng(n,m);
...
}function e(){_p=_o;_o="a37:4816";if(k.env.b_action==="confirmation"&&window.location.hash.indexOf("from_mybooking")!=-1){k.track.custom_goal(f,1);
...
l.bind("click.summary_redesign",function(m){_p=_o;_o="a37:4817";l.unbind("click.summary_redesign");
m.preventDefault();
k.track.custom_goal(f,3)
});
g(".js-custom-goal--view-policies").click(function(m){_p=_o;_o="a37:4819";m.preventDefault();
k.track.custom_goal(f,4)
});
g(".js-custom-goal--show-map").click(function(m){_p=_o;_o="a37:4821";if(!booking.track.getVariant("IZEZKZNaYKe")){m.preventDefault()
}k.track.custom_goal(f,5)
})
}return{priority:9,init:j,initElse:e}
})(booking,jQuery);
B[sNSExperiments]["IZdRWSdZbVeUZDeLcPC"]=(function(d){_p=_o;_o="a37:4825";function c(){_p=_o;_o="a37:4826";d.track.onClick(".header-user-menu-link-s-logged-in").exp("IZdRWSdZbVeUZDeLcPC")
}return{init:c,initElse:c}
})(window.booking);
B.runExp("eRQJFFKMEcbeOQIXWOJNET").onReady(function(){_p=_o;_o="a37:4829";var e="eRQJFFKMEcbeOQIXWOJNET",k=$("#price_display_wrapper_sidebar"),d=$(".price_display_control",k),g=$(".price_display_control input:checkbox",k),j=$(".price_display_submit button",k),h=$(".price_display_submit",k),c=$(".price_display_control_reset",k);
d.click(function(m){_p=_o;_o="a37:4830";B.track.custom_goal(e,1);
if(!(m.target.type=="checkbox"||$(m.target).hasClass("jq_tooltip"))){var l=$(":checkbox",this);
l.attr("checked",!l.attr("checked"));
m.stopPropagation()
}h.addClass("active")
});
j.click(function(l){_p=_o;_o="a37:4832";l.preventDefault();
B.track.custom_goal(e,2);
$(this).addClass("b-price-display-button--loader");
$.get("/preferences/price_mode?"+k.serialize(),function(m){_p=_o;_o="a37:4833";if(m.success){location.reload()
}else{f()
}});
g.each(function(){_p=_o;_o="a37:4835";$(this).attr("disabled",true)
});
j.attr("disabled",true)
});
c.click(function(l){_p=_o;_o="a37:4838";l.preventDefault();
B.track.custom_goal(e,3);
$.get("/preferences/price_mode?reset_price_preferences=on",function(m){_p=_o;_o="a37:4839";if(m.success){location.reload()
}else{f()
}});
g.each(function(){_p=_o;_o="a37:4841";$(this).attr("disabled",true)
});
j.attr("disabled",true)
});
function f(){_p=_o;_o="a37:4844";$(":input",k).removeAttr("disabled");
j.removeClass("b-price-display-button--loader")
}});
booking[sNSExperiments]["BOebKPJTDfNLT"]={init:function(){_p=_o;_o="a37:4847";var c=B.require("user-left-client");
...
$(".usabilla_pre_lightbox").click(function(){_p=_o;_o="a37:4849";booking[sNSStartup].lightbox.show($("#usabilla_lightbox"),{customWrapperClassName:"usabilla_lightbox",bCloseButton:true});
return false
});
B[sNSStartup]["ZFeNBKKYAPACLO"]=(function(f,j){_p=_o;_o="a37:4851";var e=150+7+10;
if(j.env.b_lang==="ar"){e=235+43+7+10
}if(j.env.b_is_villa_site){e=135+7+10+50
}function d(k){_p=_o;_o="a37:4852";this.$element=f(k);
this.priority_=this.$element.data("priority")||5
}d.prototype.width=function(){_p=_o;_o="a37:4854";if(!this.width_){this.width_=this.$element.outerWidth()
}return this.width_
};
d.prototype.priority=function(){_p=_o;_o="a37:4856";return this.priority_
};
d.prototype.hide=function(){_p=_o;_o="a37:4858";this.$element.hide();
return this
};
d.prototype.show=function(){_p=_o;_o="a37:4860";this.$element.show();
return this
};
function c(k){_p=_o;_o="a37:4862";this.$element=f(k);
this.items=f.map(this.$element.find(".user_center_option"),function(l){_p=_o;_o="a37:4863";return new d(l)
});
this.sortedItems=this.items.sort(function(m,l){_p=_o;_o="a37:4865";return m.priority()-l.priority()
})
}c.prototype.fitWidth=function(k){_p=_o;_o="a37:4868";f.each(this.sortedItems,function(l,m){_p=_o;_o="a37:4869";if(k-m.width()>0){k-=m.width();
m.show()
}else{m.hide()
}});
return this
};
function h(){_p=_o;_o="a37:4872";var k=f("#top .user_center_nav .user_center_option");
f(window).bind("resize",j.tools.functions.throttle(function(){_p=_o;_o="a37:4873";var l=k.toArray().reduce(function(n,o){_p=_o;_o="a37:4874";return n+f(o).width()
},0),m=f("#top").width()-e;
if(l>m){j.track.exp("ZFeNBKKYAPACLO")
}},1000))
}function g(){_p=_o;_o="a37:4878";h();
var k=f("#top"),l=new c(k.find(".user_center_nav"));
function m(){_p=_o;_o="a37:4879";l.fitWidth(k.width()-e)
}f(window).bind("resize",j.tools.functions.throttle(m,300));
m()
}return{init:g,priority:9}
}($,booking));
$(function(){_p=_o;_o="a37:4883";$("a.room_link_changes_date").click(function(c){_p=_o;_o="a37:4884";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date a[href=#cancel]").click(function(c){_p=_o;_o="a37:4886";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date").hide()
});
$(".confirm_change_date").click(function(c){_p=_o;_o="a37:4888";c.stopPropagation()
});
if($(".confirm_change_date").length>0){$("body").click(function(){_p=_o;_o="a37:4890";$(".confirm_change_date").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
$(function(){_p=_o;_o="a37:4893";$("a.hotel_link_changes_date").click(function(c){_p=_o;_o="a37:4894";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date_hotel").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date_hotel a[href=#cancel]").click(function(c){_p=_o;_o="a37:4896";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date_hotel").hide()
});
$(".confirm_change_date_hotel").click(function(c){_p=_o;_o="a37:4898";c.stopPropagation()
});
if($(".confirm_change_date_hotel").length>0){$("body").click(function(){_p=_o;_o="a37:4900";$(".confirm_change_date_hotel").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
$(function(){_p=_o;_o="a37:4903";$("a.photo_link_changes_date").click(function(c){_p=_o;_o="a37:4904";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date_photo").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date_photo a[href=#cancel]").click(function(c){_p=_o;_o="a37:4906";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date_photo").hide()
});
$(".confirm_change_date_photo").click(function(c){_p=_o;_o="a37:4908";c.stopPropagation()
});
if($(".confirm_change_date_photo").length>0){$("body").click(function(){_p=_o;_o="a37:4910";$(".confirm_change_date_photo").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
$(function(){_p=_o;_o="a37:4913";$("a.review_link_changes_date").click(function(c){_p=_o;_o="a37:4914";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date_review").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date_review a[href=#cancel]").click(function(c){_p=_o;_o="a37:4916";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date_review").hide()
});
$(".confirm_change_date_review").click(function(c){_p=_o;_o="a37:4918";c.stopPropagation()
});
if($(".confirm_change_date_review").length>0){$("body").click(function(){_p=_o;_o="a37:4920";$(".confirm_change_date_review").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
$(function(){_p=_o;_o="a37:4923";$("a.more_link_changes_date").click(function(c){_p=_o;_o="a37:4924";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date_more").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date_more a[href=#cancel]").click(function(c){_p=_o;_o="a37:4926";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date_more").hide()
});
$(".confirm_change_date_more").click(function(c){_p=_o;_o="a37:4928";c.stopPropagation()
});
if($(".confirm_change_date_more").length>0){$("body").click(function(){_p=_o;_o="a37:4930";$(".confirm_change_date_more").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
$(function(){_p=_o;_o="a37:4933";$("a.scarcity_link_changes_date").click(function(c){_p=_o;_o="a37:4934";c.stopPropagation();
c.preventDefault();
$(this).siblings(".confirm_change_date_scarcity").css({top:c.pageY+"px"}).show().find("a[href=#continue]").attr("href",$(this).attr("href"))
});
$(".confirm_change_date_scarcity a[href=#cancel]").click(function(c){_p=_o;_o="a37:4936";c.stopPropagation();
c.preventDefault();
$(".confirm_change_date_scarcity").hide()
});
$(".confirm_change_date_scarcity").click(function(c){_p=_o;_o="a37:4938";c.stopPropagation()
});
if($(".confirm_change_date_scarcity").length>0){$("body").click(function(){_p=_o;_o="a37:4940";$(".confirm_change_date_scarcity").hide()
})
}if($("#maxotel_rooms tr.highlight").length>0){$("body, html").scrollTop($("#availability_target").offset().top)
}});
booking[sNSExperiments].notifications={priority:9,init:function(){_p=_o;_o="a37:4943";this.initializeNotifications()
},initElse:function(){_p=_o;_o="a37:4945";this.initializeNotifications()
},initializeNotifications:function(){_p=_o;_o="a37:4947";var f=$("#notificationMenu .alert");
...
booking[sNSExperiments]["PVJWcRARe"]={init:function(){_p=_o;_o="a37:4949";var e=$(".search_header_bar"),d=$("#searchBarAdvancedOptions"),c=$(".search_header_bar #b_searchbox_errors");
if(!e.length){return
}$(".search_icon").click(function(f){_p=_o;_o="a37:4950";f.stopPropagation();
d.toggle()
});
$(document).click(function(f){_p=_o;_o="a37:4952";if(!d.is(f.target)&&d.has(f.target).length===0){d.hide();
c.hide()
}});
B.eventEmitter.bind(B.Search.Events.DATE_INVALID,function(f,g){_p=_o;_o="a37:4954";d.show()
});
$("#b2indexPage #destination").focus(function(){_p=_o;_o="a37:4956";B.track.custom_goal("PVJWcRARe",1)
});
$("body.has_search_bar .search_icon").click(function(){_p=_o;_o="a37:4958";B.track.custom_goal("PVJWcRARe",2)
})
}};
B[sNSStartup]["search_summary_block"]={init:function(){_p=_o;_o="a37:4961";function c(d){_p=_o;_o="a37:4962";var e=$("#searchboxInc");
...
$(".sb-summary-block-item, .sb-summary-block__submit").click(function(d){_p=_o;_o="a37:4964";d.preventDefault();
$(".b-searchbox").removeClass("b-searchbox_summary")
})
}};
booking[sNSStartup].SecretDeals={priority:8,init:function(){_p=_o;_o="a37:4967";var d=this;
if(!$("#secretdeals-bg1").length){return false
}$(window).bind("scroll",function(f){_p=_o;_o="a37:4968";d.parallaxScroll()
});
$("a.section1").click(function(){_p=_o;_o="a37:4970";$("html, body").animate({scrollTop:0},1000,function(){_p=_o;_o="a37:4971";d.parallaxScroll()
});
return false
});
$("a.section2").click(function(){_p=_o;_o="a37:4974";$("html, body").animate({scrollTop:$("#section2").offset().top},1000,function(){_p=_o;_o="a37:4975";d.parallaxScroll()
});
return false
});
$("a.section3").click(function(){_p=_o;_o="a37:4978";$("html, body").animate({scrollTop:$("#section3").offset().top},1000,function(){_p=_o;_o="a37:4979";d.parallaxScroll()
});
return false
});
$("a.section4").click(function(){_p=_o;_o="a37:4982";$("html, body").animate({scrollTop:$("#section4").offset().top},1000,function(){_p=_o;_o="a37:4983";d.parallaxScroll()
});
return false
});
$("nav#primary a").hover(function(){_p=_o;_o="a37:4986";$(this).prev("h1").show()
},function(){_p=_o;_o="a37:4988";$(this).prev("h1").hide()
});
var c=$(".sc_navigator");
$(window).scroll(function(){_p=_o;_o="a37:4990";var e=$(window).scrollTop();
...
},removeActiveClass:function(){_p=_o;_o="a37:4993";$(".sc_navigator a").each(function(){_p=_o;_o="a37:4994";$(this).removeClass("active")
})
},parallaxScroll:function(){_p=_o;_o="a37:4997";var c=$(window).scrollTop();
...
if(B.env.b_action==="index"){if($("#ed-wrapper").length>0){booking[sNSExperiments]["IZVJPVZMYCOKNIUAFCSDWLYScEUC"]={init:function(){_p=_o;_o="a37:4999";var d=$("#ed-pagination");
var k=$("#ed-prevpage");
var e=$("#ed-nextpage");
var g=$("#ed-cpagenum");
var l=$("#ed-tpagenum");
...
var j=c.length;
if(j>1){c.each(function(m){_p=_o;_o="a37:5000";if($(this).hasClass("ed-cgrp")){g.text(m+1)
}});
c.eq(j-1).addClass("ed-lgrp");
d.show();
l.text(j);
function h(){_p=_o;_o="a37:5002";$this=$(this);
...
}}if($(".popular_hotels-wrp").length>0){booking[sNSExperiments]["IZAFCSDWLCUC"]={init:function(){_p=_o;_o="a37:5005";$(".popular_hotels-wrp").delegate(".popular_hotels-content","mouseenter",function(){_p=_o;_o="a37:5006";var c=$(this);
...
$(".popular_hotels-wrp").delegate(".popular_hotels-content","mouseleave",function(){_p=_o;_o="a37:5008";var c=$(this);
...
}B[sNSExperiments]["aKFEIcYNJPbHDbMHaZLT"]=(function(d){_p=_o;_o="a37:5011";function c(){_p=_o;_o="a37:5012";d.track.onMouseover("#removeAllHistory").exp("aKFEIcYNJPbHDbMHaZLT")
}return{init:c,initElse:c}
})(window.booking);
booking[sNSStartup].survey={priority:9,run:function(){_p=_o;_o="a37:5015";var d=$("#survey").attr("surveyurl");
if(d){b_survey_url=d;
...
var g=function(){_p=_o;_o="a37:5016";if(booking.env.b_action==="hotel"){booking[sNSStartup].bookingSticker.update()
}};
var f=function(k){_p=_o;_o="a37:5018";if(booking.env.showRevdSurvey2016Q1){var l=$(k.target).val()
}else{var l=$(this).val()
...
}$.get(h+"decision="+l+"&survey_key="+booking.env.survey_key,{},function(m){_p=_o;_o="a37:5019";c.hide("normal",function(){_p=_o;_o="a37:5020";c.remove();
g()
})
})
}return false
};
if(booking.env.showRevdSurvey2016Q1){booking.events.on("REVIEWS:fetched",function(){_p=_o;_o="a37:5024";c.addClass("show")
});
c.find("button").live("click",f)
}else{c.fadeIn("normal",g);
c.find("button").click(f)
}}},init:function(){_p=_o;_o="a37:5027";this.run();
if(B.env.b_run_sr_ajax){var c=B.require("searchresults/events");
c.on(c.UI_RESULTS_UPDATED,function(){_p=_o;_o="a37:5028";this.run()
}.bind(this))
}}};
(function(d,c){_p=_o;_o="a37:5031";if(booking.env.b_is_tdot_traffic&&booking.env.b_ncexp){}else{return
}var g=$(c),f=$(d),e=booking.env.b_ncexp===1?"cta-loading_progress":"cta-loading_spinner";
g.delegate(".cta-touch","touchstart touchend touchmove",function(j){_p=_o;_o="a37:5032";var h=j.type;
$(this)[(h=="touchstart"?"addClass":"removeClass")]("cta-touch_touched")
});
g.delegate("a.cta[data-component-rel]","click",function(h){_p=_o;_o="a37:5034";$(this).addClass("cta-loading")
});
g.delegate(".cta-loading","click",function(){_p=_o;_o="a37:5036";var h=$(this);
h.removeClass(e);
setTimeout(function(){_p=_o;_o="a37:5037";h.addClass(e)
},60)
});
g.delegate("form","submit",function(j){_p=_o;_o="a37:5040";var h=booking.env.b_action==="book"?$('.cta-touch[data-component-rel="book"]'):$(this).find(".cta-touch");
if(h.length){h.addClass("cta-loading")
}});
f.bind("load pageshow reset popstate",function(){_p=_o;_o="a37:5042";$(".cta-touch").removeClass("cta-loading")
})
})(window,document);
B.run("PcVBcTaNFMGUbAXKAFXbWC").onLoad(function(){_p=_o;_o="a37:5045";if($.cookie("tfl_signup_notification_prompt")){return
}$.cookie("tfl_signup_notification_prompt",1);
if(B.track.getVariant("PcVBcTaNFMGUbAXKAFXbWC")){setTimeout(function(){_p=_o;_o="a37:5046";var c=$(".js-uc-notifications .user_center_popover");
B[sNSExperiments].user_center_bar.positionPopover(c,{});
c.css({opacity:0}).animate({opacity:1},1000)
},2000);
$(".js-uc-notification a, .uc-notifications__footer a").click(function(){_p=_o;_o="a37:5048";B.track.stage("PcVBcTaNFMGUbAXKAFXbWC",1)
})
}});
booking[sNSExperiments]["ZeZbObSAeOESJVWKMKe"]={init:function(){_p=_o;_o="a37:5051";$(".wl_create_form").delegate(".wl-dropdown-toggle","click",function(){_p=_o;_o="a37:5052";$(this).toggleClass("collapsed");
$(this).parents(".wl-btn-group-wrap").next(".wl-dropdown-menu").slideToggle("fast")
});
$(".wl_create_form").delegate(".wl-dropdown-menu-a","click",function(c){_p=_o;_o="a37:5054";c.preventDefault();
var d=$(this);
...
},initElse:function(){_p=_o;_o="a37:5057";}};
(function(){_p=_o;_o="a37:5059";var d="adfaPbPELXVFfIbYO";
function c(){_p=_o;_o="a37:5060";booking.eventEmitter.bind("uc_popover_showed",function(){_p=_o;_o="a37:5061";booking.track.exp(d)
})
}booking[sNSExperiments][d]={init:c,initElse:c}
})();
booking[sNSExperiments]["beODVAfSPSMTafUcO"]={e_hash:"beODVAfSPSMTafUcO",$ul:false,setFocusAndOrTrack:function(){_p=_o;_o="a37:5065";var c=this;
booking.track.exp(this.e_hash);
if(booking.track.getVariant(c.e_hash)){setTimeout(function(){_p=_o;_o="a37:5066";c.$ul.find(".user_access_email:visible:first").select()
},50)
}},setFocusSignIn:function(){_p=_o;_o="a37:5069";var c=this;
c.$ul.find(".signin_cta").add(".user_access_section_trigger").click(function(){_p=_o;_o="a37:5070";c.setFocusAndOrTrack()
})
},setFocusSignUp:function(){_p=_o;_o="a37:5073";var c=this;
c.$ul.find(".user_center_nav").find(".user_access_signup_menu_tab").click(function(){_p=_o;_o="a37:5074";c.setFocusAndOrTrack()
})
},init:function(){_p=_o;_o="a37:5077";this.$ul=$(".user_center_nav");
this.setFocusSignIn();
this.setFocusSignUp()
},initElse:function(){_p=_o;_o="a37:5079";this.init()
}};
booking[sNSExperiments].user_center_bar={priority:9,init:function(){_p=_o;_o="a37:5081";this.initializeUserCenterBar();
booking.events.emit("user_center_bar:init")
},initializeUserCenterBar:function(){_p=_o;_o="a37:5083";var f=this,c,l,o,g;
var m=[];
...
$(document).on("click",".close_popover",function(){_p=_o;_o="a37:5084";$(".popover_notice").remove()
});
$(document).on("click","#faves_to_wishlist_notice_link",function(){_p=_o;_o="a37:5086";$(".popover_notice").remove();
...
}$(".popover_trigger").click(function(z){_p=_o;_o="a37:5088";var y=$(this),u=y.parent(),t=(y.parent().hasClass("logged_in_user"));
...
$(document).ready(function(){_p=_o;_o="a37:5090";var t=$(".user_center_option");
$("body").mousedown(function(u){_p=_o;_o="a37:5091";if(u&&u.target&&!$(u.target).closest(".user_center_popover").length){$(".user_center_popover").hide();
...
$.ajax({url:t,type:"GET",success:function(w){_p=_o;_o="a37:5095";u.html(w);
h=true;
...
$(document).on("click","#user_form a.remove_hotel",function(){_p=_o;_o="a37:5104";var u=$(this).attr("href").split("#")[1];
var x={hotel_id:u};
...
var w=t.parentNode;
$(t).hide("slow",function(){_p=_o;_o="a37:5105";if($(".hidden_item",w).length){var y=$(".hidden_item",w).get(0);
...
B.when({condition:(B.env.b_action==="index"&&(B.env.b_site_type_id===1||B.env.b_site_type_id===2||B.env.b_site_type_id===3)),events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5241";var c="PVaUYRYNZVC";
...
B.when({condition:B.env.b_site_type_id==1||B.env.b_site_type_id==3,events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5257";var c="PVdIOHHAVCMILFPWcZMO";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5258";var g=d.track(c);
if(g){h.e_tbcc=g
}});
e.on("afterajax",function(f,h){_p=_o;_o="a37:5260";var g=d.track(c);
if(h&&h.theme){d.stage(c,1)
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5263";var c="PAWSUKaVeDdEAZLbMKXe";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5264";var j=d.track("PVdIYROdVaC");
if(j===0){var g=d.track(c);
if(g){h.e_arabic=g
}}});
e.on("afterajax",function(f,j){_p=_o;_o="a37:5266";var h=d.track("PVdIYROdVaC");
if(h===0){var g=d.track(c);
if(g&&j&&j.__deb__&&(j.__deb__.s&32)==32){d.stage(c,1)
}}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5269";var c="PAcbdQNZCYEIUDeTTEC";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5270";var g=d.track(c);
if(g){h.e_themes_spellcheck=1
}});
e.on("afterajax",function(f,g){_p=_o;_o="a37:5272";if(g&&g.__theme_suggester_called__){d.stage(c,1);
d.stage(c,2)
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5275";var c="PAcbdQNZCYEIUDBCeXUFeXe";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5276";var g=d.track(c);
if(g){h.e_themes_stemming=g
}});
e.on("afterajax",function(f,g){_p=_o;_o="a37:5278";if(g&&g.__theme_deb__&&(g.__theme_deb__.s&8)==8){d.stage(c,1);
d.stage(c,2)
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5281";var c="PAcbdQNZCYEIUJUSOMcaT";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5282";var g=d.track(c);
if(g){h.e_themes_msm_1=1
}});
e.on("afterajax",function(f,g){_p=_o;_o="a37:5284";if(g&&g.__theme_msm__){d.stage(c,1);
d.stage(c,2)
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5287";var c="PAUPQPJJFRbZNHT";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5288";var g=d.track(c);
if(g){h.e_drz=g
}});
e.on("afterajax",function(f,g){_p=_o;_o="a37:5290";if(g&&g.__dynamic_result_size_flag__){d.stage(c,1)
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(f,g){_p=_o;_o="a37:5293";var e="PVdIOHHANVADeMNEHT";
var d=B.env.b_action;
var c=B.env.b_site_type;
g.on("afterajax",function(h,j){_p=_o;_o="a37:5294";if(c=="www"&&j){if(d.match(/destinationfinder|destinations|index|country|region/)){f.stage(e,1)
...
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5297";var c="PVUDWVYZaXe";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5298";var g=d.track(c);
if(g){h.e_random=g
}})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5301";var c="PVdIOHHANAPAFVRZaPJGEXe";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5302";var g=d.track(c);
if(g){h.e_tclm=1
}d.stage(c,1)
})
});
B.when({events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){_p=_o;_o="a37:5305";var c="PVEQHARKEEZaORe";
e.on("beforeajax",function(f,h){_p=_o;_o="a37:5306";var g=d.track(c);
if(g){h.e_noise_if_no_results=g
}});
e.on("afterajax",function(f,g){_p=_o;_o="a37:5308";if(g&&g.__fallback_query__){d.stage(c,1);
d.stage(c,2)
}})
});
