...
;var Lf={"consent.google.com":!0,"consent.youtube.com":!0,"consent-daily-0.sandbox.youtube.com":!0,"consent-daily-1.sandbox.youtube.com":!0,"consent-daily-2.sandbox.youtube.com":!0,"consent-daily-3.sandbox.youtube.com":!0,"consent-daily-4.sandbox.youtube.com":!0,"consent-daily-5.sandbox.youtube.com":!0,"consent-daily-6.sandbox.youtube.com":!0,"consent-autopush.sandbox.youtube.com":!0};var Mf="StopIteration"in m?m.StopIteration:{message:"StopIteration",stack:""};function Nf(){}
...
function ug(a){a.c||(a.c=new Rf,a.f=0,a.j&&Af(a.j,function(b,c){vg(a,ta(b),c)}))}
...
a.A=b}
g.extend=function(a){for(var b=0;b<arguments.length;b++)Yf(arguments[b],function(a,b){vg(this,b,a)},this)};var yg=F("Firefox"),zg=Lb(),Ag=F("Safari")&&!(Lb()||F("Coast")||F("Opera")||F("Edge")||F("Silk")||F("Android"))&&!(F("iPhone")&&!F("iPod")&&!F("iPad")||F("iPad")||F("iPod"));var Bg={},Cg=0,Dg=t("yt.net.ping.workerUrl_")||null;q("yt.net.ping.workerUrl_",Dg,void 0);function Eg(a){try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||a&&Fg(a,void 0)}catch(b){a&&Fg(a,void 0)}}
...
function Ig(a,b){var c=a.split("#",2);a=c[0];var c=1<c.length?"#"+c[1]:"",d=a.split("?",2);a=d[0];var d=Gg(d[1]||""),e;for(e in b)d[e]=b[e];return Ef(a,d)+c}
function Jg(a){a=wf(a);a=null===a?null:a.split(".").reverse();return(null===a?!1:"com"==a[0]&&a[1].match(/^youtube(?:-nocookie)?$/)?!0:!1)||(null===a?!1:"google"==a[1]?!0:"google"==a[2]?"au"==a[0]&&"com"==a[1]?!0:"uk"==a[0]&&"co"==a[1]?!0:!1:!1)}
;function Kg(a,b){var c="/gen_204?"+a;c&&Fg(c,b)}
;function Lg(a,b){(a=R(a))&&a.style&&(Le(a,b),pb(a,"hid",!b))}
function Mg(a){return(a=R(a))?!("none"==a.style.display||C(a,"hid")):!1}
function Ng(a){if(a=R(a))Mg(a)?(Le(a,!1),D(a,"hid")):(Le(a,!0),E(a,"hid"))}
...
Math.min(l.top+l.height,r.top+r.height);K<=r&&(l.left=n,l.top=K,l.width=x-n,l.height=r-K)}}n=Dd(a);K=Dd(c);if(n.c!=K.c){x=n.c.body;var K=Pd(K.c),r=new ed(0,0),P;P=(P=Fd(x))?Pd(P):window;if(ve(P,"parent")){var W=x;do{var ga=P==K?Ee(W):Fe(W);r.x+=ga.x;r.y+=ga.y}while(P&&P!=K&&P!=P.parent&&(W=P.frameElement)&&(P=P.parent))}x=fd(r,Ee(x));!Q||wd(9)||Md(n.c)||(x=fd(x,Nd(n.c)));l.left+=x.x;l.top+=x.y}a=Sg(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new ed(b,l.top+(a&1?l.height:0));b=fd(b,k);e&&(b.x+=
...
function Sg(a,b){return(b&8&&Me(a)?b^4:b)&-9}
;function Tg(a,b){return Yb(b,null)}
;function Ug(){}
;function Vg(a){var b=window.location;a=Ef(a,{})+"";a=a instanceof Ob?a:Sb(a);b.href=Qb(a)}
function Wg(a){(window.ytspf||{}).enabled?spf.navigate(a):Vg(a)}
function Xg(a,b,c){var d=I("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=I("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=wf(window.location.href);e&&d.push(e);e=wf(a);if(Va(d,e)||!e&&0==a.lastIndexOf("/",0))if(d=yf(a),d=zf(d)){var e=I("ST_BASE36",!0),f;f=I("ST_SHORT",!0)?"ST-":"s_tempdata-";d=f=e?f+Ja(d).toString(36):f+Ja(d);e=b?Df(b):"";Jf(d,e,5,"/");b&&(b=b.itct||b.ved,d=t("yt.logging.screenreporter.storeParentElement"),b&&d&&d(new Ug))}}if(c)return!1;Wg(a);return!0}
...
;var jh={},kh="ontouchstart"in document;function lh(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return oe(c,function(a){return C(a,b)},d)}
function mh(a){var b="mouseover"==a.type&&"mouseenter"in jh||"mouseout"==a.type&&"mouseleave"in jh,c=a.type in jh||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=jh[b],d;for(d in c.ra){var e=lh(b,d,a.target);e&&!oe(a.relatedTarget,function(a){return a==e})&&c.F(d,e,b,a)}}if(b=jh[a.type])for(d in b.ra)(e=lh(a.type,d,a.target))&&b.F(d,e,a.type,a)}}
...
g=nh.prototype;g.Ha=function(a){return pe(a,U(this))};
function U(a,b){return"yt-uix"+(a.j?"-"+a.j:"")+(b?"-"+b:"")}
g.unregister=function(){Nc(this.l);this.l.length=0;ih(this.C);this.C.length=0};
...
A(qh,nh);ca(qh);g=qh.prototype;g.register=function(){oh(this,"click",this.Jc);oh(this,"keydown",this.Wc);oh(this,"keypress",this.Xc);this.l.push(M("page-scroll",this.ee,this))};
g.unregister=function(){ph(this,"click",this.Jc);ph(this,"keydown",this.Wc);ph(this,"keypress",this.Xc);rh(this);this.f={};qh.H.unregister.call(this)};
g.Jc=function(a){if(a&&!a.disabled){sh(this,a);if(th(this,a)){var b=th(this,a),c=pe(b.activeButtonNode||b.parentNode,U(this));c&&c!=a?(uh(this,c),J(v(this.Md,this,a),1)):Mg(b)?uh(this,a):this.Md(a);a.focus()}this.pb(a,"button-action")}};
g.Wc=function(a,b,c){if(!(c.altKey||c.ctrlKey||c.shiftKey)&&(b=th(this,a))){var d=function(a){var b="";a.tagName&&(b=a.tagName.toLowerCase());return"ul"==b||"table"==b},e;
d(b)?e=b:e=he(b,d);if(e){e=e.tagName.toLowerCase();var f;"ul"==e?f=this.pe:"table"==e&&(f=this.oe);f&&vh(this,a,b,c,v(f,this))}}};
g.ee=function(){var a=this.f;if(0!=ub(a))for(var b in a){var c=a[b],d=pe(c.activeButtonNode||c.parentNode,U(this));if(void 0==d||void 0==c)break;wh(this,d,c,!0)}};
function vh(a,b,c,d,e){var f=Mg(c),h=9==d.keyCode;h||32==d.keyCode||13==d.keyCode?(d=xh(a,c))?(b=Zd(d),"a"==b.tagName.toLowerCase()?Vg(b.href):qf(b)):h&&uh(a,b):f?27==d.keyCode?(xh(a,c),uh(a,b)):e(b,c,d):(a=C(b,U(a,"reverse"))?38:40,d.keyCode==a&&(qf(b),d.preventDefault()))}
g.Xc=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||(a=th(this,a),Mg(a)&&c.preventDefault())};
...
g.oe=function(a,b,c){var d=xh(this,b);b=bf("table",null,b);var e=bf("tr",null,b),e=Id("td",null,e).length;b=Id("td",null,b);d=zh(d,b,e,c);-1!=d&&(yh(this,a,b[d]),c.preventDefault())};
g.pe=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=xh(this,b);b=Oa(Id("li",null,b),Mg);d=zh(d,b,1,c);yh(this,a,b[d]);c.preventDefault()}};
...
function wh(a,b,c,d){var e=pe(b,U(a,"group")),f=!!a.M(b,"button-menu-ignore-group"),e=e&&!f?e:b,f=9,h=8,k=Ke(b);if(C(b,U(a,"reverse"))){f=8;h=9;k=k.top+"px";try{c.style.maxHeight=k}catch(r){}}C(b,"flip")&&(C(b,U(a,"reverse"))?(f=12,h=13):(f=13,h=12));var l;a.M(b,"button-has-sibling-menu")?l=Ce(e):a.M(b,"button-menu-root-container")&&(l=Bh(a,b));Q&&!vd("8")&&(l=null);var n;l&&(n=Ke(l),n=new se(-n.top,n.left,n.top,-n.left));l=new ed(0,1);C(b,U(a,"center-menu"))&&(l.x-=Math.round((Ie(c).width-Ie(b).width)/
2));d&&(l.y+=Nd(document).y);if(a=Ah(a,b))b=Ie(c),a.style.width=b.width+"px",a.style.height=b.height+"px",Rg(e,f,a,h,l,n,197),d&&we(a,"position","fixed");Rg(e,f,c,h,l,n,197)}
function Bh(a,b){if(a.M(b,"button-menu-root-container")){var c=a.M(b,"button-menu-root-container");return pe(b,c)}return document.body}
g.Md=function(a){if(a){var b=th(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.M(a,"button-has-sibling-menu")?c=a.parentNode:c=Bh(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=Ah(this,a);d&&c.appendChild(d);(c=!!this.M(a,"button-menu-fixed"))&&(this.f[Ye(a).toString()]=b);wh(this,a,b,c);Oc("yt-uix-button-menu-before-show",a,b);Og(b);d&&Og(d);
this.pb(a,"button-menu-action",!0);D(a,U(this,"active"));b=v(this.Ld,this,a,!1);d=v(this.Ld,this,a,!0);c=v(this.vf,this,a,void 0);this.c&&th(this,this.c)==th(this,a)||rh(this);O("yt-uix-button-menu-show",a);mf(this.A);this.A=[T(document,"click",d),T(document,"contextmenu",b),T(window,"resize",c)];this.c=a}}};
function uh(a,b){if(b){var c=th(a,b);if(c){a.c=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");Pg(c);a.pb(b,"button-menu-action",!1);var d=Ah(a,b),e=Ye(c).toString();delete a.f[e];J(function(){d&&d.parentNode&&(Pg(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=pe(b,U(a,"group")),f=[U(a,"active")];
e&&f.push(U(a,"group-active"));ob(b,f);O("yt-uix-button-menu-hide",b);mf(a.A);a.A.length=0}}
g.vf=function(a,b){var c=th(this,a);if(c){b&&(b instanceof Ub?c.innerHTML=Wb(b):ge(c,b));var d=!!this.M(a,"button-menu-fixed");wh(this,a,c,d)}};
g.Ld=function(a,b,c){c=pf(c);var d=pe(c,U(this));if(d){var d=th(this,d),e=th(this,a);if(d==e)return}var d=pe(c,U(this,"menu")),e=d==th(this,a),f=C(c,U(this,"menu-item")),h=C(c,U(this,"menu-close"));if(!d||e&&(f||h))uh(this,a),d&&b&&this.M(a,"button-menu-indicate-selected")&&((a=S(U(this,"content"),a))&&ge(a,le(c)),Ch(this,d,c))};
function Ch(a,b,c){var d=U(a,"menu-item-selected");a=Hd(d,b);B(a,function(a){E(a,d)});
D(c.parentNode,d)}
...
function sh(a,b){if(a.M(b,"button-toggle")){var c=pe(b,U(a,"group")),d=U(a,"toggled"),e=C(b,d);if(c&&a.M(c,"button-toggle-group")){var f=a.M(c,"button-toggle-group"),c=Hd(U(a),c);B(c,function(a){a!=b||"optional"==f&&e?(E(a,d),a.removeAttribute("aria-pressed")):(D(b,d),a.setAttribute("aria-pressed","true"))})}else e?b.removeAttribute("aria-pressed"):b.setAttribute("aria-pressed","true"),qb(b,d)}}
...
function Fh(a,b,c){var d=c||b,e=U(a,"card");c=Ih(a,d);var f=R(U(a,"card")+Ye(d));if(f)return a=S(U(a,"card-body"),f),fe(a,c)||(Wd(c),a.appendChild(c)),f;f=document.createElement("div");f.id=U(a,"card")+Ye(d);f.className=e;(d=a.M(d,"card-class"))&&nb(f,d.split(/\s+/));d=document.createElement("div");d.className=U(a,"card-border");b=a.M(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var h=document.createElement("div");
...
e&&(e=6,d?K.y+=12-b.offsetHeight/2:K.x+=12-b.offsetWidth/2);var W=null;f||(W=10);P=U(a,"card-flip");a=U(a,"card-reverse");pb(c,P,l);pb(c,a,k);W=Rg(b,r,c,n,K,null,W);!f&&W&&(W&48&&(l=!l,r^=4,n^=4),W&192&&(k=!k,r^=1,n^=1),pb(c,P,l),pb(c,a,k),Rg(b,r,c,n,K));h&&(b=parseInt(c.style.top,10),f=Nd(document).y,we(c,"position","fixed"),we(c,"top",b-f+"px"));x&&(c.style.right="",b=Ke(c),b.left=b.left||parseInt(c.style.left,10),f=Ld(window),c.style.left="",c.style.right=f.width-b.left-b.width+"px");b=S("yt-uix-card-body-arrow",
...
g.ha=function(a){if(a=this.Ha(a)){var b=R(U(this,"card")+Ye(a));b&&(E(a,U(this,"active")),E(b,U(this,"card-visible")),Pg(b),this.A=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Wd(b.cardMask),b.cardMask=null))}};
function Eh(a){a.A&&a.ha(a.A)}
g.Cd=function(a,b){var c=this.Ha(a);if(c){if(b){var d=Ih(this,c);if(!d)return;b instanceof Ub?d.innerHTML=Wb(b):ge(d,b)}C(c,U(this,"active"))&&(c=Fh(this,a,c),Gh(this,a,c),Og(c),Hh(c))}};
...
A(Jh,Dh);ca(Jh);g=Jh.prototype;g.register=function(){Jh.H.register.call(this);oh(this,"click",this.Lc,"target");oh(this,"click",this.Kc,"close")};
g.unregister=function(){Jh.H.unregister.call(this);ph(this,"click",this.Lc,"target");ph(this,"click",this.Kc,"close");for(var a in this.c)mf(this.c[a]);this.c={};for(a in this.f)mf(this.f[a]);this.f={}};
...
g.nb=function(a){Jh.H.nb.call(this,a);var b=this.Ha(a);if(!G(b,"click-outside-persists")){var c=la(a);if(this.c[c])return;var b=T(document,"click",v(this.Mc,this,a)),d=T(window,"blur",v(this.Mc,this,a));this.c[c]=[b,d]}a=T(window,"resize",v(this.Cd,this,a,void 0));this.f[c]=a};
g.ha=function(a){Jh.H.ha.call(this,a);a=la(a);var b=this.c[a];b&&(mf(b),this.c[a]=null);if(b=this.f[a])mf(b),this.f[a]=null};
g.Mc=function(a,b){pe(b.target,"yt-uix"+(this.j?"-"+this.j:"")+"-card")||this.ha(a)};
g.Kc=function(a){(a=pe(a,U(this,"card")))&&(a=a.cardTargetNode)&&this.ha(a)};function Kh(){Dh.call(this,"hovercard")}
A(Kh,Dh);ca(Kh);g=Kh.prototype;g.register=function(){oh(this,"mouseenter",this.Zc,"target");oh(this,"mouseleave",this.ad,"target");oh(this,"mouseenter",this.$c,"card");oh(this,"mouseleave",this.bd,"card")};
g.unregister=function(){ph(this,"mouseenter",this.Zc,"target");ph(this,"mouseleave",this.ad,"target");ph(this,"mouseenter",this.$c,"card");ph(this,"mouseleave",this.bd,"card")};
g.Zc=function(a){if(Lh!=a){Lh&&(this.ha(Lh),Lh=null);var b=v(this.nb,this,a),c=parseInt(this.M(a,"delay-show"),10),b=J(b,-1<c?c:200);ac(a,"card-timer",b.toString());Lh=a;a.alt&&(ac(a,"card-alt",a.alt),a.alt="");a.title&&(ac(a,"card-title",a.title),a.title="")}};
...
g.ke=function(a){this.Ha(a).isCardHidable&&(this.ha(a),Lh=null)};
g.$c=function(a){a&&(a.cardRootNode.isCardHidable=!1)};
g.bd=function(a){a&&this.ha(a.cardTargetNode)};
var Lh=null;function Mh(a,b,c,d){this.c=a;this.C=null;this.j=S("yt-dialog-fg",this.c)||this.c;if(a=S("yt-dialog-title",this.j)){var e="yt-dialog-title-"+la(this.j);a.setAttribute("id",e);this.j.setAttribute("aria-labelledby",e)}this.j.setAttribute("tabindex","-1");this.R=S("yt-dialog-focus-trap",this.c);this.K=!1;this.A=new H;this.D=[];this.D.push(nf(this.c,"click",v(this.ze,this),"yt-dialog-dismiss"));this.D.push(T(this.R,"focus",v(this.Td,this),!0));Nh(this);this.sa=b;this.O=c;this.L=d;this.B=this.l=null}
var Oh={LOADING:"loading",Nf:"content",Vf:"working"};function Nh(a){a=S("yt-dialog-fg-content",a.c);var b=[];sb(Oh,function(a){b.push("yt-dialog-show-"+a)});
ob(a,b);D(a,"yt-dialog-show-content")}
function Ph(){var a=Hd("yt-dialog");return Ra(a,function(a){return Mg(a)})}
g=Mh.prototype;g.ie=function(){ef(this.c)};
function Qh(a){var b=Id("iframe",null,a.c);B(b,function(a){var b=G(a,"onload");b&&(b=t(b))&&T(a,"load",b);if(b=G(a,"src"))a.src=b},a);
return db(b)}
function Rh(a){B(document.getElementsByTagName("iframe"),function(b){-1==Ma(a,b)&&D(b,"iframe-hid")})}
function Sh(){var a=Hd("iframe-hid");B(a,function(a){E(a,"iframe-hid")})}
g.ze=function(a){a=a.currentTarget;a.disabled||(a=G(a,"action")||"",Th(this,a))};
function Th(a,b){if(!a.isDisposed()){a.A.F("pre-all");a.A.F("pre-"+b);Pg(a.c);Eh(Jh.getInstance());Eh(Kh.getInstance());a.j.setAttribute("tabindex","-1");Ph()||(Pg(a.f),E(document.body,"yt-dialog-active"),ff(),Sh());a.l&&(mf(a.l),a.l=null);a.B&&(mf(a.B),a.B=null);var c=a.c;if(c){var d=G(c,"player-ready-pubsub-key");d&&(Nc(d),cc(c,"player-ready-pubsub-key"))}a.A.F("post-all");O("yt-ui-dialog-hide-complete",a);"cancel"==b&&O("yt-ui-dialog-cancelled",a);a.A&&a.A.F("post-"+b);a.C&&a.C.focus()}}
g.setTitle=function(a){ge(S("yt-dialog-title",this.c),a)};
g.ne=function(a){J(v(function(){this.sa||27!=a.keyCode||Th(this,"cancel")},this),0);
9==a.keyCode&&a.shiftKey&&C(document.activeElement,"yt-dialog-fg")&&a.preventDefault()};
g.af=function(a){"yt-dialog-base"==a.target.className&&Th(this,"cancel")};
g.uc=function(a){var b=M("player-added",this.ie,this);ac(a,"player-ready-pubsub-key",b)};
g.isDisposed=function(){return this.K};
g.dispose=function(){Mg(this.c)&&Th(this,"dispose");mf(this.D);this.D.length=0;J(v(function(){this.C=null},this),0);
this.R=this.j=null;this.A.dispose();this.A=null;this.K=!0};
g.Td=function(a){a.stopPropagation();Uh(this)};
...
;function fi(){var a;if(a=If.get("PREF",void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(gi[d]=c.toString())}}}
...
function mi(){var a;a=[];for(var b in gi)a.push(b+"="+escape(gi[b]));a=a.join("&");Jf("PREF",a,63072E3,"/")}
...
function qi(a){return nd?!oi(a,11,2):md?!oi(a,11,3):!pi(a)}
;function ri(a,b,c){if(b){a=u(a)?Gd(a):a;var d=Eb(c.attrs);d.tabindex=0;var e=Eb(c.params);e.flashvars=Df(c.args);if(Fc){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=b;b=document.createElement("object");for(var f in d)b.setAttribute(f,d[f]);for(f in e)d=document.createElement("param"),d.setAttribute("name",f),d.setAttribute("value",e[f]),b.appendChild(d)}else{d.type="application/x-shockwave-flash";d.src=b;b=document.createElement("embed");b.setAttribute("name",d.id);for(f in d)b.setAttribute(f,
...
function vi(a,b,c){0==c.c&&b.fallback?b.fallback():0==c.c&&b.fallbackMessage?b.fallbackMessage():a.innerHTML='<div id="flash-upgrade">'+Cc("FLASH_UPGRADE",void 0,'You need to upgrade your Adobe Flash Player to watchthis video. <br> <a href="http://get.adobe.com/flashplayer/">Download it from Adobe.</a>')+"</div>"}
...
A(Di,sc);function Ei(a,b,c,d){d=zc(v(d,a.f));b.addEventListener(c,d);a.c.push({target:b,name:c,Dc:d})}
Di.prototype.Tb=function(a){for(var b=0;b<this.c.length;b++)if(this.c[b]==a){this.c.splice(b,1);a.target.removeEventListener(a.name,a.Dc);break}};
function Fi(a){for(;a.c.length;){var b=a.c.pop();b.target.removeEventListener(b.name,b.Dc)}}
Di.prototype.J=function(){Fi(this);Di.H.J.call(this)};function Gi(a){Zg.call(this,1,arguments)}
A(Gi,Zg);var Hi=new bh("timing-sent",Gi);function Ii(a){var b=a||window;if(!(b.performance&&b.performance.timing&&b.performance.getEntriesByType))return{Sb:0,Dd:0};a=Ld(b||window);for(var c=[],d=b.document.getElementsByTagName("*"),e=0,f=d.length;e<f;e++){var h=d[e];if("IMG"==h.tagName||"IFRAME"==h.tagName){var k=Ji(h,h.src,a);if(k){if("IFRAME"==h.tagName){var l;try{l=Ii(h.contentWindow).Sb}catch(n){l=0}0<l&&(k.timing=l)}c.push(k)}}(k=b.getComputedStyle(h)["background-image"])&&(k=Ki.exec(k))&&1<k.length&&(k=Ji(h,k[1],a))&&c.push(k)}l=b.performance.getEntriesByType("resource");
h=b.performance.getEntriesByType("mark");d={};e=0;for(f=l.length;e<f;e++)k=l[e],d[k.name]=k.responseEnd;e=0;for(f=h.length;e<f;e++)k=h[e],"mark_iframe_loaded: "==k.name.slice(0,20)&&(d[k.name.slice(20)]=k.startTime);e=0;for(f=c.length;e<f;e++)h=c[e],h.timing||(h.timing=d[h.url]||0);b=Li(b,l);a=Mi(b,a,c);h=c=0;if(a.length)for(d=l=0,e=a.length;d<e;d++)f=a[d],h=f.timing-h,0<h&&1>l&&(c+=(1-l)*h),h=f.timing,l=f.progress;return{Sb:Math.round(c||b),Dd:h}}
...
;var aj={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function bj(a,b){sc.call(this);this.l=this.A=a;this.X=b;this.D=!1;this.api={};this.la=this.T=null;this.$=new H;tc(this,w(uc,this.$));this.j={};this.B=this.Ba=this.f=this.Zb=this.c=null;this.ta=!1;this.K=this.C=this.O=this.S=null;this.Ma={};this.Od=["onReady"];this.fa=new Di(this);tc(this,w(uc,this.fa));this.$b=null;this.yc=NaN;this.ga={};cj(this);this.Da("onDetailedError",v(this.Je,this));this.Da("onTabOrderChange",v(this.Pd,this));this.Da("onTabAnnounce",v(this.zc,this));this.Da("WATCH_LATER_VIDEO_ADDED",
v(this.Ke,this));this.Da("WATCH_LATER_VIDEO_REMOVED",v(this.Le,this));yg||(this.Da("onMouseWheelCapture",v(this.Fe,this)),this.Da("onMouseWheelRelease",v(this.Ge,this)));this.Da("onAdAnnounce",v(this.zc,this));this.L=new Di(this);tc(this,w(uc,this.L));this.Yb=!1;this.Va=null}
A(bj,sc);var dj=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=bj.prototype;g.getId=function(){return this.X};
g.xc=function(a,b){this.isDisposed()||(ej(this,a),fj(this,b),this.D&&gj(this))};
function ej(a,b){a.Zb=b;a.c=b.clone();a.f=a.c.attrs.id||a.f;"video-player"==a.f&&(a.f=a.X,a.c.attrs.id=a.X);a.l.id==a.f&&(a.f+="-player",a.c.attrs.id=a.f);a.c.args.enablejsapi="1";a.c.args.playerapiid=a.X;a.Ba||(a.Ba=hj(a,a.c.args.jsapicallback||"onYouTubePlayerReady"));a.c.args.jsapicallback=null;var c=a.c.attrs.width;c&&(a.l.style.width=He(Number(c)||c,!0));if(c=a.c.attrs.height)a.l.style.height=He(Number(c)||c,!0)}
...
a.c.disable.html5=!d;d||(a.c.args.html5_unavailable="1")}c=!!a.c.disable.html5}b=c?ij(a)?"flash":"unsupported":"html5"}("flash"==b?a.wf:"html5"==b?a.xf:a.yf).call(a)}}
function lj(a){var b=!0,c=kj(a);c&&a.c&&(a=a.c,b=G(c,"version")==a.assets.js);return b&&!!t("yt.player.Application.create")}
g.xf=function(){if(!this.ta){var a=lj(this);a&&"html5"==mj(this)?(this.B="html5",this.D||this.gb()):(nj(this),this.B="html5",a&&this.O?(this.A.appendChild(this.O),this.gb()):(this.c.loaded=!0,this.S=v(function(){var a=this.A,c=this.c.clone();t("yt.player.Application.create")(a,c);this.gb()},this),this.ta=!0,a?this.S():(Rc(this.c.assets.js,this.S),Zc(this.c.assets.css))))}};
g.wf=function(){var a=this.c.clone();if(!this.C){var b=kj(this);b&&(this.C=document.createElement("span"),this.C.tabIndex=0,Ei(this.fa,this.C,"focus",this.fd),this.K=document.createElement("span"),this.K.tabIndex=0,Ei(this.fa,this.K,"focus",this.fd),b.parentNode&&b.parentNode.insertBefore(this.C,b),b.parentNode&&b.parentNode.insertBefore(this.K,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==mj(this))this.B="flash",this.D||si(a,!1,v(this.gb,this));
else{nj(this);this.B="flash";this.c.loaded=!0;b=this.A;b=u(b)?Gd(b):b;a=Zh(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=ni.getInstance();oi(c,a.minVersion)?(c=ti(a,c),ri(b,c,a)):vi(b,a,c);this.gb()}};
g.fd=function(){kj(this).focus()};
...
function oj(a,b,c){var d=b[c];return function(){try{return a.$b=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.$b=e,Bc(e,"WARNING"))}}}
function cj(a){a.D=!1;if(a.la)for(var b in a.j)a.la(b,a.j[b]);for(var c in a.ga)L(parseInt(c,10));a.ga={};a.T=null;a.la=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=v(a.Da,a);a.api.removeEventListener=v(a.jf,a);a.api.destroy=v(a.dispose,a);a.api.getLastError=v(a.Wd,a);a.api.getPlayerType=v(a.Xd,a);a.api.getCurrentVideoConfig=v(a.Vd,a);a.api.loadNewVideoConfig=v(a.xc,a);a.api.isReady=v(a.Jf,a)}
g.Jf=function(){return this.D};
g.Da=function(a,b){if(!this.isDisposed()){var c=hj(this,b);if(c){if(!Va(this.Od,a)&&!this.j[a]){var d=pj(this,a);this.T&&this.T(a,d)}this.$.subscribe(a,c);"onReady"==a&&this.D&&J(w(c,this.api),0)}}};
g.jf=function(a,b){if(!this.isDisposed()){var c=hj(this,b);c&&this.$.unsubscribe(a,c)}};
...
g.Je=function(a){jj(this,a)};
g.Ke=function(a){O("WATCH_LATER_VIDEO_ADDED",a)};
g.Le=function(a){O("WATCH_LATER_VIDEO_REMOVED",a)};
g.Fe=function(){this.Yb||(zg?(this.Va=Nd(document),Ei(this.L,window,"scroll",this.Ze),Ei(this.L,this.A,"touchmove",this.Ue)):(Ei(this.L,this.A,"mousewheel",this.gd),Ei(this.L,this.A,"wheel",this.gd)),this.Yb=!0)};
g.Ge=function(){Fi(this.L);this.Yb=!1};
...
n.navigationStart&&0<x&&(r.stcp_=x);x=n.responseStart-n.requestStart;0<x&&(r.req_=x);x=n.responseEnd-n.responseStart;0<x&&(r.rcv_=x);Pi.getEntriesByType&&Xi(d);(n=I("SPEEDINDEX_FOR_ACTIONS",void 0))&&-1<n.indexOf(h)&&(n=Ec(),h=Ii(),r=Ec(),0<h.Sb&&(e.si=h.Sb,d.vsc=Wi(h.Dd),d.sics=n,d.sice=r));n=[];if(document.querySelector&&Pi&&Pi.getEntriesByName){var h={'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'script[name="scheduler/scheduler"]':"sj",'script[name="desktop_polymer/desktop_polymer"]':"dpj",
'link[rel="import"][name="desktop_polymer"]':"dph"},P;for(P in h)if(r=document.querySelector(P))x="",K=r.nodeName,"SCRIPT"==K?x=r.src:"LINK"==K&&(x=r.href),x&&(r=Pi.getEntriesByName(x))&&r[0]&&n.push(h[P]+"."+Math.round(r[0].duration))}n.length&&(e.rs=n.join(","))}h=Vi();P=h.pbr;n=h.vc;h=h.pbs;P&&n&&h&&P<n&&n<h&&1==$i().info.yt_vis&&"youtube"==f&&($i().info.yt_lt="hot_bg",P=d.vc,f=d.pbs,delete d.aft,c.aft=Math.round(f-P));(P=I("PREVIOUS_ACTION"))&&(e.pa=P);e.p=I("CLIENT_PROTOCOL")||"unknown";e.t=
...
y,void 0)):Yi(b);y=new Gi(W.aft+(l||0));(ga=hh())&&ga.publish.call(ga,Hi.toString(),Hi,y)}}a.cancel();cj(a);a.B=null;a.c&&(a.c.loaded=!1);y=kj(a);"html5"==mj(a)?a.O=y:y&&y.destroy&&y.destroy();Ud(a.A);Fi(a.fa);a.C=null;a.K=null}
g.cancel=function(){this.S&&Yc(this.c.assets.js,this.S);L(this.yc);this.ta=!1};
g.J=function(){nj(this);if(this.O&&this.c)try{this.O.destroy()}catch(b){Bc(b)}this.Ma=null;for(var a in this.j)m[this.j[a]]=null;this.Zb=this.c=this.api=null;delete this.A;delete this.l;bj.H.J.call(this)};var qj={},rj="player_uid_"+(1E9*Math.random()>>>0);function sj(a,b){a=u(a)?Gd(a):a;b=Zh(b);var c=rj+"_"+la(a),d=qj[c];if(d)return d.xc(b),d.api;d=new bj(a,c);qj[c]=d;O("player-added",d.api);tc(d,w(tj,d));J(function(){d.xc(b)},0);
return d.api}
...
;var vj=t("yt.abuse.botguardInitialized")||$h;q("yt.abuse.botguardInitialized",vj,void 0);var xj=t("yt.abuse.invokeBotguard")||ai;q("yt.abuse.invokeBotguard",xj,void 0);var yj=t("yt.abuse.dclkstatus.checkDclkStatus")||bi;q("yt.abuse.dclkstatus.checkDclkStatus",yj,void 0);var zj=t("yt.player.exports.navigate")||Xg;q("yt.player.exports.navigate",zj,void 0);var Aj=t("yt.player.embed")||sj;q("yt.player.embed",Aj,void 0);var Bj=t("yt.player.getPlayerByElement")||uj;q("yt.player.getPlayerByElement",Bj,void 0);
...
;var N={},Jj=null;N.nc=!1;N.init=function(){var a=R("yt-consent");nf(a,"click",N.ge,"consent-close");nf(a,"click",N.he,"consent-review");T(window,"message",N.hf);I("CONSENT_SHOW_DIALOG")&&(a=R("yt-consent-dialog-content"),N.uc(a),N.zd(),Kg(Df({a:"consent",consent:"forced"})),nf(a,"click",N.ae,"yt-dialog-dismiss"))};
N.ge=function(){E(document.body,"sitewide-consent-visible");Jf("HideTicker","true",86400,"/");Kg(Df({a:"consent",consent:"later"}))};
N.he=function(){N.zd();Kg(Df({a:"consent",consent:"review"}))};
N.ae=function(a){a=a.currentTarget;a.disabled||(a=G(a,"action")||"",Th(Mh.prototype,a),Kg(Df({a:"consent",consent:"dismiss"})),N.zb())};
N.zd=function(){var a=R("yt-consent-dialog");if(a){var b=!!I("CONSENT_SHOW_DIALOG");Jj=new Mh(a,b,!b);N.mc();N.pf();a=Jj;if(!a.isDisposed()){a.C=document.activeElement;if(!a.L){a.f||(a.f=R("yt-dialog-bg"),a.f||(a.f=document.createElement("div"),a.f.id="yt-dialog-bg",a.f.className="yt-dialog-bg",document.body.appendChild(a.f)));a:{var c=window,d=c.document,b=0;if(d){var b=d.body,e=d.documentElement;if(!e||!b){b=0;break a}c=Ld(c).height;if(Md(d)&&e.scrollHeight)b=e.scrollHeight!=c?e.scrollHeight:e.offsetHeight;
else{var d=e.scrollHeight,f=e.offsetHeight;e.clientHeight!=f&&(d=b.scrollHeight,f=b.offsetHeight);b=d>c?d>f?d:f:d<f?d:f}}}a.f.style.height=b+"px";Og(a.f)}ef(a.c);b=Qh(a);Rh(b);a.l=T(document,"keydown",v(a.ne,a));a.uc(a.c);a.O&&(a.B=T(document,"click",v(a.af,a)));Og(a.c);a.j.setAttribute("tabindex","0");Uh(a);D(document.body,"yt-dialog-active");rh(qh.getInstance());Eh(Jh.getInstance());Eh(Kh.getInstance())}}};
N.mc=function(){try{var a=Hj();a&&(a.isReady()?(1==a.getPlayerState(a.getPresentingPlayerType())&&(N.nc=!0),a.pauseVideo()):a.addEventListener("onReady",N.mc))}catch(b){Bc(b)}};
N.zb=function(){try{var a=Hj();a&&a.isReady()&&N.nc&&(ff(),a.playVideo(),N.nc=!1)}catch(b){Bc(b)}};
N.uc=function(a){var b=M("player-added",N.mc,N);ac(a,"player-ready-pubsub-key",b)};
N.pf=function(){Mc()};
N.hf=function(a){var b=a&&a.data,c=a&&a.origin;a=a&&a.source;var d=!1,e=wf(c);if(Lf[e]&&Lf.hasOwnProperty(e)||String(I("EXPERIMENT_FLAGS",{}).consent_url_override||"")){switch(b){case "cb-user-closed":Jj.dispose();N.zb();break;case "cb-ui-done-early":Th(Jj,"close");N.zb();d=!0;break;case "cb-ui-done":case "cb-already-consented":Th(Jj,"close");N.zb();d=!0;break;case "verify-origin":a.parent==window&&a.postMessage("verify-origin-reply",c)}d&&(E(document.body,"sitewide-consent-visible"),Kg(Df({a:"consent",
...
function Zj(a,b){b=b||{};var c;c||(c=window.location.href);var d=a.match(vf)[1]||null,e=wf(a);d&&e?(d=c,c=a.match(vf),d=d.match(vf),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?wf(c)==e&&(Number(c.match(vf)[4]||null)||null)==(Number(a.match(vf)[4]||null)||null):!0;for(var f in ak){if((e=d=I(ak[f]))&&!(e=c)){var e=f,h=I("CORS_HEADER_WHITELIST")||{},k=wf(a);e=k?(h=h[k])?Va(h,e):!1:!0}e&&(b[f]=d)}return b}
function bk(a,b){var c=I("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.Zf&&(!wf(a)||b.withCredentials||wf(a)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.qa&&b.qa[c])}
function ck(a,b){var c=b.format||"JSON";b.ag&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=I("XSRF_FIELD_NAME",void 0),e=I("XSRF_TOKEN",void 0),f=b.Ta;f&&(f[d]&&delete f[d],a=Ig(a,f||{}));var h=b.ff||"",f=b.qa;bk(a,b)&&(f||(f={}),f[d]=e);f&&u(h)&&(d=Gg(h),Hb(d,f),h=Df(d));var k=!1,l,n=Yj(a,function(a){if(!k){k=!0;l&&L(l);var d;a:switch(a&&"status"in a?a.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:d=
...
return d}
function gk(a){if(ka(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);c?a[b]=Tg(Nb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax"),a[b]):gk(a[b])}}
...
function Pl(a,b){var c;c=qh.getInstance();c=S(U(c,"content"),a.D);ge(c,sa(le(b)));c=S("is-selected",a.T);E(c,"is-selected");D(b,"is-selected");c=G(b,"privacy-state");ac(a.D,"privacy-state",c)}
...
g.Ee=function(a){a.preventDefault();a=this.S;var b={context:this,Z:this.Be,onError:this.Ae};b.method=a.method.toUpperCase();if("POST"==b.method){var c;c=[];Kj(a,c,Nj);c=c.join("&");b.ff=c}else{var d=new Rf;Kj(a,d,Mj);Sf(d);c={};for(var e=0;e<d.c.length;e++){var f=d.c[e];c[f]=d.f[f]}d=b.Ta||{};Hb(d,c);b.Ta=d}ck(a.action,b);Ql(this,!1)};
...
g.De=function(){Ol(this);this.K&&ia(this.K.Lb)&&this.K.Lb()};function Rl(a){Zg.call(this,1,arguments);this.c=a}
A(Rl,Zg);function Sl(a,b,c){Zg.call(this,1,arguments);this.c=c}
A(Sl,Zg);var Tl=new bh("subscription-subscribe-success",Sl),Ul=new bh("subscription-unsubscribe-success",Rl);var Vl,Wl,Xl={Sf:"content-snap-width-1",Tf:"content-snap-width-2",Uf:"content-snap-width-3"};function Yl(){var a=[],b;for(b in Xl)a.push(Xl[b]);return a}
...
function xm(a){var b=S("guide-sort-button"),c=G(b,"guide-sort")||"",d=G(a.currentTarget,"guide-sort")||"";c!=d&&(ac(b,"guide-sort",d),ck("/guide_channels_ajax?action_set_guide_sort=1",{method:"POST",Ta:{sort:d},format:"JSON",Z:function(a,b){Cm(b);var c=Hd("guide-sort-choice");B(c,function(a){var b=G(a,"guide-sort");qh.getInstance();a=a.parentNode;var b=d==b,c=bf("span","yt-uix-button-icon-wrapper",a);if(!c&&b){var e=Qd("span",{"class":"yt-uix-button-icon-wrapper yt-uix-button-icon-checkbox"}),f=Qd("div",
{"class":"yt-uix-button-icon-dropdown-checked"});e.appendChild(f);Vd(a,e,0)}Lg(c,b)})}}))}
...
g.Qd=function(){6E5<ei()?Mn(this.f,!1):Mn(this.f,!0)};var Rn="";function Sn(){var a=R("yt-masthead-doodle-first-frame"),b=R("logo-container"),c=I("YOODLE_IMG_SRC"),d=new Image;d.src=c;c=Qd("img",{id:"logo","class":"logo doodle",usemap:"#doodle",src:c,style:I("YOODLE_EXTRA_ATTRS")});Vd(b,c,0);d.onload=function(){Wd(a)}}
...
function Un(){if("U"==I("CREATOR_CONTEXT","U")){var a=Hd("yt-masthead-account-picker-user-option"),b=yf(window.location.href);B(a,function(a){if(-1!=a.href.indexOf("action_handle_signin")){var c;c=Ig(a.href,{next:b});$b(a,yf(c))}})}else{var a=Hd("yt-masthead-account-picker-owner-option"),c=xf();
if(c){var d=c.indexOf(";");-1!=d&&(c=c.substring(0,d))}c&&B(a,function(a){var b=Hg(a.href).next;b&&(b=zf(b)+(c?"#"+c:""),b=Ig(a.href,{next:b}),$b(a,yf(b)))})}}
...
mo.push(M("init",a));mo.push(M("dispose",no));oo=Yl();fi.getInstance();po(ki(0,128)?ki(0,129):!0);qo=Id("html",void 0,void 0)[0];mo.push(M("masthead-ticker-close",ro));mo.push(M("appbar-guide-delay-load",ho));mo.push(M("page-resize",so));eo||lo()}}
...
function yo(){if(!to||Ao)Lg($n,!0);else{var a=Ie(to).height,b=Ie(ao).height,b=Ge(ao).y+b,a=Math.floor(Ge(to).y)+a,c=C(document.body,"appbar-hidden"),d=Od(document);c&&a<b+40?(d.scrollTop+=40,Lg($n,!0),E(document.body,"appbar-hidden"),Bo()):!c&&b<a&&(d.scrollTop-=40,D(document.body,"appbar-hidden"),Bo())}}
...
var Mo=[],uo="",mo=[],xo=0,Fo=0,Po=!1,Lo=!1,Ho=0,Io=0,Jo=0,jo=null,to=null,oo=null,Co=!1,qo=null;function Qo(a){this.c=new Rf;a&&Ro(this,a)}
...
function Ro(a,b){for(var c=Wf(b),d=c.length,e=0;e<d;e++){var f=c[e];a.c.set(So(f),f)}}
...
g.contains=function(a){a=So(a);return Tf(this.c.f,a)};
g.aa=function(){return this.c.aa()};
g.clone=function(){return new Qo(this)};
g.equals=function(a){return this.Y()==Vf(a)&&To(this,a)};
function To(a,b){var c=Vf(b);if(a.Y()>c)return!1;!(b instanceof Qo)&&5<c&&(b=new Qo(b));return Zf(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.qb&&"function"==typeof c.qb?c.qb(a):fa(c)||u(c)?Va(c,a):wb(c,a)})}
...
function np(a,b,c){a.jb=1;a.Na=qg(b.clone());a.ab=c;a.B=!0;op(a,null)}
function pp(a,b,c,d,e){a.jb=1;a.Na=qg(b.clone());a.ab=null;a.B=c;e&&(a.yd=!1);op(a,d)}
function op(a,b){a.yb=z();qp(a);a.Sa=a.Na.clone();og(a.Sa,"t",a.C);a.Bb=0;a.W=a.c.cc(a.c.Ab()?b:null);0<a.hc&&(a.Pb=new cp(v(a.Ed,a,a.W),a.hc));a.A.Ka(a.W,"readystatechange",a.gf);var c=a.Za?Eb(a.Za):{};a.ab?(a.Wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.W.send(a.Sa,a.Wb,a.ab,c)):(a.Wb="GET",a.yd&&!ld&&(c.Connection="close"),a.W.send(a.Sa,a.Wb,null,c));a.c.va(1)}
...
function Ap(a,b){a.yb=z();qp(a);var c=b?window.location.hostname:"";a.Sa=a.Na.clone();ng(a.Sa,"DOMAIN",c);ng(a.Sa,"t",a.C);try{a.xa=new ActiveXObject("htmlfile")}catch(n){up(a);a.$a=7;xp();yp(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var h=c.charAt(f);if("<"==h)e+="\\x3c";else if(">"==h)e+="\\x3e";else{if(h in Ga)h=Ga[h];else if(h in Fa)h=Ga[h]=Fa[h];else{var k=h,l=h.charCodeAt(0);if(31<l&&127>l)k=h;else{if(256>l){if(k="\\x",16>l||256<l)k+="0"}else k="\\u",4096>l&&(k+=
"0");k+=l.toString(16).toUpperCase()}h=Ga[h]=k}e+=h}}d+='<script>document.domain="'+e+'"\x3c/script>'}d+="</body></html>";c=Tg(Nb("b/12014412"),d);a.xa.open();a.xa.write(Wb(c));a.xa.close();a.xa.parentWindow.m=v(a.Xe,a);a.xa.parentWindow.d=v(a.pd,a,!0);a.xa.parentWindow.rpcClose=v(a.pd,a,!1);c=a.xa.createElement("DIV");a.xa.parentWindow.document.body.appendChild(c);d=Sb(a.Sa.toString());d=ua(Qb(d));d=Tg(Nb("b/12014412"),'<iframe src="'+d+'"></iframe>');c.innerHTML=Wb(d);a.c.va(1)}
...
g=Hp.prototype;g.fc=null;g.ka=null;g.Qb=!1;g.Bd=null;g.Eb=null;g.jc=null;g.gc=null;g.oa=null;g.Ja=-1;g.tb=null;g.ob=null;g.connect=function(a){this.gc=a;a=Ip(this.c,null,this.gc);xp();this.Bd=z();var b=this.c.D;null!=b?(this.tb=b[0],(this.ob=b[1])?(this.oa=1,Jp(this)):(this.oa=2,Kp(this))):(og(a,"MODE","init"),this.ka=new kp(this,0,void 0,void 0,void 0),this.ka.Za=this.fc,pp(this.ka,a,!1,null,!0),this.oa=0)};
function Jp(a){var b=Ip(a.c,a.ob,"/mail/images/cleardot.gif");qg(b);Ep(b.toString(),5E3,v(a.Rd,a),3,2E3);a.va(1)}
g.Rd=function(a){if(a)this.oa=2,Kp(this);else{xp();var b=this.c;b.ua=b.Oa.Ja;Lp(b,9)}a&&this.va(2)};
function Kp(a){var b=a.c.R;if(null!=b)xp(),b?(xp(),Mp(a.c,a,!1)):(xp(),Mp(a.c,a,!0));else if(a.ka=new kp(a,0,void 0,void 0,void 0),a.ka.Za=a.fc,b=a.c,b=Ip(b,b.Ab()?a.tb:null,a.gc),xp(),!Q||wd(10))og(b,"TYPE","xmlhttp"),pp(a.ka,b,!1,a.tb,!1);else{og(b,"TYPE","html");var c=a.ka;a=!!a.tb;c.jb=3;c.Na=qg(b.clone());Ap(c,a)}}
...
g.va=function(a){this.c.va(a)};function Np(a){Kk.call(this);this.headers=new Rf;this.T=a||null;this.f=!1;this.S=this.c=null;this.fa=this.K="";this.l=0;this.B="";this.A=this.$=this.D=this.X=!1;this.C=0;this.L=null;this.ga="";this.O=this.la=!1}
...
function dq(a){eq(a);if(3==a.c){var b=a.vb++,c=a.Fb.clone();ng(c,"SID",a.j);ng(c,"RID",b);ng(c,"TYPE","terminate");fq(a,c);b=new kp(a,0,a.j,b,void 0);b.jb=2;b.Na=qg(c.clone());(new Image).src=b.Na;b.yb=z();qp(b)}gq(a)}
...
function kq(a,b){if(1==a.c){if(!b){a.vb=Math.floor(1E5*Math.random());var c=a.vb++,d=new kp(a,0,"",c,void 0);d.Za=null;var e=lq(a),f=a.Fb.clone();ng(f,"RID",c);a.C&&ng(f,"CVER",a.C);fq(a,f);np(d,f,e);a.da=d;a.c=2}}else 3==a.c&&(b?mq(a,b):0!=a.f.length&&(a.da||mq(a)))}
function mq(a,b){var c,d;b?6<a.Xa?(a.f=a.A.concat(a.f),a.A.length=0,c=a.vb-1,d=lq(a)):(c=b.D,d=b.ab):(c=a.vb++,d=lq(a));var e=a.Fb.clone();ng(e,"SID",a.j);ng(e,"RID",c);ng(e,"AID",a.eb);fq(a,e);c=new kp(a,0,a.j,c,a.sb+1);c.Za=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.da=c;np(c,e,d)}
function fq(a,b){if(a.ca){var c=a.ca.Oc(a);c&&sb(c,function(a,c){ng(b,c,a)})}}
function lq(a){var b=Math.min(a.f.length,1E3),c=["count="+b],d;6<a.Xa&&0<b?(d=a.f[0].c,c.push("ofs="+d)):d=0;for(var e=0;e<b;e++){var f=a.f[e].c,h=a.f[e].map,f=6>=a.Xa?e:f-d;try{Yf(h,function(a,b){c.push("req"+f+"_"+b+"="+encodeURIComponent(a))})}catch(k){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.A=a.A.concat(a.f.splice(0,b));
return c.join("&")}
...
g.md=function(){this.Ea=null;this.U=new kp(this,0,this.j,"rpc",this.B);this.U.Za=null;this.U.hc=0;var a=this.Cc.clone();ng(a,"RID","rpc");ng(a,"SID",this.j);ng(a,"CI",this.Vb?"0":"1");ng(a,"AID",this.eb);fq(this,a);if(!Q||wd(10))ng(a,"TYPE","xmlhttp"),pp(this.U,a,!0,this.Hb,!1);else{ng(a,"TYPE","html");var b=this.U,c=!!this.Hb;b.jb=3;b.Na=qg(a.clone());Ap(b,c)}};
...
function Lp(a,b){if(2==b||9==b){var c=null;a.ca&&(c=null);var d=v(a.qf,a);c||(c=new $f("//www.google.com/images/cleardot.gif"),qg(c));Fp(c.toString(),1E4,d)}else xp();qq(a,b)}
...
function Ip(a,b,c){var d=rg(c);if(""!=d.f)b&&bg(d,b+"."+d.f),cg(d,d.C);else var e=window.location,d=sg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.rb&&sb(a.rb,function(a,b){ng(d,b,a)});
ng(d,"VER",a.Xa);fq(a,d);return d}
...
;function cr(a){this.A=this.j="";this.c="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(a.match(vf)[4]||null)||null||"";b&&(this.A=":"+b);this.j=wf(a)||"";a=Ib;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ha(a,"10.0")&&(this.f=!1))}
function dr(a,b,c,d){var e=a.c;if(p(d)?d:a.f)e="https://"+a.j+a.A+a.c;return Ef(e+b,c||{})}
...
function ps(a){var b={};b.pairingCode=a.O;if(a.l){var c=a.l.index||0,d=a.l.currentTime||0;b.v=a.l.videoId||a.l.videoIds[c];b.t=d}Or()&&(b.env_useStageMdx=1);return Df(b)}
...
var Js=null;function As(){var a;a=0<=Ib.search(/\ (CrMo|Chrome|CriOS)\//);return zg||a}
...
var tu=[];function Ku(a){Tk.call(this);this.L={Mb:a.Mb,Lb:v(function(){Jh.getInstance().ha(this.za());ia(a.Lb)&&a.Lb()},this)};
this.l=this.A=null}
...
Ku.prototype.D=function(a){fe(this.A,pf(a))||Jh.getInstance().ha(this.za())};
Ku.prototype.K=function(a){a==this.za()&&Pk(this.l,"title-input").focus()};function Lu(){nh.call(this,"scroller");this.c={}}
A(Lu,nh);ca(Lu);g=Lu.prototype;g.register=function(){oh(this,"mouseenter",this.cd);oh(this,"mouseleave",this.Kb)};
g.unregister=function(){ph(this,"mouseenter",this.cd);ph(this,"mouseleave",this.Kb);for(var a in this.c)this.Kb(this.c[a]);this.c={};Lu.H.unregister.call(this)};
...
function Sv(){var a=!1;if(!V||!Mg(Mu)||!I("PAGE_NAME"))return Tv(),a;var b=Uv(),c=Vv();Wv()&&c&&b!=c&&(Xv(c),b=c);c=!!I("LIST_ID");if(b=Wv()&&!!b&&(b==I("VIDEO_ID")||b==Pu)&&!c){var d=R("player-playlist");d&&!Rv()&&(E(Mu,"mole-notification"),Vd(d,ee,0),O("watch-queue-show",1),Yv(),a=!0)}else de()!=Mu&&(Mu.appendChild(ee),O("watch-queue-show",0),uv(),a=!0);d=R("placeholder-playlist");b||c?Og(d):Pg(d);Tv();return a}
function Xv(a){if(Nu){var b=!!V,c=b&&!(a&&(a==I("VIDEO_ID")||a==Pu));Ij(c);b&&Wv()&&(c?O("watch-queue-show",0):O("watch-queue-show",1));if(Nu.isReady())Nu.loadVideoById(a);else{var d=function(){Nu.loadVideoById(a);Nu.removeEventListener("onReady",d)};
...
function Tv(){Nu&&(Uv()?Ou||Ij(!!V&&(Mg(Mu)||cw())&&de()==Mu):Ij(!1))}
function Hv(){E(Mu,"mole-notification");Pu="";Fj();Sv();var a=Nu;a&&a.addEventListener("onStateChange",Zv)}
...
function xv(a){if(a.currentTarget==Wu){if(cw()){var b=Yd(Z);a=fw();b=b.length;a=(b+a-1)%b;gw(a);Yv();(b=$v())&&V&&V.sd(b,a)}}else if(a.currentTarget==Xu)cw()&&(a=Yd(Z),a=(fw()+1)%a.length,gw(a),Yv(),(b=$v())&&V&&V.Fd(b,a));else if(a.currentTarget==Yu)Pg(Yu),Og(Zu),V?(a=tv(),!Vv()&&a[0]?kt(V,a[0]):V.play()):Nu&&Nu.playVideo();else if(a.currentTarget==Zu)Pg(Zu),Og(Yu),V?V.pause():Nu&&Nu.pauseVideo();else if(C(a.currentTarget,"remove-item-watch-queue-button")){if(a=ne(a.currentTarget,null,"watch-queue-item"),
b=G(a,"video-id"))D(a,"fade-out"),cv(b)}else C(a.currentTarget,"expand-video-watch-queue-button")&&hw(a.currentTarget)}
function Dv(a){var b=G(a.currentTarget,"action");iw[b](a.currentTarget);a=a||window.event;a.cancelBubble=!0;a.stopPropagation&&a.stopPropagation();uh(qh.getInstance(),Vu)}
...
function Av(){E(Mu,"mole-notification");C(Mu,"mole-expanded")&&uv();uh(qh.getInstance(),Vu)}
...
function Fv(a){var b=a.cf,c=a.df;b&&c&&(a={V:tv().join(","),Ud:b,Z:function(){Wg(c)}},Ml(a))}
...
function Mv(){Mg(Mu)&&D(Mu,"mole-notification")}
function ow(){var a=ew()?fw()+1:0,b=tv().length;0<a&&0<b?Uu.innerHTML=Ru.render({count:a,total:b}):Ud(Uu)}
function bw(a){a?(Pg(Yu),Og(Zu)):(Pg(Zu),Og(Yu))}
function nw(){var a=tv().length,b=1>=a,c=ew()?fw():-1;Wu.disabled=b||0==c;Xu.disabled=b||c==a-1;ow();if(0!=a){var d=null,a=Yd(Z);B(a,function(a){var b=G(a,"video-id"),c=S("play-next",a),k=S("goto-video-page",a);pb(k,"disabled",Wv()&&b==I("VIDEO_ID")&&!I("LIST_ID"));C(a,"currently-playing")?(d=a,Pg(c)):d?(d=null,pb(c,"disabled",!0)):pb(c,"disabled",!1)})}}
...
function vw(){if(!Ou){Ou=!0;var a;$u?(a=Du(),a="RQ"+(a?a.getLoungeToken():"")):a="WQ";ck("/watch_queue_ajax",{method:"GET",Ta:{action_get_watch_queue_items:1,list:a},Z:ww,onError:uw,xb:uw});cw()?qw():(Z.innerHTML=Su.render({}),kw())}}
...
function lw(a){a=Ef("/watch",{v:a});Wg(a)}
function xw(a){Wv()&&(a!=I("VIDEO_ID")||I("LIST_ID")?(J(function(){lw(a)},100),Pu=a):Sv())}
function Jv(a){yw=a}
function Kv(){var a=Gu();uc(V);V=null;rw();Ud(Z);kw();a?(V=a,V.subscribe("proxyStateChange",zw),V.subscribe("remotePlayerChange",Aw),yw=null):pw();2!=yw&&(Fj(),O("watch-queue-remote-connection",!!a))}
function qw(){Og(Mu);if(!Sv()){var a=de()==Mu?0:1;O("watch-queue-show",a)}}
function pw(){de()!=Mu&&Mu.appendChild(ee);var a=R("placeholder-playlist");I("LIST_ID")?Og(a):Pg(a);rb(Mu,"mole-expanded","mole-collapsed");Pg(Mu);Tv();O("watch-queue-hide",0)}
...
"save-as-playlist":function(){if(!Wa(tv())){var a=Qu;Jh.getInstance().nb(a.za())}},
...
function Dw(a,b,c,d,e){c||(Bw&&Bw!=a&&Pg(Bw),Bw=a,e?Og(a):Qg(a));d?S("yt-close",a).focus():(c={},c["action_"+b]=1,c.base_url=window.location.href.split("#",1)[0],ck("/picker_ajax",{format:"JSON",method:"GET",Ta:c,Z:v(Ew,null,a),onError:function(){Pg(a)}}))}
function Ew(a,b,c){if(c&&c.html){ac(a,"loaded",1);a.innerHTML=c.html;Fw(a);c=(b=document.body||Od(document))||Od(document);var d=Ee(a),e=Ee(c),f=Se(c);if(c==Od(document)){var h=d.x-c.scrollLeft,d=d.y-c.scrollTop;Q&&!wd(10)&&(h+=f.left,d+=f.top)}else h=d.x-e.x-f.left,d=d.y-e.y-f.top;var f=c.clientHeight-a.offsetHeight,e=c.scrollLeft,k=c.scrollTop,e=e+Math.min(h,Math.max(h-(c.clientWidth-a.offsetWidth),0)),k=k+Math.min(d,Math.max(d-f,0));c=new ed(e,k);b.scrollLeft=c.x;b.scrollTop=c.y;S("yt-close",a).focus()}else Pg(a)}
...
q("yt.www.masthead.handleAccountPickerClick",function(){var a=R("yt-masthead-multilogin");if(G(a,"loaded"))Un();else{var b=Hn();b[I("XSRF_FIELD_NAME",void 0)]=I("XSRF_TOKEN",void 0);spf.load("/delegate_account_ajax",{method:"POST",postData:Df(b),onDone:function(){ac(a,"loaded","true");Un()}})}},void 0);
q("yt.www.masthead.loadSearchbox",Wn,void 0);q("yt.net.cookies.set",Jf,void 0);q("yt.net.cookies.remove",Kf,void 0);q("yt.www.picker.load",function(a){var b=G(a,"picker-key"),c=G(a,"picker-position"),d="yt-picker-"+b+"-"+c;if(c=R(d))a=G(a,"button-menu-id")==d,d=G(c,"loaded"),Dw(c,b,!!a,!!d)},void 0);
