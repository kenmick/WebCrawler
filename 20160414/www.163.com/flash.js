(function() {
    function i(a, g, h, e, c, f, b) {
        ...
        e && (a = '<div style="position:relative;overflow:hidden;width:' + g + "px;height:" + h + 'px;"><a href="' + e + '" target="' + c + '" style="position:absolute;top:0;left:0;width:100%;height:100%;filter:alpha(opacity=0);opacity:0;background:#fff;"></a>' + 
        a + "</div>");
        return a
    }
