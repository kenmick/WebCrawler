...
function Eb(a){if(a instanceof Cb&&a.constructor===Cb&&a.h===Db)return a.f;da(a);return"type_error:SafeUrl"}
...
function Kb(a){if(a instanceof Ib&&a.constructor===Ib&&a.h===Jb)return a.f;da(a);return"type_error:SafeHtml"}
...
!ia(m.setImmediate)||m.Window&&m.Window.prototype&&!C("Edge")&&m.Window.prototype.setImmediate==m.setImmediate?(Tb||(Tb=Ub()),Tb(a)):m.setImmediate(a)}}
...
function hc(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];fa(d)?hc.apply(null,d):F(d)}}
...
function I(a,b){ia(a)&&(a=nc(a));return window.setTimeout(a,b)}
function oc(a,b){ia(a)&&(a=nc(a));window.setInterval(a,b)}
...
function Hc(a,b){var c=Ic(a),d=document.getElementById(c),e=d&&D(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=yc(c,b),h=""+la(b);Jc[h]=e}f||(d=Kc(a,c,function(){D(d,"loaded")||(Nb(d,"loaded","true"),K(c),I(qa(Dc,c),0))}))}}
...
function Lc(a,b){if(a&&b){var c=""+la(b);(c=Jc[c])&&Ac(c)}}
...
function Tc(a){if(a instanceof Sc)return a;if("function"==typeof a.wa)return a.wa(!1);if(fa(a)){var b=0,c=new Sc;c.next=function(){for(;;){if(b>=a.length)throw Rc;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function Uc(a,b,c){if(fa(a))try{z(a,b,c)}catch(d){if(d!==Rc)throw d;}else{a=Tc(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==Rc)throw d;}}}
function Vc(a){if(fa(a))return Xa(a);a=Tc(a);var b=[];Uc(a,function(a){b.push(a)});
return b}
...
;function $c(a){return a.U&&"function"==typeof a.U?a.U():fa(a)||v(a)?a.length:fb(a)}
function ad(a){if(a.V&&"function"==typeof a.V)return a.V();if(v(a))return a.split("");if(fa(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return jb(a)}
function bd(a){if(a.ra&&"function"==typeof a.ra)return a.ra();if(!a.V||"function"!=typeof a.V){if(fa(a)||v(a)){var b=[];a=a.length;for(var c=0;c<a;c++)b.push(c);return b}return kb(a)}}
function cd(a,b,c){if(a.forEach&&"function"==typeof a.forEach)a.forEach(b,c);else if(fa(a)||v(a))z(a,b,c);else for(var d=bd(a),e=ad(a),f=e.length,h=0;h<f;h++)b.call(c,e[h],d&&d[h],a)}
function dd(a,b){if("function"==typeof a.every)return a.every(b,void 0);if(fa(a)||v(a))return Oa(a,b,void 0);for(var c=bd(a),d=ad(a),e=d.length,f=0;f<e;f++)if(!b.call(void 0,d[f],c&&c[f],a))return!1;return!0}
;function ed(a){this.f=new Wc;if(a){a=ad(a);for(var b=a.length,c=0;c<b;c++){var d=a[c];this.f.set(fd(d),d)}}}
function fd(a){var b=typeof a;return"object"==b&&a||"function"==b?"o"+la(a):b.substr(0,1)+a}
...
function gd(a,b){var c=$c(b);if(a.U()>c)return!1;!(b instanceof ed)&&5<c&&(b=new ed(b));return dd(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.bb&&"function"==typeof c.bb?c.bb(a):fa(c)||v(c)?B(c,a):ib(c,a)})}
g.wa=function(){return this.f.wa(!1)};function hd(){return C("iPhone")&&!C("iPod")&&!C("iPad")}
;var id=C("Opera"),L=C("Trident")||C("MSIE"),jd=C("Edge"),kd=C("Gecko")&&!(-1!=wb.toLowerCase().indexOf("webkit")&&!C("Edge"))&&!(C("Trident")||C("MSIE"))&&!C("Edge"),ld=-1!=wb.toLowerCase().indexOf("webkit")&&!C("Edge"),md=C("Macintosh"),nd=C("Windows");function od(){var a=m.document;return a?a.documentMode:void 0}
...
;function Rd(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=ua(e[0]||""),e=ua(e[1]||"");f in b?ea(b[f])?Ya(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function $d(a,b){var c=b.format||"JSON";b.jf&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=H("XSRF_FIELD_NAME",void 0),e=H("XSRF_TOKEN",void 0),f=b.hc;f&&(f[d]&&delete f[d],a=Sd(a,f||{}));var h=b.kf||"",f=b.T;Zd(a,b)&&(f||(f={}),f[d]=e);f&&v(h)&&(d=Rd(h),vb(d,f),h=Od(d));var k=!1,l,n=Wd(a,function(a){if(!k){k=!0;l&&J(l);var d=Vd(a),e=null;if(d||400<=a.status&&500>a.status)e=ae(c,a,b.gf);if(d)a:{switch(c){case "XML":d=
...
return d}
function de(a){if(ka(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);c?a[b]=Qc(Bb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax"),a[b]):de(a[b])}}
...
g.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};!kd&&!L||L&&wd(9)||kd&&vd("1.9.1");var se=L&&!vd("9");function te(a){return a?new ue(ve(a)):sa||(sa=new ue)}
...
ue.prototype.isElement=function(a){return ka(a)&&1==a.nodeType};
...
;function Xe(){if(null==r("_lact",window)){var a=parseInt(H("LACT"),10),a=isFinite(a)?x()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&Ye();N(document,"keydown",Ye);N(document,"keyup",Ye);N(document,"mousedown",Ye);N(document,"mouseup",Ye);yc("page-mouse",Ye);yc("page-scroll",Ye);yc("page-resize",Ye)}}
...
b&&d&&d(new $e))}}if(c)return!1;(window.ytspf||{}).enabled?spf.navigate(a):(c=window.location,a=Qd(a,{})+"",a=a instanceof Cb?a:Gb(a),c.href=Eb(a));return!0}
...
gf.prototype.clone=function(){var a=new gf,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==da(c)?a[b]=sb(c):a[b]=c}return a};function mf(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
...
;var zf=C("Firefox"),Af=hd()||C("iPod"),Bf=C("iPad"),Cf=C("Android")&&!(zb()||C("Firefox")||C("Opera")||C("Silk")),Df=zb(),Ef=C("Safari")&&!(zb()||C("Coast")||C("Opera")||C("Edge")||C("Silk")||C("Android"))&&!(hd()||C("iPad")||C("iPod"));function Ff(){var a;if(a=df.get("PREF",void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Gf[d]=c.toString())}}}
...
function Mf(a){z(arguments,function(a){!fa(a)||a instanceof Element?Lf(a,!0):z(a,function(a){Mf(a)})})}
function Nf(a){z(arguments,function(a){!fa(a)||a instanceof Element?Lf(a,!1):z(a,function(a){Nf(a)})})}
...
;function Sf(a,b,c){if(b){a=v(a)?xe(a):a;var d=sb(c.attrs);d.tabindex=0;var e=sb(c.params);e.flashvars=Od(c.args);if(sc){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=b;b=document.createElement("object");for(var f in d)b.setAttribute(f,d[f]);for(f in e)d=document.createElement("param"),d.setAttribute("name",f),d.setAttribute("value",e[f]),b.appendChild(d)}else{d.type="application/x-shockwave-flash";d.src=b;b=document.createElement("embed");b.setAttribute("name",d.id);for(f in d)b.setAttribute(f,
...
function Zf(a){var b=$f(a),c=document.getElementById(b),d=c&&D(c,"loaded");d||c&&!d||(c=ag(a,b,function(){D(c,"loaded")||(Nb(c,"loaded","true"),K(b),I(qa(Dc,b),0))}))}
...
function $f(a){var b=document.createElement("a");Mb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ka(a)}
...
y(jg,E);function kg(a,b,c,d){d=nc(w(d,a.h));b.addEventListener(c,d);a.f.push({target:b,name:c,Ob:d})}
...
g.V=function(a){Gg(this);var b=[];if(v(a))Jg(this,a)&&(b=Wa(b,this.f.get(Ig(this,a))));else{a=this.f.V();for(var c=0;c<a.length;c++)b=Wa(b,a[c])}return b};
...
function $g(a){var b=Yg();b&&(ha(a)&&(a=[a]),z(a,function(a){b.unsubscribeByKey(a);delete Vg[a]}))}
...
;var vh={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function wh(a,b){E.call(this);this.o=this.l=a;this.Z=b;this.C=!1;this.api={};this.va=this.S=null;this.ha=new G;gc(this,qa(F,this.ha));this.j={};this.A=this.Ba=this.h=this.Mb=this.f=null;this.qa=!1;this.J=this.B=this.P=this.R=null;this.Pa={};this.qd=["onReady"];this.ta=new jg(this);gc(this,qa(F,this.ta));this.Nb=null;this.nc=NaN;this.ua={};xh(this);this.xa("onDetailedError",w(this.Zd,this));this.xa("onTabOrderChange",w(this.sd,this));this.xa("onTabAnnounce",w(this.oc,this));this.xa("WATCH_LATER_VIDEO_ADDED",
w(this.$d,this));this.xa("WATCH_LATER_VIDEO_REMOVED",w(this.ae,this));zf||(this.xa("onMouseWheelCapture",w(this.Wd,this)),this.xa("onMouseWheelRelease",w(this.Xd,this)));this.xa("onAdAnnounce",w(this.oc,this));this.L=new jg(this);gc(this,qa(F,this.L));this.Lb=!1;this.$a=null}
...
g.Je=function(){if(!this.qa){var a=Gh(this);a&&"html5"==Hh(this)?(this.A="html5",this.C||this.Va()):(Ih(this),this.A="html5",a&&this.P?(this.l.appendChild(this.P),this.Va()):(this.f.loaded=!0,this.R=w(function(){var a=this.l,c=this.f.clone();r("yt.player.Application.create")(a,c);this.Va()},this),this.qa=!0,a?this.R():(Ec(this.f.assets.js,this.R),Xf(this.f.assets.css))))}};
...
a,d))}for(var e in this.j)this.S(e,this.j[e]);Bh(this);this.Ba&&this.Ba(this.api);this.ha.F("onReady",this.api)}else this.nc=I(w(this.Va,this),50)}};
...
g.xa=function(a,b){if(!this.isDisposed()){var c=Ch(this,b);if(c){if(!B(this.qd,a)&&!this.j[a]){var d=Kh(this,a);this.S&&this.S(a,d)}this.ha.subscribe(a,c);"onReady"==a&&this.C&&I(qa(c,this.api),0)}}};
...
b=this.f.f.player_fallback||a;a=we("player-unavailable");if(we("unavailable-submessage")&&a){we("unavailable-submessage").innerHTML=b;var b=a||document,c=null;b.getElementsByClassName?c=b.getElementsByClassName("icon")[0]:b.querySelectorAll&&b.querySelector?c=b.querySelector(".icon"):c=ze("icon",a)[0];if(c=b=c||null)c=b?b.dataset?Ob("icon")in b.dataset:b.hasAttribute?!!b.hasAttribute("data-icon"):!!b.getAttribute("data-icon"):!1;c&&(b.src=D(b,"icon"));a.style.display="";ne(we("player"),"off-screen-trigger")}};
...
g.G=function(){Ih(this);if(this.P&&this.f)try{this.P.destroy()}catch(b){pc(b)}this.Pa=null;for(var a in this.j)m[this.j[a]]=null;this.Mb=this.f=this.api=null;delete this.l;delete this.o;wh.I.G.call(this)};var Lh={},Mh="player_uid_"+(1E9*Math.random()>>>0);function Nh(a,b){a=v(a)?xe(a):a;b=lf(b);var c=Mh+"_"+la(a),d=Lh[c];if(d)return d.jc(b),d.api;d=new wh(a,c);Lh[c]=d;K("player-added",d.api);gc(d,qa(Oh,d));I(function(){d.jc(b)},0);
return d.api}
function Oh(a){Lh[a.Z]=null}
function Ph(a){a=we(a);if(!a)return null;var b=Mh+"_"+la(a),c=Lh[b];c||(c=new wh(a,b),Lh[b]=c);return c.api}
...
function Bi(a,b,c){var d=T(a,void 0),e=w(c,a);b in vi||(vi[b]=new G);vi[b].subscribe(d,e);a.j[c]=e}
function Ci(a,b,c){if(b in vi){var d=vi[b];d.unsubscribe(T(a,void 0),a.j[c]);0>=d.U()&&(d.dispose(),delete vi[b])}delete a.j[c]}
function Di(a,b){Nb(a,"tooltip-text",b)}
...
g.wb=function(a){if(!(this.f&&1E3>x()-this.f)){var b=parseInt(D(a,"tooltip-hide-timer"),10);b&&(Pb(a,"tooltip-hide-timer"),J(b));var b=w(function(){Fi(this,a);Pb(a,"tooltip-show-timer")},this),c=parseInt(D(a,"tooltip-show-delay"),10)||0,b=I(b,c);
Nb(a,"tooltip-show-timer",b.toString());a.title&&(Di(a,Gi(a)),a.title="");b=la(a).toString();this.h[b]=a}};
g.Na=function(a){var b=parseInt(D(a,"tooltip-show-timer"),10);b&&(J(b),Pb(a,"tooltip-show-timer"));b=w(function(){if(a){var b=we(Hi(this,a));b&&(Ii(b),b&&b.parentNode&&b.parentNode.removeChild(b),Pb(a,"content-id"));(b=we(Hi(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Pb(a,"tooltip-hide-timer")},this);
b=I(b,50);Nb(a,"tooltip-hide-timer",b.toString());if(b=D(a,"tooltip-text"))a.title=b;b=la(a).toString();delete this.h[b]};
...
k=wf(c,"paddingRight");n=wf(c,"paddingTop");var u=wf(c,"paddingBottom"),l=new mf(n,k,u,l)}else l=pf(c,"paddingLeft"),k=pf(c,"paddingRight"),n=pf(c,"paddingTop"),u=pf(c,"paddingBottom"),l=new mf(parseFloat(n),parseFloat(k),parseFloat(u),parseFloat(l));if(L&&!wd(9)){k=yf(c,"borderLeft");n=yf(c,"borderRight");var u=yf(c,"borderTop"),ca=yf(c,"borderBottom"),k=new mf(u,n,ca,k)}else k=pf(c,"borderLeftWidth"),n=pf(c,"borderRightWidth"),u=pf(c,"borderTopWidth"),ca=pf(c,"borderBottomWidth"),k=new mf(parseFloat(u),
parseFloat(n),parseFloat(ca),parseFloat(k));f.pixelWidth=h.width-k.left-l.left-l.right-k.right;f.pixelHeight=h.height-k.top-l.top-l.bottom-k.bottom}else f.pixelWidth=h.width,f.pixelHeight=h.height;f=Ae(window);1==c.nodeType?(c=rf(c),k=new qe(c.left,c.top)):(c=c.changedTouches?c.changedTouches[0]:c,k=new qe(c.clientX,c.clientY));c=tf(d);n=Math.floor(c.width/2);h=!!(f.height<k.y+a.height);a=!!(k.y<a.height);l=!!(k.x<n);f=!!(f.width<k.x+n);k=(c.width+3)/-2- -5;b=D(b,"force-tooltip-direction");if("left"==
...
g.Vc=function(a,b,c){b?(Nb(a,Ni.lc,"true"),c&&Nb(a,Ni.mc,c)):(Pb(a,Ni.lc),Pb(a,Ni.mc));Pi(a)};
...
g.wd=function(a){var b=!!D(a,"ypc-item-type"),c=!!D(a,"ypc-item-id");!D(a,"ypc-enabled")&&b&&c&&(ne(a,"ypc-enabled"),Nb(a,Ni.pd,"true"))};
g.vd=function(a){D(a,"ypc-enabled")&&(oe(a,"ypc-enabled"),Pb(a,"ypc-enabled"))};
...
function Oi(a,b){var c=w(function(a){a.discoverable_subscriptions&&lc("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.Qb(b)},a);
ti(c,"subscribe")}
...
;function U(a,b,c){var d=c&&0<c?c:0;c=d?x()+1E3*d:0;if((d=d?hj:ij)&&window.JSON){v(b)||(b=JSON.stringify(b,void 0));try{d.set(a,b,c)}catch(e){d.remove(a)}}}
...
function pj(a,b,c){if(ka(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function qj(a,b,c,d){if(ka(a)&&!ea(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};v(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
function rj(a){var b=a.video_id||a.videoId;if(v(b)){var c=jj("yt-player-two-stage-token")||{},d=jj("yt-player-two-stage-token")||{};p(void 0)?d[b]=void 0:delete d[b];U("yt-player-two-stage-token",d,300);(b=c[b])&&(a.two_stage_token=b)}}
...
function ak(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,ca:qa(a.A,d,!0),onError:qa(a.o,e),kb:qa(a.B,e)};c&&(a.T=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return $d(b,a)}
...
g.Qc=function(){this.h=NaN;this.f=$d(Zj(this.C,"/pairing/get_screen"),{method:"POST",T:{pairing_code:this.B},timeout:5E3,ca:w(this.Ne,this),onError:w(this.Me,this),kb:w(this.Oe,this)})};
...
g.Oe=function(){this.f=null;this.F("pairingFailed",Error("Server not responding"))};function uk(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";new ed;a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",new ed(Ma((a.capabilities||"").split(","),qa(gb,Xj))))}
...
g.ec=function(){J(this.j);this.j=NaN;this.h&&this.h.abort();var a=Zk(this);if(fb(a)){var b=Zj(this.B,"/pairing/get_screen_availability"),c={lounge_token:kb(a).join(",")};this.h=ak(this.B,b,c,w(this.ge,this,a),w(this.fe,this))}else Vk(this,{}),Yk(this)};
...
y(W,nk);g=W.prototype;g.Za=function(){this.j.Za();var a=this.h,b;b=parseInt(jj("yt-remote-fast-check-period")||"0",10);b=x()-144E5<b?0:b;a.o=b;a.o?Yk(a):(a.o=x()+3E5,U("yt-remote-fast-check-period",a.o),a.ec());this.f.length&&(this.F("screenChange"),this.h.isEmpty()||this.F("onlineScreenChange"))};
...
g.Qe=function(a,b,c,d){$d(Zj(this.B,"/pairing/get_screen"),{method:"POST",T:{pairing_code:a},timeout:5E3,ca:w(function(a,d){var h=new Oj(d.screen||{});if(!h.name||dl(this,h.name))h.name=this.Ac(h.name,b);c(bl(this,h))},this),
...
g.Re=function(a){this.isDisposed()||a||(hl(this,"Cast session died."),this.aa())};function nl(a,b){gl.call(this,a,b,"DialSession");this.A=this.J=null;this.P="";this.o=null;this.C=t;this.B=NaN;this.R=w(this.Ue,this);this.f=t}
...
ql.prototype.G=function(){J(this.f);this.f=NaN;ql.I.G.call(this)};function rl(a){V.call(this);this.h=a;this.f=null;this.A=!1;this.j=[];this.o=w(this.de,this)}
...
function im(a){Yl();var b=gm(a),c=Vl();c&&b&&b.f?(Tl("Stopping cast activity"),c.stopActivity(b.f,qa(hm,a))):Tl("Dropping cast activity stop")}
...
var Mm="__closure_events_fn_"+(1E9*Math.random()>>>0);function Dm(a){if(ia(a))return a;a[Mm]||(a[Mm]=function(b){return a.handleEvent(b)});
return a[Mm]}
...
function Om(a,b){var c,d=a.qa;if(d){c=[];for(var e=1;d;d=d.qa)c.push(d),++e}var d=a.Ba,e=b,f=e.type||e;if(v(e))e=new mm(e,d);else if(e instanceof mm)e.target=e.target||d;else{var h=e,e=new mm(f,d);vb(e,h)}var h=!0,k;if(c)for(var l=c.length-1;!e.f&&0<=l;l--)k=e.currentTarget=c[l],h=Pm(k,f,!0,e)&&h;e.f||(k=e.currentTarget=d,h=Pm(k,f,!0,e)&&h,e.f||(h=Pm(k,f,!1,e)&&h));if(c)for(l=0;!e.f&&l<c.length;l++)k=e.currentTarget=c[l],h=Pm(k,f,!1,e)&&h}
...
Rm.prototype.then=function(a,b,c){return Xm(this,ia(a)?a:null,ia(b)?b:null,c)};
...
function Sm(a,b,c){if(0==a.f){a==c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;var d;a:{var e=c,f=a.K,h=a.J;if(e instanceof Rm)bn(e,Vm(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ka(e))try{var l=e.then;if(ia(l)){dn(e,l,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.B=c,a.f=b,a.j=null,cn(a),3!=b||c instanceof Ym||en(a,c))}}
...
var gn=Sb;function Ym(a){ra.call(this,a)}
y(Ym,ra);Ym.prototype.name="cancel";function hn(a,b){Nm.call(this);this.f=a||1;this.h=b||m;this.l=w(this.Ge,this);this.o=x()}
...
function kn(a,b,c){if(ia(a))c&&(a=w(a,c));else if(a&&"function"==typeof a.handleEvent)a=w(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:m.setTimeout(a,b||0)}
...
y(nn,E);var on=[];g=nn.prototype;g.vb=function(a,b,c,d){ea(b)||(b&&(on[0]=b.toString()),b=on);for(var e=0;e<b.length;e++){var f=Cm(a,b[e],c||this.handleEvent,d||!1,this.h||this);if(!f)break;this.f[f.key]=f}return this};
g.Gb=function(a,b,c,d,e){if(ea(b))for(var f=0;f<b.length;f++)this.Gb(a,b[f],c,d,e);else c=c||this.handleEvent,e=e||this.h||this,c=Dm(c),d=!!d,b=a&&a[qm]?ym(a.j,String(b),c,d,e):a?(a=Em(a))?ym(a,b,c,d,e):null:null,b&&(Jm(b),delete this.f[b.key]);return this};
...
g.pe=function(){this.Ya=null;var a=x();0<=a-this.ic?(2!=this.Xa&&this.f.la(3),Fn(this),this.Ma=2,X(),In(this)):Mn(this,this.ic-a)};
...
function Tn(a){var b=Sn(a.f,a.ab,"/mail/images/cleardot.gif");Cg(b);On(b.toString(),5E3,w(a.ud,a),3,2E3);a.la(1)}
...
g.Jc=function(a,b){this.Aa=a.ib;if(0==this.fa)if(b){try{var c=this.h.parse(b)}catch(d){c=this.f;c.ia=this.Aa;Vn(c,2);return}this.gb=c[0];this.ab=c[1]}else c=this.f,c.ia=this.Aa,Vn(c,2);else if(2==this.fa)if(this.Cb)X(),this.bc=x();else if("11111"==b){if(X(),this.Cb=!0,this.rb=x(),c=this.rb-this.Wc,!L||wd(10)||500>c)this.Aa=200,this.da.cancel(),X(),Wn(this.f,this,!0)}else X(),this.rb=this.bc=x(),this.Cb=!1};
...
g.send=function(a,b,c,d){if(this.f)throw Error("[goog.net.XhrIo] Object is active with another request="+this.J+"; newUri="+a);b=b?b.toUpperCase():"GET";this.J=a;this.A="";this.o=0;this.ta=b;this.Z=!1;this.h=!0;this.f=this.S?un(this.S):un(sn);this.R=this.S?qn(this.S):qn(sn);this.f.onreadystatechange=w(this.Ic,this);try{km($n(this,"Opening Xhr")),this.ha=!0,this.f.open(b,String(a),!0),this.ha=!1}catch(f){km($n(this,"Error opening Xhr: "+f.message));ao(this,f);return}a=c||"";var e=this.headers.clone();
...
function eo(a){return L&&vd(9)&&ha(a.timeout)&&p(a.ontimeout)}
...
function co(a){a.f&&a.P&&(a.f.ontimeout=null);ha(a.L)&&(m.clearTimeout(a.L),a.L=null)}
...
function oo(a){po(a);if(3==a.f){var b=a.jb++,c=a.sb.clone();O(c,"SID",a.j);O(c,"RID",b);O(c,"TYPE","terminate");qo(a,c);b=new vn(a,0,a.j,b,void 0);b.Xa=2;b.Ca=Cg(c.clone());(new Image).src=b.Ca;b.lb=x();Bn(b)}ro(a)}
...
g.Jc=function(a,b){if(0!=this.f&&(this.M==a||this.Y==a))if(this.ia=a.ib,this.Y==a&&3==this.f)if(7<this.Ja){var c;try{c=this.o.parse(b)}catch(f){c=null}if(ea(c)&&3==c.length)if(0==c[0])a:{if(!this.ya){if(this.M)if(this.M.lb+3E3<this.Y.lb)so(this),this.M.cancel(),this.M=null;else break a;zo(this);X()}}else this.Dc=c[1],0<this.Dc-this.Ta&&37500>c[2]&&this.Ib&&0==this.Ra&&!this.Ka&&(this.Ka=Ln(w(this.Nd,this),6E3));else Vn(this,11)}else"y2f%"!=b&&Vn(this,11);else if(this.M==a&&so(this),!/^[\s\xa0]*$/.test(b)){c=
...
function Vn(a,b){if(2==b||9==b){var c=null;a.W&&(c=null);var d=w(a.Fe,a);c||(c=new mg("//www.google.com/images/cleardot.gif"),Cg(c));Pn(c.toString(),1E4,d)}else X();Bo(a,b)}
...
function Ln(a,b){if(!ia(a))throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){a()},b)}
...
g.tc=function(){};
g.Pb=function(){};
g.yc=function(){return{}};function Do(a,b){hn.call(this);this.A=0;if(ia(a))b&&(a=w(a,b));else if(a&&ia(a.handleEvent))a=w(a.handleEvent,a);else throw Error("Invalid listener argument");this.C=a;Cm(this,"tick",w(this.B,this));Eo(this)}
...
function Oo(a,b){Ko(a,"setVideoId");var c=a.index;a.index=La(a.h,b);c!=a.index&&Lo(a)}
function Po(a,b,c){Ko(a,"setPlaylist");c=c||Mo(a);ab(a.h,b)&&c==Mo(a)||(a.h=Xa(b),Oo(a,c))}
Jo.prototype.remove=function(a){Ko(this,"remove");var b=Mo(this);return Ua(this.h,a)?(this.index=La(this.h,b),!0):!1};
function Qo(a){var b={};b.videoIds=Xa(a.h);b.index=a.index;b.listId=a.j;b.videoId=a.f;b.playerState=a.l;b.volume=a.C;b.muted=a.B;b.audioTrackId=a.J;b.trackData=tb(a.o);b.playerTime=a.A;b.playerTimeAt=a.K;return b}
Jo.prototype.clone=function(){return new Jo(Qo(this))};function Y(a,b,c){V.call(this);this.A=NaN;this.S=!1;this.J=this.C=this.R=this.L=NaN;this.Z=[];this.j=this.D=this.f=null;this.Pa=a;this.Z.push(N(window,"beforeunload",w(this.Fd,this)));this.h=[];this.D=new Jo;3==c["mdx-version"]&&(this.D.j="RQ"+b.token);this.ha=b.id;this.f=Ro(this,c);this.f.subscribe("handlerOpened",this.Sd,this);this.f.subscribe("handlerClosed",this.Od,this);this.f.subscribe("handlerError",this.Pd,this);this.D.j?this.f.subscribe("handlerMessage",this.Qd,this):this.f.subscribe("handlerMessage",
this.Rd,this);Io(this.f,b.token);this.subscribe("remoteQueueChange",function(){var a=this.D.f;zk()&&U("yt-remote-session-video-id",a)},this)}
y(Y,V);g=Y.prototype;
...
g.G=function(){Uo(this);Vo(this);Wo(this);J(this.C);this.C=NaN;J(this.J);this.J=NaN;this.j=null;We(this.Z);this.Z.length=0;this.f.dispose();Y.I.G.call(this);this.h=this.D=this.f=null};
...
function Xo(a){Vo(a);a.R=I(w(function(){Yo(this,"getNowPlaying")},a),2E4)}
function Vo(a){J(a.R);a.R=NaN}
function Zo(a){var b=a.f;return!!b.f&&3==b.f.f&&isNaN(a.A)}
g.Sd=function(){this.H("Channel opened");this.S&&(this.S=!1,Wo(this),this.L=I(w(function(){this.H("Timing out waiting for a screen.");this.o(1)},this),15E3));
Mk(Ho(this.f),this.ha)};
g.Od=function(){this.H("Channel closed");isNaN(this.A)?Nk(!0):Nk();this.dispose()};
g.Pd=function(a){Nk();isNaN(this.B())?(this.H("Channel error: "+a+" without reconnection"),this.dispose()):(this.S=!0,this.H("Channel error: "+a+" with reconnection in "+this.B()+" ms"),To(this,2))};
function $o(a,b){b&&(Uo(a),Wo(a));b==Zo(a)?b&&(To(a,1),Yo(a,"getSubtitlesTrack")):b?(a.P()&&a.D.reset(),To(a,1),Yo(a,"getNowPlaying"),ap(a)):a.o(1)}
function bp(a,b){var c=b.f.videoId;delete b.f.videoId;c==a.D.f&&(pb(b.f)?a.D.o=null:a.D.o=b.f,a.F("remotePlayerChange"))}
...
$o(this,a);break;case "loungeScreenConnected":$o(this,!0);break;case "loungeScreenDisconnected":Va(this.h,function(a){return"LOUNGE_SCREEN"==a.type});
$o(this,!1);break;case "remoteConnected":var b=new uk(zd(a.f.device));Pa(this.h,function(a){return a.equals(b)})||Ta(this.h,b);
...
g.Rd=function(a){a.f?this.H("Received: action="+a.h+", params="+M(a.f)):this.H("Received: action="+a.h);gp(this,a);hp(this,a);if(Zo(this)){var b=this.D.clone(),c=!1,d,e,f,h,k,l;a.f&&(d=a.f.videoId||a.f.video_id,e=a.f.videoIds||a.f.video_ids,f=a.f.state,h=a.f.currentTime||a.f.current_time,k=a.f.volume,l=a.f.muted,p(a.f.currentError)&&zd(a.f.currentError));if("onSubtitlesTrackChanged"==a.h)d==Mo(this.D)&&(delete a.f.videoId,pb(a.f)?this.D.o=null:this.D.o=a.f,this.F("remotePlayerChange"));else if(Mo(this.D)||
...
function gp(a,b){switch(b.h){case "loungeStatus":var c=zd(b.f.devices);a.h=A(c,function(a){return new uk(a)});
...
function hp(a,b){var c=!1;if("loungeStatus"==b.h)c=!!Pa(a.h,function(a){return"LOUNGE_SCREEN"==a.type});
...
Y.prototype.sendMessage=Y.prototype.va;function ip(a){V.call(this);this.o=0;this.ka=jp();this.cb=NaN;this.zb="";this.A=a;this.H("Initializing local screens: "+Wj(this.ka));this.j=kp();this.H("Initializing account screens: "+Wj(this.j));this.Rb=null;this.f=[];this.h=[];lp(this,em()||[]);this.H("Initializing DIAL devices: "+dk(this.h));a=Uj(Jk());mp(this,a);this.H("Initializing online screens: "+Wj(this.f));this.o=x()+3E5;np(this)}
y(ip,V);var op=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=ip.prototype;g.H=function(a){Lj("RM",a)};
g.N=function(a){Lj("RM",a)};
function kp(){var a=jp(),b=Uj(Jk());return Ma(b,function(b){return!lk(a,b)})}
function jp(){var a=Uj(Fk());return Ma(a,function(a){return!a.uuid})}
...
function tp(a){var b=jp();ab(a.ka,b,Rj)||(a.H("Saving local screens: "+Wj(b)+" to "+Wj(a.ka)),Ek(A(a.ka,Sj)),mp(a,a.f,!0),lp(a,em()||[]),a.F("managedScreenChange",pp(a)))}
...
Tl("Sending a cast launch request with params: "+l.parameters);k.launch(l,qa(hm,a))}else Tl("No cast API or no cast device. Dropping cast launch.")}d.zb=e;d.cb=I(w(d.Pc,d,a,0,e),op[0])}else d.H("No DIAL device with id: "+a)}
...
W.prototype.$_st=W.prototype.Za;W.prototype.$_gspc=W.prototype.Qe;W.prototype.$_gsppc=W.prototype.ad;W.prototype.$_c=W.prototype.contains;W.prototype.$_g=W.prototype.get;W.prototype.$_a=W.prototype.Kb;W.prototype.$_un=W.prototype.Hb;W.prototype.$_r=W.prototype.remove;W.prototype.$_gs=W.prototype.$;W.prototype.$_gos=W.prototype.$c;W.prototype.$_s=W.prototype.subscribe;W.prototype.$_ubk=W.prototype.oa;function Cp(){var a=!!H("MDX_ENABLE_CASTV2"),b=!!H("MDX_ENABLE_QUEUE"),c={device:"Desktop",app:"youtube-desktop"};a?q("yt.mdx.remote.castv2_",!0,void 0):Yl();hj&&gj();wk();Dp||(Dp=new Yj,Ok()&&(Dp.f="/api/loungedev"));Z||a||(Z=new ip(Dp),Z.subscribe("screenPair",Ep),Z.subscribe("managedScreenChange",Fp),Z.subscribe("onlineReceiverChange",function(){K("yt-remote-receiver-availability-change")}));
...
function jq(a){q("yt.mdx.remote.currentScreenId_",a,void 0);if(Z){var b=Z;b.o=x()+3E5;if((b.Rb=a)&&(a=up(b,a))&&!lk(b.f,a)){var c=Xa(b.f);c.push(a);mp(b,c,!0)}}}
...
Kq.prototype.G=function(){this.h=this.f=null;Kq.I.G.call(this)};function Lq(a,b,c){E.call(this);this.f=a;this.j=c;this.l=N(window,"message",w(this.o,this));this.h=new Kq(this,a,b);gc(this,qa(F,this.h))}
...
$d("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",T:c,ca:function(c,f){d();var h=f.response,k=h.id;if(ea(k)&&k.length==b.length){var l=h.channel_info_map;z(k,function(a,c){var d=b[c];R(ki,new ci(d,a,l[d]))});
...
q("yt.logging.errors.log",function(a,b,c,d,e){c={name:c||H("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),version:d||H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e;if(a&&e&&!(5<=fe)){e=a.stacktrace;d=a.columnNumber;var f=r("window.location.href");if(v(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var h,k,l=!1;try{h=a.lineNumber||a.line||"Not available"}catch(u){h="Not available",l=!0}try{k=a.fileName||a.filename||a.sourceURL||
m.$googDebugFname||f}catch(u){k="Not available",l=!0}a=!l&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(ee[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){b={hc:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},T:{url:H("PAGE_NAME",
window.location.href),file:a.fileName},method:"POST"};e&&(b.T.stack=e);for(var n in c)b.T["client."+n]=c[n];$d("/error_204",b);ee[a.message]=!0;fe++}}},void 0);
q("writeEmbed",Er,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&Rg(a);return!0},void 0);
