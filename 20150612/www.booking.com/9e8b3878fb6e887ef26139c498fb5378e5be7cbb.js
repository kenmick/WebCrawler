...
I.getIW(H.id,function(J){J.b_marker_type=(H.data)?H.data.b_marker_type:"";
J.b_map_nights=z.get("checkinCheckoutInterval");
...
L.b_marker_type=H.data.b_marker_type;
...
return
}L.getIW(J,function(N){N.b_marker_type=(H.data)?H.data.b_marker_type:"";
N.b_map_nights=z.get("checkinCheckoutInterval");
...
function d(){if(!e.user.showCurrencyPopOver&&!e.user.showLanguagePopOver){return
...
}var F={type:"checkin",defaultDate:m.search.dates("checkin"),dayNames:I,monthNames:C,sundayFirst:E,title:u.transl_checkin_title,monthTitle:d,direction:u.rtl?"rtl":"ltr",arrow:true,onDateSelected:function(M,J){window.api=M;
