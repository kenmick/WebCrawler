...
}if(this.firstShow&&this.options["calendar2-type"]=="checkin"){f.track.exp("bLYQCLBMSPPbWe");
...
}},isWeekend:function(g){if(g){if(this.dateObject_.getUTCDay()===6){return" c2-day-s-saturday"
