function iCast_Play_2101507() {
    if (mutex_lock() == -1) {
       setTimeout(iCast_Play_2101507, 100)
    } else {
        iCast_Start_Enabled_2101507 = true
    }
}
if (typeof mutex_lock != "undefined") {
    iCast_Start_Enabled_2101507 = false;
    iCast_Play_2101507()
}
!function(){
	var _win=window,
	_dc=_win.document,
	_track_url = "http://track.ra.icast.cn/icast3/?cid=46991&r=[rnd]&pos_id=1591&ad_id=249896&",
	_ad_id = 2101507,
	_pos_id = 1591,
	_download = "http://ra.gtimg.com/icast/2101507/",
	...
	_um_imp="http://qq.m.cn.miaozhen.com/x/k=2007325&p=6tYcR&dx=0&rt=2&ns=__IP__&ni=__IESID__&v=__LOC__&rnd=[rnd]&o=http://ad.kodmp.com/o.htm?pv=0&sp=0,103925,6440,103924,0,1,1",
	_um_clk="",
	_clk_url="http://c.l.qq.com/lclick?seq=20150609000072&loc=WWW_RM_RightMove1",
	_is_done=0,
	_length="length",
	_track_pool = [],
	_util = {
	...
	function run(){
		...
		"displayLogic":{	
			"init":[
				["freq_2101507","DailyCounter","*ad_life",1],
				["dt1","DownTimer","=0.02"],
				["dt2","DownTimer","=0.02"],
				["ct1","Counter"],
				["ct3","Counter"],
