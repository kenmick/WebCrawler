...
$(function(){if(B.track.getVariant("NGEcaGQQOSPDEaBcDfWLT")){if(B.env.b_action!=="faq"||B.env._ran_faq_js_code){return
}}$.extend($.expr[":"],{containsi:function(l,k,j){return(l.textContent||l.innerText||"").toLowerCase().indexOf((j[3]||"").toLowerCase())>=0
}});
...
if(B.track.getVariant("NGEcaGQQOSPDEaBcDfWLT")&&B.env.b_action==="faq"){B.env._ran_faq_js_code=true
}});
