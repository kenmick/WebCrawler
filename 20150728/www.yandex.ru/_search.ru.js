...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("HmoluO92-6LkP56XIJoo6TDcUcY")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
if("js"===e)return ye(t);if("auto-content"===e)return"auth"===n?Ee(t):Ve(t);if("action"===e)return"auth"===n?!!s==!1?xe(t):Ve(t):Ve(t);
if("format-value"===e){if("value"===s){var e=n;return"notice"===e?Be(t):"ticker"===e?Ce(t):Ve(t)}return Ve(t)
}if("mix"===e)return be(t);if(""===e)return Ie(t);if("value"===e){var e=n;return"input"===e?Oe(t):"tumbler"===e?"option"===s?Le(t):Ve(t):Ve(t)
}if("getLive"===e)return"input"===n?!!s==!1?Ne(t):Ve(t):Ve(t);if("live"===e)return"input"===n?!!s==!1?Re(t):Ve(t):Ve(t);
if("public-params"===e){if("i-global"===n){var e=s;return"areScriptsAsync"===e||"isPageLoadCounter"===e||"geoanswer"===e||"isCounterHeights"===e||"serpRequestExtraParams"===e||"isCounterSerpview"===e||"lr"===e||"ajaxUrl"===e||"framebuster"===e||"shownResult"===e||"pg"===e||"cache"===e||"nahodki"===e||"pref-ajax"===e||"tld"===e||"maxAjaxUrlLength"===e||"reqid"===e||"nonce"===e||"query"===e||"pid"===e?!0:!s==!1?{id:1,lang:1,tld:1,"content-region":1,"user-region":1,login:1,displayName:1,index:1,yandexuid:1,"passport-host":1,"pass-host":1,"passport-msg":1,"static-host":1,"lego-static-host":1,"social-host":1,clck:1,"click-host":1,"export-host":1,"i-host":1,"social-retpath":1,"lego-path":1,sid:1,retpath:1,uid:1}[s]||!1:Ve(t)
}return Ve(t)}return"default"===e?L(t):"env"===e?"i-global"===n?qe(t):Ve(t):"content"===e?I(t):"jsAttr"===e?$e(t):"tag"===e?C(t):"cls"===e?Fe(t):"bem"===e?Se(t):Ve(t)
...
if("retpath"===e)return{type:"hidden",name:"retpath",value:t._retpath||""};if(!!s==!1){var _,g;return{method:"POST",action:t.ctx.url||(_=i,i="action",g=xe(t),i=_,g),role:"form","aria-label":BEM.I18N("auth","auth")}
...
}function g(t){for(var e,n,s,o,r=t.ctx,a=["title","target"],c=typeof r.url,h={href:"undefined"===c||"string"===c?r.url:(c=[],e=t._buf,t._buf=c,n=i,i="",s=t.ctx,t.ctx=r.url,o=Pe(t),t._buf=e,i=n,t.ctx=s,c.join(""))};c=a.pop();)r[c]&&(h[c]=r[c]);
...
}),n)if(t.isSimple(n))s.href=n;else{var o=[],r=i;i="";var a=t._buf;t._buf=o;var c=t.ctx;t.ctx=n,Pe(t),i=r,t._buf=a,t.ctx=c,s.href=o.join("")
...
}if("notice"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Be(t),i=o,a}return"count"===e?[{elem:"text"},{elem:"value",maxCount:t.ctx.maxCount,count:t.ctx.content}]:j(t)
}if("ticker"===e){var e=s;if("value"===e){var o,a;return o=i,i="format-value",a=Ce(t),i=o,a}return"text"===e?BEM.I18N("ticker__text","notifications"):j(t)
...
}return j(t)}return j(t)}function T(t){if(!!s==!1){var e,n;return[t.ctx.content||(e=i,i="auto-content",n=Ee(t),i=e,n),{elem:"retpath"}]
...
}function j(t){return t.ctx.content}function L(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg33!==!0)==!1?N(t):Ve(t):Ve(t);
if("checkbox"===e)return R(t);if("button"===e)return $(t);if("input"===e)return F(t);if("auth"===e)return W(t);
if("suggest2-item"===e){var e=s;return"icon"===e?X(t):"fact"===e?J(t):Ve(t)}return"select"===e?te(t):"popup"===e?re(t):"tumbler"===e?ce(t):"i-global"===e?_e(t):Ve(t)
...
var r=i;i="",Pe(t),t.ctx=o,i=r,t.__$anflg33=s}function R(t){return!(t.__$anflg32!==!0)==!1?!!s==!1?q(t):Ve(t):Ve(t)
...
}function $(t){if(!(t.__$anflg28!==!0)==!1){if(!!s==!1){t.ctx.mods=t.extend({theme:"normal"},t.ctx.mods);
var e=t.__$anflg28;return t.__$anflg28=!0,$(t),t.__$anflg28=e,void 0}return Ve(t)}return Ve(t)}function F(t){var e=s;
return"hint"===e?V(t):"control"===e?!(t.__$anflg25!==!0)==!1?U(t):z(t):z(t)}function V(t){if(!(t.__$anflg26!==!0)==!1){if(!!t._value==!1){if(!(0!==t._value)==!1){var e=t.ctx,i=e.elemMods||(e.elemMods={});
i.visibility="visible";var n=t.__$anflg26;return t.__$anflg26=!0,V(t),t.__$anflg26=n,void 0}return z(t)
}return z(t)}return z(t)}function U(t){var e=t.__$anflg25;t.__$anflg25=!0;var n=t.ctx;t.ctx=[t._placeholder?{elem:"hint",elemMods:{fallback:"yes"},content:t._placeholder}:"",{elem:"box",content:t.ctx}];
var s=i;i="",Pe(t),t.ctx=n,i=s,t.__$anflg25=e}function z(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?H(t):Ve(t):Ve(t)
}function H(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Oe(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Ne(t),i=o,a);
...
t._live=l;var k=t._placeholder;t._placeholder=t.ctx.placeholder;var M=t.ctx,E=M.mods;M.mods=u,F(t),t._inputId=p,t._labelId=f,t._hintId=m,t._name=_,t._value=g,t._inputLink=b,t._disabled=v,t._live=y,t._placeholder=k,M.mods=E,t.__$anflg12=d
}function W(t){return"retpath"===s?K(t):Q(t)}function K(t){if(!(t.__$anflg24!==!0)==!1){var e=t.__$anflg24;
t.__$anflg24=!0;var i=t._retpath;return t._retpath=BEM&&BEM.blocks?BEM.blocks["i-global"].param("retpath"):t["i-global"].retpath,K(t),t._retpath=i,t.__$anflg24=e,void 0
}return Q(t)}function Q(t){return!(t.__$anflg23!==!0)==!1?!!s==!1?G(t):Ve(t):Ve(t)}function G(t){var e,i,n,s;
...
var c=t._paramFrom;t._paramFrom=n?"&from="+encodeURIComponent(n):"",W(t),t._passportHost=r,t._paramRetpath=a,t._paramFrom=c,t.__$anflg23=o
}function X(t){if(!(t.__$anflg21!==!0)==!1){if(!o.weather==!1){var e=t.__$anflg21;t.__$anflg21=!0;var i=o,n=i.weather;
return i.weather=o.weather.replace("-","minus-").replace("+","plus-").replace(/_/g,"-"),X(t),i.weather=n,t.__$anflg21=e,void 0
}return Y(t)}return Y(t)}function Y(t){return!(t.__$anflg20!==!0)==!1?Z(t):Ve(t)}function Z(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg20;t.__$anflg20=!0,X(t),t.__$anflg20=i}function J(t){if(!(t.__$anflg19!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg19;return t.__$anflg19=!0,J(t),t.__$anflg19=e,void 0}return Ve(t)}return Ve(t)}function te(t){return"group"===s?ee(t):ie(t)
}function ee(t){if(!(t.__$anflg18!==!0)==!1){var e=t.__$anflg18;t.__$anflg18=!0;var i=t._labelId;return t._labelId=t.generateId(),ee(t),t._labelId=i,t.__$anflg18=e,void 0
}return ie(t)}function ie(t){return!(t.__$anflg14!==!0&&t.__$anflg15!==!0)==!1?!!s==!1?ne(t):se(t):se(t)
}function ne(t){var e,n,s,o,r,a,c,h=t.ctx,u=(e=i,i="js",n=ke(t),i=e,n||{}).live;if(u){var l=h.content.filter(function(t){return"control"===t.elem
...
},p=d(l);return p||(p=l[0],"option-group"===p.elem&&(p=p.content[0])),s=t.__$anflg14,t.__$anflg14=!0,r=t._initValue,t._initValue=p.attrs.value,a=t._initText,t._initText=p.content,c=te(t),t._initValue=r,t._initText=a,o=c,t.__$anflg14=s,o
}}var f=t.__$anflg15;t.__$anflg15=!0,te(t),t.__$anflg15=f}function se(t){return!(t.__$anflg13!==!0)==!1?!!s==!1?oe(t):Ve(t):Ve(t)
}function oe(t){var e=t.ctx,i=e.id||t.generateId(),s=t.__$anflg13;t.__$anflg13=!0;var o=t._controlAttrs;
t._controlAttrs={id:i,name:e.name||i};var a=t._formSelect;t._formSelect={block:n,mods:r,tabindex:e.tabindex},te(t),t._controlAttrs=o,t._formSelect=a,t.__$anflg13=s
}function re(t){return!!t._popupDefaults==!1?!!s==!1?ae(t):Ve(t):Ve(t)}function ae(t){var e=t.ctx;if(e.mods=r=t.extend({theme:"ffffff",autoclosable:"yes",adaptive:"yes",animate:"yes"},r),e.zIndex){var i=e.attrs||(e.attrs={});
i.style=(i.style||"")+";z-index:"+e.zIndex+";"}var n=t._popupDefaults;t._popupDefaults=!0,re(t),t._popupDefaults=n
}function ce(t){if("option"===s){if("left"===t.ctx.side){if(!(t.__$anflg9!==!0)==!1){var e=t.__$anflg9;
t.__$anflg9=!0;var n=t.ctx;t.ctx=[t.ctx,{elem:"box"}];var o=i;return i="",Pe(t),t.ctx=n,i=o,t.__$anflg9=e,void 0
}return he(t)}return he(t)}return le(t)}function he(t){return!(t.__$anflg8!==!0)==!1?ue(t):le(t)}function ue(t){var e,n,s=(e=i,i="value",n=Le(t),i=e,n),o=t.__$anflg8;
...
var a=i;i="",Pe(t),t.ctx=r,i=a,t.__$anflg8=o}function le(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
t.__$anflg6=!0;var i=t._disabled;return t._disabled="disabled",ce(t),t._disabled=i,t.__$anflg6=e,void 0
}return de(t)}return de(t)}return de(t)}function de(t){if("yes"===(t.ctx.mods||{}).checked){if(!(t.__$anflg5!==!0)==!1){if(!!s==!1){var e=t.__$anflg5;
t.__$anflg5=!0;var i=t._checked;return t._checked="checked",ce(t),t._checked=i,t.__$anflg5=e,void 0}return pe(t)
}return pe(t)}return pe(t)}function pe(t){if(!(t.__$anflg4!==!0)==!1){if(!!s==!1){if(!!(t.ctx.mods||{}).theme==!1){var e=t.__$anflg4;
t.__$anflg4=!0;var i=t.ctx,n=i.mods;return i.mods=t._.extend(t.ctx.mods||{},{theme:"normal"}),ce(t),i.mods=n,t.__$anflg4=e,void 0
}return fe(t)}return fe(t)}return fe(t)}function fe(t){return!(t.__$anflg3!==!0)==!1?!!s==!1?me(t):Ve(t):Ve(t)
}function me(t){var e=t.generateId(),i="left"+e,n="right"+e,s=null,o=t.ctx.content;o&&o.length>0&&(s="left"===t.ctx.content[0].side?i:n);
var r=t.__$anflg3;t.__$anflg3=!0;var a=t._name;t._name=t.ctx.name||(t.ctx.name=e);var c=t._leftId;t._leftId=i;
var h=t._rightId;t._rightId=n;var u=t._sideId;t._sideId=s,ce(t),t._name=a,t._leftId=c,t._rightId=h,t._sideId=u,t.__$anflg3=r
}function _e(t){var e=s;return"lego-static-host"===e?"//yastatic.net/lego/2.10-142":"export-host"===e?"https://export.yandex.ru":"social-host"===e?"https://social.yandex.ru":"pass-host"===e?"https://pass.yandex.ru":"passport-host"===e?"https://passport.yandex.ru":"click-host"===e?"//clck.yandex.ru":"content-region"===e||"tld"===e||"lang"===e?"ru":!s==!1?"":!!s==!1?ge(t):Ve(t)
}function ge(t){var e,i,n,s=t.ctx.params||{},o=t["i-global"],r=s.tld&&s.tld!==o.tld;r&&(e=s.tld,i="tr"===e?"yandex.com.tr":"yandex."+e,n=-1!=["ua","by","kz"].indexOf(e)?"yandex.ru":i,o["content-region"]=e,o["click-host"]="//clck."+n,o["passport-host"]="https://passport."+n,o["pass-host"]="https://pass."+i,o["social-host"]="https://social."+i,o["export-host"]="https://export."+i);
for(var a in s)o[a]=s[a]}function be(t){var e=n;if("dropdown"===e)return!!s==!1?[{mods:{action:"closed"}}]:ve(t);
if("notice"===e)return"count"===s?!!t.ctx.url==!1?[{elem:"plain"}]:ve(t):ve(t);if("ticker"===e)return"text"===s?[{block:"a11y-hidden"}]:ve(t);
if("suggest2-item"===e)return"text"===s?!(r&&"link"===r.interact)==!1?!("nav"===r.type||"icon"===r.type)==!1?{mods:{type:"url"}}:ve(t):ve(t):ve(t);
if("suggest2"===e)return!!s==!1?[{block:"suggest2-detect",js:!0}]:ve(t);if("select"===e){if("group"===s){var i=t.isFirst()?t.isLast()?"both":"first":t.isLast()?"last":"middle";
return{mods:{position:i}}}return ve(t)}return"input"===e?"ahead"===s?[{block:"input",elem:"input"}]:ve(t):ve(t)
}function ve(){return void 0}function ye(t){var e=n;return"dropdown"===e?!!s==!1?!0:Me(t):"checkbox"===e?!!s==!1?t.extend({live:!1},t.ctx.js):Me(t):"button"===e||"auth"===e||"suggest2-item"===e||"suggest2"===e?!!s==!1?!0:Me(t):"select"===e?!!s==!1?ke(t):Me(t):"input"===e?!!s==!1?{live:t._live}:Me(t):"tumbler"===e?!!s==!1?t.extend({live:!1},t.ctx.js):Me(t):"link"===e?!t.ctx.tabindex==!1?!!s==!1?{origTabindex:t.ctx.tabindex}:Me(t):Me(t):Me(t)
}function ke(t){return t.extend({live:!1},t.ctx.js)}function Me(){return void 0}function Ee(t){return!!t.ctx.content==!1?!!s==!1?[{elem:"username"},{elem:"password"},{elem:"row",mods:{button:"yes"},content:[{elem:"haunter"},{elem:"button"}]},{elem:"social"},{elem:"row",content:[{elem:"remember"},{elem:"register"}]}]:we(t):we(t)
}function we(t){return!!s==!1?[]:Ve(t)}function xe(t){var e,i;return BEM&&BEM.blocks?(e=BEM.blocks["i-global"],i=e.param("passport-msg")):(e=t["i-global"],i=e["passport-msg"]),[t._passportHost,"/auth?twoweeks=yes",i?"&from="+encodeURIComponent(i):""].join("")
}function Be(t){var e,i,n=t.ctx;return e=parseInt(n.count,10),i=n.maxCount?n.maxCount:99,e>i?i+"+":e}function Ce(t){return t._count>t._maxCount?t._maxCount+"+":t._count
}function Se(t){return"suggest2-item"===n?"highlight"===s?!1:De(t):De(t)}function De(){return void 0}function Ie(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Ze(t),void 0):Pe(t):Pe(t):Pe(t)
}function Pe(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?Te(t):Ve(t):Ve(t)}function Te(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=_e(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",u=qe(t),i=c,n=h,u),m=t.__$anflg1;t.__$anflg1=!0;var _=t["i-global"];
t["i-global"]=t.extend(d,f),Ie(t),t["i-global"]=_,t.__$anflg1=m}function Oe(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Ae(t):Ae(t)
}function Ae(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Pe(t),t._buf=n,i=o,e.join("")
}return je(t)}return je(t)}function je(t){return!!s==!1?"":Ve(t)}function Le(t){return t.ctx.value||"left"!==t.ctx.side
}function Ne(t){var e,n,s=(e=i,i="live",n=Re(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function Re(){return!1}function qe(t){return!!s==!1?{}:Ve(t)}function $e(){return void 0}function Fe(){return void 0
}function Ve(t){return!t.ctx==!1?!t.ctx.link==!1?!!t._.isSimple(t.ctx)==!1?Ue(t):ze(t):ze(t):ze(t)}function Ue(i){function n(){if("no-follow"===this.ctx.link)return void 0;
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(Ze,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
var s=i._buf.slice(i._cachePos).join("");i._cachePos=i._buf.length,i._cacheLog.push(s,{log:i._localLog.slice(),link:i.ctx.link});
var o=n.call(t(i));return i._cachePos=i._buf.length,o}function ze(t){return!a==!1?!t.ctx==!1?!t.ctx.cache==!1?He(t):We(t):We(t):We(t)
}function He(e){function i(t,e,i){if(0===e.length)return void 0;if(Array.isArray(i)){for(var n=t,s=0;s<i.length-1;s++)n=n[i[s]];
...
}function We(t){var e=i;if("default"===e)return Ke(t);if(""===e){if(!t._.isSimple(t.ctx)==!1){t._listLength--;
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?Qe(t):Ge(t)
}return Xe(t)}function Ke(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,S,D,P,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=C(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,N;
n&&A.js!==!1&&(h=i,i="js",l=ye(t),i=h,N=l,N=N?t._.extend(A.js,N===!0?{}:N):A.js===!0?{}:A.js,N&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=N)),j.push("<",T);
var R=(d=i,i="bem",p=Se(t),i=d,p);"undefined"!=typeof R||(R="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var q=(f=i,i="cls",m=Fe(t),i=f,m);q||(q=A.cls);var $=A.block&&L&&!A.elem;if(R||q){if(j.push(' class="'),R){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
var F=(_=i,i="mix",g=be(t),i=_,g);if(A.mix&&(F=F?[].concat(F,A.mix):A.mix),F){var V={};V[e(n,s)]=!0,t._.isArray(F)||(F=[F]);
...
var X=(b=n,n=W,a=s,s=K,y=r,r=Q,k=o,o=G,M=i,i="mix",E=be(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
(Z.block||Z.elem)&&V[e(Z.block,Z.elem)]||(Z._block=W,Z._elem=K,F.splice(U+1,0,Z))}}}}}}q&&j.push(R?" ":"",q),$&&j.push(" i-bem"),j.push('"')
}if(L){var J=(w=i,i="jsAttr",x=$e(t),i=w,x);j.push(" ",J||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
...
var re=t.ctx;t.ctx=ie;var ae=i;i="",Ie(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}T&&j.push("</",T,">")}}function Qe(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,Ie(t),t.ctx=a}o||(t.position=s)}function Ge(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
}function Xe(){throw new Error(this)}function Ye(t){return Ze(t||this)}function Ze(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
},t.prototype.generateId=function(){return this.identify(this.ctx)},c.apply=t.apply=function(){var e=new t(Ye);
...
},hide:function(){this.page.delMod("fade"),this.delMod("visible")}}),_borschik("37dEdB3GojphoYvNWueCUY7jf2o")&&BEM.DOM.decl("popup",{onSetMod:{js:function(){this.__base(),this._tailPos={}
...
this._searchInput&&this._searchInput.val(n,{noSuggest:!0})}}),_borschik("-g8syBEA7J5pCfbit0cJ0MvWiXs")&&BEM.HTML.decl("b-link",{onBlock:function(t){t.tag("a").attr("href",t.param("url"));
...
t.execute()}}),_borschik("NA-QJ2YuFyCxRU40NmS3Z2wB2l0")&&BEM.decl("install-chrome-webstore-item-action",{execute:function(){var t=this.params.id&&BEM.blocks["chrome-webstore-item_type_"+this.params.id]?BEM.create("chrome-webstore-item_type_"+this.params.id,this.params.webItem):BEM.create("chrome-webstore-item",this.params.webItem);
...
}}),_borschik("31q2wbJAXMtRlxaHv-WTjOaZ9Aw")&&BEM.DOM.decl("cut",{onSetMod:{js:function(){this.bindTo("more","leftclick tap",this.onClick),this.hasMod("clickable-content","yes")&&this.bindTo("content","leftclick tap",this.onClick)
}},onClick:function(){this.open()},open:function(){this.hasMod("opened","yes")||(this.setMod("opened","yes"),this.params.openCounter&&BEM.blocks.counter.log(this.params.openCounter))
...
}},{live:function(){this.liveBindTo("arrow","click",function(t){this._showPopup(t)})}}),_borschik("jgTQ8eiKpf82dTs7IJJRAjIPgmk")&&!function(t){var e=1e3;
...
},_calcIsAnchorVisible:function(){var e=this._anchor,i=this._getOffsetOf(e),n=i.left,s=i.top,o=n+e.outerWidth(),r=s+e.outerHeight(),a=this.getMod("direction"),c=Math.floor(this._checkDirection(a,"top")?s:r),h=Math.floor(this._checkDirection(a,"left")?n:o),u=!0;
...
}if(o){var l=Math.floor(r.left);return u=h>=l&&l+i.outerWidth()>=h}}}.bind(this)),u},_calcZIndexGroupLevel:function(){var t=this.__base.apply(this,arguments);
...
var l;h.bind("keyboardOpened.lego",function(){s(),t("input:focus").focus()})}}(jQuery,window.Lego),_borschik("lYXAb_RFH0GR0fpkRlZvhJJprgg")&&!function(t){function e(){function e(t,e){u[t](e,function(t){"error"===t?d.push(e):l.push(e)&&r.each(e),s()
