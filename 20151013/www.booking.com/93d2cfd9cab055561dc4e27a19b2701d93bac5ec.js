...
K=B.env.b_action==="hotel"&&B.track.getVariant("BUcJZSQZXSMC");
if(!f.length){return
}if(D>=y){return
...
h.MN(c[68],d[112]);
x+=d[110];
if((h.MJ(d[43])&&h.MJ(d[43]))){x+=[d[4],h.MC(c[68]),d[1]].join("")
}else{if(h.MJ(d[43])){x+=[d[4],h.MC(c[67]),d[1]].join("")
...
if(((h.MJ(h.MC(c[19])+""==="www"))&&h.MJ(h.track_experiment("cQZJAQPeMJZAeWPVT")))){x+=d[38]
}x+=d[39];
if((h.MJ(h.MC(c[20]))&&(h.MJ(h.MC(c[19])+""==="www")))){x+=[d[40],"cQZJAQPeMJZAeWPVT",d[41]].join("")
}x+=d[42];
var r="";
if((((h.MJ(h.MC(c[20]))&&(h.MJ(h.MC(c[19])+""==="www")))&&((h.MJ(h.MC(c[22])+""==="hotel"))||(h.MJ(h.MC(c[22])+""==="searchresults"))))&&h.MJ(h.track_experiment("cQZJARGUJbWTaSAeMVNaRe")))){r+=d[43]
}h.MN(c[21],r);
x+=d[44];
if(h.MD(c[21])){x+=d[45];
var z="";
...
if(((h.MJ(h.MC(c[20]))&&(h.MJ(h.MC(c[19])+""==="www")))&&((h.MJ(h.MC(c[22])+""==="hotel"))||(h.MJ(h.MC(c[22])+""==="searchresults"))))){x+=[d[53],"cQZJARGUJbWTaSAeMVNaRe",d[54]].join("")
...
n.unshift({b_color:d[19],b_tooltip:d[3],b_classname:d[20]});
l();
n.shift();
...
n.unshift({b_ge_freebies:d[43],b_classname:d[107],b_ge_discount:d[43]});
p();
n.shift();
x+=[d[113],h.MB(c[69]),d[114],h.MB(c[70]),d[115]].join("");
return x
}
})());
"use strict";
...
c.eventEmitter.bind("AUTOCOMPLETE:afterAjax",function(n,m){if(m.data&&(m.data.__first_result_is_country__||m.data.__first_result_is_region__)){c.track.stage(h,1)
}})
}if(c[sNSExperiments]){c[sNSExperiments][h]={priority:9,init:l,initElse:l}
}else{l()
