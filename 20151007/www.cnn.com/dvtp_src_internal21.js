...
M));var Aa=ya.join("&"),Ba=N.join("&"),Sa=window._dv_win.dv_config.tpsAddress||"tps"+M+".doubleverify.com",E="visit.js";switch(dv_GetParam(c,"dvapi")){case "1":E="dvvisit.js";break;case "5":E="query.js";break;default:E="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=E;for(var P="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr".split(" "),ja=[],l=0;l<P.length;l++){var ka=dv_GetParam(c,P[l])||"";ja.push(P[l]+"="+ka);""!==ka&&(window._dv_win.$dv.DebugInfo["dvp_"+
...
window._dv_win.$dv.Enums.TrafficScenario;try{if(window.top==window)return d.OnPage;if(window.top.document.domain==window.document.domain)return d.SameDomain}catch(a){}return d.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"65"}};
