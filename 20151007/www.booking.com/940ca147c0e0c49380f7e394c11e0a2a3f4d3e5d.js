...
"use strict";
booking[sNSExperiments]["cQZeCJEcDHET"]=(function(c,e){function d(){c(".genius-user-account-sign .clickable-area").click(function(f){f.preventDefault();
c(".user_center_popover").hide();
booking.lightbox.show(booking.jstmpl("ge_about_lightbox").render({b_genius_user:e.env.b_genius_user||{}}),{customWrapperClassName:"ge-about-lightbox-wrapper"},function(g){c(".ge-mod-button").click(function(){booking.lightbox.hide();
return false
})
})
})
...
h.MN(c[68],d[106]);
x+=d[104];
if((h.MJ(d[37])&&h.MJ(d[37]))){x+=[d[4],h.MC(c[68]),d[1]].join("")
}else{if(h.MJ(d[37])){x+=[d[4],h.MC(c[67]),d[1]].join("")
}else{if(h.MJ(d[37])){x+=[d[4],h.MC(c[66]),d[1]].join("")
}}}x+=d[88]
}function q(){x+=d[2];
...
x+=d[1];
if(((h.MJ(d[100]+""==="freebie_icon"))&&((h.MJ(h.MC(c[62])+""===""))||(h.MJ(h.MC(c[62])==0))))){x+=d[4];
...
if(h.MJ(d[16])){x+=d[4];
var r="";
r+=[d[18],h.MC(c[64]),d[18],d[101],d[18]].join("");
...
h.MN(c[12],[d[18],h.MC(c[64]),d[18],d[101],d[18]].join(""));
x+=d[8];
...
x+=d[8]
}}}x+=[d[68],h.STATIC_HOSTNAME(h.MC(c[35]),0,0,0),d[69],h.MC(c[0]),d[70],d[101],d[71]].join("");
...
h.MN(c[35],[d[79],h.MC(c[64]),d[80],h.MC(c[0]),d[67]].join(""));
x+=[d[68],h.STATIC_HOSTNAME(h.MC(c[35]),0,0,0),d[69],h.MC(c[0]),d[81],d[101],d[71]].join("");
if(h.MD(c[40])){x+=[d[72],h.MC(c[0]),d[73],(h.MC(c[36])||"auto"),d[74],(h.MC(c[37])||"inline-block"),d[75],(h.MC(c[38])||"baseline"),d[76],h.MC(c[39]),d[71]].join("")
}x+=d[82]
}}x+=d[62]
}else{if(h.MD(c[43])){x+=d[4];
var r="";
r+=[d[83],h.MC(c[42]),d[80],h.MC(c[64]),d[80],h.MC(c[0]),d[18],d[101],d[18]].join("");
if(h.MD(c[9])){r+=h.MC(c[8])
}r+=d[18];
h.MN(c[12],r);
...
n.unshift({b_type:d[100],b_genius_img:d[16]});
t();
n.shift();
x+=d[88]
}function p(){x+=d[1];
...
if((h.MJ(h.MC(c[21])+""==="mdot"))){x+=d[6];
o();
x+=d[4]
}else{x+=d[6];
n.unshift({b_type:d[100],b_genius_iconfont:d[16]});
q();
n.shift();
x+=d[4]
}x+=d[1]
...
}x+=[d[92],h.MB(c[50]),d[93]].join("");
if(h.MD(c[52])){x+=h.MB(c[51])
}else{x+=h.MB(c[53])
}x+=d[94];
if(h.MD(c[52])){x+=h.MB(c[54])
}else{x+=h.MB(c[55])
}x+=[d[95],h.MB(c[56]),d[94],h.MB(c[57]),d[96],h.MB(c[58]),d[94],h.MB(c[59]),d[97],h.MB(c[60]),d[94],h.MB(c[61]),d[98]].join("");
n.unshift({b_classname:d[101],b_ge_freebies:d[37],b_ge_discount:d[37]});
p();
n.shift();
x+=[d[107],h.MB(c[69]),d[108],h.MB(c[70]),d[109]].join("");
return x
}
})());
(function(d,h){var g;
...
"use strict";
booking[sNSExperiments]["cQZGSRaPSZQOWVRdMJO"]=(function(c,e){function d(){if(booking.user.fromGeniusDomain){booking.track.exp("cQZGSRaPSZQOWVRdMJO");
if(booking.track.getVariant("cQZGSRaPSZQOWVRdMJO")&&!e.env.b_ge_has_seen_onboarding_on_login){var f={b_genius_user:e.env.b_genius_user||{}};
booking.lightbox.show(booking.jstmpl("ge_about_lightbox").render(f),{customWrapperClassName:"ge-about-lightbox-wrapper"},function(){c(".ge-mod-button").click(function(){booking.lightbox.hide();
return false
})
})
...
if(g.env.b_ge_should_show_onboarding_on_login===1){var h={b_genius_user:g.env.b_genius_user||{}};
g.lightbox.show(g.jstmpl("ge_about_lightbox").render(h),{customWrapperClassName:"ge-about-lightbox-wrapper"},function(){e(".ge-mod-button").bind("click",g.lightbox.hide);
g.eventEmitter.bind("modal:close",c)
})
