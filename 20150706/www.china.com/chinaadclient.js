...
function chinaadclient_duilian(apcode){
 if(typeof(duilians)=="undefined"){
   ...
   //##15392: ææ¯æ¯æ/360åä½ï¼å¨ç«å±è½å¯¹èå¹¿å   start    2015.1.20
    var referer1 = document.referrer;
	if(typeof(referer1)!=='undefined'&&referer1!==''&&(referer1.indexOf("360.cn")>0||referer1.indexOf("qihoo.com")>0||referer1.indexOf("so.com")>0 ||referer1.indexOf("haosou.com")>0 )){
		return false;
	}
...
function chinaadclient_liumeiti_js(apcode){
 ...
 // var cellCount = parseInt(sec/8);// å³å®æ¾ç¤ºç¬¬å ä¸ªDIV,æ¯10ç§æ¾ç¤ºä¸ä¸ªå¹¿å
  ...
  //æ¥æºäº360çé¡µé¢ä¸­ï¼æµåªä½å¹¿åç¦æ­1åéã#15898 20150323  chenting   start
  if(get_cookie("forbidden_from360_ad") !== undefined && get_cookie("forbidden_from360_ad") == "one"){
		return false;
  }
   //æ¥æºäº360çé¡µé¢ä¸­ï¼æµåªä½å¹¿åç¦æ­1åéã#15898 20150323  chenting   end
  ...
  if(typeof(referer)!=='undefined'&&referer!==''&&(referer.indexOf("360.cn")>0||referer.indexOf("qihoo.com")>0||referer.indexOf("so.com")>0|| referer.indexOf("haosou.com")>0)){
