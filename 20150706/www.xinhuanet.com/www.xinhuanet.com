...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="publishid" content="1192641.0.3.0"/>
...
--------------------------------------------------*/
/*.lazy{display: none;}*/
.lazy, .lazyIframe, .wloadIframeAD { background:#f1f1f1 url(http://www.newsimg.cn/public/2015/Loading.gif) no-repeat 50% 50%; }
.fl { float: left; }
.fr { float: right; }
/* æ¸é¤æµ®å¨ */
...
.dataList06 li .img a { display: block; width: 60px; height: 60px; line-he