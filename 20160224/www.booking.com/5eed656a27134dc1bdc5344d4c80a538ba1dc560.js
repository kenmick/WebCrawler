...
}B.atlas.define("icons-zindex",["jQuery"],function(f){var e,d="//q-ec.bstatic.com/static/img/map_sprites_omnibus_mk3/44f183b1860aa3035b88da99006cef42c70d8038.png",b={url:d,w:18,h:27,x:33,y:33,z:500};
...
}if(w.type==="land_mark"&&B.et.track("YdVNNeHHOIBeaT")){y.setIW({className:"iw-overlay-lp iw-overlay-geosearch-place"});
...
if(w.b_type==="land_mark"&&B.et.track("YdVNNeHHOIBeaT")){return
