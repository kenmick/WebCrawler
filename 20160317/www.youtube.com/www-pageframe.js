...
e.yt_hrd=k}var k=G("TIMING_INFO",{}),l;for(l in k)e[l]=k[l];l=e.srt;delete e.srt;var n;l||0===l||(n=Ri.timing||{},l=Math.max(0,n.responseStart-n.navigationStart),isNaN(l)&&e.pt&&(l=e.pt));if(l||0===l)e.srt=Math.round(l);e.h5jse&&(k=window.location.protocol+t("ytplayer.config.assets.js"),(k=Ri.getEntriesByName?Ri.getEntriesByName(k)[0]:null)?e.h5jse=Math.round(e.h5jse-k.responseEnd):delete e.h5jse);d.aft=Wi();k=d._start;if("cold"==e.yt_lt){n||(n=Ri.timing||{});var q;a:if(q=n,q.msFirstPaint)q=Math.max(0,
