...
h}var h=H("TIMING_INFO",{}),k;for(k in h)d[k]=h[k];k=d.srt;delete d.srt;var l;k||0===k||(l=S.timing||{},k=Math.max(0,l.responseStart-l.navigationStart),isNaN(k)&&d.pt&&(k=d.pt));if(k||0===k)d.srt=Math.round(k);d.h5jse&&(h=window.location.protocol+r("ytplayer.config.assets.js"),(h=S.getEntriesByName?S.getEntriesByName(h)[0]:null)?d.h5jse=Math.round(d.h5jse-h.responseEnd):delete d.h5jse);c.aft=ph();h=c._start;if("cold"==d.yt_lt){l||(l=S.timing||{});var n;a:if(n=l,n.msFirstPaint)n=Math.max(0,n.msFirstPaint);
else{var x=window.chrome;if(x&&(x=x.loadTimes,ga(x))){var x=x(),pa=1E3*Math.min(x.requestTime||Infinity,x.startLoadTime||Infinity),pa=Infinity===pa?0:n.navigationStart-pa;n=Math.max(0,Math.round(1E3*x.firstPaintTime+pa)||0);break a}n=0}0<n&&n>h&&(c.fpt=n);n=a||qh().span;x=l.redirectEnd-l.redirectStart;0<x&&(n.rtime_=x);x=l.domainLookupEnd-l.domainLookupStart;0<x&&(n.dns_=x);x=l.connectEnd-l.connectStart;0<x&&(n.tcp_=x);x=l.connectEnd-l.secureConnectionStart;l.secureConnectionStart>=l.navigationStart&&
0<x&&(n.stcp_=x);x=l.responseStart-l.requestStart;0<x&&(n.req_=x);x=l.responseEnd-l.responseStart;0<x&&(n.rcv_=x);S.getEntriesByType&&th(c);(l=H("SPEEDINDEX_FOR_ACTIONS",void 0))&&-1<l.indexOf(f)&&(l=rc(),f=eh(),l=rc()-l,0<f.Eb&&(d.si=f.Eb,c.vsc=uh(f.Yc),a.sid=l))}n=oh();l=n.pbr;f=n.vc;n=n.pbs;l&&f&&n&&l<f&&f<n&&1==qh().info.yt_vis&&"youtube"==e&&(qh().info.yt_lt="hot_bg",e=c.vc,l=c.pbs,delete c.aft,a.aft=Math.round(l-e));(e=H("PREVIOUS_ACTION"))&&(d.pa=e);d.p=H("CLIENT_PROTOCOL")||"unknown";d.t=
...
q("yt.timing.deferredPingTimer_",sb,void 0)):rh(b);R(dh,new ch(ta.aft+(k||0)))}}}
