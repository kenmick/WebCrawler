...
B[sNSExperiments]["HSCQQOcZQPPeae"]=(function(){var c={DOM_CHANGED:"GENERAL:dom_chaged",LAYOUT_CHANGED:"GENERAL:layout_changed",THROTTLED_SCROLL:"GENERAL:throttled_scroll",THROTTLED_RESIZE:"GENERAL:throttled_resize",HP_TAB_OPENED:"tab-opened",HEADER_LOGIN_TAB_SELECTED:"user_access_menu_register_tab",HEADER_REGISTER_TAB_SELECTED:"user_access_menu_login_tab",HEADER_POPOVER_SHOWN:"uc_popover_showed",HP_RT_LIGHTBOX_OPENED:"rt-lightbox-open",HP_RT_LIGHTBOX_CLOSED:"rt-lightbox-closed"};
...
if(B.track.getVariant("TDXbEBZeEGGTUDdWe")){B.require([],function(){var c=$(".gta-qr-code-placeholder");
...
n.unshift({b_ge_freebies:d[37],b_classname:d[101],b_ge_discount:d[37]});
p();
n.shift();
...
"use strict";
booking[sNSExperiments]["cQHDHOeWWbeEfHfGET"]=(function(c,e){function d(){if(e.env.b_ge_should_show_onboarding_on_login){booking.track.exp("cQHDHOeWWbeEfHfGET");
if(booking.track.getVariant("cQHDHOeWWbeEfHfGET")&&!e.env.b_ge_has_seen_onboarding_on_login){var f={b_genius_user:e.env.b_genius_user||{}};
...
},initElse:function(){var d;
$("."+c).bind("mouseenter",d=function(){$(this).unbind("mouseenter",d);
setTimeout(function(){B.track.exp(c)
},1000)
})
}}
