...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("TcAbhcO7SQ4kmX0QYnydYHxEKWk")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
}function Se(t){return"suggest2-item"===n?"highlight"===s?!1:De(t):De(t)}function De(){return void 0}function Pe(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Ze(t),void 0):Ie(t):Ie(t):Ie(t)
...
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=be(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var Z=X[Y];
