...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("Q_jwLpBPXoEx1tDiUsGFjRlssN4")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
}if("getLive"===e)return"input"===n?!!s==!1?Re(t):Ve(t):Ve(t);if("live"===e)return"input"===n?!!s==!1?Ne(t):Ve(t):Ve(t);
...
}return Ve(t)}return"default"===e?L(t):"env"===e?"i-global"===n?qe(t):Ve(t):"content"===e?P(t):"jsAttr"===e?$e(t):"tag"===e?C(t):"cls"===e?Fe(t):"bem"===e?De(t):Ve(t)
...
}if("notice"===e){var e=s;return"value"===e?"span":"count"===e?!t.ctx.url==!1?"a":"span":S(t)}if("checkbox"===e){var e=s;
return"control"===e?"input":"label"===e?"label":!!s==!1?"span":S(t)}if("b-link"===e)return!!s==!1?"a":S(t);
...
}if("tumbler"===e){var e=s;return"input"===e?"input":"label"===e?"label":"box"===e?"span":!!s==!1?"span":S(t)
}if("auth"===e){var e=s;return"social-link"===e?"a":"retpath"===e?"input":!!s==!1?"form":S(t)}if("link"===e)return"inner"===s?"span":!!s==!1?t.ctx.url?"a":"span":S(t);
if("ticker"===e){var e=s;return"value"===e||"text"===e?"span":S(t)}return S(t)}function D(t){return!!s==!1?"button":S(t)
}function S(){return void 0}function P(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:j(t);
...
}function j(t){return t.ctx.content}function L(t){var e=n;if("dropdown"===e)return"popup"===s?!(t.__$anflg33!==!0)==!1?R(t):Ve(t):Ve(t);
if("checkbox"===e)return N(t);if("button"===e)return $(t);if("input"===e)return F(t);if("auth"===e)return W(t);
...
}function R(t){var e=t.ctx,n=[{block:"dropdown",elem:"popup"}];e.mix&&(n=n.concat(e.mix));var s=t.__$anflg33;
...
var r=i;i="",Ie(t),t.ctx=o,i=r,t.__$anflg33=s}function N(t){return!(t.__$anflg32!==!0)==!1?!!s==!1?q(t):Ve(t):Ve(t)
...
t._labelId="label"+n;var c=t.ctx,h=c.mods;c.mods=s,N(t),t._checkboxAttrs=r,t._labelId=a,c.mods=h,t.__$anflg32=o
...
}function H(t){var e,n,s,o,a,c=(e=i,i="value",n=t.ctx,t.ctx=t.ctx.value,s=Oe(t),i=e,t.ctx=n,s),h=t.ctx.id||t.generateId(),u=t.ctx.mods||{},l=(o=i,i="getLive",a=Re(t),i=o,a);
...
}function De(t){return"suggest2-item"===n?"highlight"===s?!1:Se(t):Se(t)}function Se(){return void 0}function Pe(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Ze(t),void 0):Ie(t):Ie(t):Ie(t)
...
}function Re(t){var e,n,s=(e=i,i="live",n=Ne(t),i=e,n),o=t.ctx.js,r=t.ctx.mods,a={autofocus:"yes",width:"content","tap-ahead":"yes"};
...
}return s}function Ne(){return!1}function qe(t){return!!s==!1?{}:Ve(t)}function $e(){return void 0}function Fe(){return void 0
...
}return Xe(t)}function Ke(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,D,S,I,T,O=t.BEM,A=t.ctx,j=t._buf;
if(c=i,i="tag",v=C(t),i=c,T=v,"undefined"!=typeof T||(T=A.tag),"undefined"!=typeof T||(T="div"),T){var L,R;
n&&A.js!==!1&&(h=i,i="js",l=ye(t),i=h,R=l,R=R?t._.extend(A.js,R===!0?{}:R):A.js===!0?{}:A.js,R&&((L={})[O.INTERNAL.buildClass(n,A.elem)]=R)),j.push("<",T);
var N=(d=i,i="bem",p=De(t),i=d,p);"undefined"!=typeof N||(N="undefined"!=typeof A.bem?A.bem:A.block||A.elem);
var q=(f=i,i="cls",m=Fe(t),i=f,m);q||(q=A.cls);var $=A.block&&L&&!A.elem;if(N||q){if(j.push(' class="'),N){O.INTERNAL.buildClasses(n,A.elem,A.elemMods||A.mods,j);
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(S=i,i="content",I=P(t),i=S,I);if(ie||0===ie){var N=n||s,ne=t._notNewList;
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',D="allowScriptAccess",S="always",P="height",I="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",R=i(x,B)+i(O,1)+i(P,1)+i("id",L),N=!1;
...
}catch(P){}}return d=f?g?'<div style="'+B+'"><'+v+R+i("src",x)+i(I,T)+i(A,j)+i(D,S)+i("type",w)+"/></div>":(b?"<"+v+C+R+">"+e("movie",x):"<"+v+R+i("type",w)+i("data",x)+">")+e(I,T)+e(A,j)+e(D,S)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
},onElem:{inner:function(t){t.tag("span")}}}),_borschik("K6pRCa0RAnhUAefWhbjVl3FPEZc")&&!function(){var t=50,e=85,i=$.inherit($.observable,{alreadySent:{},children:[],__constructor:function(t){this.tree=t,this.send=$.debounce(this.send,500,this)
