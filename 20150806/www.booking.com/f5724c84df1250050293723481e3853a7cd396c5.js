...
}else{(function(j,h){if(window.sNSStartup&&j[sNSStartup]){j[sNSStartup].bComponents={priority:100,init:function(){j.require("component/loader").boot()
}}
}else{h(function(){j.require("component/loader").boot()
})
...
d.boot=function(){d.registerJQuery();
d.loadComponents()
}
});
...
c.prototype.getPayload=function(){var d={stype:B.env.b_site_type_id,page:B.env.b_action,placement:this.userParams.placement};
...
$(".review_useful_t").live("click",function(){if(B.track.getVariant("cDZKCBHeabDZWRFKMdYYHT")){B.track.custom_goal("cDZKCBHeabDZWRFKMdYYHT",1)
}create_twitter_short_url(this);
return false
});
$(".share_t").click(function(){if(B.track.getVariant("cDZKCBHeabDZWRFKMdYYHT")){B.track.custom_goal("cDZKCBHeabDZWRFKMdYYHT",2)
}create_twitter_short_url(this);
return false
})
}};
...
if(!(h===0||h===1)){return
}function k(){c.eventEmitter.bind("AUTOCOMPLETE:beforeAjax",function(m,l){if(h==1){l.params.mr=0.5
}d(g)
})
