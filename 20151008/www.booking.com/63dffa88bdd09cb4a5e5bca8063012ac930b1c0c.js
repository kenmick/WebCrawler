...
}else{g.find('input[name="suggestion_clicked"], input[name="suggested_term"]').remove();
...
s.menu.suggestedTerm="";
g.find('input[name="suggestion_clicked"], input[name="suggested_term"]').remove()
});
...
}if(l===2&&u.__suggestions__.updated_suggestion){s.menu.suggestedTerm=u.__suggestions__.updated_suggestion
...
b("ul.ui-autocomplete").delegate(".partition_item","click.search_rewrite",function(){s.menu.suggestedTerm=""
})
})
