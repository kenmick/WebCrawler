...
// WR version: 15.3
// Recording ratio: 0.5
// Generated on: 10/23/2015 11:13:07 AM (UTC 10/23/2015 4:13:07 PM)
...
ClickTaleCDNHTTPSRewrite('https://cdnssl.clicktale.net/www04/pcc/023bc397-b998-4163-acae-65e421c0d27e.js?DeploymentConfigName=Release_22102015&Version=1'):
'http://cdn.clicktale.net/www04/pcc/023bc397-b998-4163-acae-65e421c0d27e.js?DeploymentConfigName=Release_22102015&Version=1');
...
ctlib.doOnlyWhen(function(){
	...
	s_adobe.eVar73 = ClickTaleGetUID() + "." + ClickTaleGetPID();
    s_adobe.linkTrackVars = "eVar73";
    s_adobe.tl(true, "o", "ClickTale ID");
}, function () {
        if (window['jQuery'] && typeof jQuery.fn.on === 'function' && typeof jQuery.fn.one === 'function' && typeof ClickTaleIsRecording === 'function' && ClickTaleIsRecording() && typeof s_adobe != 'undefined') {
            return true;
        }
        return false;
}, 250, 40);
