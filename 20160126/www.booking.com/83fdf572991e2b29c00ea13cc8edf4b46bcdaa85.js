...
booking[sNSExperiments]["VOGPeYJMFKUVXZePWEYZLPNTWHT"]=(function(e,c){function d(){var g=c(".b-booker-type__input");
var h=c(".extra-business-field__container");
var f=c(".extra-business-field__input");
var j=c(".extra-business-field__icon");
g.click(function(){if(c(this).hasClass("b-booker-type__input_business-booker")){e.track.stage("VOGPeYJMFKUVXZePWEYZLPNTWHT",1);
h.removeClass("g-hidden")
}else{if(c(this).hasClass("b-booker-type__input_leisure-booker")){h.toggleClass("g-hidden",true);
f.attr("checked",false)
}}});
j.click(function(){if(f.prop("checked")){f.prop("checked",false)
...
if(B.track.getVariant(c)==2){$(".default_cur_lang_settings_content_wrapper [data-trigger]").click(function(){$($(this).data("trigger")).click();
return false
})
}}}
...
B.when({condition:B.env.b_site_type_id==1,events:["ready"]}).require(["et","search/destination/service-booking"],function(d,e){var c="PVdIOHHAVCMILFPWcZMO";
e.on("beforeajax",function(f,h){var g=d.track(c);
if(g){h.e_tbcc=g
}});
e.on("afterajax",function(f,h){var g=d.track(c);
