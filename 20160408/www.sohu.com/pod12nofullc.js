ï»¿var SohuTopad = function(beans){
		var tag = true;
    ...
    b.style.cssText ="position:absolute;z-index:101;top:"+beans.top+"px;width:100%;cursor: pointer;cursor:hand;margin:auto;left:0px;height:45px;";
     ...
     //                        full.empty();
					...
					// 		     var sohuFlash2 = new sohuFlash("http://images.sohu.com/bill/s2016/xiaoluanhao/04/tx/7604800407.swf","_LIUMEITI2",760,400,"7");
                    ...
                    var topad_reshow = jQuery("#flashbackground");
                    if(!!topad_reshow[0]){
                        ...
                        clearTimeout(SohuTopad.topad_timeout);
                        SohuTopad.topad_timeout = setTimeout(function() {
                            jQuery("#flashbackground").empty();
                            jQuery("<img src='http://images.sohu.com/bill/s2016/xiaoluanhao/04/tx/14185700408.jpg'>").appendTo("#flashbackground");
                        },8000)
...
//æ§å¶å¨å±
 ...
 //    	};
	...
	// 		img = null;
	// 	};
	// 	img.src = "http://imp.optaim.com/201510/e137558168e26ad06c69aaf28b315dae.php?a=0";//é²çæ¹è¿
	// 	setTimeout(function() {
	// 		isClose = true;
