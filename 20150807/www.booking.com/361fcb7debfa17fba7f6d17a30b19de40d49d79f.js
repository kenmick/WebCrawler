...
(function(d,c,a){var b={paging:function(e){var g={$tabButton:".rlp-main-section-tab__btn",$tabButtonActive:".rlp-main-section-tab__btn--active",$tabSectionContainer:".rlp-main-section-hotels--waterfall",callback:null};
var f=d.extend({},g,e);
return this.each(function(){var h=d(this);
d(f.$tabButton,this).bind("click",function(){var k=d(this);
var i=d(f.$tabButtonActive).index();
var j=k.index();
if(i!==j){d(f.$tabButtonActive,h).removeClass("rlp-main-section-tab__btn--active");
k.addClass("rlp-main-section-tab__btn--active");
d(f.$tabSectionContainer,h).eq(i).removeClass("rlp-main-section-hotels--tab-active-waterfall");
d(f.$tabSectionContainer,h).eq(j).addClass("rlp-main-section-hotels--tab-active-waterfall")
