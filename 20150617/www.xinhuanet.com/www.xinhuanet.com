...
--------------------------------------------------*/
/*.lazy{display: none;}*/
.lazy, .lazyIframe, .wloadIframeAD { background:#f1f1f1 url(http://www.news.cn/2015/img2015/Loading.gif) no-repeat 50% 50%; }
.fl { float: left; }
.fr { float: right; }
/* æ¸é¤æµ®å¨ */
...
.dataList06 li .img a { display: block; width: 60px; height: 60px; line-hei