...
K.on(K.EVENTS.IW_CLOSE,function(){$(".fly-dropdown.wl-dropdown").hide()
})
}})
...
}var F={type:"checkin",defaultDate:m.search.dates("checkin"),dayNames:I,monthNames:C,sundayFirst:E,title:u.transl_checkin_title,monthTitle:d,direction:u.rtl?"rtl":"ltr",arrow:true,onDateSelected:function(M,J){var O={year:J.getYear(),month:J.getMonth(),date:J.getDate()};
