...
if(booking.track.getVariant("HMeECeEFbLFHTdFPZFeDSUZRT")!==null){booking.track.exp("HMeECeEFbLFHTdFPZFeDSUZRT")
...
}$(".uc_language a.popover_trigger").click(function(){if(B.env.b_guest_country=="au"||B.env.b_guest_country=="nz"||B.env.b_guest_country=="ca"){booking.track.exp("YdVZHLbYFHQeFaMPLWEcIURe")
}})
};
