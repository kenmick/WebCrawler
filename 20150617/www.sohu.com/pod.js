var SohuTopad = function(beans){
    ...
    //beans.t = parseInt(beans.t) || parseInt(document.body.clientWidth * (150/1064));//¶¥²¿
    beans.t = parseInt(beans.t) || 150;//¶¥²¿
    ...
    b.style.cssText ="position:absolute;z-index:101;top:"+beans.top+"px;width:100%;cursor: pointer;cursor:hand;margin:auto;left:0px;height:45px;";
    	...
    	var replay_btn = this.replay_btn = jQuery('<div/>').attr('id', 'banner_replay').css({
			...
			var close_btn = this.close_btn = jQuery('<div/>').attr('id', 'banner_close').css({
				...
				'cursor': 'pointer',
				'z-index':100010000000001 ,
				'backgroundImage': 'url(http://images.sohu.com/bill/s2012/gates/all/close_h.png)'
			}).insertAfter(jQuery("#fullscreenad"));
    ...
    jQuery('#AdAction').attr('onclick','').click(eval(function(){
		window.open('http://clk.optaim.com/event.ng/Type=click&FlightID=201506&TargetID=sohu&Values=d007ec53,cad13b65,aacb9852,fb99fa1f&AdID=10141654');
	}));
...
//¿ØÖÆÈ«ÆÁ
    window["SHOW_"+"FULLSCREEN"] = function(){
		...
		img.src = "http://imp.optaim.com/201503/da21f60a55db556e3a56dbd00a40c344.php?a=0";//Â³Ñà¸ÄÕâ
		setTimeout(function() {
			isClose = true;
