...
}var _borschik=function(){var t=this._borschik||function(e){return!(e in t||t[e]++)};return t}();if(_borschik("arjLEeVk_K_C8C-yJ3Yv1Qk6bgU")){var BEMHTML=function(){function t(t){return t._mode=i,t.block=n,t.elem=s,t.elemMods=o,t.mods=r,t
...
}if("mix"===e)return be(t);if(""===e)return Pe(t);if("value"===e){var e=n;return"input"===e?Oe(t):"tumbler"===e?"option"===s?Le(t):Ve(t):Ve(t)
...
}return Ve(t)}return"default"===e?L(t):"env"===e?"i-global"===n?qe(t):Ve(t):"content"===e?P(t):"jsAttr"===e?$e(t):"tag"===e?C(t):"cls"===e?Fe(t):"bem"===e?Se(t):Ve(t)
...
}function D(){return void 0}function P(t){var e=n;if("suggest2"===e)return"title"===s?[{elem:"a11y",content:BEM.I18N("suggest2","group")+": "},t.ctx.content]:j(t);
...
return"box"===e?I(t):"ahead"===e?[{elem:"ahead-filler"},{elem:"ahead-hint"}]:j(t)}if("auth"===e){var e=s;
...
}function I(t){if(!(t.__$anflg27!==!0)==!1){if(!!r.clear==!1){var e,i;return[(e=t.__$anflg27,t.__$anflg27=!0,i=I(t),t.__$anflg27=e,i),{elem:"clear",elemMods:t._value||0===t._value?{visibility:"visible"}:void 0}]
...
if("suggest2-item"===e){var e=s;return"icon"===e?X(t):"fact"===e?Z(t):Ve(t)}return"select"===e?te(t):"popup"===e?re(t):"tumbler"===e?ce(t):"i-global"===e?_e(t):Ve(t)
...
var r=i;i="",Ie(t),t.ctx=o,i=r,t.__$anflg33=s}function R(t){return!(t.__$anflg32!==!0)==!1?!!s==!1?q(t):Ve(t):Ve(t)
...
var s=i;i="",Ie(t),t.ctx=n,i=s,t.__$anflg25=e}function z(t){return!(t.__$anflg12!==!0)==!1?!!s==!1?H(t):Ve(t):Ve(t)
...
}function W(t){return"retpath"===s?K(t):G(t)}function K(t){if(!(t.__$anflg24!==!0)==!1){var e=t.__$anflg24;
...
}return G(t)}function G(t){return!(t.__$anflg23!==!0)==!1?!!s==!1?Q(t):Ve(t):Ve(t)}function Q(t){var e,i,n,s;
...
}return Y(t)}return Y(t)}function Y(t){return!(t.__$anflg20!==!0)==!1?J(t):Ve(t)}function J(t){var e=t.ctx.png&&t.ctx.svg?t.ctx[BEM.blocks["i-ua"]&&BEM.blocks["suggest2-detect"].isSupportInlineSVG()?"svg":"png"]:t.ctx.svg||t.ctx.png;
e&&(t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+';background-image:url("'+e+'");'}));
var i=t.__$anflg20;t.__$anflg20=!0,X(t),t.__$anflg20=i}function Z(t){if(!(t.__$anflg19!==!0)==!1){if(!t.ctx.color==!1){t.ctx.attrs=t.extend(t.ctx.attrs||{},{style:((t.ctx.attrs||{}).style||"")+";color:"+t.ctx.color+";"});
var e=t.__$anflg19;return t.__$anflg19=!0,Z(t),t.__$anflg19=e,void 0}return Ve(t)}return Ve(t)}function te(t){return"group"===s?ee(t):ie(t)
...
var a=i;i="",Ie(t),t.ctx=r,i=a,t.__$anflg8=o}function le(t){if("yes"===(t.ctx.mods||{}).disabled){if(!(t.__$anflg6!==!0)==!1){if(!!s==!1){var e=t.__$anflg6;
...
}function Se(t){return"suggest2-item"===n?"highlight"===s?!1:De(t):De(t)}function De(){return void 0}function Pe(t){return"popup"===n?!t._popupDefaults==!1?!!s==!1?(delete t._popupDefaults,Je(t),void 0):Ie(t):Ie(t):Ie(t)
}function Ie(t){return!(t.__$anflg1!==!0)==!1?!!t["i-global"]==!1?Te(t):Ve(t):Ve(t)}function Te(t){for(var e,o,r,a,c,h,u,l,d={},p=["lang","tld","content-region","click-host","passport-host","pass-host","social-host","export-host","login","lego-static-host"];l=p.shift();)d[l]=(e=i,i="default",o=n,n="i-global",r=s,s=l,a=_e(t),i=e,n=o,s=r,a);
var f=(c=i,i="env",h=n,n="i-global",u=qe(t),i=c,n=h,u),m=t.__$anflg1;t.__$anflg1=!0;var _=t["i-global"];
t["i-global"]=t.extend(d,f),Pe(t),t["i-global"]=_,t.__$anflg1=m}function Oe(t){return!t.isSimple(t.ctx)==!1?!!s==!1?t.ctx:Ae(t):Ae(t)
}function Ae(t){if(!t.ctx==!1){if(!!s==!1){var e=[],n=t._buf;t._buf=e;var o=i;return i="",Ie(t),t._buf=n,i=o,e.join("")
...
var t=this._links[this.ctx.link];return __r0=this.ctx,this.ctx=t,__r1=e(Je,this),this.ctx=__r0,__r1}if(!a||!i._cacheLog)return n.call(t(i));
...
var n=t.ctx;return(n&&n!==!0||0===n)&&t._buf.push(n),void 0}return!!t.ctx==!1?(t._listLength--,void 0):!t._.isArray(t.ctx)==!1?Ge(t):Qe(t)
}return Xe(t)}function Ke(t){function e(t,e){return(t||"")+"__"+(e||"")}var a,c,h,l,d,p,f,m,_,g,b,v,y,k,M,E,w,x,B,S,D,I,T,O=t.BEM,A=t.ctx,j=t._buf;
...
for(var U=0;U<F.length;U++){var z=F[U];if(z){var H=z.block||z.elem,W=z.block||z._block||n,K=z.elem||z._elem||s,G=z.mods||r,Q=z.elemMods||{};
...
var X=(b=n,n=W,a=s,s=K,y=r,r=G,k=o,o=Q,M=i,i="mix",E=be(t),n=b,s=a,r=y,o=k,i=M,E);if(X)for(var Y=0;Y<X.length;Y++){var J=X[Y];
(J.block||J.elem)&&V[e(J.block,J.elem)]||(J._block=W,J._elem=K,F.splice(U+1,0,J))}}}}}}q&&j.push(R?" ":"",q),$&&j.push(" i-bem"),j.push('"')
}if(L){var Z=(w=i,i="jsAttr",x=$e(t),i=w,x);j.push(" ",Z||"data-bem",'="',t._.attrEscape(JSON.stringify(L)),'"')
...
}}if(t._.isShortTag(T))j.push("/>");else{T&&j.push(">");var ie=(D=i,i="content",I=P(t),i=D,I);if(ie||0===ie){var R=n||s,ne=t._notNewList;
t._notNewList=!1;var se=t.position;t.position=R?1:t.position;var oe=t._listLength;t._listLength=R?1:t._listLength;
var re=t.ctx;t.ctx=ie;var ae=i;i="",Pe(t),t._notNewList=ne,t.position=se,t._listLength=oe,t.ctx=re,i=ae
}T&&j.push("</",T,">")}}function Ge(t){var e=t.ctx,i=e.length,n=0,s=t.position,o=t._notNewList;for(o?t._listLength+=i-1:(t.position=0,t._listLength=i),t._notNewList=!0;i>n;){var r=e[n++],a=t.ctx;
t.ctx=null==r?"":r,Pe(t),t.ctx=a}o||(t.position=s)}function Qe(t){var e=t.ctx.block,a=t.ctx.elem,c=t._currBlock||n;
...
}function Xe(){throw new Error(this)}function Ye(t){return Je(t||this)}function Je(t){return h(t)}return!function(){function t(t){this.apply=t,this._buf=null,this.ctx=null,this._=this,this._start=!0,this._listLength=0,this._notNewList=!1,this._inside=!1,this.position=0
...
}function o(){var t=d.domain;return t&&n(t,/[^.]+\.[^.]{2,3}(\.tr)?$/,0)}t||(t={});var r,a,c,h,u=t.host||"kiks.yandex",l=window,d=document,p=navigator,f=p.userAgent,m=p.mimeTypes,_=9,g=f&&/gecko/i.test(f),b=f&&/MSIE/.test(f)&&/Win/.test(f),v=g?"embed":"object",y="//"+u.split(".").slice(0,-1).join(".")+".%s/system/fc%d.html",k="//"+u+".ru/system/%s%d.swf",M="//"+u+".ru/fu",E="//"+u+".ru/fu",w="application/x-shockwave-flash",x="style",B="position:absolute;margin-left:-999em;top:0;",C=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"',S="allowScriptAccess",D="always",P="height",I="wmode",T="window",O="width",A="bgcolor",j="#FFFFFF",L="ya_fc",N=i(x,B)+i(O,1)+i(P,1)+i("id",L),R=!1;
...
}catch(P){}}return d=f?g?'<div style="'+B+'"><'+v+N+i("src",x)+i(I,T)+i(A,j)+i(S,D)+i("type",w)+"/></div>":(b?"<"+v+C+N+">"+e("movie",x):"<"+v+N+i("type",w)+i("data",x)+">")+e(I,T)+e(A,j)+e(S,D)+"</"+v+">":'<img src="'+E.replace("%s",o())+'" style="'+B+'" />'
...
t.execute()}}),_borschik("S3rZ8rL-AZC-xAiQj7VGj3GJ_xM")&&BEM.DOM.decl("serp-item",{onSetMod:{js:function(){this.__base.apply(this,arguments);
...
for(var e,i=["title","target"];e=i.pop();)t.param(e)&&t.attr(e,t.param(e))}}),_borschik("MUpq9D2dAErd1HJcL8yG176Ivmw")&&BEM.DOM.decl("b-link"),_borschik("H1dCGwH6w0mbQGdFysrGvHzBQsk")&&BEM.DOM.decl("serp-url",{_showPopup:function(t){this._popup=this._popup||this.findBlockInside("popup2").setAnchor(t.data.domElem),this._popup&&this._popup.toggleMod("visible","yes")
...
var e=this.css("counter-reset");return e=e&&e.split(" ")||"",e[1===e.length?0:e.length-2]===t}})}(jQuery),_borschik("4IsucfDkDjO3Mb7-LVtQBL8pnbk")&&BEM.DOM.decl({block:"b-link",modName:"pseudo",modVal:"yes"},{_onClick:function(t){t.preventDefault(),this.hasMod("disabled","yes")||this.afterCurrentEvent(function(){this.trigger("click")
...
}}}):this.tests.push(function(){for(var t=e.documentElement.webkitShadowRoot||e.documentElement.shadowRoot,i=t?Array.apply(null,t.querySelectorAll("style")):[],n=Array.prototype.slice.call(e.querySelectorAll('head>style[type="text/css"]'),0),s=i.concat(n),o=0,r=s.length;r>o;o++){var a,u=s[o].sheet.cssRules;
