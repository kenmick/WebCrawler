...
define(['external/modernizr', 'jquery', 'modules/core/browser', 'modules/core/html', 'modules/core/i18n', 'modules/core/notify', 'modules/clean/components/ajax_form', 'modules/clean/em_string', 'modules/clean/gandalf_util', 'modules/clean/unity/features', 'modules/clean/unity/features/destiny_logger', 'modules/clean/unity/features/web_destiny'], function(Modernizr, $j, Browser, HTML, _arg, Notify, AjaxForm, Emstring, GandalfUtil, UnityFeatures, DestinyLogger, WebDestiny) {
  ...
  WebDestinyInterface = (function() {
    ...
    WebDestinyInterface.prototype._is_destiny_enabled = function() {
      return GandalfUtil.getGandalfRule("unity-web-destiny") && (WebDestiny != null) && (window.location.pathname === "/login" || GandalfUtil.getGandalfRule("unity-web-destiny-all-pages"));
    };
    ...
    WebDestinyInterface.prototype._web_destiny_login = function() {
      ...
      if (Browser.msie || !Modernizr.localstorage) {
