...
function chinaadclient_liumeiti_js(apcode){
 ...
 // var cellCount = parseInt(sec/8);// å³å®æ¾ç¤ºç¬¬å ä¸ªDIV,æ¯10ç§æ¾ç¤ºä¸ä¸ªå¹¿å
  ...
  if(typeof(referer)!=='undefined'&&referer!==''&&(referer.indexOf("360.cn")>0||referer.indexOf("qihoo.com")>0||referer.indexOf("so.com")>0|| referer.indexOf("haosou.com")>0 || referer.indexOf("duba.com")>0 || referer.indexOf("sports.china.com/iframe/")>0 || referer1.indexOf("sports.china.com/nba/news360/")>0 ) ){
