...
if(f.track.getVariant("cDPBDWATUZSdcJZCBXbDKe")){var i=f.clickStore.get$(this.$input);
if(i){f.track.stage("cDPBDWATUZSdcJZCBXbDKe",1);
if(f.track.getVariant("cDPBDWATUZSdcJZCBXbDKe")==2){this.toggle()
}}}};
