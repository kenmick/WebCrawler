...
define("js/fo/native/integration/card/integration", [ "require", "exports", "util/str", "util/resource", "util/informer", "omnitag/gostructs", "common/base", "lib/jquery", "card_variables", "native_card_css" ], function(e, t, n, i, r, o, a, s, l, c) {
    var d, g, h, f, m, C, u, p, v = s.jQuery, w = "ayl_native_card_", _ = function(e) {
        function t() {
        ...
        return __extends(t, e), t.prototype.insertTemplate = function() {
            ...
            var r = document.createElement("div");
            r.className = w + "logo", r.style.backgroundImage = "url(" + i.GetUrlDynamicImage(this.Config, this.Config.Content.Preview.Thumbnail.Image, 360, 360) + ")";
            var a = document.createElement("div");
            a.className = w + "txt";
            var s = document.createElement("div");
            s.className = w + "title", s.innerHTML = n.EscapeHTML(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.TITLE));
            var l = document.createElement("div");
            if (l.className = w + "desc", l.innerHTML = n.EscapeHTML(n.ChunkText(this.Config.Content.Preview.Text.Get(o.PreviewTranslationKind.DESCRIPTION), 200)), 
            a.appendChild(s), a.appendChild(l), this.Config.Content.Preview.Branding) {
                var c = document.createElement("div");
                if (c.className = w + "image", c.style.backgroundImage = "url(" + i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[0]) + ")", 
                this.Config.Content.Preview.Branding.Images.length > 1) {
                    var g = document.createElement("div");
                    g.className = w + "image_carousel";
                    var h = document.createElement("ul");
                    h.className = w + "carousel";
                    for (var f = this.Config.Content.Preview.Branding.Images, m = 0; m < f.length; m++) {
                        var C = document.createElement("li");
                        C.className = w + "carousel_li";
                        var u = document.createElement("img");
                        u.className = w + "carousel_image", u.src = i.GetUrlFromResourceImage(this.Config, this.Config.Content.Preview.Branding.Images[m]), 
                        C.appendChild(u), h.appendChild(C);
                    }
                    g.appendChild(h);
                    var p = document.createElement("div");
                    p.className = w + "left_arrow";
                    var v = document.createElement("div");
                    v.className = w + "right_arrow", this.isDesktop() && (g.appendChild(p), g.appendChild(v));
                }
            }
            ...
            this.Config.Content.Preview.Sponsor ? (E.appendChild(y), E.innerHTML += this.getCredit()) : (E.innerHTML += this.getCredit(), 
            y.setAttribute("style", "padding-left:3px"), E.appendChild(y)), t.appendChild(r), 
            t.appendChild(a), this.Config.Content.Preview.Branding && (this.Config.Content.Preview.Branding.Images.length > 1 ? t.appendChild(g) : t.appendChild(c)), 
            ...
            f = v("." + w + "carousel_li"), m = v("." + w + "image_carousel").width(), C = f.outerWidth(), 
            u = (m - C) / 2, this.sliderMove(u), g = v("#" + d), n = 0;
            ...
            f = v("." + w + "carousel_li"), C = f.outerHeight(), t.find("." + w + "left_arrow").css("height", C), 
            t.find("." + w + "right_arrow").css("height", C), e ? (0 != p ? t.find("." + w + "left_arrow").addClass("show_arrow") : t.find("." + w + "left_arrow").removeClass("show_arrow"), 
            p < n.length - 1 ? t.find("." + w + "right_arrow").addClass("show_arrow") : t.find("." + w + "right_arrow").removeClass("show_arrow")) : (t.find("." + w + "left_arrow").removeClass("show_arrow"), 
            ...
            n.find("." + w + "logo").click(function() {
                ...
                0 != p && (p--, e.sliderAction(), n.find("." + w + "right_arrow").addClass("show_arrow")), 
                0 == p && n.find("." + w + "left_arrow").removeClass("show_arrow");
            }), n.find("." + w + "right_arrow").click(function() {
                p < t.length - 1 && (p++, e.sliderAction(), n.find("." + w + "left_arrow").addClass("show_arrow")), 
                p == t.length - 1 && n.find("." + w + "right_arrow").removeClass("show_arrow");
            });
        }, t.prototype.Execute = function() {
