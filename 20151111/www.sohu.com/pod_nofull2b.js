var SohuTopad = function(beans){
    ...
    //beans.t = parseInt(beans.t) || parseInt(document.body.clientWidth * (150/1064));//æ¤¤å å´
    beans.t = parseInt(beans.t) || 150;//æ¤¤å å´
                        ...
                        if(!!full[0]){
                            ...
                            full.append("<div id='fullflash'></div>")
                             // full.show();//sohu_flash new
                                 var sohuFlash2 = new sohuFlash("http://images.sohu.com/bill/s2015/yanlu/taobao/1111/7604001111.swf","_LIUMEITI2",760,400,"7");
                            ...
                            jQuery("<div id='close' style='position:absolute;right:0px;height:20px;width:57px;background-color:red;opacity:0;filter:alpha(opacity=0);cursor:pointer;'></div>").prependTo(jQuery("#NEWFULL"));
                            jQuery("#close").live("click",function(){
                                jQuery("#NEWFULL").empty();
                            })
                        }
                    }
                });
...
//éºÑåéã¥ç
    window["SHOW_"+"FULLSCREEN"] = function(){
        ...
        img.src = "http://imp.optaim.com/201511/b3cf22532db5029d992e891192d66750.php?a=99";//æ¤´ä½ºåéç¡ç¹
        setTimeout(function() {
            isClose = true;
