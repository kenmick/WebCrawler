...
function Xd(a,b){b=b||{};for(var c in Yd){var d=G(Yd[c]),e;if(e=d){e=a;var f=void 0;f=window.location.href;var h=e.match(Hd)[1]||null,k=Id(e);h&&k?(e=e.match(Hd),f=f.match(Hd),e=e[3]==f[3]&&e[1]==f[1]&&e[4]==f[4]):e=k?Id(f)==k&&(Number(f.match(Hd)[4]||null)||null)==(Number(e.match(Hd)[4]||null)||null):!0;e||(e=c,f=G("CORS_HEADER_WHITELIST")||{},e=(h=Id(a))?(f=f[h])?A(f,e):!1:!0)}e&&(b[c]=d)}return b}
...
function $d(a,b){var c=b.format||"JSON";b.ff&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=G("XSRF_FIELD_NAME",void 0),e=G("XSRF_TOKEN",void 0),f=b.ac;f&&(f[d]&&delete f[d],a=Sd(a,f||{}));var h=b.postBody||"",f=b.S;Zd(a,b)&&(f||(f={}),f[d]=e);f&&u(h)&&(d=Rd(h),wb(d,f),h=Od(d));var k=!1,l,n=Wd(a,function(a){if(!k){k=!0;l&&J(l);var d=Vd(a),e=null;if(d||400<=a.status&&500>a.status)e=ae(c,a,b.df);if(d)a:{switch(c){case "XML":d=
...
function Le(a){var b=Me.bd;return b?Ne(a,function(a){return!b||u(a.className)&&A(a.className.split(/\s+/),b)},!0,void 0):null}
...
g.U=function(){return df(this).values};
g.isEmpty=function(){return!this.f.cookie};
g.X=function(){return this.f.cookie?(this.f.cookie||"").split(bf).length:0};
...
;function gf(a,b,c){var d=G("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=G("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=Id(window.location.href);e&&d.push(e);e=Id(a);if(A(d,e)||!e&&0==a.lastIndexOf("/",0)){var f=a.match(Hd),d=f[5],e=f[6],f=f[7],h="";d&&(h+=d);e&&(h+="?"+e);f&&(h+="#"+f);d=h;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e))d=G("SMALLER_SESSION_TEMPDATA_NAME")?"ST-"+Ka(d).toString(36):"s_tempdata-"+Ka(d),e=b?Od(b):"",ff(d,e,5),b&&(b=b.itct||b.ved,d=r("yt.logging.screenreporter.storeParentElement"),
...
x(kg,D);function lg(a,b,c,d){d=nc(v(d,a.h));b.addEventListener(c,d);a.f.push({target:b,name:c,Ib:d})}
kg.prototype.zb=function(a){for(var b=0;b<this.f.length;b++)if(this.f[b]==a){this.f.splice(b,1);a.target.removeEventListener(a.name,a.Ib);break}};
function mg(a){for(;a.f.length;){var b=a.f.pop();b.target.removeEventListener(b.name,b.Ib)}}
...
g=tg.prototype;g.X=function(){Bg(this);return this.h};
...
g.ra=function(){Bg(this);for(var a=this.f.U(),b=this.f.ra(),c=[],d=0;d<b.length;d++)for(var e=a[d],f=0;f<e.length;f++)c.push(b[d]);return c};
g.U=function(a){Bg(this);var b=[];if(u(a))Dg(this,a)&&(b=Xa(b,this.f.get(Cg(this,a))));else{a=this.f.U();for(var c=0;c<a.length;c++)b=Xa(b,a[c])}return b};
...
function Sg(a){if(!a.Ea){var b={};a.call(b);a.Ea=b.version}return a.Ea}
...
Q.prototype.toString=function(){return this.topic};var Ug=r("yt.pubsub2.instance_")||new F;F.prototype.subscribe=F.prototype.subscribe;F.prototype.unsubscribeByKey=F.prototype.qa;F.prototype.publish=F.prototype.D;F.prototype.clear=F.prototype.clear;q("yt.pubsub2.instance_",Ug,void 0);var Vg=r("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",Vg,void 0);var Wg=r("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",Wg,void 0);var Xg=r("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",Xg,void 0);
...
;var oh={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"drm.unavailable":5};function ph(a,b){D.call(this);this.A=this.o=a;this.ha=b;this.J=!1;this.h={};this.za=this.Z=null;this.ia=new F;gc(this,pa(E,this.ia));this.l={};this.B=this.Ma=this.j=this.Gb=this.f=null;this.sa=!1;this.K=this.F=this.P=this.R=null;this.Na={};this.Zc=["onReady"];this.ta=new kg(this);gc(this,pa(E,this.ta));this.Hb=null;this.gc=NaN;this.ua={};qh(this);this.wa("onDetailedError",v(this.Ud,this));this.wa("onTabOrderChange",v(this.md,this));this.wa("onTabAnnounce",v(this.hc,this));this.wa("WATCH_LATER_VIDEO_ADDED",
v(this.Vd,this));this.wa("WATCH_LATER_VIDEO_REMOVED",v(this.Wd,this));Af||(this.wa("onMouseWheelCapture",v(this.Rd,this)),this.wa("onMouseWheelRelease",v(this.Sd,this)));this.wa("onAdAnnounce",v(this.hc,this));this.N=new kg(this);gc(this,pa(E,this.N));this.Fb=!1;this.Eb=null}
x(ph,D);var rh=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=ph.prototype;g.cc=function(a,b){this.isDisposed()||(sh(this,a),b||th(this),uh(this,b),this.J&&vh(this))};
function sh(a,b){a.Gb=b;a.f=b.clone();a.j=a.f.attrs.id||a.j;"video-player"==a.j&&(a.j=a.ha,a.f.attrs.id=a.ha);a.A.id==a.j&&(a.j+="-player",a.f.attrs.id=a.j);a.f.args.enablejsapi="1";a.f.args.playerapiid=a.ha;a.Ma||(a.Ma=wh(a,a.f.args.jsapicallback||"onYouTubePlayerReady"));a.f.args.jsapicallback=null;var c=a.f.attrs.width;c&&(a.A.style.width=tf(Number(c)||c,!0));if(c=a.f.attrs.height)a.A.style.height=tf(Number(c)||c,!0)}
g.wd=function(){return this.Gb};
function vh(a){a.f.loaded||(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.h.loadVideoByPlayerVars(a.f.args):a.h.cueVideoByPlayerVars(a.f.args))}
...
g.Ge=function(){if(!this.sa){var a=yh(this);a&&"html5"==Bh(this)?(this.B="html5",this.J||this.Ta()):(Ch(this),this.B="html5",a&&this.P?(this.o.appendChild(this.P),this.Ta()):(this.f.loaded=!0,this.R=v(function(){var a=this.o,c=this.f.clone();r("yt.player.Application.create")(a,c);this.Ta()},this),this.sa=!0,a?this.R():(Dc(this.f.assets.js,this.R),Yf(this.f.assets.css))))}};
g.Fe=function(){var a=this.f.clone();if(!this.F){var b=Ah(this);b&&(this.F=document.createElement("span"),this.F.tabIndex=0,lg(this.ta,this.F,"focus",this.wc),this.K=document.createElement("span"),this.K.tabIndex=0,lg(this.ta,this.K,"focus",this.wc),b.parentNode&&b.parentNode.insertBefore(this.F,b),b.parentNode&&b.parentNode.insertBefore(this.K,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Bh(this))this.B="flash",this.J||Uf(a,!1,v(this.Ta,this));
else{Ch(this);this.B="flash";this.f.loaded=!0;b=this.o;b=u(b)?ye(b):b;a=mf(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=Pf.getInstance();Qf(c,a.minVersion)?(c=Vf(a,c),Tf(b,c,a)):Xf(b,a,c);this.Ta()}};
g.wc=function(){Ah(this).focus()};
function Ah(a){var b=xe(a.j);!b&&a.A&&a.A.querySelector&&(b=a.A.querySelector("#"+a.j));return b}
g.Ta=function(){if(!this.isDisposed()){var a=Ah(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.sa=!1,a.isNotServable&&a.isNotServable(this.f.args.video_id))zh(this);else{qh(this);this.J=!0;a=Ah(this);a.addEventListener&&(this.Z=Dh(this,a,"addEventListener"));a.removeEventListener&&(this.za=Dh(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.h[d]||(this.h[d]=Dh(this,a,d))}for(var e in this.l)this.Z(e,
this.l[e]);vh(this);this.Ma&&this.Ma(this.h);this.ia.D("onReady",this.h)}else this.gc=I(v(this.Ta,this),50)}};
function Dh(a,b,c){var d=b[c];return function(){try{return a.Hb=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Hb=e,pc(e,"WARNING"))}}}
function qh(a){a.J=!1;if(a.za)for(var b in a.l)a.za(b,a.l[b]);for(var c in a.ua)J(parseInt(c,10));a.ua={};a.Z=null;a.za=null;for(var d in a.h)a.h[d]=null;a.h.addEventListener=v(a.wa,a);a.h.removeEventListener=v(a.qe,a);a.h.destroy=v(a.dispose,a);a.h.getLastError=v(a.xd,a);a.h.getPlayerType=v(a.yd,a);a.h.getCurrentVideoConfig=v(a.wd,a);a.h.loadNewVideoConfig=v(a.cc,a);a.h.isReady=v(a.Se,a)}
g.Se=function(){return this.J};
g.wa=function(a,b){if(!this.isDisposed()){var c=wh(this,b);if(c){if(!A(this.Zc,a)&&!this.l[a]){var d=Eh(this,a);this.Z&&this.Z(a,d)}this.ia.subscribe(a,c);"onReady"==a&&this.J&&I(pa(c,this.h),0)}}};
g.qe=function(a,b){if(!this.isDisposed()){var c=wh(this,b);c&&this.ia.unsubscribe(a,c)}};
function wh(a,b){var c=b;if("string"==typeof b){if(a.Na[b])return a.Na[b];c=function(){var a=r(b);a&&a.apply(m,arguments)};
a.Na[b]=c}return c?c:null}
function Eh(a,b){var c="ytPlayer"+b+a.ha;a.l[b]=c;m[c]=function(c){var e=I(function(){if(!a.isDisposed()){a.ia.D(b,c);var f=a.ua,h=String(e);h in f&&delete f[h]}},0);
sb(a.ua,String(e))};
return c}
g.md=function(a){a=a?Fe:Ee;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.F||b==this.K||(b.focus(),b!=document.activeElement));)b=a(b)};
...
g.Rd=function(){this.Fb||(Ef?(this.Eb=Be(document),lg(this.N,window,"scroll",this.le),lg(this.N,this.o,"touchmove",this.fe)):(lg(this.N,this.o,"mousewheel",this.zc),lg(this.N,this.o,"wheel",this.zc)),this.Fb=!0)};
g.Sd=function(){mg(this.N);this.Fb=!1};
...
g.yd=function(){return this.B||Bh(this)};
g.xd=function(){return this.Hb};
function Bh(a){return(a=Ah(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function Ch(a){eh("dcp");a.cancel();qh(a);a.B=null;a.f&&(a.f.loaded=!1);var b=Ah(a);"html5"==Bh(a)?a.P=b:b&&b.destroy&&b.destroy();De(a.o);mg(a.ta);a.F=null;a.K=null}
g.cancel=function(){this.R&&Kc(this.f.assets.js,this.R);J(this.gc);this.sa=!1};
g.G=function(){Ch(this);if(this.P&&this.f)try{this.P.destroy()}catch(b){pc(b)}this.Na=null;for(var a in this.l)m[this.l[a]]=null;this.Gb=this.f=this.h=null;delete this.o;delete this.A;ph.I.G.call(this)};var Fh={},Gh="player_uid_"+(1E9*Math.random()>>>0);function Hh(a,b){a=u(a)?ye(a):a;b=mf(b);var c=Gh+"_"+ka(a),d=Fh[c];if(d)return d.cc(b),d.h;d=new ph(a,c);Fh[c]=d;K("player-added",d.h);gc(d,pa(Ih,d));I(function(){d.cc(b)},0);
return d.h}
function Ih(a){Fh[a.ha]=null}
function Jh(a){a=xe(a);if(!a)return null;var b=Gh+"_"+ka(a),c=Fh[b];c||(c=new ph(a,b),Fh[b]=c);return c.h}
...
N(document,"blur",si,!0);N(document,"change",si,!0);N(document,"click",si);N(document,"focus",si,!0);N(document,"mouseover",si);N(document,"mouseout",si);N(document,"mousedown",si);N(document,"keydown",si);N(document,"keyup",si);N(document,"keypress",si);N(document,"cut",si);N(document,"paste",si);qi&&(N(document,"touchstart",si),N(document,"touchend",si),N(document,"touchcancel",si));function ti(a){this.j=a;this.l={};this.Jc=[];this.o=[]}
...
x(yi,ti);ba(yi);g=yi.prototype;g.register=function(){wi(this,"mouseover",this.Wb);wi(this,"mouseout",this.eb);wi(this,"focus",this.vd);wi(this,"blur",this.ld);wi(this,"click",this.eb);wi(this,"touchstart",this.De);wi(this,"touchend",this.Rc);wi(this,"touchcancel",this.Rc)};
g.dispose=function(){for(var a in this.h)this.eb(this.h[a]);this.h={}};
g.Wb=function(a){if(!(this.f&&1E3>w()-this.f)){var b=parseInt(C(a,"tooltip-hide-timer"),10);b&&(Rb(a,"tooltip-hide-timer"),J(b));var b=v(function(){zi(this,a);Rb(a,"tooltip-show-timer")},this),c=parseInt(C(a,"tooltip-show-delay"),10)||0,b=I(b,c);
...
g.De=function(a,b,c){c.changedTouches&&(this.f=0,a=ri(b,ui(this),c.changedTouches[0].target),this.Wb(a))};
g.Rc=function(a,b,c){c.changedTouches&&(this.f=w(),a=ri(b,ui(this),c.changedTouches[0].target),this.eb(a))};
...
x(Gi,ti);ba(Gi);Gi.prototype.register=function(){wi(this,"click",this.nc);vi(this,ci,this.yc);vi(this,di,this.xc);vi(this,ei,this.de);vi(this,hi,this.yc);vi(this,ii,this.xc);vi(this,ji,this.je);vi(this,li,this.Qd);vi(this,mi,this.Pd)};
var Me={dc:"hover-enabled",$c:"yt-uix-button-subscribe",ad:"yt-uix-button-subscribed",Ue:"ypc-enabled",bd:"yt-uix-button-subscription-container",cd:"yt-subscription-button-disabled-mask-container"},Hi={Ve:"channel-external-id",ed:"subscriber-count-show-when-subscribed",fd:"subscriber-count-tooltip",gd:"subscriber-count-title",We:"href",ec:"is-subscribed",Ye:"parent-url",$e:"clicktracking",hd:"style-type",fc:"subscription-id",cf:"target",jd:"ypc-enabled"};g=Gi.prototype;
g.nc=function(a){var b=C(a,"href"),c=oi();if(b)a=C(a,"target")||"_self",window.open(b,a);else if(c){var b=C(a,"channel-external-id"),c=C(a,"clicktracking"),d;if(C(a,"ypc-enabled")){d=C(a,"ypc-item-type");var e=C(a,"ypc-item-id");d={itemType:d,itemId:e,subscriptionElement:a}}else d=null;e=C(a,"parent-url");if(C(a,"is-subscribed")){var f=C(a,"subscription-id");R(gi,new Yh(b,f,d,a,c,e))}else R(bi,new Wh(b,d,c,e))}else Ii(this,a)};
...
g.Pc=function(a,b,c){b?(Pb(a,Hi.ec,"true"),c&&Pb(a,Hi.fc,c)):(Rb(a,Hi.ec),Rb(a,Hi.fc));Ji(a)};
g.Oc=function(a,b){var c;c=Le(a);qe(c,Me.cd,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function Ji(a){var b=C(a,Hi.hd),c=!!C(a,"is-subscribed"),b="-"+b,d=Me.ad+b;qe(a,Me.$c+b,!c);qe(a,d,c);C(a,Hi.fd)&&!C(a,Hi.ed)&&(b=ui(yi.getInstance()),qe(a,b,!c),a.title=c?"":C(a,Hi.gd));c?I(function(){oe(a,Me.dc)},1E3):pe(a,Me.dc)}
g.pd=function(a){var b=!!C(a,"ypc-item-type"),c=!!C(a,"ypc-item-id");!C(a,"ypc-enabled")&&b&&c&&(oe(a,"ypc-enabled"),Pb(a,Hi.jd,"true"))};
g.od=function(a){C(a,"ypc-enabled")&&(pe(a,"ypc-enabled"),Rb(a,"ypc-enabled"))};
...
g.Oa=function(a,b,c){var d=Ki(this,a),d=Xa([d],ab(arguments,1));this.kd.apply(this,d)};
function Ii(a,b){var c=v(function(a){a.discoverable_subscriptions&&lc("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.nc(b)},a);
ni(c,"subscribe")}
...
;function Oi(){}
x(Oi,Ni);Oi.prototype.X=function(){var a=0;Tc(this.va(!0),function(){a++});
return a};
Oi.prototype.clear=function(){var a=Uc(this.va(!0)),b=this;y(a,function(a){b.remove(a)})};function Pi(a){this.f=a}
...
Si.prototype.h=function(a,b){p(b)?this.f.zd(a,M(b)):this.f.remove(a)};
...
function aj(){var a=bj;$i(a,a.f.va(!0))}
...
x(kk,V);var lk=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=kk.prototype;g.start=function(){!this.f&&isNaN(this.h)&&this.Ic()};
g.stop=function(){this.f&&(this.f.abort(),this.f=null);isNaN(this.h)||(J(this.h),this.h=NaN)};
g.G=function(){this.stop();kk.I.G.call(this)};
g.Ic=function(){this.h=NaN;this.f=$d(Sj(this.F,"/pairing/get_screen"),{method:"POST",S:{pairing_code:this.B},timeout:5E3,ca:v(this.Ke,this),onError:v(this.Je,this),gb:v(this.Le,this)})};
g.Ke=function(a,b){this.f=null;var c=b.screen||{};c.dialId=this.o;c.name=this.A;this.D("pairingComplete",new Hj(c))};
g.Je=function(a){this.f=null;a.status&&404==a.status?this.j>=lk.length?this.D("pairingFailed",Error("DIAL polling timed out")):(a=lk[this.j],this.h=I(v(this.Ic,this),a),this.j++):this.D("pairingFailed",Error("Server error "+a.status))};
...
Tj(a.h,c,{screen_ids:b.join(",")},v(a.Dd,a),v(a.Cd,a))}}
g.Dd=function(a){Ik(this);var b=this.screens.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}Kk(this,!b);b&&Ej(this.B,"Missed "+b+" lounge tokens.")};
g.Cd=function(a){Ej(this.B,"Requesting lounge tokens failed: "+a)};
...
x(Lk,V);g=Lk.prototype;g.start=function(){var a=parseInt(U("yt-remote-fast-check-period")||"0",10);(this.o=w()-144E5<a?0:a)?Nk(this):(this.o=w()+3E5,T("yt-remote-fast-check-period",this.o),this.Yb())};
...
function Nk(a){isNaN(a.j)||J(a.j);a.j=I(v(a.Yb,a),0<a.o&&a.o<w()?2E4:1E4)}
g.Yb=function(){J(this.j);this.j=NaN;this.h&&this.h.abort();var a=Rk(this);if(gb(a)){var b=Sj(this.B,"/pairing/get_screen_availability"),c={lounge_token:lb(a).join(",")};this.h=Tj(this.B,b,c,v(this.be,this,a),v(this.ae,this))}else Ok(this,{}),Nk(this)};
g.be=function(a,b){this.h=null;var c=lb(Rk(this));if(bb(c,lb(a))){for(var c=b.screens||[],d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;Ok(this,d);Nk(this)}else this.M("Changing Screen set during request."),this.Yb()};
...
g.Uc=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new kk(this.A,a,b,c);f.subscribe("pairingComplete",v(function(a){E(f);d(Uk(this,a))},this));
...
g.qc=function(a,b){for(var c=2,d=b(a,c);Wk(this,d);){c++;if(20<c)return a;d=b(a,c)}return d};
g.Ne=function(a,b,c,d){$d(Sj(this.A,"/pairing/get_screen"),{method:"POST",S:{pairing_code:a},timeout:5E3,ca:v(function(a,d){var h=new Hj(d.screen||{});if(!h.name||Wk(this,h.name))h.name=this.qc(h.name,b);c(Uk(this,h))},this),
...
g.Ed=function(){Xk(this);this.D("screenChange");this.f.update()};
function Sk(a){Yk(a);a.h=new Hk(a.A);a.h.subscribe("screenChange",v(a.Ed,a));Xk(a);a.j=Nj(U("yt-remote-automatic-screen-cache")||[]);Yk(a);a.info("Initializing automatic screens: "+Pj(a.j));a.f=new Lk(a.A,v(a.$,a,!0));a.f.subscribe("screenChange",v(function(){this.D("onlineScreenChange")},a))}
...
g.G=function(){this.$b("");Zk.I.G.call(this)};function al(a,b){Zk.call(this,a,b,"CastSession");this.f=null;this.A=0;this.o=null;this.F=v(this.Oe,this);this.B=v(this.me,this);this.A=I(v(function(){bl(this,null)},this),12E4)}
x(al,Zk);g=al.prototype;g.Zb=function(a){if(this.f){if(this.f==a)return;$k(this,"Overriding cast sesison with new session object");this.f.removeUpdateListener(this.F);this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.B)}this.f=a;this.f.addUpdateListener(this.F);this.f.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.B);this.o&&cl(this);dl(this,"getMdxSessionStatus")};
g.Sa=function(a){this.info("launchWithParams: "+M(a));this.o=a;this.f&&cl(this)};
...
g.$b=t;g.G=function(){this.info("disposeInternal");J(this.A);this.A=0;this.f&&(this.f.removeUpdateListener(this.F),this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.B));this.f=null;al.I.G.call(this)};
...
function bl(a,b){J(a.A);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.j||a.j.id!=b){var c=v(a.ub,a),d=v(a.aa,a);a.pc(b,c,d,5)}}else a.aa(Error("Waiting for session status timed out."))}
g.pc=function(a,b,c,d){Tk(this.K,this.h.label,a,this.h.friendlyName,v(function(e){e?b(e):0<=d?($k(this,"Screen "+a+" appears to be offline. "+d+" retries left."),I(v(this.pc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.Wc=function(){return this.f};
g.Oe=function(a){this.isDisposed()||a||($k(this,"Cast session died."),this.aa())};function el(a,b){Zk.call(this,a,b,"DialSession");this.A=this.J=null;this.N="";this.o=null;this.F=t;this.B=NaN;this.P=v(this.Re,this);this.f=t}
x(el,Zk);g=el.prototype;g.Zb=function(a){this.A=a;this.A.addUpdateListener(this.P)};
...
function fl(a){a.f=a.K.Uc(a.N,a.h.label,a.h.friendlyName,v(function(a){this.f=t;this.ub(a)},a),v(function(a){this.f=t;
this.aa(a)},a))}
g.Re=function(a){this.isDisposed()||a||($k(this,"DIAL session died."),this.f(),this.f=t,this.aa())};
function gl(a){var b={};b.pairingCode=a.N;if(a.o){var c=a.o.index||0,d=a.o.currentTime||0;b.v=a.o.videoId||a.o.videoIds[c];b.t=d}Gk()&&(b.env_useStageMdx=1);return Od(b)}
g.Ub=function(a){this.N=Xj();if(this.o){var b=new chrome.cast.DialLaunchResponse(!0,gl(this));a(b);fl(this)}else this.F=v(function(){J(this.B);this.F=t;this.B=NaN;var b=new chrome.cast.DialLaunchResponse(!0,gl(this));a(b);fl(this)},this),this.B=I(v(function(){this.F()},this),100)};
g.Fd=function(a,b){Tk(this.K,this.J.receiver.label,a,this.h.friendlyName,v(function(a){a&&a.token?(this.ub(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Ub(b)},this),v(function(a){$k(this,"Failed to get DIAL screen: "+a);
this.Ub(b)},this))};function hl(a,b){Zk.call(this,a,b,"ManualSession");this.f=I(v(this.Sa,this,null),150)}
x(hl,Zk);hl.prototype.stop=function(){this.aa()};
hl.prototype.Zb=t;hl.prototype.Sa=function(){J(this.f);this.f=NaN;var a=fk(this.K.$(),this.h.label);a?this.ub(a):this.aa(Error("No such screen"))};
...
Aj(jl),this.h.subscribe("onlineScreenChange",v(this.Vc,this)),this.j=kl(this),chrome.cast.setCustomReceivers(this.j,t,v(function(a){this.M("Failed to set initial custom receivers: "+M(a))},this)),this.D("yt-remote-cast2-availability-change",ll(this)),b(!0))},this),v(function(a){this.M("Failed to initialize API: "+M(a));
b(!1)},this))};
...
ml("setConnectedScreenStatus: new active receiver: "+d.friendlyName);ol(this,new hl(this.h,d),!0)}this.f.$b(b)}else ml("setConnectedScreenStatus: no screen.")};
...
g.G=function(){this.h.unsubscribe("onlineScreenChange",v(this.Vc,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.o);Dj(jl);E(this.f);il.I.G.call(this)};
...
function ol(a,b,c){E(a.f);(a.f=b)?(c?a.D("yt-remote-cast2-receiver-resumed",b.h):a.D("yt-remote-cast2-receiver-selected",b.h),b.subscribe("sessionScreen",v(a.Dc,a,b)),b.j?a.D("yt-remote-cast2-session-change",b.j):c&&a.f.Sa(null)):a.D("yt-remote-cast2-session-change",null)}
g.Dc=function(a,b){this.f==a&&(b||ol(this,null),this.D("yt-remote-cast2-session-change",b))};
...
g.Cc=function(a){if(!this.isDisposed()){ml("New cast session ID: "+a.sessionId);var b=a.receiver;if(b.receiverType!=chrome.cast.ReceiverType.CUSTOM){if(!this.f)if(b.receiverType==chrome.cast.ReceiverType.CAST)ml("Got resumed cast session before resumed mdx connection."),ol(this,new al(this.h,b),!0);else{this.M("Got non-cast session without previous mdx receiver event, or mdx resume.");return}var c=this.f.h,d=fk(this.h.$(),c.label);d&&Ij(d,b.label)&&c.receiverType!=chrome.cast.ReceiverType.CAST&&b.receiverType==
chrome.cast.ReceiverType.CAST&&(ml("onSessionEstablished_: manual to cast session change "+b.friendlyName),E(this.f),this.f=new al(this.h,b),this.f.subscribe("sessionScreen",v(this.Dc,this,this.f)),this.f.Sa(null));this.f.Zb(a)}}};
...
function kl(a){var b=a.h.Tc(),c=a.f&&a.f.h;a=z(b,function(a){c&&Ij(a,c.label)&&(c=null);var b=a.f?a.f:a.id,f=nl(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a}
g.Vc=function(){if(!this.isDisposed()){var a=ll(this);this.j=kl(this);ml("Updating custom receivers: "+M(this.j));chrome.cast.setCustomReceivers(this.j,t,v(function(){this.M("Failed to set custom receivers.")},this));
...
dm.prototype.get=function(){return this.f};function em(a,b){this.type=a;this.currentTarget=this.target=b;this.defaultPrevented=!1;this.Mc=!0}
em.prototype.preventDefault=function(){this.defaultPrevented=!0;this.Mc=!1};var fm=!L||wd(9),gm=L&&!vd("9");!ld||vd("528");kd&&vd("1.9b")||L&&vd("8")||id&&vd("9.5")||ld&&vd("528");kd&&!vd("8")||L&&vd("9");function hm(a,b){em.call(this,a?a.type:"");this.relatedTarget=this.currentTarget=this.target=null;this.charCode=this.keyCode=this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.f=this.state=null;a&&this.init(a,b)}
x(hm,em);
...
function om(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Ua&&f.listener==b&&f.nb==!!c&&f.rb==d)return e}return-1}
...
return a[Em]}
;function Fm(){D.call(this);this.j=new mm(this);this.za=this;this.ia=null}
...
function Gm(a,b){var c,d=a.ia;if(d){c=[];for(var e=1;d;d=d.ia)c.push(d),++e}var d=a.za,e=b,f=e.type||e;if(u(e))e=new em(e,d);else if(e instanceof em)e.target=e.target||d;else{var h=e,e=new em(f,d);wb(e,h)}var h=!0,k;if(c)for(var l=c.length-1;0<=l;l--)k=e.currentTarget=c[l],h=Hm(k,f,!0,e)&&h;k=e.currentTarget=d;h=Hm(k,f,!0,e)&&h;h=Hm(k,f,!1,e)&&h;if(c)for(l=0;l<c.length;l++)k=e.currentTarget=c[l],h=Hm(k,f,!1,e)&&h}
g.G=function(){Fm.I.G.call(this);this.removeAllListeners();this.ia=null};
...
function Hm(a,b,c,d){b=a.j.f[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var h=b[f];if(h&&!h.Ua&&h.nb==c){var k=h.listener,l=h.rb||h.src;h.lb&&pm(a.j,h);e=!1!==k.call(l,d)&&e}}return e&&0!=d.Mc}
...
Jm.prototype.J=function(a){this.f=0;Km(this,2,a)};
Jm.prototype.Y=function(a){this.f=0;Km(this,3,a)};
function Km(a,b,c){if(0==a.f){a==c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;var d;a:{var e=c,f=a.J,h=a.Y;if(e instanceof Jm)Um(e,Nm(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ia(e))try{var l=e.then;if(ha(l)){Wm(e,l,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.B=c,a.f=b,a.j=null,Vm(a),3!=b||c instanceof Qm||Xm(a,c))}}
...
g=nn.prototype;g.Ia=null;g.na=!1;g.Wa=null;g.bc=null;g.ib=null;g.Va=null;g.Aa=null;g.Da=null;g.Ka=null;g.O=null;g.kb=0;g.oa=null;g.Cb=null;g.Ja=null;g.cb=-1;g.Nc=!0;g.Fa=!1;g.Sb=0;g.wb=null;var on={},pn={};g=nn.prototype;g.setTimeout=function(a){this.o=a};
function qn(a,b,c){a.Va=1;a.Aa=Gg(b.clone());a.Ka=c;a.A=!0;rn(a,null)}
function sn(a,b,c,d,e){a.Va=1;a.Aa=Gg(b.clone());a.Ka=null;a.A=c;e&&(a.Nc=!1);rn(a,d)}
function rn(a,b){a.ib=w();tn(a);a.Da=a.Aa.clone();Eg(a.Da,"t",a.B);a.kb=0;a.O=a.f.Lb(a.f.jb()?b:null);0<a.Sb&&(a.wb=new cn(v(a.Sc,a,a.O),a.Sb));a.l.sb(a.O,"readystatechange",a.oe);var c=a.Ia?tb(a.Ia):{};a.Ka?(a.Cb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.O.send(a.Da,a.Cb,a.Ka,c)):(a.Cb="GET",a.Nc&&!ld&&(c.Connection="close"),a.O.send(a.Da,a.Cb,null,c));a.f.ma(1)}
g.oe=function(a){a=a.target;var b=this.wb;b&&3==un(a)?b.sd():this.Sc(a)};
g.Sc=function(a){try{if(a==this.O)a:{var b=un(this.O),c=this.O.o,d=this.O.getStatus();if(L&&!wd(10)||ld&&!vd("420+")){if(4>b)break a}else if(3>b||3==b&&!id&&!vn(this.O))break a;this.Fa||4!=b||7==c||(8==c||0>=d?this.f.ma(3):this.f.ma(2));wn(this);var e=this.O.getStatus();this.cb=e;var f=vn(this.O);(this.na=200==e)?(4==b&&xn(this),this.A?(yn(this,b,f),id&&this.na&&3==b&&(this.l.sb(this.h,"tick",this.ne),this.h.start())):zn(this,f),this.na&&!this.Fa&&(4==b?this.f.tb(this):(this.na=!1,tn(this)))):(this.Ja=
400==e&&0<f.indexOf("Unknown SID")?3:0,X(),xn(this),An(this))}}catch(h){this.O&&vn(this.O)}finally{}};
function yn(a,b,c){for(var d=!0;!a.Fa&&a.kb<c.length;){var e=Bn(a,c);if(e==pn){4==b&&(a.Ja=4,X(),d=!1);break}else if(e==on){a.Ja=4;X();d=!1;break}else zn(a,e)}4==b&&0==c.length&&(a.Ja=1,X(),d=!1);a.na=a.na&&d;d||(xn(a),An(a))}
g.ne=function(){var a=un(this.O),b=vn(this.O);this.kb<b.length&&(wn(this),yn(this,a,b),this.na&&4!=a&&tn(this))};
...
g.he=function(a){this.Fa||(wn(this),zn(this,a),tn(this))};
g.Gc=function(a){Dn(v(this.ge,this,a),0)};
g.ge=function(a){this.Fa||(xn(this),this.na=a,this.f.tb(this),this.f.ma(4))};
g.cancel=function(){this.Fa=!0;xn(this)};
function tn(a){a.bc=w()+a.o;En(a,a.o)}
function En(a,b){if(null!=a.Wa)throw Error("WatchDog timer not null");a.Wa=Dn(v(a.ke,a),b)}
function wn(a){a.Wa&&(m.clearTimeout(a.Wa),a.Wa=null)}
g.ke=function(){this.Wa=null;var a=w();0<=a-this.bc?(2!=this.Va&&this.f.ma(3),xn(this),this.Ja=2,X(),An(this)):En(this,this.bc-a)};
function An(a){a.f.tc()||a.Fa||a.f.tb(a)}
function xn(a){wn(a);E(a.wb);a.wb=null;a.h.stop();a.l.removeAll();if(a.O){var b=a.O;a.O=null;Fn(b);b.dispose()}a.oa&&(a.oa=null)}
function zn(a,b){try{a.f.Bc(a,b),a.f.ma(4)}catch(c){}}
...
g=Jn.prototype;g.Qb=null;g.da=null;g.xb=!1;g.Qc=null;g.ob=null;g.Vb=null;g.Rb=null;g.fa=null;g.ya=-1;g.bb=null;g.Xa=null;g.connect=function(a){this.Rb=a;a=Kn(this.f,null,this.Rb);X();this.Qc=w();var b=this.f.F;null!=b?(this.bb=b[0],(this.Xa=b[1])?(this.fa=1,Ln(this)):(this.fa=2,Mn(this))):(Eg(a,"MODE","init"),this.da=new nn(this,0,void 0,void 0,void 0),this.da.Ia=this.Qb,sn(this.da,a,!1,null,!0),this.fa=0)};
function Ln(a){var b=Kn(a.f,a.Xa,"/mail/images/cleardot.gif");Gg(b);Gn(b.toString(),5E3,v(a.nd,a),3,2E3);a.ma(1)}
g.nd=function(a){if(a)this.fa=2,Mn(this);else{X();var b=this.f;b.ka=b.Ba.ya;Nn(b,9)}a&&this.ma(2)};
function Mn(a){var b=a.f.J;if(null!=b)X(),b?(X(),On(a.f,a,!1)):(X(),On(a.f,a,!0));else if(a.da=new nn(a,0,void 0,void 0,void 0),a.da.Ia=a.Qb,b=a.f,b=Kn(b,b.jb()?a.bb:null,a.Rb),X(),!L||wd(10))Eg(b,"TYPE","xmlhttp"),sn(a.da,b,!1,a.bb,!1);else{Eg(b,"TYPE","html");var c=a.da;a=!!a.bb;c.Va=3;c.Aa=Gg(b.clone());Cn(c,a)}}
g.Lb=function(a){return this.f.Lb(a)};
g.tc=function(){return!1};
g.Bc=function(a,b){this.ya=a.cb;if(0==this.fa)if(b){try{var c=this.h.parse(b)}catch(d){c=this.f;c.ka=this.ya;Nn(c,2);return}this.bb=c[0];this.Xa=c[1]}else c=this.f,c.ka=this.ya,Nn(c,2);else if(2==this.fa)if(this.xb)X(),this.Vb=w();else if("11111"==b){if(X(),this.xb=!0,this.ob=w(),c=this.ob-this.Qc,!L||wd(10)||500>c)this.ya=200,this.da.cancel(),X(),On(this.f,this,!0)}else X(),this.ob=this.Vb=w(),this.xb=!1};
g.tb=function(){this.ya=this.da.cb;if(this.da.na)0==this.fa?this.Xa?(this.fa=1,Ln(this)):(this.fa=2,Mn(this)):2==this.fa&&(a=!1,(a=!L||wd(10)?this.xb:200>this.Vb-this.ob?!1:!0)?(X(),On(this.f,this,!0)):(X(),On(this.f,this,!1)));else{0==this.fa?X():2==this.fa&&X();var a=this.f;a.ka=this.ya;Nn(a,2)}};
g.jb=function(){return this.f.jb()};
g.isActive=function(){return this.f.isActive()};
g.ma=function(a){this.f.ma(a)};function Pn(a){Fm.call(this);this.headers=new Vc;this.R=a||null;this.h=!1;this.P=this.f=null;this.sa=this.J="";this.o=0;this.A="";this.l=this.ha=this.F=this.Z=!1;this.B=0;this.K=null;this.ta="";this.N=this.ua=!1}
x(Pn,Fm);var Qn=/^https?$/i,Rn=["POST","PUT"];g=Pn.prototype;
g.send=function(a,b,c,d){if(this.f)throw Error("[goog.net.XhrIo] Object is active with another request="+this.J+"; newUri="+a);b=b?b.toUpperCase():"GET";this.J=a;this.A="";this.o=0;this.sa=b;this.Z=!1;this.h=!0;this.f=this.R?mn(this.R):mn(kn);this.P=this.R?hn(this.R):hn(kn);this.f.onreadystatechange=v(this.Ac,this);try{cm(Sn(this,"Opening Xhr")),this.ha=!0,this.f.open(b,String(a),!0),this.ha=!1}catch(f){cm(Sn(this,"Error opening Xhr: "+f.message));Tn(this,f);return}a=c||"";var e=this.headers.clone();
...
function Vn(a){a.f&&a.N&&(a.f.ontimeout=null);ga(a.K)&&(m.clearTimeout(a.K),a.K=null)}
...
function Sn(a,b){return b+" ["+a.sa+" "+a.J+" "+a.getStatus()+"]"}
;function $n(a,b,c){this.B=a||null;this.f=1;this.h=[];this.l=[];this.o=new Im(null,!0);this.F=b||null;this.J=null!=c?c:null}
function ao(a,b){this.f=a;this.map=b;this.context=null}
g=$n.prototype;g.$a=null;g.W=null;g.L=null;g.Pb=null;g.pb=null;g.ic=null;g.qb=null;g.fb=0;g.Hd=0;g.T=null;g.Ca=null;g.xa=null;g.Ha=null;g.Ba=null;g.Bb=null;g.Ra=-1;g.uc=-1;g.ka=-1;g.ab=0;g.Pa=0;g.Ga=8;var bo=new Fm;function co(a){em.call(this,"statevent",a)}
x(co,em);function eo(a,b){em.call(this,"timingevent",a);this.size=b}
x(eo,em);function fo(a){em.call(this,"serverreachability",a)}
x(fo,em);g=$n.prototype;g.connect=function(a,b,c,d,e){X();this.Pb=b;this.$a=c||{};d&&p(e)&&(this.$a.OSID=d,this.$a.OAID=e);this.Ba=new Jn(this);this.Ba.Qb=null;this.Ba.h=this.o;this.Ba.connect(a)};
function go(a){ho(a);if(3==a.f){var b=a.fb++,c=a.pb.clone();O(c,"SID",a.j);O(c,"RID",b);O(c,"TYPE","terminate");io(a,c);b=new nn(a,0,a.j,b,void 0);b.Va=2;b.Aa=Gg(c.clone());(new Image).src=b.Aa;b.ib=w();tn(b)}jo(a)}
function ho(a){if(a.Ba){var b=a.Ba;b.da&&(b.da.cancel(),b.da=null);b.ya=-1;a.Ba=null}a.L&&(a.L.cancel(),a.L=null);a.xa&&(m.clearTimeout(a.xa),a.xa=null);ko(a);a.W&&(a.W.cancel(),a.W=null);a.Ca&&(m.clearTimeout(a.Ca),a.Ca=null)}
function lo(a,b){if(0==a.f)throw Error("Invalid operation: sending map when state is closed");a.h.push(new ao(a.Hd++,b));2!=a.f&&3!=a.f||mo(a)}
g.tc=function(){return 0==this.f};
function mo(a){a.W||a.Ca||(a.Ca=Dn(v(a.Fc,a),0),a.ab=0)}
g.Fc=function(a){this.Ca=null;no(this,a)};
function no(a,b){if(1==a.f){if(!b){a.fb=Math.floor(1E5*Math.random());var c=a.fb++,d=new nn(a,0,"",c,void 0);d.Ia=null;var e=oo(a),f=a.pb.clone();O(f,"RID",c);a.B&&O(f,"CVER",a.B);io(a,f);qn(d,f,e);a.W=d;a.f=2}}else 3==a.f&&(b?po(a,b):0!=a.h.length&&(a.W||po(a)))}
function po(a,b){var c,d;b?6<a.Ga?(a.h=a.l.concat(a.h),a.l.length=0,c=a.fb-1,d=oo(a)):(c=b.F,d=b.Ka):(c=a.fb++,d=oo(a));var e=a.pb.clone();O(e,"SID",a.j);O(e,"RID",c);O(e,"AID",a.Ra);io(a,e);c=new nn(a,0,a.j,c,a.ab+1);c.Ia=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.W=c;qn(c,e,d)}
function io(a,b){if(a.T){var c=a.T.oc(a);c&&eb(c,function(a,c){O(b,c,a)})}}
function oo(a){var b=Math.min(a.h.length,1E3),c=["count="+b],d;6<a.Ga&&0<b?(d=a.h[0].f,c.push("ofs="+d)):d=0;for(var e=0;e<b;e++){var f=a.h[e].f,h=a.h[e].map,f=6>=a.Ga?e:f-d;try{cd(h,function(a,b){c.push("req"+f+"_"+b+"="+encodeURIComponent(a))})}catch(k){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.l=a.l.concat(a.h.splice(0,b));
return c.join("&")}
function qo(a){a.L||a.xa||(a.A=1,a.xa=Dn(v(a.Ec,a),0),a.Pa=0)}
function ro(a){if(a.L||a.xa||3<=a.Pa)return!1;a.A++;a.xa=Dn(v(a.Ec,a),so(a,a.Pa));a.Pa++;return!0}
g.Ec=function(){this.xa=null;this.L=new nn(this,0,this.j,"rpc",this.A);this.L.Ia=null;this.L.Sb=0;var a=this.ic.clone();O(a,"RID","rpc");O(a,"SID",this.j);O(a,"CI",this.Bb?"0":"1");O(a,"AID",this.Ra);io(this,a);if(!L||wd(10))O(a,"TYPE","xmlhttp"),sn(this.L,a,!0,this.qb,!1);else{O(a,"TYPE","html");var b=this.L,c=!!this.qb;b.Va=3;b.Aa=Gg(a.clone());Cn(b,c)}};
function On(a,b,c){a.Bb=c;a.ka=b.ya;a.qd(1,0);a.pb=Kn(a,null,a.Pb);mo(a)}
g.Bc=function(a,b){if(0!=this.f&&(this.L==a||this.W==a))if(this.ka=a.cb,this.W==a&&3==this.f)if(7<this.Ga){var c;try{c=this.o.parse(b)}catch(f){c=null}if(ea(c)&&3==c.length)if(0==c[0])a:{if(!this.xa){if(this.L)if(this.L.ib+3E3<this.W.ib)ko(this),this.L.cancel(),this.L=null;else break a;ro(this);X()}}else this.uc=c[1],0<this.uc-this.Ra&&37500>c[2]&&this.Bb&&0==this.Pa&&!this.Ha&&(this.Ha=Dn(v(this.Id,this),6E3));else Nn(this,11)}else"y2f%"!=b&&Nn(this,11);else if(this.L==a&&ko(this),!/^[\s\xa0]*$/.test(b)){c=
this.o.parse(b);ea(c);for(var d=0;d<c.length;d++){var e=c[d];this.Ra=e[0];e=e[1];2==this.f?"c"==e[0]?(this.j=e[1],this.qb=e[2],e=e[3],null!=e?this.Ga=e:this.Ga=6,this.f=3,this.T&&this.T.mc(this),this.ic=Kn(this,this.jb()?this.qb:null,this.Pb),qo(this)):"stop"==e[0]&&Nn(this,7):3==this.f&&("stop"==e[0]?Nn(this,7):"noop"!=e[0]&&this.T&&this.T.lc(this,e),this.Pa=0)}}};
g.Id=function(){null!=this.Ha&&(this.Ha=null,this.L.cancel(),this.L=null,ro(this),X())};
function ko(a){null!=a.Ha&&(m.clearTimeout(a.Ha),a.Ha=null)}
g.tb=function(a){var b;if(this.L==a)ko(this),this.L=null,b=2;else if(this.W==a)this.W=null,b=1;else return;this.ka=a.cb;if(0!=this.f)if(a.na)1==b?(w(),Gm(bo,new eo(bo,a.Ka?a.Ka.length:0)),mo(this),this.l.length=0):qo(this);else{var c=a.Ja,d;if(!(d=3==c||7==c||0==c&&0<this.ka)){if(d=1==b)this.W||this.Ca||1==this.f||2<=this.ab?d=!1:(this.Ca=Dn(v(this.Fc,this,a),so(this,this.ab)),this.ab++,d=!0);d=!(d||2==b&&ro(this))}if(d)switch(c){case 1:Nn(this,5);break;case 4:Nn(this,10);break;case 3:Nn(this,6);
...
function Nn(a,b){if(2==b||9==b){var c=null;a.T&&(c=null);var d=v(a.Be,a);c||(c=new ng("//www.google.com/images/cleardot.gif"),Gg(c));Hn(c.toString(),1E4,d)}else X();to(a,b)}
g.Be=function(a){a?X():(X(),to(this,8))};
function to(a,b){a.f=0;a.T&&a.T.kc(a,b);jo(a);ho(a)}
function jo(a){a.f=0;a.ka=-1;if(a.T)if(0==a.l.length&&0==a.h.length)a.T.Jb(a);else{var b=Ya(a.l),c=Ya(a.h);a.l.length=0;a.h.length=0;a.T.Jb(a,b,c)}}
...
O(d,"VER",a.Ga);io(a,d);return d}
g.Lb=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new Pn;a.ua=!1;return a};
...
g.ma=function(){Gm(bo,new fo(bo))};
function X(){Gm(bo,new co(bo))}
g.jb=function(){return!(!L||wd(10))};
function uo(){}
g=uo.prototype;g.mc=function(){};
g.lc=function(){};
g.kc=function(){};
g.Jb=function(){};
...
vo.prototype.stop=function(){this.A=0;vo.I.stop.call(this)};function wo(a,b){this.K=a;this.l=b;this.j=new F;this.h=new vo(this.Ie,this);this.f=null;this.Y=!1;this.A=null;this.J="";this.F=this.o=0;this.B=[]}
...
g.dispose=function(){this.Y||(this.Y=!0,this.j.clear(),xo(this),E(this.j))};
g.isDisposed=function(){return this.Y};
function yo(a){return{firstTestResults:[""],secondTestResults:!a.f.Bb,sessionId:a.f.j,arrayId:a.f.Ra}}
g.connect=function(a,b,c){if(!this.f||2!=this.f.f){this.J="";this.h.stop();this.A=a||null;this.o=b||0;a=this.K+"/test";b=this.K+"/bind";var d=new $n("1",c?c.firstTestResults:null,c?c.secondTestResults:null),e=this.f;e&&(e.T=null);d.T=this;this.f=d;e?this.f.connect(a,b,this.l,e.j,e.Ra):c?this.f.connect(a,b,this.l,c.sessionId,c.arrayId):this.f.connect(a,b,this.l)}};
...
g.mc=function(){var a=this.h;a.stop();an(a,5E3+2E4*Math.random());this.A=null;this.o=0;if(this.B.length){a=this.B;this.B=[];for(var b=0,c=a.length;b<c;++b)lo(this.f,a[b])}this.D("handlerOpened")};
...
g.lc=function(a,b){if("S"==b[0])this.J=b[1];else if("gracefulReconnect"==b[0]){var c=this.h;c.stop();an(c,500);this.h.start();go(this.f)}else this.D("handlerMessage",new bm(b[0],b[1]))};
function zo(a,b){(a.l.loungeIdToken=b)||a.h.stop()}
g.Ie=function(){this.h.stop();var a=this.f,b=0;a.L&&b++;a.W&&b++;0!=b?this.h.start():this.connect(this.A,this.o)};function Ao(a){this.videoIds=null;this.index=-1;this.videoId=this.f="";this.volume=this.h=-1;this.o=!1;this.audioTrackId=null;this.A=this.l=0;this.j=null;this.reset(a)}
...
function Qo(a,b){b&&(Ko(a),Mo(a));b==Po(a)?b&&(Jo(a,1),Oo(a,"getSubtitlesTrack")):b?(a.N()&&a.C.reset(),Jo(a,1),Oo(a,"getNowPlaying"),Ro(a)):a.o(1)}
...
else if("loungeScreenConnected"==b.action)c=!0;else if("loungeScreenDisconnected"==b.action)c=!1;else return;if(!isNaN(a.K))if(c)Mo(a);else return;c==Po(a)?c&&Jo(a,1):c?(Ko(a),a.N()&&a.C.reset(),Jo(a,1),Oo(a,"getNowPlaying"),Ro(a)):a.o(1)}
g.re=function(){if(this.j){var a=this.j;this.j=null;this.C.videoId!=a&&Oo(this,"getNowPlaying")}};
Y.prototype.subscribe=Y.prototype.subscribe;Y.prototype.unsubscribeByKey=Y.prototype.qa;Y.prototype.ta=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.B())?Po(this)&&(a=1):a=2);return a};
Y.prototype.getProxyState=Y.prototype.ta;Y.prototype.o=function(a){this.H("Disconnecting with "+a);Ko(this);this.D("beforeDisconnect",a);1==a&&Fk();xo(this.f,a);this.dispose()};
Y.prototype.disconnect=Y.prototype.o;Y.prototype.sa=function(){var a=this.C;if(this.j){var b=a=this.C.clone(),c=this.j,d=a.index,e=b.videoId;b.videoId=c;b.index=d;c!=e&&Co(b)}return Go(a)};
Y.prototype.getPlayerContextData=Y.prototype.sa;Y.prototype.za=function(a){var b=new Ao(a);b.videoId&&b.videoId!=this.C.videoId&&(this.j=b.videoId,J(this.F),this.F=I(v(this.re,this),5E3));var c=[];this.C.f==b.f&&this.C.videoId==b.videoId&&this.C.index==b.index&&bb(this.C.videoIds,b.videoIds)||c.push("remoteQueueChange");this.C.h==b.h&&this.C.volume==b.volume&&this.C.o==b.o&&Eo(this.C)==Eo(b)&&M(this.C.j)==M(b.j)||c.push("remotePlayerChange");this.C.reset(a);y(c,function(a){this.D(a)},this)};
...
Y.prototype.reconnect=Y.prototype.Na;function Ro(a){J(a.J);a.J=I(v(a.o,a,1),864E5)}
function Oo(a,b,c){c?a.H("Sending: action="+b+", params="+M(c)):a.H("Sending: action="+b);a.f.sendMessage(b,c)}
Y.prototype.ua=function(a,b){Oo(this,a,b);Ro(this)};
Y.prototype.sendMessage=Y.prototype.ua;function Zo(a){V.call(this);this.o=0;this.la=$o();this.Za=NaN;this.vb="";this.A=a;this.H("Initializing local screens: "+Pj(this.la));this.j=ap();this.H("Initializing account screens: "+Pj(this.j));this.Kb=null;this.f=[];this.h=[];bp(this,Xl()||[]);this.H("Initializing DIAL devices: "+Wj(this.h));a=Nj(Bk());cp(this,a);this.H("Initializing online screens: "+Pj(this.f));this.o=w()+3E5;dp(this)}
...
g.Lc=function(){var a=Xl()||[];0==a.length||bp(this,a);a=fp(this);0==a.length||(Oa(a,function(a){return!ek(this.j,a)},this)&&zk()?gp(this):hp(this,a))};
function ip(a,b){var c=fp(a);return Na(b,function(a){return a.f?(a=dk(this.h,a.f),!!a&&"RUNNING"==a.status):!!ek(c,a)},a)}
function bp(a,b){var c=!1;y(b,function(a){var b=fk(this.la,a.id);b&&b.name!=a.name&&(this.H("Renaming screen id "+b.id+" from "+b.name+" to "+a.name),b.name=a.name,c=!0)},a);
...
var e=this.Kb?lp(this,this.Kb):null;e&&!ek(c,e)&&c.push(e);cp(this,c,!0)}};
$d(Sj(a.A,"/pairing/get_screen_availability"),e)}
function gp(a){var b=fp(a),c=z(b,function(a){return a.id});
0!=c.length&&(a.H("Updating lounge tokens for: "+M(c)),$d(Sj(a.A,"/pairing/get_lounge_token_batch"),{S:{screen_ids:c.join(",")},method:"POST",context:a,ca:function(a,c){mp(this,c.screens||[]);this.la=Na(this.la,function(a){return!!a.token});
kp(this);hp(this,b)}}))}
function mp(a,b){y(Xa(a.la,a.j),function(a){var d=Qa(b,function(b){return a.id==b.screenId});
d&&(a.token=d.loungeToken)})}
function kp(a){var b=$o();bb(a.la,b,Kj)||(a.H("Saving local screens: "+Pj(b)+" to "+Pj(a.la)),wk(z(a.la,Lj)),cp(a,a.f,!0),bp(a,Xl()||[]),a.D("managedScreenChange",fp(a)))}
function np(a,b,c){var d=Ra(b,function(a){return Jj(c,a)}),e=0>d;
0>d?b.push(c):b[d]=c;ek(a.f,c)||a.f.push(c);return e}
g.qc=function(a,b){for(var c=fp(this),c=z(c,function(a){return a.name}),d=a,e=2;A(c,d);)d=b.call(m,e),e++;
return d};
g.Hc=function(a,b,c){var d=!1;b>=ep.length&&(this.H("Pairing DIAL device "+a+" with "+c+" timed out."),d=!0);var e=dk(this.h,a);if(!e)this.H("Pairing DIAL device "+a+" with "+c+" failed: no device for "+a),d=!0;else if("ERROR"==e.status||"STOPPED"==e.status)this.H("Pairing DIAL device "+a+" with "+c+" failed: launch error on "+a),d=!0;d?(op(this),this.D("screenPair",null)):$d(Sj(this.A,"/pairing/get_screen"),{method:"POST",S:{pairing_code:c},context:this,ca:function(a,b){if(c==this.vb){op(this);var d=
new Hj(b.screen);d.name=e.name;d.f=e.id;this.H("Pairing "+c+" succeeded.");var l=np(this,this.la,d);this.H("Paired with "+(l?"a new":"an old")+" local screen:"+Oj(d));kp(this);this.D("screenPair",d)}},
onError:function(){c==this.vb&&(this.H("Polling pairing code: "+c),J(this.Za),this.Za=I(v(this.Hc,this,a,b+1,c),ep[b]))}})};
...
Ll("Sending a cast launch request with params: "+l.parameters);k.launch(l,pa($l,a))}else Ll("No cast API or no cast device. Dropping cast launch.")}d.vb=e;d.Za=I(v(d.Hc,d,a,0,e),ep[0])}else d.H("No DIAL device with id: "+a)}
...
function rp(a){var b=Z,c=dk(b.h,a);if(!c){var d=fk(b.la,a);d&&(c=dk(b.h,d.f))}b.H("Found DIAL: "+(c?c.toString():"null")+" with key: "+a);return c}
function fp(a){return Xa(a.j,Na(a.la,function(a){return!ek(this.j,a)},a))}
;function sp(a){gk.call(this,"ScreenServiceProxy");this.V=a;this.f=[];this.f.push(this.V.$_s("screenChange",v(this.Me,this)));this.f.push(this.V.$_s("onlineScreenChange",v(this.Td,this)))}
x(sp,gk);g=sp.prototype;g.$=function(a){return this.V.$_gs(a)};
...
g.G=function(){for(var a=0,b=this.f.length;a<b;++a)this.V.$_ubk(this.f[a]);this.f.length=0;this.V=null;sp.I.G.call(this)};
g.Me=function(){this.D("screenChange")};
g.Td=function(){this.D("onlineScreenChange")};
W.prototype.$_st=W.prototype.start;W.prototype.$_gspc=W.prototype.Ne;W.prototype.$_gsppc=W.prototype.Uc;W.prototype.$_c=W.prototype.contains;W.prototype.$_g=W.prototype.get;W.prototype.$_a=W.prototype.Db;W.prototype.$_un=W.prototype.Ab;W.prototype.$_r=W.prototype.remove;W.prototype.$_gs=W.prototype.$;W.prototype.$_gos=W.prototype.Tc;W.prototype.$_s=W.prototype.subscribe;W.prototype.$_ubk=W.prototype.qa;function tp(){var a=!!G("MDX_ENABLE_CASTV2"),b=!!G("MDX_ENABLE_QUEUE"),c={device:"Desktop",app:"youtube-desktop"};a?q("yt.mdx.remote.castv2_",!0,void 0):Ql();bj&&aj();ok();up||(up=new Rj,Gk()&&(up.f="/api/loungedev"));Z||a||(Z=new Zo(up),Z.subscribe("screenPair",vp),Z.subscribe("managedScreenChange",wp),Z.subscribe("onlineReceiverChange",function(){K("yt-remote-receiver-availability-change")}));
...
function Pp(){var a=[],a=Qp()?zp().V.$_gos():Nj(Bk()),b=Rp();b&&Np()&&(ek(a,b)||a.push(b));Qp()||(b=bk(Dk()),b=Na(b,function(b){return!fk(a,b.id)}),a=Xa(a,b));
return Zj(a)}
...
function aq(a){q("yt.mdx.remote.currentScreenId_",a,void 0);if(Z){var b=Z;b.o=w()+3E5;if((b.Kb=a)&&(a=lp(b,a))&&!ek(b.f,a)){var c=Ya(b.f);c.push(a);cp(b,c,!0)}}}
...
;var iq=null,jq=[];function kq(a){return{externalChannelId:a.externalChannelId,Gd:!!a.isChannelPaid,source:a.source,subscriptionId:a.subscriptionId}}
function lq(a){mq(kq(a))}
function mq(a){oi()?(R(bi,new Wh(a.externalChannelId,a.Gd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Od({event:"subscribe",source:a.source}))&&Rg(a)):nq(a)}
...
;function rq(a){D.call(this);this.h=a;this.h.subscribe("command",this.Kc,this);this.j={};this.l=!1}
...
g.te=function(a,b){this.l&&!this.isDisposed()&&sq(this.h,a,this.Mb(a,b))};
g.Mb=function(a,b){if(null!=b)return{value:b}};
function tq(a,b){b in a.j&&(a.removeEventListener(b,a.j[b]),delete a.j[b])}
g.G=function(){this.h.unsubscribe("command",this.Kc,this);this.h=null;for(var a in this.j)tq(this,a);rq.I.G.call(this)};function wq(a,b){rq.call(this,b);this.f=a;this.start()}
...
wq.prototype.Mb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return wq.I.Mb.call(this,a,b)};
...
g=xq.prototype;g.pe=function(a,b){if(this.o&&this.o!=this.h.origin)this.dispose();else if("addEventListener"==a&&b){var c=b[0];this.A[c]||"onReady"==c||(this.addEventListener(c,yq(this,c)),this.A[c]=!0)}else this.Xc(a,b)};
g.Xc=function(){};
...
g.dispose=function(){Aq.I.dispose.call(this);for(var a=0;a<this.j.length;a++){var b=this.j[a];this.f.removeEventListener(b.rd,b.listener)}this.j=[]};function Bq(a,b,c){V.call(this);this.f=a;this.h=b;this.j=c}
...
(function(){if(Af)return Fq(/Firefox\/([0-9.]+)/);if(L||jd||id)return td;if(Ef)return Fq(/Chrome\/([0-9.]+)/);if(Ff&&!(hd()||B("iPad")||B("iPod")))return Fq(/Version\/([0-9.]+)/);if(Bf||Cf){var a;if(a=/Version\/(\S+).*Mobile\/(\S+)/.exec(xb))return a[1]+"."+a[2]}else if(Df)return(a=Fq(/Android\s+([0-9.]+)/))?a:Fq(/Version\/([0-9.]+)/);return""})();function Gq(){var a={format:"RAW",headers:{Origin:window.location.origin?window.location.origin:window.location.protocol+"//"+window.location.host},method:"GET",timeout:5E3,withCredentials:!0};return new Jm(function(b,c){a.ca=function(a){Vd(a)?b(a):c(a)};
a.onError=c;a.gb=c;$d("//googleads.g.doubleclick.net/pagead/id",a)})}
;var Hq=null;function Iq(a){a=a.responseText;return 0==a.lastIndexOf(")]}'",0)?JSON.parse(a.substr(4)).id:""}
function Jq(){I(function(){Hq=null},3E5)}
;function Kq(a){Lq=a;q("yt.www.ads.data.encryptedBiscottiId",Lq,void 0)}
function Mq(){}
var Lq="";function Nq(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&Rg(c)}}
;function Oq(a){P.call(this,1,arguments);this.Ib=a}
x(Oq,P);function Pq(a,b){P.call(this,2,arguments);this.h=a;this.f=b}
x(Pq,P);function Qq(a,b,c,d){P.call(this,1,arguments);this.f=b;this.j=c||null;this.h=d||null}
x(Qq,P);function Rq(a,b){P.call(this,1,arguments);this.h=a;this.f=b||null}
x(Rq,P);function Sq(a){P.call(this,1,arguments)}
x(Sq,P);var Tq=new Q("ypc-core-load",Oq),Uq=new Q("ypc-guide-sync-success",Pq),Vq=new Q("ypc-purchase-success",Qq),Wq=new Q("ypc-subscription-cancel",Sq),Xq=new Q("ypc-subscription-cancel-success",Rq),Yq=new Q("ypc-init-subscription",Sq);var Zq=!1,$q=[],ar=[];function br(a){a.f?Zq?R(fi,a):R(Tq,new Oq(function(){R(Yq,new Sq(a.f))})):cr(a.h,a.l,a.j,a.source)}
function dr(a){a.f?Zq?R(ki,a):R(Tq,new Oq(function(){R(Wq,new Sq(a.f))})):er(a.h,a.subscriptionId,a.l,a.j,a.source)}
function fr(a){gr(Ya(a.f))}
function hr(a){ir(Ya(a.f))}
function jr(a){kr(a.f,a.isEnabled,null)}
function lr(a,b,c,d){kr(a,b,c,d)}
function mr(a){var b=a.h,c=a.f.subscriptionId;b&&c&&R(ei,new Xh(b,c,a.f.channelInfo))}
function nr(a){var b=a.f;eb(a.h,function(a,d){R(ei,new Xh(d,a,b[d]))})}
function or(a){R(ji,new Uh(a.h.itemId));a.f&&a.f.length&&(pr(a.f,ji),pr(a.f,li))}
function cr(a,b,c,d){var e=new Uh(a);R(ci,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&qr(b,c);$d("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",ac:f,S:c,ca:function(b,c){var d=c.response;R(ei,new Xh(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&K("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Nq(d.actions)},
Xb:function(){R(di,e)}})}
function er(a,b,c,d,e){var f=new Uh(a);R(hi,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&qr(c,d);$d("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",ac:h,S:d,ca:function(a,b){var c=b.response;R(ji,f);c.actions&&Nq(c.actions)},
Xb:function(){R(ii,f)}})}
function kr(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);$d("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",S:e,onError:function(){d&&d()}})}}
function gr(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-subscribe-loading");pr(b,ci);var c={};c.a=b.join(",");var d=function(){R("subscription-batch-subscribe-loaded");pr(b,di)};
...
function ir(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-unsubscribe-loading");pr(b,hi);var c={};c.c=b.join(",");var d=function(){R("subscription-batch-unsubscribe-loaded");pr(b,ii)};
$d("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",S:c,ca:function(){d();pr(b,ji);a.length&&ir(a)},
onError:function(){d()}})}}
function pr(a,b){y(a,function(a){R(b,new Uh(a))})}
function qr(a,b){var c=Rd(a),d;for(d in c)b[d]=c[d]}
;var rr,sr=null,tr=null,ur=null,vr=!1;
function wr(){var a=G("PLAYER_CONFIG",void 0),b=G("REVERSE_MOBIUS_PERCENT",void 0);if(hg&&100*Math.random()<b)try{var c;try{var d=r("yt.www.ads.biscotti.getId_"),e;if(d)e=d();else{if(!Hq){var f=Gq().then(Iq),h=Nm(Jq,Jq,void 0);h.j=!0;Um(f,h);Hq=f}e=Hq}c=e}catch(k){c=Om(k)}c.then(Kq,Mq)}catch(k){pc(k)}if(G("REQUEST_POST_MESSAGE_ORIGIN")){if(!rr){rr=new Mi;rr.f=wr;return}rr.origin&&"*"!=rr.origin&&(a.args.post_message_origin=rr.origin)}d=document.referrer;b=G("POST_MESSAGE_ORIGIN");c=!1;u(d)&&u(b)&&
-1<d.indexOf(b)&&Mg(b)&&Mg(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);G("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&kj(a.args);sr=Hh("player",a);d=G("POST_MESSAGE_ID","player");G("ENABLE_JS_API")?ur=new Aq(sr):G("ENABLE_POST_API")&&u(d)&&u(b)&&(tr=new Cq(window.parent,d,b),ur=new wq(sr,tr.h));(vr=c&&!G("ENABLE_CAST_API"))?a.args.disableCast="1":(a=sr,tp(),cq=a,cq.addEventListener("onReady",eq),cq.addEventListener("onRemoteReceiverSelected",gq),dq.push(xc("yt-remote-receiver-availability-change",
fq)),dq.push(xc("yt-remote-auto-connect",hq)));G("BG_P")&&(G("BG_I")||G("BG_IU"))&&Mc();ke();iq=sr;iq.addEventListener("SUBSCRIBE",lq);iq.addEventListener("UNSUBSCRIBE",oq);jq.push(Zg(ei,pq),Zg(ji,qq))}
...
a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:k,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;d=d||G("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);k=a.lineNumber.toString();isNaN(k)||isNaN(f)||(k=k+":"+f);ee[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")||(b={ac:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:k,level:b||"ERROR"},S:{url:G("PAGE_NAME",window.location.href),file:a.fileName,"client.name":c||"WEB"},
method:"POST"},e&&(b.S.stack=e),d&&(b.S["client.version"]=d),$d("/error_204",b),ee[a.message]=!0,fe++)}},void 0);
q("writeEmbed",wr,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a=a+"mac_204?action_fcts=1")&&Rg(a);return!0},void 0);
var xr=nc(function(){eh("ol");Zq=!0;ar.push(Zg(bi,br),Zg(gi,dr));Zq||(ar.push(Zg(fi,br),Zg(ki,dr),Zg(Zh,fr),Zg($h,hr),Zg(ai,jr)),$q.push(xc("subscription-prefs",lr)),ar.push(Zg(Vq,mr),Zg(Xq,or),Zg(Uq,nr)));Gf.getInstance();var a=1<window.devicePixelRatio;if(Lf(0,119)!=a){var b="f"+(Math.floor(119/31)+1),c=Kf(b)||0,c=a?c|67108864:c&-67108865;0==c?delete Hf[b]:(a=c.toString(16),Hf[b]=a.toString());var d,b=[];for(d in Hf)b.push(d+"="+escape(Hf[d]));d=b.join("&");ff("PREF",d,63072E3)}}),yr=nc(function(){var a=
sr;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();G("PL_ATT")&&(Lc=null);for(var a=0,b=ie.length;a<b;a++){var c=ie[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}}ie.length=0;a=Hc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Cc(a),b.parentNode.removeChild(b);je=!1;lc("DCLKSTAT",0);zc($q);$q.length=0;$g(ar);ar.length=0;Zq=!1;iq&&(iq.removeEventListener("SUBSCRIBE",mq),iq.removeEventListener("UNSUBSCRIBE",oq));iq=null;$g(jq);jq.length=0;
vr||(zc(dq),dq.length=0,cq&&(cq.removeEventListener("onRemoteReceiverSelected",gq),cq.removeEventListener("onReady",eq),cq=null),Jp());hc(ur,tr);sr&&sr.destroy()});
window.addEventListener?(window.addEventListener("load",xr),window.addEventListener("unload",yr)):window.attachEvent&&(window.attachEvent("onload",xr),window.attachEvent("onunload",yr));var zr=Gi.getInstance(),Ar=ui(zr);Ar in Li||(zr.register(),zr.Jc.push(xc("yt-uix-init-"+Ar,zr.init,zr)),zr.Jc.push(xc("yt-uix-dispose-"+Ar,zr.dispose,zr)),Li[Ar]=zr);})();
