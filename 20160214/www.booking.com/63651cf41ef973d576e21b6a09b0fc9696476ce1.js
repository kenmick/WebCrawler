...
B.atlas.define("provider-google-mixed-markers",["util-array","util-object","provider-google-overlay-marker"],function(n,d,g){function l(q){return n.findIndex(this.markers,function(r){if(r){return r.b_id===String(q)
}})
...
}function f(q){return n.find(this.markers,function(r){if(r){return r.b_id===String(q)
}})
}function p(){var r;
try{r=this.markers.map(function(v){var u={};
Object.keys(v).forEach(function(w){if(/^b_/.test(w)){u[w]=v[w]
}});
return u
})
}catch(t){var s,q;
