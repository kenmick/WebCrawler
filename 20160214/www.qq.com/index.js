...
window._AdSameObj_CY2528363 = {};
var cyis1 = true;
var cyis2 = false;

window._AdSameObj_CY2528363.setis = function(val){
	cyis1=val;
	cyis2=!val;};
window._AdSameObj_CY2528363.setis(_as_dts("_as_crazy2528363",2));

window._AdSameObj_CY2528363.status=0;

window._AdSameObj_CY2528363.fc = function(cmd, args) {
	switch (cmd)
	{
	case "replay":
		if (mutex_lock()==0) {
		window._AdSameObj_CY2528363.b1.show();


		window._AdSameObj_CY2528363.b2.hide();


		window._AdSameObj_CY2528363.status=1;
		}
		break;
	...
	case "closeBig":
		...
		window._AdSameObj_CY2528363.b1.hide();
	...
	case "close":
			...
			window._AdSameObj_CY2528363.b1.destroy();
			window._AdSameObj_CY2528363.b2.destroy();
...
window._AdSameObj_CY2528363.f1 = new _as_fl({
	width: 1000,
	height: 300,
	srcUrl: "http://ra.gtimg.com/adsame/2528363/1000300.swf",
	target: "_blank",
	clsbtn: 0,
	clickUrl: "http://c.l.qq.com/lclick?seq=20160204001132&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY2528363.f1",
	fscmdfc: window._AdSameObj_CY2528363.fc,
    paras:{
    	this_obj:window._AdSameObj_CY2528363.fc
   	}
});
window._AdSameObj_CY2528363.b1 = new _as_divfl({
	width: 1000,
	height: 300,
	hAlign: "center",
	vAlign: "bottom",
	...
	followScroll: 1,
	firstScreen: 0,
	flash: window._AdSameObj_CY2528363.f1,
	selfName: "window._AdSameObj_CY2528363.b1",
	iniShow: cyis1
});
window._AdSameObj_CY2528363.b1.onAfterHide = function() {


		window._AdSameObj_CY2528363.b2.show();
	mutex_unlock();
}

window._AdSameObj_CY2528363.f2 = new _as_fl({
	width: 20,
	height: 100,
	srcUrl: "http://ra.gtimg.com/adsame/2528363/20100.swf",
	target: "_blank",
	repfc: "window._AdSameObj_CY2528363.fc(\"replay\")",
	clsfc: "window._AdSameObj_CY2528363.fc(\"close\")",
	clickUrl: "http://c.l.qq.com/lclick?seq=20160204001132&loc=WWW_RM_RightMove1",
	selfName: "window._AdSameObj_CY2528363.f2",
	fscmdfc: window._AdSameObj_CY2528363.fc,
    paras:{
    	this_obj:window._AdSameObj_CY2528363.fc
   	}
});
window._AdSameObj_CY2528363.b2 = new _as_divfl({
	width: 20,
	height: 100,
	...
	firstScreen: 0,
	alwaysShow: 0,
	flash: window._AdSameObj_CY2528363.f2,
	selfName: "window._AdSameObj_CY2528363.b2",
	iniShow: (cyis2 || 0)
});


window._AdSameObj_CY2528363.run = function() {
	if(window._AdSameObj_CY2528363.inited)return;
	window._AdSameObj_CY2528363.inited=true;
	var s = function() {
	...
	window._AdSameObj_CY2528363.b1.create(window._AdSameObj_CY2528363.f1.getcode()+ifmcode);
	window._AdSameObj_CY2528363.b1.show();
	window._AdSameObj_CY2528363.b2.create(window._AdSameObj_CY2528363.f2.getcode()+ifmcode);
	window._AdSameObj_CY2528363.b2.show();



	window._AdSameObj_CY2528363.status=cyis1;
...
window._AdSameObj_CY2528363.run();
