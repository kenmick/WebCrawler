...
define(['external/modernizr', 'modules/clean/ajax', 'modules/clean/unity/features', 'modules/core/browser', 'modules/core/exception', 'modules/core/uri'], function(Modernizr, ajax, UnityFeatures, Browser, exception, URI) {
  var WebDestiny;
  ...
  WebDestiny = (function() {
    ...
    WebDestiny.finish_indirect_web_destiny = function(refresh_token) {
      if (Modernizr.localstorage) {
        return localStorage.setItem(this._DESTINY_REFRESH_TOKEN_KEY, refresh_token);
      }
    };
